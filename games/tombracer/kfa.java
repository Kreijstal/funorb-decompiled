...
final class kfa {
    ...
    public final void movemouse(int param0, int param1) {
        ((kfa) this).field_a.mouseMove(param0, param1);
    }
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            ...
            if (((kfa) this).field_b == param0) {
              return;
            } else {
              L1: {
                if (((kfa) this).field_b != null) {
                  ((kfa) this).field_b.setCursor((java.awt.Cursor) null);
                  ((kfa) this).field_b = null;
                  break L1;
                } else {
                  break L1;
                }
    ...
    public kfa() throws Exception {
        java.awt.Robot var2 = new java.awt.Robot();
        ((kfa) this).field_a = var2;
    }
}
