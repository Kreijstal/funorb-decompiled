...
final class ul extends nqa implements na {
    ...
    public final void b(byte param0) {
        ((ul) this).field_d.a((byte) 77, (nqa) this);
        if (param0 <= 32) {
            ((ul) this).b((byte) -63);
        }
    }
    ...
    final jagdx.IDirect3DBaseTexture c(int param0) {
        ...
        return (jagdx.IDirect3DBaseTexture) (Object) ((ul) this).field_g;
    }
    ...
    ul(cta param0, int param1, boolean param2, int[][] param3) {
        ...
        L2: {
          ...
          if (((ul) this).field_c) {
            ((ul) this).field_g = ((ul) this).field_d.field_jd.a(((ul) this).field_f, 0, 1024, 21, 1);
            break L2;
          } else {
            ((ul) this).field_g = ((ul) this).field_d.field_jd.a(((ul) this).field_f, 1, 0, 21, 1);
            break L2;
          }
        }
        var10 = ((ul) this).field_d.field_Nc;
        var11 = var10;
        var6 = 0;
        L3: while (true) {
          if (var6 >= 6) {
            ...
            if (jagdx.ah.a(var7, (byte) 112)) {
              L4: {
                ...
                if (var8 == 4 * ((ul) this).field_f) {
                  var10.a(param3[var6], 0, 0, ((ul) this).field_f * ((ul) this).field_f);
                  break L4;
                } else {
                  var9 = 0;
                  L5: while (true) {
                    if (var9 >= ((ul) this).field_f) {
                      break L4;
                    } else {
                      var10.a(param3[var6], var9 * ((ul) this).field_f, var9 * var8, ((ul) this).field_f);
                      var9++;
                      continue L5;
                    }
                  }
              ...
              boolean discarded$1 = ((ul) this).field_g.UnlockRect(var6, 0);
              var6++;
              continue L3;
            } else {
              var6++;
