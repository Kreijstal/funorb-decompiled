...
final class ata extends rra {
    ...
    final void a(int param0, int param1, boolean param2) {
        int var4 = this.field_i * param0 >> 1637429676;
        int var5 = this.field_f * param0 >> 1172633036;
        if (!param2) {
            return;
        }
        int var6 = param1 * this.field_h >> 495955404;
        int var7 = this.field_g * param1 >> -787381556;
    ...
    final void a(byte param0, int param1, int param2) {
        int var4 = param1 * this.field_i >> 951052972;
        int var5 = param1 * this.field_f >> 2081271788;
        if (param0 > -117) {
            this.a((byte) -12, 75, -53);
        }
        int var6 = this.field_h * param2 >> -235318868;
        int var7 = this.field_g * param2 >> -659960020;
