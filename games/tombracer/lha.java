...
final class lha extends kl {
    ...
    lha(cka param0, int param1, int param2, int param3, int param4) {
        ...
        try {
            ...
            throw tba.a((Throwable) (Object) runtimeException, "lha.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    lha(cka param0, int param1, int param2, int param3, int param4, byte[] param5, int param6) {
        ...
        try {
            ...
            throw tba.a((Throwable) (Object) runtimeException, "lha.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + (param5 != null ? "{...}" : "null") + 44 + param6 + 41);
        }
    }
