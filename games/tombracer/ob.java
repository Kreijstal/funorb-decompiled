    ...
    final static void a(ha param0) {
        ...
        try {
              ...
              if (var2_int >= 6) {
                ...
                L2: while (true) {
                  if (var2_int >= 6) {
                    ...
                    ufa.field_r = ak.a(param0, via.field_a, -79);
                    ...
                    nh discarded$5 = su.a(ds.field_g, param0, (byte) 126);
                    ...
                    L3: while (true) {
                      if (cb.field_i.length <= var2_int) {
                        ...
                        nh discarded$6 = su.a(mp.field_d, param0, (byte) 126);
                        nh discarded$7 = su.a(baa.field_g, param0, (byte) -43);
                        fra.field_q = su.a(op.field_O, param0, (byte) 126);
                        ij.field_X = su.a(ifa.field_q, param0, (byte) 125);
                        nh discarded$8 = su.a(field_n, param0, (byte) 125);
                        ...
                        nh discarded$9 = su.a(aw.field_F, param0, (byte) -2);
                        gca.field_a = su.a(rp.field_f, param0, (byte) 126);
                        ng.field_b = ak.a(param0, qka.field_o, -123);
                        ...
                        L4: while (true) {
                          if (var15.length <= var4) {
                            ...
                            var5 = var15[var4] >> 24 & 255;
                            var6 = var15[var4] & 255;
                            var7 = (65319 & var15[var4]) >> 8;
                            var8 = (var15[var4] & 16752521) >> 16;
                            var9 = (int)(0.3 * (double)var8 + (0.59 * (double)var7 + 0.11 * (double)var6));
                            var10 = var9 + ((var9 << 16) + (var9 << 8));
                            var3[var4] = fh.a(var5 << 24, var10);
                            var4++;
                            continue L4;
                          }
                        }
          ...
          L5: {
            ...
            stackOut_17_1 = new StringBuilder().append("ob.J(");
