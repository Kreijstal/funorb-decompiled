...
final class aca extends vg {
    ...
    final static void a(sia param0, int param1) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param1 == 19711) {
                ...
                var3 = (cn) null;
                discarded$2 = aca.a((cn) null, 32, (cn) null, (byte) -47, 55);
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("aca.C(");
    ...
    final static hea a(cn param0, int param1, cn param2, byte param3, int param4) {
        ...
        RuntimeException decompiledCaughtException = null;
        hea stackOut_6_0 = null;
        hea stackOut_1_0 = null;
        ...
        try {
          L0: {
            if (param3 < -99) {
              if (jna.a(false, param4, param1, param2)) {
                stackOut_6_0 = fq.a(param0.a(false, param1, param4), (byte) 103);
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("aca.D(");
