...
class iu extends wca {
    ...
    void d(int param0, int param1) {
        ...
        int var3 = param0 + param1 * bea.field_g;
        int var4 = 0;
        int var5 = this.field_q;
        int var6 = this.field_m;
        int var7 = bea.field_g - var6;
        int var8 = 0;
    ...
    void d(int param0, int param1, int param2) {
        ...
        param0 = param0 + this.field_o;
        param1 = param1 + this.field_p;
        int var4 = param0 + param1 * bea.field_g;
        int var5 = 0;
        int var6 = this.field_q;
        int var7 = this.field_m;
        int var8 = bea.field_g - var7;
        int var9 = 0;
        if (param1 < bea.field_h) {
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                param2++;
                bea.field_l[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
    ...
    iu(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            var4.waitForAll();
            this.field_m = var3.getWidth((java.awt.image.ImageObserver) ((Object) param1));
            ...
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_m, this.field_q, this.field_r, 0, this.field_m);
            var5.grabPixels();
            break L0;
          }
