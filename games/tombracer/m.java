...
final class m extends kna {
    ...
    final static int A(int param0) {
        ...
        if (lca.a(false)) {
          if (param0 != -7111) {
            var2 = (String) null;
            discarded$2 = m.a((String) null, 34, (cn) null, (String) null);
    ...
    final static fq a(int param0, kh param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("m.TB(").append(param0).append(',');
