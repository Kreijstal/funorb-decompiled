    ...
    final void c(int param0, int param1) {
        ...
        L0: {
          ...
          if (param0 >= bea.field_b) {
            ...
            stackIn_3_0 = bea.field_b - param0 << 1;
            break L0;
          }
        }
        L1: {
          ...
          if (param0 + var3 <= bea.field_d) {
            stackIn_6_0 = this.field_m - 2;
            break L1;
          } else {
            stackIn_6_0 = (bea.field_d - param0 << 1) - 2;
            break L1;
          }
        }
        L2: {
          ...
          if (param1 >= bea.field_h) {
            ...
            stackIn_9_0 = bea.field_h - param1 << 1;
            break L2;
          }
        }
        L3: {
          ...
          if (param1 + var4 <= bea.field_k) {
            ...
            stackIn_12_0 = (bea.field_k - param1 << 1) - 2;
            break L3;
          }
        }
        var8 = stackIn_12_0;
