...
final class nfa extends ci {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        try {
              ...
              if (var6 <= var5_int) {
                  ...
                  if (var7 > 0) {
                    ...
                    if (var12 < gca.field_d) {
                      ...
                      if (var11 > hc.field_h) {
                        ...
                        L3: {
                          var13 = rp.a(ss.field_c, -16226, pka.field_b, var5_int + param3);
                ...
                if (gca.field_d > var12) {
                  ...
                  if (var11 > hc.field_h) {
                    ...
                    L4: {
                      var13 = rp.a(ss.field_c, -16226, pka.field_b, param3 + var6);
                      var14 = rp.a(ss.field_c, -16226, pka.field_b, param3 - var6);
                      if (hc.field_h < var12) {
                        break L4;
                      } else {
                        nra.a((byte) -55, param2, var13, vaa.field_a[var12], var14);
          ...
          throw tba.a((Throwable) (Object) var5, "nfa.B(" + 0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ')');
        }
    }
    ...
    final void a(byte param0, uia param1, int param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("nfa.A(").append(param0).append(',');
