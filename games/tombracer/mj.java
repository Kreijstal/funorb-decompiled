...
final class mj extends fqa {
    ...
    final static void a(String param0, File param1) {
        try {
            ...
            throw tba.a((Throwable) (Object) runtimeException, "mj.FC(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + 1 + 41);
        }
    }
    ...
    final static void a(byte param0, String param1, cn param2, cn param3, int param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("mj.VB(").append(-86).append(44);
            stackIn_4_0 = stackOut_2_0;
            stackIn_4_1 = stackOut_2_1;
            stackIn_3_0 = stackOut_2_0;
            stackIn_3_1 = stackOut_2_1;
