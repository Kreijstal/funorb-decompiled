...
final class mj extends fqa {
    ...
    final static void a(String param0, File param1, int param2) {
        ...
        try {
            ...
            discarded$0 = gj.field_d.put(param0, param1);
        } catch (RuntimeException runtimeException) {
        ...
        try {
          L0: {
            L1: {
              ...
              param4++;
              var7.a(incrementValue$9, (byte) 47, param1);
              if (param0 <= -8) {
                break L1;
              } else {
                var6 = (File) null;
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("mj.VB(").append(param0).append(',');
