...
final class oba extends gda {
    ...
    final float[] e(int param0) {
        gt.field_c[10] = this.field_q;
        gt.field_c[14] = this.field_o;
        gt.field_c[12] = this.field_m;
        gt.field_c[8] = this.field_s;
        gt.field_c[4] = this.field_k;
        gt.field_c[5] = this.field_r;
        gt.field_c[0] = this.field_l;
        gt.field_c[9] = this.field_g;
        gt.field_c[2] = this.field_j;
        gt.field_c[13] = this.field_p;
        int var2 = 108 / ((param0 - 0) / 43);
        gt.field_c[1] = this.field_i;
        gt.field_c[6] = this.field_h;
        return gt.field_c;
    }
    ...
    final void c(int param0) {
        ...
        float var4 = this.field_i;
        float var5 = this.field_r;
        float var6 = this.field_g;
        this.field_i = var2 * var4 - var3 * this.field_j;
        float var7 = this.field_p;
        this.field_r = var2 * var5 - this.field_h * var3;
        this.field_j = var3 * var4 + var2 * this.field_j;
        this.field_h = var3 * var5 + var2 * this.field_h;
        this.field_g = -(var3 * this.field_q) + var6 * var2;
        this.field_q = this.field_q * var2 + var3 * var6;
        this.field_p = var7 * var2 - var3 * this.field_o;
        this.field_o = var2 * this.field_o + var7 * var3;
    }
    ...
    final void a(gda param0, byte param1) {
        ...
        try {
          L0: {
            ...
            this.field_i = var5.field_k;
            this.field_r = var5.field_r;
            this.field_g = var5.field_h;
            this.field_m = -(this.field_k * var5.field_p + this.field_l * var5.field_m + var5.field_o * this.field_s);
            this.field_h = var5.field_g;
    ...
    final void a(int param0, int param1, int param2) {
        this.field_p = this.field_p + (float)param1;
        this.field_m = this.field_m + (float)param0;
        this.field_o = this.field_o + (float)param2;
    }
    ...
    final void d(int param0) {
        float var2 = hu.field_c[param0 & 16383];
        float var3 = hu.field_b[param0 & 16383];
        float var4 = this.field_l;
        float var5 = this.field_k;
        float var6 = this.field_s;
        float var7 = this.field_m;
        this.field_l = var3 * this.field_j + var2 * var4;
        this.field_k = this.field_h * var3 + var2 * var5;
        this.field_j = this.field_j * var2 - var3 * var4;
        this.field_s = var3 * this.field_q + var2 * var6;
        this.field_h = -(var5 * var3) + this.field_h * var2;
        this.field_q = -(var3 * var6) + var2 * this.field_q;
        this.field_m = var7 * var2 + var3 * this.field_o;
        this.field_o = -(var3 * var7) + this.field_o * var2;
    }
    ...
    final void b(int param0) {
        ...
        float var5 = this.field_k;
        float var6 = this.field_s;
        this.field_l = var2 * var4 - this.field_i * var3;
        float var7 = this.field_m;
        this.field_i = this.field_i * var2 + var4 * var3;
        this.field_k = var2 * var5 - this.field_r * var3;
        this.field_r = this.field_r * var2 + var3 * var5;
        this.field_s = var6 * var2 - var3 * this.field_g;
        this.field_m = -(var3 * this.field_p) + var2 * var7;
        this.field_g = var2 * this.field_g + var3 * var6;
        this.field_p = var3 * var7 + this.field_p * var2;
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        this.field_i = var12 * -var9 + var13 * var10;
        this.field_l = var11 * var9 + var14 * var10;
        this.field_k = var7 * var12;
        this.field_g = var10 * var12 + var13 * var9;
        this.field_s = var9 * var14 + var11 * -var10;
        this.field_q = var7 * var9;
        this.field_j = var10 * var7;
        this.field_r = var11 * var7;
        this.field_h = -var8;
        this.field_o = (float)(-param0) * this.field_j - (float)param1 * this.field_h - this.field_q * (float)param2;
        this.field_m = -(this.field_s * (float)param2) + ((float)(-param0) * this.field_l - this.field_k * (float)param1);
        this.field_p = -((float)param2 * this.field_g) + ((float)(-param0) * this.field_i - (float)param1 * this.field_r);
    }
