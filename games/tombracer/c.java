    ...
    final static boolean[] a(int param0, boolean[] param1, byte param2, kh param3) {
        ...
        try {
          L0: {
            ...
            if (var4_int != 0) {
              ...
              L3: while (true) {
                L4: {
                  if (var4_int <= var5) {
                    stackOut_13_0 = (boolean[]) (param1);
                    stackIn_14_0 = stackOut_13_0;
                    break L4;
                  } else {
                    stackOut_10_0 = (boolean[]) (param1);
                    stackIn_14_0 = stackOut_10_0;
                    stackIn_11_0 = stackOut_10_0;
                    if (var7 != 0) {
                      break L4;
                    } else {
                      stackIn_11_0[var5] = uha.a(5907, param3);
                      var5++;
                      continue L3;
                    }
                  }
          ...
          L5: {
            ...
            stackOut_15_1 = new StringBuilder().append("c.GB(").append(param0).append(',');
