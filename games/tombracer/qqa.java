...
final class qqa extends hha {
    ...
    final byte[] b(byte param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 5: {
                    try {
                        if ((((qqa) this).field_r.field_h ^ -1) > (-((qqa) this).field_q + ((qqa) this).field_r.field_g.length ^ -1)) {
                            statePc = 10;
                        } else {
                            statePc = 6;
                        }
                ...
                case 11: {
                    try {
                        stackOut_11_0 = ((qqa) this).field_r.field_g;
                ...
                case 13: {
                    ...
                    throw tba.a((Throwable) (Object) var2, "qqa.C(" + param0 + 41);
                }
    ...
    final int a(byte param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 10: {
                    var2 = (RuntimeException) (Object) caughtException;
                    throw tba.a((Throwable) (Object) var2, "qqa.E(" + param0 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
    ...
    final static boolean a(uia param0, char[] param1, int param2, boolean param3) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 12: {
                    try {
                        stackOut_12_0 = param0.field_g.length;
                ...
                case 14: {
                    try {
                        if (stackIn_14_0 == stackIn_14_1.field_h) {
                            statePc = 20;
                        } else {
                            statePc = 15;
                        }
                ...
                case 26: {
                    try {
                        ...
                        stackOut_26_1 = new StringBuilder().append("qqa.H(");
                ...
                case 34: {
                    throw tba.a((Throwable) (Object) stackIn_34_0, stackIn_34_2 + 44 + param2 + 44 + param3 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
    ...
    final static ima a(int[] param0, oc param1, int param2, byte param3) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 16: {
                    try {
                        if (stackIn_16_0 == param1.field_g[var16]) {
                            statePc = 56;
                        } else {
                            statePc = 17;
                        }
                ...
                case 21: {
                    try {
                        stackOut_21_0 = -1;
                        stackOut_21_1 = var18_int ^ -1;
                        stackIn_13_0 = stackOut_21_0;
                        stackIn_13_1 = stackOut_21_1;
                ...
                case 58: {
                    try {
                        var4_array = new int[stackIn_58_0];
                        var5_array = new int[var8];
                        var7 = new float[var8][];
                        var6_array = new int[var8];
                        var15 = 0;
                        statePc = 59;
                        continue stateLoop;
                ...
                case 62: {
                    try {
                        var4_array[var15] = (var10[var15] + var9[var15]) / 2;
                        var5_array[var15] = (var12[var15] + var11[var15]) / 2;
                        var6_array[var15] = (var13[var15] + var14[var15]) / 2;
                        if (1 == var16) {
                            statePc = 70;
                        } else {
                            statePc = 63;
                ...
                case 80: {
                    try {
                        stackOut_80_0 = new ima(var4_array, var5_array, var6_array, var7);
                ...
                case 83: {
                    try {
                        ...
                        stackOut_83_1 = new StringBuilder().append("qqa.G(");
                ...
                case 91: {
                    throw tba.a((Throwable) (Object) stackIn_91_0, stackIn_91_2 + 44 + param2 + 44 + param3 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
    ...
    public static void a(int param0) {
        ...
        try {
            ...
            throw tba.a((Throwable) (Object) runtimeException, "qqa.F(" + param0 + 41);
        }
    }
