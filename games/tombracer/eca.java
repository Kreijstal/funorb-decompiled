...
final class eca {
    ...
    final static boolean a(byte param0, int param1, long param2, int[] param3, String param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_9_1 = new StringBuilder().append("eca.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    public static void a(int param0) {
        ...
        if (param0 != 30152) {
          var2 = (String) null;
          discarded$2 = eca.a((byte) -86, 99, 60L, (int[]) null, (String) null);
          field_b = (String[][]) null;
          field_c = null;
          return;
        } else {
