...
abstract class il extends od {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 31: {
                    ...
                    var4 = var4 + ((il) this).field_B[var7];
                ...
                case 33: {
                    var4 = var4 + ((il) this).field_F[(var3 << 8) + var7];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
    ...
    final void c(String param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        this.b(param0, param1 - ((il) this).b(param0) / 2, param2);
    }
    ...
    final int a(String param0, int param1) {
        return ((il) this).a(param0, new int[1], field_H);
    }
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                      ...
                      if (var5_int >= 256) {
                        ...
                        L4: while (true) {
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ((il) this).field_F = new byte[65536];
                                var7 = 0;
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    ((il) this).field_m = var25[32] + var22[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                ((il) this).field_F[(var7 << 8) + var8] = (byte)il.a(var23, var24, var25, ((il) this).field_B, var22, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                ((il) this).field_B[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
            ...
            var2 = 0;
            L10: while (true) {
              if (var2 >= ((il) this).field_B.length) {
                ((il) this).field_m = param0[256] & 255;
                break L0;
              } else {
                ((il) this).field_B[var2] = param0[var2] & 255;
                var2++;
                continue L10;
              }
            }
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_y = (param1 - ((il) this).b(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    final int c(String param0, int param1) {
        ...
        int var5 = 0;
        int var6 = 0;
        var3 = ((il) this).a(param0, new int[1], field_H);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (var5 >= var3) {
    ...
    final void b(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.b(param0, param1 - ((il) this).b(param0), param2);
    }
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9) {
        return ((il) this).a(param0, param1, param2, param3, param4, param5, param6, 256, param7, param8, param9);
    }

    final int a(char param0) {
        return ((il) this).field_B[io.a(-377, param0) & 255];
    }
    ...
    private final void b(String param0, int param1, int param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 24: {
                    try {
                        stackOut_24_0 = ((il) this).field_I[var10];
                ...
                case 27: {
                    try {
                        var11_ref_rka.b(param1, param2 + ((il) this).field_m - var12);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 28: {
                    try {
                        var11_ref_rka.a(param1, param2 + ((il) this).field_m - var12, field_v);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 37: {
                    param1 = param1 + ((il) this).field_F[(var5 << 8) + var8];
                    statePc = 38;
                    continue stateLoop;
                }
                case 38: {
                    var9 = ((il) this).field_u[var8];
                    var10 = ((il) this).field_C[var8];
                    var11 = param1;
                    if (var8 == 32) {
                        statePc = 46;
                    } else {
                ...
                case 41: {
                    ((il) this).a(var8, param1 + ((il) this).field_n[var8] + 1, param2 + ((il) this).field_s[var8] + 1, var9, var10, field_p, true);
                    statePc = 42;
                    continue stateLoop;
                }
                case 42: {
                    ((il) this).a(var8, param1 + ((il) this).field_n[var8], param2 + ((il) this).field_s[var8], var9, var10, field_x, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 43: {
                ...
                case 44: {
                    ((il) this).a(var8, param1 + ((il) this).field_n[var8] + 1, param2 + ((il) this).field_s[var8] + 1, var9, var10, field_p, field_v, true);
                    statePc = 45;
                    continue stateLoop;
                }
                case 45: {
                    ((il) this).a(var8, param1 + ((il) this).field_n[var8], param2 + ((il) this).field_s[var8], var9, var10, field_x, field_v, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 46: {
                ...
                case 48: {
                    param1 = param1 + ((il) this).field_B[var8];
                    if (field_o == -1) {
                        statePc = 50;
                    } else {
                        statePc = 49;
                ...
                case 49: {
                    bea.c(var11, param2 + (int)((double)((il) this).field_m * 0.7), param1 - var11, field_o);
                    statePc = 50;
                    continue stateLoop;
                }
                case 50: {
                ...
                case 51: {
                    bea.c(var11, param2 + ((il) this).field_m + 1, param1 - var11, field_q);
                    statePc = 52;
                    continue stateLoop;
                }
                case 52: {
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = ana.a(0, ' ', -11, field_t);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
                ...
                case 8: {
                    ...
                    var9 = -1;
                    StringBuilder discarded$11 = field_t.append(60);
                    StringBuilder discarded$12 = field_t.append(var15);
                    StringBuilder discarded$13 = field_t.append(62);
                ...
                case 13: {
                    var4 = var4 + ((il) this).field_F[(var10 << 8) + 60];
                    statePc = 14;
                    continue stateLoop;
                }
                case 14: {
                ...
                case 18: {
                    var4 = var4 + ((il) this).field_F[(var10 << 8) + 62];
                    statePc = 19;
                    continue stateLoop;
                }
                case 19: {
                ...
                case 23: {
                    var4 = var4 + ((il) this).field_F[(var10 << 8) + 160];
                    statePc = 24;
                    continue stateLoop;
                }
                case 24: {
                ...
                case 28: {
                    var4 = var4 + ((il) this).field_F[(var10 << 8) + 173];
                    statePc = 29;
                    continue stateLoop;
                }
                case 29: {
                ...
                case 33: {
                    var4 = var4 + ((il) this).field_F[(var10 << 8) + 215];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
                ...
                case 38: {
                    var4 = var4 + ((il) this).field_F[(var10 << 8) + 128];
                    statePc = 39;
                    continue stateLoop;
                }
                case 39: {
                ...
                case 43: {
                    var4 = var4 + ((il) this).field_F[(var10 << 8) + 169];
                    statePc = 44;
                    continue stateLoop;
                }
                case 44: {
                ...
                case 48: {
                    var4 = var4 + ((il) this).field_F[(var10 << 8) + 174];
                    statePc = 49;
                    continue stateLoop;
                }
                case 49: {
                ...
                case 58: {
                    StringBuilder discarded$14 = field_t.append(var14);
                ...
                case 60: {
                    var4 = var4 + ((il) this).field_F[(var10 << 8) + var14];
                    statePc = 61;
                    continue stateLoop;
                }
                case 61: {
        ...
        if (param0 != null) {
          L0: {
            ...
            if (param10 != 0) {
              ...
              param10 = ((il) this).field_m;
              break L0;
            }
          }
          L1: {
            var12 = new int[]{param3};
            if (param4 >= ((il) this).field_w + ((il) this).field_k + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = ((il) this).a(param0, var12, field_H);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - ((il) this).field_w - ((il) this).field_k - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + ((il) this).field_w + var15;
                  param10 = param10 + var15;
                  break L3;
                } else {
                  var14 = param2 + param4 - ((il) this).field_k - (var13 - 1) * param10;
                  break L3;
                }
              } else {
                var14 = param2 + ((il) this).field_w + (param4 - ((il) this).field_w - ((il) this).field_k - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + ((il) this).field_w;
              break L3;
            }
          }
          var15 = 0;
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.b(field_H[var15], param1 + param3 - ((il) this).b(field_H[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_H[var15], param1 + (param3 - ((il) this).b(field_H[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    final int a(String param0, int param1, int param2) {
        if (param2 == 0) {
            param2 = ((il) this).field_m;
        }
        int var4 = ((il) this).a(param0, new int[1], field_H);
        int var5 = (var4 - 1) * param2;
        return ((il) this).field_w + var5 + ((il) this).field_k;
    }
    ...
    il(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        int var8 = 0;
        ((il) this).field_m = 0;
        ((il) this).field_n = param1;
        ((il) this).field_s = param2;
        ((il) this).field_u = param3;
        ((il) this).field_C = param4;
        this.a(param0);
        var6 = 2147483647;
        var7 = -2147483648;
        var8 = 0;
        L0: while (true) {
          if (var8 >= 256) {
            ((il) this).field_w = ((il) this).field_m - var6;
            ((il) this).field_k = var7 - ((il) this).field_m;
            ((il) this).field_G = ((il) this).field_m - ((il) this).field_s[88];
          } else {
            L1: {
              if (((il) this).field_s[var8] >= var6) {
                break L1;
              } else {
                if (((il) this).field_C[var8] == 0) {
                  break L1;
                } else {
                  var6 = ((il) this).field_s[var8];
                  break L1;
                }
              }
            }
            if (((il) this).field_s[var8] + ((il) this).field_C[var8] > var7) {
              var7 = ((il) this).field_s[var8] + ((il) this).field_C[var8];
              var8++;
              continue L0;
            } else {
              var8++;
