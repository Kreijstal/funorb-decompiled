                                        ...
                                        L2: {
                                          L3: {
                                            ...
                                            if (this.field_I == null) {
                                              stackIn_26_0 = var11_ref_rka.field_f;
                                              break L3;
                                            } else {
                                              stackIn_26_0 = this.field_I[var10];
                                              break L3;
                                            }
                                          }
                                          L4: {
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$0 = field_t.append('<');
                        discarded$1 = field_t.append(var15);
                        discarded$2 = field_t.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$3 = field_t.append((char) var14);
