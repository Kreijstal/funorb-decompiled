...
final class nw extends ci {
    ...
    final static void a(boolean param0, int param1, jea param2) {
        ...
        if (!param0) {
          ...
          L2: {
            if (-3 == (param1 ^ -1)) {
              var28 = hka.field_b;
              var29_ref = vda.field_m[0];
              var30 = jsa.field_z;
              var28.field_f.a(var29_ref, 11, var30, param0);
              var31 = hka.field_b;
              var32 = vda.field_m[1];
              var33 = oqa.field_t;
                      ...
                      L4: while (true) {
                        if (var17 < var7) {
                          ...
                          L6: {
                            ...
                            var13++;
                            var9 = var15 + -(var7 << -1361133524) + -((nw) this).field_v[var13];
                            var10 = -(var8 << 822321772) + (-((nw) this).field_v[var13] + var4);
    ...
    final void a(byte param0, uia param1, int param2) {
        ...
        L1: {
          var4 = param2;
          if (0 == var4) {
            ((nw) this).field_m = param1.h(param0 ^ 148);
            ((nw) this).field_t = param1.h(param0 ^ 148);
            break L1;
          } else {
            if (var4 == 1) {
    ...
    final static ha a(int param0, int param1, d param2, int param3, cn param4, java.awt.Canvas param5) {
        ...
        return ha.a(param2, var7, param4, param3, var6, param0, param5, -17441);
    }
