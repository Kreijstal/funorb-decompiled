    ...
    final static void a(int param0, int param1, int param2, ka param3, int param4, ka param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("gba.B(").append(2).append(',').append(param1).append(',').append(2097152).append(',');
          ...
          L3: {
            ...
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(',').append(-512).append(',');
          ...
          throw tba.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + ',' + param6 + ',' + 512 + ',' + 512 + ',' + param9 + ',' + param10 + ')');
        }
    }
    ...
    final static la a(int param0, boolean param1, g param2, int param3, dt param4) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_4_1 = new StringBuilder().append("gba.D(").append(param0).append(',').append(param1).append(',');
          ...
          L1: {
            stackOut_7_0 = (RuntimeException) (Object) stackIn_7_0;
            stackOut_7_1 = ((StringBuilder) (Object) stackIn_7_1).append(stackIn_7_2).append(',').append(21789).append(',');
