...
final class dh {
    ...
    final static int a(da param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, String param12) {
        ...
        try {
          L0: {
            stackOut_0_0 = param0.a((aa) null, param11, param3, 0, param7, jg.a(param1, (byte) -90, param8), (int[]) null, param2, jg.a(param1, (byte) -45, param6), param12, (byte) -118, param5, 0, (nh[]) null, param4, 1);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("dh.C(");
