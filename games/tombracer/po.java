...
final class po extends bja {
    ...
    final static int a(int param0, int param1, int param2, byte param3, g[] param4) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (param0 <= var7) {
                csa.a(param0, 2097152, var6, param4);
                stackOut_8_0 = var6;
    ...
    private final kha a(il param0, int param1, String param2, int param3) {
        ...
        try {
          L0: {
            var6 = new kha(param3 - param0.field_w, param0.field_k + param3, param2.length());
            var5 = var6;
            ((po) this).field_c = new kha[]{var6};
            stackOut_0_0 = (kha) var5;
