...
final class oj extends jea {
    ...
    final void a(int param0, int param1, byte param2, int param3) {
        ...
        L6: {
          ...
          var19.field_qb = 0;
          stackOut_13_0 = this.field_Cb;
          stackOut_13_1 = this.field_Bb;
          stackOut_13_2 = this.field_ub;
    ...
    final boolean f(int param0) {
        ...
        if ((this.field_Ab.field_E ^ -1) != param0) {
            ...
            if (-1 == (this.field_yb ^ -1)) {
                if (sta.field_B < this.field_wb.field_K + this.field_wb.field_A) {
                    this.field_yb = 3;
                    return true;
                }
            }
    ...
    final static int a(byte param0, ica param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_20_1 = new StringBuilder().append("oj.B(").append(param0).append(',');
    ...
    oj(long param0, jea param1, jea param2, jea param3, jea param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_3_1 = new StringBuilder().append("oj.<init>(").append(param0).append(',');
