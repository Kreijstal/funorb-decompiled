                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51.a(6, (byte) -126);
                      stackIn_66_0 = (uia) (var51);

                      stackIn_66_1 = -1477662136;

                      if (var2 <= 1) {
                        stackIn_67_0 = (uia) ((Object) stackIn_66_0);
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                      ...
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            var44++;
                                            var51.i((int) param0.field_g[incrementValue$1], 0);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var50++;
                              var51.i((int) param0.field_g[incrementValue$25], 0);
                              incrementValue$26 = var50;
                              var50++;
                              var51.i((int) param0.field_g[incrementValue$26], 0);
                              incrementValue$27 = var50;
                              var50++;
                              var51.i((int) param0.field_g[incrementValue$27], 0);
                              continue L5;
                            }
                          } else {
                            L18: {
