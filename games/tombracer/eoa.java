...
final class eoa {
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_e, 0, field_j, 0, var2);
        int var3 = field_d[this.field_i - 1];
        int var4 = bia.a((byte) 93, var3 - 1);
        field_c[0] = fg.a(var4);
        field_c[1] = fg.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < this.field_g.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = fg.field_n[this.field_h[var7]].c();
            }
                    ...
                    if (var6 >= var2) {
                      ...
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= this.field_a[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              incrementValue$2 = var5;
                              var5++;
                              this.field_e[incrementValue$2] = fg.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_a[this.field_g[var6]];
                      var6++;
                      continue L2;
                    }
                  }
