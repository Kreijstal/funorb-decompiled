...
final class eoa {
    ...
    final boolean a() {
        ...
        int var2 = ((eoa) this).field_e.length;
        System.arraycopy((Object) (Object) ((eoa) this).field_e, 0, (Object) (Object) field_j, 0, var2);
        int var3 = field_d[((eoa) this).field_i - 1];
        int var4 = bia.a((byte) 93, var3 - 1);
        field_c[0] = fg.a(var4);
        field_c[1] = fg.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((eoa) this).field_g.length; var6++) {
            var7 = ((eoa) this).field_g[var6];
            var8 = ((eoa) this).field_a[var7];
            var9 = ((eoa) this).field_f[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = fg.field_n[((eoa) this).field_h[var7]].c();
            }
    ...
    eoa() {
        ...
        if (var1 == 1) {
          var2 = fg.a(5);
          var3 = 0;
          ((eoa) this).field_g = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((eoa) this).field_a = new int[var3];
              ((eoa) this).field_f = new int[var3];
              ((eoa) this).field_h = new int[var3];
              ((eoa) this).field_l = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((eoa) this).field_i = fg.a(2) + 1;
                  var4 = fg.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((eoa) this).field_e = new int[var5];
                      ((eoa) this).field_e[0] = 0;
                      ((eoa) this).field_e[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((eoa) this).field_a[((eoa) this).field_g[var6]];
                      var6++;
                      continue L2;
                    }
                  }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((eoa) this).field_e.length;
        var4 = field_d[((eoa) this).field_i - 1];
        var5 = field_b;
        field_b[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_c[0] * ((eoa) this).field_i;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_b[var16]) {
                  var9 = field_j[var16];
                  var10 = field_c[var16] * ((eoa) this).field_i;
            ...
            L3: {
              var7 = eoa.b(field_j, var6);
              var8_int = eoa.a(field_j, var6);
