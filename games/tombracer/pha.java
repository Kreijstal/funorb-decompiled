...
final class pha extends jea {
    ...
    final boolean a(byte param0, pha param1) {
        ...
        try {
          L0: {
            ...
            if (stackIn_3_0 != (((pha) this).field_Fb ? 1 : 0)) {
              L2: {
                if (param0 > 106) {
                  break L2;
                } else {
                  var4 = null;
                  boolean discarded$2 = ((pha) this).a((byte) 29, (pha) null);
                  break L2;
                }
              }
              L3: {
                if (((pha) this).field_Hb) {
                  stackOut_10_0 = 0;
              ...
              if (stackIn_11_0 == (param1.field_Hb ? 1 : 0)) {
                stackOut_13_0 = ((pha) this).field_Hb;
                stackIn_14_0 = stackOut_13_0;
                return stackIn_14_0;
              } else {
                L4: {
                  if (param1.field_Mb <= ((pha) this).field_Mb) {
                    stackOut_17_0 = 0;
              ...
              stackOut_4_0 = ((pha) this).field_Fb;
          ...
          L5: {
            ...
            stackOut_19_1 = new StringBuilder().append("pha.C(").append(param0).append(44);
    ...
    pha(String param0, String param1, long param2) {
        ...
        try {
            ...
            throw tba.a((Throwable) (Object) runtimeException, "pha.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 41);
        }
    }
    ...
    final void a(String param0, int param1, String param2) {
        ...
        try {
            ...
            String discarded$0 = jd.a(1, var5);
        } catch (RuntimeException runtimeException) {
            throw tba.a((Throwable) (Object) runtimeException, "pha.D(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
