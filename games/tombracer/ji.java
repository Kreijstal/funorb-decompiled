...
final class ji {
    ...
    final vg b(int param0) {
        ...
        while (((ji) this).field_b != var2) {
            if (!((((ji) this).field_h ^ -1L) != (((ji) this).field_b.field_d ^ -1L))) {
    ...
    final vg c(int param0) {
        ...
        L0: {
          ...
          if (param0 == 20806) {
            ...
            vg discarded$2 = ((ji) this).c(17);
            break L0;
          }
        }
        L1: {
          if ((((ji) this).field_e ^ -1) >= -1) {
            break L1;
          } else {
        ...
        L2: while (true) {
          if (((ji) this).field_a > ((ji) this).field_e) {
            ...
            var2 = ((ji) this).field_f[((ji) this).field_e].field_a;
    ...
    final void a(long param0, int param1, vg param2) {
        ...
        vg var5 = ((ji) this).field_f[(int)(param0 & (long)(((ji) this).field_a + -1))];
        param2.field_a = var5;
