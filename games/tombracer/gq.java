...
final class gq extends uta {
    ...
    final boolean a(String param0, byte param1) {
        try {
            ...
            } catch (jj decompiledCaughtParameter) {
              decompiledCaughtException = decompiledCaughtParameter;
              return stackIn_3_0 != 0;
            } catch (rv decompiledCaughtParameter) {
              decompiledCaughtException = decompiledCaughtParameter;
    ...
    gq(vna param0, il param1, fia param2) {
        ...
        int var4 = 0;
        ela var5 = (ela) (Object) param0.f(-80);
        while (var5 != null) {
            var4++;
            ((gq) this).field_v[var4] = var5;
    ...
    final String[] a(boolean param0) {
        ...
        L0: {
          ...
          if (!param0) {
            ...
            var12 = null;
            boolean discarded$1 = ((gq) this).a((String) null, (byte) -83);
            break L0;
          }
        }
        L1: {
