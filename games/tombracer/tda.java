...
final class tda extends jg {
    ...
    tda(int param0) {
        ...
        while (256 > var8) {
            ...
            dupTemp$0 = this.field_c[var8];
            this.field_c[var4 - -256] = dupTemp$0;
            this.field_c[var4] = dupTemp$0;
            this.field_c[256 + var8] = var5;
            this.field_c[var8] = var5;
            var8++;
        }
    }
    ...
    final void a(float param0, float param1, float param2, int param3, float[] param4, float param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_10_1 = new StringBuilder().append("tda.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
