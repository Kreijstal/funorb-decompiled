              ...
              if (var3 >= this.field_a) {
                ...
                L2: while (true) {
                  if (var6 >= this.field_i) {
                    ...
                    var4++;
                    var7 = this.field_g[this.field_f[incrementValue$1] & 255];
                    if (var7 == 0) {
              ...
              if (var3 >= this.field_a) {
                ...
                L4: while (true) {
                  if (var6 >= this.field_i) {
                    ...
                    var5++;
                    var2[incrementValue$4] = this.field_h[var4] << 24 | this.field_g[this.field_f[var4] & 255];
                    var4++;
                    var6++;
                    continue L4;
                  }
                                                        ...
                                                        if (var13 >= var9.field_i) {
                                                          ...
                                                          L12: while (true) {
                                                            if (var14 >= var9.field_a) {
                                                              ...
                                                              L13: {
                                                                dupTemp$0 = var1.c((byte) 106);
                                                                var9.field_h[var13 + var14 * var9.field_i] = dupTemp$0;
                                                                var15 = dupTemp$0;
                                                                stackIn_63_0 = var12;
                                                    ...
                                                    if (var13 >= var10) {
                                                      ...
                                                      L16: while (true) {
                                                        if (var13 >= var10) {
                                                          ...
                                                          L17: {
                                                            dupTemp$1 = var1.c((byte) 46);
                                                            var9.field_h[var13] = dupTemp$1;
                                                            var14 = dupTemp$1;
                                                            stackIn_49_0 = var12;
              ...
              if (var4 >= this.field_a) {
                ...
                L3: while (true) {
                  if (var7 >= this.field_i) {
                    ...
                    var5++;
                    var3[incrementValue$0] = this.field_f[incrementValue$1];
                    var7++;
                    continue L3;
                  }
                }
              ...
              if (var5 >= this.field_a) {
                ...
                L5: while (true) {
                  if (var8 >= this.field_i) {
                    ...
                    var6++;
                    var4_ref_byte__[incrementValue$2] = this.field_h[incrementValue$3];
                    var8++;
                    continue L5;
                  }
                }
