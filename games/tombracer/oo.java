    ...
    final static kg a(cn param0, cn param1, boolean param2, String param3, String param4) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = sv.a(param1, var5_int, param0, 24876, var6);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("oo.I(");
    ...
    final void a(int param0, uw param1, byte param2) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_17_1 = new StringBuilder().append("oo.FA(").append(param0).append(',');
    ...
    final void a(byte param0, int param1, uw param2) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_16_1 = new StringBuilder().append("oo.V(").append(param0).append(',').append(param1).append(',');
        ...
        try {
          L0: {
            L1: {
              ...
              sua.field_K.a(2 + (485 + param2 - -param3), param5, -23776, var7 + -param5, 5);
          ...
          throw tba.a((Throwable) (Object) var6, "oo.F(" + param0 + ',' + -104 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ')');
        }
    }
    ...
    final ka a(boolean param0, lca param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("oo.B(").append(param0).append(',');
            stackIn_16_0 = stackOut_14_0;
