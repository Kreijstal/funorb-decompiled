...
class b extends ae implements tpa {
        ...
        try {
          L0: {
            if (((b) this).field_u.d((byte) 14)) {
              ...
              L1: {
                var9 = new uja(((b) this).field_u);
                if (param1 == -9) {
                  break L1;
                } else {
                  var8 = null;
                  boolean discarded$2 = ((b) this).b((ae) null, (byte) 90);
                  break L1;
                }
              }
                ...
                if (null == var4) {
                  ...
                  L3: {
                    if (var4.b((byte) -34)) {
                      ...
                      vg discarded$3 = var5.a(0, (vg) (Object) var4);
          ...
          L5: {
            ...
            stackOut_22_1 = new StringBuilder().append("b.VA(");
                ...
                if (null == var4) {
                  ...
                  L3: {
                    if (!var4.b((byte) -34)) {
                      ...
                      var5 = new uja(((b) this).field_u);
                      vg discarded$1 = var5.a((vg) (Object) var4, (byte) -11);
    ...
    final static byte[] a(int param0, int param1, int param2, byte[] param3) {
        ...
        try {
          L0: {
            var5 = new byte[32768];
            var4 = var5;
            lua.a(param3, param2, var5, 0, 32768);
    ...
    final static lu a(String param0, int param1, String param2, boolean param3, long param4) {
        ...
        try {
          L0: {
            L1: {
              if (param4 != 0L) {
                ...
                if (param2 != null) {
                  stackOut_6_0 = new wc(param2, param0);
                  stackIn_7_0 = stackOut_6_0;
                  return (lu) (Object) stackIn_7_0;
                } else {
                  break L1;
                }
              }
            }
            stackOut_8_0 = new tc(param4, param0);
            stackIn_9_0 = stackOut_8_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("b.DB(");
            ...
            L1: while (true) {
              ...
              L3: {
                if (param0 == 59) {
                  ...
                  ae discarded$2 = ((b) this).g((byte) 119);
                  break L3;
                }
              }
              break L0;
    ...
    boolean a(ae param0, boolean param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_12_1 = new StringBuilder().append("b.S(");
            stackIn_15_0 = stackOut_12_0;
            stackIn_15_1 = stackOut_12_1;
            stackIn_13_0 = stackOut_12_0;
            stackIn_13_1 = stackOut_12_1;
            ...
            if (param3) {
              ...
              L1: while (true) {
                ...
                if (var6 != 80) {
                  ...
                  L4: {
                    if (oj.field_tb[81]) {
                      stackOut_16_0 = ((b) this).b(param1, (byte) -124);
                      stackIn_17_0 = stackOut_16_0;
                      break L4;
                    } else {
                      stackOut_14_0 = ((b) this).a(param1, (byte) -9);
                      stackIn_17_0 = stackOut_14_0;
                      break L4;
                    }
                  }
    ...
    private final void b(int param0, Hashtable param1, StringBuilder param2) {
        uja var5 = null;
          ...
          L0: {
            ...
            L1: while (true) {
              if (var6 == null) {
                ...
                L2: while (true) {
                  if (param0 < var7) {
                    StringBuilder discarded$19 = var6.a(param0 + 1, param1, param2, 0);
                    var6 = (ae) (Object) var5.a(-1);
                    continue L1;
                  } else {
