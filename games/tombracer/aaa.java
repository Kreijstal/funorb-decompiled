        ...
        if (!((aaa) this).field_g) {
          ...
          L0: while (true) {
            if (16 <= var2) {
              ...
              L1: while (true) {
                if (-17 < (var2 ^ -1)) {
                  var24 = ua.a(gu.field_l, 32768, var2 * 32768, false);
                  ((aaa) this).field_i[var2] = new rt(param0, 3553, 6410, 128, 128, true, var24, 6410, false);
                  var2++;
                  continue L1;
                } else {
                }
              ...
              var23 = ua.a(hna.field_e, 32768, 32768 * var2, false);
              ((aaa) this).field_f[var2] = new rt(param0, 3553, 6410, 128, 128, true, var23, 6410, false);
              var2++;
              continue L0;
            }
          }
