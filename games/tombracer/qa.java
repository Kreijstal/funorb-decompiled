...
final class qa {
    ...
    final static int a(boolean param0, mi[] param1, int param2) {
        ...
        L0: while (true) {
          if (param1.length - 1 <= var3) {
            ...
            if (param1[var3 - -1].field_h <= param2 + -1) {
              var3++;
              continue L0;
            } else {
              return var3;
            ...
            if (param1 != dp.field_j) {
              if (qu.field_e != param1) {
                if (param1 != mma.field_c) {
                  ...
                  this.a(var4, param0 * var5, 8, aaa.a(false), (param0 - -1) * var5);
                  return;
                }
              } else {
                this.a(var4, 0, 8, aaa.a(false), var5 << -1326047231);
                return;
              }
            } else {
              this.a(0, 0, param2 + 20194, var4, koa.b(param2 ^ -20186));
              return;
            }
          } else {
    ...
    final static void a(int param0, int param1, byte param2, int param3, nh[] param4, int param5) {
        ...
        var6 = aq.field_a[0].a();
        param1 = (var6 / 2 + param1) / var6 * var6;
        var7 = aq.field_a[0].c();
        param4[0].a(param3, param5);
        param0 = (param0 + var7 / 2) / var7 * var7;
        param4[2].a(-var6 + param1 + param3, param5);
        param4[6].a(param3, -var7 + param0 + param5);
        param4[8].a(-var6 + (param3 + param1), param5 - -param0 - var7);
        var8 = var6 + param3;
        L0: while (true) {
          if (param3 - (-param1 + var6 * 2) < var8) {
            var8 = param5 + var7;
            L1: while (true) {
              if (var8 > -(var7 * 2) + param0 + param5) {
                var8 = var6 + param3;
                L2: while (true) {
                  if (var8 > param1 + param3 + -(2 * var6)) {
                    if (param2 > 64) {
                      return;
                    } else {
                      var11 = null;
                ...
                param4[5].a(param1 + (param3 - var6), var8);
                var8 = var8 + var7;
                continue L1;
              }
            }
