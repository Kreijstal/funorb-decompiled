...
final class mda extends c implements fo, ffa, gma {
          ...
          L0: {
            L1: {
              ...
              if (param1 < -16) {
                ...
                discarded$2 = mda.b(-115, (byte) 124, 61, -21);
                break L1;
              }
            }
            break L0;
    ...
    private final boolean a(gma param0, byte param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("mda.DA(");
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
    ...
    public final int a(up param0, ep param1, int param2) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = this.a(param0, var4_int, param1.d(3), 0, param1.e(9648), var4_int);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    final void a(int param0, byte param1, int param2, int param3) {
        ...
        if (param1 != -78) {
          var6 = (ep) null;
          discarded$2 = this.a((up) null, (ep) null, -22);
          this.field_j = param2;
          this.field_p = param0;
          return;
        } else {
    ...
    public final int e(int param0) {
        ...
        if (param0 != 9648) {
          var3 = (ffa) null;
          discarded$2 = this.a(-103, (gma) null, -104, -49, -55, (ffa) null, -28, -39);
          return this.field_j;
        } else {
          return this.field_j;
        }
    ...
    private final int a(up param0, int param1) {
        ...
        try {
                ...
                L2: {
                  if (0 == this.field_s) {
                    ...
                    if (-2 != (this.field_s ^ -1)) {
                      ...
                      this.i((byte) -126);
                      discarded$2 = this.field_q.b(30097, this.field_k / 2, 0, this.field_j, this.field_p);
                      var3_int = param0.field_b;
                      if (var4 == 0) {
                        break L1;
                      } else {
                ...
                L4: {
                  if ((param0.field_j ^ -1) == -4) {
                    ...
                    if (-6 != (param0.field_j ^ -1)) {
                      ...
                      this.i((byte) -127);
                      discarded$3 = this.field_q.b(param1 + 30103, this.field_k / 2, 1, this.field_j, this.field_p);
                      var3_int = param0.field_b;
                      if (var4 == 0) {
                        break L1;
                      } else {
          ...
          L5: {
            ...
            stackOut_18_1 = new StringBuilder().append("mda.K(");
    ...
    public static void j(byte param0) {
        ...
        if (param0 != 87) {
            discarded$0 = mda.b(-56, (byte) 104, -90, 106);
            field_v = null;
            return;
        }
        field_v = null;
    ...
    public final int i(int param0) {
        boolean discarded$0 = false;
        if (param0 <= 90) {
            discarded$0 = mda.b(122, (byte) -32, 39, 92);
            return this.field_u;
        }
        return this.field_u;
    }
    ...
    final void a(la param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_7_1 = new StringBuilder().append("mda.CA(");
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
            stackIn_8_0 = stackOut_7_0;
            stackIn_8_1 = stackOut_7_1;
    ...
    public final boolean j(int param0) {
        boolean discarded$0 = false;
        if (param0 != -1) {
            discarded$0 = this.a((byte) -105, false);
            return false;
        }
        return false;
    }
