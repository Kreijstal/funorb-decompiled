          ...
          if (0 >= this.field_u) {
            L3: {
              if (this.d((byte) -124)) {
                ...
                if ((stackIn_18_0 ^ -1) != (this.field_s ^ -1)) {
                  break L3;
                } else {
                  break L2;
                }
              ...
              L2: while (true) {
                if (var4 >= cb.field_i.length) {
                  L3: {
                    ...
                    be.a(vj.field_d[this.field_v].toUpperCase(), 1, eda.field_f, 2431750, 8 + o.field_d.field_m, var5, 1, var7 - (var5 >> -1930522463), var6 + -(var4 >> 810653985), -1, (byte) 60, var4);
                    if (rd.b(false)) {
                      L4: {
                        if (vpa.a(62)) {
                          break L4;
                      ...
                      be.a(var8, 1, kn.field_p, 16777215, 16, var5, 1, var7 + -(var5 >> -356409631), 10 + (var6 - (var4 >> 1785892385)), -1, (byte) 60, -20 + var4);
                      break L3;
                    } else {
                      break L3;
                    }
            ...
            L7: while (true) {
              L8: {
                if (var9 == null) {
                  ...
                  L9: {
                    if (var9.a(this.field_x, param0, (byte) 116)) {
                      L10: {
                        if (this.field_v == var9.field_i) {
                          stackIn_43_0 = var9.field_g;
                          break L10;
                        } else {
                          stackIn_43_0 = var9.field_i;
                          break L10;
                        }
                      }
                      var10 = stackIn_43_0;
