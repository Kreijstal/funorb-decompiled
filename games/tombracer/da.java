...
abstract class da {
    ...
    private final int a(int[] param0, int param1, String param2, int param3, int param4, aa param5, int param6, nh[] param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16) {
        ...
        try {
          ...
          throw tba.a((Throwable) (Object) stackIn_59_0, stackIn_59_2 + 44 + param8 + 44 + param9 + 44 + param10 + 44 + param11 + 44 + param12 + 44 + param13 + 44 + param14 + 44 + param15 + 44 + param16 + 41);
        }
        return stackIn_46_0;
    }
    ...
    private final void a(boolean param0, int param1, String param2) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_17_1 = new StringBuilder().append("da.G(").append(param0).append(44).append(param1).append(44);
