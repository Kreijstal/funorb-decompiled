...
final class ula extends nv {
    ...
    final int a(int param0, up param1, pc param2) {
        ...
        try {
          L0: {
            L1: {
              if (param0 <= -85) {
                ...
                var5 = null;
                int discarded$2 = ((ula) this).a(102, (up) null, (pc) null);
                break L1;
              }
            }
            stackOut_2_0 = this.a(param1, (byte) -115);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ula.S(").append(param0).append(44);
    ...
    final int a(int param0, ep param1, up param2) {
        ...
        try {
          L0: {
            L1: {
              if (param0 == 25940) {
                ...
                int discarded$2 = ((ula) this).a(false);
                break L1;
              }
            }
            stackOut_2_0 = this.a(param2, (byte) -115);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            var4 = decompiledCaughtException;
            stackOut_4_0 = (RuntimeException) var4;
            stackOut_4_1 = new StringBuilder().append("ula.BC(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    ula(la param0, kh param1, boolean param2) {
        ...
        try {
            ...
            ((ula) this).field_n = param1.b((byte) 44, 8) << 16;
        } catch (RuntimeException runtimeException) {
            throw tba.a((Throwable) (Object) runtimeException, "ula.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 41);
        }
    }
    ...
    final void a(boolean param0, fsa param1) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (var3_int >= 6) {
                ...
                L3: {
                  L4: {
                    if (((ula) this).field_x.a(0, var3_int)) {
                      break L4;
                    } else {
                      if (!((ula) this).field_q.a(0, var3_int)) {
                        break L3;
                      } else {
                        break L4;
                      }
          ...
          L5: {
            ...
            stackOut_11_1 = new StringBuilder().append("ula.Q(").append(param0).append(44);
    ...
    final void a(boolean param0, kh param1) {
        try {
            ...
            param1.a((byte) 127, ((ula) this).field_n >> 16, 8);
        } catch (RuntimeException runtimeException) {
            throw tba.a((Throwable) (Object) runtimeException, "ula.F(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    private final int a(up param0, byte param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("ula.V(");
    ...
    final int a(int param0, int param1, up param2, int param3, byte param4, int param5) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = this.a(param2, (byte) -115);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ula.UB(").append(param0).append(44).append(param1).append(44);
