...
final class fja extends qra {
    ...
    private final void f(int param0) {
        ...
        if (param0 != 16) {
            boolean discarded$0 = ((fja) this).a('ﾝ', -29, -124);
        }
    }
    ...
    private final void b(byte param0) {
        ...
        if (-2 <= (((fja) this).field_c.field_P ^ -1)) {
          ...
          if (((fja) this).field_h.c(false)) {
            ...
            if (!((fja) this).field_c.b(0)) {
              ...
              if (((fja) this).field_c.field_G[0].e(-31170)) {
                ...
                if ((((fja) this).field_c.field_L ^ -1) < -2) {
              ...
              L2: {
                ...
                if (param1 != null) {
                  ...
                  L5: {
                    ...
                    jg.field_a.a(lpa.field_p.nextInt(), (byte) 92);
                    stackOut_9_0 = jg.field_a;
                    stackIn_11_0 = stackOut_9_0;
                    stackIn_10_0 = stackOut_9_0;
                    if (!param4.a((byte) 29)) {
                      stackOut_11_0 = (uia) (Object) stackIn_11_0;
                      stackOut_11_1 = "";
                      stackIn_12_0 = stackOut_11_0;
                      stackIn_12_1 = stackOut_11_1;
                      break L5;
                    } else {
                      stackOut_10_0 = (uia) (Object) stackIn_10_0;
                  ...
                  L6: {
                    ((uia) (Object) stackIn_12_0).a(stackIn_12_1, (byte) 0);
          ...
          L11: {
            if (pe.field_m == km.field_p) {
              if (cla.g(0)) {
                L12: {
                  if (oka.field_z == 255) {
                    var9_ref = vc.field_q.c(-28690);
                    if (var9_ref != null) {
                      mp.a(var9_ref, di.a(82), -21407);
                      break L12;
                    } else {
                      break L12;
                    }
    ...
    fja(qh param0, v param1) {
        ...
        int var3 = ((fja) this).field_h.field_k.field_H.length;
        ((fja) this).field_n = new qa[var3];
