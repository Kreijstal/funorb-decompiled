...
final class bba {
    ...
    final static void a(String[] args, String[] param1, boolean param2, int param3, byte[] param4, String[] param5, int param6, int param7, iu[][] param8, int[] param9, String[][] param10, cn param11, byte[] param12, cn param13, cn param14, iu[][] param15, int[] param16, int param17, hja[] param18, String[][] param19) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("bba.A(");
          ...
          L3: {
            ...
            stackOut_10_1 = ((StringBuilder) (Object) stackIn_10_1).append(stackIn_10_2).append(',').append(true).append(',').append(param3).append(',');
          ...
          L5: {
            ...
            stackOut_16_1 = ((StringBuilder) (Object) stackIn_16_1).append(stackIn_16_2).append(',').append(95).append(',').append(param7).append(',');
    ...
    final boolean a(csa param0, boolean param1, boolean param2) {
        ...
        try {
          L0: {
            var4 = new uja(((bba) this).field_e);
            var5 = (csa) (Object) var4.a(param2);
            L1: while (true) {
              if (var5 == null) {
                if (param2) {
                  stackOut_14_0 = 0;
          ...
          L3: {
            ...
            stackOut_16_1 = new StringBuilder().append("bba.D(");
            stackIn_18_0 = stackOut_16_0;
            stackIn_18_1 = stackOut_16_1;
            stackIn_17_0 = stackOut_16_0;
            stackIn_17_1 = stackOut_16_1;
