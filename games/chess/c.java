...
final class c extends lh {
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19 = 0;
        int var20 = 0;
        var13 = param2 - wb.field_i;
        var14 = param3 - wb.field_a;
        var15 = var14;
        L0: while (true) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  wb.field_d[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              c.a(wb.field_d, ((c) this).field_P[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (wb.field_k == null) {
                  c.a(wb.field_d, ((c) this).field_P[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  c.a(wb.field_d, ((c) this).field_P[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, wb.field_k, wb.field_e);
                  break L5;
                }
              }
              return;
    ...
    c(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        super(param0, param1, param2, param3, param4);
        ((c) this).field_P = new byte[256][];
        ((c) this).field_P = param5;
    }
