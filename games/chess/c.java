...
final class c extends lh {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$0] == 0) {
                  ...
                  param8++;
                  wb.field_d[incrementValue$1] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        int var13 = 0;
        int var9 = param1 + param2 * wb.field_h;
        int var10 = wb.field_h - param3;
        int var11 = 0;
        int var12 = 0;
            ...
            if (param4 > 0) {
              L5: {
                if (wb.field_k == null) {
                  ...
                  c.a(wb.field_d, this.field_P[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, wb.field_k, wb.field_e);
                  break L5;
                }
              }
              return;
