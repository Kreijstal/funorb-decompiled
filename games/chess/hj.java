...
final class hj {
    ...
    final da a(byte param0, boolean param1, int param2, gd param3, gd param4) {
        ...
        try {
          L0: {
            if (((hj) this).field_e != null) {
              L1: {
                if (param2 < 0) {
                  break L1;
                } else {
                  if (param2 < ((hj) this).field_h.length) {
                    if (null != ((hj) this).field_h[param2]) {
                      stackOut_8_0 = ((hj) this).field_h[param2];
                      stackIn_9_0 = stackOut_8_0;
                      return stackIn_9_0;
                    } else {
                      ((hj) this).field_e.field_l = 72 * param2 + 6;
                      var6_int = ((hj) this).field_e.e((byte) -93);
                      if (param0 == 14) {
                        var7 = ((hj) this).field_e.e((byte) -91);
                        var13 = new byte[64];
                        ((hj) this).field_e.a(64, (byte) 125, var13, 0);
                        var9 = new da(param2, param4, param3, ((hj) this).field_d, ((hj) this).field_m, var6_int, var13, var7, param1);
                        ((hj) this).field_h[param2] = var9;
                        stackOut_13_0 = (da) var9;
                        stackIn_14_0 = stackOut_13_0;
                        break L0;
                      } else {
                        stackOut_11_0 = null;
                        stackIn_12_0 = stackOut_11_0;
                        return (da) (Object) stackIn_12_0;
                      }
                    }
                  } else {
                    break L1;
          ...
          L2: {
            ...
            stackOut_15_1 = new StringBuilder().append("hj.F(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final boolean a(boolean param0) {
        ...
        byte[] var17 = null;
        var8 = Chess.field_G;
        if (null != ((hj) this).field_e) {
          return true;
        } else {
          L0: {
            if (((hj) this).field_g != null) {
              break L0;
            } else {
              if (!((hj) this).field_d.a(true)) {
                ((hj) this).field_g = ((hj) this).field_d.a(89, 255, (byte) 0, true, 255);
                break L0;
              } else {
                return false;
              }
          ...
          if (((hj) this).field_g.field_s) {
            return false;
          } else {
            L1: {
              L2: {
                var10 = new p(((hj) this).field_g.a(param0));
                var10.field_l = 5;
                var3 = var10.i(-87);
                var10.field_l = var10.field_l + 72 * var3;
                var16 = new byte[-var10.field_l + var10.field_o.length];
                var14 = var16;
                var13 = var14;
                var11 = var13;
                var4 = var11;
                var10.a(var16.length, (byte) 125, var16, 0);
                if (((hj) this).field_c == null) {
                  break L2;
                } else {
                  if (((hj) this).field_f == null) {
                    break L2;
                  } else {
            ...
            if (var5.length == 65) {
              var17 = kh.a(5, -var16.length + var10.field_l + -5, (byte) -82, var10.field_o);
              var7 = 0;
              L3: while (true) {
                if (var7 >= 64) {
                  ((hj) this).field_e = var10;
                  ((hj) this).field_h = new da[var3];
                  return true;
                } else {
    ...
    final void a(int param0) {
        ...
        int var3 = 0;
        var3 = Chess.field_G;
        if (((hj) this).field_h == null) {
          return;
        } else {
          var2 = 0;
          L0: while (true) {
            if (var2 >= ((hj) this).field_h.length) {
              L1: {
                if (param0 == 32130) {
                  break L1;
                } else {
                  ((hj) this).field_d = null;
                  break L1;
                }
              }
              var2 = 0;
              L2: while (true) {
                if (((hj) this).field_h.length <= var2) {
                  return;
                } else {
                  if (null != ((hj) this).field_h[var2]) {
                    ((hj) this).field_h[var2].c(param0 + -32128);
                    var2++;
                    continue L2;
                  } else {
                    var2++;
    ...
    private hj(wm param0, on param1, java.math.BigInteger param2, java.math.BigInteger param3) {
        ...
        try {
          L0: {
            L1: {
              ((hj) this).field_f = param3;
              ((hj) this).field_m = param1;
              ((hj) this).field_c = param2;
              ((hj) this).field_d = param0;
              if (((hj) this).field_d.a(true)) {
                break L1;
              } else {
                ((hj) this).field_g = ((hj) this).field_d.a(127, 255, (byte) 0, true, 255);
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("hj.<init>(");
