...
final class hj {
                ...
                if (-1 < (param2 ^ -1)) {
                  ...
                  if (param2 < this.field_h.length) {
                    if (null != this.field_h[param2]) {
                      stackOut_8_0 = this.field_h[param2];
                      stackIn_9_0 = stackOut_8_0;
                      decompiledRegionSelector0 = 0;
                      break L0;
                    } else {
                      this.field_e.field_l = 72 * param2 + 6;
                      var6_int = this.field_e.e((byte) -93);
                      if (param0 == 14) {
                        var7 = this.field_e.e((byte) -91);
                        var13 = new byte[64];
                        this.field_e.a(64, (byte) 125, var13, 0);
                        var9 = new da(param2, param4, param3, this.field_d, this.field_m, var6_int, var13, var7, param1);
    ...
    final boolean a(boolean param0) {
        ...
        if (null != this.field_e) {
          ...
          L0: {
            if (this.field_g != null) {
              ...
              if (!this.field_d.a(true)) {
                this.field_g = this.field_d.a(89, 255, (byte) 0, true, 255);
                break L0;
              } else {
                return false;
              }
          ...
          if (this.field_g.field_s) {
            return false;
          } else {
            L1: {
              L2: {
                var10 = new p(this.field_g.a(param0));
                var10.field_l = 5;
                var3 = var10.i(-87);
                var10.field_l = var10.field_l + 72 * var3;
                var13 = new byte[-var10.field_l + var10.field_o.length];
                var11 = var13;
                var4 = var11;
                var10.a(var13.length, (byte) 125, var13, 0);
                if (this.field_c == null) {
                  ...
                  if (this.field_f == null) {
                    ...
                    var7_ref_java_math_BigInteger = var12.modPow(this.field_c, this.field_f);
            ...
            if (-66 == (var5.length ^ -1)) {
              var15 = kh.a(5, -var13.length + var10.field_l + -5, (byte) -82, var10.field_o);
              var7 = 0;
              L3: while (true) {
                if ((var7 ^ -1) <= -65) {
                  this.field_e = var10;
                  this.field_h = new da[var3];
                  return true;
                } else {
              ...
              L2: while (true) {
                if (this.field_h.length <= var2) {
                  ...
                  if (null != this.field_h[var2]) {
                    this.field_h[var2].c(param0 + -32128);
                    var2++;
                    continue L2;
                  } else {
                    var2++;
          ...
          L0: {
            L1: {
              ...
              if (this.field_d.a(true)) {
                ...
                this.field_g = this.field_d.a(127, 255, (byte) 0, true, 255);
                break L1;
              }
            }
            break L0;
