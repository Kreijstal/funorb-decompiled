    ...
    public final void b(qn param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("vm.L(");
        ...
        try {
            ...
            try {
              ...
              L4: {
                ...
                stackOut_7_1 = new StringBuilder().append("vm.BA(");
    ...
    public final void a(qn param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("vm.N(");
    ...
    final static int a(String param0, int param1, lh param2, String[] param3, int param4) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_22_1 = new StringBuilder().append("vm.W(");
