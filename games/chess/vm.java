...
abstract class vm extends jb implements ha {
    ...
    final String d(int param0) {
        ...
        if (param0 < 40) {
            ...
            discarded$0 = this.a((byte) 78, (String) null);
        }
    ...
    final static Object a(int param0, byte[] param1, boolean param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_14_1 = new StringBuilder().append("vm.EA(").append(param0).append(',');
    ...
    final static void g(int param0) {
        ...
        if (param0 != 1) {
            byte[] var2 = (byte[]) null;
            discarded$0 = vm.a(70, (byte[]) null, true);
        }
    }
    ...
    final static int a(String param0, int param1, lh param2, String[] param3, int param4) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_26_1 = new StringBuilder().append("vm.W(");
          ...
          throw fk.a((Throwable) ((Object) stackIn_35_0), stackIn_35_2 + ',' + param4 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_5_0;
        } else {
