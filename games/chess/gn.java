...
final class gn {
    ...
    final int a(int param0, float param1) {
        ...
        for (var4 = 1; var4 < this.field_f[param0]; var4++) {
            ...
            for (var7 = var4 * 2 - 1; var7 >= 2; var7--) {
                dupTemp$0 = field_g[param0];
                dupTemp$0[var7] = dupTemp$0[var7] + (field_g[param0][var7 - 1] * var5 + field_g[param0][var7 - 2] * var6);
            }
            dupTemp$1 = field_g[param0];
            dupTemp$1[1] = dupTemp$1[1] + (field_g[param0][0] * var5 + var6);
            dupTemp$2 = field_g[param0];
            dupTemp$2[0] = dupTemp$2[0] + var5;
        }
        if (param0 == 0) {
            for (var4 = 0; var4 < this.field_f[0] * 2; var4++) {
                dupTemp$3 = field_g[0];
                dupTemp$3[var4] = dupTemp$3[var4] * field_a;
            }
        }
        for (var4 = 0; var4 < this.field_f[param0] * 2; var4++) {
            field_e[param0][var4] = (int)(field_g[param0][var4] * 65536.0f);
        }
        return this.field_f[param0] * 2;
    }
    ...
    final void a(p param0, ll param1) {
        ...
        L0: {
          var3 = param0.i(-80);
          this.field_f[0] = var3 >> 4;
          this.field_f[1] = var3 & 15;
          if (var3 == 0) {
            var11 = this.field_c;
            this.field_c[1] = 0;
            var11[0] = 0;
            ...
            this.field_c[0] = param0.f(674914976);
            this.field_c[1] = param0.f(674914976);
            var4 = param0.i(-127);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                    ...
                    L5: while (true) {
                      if (var7 >= this.field_f[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_d[var5][1][var7] = param0.f(674914976);
                          this.field_h[var5][1][var7] = param0.f(674914976);
                          var7++;
                          continue L5;
                        }
                      }
                ...
                var6 = 0;
                L6: while (true) {
                  if (var6 >= this.field_f[var5]) {
                    var5++;
                    continue L1;
                  } else {
                    this.field_d[var5][0][var6] = param0.f(674914976);
                    this.field_h[var5][0][var6] = param0.f(674914976);
                    var6++;
                    continue L6;
                  }
                }
