    ...
    final static void a(int param0, int param1, java.math.BigInteger param2, p param3, int param4, java.math.BigInteger param5, byte[] param6) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_22_1 = new StringBuilder().append("ni.A(").append(0).append(',').append(param1).append(',');
          ...
          L10: {
            ...
            stackOut_28_1 = ((StringBuilder) (Object) stackIn_28_1).append(stackIn_28_2).append(',').append(-21105).append(',');
