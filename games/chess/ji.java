...
final class ji extends kn {
    ...
    final void a(int param0, mf param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("ji.VA(").append(param0).append(44);
          ...
          throw fk.a((Throwable) (Object) stackIn_10_0, stackIn_10_2 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
    }
    ...
    final static String a(String param0, String param1, String param2, um param3, byte param4) {
        ...
        try {
          L0: {
            L1: {
              if (param4 >= 15) {
                ...
                var6 = null;
                int discarded$2 = ji.a(74, true, (String) null, (String) null, (byte) 108, true);
                break L1;
              }
            }
            if (!param3.c((byte) 125)) {
              ...
              stackOut_6_0 = param2 + " - " + param3.c(param1, 0) + "%";
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("ji.SA(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
        ...
        try {
            ...
            try {
              ...
              L32: {
                ...
                stackOut_107_1 = new StringBuilder().append("ji.TA(").append(param0).append(44).append(param1).append(44);
              ...
              throw fk.a((Throwable) (Object) stackIn_113_0, stackIn_113_2 + 44 + param4 + 44 + param5 + 41);
            }
    ...
    private ji(int param0, int param1, int param2, int param3, jm param4, rg param5, mf param6) {
        ...
        try {
            ...
            throw fk.a((Throwable) (Object) runtimeException, "ji.<init>(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + (param6 != null ? "{...}" : "null") + 41);
        }
    }
