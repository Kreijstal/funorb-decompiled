...
final class bk extends o {
    ...
    final static ln a(int param0, int param1) {
        ...
        if (param0 > -115) {
          L0: {
            var3 = (String) null;
            discarded$6 = bk.a((byte) -107, true, (String) null, (ol) null, (String) null, 55, (String) null);
            if (null == ae.field_f) {
              stackOut_7_0 = null;
    ...
    final static boolean a(byte param0, boolean param1, String param2, ol param3, String param4, int param5, String param6) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("bk.C(").append(param0).append(',').append(param1).append(',');
