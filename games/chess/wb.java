...
final class wb {
          ...
          if (var10 >= 0) {
            ...
            L5: while (true) {
              if (var14 >= 0) {
                ...
                var9++;
                field_d[incrementValue$1] = var13;
                var14++;
                continue L5;
              }
            }
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4) {
        wb.a(param0, param1, param2, param4);
        wb.a(param0, param1 + param3 - 1, param2, param4);
        wb.f(param0, param1, param3, param4);
        wb.f(param0 + param2 - 1, param1, param3, param4);
    }
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
                  ...
                  L4: {
                    ...
                    if (var6 < field_i) {
                      ...
                      if (var6 >= field_j) {
                        ...
                        field_d[var6 + param1 * field_h] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_a) {
                      ...
                      if (var6 >= field_b) {
                        ...
                        field_d[param0 + var6 * field_h] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                wb.f(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                wb.f(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              wb.a(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              wb.a(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
    ...
    final static void g(int param0, int param1, int param2, int param3) {
        ...
        int var4 = field_h - param2;
        int var5 = param0 + param1 * field_h;
        wb.a(var5, field_d, 0, param2, -param3, var4);
    }
    ...
    final static void a(int[] param0, int param1, int param2) {
        ...
        field_h = param1;
        field_c = param2;
        wb.b(0, 0, param1, param2);
    }

    final static void e(int param0, int param1, int param2, int param3, int param4, int param5) {
        wb.a(field_d, 0, 0 * field_h, param0, 0, param4, field_h - param4, param5);
        wb.a(field_d, 0, 0 * field_h, param1, 0, param5, field_h - param4, 0, param4);
    }
          ...
          if (param4 != 0) {
            ...
            L4: while (true) {
              if (var13 >= var9) {
                ...
                L7: {
                  var21 = var19 + var13 * field_h;
                  var22 = field_h + var19 - var20;
                  ...
                  if (var13 >= var23) {
                        ...
                        L10: while (true) {
                          ...
                          L14: while (true) {
                            if (var22 > var20) {
                              ...
                              var21++;
                              field_d[incrementValue$9] = param5 + var23;
                              var22++;
                              continue L14;
                            }
                          }
                    ...
                    L15: while (true) {
                      if (var24 >= var20) {
                        ...
                        var21++;
                        field_d[incrementValue$10] = param5 + var25;
                        var24++;
                        continue L15;
                      }
                    }
                      ...
                      if (var17 > var14) {
                        ...
                        L20: while (true) {
                          if (var22 >= var20) {
                            ...
                            var21++;
                            field_d[incrementValue$12] = param5 + var23;
                            var22++;
                            continue L20;
                          }
                        }
            ...
            wb.b(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          wb.h(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
    ...
    final static void g(int param0) {
        ...
        wb.a(param0 + 31, 147, 30, 3100495, 64);
    }
        ...
        if (param4 != 0) {
          ...
          L4: while (true) {
            if (var11 >= var7) {
              ...
              L7: {
                var19 = var17 + var11 * field_h;
                var20 = field_h + var17 - var18;
                ...
                if (var11 >= var21) {
                      ...
                      L10: while (true) {
                        ...
                        L14: while (true) {
                          if (var20 > var18) {
                            ...
                            var19++;
                            field_d[incrementValue$9] = param5;
                            var20++;
                            continue L14;
                          }
                        }
                  ...
                  L15: while (true) {
                    if (var22 >= var18) {
                      ...
                      var19++;
                      field_d[incrementValue$10] = param5;
                      var22++;
                      continue L15;
                    }
                  }
                    ...
                    if (var15 > var12) {
                      ...
                      L20: while (true) {
                        if (var20 >= var18) {
                          ...
                          var19++;
                          field_d[incrementValue$12] = param5;
                          var20++;
                          continue L20;
                        }
                      }
          ...
          wb.f(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
                  ...
                  L4: {
                    ...
                    if (var11 < field_i) {
                      ...
                      if (var11 >= field_j) {
                        ...
                        var12 = var11 + param1 * field_h;
                        var13 = (field_d[var12] >> 16 & 255) * var6;
                        var14 = (field_d[var12] >> 8 & 255) * var6;
                        var15 = (field_d[var12] & 255) * var6;
            ...
            L9: {
              if (param3 < 0) {
                wb.a(param0, param1 + param3, -param3 + 1, 16777215, param5);
                break L9;
              } else {
                wb.a(param0, param1, param3 + 1, 16777215, param5);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              wb.e(param0 + param2, param1, -param2 + 1, 16777215, param5);
              break L10;
            } else {
              wb.e(param0, param1, param2 + 1, 16777215, param5);
              break L10;
            }
          }
          return;
              ...
              if (var19 >= var12) {
                ...
                L6: while (true) {
                  if (var19 >= var9) {
                    ...
                    L18: {
                      var18++;
                      if (param5 + var19 + param3 >= field_j) {
                        break L18;
                      } else {
                        param1 = param0[var17];
                        var17++;
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        for (var6 = 0; var6 < 2; var6++) {
            wb.d(param0 + var6, 146 + var6, param2 - (var6 << 1), param3 - (var6 << 1), 1);
        }
    }

    final static void b() {
        int var0 = 0;
        int var1 = field_h * field_c - 7;
        while (var0 < var1) {
            int incrementValue$0 = var0;
            var0++;
            field_d[incrementValue$0] = 0;
            int incrementValue$1 = var0;
            var0++;
            field_d[incrementValue$1] = 0;
            int incrementValue$2 = var0;
            var0++;
            field_d[incrementValue$2] = 0;
            int incrementValue$3 = var0;
            var0++;
            field_d[incrementValue$3] = 0;
            int incrementValue$4 = var0;
            var0++;
            field_d[incrementValue$4] = 0;
            int incrementValue$5 = var0;
            var0++;
            field_d[incrementValue$5] = 0;
            int incrementValue$6 = var0;
            var0++;
            field_d[incrementValue$6] = 0;
            int incrementValue$7 = var0;
            var0++;
            field_d[incrementValue$7] = 0;
        }
        var1 += 7;
        while (var0 < var1) {
            int incrementValue$8 = var0;
            var0++;
            field_d[incrementValue$8] = 0;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param0 >= field_i) {
            ...
            for (var13 = 0; var13 < param2; var13++) {
                ...
                var10 = (field_d[var12] >> 8 & 255) * var5;
                var11 = (field_d[var12] & 255) * var5;
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        int var6 = 256 - param5;
        int var7 = field_h - param2;
        int var8 = param0 + param1 * field_h;
        for (var9 = 0; var9 < param3; var9++) {
            for (var10 = -param2; var10 < 0; var10++) {
                ...
                var8++;
                field_d[incrementValue$0] = param4 + var11;
            }
            var8 = var8 + var7;
        }
    }
          ...
          if (var13 > var15) {
            ...
            L5: while (true) {
              if (var18 >= param8) {
                ...
                L7: {
                  var19 = (0 - param3) * field_h;
                  if (var13 >= var18) {
                    break L7;
                  } else {
                    var19 = var19 + (var18 - var13) * field_h;
                    break L7;
                  }
                }
                L8: while (true) {
                  if (var13 >= var18) {
                    ...
                    L26: {
                      if (var13 + param5 + param3 >= field_b) {
                        var14 = var14 + field_h;
                        break L26;
                      } else {
                        var20 = 0;
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param1 >= field_a) {
            ...
            for (var13 = 0; var13 < param2; var13++) {
                ...
                var12++;
                field_d[incrementValue$0] = var14;
            }
            return;
        }
    }
    ...
    final static void c(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var6 = 0; var6 < 4; var6++) {
            var5 = 128 - (var6 << 5);
            wb.e(param0 + var6, param1 + param3 + var6, param2, param4, var5);
            wb.a(param0 + param2 + var6, param1 + var6, param3 + 1, param4, var5);
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
                    ...
                    if (param0 >= field_j) {
                      ...
                      if (param1 + param3 < field_a) {
                        ...
                        if (param1 < field_b) {
                          L3: {
                            L4: {
                              var10 = var6 + (var7 - param4) * field_h;
                              var11 = var8 + (var7 - param4) * field_h;
                              var12 = var6 + var7 * field_h;
                              var13 = var8 + var7 * field_h;
                              var14 = var6 + var9 * field_h;
                              var15 = var8 + var9 * field_h;
                              var16 = var6 + (var9 + param4) * field_h;
                              var17 = var8 + (var9 + param4) * field_h;
                              var18 = param4;
                              var19 = 0;
                              var20 = param4 * param4;
                              var21 = var20 - var18;
                            ...
                            wb.f(param0, param1 + var18, param3 - var18 - var18, param5);
                            wb.f(param0 + param2 - 1, param1 + var18, param3 - var18 - var18, param5);
                            wb.a(param0 + var18, param1, param2 - var18 - var18, param5);
                            wb.a(param0 + var18, param1 + param3 - 1, param2 - var18 - var18, param5);
                            L11: while (true) {
                              L12: {
          ...
          wb.d(param0, param1, param2, param3, param5);
          return;
        }
    }
          ...
          L0: {
            if (param1 < field_a) {
              ...
              if (param0 >= field_j) {
                ...
                if (param1 < field_b) {
                  field_d[param0 + param1 * field_h] = param2;
                  return;
                } else {
                  break L0;
                }
                  ...
                  L6: while (true) {
                    ...
                    L10: while (true) {
                      if (var15 > var13) {
                        ...
                        int incrementValue$8 = var14;
                        var14++;
                        field_d[incrementValue$8] = param3;
                        var15++;
                        continue L10;
                      }
                    }
                    ...
                    if (var10 > var7) {
                      ...
                      L15: while (true) {
                        if (var15 >= var13) {
                          ...
                          var14++;
                          field_d[incrementValue$10] = param3;
                          var15++;
                          continue L15;
                        }
                      }
    ...
    final static void d(int param0, int param1, int param2, int param3) {
        ...
        int var4 = param0 + param1 * field_h;
        if (param2 > 0) {
            if (param3 <= 0) {
                return;
            }
            for (var5 = 0; var5 < param3; var5++) {
                for (var6 = 0; var6 < param2; var6++) {
                    ...
                    var4++;
                    field_d[incrementValue$0] = (var11 << 16) + (var11 << 8) + var11;
                }
                var4 = var4 + (field_h - param2);
            }
            return;
        }
    }
