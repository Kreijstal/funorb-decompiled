...
final class sc {
        ...
        try {
          L0: {
            if (!param1.c((byte) 121)) {
              ...
              stackOut_6_0 = param0 + " - " + param1.c(0, -77) + "%";
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("sc.D(");
          ...
          throw fk.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + 44 + -47 + 41);
        }
        return stackIn_7_0;
    }
    ...
    final static void a() {
        ...
        try {
          L0: {
            var4 = (hh) (Object) eh.field_R.g(-18110);
            L1: while (true) {
              if (var4 == null) {
                break L0;
              } else {
          ...
          throw fk.a((Throwable) (Object) var2, "sc.C(" + -116 + 44 + 2 + 41);
        }
    }
