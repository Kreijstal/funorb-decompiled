    ...
    final static c a(int param0, um param1, int param2, int param3, um param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("ig.B(").append(param0).append(',');
          ...
          L2: {
            ...
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(',').append(-122).append(',').append(param3).append(',');
