    ...
    final static void a(int param0, int param1, ci param2, int param3, ci param4, int param5, boolean param6, int param7, ci param8, byte[] param9) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_15_1 = new StringBuilder().append("hg.C(").append(param0).append(',').append(param1).append(',');
          ...
          L7: {
            ...
            stackOut_21_1 = ((StringBuilder) (Object) stackIn_21_1).append(stackIn_21_2).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',');
