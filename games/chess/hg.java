    ...
    final static void a(int param0, int param1, ci param2, int param3, ci param4, int param5, boolean param6, int param7, ci param8, byte[] param9) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("hg.C(").append(param0).append(',').append(1024).append(',');
          ...
          L5: {
            ...
            stackOut_14_1 = ((StringBuilder) (Object) stackIn_14_1).append(stackIn_14_2).append(',').append(param5).append(',').append(true).append(',').append(150).append(',');
