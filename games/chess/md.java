...
class md {
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new nf();
                          var4 = var5;
                          stackIn_10_0 = (nf) (var4);

                          stackIn_10_1 = 256;

                          if (!field_q) {
                            stackIn_11_0 = (nf) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_s <= 0) {
                            ...
                            if (field_e != null) {
                              ...
                              param0.a(field_s, true, (Runnable) ((Object) field_e));
                              break L5;
                            }
                          }
                        }
                ...
                L0: {
                  ...
                  L2: while (true) {
                    if (var1 <= this.field_t + 5000L) {
                      ...
                      this.a(256);
                      this.field_t = this.field_t + (long)(256000 / field_l);
                      var1 = ud.a(2);
                      continue L2;
                    }
                  }
              ...
              if (this.field_j != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.f();
                      if (this.field_d - var3_int <= this.field_k) {
                        break L6;
                      } else {
                        this.field_k = this.field_d - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_g) {
                        ...
                        if (var4 + 256 <= this.field_g) {
                          ...
                          this.field_u = var4 - this.field_m;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_h) {
                            ...
                            L12: {
                              if (this.field_o) {
                                ...
                                this.field_u = Math.min(this.field_b, this.field_k);
        ...
        L1: {
          ...
          if (this.field_c == null) {
            ...
            if (this.field_p > 0) {
              ...
              this.field_p = this.field_p + (field_l >> 4);
              md.a(this.field_c);
                                ...
                                if (var4 < this.field_i) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_n[var7_int] = (nm) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((nm) (var7)).field_j;
                        ((nm) (var7)).field_j = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
    ...
    md() {
        ...
        this.field_t = ud.a(2);
        this.field_h = 0L;
        this.field_n = new nm[8];
        this.field_d = 0;
        this.field_b = 0;
        this.field_k = 0;
        this.field_p = 0;
        this.field_r = 0L;
        this.field_f = new nm[8];
        this.field_o = true;
    }
}
