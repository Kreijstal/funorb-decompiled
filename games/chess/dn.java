...
final class dn {
    ...
    final static di a(ci param0, int[] param1, ci param2, ci param3, int param4) {
        ...
        try {
          ...
          throw fk.a((Throwable) (Object) stackIn_22_0, stackIn_22_2 + ',' + 13911 + ')');
        }
        return stackIn_9_0;
    }
    ...
    final static pm a(int param0, int param1, byte param2, um param3, um param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("dn.E(").append(param0).append(',').append(param1).append(',').append(124).append(',');
