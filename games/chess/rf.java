        ...
        L0: while (true) {
          if (var2 >= h.field_n) {
            ...
            if (!in.field_c[var2]) {
              ...
              L2: while (true) {
                if (var3 <= var6) {
                  var1[var2] = new km(cd.field_p, ek.field_a, be.field_a[var2], a.field_c[var2], wm.field_b[var2], b.field_c[var2], var22);
                  var2++;
                  continue L0;
                } else {
                  var10[var6] = uh.field_r[ce.a((int) var21[var6], 255)];
                  var6++;
                  continue L2;
                }
              }
            } else {
              var15 = gg.field_y[var2];
              var11 = var15;
              var9 = var11;
              var5 = var9;
              var17 = new int[var3];
              ...
              L3: while (true) {
                if (var3 <= var7) {
                  var1[var2] = (km) ((Object) new wi(cd.field_p, ek.field_a, be.field_a[var2], a.field_c[var2], wm.field_b[var2], b.field_c[var2], var17));
                  var2++;
                  continue L0;
                } else {
                  var6_ref_int__[var7] = s.a(ce.a((int) var15[var7], 255) << 1779478680, uh.field_r[ce.a((int) var21[var7], 255)]);
                  var7++;
                  continue L3;
                }
              }
