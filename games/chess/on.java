...
final class on implements Runnable {
    ...
    private final void a(byte param0, tc param1) {
        ...
        synchronized (this.field_g) {
            if (param0 != -54) {
                gd var5 = (gd) null;
                discarded$0 = this.a((byte[]) null, -10, 42, (gd) null);
            }
    ...
    final static String a(int param0, String param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("on.F(").append(param0).append(',');
                ...
                if (decompiledRegionSelector0 == 0) {
                  ...
                  try {
                    L4: {
                      L5: {
                        if (2 == var7.field_B) {
                          discarded$1 = var7.field_x.a((int)var7.field_l, var7.field_v, (byte) 59, var7.field_v.length);
                          var7.field_s = false;
                          break L5;
                        } else {
                          if (-4 != (var7.field_B ^ -1)) {
