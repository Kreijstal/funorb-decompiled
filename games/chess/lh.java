...
abstract class lh extends l {
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        if (param0 != null) {
          ...
          L1: {
            ...
            if (param4 >= this.field_C + this.field_t + param10) {
              break L1;
            } else {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - this.field_C - this.field_t - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                ...
                var14 = param2 + this.field_C + (param4 - this.field_C - this.field_t - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.a(field_A[var15], param1 + param3 - this.b(field_A[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.a(field_A[var15], param1 + (param3 - this.b(field_A[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    final int b(String param0, int param1, int param2) {
        ...
        return this.field_C + var5 + this.field_t;
    }
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var10 = fn.a(var13, 0);
                                            var11_ref_hd = this.field_z[var10];
                                            if (this.field_J == null) {
                                              stackOut_25_0 = var11_ref_hd.field_i;
                                              stackIn_26_0 = stackOut_25_0;
                                              break L3;
                                            } else {
                                              stackOut_24_0 = this.field_J[var10];
                                          ...
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_x != 256) {
                                              var11_ref_hd.a(param1, param2 + this.field_q - var12, field_x);
                                              break L4;
                                            } else {
                                              var11_ref_hd.a(param1, param2 + this.field_q - var12);
                                              break L4;
                                            }
                                          }
              ...
              if (var4 == -1) {
                    ...
                    if (field_x != 256) {
                      L8: {
                        if (field_O == -1) {
                          ...
                          this.a(var8, param1 + this.field_E[var8] + 1, param2 + this.field_M[var8] + 1, var9, var10, field_O, field_x, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_E[var8], param2 + this.field_M[var8], var9, var10, field_r, field_x, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_O == -1) {
                          ...
                          this.a(var8, param1 + this.field_E[var8] + 1, param2 + this.field_M[var8] + 1, var9, var10, field_O, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_E[var8], param2 + this.field_M[var8], var9, var10, field_r, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  ...
                  if (field_B == -1) {
                    ...
                    wb.a(var11, param2 + (int)((double)this.field_q * 0.7), param1 - var11, field_B);
                    break L10;
                  }
                }
                L11: {
                  if (field_y == -1) {
                    ...
                    wb.a(var11, param2 + this.field_q + 1, param1 - var11, field_y);
                    break L11;
                  }
                }
                var5 = var8;
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        var17 = null;
        if (param0 != null) {
          discarded$5 = rb.a(' ', field_v, 0, (byte) -119);
          var4 = 0;
          var5 = 0;
          var6 = -1;
          var7 = 0;
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$6 = field_v.append('<');
                        discarded$7 = field_v.append(var15);
                        discarded$8 = field_v.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                                          ...
                                          if (!var15.startsWith("img=")) {
                                            ...
                                            try {
                                              L4: {
                                                ...
                                                var4 = var4 + this.field_z[var16_int].field_j;
                                                var10 = 0;
                                                break L4;
                                              }
                                            } catch (java.lang.Exception decompiledCaughtParameter0) {
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$9 = field_v.append((char) var14);
    ...
    final int a(char param0) {
        return this.field_I[ai.a((byte) -43, param0) & 255];
    }
                                      ...
                                      if (var8.startsWith("img=")) {
                                        try {
                                          L2: {
                                            ...
                                            var4 = var4 + this.field_z[var9_int].field_j;
                                            var3 = 0;
                                            var6++;
                                            break L2;
                                          }
    ...
    lh(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_C = this.field_q - var6;
            this.field_t = var7 - this.field_q;
            this.field_H = this.field_q - this.field_M[88];
            this.field_G = this.field_q - this.field_M[120];
            return;
          } else {
            L1: {
            ...
            if (this.field_M[var8] + this.field_F[var8] > var7) {
              var7 = this.field_M[var8] + this.field_F[var8];
              var8++;
              continue L0;
            } else {
              var8++;
                                      ...
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_u[(var7 << 8) + var8] = (byte)lh.a(var15, var16, var17, this.field_I, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
