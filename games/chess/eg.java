...
final class eg {
    ...
    final void a(int param0, int param1, byte[] param2, int param3) throws IOException {
        try {
            if (!(~((long)param3 + ((eg) this).field_a) >= ~((eg) this).field_b)) {
            ...
            throw fk.a((Throwable) (Object) runtimeException, "eg.E(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 41);
        }
    }
        ...
        try {
          L0: {
            L1: {
              ...
              var5_int = ((eg) this).field_c.read(param1, param0, param2);
              if (var5_int <= 0) {
                break L1;
              } else {
                ((eg) this).field_a = ((eg) this).field_a + (long)var5_int;
                break L1;
              }
            }
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("eg.F(").append(param0).append(44);
    ...
    final static void a(int[] param0, String[] param1, int param2, boolean param3, um param4, km[][] param5, String[][] param6, um param7, byte[] param8, int param9, um param10, String[][] param11, byte[] param12, int param13, km[][] param14) {
        ...
        try {
          ...
          throw fk.a((Throwable) (Object) stackIn_37_0, stackIn_37_2 + 41);
        }
    }
    ...
    eg(File param0, String param1, long param2) throws IOException {
        ...
        try {
            ...
            ((eg) this).field_a = 0L;
            var5_int = ((eg) this).field_c.read();
            if (-1 != var5_int) {
                if (!param1.equals((Object) (Object) "r")) {
                    ((eg) this).field_c.seek(0L);
                    ((eg) this).field_c.write(var5_int);
                }
            }
            ((eg) this).field_c.seek(0L);
        } catch (RuntimeException runtimeException) {
            throw fk.a((Throwable) (Object) runtimeException, "eg.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 41);
        }
    }
