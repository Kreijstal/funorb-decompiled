...
final class eg {
    ...
    final static void a(int param0, int param1, int param2, le param3, le param4) {
        ...
        try {
            ...
            throw fk.a((Throwable) (Object) runtimeException, "eg.H(" + 8 + ',' + 2 + ',' + 8 + ',' + (param3 != null ? "{...}" : "null") + ',' + (param4 != null ? "{...}" : "null") + ',' + 4 + ')');
        }
    }
    ...
    final int a(int param0, byte[] param1, int param2, byte param3) throws IOException {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("eg.F(").append(param0).append(',');
    ...
    final static void a(int[] param0, String[] param1, int param2, boolean param3, um param4, km[][] param5, String[][] param6, um param7, byte[] param8, int param9, um param10, String[][] param11, byte[] param12, int param13, km[][] param14) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = ((StringBuilder) (Object) stackIn_10_1).append(stackIn_10_2).append(',').append(param2).append(',').append(true).append(',');
          ...
          L12: {
            ...
            stackOut_34_1 = ((StringBuilder) (Object) stackIn_34_1).append(stackIn_34_2).append(',').append(param13).append(',');
