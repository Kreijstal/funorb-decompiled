...
final class na extends nm {
        ...
        if (param0 != 0) {
          if (this.field_z == 0) {
            if (this.field_u == 0) {
              ...
              this.field_x = -this.field_z / param0;
              this.field_y = -this.field_u / param0;
              return;
            }
          } else {
            L6: {
    ...
    final synchronized boolean h() {
        return this.field_r < 0 || this.field_r >= ((lm) ((Object) this.field_l)).field_m.length << 8;
    }
        ...
        L0: while (true) {
          if (this.field_B <= 0) {
            L1: {
              if (this.field_s != 256) {
                ...
                if ((this.field_r & 255) != 0) {
                  ...
                  if (md.field_q) {
                    return na.b(0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_z, this.field_u, 0, param3, param2, (na) (this));
                  } else {
                    return na.a(((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_p, 0, param3, param2, (na) (this));
                  }
                }
              }
            }
            if (md.field_q) {
              return na.d(0, 0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_z, this.field_u, 0, param3, param2, (na) (this), this.field_s, param4);
            } else {
              return na.b(0, 0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_p, 0, param3, param2, (na) (this), this.field_s, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_B;
              if (var6 <= param3) {
                break L2;
              } else {
                var6 = param3;
            ...
            L3: {
              L4: {
                ...
                if (this.field_s != 256) {
                  ...
                  if ((this.field_r & 255) != 0) {
                    ...
                    if (!md.field_q) {
                      param1 = na.a(((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_p, this.field_w, 0, var6, param2, (na) (this));
                      break L3;
                    } else {
                      param1 = na.b(0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_z, this.field_u, this.field_x, this.field_y, 0, var6, param2, (na) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!md.field_q) {
                param1 = na.c(0, 0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_p, this.field_w, 0, var6, param2, (na) (this), this.field_s, param4);
                break L3;
              } else {
                param1 = na.a(0, 0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_z, this.field_u, this.field_x, this.field_y, 0, var6, param2, (na) (this), this.field_s, param4);
                break L3;
              }
            }
            this.field_B = this.field_B - param1;
        ...
        L0: while (true) {
          if (this.field_B <= 0) {
            L1: {
              if (this.field_s != -256) {
                ...
                if ((this.field_r & 255) != 0) {
                  ...
                  if (md.field_q) {
                    return na.a(0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_z, this.field_u, 0, param3, param2, (na) (this));
                  } else {
                    return na.b(((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_p, 0, param3, param2, (na) (this));
                  }
                }
              }
            }
            if (md.field_q) {
              return na.b(0, 0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_z, this.field_u, 0, param3, param2, (na) (this), this.field_s, param4);
            } else {
              return na.a(0, 0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_p, 0, param3, param2, (na) (this), this.field_s, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_B;
            ...
            L3: {
              L4: {
                ...
                if (this.field_s != -256) {
                  ...
                  if ((this.field_r & 255) != 0) {
                    ...
                    if (!md.field_q) {
                      param1 = na.b(((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_p, this.field_w, 0, var6, param2, (na) (this));
                      break L3;
                    } else {
                      param1 = na.a(0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_z, this.field_u, this.field_x, this.field_y, 0, var6, param2, (na) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!md.field_q) {
                param1 = na.a(0, 0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_p, this.field_w, 0, var6, param2, (na) (this), this.field_s, param4);
                break L3;
              } else {
                param1 = na.b(0, 0, ((lm) ((Object) this.field_l)).field_m, param0, this.field_r, param1, this.field_z, this.field_u, this.field_x, this.field_y, 0, var6, param2, (na) (this), this.field_s, param4);
                break L3;
              }
            }
            this.field_B = this.field_B - param1;
    ...
    final synchronized int l() {
        return this.field_A < 0 ? -1 : this.field_A;
    }
    ...
    final synchronized void a(int param0) {
        ...
        L0: {
          if (this.field_B <= 0) {
            ...
            if (param0 < this.field_B) {
              ...
              this.field_z = this.field_z + this.field_x * param0;
              this.field_u = this.field_u + this.field_y * param0;
        ...
        this.field_r = this.field_r + this.field_s * param0;
        if (this.field_v >= 0) {
          L5: {
            if (this.field_v <= 0) {
              break L5;
                  ...
                  if (this.field_s >= 0) {
                    if (this.field_r >= var4) {
                      ...
                      if (var7 < this.field_v) {
                        ...
                        this.field_r = this.field_r - var6 * this.field_v;
                        this.field_v = 0;
                        break L5;
                      }
                    } else {
    ...
    private final void f() {
        ...
        this.field_z = na.a(this.field_o, this.field_A);
        this.field_u = na.c(this.field_o, this.field_A);
    }
          ...
          L4: {
            if (this.field_v <= 0) {
              ...
              if (!this.field_n) {
                if (this.field_s >= 0) {
                  L5: while (true) {
                    var9 = this.a(param0, var9, var6, param2, (int) var4.field_m[this.field_t]);
                    if (this.field_r >= var6) {
                      ...
                      if (var10 < this.field_v) {
                        ...
                        this.field_r = this.field_r - var8 * this.field_v;
                        this.field_v = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_m[this.field_q - 1]);
                    if (this.field_r < var5) {
                ...
                L7: {
                  if (this.field_s >= 0) {
                    ...
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_m[this.field_t]);
                    if (this.field_r < var5) {
                ...
                L8: while (true) {
                  var9 = this.a(param0, var9, var6, param2, (int) var4.field_m[this.field_q - 1]);
                  if (this.field_r >= var6) {
    ...
    private final boolean e() {
        ...
        L0: {
          var1 = this.field_o;
          if (var1 != -2147483648) {
            var2 = na.a(var1, this.field_A);
            var3 = na.c(var1, this.field_A);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_p >= var1) {
            if (this.field_p <= var1) {
              ...
              this.field_w = -1;
              this.field_B = this.field_p - var1;
              break L2;
            }
          } else {
            this.field_w = 1;
            this.field_B = var1 - this.field_p;
            break L2;
          }
        }
        L3: {
          if (this.field_z >= var2) {
            if (this.field_z <= var2) {
              ...
              L4: {
                ...
                if (this.field_B == 0) {
                  ...
                  if (this.field_B <= this.field_z - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_B = this.field_z - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_B == 0) {
                ...
                if (this.field_B <= var2 - this.field_z) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_B = var2 - this.field_z;
            break L3;
          }
        }
        if (this.field_u < var3) {
          this.field_y = 1;
          if (this.field_B != 0) {
            if (this.field_B > var3 - this.field_u) {
              this.field_B = var3 - this.field_u;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_u <= var3) {
              ...
              L7: {
                ...
                if (this.field_B == 0) {
                  ...
                  if (this.field_B <= this.field_u - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_B = this.field_u - var3;
              break L6;
            }
          }
          return false;
    ...
    final synchronized void e(int param0) {
        int var2 = ((lm) ((Object) this.field_l)).field_m.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
    ...
    final int c() {
        ...
        if (this.field_v == 0) {
            var1 = var1 - var1 * this.field_r / (((lm) ((Object) this.field_l)).field_m.length << 8);
        } else {
            if (this.field_v >= 0) {
                var1 = var1 - var1 * this.field_t / ((lm) ((Object) this.field_l)).field_m.length;
            }
        }
    ...
    final int d() {
        if (this.field_o == 0 && this.field_B == 0) {
            return 0;
        }
        return 1;
    }
        ...
        if (param0 != 0) {
          ...
          if (this.field_z == var4) {
            if (this.field_u == var5) {
              ...
              L2: {
                if (this.field_z - var4 <= var6) {
                  break L2;
                } else {
                  var6 = this.field_z - var4;
                  break L2;
                }
              }
              L3: {
              ...
              this.field_x = (var4 - this.field_z) / param0;
              this.field_y = (var5 - this.field_u) / param0;
              return;
            }
          } else {
            L6: {
    ...
    private na(lm param0, int param1, int param2) {
        this.field_l = (pb) ((Object) param0);
        this.field_t = param0.field_k;
        this.field_q = param0.field_l;
        this.field_n = param0.field_o;
        this.field_s = param1;
        this.field_o = param2;
        this.field_A = 8192;
        this.field_r = 0;
