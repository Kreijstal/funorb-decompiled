...
final class di extends ci {
    ...
    final static void f() {
        ...
        try {
          ...
          throw fk.a((Throwable) (Object) var1, "di.F(" + 118 + 41);
        }
    }
    ...
    di(long param0, ci param1, ci param2, ci param3, di[] param4, int[] param5, String[] param6, char[] param7) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_13_1 = new StringBuilder().append("di.<init>(").append(param0).append(44);
    ...
    final static void k() {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var1 = decompiledCaughtException;
          throw fk.a((Throwable) (Object) var1, "di.I(" + 9 + 41);
        }
    }
