            ...
            L1: while (true) {
              if (var8 >= this.field_Kb.length) {
                ...
                if (var8 != this.field_Hb) {
                  this.field_Kb[var8].field_mb = this.field_Kb[var8].field_mb + 10000;
                  var8++;
                  continue L1;
                } else {
                  var8++;
          ...
          if (this.field_Eb.length <= var2) {
            ...
            if (this.field_Hb != var2) {
              if (this.field_Eb[var2].field_L != 0) {
                ...
                this.field_Kb[this.field_Hb].field_mb = this.field_Kb[this.field_Hb].field_mb + 10000;
                this.field_Hb = var2;
                this.field_Eb[var2].field_gb = true;
                this.field_Kb[var2].field_mb = this.field_Kb[var2].field_mb - 10000;
                var2++;
                continue L0;
              } else {
                var2++;
    ...
    final static void a(byte param0, ld param1) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_19_1 = new StringBuilder().append("d.F(").append(param0).append(',');
            stackIn_21_0 = stackOut_19_0;
            stackIn_21_1 = stackOut_19_1;
