...
final class wj implements jm {
    ...
    public final void a(byte param0, int param1, int param2, boolean param3, mf param4) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_20_1 = new StringBuilder().append("wj.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
    ...
    wj(lh param0, int param1, int param2) {
        try {
            ...
            throw fk.a((Throwable) (Object) runtimeException, "wj.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 41);
        }
    }
