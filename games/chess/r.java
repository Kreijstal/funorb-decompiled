    ...
    final static void a(int param0, byte param1, int param2, le param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("r.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final static boolean a(boolean param0, nk param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("r.D(").append(param0).append(44);
