        ...
        try {
          L0: {
            if (param2 == -1) {
              ...
              L3: {
                var5 = new e((vn) (this), tk.field_a, var4);
                if (!param1.field_h) {
                  L4: {
                    if (!this.field_Jb) {
                      if (5 != param1.field_g) {
                      ...
                      var5.a((byte) -114, (rg) (this), sg.field_e);
                      break L4;
                    }
                  }
                  if (param1.field_g != 3) {
                  ...
                  if (param1.field_f) {
                    this.c(new ba((vd) (this)), param2 ^ -101);
          ...
          L5: {
            ...
            stackIn_34_1 = new StringBuilder().append("vd.M(").append(param0).append(',');
          ...
          throw fk.a((Throwable) ((Object) stackIn_35_0), stackIn_35_2 + ',' + param2 + ')');
        }
