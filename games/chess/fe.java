...
final class fe {
    ...
    final lm a(int param0, int[] param1, byte param2) {
        ...
        try {
          L0: {
            ...
            if ((this.field_f.a(false) ^ -1) != -2) {
              if (-2 != (this.field_f.a((byte) -107, param0) ^ -1)) {
    ...
    private final lm a(String param0, int param1, String param2, int[] param3) {
        ...
        try {
          L0: {
            var5_int = this.field_f.a(param0, 0);
            if (0 <= var5_int) {
              if (param1 == 1) {
                var6 = this.field_f.a(param2, 7, var5_int);
                if (-1 >= (var6 ^ -1)) {
                  stackOut_9_0 = this.a(param3, (byte) 12, var6, var5_int);
                  stackIn_10_0 = stackOut_9_0;
          ...
          L1: {
            ...
            stackOut_11_1 = new StringBuilder().append("fe.G(");
    ...
    private final lm a(int[] param0, byte param1, int param2, int param3) {
        ...
        try {
          L0: {
            var5_int = param2 ^ ((536875007 & param3) << 2048493348 | param3 >>> 533276620);
            var5_int = var5_int | param3 << 1367696464;
            var6 = (long)var5_int ^ 4294967296L;
            var8 = (lm) ((Object) this.field_c.a(41, var6));
            if (var8 == null) {
              L1: {
                if (param0 == null) {
                  break L1;
              ...
              L3: {
                var9 = (hi) ((Object) this.field_b.a(-115, var6));
                if (var9 == null) {
                  var9 = hi.a(this.field_f, param3, param2);
                  if (var9 != null) {
                    this.field_b.a(param1 ^ -97, var6, var9);
                    break L3;
                  } else {
                    stackOut_12_0 = null;
              ...
              if (var8 != null) {
                var9.c(param1 + -2205);
                this.field_c.a(param1 ^ -111, var6, var8);
                stackOut_18_0 = (lm) (var8);
          ...
          L4: {
            ...
            stackOut_20_1 = new StringBuilder().append("fe.L(");
    ...
    private final lm a(int[] param0, String param1, int param2, String param3) {
        ...
        try {
          L0: {
            var5_int = this.field_a.a(param1, 0);
            if (-1 >= (var5_int ^ -1)) {
              L1: {
                if (param2 == 21887) {
                  break L1;
              ...
              var6 = this.field_a.a(param3, 7, var5_int);
              if ((var6 ^ -1) <= -1) {
                stackOut_8_0 = this.a(true, var6, var5_int, param0);
                stackIn_9_0 = stackOut_8_0;
                decompiledRegionSelector0 = 2;
                break L0;
              } else {
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("fe.D(");
    ...
    private final lm a(boolean param0, int param1, int param2, int[] param3) {
        ...
        try {
          L0: {
            L1: {
              var5_int = param1 ^ (param2 >>> 32083660 | param2 << 122872548 & 65524);
              var5_int = var5_int | param2 << 968449200;
              var6 = (long)var5_int;
              var8 = (lm) ((Object) this.field_c.a(92, var6));
              if (param0) {
                break L1;
              } else {
                discarded$2 = fe.a(8, 56, 11);
                break L1;
              }
            }
            if (var8 == null) {
              ...
              var9 = ck.a(this.field_a, param2, param1);
              if (var9 != null) {
                L3: {
                  var10 = var9.a();
                  var8 = var10;
                  this.field_c.a(29, var6, var8);
                  if (param3 == null) {
                    break L3;
                  } else {
          ...
          L4: {
            ...
            stackOut_16_1 = new StringBuilder().append("fe.J(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_18_0 = stackOut_16_0;
            stackIn_18_1 = stackOut_16_1;
            stackIn_17_0 = stackOut_16_0;
            stackIn_17_1 = stackOut_16_1;
        ...
        try {
          L0: {
            if (this.field_a.a(false) != 1) {
              ...
              if (1 != this.field_a.a((byte) -84, param1)) {
                throw new RuntimeException();
              } else {
    ...
    fe(um param0, um param1) {
        this.field_b = new kl(256);
        this.field_c = new kl(256);
        try {
            this.field_a = param0;
            this.field_f = param1;
