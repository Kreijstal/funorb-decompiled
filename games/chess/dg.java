...
final class dg {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_h, 0, field_f, 0, var2);
        int var3 = field_j[this.field_c - 1];
        ...
        for (var6 = 0; var6 < this.field_b.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = hi.field_C[this.field_i[var7]].a();
            }
                    ...
                    if (var6 >= var2) {
                      ...
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= this.field_g[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              incrementValue$2 = var5;
                              var5++;
                              this.field_h[incrementValue$2] = hi.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_g[this.field_b[var6]];
                      var6++;
                      continue L2;
                    }
                  }
