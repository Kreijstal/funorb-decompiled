...
final class dg {
    ...
    final boolean b() {
        ...
        int var2 = ((dg) this).field_h.length;
        System.arraycopy((Object) (Object) ((dg) this).field_h, 0, (Object) (Object) field_f, 0, var2);
        int var3 = field_j[((dg) this).field_c - 1];
        int var4 = ql.a(-123, var3 - 1);
        field_l[0] = hi.d(var4);
        field_l[1] = hi.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((dg) this).field_b.length; var6++) {
            var7 = ((dg) this).field_b[var6];
            var8 = ((dg) this).field_g[var7];
            var9 = ((dg) this).field_a[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = hi.field_C[((dg) this).field_i[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((dg) this).field_k[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_l[incrementValue$0] = var13 >= 0 ? hi.field_C[var13].a() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((dg) this).field_h.length;
        var4 = field_j[((dg) this).field_c - 1];
        var5 = field_d;
        field_d[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_l[0] * ((dg) this).field_c;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_d[var16]) {
                  var9 = field_f[var16];
                  var10 = field_l[var16] * ((dg) this).field_c;
            ...
            L3: {
              var7 = dg.a(field_f, var6);
              var8_int = dg.b(field_f, var6);
              var9 = this.a(field_f[var7], field_l[var7], field_f[var8_int], field_l[var8_int], field_f[var6]);
              var10 = field_l[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    dg() {
        ...
        if (var1 == 1) {
          var2 = hi.d(5);
          var3 = 0;
          ((dg) this).field_b = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((dg) this).field_g = new int[var3];
              ((dg) this).field_a = new int[var3];
              ((dg) this).field_i = new int[var3];
              ((dg) this).field_k = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((dg) this).field_c = hi.d(2) + 1;
                  var4 = hi.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((dg) this).field_h = new int[var5];
                      ((dg) this).field_h[0] = 0;
                      ((dg) this).field_h[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((dg) this).field_g[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((dg) this).field_h[incrementValue$2] = hi.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((dg) this).field_g[((dg) this).field_b[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((dg) this).field_g[var4] = hi.d(3) + 1;
                    int dupTemp$3 = hi.d(2);
                    ((dg) this).field_a[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((dg) this).field_i[var4] = hi.d(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
