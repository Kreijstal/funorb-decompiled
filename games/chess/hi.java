...
final class hi extends o {
    ...
    private static oi[] field_I;
    private int field_y;
    private int field_t;
    private static pn[] field_p;
    private static dg[] field_n;
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        byte[] var6 = null;
        p var2 = new p(param0);
        ((hi) this).field_P = var2.e((byte) -120);
        ((hi) this).field_o = var2.e((byte) -110);
        ((hi) this).field_q = var2.e((byte) -103);
        ((hi) this).field_G = var2.e((byte) -117);
        if (((hi) this).field_G < 0) {
            ((hi) this).field_G = ((hi) this).field_G ^ -1;
            ((hi) this).field_N = true;
        }
        int var3 = var2.e((byte) -121);
        if (var3 < 0) {
            throw new IOException();
        }
        ((hi) this).field_s = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            ...
            var6 = new byte[var5];
            var2.a(var5, (byte) 121, var6, 0);
            ((hi) this).field_s[var4] = var6;
        }
    }

    final static int b() {
        int var0 = field_L[field_Q] >> field_F & 1;
        field_F = field_F + 1;
        field_Q = field_Q + (field_F >> 3);
        field_F = field_F & 7;
        return var0;
    }
    ...
    private final static boolean a(um param0) {
        byte[] var1 = null;
        if (!field_K) {
            var1 = param0.a(0, 0, 5847);
            if (var1 == null) {
                return false;
            }
            hi.b(var1);
    ...
    final static int d(int param0) {
        ...
        while (param0 >= 8 - field_F) {
            var3 = 8 - field_F;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_L[field_Q] >> field_F & var4) << var2);
            field_F = 0;
            field_Q = field_Q + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_L[field_Q] >> field_F & var3) << var2);
    ...
    final lm a(int[] param0) {
        ...
        L1: {
          if (((hi) this).field_j != null) {
            break L1;
          } else {
            ((hi) this).field_v = 0;
            ((hi) this).field_l = new float[field_z];
            ((hi) this).field_j = new byte[((hi) this).field_o];
            ((hi) this).field_y = 0;
            ((hi) this).field_t = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((hi) this).field_t >= ((hi) this).field_s.length) {
            ((hi) this).field_l = null;
            var14 = ((hi) this).field_j;
            ((hi) this).field_j = null;
            return new lm(((hi) this).field_P, var14, ((hi) this).field_q, ((hi) this).field_G, ((hi) this).field_N);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((hi) this).field_y;
                  var4 = var13.length;
                  if (var4 <= ((hi) this).field_o - var3) {
                    break L5;
                  } else {
                    var4 = ((hi) this).field_o - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((hi) this).field_y);
                        break L7;
                      }
                    }
                    ((hi) this).field_y = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((hi) this).field_t = ((hi) this).field_t + 1;
            continue L2;
          }
        }
    }
    ...
    private final float[] e(int param0) {
        ...
        L0: {
          hi.a(((hi) this).field_s[param0], 0);
          int discarded$1 = hi.b();
          var2 = hi.d(ql.a(-122, field_J.length - 1));
          var3 = field_x[var2] ? 1 : 0;
          if (var3 == 0) {
          ...
          L5: {
            ...
            if (var3 == 0) {
              ...
              if (var5 != 0) {
                ...
                var8 = (var4 >> 2) - (field_A >> 2);
                var9 = (var4 >> 2) + (field_A >> 2);
                var10 = field_A >> 1;
                break L4;
              }
            }
          ...
          L7: {
            if (var3 == 0) {
              ...
              if (var6 != 0) {
                ...
                var11 = var4 - (var4 >> 2) - (field_A >> 2);
                var12 = var4 - (var4 >> 2) + (field_A >> 2);
                var13 = field_A >> 1;
                break L6;
              }
            }
          ...
          if (var17_int >= var14.field_c) {
            L10: {
              if (var15 != 0) {
                ...
                field_n[var18_int].a(field_O, var4 >> 1);
                break L10;
              }
            }
            L11: {
                                                                          ...
                                                                          if (var26 >= var9) {
                                                                            ...
                                                                            L31: while (true) {
                                                                              if (var26 >= var12) {
                                                                                ...
                                                                                field_O[var26] = field_O[var26] * (float)Math.sin(1.5707963267948966 * (double)var27 * (double)var27);
                                                                                var26++;
                                                                                continue L31;
                                                                              }
                                                                            }
            ...
            L35: {
              var17 = null;
              if (((hi) this).field_v <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((hi) this).field_v + var4 >> 2;
                  ...
                  if (((hi) this).field_M) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((hi) this).field_u) {
                        break L36;
                      } else {
                        var20 = (((hi) this).field_v >> 1) + var19;
                        var40[var19] = var40[var19] + ((hi) this).field_l[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((hi) this).field_l;
              ((hi) this).field_l = field_O;
              field_O = var18;
              ((hi) this).field_v = var4;
              ((hi) this).field_u = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    final lm a() {
        ...
        ((hi) this).field_v = 0;
        ((hi) this).field_l = new float[field_z];
        var1 = new byte[((hi) this).field_o];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((hi) this).field_s.length) {
            ((hi) this).field_l = null;
            return new lm(((hi) this).field_P, var1, ((hi) this).field_q, ((hi) this).field_G, ((hi) this).field_N);
          } else {
            var4 = this.e(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((hi) this).field_o - var2) {
                  break L1;
                } else {
                  var5 = ((hi) this).field_o - var2;
                  break L1;
                }
              }
              var6 = 0;
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = hi.d(16);
                                    int discarded$4 = hi.d(16);
                                    field_J[var6] = hi.d(8);
                                    var6++;
                                    continue L6;
                                  }
    ...
    private hi(byte[] param0) throws IOException {
        this.a(param0);
    }
