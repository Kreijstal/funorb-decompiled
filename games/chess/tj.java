...
final class tj extends vm {
    ...
    final static void b(byte param0) {
        ...
        ql.field_d.a((byte) 124, wf.field_W.field_a);
    ...
    final static boolean a(int param0, int param1, um param2, byte param3) {
        ...
        try {
          ...
          throw fk.a((Throwable) ((Object) stackIn_11_0), stackIn_11_2 + ',' + param3 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
    ...
    final static boolean a(byte param0, int[] param1) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 11: {
                    try {
                        if ((var4_ref_tf.field_m ^ -1L) <= (var2_long ^ -1L)) {
                            statePc = 18;
                        } else {
                            statePc = 12;
                        }
