    ...
    final static void a(int param0, int param1, int param2, sc param3, boolean param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_3_1 = new StringBuilder().append("wl.D(").append(1048576).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw kg.a((Throwable) (Object) stackIn_6_0, stackIn_6_2 + ',' + true + ')');
        }
    }
