 ...
 */
final class jn implements lf {
    private com.ms.directX.DSCursors[] field_a;
    private com.ms.directX.DSBufferDesc[] field_b;

    public jn() throws Exception {
        int var1 = 0;
        ((jn) this).field_a = new com.ms.directX.DSCursors[2];
        ((jn) this).field_b = new com.ms.directX.DSBufferDesc[2];
        ...
        for (var1 = 0; 2 > var1; var1++) {
            ((jn) this).field_b[var1] = new com.ms.directX.DSBufferDesc();
        }
        for (var1 = 0; 2 > var1; var1++) {
            ((jn) this).field_a[var1] = new com.ms.directX.DSCursors();
        }
    }
}
