...
final class bg extends km {
    ...
    private final int a(km param0, km param1, int param2, int param3, int param4) {
        param3 += 8;
        int var6 = param1.field_C.a(param1.field_V, -(2 * param1.field_z) + param4, param1.field_fb);
        param1.a(0, var6, param4, (byte) -66, param3);
    ...
    bg(int param0, int param1, int param2, int param3, int param4, km param5, km param6, km param7, km param8, en param9, km param10, String param11, long param12) {
        ...
        en stackOut_3_1 = null;
        en stackOut_3_2 = null;
        long stackOut_3_3 = 0L;
        en stackOut_3_4 = null;
        ...
        L0: {
          ...
          if (param11 == null) {
            ...
            var15 = 226;
            var16 = 10;
            var17 = ((bg) this).field_Fb.field_C.b(((bg) this).field_Fb.field_V, var15);
            ((bg) this).field_Fb.a(13, pg.field_e * var17, var15, (byte) -78, var16);
            var16 = var16 + var17 * pg.field_e;
            ((bg) this).field_Gb.a(0, var16 + 10, 13 + (13 - -var15), (byte) -45, 24);
              ...
              L3: {
                L4: {
                  ...
                  if (-8 >= (og.field_s ^ -1)) {
                    ...
                    stackOut_4_4 = (en) (Object) stackIn_4_4;
              ...
              if (var3 >= ad.field_c) {
                ...
                if (null != ((bg) this).field_Hb[var3]) {
                  ...
                  if (((bg) this).field_Hb[var3].field_Y) {
                    if (-1 != (((bg) this).field_Hb[var3].field_nb ^ -1)) {
                      return var3;
                    } else {
                      var3++;
                      continue L3;
    ...
    private final int a(int param0, int param1, km param2, int param3, String param4, km param5) {
        km var7 = new km(0L, param5, 0, param0, param3, 24, param4);
        param0 += 32;
        if (param1 >= -10) {
            Object var8 = null;
            int discarded$0 = this.a((km) null, (km) null, -49, 28, 48);
        }
        param2.a(0, var7);
        return param0;
    }
