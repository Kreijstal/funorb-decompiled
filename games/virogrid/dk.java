...
abstract class dk {
              ...
              try {
                L0: {
                  if (param0 == 108) {
                    ...
                    if (ij.field_q == 4) {
                      ji.field_e.a(param0 ^ -17, fb.field_i, ng.field_N);
                      ng.field_N = null;
                      vm.field_b = null;
                      ij.field_q = 0;
                      stackOut_32_0 = 0;
    ...
    final ub a(byte param0, int param1, boolean param2, int param3, int param4) {
        ...
        if (param2) {
            if (this.a((byte) -85) >= 20) {
                throw new RuntimeException();
            }
            this.field_i.a(var8, (byte) 96);
        } else {
            if (-21 < (this.e(114) ^ -1)) {
                this.field_p.a(var8, (byte) 112);
                return var8;
            }
            throw new RuntimeException();
        }
    ...
    final int a(byte param0) {
        ...
        return this.field_i.b(0) + this.field_c.b(0);
    }
    ...
    dk() {
        ...
        this.field_p = new qk();
        this.field_h = new qk();
        this.field_t = new jc(6);
        this.field_l = 0;
        this.field_b = 0;
        this.field_g = (byte) 0;
        this.field_n = new jc(10);
    }
