...
final class hi {
    ...
    final int c() {
        ...
        while (this.field_c[var1] >= 0) {
            var1 = gj.b() != 0 ? this.field_c[var1] : var1 + 1;
        }
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_d) {
                ...
                var4_int = gj.a(pn.a(this.field_d - var2, (byte) -94));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_d * this.field_b;
                break L9;
              } else {
                var7 = hi.a(this.field_d, this.field_b);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_e = new float[this.field_d][this.field_b];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
