        ...
        try {
          L0: {
            ...
            if (ee.a(88, var5)) {
              ...
              L4: {
                if (this.field_p) {
                  stackIn_15_0 = bm.field_i;
                  break L4;
                } else {
                  stackIn_15_0 = ee.field_c;
                  break L4;
                }
              }
          ...
          L5: {
            ...
            stackIn_18_1 = new StringBuilder().append("di.E(");
        ...
        try {
          L0: {
            ...
            if (var3 == null) {
              ...
              if (this.field_p) {
                stackIn_16_0 = sh.field_sb;
                decompiledRegionSelector0 = 2;
                break L0;
              } else {
                stackIn_14_0 = dm.field_t;
                decompiledRegionSelector0 = 1;
                break L0;
              }
            } else {
