...
final class vc extends dc {
    ...
    final void a(float param0, boolean param1, boolean param2, String param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("vc.T(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    vc(je param0, String param1) {
        ...
        try {
            ...
            throw kg.a((Throwable) (Object) runtimeException, "vc.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
