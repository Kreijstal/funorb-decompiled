    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6, int param7, mg[] param8, byte param9, mg[] param10, boolean param11, int param12, String param13, e param14) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("hk.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',');
