...
final class ha {
    ...
    final oa a(int param0, int param1, boolean param2, gl param3, gl param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_12_1 = new StringBuilder().append("ha.H(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static void a(int param0, da param1) {
        ...
        try {
            ...
            throw kg.a((Throwable) (Object) runtimeException, "ha.F(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + -38 + ')');
        }
    }
