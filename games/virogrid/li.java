...
final class li {
          ...
          if (this.field_s) {
            ...
            L2: {
              if (fl.field_i >= this.field_l) {
                ...
                fi.field_s = (this.field_l + -fl.field_i) / 2;
                break L2;
              }
            }
            L3: {
              L4: {
                if (fl.field_i != this.field_h) {
                  break L4;
                } else {
                  if (this.field_r == km.field_B) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_n.a(this.field_r, this.field_h, (byte) 125);
              break L3;
            }
            return;
          }
    ...
    final h a(int param0) {
        this.field_g = fl.field_i;
        this.field_v = km.field_B;
        this.field_n.a(this.field_p, this.field_e, (byte) 106);
        km.field_Db = false;
        if (param0 != 11) {
            li.a(true);
        }
        h var2 = wm.a(this.field_e, 0, this.field_p, 0, 5416, ei.field_c);
        if (!(var2 != null)) {
            this.a((byte) -122);
        }
        return var2;
    ...
    final static void a(boolean param0) {
        int stackIn_44_0 = 0;
        ic stackIn_62_0 = null;
        ic stackIn_66_0 = null;
        ic stackIn_67_0 = null;
        int stackIn_67_1 = 0;
        double stackIn_69_2 = 0.0;
        double stackIn_70_2;
        int stackIn_70_3;
        int var1;
        double var2_double;
            ...
            if (gb.g(true)) {
              ...
              if (ug.a(true)) {
                ...
                if (!eg.a((byte) 47)) {
                  ...
                  L12: {
                    if (vg.field_I == null) {
                      stackIn_62_0 = ei.field_b;
                      break L12;
                    } else {
                      stackIn_62_0 = vg.field_I;
                      break L12;
                    }
                  }
                  L13: {
                    ...
                    if (var2 != null) {
                      L14: {
                        stackIn_66_0 = (ic) (var2);

                        if (-1 != i.field_y) {
                          stackIn_67_0 = (ic) ((Object) stackIn_66_0);
                          stackIn_67_1 = 0;
                          break L14;
                        } else {
                          stackIn_67_0 = (ic) ((Object) stackIn_66_0);
                      ...
                      L15: {
                        ...
                        stackIn_69_2 = fa.field_k;

                        if (nk.field_K[11] >= 0.0) {
                          stackIn_67_0 = (ic) ((Object) stackIn_67_0);
                      ...
                      ((ic) (Object) stackIn_67_0).a(stackIn_67_1 != 0, stackIn_70_2, stackIn_70_3 != 0, j.field_e, sf.field_M, oi.field_g, var1 != 0, (byte) -64);
                      break L13;
                    } else {
                      break L13;
                    }
                                ...
                                if (var4 >= 530.0) {
                                  ...
                                  if (var6 <= 0.0) {
                                    ...
                                    if (var6 >= 400.0) {
                                      ...
                                      gd.field_n.a(new pm((int)(16.0 * var4), (int)(var6 * 16.0), Math.min(ke.field_p.field_c, ke.field_p.field_i * var3 + ke.field_p.field_a)), (byte) -38);
                                      break L17;
                                    }
                                  }
                                }
    ...
    final static void a(int param0, int param1, int param2, int[] param3, int param4, int param5, int param6, int param7, byte param8) {
        ...
        try {
                ...
                if (param0 < fk.field_n) {
                      ...
                      L8: {
                        ...
                        L10: while (true) {
                          if (param0 >= param2) {
                            ...
                            L11: {
                              var18 = var9_int >> -979917392;
                              if (fk.field_o <= var18) {
                                break L11;
                              } else {
                                var19 = -(var9_int >> 1430654672) + (var11 >> -1306193552);
                                if (-1 != (var19 ^ -1)) {
                                  L12: {
                  ...
                  L15: while (true) {
                    if (param0 >= param4) {
                      ...
                      L16: {
                        var17 = var9_int >> 1849106416;
                        if (var17 < fk.field_o) {
                          var18 = (var11 >> -410494352) + -(var9_int >> -1012959216);
                          if (var18 != 0) {
                            L17: {
          ...
          L18: {
            ...
            stackIn_76_1 = new StringBuilder().append("li.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
        ...
        if (!this.c(-1558)) {
          ...
          L2: {
            if (0.0f < this.field_c) {
              var4 = (int)(0.5f + this.field_c * (float)var3);
              if (var4 > var2) {
          ...
          L3: {
            ...
            this.field_n.a(var3, var2, (byte) 40);
            break L3;
          }
          L5: {
            if (param0 == 22) {
    ...
    final void a(byte param0) {
        this.field_n.a(this.field_v, this.field_g, (byte) 47);
        if (param0 != -122) {
            int[] var3 = (int[]) null;
