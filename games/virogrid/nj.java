...
final class nj {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((nj) this).field_c.length;
        var4 = field_a[((nj) this).field_e - 1];
        var5 = field_f;
        field_f[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_l[0] * ((nj) this).field_e;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_b[var16];
                  var10 = field_l[var16] * ((nj) this).field_e;
            ...
            L3: {
              var7 = nj.a(field_b, var6);
              var8_int = nj.b(field_b, var6);
    ...
    final boolean a() {
        ...
        int var2 = ((nj) this).field_c.length;
        System.arraycopy((Object) (Object) ((nj) this).field_c, 0, (Object) (Object) field_b, 0, var2);
        int var3 = field_a[((nj) this).field_e - 1];
        int var4 = pn.a(var3 - 1, (byte) -43);
        field_l[0] = gj.a(var4);
        field_l[1] = gj.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((nj) this).field_i.length; var6++) {
            var7 = ((nj) this).field_i[var6];
            var8 = ((nj) this).field_d[var7];
            var9 = ((nj) this).field_g[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = gj.field_g[((nj) this).field_h[var7]].c();
            }
    ...
    nj() {
        ...
        if (var1 == 1) {
          var2 = gj.a(5);
          var3 = 0;
          ((nj) this).field_i = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((nj) this).field_d = new int[var3];
              ((nj) this).field_g = new int[var3];
              ((nj) this).field_h = new int[var3];
              ((nj) this).field_j = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((nj) this).field_e = gj.a(2) + 1;
                  var4 = gj.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((nj) this).field_c = new int[var5];
                      ((nj) this).field_c[0] = 0;
                      ((nj) this).field_c[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((nj) this).field_d[((nj) this).field_i[var6]];
                      var6++;
                      continue L2;
                    }
                  }
