...
final class nj {
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_c, 0, field_b, 0, var2);
        int var3 = field_a[this.field_e - 1];
        ...
        for (var6 = 0; var6 < this.field_i.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = gj.field_g[this.field_h[var7]].c();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_d[var7]) {
                              ...
                              var5++;
                              this.field_c[incrementValue$2] = gj.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_d[this.field_i[var6]];
                      var6++;
                      continue L2;
                    }
                  }
