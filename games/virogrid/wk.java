...
final class wk extends fd implements fc, ta {
        ...
        try {
          L0: {
            if (super.a(param0, param1, param2, 127)) {
              ...
              if (param2 == 98) {
                stackOut_6_0 = ((wk) this).b(2, param0);
                ...
                if (param2 != 99) {
                  ...
                  stackOut_9_0 = ((wk) this).a(-16234, param0);
          ...
          L1: {
            ...
            stackOut_13_1 = new StringBuilder().append("wk.AA(");
    ...
    private final int a(int param0, String param1, String param2, boolean param3, int param4, fi param5) {
        ...
        try {
          L0: {
            stackOut_0_0 = this.a(param2, param0, param1, -7815, param5, param4, 35);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("wk.B(").append(param0).append(44);
          ...
          L3: {
            ...
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(44).append(1).append(44).append(param4).append(44);
    ...
    private final boolean a(byte param0, fg param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("wk.A(").append(43).append(44);
    ...
    public final void a(int param0, tg param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_8_1 = new StringBuilder().append("wk.L(").append(param0).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    public wk() {
        ...
        ((wk) this).field_E.a(40, true, var3, -var5 + 496 >> 1, var5);
    ...
    private final int a(String param0, int param1, String param2, int param3, fi param4, int param5, int param6) {
        ...
        try {
          L0: {
            L1: {
              if (param3 == -7815) {
                ...
                boolean discarded$2 = ((wk) this).a((fi) null, 'ﾴ', 84, -110);
                break L1;
              }
            }
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("wk.F(");
            stackIn_6_0 = stackOut_4_0;
          ...
          throw kg.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + 44 + param5 + 44 + param6 + 41);
        }
        return stackIn_3_0;
    }
    ...
    public final void a(String param0, boolean param1) {
        ...
        String var4 = null;
        try {
            var3 = ((wk) this).field_D;
            var4 = param0;
            ((wa) (Object) var3).a(var4, 81, param1);
        } catch (RuntimeException runtimeException) {
            throw kg.a((Throwable) (Object) runtimeException, "wk.D(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final void a(int param0, int param1, fi param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("wk.E(").append(param0).append(44).append(param1).append(44);
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
