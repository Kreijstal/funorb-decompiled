...
abstract class ec extends fi implements ja {
    ...
    final boolean a(int param0, fi param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
                ...
                L2: {
                  if (((ec) this).field_x == null) {
                    ...
                    if (!((ec) this).field_x.f(true)) {
                      ...
                      if (!((ec) this).field_x.a(param0, param1, param2, param3, param4, param5, param6)) {
                        break L2;
                      } else {
                        stackOut_6_0 = 1;
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("ec.TA(").append(param0).append(44);
          ...
          throw kg.a((Throwable) (Object) stackIn_12_0, stackIn_12_2 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
    ...
    private final boolean a(fi param0, boolean param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("ec.WA(");
            stackIn_8_0 = stackOut_6_0;
          ...
          throw kg.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + 1 + 41);
        }
          ...
          L0: {
            L1: {
              if (param1 == -8515) {
                ...
                String discarded$2 = ((ec) this).d(-27);
                break L1;
              }
            }
            L2: {
          ...
          L0: {
            L1: {
              if (param1 > 118) {
                ...
                var6 = null;
                StringBuilder discarded$2 = ((ec) this).a((Hashtable) null, (byte) 94, 63, (StringBuilder) null);
                break L1;
              }
            }
            L2: {
    ...
    private final boolean a(byte param0, fi param1) {
        ...
        try {
          L0: {
            L1: {
              if (param0 <= -50) {
                ...
                var4 = null;
                boolean discarded$2 = this.a((byte) 59, (fi) null);
                break L1;
              }
            }
            L2: {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("ec.RA(").append(param0).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    final void a(Hashtable param0, StringBuilder param1, int param2, int param3) {
        ...
        try {
          StringBuilder discarded$10 = param1.append(10);
          var5_int = 0;
          L0: while (true) {
            if (param3 < var5_int) {
              L1: {
          ...
          throw kg.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + 44 + param2 + 44 + param3 + 41);
        }
    }
    ...
    boolean a(fi param0, int param1, boolean param2, int param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          throw kg.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
        return stackIn_7_0 != 0;
    }
    ...
    void a(int param0, int param1, fi param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("ec.E(").append(param0).append(44).append(param1).append(44);
            stackIn_7_0 = stackOut_5_0;
          ...
          throw kg.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + param3 + 41);
        }
    }
    ...
    void a(int param0, int param1, int param2, fi param3, int param4, int param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ec.JA(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
