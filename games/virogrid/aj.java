...
class aj implements ol, gm {
    ...
    public final int b(int param0, fi param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("aj.EA(").append(param0).append(44);
        ...
        try {
          L0: {
            ...
            if (param4 != param1) {
              if (param3.f(true)) {
                L2: {
                  var17 = ((aj) this).a(param3, (byte) 83);
                  var18 = var17;
                  if (param1 <= param4) {
                    var9 = param4;
                    var8 = param1;
                ...
                L3: while (true) {
                  if (var11 < var12) {
                    ...
                    var15 = stackIn_20_0;
                    vi.field_g.a(((aj) this).field_o >>> 24, var13.field_c + param3.field_q + (((aj) this).field_n + param3.field_u + param5), var13.field_b, -var14 + var15, this.a(param2, var14, (byte) -76, param3), 124, ((aj) this).field_o);
                    var12++;
                    continue L3;
                  }
                }
          ...
          L6: {
            ...
            stackOut_23_1 = new StringBuilder().append("aj.DA(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
          ...
          throw kg.a((Throwable) (Object) stackIn_26_0, stackIn_26_2 + 44 + param4 + 44 + param5 + 41);
        }
    }
    ...
    private final int a(byte param0, fi param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = param1.field_q + (param2 + param1.field_u) - -((aj) this).field_n + param3;
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("aj.V(").append(param0).append(44);
          ...
          throw kg.a((Throwable) (Object) stackIn_5_0, stackIn_5_2 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_1_0;
    }
    ...
    public final int b(fi param0, boolean param1) {
        ...
        try {
          L0: {
            if (param1) {
              stackOut_3_0 = -((aj) this).field_p + param0.field_g - ((aj) this).field_d;
    ...
    private final void a(int param0, int param1, fi param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("aj.CA(").append(param0).append(44).append(param1).append(44);
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
            stackIn_4_0 = stackOut_3_0;
          ...
          L0: {
            L1: {
              if (param1 > 65) {
                ...
                var4 = null;
                int discarded$4 = ((aj) this).b(-67, (fi) null, -114);
                break L1;
              }
            }
            ie discarded$5 = ((aj) this).a(param0, (byte) -128);
            stackOut_2_0 = param0.field_r.a((byte) 20) - -((aj) this).field_n + ((aj) this).field_r;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    private final int a(int param0, fi param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = -((aj) this).field_r + -((aj) this).field_n + param1.field_m;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            var3 = decompiledCaughtException;
            stackOut_4_0 = (RuntimeException) var3;
            stackOut_4_1 = new StringBuilder().append("aj.LA(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    private final void b(fi param0, int param1) {
        ...
        try {
          L0: {
            ...
            if (param1 == -14040) {
              L2: {
                var3_int = ((aj) this).b(param0, true);
                ...
                if (var6 == 0) {
                  ...
                  if (var6 == 2) {
                    ...
                    var5 = (var4 + -((aj) this).field_i.field_H - ((aj) this).field_i.field_G >> 1) + ((aj) this).field_i.field_H;
                    break L2;
                  }
                }
              }
                    ...
                    L5: {
                      if (var6 == 1) {
                        if (!(param0.field_r instanceof bm)) {
                          ...
                          ((bm) (Object) param0.field_r).a(((aj) this).c(param0, 218479361), (byte) -98, ((aj) this).field_i, var3_int >> 1, var5);
                          return;
                        }
                      } else {
                        if (var6 != 2) {
                          ...
                          if (param0.field_r instanceof bm) {
                            ((bm) (Object) param0.field_r).a((byte) -92, var3_int, ((aj) this).c(param0, 218479361), var5, ((aj) this).field_i);
                            break L5;
                          } else {
                            return;
                          }
          ...
          throw kg.a((Throwable) (Object) stackIn_31_0, stackIn_31_2 + 44 + param1 + 41);
        }
    }
    ...
    final void a(int param0, aj param1) {
        ...
        try {
            ...
            throw kg.a((Throwable) (Object) runtimeException, "aj.U(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    public final int a(int param0, fi param1, int param2) {
        ...
        try {
          ...
          L2: {
            var4 = decompiledCaughtException;
            stackOut_4_0 = (RuntimeException) var4;
            stackOut_4_1 = new StringBuilder().append("aj.BA(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    private final int a(int param0, int param1, byte param2, fi param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ((aj) this).field_p + (param3.field_l + param0) - (-param3.field_k + -param1);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("aj.MA(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    public final int a(int param0, int param1, int param2, fi param3, boolean param4, int param5) {
        ...
        try {
          L0: {
            ie discarded$8 = ((aj) this).a(param3, (byte) -122);
            if (param4) {
              stackOut_3_0 = param3.field_r.a((byte) 120, param2 - ((aj) this).b(-587719039, param3, param1), -((aj) this).a(param0, param3, -7510) + param5);
              stackIn_4_0 = stackOut_3_0;
              break L0;
            } else {
              stackOut_1_0 = -33;
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("aj.IA(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
            stackIn_6_0 = stackOut_5_0;
            stackIn_6_1 = stackOut_5_1;
          ...
          throw kg.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + param4 + 44 + param5 + 41);
        }
        return stackIn_4_0;
    }
    ...
    private final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, fi param7) {
        ...
        try {
                ...
                L2: {
                  ...
                  if (0 == var13) {
                    ...
                    if (2 == var13) {
                      ...
                      var12 = ((aj) this).field_i.field_H + (-((aj) this).field_i.field_H + var11 + -((aj) this).field_i.field_G >> 1);
                      break L2;
                    }
                  }
                }
                L4: {
                  ...
                  if (var13 == 0) {
                    ...
                    if (var13 == 3) {
                      ...
                      if (var13 == 1) {
                        ((aj) this).field_i.c(((aj) this).c(param7, 218479361), this.a(param2, param4, (byte) -42, param7) - -(var10 >> 1), this.a((byte) 23, param7, param0, param3) - -var12, param6, param1);
                        break L1;
                      } else {
                        if (var13 == 2) {
          ...
          L5: {
            ...
            stackOut_22_1 = new StringBuilder().append("aj.AA(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44).append(param5).append(44).append(param6).append(44);
    ...
    public final void a(int param0, int param1, boolean param2, fi param3, int param4) {
        ...
        try {
          L0: {
            if (param3.f(param2)) {
              L1: {
                ...
                stackOut_2_0 = ((aj) this).b(-587719039, param3, param4);
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("aj.JA(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
          ...
          throw kg.a((Throwable) (Object) stackIn_10_0, stackIn_10_2 + 44 + param4 + 41);
        }
    }
    ...
    public final int a(fi param0, boolean param1) {
        ...
        try {
          L0: {
            L1: {
              ie discarded$8 = ((aj) this).a(param0, (byte) -118);
              if (!param1) {
                break L1;
              } else {
                var4 = null;
            ...
            stackOut_2_0 = param0.field_r.a(3209) + (((aj) this).field_p + ((aj) this).field_d);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    public void a(int param0, fi param1, boolean param2, int param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("aj.E(").append(param0).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
    ...
    aj(e param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, boolean param12) {
        try {
            ...
            throw kg.a((Throwable) (Object) runtimeException, "aj.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 44 + param8 + 44 + param9 + 44 + param10 + 44 + param11 + 44 + param12 + 41);
        }
    }
