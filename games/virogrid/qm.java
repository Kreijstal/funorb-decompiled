...
final class qm extends km {
    ...
    final boolean g(int param0) {
        if (-1 != (((qm) this).field_Nb.field_nb ^ -1)) {
            ((qm) this).field_Ib = 20;
            return true;
        }
    ...
    final static void a(int param0, boolean param1, byte param2) {
        ...
        L1: {
          stackOut_2_0 = lg.field_a.field_Ib;
          stackOut_2_1 = 2 + pg.field_e;
          stackOut_2_2 = param1;
          stackOut_2_3 = 0;
          stackOut_2_4 = 2;
          stackOut_2_5 = param0 * (6 + 3 * pg.field_e);
        ...
        L2: {
          L3: {
            var3 = ((um) (Object) stackIn_5_0).a(stackIn_5_1, stackIn_5_2, stackIn_5_3 != 0, stackIn_5_4, stackIn_5_5, stackIn_5_6 != 0) ? 1 : 0;
            ...
            if (var6 == null) {
              ...
              L9: {
                ...
                if (-1 <= (var10 ^ -1)) {
                  ...
                  stackOut_19_1 = e.a(var6.field_Eb.field_C, var6.field_Hb, var10);
              ...
              L10: {
                stackIn_21_0.field_V = stackIn_21_1;
