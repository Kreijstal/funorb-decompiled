...
final class gj extends l {
    ...
    private static nj[] field_I;
    private static float[] field_H;
    private static ue[] field_v;
    private static int[] field_s;
    private static uc[] field_D;
    private int field_J;
    static hi[] field_g;
    ...
    private final float[] d(int param0) {
        ...
        L0: {
          gj.a(((gj) this).field_N[param0], 0);
          int discarded$1 = gj.b();
          var2 = gj.a(pn.a(field_p.length - 1, (byte) -51));
          var3 = field_i[var2] ? 1 : 0;
          if (var3 == 0) {
          ...
          L5: {
            ...
            if (var3 == 0) {
              ...
              if (var5 != 0) {
                ...
                var8 = (var4 >> 2) - (field_n >> 2);
                var9 = (var4 >> 2) + (field_n >> 2);
                var10 = field_n >> 1;
                break L4;
              }
            }
          ...
          L7: {
            if (var3 == 0) {
              ...
              if (var6 != 0) {
                ...
                var11 = var4 - (var4 >> 2) - (field_n >> 2);
                var12 = var4 - (var4 >> 2) + (field_n >> 2);
                var13 = field_n >> 1;
                break L6;
              }
            }
        ...
        L8: {
          var14 = field_D[field_p[var2]];
          var16 = var14.field_b;
          var17_int = var14.field_c[var16];
          if (field_I[var17_int].a()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_d) {
            L10: {
              if (var15 != 0) {
                ...
                field_I[var18_int].a(field_r, var4 >> 1);
                break L10;
              }
            }
            L11: {
                    ...
                    L13: while (true) {
                      if (var41 >= var4) {
                        ...
                        L15: {
                          var21 = stackIn_40_0;
                          if (var3 == 0) {
                            stackOut_42_0 = (float[]) field_w;
                            stackIn_43_0 = stackOut_42_0;
                            break L15;
                          } else {
                            stackOut_41_0 = (float[]) field_B;
            ...
            L35: {
              ...
              if (((gj) this).field_L <= 0) {
                ...
                L36: {
                  var18_int = ((gj) this).field_L + var4 >> 2;
                  ...
                  if (((gj) this).field_M) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((gj) this).field_m) {
                        break L36;
                      } else {
                        var20 = (((gj) this).field_L >> 1) + var19;
                        var40[var19] = var40[var19] + ((gj) this).field_k[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((gj) this).field_k;
              ((gj) this).field_k = field_r;
              field_r = var18;
              ((gj) this).field_L = var4;
              ((gj) this).field_m = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    final static int b() {
        int var0 = field_x[field_u] >> field_z & 1;
        field_z = field_z + 1;
        field_u = field_u + (field_z >> 3);
        field_z = field_z & 7;
        return var0;
    }
    ...
    final static int a(int param0) {
        ...
        int var1 = 0;
        int var2 = 0;
        while (param0 >= 8 - field_z) {
            var3 = 8 - field_z;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_x[field_u] >> field_z & var4) << var2);
            field_z = 0;
            field_u = field_u + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_x[field_u] >> field_z & var3) << var2);
            field_z = field_z + param0;
        }
        return var1;
    }
                ...
                L10: while (true) {
                  if (var8_int >= var4) {
                    ...
                    L11: while (true) {
                      if (var9_int >= var5) {
                        var9 = new int[var5];
                        var10 = pn.a(var5 - 1, (byte) -61);
                        var11 = 0;
                        L12: while (true) {
                          if (var11 >= var5) {
                            if (var1 == 0) {
                              field_y = var6_ref_float__;
                              field_w = var7;
                              field_E = var8;
                              field_s = var9;
                              var1++;
    ...
    final ml a() {
        ...
        int var7 = 0;
        ((gj) this).field_L = 0;
        ((gj) this).field_k = new float[field_h];
        var1 = new byte[((gj) this).field_J];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((gj) this).field_N.length) {
            ((gj) this).field_k = null;
            return new ml(((gj) this).field_K, var1, ((gj) this).field_C, ((gj) this).field_o, ((gj) this).field_t);
          } else {
            var4 = this.d(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((gj) this).field_J - var2) {
                  break L1;
                } else {
                  var5 = ((gj) this).field_J - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    final ml a(int[] param0) {
        ...
        L1: {
          if (((gj) this).field_F != null) {
            ...
            ((gj) this).field_L = 0;
            ((gj) this).field_k = new float[field_h];
            ((gj) this).field_F = new byte[((gj) this).field_J];
            ((gj) this).field_l = 0;
            ((gj) this).field_q = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((gj) this).field_q >= ((gj) this).field_N.length) {
            ((gj) this).field_k = null;
            var14 = ((gj) this).field_F;
            ((gj) this).field_F = null;
            return new ml(((gj) this).field_K, var14, ((gj) this).field_C, ((gj) this).field_o, ((gj) this).field_t);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((gj) this).field_l;
                  var4 = var13.length;
                  if (var4 <= ((gj) this).field_J - var3) {
                    break L5;
                  } else {
                    var4 = ((gj) this).field_J - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((gj) this).field_l);
                        break L7;
                      }
                    }
                    ((gj) this).field_l = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((gj) this).field_q = ((gj) this).field_q + 1;
            continue L2;
          }
        }
    }
    ...
    private final void b(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        jc var2 = new jc(param0);
        ((gj) this).field_K = var2.d((byte) 102);
        ((gj) this).field_J = var2.d((byte) 117);
        ((gj) this).field_C = var2.d((byte) 115);
        ((gj) this).field_o = var2.d((byte) 104);
        if (((gj) this).field_o < 0) {
            ((gj) this).field_o = ((gj) this).field_o ^ -1;
            ((gj) this).field_t = true;
        }
        int var3 = var2.d((byte) 99);
        if (var3 < 0) {
            throw new IOException();
        }
        ((gj) this).field_N = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            var5 = 0;
            do {
                var6_int = var2.g(11132);
                var5 = var5 + var6_int;
            } while (var6_int >= 255);
            var6 = new byte[var5];
            var2.a(0, var5, true, var6);
            ((gj) this).field_N[var4] = var6;
        }
    }

    private final static boolean a(eh param0) {
        byte[] var1 = null;
        if (!field_G) {
            var1 = param0.a(0, 0, 0);
            if (var1 == null) {
    ...
    private gj(byte[] param0) throws IOException {
        this.b(param0);
    }
