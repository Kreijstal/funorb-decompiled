...
final class pd implements Runnable {
                  ...
                  L8: {
                    ...
                    if (1 != var2_int) {
                      if (22 != var2_int) {
                        if (2 == var2_int) {
                          ...
                          if (var2_int == 4) {
                            if (~hc.a(-9986) <= ~field_f) {
                              var9_ref.field_f = (Object) (Object) new DataInputStream(((java.net.URL) var9_ref.field_g).openStream());
                              break L8;
                            } else {
                            ...
                            if (var2_int != 8) {
                              if (9 != var2_int) {
                                if (var2_int == 18) {
                                  ...
                                  var9_ref.field_f = (Object) (Object) var17.getContents((Object) null);
                                  break L8;
                                } else {
                                  if (var2_int == 19) {
                                    ...
                                    if (!((pd) this).field_a) {
                                      ...
                                      if (var2_int != 3) {
                                        if (var2_int != 21) {
                                          if (var2_int != 5) {
                                            if (6 != var2_int) {
                                              if (7 != var2_int) {
                                                if (var2_int == 12) {
                                                  int discarded$9 = 100150608;
                                                  var3_ref3 = pd.a(field_n, (String) var9_ref.field_g, field_u);
                                                  var9_ref.field_f = (Object) (Object) var3_ref3;
                                                  break L8;
                                                } else {
                                                  if (13 == var2_int) {
                                                    int discarded$10 = 100150608;
                                                    var3_ref3 = pd.a("", (String) var9_ref.field_g, field_u);
                                                    var9_ref.field_f = (Object) (Object) var3_ref3;
                                                    break L8;
                                                  } else {
                                                    L9: {
                                                    ...
                                                    L10: {
                                                      if (!((pd) this).field_a) {
                                                        ...
                                                        if (15 == var2_int) {
                                                          ...
                                                          if (!((pd) this).field_g) {
                                                            Object discarded$12 = Class.forName("uj").getDeclaredMethod("showcursor", new Class[2]).invoke(((pd) this).field_b, new Object[2]);
                                                            break L8;
                                                          } else {
                                                    ...
                                                    L12: {
                                                      if (((pd) this).field_g) {
                                                        ...
                                                        if (17 == var2_int) {
                                                          ...
                                                          Object discarded$13 = Class.forName("uj").getDeclaredMethod("setcustomcursor", new Class[5]).invoke(((pd) this).field_b, new Object[5]);
                                                          break L8;
                                                        } else {
                                                          break L12;
                                                        }
                                                      ...
                                                      try {
                                                        L13: {
                                                          if (!field_x.startsWith("win")) {
                                                            ...
                                                            L15: while (true) {
                                                              if (~var8.length() >= ~var5) {
                                                                Process discarded$14 = Runtime.getRuntime().exec("cmd /c start \"j\" \"" + var8 + "\"");
                                                ...
                                                if (!((pd) this).field_g) {
                                                  Object discarded$15 = Class.forName("vk").getMethod("exit", new Class[0]).invoke(((pd) this).field_p, new Object[0]);
                                                  break L8;
                                                } else {
                                                  ((pd) this).field_s.a((byte) -54, (java.awt.Frame) var9_ref.field_g);
                                                  break L8;
                                                }
                                              }
                                            } else {
                                              ...
                                              if (!((pd) this).field_g) {
                                                Object discarded$16 = Class.forName("vk").getMethod("enter", new Class[5]).invoke(((pd) this).field_p, new Object[5]);
                                                break L8;
                                              } else {
                                                ((pd) this).field_s.a(-80, var9_ref.field_c & 65535, var13, var9_ref.field_e >>> 16, 65535 & var9_ref.field_e, var9_ref.field_c >> 16);
                                                break L8;
                                              }
                                            }
                                          } else {
                                            if (((pd) this).field_g) {
                                              var9_ref.field_f = (Object) (Object) ((pd) this).field_s.a(123);
                                              break L8;
                                            } else {
                                              var9_ref.field_f = Class.forName("vk").getMethod("listmodes", new Class[0]).invoke(((pd) this).field_p, new Object[0]);
                                              break L8;
                                            }
                                          }
                                        } else {
                                          if (hc.a(-9986) >= field_f) {
                                            var9_ref.field_f = (Object) (Object) java.net.InetAddress.getByName((String) var9_ref.field_g).getAddress();
                                            break L8;
                                          } else {
                                            throw new IOException();
                                          }
                                        ...
                                        if (~field_f >= ~hc.a(-9986)) {
                                          var12 = (var9_ref.field_e >> 24 & 255) + "." + ((16761372 & var9_ref.field_e) >> 16) + "." + (255 & var9_ref.field_e >> 8) + "." + (255 & var9_ref.field_e);
                                          var9_ref.field_f = (Object) (Object) java.net.InetAddress.getByName(var12).getHostName();
                                          break L8;
                                        } else {
                                          throw new IOException();
                                        }
                                ...
                                var9_ref.field_f = (Object) (Object) ((Class) var11[0]).getDeclaredField((String) var11[1]);
                                break L8;
                              }
                            } else {
                              L17: {
                        ...
                        if (hc.a(-9986) < field_f) {
                          ...
                          try {
                            L18: {
                              int discarded$17 = -92;
                              var9_ref.field_f = (Object) (Object) ig.a(var9_ref.field_e, (String) var9_ref.field_g).b(-18982);
                              break L18;
                            }
                      ...
                      if (field_f > hc.a(-9986)) {
                        ...
                        var9_ref.field_f = (Object) (Object) new java.net.Socket(java.net.InetAddress.getByName((String) var9_ref.field_g), var9_ref.field_e);
                        break L8;
                      }
                    }
                  }
    ...
    final un a(int param0, int param1, int param2, int param3, int param4) {
        ...
        return this.a(6, (byte) -30, param4 + (param2 << 16), (Object) null, (param1 << 16) - -param0);
    }
    ...
    private final static ji a(String param0, String param1, int param2) {
        try {
            String var4 = null;
            Object[] var5 = null;
            ...
            L1: while (true) {
              if (var6 < var5_array.length) {
                ...
                try {
                  L3: {
                    var8_ref = new ji(new File(var7, var4), "rw", 10000L);
                    stackOut_11_0 = (ji) var8_ref;
    ...
    private final un a(int param0, boolean param1, String param2, int param3) {
        ...
        return this.a(1, (byte) -30, param3, (Object) (Object) param2, 0);
    }
