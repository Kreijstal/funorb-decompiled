...
final class ok extends fd implements im, ta {
        ...
        try {
          L0: {
            if (super.a(param0, param1, param2, 94)) {
              ...
              if (param2 == 98) {
                stackOut_6_0 = ((ok) this).b(2, param0);
                ...
                if (param2 != 99) {
                  ...
                  stackOut_9_0 = ((ok) this).a(-16234, param0);
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, e param9, int param10, mg[] param11, int param12, int param13, int param14, int param15, mg[] param16, e param17, mg[] param18, int param19, int param20) {
        ...
        String stackOut_15_2 = null;
        try {
          oj.a(param13, new wg(param11), param14, 0, param2, param19, 0, param6, param7, param8, 480, new wg(param16), (byte) -29, param15, param17, param4, param10, param9, param0, new wg(param18), param5);
          return;
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L0: {
    ...
    ok(b param0) {
        ...
        try {
          L0: {
            ...
            var5 = 4;
            var6 = 200;
            ((ok) this).field_I.a(40, true, var3, -var6 + 300 >> 1, var6);
