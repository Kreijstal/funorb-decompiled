    ...
    private final ml a(int[] param0, boolean param1, int param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_19_1 = new StringBuilder().append("jg.G(");
          ...
          throw kg.a((Throwable) (Object) stackIn_23_0, stackIn_23_2 + ',' + false + ',' + param2 + ',' + param3 + ')');
        }
        return stackIn_18_0;
    }
        ...
        try {
          ...
          if (((jg) this).field_d.e(46) != -2) {
            if (-2 == ((jg) this).field_d.d((byte) 50, param1)) {
              stackOut_8_0 = this.a(param0, (byte) 90, 0, param1);
              stackIn_9_0 = stackOut_8_0;
              return stackIn_9_0;
            } else {
              throw new RuntimeException();
          ...
          L1: {
            ...
            stackOut_11_1 = new StringBuilder().append("jg.J(");
    ...
    final static void a(String[] args, String[] param1, String[][] param2, byte[] param3, eh param4, mg[][] param5, String[][] param6, byte[] param7, int param8, int param9, boolean param10, rm[] param11, int param12, eh param13, int[] param14, eh param15, byte param16, int[] param17, String[] param18, mg[][] param19) {
        ...
        try {
          L0: {
            ...
            tm.a(param19, 126, param12, 1, param14, param4, param5, param7, param2, param8, param6, param1, param18, param3, args);
            var20_int = 0;
            int discarded$2 = 1;
            vj.a(param13, param4, param10);
            int discarded$3 = -7597;
            ak.c();
            ld.a(0);
            el.a(true);
            break L0;
          ...
          L9: {
            ...
            stackOut_34_1 = ((StringBuilder) (Object) stackIn_34_1).append(stackIn_34_2).append(',').append(param8).append(',').append(1).append(',').append(param10).append(',');
          ...
          L13: {
            ...
            stackOut_50_1 = ((StringBuilder) (Object) stackIn_50_1).append(stackIn_50_2).append(',').append(99).append(',');
    ...
    private final ml a(int[] param0, byte param1, int param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_24_1 = new StringBuilder().append("jg.F(");
          ...
          throw kg.a((Throwable) (Object) stackIn_28_0, stackIn_28_2 + ',' + 90 + ',' + param2 + ',' + param3 + ')');
        }
        return stackIn_23_0;
    }
          ...
          L0: {
            ...
            if (param3 <= -63) {
              if (0 <= var5_int) {
                ...
                if (var6 >= 0) {
                  stackOut_10_0 = this.a(param0, false, var6, var5_int);
                  stackIn_11_0 = stackOut_10_0;
                  break L0;
                } else {
                  stackOut_8_0 = null;
        ...
        try {
          L0: {
            ...
            if (var5_int >= 0) {
              ...
              if (var6 >= 0) {
                stackOut_9_0 = this.a(param2, (byte) 90, var6, var5_int);
                stackIn_10_0 = stackOut_9_0;
                break L0;
              } else {
                stackOut_7_0 = null;
          ...
          L1: {
            ...
            stackOut_11_1 = new StringBuilder().append("jg.A(").append(false).append(',');
            stackIn_14_0 = stackOut_11_0;
            stackIn_14_1 = stackOut_11_1;
            stackIn_12_0 = stackOut_11_0;
            stackIn_12_1 = stackOut_11_1;
