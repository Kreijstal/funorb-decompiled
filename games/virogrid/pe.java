...
final class pe extends l {
    ...
    final static void a(java.awt.Component param0, i param1, pd param2, boolean param3) {
        try {
            ...
            throw kg.a((Throwable) (Object) runtimeException, "pe.C(" + (param0 != null ? "{...}" : "null") + ',' + (param1 != null ? "{...}" : "null") + ',' + (param2 != null ? "{...}" : "null") + ',' + param3 + ',' + -18 + ',' + 22050 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, int param2, byte param3, int param4) {
        ...
        try {
            ...
            throw kg.a((Throwable) (Object) runtimeException, "pe.D(" + param0 + ',' + 1141646 + ',' + param2 + ',' + param3 + ',' + param4 + ')');
        }
    }
    ...
    final static String a(String param0, String param1, eh param2) {
        ...
        try {
          ...
          throw kg.a((Throwable) (Object) stackIn_15_0, stackIn_15_2 + ',' + 0 + ',' + 0 + ')');
        }
        return stackIn_5_0;
    }
    ...
    final static void a(int param0) {
        ...
        try {
                          ...
                          if (var4 <= var6_int) {
                                  ...
                                  if (var8 <= var14) {
                                    ...
                                    L8: {
                                      ...
                                      if (!jc.a(rc.field_h[var11], true)) {
                                        ...
                                        if (vc.field_jb[var11] - (-tg.field_A[var11] - kf.field_j[var11]) != 0) {
                                          break L8;
                                        } else {
                                          var6[1][var15] = null;
                                          var15--;
                            ...
                            L10: {
                              ...
                              if (var6_int == 0) {
                                ...
                                fd.a(ng.field_X, lm.field_j, 0, ve.field_s, var6_int, ug.field_b);
                                break L10;
                              } else {
                                fd.a(ng.field_X, lm.field_j, 0, ve.field_s, var6_int, ug.field_b);
                                break L10;
          ...
          throw kg.a((Throwable) (Object) var1, "pe.F(" + -1 + ')');
        }
    }
    ...
    pe(jh param0, l param1) {
        try {
            ...
            ((pe) this).field_g.f(((pe) this).field_i * ag.field_c + 128 >> 8);
        } catch (RuntimeException runtimeException) {
