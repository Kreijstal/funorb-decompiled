...
final class ti implements ol {
    ...
    public final void a(int param0, fi param1, boolean param2, int param3, int param4) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_20_1 = new StringBuilder().append("ti.E(").append(param0).append(44);
          ...
          throw kg.a((Throwable) (Object) stackIn_23_0, stackIn_23_2 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    ti(e param0, int param1, int param2) {
        try {
            ...
            throw kg.a((Throwable) (Object) runtimeException, "ti.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 41);
        }
    }
