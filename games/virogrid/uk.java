...
public abstract class uk extends java.applet.Applet implements Runnable, java.awt.event.FocusListener, java.awt.event.WindowListener {
    ...
    final void a(int param0, String param1) {
        try {
            ...
            try {
              L0: {
                if (!((uk) this).field_i) {
                  ((uk) this).field_i = true;
                  System.out.println("error_game_" + param1);
                  try {
                    L1: {
                      L2: {
                        Object discarded$1 = q.b("loggedout", 6168, mb.g((byte) 16));
                        if (param0 == -25296) {
                          break L2;
                        } else {
                          ((uk) this).windowDeiconified((java.awt.event.WindowEvent) null);
                          break L2;
                        }
                      }
                      break L1;
                  ...
                  try {
                    L4: {
                      ((uk) this).getAppletContext().showDocument(new java.net.URL(((uk) this).getCodeBase(), "error_game_" + param1 + ".ws"), "_top");
                      break L4;
                    }
              ...
              L6: {
                ...
                stackOut_11_1 = new StringBuilder().append("uk.P(").append(param0).append(44);
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          throw kg.a((Throwable) (Object) var5, "uk.A(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    private final void a() {
        ...
        try {
          ...
          throw kg.a((Throwable) (Object) var2, "uk.N(" + 1 + 41);
        }
    }
    ...
    private final void a(byte param0, boolean param1) {
        ...
        try {
          ...
          throw kg.a((Throwable) (Object) var3_ref3, "uk.G(" + 20 + 44 + param1 + 41);
        }
    }
            ...
            if (bj.field_m != null) {
              ...
              L1: {
                if (ai.field_a == null) {
                  ...
                  if (this == (Object) (Object) ai.field_a) {
                    break L1;
                  } else {
    ...
    final static int a(int param0, int param1, int param2) {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var3 = decompiledCaughtException;
          throw kg.a((Throwable) (Object) var3, "uk.D(" + param0 + 44 + param1 + 44 + param2 + 41);
        }
        return stackIn_26_0;
    }
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              var2 = (Object) (Object) mk.field_cb;
              break L2;
            }
            L6: {
              ((java.awt.Container) var2).setLayout((java.awt.LayoutManager) null);
              fi.field_v = (java.awt.Canvas) (Object) new ag((java.awt.Component) this);
              java.awt.Component discarded$3 = ((java.awt.Container) var2).add((java.awt.Component) (Object) fi.field_v);
              if (param0 == 21616) {
                break L6;
              } else {
                ((uk) this).b(false);
            ...
            L7: {
              L8: {
                ...
                if (var2 == (Object) (Object) bj.field_m) {
                  break L8;
                } else {
          ...
          throw kg.a((Throwable) var2, "uk.H(" + param0 + 41);
        }
    }
    ...
    final static void a(int param0, int param1, String param2, int param3, long param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("uk.M(").append(param0).append(44).append(param1).append(44);
          ...
          throw kg.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + param3 + 44 + param4 + 41);
        }
    }
            ...
            if (null != bj.field_m) {
              ...
              L1: {
                if (null == ai.field_a) {
                  ...
                  if ((Object) (Object) ai.field_a != this) {
        ...
        try {
            ...
            try {
              try {
                L0: {
                  if (null != jj.field_n) {
                    ...
                    if (km.field_pb < 3) {
                      ((uk) this).getAppletContext().showDocument(((uk) this).getDocumentBase(), "_self");
                      return;
                    } else {
                      ((uk) this).a(-25296, "alreadyloaded");
                      return;
                    }
                  } else {
                    L1: {
                      ...
                      if (param0 > 22) {
                        ...
                        ((uk) this).focusLost((java.awt.event.FocusEvent) null);
                        break L1;
                      }
                    }
                    fl.field_i = param2;
                    ...
                    pd dupTemp$2 = new pd(param3, param6, param5, true);
                    ei.field_c = dupTemp$2;
                    qn.field_R = dupTemp$2;
                ...
                L5: {
                  ...
                  int discarded$3 = 1;
                  en.a((String) null, var8);
                  ((uk) this).a(-25296, "crash");
                  break L5;
                }
              }
              ...
              L6: {
                ...
                stackOut_21_1 = new StringBuilder().append("uk.L(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44).append(param5).append(44);
    ...
    public final void start() {
        ...
        try {
          L0: {
            L1: {
              if (this != (Object) (Object) jj.field_n) {
                break L1;
              } else {
                if (md.field_d) {
                  break L1;
    ...
    public final void destroy() {
        ...
        try {
          L0: {
            L1: {
              if ((Object) (Object) jj.field_n != this) {
                break L1;
              } else {
                if (!md.field_d) {
                ...
                try {
                  L1: {
                    L2: {
                        ...
                        L4: {
                          L5: {
                            if (pd.field_q == null) {
                              ...
                              L6: {
                                var1 = (Object) (Object) pd.field_q.toLowerCase();
                              ...
                              if (var2.startsWith("1.6.0_")) {
                                ...
                                L9: while (true) {
                                  ...
                                  if (!pa.a((CharSequence) (Object) var4, -128)) {
                                    ...
                                    int discarded$7 = 0;
                                    if (fm.a((CharSequence) (Object) var4) < 10) {
                                      ((uk) this).a(-25296, "wrongjava");
                                      if (var5 == 0) {
                                        break L2;
                                      } else {
                      ...
                      L14: {
                        var1 = (Object) (Object) jj.field_n;
                        if (ai.field_a != null) {
                          var1 = (Object) (Object) ai.field_a;
                          break L14;
                        } else {
                          break L14;
                        }
                      ...
                      ((uk) this).e(21616);
                      int discarded$9 = 101;
                      ca.field_M = eg.a((java.awt.Component) (Object) fi.field_v, fl.field_i, km.field_B);
                      ((uk) this).c(true);
                      int discarded$10 = 1;
                      kb.field_b = gf.g();
                      L18: while (true) {
                        ...
                        L21: while (true) {
                          L22: {
                            ...
                            int discarded$12 = 9282;
                            this.f();
                            od.a(ei.field_c, (Object) (Object) fi.field_v, (byte) -102);
                            break L22;
                          }
                          if (var5 == 0) {
                            continue L18;
                  ...
                  L24: {
                    ...
                    int discarded$13 = 1;
                    en.a((String) null, (Throwable) var1);
                    ((uk) this).a(-25296, "crash");
                    break L24;
                  }
                }
    ...
    private final void f() {
        ...
        try {
            ...
            L1: {
              ...
              if (var4 == 0L) {
                ...
                if (var4 < var2_long) {
                  ...
                  mj.field_E = (32000 + (var6_int >> 1)) / var6_int;
                  break L1;
                } else {
                  break L1;
                }
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var2 = decompiledCaughtException;
          throw kg.a((Throwable) (Object) var2, "uk.O(" + 9282 + 41);
        }
    }
    ...
    public static void b(int param0) {
        try {
            ...
            throw kg.a((Throwable) (Object) runtimeException, "uk.I(" + param0 + 41);
        }
    }
    ...
    public final synchronized void paint(java.awt.Graphics param0) {
        ...
        try {
                ...
                if (md.field_d) {
                  ...
                  L2: {
                    ...
                    if (!g.field_c) {
                      ...
                      if (hc.a(-9986) - oi.field_b > 1000L) {
                        L3: {
                          var2_ref = param0.getClipBounds();
                          if (null == var2_ref) {
                            break L3;
                          } else {
                            if (~var2_ref.width > ~he.field_nc) {
                              break L2;
                            } else {
                              if (~ah.field_g < ~var2_ref.height) {
                                break L2;
                              } else {
                                break L3;
                              }
          ...
          throw kg.a((Throwable) (Object) stackIn_27_0, stackIn_27_2 + 41);
        }
    }
