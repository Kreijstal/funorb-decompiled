    ...
    final static km a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, e param8, int param9, int param10, int param11, int param12) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("rb.A(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44).append(param5).append(44).append(param6).append(44).append(param7).append(44);
          ...
          throw kg.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + param9 + 44 + param10 + 44 + param11 + 44 + param12 + 41);
        }
        return stackIn_4_0;
    }
