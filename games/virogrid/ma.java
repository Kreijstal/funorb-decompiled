...
final class ma {
    ...
    final l b(int param0, l param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("ma.G(").append(param0).append(44);
    ...
    final l a(int param0, l param1) {
        ...
        try {
          ...
          L3: {
            var3_ref = decompiledCaughtException;
            stackOut_10_0 = (RuntimeException) var3_ref;
            stackOut_10_1 = new StringBuilder().append("ma.B(").append(param0).append(44);
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
    ...
    ma(p param0) {
        try {
            ...
            throw kg.a((Throwable) (Object) runtimeException, "ma.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
