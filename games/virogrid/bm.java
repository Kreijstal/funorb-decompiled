                    ...
                    if (var13 != null) {
                      L10: {
                        ...
                        if (-4 != (param1 ^ -1)) {
                          ...
                          stackOut_41_1 = this.a(var13, param5.a(var13), true, param6);
    ...
    private final ri a(boolean param0, String param1, e param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("bm.J(").append(param0).append(',');
