...
final class uj {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            if (!param1) {
              if (param0 != null) {
                if (param0 != ((uj) this).field_b) {
                  if (((uj) this).field_b != null) {
                    L0: {
                      ((uj) this).field_b.setCursor((java.awt.Cursor) null);
