    ...
    final static int a(int param0, int param1, byte[] param2, int param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (param0 <= var5) {
                ...
                var4_int = fi.field_j[(var4_int ^ param2[var5]) & 255] ^ var4_int >>> 8;
                var5++;
                continue L1;
              }
            }
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ed.B(").append(param0).append(44).append(param1).append(44);
          ...
          throw kg.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + -26459 + 41);
        }
        return stackIn_5_0;
    }
    ...
    final static pe a(int param0, ml param1, int param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("ed.A(").append(param0).append(44);
