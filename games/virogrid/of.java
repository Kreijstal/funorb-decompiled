...
final class of {
    ...
    final static void a(int param0, int param1, int param2, int param3) {
        ...
        if (param3 >= param2) {
          ve.field_x[param2 + param3 * (param3 - -1) / 2] = param1;
          if (param0 == 2) {
            return;
          } else {
            of.a(29, 120, 84, -51);
          ...
          ve.field_x[(param2 - -1) * param2 / 2 + param3] = param1;
          if (param0 == 2) {
            return;
          } else {
            of.a(29, 120, 84, -51);
    ...
    final static void a(int param0, boolean param1, boolean param2, boolean param3) {
        ...
        if (sb.field_i < 0) {
          ...
          L2: {
            L3: {
              ((km) (Object) stackIn_48_0).a(stackIn_48_1 != 0, (byte) 127);
              stackOut_48_0 = hg.field_p;
          ...
          L4: {
            L5: {
              ((km) (Object) stackIn_55_0).a(stackIn_55_1 != 0, (byte) 121);
              stackOut_55_0 = jj.field_a;
              ...
              if (!param3) {
                ...
                if (param2) {
                  ...
                  stackOut_57_0 = (km) (Object) stackIn_57_0;
          ...
          L6: {
            ((km) (Object) stackIn_60_0).a(stackIn_60_1 != 0, (byte) 100);
            dd.field_b.field_c.g(0);
            if (0 == s.field_b.field_nb) {
              break L6;
            } else {
              af.field_c = true;
              break L6;
          ...
          L8: {
            if (dc.field_R.field_nb != 0) {
              if (vj.field_b.length != 1) {
                qa.a((byte) 78, 0, p.field_e, 11, true, oj.field_Vb);
                break L8;
              } else {
          ...
          L10: {
            L11: {
              qd.field_f.field_V = oi.a(new String[1], sa.field_m, 2);
          ...
          L16: {
            ((km) (Object) stackIn_20_0).a(stackIn_20_1 != 0, (byte) 100);
            dd.field_b.field_c.g(0);
            if (0 == s.field_b.field_nb) {
              break L16;
            } else {
