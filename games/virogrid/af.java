...
final class af {
    ...
    final static void a(byte param0, java.awt.Canvas param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_6_1 = new StringBuilder().append("af.B(").append(param0).append(',');
    ...
    final static boolean a(String param0, String param1, qh param2, boolean param3, int param4, String param5, int param6) {
        b var7 = null;
        ...
        try {
          ...
          throw kg.a((Throwable) ((Object) stackIn_25_0), stackIn_25_2 + ',' + param6 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
    ...
    static {
        field_f = "You cannot join this game - it is in progress";
        field_a = new int[]{20, 21, 8};
        field_b = false;
