...
class tk {
    ...
    private final void a(int[] param0, int param1) {
        ...
        L1: {
          ...
          if (this.field_n == null) {
            ...
            if (this.field_o > 0) {
              ...
              this.field_o = this.field_o + (field_f >> 4);
              tk.b(this.field_n);
                                ...
                                if (var4 < this.field_j) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_u[var7_int] = (rf) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
        ...
        L17: {
          if (this.field_n == null) {
            ...
            this.field_n.b(param0, 0, param1);
            break L17;
          }
        }
        this.field_p = kh.a(-99);
    }
                ...
                L0: {
                  ...
                  L2: while (true) {
                    if (var1 <= this.field_p + 5000L) {
                      ...
                      this.b(256);
                      this.field_p = this.field_p + (long)(256000 / field_f);
                      var1 = kh.a(-69);
                      continue L2;
                    }
                  }
              ...
              if (this.field_e != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.g();
                      if (this.field_a - var3_int <= this.field_t) {
                        break L6;
                      } else {
                        this.field_t = this.field_a - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_i + this.field_k;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_h) {
                        break L8;
                      } else {
                        L9: {
                          this.field_h = this.field_h + 1024;
                          if (this.field_h <= 16384) {
                            break L9;
                          } else {
                            this.field_h = 16384;
                            break L9;
                        ...
                        if (var4 + 256 <= this.field_h) {
                          ...
                          var4 = this.field_h - 256;
                          this.field_k = var4 - this.field_i;
                          break L8;
                        }
                      }
                    }
                                ...
                                L13: {
                                  if (this.field_t != 0) {
                                    ...
                                    if (this.field_g != 0) {
                                      ...
                                      this.f();
                                      this.field_q = var1 + 2000L;
                                      decompiledRegionSelector0 = 1;
                                      break L4;
                                    }
                                  }
                                }
                                this.field_k = Math.min(this.field_g, this.field_t);
                                this.field_g = this.field_t;
                                break L12;
                              }
                            }
                            this.field_t = 0;
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new ug();
                          var4 = var5;
                          stackIn_10_0 = (ug) (var4);

                          stackIn_10_1 = 256;

                          if (!field_r) {
                            stackIn_11_0 = (ug) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_d <= 0) {
                            ...
                            if (field_s != null) {
                              ...
                              param0.a(field_d, 1048576, (Runnable) ((Object) field_s));
                              break L5;
                            }
                          }
                        }
    ...
    tk() {
        this.field_j = 32;
        this.field_m = false;
        this.field_p = kh.a(-86);
        this.field_t = 0;
        this.field_c = true;
        this.field_u = new rf[8];
        this.field_g = 0;
        this.field_q = 0L;
        this.field_o = 0;
        this.field_l = 0L;
        this.field_a = 0;
        this.field_b = new rf[8];
    }
}
