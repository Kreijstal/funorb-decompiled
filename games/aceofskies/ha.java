...
abstract class ha {
    ...
    private final static ha a(java.awt.Canvas param0, int param1, d param2, int param3, byte param4) {
        ...
        try {
          L0: {
            var5_int = 0;
            stackOut_0_0 = new oa(param0, param2, param3, param1);
          ...
          throw pn.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + param3 + 44 + -64 + 41);
        }
    ...
    final synchronized static ha a(int param0, gk param1, int param2, java.awt.Canvas param3, int param4, int param5, int param6, d param7) {
        ...
        try {
              ...
              if (param2 != 1) {
                if (param2 != param5) {
                  if (param2 != 3) {
                    ...
                    stackOut_14_0 = mn.a((byte) 1, param4, param3, param1, param7);
                    stackIn_15_0 = stackOut_14_0;
                    return stackIn_15_0;
                  }
                } else {
                  stackOut_11_0 = gt.a(-70, param7, param3, param1, param4);
                  stackIn_12_0 = stackOut_11_0;
                  return stackIn_12_0;
                }
              } else {
                stackOut_8_0 = lh.a(param3, (byte) 66, param4, param7);
                stackIn_9_0 = stackOut_8_0;
                return stackIn_9_0;
              }
            }
          } else {
            stackOut_1_0 = to.a(16, param7, param3, param6, param0);
          ...
          L0: {
            ...
            stackOut_17_1 = new StringBuilder().append("ha.N(").append(param0).append(44);
    ...
    final pa a(int param0, int param1, int[] param2, int param3, int param4, int param5) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = ((ha) this).a(param2, param3, param5, param4, param1, true);
            stackIn_1_0 = stackOut_0_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ha.M(").append(param0).append(44).append(param1).append(44);
            stackIn_4_0 = stackOut_2_0;
            stackIn_4_1 = stackOut_2_1;
            stackIn_3_0 = stackOut_2_0;
            stackIn_3_1 = stackOut_2_1;
          ...
          throw pn.a((Throwable) (Object) stackIn_5_0, stackIn_5_2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
        return stackIn_1_0;
    }
    ...
    final static void a(ap param0, byte param1, boolean param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (null == wt.field_e) {
                ...
                dh.a(1000000, 256, param2, 1048576, param0);
                break L1;
              }
            }
            L2: {
          ...
          L5: {
            ...
            stackOut_16_1 = new StringBuilder().append("ha.PA(");
    ...
    void a(pa param0, boolean param1) {
        try {
            ...
            throw pn.a((Throwable) (Object) runtimeException, "ha.R(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    ha(d param0) {
        ...
        try {
            ...
            ((ha) this).field_c = var2_int;
        } catch (RuntimeException runtimeException) {
            throw pn.a((Throwable) (Object) runtimeException, "ha.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
