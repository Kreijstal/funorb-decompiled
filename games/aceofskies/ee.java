          ...
          L0: {
            L1: {
              if (param1 == 0) {
                ...
                discarded$2 = ee.a((CharSequence) null, -16);
                break L1;
              }
            }
            stackOut_2_0 = po.a(param1 ^ -1, param0, false);
    ...
    final static String[] a(byte param0, char param1, String param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("ee.B(").append(param0).append(',').append(param1).append(',');
          ...
          L0: {
            L1: {
              if (param0) {
                ...
                var3 = (File) null;
                discarded$2 = ee.a(false, (File) null);
                break L1;
              }
            }
