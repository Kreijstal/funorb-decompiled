    ...
    final static ha a(gk param0, d param1, int param2, int param3, java.awt.Canvas param4, int param5) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ha.a(var7, param0, param5, param4, param3, 5, var8, param1);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("hr.E(");
    ...
    final static void a(float param0, int param1, boolean param2, String param3) {
        ...
        try {
            if (param1 != 0) {
                ...
                discarded$0 = hr.a((gk) null, (d) null, -124, -29, (java.awt.Canvas) null, -9);
            }
            if (null == fu.field_d) {
