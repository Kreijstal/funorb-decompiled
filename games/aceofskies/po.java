...
final class po extends ka {
    ...
    final static void a(fp param0, byte param1, int param2) {
        ...
        try {
            ...
            throw pn.a((Throwable) (Object) runtimeException, "po.F(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 41);
        }
    }
    ...
    final static rh a(int param0, int param1, al param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("po.A(").append(param0).append(44).append(param1).append(44);
