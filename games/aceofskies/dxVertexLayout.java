...
public class dxVertexLayout extends fa {
    ...
    dxVertexLayout(kr param0, pl[] param1) {
        ...
        var10 = new jagdx.VertexElementCollection(((kr) param0).field_Ic);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (param1.length <= var5) {
            var10.finish();
            ((dxVertexLayout) this).field_d = ((kr) param0).field_Rc.a(var10, (jagdx.IDirect3DVertexDeclaration) null);
          } else {
            var6 = 0;
            var7 = param1[var5];
            var8 = 0;
