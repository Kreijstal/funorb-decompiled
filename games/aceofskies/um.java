...
final class um extends rf {
    ...
    final void b(int[] param0, int param1, int param2) {
        ...
        try {
          L0: {
            ...
            var6 = (ft) ((Object) this.field_k.d(268435455));
            L1: while (true) {
              if (var6 == null) {
                break L0;
              } else {
                stackIn_4_0 = this.field_l.a(0, var6);
                L2: {
                  if (stackIn_4_0) {
                    break L2;
                  } else {
                    ...
                    L3: while (true) {
                      if (var5 <= var6.field_i) {
                        ...
                        if (this.field_l.a(var5, var4_int, false, var6, param0)) {
                          break L2;
                        } else {
                          continue L3;
                        }
                ...
                var6 = (ft) ((Object) this.field_k.b((byte) 103));
                continue L1;
              }
            }
          }
          ...
          L4: {
            ...
            stackIn_15_1 = new StringBuilder().append("um.M(");
          ...
          throw pn.a((Throwable) ((Object) stackIn_16_0), stackIn_16_2 + ',' + param1 + ',' + param2 + ')');
        }
    }
    ...
    private final void a(int param0, int param1, ft param2) {
        ...
        try {
          L0: {
            L1: {
              if ((4 & this.field_l.field_G[param2.field_m] ^ -1) == param0) {
                break L1;
              } else {
                if (0 <= param2.field_p) {
                  break L1;
                } else {
                  var4_int = this.field_l.field_m[param2.field_m] / tk.field_f;
                  var5 = (var4_int + 1048575 - param2.field_t) / var4_int;
                  param2.field_t = var4_int * param1 + param2.field_t & 1048575;
                  if (var5 <= param1) {
                    L2: {
                      if (this.field_l.field_z[param2.field_m] != 0) {
                        L3: {
                          param2.field_e = su.a(param2.field_x, param2.field_e.l(), 0, param2.field_e.g());
                          stackIn_8_0 = this.field_l;

                          stackIn_8_1 = (ft) (param2);

                          if (-1 >= (param2.field_y.field_n[param2.field_n] ^ -1)) {
                            stackIn_9_0 = (hk) ((Object) stackIn_8_0);
                            stackIn_9_1 = (ft) ((Object) stackIn_8_1);
                            stackIn_9_2 = 0;
                            break L3;
                          } else {
                            stackIn_9_0 = (hk) ((Object) stackIn_8_0);
                    ...
                    L4: {
                      if ((param2.field_y.field_n[param2.field_n] ^ -1) <= -1) {
                        break L4;
                      } else {
                        param2.field_e.d(-1);
                        break L4;
          ...
          L5: {
            ...
            stackIn_17_1 = new StringBuilder().append("um.C(").append(param0).append(',').append(param1).append(',');
    ...
    final static s a(boolean param0, int param1) {
        ...
        if (param0) {
          ...
          try {
            L5: {
              L6: {
                ...
                if (!tn.field_t.equals(fj.field_a)) {
                  stackIn_23_0 = var9.field_t;
                  break L6;
                } else {
                  stackIn_23_0 = null;
                  break L6;
          ...
          ep.field_x = ko.a(var8, 80, (byte) -114);
          ku.field_e = null;
          return new s(param0);
        }
    }
    ...
    final rf b() {
        ft var1 = (ft) ((Object) this.field_k.d(268435455));
        if (var1 == null) {
            return null;
        }
    ...
    final void a(int param0) {
        ...
        var3 = (ft) ((Object) this.field_k.d(268435455));
        L0: while (true) {
          if (var3 != null) {
            stackIn_4_0 = this.field_l.a(0, var3);
            L1: {
              if (!stackIn_4_0) {
                var2 = param0;
                L2: while (true) {
                  if (var3.field_i >= var2) {
                    ...
                    if (this.field_l.a(var2, 0, false, var3, (int[]) null)) {
                      break L1;
                    } else {
                      continue L2;
                    }
            ...
            var3 = (ft) ((Object) this.field_k.b((byte) 103));
            continue L0;
          } else {
            return;
          }
    ...
    final rf a() {
        ...
        do {
            var1_ref = (ft) ((Object) this.field_k.b((byte) 103));
            if (var1_ref == null) {
                return null;
            }
          ...
          if (!nf.field_a) {
            ...
            if ((var1 ^ -1) < -1) {
              if (var1 == 1) {
                ...
                uf.field_e = od.a(new CharSequence[]{(CharSequence) ((Object) uf.field_e), (CharSequence) ((Object) "<br>"), (CharSequence) ((Object) ne.field_f)}, 3);
                ml.field_m.h((byte) 127);
                nj.c(98);
                return;
              } else {
                uf.field_e = sn.a(field_n, 121, new String[]{Integer.toString(var1)});
                uf.field_e = od.a(new CharSequence[]{(CharSequence) ((Object) uf.field_e), (CharSequence) ((Object) "<br>"), (CharSequence) ((Object) ne.field_f)}, 3);
                ml.field_m.h((byte) 127);
                nj.c(98);
                return;
    ...
    private final void a(ft param0, byte param1, int param2, int param3, int[] param4, int param5) {
        ...
        try {
          L0: {
            L1: {
              if (-1 == (4 & this.field_l.field_G[param0.field_m] ^ -1)) {
                break L1;
              } else {
                if (param0.field_p >= 0) {
                  break L1;
                } else {
                  var7_int = this.field_l.field_m[param0.field_m] / tk.field_f;
                  L2: while (true) {
                    ...
                    if (var8 > param2) {
                      ...
                      L4: {
                        ...
                        if (this.field_l.field_z[param0.field_m] != 0) {
                          L5: {
                            param0.field_e = su.a(param0.field_x, var11.l(), 0, var11.g());
                            stackIn_12_0 = this.field_l;

                            stackIn_12_1 = (ft) (param0);

                            if (0 <= param0.field_y.field_n[param0.field_n]) {
                              stackIn_13_0 = (hk) ((Object) stackIn_12_0);
                              stackIn_13_1 = (ft) ((Object) stackIn_12_1);
                              stackIn_13_2 = 0;
                              break L5;
                            } else {
                              stackIn_13_0 = (hk) ((Object) stackIn_12_0);
          ...
          L7: {
            ...
            stackIn_24_1 = new StringBuilder().append("um.F(");
          ...
          L8: {
            ...
            stackIn_27_1 = ((StringBuilder) (Object) stackIn_25_1).append(stackIn_25_2).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
          ...
          throw pn.a((Throwable) ((Object) stackIn_25_0), stackIn_28_2 + ',' + param5 + ')');
        }
    }
