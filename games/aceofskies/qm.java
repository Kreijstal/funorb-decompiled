...
class qm implements ir, et {
    ...
    private final void a(int param0, byte param1, int param2, ea param3) {
        try {
            ...
            throw pn.a((Throwable) (Object) runtimeException, "qm.BA(" + param0 + ',' + 126 + ',' + param2 + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    private final void a(int param0, int param1, int param2, int param3, int param4, int param5, ea param6, int param7) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (((qm) this).field_c) {
                ...
                L4: {
                  ...
                  if (0 != var12) {
                    if (3 == var12) {
                      ...
                      if (var12 == 1) {
                        ((qm) this).field_i.c(((qm) this).d(param6, 57), (var9_int >> 1) + this.a(param6, 113, param1, 0), this.a((byte) -24, 0, param0, param6) + var11, param7, param4);
                        break L1;
                      } else {
                        if (var12 != 2) {
                          break L1;
                        } else {
                          ((qm) this).field_i.a(((qm) this).d(param6, -115), this.a(param6, 108, param1, 0) + var9_int, var11 + this.a((byte) -24, 0, param0, param6), param7, param4);
                          break L1;
                        }
                      }
                    }
                ...
                ((qm) this).field_i.b(((qm) this).d(param6, -99), this.a(param6, 103, param1, 0), var11 + this.a((byte) -24, 0, param0, param6), param7, param4);
                break L1;
              }
            }
            sl.c(2765);
          ...
          L5: {
            ...
            stackOut_25_1 = new StringBuilder().append("qm.GA(").append(param0).append(',').append(param1).append(',').append(-28524415).append(',').append(0).append(',').append(param4).append(',').append(0).append(',');
          ...
          throw pn.a((Throwable) (Object) stackIn_28_0, stackIn_28_2 + ',' + param7 + ')');
        }
    }
    ...
    private final int a(byte param0, int param1, int param2, ea param3) {
        ...
        try {
          L0: {
            stackOut_2_0 = param3.field_l + (param3.field_h + (param2 - -((qm) this).field_a));
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("qm.V(").append(-24).append(',').append(0).append(',').append(param2).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    private final void c(ea param0, int param1) {
        ...
        try {
          ...
          throw pn.a((Throwable) (Object) stackIn_31_0, stackIn_31_2 + ',' + -1 + ')');
        }
    }
    ...
    final static byte[] a(int param0, int param1, byte[] param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("qm.DA(").append(0).append(',').append(param1).append(',');
