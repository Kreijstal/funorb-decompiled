...
final class hk extends rf {
    ...
    private final synchronized void a(int param0, boolean param1, boolean param2, ap param3) {
        ...
        try {
            ...
            throw pn.a((Throwable) (Object) runtimeException, "hk.V(" + param0 + ',' + param1 + ',' + param2 + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final synchronized boolean a(int param0, int param1, ap param2, gk param3, ob param4) {
        ...
        try {
              ...
              if (var8 == null) {
                ...
                L4: {
                  L5: {
                    ...
                    if (var12 == null) {
                      int discarded$1 = 16652;
                      var13 = gu.a(var9, param3);
                      if (var13 == null) {
                        var6_int = 0;
                        break L4;
                      } else {
          ...
          L6: {
            ...
            stackOut_19_1 = new StringBuilder().append("hk.J(").append(param0).append(',').append(param1).append(',');
    ...
    private final int a(byte param0, ft param1) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_18_1 = new StringBuilder().append("hk.C(").append(-67).append(',');
    ...
    final boolean a(int param0, int param1, boolean param2, ft param3, int[] param4) {
        ...
        try {
          ...
          L20: {
            ...
            stackOut_64_1 = new StringBuilder().append("hk.CA(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw pn.a((Throwable) (Object) stackIn_70_0, stackIn_70_2 + ')');
        }
