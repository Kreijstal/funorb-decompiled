...
final class qo {
        ...
        try {
          L0: {
            if (!param2.b((byte) -105)) {
              ...
              stackOut_8_0 = param4 + " - " + param2.a(param1, (byte) -79) + "%";
          ...
          L1: {
            ...
            stackOut_10_1 = new StringBuilder().append("qo.B(");
          ...
          L4: {
            ...
            stackOut_22_1 = ((StringBuilder) (Object) stackIn_22_1).append(stackIn_22_2).append(',').append(13525).append(',');
    ...
    final static void a() {
        ...
        try {
            ...
            L1: {
              ...
              if (0 != var2) {
                ...
                if (var4_ref_oh != null) {
                  ...
                  L6: while (true) {
                    if (var7 < var5_int) {
                      var6[var7 >> 2] = var6[var7 >> 2] + (var10.g(-100) << pg.a(var7 << 8, 768));
                      var7++;
                      continue L6;
                    } else {
                      var4_ref_oh.c(-124);
          ...
          throw pn.a((Throwable) (Object) var1, "qo.D(" + -26 + ')');
        }
    }
    ...
    final boolean b(byte param0) {
        ...
        L1: {
          if ((Object) (Object) aj.field_v != this) {
            stackOut_5_0 = 0;
        ...
        L2: {
          ...
          if (this != (Object) (Object) nj.field_f) {
        ...
        return (stackIn_10_0 | stackIn_10_1) != 0;
    }
