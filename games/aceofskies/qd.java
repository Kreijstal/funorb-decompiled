...
class qd extends gg {
        ...
        try {
            ...
            try {
              try {
                ...
                stackOut_3_0 = (dp) var5_ref;
                stackIn_4_0 = stackOut_3_0;
                return (pj) (Object) stackIn_4_0;
              }
              return stackIn_2_0;
              ...
              L1: {
                ...
                stackOut_5_1 = new StringBuilder().append("qd.O(");
    ...
    final void a(int param0, int param1, byte param2) {
        ((qd) this).field_j = ((qd) this).field_j + (param1 * ((qd) this).field_k[param0] >> 12);
        if (param2 < 107) {
    ...
    final void a(int param0) {
        ...
        if (!(((qd) this).field_j < 4096)) {
            ((qd) this).field_j = 4095;
        }
        int fieldTemp$0 = ((qd) this).field_o;
        ((qd) this).field_o = ((qd) this).field_o + 1;
        ((qd) this).b(255, fieldTemp$0, (byte)(((qd) this).field_j >> 4));
    ...
    void b(int param0, int param1, byte param2) {
        int fieldTemp$0 = ((qd) this).field_o;
        ((qd) this).field_o = ((qd) this).field_o + 1;
        ((qd) this).field_l[fieldTemp$0] = (byte)((pg.a(param0, (int) param2) >> 1) + 127);
    }
