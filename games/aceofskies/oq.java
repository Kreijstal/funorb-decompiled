...
final class oq extends rg implements dn {
    ...
    oq(lt param0, lh param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_10_0 = var3;
            stackOut_10_1 = new StringBuilder().append("oq.<init>(");
    ...
    public final void a(int param0, mi param1, int param2, int param3, byte param4) {
        try {
            ...
            throw pn.a((Throwable) (Object) runtimeException, "oq.DA(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    private final mi a(String param0, int param1, no param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("oq.CA(");
        ...
        try {
          L0: {
            if (param0 < -37) {
              var2 = new fr(false);
              var2.field_c = param1;
              stackOut_3_0 = (fr) var2;
              stackIn_4_0 = stackOut_3_0;
              break L0;
            } else {
              stackOut_1_0 = null;
              stackIn_2_0 = stackOut_1_0;
              return (fr) (Object) stackIn_2_0;
            }
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("oq.AA(").append(param0).append(44);
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
            stackIn_6_0 = stackOut_5_0;
            stackIn_6_1 = stackOut_5_1;
