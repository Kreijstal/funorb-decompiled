...
public class NativeInterface {
    ...
    final native void setSunDirection(float param0, float param1, float param2);
    ...
    final native void setSunColour(float param0, float param1, float param2, float param3, float param4);
