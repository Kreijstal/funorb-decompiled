...
abstract class hc extends wt {
    ...
    final int a(char param0) {
        return this.field_p[ae.a(param0, -113) & 255];
    }
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        if (param0 != null) {
          ...
          L1: {
            ...
            if (param4 >= this.field_I + this.field_D + param10) {
              break L1;
            } else {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - this.field_I - this.field_D - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                ...
                var14 = param2 + this.field_I + (param4 - this.field_I - this.field_D - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
                                      ...
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_L[(var7 << 8) + var8] = (byte)hc.a(var15, var16, var17, this.field_p, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$0 = field_n.append('<');
                        discarded$1 = field_n.append(var15);
                        discarded$2 = field_n.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                                          ...
                                          if (!var15.startsWith("img=")) {
                                            ...
                                            try {
                                              L4: {
                                                ...
                                                var4 = var4 + this.field_u[var16_int].field_h;
                                                var10 = 0;
                                                break L4;
                                              }
                                            } catch (java.lang.Exception decompiledCaughtParameter0) {
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$3 = field_n.append((char) var14);
    ...
    final int a(String param0, int param1, int param2) {
        ...
        return this.field_I + var5 + this.field_D;
    }
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_r = (param1 - this.a(param0) << 8) / var3;
                break L1;
              }
            }
            return;
                                      ...
                                      if (var8.startsWith("img=")) {
                                        try {
                                          L2: {
                                            ...
                                            var4 = var4 + this.field_u[var9_int].field_h;
                                            var3 = 0;
                                            var6++;
                                            break L2;
                                          }
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var11_ref_df = this.field_u[var10];
                                            if (this.field_s == null) {
                                              stackIn_26_0 = var11_ref_df.field_a;
                                              break L3;
                                            } else {
                                          ...
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_x != 256) {
                                              var11_ref_df.a(param1, param2 + this.field_w - var12, field_x);
                                              break L4;
                                            } else {
                                              var11_ref_df.a(param1, param2 + this.field_w - var12);
                                              break L4;
                                            }
                                          }
              ...
              if (var4 == -1) {
                    ...
                    if (field_x != 256) {
                      L8: {
                        if (field_F == -1) {
                          ...
                          this.a(var8, param1 + this.field_B[var8] + 1, param2 + this.field_H[var8] + 1, var9, var10, field_F, field_x, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_B[var8], param2 + this.field_H[var8], var9, var10, field_y, field_x, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_F == -1) {
                          ...
                          this.a(var8, param1 + this.field_B[var8] + 1, param2 + this.field_H[var8] + 1, var9, var10, field_F, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_B[var8], param2 + this.field_H[var8], var9, var10, field_y, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  ...
                  if (field_G == -1) {
                    ...
                    vp.b(var11, param2 + (int)((double)this.field_w * 0.7), param1 - var11, field_G);
                    break L10;
                  }
                }
                L11: {
                  if (field_q == -1) {
                    ...
                    vp.b(var11, param2 + this.field_w + 1, param1 - var11, field_q);
                    break L11;
                  }
                }
                var5 = var8;
    ...
    hc(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_I = this.field_w - var6;
            this.field_D = var7 - this.field_w;
            this.field_C = this.field_w - this.field_H[88];
            return;
          } else {
            L1: {
            ...
            if (this.field_H[var8] + this.field_z[var8] > var7) {
              var7 = this.field_H[var8] + this.field_z[var8];
              var8++;
              continue L0;
            } else {
              var8++;
