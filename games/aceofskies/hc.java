...
abstract class hc extends wt {
    ...
    private df[] field_u;
    private static StringBuilder field_n;
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9) {
        return ((hc) this).a(param0, param1, param2, param3, param4, param5, param6, 256, param7, param8, param9);
    }

    final int a(char param0) {
        return ((hc) this).field_p[ae.a(param0, -113) & 255];
    }
    ...
    private final void b(String param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 27: {
                    try {
                        this.a(field_v, field_J, field_E);
                        statePc = 30;
                        continue stateLoop;
        ...
        if (param0 != null) {
          L0: {
            ...
            if (param10 != 0) {
              ...
              param10 = ((hc) this).field_w;
              break L0;
            }
          }
          L1: {
            var12 = new int[]{param3};
            if (param4 >= ((hc) this).field_I + ((hc) this).field_D + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = ((hc) this).a(param0, var12, field_A);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - ((hc) this).field_I - ((hc) this).field_D - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + ((hc) this).field_I + var15;
                  param10 = param10 + var15;
                  break L3;
                } else {
                  var14 = param2 + param4 - ((hc) this).field_D - (var13 - 1) * param10;
                  break L3;
                }
              } else {
                var14 = param2 + ((hc) this).field_I + (param4 - ((hc) this).field_I - ((hc) this).field_D - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + ((hc) this).field_I;
              break L3;
            }
          }
          var15 = 0;
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.b(field_A[var15], param1 + param3 - ((hc) this).a(field_A[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_A[var15], param1 + (param3 - ((hc) this).a(field_A[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                      ...
                      if (var5_int >= 256) {
                        ...
                        L4: while (true) {
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ((hc) this).field_L = new byte[65536];
                                var7 = 0;
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    ((hc) this).field_w = var25[32] + var22[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                ((hc) this).field_L[(var7 << 8) + var8] = (byte)hc.a(var23, var24, var25, ((hc) this).field_p, var22, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                ((hc) this).field_p[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
            ...
            var2 = 0;
            L10: while (true) {
              if (var2 >= ((hc) this).field_p.length) {
                ((hc) this).field_w = param0[256] & 255;
                break L0;
              } else {
                ((hc) this).field_p[var2] = param0[var2] & 255;
                var2++;
                continue L10;
              }
            }
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = aq.a(' ', -2, 0, field_n);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
                ...
                case 8: {
                    ...
                    var9 = -1;
                    StringBuilder discarded$11 = field_n.append(60);
                    StringBuilder discarded$12 = field_n.append(var15);
                    StringBuilder discarded$13 = field_n.append(62);
                ...
                case 9: {
                    param2[var11] = field_n.toString().substring(var5, field_n.length());
                    var11++;
                    var5 = field_n.length();
                    var4 = 0;
                    var6 = -1;
                ...
                case 13: {
                    var4 = var4 + ((hc) this).field_L[(var10 << 8) + 60];
                    statePc = 14;
                    continue stateLoop;
                }
                case 14: {
                ...
                case 18: {
                    var4 = var4 + ((hc) this).field_L[(var10 << 8) + 62];
                    statePc = 19;
                    continue stateLoop;
                }
                case 19: {
                ...
                case 23: {
                    var4 = var4 + ((hc) this).field_L[(var10 << 8) + 160];
                    statePc = 24;
                    continue stateLoop;
                }
                case 24: {
                ...
                case 28: {
                    var4 = var4 + ((hc) this).field_L[(var10 << 8) + 173];
                    statePc = 29;
                    continue stateLoop;
                }
                case 29: {
                ...
                case 33: {
                    var4 = var4 + ((hc) this).field_L[(var10 << 8) + 215];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
                ...
                case 38: {
                    var4 = var4 + ((hc) this).field_L[(var10 << 8) + 128];
                    statePc = 39;
                    continue stateLoop;
                }
                case 39: {
                ...
                case 43: {
                    var4 = var4 + ((hc) this).field_L[(var10 << 8) + 169];
                    statePc = 44;
                    continue stateLoop;
                }
                case 44: {
                ...
                case 48: {
                    var4 = var4 + ((hc) this).field_L[(var10 << 8) + 174];
                    statePc = 49;
                    continue stateLoop;
                }
                case 49: {
                ...
                case 58: {
                    StringBuilder discarded$14 = field_n.append(var14);
                ...
                case 60: {
                    var4 = var4 + ((hc) this).field_L[(var10 << 8) + var14];
                    statePc = 61;
                    continue stateLoop;
                }
                case 61: {
                ...
                case 70: {
                    param2[var11] = field_n.toString().substring(var5, var6 - var8);
                    var11++;
                    var5 = var6;
                    var6 = -1;
                    var4 = var4 - var7;
    ...
    final int a(String param0, int param1, int param2) {
        if (param2 == 0) {
            param2 = ((hc) this).field_w;
        }
        int var4 = ((hc) this).a(param0, new int[1], field_A);
        int var5 = (var4 - 1) * param2;
        return ((hc) this).field_I + var5 + ((hc) this).field_D;
    }

    final int a(String param0, int param1) {
        return ((hc) this).a(param0, new int[1], field_A);
    }
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_r = (param1 - ((hc) this).a(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    final int a(String param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 31: {
                    var7 = (char)(ae.a((char) var7, -110) & 255);
                    var4 = var4 + ((hc) this).field_p[var7];
                    if (((hc) this).field_L == null) {
                        statePc = 34;
                    } else {
                        statePc = 32;
                ...
                case 33: {
                    var4 = var4 + ((hc) this).field_L[(var3 << 8) + var7];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
    ...
    final void a(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.b(param0, param1 - ((hc) this).a(param0), param2);
    }
            ...
            switch (statePc) {
                ...
                case 23: {
                    try {
                        ...
                        var11_ref = ((hc) this).field_u[var10];
                ...
                case 24: {
                    try {
                        stackOut_24_0 = ((hc) this).field_s[var10];
                ...
                case 25: {
                    try {
                        stackOut_25_0 = ((df) var11_ref).field_a;
                ...
                case 27: {
                    try {
                        var11_ref.a(param1, param2 + ((hc) this).field_w - var12);
                        statePc = 29;
                        continue stateLoop;
                    } catch (Throwable stateCaught_27) {
                        caughtException = stateCaught_27;
                ...
                case 28: {
                    try {
                        var11_ref.a(param1, param2 + ((hc) this).field_w - var12, field_x);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 29: {
                    try {
                        param1 = param1 + ((df) var11_ref).field_h;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
                ...
                case 35: {
                    var8 = (char)(ae.a((char) var8, -107) & 255);
                    if (((hc) this).field_L == null) {
                        statePc = 38;
                    } else {
                        statePc = 36;
                ...
                case 37: {
                    param1 = param1 + ((hc) this).field_L[(var5 << 8) + var8];
                    statePc = 38;
                    continue stateLoop;
                }
                case 38: {
                    var9 = ((hc) this).field_t[var8];
                    var10 = ((hc) this).field_z[var8];
                    var11 = param1;
                    if (var8 == 32) {
                        statePc = 46;
                    } else {
                ...
                case 41: {
                    ((hc) this).a(var8, param1 + ((hc) this).field_B[var8] + 1, param2 + ((hc) this).field_H[var8] + 1, var9, var10, field_F, true);
                    statePc = 42;
                    continue stateLoop;
                }
                case 42: {
                    ((hc) this).a(var8, param1 + ((hc) this).field_B[var8], param2 + ((hc) this).field_H[var8], var9, var10, field_y, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 43: {
                ...
                case 44: {
                    ((hc) this).a(var8, param1 + ((hc) this).field_B[var8] + 1, param2 + ((hc) this).field_H[var8] + 1, var9, var10, field_F, field_x, true);
                    statePc = 45;
                    continue stateLoop;
                }
                case 45: {
                    ((hc) this).a(var8, param1 + ((hc) this).field_B[var8], param2 + ((hc) this).field_H[var8], var9, var10, field_y, field_x, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 46: {
                ...
                case 48: {
                    param1 = param1 + ((hc) this).field_p[var8];
                    if (field_G == -1) {
                        statePc = 50;
                    } else {
                        statePc = 49;
                ...
                case 49: {
                    vp.b(var11, param2 + (int)((double)((hc) this).field_w * 0.7), param1 - var11, field_G);
                    statePc = 50;
                    continue stateLoop;
                }
                case 50: {
                ...
                case 51: {
                    vp.b(var11, param2 + ((hc) this).field_w + 1, param1 - var11, field_q);
                    statePc = 52;
                    continue stateLoop;
                }
                case 52: {
    ...
    hc(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((hc) this).field_w = 0;
        ((hc) this).field_B = param1;
        ((hc) this).field_H = param2;
        ((hc) this).field_t = param3;
        ((hc) this).field_z = param4;
        this.a(param0);
        var6 = 2147483647;
        var7 = -2147483648;
        var8 = 0;
        L0: while (true) {
          if (var8 >= 256) {
            ((hc) this).field_I = ((hc) this).field_w - var6;
            ((hc) this).field_D = var7 - ((hc) this).field_w;
            ((hc) this).field_C = ((hc) this).field_w - ((hc) this).field_H[88];
          } else {
            L1: {
              if (((hc) this).field_H[var8] >= var6) {
                break L1;
              } else {
                if (((hc) this).field_z[var8] == 0) {
                  break L1;
                } else {
                  var6 = ((hc) this).field_H[var8];
                  break L1;
                }
              }
            }
            if (((hc) this).field_H[var8] + ((hc) this).field_z[var8] > var7) {
              var7 = ((hc) this).field_H[var8] + ((hc) this).field_z[var8];
              var8++;
              continue L0;
            } else {
              var8++;
    ...
    final void c(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.b(param0, param1 - ((hc) this).a(param0) / 2, param2);
    }
