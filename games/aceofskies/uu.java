    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, ll[] param6, int param7, int param8, int param9, ll[] param10, int param11, int param12, hc param13, ll[] param14, hc param15, int param16, int param17, int param18, int param19, int param20) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("uu.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
          ...
          L3: {
            ...
            stackOut_6_1 = ((StringBuilder) (Object) stackIn_6_1).append(stackIn_6_2).append(',').append(param7).append(',').append(param8).append(',').append(param9).append(',');
          ...
          L4: {
            ...
            stackOut_9_1 = ((StringBuilder) (Object) stackIn_9_1).append(stackIn_9_2).append(',').append(param11).append(',').append(param12).append(',');
          ...
          throw pn.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + ',' + param16 + ',' + param17 + ',' + param18 + ',' + param19 + ',' + param20 + ')');
        }
    }
    ...
    final pt a(String param0, int param1) {
        ...
        try {
          L0: {
            ...
            L2: {
              if (((uu) this).field_f instanceof mc) {
                var3 = ((mc) (Object) ((uu) this).field_f).a(0);
                if (var3 == null) {
                  break L2;
                } else {
                  if (var3.b(true) != fd.field_a) {
                    stackOut_7_0 = bt.field_a;
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("uu.DA(");
            stackIn_15_0 = stackOut_13_0;
            stackIn_15_1 = stackOut_13_1;
    ...
    final String a(String param0, byte param1) {
        ...
        try {
          L0: {
            L1: {
              if (param1 == 72) {
                ...
                var4 = null;
                String discarded$2 = ((uu) this).a((String) null, (byte) -99);
                break L1;
              }
            }
            L2: {
              if (!(((uu) this).field_f instanceof mc)) {
                ...
                var3 = ((mc) (Object) ((uu) this).field_f).a(param1 ^ 72);
                if (var3 == null) {
                  break L2;
                } else {
                  L3: {
          ...
          L4: {
            ...
            stackOut_15_1 = new StringBuilder().append("uu.EA(");
            stackIn_17_0 = stackOut_15_0;
            stackIn_17_1 = stackOut_15_1;
            stackIn_16_0 = stackOut_15_0;
            stackIn_16_1 = stackOut_15_1;
