...
class nr extends rt {
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              stackOut_16_0 = param7 ^ -1;
              stackIn_17_0 = stackOut_16_0;
              break L2;
            }
            L7: {
              if (stackIn_17_0 != (param9 ^ -1)) {
            ...
            L8: {
              jaggl.OpenGL.glTexSubImage2Dub(this.field_f, 0, param4, param0, param9, param6, param8, 5121, param1, param2);
              if (param7 == param9) {
                break L8;
              } else {
          ...
          L9: {
            ...
            stackOut_26_1 = new StringBuilder().append("nr.C(").append(param0).append(',');
          ...
          throw pn.a((Throwable) ((Object) stackIn_29_0), stackIn_29_2 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ',' + param9 + ')');
        }
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              this.field_j.a((rt) (this), 1);
              stackOut_15_0 = param0 ^ -1;
              stackIn_16_0 = stackOut_15_0;
              break L2;
            }
            L7: {
              if (stackIn_16_0 != (param8 ^ -1)) {
            ...
            L8: {
              jaggl.OpenGL.glTexSubImage2Di(this.field_f, 0, param4, -param2 + this.field_k + -param1, param0, param2, 32993, this.field_j.field_tb, param5, param6);
              if (param8 != param0) {
                jaggl.OpenGL.glPixelStorei(3314, 0);
                break L8;
              } else {
          ...
          L9: {
            ...
            stackOut_25_1 = new StringBuilder().append("nr.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',');
          ...
          throw pn.a((Throwable) ((Object) stackIn_28_0), stackIn_28_2 + ',' + param6 + ',' + param7 + ',' + param8 + ')');
        }
    }
    ...
    final void a(int param0, int param1, int param2, int param3) {
        int[] var6 = null;
        jaggl.OpenGL.glFramebufferTexture2DEXT(param3, param0, this.field_f, this.field_d, param2);
        this.field_l = param3;
        if (param1 != 0) {
          var6 = (int[]) null;
          this.a(100, -69, 53, true, 65, (int[]) null, 57, (byte) -105, -113);
          this.field_n = param0;
          return;
        } else {
          this.field_n = param0;
        ...
        try {
          L0: {
            ...
            L6: {
              L7: {
                L8: {
                  if (stackIn_13_0 == (this.field_f ^ -1)) {
                    break L8;
                  } else {
                    if (!param5) {
                      break L8;
                ...
                jaggl.OpenGL.glPixelStorei(3314, param7);
                jaggl.OpenGL.glTexImage2Di(this.field_f, 0, this.field_b, this.field_m, this.field_k, 0, 32993, this.field_j.field_tb, param6, 4 * param8);
                jaggl.OpenGL.glPixelStorei(3314, 0);
                this.a(false, false);
                if (var16 == 0) {
                  break L6;
              ...
              fg.a(this.field_m, this.field_k, this.field_f, 32993, 72, param6, this.field_j.field_tb, this.field_b);
              this.a(true, false);
              break L6;
            }
            this.a(true, -128);
          ...
          L10: {
            ...
            stackOut_24_1 = ((StringBuilder) (Object) stackIn_24_1).append(stackIn_24_2).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
          ...
          throw pn.a((Throwable) ((Object) stackIn_27_0), stackIn_27_2 + ',' + param7 + ',' + param8 + ',' + param9 + ')');
        }
    }

    public final void a(byte param0) {
        jaggl.OpenGL.glFramebufferTexture2DEXT(this.field_l, this.field_n, this.field_f, 0, 0);
        if (param0 != 11) {
          this.a(false, 38, false);
          this.field_l = -1;
          this.field_n = -1;
          return;
        } else {
    ...
    nr(wl param0, int param1, int param2, int param3, int param4, boolean param5, byte[] param6, int param7, boolean param8) {
        ...
        try {
          L0: {
            ...
            L6: {
              L7: {
                ...
                jaggl.OpenGL.glTexImage2Dub(this.field_f, 0, this.field_b, this.field_m, this.field_k, 0, param7, 5121, param6, 0);
                this.a(false, false);
                if (var15 == 0) {
                  break L6;
                } else {
          ...
          L10: {
            stackOut_22_0 = (RuntimeException) ((Object) stackIn_22_0);
            stackOut_22_1 = ((StringBuilder) (Object) stackIn_22_1).append(stackIn_22_2).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
            stackIn_24_0 = stackOut_22_0;
            stackIn_24_1 = stackOut_22_1;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        if (param6 <= 79) {
          ...
          var8 = -param3 + -param0 + this.field_j.field_bb;
          this.field_j.a((rt) (this), 1);
          jaggl.OpenGL.glCopyTexSubImage2D(this.field_f, 0, param4, this.field_k + (-param2 - param3), param1, var8, param5, param3);
        ...
        try {
          L0: {
            L1: {
              ...
              jaggl.OpenGL.glTexImage2Df(this.field_f, 0, this.field_b, this.field_m, this.field_k, 0, param7, 5126, param6, 0);
              this.a(false, false);
              break L1;
            }
            this.a(true, -128);
    ...
    nr(wl param0, int param1, int param2, int param3, int param4) {
        ...
        try {
            ...
            this.field_m = param3;
            this.field_j.a((rt) (this), 1);
            jaggl.OpenGL.glTexImage2Dub(this.field_f, 0, this.field_b, param3, param4, 0, ia.a(this.field_b, -16445), 5121, (byte[]) null, 0);
            this.a(true, -128);
    ...
    final static void a(int[] param0, boolean param1, byte[] param2, int param3, int param4) {
        ...
        try {
          ...
          throw pn.a((Throwable) ((Object) stackIn_21_0), stackIn_21_2 + ',' + param3 + ',' + param4 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return;
        } else {
