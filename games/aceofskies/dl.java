...
final class dl extends rb {
        ...
        if (ag.field_s > 0) {
          ...
          L0: while (true) {
            if (ag.field_s > var2) {
              ...
              if (param0 != 65) {
                String discarded$2 = dl.k((byte) -78);
                return var1;
              } else {
                return var1;
              }
          ...
          if (param0 != 65) {
            String discarded$3 = dl.k((byte) -78);
            return var6;
          } else {
            return var6;
          }
    ...
    final int b(byte param0, int param1) {
        ...
        int var3 = ((dl) this).field_q >> 3;
        int var4 = 8 - (((dl) this).field_q & 7);
        ...
        while (param1 > var4) {
            ...
            var3++;
            var5 = var5 + ((kp.field_f[var4] & ((dl) this).field_f[incrementValue$0]) << param1 + -var4);
            param1 = param1 - var4;
            var4 = 8;
        }
        if (param1 == var4) {
