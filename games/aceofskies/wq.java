    ...
    final static el a(wl param0, int param1, int param2, boolean param3, int param4, int param5, int param6, byte[] param7) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_14_1 = ((StringBuilder) (Object) stackIn_14_1).append(stackIn_14_2).append(',').append(param1).append(',').append(param2).append(',').append(false).append(',').append(6406).append(',').append(6406).append(',').append(9980).append(',');
