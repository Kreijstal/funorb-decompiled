...
final class fl {
    ...
    final void a(float[] param0, int param1, boolean param2) {
        ...
        L0: while (true) {
          if (var4 >= param1) {
            if (!param2) {
              var4 = t.field_q[this.field_d].field_b;
                    ...
                    if (var9 >= var6) {
                      ...
                      L3: {
                        if (var8 != 0) {
                          ...
                          var10 = t.field_q[this.field_d].a();
                          var11 = var4 - 1;
                          L4: while (true) {
                            if (var11 < 0) {
                              break L3;
    ...
    fl() {
        ...
        this.field_c = t.d(24);
        this.field_a = t.d(24);
        this.field_e = t.d(24) + 1;
        this.field_f = t.d(6) + 1;
        this.field_d = t.d(8);
        ...
        while (var6 < this.field_f * 8) {
            this.field_g[var6] = (var1[var6 >> 3] & 1 << (var6 & 7)) != 0 ? t.d(8) : -1;
            var6++;
        }
    }
}
