...
final class su extends rf {
    ...
    private final static int d(int param0, int param1, byte[] param2, int[] param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, su param11, int param12, int param13) {
        ...
        L0: {
          L1: {
            param11.field_i = param11.field_i - param11.field_k * param5;
            param11.field_p = param11.field_p - param11.field_o * param5;
            if (param12 == 0) {
              break L1;
            } else {
    ...
    private final static int b(int param0, byte[] param1, int[] param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, su param12) {
        ...
        param12.field_j = param12.field_j + param12.field_l * (param9 - param4);
        param4 = param4 << 1;
        param9 = param9 << 1;
        param9 -= 6;
        L1: while (true) {
    ...
    private final void k() {
        ...
        this.field_i = su.b(this.field_u, this.field_q);
        this.field_p = su.c(this.field_u, this.field_q);
    }
    ...
    private final static int b(byte[] param0, int[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, su param9) {
        ...
        param9.field_i = param9.field_i + param9.field_k * (param6 - param3);
        param9.field_p = param9.field_p + param9.field_o * (param6 - param3);
        param6 -= 3;
        L1: while (true) {
          if (param3 >= param6) {
            param6 += 3;
        ...
        if (param0 != 0) {
          if (this.field_i == 0) {
            if (this.field_p == 0) {
              ...
              this.field_l = -this.field_j / param0;
              this.field_k = -this.field_i / param0;
              this.field_o = -this.field_p / param0;
              return;
            }
          } else {
            L6: {
        ...
        if (param0 != 0) {
          ...
          if (this.field_i == var4) {
            if (this.field_p == var5) {
              ...
              L0: {
                var6 = param1 - this.field_j;
                if (this.field_j - param1 <= var6) {
                  break L0;
                } else {
              ...
              L1: {
                if (var4 - this.field_i <= var6) {
                  ...
                  var6 = var4 - this.field_i;
                  break L1;
                }
              }
              L2: {
                if (this.field_i - var4 <= var6) {
                  break L2;
                } else {
                  var6 = this.field_i - var4;
                  break L2;
                }
              }
              L3: {
                if (var5 - this.field_p <= var6) {
                  break L3;
                } else {
                  var6 = var5 - this.field_p;
                  break L3;
                }
              }
              L4: {
                if (this.field_p - var5 <= var6) {
                  break L4;
                } else {
              ...
              this.field_u = param1;
              this.field_q = param2;
              this.field_l = (param1 - this.field_j) / param0;
              this.field_k = (var4 - this.field_i) / param0;
              this.field_o = (var5 - this.field_p) / param0;
              return;
            }
          } else {
            L6: {
        ...
        L0: while (true) {
          if (this.field_w <= 0) {
            L1: {
              if (this.field_r != 256) {
                ...
                if ((this.field_v & 255) != 0) {
                  ...
                  if (tk.field_r) {
                    return su.b(0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_i, this.field_p, 0, param3, param2, (su) (this));
                  } else {
                    return su.a(((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_j, 0, param3, param2, (su) (this));
                  }
                }
              }
            }
            if (tk.field_r) {
              return su.a(0, 0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_i, this.field_p, 0, param3, param2, (su) (this), this.field_r, param4);
            } else {
              return su.a(0, 0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_j, 0, param3, param2, (su) (this), this.field_r, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_r != 256) {
                  ...
                  if ((this.field_v & 255) != 0) {
                    ...
                    if (!tk.field_r) {
                      param1 = su.a(((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_j, this.field_l, 0, var6, param2, (su) (this));
                      break L3;
                    } else {
                      param1 = su.a(0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_i, this.field_p, this.field_k, this.field_o, 0, var6, param2, (su) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!tk.field_r) {
                param1 = su.c(0, 0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_j, this.field_l, 0, var6, param2, (su) (this), this.field_r, param4);
                break L3;
              } else {
                param1 = su.b(0, 0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_i, this.field_p, this.field_k, this.field_o, 0, var6, param2, (su) (this), this.field_r, param4);
                break L3;
              }
            }
            this.field_w = this.field_w - param1;
    ...
    private final boolean h() {
        ...
        L0: {
          var1 = this.field_u;
          if (var1 != -2147483648) {
            var2 = su.b(var1, this.field_q);
            var3 = su.c(var1, this.field_q);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_j >= var1) {
            if (this.field_j <= var1) {
              ...
              this.field_l = -1;
              this.field_w = this.field_j - var1;
              break L2;
            }
          } else {
            this.field_l = 1;
            this.field_w = var1 - this.field_j;
            break L2;
          }
        }
        L3: {
          if (this.field_i >= var2) {
            if (this.field_i <= var2) {
              ...
              L4: {
                ...
                if (this.field_w == 0) {
                  ...
                  if (this.field_w <= this.field_i - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_w = this.field_i - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_w == 0) {
                ...
                if (this.field_w <= var2 - this.field_i) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_w = var2 - this.field_i;
            break L3;
          }
        }
        if (this.field_p < var3) {
          this.field_o = 1;
          if (this.field_w != 0) {
            if (this.field_w > var3 - this.field_p) {
              this.field_w = var3 - this.field_p;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_p <= var3) {
              ...
              L7: {
                ...
                if (this.field_w == 0) {
                  ...
                  if (this.field_w <= this.field_p - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_w = this.field_p - var3;
              break L6;
            }
          }
          return false;
    ...
    final synchronized void a(int param0) {
        ...
        L0: {
          if (this.field_w <= 0) {
            ...
            if (param0 < this.field_w) {
              this.field_j = this.field_j + this.field_l * param0;
              this.field_i = this.field_i + this.field_k * param0;
              this.field_p = this.field_p + this.field_o * param0;
        ...
        this.field_v = this.field_v + this.field_r * param0;
        if (this.field_n >= 0) {
          L5: {
            if (this.field_n <= 0) {
              break L5;
                  ...
                  if (this.field_r >= 0) {
                    if (this.field_v >= var4) {
                      ...
                      if (var7 < this.field_n) {
                        ...
                        this.field_v = this.field_v - var6 * this.field_n;
                        this.field_n = 0;
                        break L5;
                      }
                    } else {
    ...
    final synchronized void e(int param0) {
        int var2 = ((al) ((Object) this.field_f)).field_g.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
          ...
          L4: {
            if (this.field_n <= 0) {
              ...
              if (!this.field_m) {
                if (this.field_r >= 0) {
                  L5: while (true) {
                    var9 = this.b(param0, var9, var6, param2, (int) var4.field_g[this.field_s]);
                    if (this.field_v >= var6) {
                      var10 = (this.field_v - var5) / var8;
                      if (var10 < this.field_n) {
                        this.field_v = this.field_v - var8 * var10;
                        this.field_n = this.field_n - var10;
                        continue L5;
                      } else {
                        this.field_v = this.field_v - var8 * this.field_n;
                        this.field_n = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_g[this.field_t - 1]);
                    if (this.field_v < var5) {
                ...
                L7: {
                  if (this.field_r >= 0) {
                    ...
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_g[this.field_s]);
                    if (this.field_v < var5) {
                ...
                L8: while (true) {
                  var9 = this.b(param0, var9, var6, param2, (int) var4.field_g[this.field_t - 1]);
                  if (this.field_v >= var6) {
    ...
    final synchronized boolean f() {
        return this.field_v < 0 || this.field_v >= ((al) ((Object) this.field_f)).field_g.length << 8;
    }
        ...
        L0: while (true) {
          if (this.field_w <= 0) {
            L1: {
              if (this.field_r != -256) {
                ...
                if ((this.field_v & 255) != 0) {
                  ...
                  if (tk.field_r) {
                    return su.a(0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_i, this.field_p, 0, param3, param2, (su) (this));
                  } else {
                    return su.b(((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_j, 0, param3, param2, (su) (this));
                  }
                }
              }
            }
            if (tk.field_r) {
              return su.b(0, 0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_i, this.field_p, 0, param3, param2, (su) (this), this.field_r, param4);
            } else {
              return su.b(0, 0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_j, 0, param3, param2, (su) (this), this.field_r, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_w;
            ...
            L3: {
              L4: {
                ...
                if (this.field_r != -256) {
                  ...
                  if ((this.field_v & 255) != 0) {
                    ...
                    if (!tk.field_r) {
                      param1 = su.b(((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_j, this.field_l, 0, var6, param2, (su) (this));
                      break L3;
                    } else {
                      param1 = su.b(0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_i, this.field_p, this.field_k, this.field_o, 0, var6, param2, (su) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!tk.field_r) {
                param1 = su.d(0, 0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_j, this.field_l, 0, var6, param2, (su) (this), this.field_r, param4);
                break L3;
              } else {
                param1 = su.a(0, 0, ((al) ((Object) this.field_f)).field_g, param0, this.field_v, param1, this.field_i, this.field_p, this.field_k, this.field_o, 0, var6, param2, (su) (this), this.field_r, param4);
                break L3;
              }
            }
            this.field_w = this.field_w - param1;
    ...
    final int c() {
        int var1 = this.field_j * 3 >> 6;
        var1 = (var1 ^ var1 >> 31) + (var1 >>> 31);
        if (this.field_n == 0) {
            var1 = var1 - var1 * this.field_v / (((al) ((Object) this.field_f)).field_g.length << 8);
        } else {
            if (this.field_n >= 0) {
                var1 = var1 - var1 * this.field_s / ((al) ((Object) this.field_f)).field_g.length;
            }
        }
    ...
    private final static int a(int param0, int param1, byte[] param2, int[] param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, su param13, int param14, int param15) {
        ...
        L0: {
          L1: {
            param13.field_j = param13.field_j - param13.field_l * param5;
            if (param14 == 0) {
              break L1;
            } else {
    ...
    private su(al param0, int param1, int param2) {
        this.field_f = (gs) ((Object) param0);
        this.field_s = param0.field_h;
        this.field_t = param0.field_j;
        this.field_m = param0.field_f;
        this.field_r = param1;
        this.field_u = param2;
        this.field_q = 8192;
        this.field_v = 0;
