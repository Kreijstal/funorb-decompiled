    ...
    final static String a(CharSequence param0, boolean param1, byte param2) {
        ...
        try {
                                  ...
                                  if (param0.length() <= var6) {
                                    L5: {
                                      if (param2 == 21) {
                                        ...
                                        ls.a((CharSequence) null, true, (byte) -120);
                                        break L5;
                                      }
                                    }
                                    if (var5 > 0) {
                                      stackIn_35_0 = hd.field_a;
          ...
          L8: {
            ...
            stackIn_38_1 = new StringBuilder().append("ls.A(");
