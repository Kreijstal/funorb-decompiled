...
final class ar {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_k[var16];
                  var10 = field_c[var16] * this.field_a;
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_d, 0, field_k, 0, var2);
        ...
        for (var6 = 0; var6 < this.field_j.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = t.field_q[this.field_b[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = this.field_i[var7][var11 & var10];
                var11 = var11 >>> var9;
            ...
            if (var4 >= var2) {
              ...
              L1: while (true) {
                if (var4 >= var3) {
                    ...
                    if (var6 >= var2) {
                      ...
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= this.field_e[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              incrementValue$2 = var5;
                              var5++;
                              this.field_d[incrementValue$2] = t.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_e[this.field_j[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    this.field_e[var4] = t.d(3) + 1;
                    dupTemp$3 = t.d(2);
                    this.field_h[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      this.field_b[var4] = t.d(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
