...
final class ar {
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_g[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_g[var11];
        }
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((ar) this).field_d.length;
        var4 = field_l[((ar) this).field_a - 1];
        var5 = field_f;
        field_f[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_c[0] * ((ar) this).field_a;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_k[var16];
                  var10 = field_c[var16] * ((ar) this).field_a;
            ...
            L3: {
              var7 = ar.a(field_k, var6);
              var8_int = ar.b(field_k, var6);
              var9 = this.a(field_k[var7], field_c[var7], field_k[var8_int], field_c[var8_int], field_k[var6]);
              var10 = field_c[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
            ...
            if (var10 == 0) {
              ...
              var14 = field_f;
              var15 = var7;
              field_f[var8_int] = true;
              var14[var15] = true;
              field_f[var6] = true;
              if (var10 < var13) {
                L4: {
                  stackOut_11_0 = (int[]) field_c;
                  stackOut_11_1 = var6;
    ...
    final boolean a() {
        ...
        int var2 = ((ar) this).field_d.length;
        System.arraycopy((Object) (Object) ((ar) this).field_d, 0, (Object) (Object) field_k, 0, var2);
        int var3 = field_l[((ar) this).field_a - 1];
        int var4 = ek.a((byte) 125, var3 - 1);
        field_c[0] = t.d(var4);
        field_c[1] = t.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((ar) this).field_j.length; var6++) {
            var7 = ((ar) this).field_j[var6];
            var8 = ((ar) this).field_e[var7];
            var9 = ((ar) this).field_h[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = t.field_q[((ar) this).field_b[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((ar) this).field_i[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_c[incrementValue$0] = var13 >= 0 ? t.field_q[var13].a() : 0;
            }
        }
        return true;
    }
        ...
        if (param0 < param1) {
          ...
          L0: while (true) {
            if (var7 > param1) {
              ...
              if (var8 < var4) {
                field_k[var3] = var8;
                field_c[var3] = field_c[var7];
                field_f[var3] = field_f[var7];
                var3++;
                field_k[var7] = field_k[var3];
                field_c[var7] = field_c[var3];
                field_f[var7] = field_f[var3];
                var7++;
                continue L0;
              } else {
                var7++;
    ...
    ar() {
        ...
        if (var1 == 1) {
          var2 = t.d(5);
          var3 = 0;
          ((ar) this).field_j = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((ar) this).field_e = new int[var3];
              ((ar) this).field_h = new int[var3];
              ((ar) this).field_b = new int[var3];
              ((ar) this).field_i = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((ar) this).field_a = t.d(2) + 1;
                  var4 = t.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((ar) this).field_d = new int[var5];
                      ((ar) this).field_d[0] = 0;
                      ((ar) this).field_d[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((ar) this).field_e[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((ar) this).field_d[incrementValue$2] = t.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((ar) this).field_e[((ar) this).field_j[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((ar) this).field_e[var4] = t.d(3) + 1;
                    int dupTemp$3 = t.d(2);
                    ((ar) this).field_h[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((ar) this).field_b[var4] = t.d(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
