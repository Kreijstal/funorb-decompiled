...
final class ak extends RuntimeException {
    ...
    public static void a(boolean param0) {
        ...
        if (param0) {
          var2 = (int[]) null;
          discarded$2 = ak.a(-20, (wp) null, (int[]) null);
          field_f = null;
          return;
        } else {
          field_f = null;
    ...
    final static void a(ga param0, boolean param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("ak.C(");
    ...
    final static wp a(int param0, wp param1, int[] param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("ak.B(").append(param0).append(',');
