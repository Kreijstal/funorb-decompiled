    ...
    final boolean a(vu param0, int param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("sn.D(");
    ...
    final static String a(String param0, int param1, String[] param2) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_29_1 = new StringBuilder().append("sn.C(");
          ...
          L0: {
            L1: {
              if (param0 == -73) {
                ...
                var4 = null;
                boolean discarded$2 = ((sn) this).a((vu) null, 115);
                break L1;
              }
            }
            L2: {
              if (((sn) this).field_d != param1.field_d) {
                stackOut_4_0 = 0;
