                            ...
                            if (var7 >= var15) {
                              ...
                              L33: while (true) {
                                if (var7 >= var15) {
                                  ...
                                  var7++;
                                  var8++;
                                  var13[var7] = ((jg) this).field_E[var8];
                                  continue L33;
                                }
                              }
                            } else {
                        ...
                        if (var20 >= 0) {
                          ...
                          L40: while (true) {
                            if (var22 >= 0) {
                              ...
                              var16++;
                              var18[var16] = ((jg) this).field_E[(var9 >> 16) + var21];
                              var9 = var9 + var14;
                              var22++;
                              continue L40;
                            }
    ...
    jg(kj param0, int[] param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        for (var9 = 0; var9 < param5; var9++) {
            for (var10 = 0; var10 < param4; var10++) {
                var8++;
                param2++;
                ((jg) this).field_E[var8] = param1[param2];
            }
