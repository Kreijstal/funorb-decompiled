...
public final class IDirect3DDevice extends jaclib.peer.IUnknown {
    ...
    public final jagdx.IDirect3DCubeTexture a(int param0, int param1, int param2, int param3, int param4) {
        jagdx.IDirect3DCubeTexture var6 = new jagdx.IDirect3DCubeTexture(((jagdx.IDirect3DDevice) this).b);
        int var7 = ((jagdx.IDirect3DDevice) this)._CreateCubeTexture(param0, param1, param2, param3, param4, var6);
    ...
    public final jagdx.IDirect3DSurface b() {
        jagdx.IDirect3DSurface var1 = new jagdx.IDirect3DSurface(((jagdx.IDirect3DDevice) this).b);
    ...
    public final jagdx.IDirect3DPixelShader a(byte[] param0) {
        ...
        jagdx.IDirect3DPixelShader var2 = new jagdx.IDirect3DPixelShader(((jagdx.IDirect3DDevice) this).b);
        int var3 = ((jagdx.IDirect3DDevice) this)._CreatePixelShader(param0, var2);
        if (!(!jagdx.gf.a(-1, var3))) {
            throw new jagdx.ie(String.valueOf(var3));
        }
        return var2;
