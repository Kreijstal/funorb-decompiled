    ...
    final void a(byte param0, rk param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("hj.B(").append(param0).append(',');
    ...
    final static ll a(boolean param0, int param1, int param2, gk param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_7_1 = new StringBuilder().append("hj.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
