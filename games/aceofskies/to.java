...
abstract class to extends ea implements vm {
    ...
    ea i(int param0) {
        ...
        if (param0 != 0) {
            ...
            discarded$0 = to.a(6, (d) null, (java.awt.Canvas) null, 19, -80);
        }
        if (var2 == null) {
            return null;
        }
          ...
          L0: {
            ...
            L2: while (true) {
              if (var5_int > param3) {
                L3: {
                  if (null != this.field_s) {
                    discarded$21 = this.field_s.a(param0, 32462, 1 + param3, param1);
                    break L3;
                  } else {
                    discarded$22 = param0.append("null");
                    break L3;
                  }
                }
                break L0;
    ...
    private final boolean a(byte param0, ea param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("to.EA(").append(param0).append(',');
    ...
    String c(byte param0) {
        ...
        if (param0 > -41) {
            ...
            discarded$0 = this.a((StringBuilder) null, -79, 77, (Hashtable) null);
        }
    ...
    private final boolean a(int param0, ea param1) {
        ...
        try {
          ...
          L4: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) (var3);
            stackOut_8_1 = new StringBuilder().append("to.KA(").append(param0).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
          ...
          L0: {
            L1: {
              if (!param6) {
                ...
                var9 = (ea) null;
                discarded$2 = this.a(-108, -17, '', (ea) null);
                break L1;
              }
            }
            L2: {
