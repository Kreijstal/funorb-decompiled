...
final class il {
                ...
                switch (statePc) {
                    ...
                    case 2: {
                        try {
                            ...
                            if (!((Boolean) (var4_ref.get(this.field_a))).booleanValue()) {
                                statePc = 6;
                            } else {
                                statePc = 3;
                            }
                    ...
                    case 3: {
                        try {
                            var4_ref.set(this.field_a, Boolean.FALSE);
                            var3 = 1;
                            statePc = 6;
                            continue stateLoop;
                    ...
                    case 9: {
                        try {
                            var4_ref = Class.forName("sun.awt.Win32GraphicsDevice").getDeclaredField("valid");
                            var4_ref.set(this.field_a, Boolean.TRUE);
                            statePc = 19;
                            continue stateLoop;
                    ...
                    case 15: {
                        try {
                            ...
                            var7_ref.set(this.field_a, Boolean.TRUE);
                            statePc = 18;
                            continue stateLoop;
                    ...
                    case 18: {
                        throw il.<RuntimeException>$cfr$sneakyThrow(var6);
                    }
                    case 19: {
                        return;
                    }
    ...
    public il() throws Exception {
        ...
        if (this.field_a.isFullScreenSupported()) {
          ...
          L0: while (true) {
            if (var4 >= var3.length) {
              throw il.<RuntimeException>$cfr$sneakyThrow(new Exception());
            } else {
              var5 = var3[var4];
              if (var5 != null) {
