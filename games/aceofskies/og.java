...
final class og extends ib implements qi {
    ...
    public final void a(byte param0) {
        ((og) this).field_c.a((og) this, 87);
        if (param0 != -50) {
            int discarded$0 = ((og) this).b((byte) -21);
        }
    }
    ...
    og(kr param0, hd param1, int param2, int param3, boolean param4, byte[] param5, int param6, int param7) {
        ...
        L2: {
          if (!((og) this).field_c.field_Dc) {
            ((og) this).field_f = fk.a(param2, 63);
            ((og) this).field_h = fk.a(param3, 69);
            break L2;
          } else {
            ((og) this).field_h = param3;
            ((og) this).field_f = param2;
            break L2;
          }
        }
        L3: {
          if (!param4) {
            ((og) this).field_i = ((og) this).field_c.field_Rc.a(((og) this).field_f, ((og) this).field_h, 1, 0, kr.a(((og) this).field_e, la.field_h, false), 1);
            break L3;
          } else {
            ((og) this).field_i = ((og) this).field_c.field_Rc.a(((og) this).field_f, ((og) this).field_h, 0, 1024, kr.a(((og) this).field_e, la.field_h, false), 1);
            break L3;
          }
        }
        L4: {
          var13 = ((og) this).field_c.field_Ec;
          var10 = ((og) this).field_i.LockRect(0, 0, 0, param2, param3, 0, var13);
          if (!jagdx.gf.a((byte) 111, var10)) {
            ...
            param2 = param2 * ((og) this).field_e.field_b;
            param7 = param7 * ((og) this).field_e.field_b;
    ...
    public final int b(byte param0) {
        ...
        return ((og) this).field_h;
    }

    final jagdx.IDirect3DBaseTexture b(int param0) {
        if (param0 < 87) {
            ((og) this).field_j = false;
            return (jagdx.IDirect3DBaseTexture) (Object) ((og) this).field_i;
        }
        return (jagdx.IDirect3DBaseTexture) (Object) ((og) this).field_i;
    }
    ...
    public final float a(int param0, float param1) {
        if (param0 < 65) {
            ((og) this).field_g = true;
            return param1 / (float)((og) this).field_f;
        }
        return param1 / (float)((og) this).field_f;
    }
    ...
    og(kr param0, hd param1, la param2, int param3, int param4) {
        ...
        if (!((og) this).field_c.field_Dc) {
            ((og) this).field_f = fk.a(param3, 118);
            ((og) this).field_h = fk.a(param4, 61);
        } else {
            ((og) this).field_f = param3;
            ((og) this).field_h = param4;
        }
        ((og) this).field_i = ((og) this).field_c.field_Rc.a(param3, param4, 1, 0, kr.a(((og) this).field_e, ((og) this).field_d, false), 1);
    }
    ...
    og(kr param0, int param1, int param2, boolean param3, int[] param4, int param5, int param6) {
        ...
        L2: {
          if (((og) this).field_c.field_Dc) {
            ...
            ((og) this).field_f = fk.a(param1, 91);
            ((og) this).field_h = fk.a(param2, 22);
            break L2;
          }
        }
        L3: {
          if (!param3) {
            ((og) this).field_i = ((og) this).field_c.field_Rc.a(((og) this).field_f, ((og) this).field_h, 1, 0, 21, 1);
            break L3;
          } else {
            ((og) this).field_i = ((og) this).field_c.field_Rc.a(((og) this).field_f, ((og) this).field_h, 0, 1024, 21, 1);
            break L3;
          }
        }
    ...
    public final void a(boolean param0, boolean param1, byte param2) {
        ...
        if (param2 != -127) {
          L1: {
            boolean discarded$11 = ((og) this).c((byte) -41);
            stackOut_8_0 = this;
