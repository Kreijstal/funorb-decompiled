            ...
            if (!q.field_k[var2]) {
              ...
              L2: while (true) {
                if (var3 <= var7) {
                  ...
                  var6_ref_int__[var7] = vo.a(pg.a(-16777216, var23[var7] << -1927948328), ud.field_e[pg.a(255, (int) var24[var7])]);
                  var7++;
                  continue L2;
                }
              }
            ...
            stateLoop: while (true) {
                switch (statePc) {
                    case 0: {
                        ...
                        var6 = (Object) (Object) ((bl) this).field_f;
                        // monitorenter ((bl) this).field_f
                        statePc = 1;
                        continue stateLoop;
                    }
                    ...
                    case 2: {
                        try {
                            var7_int = (int)((519L + ((bl) this).field_f.c(param4 + -109)) / 520L);
                            if (var7_int == 0) {
                                statePc = 4;
                            } else {
                                statePc = 3;
                    ...
                    case 5: {
                        try {
                            if ((((bl) this).field_d.c(param4 + 79) ^ -1L) > ((long)(param0 * 6 + 6) ^ -1L)) {
                                statePc = 7;
                            } else {
                                statePc = 6;
                            }
                    ...
                    case 11: {
                        try {
                            if ((((bl) this).field_f.c(116) / 520L ^ -1L) > ((long)var7_int ^ -1L)) {
                                statePc = 13;
                            } else {
                                statePc = 12;
                            }
                    ...
                    case 56: {
                        try {
                            ((bl) this).field_f.a(var11, param3, var8, param4 ^ 101);
                            var8 = var8 + var11;
                            statePc = 60;
                            continue stateLoop;
