...
final class ql extends qi {
    ...
    ql(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        ...
        ((ql) this).field_M = new byte[256][];
        ((ql) this).field_M = param6;
        ((ql) this).field_N = new int[4][];
        ((ql) this).field_N[0] = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  ql.a(0, tc.field_b, ((ql) this).field_M[param0], ((ql) this).field_N[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  fn.a(tc.field_b, ((ql) this).field_M[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  ql.a(0, tc.field_b, ((ql) this).field_M[param0], ((ql) this).field_N[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  fn.a(tc.field_b, ((ql) this).field_M[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
