...
final class ci {
    ...
    final rb a(int param0, boolean param1, int param2, sk param3, sk param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("ci.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final static void b(byte param0) {
        ...
        try {
          ...
          throw kk.a((Throwable) (Object) var1, "ci.D(" + param0 + 41);
        }
    }
