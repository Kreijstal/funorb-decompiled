...
final class s {
    ...
    final void a(float[] param0, int param1, boolean param2) {
        ...
        L0: while (true) {
          if (var4 >= param1) {
            if (!param2) {
              var4 = sn.field_F[this.field_c].field_d;
                    ...
                    if (var9 >= var6) {
                      ...
                      L3: {
                        if (var8 != 0) {
                          ...
                          var10 = sn.field_F[this.field_c].c();
                          var11 = var4 - 1;
                          L4: while (true) {
                            if (var11 < 0) {
                              break L3;
    ...
    s() {
        ...
        int var5 = 0;
        int var2 = 0;
        this.field_f = sn.f(16);
        this.field_a = sn.f(24);
        this.field_e = sn.f(24);
        this.field_d = sn.f(24) + 1;
        this.field_b = sn.f(6) + 1;
        this.field_c = sn.f(8);
        ...
        while (var6 < this.field_b * 8) {
            this.field_g[var6] = (var1[var6 >> 3] & 1 << (var6 & 7)) != 0 ? sn.f(8) : -1;
            var6++;
        }
    }
}
