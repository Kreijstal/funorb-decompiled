...
abstract class oh extends md {
    ...
    final void j(int param0) {
        ...
        if (param0 == -6) {
                                            ...
                                            if (var2 == 13) {
                                              ...
                                              if (var2 != 17) {
                                                if (var2 == 18) {
                                                  ...
                                                  int discarded$16 = 0;
                                                  bl.a((Throwable) null, (byte) -119, "MGS1: " + em.b());
                                                  r.a(-28036);
                                                  break L1;
                                                }
                                              } else {
          ...
          int discarded$19 = 0;
          bl.a((Throwable) null, (byte) 70, "MGS2: " + em.b());
          r.a(-28036);
          return;
        } else {
          return;
            ...
            if (var4 == 0) {
              ...
              L0: {
                if (var4 != 1) {
                  ...
                  L1: {
                    int discarded$11 = 8790;
                    var5_int = sd.a((byte) -124, gi.i(-80), dk.a());
                    if (var5_int != -1) {
              ...
              L2: {
                if (var4 != 2) {
                  ...
                  int discarded$14 = -27;
                  int discarded$15 = 0;
                  var5_int = uf.a(oi.a(), ob.d((byte) -116), (byte) 80, ck.a(), ((oh) this).field_q, tn.d(), ef.c(4));
                  if (var5_int == -1) {
                    break L2;
                  } else {
              ...
              L3: {
                if (var4 == 3) {
                  ...
                  if (!param0) {
                    int discarded$16 = 0;
                    var5_int = v.a(((oh) this).field_w, 1, tn.d(), ef.c(4), false, ((oh) this).field_q);
                    if (var5_int != -1) {
                      if (0 != var5_int) {
    ...
    private final void a(String param0, int param1, int param2, int param3, int param4) {
        ...
        try {
          try {
            L0: {
              if (((oh) this).e(-11)) {
                ...
                ((oh) this).a(param0, 640, param4, 480, (byte) -101, ((oh) this).field_t, 32);
                break L0;
              } else {
                return;
              }
          ...
          L8: {
            ...
            stackOut_22_1 = new StringBuilder().append("oh.N(");
    ...
    final void b(int param0, boolean param1) {
        ...
        L17: {
          if (pf.field_d != 1) {
            ...
            int discarded$30 = 1;
            int discarded$31 = 0;
            ah.field_d = nm.a(true, ig.field_v, -115);
            int discarded$32 = 1;
            int discarded$33 = 0;
            am.field_d = nm.a(true, wd.field_n, -84);
            int discarded$34 = 1;
            int discarded$35 = 0;
            ca.field_p = nm.a(true, en.field_a, -94);
    ...
    final int d(byte param0) {
        ...
        if (!((oh) this).field_b) {
          ...
          if (oa.b()) {
            if (!pj.field_n) {
              int discarded$9 = 0;
              var2 = v.a(((oh) this).field_w, 1, tn.d(), ef.c(4), true, ((oh) this).field_q);
              if (var2 != -1) {
                L0: {
                  if (0 == var2) {
                    break L0;
    ...
    final static int a(el param0, int param1) {
    ...
    final void l(int param0) {
        ...
        int discarded$5 = -30;
        if (jn.a()) {
            int discarded$7 = this.a(false, null != cc.field_w ? true : false, true);
        } else {
            if (pf.field_d >= 10) {
                if (!ge.a(true)) {
                    int discarded$9 = 0;
                    ...
                    if (0 != bk.field_w) {
                        ...
                        int discarded$10 = this.a(false, false, true);
                    }
                }
            }
        }
