...
final class bm extends p {
    ...
    final void a(int param0, int param1) {
        ...
        int var9 = 0;
        L0: {
          param0 = param0 + ((bm) this).field_k;
          param1 = param1 + ((bm) this).field_d;
          var3 = param0 + param1 * tc.field_j;
          var4 = 0;
          var5 = ((bm) this).field_l;
          var6 = ((bm) this).field_i;
        ...
        L4: {
          if (var6 <= 0) {
            ...
            if (var5 > 0) {
              bm.b(tc.field_b, ((bm) this).field_m, ((bm) this).field_n, 0, var4, var3, var6, var5, var7, var8);
              return;
            } else {
              break L4;
            }
    ...
    final void a(int param0, int param1, int param2) {
        ...
        L0: {
          ...
          var5 = 0;
          var6 = ((bm) this).field_l;
          var7 = ((bm) this).field_i;
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              bm.a(tc.field_b, ((bm) this).field_m, ((bm) this).field_n, var5, var4, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
    ...
    bm(int param0, int param1, int param2, int param3, int param4, int param5, byte[] param6, int[] param7) {
        ((bm) this).field_c = param0;
        ((bm) this).field_e = param1;
        ((bm) this).field_k = param2;
        ((bm) this).field_d = param3;
        ((bm) this).field_i = param4;
        ((bm) this).field_l = param5;
        ((bm) this).field_m = param6;
        ((bm) this).field_n = param7;
    }

    bm(int param0, int param1, int param2) {
        ((bm) this).field_i = param0;
        ((bm) this).field_c = param0;
        ((bm) this).field_l = param1;
        ((bm) this).field_e = param1;
        ((bm) this).field_d = 0;
        ((bm) this).field_k = 0;
        ((bm) this).field_m = new byte[param0 * param1];
        ((bm) this).field_n = new int[param2];
    }
}
