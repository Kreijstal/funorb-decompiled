    ...
    final static String a(byte param0, byte[] param1) {
        ...
        try {
          L0: {
            ...
            stackIn_1_0 = sm.a(param1.length, 0, -129, param1);
            break L0;
          }
          ...
          L1: {
            ...
            stackIn_5_1 = new StringBuilder().append("rk.D(").append(param0).append(',');
    ...
    final static void a(byte param0, gn param1) {
        ...
        try {
          ...
          L200: {
            ...
            stackIn_709_0 = (RuntimeException) (var2_ref);

            stackIn_709_1 = new StringBuilder().append("rk.C(").append(param0).append(',');

            if (param1 == null) {
              stackIn_710_0 = (RuntimeException) ((Object) stackIn_709_0);
              stackIn_710_1 = (StringBuilder) ((Object) stackIn_709_1);
              stackIn_710_2 = "null";
              break L200;
            } else {
              stackIn_710_0 = (RuntimeException) ((Object) stackIn_709_0);
    ...
    final void a(float param0, int[] param1, int param2, int[] param3, byte param4) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 1: {
                    try {
                        var6 = new int[param3.length - -param1.length];
                        if (param4 == 49) {
                            statePc = 4;
                        } else {
                            statePc = 2;
                ...
                case 12: {
                    try {
                        var6[param3.length + 2 * var7] = param1[-(var7 * 2) + param1.length - 2];
                        var6[1 + (param3.length - -(var7 * 2))] = param1[-1 + (param1.length - 2 * var7)];
                        var7++;
                        if (var9 == 0) {
                            statePc = 11;
                        } else {
                ...
                case 19: {
                    try {
                        tk.a(var6, (byte) -92, (byte) var8, this.field_g);
                        statePc = 30;
                        continue stateLoop;
                ...
                case 21: {
                    ...
                    stackIn_24_1 = new StringBuilder().append("rk.A(").append(param0).append(',');
                ...
                case 25: {
                    ...
                    stackIn_28_1 = ((StringBuilder) (Object) stackIn_25_1).append(stackIn_25_2).append(',').append(param2).append(',');
    ...
    rk(bm param0, byte param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackIn_6_1 = new StringBuilder().append("rk.<init>(");
