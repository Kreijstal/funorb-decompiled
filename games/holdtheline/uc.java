...
final class uc extends hj {
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          L0: {
            param0 = param0 - (((uc) this).field_u << 4);
            param1 = param1 - (((uc) this).field_x << 4);
            ...
            var13 = ((((uc) this).field_s << 4) - param0) * var10 + -param1 * var9;
            var14 = -((((uc) this).field_s << 4) - param0) * var9 + -param1 * var10;
            var15 = -param0 * var10 + ((((uc) this).field_y << 4) - param1) * var9;
            var16 = --param0 * var9 + ((((uc) this).field_y << 4) - param1) * var10;
            var17 = ((((uc) this).field_s << 4) - param0) * var10 + ((((uc) this).field_y << 4) - param1) * var9;
            var18 = -((((uc) this).field_s << 4) - param0) * var9 + ((((uc) this).field_y << 4) - param1) * var10;
            if (var11 >= var13) {
              var19 = var13;
              var20 = var11;
              break L0;
                      ...
                      if (var26 >= 0) {
                        ...
                        L15: while (true) {
                          if (var33 >= 0) {
                            ...
                            L17: {
                              var32 = (1 + var35 - (((uc) this).field_s << 12) - var27) / var27;
                              if ((1 + var35 - (((uc) this).field_s << 12) - var27) / var27 <= var37) {
                                break L17;
                              } else {
                                var37 = var32;
                                break L17;
                            ...
                            L19: {
                              var32 = (1 + var36 - (((uc) this).field_y << 12) - var26) / var26;
                              if ((1 + var36 - (((uc) this).field_y << 12) - var26) / var26 <= var37) {
                                break L19;
                              } else {
                                var37 = var32;
                                break L19;
                            ...
                            L20: while (true) {
                              if (var37 >= 0) {
                                ...
                                var38 = ((uc) this).field_z[(var36 >> 12) * ((uc) this).field_s + (var35 >> 12)];
                                var39 = tc.field_b[var34];
                                var40 = var38 >>> 24;
                                var41 = 256 - var40;
                                var34++;
                                tc.field_b[var34] = ((var38 & 16711935) * var40 + (var39 & 16711935) * var41 & -16711936) + ((var38 & 65280) * var40 + (var39 & 65280) * var41 & 16711680) >>> 8;
                                var35 = var35 + var27;
                                var36 = var36 + var26;
                                var37++;
                                continue L20;
                        ...
                        L21: while (true) {
                          if (var33 >= 0) {
                            ...
                            L24: {
                              var32 = var36 - (((uc) this).field_y << 12);
                              if (var36 - (((uc) this).field_y << 12) < 0) {
                                break L24;
                              } else {
                        ...
                        L32: while (true) {
                          if (var33 >= 0) {
                            ...
                            L33: {
                              ...
                              var36 = var31 + (var28 * var26 >> 4);
                              var37 = var20;
                              var32 = var35 - (((uc) this).field_s << 12);
                              if (var35 - (((uc) this).field_s << 12) < 0) {
                                break L33;
                              } else {
    ...
    final void a(int param0, int param1) {
        ...
        int var9 = 0;
        L0: {
          param0 = param0 + ((uc) this).field_u;
          param1 = param1 + ((uc) this).field_x;
          var3 = param0 + param1 * tc.field_j;
          var4 = 0;
          var5 = ((uc) this).field_y;
          var6 = ((uc) this).field_s;
        ...
        if (var6 <= 0) {
          ...
          if (var5 > 0) {
            uc.c(tc.field_b, ((uc) this).field_z, 0, var4, var3, var6, var5, var7, var8);
            return;
          } else {
            return;
          }
    ...
    final void c(int param0, int param1, int param2) {
        ...
        L0: {
          ...
          var5 = 0;
          var6 = ((uc) this).field_y;
          var7 = ((uc) this).field_s;
        ...
        if (var7 <= 0) {
          ...
          if (var6 > 0) {
            uc.e(tc.field_b, ((uc) this).field_z, 0, var5, var4, 0, 0, var7, var6, var8, var9, param2);
            return;
          } else {
            return;
          }
    ...
    final void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 <= 0) {
          ...
          if (param3 > 0) {
            L0: {
              var6 = ((uc) this).field_s;
              var7 = ((uc) this).field_y;
              var8 = 0;
              var9 = 0;
              var10 = ((uc) this).field_o;
              var11 = ((uc) this).field_v;
              var12 = (var10 << 16) / param2;
              var13 = (var11 << 16) / param3;
              if (((uc) this).field_u <= 0) {
                break L0;
              } else {
                var14 = ((((uc) this).field_u << 16) + var12 - 1) / var12;
                param0 = param0 + var14;
                var8 = var8 + (var14 * var12 - (((uc) this).field_u << 16));
                break L0;
              }
            }
            L1: {
              if (((uc) this).field_x <= 0) {
                break L1;
              } else {
                var14 = ((((uc) this).field_x << 16) + var13 - 1) / var13;
                param1 = param1 + var14;
                var9 = var9 + (var14 * var13 - (((uc) this).field_x << 16));
                break L1;
              }
            }
            L2: {
            ...
            uc.c(tc.field_b, ((uc) this).field_z, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
            return;
          } else {
            return;
          }
    ...
    final void c(int param0, int param1) {
        ...
        int stackOut_19_2 = 0;
        L0: {
          var3 = ((uc) this).field_s >> 1;
          var4 = ((uc) this).field_y >> 1;
          param0 = param0 + ((uc) this).field_u / 2;
          param1 = param1 + ((uc) this).field_x / 2;
          if (param0 >= tc.field_d) {
            stackOut_2_0 = 0;
        ...
        L1: {
          ...
          if (param0 + var3 <= tc.field_e) {
            stackOut_5_0 = ((uc) this).field_s - 2;
        ...
        L3: {
          ...
          if (param1 + var4 <= tc.field_i) {
            stackOut_11_0 = ((uc) this).field_y - 2;
        ...
        L4: while (true) {
          if (var9 > var8) {
            ...
            var10 = var9 * ((uc) this).field_s + var5;
    ...
    final void a(int param0, int param1, int param2) {
        ...
        if (var7 <= 0) {
          ...
          if (var6 > 0) {
            uc.d(tc.field_b, ((uc) this).field_z, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
          } else {
            return;
          }
    ...
    final void a(int param0, int param1, int param2, int param3) {
        ...
        if (param2 <= 0) {
          ...
          if (param3 > 0) {
            L0: {
              var5 = ((uc) this).field_s;
              var6 = ((uc) this).field_y;
              var7 = 0;
              var8 = 0;
              var9 = ((uc) this).field_o;
              var10 = ((uc) this).field_v;
              var11 = (var9 << 16) / param2;
              var12 = (var10 << 16) / param3;
              if (((uc) this).field_u <= 0) {
                break L0;
              } else {
                var13 = ((((uc) this).field_u << 16) + var11 - 1) / var11;
                param0 = param0 + var13;
                var7 = var7 + (var13 * var11 - (((uc) this).field_u << 16));
                break L0;
              }
            }
            L1: {
              if (((uc) this).field_x <= 0) {
                ...
                var13 = ((((uc) this).field_x << 16) + var12 - 1) / var12;
                param1 = param1 + var13;
                var8 = var8 + (var13 * var12 - (((uc) this).field_x << 16));
                break L1;
              }
            }
            L2: {
            ...
            uc.d(tc.field_b, ((uc) this).field_z, 0, var7, var8, var13, var14, param2, param3, var11, var12, var5);
            return;
          } else {
            return;
          }
    ...
    final void b(int param0, int param1, int param2) {
        ...
        if (var7 <= 0) {
          ...
          if (var6 > 0) {
            uc.b(0, 0, 0, tc.field_b, ((uc) this).field_z, var5, 0, var4, 0, var7, var6, var8, var9, param2);
            return;
          } else {
            return;
          }
    ...
    final void d(int param0, int param1, int param2) {
        ...
        if (var7 <= 0) {
          ...
          if (var6 > 0) {
            uc.c(tc.field_b, ((uc) this).field_z, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
          } else {
            return;
          }
