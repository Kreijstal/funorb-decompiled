    ...
    final static void a(int param0, hj[] param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("te.A(").append(param0).append(',');
    ...
    final static void a(java.math.BigInteger param0, java.math.BigInteger param1, th param2, int param3, int param4, int param5, byte[] param6) {
        ...
        try {
          ...
          L11: {
            ...
            stackOut_28_1 = ((StringBuilder) (Object) stackIn_28_1).append(stackIn_28_2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
