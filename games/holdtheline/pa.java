...
final class pa {
    ...
    final void a(int param0, byte[] param1, int param2) {
        ...
        try {
          L0: {
            L1: {
              this.field_f[this.field_e] = (byte)kc.a((int) this.field_f[this.field_e], 128 >>> pk.a(7, this.field_a));
            ...
            L3: while (true) {
              if (this.field_e >= 32) {
                bc.a(this.field_c, 0, this.field_f, 32, 32);
                this.c(true);
                var4_int = 0;
                var5 = param2;
                L4: while (true) {
          ...
          L6: {
            ...
            stackIn_15_1 = new StringBuilder().append("pa.A(").append(param0).append(',');
    ...
    final static void a(qi param0, qi param1, byte param2, int param3) {
        ...
        try {
            ...
            throw kk.a((Throwable) ((Object) runtimeException), "pa.B(" + (param0 != null ? "{...}" : "null") + ',' + (param1 != null ? "{...}" : "null") + ',' + param2 + ',' + param3 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, int param2, hj param3) {
        ...
        try {
          ...
          L9: {
            ...
            stackIn_26_1 = new StringBuilder().append("pa.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            ...
            if (var2 >= 8) {
              ...
              L1: while (true) {
                if ((var2 ^ -1) <= -9) {
                    ...
                    if (var2 > 10) {
                      ...
                      L3: while (true) {
                        if (-9 >= (var2 ^ -1)) {
                          ...
                          this.field_k[var2] = en.a(this.field_k[var2], en.a(this.field_b[var2], this.field_g[var2]));
                          var2++;
                          continue L3;
                        }
                      }
                      ...
                      L4: while (true) {
                        if (var3 >= 8) {
                          ...
                          L5: while (true) {
                            if (var3 >= 8) {
                              this.field_d[0] = en.a(this.field_d[0], ri.field_f[var2]);
                              var3 = 0;
                              L6: while (true) {
                                if (var3 >= 8) {
                                  var3 = 0;
                                  L7: while (true) {
                                    if (8 <= var3) {
                                      ...
                                      this.field_b[var3] = this.field_j[var3];
                                      var3++;
                                      continue L7;
                                    }
                                  }
                                  ...
                                  L8: while (true) {
                                    if ((var7 ^ -1) <= -9) {
                                      ...
                                      this.field_j[var3] = en.a(this.field_j[var3], ri.field_g[var7][pk.a((int)(this.field_b[pk.a(-var7 + var3, 7)] >>> var5), 255)]);
                                      var7++;
                                      var5 -= 8;
                                      continue L8;
                                    }
                          ...
                          L9: while (true) {
                            if (8 <= var4) {
                              ...
                              this.field_j[var3] = en.a(this.field_j[var3], ri.field_g[var4][pk.a((int)(this.field_d[pk.a(var3 - var4, 7)] >>> var5), 255)]);
                              var4++;
                              var5 -= 8;
                              continue L9;
                            }
                  ...
                  this.field_b[var2] = en.a(arrayValue$1, dupTemp$0);
                  var2++;
                  continue L1;
                }
              }
            } else {
              this.field_g[var2] = en.a(en.a(gh.a(65280L, (long)this.field_f[var3 - -6] << 1398752776), en.a(gh.a((long)this.field_f[5 + var3] << -330391664, 16711680L), en.a(en.a(en.a(en.a((long)this.field_f[var3] << -1038136008, gh.a(255L, (long)this.field_f[1 + var3]) << -46476112), gh.a((long)this.field_f[2 + var3], 255L) << -1406089688), gh.a(1095216660480L, (long)this.field_f[3 + var3] << 276935776)), gh.a((long)this.field_f[4 + var3] << -147066024, 4278190080L)))), gh.a(255L, (long)this.field_f[var3 + 7]));
              var2++;
              var3 += 8;
              continue L0;
            }
    ...
    final void a(byte[] param0, byte param1, long param2) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if ((var12 ^ -1) > -1) {
                L2: while (true) {
                  if ((param2 ^ -1L) >= -9L) {
                    L3: {
                      if (0L < param2) {
                        stackIn_15_0 = 255;
                        stackIn_15_1 = param0[var5_int] << var7;
                        var9 = stackIn_15_0 & stackIn_15_1;
                        this.field_f[this.field_e] = (byte)kc.a((int) this.field_f[this.field_e], var9 >>> var8);
                        break L3;
                      } else {
                        var9 = 0;
                        break L3;
                    ...
                    L4: {
                      if ((param2 + (long)var8 ^ -1L) > -9L) {
                        ...
                        L5: {
                          ...
                          this.field_a = this.field_a + (8 - var8);
                          this.field_e = this.field_e + 1;
                        ...
                        this.field_f[this.field_e] = (byte)pk.a(var9 << 8 + -var8, 255);
                      ...
                      if ((var9 ^ -1) > -1) {
                        ...
                        if ((var9 ^ -1) <= -257) {
                          ...
                          L7: {
                            this.field_f[this.field_e] = (byte)kc.a((int) this.field_f[this.field_e], var9 >>> var8);
                            this.field_e = this.field_e + 1;
                            this.field_a = this.field_a + (-var8 + 8);
                          ...
                          this.field_f[this.field_e] = (byte)pk.a(var9 << -var8 + 8, 255);
                          param2 = param2 - 8L;
                          var5_int++;
                          this.field_a = this.field_a + var8;
                          continue L2;
                        }
                      }
                    }
                ...
                var13 = var13 + (((int)var10 & 255) + (255 & this.field_c[var12]));
                this.field_c[var12] = (byte)var13;
                var10 = var10 >>> 8;
                var13 = var13 >>> 8;
                var12--;
                continue L1;
          ...
          L8: {
            ...
            stackIn_24_1 = new StringBuilder().append("pa.I(");
          ...
          throw kk.a((Throwable) ((Object) stackIn_25_0), stackIn_25_2 + ',' + param1 + ',' + param2 + ')');
        }
    }
