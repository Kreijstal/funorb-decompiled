            ...
            if ((this.field_g.b(-1) ^ -1) == -2) {
              ...
              L1: {
                if (param2 == 115) {
                  ...
                  discarded$2 = ld.a(false, true, (CharSequence) null);
                  break L1;
                }
              }
    ...
    private final el a(int[] param0, String param1, int param2) {
        ...
        try {
            ...
            if (!this.field_g.a("", true)) {
              L1: {
                if (param2 == -343045972) {
                  ...
                  var5 = (int[]) null;
                  discarded$2 = this.a(124, (byte) 87, (int[]) null);
                  break L1;
                }
              }
              stackOut_5_0 = this.a("", param0, (byte) 104, param1);
              stackIn_6_0 = stackOut_5_0;
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
          ...
          L2: {
            var4 = decompiledCaughtException;
            stackOut_7_0 = (RuntimeException) (var4);
            stackOut_7_1 = new StringBuilder().append("ld.B(");
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
            stackIn_8_0 = stackOut_7_0;
            stackIn_8_1 = stackOut_7_1;
          ...
          L0: {
            L1: {
              if (param2 == 104) {
                ...
                var7 = (String) null;
                discarded$2 = this.a((String) null, (int[]) null, (byte) -52, (String) null);
                break L1;
              }
            }
    ...
    final static String a(boolean param0, boolean param1, CharSequence param2) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_38_1 = new StringBuilder().append("ld.I(").append(param0).append(',').append(param1).append(',');
