    ...
    private final java.net.Socket a(byte param0, String param1, String param2, int param3) throws IOException {
        ...
        try {
          ...
          L9: {
            ...
            stackOut_28_1 = new StringBuilder().append("hf.H(").append(param0).append(',');
          ...
          throw kk.a((Throwable) ((Object) stackIn_34_0), stackIn_34_2 + ',' + param3 + ')');
        }
    ...
    private final java.net.Socket a(java.net.Proxy param0, byte param1) throws IOException {
        ...
        try {
            ...
            if (param0.type() == java.net.Proxy.Type.DIRECT) {
              ...
              if ((Object) var3_ref instanceof java.net.InetSocketAddress) {
                ...
                if (param0.type() == java.net.Proxy.Type.HTTP) {
                  ...
                  stackOut_21_0 = this.a((byte) -113, var4_ref.getHostName(), (String) (var5), var4_ref.getPort());
          ...
          L5: {
            ...
            stackOut_23_1 = new StringBuilder().append("hf.I(");
