        ...
        try {
          L0: {
            ...
            if (qg.a(param0, param1, (byte) -27, param2)) {
              stackOut_5_0 = dd.a((byte) -100, param3.a(param0, true, param1));
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("ta.C(").append(param0).append(',').append(param1).append(',');
    ...
    final static String a(int param0, th param1, boolean param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("ta.E(").append(param0).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
