    ...
    final static void a(int param0, int param1, boolean param2, da param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("eg.B(").append(param0).append(',').append(param1).append(',').append(true).append(',');
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, qi param9, qi param10, int param11, vn param12, int param13, int param14, int param15, vn param16, int param17, int param18, int param19, vn param20) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("eg.C(").append(20).append(',').append(0).append(',').append(480).append(',').append(param3).append(',').append(0).append(',').append(0).append(',').append(5).append(',').append(param7).append(',').append(0).append(',');
          ...
          L4: {
            ...
            stackOut_11_1 = ((StringBuilder) (Object) stackIn_11_1).append(stackIn_11_2).append(',').append(320).append(',').append(0).append(',').append(240).append(',');
          ...
          L5: {
            ...
            stackOut_14_1 = ((StringBuilder) (Object) stackIn_14_1).append(stackIn_14_2).append(',').append(20).append(',').append(0).append(',').append(1).append(',');
