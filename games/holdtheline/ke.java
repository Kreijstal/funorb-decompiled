        ...
        if (param1 >= 10) {
          L0: {
            ...
            if (this.field_o == null) {
              ...
              this.field_o.a();
              this.field_q.a();
              var5 = (int)((double)(this.field_o.field_f - this.field_o.field_h) * 32.768 / var3);
              var6 = (int)((double)this.field_o.field_h * 32.768 / var3);
              break L0;
            }
          }
          L1: {
            ...
            if (this.field_f == null) {
              ...
              this.field_f.a();
              this.field_k.a();
              var8 = (int)((double)(this.field_f.field_f - this.field_f.field_h) * 32.768 / var3);
              var9 = (int)((double)this.field_f.field_h * 32.768 / var3);
              break L1;
            }
          }
          var11 = 0;
          L2: while (true) {
            if (var11 >= 5) {
              ...
              L3: while (true) {
                if (var11 >= param0) {
                      ...
                      L5: while (true) {
                        if (var14 >= param0) {
                          ...
                          L6: {
                            ...
                            if (var13 == 0) {
                              var12 = this.field_i.field_h + ((this.field_i.field_f - this.field_i.field_h) * var16 >> 8);
                              break L6;
                            } else {
                              var12 = this.field_i.field_h + ((this.field_i.field_f - this.field_i.field_h) * var15 >> 8);
                              break L6;
                            }
                          }
                          L7: {
                      ...
                      if (this.field_l <= 0) {
                        ...
                        L10: while (true) {
                          if (var12 >= param0) {
                            ...
                            field_g[var12] = field_g[var12] + field_g[var12 - var11] * this.field_l / 100;
                            var12++;
                            continue L10;
                          }
                        }
                  ...
                  L27: {
                    ...
                    var13 = this.field_u.a(param0);
                    if (this.field_o == null) {
                      break L27;
                    } else {
                      var14 = this.field_o.a(param0);
                      var15 = this.field_q.a(param0);
                      var12 = var12 + (this.a(var7, var15, this.field_o.field_g) >> 1);
                  ...
                  L28: {
                    if (this.field_f == null) {
                      ...
                      var13 = var13 * ((this.a(var10, var15, this.field_f.field_g) >> 1) + 32768) >> 15;
                  ...
                  L29: while (true) {
                    if (var14 < 5) {
                      if (this.field_y[var14] != 0) {
                        ...
                        if (var15 < param0) {
                          field_g[var15] = field_g[var15] + this.a(field_b[var14], var13 * field_m[var14] >> 15, this.field_r.field_g);
              ...
              if (this.field_y[var11] != 0) {
                field_b[var11] = 0;
                field_w[var11] = (int)((double)this.field_t[var11] * var3);
                field_m[var11] = (this.field_y[var11] << 14) / 100;
                field_d[var11] = (int)((double)(this.field_r.field_f - this.field_r.field_h) * 32.768 * Math.pow(1.0057929410678534, (double)this.field_j[var11]) / var3);
                field_a[var11] = (int)((double)this.field_r.field_h * 32.768 / var3);
                var11++;
                continue L2;
              } else {
                var11++;
