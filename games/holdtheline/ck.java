...
final class ck extends hl {
    ...
    final static boolean a(int param0, boolean param1, int param2, qm param3, qm param4, int param5, in param6) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_17_1 = new StringBuilder().append("ck.D(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final static void a(byte param0, java.awt.Canvas param1) {
        try {
            if (param0 != -97) {
                boolean discarded$0 = ck.a((byte) 32);
            }
            if (bk.field_w == 11) {
                nn.a(false);
            }
            ...
            throw kk.a((Throwable) (Object) runtimeException, "ck.A(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
