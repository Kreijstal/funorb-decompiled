...
abstract class qi extends ln {
    ...
    final int d(String param0, int param1) {
        return ((qi) this).a(param0, new int[1], field_v);
    }
    ...
    final void b(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param0, param1 - ((qi) this).a(param0) / 2, param2);
    }
            ...
            switch (statePc) {
                ...
                case 26: {
                    try {
                        ...
                        var9_int = mo.a(var10, (byte) -116);
                        var4 = var4 + ((qi) this).field_E[var9_int].field_c;
                        var3 = 0;
                        statePc = 27;
                        continue stateLoop;
                ...
                case 31: {
                    var7 = (char)(sj.a(-101, (char) var7) & 255);
                    var4 = var4 + ((qi) this).field_K[var7];
                ...
                case 33: {
                    var4 = var4 + ((qi) this).field_H[(var3 << 8) + var7];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
    ...
    final int a(char param0) {
        return ((qi) this).field_K[sj.a(113, param0) & 255];
    }
    ...
    final void c(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.a(param0, param1 - ((qi) this).a(param0), param2);
    }
    ...
    final int b(String param0, int param1, int param2) {
        if (param2 == 0) {
            param2 = ((qi) this).field_F;
        }
        int var4 = ((qi) this).a(param0, new int[1], field_v);
        int var5 = (var4 - 1) * param2;
        return ((qi) this).field_G + var5 + ((qi) this).field_I;
    }
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = ha.a(' ', (byte) -83, 0, field_x);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
                ...
                case 8: {
                    ...
                    var9 = -1;
                    StringBuilder discarded$11 = field_x.append(60);
                    StringBuilder discarded$12 = field_x.append(var15);
                    StringBuilder discarded$13 = field_x.append(62);
                ...
                case 13: {
                    var4 = var4 + ((qi) this).field_H[(var10 << 8) + 60];
                    statePc = 14;
                    continue stateLoop;
                }
                case 14: {
                ...
                case 18: {
                    var4 = var4 + ((qi) this).field_H[(var10 << 8) + 62];
                    statePc = 19;
                    continue stateLoop;
                }
                case 19: {
                ...
                case 23: {
                    var4 = var4 + ((qi) this).field_H[(var10 << 8) + 160];
                    statePc = 24;
                    continue stateLoop;
                }
                case 24: {
                ...
                case 28: {
                    var4 = var4 + ((qi) this).field_H[(var10 << 8) + 173];
                    statePc = 29;
                    continue stateLoop;
                }
                case 29: {
                ...
                case 33: {
                    var4 = var4 + ((qi) this).field_H[(var10 << 8) + 215];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
                ...
                case 38: {
                    var4 = var4 + ((qi) this).field_H[(var10 << 8) + 128];
                    statePc = 39;
                    continue stateLoop;
                }
                case 39: {
                ...
                case 43: {
                    var4 = var4 + ((qi) this).field_H[(var10 << 8) + 169];
                    statePc = 44;
                    continue stateLoop;
                }
                case 44: {
                ...
                case 48: {
                    var4 = var4 + ((qi) this).field_H[(var10 << 8) + 174];
                    statePc = 49;
                    continue stateLoop;
                }
                case 49: {
                ...
                case 51: {
                    try {
                        ...
                        var16_int = mo.a(var18, (byte) -116);
                        var4 = var4 + ((qi) this).field_E[var16_int].field_c;
                        var10 = 0;
                        statePc = 54;
                        continue stateLoop;
                ...
                case 58: {
                    StringBuilder discarded$14 = field_x.append(var14);
                ...
                case 60: {
                    var4 = var4 + ((qi) this).field_H[(var10 << 8) + var14];
                    statePc = 61;
                    continue stateLoop;
                }
                case 61: {
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                      ...
                      if (var5_int >= 256) {
                        ...
                        L4: while (true) {
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ((qi) this).field_H = new byte[65536];
                                var7 = 0;
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    ((qi) this).field_F = var25[32] + var22[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                ((qi) this).field_H[(var7 << 8) + var8] = (byte)qi.a(var23, var24, var25, ((qi) this).field_K, var22, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                ((qi) this).field_K[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
            ...
            var2 = 0;
            L10: while (true) {
              if (var2 >= ((qi) this).field_K.length) {
                ((qi) this).field_F = param0[256] & 255;
                break L0;
              } else {
                ((qi) this).field_K[var2] = param0[var2] & 255;
                var2++;
                continue L10;
              }
            }
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9) {
        return ((qi) this).a(param0, param1, param2, param3, param4, param5, param6, 256, param7, param8, param9);
    }
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_D = (param1 - ((qi) this).a(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    final int b(String param0, int param1) {
        ...
        int var5 = 0;
        int var6 = 0;
        var3 = ((qi) this).a(param0, new int[1], field_v);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (var5 >= var3) {
            ...
            switch (statePc) {
                ...
                case 23: {
                    try {
                        ...
                        var10 = mo.a(var13, (byte) -116);
                        var11_ref_p = ((qi) this).field_E[var10];
                        if (((qi) this).field_q == null) {
                            statePc = 25;
                        } else {
                            statePc = 24;
                        }
                ...
                case 24: {
                    try {
                        stackOut_24_0 = ((qi) this).field_q[var10];
                ...
                case 25: {
                    try {
                        stackOut_25_0 = var11_ref_p.field_e;
                ...
                case 27: {
                    try {
                        var11_ref_p.a(param1, param2 + ((qi) this).field_F - var12);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 28: {
                    try {
                        var11_ref_p.a(param1, param2 + ((qi) this).field_F - var12, field_L);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_p.field_c;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
                ...
                case 35: {
                    var8 = (char)(sj.a(127, (char) var8) & 255);
                    if (((qi) this).field_H == null) {
                        statePc = 38;
                    } else {
                        statePc = 36;
                ...
                case 37: {
                    param1 = param1 + ((qi) this).field_H[(var5 << 8) + var8];
                    statePc = 38;
                    continue stateLoop;
                }
                case 38: {
                    var9 = ((qi) this).field_z[var8];
                    var10 = ((qi) this).field_w[var8];
                    var11 = param1;
                    if (var8 == 32) {
                        statePc = 46;
                    } else {
                ...
                case 41: {
                    ((qi) this).a(var8, param1 + ((qi) this).field_J[var8] + 1, param2 + ((qi) this).field_B[var8] + 1, var9, var10, field_r, true);
                    statePc = 42;
                    continue stateLoop;
                }
                case 42: {
                    ((qi) this).a(var8, param1 + ((qi) this).field_J[var8], param2 + ((qi) this).field_B[var8], var9, var10, field_y, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 43: {
                ...
                case 44: {
                    ((qi) this).a(var8, param1 + ((qi) this).field_J[var8] + 1, param2 + ((qi) this).field_B[var8] + 1, var9, var10, field_r, field_L, true);
                    statePc = 45;
                    continue stateLoop;
                }
                case 45: {
                    ((qi) this).a(var8, param1 + ((qi) this).field_J[var8], param2 + ((qi) this).field_B[var8], var9, var10, field_y, field_L, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 46: {
                ...
                case 47: {
                    field_C = field_C + field_D;
                    param1 = param1 + (field_C >> 8);
                    field_C = field_C & 255;
                    statePc = 48;
                    continue stateLoop;
                }
                case 48: {
                    param1 = param1 + ((qi) this).field_K[var8];
                    if (field_t == -1) {
                        statePc = 50;
                    } else {
                        statePc = 49;
                ...
                case 49: {
                    tc.b(var11, param2 + (int)((double)((qi) this).field_F * 0.7), param1 - var11, field_t);
                    statePc = 50;
                    continue stateLoop;
                }
                case 50: {
                ...
                case 51: {
                    tc.b(var11, param2 + ((qi) this).field_F + 1, param1 - var11, field_A);
                    statePc = 52;
                    continue stateLoop;
                }
                case 52: {
        ...
        if (param0 != null) {
          L0: {
            ...
            if (param10 != 0) {
              ...
              param10 = ((qi) this).field_F;
              break L0;
            }
          }
          L1: {
            var12 = new int[]{param3};
            if (param4 >= ((qi) this).field_G + ((qi) this).field_I + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = ((qi) this).a(param0, var12, field_v);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - ((qi) this).field_G - ((qi) this).field_I - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + ((qi) this).field_G + var15;
                  param10 = param10 + var15;
                  break L3;
                } else {
                  var14 = param2 + param4 - ((qi) this).field_I - (var13 - 1) * param10;
                  break L3;
                }
              } else {
                var14 = param2 + ((qi) this).field_G + (param4 - ((qi) this).field_G - ((qi) this).field_I - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + ((qi) this).field_G;
              break L3;
            }
          }
          var15 = 0;
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    L6: {
                      if (var15 != var13 - 1) {
                        this.c(field_v[var15], param3);
                        this.a(field_v[var15], param1, var14);
                        field_D = 0;
                        break L6;
                      } else {
                        this.a(field_v[var15], param1, var14);
                    ...
                    this.a(field_v[var15], param1 + param3 - ((qi) this).a(field_v[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.a(field_v[var15], param1 + (param3 - ((qi) this).a(field_v[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    private final void b(String param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 27: {
                    try {
                        this.a(field_p, field_o, field_u);
                        statePc = 30;
                        continue stateLoop;
                    } catch (Throwable stateCaught_27) {
                        caughtException = stateCaught_27;
    ...
    qi(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((qi) this).field_F = 0;
        ((qi) this).field_J = param1;
        ((qi) this).field_B = param2;
        ((qi) this).field_z = param3;
        ((qi) this).field_w = param4;
        this.a(param0);
        var6 = 2147483647;
        var7 = -2147483648;
        var8 = 0;
        L0: while (true) {
          if (var8 >= 256) {
            ((qi) this).field_G = ((qi) this).field_F - var6;
            ((qi) this).field_I = var7 - ((qi) this).field_F;
            ((qi) this).field_s = ((qi) this).field_F - ((qi) this).field_B[88];
          } else {
            L1: {
              if (((qi) this).field_B[var8] >= var6) {
                break L1;
              } else {
                if (((qi) this).field_w[var8] == 0) {
                  break L1;
                } else {
                  var6 = ((qi) this).field_B[var8];
                  break L1;
                }
              }
            }
            if (((qi) this).field_B[var8] + ((qi) this).field_w[var8] > var7) {
              var7 = ((qi) this).field_B[var8] + ((qi) this).field_w[var8];
              var8++;
              continue L0;
            } else {
              var8++;
