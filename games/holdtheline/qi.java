...
abstract class qi extends ln {
    ...
    final int d(String param0, int param1) {
        return this.a(param0, new int[]{param1}, field_v);
    }
                                      ...
                                      if (var8.startsWith("img=")) {
                                        try {
                                          L2: {
                                            ...
                                            var4 = var4 + this.field_E[var9_int].field_c;
                                            var3 = 0;
                                            var6++;
                                            break L2;
                                          }
    ...
    final int a(char param0) {
        return this.field_K[sj.a(113, param0) & 255];
    }
    ...
    final int b(String param0, int param1, int param2) {
        ...
        int var4 = this.a(param0, new int[]{param1}, field_v);
        int var5 = (var4 - 1) * param2;
        return this.field_G + var5 + this.field_I;
    }
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$0 = field_x.append('<');
                        discarded$1 = field_x.append(var15);
                        discarded$2 = field_x.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                                          ...
                                          if (!var15.startsWith("img=")) {
                                            ...
                                            try {
                                              L4: {
                                                ...
                                                var4 = var4 + this.field_E[var16_int].field_c;
                                                var10 = 0;
                                                break L4;
                                              }
                                            } catch (java.lang.Exception decompiledCaughtParameter0) {
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$3 = field_x.append((char) var14);
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                                      ...
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_H[(var7 << 8) + var8] = (byte)qi.a(var15, var16, var17, this.field_K, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                this.field_K[var3_int] = param0[incrementValue$6] & 255;
                var3_int++;
                continue L1;
              }
            }
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_D = (param1 - this.a(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    final int b(String param0, int param1) {
        ...
        int var5;
        int var6;
        var3 = this.a(param0, new int[]{param1}, field_v);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (var5 >= var3) {
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var11_ref_p = this.field_E[var10];
                                            if (this.field_q == null) {
                                              stackIn_26_0 = var11_ref_p.field_e;
                                              break L3;
                                            } else {
                                          ...
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_L != 256) {
                                              var11_ref_p.a(param1, param2 + this.field_F - var12, field_L);
                                              break L4;
                                            } else {
                                              var11_ref_p.a(param1, param2 + this.field_F - var12);
                                              break L4;
                                            }
                                          }
              ...
              if (var4 == -1) {
                    ...
                    if (field_L != 256) {
                      L8: {
                        if (field_r == -1) {
                          ...
                          this.a(var8, param1 + this.field_J[var8] + 1, param2 + this.field_B[var8] + 1, var9, var10, field_r, field_L, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_J[var8], param2 + this.field_B[var8], var9, var10, field_y, field_L, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_r == -1) {
                          ...
                          this.a(var8, param1 + this.field_J[var8] + 1, param2 + this.field_B[var8] + 1, var9, var10, field_r, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_J[var8], param2 + this.field_B[var8], var9, var10, field_y, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  ...
                  if (field_t == -1) {
                    ...
                    tc.b(var11, param2 + (int)((double)this.field_F * 0.7), param1 - var11, field_t);
                    break L10;
                  }
                }
                L11: {
                  if (field_A == -1) {
                    ...
                    tc.b(var11, param2 + this.field_F + 1, param1 - var11, field_A);
                    break L11;
                  }
                }
                var5 = var8;
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        if (param0 != null) {
          ...
          L1: {
            ...
            if (param4 >= this.field_G + this.field_I + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = this.a(param0, var12, field_v);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - this.field_G - this.field_I - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                ...
                var14 = param2 + this.field_G + (param4 - this.field_G - this.field_I - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.a(field_v[var15], param1 + param3 - this.a(field_v[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.a(field_v[var15], param1 + (param3 - this.a(field_v[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    qi(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_G = this.field_F - var6;
            this.field_I = var7 - this.field_F;
            this.field_s = this.field_F - this.field_B[88];
            return;
          } else {
            L1: {
            ...
            if (this.field_B[var8] + this.field_w[var8] > var7) {
              var7 = this.field_B[var8] + this.field_w[var8];
              var8++;
              continue L0;
            } else {
              var8++;
