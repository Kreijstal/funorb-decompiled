...
final class re {
    ...
    final float[] b() {
        return this.field_f[this.c()];
    }

    final int c() {
        int var1 = 0;
        while (this.field_b[var1] >= 0) {
            var1 = sn.b() != 0 ? this.field_b[var1] : var1 + 1;
        }
        return this.field_b[var1] ^ -1;
    }
    ...
    re() {
        ...
        L0: {
          discarded$2 = sn.f(24);
          this.field_d = sn.f(16);
          this.field_c = sn.f(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_c) {
                ...
                var4_int = sn.f(qm.a(this.field_c - var2, (byte) -75));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_c * this.field_d;
                break L9;
              } else {
                var7 = re.a(this.field_c, this.field_d);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_f = new float[this.field_c][this.field_d];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
