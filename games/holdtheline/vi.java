...
final class vi extends hl {
    ...
    final void a() {
        ...
        int[] var25 = null;
        int[] var26 = null;
        if (((vi) this).field_i == null) {
          ((vi) this).field_i = new og(16);
          var26 = new int[16];
          var23 = var26;
          var20 = var23;
          var17 = var20;
                      ...
                      L6: {
                        if (var9 != 144) {
                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              var13 = var24[var10];
                              var14 = (be) (Object) ((vi) this).field_i.a((byte) 126, (long)var13);
                              if (var14 != null) {
                                break L7;
                              } else {
                                var14 = new be(new byte[128]);
                                ((vi) this).field_i.a((hl) (Object) var14, (long)var13, false);
                                break L7;
                              }
                            }
    ...
    final void b() {
        ((vi) this).field_i = null;
    }

    final static vi a(gn param0, String param1, String param2) {
        byte[] var3 = param0.a(param2, false, param1);
        if (var3 == null) {
            return null;
        }
        return new vi(new th(var3));
    }

    private vi(th param0) {
        int var2 = 0;
        int var3 = 0;
        int var4 = 0;
        int var5 = 0;
        ...
        int var66 = 0;
        int[] var70 = null;
        th stackIn_65_0 = null;
        int stackIn_65_1 = 0;
        th stackIn_66_0 = null;
        int stackIn_66_1 = 0;
        th stackIn_67_0 = null;
        int stackIn_67_1 = 0;
        int stackIn_67_2 = 0;
        int stackIn_73_0 = 0;
        th stackOut_64_0 = null;
        int stackOut_64_1 = 0;
        th stackOut_66_0 = null;
        int stackOut_66_1 = 0;
        int stackOut_66_2 = 0;
        th stackOut_65_0 = null;
        int stackOut_65_1 = 0;
        int stackOut_65_2 = 0;
        int stackOut_72_0 = 0;
        int stackOut_71_0 = 0;
        param0.field_l = param0.field_i.length - 3;
        var2 = param0.f((byte) -106);
        var3 = param0.k(102);
        var4 = 14 + var2 * 10;
        param0.field_l = 0;
        var5 = 0;
          ...
          if (var13 >= var2) {
            ...
            L1: while (true) {
              if (var15 >= var14) {
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      ((vi) this).field_j = new byte[var4];
                      var51 = new th(((vi) this).field_j);
                      var51.a((byte) -58, 1297377380);
                      var51.a((byte) -58, 6);
                      stackOut_64_0 = (th) var51;
                      stackOut_64_1 = -652561784;
                      stackIn_66_0 = stackOut_64_0;
                      stackIn_66_1 = stackOut_64_1;
                      stackIn_65_0 = stackOut_64_0;
                      stackIn_65_1 = stackOut_64_1;
                      if (var2 <= 1) {
                        stackOut_66_0 = (th) (Object) stackIn_66_0;
                        ...
                        stackOut_65_0 = (th) (Object) stackIn_65_0;
                    ...
                    ((th) (Object) stackIn_67_0).b(stackIn_67_1, stackIn_67_2);
                    var51.b(-652561784, var2);
                    var51.b(-652561784, var3);
                    ...
                    L4: while (true) {
                      if (var60 >= var2) {
                        ...
                        var51.a((byte) -58, 1297379947);
                        var51.field_l = var51.field_l + 4;
                        var61 = var51.field_l;
                        var62 = -1;
                        L5: while (true) {
                          L6: {
                            var63 = param0.d((byte) -79);
                            var51.d(var63, -121);
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                    ...
                                    if (var62 != 3) {
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            L7: {
                                              if (var65 == 0) {
                                                ...
                                                var51.f(111, 192 + var52);
                                                break L7;
                                              }
                                            }
                                            int incrementValue$30 = var44;
                                            var44++;
                                            var51.f(111, (int) param0.field_i[incrementValue$30]);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                                          ...
                                          var51.f(111, var53 & 127);
                                          var51.f(111, var58 & 127);
                                          continue L5;
                                        }
                                      } else {
                                        L9: {
                                      ...
                                      var51.f(111, var56 & 127);
                                      var51.f(111, var56 >> 7 & 127);
                                      continue L5;
                                    }
                                  } else {
                                    L11: {
                              ...
                              var50++;
                              var51.f(111, (int) param0.field_i[incrementValue$54]);
                              int incrementValue$55 = var50;
                              var50++;
                              var51.f(111, (int) param0.field_i[incrementValue$55]);
                              int incrementValue$56 = var50;
                              var50++;
                              var51.f(111, (int) param0.field_i[incrementValue$56]);
                              continue L5;
                            }
                          } else {
                            L18: {
                            ...
                            var51.f(111, 47);
                            var51.f(111, 0);
                            var51.c(127, var51.field_l - var61);
                            var60++;
                            continue L4;
                          }
                        }
                    ...
                    var28 = var28 + param0.f((byte) -110) & 127;
                    if (var28 != 0) {
                      if (var28 != 32) {
                        if (var28 != 1) {
                          if (var28 != 33) {
                ...
                int discarded$57 = param0.d((byte) -59);
                var15++;
                continue L1;
              }
            }
