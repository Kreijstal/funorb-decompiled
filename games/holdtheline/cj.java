            ...
            L1: {
              L2: {
                if (null == ((cj) this).field_J) {
                  ...
                  if (((cj) this).field_J.length <= param0) {
                    break L2;
                  } else {
                    break L1;
                  }
              ...
              L3: {
                ...
                if (null != ((cj) this).field_J) {
                  var5 = 0;
                  L4: while (true) {
                    if (var5 >= ((cj) this).field_J.length) {
                      break L3;
                    } else {
        ...
        try {
          L0: {
            L1: {
              ...
              if (((cj) this).field_p) {
                var5_int = nc.field_g + (-param0 + -((cj) this).field_k);
                var6 = rf.field_X + -param2 + -((cj) this).field_o;
                ((cj) this).field_H = this.a((byte) 124, var5_int, var6);
                break L1;
              } else {
                break L1;
              }
