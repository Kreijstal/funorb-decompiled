    ...
    final static boolean a(byte param0, String param1, String param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("an.D(").append(param0).append(44);
          ...
          L0: {
            ...
            L1: while (true) {
              if (var4 >= var2_int) {
                ...
                var3 = sj.a(113, param0.charAt(var4)) + ((var3 << 5) + -var3);
                var4++;
                continue L1;
              }
            }
    ...
    final void a(byte param0, th param1, byte[] param2) {
        try {
            ...
            try {
              L0: {
                L1: {
                  if (param1.field_i[param1.field_l] != 31) {
                    break L1;
                  } else {
                    if (-117 == param1.field_i[1 + param1.field_l]) {
                      ...
                      try {
                        L3: {
                          ...
                          int discarded$2 = ((an) this).field_b.inflate(param2);
                          break L3;
                        }
              ...
              L4: {
                ...
                stackOut_14_1 = new StringBuilder().append("an.A(").append(param0).append(44);
