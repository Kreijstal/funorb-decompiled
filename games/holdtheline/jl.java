...
final class jl {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            if (!param1) {
              if (param0 != null) {
                if (((jl) this).field_a != param0) {
                  L0: {
                    if (null != ((jl) this).field_a) {
                      ((jl) this).field_a.setCursor((java.awt.Cursor) null);
    ...
    public jl() throws Exception {
        ...
        ((jl) this).field_b = var2;
    }

    public final void movemouse(int param0, int param1) {
        ((jl) this).field_b.mouseMove(param0, param1);
    }
}
