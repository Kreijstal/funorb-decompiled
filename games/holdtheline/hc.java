...
final class hc {
    ...
    final static void a(int param0, hj param1, byte param2, int param3, int param4) {
        ...
        try {
            ...
            ug.b(-1);
            var5.d(param3 - (param1.field_o >> 1), param4 - (param1.field_v >> 1), param0);
        } catch (RuntimeException runtimeException) {
            throw kk.a((Throwable) (Object) runtimeException, "hc.D(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    final static bm a(String param0, gn param1, int param2, String param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = de.a(var4_int, var5, param1, 25);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("hc.C(");
