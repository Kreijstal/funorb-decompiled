...
final class wb {
    ...
    final int a(int param0, wb param1) {
        ...
        try {
          L0: {
            if (param0 < -80) {
              stackOut_3_0 = ((wb) this).field_k * param1.field_k + ((wb) this).field_a * param1.field_a;
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("wb.F(").append(param0).append(44);
    ...
    final int a(boolean param0, wb param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = -(param1.field_k * ((wb) this).field_a) + ((wb) this).field_k * param1.field_a;
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("wb.E(").append(param0).append(44);
          ...
          L0: {
            L1: {
              ...
              if (param2 == 3251) {
                ...
                var8 = null;
                in discarded$2 = wb.a((vj) null, (vj) null, -127);
                break L1;
              }
            }
            L2: {
    ...
    final static void a(int param0, String param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, ql param10) {
        try {
            ...
            throw kk.a((Throwable) (Object) runtimeException, "wb.H(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 44 + param8 + 44 + param9 + 44 + (param10 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    wb(qm param0, qm param1) {
        try {
            ...
            throw kk.a((Throwable) (Object) runtimeException, "wb.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
