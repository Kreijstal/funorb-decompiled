...
final class nb {
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_a[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_a[var11];
        }
    }
    ...
    final boolean b() {
        ...
        int var2 = ((nb) this).field_j.length;
        System.arraycopy((Object) (Object) ((nb) this).field_j, 0, (Object) (Object) field_i, 0, var2);
        int var3 = field_c[((nb) this).field_f - 1];
        int var4 = qm.a(var3 - 1, (byte) -126);
        field_d[0] = sn.f(var4);
        field_d[1] = sn.f(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((nb) this).field_g.length; var6++) {
            var7 = ((nb) this).field_g[var6];
            var8 = ((nb) this).field_k[var7];
            var9 = ((nb) this).field_l[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = sn.field_F[((nb) this).field_h[var7]].c();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((nb) this).field_b[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_d[incrementValue$0] = var13 >= 0 ? sn.field_F[var13].c() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((nb) this).field_j.length;
        var4 = field_c[((nb) this).field_f - 1];
        var5 = field_e;
        field_e[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_d[0] * ((nb) this).field_f;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_e[var16]) {
                  var9 = field_i[var16];
                  var10 = field_d[var16] * ((nb) this).field_f;
            ...
            L3: {
              var7 = nb.b(field_i, var6);
              var8_int = nb.a(field_i, var6);
              var9 = this.a(field_i[var7], field_d[var7], field_i[var8_int], field_d[var8_int], field_i[var6]);
              var10 = field_d[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    nb() {
        ...
        if (var1 == 1) {
          var2 = sn.f(5);
          var3 = 0;
          ((nb) this).field_g = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((nb) this).field_k = new int[var3];
              ((nb) this).field_l = new int[var3];
              ((nb) this).field_h = new int[var3];
              ((nb) this).field_b = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((nb) this).field_f = sn.f(2) + 1;
                  var4 = sn.f(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((nb) this).field_j = new int[var5];
                      ((nb) this).field_j[0] = 0;
                      ((nb) this).field_j[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((nb) this).field_k[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((nb) this).field_j[incrementValue$2] = sn.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((nb) this).field_k[((nb) this).field_g[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((nb) this).field_k[var4] = sn.f(3) + 1;
                    int dupTemp$3 = sn.f(2);
                    ((nb) this).field_l[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((nb) this).field_h[var4] = sn.f(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
