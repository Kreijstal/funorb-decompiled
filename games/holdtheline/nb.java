...
final class nb {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_j, 0, field_i, 0, var2);
        int var3 = field_c[this.field_f - 1];
        ...
        for (var6 = 0; var6 < this.field_g.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = sn.field_F[this.field_h[var7]].c();
            }
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_e[var16]) {
                  var9 = field_i[var16];
                  var10 = field_d[var16] * this.field_f;
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_k[var7]) {
                              ...
                              var5++;
                              this.field_j[incrementValue$2] = sn.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_k[this.field_g[var6]];
                      var6++;
                      continue L2;
                    }
                  }
