...
final class ga {
        ...
        if (param0) {
          ...
          L0: while (true) {
            if ((var2 ^ -1) <= -257) {
              ...
              dupTemp$1 = this.field_j + (this.field_c[rn.a(255, var3 >> 811609538)] + this.field_f);
              var4 = dupTemp$1;
              this.field_c[var2] = dupTemp$1;
              dupTemp$2 = this.field_c[rn.a(var4 >> -1106998904, 1020) >> -277124574] + var3;
    ...
    ga(int[] param0) {
        ...
        try {
            ...
            throw ig.a((Throwable) ((Object) runtimeException), "ga.<init>(" + (param0 != null ? "{...}" : "null") + ')');
        }
    }
