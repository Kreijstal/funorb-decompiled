...
final class ls {
    ...
    final static ru a(int param0, kl param1, int param2) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_5_1 = new StringBuilder().append("ls.C(").append(param0).append(',');
          ...
          throw ig.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + ',' + param2 + ',' + -80 + ')');
        }
    }
    ...
    final static void a(vh param0, int param1, java.math.BigInteger param2, int param3, int param4, java.math.BigInteger param5, byte[] param6) {
        ...
        try {
              ...
              if (var9 >= 4) {
                ...
                L5: {
                  L6: {
                    ...
                    sb.field_h.a(param6, 0, param4, 106);
          ...
          L8: {
            ...
            stackOut_20_1 = new StringBuilder().append("ls.D(");
          ...
          L10: {
            ...
            stackOut_26_1 = ((StringBuilder) (Object) stackIn_26_1).append(stackIn_26_2).append(',').append(6727).append(',').append(param4).append(',');
