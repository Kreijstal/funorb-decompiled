...
final class bh extends nl {
          ...
          if (this.field_E == null) {
            ...
            if (this.field_K == 0) {
              ...
              if (-257 == (this.field_K ^ -1)) {
                this.field_E.a(this.field_B + param0, param1 - -this.field_p, (byte) -125, param3);
                return;
              } else {
                var6 = new wk(this.field_E.field_l, this.field_E.field_w);
                if (param2 >= -82) {
                  field_M = (String[]) null;
                  vn.a(var6, 3);
                  this.field_E.a(0, 0, (byte) -86, param3);
                  rf.b(-18862);
                  var6.e(this.field_B + param0, param1 - -this.field_p, this.field_K);
                  return;
                } else {
                  vn.a(var6, 3);
                  this.field_E.a(0, 0, (byte) -86, param3);
    ...
    bh(kb param0) {
        ...
        try {
            param0.a(0, this.field_l, 0, 8192, this.field_w);
            this.field_K = 256;
            this.field_E = param0;
