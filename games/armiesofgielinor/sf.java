...
abstract class sf extends wl {
    ...
    final static int a(int param0, String param1, vh param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("sf.GB(").append(param0).append(44);
    ...
    final static void a(byte param0, of param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("sf.KB(").append(param0).append(44);
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        try {
                        ...
                        if (var7.field_r.field_w.field_x == null) {
                          ...
                          if (!var7.field_z) {
                            L9: {
                              ...
                              stackOut_41_0 = go.field_g;
                              stackOut_41_1 = -30 + var8;
                              stackOut_41_2 = var9 - 15;
                              stackOut_41_3 = op.field_c;
          ...
          throw ig.a((Throwable) (Object) var6, "sf.JB(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
    }
