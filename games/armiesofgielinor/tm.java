...
final class tm {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 22: {
                    ...
                    param1++;
                    param0[incrementValue$23] = field_h[param6 >> 8];
                    param6 = param6 + param7;
                    param3--;
                    if (param3 > 0) {
                        statePc = 22;
    ...
    final static void a() {
        tm.a(qn.field_j, qn.field_a, qn.field_e, qn.field_f);
    }
    ...
    final static void a(int param0, int param1, int param2, int param3) {
        int var5 = 0;
        field_l = param2 - param0;
        field_q = param3 - param1;
        tm.c();
        if (field_k.length < field_q) {
            field_k = new int[rs.a((byte) 84, field_q)];
        }
        int var4 = param1 * qn.field_l + param0;
        for (var5 = 0; var5 < field_q; var5++) {
            field_k[var5] = var4;
            var4 = var4 + qn.field_l;
        }
    }

    private final static void a(float param0) {
        field_b = param0;
        field_b = (float)((double)field_b + (Math.random() * 0.03 - 0.015));
    }
                      ...
                      if (param2 < 0) {
                        ...
                        L12: while (true) {
                          if (param1 < 0) {
                            ...
                            tm.a(qn.field_d, param0, param6, 0, param3 >> 16, param5 >> 16);
                            param5 = param5 + var8;
                            param3 = param3 + var7;
                            param0 = param0 + qn.field_l;
                            param1--;
                            continue L12;
                          }
                        }
                      } else {
                        tm.a(qn.field_d, param0, param6, 0, param3 >> 16, param4 >> 16);
                        param4 = param4 + var9;
                        param3 = param3 + var7;
                        param0 = param0 + qn.field_l;
                        continue L11;
                    ...
                    if (param2 < 0) {
                      ...
                      L14: while (true) {
                        if (param1 < 0) {
                          ...
                          tm.a(qn.field_d, param0, param6, 0, param5 >> 16, param3 >> 16);
                          param5 = param5 + var8;
                          param3 = param3 + var7;
                          param0 = param0 + qn.field_l;
                          param1--;
                      ...
                      tm.a(qn.field_d, param0, param6, 0, param4 >> 16, param3 >> 16);
                      param4 = param4 + var9;
                      param3 = param3 + var7;
                      param0 = param0 + qn.field_l;
                      continue L13;
                      ...
                      if (param1 < 0) {
                        ...
                        L21: while (true) {
                          if (param2 < 0) {
                            ...
                            tm.a(qn.field_d, param0, param6, 0, param4 >> 16, param5 >> 16);
                            param5 = param5 + var9;
                            param4 = param4 + var8;
                            param0 = param0 + qn.field_l;
                            param2--;
                    ...
                    if (param1 < 0) {
                      ...
                      L23: while (true) {
                        if (param2 < 0) {
                          ...
                          tm.a(qn.field_d, param0, param6, 0, param5 >> 16, param4 >> 16);
                          param5 = param5 + var9;
                          param4 = param4 + var8;
                          param0 = param0 + qn.field_l;
                          param2--;
                  ...
                  if (param1 < 0) {
                    ...
                    L29: while (true) {
                      if (param0 < 0) {
                        ...
                        tm.a(qn.field_d, param2, param6, 0, param5 >> 16, param4 >> 16);
                        param4 = param4 + var7;
                        param5 = param5 + var9;
                        param2 = param2 + qn.field_l;
                        param0--;
                        continue L29;
                      }
                    }
                  } else {
                    tm.a(qn.field_d, param2, param6, 0, param5 >> 16, param3 >> 16);
                    param3 = param3 + var8;
                    param5 = param5 + var9;
                    param2 = param2 + qn.field_l;
                    continue L28;
                  ...
                  if (param1 < 0) {
                    ...
                    L31: while (true) {
                      if (param0 < 0) {
                        ...
                        tm.a(qn.field_d, param2, param6, 0, param4 >> 16, param5 >> 16);
                        param4 = param4 + var7;
                        param5 = param5 + var9;
                        param2 = param2 + qn.field_l;
                        param0--;
                    ...
                    tm.a(qn.field_d, param2, param6, 0, param3 >> 16, param5 >> 16);
                    param3 = param3 + var8;
                    param5 = param5 + var9;
                    param2 = param2 + qn.field_l;
                    continue L30;
                  ...
                  if (param0 < 0) {
                    ...
                    L35: while (true) {
                      if (param1 < 0) {
                        ...
                        tm.a(qn.field_d, param2, param6, 0, param3 >> 16, param4 >> 16);
                        param4 = param4 + var8;
                        param3 = param3 + var7;
                        param2 = param2 + qn.field_l;
                        param1--;
                  ...
                  if (param0 < 0) {
                    ...
                    L37: while (true) {
                      if (param1 < 0) {
                        ...
                        tm.a(qn.field_d, param2, param6, 0, param4 >> 16, param3 >> 16);
                        param4 = param4 + var8;
                        param3 = param3 + var7;
                        param2 = param2 + qn.field_l;
                        param1--;
                  ...
                  if (param0 < 0) {
                    ...
                    L43: while (true) {
                      if (param2 < 0) {
                        ...
                        tm.a(qn.field_d, param1, param6, 0, param4 >> 16, param3 >> 16);
                        param3 = param3 + var9;
                        param4 = param4 + var8;
                        param1 = param1 + qn.field_l;
                        param2--;
                        continue L43;
                      }
                    }
                  } else {
                    tm.a(qn.field_d, param1, param6, 0, param4 >> 16, param5 >> 16);
                    param5 = param5 + var7;
                    param4 = param4 + var8;
                    param1 = param1 + qn.field_l;
                    continue L42;
                  ...
                  if (param0 < 0) {
                    ...
                    L45: while (true) {
                      if (param2 < 0) {
                        ...
                        tm.a(qn.field_d, param1, param6, 0, param3 >> 16, param4 >> 16);
                        param3 = param3 + var9;
                        param4 = param4 + var8;
                        param1 = param1 + qn.field_l;
                        param2--;
                    ...
                    tm.a(qn.field_d, param1, param6, 0, param5 >> 16, param4 >> 16);
                    param5 = param5 + var7;
                    param4 = param4 + var8;
                    param1 = param1 + qn.field_l;
                    continue L44;
                  ...
                  if (param2 < 0) {
                    ...
                    L52: while (true) {
                      if (param0 < 0) {
                        ...
                        tm.a(qn.field_d, param1, param6, 0, param5 >> 16, param3 >> 16);
                        param3 = param3 + var7;
                        param5 = param5 + var9;
                        param1 = param1 + qn.field_l;
                        param0--;
                ...
                if (param2 < 0) {
                  ...
                  L54: while (true) {
                    if (param0 < 0) {
                      ...
                      tm.a(qn.field_d, param1, param6, 0, param3 >> 16, param5 >> 16);
                      param3 = param3 + var7;
                      param5 = param5 + var9;
                      param1 = param1 + qn.field_l;
                      param0--;
          ...
          if (var3 >= param1) {
            ...
            L1: while (true) {
              if (var8 >= 128) {
                ...
                L8: {
                  var11 = Math.pow(var11, (double)field_b);
                  var13 = Math.pow(var13, (double)field_b);
                  var15 = Math.pow(var15, (double)field_b);
                ...
                var2++;
                field_h[incrementValue$0] = var20;
                var8++;
                continue L1;
              }
            }
    ...
    final static void c(int param0, int param1) {
        int var2 = field_k[0];
        int var3 = var2 / qn.field_l;
        int var4 = var2 - var3 * qn.field_l;
        field_c = param0 - var4;
        field_j = param1 - var3;
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16, int param17, int param18) {
        ...
        L0: {
          ...
          if (var19 == null) {
            ...
            if (field_f <= 10) {
              L1: {
                field_p = field_o.a(param18, 5409);
                if (field_o.b(-26298, param18) != 0) {
                  stackIn_6_0 = 0;
                  break L1;
                } else {
                  stackIn_6_0 = 1;
        ...
        var20 = field_o.a(param18, (byte) -5);
        tm.a(param0, param1, param2, param3, param4, param5, tm.b(var20, param6), tm.b(var20, param7), tm.b(var20, param8));
    }
                        ...
                        if (param2 < 0) {
                          ...
                          L12: while (true) {
                            if (param1 < 0) {
                              ...
                              tm.a(qn.field_d, param0, 0, 0, param3 >> 16, param5 >> 16, param6, var19);
                              param5 = param5 + var15;
                              param3 = param3 + var16;
                              param6 = param6 + var20;
                              param0 = param0 + qn.field_l;
                          ...
                          tm.a(qn.field_d, param0, 0, 0, param3 >> 16, param4 >> 16, param6, var19);
                          param4 = param4 + var17;
                          param3 = param3 + var16;
                          param6 = param6 + var20;
                          param0 = param0 + qn.field_l;
                      ...
                      if (param2 < 0) {
                        ...
                        L14: while (true) {
                          if (param1 < 0) {
                            ...
                            tm.a(qn.field_d, param0, 0, 0, param5 >> 16, param3 >> 16, param6, var19);
                            param5 = param5 + var15;
                            param3 = param3 + var16;
                            param6 = param6 + var20;
                            param0 = param0 + qn.field_l;
                        ...
                        tm.a(qn.field_d, param0, 0, 0, param4 >> 16, param3 >> 16, param6, var19);
                        param4 = param4 + var17;
                        param3 = param3 + var16;
                        param6 = param6 + var20;
                        param0 = param0 + qn.field_l;
                        ...
                        if (param1 < 0) {
                          ...
                          L21: while (true) {
                            if (param2 < 0) {
                              ...
                              tm.a(qn.field_d, param0, 0, 0, param4 >> 16, param5 >> 16, param6, var19);
                              param5 = param5 + var17;
                              param4 = param4 + var15;
                              param6 = param6 + var20;
                              param0 = param0 + qn.field_l;
                      ...
                      if (param1 < 0) {
                        ...
                        L23: while (true) {
                          if (param2 < 0) {
                            ...
                            tm.a(qn.field_d, param0, 0, 0, param5 >> 16, param4 >> 16, param6, var19);
                            param5 = param5 + var17;
                            param4 = param4 + var15;
                            param6 = param6 + var20;
                            param0 = param0 + qn.field_l;
                    ...
                    if (param1 < 0) {
                      ...
                      L29: while (true) {
                        if (param0 < 0) {
                          ...
                          tm.a(qn.field_d, param2, 0, 0, param5 >> 16, param4 >> 16, param8, var19);
                          param4 = param4 + var16;
                          param5 = param5 + var17;
                          param8 = param8 + var20;
                          param2 = param2 + qn.field_l;
                      ...
                      tm.a(qn.field_d, param2, 0, 0, param5 >> 16, param3 >> 16, param8, var19);
                      param3 = param3 + var15;
                      param5 = param5 + var17;
                      param8 = param8 + var20;
                      param2 = param2 + qn.field_l;
                    ...
                    if (param1 < 0) {
                      ...
                      L31: while (true) {
                        if (param0 < 0) {
                          ...
                          tm.a(qn.field_d, param2, 0, 0, param4 >> 16, param5 >> 16, param8, var19);
                          param4 = param4 + var16;
                          param5 = param5 + var17;
                          param8 = param8 + var20;
                          param2 = param2 + qn.field_l;
                      ...
                      tm.a(qn.field_d, param2, 0, 0, param3 >> 16, param5 >> 16, param8, var19);
                      param3 = param3 + var15;
                      param5 = param5 + var17;
                      param8 = param8 + var20;
                      param2 = param2 + qn.field_l;
                    ...
                    if (param0 < 0) {
                      ...
                      L35: while (true) {
                        if (param1 < 0) {
                          ...
                          tm.a(qn.field_d, param2, 0, 0, param3 >> 16, param4 >> 16, param8, var19);
                          param4 = param4 + var15;
                          param3 = param3 + var16;
                          param8 = param8 + var20;
                          param2 = param2 + qn.field_l;
                    ...
                    if (param0 < 0) {
                      ...
                      L37: while (true) {
                        if (param1 < 0) {
                          ...
                          tm.a(qn.field_d, param2, 0, 0, param4 >> 16, param3 >> 16, param8, var19);
                          param4 = param4 + var15;
                          param3 = param3 + var16;
                          param8 = param8 + var20;
                          param2 = param2 + qn.field_l;
                    ...
                    if (param0 < 0) {
                      ...
                      L43: while (true) {
                        if (param2 < 0) {
                          ...
                          tm.a(qn.field_d, param1, 0, 0, param4 >> 16, param3 >> 16, param7, var19);
                          param3 = param3 + var17;
                          param4 = param4 + var15;
                          param7 = param7 + var20;
                          param1 = param1 + qn.field_l;
                      ...
                      tm.a(qn.field_d, param1, 0, 0, param4 >> 16, param5 >> 16, param7, var19);
                      param5 = param5 + var16;
                      param4 = param4 + var15;
                      param7 = param7 + var20;
                      param1 = param1 + qn.field_l;
                    ...
                    if (param0 < 0) {
                      ...
                      L45: while (true) {
                        if (param2 < 0) {
                          ...
                          tm.a(qn.field_d, param1, 0, 0, param3 >> 16, param4 >> 16, param7, var19);
                          param3 = param3 + var17;
                          param4 = param4 + var15;
                          param7 = param7 + var20;
                          param1 = param1 + qn.field_l;
                      ...
                      tm.a(qn.field_d, param1, 0, 0, param5 >> 16, param4 >> 16, param7, var19);
                      param5 = param5 + var16;
                      param4 = param4 + var15;
                      param7 = param7 + var20;
                      param1 = param1 + qn.field_l;
                    ...
                    if (param2 < 0) {
                      ...
                      L52: while (true) {
                        if (param0 < 0) {
                          ...
                          tm.a(qn.field_d, param1, 0, 0, param5 >> 16, param3 >> 16, param7, var19);
                          param3 = param3 + var16;
                          param5 = param5 + var17;
                          param7 = param7 + var20;
                          param1 = param1 + qn.field_l;
                  ...
                  if (param2 < 0) {
                    ...
                    L54: while (true) {
                      if (param0 < 0) {
                        ...
                        tm.a(qn.field_d, param1, 0, 0, param3 >> 16, param5 >> 16, param7, var19);
                        param3 = param3 + var16;
                        param5 = param5 + var17;
                        param7 = param7 + var20;
                        param1 = param1 + qn.field_l;
    ...
    static {
        ...
        for (var0 = 0; var0 < 2048; var0++) {
            field_n[var0] = (int)(65536.0 * Math.sin((double)var0 * 0.0030679615));
