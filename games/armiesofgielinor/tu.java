...
final class tu extends ka {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  qn.field_d[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              tu.a(qn.field_d, ((tu) this).field_J[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    tu(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        ...
        ((tu) this).field_J = new byte[256][];
        ((tu) this).field_J = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (qn.field_k == null) {
                  tu.a(qn.field_d, ((tu) this).field_J[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  tu.a(qn.field_d, ((tu) this).field_J[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, qn.field_k, qn.field_c);
                  break L5;
                }
              }
              return;
