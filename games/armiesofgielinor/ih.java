...
class ih extends hn {
    ...
    private final void a(byte param0) {
        ...
        L2: while (true) {
          if (var3 != this.field_t) {
            ...
            L4: while (true) {
              L5: {
                if (var3 != this.field_q.field_i[var2]) {
                  break L5;
                } else {
                  this.field_q.d(var2);
    ...
    private final int a(byte param0, mi param1) {
        ...
        try {
          ...
          L7: {
            ...
            stackIn_24_1 = new StringBuilder().append("ih.CA(").append(param0).append(',');
    ...
    final void a(boolean param0, mi param1, int param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_12_1 = new StringBuilder().append("ih.TA(").append(param0).append(',');
    ...
    synchronized void a(boolean param0, byte param1, boolean param2, um param3) {
        ...
        try {
            ...
            throw ig.a((Throwable) ((Object) runtimeException), "ih.EA(" + param0 + ',' + param1 + ',' + param2 + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final synchronized boolean a(p param0, kl param1, int param2, um param3, byte param4) {
        ...
        try {
          ...
          L5: {
            ...
            stackIn_23_1 = new StringBuilder().append("ih.SA(");
          ...
          throw ig.a((Throwable) ((Object) stackIn_24_0), stackIn_30_2 + ',' + param4 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
    ...
    synchronized void b(int[] param0, int param1, int param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_11_1 = new StringBuilder().append("ih.E(");
    ...
    final boolean c(byte param0, mi param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_14_1 = new StringBuilder().append("ih.DA(").append(param0).append(',');
    ...
    final synchronized void h(int param0) {
        ...
        io var5 = (io) ((Object) this.field_T.b(1));
    ...
    private final void b(boolean param0, int param1) {
        ...
        L3: {
          if (!param0) {
            ...
            var5 = (um) null;
            this.a((p) null, (kl) null, -24, (um) null, (byte) 111);
            break L3;
          }
        }
    }
    ...
    private final void a(int param0, int param1, int param2, int param3) {
        mi var6 = null;
        int var7 = ArmiesOfGielinor.field_M ? 1 : 0;
        mi var8 = this.field_M[param3][param1];
        if (var8 == null) {
            return;
        }
        ...
        if (-1 == (this.field_o[param3] & 2 ^ -1)) {
            ...
            while (var6 != null) {
                if (var6.field_m == var8.field_m && (var6.field_x ^ -1) > -1 && var8 != var6) {
                    var8.field_x = 0;
                    break;
                }
    ...
    private final int a(int param0, mi param1) {
        ...
        try {
          ...
          L6: {
            ...
            stackIn_15_1 = new StringBuilder().append("ih.BA(").append(param0).append(',');
    ...
    final boolean a(int param0, int param1, mi param2, byte param3, int[] param4) {
        ...
        try {
                    ...
                    L16: while (true) {
                      L17: {
                        if (param2.field_p >= var7.field_g.length - 2) {
                          ...
                          if (((255 & var7.field_g[2 + param2.field_p]) << -1112088760 ^ -1) <= (param2.field_x ^ -1)) {
                            break L17;
                          } else {
          ...
          L21: {
            ...
            stackIn_67_1 = new StringBuilder().append("ih.D(").append(param0).append(',').append(param1).append(',');
          ...
          throw ig.a((Throwable) ((Object) stackIn_68_0), stackIn_71_2 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_9_0 != 0;
        } else {
    ...
    private final void e(int param0, int param1) {
        int var4 = ArmiesOfGielinor.field_M ? 1 : 0;
        mi var3 = (mi) ((Object) this.field_Q.field_p.e((byte) 121));
        if (param0 != -23024) {
            this.field_W = (int[]) null;
        }
        while (var3 != null) {
            if (-1 < (param1 ^ -1) || param1 == var3.field_m) {
    ...
    private final void b(int param0, int param1, int param2, int param3) {
        ...
        var10 = (io) ((Object) this.field_T.a(-22, (long)this.field_O[param3]));
        var11 = var10;
        var12 = var11;
        if (var11 != null) {
          ...
          if (var6 != null) {
            L3: {
              ...
              if (this.field_W[param3] != 0) {
                ...
                this.a(stackIn_16_1 != 0, var7, param0 + -48);
                break L3;
              } else {
    ...
    private final int b(byte param0, mi param1) {
        ...
        try {
          L0: {
            ...
            if ((var3_int ^ -1) <= -8193) {
              stackIn_4_0 = 16384 - ((-var3_int + 16384) * (128 - param1.field_E) - -32 >> -436802810);
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
              stackIn_2_0 = 32 + var3_int * param1.field_E >> -1156598330;
              decompiledRegionSelector0 = 0;
              break L0;
            }
          }
          ...
          L1: {
            ...
            stackIn_7_1 = new StringBuilder().append("ih.P(").append(param0).append(',');
    ...
    private final void a(boolean param0, boolean param1) {
        ...
        var3 = var5;
        while ((var5 ^ -1) > -17) {
            this.field_D[var5] = rn.a(this.field_P[var5], -128);
            var5++;
        }
    }
