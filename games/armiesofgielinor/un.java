...
final class un {
    ...
    final boolean b() {
        ...
        int var2 = ((un) this).field_f.length;
        System.arraycopy((Object) (Object) ((un) this).field_f, 0, (Object) (Object) field_c, 0, var2);
        int var3 = field_d[((un) this).field_l - 1];
        int var4 = wl.b(var3 - 1, -13337);
        field_h[0] = qs.a(var4);
        field_h[1] = qs.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((un) this).field_j.length; var6++) {
            var7 = ((un) this).field_j[var6];
            var8 = ((un) this).field_e[var7];
            var9 = ((un) this).field_b[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = qs.field_M[((un) this).field_i[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((un) this).field_a[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_h[incrementValue$0] = var13 >= 0 ? qs.field_M[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    un() {
        ...
        if (var1 == 1) {
          var2 = qs.a(5);
          var3 = 0;
          ((un) this).field_j = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((un) this).field_e = new int[var3];
              ((un) this).field_b = new int[var3];
              ((un) this).field_i = new int[var3];
              ((un) this).field_a = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((un) this).field_l = qs.a(2) + 1;
                  var4 = qs.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((un) this).field_f = new int[var5];
                      ((un) this).field_f[0] = 0;
                      ((un) this).field_f[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((un) this).field_e[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((un) this).field_f[incrementValue$2] = qs.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((un) this).field_e[((un) this).field_j[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((un) this).field_e[var4] = qs.a(3) + 1;
                    int dupTemp$3 = qs.a(2);
                    ((un) this).field_b[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((un) this).field_i[var4] = qs.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_k[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_k[var11];
        }
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((un) this).field_f.length;
        var4 = field_d[((un) this).field_l - 1];
        var5 = field_g;
        field_g[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_h[0] * ((un) this).field_l;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_c[var16];
                  var10 = field_h[var16] * ((un) this).field_l;
            ...
            L3: {
              var7 = un.a(field_c, var6);
              var8_int = un.b(field_c, var6);
              var9 = this.a(field_c[var7], field_h[var7], field_c[var8_int], field_h[var8_int], field_c[var6]);
              var10 = field_h[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
