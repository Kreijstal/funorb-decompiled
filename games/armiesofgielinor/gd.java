...
final class gd extends kk {
          ...
          if (var8 < 50) {
            L2: {
              ...
              if (var10 < 50) {
                ...
                var4++;
                field_fb[var4] = var13 + (((((gd) this).field_R[param0] & 65535) - var13) * var14 >> 16);
                break L2;
              }
            }
            if (var9 < 50) {
              ...
              var4++;
              field_fb[var4] = var13 + (((((gd) this).field_t[param0] & 65535) - var13) * var14 >> 16);
              break L1;
            }
          } else {
            ...
            var4++;
            field_fb[var4] = ((gd) this).field_Z[param0] & 65535;
            break L1;
          }
        }
        L3: {
          if (var9 < 50) {
            L4: {
              ...
              if (var8 < 50) {
                ...
                var4++;
                field_fb[var4] = var13 + (((((gd) this).field_Z[param0] & 65535) - var13) * var14 >> 16);
                break L4;
              }
            }
            if (var10 < 50) {
            ...
            var4++;
            field_fb[var4] = ((gd) this).field_t[param0] & 65535;
            break L3;
          }
        }
        L5: {
          if (var10 < 50) {
            ...
            var4++;
            field_fb[var4] = ((gd) this).field_R[param0] & 65535;
            break L5;
          }
        }
        L7: {
    ...
    final kk a(boolean param0, boolean param1, boolean param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    try {
                        if (stackIn_2_0.length >= ((gd) this).field_Y) {
                            statePc = 8;
                        } else {
                            statePc = 3;
                        }
                ...
                case 10: {
                    try {
                        if (stackIn_10_0.length >= ((gd) this).field_Y) {
                            statePc = 16;
                        } else {
                            statePc = 11;
                        }
    ...
    private final kk a(boolean param0, boolean param1, gd param2, byte[] param3, short[] param4, int[] param5, int[] param6, int[] param7) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    try {
                        if (((gd) (Object) stackIn_2_0).field_G.length >= ((gd) this).field_I) {
                            statePc = 8;
                        } else {
                            statePc = 3;
                        }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, long param7) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 22: {
                    try {
                        this.a(stackIn_22_1 != 0, stackIn_22_2 != 0, param7, (int) ((gd) this).field_A, ((gd) this).field_A << 1);
                        statePc = 25;
                        continue stateLoop;
                    } catch (Throwable stateCaught_22) {
                        caughtException = stateCaught_22;
    ...
    gd(js param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        int var15 = 0;
        lh stackIn_6_0 = null;
        js stackIn_34_0 = null;
        js stackIn_47_0 = null;
        Object stackIn_63_0 = null;
        lh stackOut_5_0 = null;
        js stackOut_33_0 = null;
        js stackOut_46_0 = null;
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 6: {
                    try {
                        if (!((lh) (Object) stackIn_6_0).a(true, var10)) {
                            statePc = 11;
                        } else {
                            statePc = 7;
                        }
                ...
                case 34: {
                    try {
                        if (((js) (Object) stackIn_34_0).field_t[var10] != 0) {
                            statePc = 40;
                        } else {
                            statePc = 35;
                        }
                ...
                case 47: {
                    try {
                        if (((js) (Object) stackIn_47_0).field_t[var11] != 0) {
                            statePc = 52;
                        } else {
                            statePc = 48;
                        }
