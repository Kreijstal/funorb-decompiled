...
final class in {
    ...
    final int b() {
        ...
        while (this.field_d[var1] >= 0) {
            var1 = qs.a() != 0 ? this.field_d[var1] : var1 + 1;
        }
        return this.field_d[var1] ^ -1;
    }

    final float[] a() {
        return this.field_a[this.b()];
    }
    ...
    in() {
        ...
        L0: {
          discarded$2 = qs.a(24);
          this.field_b = qs.a(16);
          this.field_f = qs.a(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_f) {
                ...
                var4_int = qs.a(wl.b(this.field_f - var2, -13337));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_f * this.field_b;
                break L9;
              } else {
                var7 = in.a(this.field_f, this.field_b);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_a = new float[this.field_f][this.field_b];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
