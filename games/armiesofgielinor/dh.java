...
final class dh extends bi implements java.awt.image.ImageProducer, java.awt.image.ImageObserver {
    ...
    final void a(int param0, int param1, java.awt.Component param2, int param3) {
        ...
        try {
            ...
            this.a(false);
            discarded$0 = param2.prepareImage(this.field_h, (java.awt.image.ImageObserver) (this));
            this.a(false);
            discarded$1 = param2.prepareImage(this.field_h, (java.awt.image.ImageObserver) (this));
            this.a(false);
            discarded$2 = param2.prepareImage(this.field_h, (java.awt.image.ImageObserver) (this));
            this.a(5605);
          ...
          if (var3 > -1) {
            ...
            if (null != td.field_d[var3][var4]) {
              if (0 == td.field_d[var3][var4].field_o.length) {
                ...
                discarded$2 = ub.a((byte) 52, td.field_d[var3][var4]);
                return;
              }
            } else {
              return;
          ...
          if (var3 > -1) {
            ...
            if (null != td.field_d[var3][var4]) {
              if (0 == td.field_d[var3][var4].field_o.length) {
                ...
                discarded$3 = ub.a((byte) 52, td.field_d[var3][var4]);
                return;
              }
            } else {
              return;
    ...
    final static fo a(String param0, byte param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("dh.F(");
    ...
    final void a(int param0, java.awt.Graphics param1, int param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              this.a(false);
              discarded$3 = param1.drawImage(this.field_h, param3, param2, (java.awt.image.ImageObserver) (this));
              if (param0 == 255) {
                break L1;
              } else {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("dh.C(").append(param0).append(',');
          ...
          throw ig.a((Throwable) ((Object) stackIn_6_0), stackIn_6_2 + ',' + param2 + ',' + param3 + ')');
        }
    }
