...
final class nw extends oj {
    ...
    final static void a(byte[] param0, String[][] param1, int param2, wk[][] param3, int param4, boolean param5, String[][] param6, int param7, kl param8, String[] param9, int param10, wk[][] param11, String[] param12, kl param13, ru[] param14, int[] param15, byte[] param16, String[] param17, kl param18, int[] param19) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("nw.S(");
          ...
          L6: {
            ...
            stackOut_16_1 = ((StringBuilder) (Object) stackIn_16_1).append(stackIn_16_2).append(',').append(param7).append(',');
          ...
          L8: {
            ...
            stackOut_22_1 = ((StringBuilder) (Object) stackIn_22_1).append(stackIn_22_2).append(',').append(param10).append(',');
    ...
    final void a(ha param0, int param1) {
        ...
        try {
            this.field_C = true;
            if (-8 != (this.field_w.field_P ^ -1)) {
                if ((this.field_w.field_P ^ -1) != -9) {
    ...
    final static String a(String param0, byte param1, int param2) {
        ...
        try {
          L0: {
            ...
            if (hg.a((byte) -31, var10)) {
              if ((th.field_a ^ -1) != -3) {
                ...
                if (var8 != null) {
                  discarded$1 = wh.field_c.a(true, var8);
                  L1: while (true) {
                    L2: {
                      L3: {
                  ...
                  stackOut_9_0 = fo.a(4800, sc.field_d, new String[]{param0});
                  stackIn_10_0 = stackOut_9_0;
          ...
          L5: {
            ...
            stackOut_21_1 = new StringBuilder().append("nw.E(");
          ...
          throw ig.a((Throwable) ((Object) stackIn_24_0), stackIn_24_2 + ',' + param1 + ',' + param2 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_3_0;
        } else {
