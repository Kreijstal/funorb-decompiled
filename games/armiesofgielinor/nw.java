...
final class nw extends oj {
    ...
    final static kl a(int param0, int param1, byte param2, boolean param3, boolean param4) {
        if (param2 < 98) {
          field_z = null;
          return tk.a(param1, param4, 1, false, false, param0);
        } else {
          return tk.a(param1, param4, 1, false, false, param0);
        }
    }
        ...
        try {
          L0: {
            if (param1 <= -84) {
              ...
              stackOut_3_0 = ((nw) this).a((byte) -39, param2, param0, true);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("nw.A(");
    ...
    final static void a(byte[] param0, String[][] param1, int param2, wk[][] param3, int param4, boolean param5, String[][] param6, int param7, kl param8, String[] param9, int param10, wk[][] param11, String[] param12, kl param13, ru[] param14, int[] param15, byte[] param16, String[] param17, kl param18, int[] param19) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("nw.S(");
          ...
          L3: {
            stackOut_8_0 = (RuntimeException) (Object) stackIn_8_0;
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(',').append(4).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
          ...
          L4: {
            ...
            stackOut_11_1 = ((StringBuilder) (Object) stackIn_11_1).append(stackIn_11_2).append(',').append(1).append(',').append(true).append(',');
          ...
          L7: {
            ...
            stackOut_20_1 = ((StringBuilder) (Object) stackIn_20_1).append(stackIn_20_2).append(',').append(-5429).append(',');
    ...
    final void a(ha param0, int param1) {
        ...
        try {
            ...
            if (((nw) this).field_w.field_P != 7) {
                if (((nw) this).field_w.field_P != 8) {
                    ((nw) this).field_w.field_I = ((nw) this).field_w.field_I | ((nw) this).field_A;
                }
            }
            var3_int = ((nw) this).field_D;
            if (!(var3_int <= ((nw) this).field_w.field_A + ((nw) this).field_w.field_Y)) {
                var3_int = ((nw) this).field_w.field_Y + ((nw) this).field_w.field_A;
            }
    ...
    final static String a(String param0, byte param1, int param2) {
        ...
        try {
            ...
            if (hg.a((byte) -31, var10)) {
              if (th.field_a != 2) {
                ...
                if (var8 != null) {
                  ...
                  stackOut_9_0 = fo.a(4800, sc.field_d, new String[1]);
          ...
          L2: {
            ...
            stackOut_16_1 = new StringBuilder().append("nw.E(");
          ...
          throw ig.a((Throwable) (Object) stackIn_19_0, stackIn_19_2 + ',' + -27 + ',' + param2 + ')');
        }
