...
final class ee extends mn {
    ...
    final static void a(ru[] param0, kl param1, int param2, int[] param3, kl param4) {
        ...
        try {
            ...
            L4: while (true) {
              if (vh.field_n <= var7_int) {
                ...
                L8: {
                  ...
                  var7.a(var5, var24);
                  t.field_a.a(var5, var24);
                  gm.field_f.a(var5, var24);
                ...
                dupTemp$0 = wj.a(-12310, fk.a("smallbutton_active", (byte) -124, param1, "lobby"));
                je.field_Q.field_H = dupTemp$0;
                je.field_Q.field_U = dupTemp$0;
                ...
                dupTemp$1 = wj.a(-12310, fk.a("gameoptionbutton_active", (byte) -128, param1, "lobby"));
                eb.field_a.field_H = dupTemp$1;
                eb.field_a.field_U = dupTemp$1;
                ...
                dupTemp$2 = wj.a(-12310, fk.a("chatbutton_active", (byte) -124, param1, "lobby"));
                rd.field_e.field_H = dupTemp$2;
                rd.field_e.field_U = dupTemp$2;
                ...
                dupTemp$3 = wj.a(-12310, fk.a("chatfilterbutton_active", (byte) -124, param1, "lobby"));
                bd.field_o.field_H = dupTemp$3;
                bd.field_o.field_U = dupTemp$3;
          ...
          L9: {
            ...
            stackIn_27_1 = new StringBuilder().append("ee.E(");
          ...
          throw ig.a((Throwable) ((Object) stackIn_28_0), stackIn_37_2 + ')');
        }
    }
    ...
    private final String a(String[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 == 30536) {
              stackIn_4_0 = this.a(12, param0, "mind control");
          ...
          L1: {
            ...
            stackIn_7_1 = new StringBuilder().append("ee.F(");
    ...
    final bd a(int param0, ha param1) {
        ...
        try {
          L0: {
            ...
            if (var5 == null) {
              discarded$0 = this.a(new String[]{"no unit at ", ci.c(this.field_z, 0, this.field_w)}, 30536);
              stackIn_5_0 = null;
              decompiledRegionSelector0 = 0;
              break L0;
            } else {
              if (-1 != (var5.field_B ^ -1)) {
                if (72 == var5.field_N) {
                  stackIn_13_0 = this.field_y.a(100, param1);
                  decompiledRegionSelector0 = 3;
                  break L0;
                } else {
                  discarded$1 = this.a(new String[]{"unit at ", ci.c(this.field_z, 0, this.field_w), " is not TYPE_SPHINX"}, 30536);
                  stackIn_11_0 = null;
                  decompiledRegionSelector0 = 2;
                  break L0;
                }
              } else {
                discarded$2 = this.a(new String[]{"unit at ", ci.c(this.field_z, 0, this.field_w), " has attacked"}, 30536);
                stackIn_8_0 = null;
                decompiledRegionSelector0 = 1;
                break L0;
              }
          ...
          L2: {
            ...
            stackIn_16_1 = new StringBuilder().append("ee.C(").append(param0).append(',');
