...
final class uh {
    ...
    final static void a(int param0, boolean param1, int[] param2, int[] param3, String param4, boolean param5, int param6) {
        ...
        try {
          ...
          ku.field_J.b();
          qn.b();
          int discarded$2 = dm.a(-1, -1, param2, -1, param5, param3, -1, false, 0, false, 0, param4);
          no.field_P.b();
          ...
          L0: {
            ...
            stackOut_2_1 = new StringBuilder().append("uh.A(").append(param0).append(',').append(true).append(',');
          ...
          throw ig.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + ',' + param5 + ',' + param6 + ')');
        }
    }
