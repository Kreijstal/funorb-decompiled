...
final class ja extends tc {
    ...
    final boolean a(int param0, ja param1) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_11_1 = new StringBuilder().append("ja.C(").append(param0).append(44);
    ...
    final void a(byte param0, jd param1) {
        ...
        try {
            ...
            throw ig.a((Throwable) (Object) runtimeException, "ja.I(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final int b(int param0, ja param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("ja.E(").append(param0).append(44);
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
    ...
    ja(jd param0) {
        try {
            ...
            throw ig.a((Throwable) (Object) runtimeException, "ja.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
