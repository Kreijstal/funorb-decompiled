...
final class it {
    ...
    final static wk[] a(int param0, wk param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("it.C(").append(17).append(',');
    ...
    final static void a(int param0, boolean param1, int param2, vh param3, int param4) {
        try {
            ...
            throw ig.a((Throwable) (Object) runtimeException, "it.D(" + param0 + ',' + false + ',' + param2 + ',' + (param3 != null ? "{...}" : "null") + ',' + param4 + ')');
        }
    }
