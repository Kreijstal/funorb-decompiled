...
abstract class mk extends rb implements fb {
    ...
    public final void b(fn param0, int param1) {
        try {
            ...
            throw ig.a((Throwable) (Object) runtimeException, "mk.FA(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    mk(fn param0) {
        try {
            ...
            throw ig.a((Throwable) (Object) runtimeException, "mk.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
