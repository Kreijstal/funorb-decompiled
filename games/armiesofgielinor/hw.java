...
final class hw extends mn {
    ...
    final static String a(CharSequence param0, boolean param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("hw.J(");
    ...
    private final String a(String[] param0, byte param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ((hw) this).a(119, param0, "summon");
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("hw.I(");
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    final static String a(int param0, Class param1) {
        ...
        try {
          L0: {
            ...
            if (param1.isArray()) {
              stackOut_5_0 = hw.a(param0, param1.getComponentType()) + "[]";
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("hw.K(").append(param0).append(',');
    ...
    final static void a(byte param0, int param1, int param2) {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var3 = decompiledCaughtException;
          throw ig.a((Throwable) (Object) var3, "hw.E(" + 29 + ',' + param1 + ',' + param2 + ')');
        }
    }
    ...
    final bd a(int param0, ha param1) {
        ...
        try {
          L0: {
            ...
            L3: {
              var3_int = bw.field_m[((hw) this).field_v][1];
              if (var3_int != -1) {
                var4 = 0;
            ...
            if (0 == (param1.c(((hw) this).field_E, -27300, ((hw) this).field_A, ((hw) this).field_p) & 1 << var3_int)) {
              ...
              if (param1.b(((hw) this).field_A, -26813, ((hw) this).field_v, ((hw) this).field_E, ((hw) this).field_p)) {
                ...
                stackOut_29_0 = new be(((hw) this).field_E, ((hw) this).field_A, ((hw) this).field_v, var4, ((hw) this).field_p);
          ...
          L7: {
            ...
            stackOut_31_1 = new StringBuilder().append("hw.C(").append(param0).append(',');
    ...
    final static void a(byte param0, int[] param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("hw.F(").append(param0).append(',');
