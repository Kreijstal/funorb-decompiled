...
abstract class ka extends ms {
    ...
    int field_v;
    private int[] field_Q;
    private static StringBuilder field_U;
    int field_z;
            ...
            switch (statePc) {
                ...
                case 26: {
                    try {
                        ...
                        var9_int = dq.a(49, var10);
                        var4 = var4 + ((ka) this).field_E[var9_int].field_g;
                        var3 = 0;
                        statePc = 27;
                        continue stateLoop;
                ...
                case 31: {
                    var7 = (char)(kw.a((char) var7, 39) & 255);
                    var4 = var4 + ((ka) this).field_F[var7];
                ...
                case 33: {
                    var4 = var4 + ((ka) this).field_K[(var3 << 8) + var7];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = up.a(' ', 0, field_U, true);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
                ...
                case 8: {
                    ...
                    var9 = -1;
                    StringBuilder discarded$11 = field_U.append(60);
                    StringBuilder discarded$12 = field_U.append(var15);
                    StringBuilder discarded$13 = field_U.append(62);
                ...
                case 9: {
                    param2[var11] = field_U.toString().substring(var5, field_U.length());
                    var11++;
                    var5 = field_U.length();
                    var4 = 0;
                    var6 = -1;
                ...
                case 13: {
                    var4 = var4 + ((ka) this).field_K[(var10 << 8) + 60];
                    statePc = 14;
                    continue stateLoop;
                }
                case 14: {
                ...
                case 18: {
                    var4 = var4 + ((ka) this).field_K[(var10 << 8) + 62];
                    statePc = 19;
                    continue stateLoop;
                }
                case 19: {
                ...
                case 23: {
                    var4 = var4 + ((ka) this).field_K[(var10 << 8) + 160];
                    statePc = 24;
                    continue stateLoop;
                }
                case 24: {
                ...
                case 28: {
                    var4 = var4 + ((ka) this).field_K[(var10 << 8) + 173];
                    statePc = 29;
                    continue stateLoop;
                }
                case 29: {
                ...
                case 33: {
                    var4 = var4 + ((ka) this).field_K[(var10 << 8) + 215];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
                ...
                case 38: {
                    var4 = var4 + ((ka) this).field_K[(var10 << 8) + 128];
                    statePc = 39;
                    continue stateLoop;
                }
                case 39: {
                ...
                case 43: {
                    var4 = var4 + ((ka) this).field_K[(var10 << 8) + 169];
                    statePc = 44;
                    continue stateLoop;
                }
                case 44: {
                ...
                case 48: {
                    var4 = var4 + ((ka) this).field_K[(var10 << 8) + 174];
                    statePc = 49;
                    continue stateLoop;
                }
                case 49: {
                ...
                case 51: {
                    try {
                        ...
                        var16_int = dq.a(25, var18);
                        var4 = var4 + ((ka) this).field_E[var16_int].field_g;
                        var10 = 0;
                        statePc = 54;
                        continue stateLoop;
                ...
                case 58: {
                    StringBuilder discarded$14 = field_U.append(var14);
                ...
                case 60: {
                    var4 = var4 + ((ka) this).field_K[(var10 << 8) + var14];
                    statePc = 61;
                    continue stateLoop;
                }
                case 61: {
                ...
                case 70: {
                    param2[var11] = field_U.toString().substring(var5, var6 - var8);
                    var11++;
                    var5 = var6;
                    var6 = -1;
                    var4 = var4 - var7;
    ...
    final int a(char param0) {
        return ((ka) this).field_F[kw.a(param0, -106) & 255];
    }
    ...
    final int a(String param0, int param1) {
        ...
        int var5 = 0;
        int var6 = 0;
        var3 = ((ka) this).a(param0, new int[1], field_w);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (var5 >= var3) {
    ...
    private final void b(String param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 27: {
                    try {
                        this.a(field_P, field_G, field_x);
                        statePc = 30;
                        continue stateLoop;
    ...
    final void c(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.b(param3, param4);
        this.b(param0, param1 - ((ka) this).a(param0) / 2, param2);
    }
    ...
    final void a(si[] param0, int[] param1) {
        if (param1 != null) {
    ...
    final void a(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.b(param3, param4);
        this.b(param0, param1 - ((ka) this).a(param0), param2);
    }
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_I = (param1 - ((ka) this).a(param0) << 8) / var3;
                break L1;
              }
            }
            return;
        ...
        if (param0 != null) {
          L0: {
            ...
            if (param10 != 0) {
              ...
              param10 = ((ka) this).field_v;
              break L0;
            }
          }
          L1: {
            var12 = new int[]{param3};
            if (param4 >= ((ka) this).field_H + ((ka) this).field_L + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = ((ka) this).a(param0, var12, field_w);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - ((ka) this).field_H - ((ka) this).field_L - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + ((ka) this).field_H + var15;
                  param10 = param10 + var15;
                  break L3;
                } else {
                  var14 = param2 + param4 - ((ka) this).field_L - (var13 - 1) * param10;
                  break L3;
                }
              } else {
                var14 = param2 + ((ka) this).field_H + (param4 - ((ka) this).field_H - ((ka) this).field_L - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + ((ka) this).field_H;
              break L3;
            }
          }
          var15 = 0;
                  ...
                  if (param8 != 2) {
                    L6: {
                      if (var15 != var13 - 1) {
                        ...
                        this.b(field_w[var15], param1, var14);
                        field_I = 0;
                        break L6;
                      } else {
                        this.b(field_w[var15], param1, var14);
                    ...
                    this.b(field_w[var15], param1 + param3 - ((ka) this).a(field_w[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_w[var15], param1 + (param3 - ((ka) this).a(field_w[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    final int c(String param0, int param1) {
        return ((ka) this).a(param0, new int[1], field_w);
    }

    final static String a(ka param0, String param1, int param2) {
        int var3 = 0;
        int var4 = 0;
        int var5 = 0;
        int var6 = 0;
    ...
    final int a(String param0, int param1, int param2) {
        if (param2 == 0) {
            param2 = ((ka) this).field_v;
        }
        int var4 = ((ka) this).a(param0, new int[1], field_w);
        int var5 = (var4 - 1) * param2;
        return ((ka) this).field_H + var5 + ((ka) this).field_L;
    }
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                      ...
                      if (var5_int >= 256) {
                        ...
                        L4: while (true) {
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ((ka) this).field_K = new byte[65536];
                                var7 = 0;
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    ((ka) this).field_v = var25[32] + var22[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                ((ka) this).field_K[(var7 << 8) + var8] = (byte)ka.a(var23, var24, var25, ((ka) this).field_F, var22, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                ((ka) this).field_F[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
            ...
            var2 = 0;
            L10: while (true) {
              if (var2 >= ((ka) this).field_F.length) {
                ((ka) this).field_v = param0[256] & 255;
                break L0;
              } else {
                ((ka) this).field_F[var2] = param0[var2] & 255;
                var2++;
                continue L10;
              }
            }
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9) {
        return ((ka) this).a(param0, param1, param2, param3, param4, param5, param6, 256, param7, param8, param9);
    }
            ...
            switch (statePc) {
                ...
                case 23: {
                    try {
                        ...
                        var10 = dq.a(12, var13);
                        var11_ref_si = ((ka) this).field_E[var10];
                ...
                case 24: {
                    try {
                        stackOut_24_0 = ((ka) this).field_C[var10];
                ...
                case 25: {
                    try {
                        stackOut_25_0 = var11_ref_si.field_f;
                ...
                case 27: {
                    try {
                        var11_ref_si.a(param1, param2 + ((ka) this).field_v - var12);
                        statePc = 29;
                        continue stateLoop;
                    } catch (Throwable stateCaught_27) {
                        caughtException = stateCaught_27;
                ...
                case 28: {
                    try {
                        var11_ref_si.a(param1, param2 + ((ka) this).field_v - var12, field_T);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_si.field_g;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
                ...
                case 35: {
                    var8 = (char)(kw.a((char) var8, 90) & 255);
                    if (((ka) this).field_K == null) {
                        statePc = 38;
                    } else {
                        statePc = 36;
                ...
                case 37: {
                    param1 = param1 + ((ka) this).field_K[(var5 << 8) + var8];
                    statePc = 38;
                    continue stateLoop;
                }
                case 38: {
                    var9 = ((ka) this).field_M[var8];
                    var10 = ((ka) this).field_A[var8];
                    var11 = param1;
                    if (var8 == 32) {
                        statePc = 46;
                    } else {
                ...
                case 41: {
                    ((ka) this).a(var8, param1 + ((ka) this).field_Q[var8] + 1, param2 + ((ka) this).field_R[var8] + 1, var9, var10, field_S, true);
                    statePc = 42;
                    continue stateLoop;
                }
                case 42: {
                    ((ka) this).a(var8, param1 + ((ka) this).field_Q[var8], param2 + ((ka) this).field_R[var8], var9, var10, field_D, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 43: {
                ...
                case 44: {
                    ((ka) this).a(var8, param1 + ((ka) this).field_Q[var8] + 1, param2 + ((ka) this).field_R[var8] + 1, var9, var10, field_S, field_T, true);
                    statePc = 45;
                    continue stateLoop;
                }
                case 45: {
                    ((ka) this).a(var8, param1 + ((ka) this).field_Q[var8], param2 + ((ka) this).field_R[var8], var9, var10, field_D, field_T, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 46: {
                ...
                case 48: {
                    param1 = param1 + ((ka) this).field_F[var8];
                    if (field_u == -1) {
                        statePc = 50;
                    } else {
                        statePc = 49;
                ...
                case 49: {
                    qn.e(var11, param2 + (int)((double)((ka) this).field_v * 0.7), param1 - var11, field_u);
                    statePc = 50;
                    continue stateLoop;
                }
                case 50: {
                ...
                case 51: {
                    qn.e(var11, param2 + ((ka) this).field_v + 1, param1 - var11, field_B);
                    statePc = 52;
                    continue stateLoop;
                }
                case 52: {
    ...
    ka(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((ka) this).field_v = 0;
        ((ka) this).field_Q = param1;
        ((ka) this).field_R = param2;
        ((ka) this).field_M = param3;
        ((ka) this).field_A = param4;
        this.a(param0);
        var6 = 2147483647;
        var7 = -2147483648;
        var8 = 0;
        L0: while (true) {
          if (var8 >= 256) {
            ((ka) this).field_H = ((ka) this).field_v - var6;
            ((ka) this).field_L = var7 - ((ka) this).field_v;
            ((ka) this).field_z = ((ka) this).field_v - ((ka) this).field_R[88];
            ((ka) this).field_y = ((ka) this).field_v - ((ka) this).field_R[120];
          } else {
            L1: {
              if (((ka) this).field_R[var8] >= var6) {
                break L1;
              } else {
                if (((ka) this).field_A[var8] == 0) {
                  break L1;
                } else {
                  var6 = ((ka) this).field_R[var8];
                  break L1;
                }
              }
            }
            if (((ka) this).field_R[var8] + ((ka) this).field_A[var8] > var7) {
              var7 = ((ka) this).field_R[var8] + ((ka) this).field_A[var8];
              var8++;
              continue L0;
            } else {
              var8++;
