...
final class wc extends nl {
        ...
        try {
          L0: {
            ...
            if (this.b(1, param1, param5, param0, param2)) {
              L3: {
                if (1 == param6) {
                  this.field_L = -this.field_p + (param5 - param2);
                  bn.field_f = (wc) (this);
                  this.field_N = -param1 + -this.field_B + param0;
                  break L3;
                } else {
                  break L3;
                }
          ...
          L4: {
            ...
            stackOut_14_1 = new StringBuilder().append("wc.NA(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
        ...
        try {
          L0: {
            L1: {
              L2: {
                L3: {
                  if (!(this.field_E instanceof fw)) {
                    break L3;
                  } else {
                    if (!((fw) ((Object) this.field_E)).field_I) {
                      break L2;
                    } else {
                      break L3;
                    }
                ...
                if ((this.field_q ^ -1) != -2) {
                  ...
                  L4: {
                    L5: {
                      var5_int = -param1 + (sm.field_d - this.field_N);
                      var6 = -this.field_L + (ko.field_b - param2);
                      if (this.field_B != var5_int) {
                        break L5;
                      } else {
                    ...
                    this.field_B = var5_int;
                    this.field_p = var6;
                    if (this.field_x instanceof fr) {
                      ((fr) ((Object) this.field_x)).a((wc) (this), param2, param0 ^ -32678, param1);
                      break L4;
                    } else {
                      break L4;
                    }
              ...
              if (this.field_P) {
                L6: {
                  if (this.field_O != this.field_B) {
                    L7: {
                      var5_int = -this.field_B + this.field_O;
                      stackOut_15_0 = this;
                      stackOut_15_1 = this.field_B;
                      ...
                      if (2 < Math.abs(var5_int)) {
                        ...
                        stackOut_19_2 = var5_int >> 38625889;
                ...
                if (this.field_p == this.field_M) {
                  ...
                  L8: {
                    var5_int = -this.field_p + this.field_M;
                    stackOut_22_0 = this;
                    stackOut_22_1 = this.field_p;
                    ...
                    if (2 < Math.abs(var5_int)) {
                      ...
                      stackOut_26_2 = var5_int >> -1291323775;
          ...
          L9: {
            ...
            stackOut_30_1 = new StringBuilder().append("wc.P(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final void b(boolean param0) {
        if (!param0) {
          this.field_O = -119;
          super.b(param0);
          this.field_E.a(0, this.field_l, 0, 8192, this.field_w);
    ...
    final void a(int param0, kb param1, int param2, byte param3, int param4, int param5) {
        try {
            ...
            throw ig.a((Throwable) ((Object) runtimeException), "wc.JA(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ')');
        }
    }
    ...
    final StringBuilder a(int param0, StringBuilder param1, int param2, Hashtable param3) {
        ...
        try {
          L0: {
            ...
            L2: {
              if (this.a(param3, param0, (byte) 61, param1)) {
                this.a(param0, param3, true, param1);
                this.a(param3, param0, -56, param1);
                discarded$26 = param1.append(" revert=").append(this.field_P);
                if (2147483647 == this.field_O) {
                  break L2;
                } else {
                  if (-2147483648 != (this.field_M ^ -1)) {
                    discarded$27 = param1.append(" to ").append(this.field_O).append(',').append(this.field_M);
                    break L2;
                  } else {
                    break L2;
                  }
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("wc.OA(").append(param0).append(',');
    ...
    wc(int param0, int param1, int param2, int param3, kh param4, qo param5, kb param6, boolean param7, boolean param8) {
        ...
        try {
            ...
            throw ig.a((Throwable) ((Object) runtimeException), "wc.<init>(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + (param4 != null ? "{...}" : "null") + ',' + (param5 != null ? "{...}" : "null") + ',' + (param6 != null ? "{...}" : "null") + ',' + param7 + ',' + param8 + ')');
        }
    }
    ...
    final static long a(CharSequence param0, int param1) {
        ...
        try {
                          ...
                          if (stackIn_20_0 != 0) {
                            ...
                            if (var7 != 0) {
                              ...
                              if (stackIn_22_0 == -1L) {
                                ...
                                var2_long = var2_long / 37L;
                                if (var7 == 0) {
                                  stackOut_19_0 = (0L < var2_long % 37L ? -1 : (0L == var2_long % 37L ? 0 : 1));
                                  stackIn_20_0 = stackOut_19_0;
                                  continue L5;
                                } else {
                                  break L3;
          ...
          L12: {
            ...
            stackOut_26_1 = new StringBuilder().append("wc.A(");
