    ...
    final static nc a(kl param0, int param1, kl param2, byte param3, int param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_7_1 = new StringBuilder().append("ue.L(");
          ...
          throw ig.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + ',' + -118 + ',' + param4 + ')');
        }
        return stackIn_6_0;
    }
    ...
    final void a(int param0, byte[] param1, byte param2, int param3) throws IOException {
        ...
        try {
          ...
          L16: {
            ...
            stackOut_60_1 = new StringBuilder().append("ue.O(").append(param0).append(',');
