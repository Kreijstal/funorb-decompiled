    ...
    final static int a(String param0, String[] param1, byte param2) {
        ...
        try {
              ...
              L1: while (true) {
                L2: {
                  if (var5 >= var3_int) {
                    ...
                    var6 = param1[var5];
                    stackOut_6_0 = param0.equals(var6);
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("t.A(");
        ...
        try {
            ...
            try {
                ...
                L0: {
                  L1: {
                    if (param0 == -118) {
                      ...
                      var6 = (String[]) null;
                      discarded$2 = t.a((String) null, (String[]) null, (byte) -128);
                      break L1;
                    }
                  }
                  L2: {
              ...
              L3: {
                ...
                stackOut_9_1 = new StringBuilder().append("t.C(").append(param0).append(',');
