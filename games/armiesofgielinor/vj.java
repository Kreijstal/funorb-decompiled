...
final class vj {
    ...
    final boolean a(int param0) {
        ...
        if (null != this.field_l) {
          if (0 <= this.field_h) {
            this.field_k[this.field_h] = this.field_k[this.field_h] - 1;
            if (0 > this.field_k[this.field_h]) {
              var2 = this.field_h;
