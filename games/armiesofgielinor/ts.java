...
final class ts {
    ...
    final static void a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        try {
          ...
          throw ig.a((Throwable) (Object) stackIn_10_0, stackIn_10_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 44 + param8 + 41);
        }
    }
    ...
    final static void a(om param0, int param1, sl param2) {
        ...
        try {
            ...
            if (rd.field_j.field_xb.field_T.length <= var5_int) {
              L3: {
                if ((1 & param0.field_k) == 0) {
                  ...
                  var6 = (jd) (Object) rd.field_j.field_xb.f(var5_int, ~param1).e((byte) 97);
                  L4: while (true) {
                    if (var6 == null) {
                      break L3;
                    } else {
                      ...
                      var6 = (jd) (Object) rd.field_j.field_xb.f(var5_int, ~param1).a((byte) 123);
                      continue L4;
                    }
                  }
                }
          ...
          L8: {
            ...
            stackOut_24_1 = new StringBuilder().append("ts.E(");
