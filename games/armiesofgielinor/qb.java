    ...
    private final void a(int param0, vh param1, int param2) {
        ...
        try {
                ...
                if (param2 == 2) {
                  ...
                  if (param2 != 3) {
                    if (param2 != 5) {
                      if (param2 == 6) {
                        ...
                        if (param2 == 7) {
                          ...
                          if (param2 == 8) {
                            ...
                            if (9 != param2) {
                              if (param2 == 10) {
                                int discarded$10 = param1.k(param0);
                                break L1;
                              } else {
                                if (param2 != 11) {
                                  if (param2 != 12) {
                                  ...
                                  int discarded$13 = param1.k(param0);
                                  break L1;
                                }
                              }
                            } else {
                      ...
                      int discarded$15 = param1.k(param0);
                      break L1;
                    }
                  } else {
                    var4_int = param1.k(0);
          ...
          L12: {
            ...
            stackOut_56_1 = new StringBuilder().append("qb.C(").append(param0).append(44);
    ...
    private final void a(int param0, vh param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("qb.B(").append(param0).append(44);
