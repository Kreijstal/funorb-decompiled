...
final class wi {
              ...
              L13: {
                if (var12 == null) {
                  ...
                  if (var31 != 0) {
                    ...
                    L38: {
                      if (var13 != 0) {
                        param4.field_Jb.a((je) (Object) var12, true, 2, (je) (Object) var11);
                        break L38;
                      } else {
                        break L38;
                      }
                                    ...
                                    L45: {
                                      ...
                                      if (0 >= var25_int) {
                                        ...
                                        if (jl.field_c == null) {
                                          ...
                                          if ((jl.field_c.length ^ -1) > (var25_int ^ -1)) {
                                            break L45;
                                          } else {
                                      ...
                                      if ((var25_int ^ -1) >= -1) {
                                        ...
                                        if (null == jl.field_c) {
                                          ...
                                          if ((jl.field_c.length ^ -1) > (var25_int ^ -1)) {
                                            ...
                                            if (jl.field_c[var25_int - 1] != null) {
                                              var24_ref = jl.field_c[-1 + var25_int][1];
                                              break L49;
                                            } else {
                                              break L49;
                                            }
                                        ...
                                        L57: {
                                          if (jv.field_d == null) {
                                            ...
                                            if (null == jv.field_d[var27_int]) {
                                              ...
                                              if ((var12.field_Xb ^ -1) > (var30_int ^ -1)) {
                                                var29 = 1;
                                                break L57;
                                              } else {
                                                break L57;
                                        ...
                                        L59: {
                                          if (sk.field_j == null) {
                                            ...
                                            if (null == sk.field_j[var27_int]) {
                                              ...
                                              if (((var12.field_Ob ^ -1) & sk.field_j[var27_int][var28] ^ -1) == -1) {
                                                break L59;
                                              } else {
                                                var29 = 1;
                                                break L59;
    ...
    public static void a(int param0) {
        ...
        try {
            ...
            throw ig.a((Throwable) (Object) runtimeException, "wi.A(" + param0 + 41);
        }
    }
