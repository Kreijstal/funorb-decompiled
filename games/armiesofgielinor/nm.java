...
final class nm extends hn {
    ...
    final static void a(um param0, boolean param1, int param2, byte param3) {
        ...
        try {
          ...
          throw ig.a((Throwable) (Object) stackIn_19_0, stackIn_19_2 + ',' + true + ',' + 256 + ',' + 41 + ')');
        }
    }
    ...
    final synchronized void a(int param0, boolean param1, um param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L16: {
            ...
            stackOut_56_1 = new StringBuilder().append("nm.J(").append(param0).append(',').append(param1).append(',');
    ...
    final static li a(int param0, int param1, byte[] param2) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_2_1 = new StringBuilder().append("nm.M(").append(0).append(',').append(6).append(',');
