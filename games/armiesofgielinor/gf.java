...
final class gf {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            if (!param1) {
              if (param0 != null) {
                if (((gf) this).field_a == param0) {
                  return;
                } else {
                  if (null != ((gf) this).field_a) {
                    L0: {
                      ((gf) this).field_a.setCursor((java.awt.Cursor) null);
                      ((gf) this).field_a = null;
                      if (param0 != null) {
    ...
    public final void movemouse(int param0, int param1) {
        ((gf) this).field_b.mouseMove(param0, param1);
    }

    public gf() throws Exception {
        java.awt.Robot var2 = new java.awt.Robot();
        ((gf) this).field_b = var2;
    }
}
