    ...
    final static void a(pf param0, pf param1, pf param2, byte param3) {
        ...
        try {
          L0: {
            ...
            discarded$1 = el.a("dropdown", param2, (byte) -89, "commonui");
    ...
    final static boolean a(byte param0, int[] param1) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_38_1 = new StringBuilder().append("fh.H(").append(param0).append(',');
                  ...
                  L2: {
                    ...
                    L3: while (true) {
                      if (var6 >= param3) {
                        ...
                        if ((-100 + this.field_a + this.field_l) % this.field_a == this.field_c) {
                          throw new IOException();
                        } else {
                          var6++;
                          continue L3;
