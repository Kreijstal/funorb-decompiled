    ...
    public final synchronized void removeConsumer(java.awt.image.ImageConsumer param0) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("mh.removeConsumer(");
    ...
    final static boolean a(ha param0, byte param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("mh.J(");
              ...
              if (param2.length() <= var7) {
                ...
                L2: {
                  ...
                  if (var8 != 60) {
                    ...
                    var6 = (var5_int >> 8) - -param3.field_a[0] - -param4.b(param2.substring(0, var7));
                    break L2;
                  }
                }
                L3: {
                  if (-1 == var6) {
                    ...
                    param3.field_a[var7] = (var5_int >> 8) + (param3.field_a[0] - -param4.b(param2.substring(0, 1 + var7))) - param4.a((char) var8);
                    break L3;
                  } else {
    ...
    public final boolean imageUpdate(java.awt.Image param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("mh.imageUpdate(");
