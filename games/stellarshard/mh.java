...
final class mh extends vi implements java.awt.image.ImageProducer, java.awt.image.ImageObserver {
    ...
    final void a(java.awt.Component param0, int param1, int param2, byte param3) {
        ...
        try {
            ...
            this.b(false);
            discarded$0 = param0.prepareImage(this.field_b, (java.awt.image.ImageObserver) (this));
            this.b(false);
            discarded$1 = param0.prepareImage(this.field_b, (java.awt.image.ImageObserver) (this));
            this.b(false);
            discarded$2 = param0.prepareImage(this.field_b, (java.awt.image.ImageObserver) (this));
            this.a((byte) -107);
    ...
    final static void a(int param0, int param1, String param2, uj param3, bd param4) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_15_1 = new StringBuilder().append("mh.G(").append(param0).append(',').append(param1).append(',');
    ...
    final void a(int param0, java.awt.Graphics param1, int param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              this.b(false);
              discarded$3 = param1.drawImage(this.field_b, param0, param3, (java.awt.image.ImageObserver) (this));
              if (param2 == -22984) {
                break L1;
              } else {
                field_j = (byte[][]) null;
    ...
    final static byte[] a(boolean param0, String param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("mh.K(").append(param0).append(',');
