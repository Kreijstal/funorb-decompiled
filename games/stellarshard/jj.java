...
final class jj {
    ...
    final static void a(boolean param0, int param1, int param2, int param3, int param4, int param5, int param6, pb[] param7, pb[] param8, int param9, int param10, int param11, bd param12, bd param13) {
        try {
            ...
            throw ma.a((Throwable) ((Object) runtimeException), "jj.B(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + (param7 != null ? "{...}" : "null") + ',' + (param8 != null ? "{...}" : "null") + ',' + param9 + ',' + param10 + ',' + param11 + ',' + (param12 != null ? "{...}" : "null") + ',' + (param13 != null ? "{...}" : "null") + ')');
        }
    }
            ...
            for (var6 = 0; var6 < this.field_K; var6++) {
                ...
                if (0 < var7) {
                    ...
                    for (var11 = 0; var8 > var11; var11++) {
                        ...
                        var4 = localTemp$4;
                        this.field_L[var6][var11] = localTemp$4;
                    }
                    var4 = 0;
                    array$5 = new int[var8];
                    this.field_I[var6] = array$5;
                    for (var11 = 0; var8 > var11; var11++) {
                        dupTemp$6 = var4 + param0.f(4);
                        var4 = dupTemp$6;
                        this.field_I[var6][var11] = sa.a(255, dupTemp$6);
                    }
                    array$7 = new int[var9];
                    this.field_x[var6] = array$7;
                    var4 = 0;
                    var10 = 0;
                    for (var11 = 0; var11 < var9; var11++) {
                        dupTemp$8 = var10 + param0.e(-64);
                        var10 = dupTemp$8;
                        localTemp$9 = var4 + dupTemp$8;
                        var4 = localTemp$9;
                        this.field_x[var6][var11] = localTemp$9;
                    }
                    array$10 = new int[var9];
                    this.field_g[var6] = array$10;
                    var4 = 0;
                    for (var11 = 0; var11 < var9; var11++) {
                        dupTemp$11 = var4 + param0.f(4);
                        var4 = dupTemp$11;
                        this.field_g[var6][var11] = sa.a(dupTemp$11, 255);
                    }
