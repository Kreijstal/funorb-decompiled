...
final class ub extends bd {
            ...
            if (param4 > 0) {
              L5: {
                if (ti.field_g == null) {
                  ...
                  ub.a(ti.field_a, this.field_P[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, ti.field_g, ti.field_k);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        int var13 = 0;
        int var9 = param1 + param2 * ti.field_i;
        int var10 = ti.field_i - param3;
        int var11 = 0;
        int var12 = 0;
        if (param2 < ti.field_f) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$0] == 0) {
                  ...
                  param8++;
                  ti.field_a[incrementValue$1] = param6;
                  var20++;
                  continue L3;
                }
              }
