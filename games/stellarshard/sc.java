          ...
          if (var8 < 50) {
            L2: {
              ...
              if (var10 < 50) {
                ...
                var4++;
                field_i[incrementValue$0] = var13 + (((this.field_g[param0] & 65535) - var13) * var14 >> 16);
                break L2;
              }
            }
            if (var9 < 50) {
              ...
              var4++;
              field_i[incrementValue$1] = var13 + (((this.field_A[param0] & 65535) - var13) * var14 >> 16);
              break L1;
            }
          } else {
        ...
        L3: {
          if (var9 < 50) {
            ...
            if (var10 < 50) {
              ...
              var4++;
              field_i[incrementValue$4] = var13 + (((this.field_g[param0] & 65535) - var13) * var14 >> 16);
              break L3;
            }
          } else {
            ...
            var4++;
            field_i[incrementValue$5] = this.field_A[param0] & 65535;
            break L3;
          }
        }
        L5: {
          if (var10 < 50) {
            L6: {
              ...
              if (var9 < 50) {
                ...
                var4++;
                field_i[incrementValue$6] = var13 + (((this.field_A[param0] & 65535) - var13) * var14 >> 16);
                break L6;
              }
            }
            if (var8 < 50) {
            ...
            var4++;
            field_i[incrementValue$8] = this.field_g[param0] & 65535;
            break L5;
          }
        }
        L7: {
