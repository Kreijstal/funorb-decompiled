...
final class sc extends bj {
    ...
    private final void a() {
        ...
        var9 = 0;
        L0: while (true) {
          if (var9 >= this.field_R) {
            Math.sqrt((double)var7);
            this.field_B = (short)(int)(Math.sqrt((double)var8) + 0.99);
            this.field_L = true;
            return;
          } else {
            L1: {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, long param7) {
        ...
        try {
            ...
            for (var21 = 0; var21 < this.field_p; var21++) {
                var22 = this.field_P[var21];
                var23 = this.field_e[var21];
                var24 = this.field_N[var21];
                if (param2 != 0) {
            ...
            this.a(false, param7 >= 0L ? true : false, param7, (int) this.field_B, this.field_B << 1);
                              ...
                              if (var9 <= 0) {
                                ...
                                L9: while (true) {
                                  if (var12 >= var10) {
                                    ...
                                    var13 = var47[var12];
                                    var14_int = this.field_C[var13];
                                    dupTemp$0 = field_r[var14_int];
                                    field_r[var14_int] = dupTemp$0 + 1;
                                    var15_int = dupTemp$0;
                            ...
                            if (var9 > 64) {
                              ...
                              L10: while (true) {
                                if (var12 < field_j[var10]) {
                                  var13 = var48[var12];
                                  var14_int = this.field_C[var13];
                                  dupTemp$1 = field_r[var14_int];
                                  field_r[var14_int] = dupTemp$1 + 1;
                                  var15_int = dupTemp$1;
                                  field_H[var14_int][var15_int] = var13;
                                  if (var14_int >= 10) {
                                    if (var14_int != 10) {
                      ...
                      if (var8 >= 12) {
                        ...
                        L17: while (true) {
                          if (var8 >= var7) {
                            ...
                            dupTemp$2 = field_r[var11];
                            field_r[var11] = dupTemp$2 + 1;
                            var12 = dupTemp$2;
                ...
                L40: {
                  ...
                  if (!param0) {
                    ...
                    if (var16 * var24 + var19 * var25 + var22 * var26 > 0) {
                      field_k[var8] = true;
                      if (!field_T) {
                        var27 = (field_F[var9] + field_F[var10] + field_F[var11]) / 3 + param3;
                        if (field_J[var27] >= 64) {
                          L42: {
                            var28 = field_J[var27];
                            if (var28 != 64) {
                          ...
                          var28 -= 65;
                          dupTemp$8 = field_j[var28];
                          arrayValue$9 = field_E[var28];
                          field_j[var28] = dupTemp$8 + 1;
                          arrayValue$9[dupTemp$8] = var8;
                          var8++;
                          continue L3;
                        } else {
                          dupTemp$10 = field_J[var27];
                          arrayValue$11 = field_w[var27];
                        ...
                        var7++;
                        field_f[incrementValue$12] = var8;
                        var8++;
                        continue L3;
                      }
                    } else {
                ...
                L43: {
                  if (!param1) {
                    ...
                    if (!this.a(o.field_f + cc.field_n, tc.field_v + cc.field_p, field_v[var9], field_v[var10], field_v[var11], var12, var13, var14_int)) {
                      ...
                      fieldTemp$13 = db.field_c;
                      db.field_c = db.field_c + 1;
                      pl.field_Q[fieldTemp$13] = param2;
                      param1 = false;
                      break L43;
                    }
                  }
                ...
                if ((var12 - var13) * (field_v[var11] - field_v[var10]) - (field_v[var9] - field_v[var10]) * (var14_int - var13) > 0) {
                  ...
                  if (!field_T) {
                    ...
                    if (field_J[var15_int] >= 64) {
                      ...
                      var16 -= 65;
                      dupTemp$15 = field_j[var16];
                      arrayValue$16 = field_E[var16];
                      field_j[var16] = dupTemp$15 + 1;
                      arrayValue$16[dupTemp$15] = var8;
                      var8++;
                      continue L3;
                    } else {
                      dupTemp$17 = field_J[var15_int];
                      arrayValue$18 = field_w[var15_int];
                    ...
                    var7++;
                    field_f[incrementValue$19] = var8;
                    var8++;
                    continue L3;
                  }
                } else {
    ...
    private final void e(int param0) {
        ...
        L0: {
          ...
          var6 = this.field_O[param0];
          var7 = this.field_o[param0];
          var8 = field_l[var5];
          var9 = field_l[var6];
          var10 = field_l[var7];
          if (this.field_q != null) {
            cc.field_d = this.field_q[param0] & 255;
            break L0;
          } else {
            cc.field_d = 0;
            break L0;
          ...
          if (var8 < 50) {
            L2: {
              ...
              if (var10 < 50) {
                ...
                var4++;
                field_i[incrementValue$9] = var13 + (((this.field_g[param0] & 65535) - var13) * var14 >> 16);
                break L2;
              }
            }
            if (var9 < 50) {
              ...
              var4++;
              field_i[incrementValue$10] = var13 + (((this.field_A[param0] & 65535) - var13) * var14 >> 16);
              break L1;
            }
          } else {
        ...
        L3: {
          if (var9 < 50) {
            L4: {
              var11 = field_D[var6];
              var12 = field_S[var6];
              var13 = this.field_A[param0] & 65535;
              if (var8 < 50) {
                break L4;
              } else {
            ...
            if (var10 < 50) {
              ...
              var4++;
              field_i[incrementValue$13] = var13 + (((this.field_g[param0] & 65535) - var13) * var14 >> 16);
              break L3;
            }
          } else {
            ...
            var4++;
            field_i[incrementValue$14] = this.field_A[param0] & 65535;
            break L3;
          }
        }
        L5: {
          if (var10 < 50) {
            L6: {
              var11 = field_D[var7];
              var12 = field_S[var7];
              var13 = this.field_g[param0] & 65535;
              if (var9 < 50) {
                break L6;
              } else {
                ...
                var4++;
                field_i[incrementValue$15] = var13 + (((this.field_A[param0] & 65535) - var13) * var14 >> 16);
                break L6;
              }
            }
            if (var8 < 50) {
            ...
            var4++;
            field_i[incrementValue$17] = this.field_g[param0] & 65535;
            break L5;
          }
        }
        L7: {
          ...
          if (var4 != 3) {
              ...
              if (this.field_M == null) {
                ...
                if (this.field_M[param0] != -1) {
                    ...
                    L12: {
                      if (this.field_s == null) {
                        ...
                        if (this.field_s[param0] == -1) {
                          ...
                          var20 = this.field_s[param0] & 255;
                          var17 = this.field_Q[var20];
                          var18 = this.field_t[var20];
                          var19 = this.field_h[var20];
                          break L11;
                        }
                      }
                    }
                  ...
                  if (this.field_g[param0] != -1) {
                    cc.a(var14, var15, var16, var11, var12, var13, field_i[0], field_i[1], field_i[2], field_D[var17], field_D[var18], field_D[var19], field_S[var17], field_S[var18], field_S[var19], field_l[var17], field_l[var18], field_l[var19], (int) this.field_M[param0]);
                    break L7;
                  } else {
                    cc.a(var14, var15, var16, var11, var12, var13, this.field_z[param0], this.field_z[param0], this.field_z[param0], field_D[var17], field_D[var18], field_D[var19], field_S[var17], field_S[var18], field_S[var19], field_l[var17], field_l[var18], field_l[var19], (int) this.field_M[param0]);
                    break L7;
                  }
                } else {
                  break L10;
            ...
            if (this.field_g[param0] != -1) {
              ...
              cc.a(var14, var15, var16, var11, var12, var13, cc.field_e[this.field_z[param0] & 65535]);
              break L7;
            }
          }
        }
        if (var4 != 4) {
          ...
          L15: {
              ...
              if (this.field_M == null) {
                ...
                if (this.field_M[param0] != -1) {
                  ...
                  if (this.field_g[param0] != -1) {
                    ...
                    cc.a(var14, var15, var16, var11, var12, var13, this.field_z[param0], this.field_z[param0], this.field_z[param0], field_D[var17], field_D[var18], field_D[var19], field_S[var17], field_S[var18], field_S[var19], field_l[var17], field_l[var18], field_l[var19], var20);
                    cc.a(var14, var16, field_G[3], var11, var13, field_n[3], this.field_z[param0], this.field_z[param0], this.field_z[param0], field_D[var17], field_D[var18], field_D[var19], field_S[var17], field_S[var18], field_S[var19], field_l[var17], field_l[var18], field_l[var19], var20);
                    break L15;
                  }
                } else {
                  break L16;
            ...
            if (this.field_g[param0] != -1) {
              ...
              var17 = cc.field_e[this.field_z[param0] & 65535];
    ...
    private final void d(int param0) {
        ...
        if (!field_k[param0]) {
          L0: {
            var2 = this.field_U[param0];
            var3 = this.field_O[param0];
            var4 = this.field_o[param0];
          ...
          L1: {
            L2: {
              if (this.field_M == null) {
                ...
                if (this.field_M[param0] != -1) {
                    ...
                    L4: {
                      if (this.field_s == null) {
                        ...
                        if (this.field_s[param0] == -1) {
                          ...
                          var8 = this.field_s[param0] & 255;
                          var5 = this.field_Q[var8];
                          var6 = this.field_t[var8];
                          var7 = this.field_h[var8];
                          break L3;
                        }
                      }
                    }
                  ...
                  if (this.field_g[param0] != -1) {
                    cc.a(field_v[var2], field_v[var3], field_v[var4], field_V[var2], field_V[var3], field_V[var4], this.field_z[param0], this.field_A[param0], this.field_g[param0], field_D[var5], field_D[var6], field_D[var7], field_S[var5], field_S[var6], field_S[var7], field_l[var5], field_l[var6], field_l[var7], (int) this.field_M[param0]);
                    break L1;
                  } else {
                    cc.a(field_v[var2], field_v[var3], field_v[var4], field_V[var2], field_V[var3], field_V[var4], this.field_z[param0], this.field_z[param0], this.field_z[param0], field_D[var5], field_D[var6], field_D[var7], field_S[var5], field_S[var6], field_S[var7], field_l[var5], field_l[var6], field_l[var7], (int) this.field_M[param0]);
                    break L1;
                  }
                } else {
                  break L2;
            ...
            if (this.field_g[param0] != -1) {
              cc.a(field_v[var2], field_v[var3], field_v[var4], field_V[var2], field_V[var3], field_V[var4], this.field_z[param0] & 65535, this.field_A[param0] & 65535, this.field_g[param0] & 65535);
              break L1;
            } else {
              cc.a(field_v[var2], field_v[var3], field_v[var4], field_V[var2], field_V[var3], field_V[var4], cc.field_e[this.field_z[param0] & 65535]);
              break L1;
            }
          }
          return;
                ...
                L2: {
                  ...
                  if (var10 == -1) {
                    ...
                    if (!cc.field_k.a(var10, (byte) 114)) {
                      ...
                      this.field_M[var9] = (short)var10;
                      var9++;
                      continue L1;
                    }
                  }
                }
                this.field_M[var9] = (short)-1;
                var9++;
                continue L1;
              }
            }
                ...
                if (var10 >= this.field_I) {
                  ...
                  L5: while (true) {
                    if (var10 >= param0.field_L) {
                      this.field_Q = new int[this.field_u];
                      this.field_t = new int[this.field_u];
                      this.field_h = new int[this.field_u];
                      var10 = 0;
                      var11 = 0;
                      L6: while (true) {
                        if (var11 >= param0.field_L) {
                          this.field_s = new byte[this.field_I];
                          var11 = 0;
                          L7: while (true) {
                            if (var11 >= this.field_I) {
                              ...
                              if (param0.field_J[var11] == -1) {
                                this.field_s[var11] = (byte)-1;
                                var11++;
                                continue L7;
                              } else {
                                this.field_s[var11] = (byte)var9_ref_int__[param0.field_J[var11] & 255];
                                if (this.field_s[var11] == -1) {
                                  if (this.field_M != null) {
                                    this.field_M[var11] = (short)-1;
                                    var11++;
                                    continue L7;
                                  } else {
                                    var11++;
                          ...
                          L8: {
                            if (var20[var11] <= 0) {
                              ...
                              if (param0.field_i[var11] != 0) {
                                ...
                                this.field_Q[var10] = param0.field_B[var11] & 65535;
                                this.field_t[var10] = param0.field_w[var11] & 65535;
                                this.field_h[var10] = param0.field_k[var11] & 65535;
                  ...
                  if (param0.field_J[var10] != -1) {
                    dupTemp$1 = param0.field_J[var10] & 255;
            ...
            if (var12 != -1) {
                ...
                L15: {
                  L16: {
                    if (param0.field_s == null) {
                      ...
                      if (param0.field_s[this.field_U[var16]] == null) {
                        break L16;
                      } else {
                        var13 = param0.field_s[this.field_U[var16]];
                        break L15;
                      }
                    }
                  }
                  var13 = param0.field_u[this.field_U[var16]];
                  break L15;
                }
                L17: {
                  L18: {
                    ...
                    if (param0.field_s == null) {
                      ...
                      if (param0.field_s[this.field_O[var16]] == null) {
                        break L18;
                      } else {
                        var13 = param0.field_s[this.field_O[var16]];
                        break L17;
                      }
                    }
                  }
                  var13 = param0.field_u[this.field_O[var16]];
                  break L17;
                }
                L19: {
                  L20: {
                    var14 = param1 + (param3 * var13.field_e + param4 * var13.field_d + param5 * var13.field_f) / (var8 * var13.field_g);
                    this.field_A[var16] = sc.c(var14);
                    if (param0.field_s == null) {
                      break L20;
                    } else {
                      if (param0.field_s[this.field_o[var16]] == null) {
              ...
              if (var10 != 0) {
                if (var10 != 1) {
                  ...
                  this.field_z[var16] = var14 | sc.a(param0.field_I[var16] & 65535, var14 >> 17);
                  this.field_g[var16] = -1;
                  var16++;
                  continue L9;
                }
                ...
                L23: {
                  L24: {
                    ...
                    this.field_z[var16] = var14 | sc.a(var15, var14 >> 17);
                    if (param0.field_s == null) {
                      break L24;
                    } else {
                      if (param0.field_s[this.field_O[var16]] == null) {
                ...
                L25: {
                  L26: {
                    var14 = param1 + (param3 * var13.field_e + param4 * var13.field_d + param5 * var13.field_f) / (var8 * var13.field_g) << 17;
                    this.field_A[var16] = var14 | sc.a(var15, var14 >> 17);
                    if (param0.field_s == null) {
                      break L26;
                    } else {
                      if (param0.field_s[this.field_o[var16]] == null) {
                ...
                var14 = param1 + (param3 * var13.field_e + param4 * var13.field_d + param5 * var13.field_f) / (var8 * var13.field_g) << 17;
                this.field_g[var16] = var14 | sc.a(var15, var14 >> 17);
                var16++;
                continue L9;
              }
            }
    ...
    static {
        sc discarded$0 = new sc();
        sc discarded$1 = new sc();
        sc discarded$2 = new sc();
