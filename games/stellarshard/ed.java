    ...
    final static void a(int param0, int param1, int param2, pb[] param3, int param4, int param5) {
        ...
        try {
          ...
          L24: {
            ...
            stackIn_75_1 = new StringBuilder().append("ed.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
