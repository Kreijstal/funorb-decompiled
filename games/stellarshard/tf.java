    ...
    final static byte[] a(int param0, boolean param1, Object param2) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_14_1 = new StringBuilder().append("tf.M(").append(2).append(',').append(param1).append(',');
    ...
    final static void a(int param0, int param1, pb[] param2, int param3, int param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("tf.J(").append(param0).append(',').append(2).append(',');
