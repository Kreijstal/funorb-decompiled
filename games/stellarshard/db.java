...
final class db {
    ...
    final db a(byte param0, pb[] param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("db.I(").append(param0).append(44);
    ...
    final void a(tc param0, db param1, int param2, int param3, rj param4, int param5) {
        ...
        try {
          ...
          throw ma.a((Throwable) (Object) stackIn_31_0, stackIn_31_2 + 44 + param5 + 41);
        }
    }
    ...
    final void a(db param0, boolean param1) {
        ...
        try {
            ...
            throw ma.a((Throwable) (Object) runtimeException, "db.L(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final static StringBuilder a(int param0, byte param1, char param2, StringBuilder param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("db.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final void a(int param0, tc param1, rj param2, int param3, int param4) {
        ...
        try {
          ...
          L11: {
            ...
            stackOut_28_1 = new StringBuilder().append("db.A(").append(param0).append(44);
            stackIn_30_0 = stackOut_28_0;
            stackIn_30_1 = stackOut_28_1;
            stackIn_29_0 = stackOut_28_0;
            stackIn_29_1 = stackOut_28_1;
          ...
          throw ma.a((Throwable) (Object) stackIn_34_0, stackIn_34_2 + 44 + param3 + 44 + param4 + 41);
        }
    }
