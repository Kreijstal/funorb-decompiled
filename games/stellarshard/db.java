    ...
    final static StringBuilder a(int param0, byte param1, char param2, StringBuilder param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("db.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
              ...
              if (var6_ref == null) {
                ...
                if (null == param1.field_a) {
                  ...
                  if (0 <= this.field_e) {
                    ...
                    discarded$1 = ((bd) (Object) stackIn_26_0).a(stackIn_26_1, stackIn_26_2, stackIn_26_3, stackIn_26_4, stackIn_26_5, stackIn_26_6, stackIn_26_7, stackIn_26_8, param1.field_h, param1.field_d, param1.field_j);
                    break L7;
                  } else {
                    return;
                  }
