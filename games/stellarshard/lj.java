    ...
    private final boolean a(int param0, je param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("lj.H(").append(param0).append(',');
    ...
    private final int a(int param0, byte param1, rj param2, String param3, String param4, int param5) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("lj.F(").append(param0).append(',').append(param1).append(',');
        ...
        try {
          L0: {
            if (!super.a(param0 + 0, param1, param2, param3)) {
              if (param0 == 29657) {
                if (param1 == 98) {
                  stackOut_8_0 = this.a(param3, -8666);
                  stackIn_9_0 = stackOut_8_0;
                  decompiledRegionSelector0 = 2;
                  break L0;
                } else {
                  if (param1 == 99) {
                    stackOut_12_0 = this.a(param3, (byte) 66);
