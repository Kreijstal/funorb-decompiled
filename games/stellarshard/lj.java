...
final class lj extends g implements rf, oi {
    ...
    private final boolean a(int param0, je param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("lj.H(").append(param0).append(44);
    ...
    private final int a(int param0, byte param1, rj param2, String param3, String param4, int param5) {
        ...
        try {
          L0: {
            if (param1 == 64) {
              stackOut_3_0 = this.a(param3, param0, param5, 35, param4, (byte) -120, param2);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("lj.F(").append(param0).append(44).append(param1).append(44);
    ...
    private final int a(String param0, int param1, int param2, int param3, String param4, byte param5, rj param6) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = var11.field_t + var9.field_t;
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("lj.G(");
        ...
        try {
          L0: {
            if (!super.a(param0, param1, param2, param3)) {
              if (param0 == 29657) {
                if (param1 == 98) {
                  stackOut_8_0 = ((lj) this).a(param3, -8666);
                  stackIn_9_0 = stackOut_8_0;
                  return stackIn_9_0;
                } else {
                  if (param1 == 99) {
                    stackOut_12_0 = ((lj) this).a(param3, (byte) 66);
