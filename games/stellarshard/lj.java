...
final class lj extends g implements rf, oi {
    ...
    private final int a(int param0, byte param1, rj param2, String param3, String param4) {
        ...
        try {
          L0: {
            stackOut_2_0 = this.a(param3, 170, 70, 35, param4, (byte) -120, param2);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    private final int a(String param0, int param1, int param2, int param3, String param4, byte param5, rj param6) {
        ...
        try {
          L0: {
            var11 = new kg(20, 70, 290, 25, param6, false, 120, 3, si.field_V, 16777215, param0);
            ((lj) this).b(4, (rj) (Object) var11);
            var9 = new cd(((je) (Object) param6).a((byte) 48), param4, 126, var11.field_t + 70, 195, 35);
