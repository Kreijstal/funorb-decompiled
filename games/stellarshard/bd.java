...
abstract class bd extends ah {
    ...
    private final void a(String param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 27: {
                    try {
                        this.a(field_J, field_D, field_I);
                        statePc = 30;
                        continue stateLoop;
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                      ...
                      if (var5_int >= 256) {
                        ...
                        L4: while (true) {
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ((bd) this).field_O = new byte[65536];
                                var7 = 0;
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    ((bd) this).field_v = var25[32] + var22[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                ((bd) this).field_O[(var7 << 8) + var8] = (byte)bd.a(var23, var24, var25, ((bd) this).field_B, var22, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                ((bd) this).field_B[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
            ...
            var2 = 0;
            L10: while (true) {
              if (var2 >= ((bd) this).field_B.length) {
                ((bd) this).field_v = param0[256] & 255;
                break L0;
              } else {
                ((bd) this).field_B[var2] = param0[var2] & 255;
                var2++;
                continue L10;
              }
            }
    ...
    final int b(String param0, int param1, int param2) {
        if (param2 == 0) {
            param2 = ((bd) this).field_v;
        }
        int var4 = ((bd) this).a(param0, new int[1], field_F);
        int var5 = (var4 - 1) * param2;
        return ((bd) this).field_N + var5 + ((bd) this).field_r;
    }

    private final void d(String param0, int param1) {
        int var3 = 0;
        int var4 = 0;
        int var5 = 0;
        int var6 = 0;
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_M = (param1 - ((bd) this).b(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    final int b(String param0, int param1) {
        ...
        int var5 = 0;
        int var6 = 0;
        var3 = ((bd) this).a(param0, new int[1], field_F);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (var5 >= var3) {
    ...
    final int a(char param0) {
        return ((bd) this).field_B[bf.a(-8250, param0) & 255];
    }
    ...
    final void b(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param0, param1 - ((bd) this).b(param0), param2);
    }
    ...
    private final void a(String param0, int param1, int param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 24: {
                    try {
                        stackOut_24_0 = ((bd) this).field_G[var10];
                ...
                case 27: {
                    try {
                        var11_ref_o.a(param1, param2 + ((bd) this).field_v - var12);
                        statePc = 29;
                        continue stateLoop;
                    } catch (Throwable stateCaught_27) {
                        caughtException = stateCaught_27;
                ...
                case 28: {
                    try {
                        var11_ref_o.a(param1, param2 + ((bd) this).field_v - var12, field_C);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_o.field_k;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
                ...
                case 35: {
                    var8 = (char)(bf.a(-8250, (char) var8) & 255);
                ...
                case 37: {
                    param1 = param1 + ((bd) this).field_O[(var5 << 8) + var8];
                    statePc = 38;
                    continue stateLoop;
                }
                case 38: {
                    var9 = ((bd) this).field_z[var8];
                    var10 = ((bd) this).field_L[var8];
                    var11 = param1;
                    if (var8 == 32) {
                        statePc = 46;
                    } else {
                ...
                case 41: {
                    ((bd) this).a(var8, param1 + ((bd) this).field_A[var8] + 1, param2 + ((bd) this).field_w[var8] + 1, var9, var10, field_K, true);
                    statePc = 42;
                    continue stateLoop;
                }
                case 42: {
                    ((bd) this).a(var8, param1 + ((bd) this).field_A[var8], param2 + ((bd) this).field_w[var8], var9, var10, field_E, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 43: {
                ...
                case 44: {
                    ((bd) this).a(var8, param1 + ((bd) this).field_A[var8] + 1, param2 + ((bd) this).field_w[var8] + 1, var9, var10, field_K, field_C, true);
                    statePc = 45;
                    continue stateLoop;
                }
                case 45: {
                    ((bd) this).a(var8, param1 + ((bd) this).field_A[var8], param2 + ((bd) this).field_w[var8], var9, var10, field_E, field_C, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 46: {
                ...
                case 47: {
                    field_H = field_H + field_M;
                    param1 = param1 + (field_H >> 8);
                    field_H = field_H & 255;
                    statePc = 48;
                    continue stateLoop;
                }
                case 48: {
                    param1 = param1 + ((bd) this).field_B[var8];
                    if (field_y == -1) {
                        statePc = 50;
                    } else {
                        statePc = 49;
                ...
                case 49: {
                    ti.g(var11, param2 + (int)((double)((bd) this).field_v * 0.7), param1 - var11, field_y);
                    statePc = 50;
                    continue stateLoop;
                }
                case 50: {
                ...
                case 51: {
                    ti.g(var11, param2 + ((bd) this).field_v + 1, param1 - var11, field_t);
                    statePc = 52;
                    continue stateLoop;
                }
                case 52: {
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = db.a(0, (byte) 61, ' ', field_u);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
                ...
                case 13: {
                    var4 = var4 + ((bd) this).field_O[(var10 << 8) + 60];
                    statePc = 14;
                    continue stateLoop;
                }
                case 14: {
                ...
                case 18: {
                    var4 = var4 + ((bd) this).field_O[(var10 << 8) + 62];
                    statePc = 19;
                    continue stateLoop;
                }
                case 19: {
                ...
                case 23: {
                    var4 = var4 + ((bd) this).field_O[(var10 << 8) + 160];
                    statePc = 24;
                    continue stateLoop;
                }
                case 24: {
                ...
                case 28: {
                    var4 = var4 + ((bd) this).field_O[(var10 << 8) + 173];
                    statePc = 29;
                    continue stateLoop;
                }
                case 29: {
                ...
                case 33: {
                    var4 = var4 + ((bd) this).field_O[(var10 << 8) + 215];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
                ...
                case 38: {
                    var4 = var4 + ((bd) this).field_O[(var10 << 8) + 128];
                    statePc = 39;
                    continue stateLoop;
                }
                case 39: {
                ...
                case 43: {
                    var4 = var4 + ((bd) this).field_O[(var10 << 8) + 169];
                    statePc = 44;
                    continue stateLoop;
                }
                case 44: {
                ...
                case 48: {
                    var4 = var4 + ((bd) this).field_O[(var10 << 8) + 174];
                    statePc = 49;
                    continue stateLoop;
                }
                case 49: {
                ...
                case 60: {
                    var4 = var4 + ((bd) this).field_O[(var10 << 8) + var14];
                    statePc = 61;
                    continue stateLoop;
                }
                case 61: {
    ...
    final int b(String param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 31: {
                    var7 = (char)(bf.a(-8250, (char) var7) & 255);
                    var4 = var4 + ((bd) this).field_B[var7];
                    if (((bd) this).field_O == null) {
                        statePc = 34;
                    } else {
                        statePc = 32;
                ...
                case 33: {
                    var4 = var4 + ((bd) this).field_O[(var3 << 8) + var7];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
    ...
    final void c(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.a(param0, param1 - ((bd) this).b(param0) / 2, param2);
    }
    ...
    final int c(String param0, int param1) {
        return ((bd) this).a(param0, new int[1], field_F);
    }
        ...
        if (param0 != null) {
          L0: {
            ...
            if (param10 != 0) {
              ...
              param10 = ((bd) this).field_v;
              break L0;
            }
          }
          L1: {
            var12 = new int[]{param3};
            if (param4 >= ((bd) this).field_N + ((bd) this).field_r + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = ((bd) this).a(param0, var12, field_F);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - ((bd) this).field_N - ((bd) this).field_r - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + ((bd) this).field_N + var15;
                  param10 = param10 + var15;
                  break L3;
                } else {
                  var14 = param2 + param4 - ((bd) this).field_r - (var13 - 1) * param10;
                  break L3;
                }
              } else {
                var14 = param2 + ((bd) this).field_N + (param4 - ((bd) this).field_N - ((bd) this).field_r - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + ((bd) this).field_N;
              break L3;
            }
          }
          var15 = 0;
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.a(field_F[var15], param1 + param3 - ((bd) this).b(field_F[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.a(field_F[var15], param1 + (param3 - ((bd) this).b(field_F[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9) {
        return ((bd) this).a(param0, param1, param2, param3, param4, param5, param6, 256, param7, param8, param9);
    }

    bd(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((bd) this).field_v = 0;
        ...
        ((bd) this).field_z = param3;
        ((bd) this).field_L = param4;
        this.a(param0);
        var6 = 2147483647;
        var7 = -2147483648;
        var8 = 0;
        L0: while (true) {
          if (var8 >= 256) {
            ((bd) this).field_N = ((bd) this).field_v - var6;
            ((bd) this).field_r = var7 - ((bd) this).field_v;
            ((bd) this).field_x = ((bd) this).field_v - ((bd) this).field_w[88];
          } else {
            L1: {
              if (((bd) this).field_w[var8] >= var6) {
                break L1;
              } else {
                if (((bd) this).field_L[var8] == 0) {
                  break L1;
                } else {
                  var6 = ((bd) this).field_w[var8];
                  break L1;
                }
              }
            }
            if (((bd) this).field_w[var8] + ((bd) this).field_L[var8] > var7) {
              var7 = ((bd) this).field_w[var8] + ((bd) this).field_L[var8];
              var8++;
              continue L0;
            } else {
              var8++;
