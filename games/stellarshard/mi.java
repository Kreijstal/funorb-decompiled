...
final class mi {
    ...
    final boolean b() {
        ...
        int var2 = ((mi) this).field_k.length;
        System.arraycopy((Object) (Object) ((mi) this).field_k, 0, (Object) (Object) field_i, 0, var2);
        int var3 = field_b[((mi) this).field_f - 1];
        int var4 = ug.a(var3 - 1, 4);
        field_g[0] = ad.d(var4);
        field_g[1] = ad.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((mi) this).field_a.length; var6++) {
            var7 = ((mi) this).field_a[var6];
            var8 = ((mi) this).field_d[var7];
            var9 = ((mi) this).field_j[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ad.field_A[((mi) this).field_e[var7]].b();
            }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((mi) this).field_k.length;
        var4 = field_b[((mi) this).field_f - 1];
        var5 = field_h;
        field_h[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_g[0] * ((mi) this).field_f;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_h[var16]) {
                  var9 = field_i[var16];
                  var10 = field_g[var16] * ((mi) this).field_f;
    ...
    mi() {
        ...
        if (var1 == 1) {
          var2 = ad.d(5);
          var3 = 0;
          ((mi) this).field_a = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((mi) this).field_d = new int[var3];
              ((mi) this).field_j = new int[var3];
              ((mi) this).field_e = new int[var3];
              ((mi) this).field_l = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((mi) this).field_f = ad.d(2) + 1;
                  var4 = ad.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((mi) this).field_k = new int[var5];
                      ((mi) this).field_k[0] = 0;
                      ((mi) this).field_k[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((mi) this).field_d[((mi) this).field_a[var6]];
                      var6++;
                      continue L2;
                    }
                  }
