...
final class vf extends g implements oi {
    ...
    final static pb[] a(pf param0, byte param1, int param2, int param3) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_8_1 = new StringBuilder().append("vf.G(");
          ...
          throw ma.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, pb[] param4, int param5, bd param6, int param7, pb[] param8, int param9, int param10, int param11, int param12, boolean param13, int param14, bd param15) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("vf.D(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
          ...
          L3: {
            ...
            stackOut_6_1 = ((StringBuilder) (Object) stackIn_6_1).append(stackIn_6_2).append(44).append(param5).append(44);
          ...
          L5: {
            ...
            stackOut_12_1 = ((StringBuilder) (Object) stackIn_12_1).append(stackIn_12_2).append(44).append(param9).append(44).append(param10).append(44).append(param11).append(44).append(param12).append(44).append(param13).append(44).append(param14).append(44);
    ...
    final ig a(lf param0, String param1, byte param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("vf.C(");
    ...
    final void a(int param0, int param1, String param2) {
        int var4_int = 0;
        try {
            var4_int = ((vf) this).field_B;
            this.a(var4_int - -1, 73);
            ((vf) this).field_J[var4_int] = ((vf) this).a((lf) this, param2, (byte) -96);
            if (param0 != -31805) {
                Object var5 = null;
                ig discarded$0 = ((vf) this).a((lf) null, (String) null, (byte) -31);
            }
            ((vf) this).field_K[var4_int] = param1;
        } catch (RuntimeException runtimeException) {
            throw ma.a((Throwable) (Object) runtimeException, "vf.E(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
        ...
        try {
          L0: {
            ...
            if (!param3) {
              ...
              L1: while (true) {
                L2: {
                  if (~stackIn_5_0 <= ~((vf) this).field_B) {
                    break L2;
                  } else {
                    if (param2 == ((vf) this).field_J[var6_int]) {
                      var7 = ((vf) this).field_K[var6_int];
                      if (var7 == -1) {
                        ((vf) this).field_I.o(3);
                        break L2;
                      } else {
                        rh.a(((vf) this).field_K[var6_int], (byte) -72);
                        break L2;
                      }
                    } else {
                      var6_int++;
                      stackOut_4_0 = var6_int;
                      stackIn_5_0 = stackOut_4_0;
                      continue L1;
                    }
                  }
          ...
          L3: {
            ...
            stackOut_19_1 = new StringBuilder().append("vf.M(").append(param0).append(44).append(param1).append(44);
    ...
    vf(ck param0, bd param1, String param2) {
        ...
        try {
            ...
            var4_int = null != ((vf) this).field_C ? ((vf) this).field_G.b(((vf) this).field_C, 260, ((vf) this).field_G.field_N) : 0;
            ((vf) this).b(288, 0, 0, var4_int + 22, 23987);
        } catch (RuntimeException runtimeException) {
            throw ma.a((Throwable) (Object) runtimeException, "vf.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
