...
final class gd extends kd {
    ...
    final synchronized void h(int param0) {
        param0 = param0 << 8;
        int var2 = ((ud) ((Object) this.field_l)).field_n.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
        ...
        L0: while (true) {
          if (this.field_r <= 0) {
            L1: {
              if (this.field_C != -256) {
                ...
                if ((this.field_x & 255) != 0) {
                  ...
                  if (ba.field_d) {
                    return gd.a(0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_s, this.field_z, 0, param3, param2, (gd) (this));
                  } else {
                    return gd.b(((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_u, 0, param3, param2, (gd) (this));
                  }
                }
              }
            }
            if (ba.field_d) {
              return gd.b(0, 0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_s, this.field_z, 0, param3, param2, (gd) (this), this.field_C, param4);
            } else {
              return gd.a(0, 0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_u, 0, param3, param2, (gd) (this), this.field_C, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_C != -256) {
                  ...
                  if ((this.field_x & 255) != 0) {
                    ...
                    if (!ba.field_d) {
                      param1 = gd.a(((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_u, this.field_A, 0, var6, param2, (gd) (this));
                      break L3;
                    } else {
                      param1 = gd.b(0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_s, this.field_z, this.field_q, this.field_p, 0, var6, param2, (gd) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!ba.field_d) {
                param1 = gd.a(0, 0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_u, this.field_A, 0, var6, param2, (gd) (this), this.field_C, param4);
                break L3;
              } else {
                param1 = gd.a(0, 0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_s, this.field_z, this.field_q, this.field_p, 0, var6, param2, (gd) (this), this.field_C, param4);
                break L3;
              }
            }
            this.field_r = this.field_r - param1;
    ...
    final int b() {
        if (this.field_o == 0 && this.field_r == 0) {
            return 0;
        }
        return 1;
    }
    ...
    final int a() {
        ...
        if (this.field_w == 0) {
            var1 = var1 - var1 * this.field_x / (((ud) ((Object) this.field_l)).field_n.length << 8);
        } else {
            if (this.field_w >= 0) {
                var1 = var1 - var1 * this.field_B / ((ud) ((Object) this.field_l)).field_n.length;
            }
        }
    ...
    private final void g() {
        ...
        this.field_s = gd.a(this.field_o, this.field_t);
        this.field_z = gd.c(this.field_o, this.field_t);
    }
    ...
    private final boolean e() {
        ...
        L0: {
          var1 = this.field_o;
          if (var1 != -2147483648) {
            var2 = gd.a(var1, this.field_t);
            var3 = gd.c(var1, this.field_t);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_u >= var1) {
            if (this.field_u <= var1) {
              ...
              this.field_A = -1;
              this.field_r = this.field_u - var1;
              break L2;
            }
          } else {
            this.field_A = 1;
            this.field_r = var1 - this.field_u;
            break L2;
          }
        }
        L3: {
          if (this.field_s >= var2) {
            if (this.field_s <= var2) {
              ...
              L4: {
                ...
                if (this.field_r == 0) {
                  ...
                  if (this.field_r <= this.field_s - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_r = this.field_s - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_r == 0) {
                ...
                if (this.field_r <= var2 - this.field_s) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_r = var2 - this.field_s;
            break L3;
          }
        }
        if (this.field_z < var3) {
          this.field_p = 1;
          if (this.field_r != 0) {
            if (this.field_r > var3 - this.field_z) {
              this.field_r = var3 - this.field_z;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_z <= var3) {
              ...
              L7: {
                ...
                if (this.field_r == 0) {
                  ...
                  if (this.field_r <= this.field_z - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_r = this.field_z - var3;
              break L6;
            }
          }
          return false;
    ...
    private final synchronized int h() {
        return this.field_t < 0 ? -1 : this.field_t;
    }
          ...
          L4: {
            if (this.field_w <= 0) {
              ...
              if (!this.field_y) {
                if (this.field_C >= 0) {
                  L5: while (true) {
                    var9 = this.b(param0, var9, var6, param2, (int) var4.field_n[this.field_B]);
                    if (this.field_x >= var6) {
                      ...
                      if (var10 < this.field_w) {
                        ...
                        this.field_x = this.field_x - var8 * this.field_w;
                        this.field_w = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_n[this.field_v - 1]);
                ...
                L7: {
                  if (this.field_C >= 0) {
                    ...
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_n[this.field_B]);
                    if (this.field_x < var5) {
                ...
                L8: while (true) {
                  var9 = this.b(param0, var9, var6, param2, (int) var4.field_n[this.field_v - 1]);
                  if (this.field_x >= var6) {
        ...
        if (param0 != 0) {
          ...
          if (this.field_s == var4) {
            if (this.field_z == var5) {
              ...
              L3: {
                if (var5 - this.field_z <= var6) {
                  break L3;
                } else {
                  var6 = var5 - this.field_z;
                  break L3;
                }
              }
              L4: {
                if (this.field_z - var5 <= var6) {
                  break L4;
                } else {
              ...
              this.field_o = param1;
              this.field_t = param2;
              this.field_A = (param1 - this.field_u) / param0;
              this.field_q = (var4 - this.field_s) / param0;
              this.field_p = (var5 - this.field_z) / param0;
              return;
            }
          } else {
            L6: {
    ...
    final synchronized void a(int param0) {
        ...
        L0: {
          if (this.field_r <= 0) {
            ...
            if (param0 < this.field_r) {
              ...
              this.field_z = this.field_z + this.field_p * param0;
        ...
        this.field_x = this.field_x + this.field_C * param0;
        if (this.field_w >= 0) {
          L5: {
            if (this.field_w <= 0) {
              break L5;
                  ...
                  if (this.field_C >= 0) {
                    if (this.field_x >= var4) {
                      ...
                      if (var7 < this.field_w) {
                        ...
                        this.field_x = this.field_x - var6 * this.field_w;
                        this.field_w = 0;
                        break L5;
                      }
                    } else {
        ...
        L0: while (true) {
          if (this.field_r <= 0) {
            L1: {
              if (this.field_C != 256) {
                ...
                if ((this.field_x & 255) != 0) {
                  ...
                  if (ba.field_d) {
                    return gd.b(0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_s, this.field_z, 0, param3, param2, (gd) (this));
                  } else {
                    return gd.a(((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_u, 0, param3, param2, (gd) (this));
                  }
                }
              }
            }
            if (ba.field_d) {
              return gd.d(0, 0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_s, this.field_z, 0, param3, param2, (gd) (this), this.field_C, param4);
            } else {
              return gd.b(0, 0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_u, 0, param3, param2, (gd) (this), this.field_C, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_r;
            ...
            L3: {
              L4: {
                ...
                if (this.field_C != 256) {
                  ...
                  if ((this.field_x & 255) != 0) {
                    ...
                    if (!ba.field_d) {
                      param1 = gd.b(((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_u, this.field_A, 0, var6, param2, (gd) (this));
                      break L3;
                    } else {
                      param1 = gd.a(0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_s, this.field_z, this.field_q, this.field_p, 0, var6, param2, (gd) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!ba.field_d) {
                param1 = gd.c(0, 0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_u, this.field_A, 0, var6, param2, (gd) (this), this.field_C, param4);
                break L3;
              } else {
                param1 = gd.b(0, 0, ((ud) ((Object) this.field_l)).field_n, param0, this.field_x, param1, this.field_s, this.field_z, this.field_q, this.field_p, 0, var6, param2, (gd) (this), this.field_C, param4);
                break L3;
              }
            }
            this.field_r = this.field_r - param1;
        ...
        if (param0 != 0) {
          if (this.field_s == 0) {
            if (this.field_z == 0) {
              ...
              this.field_A = -this.field_u / param0;
              this.field_q = -this.field_s / param0;
              this.field_p = -this.field_z / param0;
              return;
            }
          } else {
            L6: {
    ...
    private gd(ud param0, int param1, int param2) {
        this.field_l = (gb) ((Object) param0);
        this.field_B = param0.field_l;
        this.field_v = param0.field_p;
