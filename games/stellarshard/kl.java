...
final class kl extends gg {
          ...
          L0: {
            ...
            L2: while (true) {
              if (stellarshard.field_L.length <= var3) {
                    ...
                    if (var2 != 1) {
                      ...
                      L5: {
                        if (~pd.field_g.length > ~bb.field_k.length) {
                          stackOut_16_0 = bb.field_k.length;
                          stackIn_17_0 = stackOut_16_0;
                          break L5;
                        } else {
                          stackOut_15_0 = pd.field_g.length;
                      ...
                      L6: {
                        ...
                        if (o.field_g.length <= fb.field_e.length) {
                          stackOut_19_0 = fb.field_e.length;
                          stackIn_20_0 = stackOut_19_0;
                          break L6;
                        } else {
                          stackOut_18_0 = o.field_g.length;
                      ...
                      L7: {
                        ...
                        if (6 > var3) {
                          ...
                          if (var3 < 6 + var7) {
                            L8: {
                              if (-6 + var3 - -pd.field_g.length + -var7 >= 0) {
                                stackOut_25_0 = pd.field_g[-var7 + var3 + (-6 - -pd.field_g.length)];
                        ...
                        if (var8 + var7 + 7 <= var3) {
                          ...
                          L9: {
                            if (~fb.field_e.length >= ~(var3 + (-7 - var7))) {
                              ...
                              stackOut_30_0 = fb.field_e[-var7 + -7 + var3];
                ...
                L12: {
                  var7 = qe.a((byte) stackIn_39_0, stackIn_39_1, stackIn_39_2 != 0);
                  var8 = s.field_b - (var7 >> 1);
                  if (var4 >= 0) {
                    L13: {
                      if (var4 == ua.field_i.field_f) {
                        stackOut_43_0 = ld.field_y;
                        stackIn_44_0 = stackOut_43_0;
                        break L13;
                      } else {
                        stackOut_42_0 = pk.field_a;
                    ...
                    L14: {
                      ...
                      if (var9 != null) {
                        var9.a(true, var7 + (le.field_k << 1), na.field_a - -(nh.field_h << 1), var1_int, var8 - le.field_k);
                        break L14;
                      } else {
                        break L14;
                      }
    ...
    final static byte[] a(CharSequence param0, int param1) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_68_1 = new StringBuilder().append("kl.A(");
    ...
    kl(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        ((kl) this).field_p = param5;
        ((kl) this).field_m = param2;
        ((kl) this).field_q = param4;
