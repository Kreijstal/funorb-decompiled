    ...
    final static boolean a(pf param0, pf param1, pf param2, byte param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_19_1 = new StringBuilder().append("ni.D(");
          ...
          throw ma.a((Throwable) ((Object) stackIn_28_0), stackIn_28_2 + ',' + param3 + ')');
        }
    ...
    final static String a(boolean param0, int param1, ka param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("ni.C(").append(param0).append(',').append(param1).append(',');
    ...
    final static void a(ej param0, Object param1, int param2) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_13_1 = new StringBuilder().append("ni.B(");
