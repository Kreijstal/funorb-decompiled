    ...
    final static void a(int param0, ka param1, java.math.BigInteger param2, java.math.BigInteger param3, byte[] param4, int param5, int param6) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_22_1 = new StringBuilder().append("rl.D(").append(param0).append(',');
          ...
          throw ma.a((Throwable) ((Object) stackIn_34_0), stackIn_34_2 + ',' + param5 + ',' + param6 + ')');
        }
    ...
    final static void a(java.awt.Canvas param0, int param1, boolean param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_11_1 = new StringBuilder().append("rl.E(");
        ...
        try {
            ...
            try {
              L0: {
                try {
                  L1: {
                    ...
                    discarded$6 = sh.a(new Object[]{"home", var3 + "home.ws"}, false, "updatelinks", param0);
                    discarded$7 = sh.a(new Object[]{"gamelist", var3 + "togamelist.ws"}, false, "updatelinks", param0);
                    discarded$8 = sh.a(new Object[]{"serverlist", var3 + "toserverlist.ws"}, false, "updatelinks", param0);
                    discarded$9 = sh.a(new Object[]{"options", var3 + "options.ws"}, false, "updatelinks", param0);
                    discarded$10 = sh.a(new Object[]{"terms", var3 + "terms.ws"}, false, "updatelinks", param0);
                    discarded$11 = sh.a(new Object[]{"privacy", var3 + "privacy.ws"}, false, "updatelinks", param0);
                    break L1;
                  }
              ...
              L4: {
                ...
                stackOut_6_1 = new StringBuilder().append("rl.A(");
    ...
    final static int a(CharSequence param0, byte param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_9_1 = new StringBuilder().append("rl.B(");
