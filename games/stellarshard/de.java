                      ...
                      L2: while (true) {
                        if (param3 <= var11) {
                          ...
                          L3: {
                            ...
                            if (!param5) {
                              stackIn_23_0 = vh.field_h[var12];
                              break L3;
                            } else {
                              stackIn_23_0 = se.field_B[var12];
                              break L3;
                            }
                          }
                          L4: {
                            ...
                            if (var7_int >= var13) {
                              ...
                              var8++;
                              fj.field_b[incrementValue$0] = var12;
                              break L4;
                            }
                          }
                          var11++;
    ...
    final static bk a(String param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("de.B(");
