...
final class hh implements uk {
    ...
    hh(bd param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7) {
        try {
            ...
            throw ma.a((Throwable) (Object) runtimeException, "hh.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 41);
        }
    }
    ...
    public final void a(boolean param0, int param1, int param2, rj param3, int param4) {
        ...
        try {
            ...
            if (param4 == 4549) {
              ...
              L4: {
                ...
                if (((hh) this).field_c == null) {
                  ...
                  int discarded$1 = ((hh) this).field_c.a(param3.field_m, var13 + (param1 - -param3.field_w), ((hh) this).field_e + (param3.field_k + param2), -var13 + (-((hh) this).field_b + param3.field_p), param3.field_t - (((hh) this).field_b << 1), ((hh) this).field_f, ((hh) this).field_g, 1, 1, 0);
                  break L4;
                }
              }
              break L0;
          ...
          L5: {
            ...
            stackOut_12_1 = new StringBuilder().append("hh.A(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
          ...
          throw ma.a((Throwable) (Object) stackIn_15_0, stackIn_15_2 + 44 + param4 + 41);
        }
    }
