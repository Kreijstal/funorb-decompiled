...
final class ti {
    ...
    final static void a(int param0, int param1, int param2) {
        if (param0 >= field_e) {
            if (param1 < field_f || param0 >= field_c || param1 >= field_l) {
                return;
            }
            field_a[param0 + param1 * field_i] = param2;
            return;
        }
    }
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
          ...
          ti.f(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    final static void c(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param4 != 0) {
          if (param4 != 256) {
            ...
            ti.e(param0, param1, param2, param3);
            return;
          }
        } else {
          return;
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        if (param6 != 256) {
          if (param4 != 0) {
            ...
            ti.b(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          ti.f(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
                    ...
                    if (param0 >= field_c) {
                      ...
                      if (param1 + param3 < field_f) {
                        ...
                        if (param1 < field_l) {
                          L3: {
                            L4: {
                              var10 = var6 + (var7 - param4) * field_i;
                              var11 = var8 + (var7 - param4) * field_i;
                              var12 = var6 + var7 * field_i;
                              var13 = var8 + var7 * field_i;
                              var14 = var6 + var9 * field_i;
                              var15 = var8 + var9 * field_i;
                              var16 = var6 + (var9 + param4) * field_i;
                              var17 = var8 + (var9 + param4) * field_i;
                              var18 = param4;
                              var19 = 0;
                              var20 = param4 * param4;
                              var21 = var20 - var18;
                            ...
                            ti.f(param0, param1 + var18, param3 - var18 - var18, param5);
                            ti.f(param0 + param2 - 1, param1 + var18, param3 - var18 - var18, param5);
                            ti.g(param0 + var18, param1, param2 - var18 - var18, param5);
                            ti.g(param0 + var18, param1 + param3 - 1, param2 - var18 - var18, param5);
                            L11: while (true) {
                              L12: {
          ...
          ti.b(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
                  ...
                  L4: {
                    ...
                    if (var6 < field_e) {
                      ...
                      if (var6 >= field_c) {
                        ...
                        field_a[var6 + param1 * field_i] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_f) {
                      ...
                      if (var6 >= field_l) {
                        ...
                        field_a[param0 + var6 * field_i] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                ti.f(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                ti.f(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              ti.g(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              ti.g(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ti.g(param0, param1, param2, param4, param5);
        ti.g(param0, param1 + param3 - 1, param2, param4, param5);
        if (param3 >= 3) {
            ti.d(param0, param1 + 1, param3 - 2, param4, param5);
            ti.d(param0 + param2 - 1, param1 + 1, param3 - 2, param4, param5);
            return;
        }
    }

    final static void b(int param0, int param1, int param2, int param3, int param4) {
        ti.g(param0, param1, param2, param4);
        ti.g(param0, param1 + param3 - 1, param2, param4);
        ti.f(param0, param1, param3, param4);
        ti.f(param0 + param2 - 1, param1, param3, param4);
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int[] param4) {
        ...
        ti.a(0, 0, 0, 0, 0, var15, var5, var22, field_a, param3, param4, var23, var13, var6 - var7, var16 + var10, var19, var21, var8 - var9);
    }
                        ...
                        if (param1 - param2 < field_l) {
                          L3: {
                            L4: {
                              var4 = param0 + param1 * field_i;
                              var5 = var4;
                              var6 = var4 - param2 * field_i;
                              var7 = var4 + param2 * field_i;
                              var8 = param2;
                              var9 = 0;
                  ...
                  if (var18 <= var20) {
                    L7: {
                      ...
                      if (!ti.a(0, 0, 0, 0, 0, var26, var5, var14 + var17, var17 - var18, field_a, param3, param4, 1, var24, var8 + var21)) {
                        ...
                        ti.a(0, 0, 0, 0, 0, var26, var5, var14 + var18 - 1, var17 - var18, field_a, param3, param4, -1, var29, var8 + var27);
                        break L7;
                      }
                    }
                    var14 = var14 + var15;
