...
class id implements uk, pj {
    ...
    public final int a(rj param0, byte param1) {
        ...
        try {
          L0: {
            ...
            vk discarded$2 = ((id) this).b(param0, (byte) 111);
            stackOut_2_0 = param0.field_r.a(false) - (-((id) this).field_m + -((id) this).field_f);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    private final int a(int param0, rj param1, byte param2, int param3) {
        ...
        try {
          L0: {
            if (param2 < -122) {
              stackOut_3_0 = param1.field_k + (param3 + ((id) this).field_c) + (param1.field_n - -param0);
              stackIn_4_0 = stackOut_3_0;
              break L0;
            } else {
              stackOut_1_0 = 14;
        ...
        try {
          L0: {
            L1: {
              ...
              var9_int = ((id) this).a(param0 + -27246, param6);
                ...
                L2: {
                  ...
                  if (0 != var12) {
                    if (var12 != 2) {
                      ...
                      var11 = (-((id) this).field_a.field_r + var10 - ((id) this).field_a.field_N >> 1) + ((id) this).field_a.field_N;
                      break L2;
                    } else {
    ...
    private final int a(rj param0, int param1, int param2, boolean param3) {
        ...
        try {
          L0: {
            stackOut_0_0 = param0.field_l + (param2 + param0.field_w + ((id) this).field_m) - -param1;
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("id.IA(");
            stackIn_4_0 = stackOut_2_0;
            stackIn_4_1 = stackOut_2_1;
            stackIn_3_0 = stackOut_2_0;
            stackIn_3_1 = stackOut_2_1;
    ...
    public final int a(int param0, rj param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = -((id) this).field_m + param1.field_p + -((id) this).field_f;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L0: {
            L1: {
              if (param1 == 0) {
                ...
                var4 = null;
                int discarded$2 = this.a((byte) -122, (rj) null);
                break L1;
              }
            }
    ...
    public final int a(int param0, rj param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          L0: {
            vk discarded$2 = ((id) this).b(param1, (byte) 115);
            var7_int = 63 % ((-53 - param0) / 37);
            stackOut_0_0 = param1.field_r.a(param5 + -((id) this).a(0, param1, param2), (byte) -53, -((id) this).a((byte) 118, param1, param4) + param3);
            stackIn_1_0 = stackOut_0_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    private final int a(byte param0, rj param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = -((id) this).field_k + param1.field_t + -((id) this).field_c;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    final static void b(byte param0) {
        ma var1 = (ma) (Object) dd.field_g.c((byte) -111);
        if (!(var1 != null)) {
            throw new IllegalStateException();
        }
        ti.a(var1.field_p, var1.field_q, var1.field_r);
        ti.d(var1.field_t, var1.field_u, var1.field_n, var1.field_l);
        var1.field_p = null;
        mb.field_b.b(-119, (gg) (Object) var1);
    }
