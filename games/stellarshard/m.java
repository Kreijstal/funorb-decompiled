...
final class m extends ba {
    ...
    final int c() {
        return ((m) this).field_x - (((m) this).field_w.available() >> (field_d ? 2 : 1));
    }
    ...
    final void b() {
        try {
            ...
            for (var2 = 0; var2 < var1; var2++) {
                var3 = ((m) this).field_f[var2];
                if ((var3 + 8388608 & -16777216) != 0) {
                    var3 = 8388607 ^ var3 >> 31;
                }
                ((m) this).field_v[var2 * 2] = (byte)(var3 >> 8);
                ((m) this).field_v[var2 * 2 + 1] = (byte)(var3 >> 16);
            }
            int discarded$0 = ((m) this).field_w.write(((m) this).field_v, 0, var1 << 1);
    ...
    final void b(int param0) throws javax.sound.sampled.LineUnavailableException {
        ...
        try {
            var2 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, ((m) this).field_y, param0 << (field_d ? 2 : 1));
            ((m) this).field_w = (javax.sound.sampled.SourceDataLine) (Object) javax.sound.sampled.AudioSystem.getLine((javax.sound.sampled.Line.Info) (Object) var2);
            ((m) this).field_w.open();
            ((m) this).field_w.start();
            ((m) this).field_x = param0;
        } catch (javax.sound.sampled.LineUnavailableException lineUnavailableException) {
            if (dl.a(1, param0) != 1) {
                ((m) this).b(u.a(7527, param0));
                return;
            }
            ((m) this).field_w = null;
    ...
    final void a(java.awt.Component param0) {
        ...
        L4: {
          ((m) this).field_y = new javax.sound.sampled.AudioFormat(stackIn_13_3, stackIn_13_4, stackIn_13_5, true, false);
          stackOut_13_0 = this;
          stackOut_13_1 = 256;
        ...
        ((m) this).field_v = new byte[stackIn_16_1 << stackIn_16_2];
    }
