    ...
    final ok a(int param0, String param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("sj.C(").append(param0).append(',');
    ...
    final String a(String param0, int param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("sj.A(");
