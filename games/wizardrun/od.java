...
final class od {
    ...
    final void a(vd param0, int param1) {
        ...
        try {
          L0: {
            var17 = new ll(param0, 2, 2, 2236962, 1, 1, 1, param0.field_M + (param0.field_B - -2));
            var17.field_i = 16777215;
            ((od) this).field_u = (bf) (Object) var17;
            var4 = new qa();
            var17.a((ll) (Object) var4, 0);
            ((od) this).field_r = 3;
            ((od) this).field_p = 5592405;
            ((od) this).field_l = 3;
            ((od) this).field_e = 15658734;
            ((od) this).field_g = param0;
            ((od) this).field_h = 3;
            ((od) this).field_q = 15658734;
            ((od) this).field_t = -1;
            ((od) this).field_i = 3;
            ...
            L1: while (true) {
              if (var7_int >= var18.field_B.length) {
                ...
                if (param1 <= -109) {
                  ...
                  var11 = new qa();
                  var12 = new qa();
                  var11.a(0, var9, (byte) 95);
                  var12.a(0, var10, (byte) -103);
                  var13 = new o(7, 4);
                  ...
                  var14 = new qa(var4, true);
                  var14.a((byte) 59, var13.e());
                  var13.f();
                  var14 = new qa(var4, true);
                  var14.a((byte) 71, var13.e());
                  var13.f();
                  var14 = new qa(var4, true);
                  var14.a((byte) 110, var13.e());
                  var13.f();
                  var19 = new qa(var4, true);
                  var19.a((byte) 106, var13);
                  break L0;
                } else {
                  return;
                }
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("od.F(");
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, byte param6) {
        int var8 = -61 / ((-16 - param6) / 63);
        ed.d(param0, param5, param1, param3, param4, param2);
    }
    ...
    private final void a(int param0, int param1, byte param2, String param3) {
        ...
        try {
          L0: {
            L1: {
              var5_int = ((od) this).field_i + ((od) this).field_l;
              var6 = ((od) this).field_r + ((od) this).field_h;
              var8 = 105 % ((-35 - param2) / 43);
              var7 = ((od) this).field_t;
              if (-1 == var7) {
                var7 = ((od) this).field_g.field_B + ((od) this).field_g.field_M;
                break L1;
              } else {
                break L1;
              }
            ...
            L2: {
              L3: {
                var9 = ed.field_h >> 2;
                var10 = ((od) this).field_g.b(param3);
                var11 = ((od) this).field_g.field_M - -((od) this).field_g.field_B;
                var12 = 1;
                if (var10 > var9) {
                  break L3;
                } else {
              ...
              L5: {
                if (var10 <= var9) {
                  ...
                  var14 = var10 / var9;
                  var13 = var9 - -(2 * ((-1 + var14 + var10 % var9) / var14));
                  break L5;
                }
              }
              var12 = ((od) this).field_g.a(param3, new int[1], sd.field_b);
              var10 = 0;
              var11 = var11 + var7 * (var12 - 1);
              var14 = 0;
              L6: while (true) {
                if (var12 <= var14) {
                  break L2;
                  ...
                  L7: {
                    var15 = ((od) this).field_g.b(sd.field_b[var14]);
                    if (var10 < var15) {
                      var10 = var15;
                      break L7;
                    } else {
            ...
            L8: {
              var13 = param0;
              if (ed.field_h < var5_int + (var13 - -var10)) {
                var13 = -var10 + (ed.field_h - var5_int);
                break L8;
              } else {
                break L8;
              }
            ...
            L9: {
              var14 = 32 + -((od) this).field_g.field_q + param1;
              if (var6 + var14 + var11 > ed.field_d) {
                var14 = -var6 + (-var11 + param1);
                break L9;
              } else {
                break L9;
              }
            }
            ed.a(var13, var14, var10 + var5_int, var11 - -var6, ((od) this).field_e);
            ed.c(1 + var13, var14 - -1, -2 + (var5_int + var10), var6 + (var11 - 2), ((od) this).field_p);
            int discarded$1 = ((od) this).field_g.a(param3, var13 + ((od) this).field_l, var14 - -((od) this).field_r, var10, var11, ((od) this).field_q, -1, 0, 0, var7);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L10: {
            ...
            stackOut_26_1 = new StringBuilder().append("od.D(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final void a(int param0, int param1, String param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("od.I(").append(param0).append(44).append(param1).append(44);
    ...
    final static boolean a(String param0, String param1, int param2) {
        ...
        try {
              ...
              if (p.a(false, param0)) {
                ...
                if (ub.a(param0, 94)) {
                  ...
                  if (param1.length() == 0) {
                    ...
                    if (pd.a(param1, (byte) -109, param0)) {
                      stackOut_18_0 = 0;
                      stackIn_19_0 = stackOut_18_0;
                      return stackIn_19_0 != 0;
                    } else {
                      if (pa.a(0, param1, param0)) {
                        stackOut_22_0 = 0;
          ...
          L1: {
            ...
            stackOut_29_1 = new StringBuilder().append("od.G(");
          ...
          throw bd.a((Throwable) (Object) stackIn_35_0, stackIn_35_2 + 44 + 67 + 41);
        }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ed.e(param2, param0, param5, param1, param4);
        if (param3 != 0) {
    ...
    private final void a(String param0, int param1, int param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              var5_int = ((od) this).field_g.b(param0);
              var6 = ((od) this).field_g.field_q - -((od) this).field_g.field_B;
              var7 = param2;
              if (6 + var5_int + var7 <= ed.field_h) {
                break L1;
              } else {
                var7 = -6 + (-var5_int + ed.field_h);
                break L1;
              }
            }
            L2: {
              var8 = 32 + -((od) this).field_g.field_q + param1;
              if (var6 + var8 + 6 > ed.field_d) {
                var8 = -6 + -var6 + ed.field_d;
                break L2;
              } else {
                break L2;
              }
            }
            ed.a(var7, var8, var5_int + 6, var6 - -6, ((od) this).field_q);
            ed.c(var7 - -1, 1 + var8, 4 + var5_int, 4 + var6, ((od) this).field_p);
            ((od) this).field_g.c(param0, 3 + var7, var8 - (-3 - ((od) this).field_g.field_q), ((od) this).field_q, -1);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("od.A(");
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
          ...
          throw bd.a((Throwable) (Object) stackIn_10_0, stackIn_10_2 + 44 + param1 + 44 + param2 + 44 + 2562 + 41);
        }
    }

    public od() {
        ((od) this).field_d = true;
    }
