    ...
    final static void a(o[] param0, int param1, byte param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L24: {
            ...
            stackIn_75_1 = new StringBuilder().append("ig.B(");
