            ...
            if (var2 >= this.field_i.length) {
              L1: {
                ...
                if (param0 == -84) {
                  ...
                  discarded$1 = ad.a(-2, -101, true, -78);
                  break L1;
                }
              }
              L2: while (true) {
                ...
                if ((param3 ^ -1) > -1) {
                  ...
                  if (param3 >= this.field_i.length) {
                    ...
                    if (null == this.field_i[param3]) {
                      ...
                      stackOut_7_0 = this.field_i[param3];
    ...
    final static sf a(String param0, int param1) {
        ...
        try {
          L0: {
            ...
            if (param1 == 6) {
              stackOut_6_0 = we.field_c;
              stackIn_7_0 = stackOut_6_0;
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
              stackOut_4_0 = (sf) null;
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("ad.G(");
