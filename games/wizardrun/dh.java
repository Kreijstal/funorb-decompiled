    ...
    final static ae a(int param0, String param1) {
        ...
        try {
            ...
            if (-1 == (var2_int ^ -1)) {
              ...
              if (255 >= var2_int) {
                ...
                if (var3.length >= 2) {
                  ...
                  L2: while (true) {
                    if (var5 >= var4.length) {
                      stackOut_20_0 = u.b(var3[var3.length + -1], (byte) -125);
          ...
          L3: {
            ...
            stackOut_22_1 = new StringBuilder().append("dh.B(").append(param0).append(',');
        ...
        try {
          L0: {
            if (h.a(param1, param0, param4, -118)) {
              if (param2 <= -62) {
                stackOut_6_0 = dc.a(param3.a(param0, param1, 1), 0);
                stackIn_7_0 = stackOut_6_0;
                decompiledRegionSelector0 = 2;
                break L0;
              } else {
                stackOut_4_0 = (gb) null;
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("dh.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
