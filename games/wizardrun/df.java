...
abstract class df {
    ...
    final static void a(int param0, int param1, o param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        try {
            ...
            throw bd.a((Throwable) ((Object) runtimeException), "df.D(" + param0 + ',' + param1 + ',' + (param2 != null ? "{...}" : "null") + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ')');
        }
    }
                        ...
                        if (!pj.field_M.a((byte) 29, "benefits")) {
                          ...
                          L2: while (true) {
                            if (nl.field_w.length <= var7) {
                              ...
                              dc.field_s[var7].b();
                              bk.field_a.a(nl.field_w[var7], 3, 3, dc.field_s[var7].field_z + -6, -6 + dc.field_s[var7].field_p, ug.field_H, -1, 1, 1, bk.field_a.field_B + bk.field_a.field_M);
              ...
              L3: {
                if (uk.field_b == null) {
                  ...
                  if (null == v.field_b) {
                    ...
                    var9.b();
                    v.field_b.a(var14, jg.field_m, cb.field_a, ta.field_a, r.field_a, 16777215, -1, 1, 1, v.field_b.field_M + v.field_b.field_B);
              ...
              L8: {
                if (null == pc.field_r) {
                  ...
                  if (bk.field_a != null) {
                    ...
                    pc.field_r = null;
                    var16.b();
                    bk.field_a.a(var5_ref_String, 3, 3, var16.field_z + -6, -6 + var16.field_p, 16777215, -1, 0, 1, bk.field_a.field_B + bk.field_a.field_M);
