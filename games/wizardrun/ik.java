...
final class ik extends mi {
    ...
    final void a(int param0, int param1, int param2, int param3) {
        ...
        int discarded$0 = this.field_N.a(this.field_I, var5 + var7 - -this.field_L, this.field_L + var6, this.field_M + -this.field_L, -(2 * this.field_L) + this.field_n, this.field_J, -1, !this.field_O ? 2 : 0, 1, this.field_N.field_M);
    }
          ...
          L0: {
            ...
            L3: {
              if (this.field_O) {
                ...
                stackOut_8_0 = this.field_M - -(2 * this.field_L);
