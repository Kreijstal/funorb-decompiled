...
final class gl implements m {
    ...
    public gl() throws Exception {
        int var1 = 0;
        ((gl) this).field_b = new com.ms.directX.DSCursors[2];
        ((gl) this).field_a = new com.ms.directX.DSBufferDesc[2];
        ...
        for (var1 = 0; var1 < 2; var1++) {
            ((gl) this).field_a[var1] = new com.ms.directX.DSBufferDesc();
        }
        for (var1 = 0; var1 < 2; var1++) {
            ((gl) this).field_b[var1] = new com.ms.directX.DSCursors();
        }
    }
}
