    ...
    final static ua a(int param0, kl param1, kl param2, int param3, int param4) {
        ...
        try {
          L0: {
            if (param3 <= -114) {
              if (h.a(param0, param4, param1, -114)) {
                stackOut_6_0 = mg.a(65, param2.a(param4, param0, 1));
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("n.A(").append(param0).append(44);
          ...
          throw bd.a((Throwable) (Object) stackIn_14_0, stackIn_14_2 + 44 + param3 + 44 + param4 + 41);
        }
        return stackIn_7_0;
    }
