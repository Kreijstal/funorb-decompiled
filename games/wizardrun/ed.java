...
final class ed {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ed.f(param0, param1, param2, param4);
        ed.f(param0, param1 + param3 - 1, param2, param4);
        ed.e(param0, param1, param3, param4);
        ed.e(param0 + param2 - 1, param1, param3, param4);
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        if (param6 != 256) {
          if (param4 != 0) {
            ...
            ed.d(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          ed.b(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
    ...
    private final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
          ...
          ed.c(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
                  ...
                  L4: {
                    ...
                    if (var6 < field_c) {
                      ...
                      if (var6 >= field_l) {
                        ...
                        field_k[var6 + param1 * field_h] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_i) {
                      ...
                      if (var6 >= field_b) {
                        ...
                        field_k[param0 + var6 * field_h] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                ed.e(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                ed.e(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              ed.f(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              ed.f(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
                      ...
                      if (param1 + param3 < field_i) {
                        ...
                        if (param1 < field_b) {
                          L3: {
                            ...
                            ed.e(param0, param1 + var18, param3 - var18 - var18, param5);
                            ed.e(param0 + param2 - 1, param1 + var18, param3 - var18 - var18, param5);
                            ed.f(param0 + var18, param1, param2 - var18 - var18, param5);
                            ed.f(param0 + var18, param1 + param3 - 1, param2 - var18 - var18, param5);
                            L11: while (true) {
                              L12: {
                                incrementValue$1 = var19;
                                var19++;
          ...
          ed.a(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    private final static void e(int param0, int param1, int param2, int param3) {
        int var4 = 0;
        int var5 = 0;
        if (param0 >= field_c) {
            if (param0 >= field_l) {
    ...
    final static void a(int param0, int param1, int param2) {
        if (param0 >= field_c) {
            if (param1 < field_i || param0 >= field_l || param1 >= field_b) {
                return;
            }
            field_k[param0 + param1 * field_h] = param2;
            return;
        }
    }
