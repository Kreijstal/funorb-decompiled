...
final class oe {
    ...
    final int b(byte param0, int param1) {
        ...
        var3 = (((oe) this).field_b.length >> 1) - 1;
        var4 = var3 & param1;
        L1: while (true) {
    ...
    final static void a(byte param0, int param1) {
        ...
        try {
          L0: {
            var4 = (ie) (Object) pa.field_e.b((byte) 68);
            L1: while (true) {
              if (var4 == null) {
                L2: {
                  if (param0 == -86) {
          ...
          throw bd.a((Throwable) (Object) var2_ref, "oe.B(" + param0 + 44 + 6 + 41);
        }
    }
    ...
    final static String a(byte param0, CharSequence param1) {
        ...
        try {
          L0: {
            var2 = di.a(sb.a((byte) -75, param1), 74);
            if (param0 == 27) {
              L1: {
                if (var2 != null) {
                  break L1;
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("oe.C(").append(param0).append(44);
    ...
    final static boolean a(byte param0, mg param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("oe.E(").append(param0).append(44);
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
            stackIn_8_0 = stackOut_7_0;
            stackIn_8_1 = stackOut_7_1;
          ...
          L0: {
            ...
            L1: while (true) {
              if ((param0.length >> 1) + param0.length < var2_int) {
                ((oe) this).field_b = new int[var2_int + var2_int];
                var3 = 0;
                L2: while (true) {
                  if (var2_int + var2_int <= var3) {
                    ...
                    L3: while (true) {
                      if (var3 >= param0.length) {
                        ...
                        L4: while (true) {
                          if (((oe) this).field_b[1 + (var4 + var4)] == -1) {
