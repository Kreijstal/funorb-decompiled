...
final class mb {
    ...
    final float[] b() {
        return this.field_c[this.a()];
    }

    final int a() {
        int var1 = 0;
        while (this.field_d[var1] >= 0) {
            var1 = nc.c() != 0 ? this.field_d[var1] : var1 + 1;
        }
    ...
    mb() {
        ...
        L0: {
          discarded$2 = nc.a(24);
          this.field_a = nc.a(16);
          this.field_b = nc.a(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_b) {
                ...
                var4_int = nc.a(dj.a(false, this.field_b - var2));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
          ...
          if (var2 <= 0) {
            ...
            L9: {
              ...
              if (var2 != 1) {
                ...
                var7 = mb.a(this.field_b, this.field_a);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_c = new float[this.field_b][this.field_a];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
