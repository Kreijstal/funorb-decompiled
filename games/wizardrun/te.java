    ...
    final static void a(byte param0, byte[] param1, int[] param2, int param3, int param4) {
        ...
        try {
              ...
              if (var5_int >= id.field_b.length) {
                ...
                L3: while (true) {
                  ...
                  if (incrementValue$12 == 0) {
                    ...
                    var6++;
                    param3 = cb.field_e[incrementValue$13];
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("te.B(").append(param0).append(44);
          ...
          throw bd.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + 44 + param3 + 44 + param4 + 41);
        }
    }
