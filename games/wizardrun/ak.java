...
final class ak {
    ...
    public final void movemouse(int param0, int param1) {
        ((ak) this).field_b.mouseMove(param0, param1);
    }
            ...
            if (((ak) this).field_a == param0) {
              ...
              if (((ak) this).field_a == null) {
                if (param0 != null) {
                  ...
                  ((ak) this).field_a = param0;
                  return;
                } else {
                  return;
                }
              } else {
                ((ak) this).field_a.setCursor((java.awt.Cursor) null);
