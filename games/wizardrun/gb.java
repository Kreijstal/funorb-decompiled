...
final class gb extends vd {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$0] == 0) {
                  ...
                  param8++;
                  ed.field_k[incrementValue$1] = param6;
                  var20++;
                  continue L3;
                }
              }
            ...
            if (param4 > 0) {
              L5: {
                if (ed.field_f == null) {
                  ...
                  gb.a(ed.field_k, this.field_N[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, ed.field_f, ed.field_g);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        int var13 = 0;
        int var9 = param1 + param2 * ed.field_h;
        int var10 = ed.field_h - param3;
        int var11 = 0;
        int var12 = 0;
        if (param2 < ed.field_i) {
