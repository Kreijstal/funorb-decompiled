...
final class el {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_b[var16];
                  var10 = field_l[var16] * this.field_c;
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_j, 0, field_b, 0, var2);
        int var3 = field_d[this.field_c - 1];
        ...
        for (var6 = 0; var6 < this.field_f.length; var6++) {
            ...
            var9 = this.field_a[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = nc.field_A[this.field_e[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = this.field_h[var7][var11 & var10];
                var11 = var11 >>> var9;
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_k[var7]) {
                              ...
                              var5++;
                              this.field_j[incrementValue$2] = nc.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_k[this.field_f[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    this.field_k[var4] = nc.a(3) + 1;
                    dupTemp$3 = nc.a(2);
                    this.field_a[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      this.field_e[var4] = nc.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
