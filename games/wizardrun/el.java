...
final class el {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((el) this).field_j.length;
        var4 = field_d[((el) this).field_c - 1];
        var5 = field_g;
        field_g[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_l[0] * ((el) this).field_c;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_b[var16];
                  var10 = field_l[var16] * ((el) this).field_c;
            ...
            L3: {
              var7 = el.b(field_b, var6);
              var8_int = el.a(field_b, var6);
              var9 = this.a(field_b[var7], field_l[var7], field_b[var8_int], field_l[var8_int], field_b[var6]);
              var10 = field_l[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean b() {
        ...
        int var2 = ((el) this).field_j.length;
        System.arraycopy((Object) (Object) ((el) this).field_j, 0, (Object) (Object) field_b, 0, var2);
        int var3 = field_d[((el) this).field_c - 1];
        int var4 = dj.a(false, var3 - 1);
        field_l[0] = nc.a(var4);
        field_l[1] = nc.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((el) this).field_f.length; var6++) {
            var7 = ((el) this).field_f[var6];
            var8 = ((el) this).field_k[var7];
            var9 = ((el) this).field_a[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = nc.field_A[((el) this).field_e[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((el) this).field_h[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_l[incrementValue$0] = var13 >= 0 ? nc.field_A[var13].a() : 0;
            }
        }
        return true;
    }
    ...
    el() {
        ...
        if (var1 == 1) {
          var2 = nc.a(5);
          var3 = 0;
          ((el) this).field_f = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((el) this).field_k = new int[var3];
              ((el) this).field_a = new int[var3];
              ((el) this).field_e = new int[var3];
              ((el) this).field_h = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((el) this).field_c = nc.a(2) + 1;
                  var4 = nc.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((el) this).field_j = new int[var5];
                      ((el) this).field_j[0] = 0;
                      ((el) this).field_j[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((el) this).field_k[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((el) this).field_j[incrementValue$2] = nc.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((el) this).field_k[((el) this).field_f[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((el) this).field_k[var4] = nc.a(3) + 1;
                    int dupTemp$3 = nc.a(2);
                    ((el) this).field_a[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((el) this).field_e[var4] = nc.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
