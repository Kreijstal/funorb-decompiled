...
abstract class mf extends r implements fj {
    ...
    public final void a(int param0, og param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("mf.IA(").append(param0).append(',');
    ...
    public static void e(int param0) {
        ...
        if (param0 <= 18) {
          var2 = (kl) null;
          discarded$2 = mf.a((String) null, (String) null, (kl) null, (byte) 23);
          field_j = (byte[][]) null;
          field_g = null;
          return;
        } else {
