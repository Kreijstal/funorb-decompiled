...
final class uj extends k {
    ...
    final synchronized void g(int param0) {
        int var2 = ((je) ((Object) this.field_k)).field_k.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
        ...
        if (param0 != 0) {
          if (this.field_A == 0) {
            if (this.field_v == 0) {
              ...
              this.field_r = -this.field_q / param0;
              this.field_t = -this.field_A / param0;
              this.field_x = -this.field_v / param0;
              return;
            }
          } else {
            L6: {
    ...
    final int d() {
        if (this.field_n == 0 && this.field_z == 0) {
            return 0;
        }
        return 1;
    }
    ...
    private final void l() {
        ...
        this.field_A = uj.d(this.field_n, this.field_p);
        this.field_v = uj.b(this.field_n, this.field_p);
    }
          ...
          L4: {
            if (this.field_w <= 0) {
              ...
              if (!this.field_s) {
                if (this.field_m >= 0) {
                  L5: while (true) {
                    var9 = this.a(param0, var9, var6, param2, (int) var4.field_k[this.field_y]);
                    if (this.field_o >= var6) {
                      var10 = (this.field_o - var5) / var8;
                      if (var10 < this.field_w) {
                        this.field_o = this.field_o - var8 * var10;
                        this.field_w = this.field_w - var10;
                        continue L5;
                      } else {
                        this.field_o = this.field_o - var8 * this.field_w;
                        this.field_w = 0;
                        break L4;
                      }
                    } else {
                ...
                L7: {
                  if (this.field_m >= 0) {
                    ...
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_k[this.field_y]);
                    if (this.field_o < var5) {
        ...
        L0: while (true) {
          if (this.field_z <= 0) {
            L1: {
              if (this.field_m != 256) {
                ...
                if ((this.field_o & 255) != 0) {
                  ...
                  if (c.field_r) {
                    return uj.a(0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_A, this.field_v, 0, param3, param2, (uj) (this));
                  } else {
                    return uj.b(((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_q, 0, param3, param2, (uj) (this));
                  }
                }
              }
            }
            if (c.field_r) {
              return uj.a(0, 0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_A, this.field_v, 0, param3, param2, (uj) (this), this.field_m, param4);
            } else {
              return uj.a(0, 0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_q, 0, param3, param2, (uj) (this), this.field_m, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_m != 256) {
                  ...
                  if ((this.field_o & 255) != 0) {
                    ...
                    if (!c.field_r) {
                      param1 = uj.a(((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_q, this.field_r, 0, var6, param2, (uj) (this));
                      break L3;
                    } else {
                      param1 = uj.b(0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_A, this.field_v, this.field_t, this.field_x, 0, var6, param2, (uj) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!c.field_r) {
                param1 = uj.d(0, 0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_q, this.field_r, 0, var6, param2, (uj) (this), this.field_m, param4);
                break L3;
              } else {
                param1 = uj.a(0, 0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_A, this.field_v, this.field_t, this.field_x, 0, var6, param2, (uj) (this), this.field_m, param4);
                break L3;
              }
            }
            this.field_z = this.field_z - param1;
        ...
        L0: while (true) {
          if (this.field_z <= 0) {
            L1: {
              if (this.field_m != -256) {
                ...
                if ((this.field_o & 255) != 0) {
                  ...
                  if (c.field_r) {
                    return uj.b(0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_A, this.field_v, 0, param3, param2, (uj) (this));
                  } else {
                    return uj.a(((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_q, 0, param3, param2, (uj) (this));
                  }
                }
              }
            }
            if (c.field_r) {
              return uj.c(0, 0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_A, this.field_v, 0, param3, param2, (uj) (this), this.field_m, param4);
            } else {
              return uj.b(0, 0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_q, 0, param3, param2, (uj) (this), this.field_m, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_z;
            ...
            L3: {
              L4: {
                ...
                if (this.field_m != -256) {
                  ...
                  if ((this.field_o & 255) != 0) {
                    ...
                    if (!c.field_r) {
                      param1 = uj.b(((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_q, this.field_r, 0, var6, param2, (uj) (this));
                      break L3;
                    } else {
                      param1 = uj.a(0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_A, this.field_v, this.field_t, this.field_x, 0, var6, param2, (uj) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!c.field_r) {
                param1 = uj.b(0, 0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_q, this.field_r, 0, var6, param2, (uj) (this), this.field_m, param4);
                break L3;
              } else {
                param1 = uj.b(0, 0, ((je) ((Object) this.field_k)).field_k, param0, this.field_o, param1, this.field_A, this.field_v, this.field_t, this.field_x, 0, var6, param2, (uj) (this), this.field_m, param4);
                break L3;
              }
            }
            this.field_z = this.field_z - param1;
    ...
    final synchronized void a(int param0) {
        ...
        L0: {
          if (this.field_z <= 0) {
            ...
            if (param0 < this.field_z) {
              this.field_q = this.field_q + this.field_r * param0;
              this.field_A = this.field_A + this.field_t * param0;
              this.field_v = this.field_v + this.field_x * param0;
        ...
        this.field_o = this.field_o + this.field_m * param0;
        if (this.field_w >= 0) {
          L5: {
            if (this.field_w <= 0) {
              break L5;
                  ...
                  if (this.field_m >= 0) {
                    if (this.field_o >= var4) {
                      ...
                      if (var7 < this.field_w) {
                        ...
                        this.field_o = this.field_o - var6 * this.field_w;
                        this.field_w = 0;
                        break L5;
                      }
                    } else {
    ...
    private final boolean e() {
        ...
        L0: {
          var1 = this.field_n;
          if (var1 != -2147483648) {
            var2 = uj.d(var1, this.field_p);
            var3 = uj.b(var1, this.field_p);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_q >= var1) {
            if (this.field_q <= var1) {
              ...
              this.field_r = -1;
              this.field_z = this.field_q - var1;
              break L2;
            }
          } else {
            this.field_r = 1;
            this.field_z = var1 - this.field_q;
            break L2;
          }
        }
        L3: {
          if (this.field_A >= var2) {
            if (this.field_A <= var2) {
              ...
              L4: {
                ...
                if (this.field_z == 0) {
                  ...
                  if (this.field_z <= this.field_A - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_z = this.field_A - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_z == 0) {
                ...
                if (this.field_z <= var2 - this.field_A) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_z = var2 - this.field_A;
            break L3;
          }
        }
        if (this.field_v < var3) {
          this.field_x = 1;
          if (this.field_z != 0) {
            if (this.field_z > var3 - this.field_v) {
              this.field_z = var3 - this.field_v;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_v <= var3) {
              ...
              L7: {
                ...
                if (this.field_z == 0) {
                  ...
                  if (this.field_z <= this.field_v - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_z = this.field_v - var3;
              break L6;
            }
          }
          return false;
    ...
    final int b() {
        int var1 = this.field_q * 3 >> 6;
        var1 = (var1 ^ var1 >> 31) + (var1 >>> 31);
        if (this.field_w == 0) {
            var1 = var1 - var1 * this.field_o / (((je) ((Object) this.field_k)).field_k.length << 8);
        } else {
            if (this.field_w >= 0) {
                var1 = var1 - var1 * this.field_y / ((je) ((Object) this.field_k)).field_k.length;
            }
        }
          ...
          if (this.field_A == var4) {
            if (this.field_v == var5) {
              ...
              L0: {
                ...
                if (this.field_q - param1 <= var6) {
                  break L0;
                } else {
                  var6 = this.field_q - param1;
                  break L0;
                }
              }
              L1: {
                if (var4 - this.field_A <= var6) {
                  break L1;
                } else {
                  var6 = var4 - this.field_A;
                  break L1;
                }
              }
              L2: {
                if (this.field_A - var4 <= var6) {
                  break L2;
                } else {
              ...
              this.field_n = param1;
              this.field_p = param2;
              this.field_r = (param1 - this.field_q) / param0;
              this.field_t = (var4 - this.field_A) / param0;
              this.field_x = (var5 - this.field_v) / param0;
              return;
            }
          } else {
            L6: {
    ...
    final synchronized boolean g() {
        return this.field_o < 0 || this.field_o >= ((je) ((Object) this.field_k)).field_k.length << 8;
    }
    ...
    private uj(je param0, int param1, int param2) {
        this.field_k = (kf) ((Object) param0);
        this.field_y = param0.field_n;
