...
final class gj {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((gj) this).field_c.length;
        var4 = field_l[((gj) this).field_i - 1];
        var5 = field_a;
        field_a[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_h[0] * ((gj) this).field_i;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_a[var16]) {
                  var9 = field_f[var16];
                  var10 = field_h[var16] * ((gj) this).field_i;
            ...
            L3: {
              var7 = gj.b(field_f, var6);
              var8_int = gj.a(field_f, var6);
              var9 = this.a(field_f[var7], field_h[var7], field_f[var8_int], field_h[var8_int], field_f[var6]);
              var10 = field_h[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean a() {
        ...
        int var2 = ((gj) this).field_c.length;
        System.arraycopy((Object) (Object) ((gj) this).field_c, 0, (Object) (Object) field_f, 0, var2);
        int var3 = field_l[((gj) this).field_i - 1];
        int var4 = oi.a(var3 - 1, (byte) 1);
        field_h[0] = tk.d(var4);
        field_h[1] = tk.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((gj) this).field_e.length; var6++) {
            var7 = ((gj) this).field_e[var6];
            var8 = ((gj) this).field_g[var7];
            var9 = ((gj) this).field_k[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = tk.field_B[((gj) this).field_b[var7]].c();
            }
    ...
    gj() {
        ...
        if (var1 == 1) {
          var2 = tk.d(5);
          var3 = 0;
          ((gj) this).field_e = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((gj) this).field_g = new int[var3];
              ((gj) this).field_k = new int[var3];
              ((gj) this).field_b = new int[var3];
              ((gj) this).field_d = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((gj) this).field_i = tk.d(2) + 1;
                  var4 = tk.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((gj) this).field_c = new int[var5];
                      ((gj) this).field_c[0] = 0;
                      ((gj) this).field_c[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((gj) this).field_g[((gj) this).field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
