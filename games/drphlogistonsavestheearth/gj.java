...
final class gj {
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_c, 0, field_f, 0, var2);
        int var3 = field_l[this.field_i - 1];
        ...
        for (var6 = 0; var6 < this.field_e.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = tk.field_B[this.field_b[var7]].c();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_g[var7]) {
                              ...
                              var5++;
                              this.field_c[incrementValue$2] = tk.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_g[this.field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
