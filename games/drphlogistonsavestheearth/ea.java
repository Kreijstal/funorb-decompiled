...
final class ea {
    ...
    final static void a(int param0, vj param1) {
        ...
        try {
            ...
            throw ie.a((Throwable) (Object) runtimeException, "ea.A(" + 0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final static nh[] a(String param0, String param1, int param2, vj param3) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = ob.a(var5, -13339, param3, var4_int);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ea.C(");
