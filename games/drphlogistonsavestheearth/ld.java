...
final class ld {
    ...
    private final void a(int param0) {
        ...
        L0: while (true) {
          if (-4 >= (var3 ^ -1)) {
            cb.field_b.a(aj.field_f, 285, -cb.field_b.field_x + 122 + (var2 + 64), 200, 140, 0, -1, param0, 0, cb.field_b.field_x);
            return;
          } else {
            var4 = 0;
            L1: while (true) {
    ...
    private final void f(byte param0) {
        ...
        L1: while (true) {
          if (-1 < (var3 ^ -1)) {
            ...
            var6 = (int)(2.55 * (double)var9[var3]);
            if (0 < var6) {
              v.field_W[var3].a(-50 + var9[var3] / 2, var9[var3] / 2 - 50, var6);
              cb.field_b.a(mg.field_a[sd.field_a.field_q][var3], 225, kj.field_f[sd.field_a.field_q][var3], 405, 640, var6 * 65793, -1, 0, 0, cb.field_b.field_x);
              var3--;
              continue L1;
            } else {
              var3--;
    ...
    private final void a(he param0, int param1, int param2, int param3) {
        ...
        try {
            ...
            throw ie.a((Throwable) ((Object) runtimeException), "ld.F(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ',' + param2 + ',' + param3 + ')');
        }
    }
    ...
    private final void d(int param0) {
        ...
        int[] var10;
        var7 = DrPhlogistonSavesTheEarth.field_D ? 1 : 0;
        var10 = new int[mk.field_g.length];
        var9 = var10;
        var8 = var9;
        var2 = var8;
        var3 = mk.field_g.length + param0;
        L0: while (true) {
          if (-1 < (var3 ^ -1)) {
            L1: {
              if (l.field_n[sd.field_a.field_q][7] >= ul.field_d) {
                ...
                if (kc.field_o[sd.field_a.field_q][7] > ul.field_d) {
                  wj.d(0, 0, 640, 480, 16777215, 255 + -(int)(2.5 * (double)var10[7]));
                  break L1;
                } else {
                  break L1;
                }
            ...
            var6 = (int)((double)var10[var3] * 2.55);
            if (-1 > (var6 ^ -1)) {
              mk.field_g[var3].a(-50 + var10[var3] / 2, var10[var3] / 2 + -50, var6);
              cb.field_b.a(mg.field_a[sd.field_a.field_q][var3], 225, kj.field_f[sd.field_a.field_q][var3], 405, 640, var6 * 65793, -1, 0, 0, cb.field_b.field_x);
              var3--;
              continue L0;
            } else {
    ...
    private final int a(int param0, byte param1) {
        ...
        int var3 = ul.field_j[this.field_c][param0];
        if (!((this.field_c ^ -1) != -3)) {
            return this.b(param0, true) - -cb.field_b.b(hg.field_ob[var3]);
        }
        if (10 == this.field_c && ul.field_j[this.field_c][param0] != 5 && 13 != ul.field_j[this.field_c][param0]) {
            return 70 + this.b(param0, true);
        }
        return ul.field_i[this.field_c];
    }
    ...
    private final int b(int param0, boolean param1) {
        ...
        L1: {
          var3 = ul.field_j[this.field_c][param0];
          if (-3 != (this.field_c ^ -1)) {
            break L1;
          } else {
            if (oh.a(0)) {
        ...
        return ul.field_b[this.field_c];
    }
        ...
        try {
          L0: {
            if (!param0) {
              ...
              cb.field_b.a(mg.field_a[sd.field_a.field_q][0], 225, kj.field_f[sd.field_a.field_q][0], 405, 640, var3_int * 65793, -1, 0, 0, cb.field_b.field_x);
          ...
          L5: {
            ...
            stackIn_18_1 = new StringBuilder().append("ld.D(").append(param0).append(',');
    ...
    private final int b(int param0, byte param1) {
        ...
        if (this.field_c == 10 && (ul.field_j[this.field_c][param0] ^ -1) != -6) {
            return 70;
        }
        return 30;
    }
    ...
    final void f(int param0) {
        ...
        L1: {
          if (param0 == -8448) {
            ...
            discarded$0 = this.a((byte) 16, 0);
            break L1;
          }
        }
        L2: {
          lg.field_f = kj.field_b[this.field_c];
          re.field_e = ih.field_O[this.field_c];
          var3 = this.field_c;
          if (var3 == 0) {
            v.field_O.a(0, 0);
            ...
            if (1 != var3) {
              if (var3 != 2) {
                if (-4 != (var3 ^ -1)) {
                  ...
                  this.b(stackIn_36_1 != 0, (byte) -106);
                  break L2;
                } else {
                  this.c(param0 ^ 8331);
                  break L2;
        ...
        L7: while (true) {
          if (this.field_e.field_e <= var2) {
            ...
            if (this.a(var2, false)) {
              ...
              this.a(stackIn_49_1 != 0, stackIn_49_2 != 0, var2);
              var2++;
              continue L7;
            } else {
              var2++;
    ...
    private final void h(int param0) {
        if (param0 < 61) {
            he var3 = (he) null;
            this.a((he) null, 32, 19, -17);
        }
        if (hl.field_d || td.field_g[sd.field_a.field_q] < ul.field_d) {
            ek.a(-80, false, -1);
            ul.field_d = 0;
        }
    }
    ...
    private final void b(boolean param0) {
        ...
        L3: {
          var4 = nj.a(stackIn_3_0 != 0, stackIn_6_1 != 0, stackIn_9_2, stackIn_9_3 != 0);
          if (var4 != null) {
            break L3;
          } else {
            var4 = tf.field_nb[7];
        ...
        if (!param0) {
          ...
          L8: {
            var4 = jl.a(stackIn_16_0 != 0, stackIn_19_1 != 0, stackIn_22_2 != 0, stackIn_25_3 != 0);
            if (var4 == null) {
              var4 = kk.field_d[7];
              break L8;
            } else {
          ...
          var3.a(var5 + " " + var6, 50, 130 + var2, 540, 480, 0, -1, 1, 0, var3.field_E);
          var7 = re.field_e;
          dj.a(var7, 75, lf.field_b, param0, 385);
          return;
        } else {
          return;
        }
    ...
    private final int a(byte param0, int param1) {
        ...
        L0: {
          ...
          if (-3 != (this.field_c ^ -1)) {
            ...
            if (!oh.a(0)) {
              if (-4 < (param1 ^ -1)) {
                return ul.field_e[this.field_c];
              } else {
                return ul.field_f[this.field_c] + ul.field_e[this.field_c];
              }
            } else {
              break L0;
            }
        ...
        L1: {
          var3 = ul.field_j[this.field_c][param1];
          if (10 != this.field_c) {
            break L1;
          } else {
            if (-6 == (var3 ^ -1)) {
        ...
        return param1 * ul.field_f[this.field_c] + ul.field_e[this.field_c];
    }
        ...
        L0: {
          ...
          if (2 != this.field_c) {
            ...
            if (oh.a(param0 ^ -97)) {
              ...
              L1: {
                if (-97 == (di.field_c ^ -1)) {
                  if (-1 > (this.field_e.field_f ^ -1)) {
                    if (3 == this.field_e.field_f) {
                      break L1;
                    } else {
                      this.field_e.a(this.field_e.field_f + -1, 100);
                      break L1;
                    }
                  } else {
                    this.field_e.a(2, 100);
                    break L1;
                  }
                } else {
                  break L1;
              ...
              L2: {
                if (97 == di.field_c) {
                  if (2 > this.field_e.field_f) {
                    this.field_e.a(1 + this.field_e.field_f, param0 + 197);
                    break L2;
                  } else {
                    if (this.field_e.field_f != 2) {
                      break L2;
                    } else {
                      this.field_e.a(0, 100);
                      break L2;
                    }
                  }
                } else {
              ...
              L3: {
                if (di.field_c != 99) {
                  ...
                  L4: {
                    if ((this.field_e.field_f ^ -1) > -1) {
                      break L4;
                    } else {
                      if ((this.field_e.field_f ^ -1) < -3) {
                        break L4;
                      } else {
                        this.field_e.a(3, 100);
                        break L3;
                      }
                    }
                  }
                  this.field_e.a(pa.field_d, 100);
                  break L3;
                }
              }
              L5: {
        ...
        L6: {
          if ((this.field_c ^ -1) != -12) {
            if (-11 != (this.field_c ^ -1)) {
              ...
              if (0 != (this.field_e.field_f ^ -1)) {
                L7: {
                  this.field_e.d(-1);
                  if (0 <= this.field_e.field_f) {
                    break L7;
                  } else {
                    this.field_e.field_f = 0;
                    break L7;
                  }
                }
                L8: {
                  if (ul.field_j[this.field_c].length >= this.field_e.field_f) {
                    break L8;
                  } else {
                    this.field_e.field_f = ul.field_j[this.field_c].length;
                    break L8;
                  }
                }
                L9: {
                  var2 = ul.field_j[this.field_c][this.field_e.field_f];
                  if (oh.a(0)) {
                    stackIn_43_0 = 13;
                    break L9;
                  } else {
                  ...
                  if (-6 == (var5 ^ -1)) {
                    L12: {
                      if (-99 != (di.field_c ^ -1)) {
                        ...
                        this.field_e.field_f = -var4 + (8 - -this.field_g);
                        break L12;
                      }
                    }
                    if ((di.field_c ^ -1) == -100) {
                      if (var3 != var2) {
                        this.field_e.field_f = 1;
                        break L11;
                      } else {
                        this.field_e.field_f = this.field_e.field_f + (var4 + (1 + this.field_g));
                        break L11;
                      }
                    } else {
                      break L11;
                    ...
                    if (var5 == 13) {
                      ...
                      if (99 == di.field_c) {
                        this.field_e.field_f = this.field_e.field_f + (this.field_g + (1 + var4));
                        break L11;
                      } else {
                        break L11;
                      }
                                      ...
                                      if (var5 == 31) {
                                        ...
                                        L19: {
                                          if ((di.field_c ^ -1) != -99) {
                                            ...
                                            this.field_e.field_f = this.field_e.field_f - 3;
                                            break L19;
                                          }
                                        }
                                        L20: {
                ...
                L24: {
                  if ((this.field_e.field_f ^ -1) < -1) {
                    ...
                    this.field_e.field_f = this.field_e.field_e;
                    break L24;
                  }
                }
                if (this.field_e.field_e <= this.field_e.field_f) {
                  this.field_e.field_f = 0;
                  break L6;
                } else {
                  break L6;
    ...
    final void a(boolean param0, byte param1) {
        ...
        if (this.field_c == 0) {
            if (!(-1 == this.field_e.field_f)) {
                var3 = this.field_e.field_f;
            }
        }
        if (-2 == (this.field_c ^ -1) && 0 != (this.field_e.field_f ^ -1) && (hl.field_f ^ -1) != 0) {
            var3 = this.field_e.field_f;
        }
        if (!(-4 != (this.field_c ^ -1))) {
            var3 = 1;
        }
        this.field_e.a(var3, this.a(ob.field_g, false, ck.field_c), param0, 113);
        if (param1 < 83) {
            field_b = -113L;
        }
        ie.field_y = -1;
        ...
        L3: while (true) {
          if ((var11 ^ -1) <= -6) {
            L4: {
              ...
              ni.field_q.a(var7, 50, var8, 540, var11, 0, 16777215, 0, 0, ni.field_q.field_x);
              wj.d(40, var8, 560, var11, 1);
              if (0 == gf.field_b) {
                stackIn_16_0 = lf.field_b;
                break L4;
              } else {
                stackIn_16_0 = 56;
                break L4;
            ...
            var12 = stackIn_16_0;
            dj.a(56, 80, var12, false, -10 + ul.field_e[this.field_c]);
            return;
          } else {
            var9 += 34;
    ...
    private final void a(boolean param0, int param1) {
        this.field_e.a(this.a(ob.field_g, false, ck.field_c), (byte) 3, param0);
        if (param1 != 0) {
            this.field_c = 106;
        }
    }
    ...
    private final void a(boolean param0) {
        ...
        if (0 == (!hl.field_d ? 1 : 0) || td.field_g[sd.field_a.field_q] < ul.field_d) {
            ek.a(-63, false, -1);
            ul.field_d = 0;
        }
    }
    ...
    private final void c(boolean param0) {
        ...
        int[] var9;
        var7 = DrPhlogistonSavesTheEarth.field_D ? 1 : 0;
        var9 = new int[pc.field_b.length];
        var8 = var9;
        var2 = var8;
        ...
        if (param0) {
          L0: while (true) {
            if ((var3 ^ -1) > -1) {
              ...
              var6 = (int)((double)var9[var3] * 2.55);
              if (var6 > 0) {
                pc.field_b[var3].a(-50 + var9[var3] / 2, -50 + var9[var3] / 2, var6);
                cb.field_b.a(mg.field_a[sd.field_a.field_q][var3], 225, kj.field_f[sd.field_a.field_q][var3], 405, 640, var6 * 65793, -1, 0, 0, cb.field_b.field_x);
                var3--;
                continue L0;
              } else {
    ...
    private final void a(boolean param0, boolean param1, int param2) {
        ...
        L1: {
          var8 = ul.field_j[this.field_c][param2];
        ...
        L3: {
          ...
          if (8 != var8) {
            ...
            L10: {
              var7.c((String) (var9), var11, var4 + var7.field_x, var10, -1, var14);
              if (!param1) {
                break L10;
              } else {
                if (((String) (var9)).length() != 0) {
                  var7.a("{", var11, var7.field_x + var4, var10, -1, var14);
                  var7.c("}", var7.b((String) (var9)) + var11, var7.field_x + var4, var10, -1, var14);
                  break L10;
                } else {
                  break L10;
                }
            ...
            L13: {
              var16 = n.field_c + ul.field_b[this.field_c] + cb.field_b.b(" ");
              if (-11 != (var8 ^ -1)) {
                stackIn_63_0 = oa.field_b;
                break L13;
              } else {
                stackIn_63_0 = dg.field_e;
                break L13;
              }
            }
            var17 = stackIn_63_0;
                ...
                if (!param1) {
                      ...
                      L24: while (true) {
                        if (var19 >= 4) {
                          L25: {
                            ...
                            if (gf.field_D >= var14) {
                              stackIn_82_0 = tc.field_b[var14];
                              break L25;
                            } else {
                              stackIn_82_0 = s.field_f;
                              break L25;
                            }
                          }
                          L26: {
                          ...
                          L27: {
                            L28: {
                              cb.field_b.c((String) (var9), 285, 64 + (var17 - -122), 0, -1);
                              var20 = 0;
                              if ((hb.field_g ^ -1) < -1) {
                                break L28;
                              } else {
                          ...
                          cb.field_b.a((String) (var9), 285, var17 + 122 - -94, 320, 240, var20, -1, 0, 0, cb.field_b.field_x);
                          if (var14 > gf.field_D) {
                            break L21;
                          } else {
                            L29: {
                            ...
                            cb.field_b.c((String) (var9), 285, 94 + (122 + var17) + 100, 0, -1);
                            break L21;
                          }
                        } else {
                  ...
                  if ((var15 ^ -1) == 0) {
                    ...
                    if (-1 == var16) {
                      ...
                      cb.field_b.c(a.a(5044, ek.field_q, new String[]{Integer.toString(var15 + 1), Integer.toString(1 + var16)}), 285, var17 + 122 - -20, 0, -1);
                      break L19;
                    }
                  }
                }
    ...
    final void l(int param0) {
        ...
        if (11 != this.field_c) {
          ...
          L7: while (true) {
            if (!th.a(24)) {
              L8: {
                this.field_e.a(0, this.a(ob.field_g, false, ck.field_c), this.a(ih.field_R, false, ae.field_gb));
                if (-1 != this.field_e.field_f) {
                  this.a(this.field_e.field_f, 80, true);
                  break L8;
                } else {
                  break L8;
                }
              ...
              if (di.field_c != 13) {
                ...
                if (0 == (this.field_e.field_f ^ -1)) {
                  ...
                  this.a(this.field_e.field_f, 80, false);
                  continue L7;
                }
              } else {
                if ((this.field_c ^ -1) == -2) {
    ...
    private final int a(int param0, boolean param1, int param2) {
        ...
        var4 = 0;
        L1: while (true) {
          if (ul.field_j[this.field_c].length <= var4) {
            return -1;
          } else {
    ...
    private final void b(int param0) {
        ...
        if (hl.field_d || ul.field_d > td.field_g[sd.field_a.field_q]) {
            ek.a(-79, false, -1);
            ul.field_d = 0;
        }
    }
    ...
    private final void a(int param0, int param1, boolean param2) {
        ...
        L0: {
          ...
          var4 = r.field_d;
          var5 = ul.field_j[this.field_c][param0];
          if (-11 == (var5 ^ -1)) {
            break L0;
          } else {
            if (11 == var5) {
                                      ...
                                      if (13 != var7) {
                                                      ...
                                                      if ((var7 ^ -1) != -25) {
                                                        if (-11 == (var7 ^ -1)) {
                                                          ...
                                                          if (-12 != (var7 ^ -1)) {
                                                            ...
                                                            L20: {
                                                              if (this.field_e.a(param1 ^ -14084)) {
                                                                var7 = -284 + ck.field_c;
                                                                if ((var7 ^ -1) >= -1) {
                                                                  wk.a(param1 + 0, 0);
                                                                  break L20;
                                        ...
                                        if (this.field_e.e(-748)) {
                                          if (oh.a(0)) {
                                            ...
                                            wl.a(this.field_c, this.field_c, 57);
                                            break L1;
                                          } else {
                                            break L1;
                                          }
    ...
    private final void b(boolean param0, byte param1) {
        ...
        if (param1 < -95) {
          ...
          L1: {
            ...
            var6 = var5 + 220;
            if (!param0) {
              stackIn_8_0 = qe.field_k;
              break L1;
            } else {
              stackIn_8_0 = el.field_ub;
              break L1;
            }
          }
          L2: {
          ...
          L3: {
            ...
            var10 = 133 + var4;
            if (!param0) {
              stackIn_13_0 = hi.field_j;
              break L3;
            } else {
              stackIn_13_0 = ej.field_h;
              break L3;
            }
          }
          var11 = stackIn_13_0;
                ...
                if (var14 != -1) {
                  ...
                  L10: {
                    ...
                    if (var15 == 0) {
                      L11: {
                        ...
                        stackIn_64_0 = tl.field_P;
                        break L11;
                      }
                      var17_ref_he = stackIn_64_0;
                  ...
                  L13: while (true) {
                    if (qh.field_a[var14] <= var19) {
                      ...
                      var22 = 297;
                      var23 = var19 * 5;
                      var25.a(jk.field_K[var14], var20, var21, var22, var23, 0, -1, 0, 1, var19);
                      break L7;
                    } else {
                  ...
                  var25.a(re.field_j, 166, -var25.field_x + var4 - -150, 500, 200, 0, -1, 0, 0, var25.field_x);
                  if (!oh.a(0)) {
                    break L7;
                  } else {
                    ni.field_q.a(gl.field_f, 213, 116 + (var4 - -(var6 / 2)), 300, 200, 1, -1, 1, 0, ni.field_q.field_x);
                    break L7;
                  }
                }
              }
    ...
    ld(int param0) {
        ...
        this.field_g = 2;
        this.field_c = param0;
        this.field_e = new ql(ul.field_j[param0].length);
        if (eg.field_a == null) {
    ...
    private final void d(byte param0) {
        ...
        L9: {
          ...
          if (!oh.a(0)) {
            stackIn_38_0 = mi.field_h;
            break L9;
          } else {
            stackIn_38_0 = gl.field_f;
            break L9;
          }
        }
        var3 = stackIn_38_0;
        var11 = var4.field_x + (140 + var10) - -(var5 * 10);
        var4.a(var3, 85, var5 / 2 + var11, 465, 100, 4210752, -1, 1, 0, ni.field_q.field_x);
    }
              ...
              L1: while (true) {
                if (480 <= var10) {
                  ...
                  L2: {
                    ...
                    if (2 == sd.field_e) {
                      wj.a(1600, 430 + param0 << 101621956, 4800, 92, var13);
                      break L2;
                    } else {
                  ...
                  wj.f(var8, var10, var9, 1 + var10);
                  if (2 == sd.field_e) {
                    wj.a(8640, 430 + param0 << 1246132996, 4800, 92, var13);
                    var10++;
                    continue L1;
                  } else {
