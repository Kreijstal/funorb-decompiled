...
final class ac {
    ...
    final ai a(int param0, byte param1) {
        ...
        byte[] var4 = null;
        ai var5 = null;
        var3 = (ai) ((ac) this).field_i.a(true, (long)param0);
        if (var3 == null) {
          L0: {
            if (32768 <= param0) {
              var4 = ((ac) this).field_e.a(1, 32767 & param0, (byte) 35);
              break L0;
            } else {
              var4 = ((ac) this).field_c.a(1, param0, (byte) 35);
              break L0;
            }
          }
          var5 = new ai();
          if (var4 == null) {
            if (32768 > param0) {
              if (param1 != -74) {
                ...
                ((ac) this).field_i.a((Object) (Object) var5, (long)param0, 117);
                return var5;
              }
            } else {
              var5.a((byte) 5);
