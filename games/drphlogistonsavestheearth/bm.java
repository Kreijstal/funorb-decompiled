...
final class bm extends rf {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  bm.a(wj.field_l, ((bm) this).field_J[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  jb.a(wj.field_l, ((bm) this).field_J[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
    ...
    bm(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        ...
        ((bm) this).field_J = new byte[256][];
        ((bm) this).field_J = bm.a(param5, param6);
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  bm.a(wj.field_l, ((bm) this).field_J[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  jb.a(wj.field_l, ((bm) this).field_J[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
