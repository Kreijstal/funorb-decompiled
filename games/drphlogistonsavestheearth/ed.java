...
final class ed extends id {
    ...
    final void b() {
        try {
            ...
            for (var2 = 0; var2 < var1; var2++) {
                var3 = ((ed) this).field_a[var2];
                if ((var3 + 8388608 & -16777216) != 0) {
                    var3 = 8388607 ^ var3 >> 31;
                }
                ((ed) this).field_w[var2 * 2] = (byte)(var3 >> 8);
                ((ed) this).field_w[var2 * 2 + 1] = (byte)(var3 >> 16);
            }
            int discarded$0 = ((ed) this).field_x.write(((ed) this).field_w, 0, var1 << 1);
    ...
    final int c() {
        return ((ed) this).field_v - (((ed) this).field_x.available() >> (field_f ? 2 : 1));
    }

    final void f() {
        if (((ed) this).field_x != null) {
            ((ed) this).field_x.close();
            ((ed) this).field_x = null;
        }
    }

    ed() {
        ((ed) this).field_z = false;
    }
    ...
    final void d() throws javax.sound.sampled.LineUnavailableException {
        ...
        ((ed) this).field_x.flush();
        if (((ed) this).field_z) {
            ((ed) this).field_x.close();
            ((ed) this).field_x = null;
            var1 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, ((ed) this).field_y, ((ed) this).field_v << (field_f ? 2 : 1));
            ((ed) this).field_x = (javax.sound.sampled.SourceDataLine) (Object) javax.sound.sampled.AudioSystem.getLine((javax.sound.sampled.Line.Info) (Object) var1);
            ((ed) this).field_x.open();
            ((ed) this).field_x.start();
        }
    }
    ...
    final void a(int param0) throws javax.sound.sampled.LineUnavailableException {
        ...
        try {
            var2 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, ((ed) this).field_y, param0 << (field_f ? 2 : 1));
            ((ed) this).field_x = (javax.sound.sampled.SourceDataLine) (Object) javax.sound.sampled.AudioSystem.getLine((javax.sound.sampled.Line.Info) (Object) var2);
            ((ed) this).field_x.open();
            ((ed) this).field_x.start();
            ((ed) this).field_v = param0;
        } catch (javax.sound.sampled.LineUnavailableException lineUnavailableException) {
            if (ig.a(param0, (byte) -121) != 1) {
                ((ed) this).a(lg.a(2, param0));
                return;
            }
            ((ed) this).field_x = null;
