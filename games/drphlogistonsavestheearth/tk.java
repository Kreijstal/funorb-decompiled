...
final class tk extends gi {
              ...
              if (var7 == null) {
                ...
                L6: while (true) {
                  if (var5 >= var4) {
                    ...
                    var3++;
                    this.field_o[incrementValue$0] = (byte)(var6 - 128);
                    var5++;
                    continue L6;
                  }
                }
          ...
          if (var17_int >= var14.field_b) {
            L10: {
              if (var15 != 0) {
                ...
                field_E[var18_int].a(field_C, var4 >> 1);
                break L10;
              }
            }
            L11: {
    ...
    final static int a() {
        int var0 = field_k[field_J] >> field_w & 1;
        field_w = field_w + 1;
        field_J = field_J + (field_w >> 3);
        field_w = field_w & 7;
        return var0;
    }
    ...
    final static int d(int param0) {
        ...
        while (param0 >= 8 - field_w) {
            var3 = 8 - field_w;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_k[field_J] >> field_w & var4) << var2);
            field_w = 0;
            field_J = field_J + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_k[field_J] >> field_w & var3) << var2);
            field_w = field_w + param0;
        }
        return var1;
    }

    private final static boolean a(vj param0) {
        byte[] var1 = null;
        if (!field_v) {
            var1 = param0.a(0, 0, (byte) 35);
            if (var1 == null) {
                return false;
            }
            tk.b(var1);
    ...
    private tk(byte[] param0) throws IOException {
        this.a(param0);
    }
