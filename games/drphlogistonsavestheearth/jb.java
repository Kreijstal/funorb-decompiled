...
final class jb extends rf {
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19 = 0;
        int var20 = 0;
        var13 = param2 - wj.field_g;
        var14 = param3 - wj.field_e;
        var15 = var14;
        L0: while (true) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  wj.field_l[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    jb(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        super(param0, param1, param2, param3, param4);
        ((jb) this).field_J = new byte[256][];
        ((jb) this).field_J = param5;
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * wj.field_k;
          var10 = wj.field_k - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= wj.field_e) {
            break L0;
          } else {
            var13 = wj.field_e - param2;
            param4 = param4 - var13;
            param2 = wj.field_e;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * wj.field_k;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= wj.field_j) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - wj.field_j);
            break L1;
          }
        }
        L2: {
        ...
        L3: {
          if (param1 + param3 <= wj.field_b) {
            break L3;
          } else {
            var13 = param1 + param3 - wj.field_b;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              jb.a(wj.field_l, ((jb) this).field_J[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * wj.field_k;
          var9 = wj.field_k - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= wj.field_e) {
            break L0;
          } else {
            var12 = wj.field_e - param2;
            param4 = param4 - var12;
            param2 = wj.field_e;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * wj.field_k;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= wj.field_b) {
            ...
            var12 = param1 + param3 - wj.field_b;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (wj.field_i == null) {
                  jb.a(wj.field_l, ((jb) this).field_J[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  jb.a(wj.field_l, ((jb) this).field_J[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, wj.field_i, wj.field_f);
                  break L5;
                }
              }
              return;
