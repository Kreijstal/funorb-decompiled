...
class id {
                ...
                L0: {
                  ...
                  L2: while (true) {
                    if (var1 <= this.field_p + 5000L) {
                      ...
                      this.b(256);
                      this.field_p = this.field_p + (long)(256000 / field_d);
                      var1 = la.a(false);
                      continue L2;
                    }
                  }
              ...
              if (this.field_a != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.c();
                      if (this.field_n - var3_int <= this.field_u) {
                        break L6;
                      } else {
                        this.field_u = this.field_n - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_s + this.field_r;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_h) {
                        ...
                        if (var4 + 256 <= this.field_h) {
                          ...
                          this.field_r = var4 - this.field_s;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_t) {
                            ...
                            L12: {
                              if (this.field_m) {
                                ...
                                this.field_r = Math.min(this.field_q, this.field_u);
    ...
    private final void a(int[] param0, int param1) {
        ...
        L1: {
          ...
          if (this.field_l == null) {
            ...
            if (this.field_k > 0) {
              ...
              this.field_k = this.field_k + (field_d >> 4);
              id.b(this.field_l);
              this.a(this.field_l, this.field_l.b());
              var4 = 0;
              var5 = 255;
              var6 = 7;
              L2: while (true) {
                                ...
                                if (var4 < this.field_c) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_i[var7_int] = (ic) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((ic) (var7)).field_j;
                        ((ic) (var7)).field_j = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
        ...
        L17: {
          if (this.field_l == null) {
            ...
            this.field_l.b(param0, 0, param1);
            break L17;
          }
        }
        this.field_p = la.a(false);
    }
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new ed();
                          var4 = var5;
                          stackIn_10_0 = (ed) (var4);

                          stackIn_10_1 = 256;

                          if (!field_f) {
                            stackIn_11_0 = (ed) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_o <= 0) {
                            ...
                            if (field_g != null) {
                              ...
                              param0.a((Runnable) ((Object) field_g), field_o, (byte) -8);
                              break L5;
                            }
                          }
                        }
    ...
    id() {
        ...
        this.field_k = 0;
        this.field_n = 0;
        this.field_b = new ic[8];
        this.field_i = new ic[8];
        this.field_m = true;
        this.field_j = 0L;
        this.field_u = 0;
        this.field_t = 0L;
