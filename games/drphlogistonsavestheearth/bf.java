...
final class bf {
    ...
    private final void d(int param0) {
        ...
        if (this.field_o < (double)param0) {
          ...
          if (-1 > (this.field_a ^ -1)) {
                  ...
                  if ((var6_int ^ -1) != -12) {
                    ...
                    L4: {
                      ...
                      L6: while (true) {
                        if (-4 >= (var6_int ^ -1)) {
                          if ((var2 ^ -1) != 0) {
                            th.a(-27610, 32, e.a(param0 + 115, (int)this.field_o), nl.field_r[var2]);
                            break L4;
                          } else {
                            break L4;
                          }
            ...
            L9: {
              if ((var2 ^ -1) != 0) {
                th.a(-27610, 32, e.a(116, (int)this.field_o), nl.field_r[var2]);
                break L9;
              } else {
                break L9;
              }
              ...
              if (var5 != 11) {
                ...
                L10: while (true) {
                  if (this.field_L.length <= var7) {
                    ...
                    var4 += 256;
                    this.field_L[var7].a(-var3 + (int)this.field_N + this.field_t - -hi.a(var3 * 2, 4, this.field_T), var3 / 2, var4, 112, 1, (int)this.field_o - -hi.a(2 * var3, 4, this.field_T) + -var3);
                    var7++;
                    continue L10;
                  }
                }
              ...
              if (0 == (vg.field_r[this.field_Q] ^ -1)) {
                ...
                L20: while (true) {
                  if (this.field_i.length <= var8) {
                    ...
                    this.field_i[var8].a(lb.field_B[this.field_Q], 30, (double)vg.field_r[this.field_Q], (double)(int)((double)dd.field_h[this.field_Q] + this.field_N), 0, -1.0, 1.0, (double)(int)((double)nc.field_L[this.field_Q] + this.field_o), 64);
                    var8++;
                    continue L20;
                  }
                }
    ...
    final int e(byte param0) {
        int var2 = -(int)this.field_N + 430;
        double var3 = (double)(this.field_e % k.field_M[this.field_Q]) / (0.5 * (double)k.field_M[this.field_Q]);
                              ...
                              if (3 == var4) {
                                ...
                                if ((var4 ^ -1) == -47) {
                                  ...
                                  if (var4 == 5) {
                                    ...
                                    L6: {
                                      if (this.field_V % this.b((byte) -120, this.field_Q) == 0) {
                                        this.e(63);
                                        break L6;
                                      } else {
                                        break L6;
                                    ...
                                    if (-8 != (var4 ^ -1)) {
                                      ...
                                      L18: {
                                        var2 = (int)(-sd.field_a.field_N + this.field_o);
                                        var3 = (int)(this.field_N - sd.field_a.field_D);
                                        if (0 <= this.field_u) {
                                          break L18;
                                        } else {
                                          if (-5626 > (var2 * var2 + var3 * var3 ^ -1)) {
              ...
              if (-1 < (ta.field_j[this.field_Q] ^ -1)) {
                ...
                L1: while (true) {
                  if (this.field_i.length <= var2) {
                    ...
                    this.field_i[var2].a(param0 ^ 30217);
                    var2++;
                    continue L1;
                  }
                }
              ...
              if (0.0 < var5_double) {
                ...
                L11: while (true) {
                  if (var11 >= 128) {
                    L12: {
                      if (45 == this.field_Q) {
                        wj.a((int)this.field_o - -this.field_I << -2002504060, (int)this.field_N - -41 << -1459260252, 1920, 126, var16);
                        break L12;
                      } else {
                        break L12;
                      }
                    ...
                    if (this.field_Q != 44) {
                      ...
                      wj.a(41 + (int)this.field_o << 1559008484, this.field_t + (int)this.field_N << 1310863940, 1920, 126, var16);
                      break L8;
                    }
                  } else {
                                    ...
                                    if (-10 != (var3 ^ -1)) {
                                      if (var3 == 10) {
                                        ...
                                        if ((var3 ^ -1) != -3) {
                                          ...
                                          if (hc.field_G <= hi.a(3, 4, this.field_T)) {
    ...
    private final void k(int param0) {
                ...
                if (var23 != 5) {
                  if (11 != var23) {
                    if ((var23 ^ -1) != -18) {
                      ...
                      sd.field_a.a(24, new gf(var16, -60.0 + var2, var4, ji.a(param0 ^ 65535, var10) * var14, var14 * pj.a(var10, 32768), -10.0, this.field_N));
                      sd.field_a.a(24, new gf(var16, 60.0 + var2, var4, var14 * ji.a(65535, var12), var14 * pj.a(var12, param0 ^ 32768), -10.0, this.field_N));
                      sd.field_a.a(24, new gf(var16, var2 - 60.0, var4, ji.a(65535, var10) * -var14, pj.a(var10, 32768) * var14, -10.0, this.field_N));
                      sd.field_a.a(24, new gf(var16, 60.0 + var2, var4, ji.a(65535, var12) * -var14, pj.a(var12, 32768) * var14, -10.0, this.field_N));
                      return;
                    }
                  } else {
                    ...
                    sd.field_a.a(24, new gf(var16, var2 - 60.0, var4, var14 * ji.a(65535, var10), pj.a(var10, 32768) * var14, -10.0, this.field_N));
                    sd.field_a.a(24, new gf(var16, 60.0 + var2, var4, ji.a(65535, -var10) * var14, pj.a(-var10, 32768) * var14, -10.0, this.field_N));
                    return;
                  }
                } else {
                  var16 = 6;
        ...
        L3: {
          if (var16 == -1) {
            ...
            sd.field_a.a(24, new gf(var16, var2, var4, var6, var8, -10.0, this.field_N));
            break L3;
          }
        }
    }
            ...
            if (this.field_s) {
              L4: {
                if ((ga.field_j[this.field_Q] ^ -1) != 0) {
                  var3 = e.a(param1 + 104, this.field_I + (int)this.field_o);
                  if (-70 != (ga.field_j[this.field_Q] ^ -1)) {
                    th.a(-27610, 48, var3, nl.field_r[ga.field_j[this.field_Q]]);
                    break L4;
                  } else {
                    break L4;
                  }
    ...
    final static String a(long param0, byte param1) {
        ...
        if (param1 != -29) {
            java.applet.Applet var10 = (java.applet.Applet) null;
    ...
    final he b(byte param0) {
                          ...
                          if (var2 == 44) {
                            ...
                            L3: {
                              if (!this.field_s) {
                                ...
                                return this.field_n[this.field_E % this.field_n.length];
                              }
                            }
                            L5: {
                              if (this.field_Q != 12) {
                                ...
                                if (2 == this.field_J) {
                                  return ib.field_j[this.field_E % ib.field_j.length];
                                } else {
                                  break L5;
                                }
                              }
                            }
                            return this.field_F[this.field_E % this.field_F.length];
                          }
                        }
                      }
                      if (!this.field_s) {
                        if (!this.g((byte) -78)) {
                          return sh.field_c[this.field_Q][0];
                        } else {
                          return sh.field_c[this.field_Q][1];
                        }
                      } else {
        ...
        if (!this.field_s) {
          return this.field_F[this.field_J % this.field_F.length];
        } else {
          return this.field_n[this.field_J % this.field_n.length];
        }
    }
    ...
    private final double i(int param0) {
        ...
        if (sd.field_a != null) {
            return dl.a(true, this.field_o - sd.field_a.field_N, -sd.field_a.field_D + this.field_N);
        }
        return -1.0;
    }
          ...
          if ((this.field_a ^ -1) < -1) {
            ...
            L4: {
              if (var2 == -1) {
                ...
                th.a(-27610, 32, e.a(112, (int)this.field_o), nl.field_r[var2]);
                break L4;
              }
            }
            return;
    ...
    bf(int param0, int param1, int param2, int param3, int param4, boolean param5) {
        ...
        L3: {
          L4: {
            var12 = this.b((byte) 55);
            this.field_t = var12.field_k / 2 - -var12.field_f;
            this.field_I = var12.field_d / 2 - -var12.field_a;
            this.field_O = var12.field_c;
            this.field_m = var12.field_h;
            if (4 == this.field_Q) {
              break L4;
            } else {
              if (-4 == (this.field_Q ^ -1)) {
