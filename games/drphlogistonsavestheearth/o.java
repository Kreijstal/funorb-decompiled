...
final class o extends em {
    ...
    final static void a(boolean param0, int param1, java.awt.Canvas param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("o.A(").append(param0).append(44).append(320).append(44);
    ...
    final void a(rf param0, int param1, int param2, int param3, int param4, String param5, int param6, int param7) {
        ...
        try {
          L0: {
            ...
            if (param5 == null) {
              ...
              L4: {
                ...
                if (((o) this).field_q != 0) {
                  if (((o) this).field_q == 1) {
                    var12 = (-(((o) this).field_i * var10) + ((o) this).field_g >> 1) + param0.field_x;
                    break L4;
                  } else {
                    if (((o) this).field_q != 2) {
                      L5: {
                    ...
                    if (var14 != null) {
                      L9: {
                        ...
                        if (param2 != 3) {
                          ...
                          stackOut_41_1 = ((o) this).a(param1, var14, param0.b(var14), 0);
          ...
          L11: {
            ...
            stackOut_49_1 = ((StringBuilder) (Object) stackIn_49_1).append(stackIn_49_2).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
          ...
          throw ie.a((Throwable) (Object) stackIn_52_0, stackIn_52_2 + 44 + param6 + 44 + param7 + 41);
        }
    }
    ...
    final void a(rf param0, String param1, int param2, int param3, int param4) {
        ...
        try {
            ...
            throw ie.a((Throwable) (Object) runtimeException, "o.E(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    final void a(rf param0, int param1, int param2, String param3, boolean param4) {
        ...
        try {
            ...
            var8.field_a[0] = -(var7 >> 1) + param1;
            var8.field_a[param3.length()] = (var7 >> 1) + param1;
            dc.a(param4, 0, param3, param0, var8);
        } catch (RuntimeException runtimeException) {
            throw ie.a((Throwable) (Object) runtimeException, "o.G(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + (param3 != null ? "{...}" : "null") + 44 + param4 + 41);
        }
    }
    ...
    final void a(rf param0, int param1, boolean param2, int param3, String param4) {
        ...
        try {
            ...
            throw ie.a((Throwable) (Object) runtimeException, "o.B(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    private final mi a(rf param0, byte param1, int param2, String param3) {
        ...
        try {
          L0: {
            var6 = new mi(param2 + -param0.field_x, param0.field_S + param2, param3.length());
            var5 = var6;
            ((o) this).field_a = new mi[]{var6};
            stackOut_0_0 = (mi) var5;
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("o.D(");
          ...
          L2: {
            ...
            stackOut_5_1 = ((StringBuilder) (Object) stackIn_5_1).append(stackIn_5_2).append(44).append(76).append(44).append(param2).append(44);
