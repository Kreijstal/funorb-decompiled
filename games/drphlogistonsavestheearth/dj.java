    ...
    public final void a(int param0, int param1, boolean param2, hf param3, int param4) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              L3: {
                if (((dj) this).field_J <= var6_int) {
                  break L3;
                } else {
                  if (param3 != ((dj) this).field_Q[var6_int]) {
                    var6_int++;
                    continue L2;
                  } else {
                    var7 = ((dj) this).field_M[var6_int];
                    if (var7 != -1) {
                      sf.a(((dj) this).field_M[var6_int], 11649);
                      break L3;
                    } else {
