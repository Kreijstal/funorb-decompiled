...
final class ae extends ca implements ke {
    ...
    public final void a(int param0, int param1, boolean param2, hf param3, int param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("ae.G(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final static void a(int param0, int param1, int param2, int param3, boolean param4, int param5, int param6) {
        ...
        try {
                      ...
                      L2: while (true) {
                        if (var11 >= param3) {
                          ...
                          L3: {
                            ...
                            if (!param4) {
                              stackOut_23_0 = kf.field_c[var12];
                              stackIn_24_0 = stackOut_23_0;
                              break L3;
                            } else {
                              stackOut_22_0 = rc.field_i[var12];
          ...
          throw ie.a((Throwable) (Object) var7, "ae.A(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
    }
