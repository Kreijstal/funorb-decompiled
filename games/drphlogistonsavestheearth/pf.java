...
final class pf {
    ...
    final static boolean a(int param0, boolean param1, CharSequence param2) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_36_1 = new StringBuilder().append("pf.F(").append(param0).append(44).append(param1).append(44);
          ...
          throw ie.a((Throwable) (Object) stackIn_39_0, stackIn_39_2 + 41);
        }
    ...
    final int a(byte[] param0, int param1, int param2, int param3) throws IOException {
        ...
        try {
          ...
          throw ie.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_4_0;
    }
    ...
    final void a(byte param0, int param1, int param2, byte[] param3) throws IOException {
        ...
        try {
            ...
            throw ie.a((Throwable) (Object) runtimeException, "pf.C(" + param0 + 44 + param1 + 44 + param2 + 44 + (param3 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    pf(File param0, String param1, long param2) throws IOException {
        ...
        try {
            ...
            throw ie.a((Throwable) (Object) runtimeException, "pf.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 41);
        }
    }
