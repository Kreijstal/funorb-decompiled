        ...
        try {
          L0: {
            if (fl.a(param0, param1, param2, (byte) -98)) {
              if (param4 == 65245) {
                stackOut_6_0 = af.a(119, param3.a(param2, param0, (byte) 35));
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("tc.A(").append(param0).append(',');
    ...
    final static u a(long param0, String param1, String param2, int param3, boolean param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("tc.E(").append(param0).append(',');
