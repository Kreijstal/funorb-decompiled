...
final class ag extends ic {
    ...
    final synchronized void i(int param0) {
        param0 = param0 << 8;
        int var2 = ((vk) ((Object) this.field_i)).field_i.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
        ...
        if (param0 != 0) {
          ...
          if (this.field_x == var4) {
            if (this.field_m == var5) {
              ...
              L1: {
                if (var4 - this.field_x <= var6) {
                  break L1;
                } else {
                  var6 = var4 - this.field_x;
                  break L1;
                }
              }
              L2: {
                if (this.field_x - var4 <= var6) {
                  break L2;
                } else {
                  var6 = this.field_x - var4;
                  break L2;
                }
              }
              L3: {
              ...
              this.field_l = param1;
              this.field_q = param2;
              this.field_w = (param1 - this.field_t) / param0;
              this.field_s = (var4 - this.field_x) / param0;
              this.field_z = (var5 - this.field_m) / param0;
              return;
            }
          } else {
            L6: {
    ...
    final static ag b(vk param0, int param1, int param2) {
        if (param0.field_i != null) {
          if (param0.field_i.length == 0) {
            ...
            return new ag(param0, (int)((long)param0.field_j * 256L * (long)param1 / (long)(100 * id.field_d)), param2 << 6);
          }
        } else {
          return null;
        }
    ...
    final synchronized int j() {
        return this.field_u < 0 ? -this.field_u : this.field_u;
    }

    final synchronized boolean m() {
        return this.field_o < 0 || this.field_o >= ((vk) ((Object) this.field_i)).field_i.length << 8;
    }
    ...
    final synchronized void l(int param0) {
        this.d(this.e(), param0 << 6);
    }

    final synchronized int f() {
        return this.field_o >> 8;
    }
    ...
    private final boolean l() {
        ...
        L0: {
          var1 = this.field_l;
          if (var1 != -2147483648) {
            var2 = ag.a(var1, this.field_q);
            var3 = ag.b(var1, this.field_q);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_t >= var1) {
            if (this.field_t <= var1) {
              ...
              this.field_w = -1;
              this.field_n = this.field_t - var1;
              break L2;
            }
          } else {
            this.field_w = 1;
            this.field_n = var1 - this.field_t;
            break L2;
          }
        }
        L3: {
          if (this.field_x >= var2) {
            if (this.field_x <= var2) {
              ...
              L4: {
                ...
                if (this.field_n == 0) {
                  ...
                  if (this.field_n <= this.field_x - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_n = this.field_x - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_n == 0) {
                ...
                if (this.field_n <= var2 - this.field_x) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_n = var2 - this.field_x;
            break L3;
          }
        }
        if (this.field_m < var3) {
          this.field_z = 1;
          if (this.field_n != 0) {
            if (this.field_n > var3 - this.field_m) {
              this.field_n = var3 - this.field_m;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_m <= var3) {
              ...
              L7: {
                ...
                if (this.field_n == 0) {
                  ...
                  if (this.field_n <= this.field_m - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_n = this.field_m - var3;
              break L6;
            }
          }
          return false;
    ...
    final synchronized void a(boolean param0) {
        this.field_u = (this.field_u ^ this.field_u >> 31) + (this.field_u >>> 31);
        if (param0) {
    ...
    final int d() {
        if (this.field_l == 0 && this.field_n == 0) {
            return 0;
        }
        return 1;
    }
    ...
    final synchronized int e() {
        return this.field_l == -2147483648 ? 0 : this.field_l;
    }
        ...
        L0: while (true) {
          if (this.field_n <= 0) {
            L1: {
              if (this.field_u != 256) {
                ...
                if ((this.field_o & 255) != 0) {
                  ...
                  if (id.field_f) {
                    return ag.a(0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_x, this.field_m, 0, param3, param2, (ag) (this));
                  } else {
                    return ag.b(((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_t, 0, param3, param2, (ag) (this));
                  }
                }
              }
            }
            if (id.field_f) {
              return ag.c(0, 0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_x, this.field_m, 0, param3, param2, (ag) (this), this.field_u, param4);
            } else {
              return ag.b(0, 0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_t, 0, param3, param2, (ag) (this), this.field_u, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_u != 256) {
                  ...
                  if ((this.field_o & 255) != 0) {
                    ...
                    if (!id.field_f) {
                      param1 = ag.a(((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_t, this.field_w, 0, var6, param2, (ag) (this));
                      break L3;
                    } else {
                      param1 = ag.b(0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_x, this.field_m, this.field_s, this.field_z, 0, var6, param2, (ag) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!id.field_f) {
                param1 = ag.d(0, 0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_t, this.field_w, 0, var6, param2, (ag) (this), this.field_u, param4);
                break L3;
              } else {
                param1 = ag.a(0, 0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_x, this.field_m, this.field_s, this.field_z, 0, var6, param2, (ag) (this), this.field_u, param4);
                break L3;
              }
            }
            this.field_n = this.field_n - param1;
    ...
    final int b() {
        ...
        if (this.field_r == 0) {
            var1 = var1 - var1 * this.field_o / (((vk) ((Object) this.field_i)).field_i.length << 8);
        } else {
            if (this.field_r >= 0) {
                var1 = var1 - var1 * this.field_v / ((vk) ((Object) this.field_i)).field_i.length;
            }
        }
          ...
          L4: {
            if (this.field_r <= 0) {
              ...
              if (!this.field_y) {
                if (this.field_u >= 0) {
                  L5: while (true) {
                    var9 = this.b(param0, var9, var6, param2, (int) var4.field_i[this.field_v]);
                    if (this.field_o >= var6) {
                      ...
                      if (var10 < this.field_r) {
                        ...
                        this.field_o = this.field_o - var8 * this.field_r;
                        this.field_r = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_i[this.field_p - 1]);
                ...
                L7: {
                  if (this.field_u >= 0) {
                    ...
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_i[this.field_v]);
                    if (this.field_o < var5) {
                ...
                L8: while (true) {
                  var9 = this.b(param0, var9, var6, param2, (int) var4.field_i[this.field_p - 1]);
                  if (this.field_o >= var6) {
        ...
        if (param0 != 0) {
          if (this.field_x == 0) {
            if (this.field_m == 0) {
              ...
              this.field_z = -this.field_m / param0;
              return;
            }
          } else {
            L6: {
    ...
    final synchronized void d(int param0) {
        ...
        this.field_o = this.field_o + this.field_u * param0;
        if (this.field_r >= 0) {
          L5: {
            if (this.field_r <= 0) {
              break L5;
                  ...
                  if (this.field_u >= 0) {
                    if (this.field_o >= var4) {
                      ...
                      if (var7 < this.field_r) {
                        ...
                        this.field_o = this.field_o - var6 * this.field_r;
                        this.field_r = 0;
                        break L5;
                      }
                    } else {
    ...
    private ag(vk param0, int param1, int param2) {
        this.field_i = (me) ((Object) param0);
        this.field_v = param0.field_k;
        this.field_p = param0.field_l;
        this.field_y = param0.field_m;
        this.field_u = param1;
        this.field_l = param2;
        this.field_q = 8192;
        this.field_o = 0;
    ...
    private final void k() {
        ...
        this.field_x = ag.a(this.field_l, this.field_q);
        this.field_m = ag.b(this.field_l, this.field_q);
    }
        ...
        L0: while (true) {
          if (this.field_n <= 0) {
            L1: {
              if (this.field_u != -256) {
                ...
                if ((this.field_o & 255) != 0) {
                  ...
                  if (id.field_f) {
                    return ag.b(0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_x, this.field_m, 0, param3, param2, (ag) (this));
                  } else {
                    return ag.a(((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_t, 0, param3, param2, (ag) (this));
                  }
                }
              }
            }
            if (id.field_f) {
              return ag.b(0, 0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_x, this.field_m, 0, param3, param2, (ag) (this), this.field_u, param4);
            } else {
              return ag.a(0, 0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_t, 0, param3, param2, (ag) (this), this.field_u, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_n;
            ...
            L3: {
              L4: {
                ...
                if (this.field_u != -256) {
                  ...
                  if ((this.field_o & 255) != 0) {
                    ...
                    if (!id.field_f) {
                      param1 = ag.b(((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_t, this.field_w, 0, var6, param2, (ag) (this));
                      break L3;
                    } else {
                      param1 = ag.a(0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_x, this.field_m, this.field_s, this.field_z, 0, var6, param2, (ag) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!id.field_f) {
                param1 = ag.a(0, 0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_t, this.field_w, 0, var6, param2, (ag) (this), this.field_u, param4);
                break L3;
              } else {
                param1 = ag.b(0, 0, ((vk) ((Object) this.field_i)).field_i, param0, this.field_o, param1, this.field_x, this.field_m, this.field_s, this.field_z, 0, var6, param2, (ag) (this), this.field_u, param4);
                break L3;
              }
            }
            this.field_n = this.field_n - param1;
