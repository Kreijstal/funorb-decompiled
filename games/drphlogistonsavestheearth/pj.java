...
class pj extends vg implements ba {
          ...
          L0: {
            L1: {
              if (param3 == -10612) {
                ...
                var6 = (vg) null;
                discarded$2 = this.a(0, 46, (byte) 23, 114, (vg) null, 80, 117);
                break L1;
              }
            }
            L2: {
    ...
    final static int a(String param0, int param1, a param2, a param3, int param4, int param5, boolean param6) {
        ...
        try {
          ...
          throw ie.a((Throwable) ((Object) stackIn_74_0), stackIn_74_2 + ',' + param4 + ',' + param5 + ',' + param6 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_6_0;
        } else {
          ...
          L0: {
            ...
            L2: while (true) {
              ...
              if (var6 != 80) {
                ...
                L5: {
                  if (!ck.field_f[81]) {
                    stackOut_14_0 = this.a(param2, (byte) 79);
                    stackIn_15_0 = stackOut_14_0;
                    break L5;
                  } else {
                    stackOut_13_0 = this.a(param2, 65535);
                    stackIn_15_0 = stackOut_13_0;
                    break L5;
                  }
                }
                  ...
                  if (var4 == null) {
                    ...
                    L2: {
                      if (!var4.a(true)) {
                        ...
                        var5 = new rh(this.field_I);
                        discarded$2 = var5.a((gi) (var4), (byte) -98);
    ...
    final boolean a(boolean param0) {
        ...
        if (!param0) {
            vg var3 = (vg) null;
            discarded$0 = this.a(-123, 'ﾼ', (vg) null, 80);
        }
    ...
    private final void a(Hashtable param0, boolean param1, StringBuilder param2, int param3) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (var6 == null) {
                ...
                L3: while (true) {
                  if (var7 > param3) {
                    discarded$13 = var6.a(param3 + 1, param0, param2, -10612);
          ...
          throw ie.a((Throwable) ((Object) stackIn_15_0), stackIn_15_2 + ',' + param3 + ')');
        }
    }
