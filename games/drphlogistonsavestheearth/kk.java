...
final class kk {
    ...
    final static java.net.URL a(java.net.URL param0, java.applet.Applet param1, int param2) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (ih.field_J == null) {
                ...
                if (ih.field_J.equals(param1.getParameter("settings"))) {
                  break L1;
                } else {
                  var3 = ih.field_J;
                  var4 = var3;
            ...
            L2: {
              ...
              if (ml.field_h == null) {
                ...
                if (!ml.field_h.equals(param1.getParameter("session"))) {
                  var4 = ml.field_h;
                  break L2;
                } else {
                  break L2;
            ...
            stackIn_10_0 = th.a((String) (var3), -1, param0, -1, (String) (var4));
            break L0;
          }
          ...
          L4: {
            ...
            stackIn_13_1 = new StringBuilder().append("kk.A(");
          ...
          throw ie.a((Throwable) ((Object) stackIn_14_0), stackIn_17_2 + ',' + param2 + ')');
        }
        return stackIn_10_0;
    }
    ...
    final static void a(int param0, vj param1, vj param2, vj param3) {
        ...
        try {
            ...
            eh.a("commonui", (byte) -45, param1, "dropdown");
            var5 = ij.a("screen_options", (byte) 113, param1, "commonui");
            al.field_d = new he[4];
            qb.field_b = new he[4];
            gd.field_b = new he[4];
            var6 = new he[][]{al.field_d, qb.field_b, gd.field_b};
            var20 = new int[4][];
            var17 = var20;
            var7 = var17;
            ...
            for (var9 = 0; -4 < (var9 ^ -1); var9++) {
                ...
                for (var11 = 0; var11 < var15.length; var11++) {
                    var15[var11] = a.a(var5[var9], var20[var11], (byte) -122);
                }
            }
            var9 = var18.field_w;
            aj.a(true);
            ...
            var19.c();
            var18.a(0, 0);
            var12 = new nh(var9, var9);
            var12.c();
            var18.a(-var18.field_y + var9, 0);
            var13 = new nh(var18.field_y + -(var9 * 2), var9);
            var13.c();
            var18.a(-var9, 0);
            cl.d((byte) -73);
            rk.field_d = new nh[]{var16, var13, var12};
        } catch (RuntimeException runtimeException) {
            throw ie.a((Throwable) ((Object) runtimeException), "kk.B(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + (param2 != null ? "{...}" : "null") + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
