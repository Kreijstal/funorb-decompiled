              ...
              if (param2.length() <= var7) {
                ...
                L3: {
                  ...
                  if (var8 != 60) {
                    ...
                    var6 = param4.field_a[0] + ((var5_int >> 8) - -param3.b(param2.substring(0, var7)));
                    break L3;
                  }
                }
                L4: {
                  if (var6 == -1) {
                    ...
                    param4.field_a[var7] = param4.field_a[0] + (var5_int >> 8) - (-param3.b(param2.substring(0, 1 + var7)) - -param3.a((char) var8));
                    break L4;
                  } else {
