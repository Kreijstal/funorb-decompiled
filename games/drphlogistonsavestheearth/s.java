...
final class s {
    ...
    public static void a(int param0) {
        try {
            ...
            throw ie.a((Throwable) ((Object) runtimeException), "s.A(" + param0 + ')');
        }
    }
    ...
    final static void b(byte param0) {
        ...
        try {
          ...
          throw ie.a((Throwable) ((Object) var1_ref), "s.B(" + param0 + ')');
        }
    }
            ...
            L1: {
              if (hb.field_g <= 0) {
                ...
                if (df.field_l == null) {
                  ...
                  var2_int = 2;
                  ej.a(df.field_l, (byte) 57);
                  break L1;
                }
              }
            }
            L2: {
              la.a(cb.field_b, cb.field_b.field_E, param0, 240, (byte) -38, ni.field_q.field_E, 18, ch.field_z, var2_int, ee.field_c, ni.field_q.field_E, 320, 2, 8, ni.field_q, 30);
              if (param1 < -117) {
                break L2;
              } else {
    ...
    final static void a(boolean param0, int[] param1, boolean param2, int[] param3, boolean param4, ja param5, int param6) {
        ...
        try {
              ...
              L2: {
                if ((param5.field_q ^ -1) >= (var23 ^ -1)) {
                  ...
                  if (param0) {
                    ...
                    var18 = 0;
                    L5: while (true) {
                      stackIn_61_0 = param5.field_H ^ -1;
                      stackIn_61_1 = var18 ^ -1;
                      if (stackIn_61_0 >= stackIn_61_1) {
                        break L2;
                      } else {
                        stackIn_64_0 = var18;
                        stackIn_64_1 = jd.field_L.length;
          ...
          L11: {
            ...
            stackIn_73_1 = new StringBuilder().append("s.C(").append(param0).append(',');
          ...
          L13: {
            ...
            stackIn_81_1 = ((StringBuilder) (Object) stackIn_78_1).append(stackIn_78_2).append(',').append(param4).append(',');
          ...
          throw ie.a((Throwable) ((Object) stackIn_74_0), stackIn_82_2 + ',' + param6 + ')');
        }
    }
    ...
    final static boolean a(byte param0) {
        ...
        try {
          ...
          throw ie.a((Throwable) ((Object) var1), "s.F(" + param0 + ')');
        }
    ...
    final static void c(byte param0) {
        ...
        try {
            ...
            throw ie.a((Throwable) ((Object) runtimeException), "s.E(" + param0 + ')');
        }
    }
