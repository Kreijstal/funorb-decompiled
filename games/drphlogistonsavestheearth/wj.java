...
final class wj {
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            L13: {
              if (param3 < 0) {
                wj.a(param0, param1 + param3 + 1, -param3, 255, param5);
                break L13;
              } else {
                wj.a(param0, param1, param3, 255, param5);
                break L13;
              }
            }
            return;
          ...
          L14: {
            if (param2 < 0) {
              wj.e(param0 + param2 + 1, param1, -param2, 255, param5);
              break L14;
            } else {
              wj.e(param0, param1, param2, 255, param5);
              break L14;
            }
          }
          return;
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var6 = 0; var6 < 4; var6++) {
            var5 = 128 - (var6 << 5);
            wj.e(param0 + var6, param1 + param3 + var6, param2, 5592405, var5);
            wj.a(param0 + param2 + var6, param1 + var6, param3 + 1, 5592405, var5);
        }
    }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        L4: while (true) {
          if (var10 >= 0) {
            ...
            var11 = 65536 - var6 >> 8;
            var12 = var6 >> 8;
            var13 = (128 * var11 + 0 * var12 & -16711936) + (61440 * var11 + 0 * var12 & 16711680) >>> 8;
            var14 = -param2;
            L5: while (true) {
              if (var14 >= 0) {
                var9 = var9 + var8;
