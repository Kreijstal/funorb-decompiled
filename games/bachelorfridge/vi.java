...
final class vi {
    ...
    final void a(eo param0, long param1, int param2) {
        ...
        try {
            ...
            this.field_g.a(param1, (byte) -97, param0);
            this.field_c.a(param0, (byte) -107);
          ...
          L0: {
            ...
            L1: while (true) {
              if (var1_int >= ia.field_j.length) {
                ...
                oi.field_v.a((long)ia.field_j[var1_int].toLowerCase().hashCode(), (byte) 102, new ji(var1_int));
                var1_int++;
                continue L1;
              }
            }
    ...
    final eo a(int param0, long param1) {
        ...
        eo var4 = (eo) ((Object) this.field_g.a(true, param1));
        if (!(var4 == null)) {
            this.field_c.a(var4, (byte) 115);
        }
        return var4;
    }
