...
final class efa extends td {
    ...
    final static void a(int param0, int param1, int param2, boolean param3, ht param4, int param5, java.awt.Component param6, jp param7) {
        ...
        try {
          L0: {
            ...
            nia.field_m = pb.a(param4, param6, 1, 1024);
            saa.field_a = new hn();
            ud.field_p = 1024000 / param0;
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("efa.C(").append(param0).append(44).append(param1).append(44).append(1024).append(44).append(1).append(44);
          ...
          L2: {
            ...
            stackOut_5_1 = ((StringBuilder) (Object) stackIn_5_1).append(stackIn_5_2).append(44).append(19299).append(44);
    ...
    final static int a(CharSequence param0, boolean param1) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var4 >= var2_int) {
                ...
                var3 = -var3 + (var3 << 5) + aca.a(param0.charAt(var4), 8220);
                var4++;
                continue L1;
              }
            }
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("efa.D(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    efa(int param0, aga param1, int param2, int param3) {
        ...
        try {
            ...
            throw pe.a((Throwable) (Object) runtimeException, "efa.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 41);
        }
    }
    ...
    final ii a(op param0, int param1) {
        ...
        try {
          L0: {
            var3 = ((efa) this).field_h.a(107, param0);
            var4 = new u(((efa) this).field_g, new nq(var3));
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("efa.A(");
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
            stackIn_6_0 = stackOut_5_0;
            stackIn_6_1 = stackOut_5_1;
