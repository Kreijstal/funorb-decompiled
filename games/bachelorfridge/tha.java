    ...
    final static void a(lda param0, po param1, int param2, lda param3, int param4, int param5, int param6, int param7, boolean param8, int param9, int param10, po param11, lda param12, int param13, int param14, int param15, int param16, int param17, int param18, int param19, int param20) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_11_1 = ((StringBuilder) (Object) stackIn_11_1).append(stackIn_11_2).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',').append(true).append(',').append(param9).append(',').append(param10).append(',');
          ...
          throw pe.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + ',' + param13 + ',' + param14 + ',' + param15 + ',' + param16 + ',' + param17 + ',' + param18 + ',' + param19 + ',' + param20 + ')');
        }
    }
    ...
    final static String a(int param0, String param1, String param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_13_1 = new StringBuilder().append("tha.C(").append(2).append(',');
