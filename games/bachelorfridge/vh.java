...
final class vh extends ana {
    ...
    final static void a(byte[] param0, int[] param1, byte[] param2, ee[] param3, int param4, int[] param5, boolean param6, vr param7, kv[][] param8, String[][] param9, int param10, String[] param11, int param12, vr param13, String[] param14, kv[][] param15, vr param16, String[][] param17, int param18) {
        ...
        try {
          ...
          throw pe.a((Throwable) ((Object) stackIn_46_0), stackIn_46_2 + ',' + param18 + ')');
        }
    ...
    private final void e(int param0) {
        ...
        var7 = this.field_v.field_l.a(77, this.field_q.field_h);
        if (!var7.i(111)) {
          var3 = (iv) ((Object) this.field_v.field_o.b((byte) 90));
          discarded$1 = al.a(param0 + 88, this.field_v.field_k);
          if (param0 == 0) {
            var8 = this.field_v.field_l.a(-27449, this.field_q);
            this.field_q.field_fb.a(new vt(this.field_q, var8), true);
            L0: while (true) {
              if (var3 == null) {
                return;
              } else {
                var3.a(var7, this.field_q.field_h, 12);
                var9 = var3.field_h.a(-27449, this.field_q);
                var9.b(param0 ^ -1, 6);
                var9.a(24831, 17, kna.field_g[40]);
                var3 = (iv) ((Object) this.field_v.field_o.c(param0 ^ 0));
                continue L0;
              }
            }
          } else {
            ...
            var10 = this.field_v.field_l.a(-27449, this.field_q);
            this.field_q.field_fb.a(new vt(this.field_q, var10), true);
            L1: while (true) {
              if (var3 == null) {
                return;
              } else {
                var3.a(var7, this.field_q.field_h, 12);
                var11 = var3.field_h.a(-27449, this.field_q);
                var11.b(param0 ^ -1, 6);
    ...
    final static void a(int param0, String[] param1, int param2, int param3, int param4, java.applet.Applet param5) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_17_1 = new StringBuilder().append("vh.D(").append(param0).append(',');
            stackIn_19_0 = stackOut_17_0;
            stackIn_19_1 = stackOut_17_1;
