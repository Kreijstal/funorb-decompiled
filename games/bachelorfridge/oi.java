...
final class oi extends ana {
    ...
    private final void e(int param0) {
        ...
        var2 = 0;
        L0: while (true) {
          if (this.field_q.field_h.field_z <= var2) {
            L1: {
              if (param0 == 48) {
                break L1;
              } else {
            ...
            var3 = 0;
            L2: while (true) {
              if (var3 >= this.field_q.field_h.field_B) {
                var2++;
                continue L0;
              } else {
                var4 = this.field_q.field_h.field_a[var2][var3];
                if (var4.c(-123)) {
                  this.field_q.b(param0 + 30948, var2, var3);
                  var3++;
                  continue L2;
                } else {
                  var3++;
