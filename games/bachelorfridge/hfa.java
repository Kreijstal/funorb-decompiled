    ...
    final boolean a(int param0, int param1, int param2, int param3, int param4, wj param5, int param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("hfa.S(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
    ...
    boolean b(int param0, int param1, int param2, int param3, int param4, wj param5, int param6) {
        ...
        try {
          ...
          L3: {
            var8 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) var8;
            stackOut_8_1 = new StringBuilder().append("hfa.L(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    final boolean a(int param0, int param1, char param2, wj param3) {
        ...
        try {
          L0: {
            ...
            if (var5_int != 80) {
              if (param0 == 10) {
                ...
                var6 = null;
                boolean discarded$2 = ((hfa) this).b(-49, 33, 67, -11, -47, (wj) null, 62);
                return false;
              }
            } else {
              L2: {
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("hfa.I(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final void b(int param0, Hashtable param1, StringBuilder param2, int param3) {
        ...
        try {
            ...
            if (param3 >= 107) {
              ...
              L1: while (true) {
                if (var5_int > param0) {
                  L2: {
                    if (((hfa) this).field_A == null) {
                      StringBuilder discarded$19 = param2.append("null");
                      break L2;
                    } else {
                      StringBuilder discarded$20 = ((hfa) this).field_A.a(param1, 1 + param0, (byte) 74, param2);
                      break L2;
                    }
                  }
                  break L0;
                } else {
                  StringBuilder discarded$21 = param2.append(32);
                  var5_int++;
                  continue L1;
                }
              }
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("hfa.D(").append(param0).append(44);
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
    ...
    void a(int param0, int param1, byte param2, wj param3, int param4, int param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("hfa.H(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
          ...
          throw pe.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + param4 + 44 + param5 + 41);
        }
    }
    ...
    void a(int param0, int param1, wj param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("hfa.O(").append(param0).append(44).append(param1).append(44);
    ...
    private final boolean a(int param0, wj param1) {
        ...
        try {
              ...
              L2: {
                if (((hfa) this).field_A == null) {
                  ...
                  if (((hfa) this).field_A.e(1023)) {
                    ...
                    if (!((hfa) this).field_A.a(param1, -97)) {
                      break L2;
                    } else {
                      stackOut_3_0 = 1;
                      stackIn_5_0 = stackOut_3_0;
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("hfa.T(").append(0).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
    ...
    private final boolean b(int param0, wj param1) {
        ...
        try {
          ...
          L3: {
            var3 = decompiledCaughtException;
            stackOut_6_0 = (RuntimeException) var3;
            stackOut_6_1 = new StringBuilder().append("hfa.R(").append(-14391).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
