...
final class bo {
    ...
    final int a() {
        ...
        while (this.field_a[var1] >= 0) {
            var1 = dv.a() != 0 ? this.field_a[var1] : var1 + 1;
        }
    ...
    bo() {
        ...
        L0: {
          discarded$2 = dv.a(24);
          this.field_f = dv.a(16);
          this.field_b = dv.a(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_b) {
                ...
                var4_int = dv.a(mda.a(this.field_b - var2, 16));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_b * this.field_f;
                break L9;
              } else {
                var7 = bo.a(this.field_b, this.field_f);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_d = new float[this.field_b][this.field_f];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
