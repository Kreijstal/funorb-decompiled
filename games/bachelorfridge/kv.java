...
class kv extends go {
          ...
          if (param2 > this.field_n) {
            ...
            if (param3 <= this.field_o) {
              ...
              if (var5 >= var6) {
                ...
                if (var7 < var8) {
                  var9 = var7 * dg.field_i + var5;
                  var10 = dg.field_i - (var6 - var5);
                  var11 = var7;
                  L5: while (true) {
                    if (var11 >= var8) {
                      return;
          ...
          if (var9 > var8) {
            ...
            L5: while (true) {
              if (var12 > var6) {
                ...
                L6: while (true) {
                  if (var16 >= 4) {
                    dg.field_e[var11] = (var14 & 267390960 | var15 & 1044480) >> 4;
                    var12 += 4;
                    var10 += 4;
                    var11++;
                    continue L5;
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                L2: {
                  var11 = dg.field_e[param2] & 16711935;
                  var12 = dg.field_e[param2] & 65280;
                  var13 = 0;
                  var14 = 0;
                ...
                param2++;
                dg.field_e[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
    ...
    final void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            if (param2 == this.field_q && param3 == this.field_p) {
    ...
    final boolean a(int param0, int param1, int param2, int param3) {
        ...
        if (param2 < 0 || param2 >= this.field_q) {
            return false;
        }
        param3 = param3 - (param1 + this.field_u);
        if (param3 < 0 || param3 >= this.field_p) {
            return false;
        }
        return this.field_v[param3 * this.field_q + param2] != 0 ? true : false;
    }

    final void g() {
        int var2 = 0;
        int var3 = 0;
        if (this.field_q == this.field_n && this.field_p == this.field_o) {
            return;
        }
    ...
    kv(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_q, this.field_p, this.field_v, 0, this.field_q);
            var5.grabPixels();
            break L0;
          }
