              ...
              L2: {
                ...
                if (null == ((kb) this).field_b) {
                  ...
                  if (null == ((kb) this).field_f) {
                    ...
                    var7_ref_java_math_BigInteger = var12.modPow(((kb) this).field_b, ((kb) this).field_f);
    ...
    final fp a(boolean param0, int param1, ta param2, ta param3, int param4) {
        ...
        try {
                ...
                if (param1 < 0) {
                  ...
                  if (param1 < ((kb) this).field_a.length) {
                    if (null != ((kb) this).field_a[param1]) {
                      stackOut_8_0 = ((kb) this).field_a[param1];
                      stackIn_9_0 = stackOut_8_0;
                      return stackIn_9_0;
                    } else {
                      ((kb) this).field_c.field_g = param1 * 72 - -6;
                      var6_int = ((kb) this).field_c.f(81);
                      var7 = ((kb) this).field_c.f(-121);
                      var13 = new byte[param4];
                      ((kb) this).field_c.a(var13, 64, 128, 0);
                      var9 = new fp(param1, param2, param3, ((kb) this).field_i, ((kb) this).field_k, var6_int, var13, var7, param0);
          ...
          L2: {
            ...
            stackOut_12_1 = new StringBuilder().append("kb.A(").append(param0).append(44).append(param1).append(44);
