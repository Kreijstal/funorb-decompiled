        ...
        try {
          L0: {
            L1: {
              ...
              param1.d(0, 0);
              var3_ref = (ho) ((Object) this.field_h.b((byte) 90));
              if (param0 < -21) {
                break L1;
              } else {
                var7 = (oha) null;
            ...
            L2: while (true) {
              if (var3_ref == null) {
                ...
                var3_ref = (ho) ((Object) this.field_h.c(0));
                continue L2;
              }
            }
          }
        ...
        try {
          L0: {
            if (-2 == (param0.field_a ^ -1)) {
              ...
              var4 = stackIn_8_0;
              stackOut_8_0 = it.field_c[this.field_k[var4]] / 100.0;
              stackIn_9_0 = stackOut_8_0;
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
    ...
    final static pp a(int param0, lu param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = new rla(var2, var3);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("rk.CB(").append(param0).append(',');
          ...
          L0: {
            ...
            L1: while (true) {
              if (var2_ref == null) {
                ...
                this.field_h.a(var2_ref.c((byte) 68), true);
                this.field_g[var2_ref.field_i * 3 - 2] = true;
