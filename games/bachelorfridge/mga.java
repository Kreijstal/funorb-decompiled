...
final class mga {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_h[var16]) {
                  var9 = field_c[var16];
                  var10 = field_l[var16] * this.field_k;
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_g, 0, field_c, 0, var2);
        int var3 = field_e[this.field_k - 1];
        ...
        for (var6 = 0; var6 < this.field_f.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = dv.field_K[this.field_a[var7]].a();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_i[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_g[incrementValue$0] = dv.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_i[this.field_f[var6]];
                      var6++;
                      continue L2;
                    }
                  }
