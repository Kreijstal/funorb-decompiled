...
final class mga {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((mga) this).field_g.length;
        var4 = field_e[((mga) this).field_k - 1];
        var5 = field_h;
        field_h[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_l[0] * ((mga) this).field_k;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_h[var16]) {
                  var9 = field_c[var16];
                  var10 = field_l[var16] * ((mga) this).field_k;
            ...
            L3: {
              var7 = mga.b(field_c, var6);
              var8_int = mga.a(field_c, var6);
    ...
    final boolean a() {
        ...
        int var2 = ((mga) this).field_g.length;
        System.arraycopy((Object) (Object) ((mga) this).field_g, 0, (Object) (Object) field_c, 0, var2);
        int var3 = field_e[((mga) this).field_k - 1];
        int var4 = mda.a(var3 - 1, 16);
        field_l[0] = dv.a(var4);
        field_l[1] = dv.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((mga) this).field_f.length; var6++) {
            var7 = ((mga) this).field_f[var6];
            var8 = ((mga) this).field_i[var7];
            var9 = ((mga) this).field_b[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = dv.field_K[((mga) this).field_a[var7]].a();
            }
    ...
    mga() {
        ...
        if (var1 == 1) {
          var2 = dv.a(5);
          var3 = 0;
          ((mga) this).field_f = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((mga) this).field_i = new int[var3];
              ((mga) this).field_b = new int[var3];
              ((mga) this).field_a = new int[var3];
              ((mga) this).field_j = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((mga) this).field_k = dv.a(2) + 1;
                  var4 = dv.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((mga) this).field_g = new int[var5];
                      ((mga) this).field_g[0] = 0;
                      ((mga) this).field_g[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((mga) this).field_i[((mga) this).field_f[var6]];
                      var6++;
                      continue L2;
                    }
                  }
