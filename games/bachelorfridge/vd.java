    ...
    private final void a(int param0, Hashtable param1, StringBuilder param2, byte param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var6 == null) {
                ...
                L3: while (true) {
                  if (param0 < var7) {
                    discarded$7 = var6.a(param1, 1 + param0, (byte) 113, param2);
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("vd.CB(").append(param0).append(',');
    ...
    final static boolean a(byte param0, vr param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("vd.BB(").append(param0).append(',');
    ...
    wj g(int param0) {
        ...
        L0: {
          ...
          if (param0 < -26) {
            ...
            var5 = (vr) null;
            discarded$2 = vd.a((byte) 113, (vr) null);
            break L0;
          }
        }
    ...
    final boolean a(int param0, wj param1) {
        ...
        try {
            ...
            if (this.field_A.e(12917)) {
              ...
              L1: {
                ...
                if (param0 < -121) {
                  ...
                  var8 = (wj) null;
                  discarded$4 = this.b(-33, -39, 54, -107, -45, (wj) null, -22);
                  break L1;
                }
              }
                ...
                if (var4 == null) {
                  ...
                  L3: {
                    if (!var4.e(1023)) {
                      ...
                      var5 = new rna(this.field_A);
                      discarded$5 = var5.a(var4, (byte) -86);
          ...
          L5: {
            ...
            stackOut_20_1 = new StringBuilder().append("vd.WA(").append(param0).append(',');
    ...
    final boolean b(int param0, int param1, int param2, int param3, int param4, wj param5, int param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("vd.L(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',');
            stackIn_14_0 = stackOut_12_0;
            stackIn_14_1 = stackOut_12_1;
            stackIn_13_0 = stackOut_12_0;
            stackIn_13_1 = stackOut_12_1;
    ...
    boolean a(int param0, int param1, char param2, wj param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              ...
              if (var6 == 80) {
                L5: {
                  if (wga.field_q[81]) {
                    stackOut_15_0 = this.a(-128, param3);
                    stackIn_16_0 = stackOut_15_0;
                    break L5;
                  } else {
                    stackOut_14_0 = this.b(param3, 1);
                    stackIn_16_0 = stackOut_14_0;
                    break L5;
                  }
                }
          ...
          L6: {
            ...
            stackOut_17_1 = new StringBuilder().append("vd.I(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    void a(int param0, int param1, wj param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("vd.O(").append(param0).append(',').append(param1).append(',');
    ...
    final boolean a(int param0, int param1, int param2, int param3, int param4, wj param5, int param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("vd.S(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',');
            stackIn_15_0 = stackOut_13_0;
            stackIn_15_1 = stackOut_13_1;
            stackIn_14_0 = stackOut_13_0;
            stackIn_14_1 = stackOut_13_1;
                  ...
                  if (var4 == null) {
                    ...
                    L2: {
                      if (!var4.e(1023)) {
                        ...
                        var5 = new rna(this.field_A);
                        discarded$2 = var5.a(param1 + 5999, var4);
                        var6 = (wj) ((Object) var5.a((byte) 0));
                        L3: while (true) {
                          if (var6 == null) {
                            break L2;
    ...
    final void a(int param0, int param1, byte param2, wj param3, int param4, int param5) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("vd.H(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
