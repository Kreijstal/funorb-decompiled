...
final class dv extends bw {
    ...
    private static hg[] field_x;

    final static int a() {
        int var0 = field_F[field_o] >> field_w & 1;
        field_w = field_w + 1;
        field_o = field_o + (field_w >> 3);
        field_w = field_w & 7;
        return var0;
    }
    ...
    final be b() {
        ...
        int var7 = 0;
        ((dv) this).field_t = 0;
        ((dv) this).field_m = new float[field_f];
        var1 = new byte[((dv) this).field_u];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((dv) this).field_J.length) {
            ((dv) this).field_m = null;
            return new be(((dv) this).field_h, var1, ((dv) this).field_g, ((dv) this).field_k, ((dv) this).field_H);
          } else {
            var4 = this.b(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((dv) this).field_u - var2) {
                  break L1;
                } else {
                  var5 = ((dv) this).field_u - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    final be a(int[] param0) {
        ...
        L1: {
          if (((dv) this).field_C != null) {
            break L1;
          } else {
            ((dv) this).field_t = 0;
            ((dv) this).field_m = new float[field_f];
            ((dv) this).field_C = new byte[((dv) this).field_u];
            ((dv) this).field_M = 0;
            ((dv) this).field_A = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((dv) this).field_A >= ((dv) this).field_J.length) {
            ((dv) this).field_m = null;
            var14 = ((dv) this).field_C;
            ((dv) this).field_C = null;
            return new be(((dv) this).field_h, var14, ((dv) this).field_g, ((dv) this).field_k, ((dv) this).field_H);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((dv) this).field_M;
                  var4 = var13.length;
                  if (var4 <= ((dv) this).field_u - var3) {
                    break L5;
                  } else {
                    var4 = ((dv) this).field_u - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((dv) this).field_M);
                        break L7;
                      }
                    }
                    ((dv) this).field_M = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((dv) this).field_A = ((dv) this).field_A + 1;
            continue L2;
          }
        }
    }
    ...
    final static void b(byte[] param0) {
        ...
        L0: while (true) {
          if (var1 >= 2) {
                  ...
                  if (var3 >= var2) {
                    ...
                    L3: while (true) {
                      if (var3 >= var2) {
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = dv.a(16);
                                    int discarded$4 = dv.a(16);
                                    field_v[var6] = dv.a(8);
                                    var6++;
                                    continue L6;
                                  }
                        ...
                        field_z[var3] = new mga();
                        var3++;
                        continue L3;
                      }
                    }
                  } else {
                    int discarded$5 = dv.a(16);
                    var3++;
                    continue L2;
                  }
                }
            ...
            L8: {
              if (var1 == 0) {
                stackOut_4_0 = field_s;
                stackIn_5_0 = stackOut_4_0;
                break L8;
              } else {
                stackOut_3_0 = field_f;
                ...
                L10: while (true) {
                  if (var8_int >= var4) {
                    ...
                    L11: while (true) {
                      if (var9_int >= var5) {
                        var9 = new int[var5];
                        var10 = mda.a(var5 - 1, 16);
                        var11 = 0;
                        L12: while (true) {
                          if (var11 >= var5) {
                            if (var1 == 0) {
                              field_n = var6_ref_float__;
                              field_y = var7;
                              field_j = var8;
                              field_G = var9;
                              var1++;
                            ...
                            var9[var11] = gna.b(255, var10, var11);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    private final float[] b(int param0) {
        ...
        L0: {
          dv.a(((dv) this).field_J[param0], 0);
          int discarded$1 = dv.a();
          var2 = dv.a(mda.a(field_v.length - 1, 16));
          var3 = field_D[var2] ? 1 : 0;
          if (var3 == 0) {
            stackOut_2_0 = field_s;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          } else {
            stackOut_1_0 = field_f;
          ...
          L5: {
            ...
            if (var3 == 0) {
              ...
              if (var5 != 0) {
                ...
                var8 = (var4 >> 2) - (field_s >> 2);
                var9 = (var4 >> 2) + (field_s >> 2);
                var10 = field_s >> 1;
                break L4;
              }
            }
          ...
          L7: {
            if (var3 == 0) {
              ...
              if (var6 != 0) {
                ...
                var11 = var4 - (var4 >> 2) - (field_s >> 2);
                var12 = var4 - (var4 >> 2) + (field_s >> 2);
                var13 = field_s >> 1;
                break L6;
              }
            }
        ...
        L8: {
          var14 = field_x[field_v[var2]];
          var16 = var14.field_a;
          var17_int = var14.field_d[var16];
          if (field_z[var17_int].a()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_c) {
            L10: {
              if (var15 != 0) {
                ...
                field_z[var18_int].a(field_q, var4 >> 1);
                break L10;
              }
            }
            L11: {
            ...
            L35: {
              var17 = null;
              if (((dv) this).field_t <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((dv) this).field_t + var4 >> 2;
                  ...
                  if (((dv) this).field_p) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((dv) this).field_I) {
                        break L36;
                      } else {
                        var20 = (((dv) this).field_t >> 1) + var19;
                        var40[var19] = var40[var19] + ((dv) this).field_m[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((dv) this).field_m;
              ((dv) this).field_m = field_q;
              field_q = var18;
              ((dv) this).field_t = var4;
              ((dv) this).field_I = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    final static int a(int param0) {
        ...
        while (param0 >= 8 - field_w) {
            var3 = 8 - field_w;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_F[field_o] >> field_w & var4) << var2);
            field_w = 0;
            field_o = field_o + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_F[field_o] >> field_w & var3) << var2);
            field_w = field_w + param0;
        }
        return var1;
    }
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        lu var2 = new lu(param0);
        ((dv) this).field_h = var2.f(78);
        ((dv) this).field_u = var2.f(-73);
        ...
        ((dv) this).field_J = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            var5 = 0;
            do {
                var6_int = var2.b(16711935);
                var5 = var5 + var6_int;
            } while (var6_int >= 255);
            var6 = new byte[var5];
            var2.a(var6, var5, 128, 0);
            ((dv) this).field_J[var4] = var6;
        }
    }
    ...
    final static dv a(vr param0, int param1, int param2) {
        try {
            ...
            byte[] var3 = param0.b(93, param1, param2);
            if (var3 == null) {
                return null;
            }
            dv var4 = null;
    ...
    private final static boolean a(vr param0) {
        byte[] var1 = null;
        if (!field_E) {
            var1 = param0.b(120, 0, 0);
            if (var1 == null) {
                return false;
            }
            dv.b(var1);
    ...
    private dv(byte[] param0) throws IOException {
        this.a(param0);
    }
