    ...
    private final java.net.Socket a(String param0, int param1, String param2, int param3) throws IOException {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_25_1 = new StringBuilder().append("dm.H(");
    ...
    final java.net.Socket a(byte param0) throws IOException {
        ...
        try {
          L2: {
            ...
            L4: {
              var3 = ((java.net.ProxySelector) (Object) stackIn_10_0).select(new java.net.URI(stackIn_10_4 + "://" + ((dm) this).field_a));
            ...
            var4 = ((java.net.ProxySelector) (Object) stackIn_13_0).select(new java.net.URI(stackIn_13_4 + "://" + ((dm) this).field_a));
            break L2;
          }
              ...
              if ((Object) var3_ref instanceof java.net.InetSocketAddress) {
                ...
                if (param1.type() != java.net.Proxy.Type.HTTP) {
                  if (param1.type() == java.net.Proxy.Type.SOCKS) {
                    ...
                    ((java.net.Socket) var6).connect((java.net.SocketAddress) (Object) new java.net.InetSocketAddress(((dm) this).field_a, ((dm) this).field_b));
                    stackOut_19_0 = var6;
                  ...
                  stackOut_15_0 = this.a(var5_ref.getHostName(), 23772, (String) var6, var5_ref.getPort());
