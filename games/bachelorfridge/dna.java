          ...
          if (var2 >= this.field_xb.length) {
            ...
            if (var2 != this.field_yb) {
              if (0 != this.field_xb[var2].field_R) {
                ...
                this.field_wb[this.field_yb].field_kb = this.field_wb[this.field_yb].field_kb + 10000;
                this.field_yb = var2;
                this.field_xb[var2].field_t = true;
                this.field_wb[var2].field_kb = this.field_wb[var2].field_kb - 10000;
                var2++;
                continue L0;
              } else {
                var2++;
    ...
    dna(long param0, sna param1, String[] param2, sna param3, sna[] param4, int param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("dna.<init>(").append(param0).append(',');
          ...
          throw pe.a((Throwable) ((Object) stackIn_21_0), stackIn_21_2 + ',' + param5 + ')');
        }
    }
              ...
              L1: while (true) {
                if (this.field_wb.length <= var8) {
                  ...
                  if (this.field_yb != var8) {
                    this.field_wb[var8].field_kb = this.field_wb[var8].field_kb + 10000;
                    var8++;
                    continue L1;
                  } else {
                    var8++;
