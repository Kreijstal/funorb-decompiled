...
final class hda extends k {
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              if (var4_int != 0) {
                if (-2 == (var4_int ^ -1)) {
                  this.field_n = param1.e((byte) 119);
                  break L2;
                } else {
                  if (var4_int == 2) {
                    this.field_m = param1.b(16711935);
                    break L2;
                  } else {
                    break L2;
                  }
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("hda.E(").append(param0).append(',');
            ...
            if (0 == this.field_m) {
                ...
                L2: {
                  if (var6 >= this.field_k) {
                    ...
                    if (var4 >= this.field_q[var6]) {
                      if (this.field_q[1 + var6] > var4) {
                        if (this.field_p[var6] <= var4) {
                          break L2;
                        } else {
                          var5 = 4096;
                          break L2;
              ...
              L3: while (true) {
                if (var5 >= hh.field_d) {
                  ...
                  L5: while (true) {
                    L6: {
                      if (var11 >= this.field_k) {
                        break L6;
                      } else {
                        if (this.field_q[var11] <= var6) {
                          if (var6 < this.field_q[1 + var11]) {
                            if (this.field_p[var11] > var6) {
                              var7 = 4096;
                              break L6;
                            } else {
                              break L6;
    ...
    private final void d(int param0) {
        ...
        this.field_q = new int[this.field_k + 1];
        int var2 = 0;
        this.field_p = new int[this.field_k - -1];
        int var3 = 4096 / this.field_k;
        if (param0 != 2048) {
            return;
        }
        int var4 = var3 * this.field_n >> 517509420;
        for (var5 = 0; var5 < this.field_k; var5++) {
            this.field_q[var5] = var2;
            this.field_p[var5] = var4 + var2;
            var2 = var2 + var3;
        }
        this.field_q[this.field_k] = 4096;
        this.field_p[this.field_k] = this.field_p[0] + 4096;
    }
    ...
    final static void a(int param0, kia param1, boolean param2, int param3) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_18_1 = new StringBuilder().append("hda.F(").append(param0).append(',');
