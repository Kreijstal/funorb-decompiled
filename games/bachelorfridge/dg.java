...
final class dg {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        dg.e(param0, param1, param2, param4);
        dg.e(param0, param1 + param3 - 1, param2, param4);
        dg.f(param0, param1, param3, param4);
        dg.f(param0 + param2 - 1, param1, param3, param4);
    }
              ...
              if (var18 >= param8) {
                ...
                L7: {
                  ...
                  if (var13 >= var18) {
                    ...
                    var19 = var19 + (var18 - var13) * field_i;
                    break L7;
                  }
                }
                L8: while (true) {
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        L1: {
          if (param1 >= field_j) {
            ...
            var6 = var6 + (field_j - param1) * var7;
            param3 = param3 - (field_j - param1);
            param1 = field_j;
            break L1;
          }
        }
          ...
          if (var10 >= 0) {
            ...
            L5: while (true) {
              if (var14 >= 0) {
                ...
                var9++;
                field_e[incrementValue$0] = var13;
                var14++;
                continue L5;
              }
            }
    ...
    final static void a(int param0, int param1, int param2) {
        if (param0 >= field_f) {
            if (param1 < field_j || param0 >= field_h || param1 >= field_k) {
                return;
            }
            field_e[param0 + param1 * field_i] = param2;
            return;
        }
    }

    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        dg.a(field_e, 0, param2 + param3 * field_i, param0, param2, param4, field_i - param4, param5);
        dg.a(field_e, 0, param2 + param3 * field_i, param1, param3, param5, field_i - param4, param2, param4);
    }

    final static void c(int param0, int param1, int param2, int param3, int param4, int param5) {
        int var6 = 0;
        for (var6 = 0; var6 < param4; var6++) {
            dg.a(param0 + var6, param1 + var6, param2 - (var6 << 1), param3 - (var6 << 1), param5);
        }
    }
    ...
    private final static void g(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param1 >= field_j) {
            ...
            for (var13 = 0; var13 < param2; var13++) {
                ...
                var10 = (field_e[var12] >> 8 & 255) * var5;
                var11 = (field_e[var12] & 255) * var5;
                var14 = (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8) + (var8 + var11 >> 8);
                incrementValue$0 = var12;
                var12++;
                field_e[incrementValue$0] = var14;
            }
            return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int[] param4) {
        ...
        int var22 = var6 + var8 * field_i;
        int var23 = field_i + var6 - var7;
        dg.a(0, 0, 0, 0, 0, var15, var5, var22, field_e, param3, param4, var23, var13, var6 - var7, var16 + var10, var19, var21, var8 - var9);
    }
    ...
    final static void g(int param0, int param1, int param2, int param3) {
        ...
        int var4 = field_i - param2;
        int var5 = param0 + param1 * field_i;
        dg.a(var5, field_e, 0, param2, -param3, var4);
    }
    ...
    final static void i(int param0, int param1, int param2, int param3) {
        ...
        int var4 = param0 + param1 * field_i;
        if (param2 > 0) {
            if (param3 <= 0) {
                return;
            }
            for (var5 = 0; var5 < param3; var5++) {
                for (var6 = 0; var6 < param2; var6++) {
                    ...
                    var4++;
                    field_e[incrementValue$0] = (var11 << 16) + (var11 << 8) + var11;
                }
          ...
          if (param4 != 0) {
            ...
            L4: while (true) {
              if (var13 >= var9) {
                ...
                L7: {
                  var21 = var19 + var13 * field_i;
                  var22 = field_i + var19 - var20;
                  ...
                  if (var13 >= var23) {
                        ...
                        L10: while (true) {
                          ...
                          L14: while (true) {
                            if (var22 > var20) {
                              ...
                              var21++;
                              field_e[incrementValue$2] = param5 + var23;
                              var22++;
                              continue L14;
                            }
                          }
                    ...
                    L15: while (true) {
                      if (var24 >= var20) {
                        ...
                        var21++;
                        field_e[incrementValue$3] = param5 + var25;
                        var24++;
                        continue L15;
                      }
                    }
                      ...
                      if (var17 > var14) {
                        ...
                        L20: while (true) {
                          if (var22 >= var20) {
                            ...
                            var21++;
                            field_e[incrementValue$5] = param5 + var23;
                            var22++;
                            continue L20;
                          }
                        }
            ...
            dg.f(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          dg.e(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var6 = 0; var6 < 4; var6++) {
            var5 = 128 - (var6 << 5);
            dg.g(param0 + var6, param1 + param3 + var6, param2, param4, var5);
            dg.b(param0 + param2 + var6, param1 + var6, param3 + 1, param4, var5);
        }
    }
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            if (param2 <= param3) {
              L1: {
                ...
                if (param1 >= field_j) {
                  ...
                  param0 = param0 + var5 * (field_j - param1);
                  param1 = field_j;
                  break L1;
                }
              }
                  ...
                  L4: {
                    ...
                    if (var6 < field_f) {
                      ...
                      if (var6 >= field_h) {
                        ...
                        field_e[var6 + param1 * field_i] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_j) {
                      ...
                      if (var6 >= field_k) {
                        ...
                        field_e[param0 + var6 * field_i] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                dg.f(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                dg.f(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              dg.e(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              dg.e(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param4 != 0) {
          if (param4 != 256) {
                    ...
                    L6: while (true) {
                      ...
                      L10: while (true) {
                        if (var23 > var21) {
                          ...
                          var9 = (field_e[var25] >> 16 & 255) * var5;
                          var10 = (field_e[var25] >> 8 & 255) * var5;
                          var11 = (field_e[var25] & 255) * var5;
                          var24 = (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8) + (var8 + var11 >> 8);
                          incrementValue$2 = var25;
                          var25++;
                          field_e[incrementValue$2] = var24;
                          var23++;
                          continue L10;
                        }
                      }
                      ...
                      if (var18 > var15) {
                        ...
                        L15: while (true) {
                          if (var23 >= var21) {
                            ...
                            var9 = (field_e[var22] >> 16 & 255) * var5;
                            var10 = (field_e[var22] >> 8 & 255) * var5;
                            var11 = (field_e[var22] & 255) * var5;
                            var24 = (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8) + (var8 + var11 >> 8);
                            incrementValue$4 = var22;
                            var22++;
                            field_e[incrementValue$4] = var24;
                            var23++;
                            continue L15;
                          }
                        }
            ...
            dg.b(param0, param1, param2, param3);
            return;
          }
        } else {
          return;
    ...
    final static void d() {
        ...
        while (var0 < var1) {
            ...
            var0++;
            field_e[incrementValue$0] = 0;
            incrementValue$1 = var0;
            var0++;
            field_e[incrementValue$1] = 0;
            incrementValue$2 = var0;
            var0++;
            field_e[incrementValue$2] = 0;
            incrementValue$3 = var0;
            var0++;
            field_e[incrementValue$3] = 0;
            incrementValue$4 = var0;
            var0++;
            field_e[incrementValue$4] = 0;
            incrementValue$5 = var0;
            var0++;
            field_e[incrementValue$5] = 0;
            incrementValue$6 = var0;
            var0++;
            field_e[incrementValue$6] = 0;
            incrementValue$7 = var0;
            var0++;
            field_e[incrementValue$7] = 0;
        }
        var1 += 7;
        while (var0 < var1) {
            incrementValue$8 = var0;
            var0++;
            field_e[incrementValue$8] = 0;
        }
    }
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (var10 != 0) {
          ...
          jb.a(var17, var18, var19);
          jb.a(var21, var22, var23, var17, var18, var19, param4);
          jb.a(var17, var19, var20);
          jb.a(var21, var23, var24, var17, var19, var20, param4);
          return;
        } else {
          return;
        }
        ...
        if (param4 != 0) {
          ...
          L4: while (true) {
            if (var11 >= var7) {
              ...
              L7: {
                var19 = var17 + var11 * field_i;
                var20 = field_i + var17 - var18;
                ...
                if (var11 >= var21) {
                      ...
                      L10: while (true) {
                        ...
                        L14: while (true) {
                          if (var20 > var18) {
                            ...
                            var19++;
                            field_e[incrementValue$2] = param5;
                            var20++;
                            continue L14;
                          }
                        }
                  ...
                  L15: while (true) {
                    if (var22 >= var18) {
                      ...
                      var19++;
                      field_e[incrementValue$3] = param5;
                      var22++;
                      continue L15;
                    }
                  }
                    ...
                    if (var15 > var12) {
                      ...
                      L20: while (true) {
                        if (var20 >= var18) {
                          ...
                          var19++;
                          field_e[incrementValue$5] = param5;
                          var20++;
                          continue L20;
                        }
                      }
          ...
          dg.c(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        int var6 = 256 - param5;
        int var7 = field_i - param2;
        int var8 = param0 + param1 * field_i;
        for (var9 = 0; var9 < param3; var9++) {
            for (var10 = -param2; var10 < 0; var10++) {
                ...
                var8++;
                field_e[incrementValue$0] = param4 + var11;
            }
            var8 = var8 + var7;
        }
    }
                  ...
                  L6: while (true) {
                    ...
                    L10: while (true) {
                      if (var15 > var13) {
                        ...
                        var14++;
                        field_e[incrementValue$2] = param3;
                        var15++;
                        continue L10;
                      }
                    }
                    ...
                    if (var10 > var7) {
                      ...
                      L15: while (true) {
                        if (var15 >= var13) {
                          ...
                          incrementValue$4 = var14;
                          var14++;
                          field_e[incrementValue$4] = param3;
                          var15++;
                          continue L15;
                        }
                      }
    ...
    final static void h(int param0, int param1, int param2, int param3) {
        ...
        if (param0 >= field_f) {
            ...
            field_e[var4] = var6 - var5 | var5 - (var5 >>> 8);
            return;
        }
    }
