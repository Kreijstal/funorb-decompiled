    ...
    final ad a(int param0, gj param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = param1.field_o[this.field_g][this.field_f];
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("nq.C(").append(param0).append(',');
    ...
    final aga a(int param0, op param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("nq.B(").append(param0).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
