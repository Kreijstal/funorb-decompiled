...
final class saa {
    ...
    final void b(byte param0) {
        int var2 = 0;
        if ((gf.field_k ^ -1) == -14 && kaa.field_m != 0) {
            if (!(0 == iba.field_s)) {
                var2 = 1;
    ...
    private final void f(byte param0) {
        ...
        mk stackIn_91_2;
        jfa stackIn_91_3;
        boolean stackIn_91_4;
        Object stackIn_92_0;
        mk stackIn_92_1;
        mk stackIn_92_2;
        jfa stackIn_92_3;
        boolean stackIn_92_4;
        int stackIn_92_5;
        Object stackIn_97_0;
        mk stackIn_97_1;
        mk stackIn_97_2;
        jfa stackIn_97_3;
        boolean stackIn_97_4;
        Object stackIn_98_0;
        mk stackIn_98_1;
        mk stackIn_98_2;
        jfa stackIn_98_3;
        boolean stackIn_98_4;
        int stackIn_98_5;
        int var2;
        int var3;
        int var4;
                    ...
                    if (null == this.field_d.field_c.a(mk.field_p, -4456, gd.field_m)) {
                      ...
                      if (this.field_d.field_c.a(mk.field_p, -4456, gd.field_m) == null) {
                        ...
                        L19: {
                          ...
                          stackIn_97_3 = this.field_d.field_c.a(mk.field_p, -4456, gd.field_m);

                          stackIn_97_4 = this.field_t;

                          if (this.field_t) {
                            stackIn_98_0 = this;
                            stackIn_98_1 = null;
                            stackIn_98_2 = null;
                            stackIn_98_3 = (jfa) ((Object) stackIn_97_3);
                            stackIn_98_4 = stackIn_97_4;
                            stackIn_98_5 = this.field_l;
                            break L19;
                          } else {
                            stackIn_98_0 = this;
                            stackIn_98_1 = null;
                ...
                if (this.field_q != null) {
                  ...
                  if (!this.field_d.field_c.field_k.a(-22263)) {
                    ...
                    if (this.field_d.field_c.field_k.field_a != 1) {
                      ...
                      L21: {
                        if (stackIn_82_0 != 0 & this.field_p) {
                          break L21;
                        } else {
                          if (nd.field_h != 4) {
                            break L14;
                      ...
                      lf.field_c = 0;
                      var2 = this.field_d.field_c.field_k.d(false);
                      if (var2 != -1) {
                        L22: {
                          this.field_l = var2;
                          this.field_c = true;
                          ...
                          if (this.field_d.field_c.field_k.b(-97) == null) {
                            ...
                            L23: {
                              ...
                              stackIn_91_3 = this.field_d.field_c.field_k.b(125);

                              stackIn_91_4 = this.field_t;

                              if (!this.field_t) {
                                stackIn_92_0 = this;
                                stackIn_92_1 = null;
                                stackIn_92_2 = null;
                                stackIn_92_3 = (jfa) ((Object) stackIn_91_3);
                                stackIn_92_4 = stackIn_91_4;
                                stackIn_92_5 = this.field_g;
                                break L23;
                              } else {
                                stackIn_92_0 = this;
                                stackIn_92_1 = null;
    ...
    final void a(int param0, boolean[] param1) {
        try {
            ...
            throw pe.a((Throwable) ((Object) runtimeException), "saa.M(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final void a(boolean param0, eaa param1) {
        try {
            ...
            throw pe.a((Throwable) ((Object) runtimeException), "saa.F(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final void a(eaa param0, int param1) {
        ...
        try {
            ...
            throw pe.a((Throwable) ((Object) runtimeException), "saa.A(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ')');
        }
    }

    private final void a(boolean param0) {
        sna var2 = mka.a(13558251, 13558251, 13558251, (byte) -124, jha.field_g, 13558251, 16777215, 13558251);
                  ...
                  L3: while (true) {
                    L4: {
                      if (var4 == null) {
                        ...
                        stackIn_16_0 = var4.a(gd.field_m, (byte) 116, mk.field_p);
    ...
    saa(String param0) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_7_1 = new StringBuilder().append("saa.<init>(");
