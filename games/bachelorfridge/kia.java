 ...
 */
final class kia extends bw {
    js field_f;
    byte[] field_g;

    final static kia a(vr param0, String param1, String param2) {
        byte[] var3 = param0.a((byte) 123, param2, param1);
        if (var3 == null) {
            return null;
        }
        return new kia(new lu(var3));
    }
                      ...
                      L6: {
                        if (var9 != 144) {
                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              var13 = var19[var10];
                              var14 = (g) ((Object) this.field_f.a(true, (long)var13));
                              if (var14 != null) {
                                break L7;
                              } else {
                                var15 = new g(new byte[128]);
                                var14 = var15;
                                this.field_f.a((long)var13, (byte) 101, var15);
                                break L7;
                              }
                            }
    ...
    private kia(lu param0) {
        ...
        lu stackIn_66_0 = null;
        lu stackIn_67_0 = null;
        int stackIn_67_1 = 0;
        int stackIn_73_0 = 0;
        int var2;
        int var3;
        ...
        int var66;
        int[] var70;
        param0.field_g = param0.field_h.length - 3;
        var2 = param0.b(16711935);
        var3 = param0.e((byte) 106);
        var4 = 14 + var2 * 10;
        param0.field_g = 0;
        var5 = 0;
        var6 = 0;
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51 = new lu(this.field_g);
                      var51.e(1297377380, -1615464796);
                      var51.e(6, -1615464796);
                      stackIn_66_0 = (lu) (var51);

                      if (var2 <= 1) {
                        stackIn_67_0 = (lu) ((Object) stackIn_66_0);
                        stackIn_67_1 = 0;
                        break L3;
                      } else {
                        stackIn_67_0 = (lu) ((Object) stackIn_66_0);
                    ...
                    ((lu) (Object) stackIn_67_0).b(stackIn_67_1, -113);
                    var51.b(var2, -128);
                    var51.b(var3, -118);
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                      ...
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            var44++;
                                            var51.d((int) param0.field_h[incrementValue$1], 0);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var50++;
                              var51.d((int) param0.field_h[incrementValue$25], 0);
                              incrementValue$26 = var50;
                              var50++;
                              var51.d((int) param0.field_h[incrementValue$26], 0);
                              incrementValue$27 = var50;
                              var50++;
                              var51.d((int) param0.field_h[incrementValue$27], 0);
                              continue L5;
                            }
                          } else {
                            L18: {
                            ...
                            var51.d(47, 0);
                            var51.d(0, 0);
                            var51.b(var51.field_g - var61, (byte) -98);
                            var60++;
                            continue L4;
                          }
                        }
                    ...
                    var28 = var28 + param0.b(16711935) & 127;
                    if (var28 != 0) {
                      if (var28 != 32) {
                        if (var28 != 1) {
                          if (var28 != 33) {
