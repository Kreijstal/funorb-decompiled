...
final class i {
    ...
    final be a(String param0, String param1, int param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("i.A(");
    ...
    final be a(int param0, int[] param1, int param2) {
        ...
        try {
          if (1 != ((i) this).field_g.a((byte) 20)) {
            var4_int = 13 / ((-10 - param0) / 33);
            if (((i) this).field_g.d(param2, 0) != 1) {
              throw new RuntimeException();
            } else {
              stackOut_4_0 = this.a(0, param2, (byte) 106, param1);
              stackIn_5_0 = stackOut_4_0;
              return stackIn_5_0;
            }
          } else {
            stackOut_1_0 = this.a(param2, 0, (byte) -69, param1);
            stackIn_2_0 = stackOut_1_0;
            return stackIn_2_0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L0: {
            ...
            stackOut_7_1 = new StringBuilder().append("i.F(").append(param0).append(44);
    ...
    private final be a(int[] param0, int param1, String param2, String param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("i.G(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    private final be a(String param0, int[] param1, String param2) {
        ...
        try {
          L0: {
            var5_int = ((i) this).field_g.a(param0, false);
            if (0 <= var5_int) {
              var6 = ((i) this).field_g.a((byte) 6, var5_int, param2);
              if (var6 >= 0) {
                stackOut_6_0 = this.a(var6, var5_int, (byte) -27, param1);
                stackIn_7_0 = stackOut_6_0;
                break L0;
              } else {
                stackOut_4_0 = null;
          ...
          L1: {
            var5 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) var5;
            stackOut_8_1 = new StringBuilder().append("i.C(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
          ...
          throw pe.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + 44 + 0 + 41);
        }
        return stackIn_7_0;
    }
    ...
    final be a(int param0, byte param1, int[] param2) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_8_1 = new StringBuilder().append("i.B(").append(param0).append(44).append(param1).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    private final be a(int param0, int param1, int[] param2) {
        ...
        try {
          L0: {
            var5_int = param0 ^ (65530 & param1 << 4 | param1 >>> 12);
            var5_int = var5_int | param1 << 16;
            var6 = 4294967296L ^ (long)var5_int;
            var8 = (be) (Object) ((i) this).field_c.a(true, var6);
            if (var8 == null) {
              L1: {
                if (param2 == null) {
                  break L1;
                  ...
                  if (param2[0] > 0) {
                    ...
                    stackOut_5_0 = null;
                    stackIn_6_0 = stackOut_5_0;
                    return (be) (Object) stackIn_6_0;
                  }
                }
              }
              L2: {
                var9 = (dv) (Object) ((i) this).field_f.a(true, var6);
                if (var9 != null) {
                  break L2;
                } else {
                  var9 = dv.a(((i) this).field_b, param1, param0);
                  if (var9 != null) {
                    ((i) this).field_f.a(var6, (byte) -111, (bw) (Object) var9);
                    break L2;
                  } else {
                    return null;
                  }
              ...
              if (var8 != null) {
                var9.a(false);
                ((i) this).field_c.a(var6, (byte) 124, (bw) (Object) var8);
                stackOut_15_0 = (be) var8;
          ...
          L3: {
            ...
            stackOut_17_1 = new StringBuilder().append("i.H(").append(param0).append(44).append(param1).append(44);
          ...
          throw pe.a((Throwable) (Object) stackIn_20_0, stackIn_20_2 + 44 + -1884086484 + 41);
        }
        return stackIn_16_0;
    }
    ...
    private final be a(int param0, int param1, byte param2, int[] param3) {
        ...
        try {
          L0: {
            var5_int = (param1 >>> 12 | 65530 & param1 << 4) ^ param0;
            var5_int = var5_int | param1 << 16;
            var6 = (long)var5_int;
            var9 = 124 % ((param2 - 55) / 42);
            var8 = (be) (Object) ((i) this).field_c.a(true, var6);
            if (var8 != null) {
              stackOut_2_0 = (be) var8;
              ...
              var10 = vp.a(((i) this).field_g, param1, param0);
              if (var10 != null) {
                L2: {
                  var11 = var10.b();
                  var8 = var11;
                  ((i) this).field_c.a(var6, (byte) 67, (bw) (Object) var8);
                  if (param3 == null) {
                    break L2;
                  } else {
          ...
          L3: {
            ...
            stackOut_15_1 = new StringBuilder().append("i.I(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_17_0 = stackOut_15_0;
            stackIn_17_1 = stackOut_15_1;
            stackIn_16_0 = stackOut_15_0;
    ...
    final be a(String param0, String param1, byte param2) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = this.a((int[]) null, -122, param1, param0);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    i(vr param0, vr param1) {
        ((i) this).field_f = new js(256);
        ((i) this).field_c = new js(256);
        try {
            ((i) this).field_b = param1;
            ((i) this).field_g = param0;
        } catch (RuntimeException runtimeException) {
            throw pe.a((Throwable) (Object) runtimeException, "i.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
