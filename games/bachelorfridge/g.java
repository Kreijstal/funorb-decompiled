    ...
    final static void a(String param0, String param1) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_2_1 = new StringBuilder().append("g.A(");
          ...
          throw pe.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + ',' + 81 + ')');
        }
    }
    ...
    final static boolean a(int param0, int param1, int param2, vr param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("g.B(").append(param0).append(',').append(param1).append(',').append(-30744).append(',');
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
            stackIn_6_0 = stackOut_5_0;
            stackIn_6_1 = stackOut_5_1;
