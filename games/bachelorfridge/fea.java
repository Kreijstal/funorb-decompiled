...
final class fea extends po {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        int var13 = 0;
        int var9 = param1 + param2 * dg.field_i;
        int var10 = dg.field_i - param3;
        int var11 = 0;
        int var12 = 0;
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$0] == 0) {
                  ...
                  param8++;
                  dg.field_e[incrementValue$1] = param6;
                  var20++;
                  continue L3;
                }
              }
            ...
            if (param4 > 0) {
              L5: {
                if (dg.field_d == null) {
                  ...
                  fea.a(dg.field_e, this.field_L[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, dg.field_d, dg.field_b);
                  break L5;
                }
              }
              return;
