...
final class ej extends jm {
        ...
        try {
          L0: {
            L1: {
              var8 = param0.field_o;
              var9 = var8;
              var8.field_T[((ej) this).field_m] = 0;
              if (param1 <= -2) {
                break L1;
              } else {
                var7 = null;
            ...
            var4 = param0.field_o.field_h.field_S[((ej) this).field_m];
            var5 = 0;
            L2: while (true) {
              if (var4.field_b.length <= var5) {
                ((ej) this).a(false, var9.field_h);
                break L0;
              } else {
                L3: {
                  if (var4.field_b[var5] == null) {
                    ...
                    param0.a(27799, (at) (Object) new cb(param0.field_o.b(var4.field_b[var5], -23990), 5));
                    var5++;
                    break L3;
                  }
                }
    ...
    final static void a(int param0, int param1, String param2, boolean param3, int param4, int param5) {
        try {
            param0 = param0 - (hl.field_C.a(param2) >> 1);
        ...
        try {
          L0: {
            L1: {
              ...
              var7 = param1.field_S[((ej) this).field_m];
              var3 = var7;
              if (!param0) {
                break L1;
              } else {
        ...
        try {
          L0: {
            if (!param0.a(0)) {
              ...
              stackOut_4_0 = param4 + " - " + param0.a(0, param3) + "%";
