    ...
    final void a(ub param0, int param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("ej.B(");
    ...
    final void a(boolean param0, op param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("ej.C(").append(param0).append(',');
        ...
        try {
          L0: {
            ...
            if (!param0.a(0)) {
              ...
              stackOut_6_0 = param4 + " - " + param0.a(0, param3) + "%";
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("ej.A(");
