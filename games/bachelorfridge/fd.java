    ...
    final static pia a(byte param0, int param1, int param2, vr param3, vr param4) {
        ...
        try {
          L0: {
            if (param0 == -105) {
              if (g.a(param2, param1, param0 ^ 30847, param4)) {
                stackOut_6_0 = cea.a(param3.b(-56, param2, param1), 28450);
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("fd.F(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    fd(gj param0, tla param1) {
        ...
        try {
          L0: {
            ...
            var4 = ((fd) this).field_B.field_u;
            var5 = ((fd) this).field_B.field_t;
              ...
              if (var6 >= var4) {
                L3: {
                  if (var4 <= 0) {
                    ...
                    ((fd) this).field_F = ((fd) this).field_I[var4 >> 1].e((byte) -120);
                ...
                ((fd) this).field_I[var6] = new rr(((fd) this).field_q, (fd) this, var5[var6].field_c, var5[var6].field_a, var3_int != 0);
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("fd.<init>(");
    ...
    final static void a(int[] param0, vr param1, int param2, int param3, byte[] param4, vr param5, boolean param6, vr param7, int[] param8, int param9, ee[] param10, kv[][] param11, kv[][] param12, byte[] param13, String[][] param14, String[][] param15, String[] param16) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param3 == 0) {
                ...
                var18 = null;
                pia discarded$1 = fd.a((byte) 115, 95, 37, (vr) null, (vr) null);
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("fd.D(");
          ...
          L6: {
            stackOut_15_0 = (RuntimeException) (Object) stackIn_15_0;
            stackOut_15_1 = ((StringBuilder) (Object) stackIn_15_1).append(stackIn_15_2).append(44).append(param6).append(44);
          ...
          L8: {
            ...
            stackOut_21_1 = ((StringBuilder) (Object) stackIn_21_1).append(stackIn_21_2).append(44).append(param9).append(44);
    ...
    final boolean c(byte param0) {
        ...
        if (((fd) this).field_m.a((byte) -106)) {
          ...
          L5: while (true) {
            if (var5 >= var8.length) {
              L6: {
                if (((fd) this).field_B.field_u > 0) {
                  var10 = ((fd) this).field_I[((fd) this).field_B.field_u >> 1];
                  var4_ref = var10;
                  if (var4_ref != null) {
                    var10.d(320);
                    break L6;
