    ...
    final static pia a(byte param0, int param1, int param2, vr param3, vr param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_7_1 = new StringBuilder().append("fd.F(").append(-105).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static void a(int[] param0, vr param1, int param2, int param3, byte[] param4, vr param5, boolean param6, vr param7, int[] param8, int param9, ee[] param10, kv[][] param11, kv[][] param12, byte[] param13, String[][] param14, String[][] param15, String[] param16) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("fd.D(");
            stackIn_4_0 = stackOut_2_0;
          ...
          L3: {
            stackOut_8_0 = (RuntimeException) (Object) stackIn_8_0;
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(',').append(5).append(',').append(0).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
          ...
          throw pe.a((Throwable) (Object) stackIn_41_0, stackIn_41_2 + ')');
        }
    }
