...
final class fd extends ana {
    ...
    final static pia a(byte param0, int param1, int param2, vr param3, vr param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("fd.F(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          L0: {
            ...
            L2: while (true) {
              if (var6 >= var4) {
                ...
                this.field_I[var6].field_w = this.field_I[var6].field_w - var6 * this.field_y;
                var6++;
                continue L2;
              }
            }
    ...
    final static void a(int[] param0, vr param1, int param2, int param3, byte[] param4, vr param5, boolean param6, vr param7, int[] param8, int param9, ee[] param10, kv[][] param11, kv[][] param12, byte[] param13, String[][] param14, String[][] param15, String[] param16) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param3 == 0) {
                ...
                var18 = (vr) null;
                discarded$1 = fd.a((byte) 115, 95, 37, (vr) null, (vr) null);
                break L1;
              }
            }
            break L0;
          ...
          L6: {
            stackOut_15_0 = (RuntimeException) ((Object) stackIn_15_0);
            stackOut_15_1 = ((StringBuilder) (Object) stackIn_15_1).append(stackIn_15_2).append(',').append(param6).append(',');
