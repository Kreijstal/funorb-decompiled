...
final class pfa {
    ...
    final static void b(int param0) {
        ...
        L1: while (true) {
          if (var3 >= mj.field_h.length) {
                ...
                if (-2 != var2) {
                  ...
                  L5: {
                    if (vka.field_p.length < mq.field_a.length) {
                      stackOut_14_0 = mq.field_a.length;
                      stackIn_15_0 = stackOut_14_0;
                      break L5;
                    } else {
                      stackOut_13_0 = vka.field_p.length;
                      ...
                      if (var7 + 6 > var3) {
                        L7: {
                          if ((var3 + -6 - -vka.field_p.length - var7 ^ -1) <= -1) {
                            stackOut_20_0 = vka.field_p[-6 + var3 + vka.field_p.length + -var7];
                        ...
                        var6_ref = (String) (Object) stackIn_21_0;
                        break L6;
                      } else {
                        break L6;
                      }
                  ...
                  L8: {
                    if (wba.field_a.length < ta.field_b.length) {
                      stackOut_24_0 = ta.field_b.length;
                      stackIn_25_0 = stackOut_24_0;
                      break L8;
                    } else {
                      stackOut_23_0 = wba.field_a.length;
                    ...
                    if (var3 < var8 + 7 - -var7) {
                      L9: {
                        if (-var7 + -7 + var3 >= wba.field_a.length) {
                          ...
                          stackOut_29_0 = wba.field_a[-var7 + -7 + var3];
                          stackIn_31_0 = stackOut_29_0;
                          break L9;
                        }
                      }
                      var6_ref = (String) (Object) stackIn_31_0;
                      break L4;
                    } else {
                      break L4;
                    }
            ...
            L12: {
              var7 = gg.a(stackIn_38_0 != 0, -59, var6_ref);
              ...
              if (-1 < (var4 ^ -1)) {
                ...
                L13: {
                  if (var4 != dp.field_o.field_g) {
                    stackOut_41_0 = st.field_b;
                    stackIn_42_0 = stackOut_41_0;
                    break L13;
                  } else {
                    stackOut_40_0 = hi.field_a;
                    stackIn_42_0 = stackOut_40_0;
                    break L13;
                  }
                }
                L14: {
                  var9 = (lda) (Object) stackIn_42_0;
                  var1 = var1 + cba.field_d;
                  if (var9 != null) {
                    var9.a((um.field_d << -1672420575) + hc.field_D, 28, var8 - vt.field_k, var1, (vt.field_k << 2120631745) + var7);
                    break L14;
                  } else {
                    break L14;
                  }
                }
                var1 = var1 + um.field_d;
                break L12;
              }
            }
            if ((var4 ^ -1) > -1) {
              jk.field_o.c(var6_ref, var8, gaa.field_k + var1, var5, -1);
              var1 = var1 + mm.field_z;
              var3++;
              continue L1;
            } else {
              fp.field_f.c(var6_ref, var8, var1 + tca.field_f, var5, -1);
              var1 = var1 + (um.field_d + (cba.field_d + hc.field_D));
              var3++;
              continue L1;
            }
          }
    ...
    private final void a(byte param0) {
        ...
        L0: while (true) {
          if (((pfa) this).field_e.length <= var3_int) {
            ...
            if ((((pfa) this).field_f.field_s.field_m[var3_int] ^ -1) != 0) {
    ...
    private final void a(kv param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        for (var8 = 0; param1 > var8; var8++) {
            var7 = var7 + am.field_Q[var8];
        }
        dg.a(param3, param4, param3 - -var7, 28 + param4);
          ...
          L1: while (true) {
            if (var3_int >= ((pfa) this).field_e.length) {
                ...
                if (var12 >= ((pfa) this).field_e.length) {
                  L4: {
                    if (!((pfa) this).field_a.field_T) {
                      ...
                      if (-1 == (((pfa) this).field_f.field_s.field_y ^ -1)) {
                        break L4;
                      } else {
                  ...
                  if (null != ((pfa) this).field_e[var12]) {
                    if (0 != (((pfa) this).field_e[var12].field_zb ^ -1)) {
              ...
              if (((pfa) this).field_e[var3_int] != null) {
                if (0 != (((pfa) this).field_e[var3_int].field_zb ^ -1)) {
                  L5: {
                      ...
                      if (!(var14 instanceof hd)) {
                        if (var14 instanceof a) {
                          ...
                          if (var14 instanceof t) {
                            L6: {
                              if (-2 == ((t) (Object) var14).field_p) {
                                break L6;
                              } else {
                                if (-3 == ((t) (Object) var14).field_p) {
                                  break L6;
                                } else {
                  ...
                  if (!((pfa) this).field_f.field_s.c((byte) -10, ((pfa) this).field_e[var3_int].field_zb)) {
                    dg.d(4 + ((pfa) this).field_e[var3_int].field_kb, 4 + ((pfa) this).field_e[var3_int].field_rb, (((pfa) this).field_e[var3_int].field_sb >> -496263967) + (((pfa) this).field_e[var3_int].field_kb - -15), ((pfa) this).field_e[var3_int].field_rb - -(((pfa) this).field_e[var3_int].field_p >> -214844415) - -15, 65793, 4);
                    dg.d(5 + ((pfa) this).field_e[var3_int].field_kb, 5 + ((pfa) this).field_e[var3_int].field_rb, (((pfa) this).field_e[var3_int].field_sb >> -182531967) + (((pfa) this).field_e[var3_int].field_kb + 14), 14 + ((pfa) this).field_e[var3_int].field_rb + (((pfa) this).field_e[var3_int].field_p >> 618161985), 16711680, 2);
                    var3_int++;
                    continue L1;
                  } else {
                    var3_int++;
