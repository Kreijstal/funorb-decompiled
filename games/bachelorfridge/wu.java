...
final class wu extends hf {
    ...
    final void a(byte param0, int param1, int param2, int param3) {
        ...
        if (0 != param2) {
          ...
          var5 = (this.field_p >> 1299837825) + param3 + this.field_s;
          var6 = this.field_v + (param1 - -(this.field_q >> 149441377));
          var9 = -121 % ((-20 - param0) / 54);
          var8 = this.field_A.b(-19704);
          if (var8 != cq.field_g) {
            if (var8 != ji.field_f) {
              if (var8 != jt.field_f) {
                if (var8 != cm.field_u) {
              ...
              if (null != rs.field_f) {
                if (var10 <= rs.field_f.field_q) {
                  if (rs.field_f.field_p >= var11) {
                    bu.a(0, rs.field_f);
                    dg.d();
                    var17.b(112, 144, var17.field_n << 96016100, var17.field_o << -1476124060, -this.field_D << 177657610, 4096);
                    db.b(89);
            ...
            if (null != rs.field_f) {
              if (var10 <= rs.field_f.field_q) {
                if (rs.field_f.field_p >= var11) {
                  bu.a(0, rs.field_f);
                  dg.d();
                  var16.b(112, 144, var16.field_n << 96016100, var16.field_o << -1476124060, -this.field_D << 177657610, 4096);
                  db.b(89);
    ...
    final String c(byte param0) {
        wj var3;
        if (this.field_t) {
          return this.field_A.a((byte) 71);
        } else {
          if (param0 == 16) {
            return null;
          } else {
            var3 = (wj) null;
            this.a(-94, 42, (wj) null, -101);
            return null;
          }
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, byte param4) {
        ...
        try {
          ...
          throw pe.a((Throwable) ((Object) var5), "wu.B(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ')');
        }
    ...
    final static eq a(int param0, byte param1, String param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackIn_4_1 = new StringBuilder().append("wu.C(").append(param0).append(',').append(param1).append(',');
    ...
    final boolean a(wj param0, int param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackIn_6_1 = new StringBuilder().append("wu.W(");
