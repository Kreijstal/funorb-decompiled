...
final class tc {
    ...
    final static boolean a(int param0, int param1, int param2, boolean param3) {
        ...
        if (param3) {
            gs var5 = (gs) null;
            discarded$0 = tc.a(false, (gs) null);
        }
        if (!(!hl.field_I)) {
        ...
        try {
            ...
            try {
              ...
              L7: {
                ...
                stackOut_21_1 = new StringBuilder().append("tc.G(").append(param0).append(',');
              ...
              if (var6_ref == null) {
                ...
                if (null == param1.field_l) {
                  ...
                  if ((this.field_h ^ -1) <= -1) {
                    ...
                    discarded$1 = ((po) (Object) stackIn_28_0).a(stackIn_28_1, stackIn_28_2, stackIn_28_3, stackIn_28_4, stackIn_28_5, stackIn_28_6, stackIn_28_7, stackIn_28_8, param1.field_m, param1.field_g, param1.field_c);
                    break L7;
                  } else {
                    break L7;
                  }
    ...
    final static int a(boolean param0, gs param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_17_1 = new StringBuilder().append("tc.B(").append(param0).append(',');
