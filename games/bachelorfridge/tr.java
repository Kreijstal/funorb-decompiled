    ...
    final static void a(int param0, kv param1, int param2, int param3, kv param4, int param5, int param6, int param7) {
        ...
        try {
            ...
            L1: while (true) {
              if (param1.field_v.length <= var8_int) {
                ...
                L2: {
                  ...
                  if ((-16777216 & param1.field_v[var8_int]) != -16777216) {
                    var8_int++;
                    var8_int++;
                    break L2;
                  } else {
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("tr.B(").append(param0).append(',');
          ...
          throw pe.a((Throwable) (Object) stackIn_19_0, stackIn_19_2 + ',' + param5 + ',' + -26512 + ',' + param7 + ')');
        }
    }
