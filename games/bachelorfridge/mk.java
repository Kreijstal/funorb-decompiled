...
final class mk {
    ...
    private final boolean a(int[] param0, int param1, int[] param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_15_1 = new StringBuilder().append("mk.L(");
    ...
    private final boolean a(int param0, int[] param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_15_1 = new StringBuilder().append("mk.K(").append(param0).append(',');
    ...
    final void b(boolean param0) {
        ...
        L0: {
          var5 = BachelorFridge.field_y;
          this.field_s.c(11);
          this.field_u.a(19842, param0);
          if (-2 != (this.field_u.field_R ^ -1)) {
            break L0;
          } else {
            if (gi.field_a) {
              if (this.a(true)) {
                L1: {
                  qm.a(14, 7758);
                  if (!this.a(this.field_k, 0, rn.field_s.field_g.field_m)) {
                    ep.a((byte) 42, rn.field_s, this.field_l, this.field_e, rn.field_s.field_g.field_m);
                    break L1;
                  } else {
                    break L1;
                  }
                ...
                this.field_m = new mj(100, 150, 440, 160, wja.field_n);
                return;
              }
            } else {
              break L0;
            ...
            if (var2 <= var3) {
                ...
                if (var7 >= hha.field_w.length) {
                  ...
                  if (hha.field_w[var7].field_T) {
                    ...
                    if ((hha.field_w[var7].field_R ^ -1) == -2) {
                      qm.a(9, 7758);
                      rn.field_s.field_g.field_m[this.field_t] = -1;
                      var7++;
                      continue L5;
                    } else {
                      var7++;
              ...
              if (bf.field_g[var3].field_T) {
                ...
                if (-2 == (bf.field_g[var3].field_R ^ -1)) {
                  L8: {
                    if (this.a(this.field_x, rn.field_s.field_g.field_m, -125)) {
                      break L8;
                    } else {
                      L9: {
                        if (this.field_x < 2) {
                          ...
                          if (rn.field_s.field_g.field_g[-2 + this.field_x]) {
                            break L9;
                          } else {
                            break L8;
                          }
                      ...
                      L10: while (true) {
                        if (var6 < rn.field_s.field_g.field_m.length) {
                          if (-1 != rn.field_s.field_g.field_m[var6]) {
                            ...
                            qm.a(8, 7758);
                            uca.a(17, (byte) 105);
                            rn.field_s.field_g.field_m[var6] = this.field_x;
                            var3++;
                            continue L4;
                          }
                        } else {
                  ...
                  if (-1 != this.field_x) {
                    if (this.a(this.field_x, rn.field_s.field_g.field_m, -126)) {
                      L11: {
                        if (-3 < (this.field_x ^ -1)) {
                          break L11;
                        } else {
                      ...
                      qm.a(9, 7758);
                      var4 = this.a(rn.field_s.field_g.field_m, 0, this.field_x);
                      if ((var4 ^ -1) != 0) {
    ...
    final static int a(byte[] param0, int param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var5 >= param3) {
                ...
                var4_int = var4_int >>> 1036397736 ^ uca.field_d[(param0[var5] ^ var4_int) & 255];
                var5++;
                continue L1;
              }
            }
          ...
          L3: {
            ...
            stackIn_10_1 = new StringBuilder().append("mk.E(");
    ...
    final void a(boolean param0, int param1) {
        ...
        L0: {
          ...
          wq.field_k.e(0, 0);
          j.a(this.field_v, 34, 16762880, true, 444, false);
          wt.field_k.a(rn.field_s.field_g.field_o.field_a, 350, 40, 240, 100, 16777215, -1, 0, 1, 14);
        ...
        this.field_s.a(false, false, 2048, 2048, 0, -60, 256, 110, 100);
        var4 = (ho) ((Object) rn.field_s.field_g.field_h.b((byte) 90));
        L1: while (true) {
          if (var4 == null) {
            L2: {
              this.a((byte) 21, this.field_d[2], dt.field_a, 154, 472, 2);
              this.a((byte) 21, this.field_d[3], in.field_b, 184, 472, 3);
              this.a((byte) 21, this.field_d[0], fk.field_s, 216, 472, 0);
              this.a((byte) 21, this.field_d[1], vaa.field_b, 243, 472, 1);
              this.c(false);
              pw.field_y.e(470, 320);
              stackIn_7_0 = jha.field_g;

              stackIn_7_1 = di.field_l;

              stackIn_7_2 = 522;

              stackIn_7_3 = 342;

              if (!this.field_u.field_T) {
                stackIn_8_0 = (fea) ((Object) stackIn_7_0);
                stackIn_8_1 = (String) ((Object) stackIn_7_1);
                stackIn_8_2 = stackIn_7_2;
                stackIn_8_3 = stackIn_7_3;
                stackIn_8_4 = 16777215;
                break L2;
              } else {
                stackIn_8_0 = (fea) ((Object) stackIn_7_0);
                stackIn_8_1 = (String) ((Object) stackIn_7_1);
            ...
            L3: while (true) {
              if (var5 >= rn.field_s.field_g.field_m.length) {
                L4: {
                  ...
                  L6: {
                    if (0 == (this.field_x ^ -1)) {
                      stackIn_40_0 = rn.field_s.field_g.field_m[this.field_t];
                      break L6;
                    } else {
                      stackIn_40_0 = this.field_x;
                      break L6;
                    }
                  }
                  var5 = stackIn_40_0;
                ...
                L5: {
                  if (var3 != rn.field_s.field_g.field_i) {
                    ...
                    if (-1 != (rn.field_s.field_g.field_i ^ -1)) {
                      this.field_r.d(-13 + var4, var5 + -13, 255);
                      break L5;
                    } else {
                      break L5;
                    }
                          ...
                          if (!(var7 instanceof t)) {
                            ...
                            L9: {
                              if (((t) ((Object) var10)).field_p == 1) {
                                ...
                                if (-3 == (((t) ((Object) var10)).field_p ^ -1)) {
                                  break L9;
                                } else {
                                  if (-5 == (((t) ((Object) var10)).field_p ^ -1)) {
    ...
    final static void a(byte param0) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var1_int >= gb.field_f.length) {
                ...
                me.field_t.a((long)gb.field_f[var1_int].toLowerCase().hashCode(), (byte) 78, new ji(var1_int));
                var1_int++;
                continue L1;
              }
            }
          ...
          throw pe.a((Throwable) ((Object) var1), "mk.J(" + param0 + ')');
        }
    }
    ...
    private final void a(byte param0, int param1, kv param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L7: {
            ...
            stackIn_24_1 = new StringBuilder().append("mk.G(").append(param0).append(',').append(param1).append(',');
          ...
          throw pe.a((Throwable) ((Object) stackIn_25_0), stackIn_25_2 + ',' + param3 + ',' + param4 + ',' + param5 + ')');
        }
    }
    ...
    private final int a(int[] param0, int param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_11_1 = new StringBuilder().append("mk.H(");
    ...
    mk(jfa param0, boolean param1, int param2) {
        ...
        try {
            ...
            this.field_v = rn.field_s.field_g.field_n;
            this.field_k = new int[rn.field_s.field_g.field_m.length];
            bl.a(rn.field_s.field_g.field_m, 0, this.field_k, 0, this.field_k.length);
            this.field_d = rn.field_s.field_g.field_k;
            this.field_s = rn.field_s.field_g.e((byte) -121);
            rn.field_v = mka.a(13558251, 13558251, 13558251, (byte) -123, jha.field_g, 13558251, 16777215, 13558251);
            rn.field_v.field_eb = wd.field_w;
            rn.field_v.field_A = bla.field_p;
            rn.field_v.field_db = op.field_I;
            rn.field_v.field_N = 1;
            this.field_u = new sna("confirm", rn.field_v, 470, 320, jha.field_g.a(di.field_l) - -40, 40, di.field_l);
            ...
            this.field_j = new kv(120, 60);
            this.field_j.b();
            var9.d(60, 30, 0, 4096);
            this.field_b = new kv(120, 60);
            this.field_b.b();
            ...
            this.field_c = new kv(120, 60);
            this.field_c.b();
            var10.d(60, 30, 200, 4096);
            this.field_a = new kv(120, 60);
            this.field_a.b();
            var10.d(60, 30, -200, 4096);
            var11 = new kv(180, 30);
            var11.b();
            ...
            this.field_g = new kv(200, 60);
            this.field_g.b();
            var11.d(100, 30, 200, 4096);
            hga.field_U.a((byte) 21);
            this.field_n = new int[256];
            for (var5 = 0; -257 < (var5 ^ -1); var5++) {
                this.field_n[var5] = var5 * 65793;
            }
            this.field_w = new int[256];
            var7 = 0;
            var5 = var7;
            while (-257 < (var7 ^ -1)) {
                this.field_w[var7] = 257 * var7;
                var7++;
            }
            this.field_q = new kv(25, 25);
            this.field_q.b();
            dg.a(208, 208, 192, 255, this.field_n);
            this.field_r = new kv(25, 25);
            this.field_r.b();
            dg.a(208, 208, 192, 255, this.field_w);
            hga.field_U.a((byte) 125);
            this.field_s.a((byte) 65, rn.field_s.field_g.field_o.field_b, 0);
            rn.field_s.field_g.field_f = -1;
            qm.a(13, 7758);
            ct.c(0, -121);
            a.a(15843842, 32, 16763049, 16435458);
            uca.a(16, (byte) -61);
        } catch (RuntimeException runtimeException) {
            throw pe.a((Throwable) ((Object) runtimeException), "mk.<init>(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ',' + param2 + ')');
        }
    }
