...
final class hca {
    ...
    final static kv a(String param0, vr param1, int param2, String param3) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = jha.a(param1, (byte) 4, var4_int, var6);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("hca.C(");
    ...
    hca(int param0, int param1, String param2) {
        try {
            ...
            throw pe.a((Throwable) (Object) runtimeException, "hca.<init>(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
