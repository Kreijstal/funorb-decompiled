...
final class bla extends td {
    ...
    final static ee[] a(int param0, String param1, String param2, vr param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("bla.B(").append(param0).append(44);
    ...
    bla(int param0, aga param1, nq param2) {
        ...
        try {
            ...
            throw pe.a((Throwable) (Object) runtimeException, "bla.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
