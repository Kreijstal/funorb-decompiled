...
final class bla extends td {
    ...
    final static ee[] a(int param0, String param1, String param2, vr param3) {
        ...
        try {
          L0: {
            L1: {
              var4_int = param3.a(param1, false);
              var5 = param3.a((byte) 6, var4_int, param2);
              if (param0 == 29611) {
                break L1;
              } else {
                var6 = null;
            ...
            stackOut_2_0 = kn.a(-7726, param3, var5, var4_int);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("bla.B(").append(param0).append(',');
    ...
    final static void a(int param0, kv[] param1, byte param2, int param3) {
        ...
        try {
            ...
            throw pe.a((Throwable) (Object) runtimeException, "bla.D(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + param2 + ',' + param3 + ')');
        }
    }
    ...
    final ii a(op param0, int param1) {
        ...
        RuntimeException decompiledCaughtException = null;
        pg stackOut_7_0 = null;
        ew stackOut_5_0 = null;
        RuntimeException stackOut_9_0 = null;
        StringBuilder stackOut_9_1 = null;
        RuntimeException stackOut_11_0 = null;
        StringBuilder stackOut_11_1 = null;
        ...
        try {
          L0: {
            ...
            L2: {
              var3 = ((bla) this).field_h.a(62, param0);
              var4 = ((bla) this).field_j.a(116, param0);
              if (var4 == null) {
                break L2;
              } else {
                if (var4.i(-77)) {
                  ...
                  var5 = new pg(((bla) this).field_g, new nq(var3), ((bla) this).field_j);
                  var5.field_o.a((bw) (Object) new iv(new nq(var4), false, 1, 0, 42), true);
                  stackOut_7_0 = (pg) var5;
                  stackIn_8_0 = stackOut_7_0;
                  break L0;
                }
              }
            }
            stackOut_5_0 = new ew(new nq(var3));
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("bla.A(");
    ...
    bla(int param0, aga param1, nq param2) {
        ...
        try {
            ...
            throw pe.a((Throwable) (Object) runtimeException, "bla.<init>(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + (param2 != null ? "{...}" : "null") + ')');
        }
    }
