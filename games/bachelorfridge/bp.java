...
final class bp extends ana {
    ...
    private final void f(int param0) {
        ...
        if (param0 == -2602) {
          var9 = this.field_v.field_l.a(63, this.field_q.field_h);
          if (var9.i(-100)) {
            return;
          } else {
            ...
            L0: while (true) {
              if (var3_ref == null) {
                ...
                L1: {
                  ...
                  var10 = var3_ref.field_h.a(param0 ^ 24849, this.field_q);
                  if (var10 != null) {
                    this.a(27799, new taa(this.field_q, var10));
                    this.a(27799, new iu(3));
                    this.a(27799, new cb(var10, 7));
                    this.a(27799, new wn(var10, kna.field_g[18], 24831));
                    break L1;
                  } else {
                    break L1;
                  }
                }
                var3_ref = (iv) ((Object) this.field_v.field_o.c(0));
                continue L0;
              }
            }
          }
          ...
          field_x = -4;
          var7 = this.field_v.field_l.a(63, this.field_q.field_h);
          if (var7.i(-100)) {
            return;
          } else {
            var3_ref = (iv) ((Object) this.field_v.field_o.b((byte) 90));
            ...
            L2: while (true) {
              if (var3_ref == null) {
                ...
                L3: {
                  ...
                  var8 = var3_ref.field_h.a(param0 ^ 24849, this.field_q);
                  if (var8 != null) {
                    this.a(27799, new taa(this.field_q, var8));
                    this.a(27799, new iu(3));
                    this.a(27799, new cb(var8, 7));
                    this.a(27799, new wn(var8, kna.field_g[18], 24831));
                    break L3;
                  } else {
                    break L3;
                  }
