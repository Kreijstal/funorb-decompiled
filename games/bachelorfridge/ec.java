...
final class ec {
    ...
    final static kv[] a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        var9 = 3;
        var10 = new kv[]{new kv(var9, var9), new kv(3, var9), new kv(var9, var9), new kv(var9, 3), new kv(64, 64), new kv(var9, 3), new kv(var9, var9), new kv(3, var9), new kv(var9, var9)};
          ...
          if (var11_ref_kv__.length <= var12) {
            ...
            L1: while (true) {
              if (var11 >= 1) {
                  ...
                  if (var11 >= 1) {
                      ...
                      if (var11 >= 3) {
                          ...
                          if (var11 >= 1) {
                            ...
                            L5: while (true) {
                              if (1 <= var12) {
                                ...
                                var10[3].field_v[var11 * var9 - (var12 + (-var9 + 1))] = 65793;
                                var10[7].field_v[3 * var12 - -var11] = 65793;
                        ...
                        L6: while (true) {
                          if (1 > var12) {
                            ...
                            var10[5].field_v[var9 + (-1 - var12) + var9 * var11] = 0;
                            var10[1].field_v[var12 * 3 - -var11] = 0;
                            var10[3].field_v[var12 + var11 * var9] = 0;
                            var12++;
                            continue L6;
                          } else {
                            var11++;
                    ...
                    L7: while (true) {
                      if (var9 > var12) {
                        ...
                        if (var12 < var9 - var11) {
                          var10[2].field_v[var12 + var11 * var9] = 0;
                ...
                L8: while (true) {
                  if (var9 > var12) {
                    var10[6].field_v[var12 + var9 * (-1 + (var9 - var11))] = 0;
                    var10[8].field_v[var12 + var9 * (-var11 + (var9 + -1))] = 0;
                    var10[2].field_v[var12 * var9 - -var9 + (-1 - var11)] = 0;
