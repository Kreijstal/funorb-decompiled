...
final class mi extends at {
    ...
    final boolean c(byte param0) {
        ...
        aj var5;
        aj var6;
        int fieldTemp$2 = this.field_q - 1;
        ...
        if (0 <= fieldTemp$2) {
          ...
          if (this.field_p <= this.field_o) {
            ...
            L0: {
              ...
              var5 = this.field_m[fieldTemp$3];
              var6 = var5;
              var3 = new uea(this.field_j, var6.field_c, var6.field_a, 16777215);
              ((kj) ((Object) var3)).a(0);
              this.field_j.field_h.field_a[var5.field_c][var5.field_a].field_i = true;
              this.field_j.field_s.d(74);
              var4 = -120 / ((71 - param0) / 47);
              this.field_q = 200 / (this.field_j.field_h.field_B + this.field_j.field_h.field_z);
              if (1 > this.field_q) {
                this.field_q = 1;
                break L0;
              } else {
            ...
            L1: {
              if (-2 == (this.field_o ^ -1)) {
                ...
                if (0 != this.field_o % (100 / this.field_q)) {
                  break L1;
                } else {
                  wf.a(19, (byte) 126);
                  break L1;
    ...
    mi(gj param0, bja param1) {
        ...
        try {
          L0: {
            this.field_j = param0;
            var8 = this.field_j.field_h;
            var9 = var8;
            this.field_p = 0;
            var4 = 0;
            L1: while (true) {
              if (var4 >= var9.field_z) {
                this.field_m = new aj[this.field_p];
                this.field_o = 0;
                var4 = 0;
                L2: while (true) {
                  if (var9.field_z <= var4) {
                    ...
                    L3: while (true) {
                      if (var4 >= this.field_p) {
                        ...
                        L4: {
                          var5 = kla.a(this.field_p, m.field_a, -2147483648);
                          if (var5 == var4) {
                            break L4;
                          } else {
                            var6 = this.field_m[var4];
                            this.field_m[var4] = this.field_m[var5];
                        ...
                        L6: {
                          if (var8.field_a[var4][var5].field_i) {
                            ...
                            if (1 != var8.field_L.field_o[var4][var5].field_n) {
                              ...
                              this.field_o = this.field_o + 1;
                              this.field_m[fieldTemp$0] = new aj(var4, var5);
                              break L6;
                            }
                          }
                        }
          ...
          L9: {
            ...
            stackIn_28_1 = new StringBuilder().append("mi.<init>(");
          ...
          throw pe.a((Throwable) ((Object) stackIn_29_0), stackIn_32_2 + ')');
        }
    }
