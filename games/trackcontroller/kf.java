    ...
    final static mh a(int param0, kk param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_9_1 = new StringBuilder().append("kf.A(").append(param0).append(',');
    ...
    final static oi a(String param0, boolean param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_29_1 = new StringBuilder().append("kf.E(");
