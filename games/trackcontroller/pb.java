...
final class pb {
    ...
    final static ck a(int param0, int param1, kk param2, kk param3, byte param4) {
        ...
        try {
          L0: {
            var5_int = -30 % ((param4 - 10) / 43);
            if (sk.a(param1, param2, 1, param0)) {
              stackOut_3_0 = bc.a(12587, param3.a(param0, param1, (byte) -25));
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("pb.B(").append(param0).append(',').append(param1).append(',');
          ...
          throw sl.a((Throwable) ((Object) stackIn_11_0), stackIn_11_2 + ',' + param4 + ')');
        }
        return stackIn_4_0;
    }
