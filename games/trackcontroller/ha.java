...
final class ha extends fc {
    ...
    final static void a(java.math.BigInteger param0, java.math.BigInteger param1, int param2, byte[] param3, int param4, byte param5, be param6) {
        ...
        try {
          ...
          L11: {
            ...
            stackOut_29_1 = ((StringBuilder) (Object) stackIn_29_1).append(stackIn_29_2).append(',').append(0).append(',').append(77).append(',');
    ...
    final static oi a(String param0, int param1) {
        ...
        try {
          ...
          throw sl.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + ',' + -125 + ')');
        }
        return stackIn_12_0;
    }
    ...
    final static void a(oh param0, int param1, int param2, oh param3) {
        try {
            ...
            throw sl.a((Throwable) (Object) runtimeException, "ha.D(" + (param0 != null ? "{...}" : "null") + ',' + 2 + ',' + 480 + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
