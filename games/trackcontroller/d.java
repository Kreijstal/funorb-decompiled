...
final class d extends qj {
    final void h(int param0, int param1) {
        ...
        int var9 = 0;
        L0: {
          param0 = param0 + ((d) this).field_r;
          param1 = param1 + ((d) this).field_o;
        ...
        L4: {
          if (var6 <= 0) {
            ...
            if (var5 > 0) {
              d.d(ll.field_i, ((d) this).field_z, 0, var4, var3, var6, var5, var7, var8);
              return;
            } else {
              break L4;
            }
    ...
    final void g(int param0, int param1) {
        ...
        int var9 = 0;
        L0: {
          param0 = param0 + (((d) this).field_s - ((d) this).field_t - ((d) this).field_r);
          param1 = param1 + ((d) this).field_o;
          var3 = param0 + param1 * ll.field_d;
          var4 = ((d) this).field_t - 1;
          var5 = ((d) this).field_q;
          var6 = ((d) this).field_t;
          var7 = ll.field_d - var6;
          var8 = var6 + var6;
        ...
        L4: {
          if (var6 <= 0) {
            ...
            if (var5 > 0) {
              d.e(ll.field_i, ((d) this).field_z, 0, var4, var3, var6, var5, var7, var8);
              return;
            } else {
              break L4;
            }
    ...
    final void d(int param0, int param1) {
        ...
        int stackOut_19_2 = 0;
        L0: {
          var3 = ((d) this).field_t >> 1;
          var4 = ((d) this).field_q >> 1;
          param0 = param0 + ((d) this).field_r / 2;
          param1 = param1 + ((d) this).field_o / 2;
          if (param0 >= ll.field_a) {
            stackOut_2_0 = 0;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          } else {
            stackOut_1_0 = ll.field_a - param0 << 1;
        ...
        L1: {
          ...
          if (param0 + var3 <= ll.field_e) {
            stackOut_5_0 = ((d) this).field_t - 2;
            stackIn_6_0 = stackOut_5_0;
            break L1;
          } else {
            stackOut_4_0 = (ll.field_e - param0 << 1) - 2;
        ...
        L2: {
          ...
          if (param1 >= ll.field_b) {
            ...
            stackOut_7_0 = ll.field_b - param1 << 1;
        ...
        L3: {
          ...
          if (param1 + var4 <= ll.field_g) {
            stackOut_11_0 = ((d) this).field_q - 2;
            stackIn_12_0 = stackOut_11_0;
            break L3;
          } else {
            stackOut_10_0 = (ll.field_g - param1 << 1) - 2;
        ...
        L4: while (true) {
          if (var9 > var8) {
            ...
            var10 = var9 * ((d) this).field_t + var5;
            var11 = (param1 + (var9 >> 1)) * ll.field_d + (param0 + (var5 >> 1));
            var12 = var5;
            L5: while (true) {
              if (var12 > var6) {
                var9 += 2;
                ...
                L6: while (true) {
                  if (var19 >= 4) {
                    if (var18 != 0) {
                      ...
                      var19 = var18 >> 2;
                      var20 = 256 - var19;
                      var21 = ll.field_i[var11];
                      ll.field_i[var11] = (var19 * var15 + var20 * (var21 & 16711935) & -16711936) + (var19 * var16 + var20 * (var21 & 65280) & 16711680) >>> 8;
                      var12 += 2;
                      var11++;
                      var10 += 2;
                      continue L5;
    ...
    final void d(int param0, int param1, int param2) {
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              d.c(ll.field_i, ((d) this).field_z, 0, var5, var4, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
    ...
    final void a(int param0, int param1, int param2) {
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              d.b(0, 0, 0, ll.field_i, ((d) this).field_z, var5, 0, var4, 0, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
    ...
    final void f(int param0, int param1) {
        ...
        L0: {
          param0 = param0 + ((d) this).field_r;
          param1 = param1 + (((d) this).field_v - ((d) this).field_q - ((d) this).field_o);
          var3 = param0 + (param1 + ((d) this).field_q - 1) * ll.field_d;
          var4 = 0;
          var5 = ((d) this).field_q;
          var6 = ((d) this).field_t;
          var7 = -ll.field_d - var6;
    ...
    final void b(int param0, int param1) {
        ...
        int stackOut_10_0 = 0;
        L0: {
          var3 = ((d) this).field_t >> 2;
          var4 = ((d) this).field_q >> 2;
          param0 = param0 + ((d) this).field_r / 4;
          param1 = param1 + ((d) this).field_o / 4;
          if (param0 >= ll.field_a) {
            stackOut_2_0 = 0;
            stackIn_3_0 = stackOut_2_0;
            break L0;
        ...
        L3: {
          var7 = stackIn_9_0;
          if (param1 + var4 <= ll.field_g) {
            stackOut_11_0 = ((d) this).field_q - 4;
            stackIn_12_0 = stackOut_11_0;
            break L3;
          } else {
          ...
          if (var10 > var8) {
            ...
            L5: while (true) {
              if (var11 > var6) {
                ...
                var12 = var10 * ((d) this).field_t + var11;
                var13 = (param1 + (var10 >> 2)) * ll.field_d + (param0 + (var11 >> 2));
                var14 = 0;
                L6: while (true) {
                  if (var14 >= 4) {
                    var25 = var24;
                    ...
                    L7: while (true) {
                      if (var19 >= 16) {
                        if (var15 != 0) {
                          ...
                          var19 = var15 >> 4;
                          var20 = 256 - var19;
                          var21 = ll.field_i[var13];
                          ll.field_i[var13] = (var19 * var16 + var20 * (var21 & 16711935) & -16711936) + (var19 * var17 + var20 * (var21 & 65280) & 16711680) >>> 8;
                          var11 += 4;
                          continue L5;
                        } else {
                          var11 += 4;
                    ...
                    L8: while (true) {
                      if (var15 >= 4) {
                        ...
                        var9[(var14 << 2) + var15] = ((d) this).field_z[var12 + var14 * ((d) this).field_t + var15];
                        var15++;
                        continue L8;
                      }
                    }
    ...
    final void c(int param0, int param1, int param2) {
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              d.b(ll.field_i, ((d) this).field_z, 0, var5, var4, 0, 0, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
    ...
    final void e(int param0, int param1, int param2) {
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              d.d(ll.field_i, ((d) this).field_z, 0, var5, var4, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
