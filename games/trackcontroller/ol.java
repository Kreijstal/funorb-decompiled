    ...
    private final void a(int[] param0, int param1, byte param2, int param3, ha param4, int param5) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_27_1 = ((StringBuilder) (Object) stackIn_27_1).append(stackIn_27_2).append(',').append(param1).append(',').append(126).append(',').append(param3).append(',');
          ...
          throw sl.a((Throwable) (Object) stackIn_30_0, stackIn_30_2 + ',' + param5 + ')');
        }
    }
