 ...
 */
final class ph implements tl {
    private com.ms.directX.DSCursors[] field_a;
    private com.ms.directX.DSBufferDesc[] field_b;

    public ph() throws Exception {
        int var1 = 0;
        ((ph) this).field_b = new com.ms.directX.DSBufferDesc[2];
        ((ph) this).field_a = new com.ms.directX.DSCursors[2];
        ...
        for (var1 = 0; -3 < var1; var1++) {
            ((ph) this).field_b[var1] = new com.ms.directX.DSBufferDesc();
        }
        for (var1 = 0; -3 > var1; var1++) {
            ((ph) this).field_a[var1] = new com.ms.directX.DSCursors();
        }
    }
}
