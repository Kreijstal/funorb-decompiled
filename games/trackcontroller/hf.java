...
final class hf {
    ...
    final static void a(oh param0, int param1, int param2, int param3, boolean param4, int param5, int param6, oh param7, int param8, int param9, na param10, int param11, int param12, int param13, na param14, int param15, int param16, int param17, na param18) {
        ...
        try {
          L0: {
            ha.a(param7, 2, 480, param0);
            vb.a(20, 26, -74, 18, 26);
            jk.a(240, -114, 320);
            uh.a(0, param10, 0, -97, 10, param14);
            we.a(0, 104, 0, param18);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("hf.C(");
          ...
          L2: {
            ...
            stackOut_5_1 = ((StringBuilder) (Object) stackIn_5_1).append(stackIn_5_2).append(44).append(20).append(44).append(480).append(44).append(param3).append(44).append(0).append(44).append(26).append(44).append(param6).append(44);
          ...
          L3: {
            ...
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(44).append(0).append(44).append(param9).append(44);
          ...
          L4: {
            ...
            stackOut_11_1 = ((StringBuilder) (Object) stackIn_11_1).append(stackIn_11_2).append(44).append(18).append(44).append(320).append(44).append(10).append(44);
          ...
          L5: {
            ...
            stackOut_14_1 = ((StringBuilder) (Object) stackIn_14_1).append(stackIn_14_2).append(44).append(0).append(44).append(26).append(44).append(0).append(44);
          ...
          throw sl.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + 44 + 0 + 44 + 240 + 41);
        }
    }
    ...
    final byte[] a(byte param0, int param1) {
        try {
            ...
            synchronized (var3) {
              try {
                L0: {
                  if (~(long)(6 + param1 * 6) >= ~((hf) this).field_g.a((byte) -88)) {
                    L1: {
                    ...
                    var4_int = (65280 & fh.field_a[1] << 8) + ((fh.field_a[0] & 255) << 16) - -(255 & fh.field_a[2]);
                    var5 = (fh.field_a[3] << 16 & 16711680) - (-(65280 & fh.field_a[4] << 8) - (fh.field_a[5] & 255));
                    if (0 <= var4_int) {
                                ...
                                if (var5 != 0) {
                                  L3: {
                                    ...
                                    if (param1 > 65535) {
                                      ...
                                      var10 = (255 & fh.field_a[3]) + (((fh.field_a[2] & 255) << 8) + (((255 & fh.field_a[0]) << 24) + (fh.field_a[1] << 16 & 16711680)));
                                      var11 = (fh.field_a[5] & 255) + ((fh.field_a[4] & 255) << 8);
                                      var13 = fh.field_a[9] & 255;
                                      var12 = ((255 & fh.field_a[7]) << 8) + (fh.field_a[6] << 16 & 16711680) - -(fh.field_a[8] & 255);
                                      break L3;
                                    } else {
                                      L5: {
                                        if (var9 > 512) {
                                      ...
                                      var14 = 8;
                                      ((hf) this).field_h.a(fh.field_a, var14 + var9, 0, 0);
                                      var12 = (fh.field_a[6] & 255) + ((fh.field_a[4] & 255) << 16) + (65280 & fh.field_a[5] << 8);
                                      var11 = (fh.field_a[3] & 255) + ((255 & fh.field_a[2]) << 8);
                                      var13 = 255 & fh.field_a[7];
                                      var10 = ((fh.field_a[0] & 255) << 8) + (fh.field_a[1] & 255);
                                      break L3;
                                    }
                                  }
                                  if (var10 == param1) {
    ...
    private final boolean a(byte[] param0, int param1, int param2, boolean param3) {
        try {
            ...
            try {
              var6_ref2 = (Object) (Object) ((hf) this).field_h;
              synchronized (var6_ref2) {
                try {
                  L0: {
                    L1: {
                      if (param3) {
                        if (~(long)(6 * param1 + 6) >= ~((hf) this).field_g.a((byte) -95)) {
                          L2: {
                            ((hf) this).field_g.a((long)(6 * param1), true);
                            ((hf) this).field_g.a(fh.field_a, 6, 0, 0);
                            var7_int = ((fh.field_a[4] & 255) << 8) + ((16711680 & fh.field_a[3] << 16) - -(255 & fh.field_a[5]));
                            if (var7_int <= 0) {
                              break L2;
                            } else {
                    ...
                    fh.field_a[3] = (byte)(var7_int >> 16);
                    fh.field_a[1] = (byte)(param2 >> 8);
                    fh.field_a[0] = (byte)(param2 >> 16);
                    fh.field_a[4] = (byte)(var7_int >> 8);
                      ...
                      L4: {
                        if (param2 <= var8) {
                              ...
                              L6: {
                                ...
                                if (65535 < param1) {
                                  ...
                                  if (decompiledRegionSelector1 == 0) {
                                    var11 = ((fh.field_a[1] & 255) << 16) + (-16777216 & fh.field_a[0] << 24) - -((255 & fh.field_a[2]) << 8) - -(255 & fh.field_a[3]);
                                    var12 = (fh.field_a[4] << 8 & 65280) + (fh.field_a[5] & 255);
                                    var10 = ((255 & fh.field_a[6]) << 16) + (((fh.field_a[7] & 255) << 8) + (fh.field_a[8] & 255));
                                  ...
                                  if (decompiledRegionSelector0 == 0) {
                                    var12 = (255 & fh.field_a[3]) + ((255 & fh.field_a[2]) << 8);
                                    var13 = 255 & fh.field_a[7];
                                    var11 = (fh.field_a[0] << 8 & 65280) - -(255 & fh.field_a[1]);
                                    var10 = (255 & fh.field_a[6]) + (16711680 & fh.field_a[4] << 16) + (fh.field_a[5] << 8 & 65280);
                                    break L6;
                                  } else {
                                    break L4;
                                  }
                                    ...
                                    if (var13 != ((hf) this).field_c) {
                                      ...
                                      L12: {
                                        if (var10 < 0) {
                                          ...
                                          if (~(long)var10 < ~(((hf) this).field_h.a((byte) -102) / 520L)) {
                                            break L12;
                                          } else {
                                            break L5;
                                          }
                          ...
                          L16: {
                            if (param1 > 65535) {
                              L17: {
                                fh.field_a[2] = (byte)(param1 >> 8);
                                fh.field_a[7] = (byte)(var10 >> 8);
                                fh.field_a[4] = (byte)(var9 >> 8);
                                fh.field_a[8] = (byte)var10;
                                fh.field_a[5] = (byte)var9;
                                fh.field_a[9] = (byte)((hf) this).field_c;
                                fh.field_a[0] = (byte)(param1 >> 24);
                                fh.field_a[6] = (byte)(var10 >> 16);
                                fh.field_a[1] = (byte)(param1 >> 16);
                              ...
                              L18: {
                                ...
                                fh.field_a[2] = (byte)(var9 >> 8);
                                fh.field_a[5] = (byte)(var10 >> 8);
                                fh.field_a[4] = (byte)(var10 >> 16);
                                fh.field_a[7] = (byte)((hf) this).field_c;
                                fh.field_a[0] = (byte)(param1 >> 8);
              ...
              L19: {
                ...
                stackOut_69_1 = new StringBuilder().append("hf.B(");
              ...
              throw sl.a((Throwable) (Object) stackIn_72_0, stackIn_72_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + 0 + 41);
            }
        } catch (RuntimeException | Error decompiledUncheckedException) {
            throw decompiledUncheckedException;
        } catch (Throwable decompiledCheckedException) {
    ...
    hf(int param0, il param1, il param2, int param3) {
        ...
        try {
            ...
            throw sl.a((Throwable) (Object) runtimeException, "hf.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 41);
        }
    }
    ...
    final boolean a(int param0, int param1, byte[] param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("hf.E(").append(param0).append(44).append(param1).append(44);
            stackIn_16_0 = stackOut_14_0;
            stackIn_16_1 = stackOut_14_1;
            stackIn_15_0 = stackOut_14_0;
            stackIn_15_1 = stackOut_14_1;
