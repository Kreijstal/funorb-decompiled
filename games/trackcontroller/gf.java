...
final class gf {
    ...
    final void b(boolean param0) {
        ...
        if (null != og.field_rb) {
          ...
          if (!this.field_d) {
            if (this.field_j <= og.field_pb) {
              if (0 >= this.field_j) {
                if (this.field_s == og.field_pb) {
                  if (wf.field_b == this.field_h) {
                    return;
                  } else {
                    this.field_b.a(this.field_s, this.field_h, (byte) 4);
                    return;
                  }
                } else {
                  this.field_b.a(this.field_s, this.field_h, (byte) 4);
              ...
              gb.field_i = (-og.field_pb + this.field_j) / 2;
              if (this.field_s == og.field_pb) {
                if (wf.field_b == this.field_h) {
                  return;
                } else {
            ...
            if (var2 > this.field_l) {
              ...
              if (this.field_u > var2) {
                ...
                if (0.0f < this.field_k) {
                  L2: {
                    var4 = (int)(this.field_k * (float)var3 + 0.5f);
                    if (var2 < var4) {
                      ...
                      if (var2 <= var4) {
                        ...
                        L5: {
                          if (0 >= this.field_j) {
                            ...
                            gb.field_i = (this.field_j + -og.field_pb) / 2;
                            break L5;
                          }
                        }
                        return;
    ...
    final ih c(int param0) {
        ...
        mj.field_c = false;
        var2 = dj.a(param0, this.field_v, this.field_f, (byte) 28, rg.field_c, 0);
        if (var2 == null) {
          this.b(param0 + 6391);
          return var2;
        } else {
    ...
    final void b(int param0) {
        if (param0 != 6391) {
          this.field_h = 97;
          this.field_b.a(this.field_n, this.field_p, (byte) 4);
          return;
        } else {
          this.field_b.a(this.field_n, this.field_p, (byte) 4);
          return;
