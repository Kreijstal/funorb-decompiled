...
abstract class oh extends gb {
    ...
    private final void b(String param0, int param1, int param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_fd.field_g;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
                ...
                case 47: {
                    field_p = field_p + field_z;
                    param1 = param1 + (field_p >> 8);
                    field_p = field_p & 255;
                    statePc = 48;
                    continue stateLoop;
                }
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                ...
                var2++;
                ((oh) this).field_K[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = wd.a(field_C, ' ', 0, 1);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
    ...
    final void a(String param0, int param1, int param2, int[] param3, int[] param4) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 6: {
                    var12_ref = param0.substring(var6 + 1, var10).toLowerCase();
                    var6 = -1;
                ...
                case 29: {
                    try {
                        var8++;
                        var19 = (CharSequence) (Object) var12_ref.substring(4);
                        var15 = uk.a(var19, 10);
                ...
                case 35: {
                    try {
                        param1 = param1 + var16_ref_fd.field_g;
                        var7 = 0;
                        statePc = 36;
                        continue stateLoop;
    ...
    oh(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((oh) this).field_q = 0;
