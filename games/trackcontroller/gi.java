...
final class gi extends ic {
    ...
    private final void a(boolean param0, gi param1, int param2) {
        ...
        qi stackIn_9_0 = null;
        int stackIn_9_1 = 0;
        qi stackIn_10_0 = null;
        int stackIn_10_1 = 0;
        qi stackIn_10_2 = null;
        ...
        int stackOut_7_1 = 0;
        qi stackOut_9_0 = null;
        int stackOut_9_1 = 0;
        qi stackOut_9_2 = null;
        ...
        try {
          L0: {
            L1: {
              super.a(-19397, param1);
              if (param2 == 11) {
                break L1;
              } else {
                this.field_s = (qi[]) null;
                break L1;
              }
            }
            L2: {
              if (!param0) {
                pd.a(this.field_s, 0, param1.field_s, 0, 6);
                break L2;
              } else {
                var4_int = 0;
                L3: while (true) {
                      ...
                      if (var5 == null) {
                        ...
                        L5: {
                          ...
                          if (var6 == null) {
                            ...
                            stackOut_9_0 = (qi) ((Object) stackIn_9_0);
                            stackOut_9_1 = stackIn_9_1;
                            stackOut_9_2 = (qi) (dupTemp$13);
                        ...
                        ((qi) (Object) stackIn_10_0).a(stackIn_10_1 != 0, stackIn_10_2);
                        break L4;
                      }
                    }
                    var4_int++;
          ...
          L6: {
            ...
            stackOut_15_1 = new StringBuilder().append("gi.P(").append(param0).append(',');
          ...
          throw sl.a((Throwable) ((Object) stackIn_18_0), stackIn_18_2 + ',' + param2 + ')');
        }
    }
    ...
    final void a(int param0, qj[] param1) {
        ...
        try {
          ...
          L3: {
            var3_ref = decompiledCaughtException;
            stackOut_10_0 = (RuntimeException) (var3_ref);
            stackOut_10_1 = new StringBuilder().append("gi.O(").append(param0).append(',');
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
    ...
    public final void a(int param0, al param1, int param2, boolean param3, int param4) {
        ...
        try {
          L0: {
            ...
            L4: {
              var7.a((gi) (this), param2, param1, -1, this.field_p, param4);
              if (var10 == null) {
                break L4;
              } else {
                L5: {
                  if (var10.field_G) {
                    ...
                    if (var11 == null) {
                      ...
                      var11.a((gi) (this), param2, param1, -1, this.field_p, param4);
                      break L5;
                    }
                  } else {
                    break L5;
                ...
                if (!var10.field_q) {
                  ...
                  L6: {
                    ...
                    if (var10.field_r == 0) {
                      ...
                      if (var12 != null) {
                        var12.a((gi) (this), param2, param1, param0 ^ 24968, this.field_p, param4);
                        break L4;
                      } else {
                        break L6;
                      }
                  ...
                  var9 = this.field_s[2];
                  if (var9 != null) {
                    var9.a((gi) (this), param2, param1, -1, this.field_p, param4);
                    break L4;
                  } else {
                    break L4;
                  }
            ...
            L7: {
              if (!param1.h(-115)) {
                ...
                if (var13 != null) {
                  var13.a((gi) (this), param2, param1, param0 ^ 24968, this.field_p, param4);
                  break L7;
                } else {
                  break L7;
                }
            ...
            L8: {
              if (param3) {
                ...
                if (var14 == null) {
                  ...
                  var14.a((gi) (this), param2, param1, param0 + 24968, this.field_p, param4);
                  break L8;
                }
              }
            }
            this.field_p.a(param4, param2, param1, -16711924, (gi) (this));
            ch.m(35);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L9: {
            ...
            stackOut_29_1 = new StringBuilder().append("gi.L(").append(param0).append(',');
          ...
          throw sl.a((Throwable) ((Object) stackIn_32_0), stackIn_32_2 + ',' + param2 + ',' + param3 + ',' + param4 + ')');
        }
    }
    ...
    final void a(int param0, qj[] param1, byte param2) {
        ...
        try {
            ...
            if (param2 != -33) {
                al var5 = (al) null;
                this.a(111, (al) null, -5, true, -65);
            }
            if (null == this.field_s[var4_int]) {
                this.field_s[var4_int] = new qi();
            }
            this.field_s[param0].field_i = param1;
        } catch (RuntimeException runtimeException) {
            throw sl.a((Throwable) ((Object) runtimeException), "gi.Q(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + param2 + ')');
        }
    }

    public gi() {
        this.field_s = new qi[6];
        this.field_p = new qi();
        qi dupTemp$0 = new qi();
