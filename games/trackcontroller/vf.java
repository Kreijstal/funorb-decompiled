...
final class vf {
    ...
    final void a(be param0, jl param1) {
        ...
        L0: {
          var3 = param0.h(16383);
          this.field_h[0] = var3 >> 4;
          this.field_h[1] = var3 & 15;
          if (var3 == 0) {
            var11 = this.field_b;
            this.field_b[1] = 0;
            var11[0] = 0;
            ...
            this.field_b[0] = param0.d((byte) -112);
            this.field_b[1] = param0.d((byte) -63);
            var4 = param0.h(16383);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                    ...
                    L3: {
                      L4: {
                        if (var4 != 0) {
                          ...
                          if (this.field_b[1] == this.field_b[0]) {
                            break L3;
                          } else {
                            break L4;
                          }
                    ...
                    L5: while (true) {
                      if (var7 >= this.field_h[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_c[var5][1][var7] = param0.d((byte) -63);
                          this.field_e[var5][1][var7] = param0.d((byte) -127);
                          var7++;
                          continue L5;
                        }
                      }
                ...
                var6 = 0;
                L6: while (true) {
                  if (var6 >= this.field_h[var5]) {
                    var5++;
                    continue L1;
                  } else {
                    this.field_c[var5][0][var6] = param0.d((byte) -83);
                    this.field_e[var5][0][var6] = param0.d((byte) -59);
                    var6++;
                    continue L6;
                  }
                }
    ...
    final int a(int param0, float param1) {
        ...
        int var4 = 0;
        if (param0 == 0) {
            var3 = (float)this.field_b[0] + (float)(this.field_b[1] - this.field_b[0]) * param1;
        ...
        for (var4 = 1; var4 < this.field_h[param0]; var4++) {
            ...
            for (var7 = var4 * 2 - 1; var7 >= 2; var7--) {
                dupTemp$0 = field_a[param0];
                dupTemp$0[var7] = dupTemp$0[var7] + (field_a[param0][var7 - 1] * var5 + field_a[param0][var7 - 2] * var6);
            }
            dupTemp$1 = field_a[param0];
            dupTemp$1[1] = dupTemp$1[1] + (field_a[param0][0] * var5 + var6);
            dupTemp$2 = field_a[param0];
            dupTemp$2[0] = dupTemp$2[0] + var5;
        }
        if (param0 == 0) {
            for (var4 = 0; var4 < this.field_h[0] * 2; var4++) {
                dupTemp$3 = field_a[0];
                dupTemp$3[var4] = dupTemp$3[var4] * field_f;
            }
        }
        for (var4 = 0; var4 < this.field_h[param0] * 2; var4++) {
            field_d[param0][var4] = (int)(field_a[param0][var4] * 65536.0f);
        }
        return this.field_h[param0] * 2;
    }
