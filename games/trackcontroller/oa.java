...
class oa {
                ...
                L0: {
                  ...
                  L2: while (true) {
                    if (var1 <= this.field_u + 5000L) {
                      ...
                      this.a(256);
                      this.field_u = this.field_u + (long)(256000 / field_h);
                      var1 = qg.a(false);
                      continue L2;
                    }
                  }
              ...
              if (this.field_s != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.h();
                      if (this.field_p - var3_int <= this.field_t) {
                        break L6;
                      } else {
                        this.field_t = this.field_p - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_f + this.field_e;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_b) {
                        ...
                        if (var4 + 256 <= this.field_b) {
                          ...
                          this.field_e = var4 - this.field_f;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_r) {
                            ...
                            L12: {
                              if (this.field_g) {
                                ...
                                this.field_e = Math.min(this.field_a, this.field_t);
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new pk();
                          var4 = var5;
                          stackIn_10_0 = (pk) (var4);

                          stackIn_10_1 = 256;

                          if (!field_k) {
                            stackIn_11_0 = (pk) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_o <= 0) {
                            ...
                            if (field_q != null) {
                              ...
                              param0.a(field_o, (Runnable) ((Object) field_q), 43);
                              break L5;
                            }
                          }
                        }
                                ...
                                if (var4 < this.field_n) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_l[var7_int] = (wh) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((wh) (var7)).field_l;
                        ((wh) (var7)).field_l = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
    ...
    oa() {
        ...
        this.field_c = 0L;
        this.field_m = 0;
        this.field_l = new wh[8];
        this.field_j = new wh[8];
        this.field_g = true;
        this.field_t = 0;
        this.field_r = 0L;
        this.field_a = 0;
