...
class qj extends g {
    ...
    void c(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            qj.a(ll.field_i, this.field_z, 0, var5, var4, 0, 0, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    final qj b() {
        int var3 = 0;
        qj var1 = new qj(this.field_t, this.field_q);
    ...
    void b(int param0, int param1) {
        ...
        L0: {
          ...
          if (param0 >= ll.field_a) {
            ...
            stackIn_3_0 = ll.field_a - param0 << 2;
            break L0;
          }
        }
        L1: {
          ...
          if (param0 + var3 <= ll.field_e) {
            stackIn_6_0 = this.field_t - 4;
            break L1;
          } else {
            stackIn_6_0 = (ll.field_e - param0 << 2) - 4;
            break L1;
          }
        }
        L2: {
          ...
          if (param1 >= ll.field_b) {
            ...
            stackIn_9_0 = ll.field_b - param1 << 2;
            break L2;
          }
        }
        L3: {
          ...
          if (param1 + var4 <= ll.field_g) {
            stackIn_12_0 = this.field_q - 4;
            break L3;
          } else {
            stackIn_12_0 = (ll.field_g - param1 << 2) - 4;
            break L3;
          }
        }
        var8 = stackIn_12_0;
                  ...
                  if (var16 >= 4) {
                    ...
                    L7: while (true) {
                      if (var17 >= 4) {
                        ...
                        L8: {
                          var13 = this.field_z[var10 + var16 * this.field_t + var17];
                          if (var13 != 0) {
                            break L8;
                          } else {
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                param2++;
                ll.field_i[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
    ...
    void e(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            qj.b(ll.field_i, this.field_z, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final void c(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            qj.a(0, ll.field_i, this.field_z, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }

    final void a() {
        ll.a(this.field_z, this.field_t, this.field_q);
    }
    ...
    void a(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            if (param2 == 256) {
                qj.a(0, 0, 0, ll.field_i, this.field_z, var5, 0, var4, 0, var7, var6, var8, var9);
            } else {
                qj.a(0, 0, 0, ll.field_i, this.field_z, var5, 0, var4, 0, var7, var6, var8, var9, param2);
            }
            return;
        }
    }
        ...
        L0: {
          if (param2 > this.field_s) {
            ...
            if (param3 <= this.field_v) {
              L1: {
                var5 = param0 + this.field_r * param2 / this.field_s;
                var6 = param0 + ((this.field_r + this.field_t) * param2 + this.field_s - 1) / this.field_s;
                var7 = param1 + this.field_o * param3 / this.field_v;
                var8 = param1 + ((this.field_o + this.field_q) * param3 + this.field_v - 1) / this.field_v;
                if (var5 >= ll.field_a) {
                  break L1;
                } else {
                  var5 = ll.field_a;
                    ...
                    if (var11 >= var8) {
                      ...
                      L6: while (true) {
                        if (var12 >= var6) {
                          ...
                          var15 = var13 * this.field_s / param2 - (this.field_r << 4);
                          var16 = (var13 + 16) * this.field_s / param2 - (this.field_r << 4);
                          var17 = var14 * this.field_v / param3 - (this.field_o << 4);
                          var18 = (var14 + 16) * this.field_v / param3 - (this.field_o << 4);
                          ...
                          if (var19 != 0) {
                            ...
                            L8: {
                              if (var16 <= this.field_t << 4) {
                                break L8;
                              } else {
                                var16 = this.field_t << 4;
                                break L8;
                              }
                            }
                            L9: {
                              ...
                              if (var28 > var18) {
                                ...
                                L15: while (true) {
                                  if (var30 > var16) {
                                    ...
                                    var31 = this.field_z[var28 * this.field_t + var30];
                                    if (var31 != 0) {
                                      L16: {
                                        var32 = var29;
                                        if (var30 != var15) {
    ...
    void h(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            qj.a(ll.field_i, this.field_z, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final void d() {
        ...
        int incrementValue$0 = 0;
        int var3 = 0;
        int[] var1 = new int[this.field_t * this.field_q];
        int var2 = 0;
        for (var3 = 0; var3 < this.field_t; var3++) {
            for (var4 = this.field_q - 1; var4 >= 0; var4--) {
                incrementValue$0 = var2;
                var2++;
                var1[incrementValue$0] = this.field_z[var3 + var4 * this.field_t];
            }
        }
        this.field_z = var1;
        var3 = this.field_o;
        this.field_o = this.field_r;
        this.field_r = this.field_v - this.field_q - var3;
        var3 = this.field_q;
    ...
    void e(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            qj.a(ll.field_i, this.field_z, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    void g(int param0, int param1) {
        int var9 = 0;
        param0 = param0 + (this.field_s - this.field_t - this.field_r);
        param1 = param1 + this.field_o;
        int var3 = param0 + param1 * ll.field_d;
        int var4 = this.field_t - 1;
        int var5 = this.field_q;
        int var6 = this.field_t;
        int var7 = ll.field_d - var6;
        int var8 = var6 + var6;
        ...
        if (var6 > 0) {
            ...
            qj.a(ll.field_i, this.field_z, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    private final void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        int var18;
        L0: {
          var6 = param2 * this.field_t + param1;
          param3 = param3 & 4095;
          param4 = param4 & 4095;
          if (param2 < 0) {
            var12 = 0;
          ...
          if (param2 >= this.field_q - 1) {
            ...
            L5: {
              if (param1 < 0) {
                ...
                L6: {
                  var9 = this.field_z[var6 + this.field_t];
                  if (var9 == 0) {
                    stackIn_19_0 = 0;
                    break L6;
                  } else {
            ...
            if (param1 >= this.field_t - 1) {
              ...
              L7: {
                var10 = this.field_z[var6 + this.field_t + 1];
                if (var10 == 0) {
                  stackIn_25_0 = 0;
                  break L7;
                } else {
    ...
    void d(int param0, int param1) {
        ...
        int var4 = param0 + (this.field_t >> 1) > ll.field_e ? ll.field_e - param0 << 1 : this.field_t;
        int var5 = param1 < ll.field_b ? ll.field_b - param1 << 1 : 0;
        int var6 = param1 + (this.field_q >> 1) > ll.field_g ? ll.field_g - param1 << 1 : this.field_q;
        qj.a(this.field_z, var5 * this.field_t + var3, (param1 + (var5 >> 1)) * ll.field_d + (param0 + (var3 >> 1)), (this.field_t << 1) - (var4 - var3) + (this.field_t & 1), ll.field_d - (var4 - var3 >> 1), this.field_t, var4 - var3 >> 1, var6 - var5 >> 1);
    }
    ...
    final void b(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            qj.c(ll.field_i, this.field_z, param2, var5, var4, var7, var6, var8, var9);
            return;
        }
    }
    ...
    void d(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            qj.b(ll.field_i, this.field_z, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    final qj c() {
        ...
        var1.field_s = this.field_s;
        var1.field_v = this.field_v;
        var1.field_r = this.field_s - this.field_t - this.field_r;
        var1.field_o = this.field_o;
        for (var2 = 0; var2 < this.field_q; var2++) {
            for (var3 = 0; var3 < this.field_t; var3++) {
                var1.field_z[var2 * this.field_t + var3] = this.field_z[var2 * this.field_t + this.field_t - 1 - var3];
            }
        }
        return var1;
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          L0: {
            ...
            var13 = ((this.field_t << 4) - param0) * var10 + -param1 * var9;
            var14 = -((this.field_t << 4) - param0) * var9 + -param1 * var10;
            var15 = -param0 * var10 + ((this.field_q << 4) - param1) * var9;
            var16 = --param0 * var9 + ((this.field_q << 4) - param1) * var10;
            var17 = ((this.field_t << 4) - param0) * var10 + ((this.field_q << 4) - param1) * var9;
            var18 = -((this.field_t << 4) - param0) * var9 + ((this.field_q << 4) - param1) * var10;
            if (var11 >= var13) {
              var19 = var13;
              var20 = var11;
              break L0;
    ...
    void f(int param0, int param1) {
        int var9 = 0;
        param0 = param0 + this.field_r;
        param1 = param1 + (this.field_v - this.field_q - this.field_o);
        int var3 = param0 + (param1 + this.field_q - 1) * ll.field_d;
        int var4 = 0;
        int var5 = this.field_q;
        int var6 = this.field_t;
        int var7 = -ll.field_d - var6;
    ...
    qj(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            var4.waitForAll();
            this.field_t = var3.getWidth((java.awt.image.ImageObserver) ((Object) param1));
            this.field_q = var3.getHeight((java.awt.image.ImageObserver) ((Object) param1));
            this.field_s = this.field_t;
            this.field_v = this.field_q;
            this.field_r = 0;
            this.field_o = 0;
            this.field_z = new int[this.field_t * this.field_q];
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_t, this.field_q, this.field_z, 0, this.field_t);
            var5.grabPixels();
            break L0;
          }
