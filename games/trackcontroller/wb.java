                      ...
                      L6: {
                        if (var9 != 144) {
                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              var13 = var19[var10];
                              var14 = (wl) ((Object) this.field_i.a(8434, (long)var13));
                              if (var14 != null) {
                                break L7;
                              } else {
                                var15 = new wl(new byte[128]);
                                var14 = var15;
                                this.field_i.a(false, (long)var13, var15);
                                break L7;
                              }
                            }
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51 = new be(this.field_j);
                      var51.b(false, 1297377380);
                      var51.b(false, 6);
                      stackIn_66_0 = (be) (var51);

                      if (var2 <= 1) {
                        stackIn_67_0 = (be) ((Object) stackIn_66_0);
                        stackIn_67_1 = 0;
                        break L3;
                      } else {
                        stackIn_67_0 = (be) ((Object) stackIn_66_0);
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                      ...
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            var44++;
                                            var51.a((int) param0.field_j[incrementValue$1], (byte) -77);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var50++;
                              var51.a((int) param0.field_j[incrementValue$25], (byte) -74);
                              incrementValue$26 = var50;
                              var50++;
                              var51.a((int) param0.field_j[incrementValue$26], (byte) -65);
                              incrementValue$27 = var50;
                              var50++;
                              var51.a((int) param0.field_j[incrementValue$27], (byte) -80);
                              continue L5;
                            }
                          } else {
                            L18: {
