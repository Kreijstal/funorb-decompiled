...
final class rk extends wd {
    ...
    final static void r(int param0) {
        ...
        he.field_f[1] = new ra(var6, 21, 48);
        he.field_f[0] = new ra(var6, 21, 48);
        var7 = new ea(-1, vl.field_E);
        he.field_f[param0] = new ra(var7, 16, 48);
        he.field_f[12] = new ra(var7, 16, 48);
        ...
        he.field_f[11] = new ra(var8, 21, 48);
        he.field_f[10] = new ra(var8, 21, 48);
        var2 = he.field_f;
        var3 = 0;
        L0: while (true) {
          if (var2.length <= var3) {
