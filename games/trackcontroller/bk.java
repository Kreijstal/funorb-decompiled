...
final class bk extends td implements a, m {
    ...
    private final int a(int param0, int param1, int param2, al param3, int param4, String param5, String param6) {
        ...
        try {
          L0: {
            var10 = new sa(20, 70, 290, 25, param3, false, 120, 3, gk.field_c, 16777215, param6);
            ((bk) this).a(false, (al) (Object) var10);
            var9 = new mi(((wk) (Object) param3).a((byte) -100), param5, 126, 70 - -var10.field_u, 195, 35);
            var9.field_l = (tg) this;
            ((bk) this).a(false, (al) (Object) var9);
            stackOut_0_0 = var9.field_u + var10.field_u;
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("bk.CA(").append(35).append(',').append(170).append(',').append(70).append(',');
          ...
          L2: {
            ...
            stackOut_5_1 = ((StringBuilder) (Object) stackIn_5_1).append(stackIn_5_2).append(',').append(19753).append(',');
    ...
    public final void a(boolean param0, String param1) {
        ...
        try {
            if (!param0) {
                Object var5 = null;
                boolean discarded$0 = this.a((wk) null, (byte) -89);
            }
    ...
    public final void a(rh param0, int param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("bk.A(");
    ...
    public bk() {
        ...
        ((bk) this).field_F.a(40, -3050, var3, var5, -var5 + 496 >> 1);
    ...
    private final int a(al param0, String param1, int param2, byte param3, int param4, String param5) {
        ...
        try {
          L0: {
            stackOut_0_0 = this.a(35, 170, 70, param0, 19753, param1, param5);
            stackIn_1_0 = stackOut_0_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("bk.LA(");
            stackIn_4_0 = stackOut_2_0;
            stackIn_4_1 = stackOut_2_1;
            stackIn_3_0 = stackOut_2_0;
            stackIn_3_1 = stackOut_2_1;
          ...
          L3: {
            stackOut_8_0 = (RuntimeException) (Object) stackIn_8_0;
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(',').append(170).append(',').append(-13).append(',').append(70).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    private final boolean a(wk param0, byte param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("bk.KA(");
        ...
        try {
          L0: {
            if (!super.a((byte) -106, param1, param2, param3)) {
              ...
              if (param3 == 98) {
                stackOut_5_0 = ((bk) this).a(param2, -46);
                stackIn_6_0 = stackOut_5_0;
                return stackIn_6_0;
              } else {
                if (param3 != 99) {
                  ...
                  stackOut_8_0 = ((bk) this).a(param2, true);
                  stackIn_9_0 = stackOut_8_0;
                  return stackIn_9_0;
                }
              }
          ...
          L1: {
            ...
            stackOut_12_1 = new StringBuilder().append("bk.GA(").append(param0).append(',').append(param1).append(',');
