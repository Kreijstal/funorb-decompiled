...
final class ue {
    ...
    final static String a(int param0, CharSequence[] param1, byte param2, int param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_25_1 = new StringBuilder().append("ue.C(").append(0).append(',');
          ...
          throw sl.a((Throwable) (Object) stackIn_28_0, stackIn_28_2 + ',' + 57 + ',' + param3 + ')');
        }
        return stackIn_24_0;
    }
    ...
    final fc a(byte param0, fc param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("ue.I(").append(param0).append(',');
    ...
    final static java.net.URL a(java.net.URL param0, int param1, String param2, int param3, String param4) {
        try {
            ...
            try {
              ...
              throw sl.a((Throwable) (Object) stackIn_53_0, stackIn_53_2 + ')');
            }
    ...
    final static void a(int param0, int param1, byte param2, int param3) {
        ...
        u discarded$0 = nl.a(e.a(param1, -1932340400, var4), true, -257, param0, 0, var4, param3, param1);
    }
