    ...
    final static String a(int param0, CharSequence[] param1, byte param2, int param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_26_1 = new StringBuilder().append("ue.C(").append(param0).append(',');
          ...
          L0: {
            L1: {
              if (param0 == -37) {
                ...
                var4 = (String) null;
                discarded$2 = ue.a((java.net.URL) null, 89, (String) null, 12, (String) null);
                break L1;
              }
            }
            L2: {
