...
abstract class g extends gb {
    ...
    final static int g(int param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 10: {
                    try {
                        if ((stackIn_10_0 + cl.field_a ^ -1) < (fe.field_L ^ -1)) {
                            statePc = 15;
                        } else {
                            statePc = 11;
                        }
                ...
                case 19: {
                    ...
                    throw sl.a((Throwable) (Object) var1, "g.A(" + param0 + 41);
                }
    ...
    final static void f(int param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 12: {
                    var1 = (RuntimeException) (Object) caughtException;
                    throw sl.a((Throwable) (Object) var1, "g.C(" + param0 + 41);
                }
                case 13: {
                    return;
                }
    ...
    final static qj[] a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    try {
                        if ((var12 ^ -1) <= (var11_ref_qj__.length ^ -1)) {
                            statePc = 12;
                        } else {
                            statePc = 3;
                        }
                ...
                case 67: {
                    ...
                    throw sl.a((Throwable) (Object) var9, "g.D(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 44 + param8 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
    ...
    public static void a(byte param0) {
        try {
            ...
            throw sl.a((Throwable) (Object) runtimeException, "g.B(" + param0 + 41);
        }
    }
