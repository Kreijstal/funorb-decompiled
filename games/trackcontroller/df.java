...
final class df {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_j[var16];
                  var10 = field_c[var16] * this.field_i;
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_a, 0, field_j, 0, var2);
        int var3 = field_k[this.field_i - 1];
        ...
        for (var6 = 0; var6 < this.field_e.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = ml.field_w[this.field_d[var7]].a();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_l[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_a[incrementValue$0] = ml.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_l[this.field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    this.field_l[var4] = ml.f(3) + 1;
                    dupTemp$1 = ml.f(2);
                    this.field_b[var4] = dupTemp$1;
                    var5 = dupTemp$1;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      this.field_d[var4] = ml.f(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
