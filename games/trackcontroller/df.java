...
final class df {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((df) this).field_a.length;
        var4 = field_k[((df) this).field_i - 1];
        var5 = field_f;
        field_f[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_c[0] * ((df) this).field_i;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_j[var16];
                  var10 = field_c[var16] * ((df) this).field_i;
            ...
            L3: {
              var7 = df.a(field_j, var6);
              var8_int = df.b(field_j, var6);
              var9 = this.a(field_j[var7], field_c[var7], field_j[var8_int], field_c[var8_int], field_j[var6]);
              var10 = field_c[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean a() {
        ...
        int var2 = ((df) this).field_a.length;
        System.arraycopy((Object) (Object) ((df) this).field_a, 0, (Object) (Object) field_j, 0, var2);
        int var3 = field_k[((df) this).field_i - 1];
        int var4 = ea.b(false, var3 - 1);
        field_c[0] = ml.f(var4);
        field_c[1] = ml.f(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((df) this).field_e.length; var6++) {
            var7 = ((df) this).field_e[var6];
            var8 = ((df) this).field_l[var7];
            var9 = ((df) this).field_b[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ml.field_w[((df) this).field_d[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((df) this).field_h[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_c[incrementValue$0] = var13 >= 0 ? ml.field_w[var13].a() : 0;
            }
        }
        return true;
    }
    ...
    df() {
        ...
        if (var1 == 1) {
          var2 = ml.f(5);
          var3 = 0;
          ((df) this).field_e = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((df) this).field_l = new int[var3];
              ((df) this).field_b = new int[var3];
              ((df) this).field_d = new int[var3];
              ((df) this).field_h = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((df) this).field_i = ml.f(2) + 1;
                  var4 = ml.f(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((df) this).field_a = new int[var5];
                      ((df) this).field_a[0] = 0;
                      ((df) this).field_a[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((df) this).field_l[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((df) this).field_a[incrementValue$2] = ml.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((df) this).field_l[((df) this).field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
