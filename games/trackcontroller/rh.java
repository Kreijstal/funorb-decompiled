...
class rh extends al {
    ...
    boolean a(byte param0, char param1, al param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_10_1 = new StringBuilder().append("rh.GA(").append(param0).append(',').append(param1).append(',');
    ...
    void b(int param0, int param1, int param2, int param3) {
        if (param2 == 0) {
          if (this.field_l != null) {
            if (!(this.field_l instanceof m)) {
              return;
            } else {
              ((m) ((Object) this.field_l)).a((rh) (this), param3, param0, param1, -27322);
              return;
            }
          } else {
            return;
    ...
    boolean a(byte param0, al param1) {
        ...
        try {
                ...
                if (!this.field_C) {
                  ...
                  L2: {
                    ...
                    if (param0 <= -104) {
                      ...
                      var4 = (al) null;
                      this.a((al) null, 111, -49, 100, -115, 115, 9);
                      break L2;
                    }
                  }
                  L3: {
                    if (this.field_l == null) {
                      ...
                      if (this.field_l instanceof ah) {
                        ((ah) ((Object) this.field_l)).a(11477, (al) (this), this.field_D);
                        break L3;
                      } else {
                        return true;
                      }
          ...
          L4: {
            ...
            stackIn_15_1 = new StringBuilder().append("rh.QA(").append(param0).append(',');
    ...
    public static void i(int param0) {
        ...
        if (param0 >= -108) {
          var2 = (String) null;
          rh.a(31, (String) null, (String) null);
          field_E = null;
          return;
        } else {
          field_E = null;
    ...
    final static void a(java.applet.Applet param0, byte param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_9_1 = new StringBuilder().append("rh.KA(");
    ...
    final static boolean a(int param0, String param1, String param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_11_1 = new StringBuilder().append("rh.IA(").append(param0).append(',');
          ...
          throw sl.a((Throwable) ((Object) stackIn_12_0), stackIn_15_2 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
    ...
    boolean a(al param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
                ...
                if (this.a(param5, param6, param2, false, param1)) {
                  L1: {
                    ...
                    if (this.field_l == null) {
                      ...
                      if (this.field_l instanceof gg) {
                        ((gg) ((Object) this.field_l)).a(param2, param6, param5, param1, param3, -2278, (rh) (this));
                        break L1;
                      } else {
                        break L1;
                      }
          ...
          L2: {
            ...
            stackIn_16_1 = new StringBuilder().append("rh.R(");
          ...
          throw sl.a((Throwable) ((Object) stackIn_17_0), stackIn_17_2 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_2_0 != 0;
        } else {
    ...
    final StringBuilder a(boolean param0, Hashtable param1, StringBuilder param2, int param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_13_1 = new StringBuilder().append("rh.BB(").append(param0).append(',');
          ...
          throw sl.a((Throwable) ((Object) stackIn_14_0), stackIn_17_2 + ',' + param3 + ')');
        }
        return stackIn_10_0;
    }
    ...
    final void a(al param0, boolean param1, int param2, int param3, int param4, int param5) {
        ...
        try {
            if (this.field_l != null && this.field_l instanceof gg) {
                ((gg) ((Object) this.field_l)).a(param3, param2, param5, (rh) (this), param4, param1);
            }
            this.field_r = 0;
        } catch (RuntimeException runtimeException) {
            throw sl.a((Throwable) ((Object) runtimeException), "rh.GB(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ')');
        }
    }
    ...
    protected rh() {
        ...
        this.field_C = true;
        this.field_B = true;
        this.field_y = lb.field_O.field_g;
    }
