...
final class lf extends lb implements wk {
    ...
    public static void f(byte param0) {
        ...
        field_T = null;
        if (param0 > -33) {
          discarded$2 = lf.a(68, 38, (byte) -50, true);
          field_Y = null;
          return;
        } else {
          field_Y = null;
    ...
    final static boolean a(byte param0, la param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("lf.W(").append(param0).append(',');
    ...
    final String e(int param0) {
        ...
        if (this.field_q) {
          if (null != this.field_n) {
            if (param0 != 0) {
              discarded$2 = lf.a(34, 125, (byte) -88, true);
