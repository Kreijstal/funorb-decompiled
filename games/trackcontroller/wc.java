...
final class wc {
    ...
    public final void movemouse(int param0, int param1) {
        ((wc) this).field_a.mouseMove(param0, param1);
    }
    ...
    public wc() throws Exception {
        java.awt.Robot var2 = new java.awt.Robot();
        ((wc) this).field_a = var2;
    }
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            if (!param1) {
              if (param0 != null) {
                if (param0 != ((wc) this).field_b) {
                  if (((wc) this).field_b == null) {
                    if (param0 != null) {
                    ...
                    ((wc) this).field_b.setCursor((java.awt.Cursor) null);
