...
final class ge extends td implements jg, m {
    ...
    private final String j(int param0) {
        ...
        if (param0 != 11844) {
            int[] var3 = (int[]) null;
            discarded$0 = ge.a((int[]) null, true);
        }
        return "</col></u>";
    }
          ...
          L0: {
            ...
            L2: {
              if (param3 == 1) {
                ...
                var7 = (int[]) null;
                discarded$1 = ge.a((int[]) null, false);
                break L2;
              }
            }
            break L0;
            ...
            if (!super.a((byte) -75, param1, param2, param3)) {
              if (param3 != 98) {
                if (99 != param3) {
                  ...
                  stackOut_7_0 = this.a(param2, true);
                  stackIn_8_0 = stackOut_7_0;
                  decompiledRegionSelector0 = 2;
                  break L0;
                }
              } else {
                stackOut_4_0 = this.a(param2, 121);
    ...
    final static boolean a(int[] param0, boolean param1) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_35_1 = new StringBuilder().append("ge.F(");
