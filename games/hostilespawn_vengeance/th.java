...
final class th extends le {
    ...
    final static fn a(int param0, byte[] param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("th.B(").append(param0).append(44);
    ...
    th(long param0, le param1, le param2, pb param3) {
        ...
        try {
            ...
            throw wg.a((Throwable) (Object) runtimeException, "th.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 44 + (param3 != null ? "{...}" : "null") + 41);
        }
    }
