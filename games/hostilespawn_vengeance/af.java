...
final class af extends ug {
    ...
    final int d() {
        return ((af) this).field_w - (((af) this).field_x.available() >> (field_b ? 2 : 1));
    }

    final void c() {
        if (((af) this).field_x != null) {
            ((af) this).field_x.close();
            ((af) this).field_x = null;
        }
    }

    af() {
        ((af) this).field_v = false;
    }
    ...
    final void a(java.awt.Component param0) {
        ...
        L3: {
          ((af) this).field_y = new javax.sound.sampled.AudioFormat(stackIn_13_3, stackIn_13_4, stackIn_13_5, true, false);
          stackOut_13_0 = this;
          stackOut_13_1 = 256;
        ...
        ((af) this).field_z = new byte[stackIn_16_1 << stackIn_16_2];
    }

    final void b() throws javax.sound.sampled.LineUnavailableException {
        javax.sound.sampled.DataLine.Info var1 = null;
        ((af) this).field_x.flush();
        if (((af) this).field_v) {
            ((af) this).field_x.close();
            ((af) this).field_x = null;
            var1 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, ((af) this).field_y, ((af) this).field_w << (field_b ? 2 : 1));
            ((af) this).field_x = (javax.sound.sampled.SourceDataLine) (Object) javax.sound.sampled.AudioSystem.getLine((javax.sound.sampled.Line.Info) (Object) var1);
            ((af) this).field_x.open();
            ((af) this).field_x.start();
        }
    }
    ...
    final void a() {
        try {
            ...
            for (var2 = 0; var2 < var1; var2++) {
                var3 = ((af) this).field_u[var2];
                if ((var3 + 8388608 & -16777216) != 0) {
                    var3 = 8388607 ^ var3 >> 31;
                }
                ((af) this).field_z[var2 * 2] = (byte)(var3 >> 8);
                ((af) this).field_z[var2 * 2 + 1] = (byte)(var3 >> 16);
            }
            int discarded$0 = ((af) this).field_x.write(((af) this).field_z, 0, var1 << 1);
    ...
    final void a(int param0) throws javax.sound.sampled.LineUnavailableException {
        ...
        {
            var2 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, ((af) this).field_y, param0 << (field_b ? 2 : 1));
            ((af) this).field_x = (javax.sound.sampled.SourceDataLine) (Object) javax.sound.sampled.AudioSystem.getLine((javax.sound.sampled.Line.Info) (Object) var2);
            ((af) this).field_x.open();
            ((af) this).field_x.start();
            ((af) this).field_w = param0;
        }
    }
