...
final class af extends ug {
    ...
    final int d() {
        return this.field_w - (this.field_x.available() >> (field_b ? 2 : 1));
    }
    ...
    final void b() throws javax.sound.sampled.LineUnavailableException {
        ...
        if (this.field_v) {
            this.field_x.close();
            this.field_x = null;
            var1 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, this.field_y, this.field_w << (field_b ? 2 : 1));
    ...
    final void a(int param0) throws javax.sound.sampled.LineUnavailableException {
        ...
        try {
            var2 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, this.field_y, param0 << (field_b ? 2 : 1));
