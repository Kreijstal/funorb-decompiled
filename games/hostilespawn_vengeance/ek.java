...
final class ek {
    ...
    final int b() {
        ...
        while (this.field_d[var1] >= 0) {
            var1 = qf.b() != 0 ? this.field_d[var1] : var1 + 1;
        }
    ...
    ek() {
        ...
        L0: {
          qf.e(24);
          this.field_f = qf.e(16);
          this.field_c = qf.e(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_c) {
                ...
                var4_int = qf.e(vf.b(126, this.field_c - var2));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
          ...
          if (var2 <= 0) {
            ...
            L9: {
              ...
              if (var2 != 1) {
                ...
                var7 = ek.a(this.field_c, this.field_f);
                break L9;
              }
            }
