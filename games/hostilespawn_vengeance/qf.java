...
final class qf extends am {
    private static int field_k;
    private static float[] field_M;
    private byte[][] field_L;
    private static rk[] field_I;
    private static float[] field_y;
    private int field_J;
    private static rm[] field_q;
    private int field_x;
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = kd.a((byte) 117, var10, var11);
                            var11++;
                            continue L12;
                          }
                        }
          ...
          if (var17_int >= var14.field_a) {
            L10: {
              if (var15 != 0) {
                ...
                field_q[var18_int].a(field_r, var4 >> 1);
                break L10;
              }
            }
            L11: {
    ...
    final static int e(int param0) {
        ...
        while (param0 >= 8 - field_O) {
            var3 = 8 - field_O;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_F[field_k] >> field_O & var4) << var2);
            field_O = 0;
            field_k = field_k + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_F[field_k] >> field_O & var3) << var2);
            field_O = field_O + param0;
        }
        return var1;
    }

    private final static boolean a(gb param0) {
        byte[] var1 = null;
        if (!field_K) {
    ...
    private qf(byte[] param0) throws IOException {
        this.b(param0);
    }

    final static int b() {
        int var0 = field_F[field_k] >> field_O & 1;
        field_O = field_O + 1;
