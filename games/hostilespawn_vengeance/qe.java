...
final class qe implements pd {
    ...
    public qe() throws Exception {
        int var1 = 0;
        ((qe) this).field_b = new com.ms.directX.DSBufferDesc[2];
        ((qe) this).field_a = new com.ms.directX.DSCursors[2];
        ...
        for (var1 = 0; var1 < 2; var1++) {
            ((qe) this).field_b[var1] = new com.ms.directX.DSBufferDesc();
        }
        for (var1 = 0; var1 < 2; var1++) {
            ((qe) this).field_a[var1] = new com.ms.directX.DSCursors();
        }
    }
}
