...
final class b extends tj {
    ...
    final synchronized void e(int param0) {
        int var2 = ((jb) ((Object) this.field_j)).field_k.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
    ...
    final int a() {
        int var1 = this.field_z * 3 >> 6;
        var1 = (var1 ^ var1 >> 31) + (var1 >>> 31);
        if (this.field_s == 0) {
            var1 = var1 - var1 * this.field_n / (((jb) ((Object) this.field_j)).field_k.length << 8);
        } else {
            if (this.field_s >= 0) {
                var1 = var1 - var1 * this.field_u / ((jb) ((Object) this.field_j)).field_k.length;
            }
        }
          ...
          if (this.field_t <= 0) {
            L1: {
              if (this.field_x != -256) {
                ...
                if ((this.field_n & 255) != 0) {
                  break L1;
                } else {
                  if (ug.field_b) {
                    return b.b(0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_v, this.field_w, 0, param3, param2, (b) (this));
                  } else {
                    return b.b(((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_z, 0, param3, param2, (b) (this));
                  }
                }
              }
            }
            if (ug.field_b) {
              return b.d(0, 0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_v, this.field_w, 0, param3, param2, (b) (this), this.field_x, param4);
            } else {
              return b.b(0, 0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_z, 0, param3, param2, (b) (this), this.field_x, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_x != -256) {
                  ...
                  if ((this.field_n & 255) != 0) {
                    ...
                    if (!ug.field_b) {
                      param1 = b.a(((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_z, this.field_l, 0, var6, param2, (b) (this));
                      break L3;
                    } else {
                      param1 = b.a(0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_v, this.field_w, this.field_y, this.field_q, 0, var6, param2, (b) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!ug.field_b) {
                param1 = b.b(0, 0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_z, this.field_l, 0, var6, param2, (b) (this), this.field_x, param4);
                break L3;
              } else {
                param1 = b.b(0, 0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_v, this.field_w, this.field_y, this.field_q, 0, var6, param2, (b) (this), this.field_x, param4);
                break L3;
              }
            }
            this.field_t = this.field_t - param1;
    ...
    final synchronized int k() {
        return this.field_r == -2147483648 ? 0 : this.field_r + 32 >> 6;
    }

    private final void g() {
        this.field_z = this.field_r;
        this.field_v = b.a(this.field_r, this.field_o);
        this.field_w = b.c(this.field_r, this.field_o);
    }
    ...
    private final boolean l() {
        ...
        L0: {
          var1 = this.field_r;
          if (var1 != -2147483648) {
            var2 = b.a(var1, this.field_o);
            var3 = b.c(var1, this.field_o);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_z >= var1) {
            if (this.field_z <= var1) {
              ...
              this.field_l = -1;
              this.field_t = this.field_z - var1;
              break L2;
            }
          } else {
            this.field_l = 1;
            this.field_t = var1 - this.field_z;
            break L2;
          }
        }
        L3: {
          if (this.field_v >= var2) {
            if (this.field_v <= var2) {
              ...
              L4: {
                ...
                if (this.field_t == 0) {
                  ...
                  if (this.field_t <= this.field_v - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_t = this.field_v - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_t == 0) {
                ...
                if (this.field_t <= var2 - this.field_v) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_t = var2 - this.field_v;
            break L3;
          }
        }
        if (this.field_w < var3) {
          this.field_q = 1;
          if (this.field_t != 0) {
            if (this.field_t > var3 - this.field_w) {
              this.field_t = var3 - this.field_w;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_w <= var3) {
              ...
              L7: {
                ...
                if (this.field_t == 0) {
                  ...
                  if (this.field_t <= this.field_w - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_t = this.field_w - var3;
              break L6;
            }
          }
          return false;
          ...
          if (this.field_v == var4) {
            if (this.field_w == var5) {
              ...
              L0: {
                ...
                if (this.field_z - param1 <= var6) {
                  break L0;
                } else {
                  var6 = this.field_z - param1;
                  break L0;
                }
              }
              L1: {
              ...
              this.field_r = param1;
              this.field_o = param2;
              this.field_l = (param1 - this.field_z) / param0;
              this.field_y = (var4 - this.field_v) / param0;
              this.field_q = (var5 - this.field_w) / param0;
              return;
            }
          } else {
            L6: {
        ...
        L0: {
          if (this.field_t <= 0) {
            ...
            if (param0 < this.field_t) {
              this.field_z = this.field_z + this.field_l * param0;
              this.field_v = this.field_v + this.field_y * param0;
              ...
              if (!this.field_p) {
                L6: {
                  if (this.field_x >= 0) {
                    if (this.field_n >= var4) {
                      var7 = (this.field_n - var3) / var6;
                      if (var7 < this.field_s) {
                        this.field_n = this.field_n - var6 * var7;
                        this.field_s = this.field_s - var7;
                        break L6;
                      } else {
                        this.field_n = this.field_n - var6 * this.field_s;
                        this.field_s = 0;
                        break L5;
                      }
                    } else {
                ...
                L7: {
                  if (this.field_x >= 0) {
                    ...
                    if (this.field_n < var3) {
                      this.field_n = var3 + var3 - 1 - this.field_n;
                      this.field_x = -this.field_x;
                ...
                L8: while (true) {
                  if (this.field_n >= var4) {
                    this.field_n = var4 + var4 - 1 - this.field_n;
                    this.field_x = -this.field_x;
          ...
          if (!this.field_p) {
            if (this.field_x >= 0) {
              if (this.field_n < var4) {
                ...
                this.field_n = var3 + (this.field_n - var3) % var6;
                return;
              }
            } else {
              if (this.field_n < var3) {
                this.field_n = var4 - 1 - (var4 - 1 - this.field_n) % var6;
                return;
              } else {
                return;
              }
        ...
        if (param0 != 0) {
          if (this.field_v == 0) {
            if (this.field_w == 0) {
              ...
              this.field_l = -this.field_z / param0;
              this.field_y = -this.field_v / param0;
              this.field_q = -this.field_w / param0;
              return;
            }
          } else {
            L6: {
    ...
    final synchronized boolean j() {
        return this.field_n < 0 || this.field_n >= ((jb) ((Object) this.field_j)).field_k.length << 8;
    }
        ...
        L0: while (true) {
          if (this.field_t <= 0) {
            L1: {
              if (this.field_x != 256) {
                ...
                if ((this.field_n & 255) != 0) {
                  ...
                  if (ug.field_b) {
                    return b.a(0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_v, this.field_w, 0, param3, param2, (b) (this));
                  } else {
                    return b.a(((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_z, 0, param3, param2, (b) (this));
                  }
                }
              }
            }
            if (ug.field_b) {
              return b.c(0, 0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_v, this.field_w, 0, param3, param2, (b) (this), this.field_x, param4);
            } else {
              return b.a(0, 0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_z, 0, param3, param2, (b) (this), this.field_x, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_t;
            ...
            L3: {
              L4: {
                ...
                if (this.field_x != 256) {
                  ...
                  if ((this.field_n & 255) != 0) {
                    ...
                    if (!ug.field_b) {
                      param1 = b.b(((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_z, this.field_l, 0, var6, param2, (b) (this));
                      break L3;
                    } else {
                      param1 = b.b(0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_v, this.field_w, this.field_y, this.field_q, 0, var6, param2, (b) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!ug.field_b) {
                param1 = b.a(0, 0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_z, this.field_l, 0, var6, param2, (b) (this), this.field_x, param4);
                break L3;
              } else {
                param1 = b.a(0, 0, ((jb) ((Object) this.field_j)).field_k, param0, this.field_n, param1, this.field_v, this.field_w, this.field_y, this.field_q, 0, var6, param2, (b) (this), this.field_x, param4);
                break L3;
              }
            }
            this.field_t = this.field_t - param1;
    ...
    final int c() {
        if (this.field_r == 0 && this.field_t == 0) {
            return 0;
        }
        return 1;
    }
              ...
              if (!this.field_p) {
                if (this.field_x >= 0) {
                  L5: while (true) {
                    ...
                    if (this.field_n >= var6) {
                      var10 = (this.field_n - var5) / var8;
                      if (var10 < this.field_s) {
                        this.field_n = this.field_n - var8 * var10;
                        this.field_s = this.field_s - var10;
                        continue L5;
                      } else {
                        this.field_n = this.field_n - var8 * this.field_s;
                        this.field_s = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_k[this.field_m - 1]);
                    if (this.field_n < var5) {
                      var10 = (var6 - 1 - this.field_n) / var8;
                      if (var10 < this.field_s) {
                        this.field_n = this.field_n + var8 * var10;
                        this.field_s = this.field_s - var10;
                        continue L6;
                ...
                L7: {
                  if (this.field_x >= 0) {
                    ...
                    if (this.field_n < var5) {
                      this.field_n = var5 + var5 - 1 - this.field_n;
                      this.field_x = -this.field_x;
                      fieldTemp$0 = this.field_s - 1;
                      this.field_s = this.field_s - 1;
                      if (fieldTemp$0 != 0) {
                ...
                L8: while (true) {
                  var9 = this.a(param0, var9, var6, param2, (int) var4.field_k[this.field_m - 1]);
                  if (this.field_n >= var6) {
                    this.field_n = var6 + var6 - 1 - this.field_n;
                    this.field_x = -this.field_x;
                    fieldTemp$1 = this.field_s - 1;
                    this.field_s = this.field_s - 1;
                    if (fieldTemp$1 != 0) {
          ...
          if (!this.field_p) {
            if (this.field_x >= 0) {
              L10: while (true) {
                var9 = this.a(param0, var9, var6, param2, (int) var4.field_k[this.field_u]);
                if (this.field_n >= var6) {
                  this.field_n = var5 + (this.field_n - var5) % var8;
                  continue L10;
                } else {
                  return;
                }
              ...
              L11: while (true) {
                var9 = this.b(param0, var9, var5, param2, (int) var4.field_k[this.field_m - 1]);
                if (this.field_n < var5) {
                  this.field_n = var6 - 1 - (var6 - 1 - this.field_n) % var8;
                  continue L11;
                } else {
                  return;
                }
