                    ...
                    if (!this.a(121, param1)) {
                      if (0 < var7.length()) {
                        if (kc.a(var6, true, var7)) {
                          stackOut_22_0 = jc.field_e;
                          stackIn_23_0 = stackOut_22_0;
                          return stackIn_23_0;
                        } else {
                          if (!vh.a(var7, 29360, var6)) {
                            if (!eg.a(false, var7, var6)) {
                              stackOut_30_0 = ei.field_k;
                              stackIn_31_0 = stackOut_30_0;
                              break L0;
                            } else {
                              stackOut_28_0 = jc.field_e;
                              stackIn_29_0 = stackOut_28_0;
                              return stackIn_29_0;
                            }
                          } else {
                            stackOut_25_0 = dc.field_c;
                            stackIn_26_0 = stackOut_25_0;
                            return stackIn_26_0;
                          }
                        }
                      } else {
                        stackOut_18_0 = l.field_b;
    ...
    final static String a(byte[] param0, int param1, byte param2, int param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_19_1 = new StringBuilder().append("db.E(");
    ...
    final bm a(String param0, byte param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_11_1 = new StringBuilder().append("db.L(");
