...
final class jh extends wb implements qk {
    ...
    final static void b(int param0, int param1) {
        ...
        try {
          L0: {
            var4 = (cl) (Object) ne.field_q.g(-101);
            L1: while (true) {
              if (var4 == null) {
                break L0;
              } else {
    ...
    final static void a(int param0, byte[] param1) {
        ...
        try {
          L0: {
            var16 = new vi(param1);
            var17 = var16;
            var17.field_i = param1.length + -2;
            sc.field_c = var17.e(8);
            ...
            var17.field_i = -(sc.field_c * 8) + (-7 + param1.length);
            ra.field_a = var17.e(8);
            vc.field_e = var17.e(8);
            var3 = 1 + (255 & var17.l(32270));
            var4 = 0;
            L1: while (true) {
              if (sc.field_c <= var4) {
                var4 = 0;
                  ...
                  if (var4 >= sc.field_c) {
                    ...
                    L3: while (true) {
                      if (var4 >= sc.field_c) {
                        ...
                        L4: while (true) {
                          if (var4 >= sc.field_c) {
                            var17.field_i = 3 + -(var3 * 3) + param1.length - (7 - -(8 * sc.field_c));
                                ...
                                L6: while (true) {
                                  if (var4 >= sc.field_c) {
                                    ...
                                    L7: {
                                      ...
                                      var18 = var20;
                                      var8 = var18;
                                      ja.field_e[var4] = var24;
                                      var25 = new byte[var7];
                                      var23 = var25;
                                      var21 = var23;
                                      var19 = var21;
                                      var9 = var19;
                                      vh.field_a[var4] = var25;
                                      var10 = 0;
                                      var11 = var17.l(32270);
                                      if ((1 & var11) == 0) {
                                        var12 = 0;
                        ...
                        sf.field_X[var4] = var17.e(bm.a(-26869, -26877));
                        var4++;
                        continue L3;
                      }
                    }
                ...
                th.field_Jb[var4] = var16.e(bm.a(-26869, -26877));
                var4++;
                continue L1;
              }
            }
    ...
    final static bd[] a(bd[] param0, int param1, int param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_6_1 = new StringBuilder().append("jh.A(");
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
