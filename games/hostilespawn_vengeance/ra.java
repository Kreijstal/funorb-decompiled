...
final class ra implements nn {
    ...
    final static void a(int param0, int[] param1, int param2, oj param3, int[] param4) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_4_1 = new StringBuilder().append("ra.A(").append(1).append(44);
    ...
    public final void a(int param0, int param1, int param2, ag param3, boolean param4) {
        ...
        try {
          L0: {
            ...
            if (param2 == 15430) {
              ...
              if (((ra) this).field_l != null) {
                ...
                int discarded$1 = ((ra) this).field_l.a(param3.field_n, param1 + param3.field_v - -var13, param0 + param3.field_m - -((ra) this).field_k, param3.field_s - ((ra) this).field_c - var13, param3.field_x - (((ra) this).field_c << 1), ((ra) this).field_d, ((ra) this).field_m, 1, 1, 0);
                break L0;
              } else {
                return;
              }
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("ra.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    ra(vm param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7) {
        try {
            ...
            throw wg.a((Throwable) (Object) runtimeException, "ra.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 41);
        }
    }
