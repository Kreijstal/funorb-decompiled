    ...
    final static void a(int param0, int[] param1, int param2, oj param3, int[] param4) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_4_1 = new StringBuilder().append("ra.A(").append(1).append(',');
    ...
    public final void a(int param0, int param1, int param2, ag param3, boolean param4) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("ra.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
