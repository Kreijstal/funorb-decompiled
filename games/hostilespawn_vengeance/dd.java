...
final class dd extends ql {
    ...
    final String a(boolean param0) {
        if (param0) {
            String discarded$0 = ((dd) this).a(false);
        }
        if (!(9 != ha.field_t)) {
            return jk.field_a;
        }
    ...
    final static void g(int param0) {
                ...
                if (0 <= ul.field_L) {
                    ...
                    if (dn.field_i == of.field_d) {
                      ...
                      L5: while (true) {
                        if (~var9.length >= ~var2) {
                          ...
                          var10 = var9[var2];
                          boolean discarded$4 = var10.a(32669);
                          var2++;
                          continue L5;
                        }
                      }
                  ...
                  L6: {
                    if (ul.field_L != 0) {
                      ...
                      if (mm.field_m[0].field_j.field_e > 43) {
                        break L6;
                      } else {
                        if (58 >= mm.field_m[0].field_j.field_g) {
                          ul.field_L = 1;
                          var11 = new oc(42, 52);
                          mm.field_m[el.field_j] = new oj(var11, 6, rl.field_c);
                          ln.field_a.field_c[var11.b(-4)] = 3;
                  ...
                  L7: {
                    if (ul.field_L != 0) {
                      ...
                      if (mm.field_m[0].field_j.field_e < 48) {
                        break L7;
                      } else {
                        if (mm.field_m[0].field_j.field_g > 56) {
                          break L7;
                        } else {
                          ul.field_L = 2;
                          var12 = new oc(42, 52);
                          mm.field_m[el.field_j] = new oj(var12, 6, rl.field_c);
                          ln.field_a.field_c[var12.b(-4)] = 3;
                          el.field_j = el.field_j + 1;
                          break L7;
                        }
                      }
                  ...
                  L8: {
                    if (ul.field_L != 0) {
                      ...
                      L9: {
                        var1_int = -uj.field_p.field_e + 888;
                        var2 = -uj.field_p.field_g + 1220;
                        var3 = 320;
                        var1_int -= 64;
                        var4 = 102;
                        si.d(-16 + (var3 / 2 + var1_int), 39 + (var4 + var2), var3 / 2 + (var1_int + 16), 42 + var2 + var4);
                        stackOut_39_0 = var1_int + (var3 / 2 - 3);
                        stackOut_39_1 = 39 + (var2 + var4);
                        stackOut_39_2 = 32;
                        stackOut_39_3 = 65280;
                      ...
                      L10: {
                        si.f(stackIn_42_0, stackIn_42_1, stackIn_42_2, stackIn_42_3, stackIn_42_4 >> 4);
                        stackOut_42_0 = 2 + (var1_int + var3 / 2);
                        stackOut_42_1 = var2 + var4 - -39;
                        stackOut_42_2 = 32;
                        stackOut_42_3 = 16711680;
                      ...
                      L11: {
                        si.f(stackIn_45_0, stackIn_45_1, stackIn_45_2, stackIn_45_3, stackIn_45_4 >> 4);
                        stackOut_45_0 = var1_int + var3 / 2 + -3;
                        stackOut_45_1 = 39 + var2 + var4;
                        stackOut_45_2 = 24;
                        stackOut_45_3 = 65280;
                      ...
                      L12: {
                        si.f(stackIn_48_0, stackIn_48_1, stackIn_48_2, stackIn_48_3, stackIn_48_4 >> 4);
                        stackOut_48_0 = 2 + (var1_int + var3 / 2);
                        stackOut_48_1 = var4 + (var2 - -39);
                        stackOut_48_2 = 24;
                        stackOut_48_3 = 16711680;
                      ...
                      L13: {
                        si.f(stackIn_51_0, stackIn_51_1, stackIn_51_2, stackIn_51_3, stackIn_51_4 >> 4);
                        stackOut_51_0 = -3 + (var1_int + var3 / 2);
                        stackOut_51_1 = 39 + var2 + var4;
                        stackOut_51_2 = 16;
                        stackOut_51_3 = 65280;
                      ...
                      L14: {
                        si.f(stackIn_54_0, stackIn_54_1, stackIn_54_2, stackIn_54_3, stackIn_54_4 >> 4);
                        stackOut_54_0 = 2 + var1_int - -(var3 / 2);
                        stackOut_54_1 = 39 + (var2 + var4);
                        stackOut_54_2 = 16;
                        stackOut_54_3 = 16711680;
                      ...
                      L15: {
                        si.f(stackIn_57_0, stackIn_57_1, stackIn_57_2, stackIn_57_3, stackIn_57_4 >> 4);
                        si.d(0, 42 + (var4 + var2), 640, 480);
                        stackOut_57_0 = -3 + (var3 / 2 + var1_int);
                        stackOut_57_1 = 39 + var4 + var2;
                        stackOut_57_2 = 32;
                        stackOut_57_3 = 65280;
                      ...
                      L16: {
                        si.f(stackIn_60_0, stackIn_60_1, stackIn_60_2, stackIn_60_3, stackIn_60_4 >> 4);
                        stackOut_60_0 = var3 / 2 + (var1_int + 2);
                        stackOut_60_1 = var2 + (var4 + 39);
                        stackOut_60_2 = 32;
                        stackOut_60_3 = 16711680;
                      ...
                      L17: {
                        si.f(stackIn_63_0, stackIn_63_1, stackIn_63_2, stackIn_63_3, stackIn_63_4 >> 4);
                        stackOut_63_0 = var1_int - -(var3 / 2) - 3;
                        stackOut_63_1 = var2 - -var4 + 39;
                        stackOut_63_2 = 24;
                        stackOut_63_3 = 65280;
                      ...
                      L18: {
                        si.f(stackIn_66_0, stackIn_66_1, stackIn_66_2, stackIn_66_3, stackIn_66_4 >> 4);
                        stackOut_66_0 = 2 + var1_int + var3 / 2;
                        stackOut_66_1 = 39 + (var2 + var4);
                        stackOut_66_2 = 24;
                        stackOut_66_3 = 16711680;
                      ...
                      L19: {
                        si.f(stackIn_69_0, stackIn_69_1, stackIn_69_2, stackIn_69_3, stackIn_69_4 >> 4);
                        stackOut_69_0 = var1_int + (var3 / 2 - 3);
                        stackOut_69_1 = var4 + (var2 + 39);
                        stackOut_69_2 = 16;
                        stackOut_69_3 = 65280;
                      ...
                      L20: {
                        si.f(stackIn_72_0, stackIn_72_1, stackIn_72_2, stackIn_72_3, stackIn_72_4 >> 4);
                        stackOut_72_0 = 2 + (var3 / 2 + var1_int);
                        stackOut_72_1 = var4 + (var2 + 39);
                        stackOut_72_2 = 16;
                        stackOut_72_3 = 16711680;
                      ...
                      L21: {
                        si.f(stackIn_75_0, stackIn_75_1, stackIn_75_2, stackIn_75_3, stackIn_75_4 >> 4);
                        si.d(0, var2 + var4 + 38, 640, 480);
                        stackOut_75_0 = -3 + (var1_int + var3 / 2);
                        stackOut_75_1 = var4 + var2 - -39;
                        stackOut_75_2 = 4;
                        stackOut_75_3 = 65280;
                      ...
                      L22: {
                        si.f(stackIn_78_0, stackIn_78_1, stackIn_78_2, stackIn_78_3, stackIn_78_4 >> 1);
                        stackOut_78_0 = 2 + var1_int + var3 / 2;
                        stackOut_78_1 = 39 + (var2 - -var4);
                        stackOut_78_2 = 4;
                        stackOut_78_3 = 16711680;
                      ...
                      L23: {
                        si.f(stackIn_81_0, stackIn_81_1, stackIn_81_2, stackIn_81_3, stackIn_81_4 >> 1);
                        stackOut_81_0 = -3 + (var1_int - -(var3 / 2));
                        stackOut_81_1 = var2 + var4 - -39;
                        stackOut_81_2 = 2;
                        stackOut_81_3 = 16777215;
                      ...
                      L24: {
                        si.f(stackIn_84_0, stackIn_84_1, stackIn_84_2, stackIn_84_3, stackIn_84_4 >> 1);
                        stackOut_84_0 = 2 + var3 / 2 + var1_int;
                        stackOut_84_1 = 39 + (var4 + var2);
                        stackOut_84_2 = 2;
                        stackOut_84_3 = 16777215;
                      ...
                      si.f(stackIn_87_0, stackIn_87_1, stackIn_87_2, stackIn_87_3, stackIn_87_4 >> 1);
                      si.c();
                      break L8;
                    }
                  }
                  L25: {
                    ...
                    var13 = new oc(42, 52);
                    if (ln.field_a.field_c[var13.b(-4)] != 3) {
                      ul.field_L = 3;
                      break L25;
                    } else {
                      break L25;
                  ...
                  L27: {
                    if (1 == ul.field_L) {
                      L28: {
                        var1_int = -32 + (-uj.field_p.field_e + 897);
                        var2 = 425 + -uj.field_p.field_g + 710;
                        var3 = 256;
                        var4 = 70;
                        var5 = 14;
                        stackOut_96_0 = -var5 + (var3 / 2 + var1_int - -3);
                        stackOut_96_1 = var2 + (var4 - (-55 + var5));
                        stackOut_96_2 = var5 << 1;
                        stackOut_96_3 = var5 << 1;
                      ...
                      L29: {
                        si.a(stackIn_99_0, stackIn_99_1, stackIn_99_2, stackIn_99_3, stackIn_99_4, stackIn_99_5 >> 1);
                        var5 = 15;
                        stackOut_99_0 = -var5 + 3 + var1_int - -(var3 / 2);
                        stackOut_99_1 = 55 + var4 + (var2 - var5);
                        stackOut_99_2 = var5 << 1;
                        stackOut_99_3 = var5 << 1;
                        stackOut_99_4 = 16711680;
                      ...
                      L30: {
                        si.a(stackIn_102_0, stackIn_102_1, stackIn_102_2, stackIn_102_3, stackIn_102_4, stackIn_102_5 >> 2);
                        var5 = 16;
                        stackOut_102_0 = 3 + (var3 / 2 + (var1_int - var5));
                        stackOut_102_1 = 55 + (var4 + var2) + -var5;
                        stackOut_102_2 = var5 << 1;
                        stackOut_102_3 = var5 << 1;
                        stackOut_102_4 = 16711680;
                      ...
                      si.a(stackIn_105_0, stackIn_105_1, stackIn_105_2, stackIn_105_3, stackIn_105_4, stackIn_105_5 >> 3);
                      break L27;
                    } else {
                      break L27;
                    }
                  ...
                  L31: {
                    if (ul.field_L != 3) {
                      ...
                      if (mm.field_m[0].field_j.field_e > 42) {
                        break L31;
                      } else {
                        if (mm.field_m[0].field_j.field_g > 49) {
                          break L31;
                        } else {
                          ul.field_L = 4;
                          break L31;
                  ...
                  L33: {
                    if (ul.field_L != 5) {
                      ...
                      if (50 > mm.field_m[0].field_j.field_e) {
                        break L33;
                      } else {
                        ul.field_L = 10;
                        break L33;
                  ...
                  L34: {
                    if (ul.field_L != 10) {
                      ...
                      if (mm.field_m[0].field_j.field_e != 63) {
                        break L34;
                      } else {
                        if (mm.field_m[0].field_j.field_g <= 30) {
                          ul.field_L = 11;
                          break L34;
                        } else {
                          break L34;
                  ...
                  L35: {
                    if (ul.field_L != 10) {
                      ...
                      if (mm.field_m[0].field_j.field_e != 77) {
                        break L35;
                      } else {
                        if (mm.field_m[0].field_j.field_g >= 43) {
                          ul.field_L = 12;
                          break L35;
                        } else {
                          break L35;
                  ...
                  L36: {
                    if (ul.field_L < 10) {
                      ...
                      if (12 < ul.field_L) {
                        ...
                        if (mm.field_m[0].field_j.field_e < 82) {
                          break L36;
                        } else {
                          if (mm.field_m[0].field_j.field_g >= 30) {
                            ul.field_L = 13;
              ...
              if (bm.field_c == 0) {
                L39: {
                  if (tg.field_a) {
                    ...
                    if (mm.field_m[0].field_j.field_e >= 35) {
                      break L39;
                    } else {
                      boolean discarded$5 = vg.field_e[0].a((byte) -74);
                      break L39;
                    }
                  }
                }
                if (!tg.field_a) {
                  ...
                  if (of.field_d == dn.field_i) {
                    ...
                    boolean discarded$6 = vg.field_e[1].a((byte) -50);
                    break L2;
                  }
                }
              } else {
          ...
          if (rl.field_c != 3) {
            ...
            if (bm.field_c == 0) {
              if (ng.field_u >= 1500) {
                ...
                boolean discarded$7 = vg.field_e[0].a((byte) -71);
                break L2;
              }
            } else {
              break L2;
        ...
        L40: {
          if (q.field_g != null) {
            q.field_g.b((byte) 115);
            break L40;
          } else {
            break L40;
          }
        }
        var1_int = -98 / ((param0 - -81) / 35);
    }
    ...
    final void c(int param0) {
        ...
        if (param0 != 0) {
            ((dd) this).field_d = null;
        }
        int var2 = 1;
        for (var3 = 1; 8 > var3; var3++) {
            if (!kh.field_Q[var3]) {
                var2 = 0;
                break;
            }
        ...
        if (var2 != 0) {
            ti.a(230, (byte) -111, 25);
        }
    }

    final void b(byte param0) {
        int var2 = -99 / ((-48 - param0) / 38);
        if (((dd) this).field_d.field_l > 0) {
            if (!((dd) this).field_d.a((byte) -87)) {
                ((dd) this).field_d.field_l = -1;
            }
        }
        if (((dd) this).field_p.field_l > 0) {
            if (!(((dd) this).field_p.a((byte) -65))) {
                ((dd) this).field_p.field_l = -1;
            }
        }
    }
    ...
    final void e(int param0) {
        ...
        var6 = var8;
        var2 = var6;
        ((dd) this).field_l = new oc(var11[0], var11[1]);
        ((dd) this).field_f = new oc(var11[2], var11[3]);
        ((dd) this).field_m = new oc(var11[4], var11[5]);
        var3 = 0;
        L0: while (true) {
          if (((dd) this).field_h.length <= var3) {
            ((dd) this).field_d = new v(ta.field_kb, 0, 24 * ((dd) this).field_m.field_g - 168, 200);
            ((dd) this).field_d.field_l = 0;
            ((dd) this).field_p = new v(vi.field_o, 0, 0, 200);
            ((dd) this).field_p.field_l = 0;
            var3 = param0;
            var4 = 0;
            L1: while (true) {
              if (el.field_j <= var4) {
                ((dd) this).field_k = new oc();
                var7 = 0;
                var4 = var7;
                L2: while (true) {
                  if (var7 >= ll.field_a) {
                    L3: {
                      kd.a(9, param0 ^ 1);
                      nh.field_E.a((byte) 46, ((dd) this).field_l);
                      if (om.field_b) {
                        mm.field_m[0].field_j.a((byte) 46, ((dd) this).field_l);
                        kh.field_Q[1] = true;
                        kh.field_U[0] = 1;
                        kh.field_ib[0] = 420;
                        break L3;
                    ...
                    if (wh.field_b[var7].field_i == 0) {
                      if (wh.field_b[var7].field_h == 4) {
                        ((dd) this).field_k.a((byte) 46, wh.field_b[var7].field_j);
                        var7++;
                        continue L2;
                      } else {
                        var7++;
                ...
                L4: {
                  if (mm.field_m[var4].field_i == 22) {
                    break L4;
                  } else {
                    if (mm.field_m[var4].field_i == 5) {
                      break L4;
                    } else {
                      var4++;
                      continue L1;
                ...
                var3++;
                ((dd) this).field_e[incrementValue$1] = mm.field_m[var4];
                var4++;
                continue L1;
              }
            }
          } else {
            ((dd) this).field_h[var3] = new oc(var6[10 + 2 * var3], var6[1 + (10 - -(2 * var3))]);
            var3++;
            continue L0;
          }
        }
    ...
    final void d(int param0) {
        ...
        L0: {
          ...
          if (((dd) this).field_d.field_l != 0) {
            ...
            var3 = ih.a(var8, (byte) -77, ((dd) this).field_m);
            if (var3 <= 4) {
              ((dd) this).field_d.field_l = ((dd) this).field_m.field_e * 24 + 24;
              break L0;
            } else {
              break L0;
            }
        ...
        L1: {
          if (((dd) this).field_p.field_l == 0) {
            var4_int = 0;
            L2: while (true) {
              if (var4_int >= ((dd) this).field_h.length) {
                break L1;
              } else {
                var3 = ih.a(var8, (byte) -102, ((dd) this).field_h[var4_int]);
                if (var3 < 2) {
                  L3: {
                    if (var4_int >= 4) {
                      ((dd) this).field_p.field_l = -200 + 24 * (-2 + ((dd) this).field_h[var4_int].field_e);
                      break L3;
                    } else {
                      ((dd) this).field_p.field_l = (((dd) this).field_h[var4_int].field_e + 2) * 24;
                      break L3;
                    }
                  }
                  if ((1 & var4_int) == 0) {
                    ((dd) this).field_p.field_d = ((dd) this).field_h[var4_int].field_g * 24;
                    var4_int++;
                    continue L2;
                  } else {
                    ((dd) this).field_p.field_d = -24 + ((dd) this).field_h[var4_int].field_g * 24;
                    var4_int++;
                    continue L2;
                  }
                } else {
        ...
        L4: {
          L5: {
            if (9 != ha.field_t) {
              ...
              if (!((dd) this).field_g) {
                var3 = ih.a(var8, (byte) -117, ((dd) this).field_l);
                if (var3 < 2) {
                  ((dd) this).field_g = true;
                  ca.a((double)(((dd) this).field_l.field_e + 1), 0, (double)((dd) this).field_l.field_g + 1.5, true, 128);
                  break L4;
                } else {
                  break L4;
                }
          ...
          if (ha.field_t != 9) {
            ...
            if (!((dd) this).field_g) {
              ...
              if (of.field_d == dn.field_i) {
                ...
                ti.a(236, (byte) 103, 19);
                kd.a(0, 1);
                nh.field_E.a((byte) 46, ((dd) this).field_f);
                ((dd) this).field_d.field_l = -1;
                ((dd) this).field_p.field_l = -1;
                var4 = ((dd) this).field_e;
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4.length) {
                    break L4;
        ...
        L7: {
          if (9 != ha.field_t) {
            ...
            ((dd) this).field_e[1].field_I = ((dd) this).field_e[1].field_x;
            ((dd) this).field_e[7].field_I = ((dd) this).field_e[7].field_x;
            ((dd) this).field_e[8].field_I = ((dd) this).field_e[8].field_x;
            break L7;
          }
        }
        L8: {
          L9: {
            if (ha.field_t == param0) {
              if (nh.field_E.field_g + -1 <= var8.field_g) {
                if (1 + nh.field_E.field_g >= var8.field_g) {
                  if (var8.field_e == 1 + nh.field_E.field_e) {
                    mf.a(false, 2);
                    break L9;
                  } else {
                    if ((ng.field_u & 15) != 0) {
                      ...
                      if (((dd) this).field_g) {
                        ...
                        boolean discarded$4 = ((dd) this).a(((dd) this).field_k, param0);
                        break L8;
                      }
                    }
                  }
                  ...
                  if ((ng.field_u & 15) != 0) {
                    ...
                    if (((dd) this).field_g) {
                      ...
                      boolean discarded$5 = ((dd) this).a(((dd) this).field_k, param0);
                      break L8;
                    }
                  }
                }
                ...
                if (-1 != (ng.field_u & 15)) {
                  ...
                  if (((dd) this).field_g) {
                    ...
                    boolean discarded$6 = ((dd) this).a(((dd) this).field_k, param0);
                    break L8;
                  }
                }
              }
          ...
          if ((ng.field_u & 15) != 0) {
            ...
            if (((dd) this).field_g) {
              ...
              boolean discarded$7 = ((dd) this).a(((dd) this).field_k, param0);
              break L8;
            }
          }
        }
    ...
    public dd() {
        ((dd) this).field_h = new oc[6];
        ((dd) this).field_e = new oj[10];
    }
    ...
    private static void $cfr$clinit() {
        field_o = new int[][]{new int[7], new int[1], new int[3], new int[0], new int[2], new int[5], new int[2], new int[1], new int[2], new int[2], new int[2], new int[1], new int[1], new int[2], new int[2], new int[2], new int[3], new int[4]};
    }
}
