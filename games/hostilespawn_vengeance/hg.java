    ...
    final static void a(byte[] param0, int param1, int param2, int param3, vi param4, java.math.BigInteger param5, java.math.BigInteger param6) {
        ...
        try {
              ...
              if (4 <= var9) {
                ...
                L5: {
                  L6: {
                    ...
                    bb.field_f.a(param2, param0, true, 0);
                    bb.field_f.g(var7_int, -122);
                    bb.field_f.a(var15, (byte) 108);
                    if (tb.field_M == null) {
                      break L6;
                    } else {
                      if (tb.field_M.field_n.length < 100) {
                        break L6;
                      } else {
                        break L5;
                      }
          ...
          L8: {
            ...
            stackOut_21_1 = new StringBuilder().append("hg.A(");
          ...
          L9: {
            ...
            stackOut_24_1 = ((StringBuilder) (Object) stackIn_24_1).append(stackIn_24_2).append(44).append(-120).append(44).append(param2).append(44).append(0).append(44);
        ...
        try {
          L0: {
            if (dl.field_l) {
              ...
              var13 = mm.field_m[0];
              var3 = jj.a(param1, 1, (p) (Object) var13);
              if (var3 > 16.0) {
                return;
              } else {
                L1: {
                  var5 = nh.a(-12149, param1, (p) (Object) var13);
                  var7 = 16.0;
                  if (var13.field_t != 0) {
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("hg.B(").append(64).append(44);
