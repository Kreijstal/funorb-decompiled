...
final class rm {
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_c, 0, field_g, 0, var2);
        int var3 = field_b[this.field_j - 1];
        ...
        for (var6 = 0; var6 < this.field_e.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = qf.field_w[this.field_d[var7]].b();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_h[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_c[incrementValue$0] = qf.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_h[this.field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_i[var16]) {
                  var9 = field_g[var16];
                  var10 = field_f[var16] * this.field_j;
