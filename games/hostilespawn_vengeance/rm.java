...
final class rm {
    ...
    final boolean a() {
        ...
        int var2 = ((rm) this).field_c.length;
        System.arraycopy((Object) (Object) ((rm) this).field_c, 0, (Object) (Object) field_g, 0, var2);
        int var3 = field_b[((rm) this).field_j - 1];
        int var4 = vf.b(-69, var3 - 1);
        field_f[0] = qf.e(var4);
        field_f[1] = qf.e(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((rm) this).field_e.length; var6++) {
            var7 = ((rm) this).field_e[var6];
            var8 = ((rm) this).field_h[var7];
            var9 = ((rm) this).field_a[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = qf.field_w[((rm) this).field_d[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((rm) this).field_k[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_f[incrementValue$0] = var13 >= 0 ? qf.field_w[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    rm() {
        ...
        if (var1 == 1) {
          var2 = qf.e(5);
          var3 = 0;
          ((rm) this).field_e = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((rm) this).field_h = new int[var3];
              ((rm) this).field_a = new int[var3];
              ((rm) this).field_d = new int[var3];
              ((rm) this).field_k = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((rm) this).field_j = qf.e(2) + 1;
                  var4 = qf.e(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((rm) this).field_c = new int[var5];
                      ((rm) this).field_c[0] = 0;
                      ((rm) this).field_c[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((rm) this).field_h[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((rm) this).field_c[incrementValue$2] = qf.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((rm) this).field_h[((rm) this).field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((rm) this).field_h[var4] = qf.e(3) + 1;
                    int dupTemp$3 = qf.e(2);
                    ((rm) this).field_a[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((rm) this).field_d[var4] = qf.e(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((rm) this).field_c.length;
        var4 = field_b[((rm) this).field_j - 1];
        var5 = field_i;
        field_i[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_f[0] * ((rm) this).field_j;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_i[var16]) {
                  var9 = field_g[var16];
                  var10 = field_f[var16] * ((rm) this).field_j;
            ...
            L3: {
              var7 = rm.b(field_g, var6);
              var8_int = rm.a(field_g, var6);
              var9 = this.a(field_g[var7], field_f[var7], field_g[var8_int], field_f[var8_int], field_g[var6]);
              var10 = field_f[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
