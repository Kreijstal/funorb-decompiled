              ...
              if (param3 < var17) {
                ...
                L5: {
                  L6: {
                    ...
                    L8: {
                      if (var39[var7_int] < 16) {
                        break L8;
                      } else {
                        if (17 >= var39[var7_int]) {
                          break L6;
                        } else {
                          break L8;
                        }
                    ...
                    L9: {
                      if (var39[var7_int] < 22) {
                        break L9;
                      } else {
                        if (var39[var7_int] <= 23) {
                          break L6;
                        } else {
                          break L9;
                        }
                    ...
                    L10: {
                      if (var39[var7_int] < 30) {
                        break L10;
                      } else {
                        if (var39[var7_int] <= 31) {
                          break L6;
                        } else {
                          break L10;
                        }
                    ...
                    if (var39[var7_int] < 38) {
                      break L5;
                    } else {
                      if (39 >= var39[var7_int]) {
                        break L6;
                      } else {
                        break L5;
                      }
                  ...
                  var27 = fa.field_d[var39[var7_int]];
                  break L5;
                }
                L11: {
                  L12: {
