...
final class re {
    ...
    private final void a(int param0, int param1, int param2, String param3, boolean param4, int param5) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_15_1 = new StringBuilder().append("re.KA(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    private final void j(byte param0) {
        ...
        L2: {
          ...
          if (rl.field_c >= 9) {
            ...
            StringBuilder discarded$8 = var4.append('0');
            break L2;
          }
        }
        L3: {
    ...
    private final void c(boolean param0) {
        ...
        int stackIn_28_2 = 0;
        int stackIn_28_3 = 0;
        String stackIn_28_4 = null;
        Object stackIn_29_0 = null;
        int stackIn_29_1 = 0;
        int stackIn_29_2 = 0;
        int stackIn_29_3 = 0;
        String stackIn_29_4 = null;
        int stackIn_29_5 = 0;
        int stackOut_17_0 = 0;
        int stackOut_16_0 = 0;
        int stackOut_14_0 = 0;
        ...
        int stackOut_28_2 = 0;
        int stackOut_28_3 = 0;
        String stackOut_28_4 = null;
        int stackOut_28_5 = 0;
        Object stackOut_27_0 = null;
        int stackOut_27_1 = 0;
        int stackOut_27_2 = 0;
        int stackOut_27_3 = 0;
        String stackOut_27_4 = null;
        int stackOut_27_5 = 0;
        L0: {
                  ...
                  if (10 <= var11) {
                    ...
                    L6: {
                      if (var5[var11] != null) {
                        L7: {
                          stackOut_26_0 = this;
                          stackOut_26_1 = var19[var11];
                          stackOut_26_2 = var10;
                          stackOut_26_3 = -128;
                          stackOut_26_4 = var5[var11].toUpperCase();
                          ...
                          if (var7 != var11) {
                            ...
                            stackOut_28_4 = (String) (Object) stackIn_28_4;
                            stackOut_28_5 = 0;
                            ...
                            stackOut_27_4 = (String) (Object) stackIn_27_4;
                            stackOut_27_5 = 1;
                        ...
                        this.a(stackIn_29_1, stackIn_29_2, stackIn_29_3, stackIn_29_4, stackIn_29_5 != 0, var11 - -1);
                        var4 = "";
                        break L6;
                      } else {
                        break L6;
                  ...
                  if (!p.field_m[bm.field_c].field_m) {
                    ...
                    if (var15.field_l == null) {
                      ...
                      if (var14.field_l[ue.field_e] == null) {
                        ...
                        if (var14.field_l[ue.field_e].length != 0) {
                          break L9;
                        } else {
                          break L9;
                        }
    ...
    private final int a(bd param0, String param1, int param2, String param3, byte param4, bd param5) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_21_1 = new StringBuilder().append("re.O(");
          ...
          L8: {
            ...
            stackOut_30_1 = ((StringBuilder) (Object) stackIn_30_1).append(stackIn_30_2).append(',').append(80).append(',');
          ...
          throw wg.a((Throwable) (Object) stackIn_33_0, stackIn_33_2 + ')');
        }
        return stackIn_20_0;
    }
            ...
            L1: while (true) {
              if (var9 >= 8) {
                ...
                L7: {
                  if (kh.field_Q[var9]) {
                    L8: {
                      dn.a(-4 + var6, -113, var9, var7 - 10, 16772608);
                      if (var9 == 0) {
                    ...
                    L11: {
                      if (ka.a(var7, 0, 40, 40, var6)) {
                        L12: {
                          if (0 == var9) {
                            stackOut_28_0 = gi.field_m;
                            stackIn_29_0 = stackOut_28_0;
                            break L12;
                          } else {
                            stackOut_27_0 = rf.field_s[var9 - 1];
                            stackIn_29_0 = stackOut_27_0;
                            break L12;
                          }
                        }
          ...
          if (2 <= var4_int) {
            ...
            L4: while (true) {
              if (var10 >= var9) {
                ...
                ((re) this).field_E.a(16, 0, (byte) 33);
    ...
    private final void g(int param0, int param1) {
        ...
        L14: {
          if (rl.field_c >= 9) {
            ...
            stackOut_47_0 = fh.field_d + '0' + (1 + rl.field_c);
    ...
    private final void a(byte param0, int param1, bd param2, int param3) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_18_1 = new StringBuilder().append("re.JB(").append(50).append(',').append(param1).append(',');
    ...
    private final void a(byte param0, String param1) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_25_1 = new StringBuilder().append("re.JA(").append(param0).append(',');
            stackIn_27_0 = stackOut_25_0;
            stackIn_27_1 = stackOut_25_1;
            stackIn_26_0 = stackOut_25_0;
            stackIn_26_1 = stackOut_25_1;
