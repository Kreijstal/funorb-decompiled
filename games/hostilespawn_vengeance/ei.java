...
final class ei extends am {
            ...
            if (var22 != 1) {
              ...
              L29: {
                if (param9.field_i != 27) {
                  ...
                  L30: {
                    if (ln.field_a.field_c[param12] == 6) {
                  ...
                  L31: {
                    if (ln.field_a.field_c[-1 + param12] == 6) {
              ...
              L33: {
                if (param8) {
                  ...
                  L40: {
                    var30 = stackIn_121_0;
                    if (ln.field_a.b(var27, 5857, var26) <= 1) {
                      stackOut_123_0 = 0;
    ...
    final static bd[] a(int param0, int param1, int param2, int param3) {
        ...
        var5[1] = dupTemp$0;
        var5[0] = dupTemp$0;
        bd dupTemp$1 = el.a(-122, 1, param0);
        var6[8] = dupTemp$1;
        var5[7] = dupTemp$1;
        var5[5] = dupTemp$1;
        if (param2 != 0) {
            ...
            if (dl.field_n == null) {
              ...
              if (var4 == 0) {
                ...
                if (var3 == 0) {
                  ...
                  if (jf.field_d < 40) {
                    dl.field_n.b(var1 + dl.field_n.field_z / 2, var2 + dl.field_n.field_z / 2, 0, jf.field_d + 78 << 5);
                    break L0;
                  } else {
    ...
    final static void a(p param0, byte param1, int[] param2, int param3, int[] param4, int[] param5) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_20_1 = new StringBuilder().append("ei.D(");
            stackIn_22_0 = stackOut_20_0;
          ...
          L7: {
            ...
            stackOut_23_1 = ((StringBuilder) (Object) stackIn_23_1).append(stackIn_23_2).append(44).append(-116).append(44);
    ...
    final static bd[] a(gb param0, int param1, String param2, String param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ne.a(44, param0, var5, var4_int);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ei.C(");
    ...
    ei(long param0, int param1, byte[] param2) {
        try {
            ...
            throw wg.a((Throwable) (Object) runtimeException, "ei.<init>(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
