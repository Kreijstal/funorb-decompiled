...
final class fg {
    ...
    final static void a(int param0, int param1, int param2, p param3) {
        ...
        try {
            ...
            throw wg.a((Throwable) (Object) runtimeException, "fg.F(" + param0 + ',' + param1 + ',' + 25 + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final static int a(ic param0, int param1, boolean param2, jd param3) {
        ...
        try {
                    ...
                    if (param0.field_j == param3.field_t) {
                      ...
                      L2: while (true) {
                        if (var5 <= var6) {
                          ...
                          L3: {
                            if (~param3.field_k != ~param0.field_i[param1][var6]) {
                              break L3;
                            } else {
          ...
          L5: {
            ...
            stackOut_24_1 = new StringBuilder().append("fg.A(");
          ...
          L6: {
            ...
            stackOut_27_1 = ((StringBuilder) (Object) stackIn_27_1).append(stackIn_27_2).append(',').append(param1).append(',').append(false).append(',');
          ...
          throw wg.a((Throwable) (Object) stackIn_30_0, stackIn_30_2 + ')');
        }
        return stackIn_23_0;
    }
    ...
    final static bd a(String param0, String param1, gb param2) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ac.a(var4_int, var5, (byte) -118, param2);
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("fg.B(");
          ...
          throw wg.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + ',' + false + ')');
        }
        return stackIn_3_0;
    }
