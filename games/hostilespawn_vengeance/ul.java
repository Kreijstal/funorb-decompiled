...
abstract class ul extends vd {
    ...
    ul(gg param0, int param1, int param2) {
        ...
        try {
            ...
            throw wg.a((Throwable) (Object) runtimeException, "ul.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 41);
        }
    }
    ...
    final static ca a(boolean param0, String param1, long param2, String param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("ul.PB(").append(param0).append(44);
