...
final class kf extends c implements java.awt.image.ImageProducer, java.awt.image.ImageObserver {
    ...
    public final synchronized void removeConsumer(java.awt.image.ImageConsumer param0) {
        try {
            ...
            throw vk.a((Throwable) ((Object) runtimeException), "kf.removeConsumer(" + (param0 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final void a(int param0, boolean param1, java.awt.Graphics param2, int param3) {
        try {
            ...
            throw vk.a((Throwable) ((Object) runtimeException), "kf.B(" + param0 + ',' + param1 + ',' + (param2 != null ? "{...}" : "null") + ',' + param3 + ')');
        }
    }
