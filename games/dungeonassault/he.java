...
final class he extends ip {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, cn[] param7, int param8, int param9, cn[] param10, se param11, se param12, int param13, boolean param14) {
        try {
            ...
            throw vk.a((Throwable) ((Object) runtimeException), "he.F(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + (param7 != null ? "{...}" : "null") + ',' + param8 + ',' + param9 + ',' + (param10 != null ? "{...}" : "null") + ',' + (param11 != null ? "{...}" : "null") + ',' + (param12 != null ? "{...}" : "null") + ',' + param13 + ',' + param14 + ')');
        }
    }
    ...
    final static void e(byte param0) {
        ...
        try {
                    ...
                    if (null == hf.field_pb) {
                      ...
                      if (!hf.field_pb.a(-14354)) {
                        ...
                        if (hf.field_pb.a(false, "benefits")) {
                          ...
                          var12.e();
                          dc.field_e.c(jk.a(new String[]{mj.field_f}, md.field_a, 30496), var6, 40, 16777215, -1);
                          tg.field_l.c(jk.a(new String[]{mj.field_f}, hm.field_t, 30496), var6, 60, 16777215, -1);
                          dc.field_e.c(jk.a(new String[]{dh.field_f}, bh.field_K, 30496), var6, 110, 16777215, -1);
                          tg.field_l.c(jk.a(new String[]{dh.field_f}, jm.field_b, 30496), var6, 130, 16777215, -1);
                ...
                if (qc.field_z == null) {
                  ...
                  if (dc.field_e == null) {
                    ...
                    L4: {
                      ...
                      var3 = gf.field_c;
                      gf.a(rp.field_e);
                      var14 = jk.a(new String[]{kl.field_c[wo.field_g]}, rn.field_e, 30496);
              ...
              L13: {
                if (tl.field_i == null) {
                  ...
                  if (nl.field_g == null) {
                    ...
                    L16: {
                      var3 = (la.a(stackIn_51_0 << stackIn_51_1, (byte) 86) * 40 >> 1060634736) + 40;
                      if ((var3 ^ -1) < -1) {
                    ...
                    cf.a(stackIn_57_0 != 0, wk.field_h, 127, fo.field_b);
                    break L13;
                  }
                }
              }
              L18: {
                if (tl.field_i == null) {
                  ...
                  if (null != nl.field_g) {
                    ...
                    cf.a(stackIn_67_0 != 0, rm.field_T, 126, mi.field_f);
                    break L18;
                  } else {
                    break L18;
                  }
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var1 = decompiledCaughtException;
          throw vk.a((Throwable) ((Object) var1), "he.G(" + param0 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return;
        } else {
                  ...
                  if (param13 >= 0) {
                    ...
                    L4: {
                      ...
                      if (param12 != 0) {
                        ...
                        param12 = (var16 * param12 & 16711680 | -16711936 & param12 * var15_int) >>> 1967473992;
