...
final class bf {
    ...
    final static void a(String param0, tg param1, int param2, se param3, int param4) {
        ...
        try {
          ...
          throw vk.a((Throwable) ((Object) stackIn_20_0), stackIn_26_2 + ',' + param4 + ')');
        }
    }
                          ...
                          if (var4 <= var6_int) {
                            ...
                            L7: while (true) {
                              if (var8 <= var9) {
                                ...
                                L8: while (true) {
                                  if (var9 < var8) {
                                    var11 = ol.field_k[var9 + var5];
                                    var6[1][var14] = ah.field_c[var11];
                                    var19[1][var14 * 4] = i.field_t[var11];
                                    var19[1][4 * var14 + 1] = mf.field_d[var11];
                                    var19[1][4 * var14 + 2] = wa.field_m[var11];
                                    var19[1][var14 * 4 + 3] = tc.field_w[var11];
                                ...
                                L10: {
                                  ...
                                  var19[0][var10 * 4] = i.field_t[var11];
                                  var19[0][1 + var10 * 4] = mf.field_d[var11];
                                  var19[0][2 + var10 * 4] = wa.field_m[var11];
                                  var19[0][4 * var10 - -3] = tc.field_w[var11];
                                  if (!eh.a(true, ah.field_c[var11])) {
                                    break L10;
                                  } else {
    ...
    final static void a(int param0, int param1, int param2, int param3, String param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_5_1 = new StringBuilder().append("bf.F(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
