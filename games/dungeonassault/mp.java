...
final class mp {
    ...
    final static void a(Random param0, int[] param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          throw vk.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + ',' + param2 + ',' + param3 + ',' + param4 + ')');
        }
    }
    ...
    final static cf a(String param0, String param1, int param2, int param3) {
        ...
        try {
          L0: {
            stackOut_0_0 = hd.a(false, param3, param1 + "_" + param0);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("mp.D(");
          ...
          throw vk.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + ',' + 0 + ',' + param3 + ')');
        }
        return stackIn_1_0;
    }
