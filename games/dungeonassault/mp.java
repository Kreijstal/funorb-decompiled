    ...
    final static void a(Random param0, int[] param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("mp.C(");
          ...
          throw vk.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    final static cf a(String param0, String param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = hd.a(false, param3, param1 + "_" + param0);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("mp.D(");
