    ...
    final static void a(int param0, int param1, cn[] param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L23: {
            ...
            stackIn_75_1 = new StringBuilder().append("sn.B(").append(param0).append(',').append(param1).append(',');
