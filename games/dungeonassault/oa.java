...
final class oa implements ca {
    ...
    public final void a(byte param0, lm param1, int param2, int param3, boolean param4) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_19_1 = new StringBuilder().append("oa.B(").append(param0).append(44);
          ...
          throw vk.a((Throwable) (Object) stackIn_22_0, stackIn_22_2 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    oa(se param0, int param1, int param2) {
        try {
            ...
            throw vk.a((Throwable) (Object) runtimeException, "oa.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 41);
        }
    }
