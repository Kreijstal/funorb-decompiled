...
final class bi {
    ...
    final int a(int param0, float param1) {
        ...
        for (var4 = 1; var4 < this.field_e[param0]; var4++) {
        ...
        if (param0 == 0) {
            for (var4 = 0; var4 < this.field_e[0] * 2; var4++) {
                dupTemp$3 = field_h[0];
                dupTemp$3[var4] = dupTemp$3[var4] * field_f;
            }
        }
        for (var4 = 0; var4 < this.field_e[param0] * 2; var4++) {
    ...
    final void a(ec param0, fh param1) {
        ...
        L0: {
          ...
          if (var3 == 0) {
            ...
            this.field_g[0] = param0.k(0);
            this.field_g[1] = param0.k(0);
            var4 = param0.c(true);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                    ...
                    L5: while (true) {
                      if (var7 >= this.field_e[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_b[var5][1][var7] = param0.k(0);
                          this.field_a[var5][1][var7] = param0.k(0);
                          var7++;
                          continue L5;
                        }
                      }
                ...
                L6: while (true) {
                  if (var6 >= this.field_e[var5]) {
                    ...
                    this.field_b[var5][0][var6] = param0.k(0);
                    this.field_a[var5][0][var6] = param0.k(0);
                    var6++;
                    continue L6;
                  }
                }
