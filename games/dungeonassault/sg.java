    ...
    final static void a(int[] param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, byte param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16) {
        ...
        try {
                ...
                if (re.field_i > param9) {
                      ...
                      L9: {
                        ...
                        L11: while (true) {
                          if (param7 <= param9) {
                            ...
                            L12: {
                              var37 = var17_int >> -85975184;
                              if (var37 >= re.field_b) {
                                break L12;
                              } else {
                                var38 = (var18 >> -1924408112) + -(var17_int >> -890356784);
                                if (var38 == 0) {
                                  if ((var37 ^ -1) > -1) {
                                    break L12;
                                  } else {
                  ...
                  L16: while (true) {
                    if (param9 >= param3) {
                      ...
                      L17: {
                        var36 = var17_int >> 979545104;
                        if (re.field_b > var36) {
                          var37 = (var18 >> 60602480) - (var17_int >> 14226384);
                          if (var37 != 0) {
                            L18: {
          ...
          L19: {
            ...
            stackIn_80_1 = new StringBuilder().append("sg.B(");
          ...
          throw vk.a((Throwable) ((Object) stackIn_81_0), stackIn_81_2 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ',' + param9 + ',' + param10 + ',' + param11 + ',' + param12 + ',' + param13 + ',' + param14 + ',' + param15 + ',' + param16 + ')');
        }
