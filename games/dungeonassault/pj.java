...
final class pj {
            ...
            if (var4 == 0) {
              ...
              if (var6 != 0) {
                ...
                if (!((pj) this).field_j.a(var8, (byte) 79)) {
                  var12 = ((pj) this).field_h[var8];
                  if (var12.field_h == null) {
                    break L4;
                  } else {
                    if (2 != var12.field_h.field_g) {
                      break L4;
                    } else {
                      var12.field_q = var12.field_q + var9;
                      break L4;
                    }
                  }
                } else {
            ...
            if (var4 == 0) {
              ...
              if (var7 == 0) {
                ...
                if (((pj) this).field_j.a(var8, (byte) 90)) {
                  ...
                  if (var14.field_h == null) {
                    break L6;
                  } else {
                    if (2 == var14.field_h.field_g) {
    ...
    private final void a(wm param0, ec param1, int param2) {
        ...
        try {
          ...
          throw vk.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + ',' + -23082 + ')');
        }
    }
    ...
    private final void a(hb param0, int param1) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_14_1 = new StringBuilder().append("pj.GA(");
          ...
          throw vk.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + ',' + 6 + ')');
        }
    }
    ...
    private final void a(int param0, boolean param1, ec param2) {
        ...
        try {
                ...
                L2: while (true) {
                  if (var4_int >= 4) {
                    L3: {
                      ...
                      if (4 > var4_int) {
                        stackOut_16_0 = this;
                        stackOut_16_1 = ((pj) this).field_A[var4_int];
                        stackIn_17_0 = stackOut_16_0;
                        stackIn_17_1 = stackOut_16_1;
                        break L3;
                      } else {
                        ...
                        stackOut_15_1 = null;
                        stackIn_17_0 = stackOut_15_0;
                        stackIn_17_1 = (hb) (Object) stackOut_15_1;
                        break L3;
                      }
                    }
                    L4: {
                      ((pj) this).field_u = stackIn_17_1;
          ...
          L7: {
            ...
            stackOut_23_1 = new StringBuilder().append("pj.Q(").append(111).append(',').append(param1).append(',');
    ...
    private final mo a(boolean param0, ai param1, int param2, byte param3) {
        ...
        try {
          ...
          L32: {
            ...
            stackOut_92_1 = new StringBuilder().append("pj.LA(").append(param0).append(',');
          ...
          throw vk.a((Throwable) (Object) stackIn_95_0, stackIn_95_2 + ',' + param2 + ',' + 98 + ')');
        }
        return stackIn_91_0;
    }
    ...
    private final mo a(int param0, ai param1, byte param2, boolean param3) {
        ...
        try {
            ...
            L14: while (true) {
              L15: {
                ...
                if (var5_int != 0) {
                  ...
                  stackOut_70_0 = new mo(66, var14 | var15);
          ...
          L24: {
            var5 = decompiledCaughtException;
            stackOut_72_0 = (RuntimeException) var5;
            stackOut_72_1 = new StringBuilder().append("pj.W(").append(param0).append(',');
          ...
          throw vk.a((Throwable) (Object) stackIn_75_0, stackIn_75_2 + ',' + 26 + ',' + param3 + ')');
        }
        return stackIn_71_0;
    }
    ...
    private final void a(int param0, ec param1, wm param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("pj.HA(").append(105).append(',');
