    ...
    final static void a(java.math.BigInteger param0, int param1, byte[] param2, ec param3, int param4, java.math.BigInteger param5) {
        ...
        try {
              ...
              if (var9 >= 4) {
                ...
                L5: {
                  L6: {
                    ...
                    wa.field_b.a(param2, 1, param1, 0);
                    wa.field_b.g(3, var7_int);
                    wa.field_b.a(var15, true);
                    if (t.field_d == null) {
                      break L6;
                    } else {
                      if (t.field_d.field_m.length >= 100) {
                        break L5;
                      } else {
                        break L6;
                      }
          ...
          L11: {
            ...
            stackOut_28_1 = ((StringBuilder) (Object) stackIn_28_1).append(stackIn_28_2).append(44).append(5471).append(44);
          ...
          throw vk.a((Throwable) (Object) stackIn_31_0, stackIn_31_2 + 44 + 0 + 41);
        }
    }
