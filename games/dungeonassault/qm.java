    ...
    final static int a(int param0, int param1, boolean param2, String param3, String param4, int param5, String param6) {
        ...
        try {
          L0: {
            ...
            var7 = new cd(param4);
            var8 = new cd(param6);
            stackOut_2_0 = op.a(var7, param0, param1, var8, param3, param5 ^ -1, param2);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("qm.E(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
