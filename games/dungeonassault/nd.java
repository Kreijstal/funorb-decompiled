...
final class nd {
    ...
    final boolean a() {
        ...
        int var2 = ((nd) this).field_d.length;
        System.arraycopy((Object) (Object) ((nd) this).field_d, 0, (Object) (Object) field_a, 0, var2);
        int var3 = field_k[((nd) this).field_i - 1];
        int var4 = ue.a(var3 - 1, -715);
        field_h[0] = jp.a(var4);
        field_h[1] = jp.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((nd) this).field_g.length; var6++) {
            var7 = ((nd) this).field_g[var6];
            var8 = ((nd) this).field_l[var7];
            var9 = ((nd) this).field_j[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = jp.field_x[((nd) this).field_c[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((nd) this).field_e[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_h[incrementValue$0] = var13 >= 0 ? jp.field_x[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((nd) this).field_d.length;
        var4 = field_k[((nd) this).field_i - 1];
        var5 = field_b;
        field_b[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_h[0] * ((nd) this).field_i;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_b[var16]) {
                  var9 = field_a[var16];
                  var10 = field_h[var16] * ((nd) this).field_i;
            ...
            L3: {
              var7 = nd.a(field_a, var6);
              var8_int = nd.b(field_a, var6);
              var9 = this.a(field_a[var7], field_h[var7], field_a[var8_int], field_h[var8_int], field_a[var6]);
              var10 = field_h[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    nd() {
        ...
        if (var1 == 1) {
          var2 = jp.a(5);
          var3 = 0;
          ((nd) this).field_g = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((nd) this).field_l = new int[var3];
              ((nd) this).field_j = new int[var3];
              ((nd) this).field_c = new int[var3];
              ((nd) this).field_e = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((nd) this).field_i = jp.a(2) + 1;
                  var4 = jp.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((nd) this).field_d = new int[var5];
                      ((nd) this).field_d[0] = 0;
                      ((nd) this).field_d[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((nd) this).field_l[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((nd) this).field_d[incrementValue$2] = jp.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((nd) this).field_l[((nd) this).field_g[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((nd) this).field_l[var4] = jp.a(3) + 1;
                    int dupTemp$3 = jp.a(2);
                    ((nd) this).field_j[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((nd) this).field_c[var4] = jp.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
