    ...
    boolean a(lm param0, char param1, int param2, byte param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_15_1 = new StringBuilder().append("hf.W(");
    ...
    void b(int param0, lm param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_10_1 = new StringBuilder().append("hf.L(").append(param0).append(',');
