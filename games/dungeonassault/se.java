...
abstract class se extends ll {
                                      ...
                                      if (var8.startsWith("img=")) {
                                        try {
                                          L2: {
                                            ...
                                            var4 = var4 + this.field_x[var9_int].field_d;
                                            var3 = 0;
                                            var6++;
                                            break L2;
                                          }
                          ...
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ...
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    this.field_R = var17[32] + var14[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_v[(var7 << 8) + var8] = (byte)se.a(var15, var16, var17, this.field_M, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_C = (param1 - this.b(param0) << 8) / var3;
                break L1;
              }
            }
            return;
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var11_ref_lo = this.field_x[var10];
                                            if (this.field_D == null) {
                                              stackIn_26_0 = var11_ref_lo.field_g;
                                              break L3;
                                            } else {
                                              stackIn_26_0 = this.field_D[var10];
                                              break L3;
                                            }
                                          }
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_F != 256) {
                                              var11_ref_lo.a(param1, param2 + this.field_R - var12, field_F);
                                              break L4;
                                            } else {
                                              var11_ref_lo.a(param1, param2 + this.field_R - var12);
                                              break L4;
                                            }
                                          }
              ...
              if (var4 == -1) {
                    ...
                    if (field_F != 256) {
                      L8: {
                        if (field_L == -1) {
                          ...
                          this.a(var8, param1 + this.field_P[var8] + 1, param2 + this.field_z[var8] + 1, var9, var10, field_L, field_F, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_P[var8], param2 + this.field_z[var8], var9, var10, field_O, field_F, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_L == -1) {
                          ...
                          this.a(var8, param1 + this.field_P[var8] + 1, param2 + this.field_z[var8] + 1, var9, var10, field_L, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_P[var8], param2 + this.field_z[var8], var9, var10, field_O, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  ...
                  if (field_w == -1) {
                    ...
                    gf.b(var11, param2 + (int)((double)this.field_R * 0.7), param1 - var11, field_w);
                    break L10;
                  }
                }
                L11: {
                  if (field_S == -1) {
                    ...
                    gf.b(var11, param2 + this.field_R + 1, param1 - var11, field_S);
                    break L11;
                  }
                }
                var5 = var8;
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$0 = field_J.append('<');
                        discarded$1 = field_J.append(var15);
                        discarded$2 = field_J.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                                          ...
                                          if (!var15.startsWith("img=")) {
                                            ...
                                            try {
                                              L4: {
                                                ...
                                                var4 = var4 + this.field_x[var16_int].field_d;
                                                var10 = 0;
                                                break L4;
                                              }
                                            } catch (java.lang.Exception decompiledCaughtParameter0) {
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$3 = field_J.append((char) var14);
    ...
    final int a(String param0, int param1, int param2) {
        ...
        return this.field_H + var5 + this.field_E;
    }
    ...
    final int a(char param0) {
        return this.field_M[hb.a((byte) -38, param0) & 255];
    }
        ...
        if (param0 != null) {
          L0: {
            ...
            if (param10 != 0) {
              ...
              param10 = this.field_R;
              break L0;
            }
          }
          L1: {
            var12 = new int[]{param3};
            if (param4 >= this.field_H + this.field_E + param10) {
              break L1;
            } else {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - this.field_H - this.field_E - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + param4 - this.field_E - (var13 - 1) * param10;
                  break L3;
                }
              } else {
                var14 = param2 + this.field_H + (param4 - this.field_H - this.field_E - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.b(field_A[var15], param1 + param3 - this.b(field_A[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_A[var15], param1 + (param3 - this.b(field_A[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    se(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_H = this.field_R - var6;
            this.field_E = var7 - this.field_R;
            this.field_N = this.field_R - this.field_z[88];
            return;
          } else {
            L1: {
            ...
            if (this.field_z[var8] + this.field_Q[var8] > var7) {
              var7 = this.field_z[var8] + this.field_Q[var8];
              var8++;
              continue L0;
            } else {
              var8++;
