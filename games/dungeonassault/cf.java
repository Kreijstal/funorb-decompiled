...
final class cf {
    ...
    cf(va param0, int param1) {
        try {
            ...
            throw vk.a((Throwable) (Object) runtimeException, "cf.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final static fa a(int param0, va param1, int param2) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = l.a(ni.b(param1, 100, param2), 0);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("cf.B(").append(param0).append(44);
