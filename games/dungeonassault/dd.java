...
final class dd extends rj {
    ...
    final void d(int param0, int param1, int param2) {
        ...
        int var4 = (-33 + param0) * this.field_G / (-46 + this.field_D);
    ...
    final void b(int param0, int param1, int param2) {
        ...
        bp.a(this.field_D + var5 - -10, go.field_S, var4, (byte) 99);
        var6 = 0;
        L0: while (true) {
          if (var6 >= 7) {
            var6 = 0;
            L1: while (true) {
              if ((var6 ^ -1) <= -4) {
                var6 = 1;
                L2: while (true) {
                  if (this.field_D + -1 <= var6) {
                    L3: {
                      if (this.field_G != 0) {
                        stackOut_11_0 = (this.field_D - 46) * this.field_F / this.field_G;
                    ...
                    dc.field_x.h(this.field_D + var4 + 10, var5);
                    ml.field_a.h(var4 + (10 + var6), 4 + var5);
                    return;
                  } else {
                    qe.b(var6 + (10 + var4), var5 + 7, 5, 0, -(var6 * 80 / this.field_D) + 144);
                    var6++;
                    continue L2;
                  }
                }
              } else {
                qe.a(11 + var4, var5 + 5 + -var6, -2 + this.field_D, 0, 64 * (-var6 + 3));
                qe.a(11 + var4, var5 - -13 - -var6, -2 + this.field_D, 0, (3 - var6) * 64);
                var6++;
                continue L1;
              }
            }
          } else {
            te.a(var4 + 11, var6 + var5 + 6, -2 + this.field_D, kc.field_M);
            var6++;
            continue L0;
          }
        }
    ...
    final void a(int param0, int param1) {
        this.field_F = this.field_F + (param1 * this.field_G >> 1473275173);
    ...
    final static cn a(byte param0, int param1, cn param2) {
        ...
        try {
          L0: {
            var6 = new cn(param1 * 2 + param2.field_y, 2 * param1 + param2.field_v);
            jh.a(var6);
          ...
          L2: {
            ...
            stackOut_9_1 = new StringBuilder().append("dd.B(").append(param0).append(',').append(param1).append(',');
    ...
    final void a(int param0, byte param1, int param2) {
        ...
        int var4 = this.field_G * (param2 + -33) / (-46 + this.field_D);
        if (this.field_F < var4) {
            this.field_F = this.field_F + (this.field_G >> -556957852);
        }
        if (var4 < this.field_F) {
            this.field_F = this.field_F - (this.field_G >> 389311268);
        }
