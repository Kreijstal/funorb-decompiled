...
final class ni extends qb {
    ...
    final synchronized void a(int param0) {
        ...
        L0: {
          if (this.field_s <= 0) {
            ...
            if (param0 < this.field_s) {
              this.field_p = this.field_p + this.field_x * param0;
              this.field_m = this.field_m + this.field_v * param0;
              this.field_r = this.field_r + this.field_o * param0;
        ...
        this.field_u = this.field_u + this.field_q * param0;
        if (this.field_z >= 0) {
          L5: {
            if (this.field_z <= 0) {
              break L5;
    ...
    private final void g() {
        this.field_p = this.field_w;
        this.field_m = ni.b(this.field_w, this.field_A);
        this.field_r = ni.d(this.field_w, this.field_A);
    }
        ...
        L0: while (true) {
          if (this.field_s <= 0) {
            L1: {
              if (this.field_q != -256) {
                ...
                if ((this.field_u & 255) != 0) {
                  ...
                  if (vn.field_g) {
                    return ni.b(0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_m, this.field_r, 0, param3, param2, (ni) (this));
                  } else {
                    return ni.a(((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_p, 0, param3, param2, (ni) (this));
                  }
                }
              }
            }
            if (vn.field_g) {
              return ni.c(0, 0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_m, this.field_r, 0, param3, param2, (ni) (this), this.field_q, param4);
            } else {
              return ni.b(0, 0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_p, 0, param3, param2, (ni) (this), this.field_q, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_q != -256) {
                  ...
                  if ((this.field_u & 255) != 0) {
                    ...
                    if (!vn.field_g) {
                      param1 = ni.a(((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_p, this.field_x, 0, var6, param2, (ni) (this));
                      break L3;
                    } else {
                      param1 = ni.b(0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_m, this.field_r, this.field_v, this.field_o, 0, var6, param2, (ni) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!vn.field_g) {
                param1 = ni.b(0, 0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_p, this.field_x, 0, var6, param2, (ni) (this), this.field_q, param4);
                break L3;
              } else {
                param1 = ni.b(0, 0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_m, this.field_r, this.field_v, this.field_o, 0, var6, param2, (ni) (this), this.field_q, param4);
                break L3;
              }
            }
            this.field_s = this.field_s - param1;
    ...
    final synchronized boolean f() {
        return this.field_u < 0 || this.field_u >= ((va) ((Object) this.field_k)).field_k.length << 8;
    }
    ...
    final int b() {
        ...
        if (this.field_z == 0) {
            var1 = var1 - var1 * this.field_u / (((va) ((Object) this.field_k)).field_k.length << 8);
        } else {
            if (this.field_z >= 0) {
                var1 = var1 - var1 * this.field_t / ((va) ((Object) this.field_k)).field_k.length;
            }
        }
            ...
            if (this.field_r == var5) {
              ...
              L1: {
                if (var4 - this.field_m <= var6) {
                  ...
                  var6 = var4 - this.field_m;
                  break L1;
                }
              }
              L2: {
                if (this.field_m - var4 <= var6) {
                  break L2;
                } else {
                  var6 = this.field_m - var4;
                  break L2;
                }
              }
              L3: {
              ...
              this.field_w = param1;
              this.field_A = param2;
              this.field_x = (param1 - this.field_p) / param0;
              this.field_v = (var4 - this.field_m) / param0;
              this.field_o = (var5 - this.field_r) / param0;
              return;
            }
          } else {
            L6: {
    ...
    private final boolean j() {
        ...
        L0: {
          var1 = this.field_w;
          if (var1 != -2147483648) {
            var2 = ni.b(var1, this.field_A);
            var3 = ni.d(var1, this.field_A);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_p >= var1) {
            if (this.field_p <= var1) {
              ...
              this.field_x = -1;
              this.field_s = this.field_p - var1;
              break L2;
            }
          } else {
            this.field_x = 1;
            this.field_s = var1 - this.field_p;
            break L2;
          }
        }
        L3: {
          if (this.field_m >= var2) {
            if (this.field_m <= var2) {
              ...
              L4: {
                ...
                if (this.field_s == 0) {
                  ...
                  if (this.field_s <= this.field_m - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_s = this.field_m - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_s == 0) {
                ...
                if (this.field_s <= var2 - this.field_m) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_s = var2 - this.field_m;
            break L3;
          }
        }
        if (this.field_r < var3) {
          this.field_o = 1;
          if (this.field_s != 0) {
            if (this.field_s > var3 - this.field_r) {
              this.field_s = var3 - this.field_r;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_r <= var3) {
              ...
              L7: {
                ...
                if (this.field_s == 0) {
                  ...
                  if (this.field_s <= this.field_r - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_s = this.field_r - var3;
              break L6;
            }
          }
          return false;
        ...
        if (param0 != 0) {
          if (this.field_m == 0) {
            if (this.field_r == 0) {
              ...
              this.field_x = -this.field_p / param0;
              this.field_v = -this.field_m / param0;
              this.field_o = -this.field_r / param0;
              return;
            }
          } else {
            L6: {
    ...
    final static ni a(va param0, int param1, int param2) {
        if (param0.field_k != null) {
          if (param0.field_k.length == 0) {
            ...
            return new ni(param0, param1, param2 << 6);
          }
        } else {
          return null;
        }
    ...
    final synchronized void i(int param0) {
        int var2 = ((va) ((Object) this.field_k)).field_k.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
    ...
    final int a() {
        if (this.field_w == 0 && this.field_s == 0) {
            return 0;
        }
        return 1;
    }
          ...
          L4: {
            if (this.field_z <= 0) {
              ...
              if (!this.field_n) {
                if (this.field_q >= 0) {
                  L5: while (true) {
                    var9 = this.b(param0, var9, var6, param2, (int) var4.field_k[this.field_t]);
                  ...
                  L6: while (true) {
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_k[this.field_y - 1]);
                    if (this.field_u < var5) {
                ...
                L7: {
                  if (this.field_q >= 0) {
                    ...
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_k[this.field_t]);
                    if (this.field_u < var5) {
                ...
                L8: while (true) {
                  var9 = this.b(param0, var9, var6, param2, (int) var4.field_k[this.field_y - 1]);
                  if (this.field_u >= var6) {
        ...
        L0: while (true) {
          if (this.field_s <= 0) {
            L1: {
              if (this.field_q != 256) {
                ...
                if ((this.field_u & 255) != 0) {
                  ...
                  if (vn.field_g) {
                    return ni.a(0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_m, this.field_r, 0, param3, param2, (ni) (this));
                  } else {
                    return ni.b(((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_p, 0, param3, param2, (ni) (this));
                  }
                }
              }
            }
            if (vn.field_g) {
              return ni.d(0, 0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_m, this.field_r, 0, param3, param2, (ni) (this), this.field_q, param4);
            } else {
              return ni.a(0, 0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_p, 0, param3, param2, (ni) (this), this.field_q, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_s;
            ...
            L3: {
              L4: {
                ...
                if (this.field_q != 256) {
                  ...
                  if ((this.field_u & 255) != 0) {
                    ...
                    if (!vn.field_g) {
                      param1 = ni.b(((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_p, this.field_x, 0, var6, param2, (ni) (this));
                      break L3;
                    } else {
                      param1 = ni.a(0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_m, this.field_r, this.field_v, this.field_o, 0, var6, param2, (ni) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!vn.field_g) {
                param1 = ni.a(0, 0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_p, this.field_x, 0, var6, param2, (ni) (this), this.field_q, param4);
                break L3;
              } else {
                param1 = ni.a(0, 0, ((va) ((Object) this.field_k)).field_k, param0, this.field_u, param1, this.field_m, this.field_r, this.field_v, this.field_o, 0, var6, param2, (ni) (this), this.field_q, param4);
                break L3;
              }
            }
            this.field_s = this.field_s - param1;
    ...
    private ni(va param0, int param1, int param2) {
        this.field_k = (ap) ((Object) param0);
        this.field_t = param0.field_l;
        this.field_y = param0.field_m;
        this.field_n = param0.field_j;
        this.field_q = param1;
        this.field_w = param2;
        this.field_A = 8192;
        this.field_u = 0;
