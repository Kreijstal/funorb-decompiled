...
final class fl extends ne {
    ...
    final static boolean a(int param0, nh param1) {
        ...
        try {
          L0: {
            var2_int = -37 / ((70 - param0) / 37);
            stackOut_0_0 = param1.a((byte) 59);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("fl.E(").append(param0).append(44);
    ...
    final static void a(byte param0, int param1) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (var4 == null) {
                var5 = (al) (Object) hg.field_n.e(-24172);
                L3: while (true) {
                  if (var5 == null) {
                    break L0;
                  } else {
                    hl.a(param1, -124, var5);
                    var5 = (al) (Object) hg.field_n.a(4);
                    continue L3;
                  }
                }
              } else {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var2 = decompiledCaughtException;
          throw vk.a((Throwable) (Object) var2, "fl.B(" + param0 + 44 + param1 + 41);
        }
    }
    ...
    final static q a(int param0, nh param1, int param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("fl.A(").append(param0).append(44);
          ...
          throw vk.a((Throwable) (Object) stackIn_10_0, stackIn_10_2 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_6_0;
    }
