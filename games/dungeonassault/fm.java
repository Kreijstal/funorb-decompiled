...
final class fm {
        ...
        try {
          L0: {
            L1: {
              ...
              var4_array = new int[64];
              var5 = 0;
              L3: while (true) {
                if (var5 >= 64) {
                  var5_ref_cn = te.a(param1, param2, var4_array, 16, 8, 0.125);
                  uc.field_E = new ph(var5_ref_cn, te.b(param1, param2, 0.125));
                  break L1;
                } else {
                  var4_array[var5] = mp.a(65793 * (var5 + 24), -2147483648);
                  var5++;
                  continue L3;
                }
              }
            }
            var4_int = -(param1 / 2) + 320;
            var5 = -(param2 / 2) + 240;
            uc.field_E.b(var4_int, var5);
            gf.b(var4_int, var5, param1, param2, 6637335);
            ...
            var10 = -var9 + var4_int;
            var11 = -var8 + var5;
            var12 = -oe.field_m.field_d + (var9 + param1 + var4_int);
            ...
            L4: {
              ...
              var14 = 14;
              var15 = 37;
              var16 = jn.field_n.field_j >> 16;
              var17 = jn.field_n.field_t >> 16;
          ...
          L7: {
            ...
            stackOut_19_1 = new StringBuilder().append("fm.E(");
          ...
          throw vk.a((Throwable) (Object) stackIn_22_0, stackIn_22_2 + 44 + param1 + 44 + param2 + 44 + -127 + 41);
        }
    }
    ...
    final static boolean a(ec param0) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("fm.F(");
          ...
          throw vk.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + -127 + 41);
        }
    ...
    final static int a(int param0, int param1, int param2, byte[] param3) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (param0 <= var5) {
                ...
                var4_int = var4_int >>> 8 ^ ih.field_J[255 & (var4_int ^ param3[var5])];
                var5++;
                continue L2;
              }
            }
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("fm.A(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final String a(String param0, int param1) {
        ...
        try {
          L0: {
            L1: {
              var3 = ((fm) this).field_k;
              if (param1 <= -45) {
                break L1;
              } else {
                cn discarded$2 = fm.b(104, -22);
                break L1;
              }
            }
            L2: while (true) {
              if (var3 == null) {
                if (null != ((fm) this).field_c) {
                  stackOut_11_0 = ((fm) this).field_c.a(param0, -96);
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("fm.I(");
    ...
    final void a(String param0, int param1, String param2) {
        ...
        try {
          L0: {
            var5 = 119 / ((param1 - -30) / 59);
            var4 = ((fm) this).field_k;
            L1: while (true) {
              if (var4 == null) {
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("fm.J(");
    ...
    final String a(String param0, byte param1) {
        ...
        try {
          L0: {
            if (param0 != null) {
              L1: {
                var12 = new StringBuilder(param0.length());
                if (param1 == -48) {
                  break L1;
                } else {
                  cn discarded$5 = fm.b(-93, -72);
                  break L1;
                }
              }
              var4 = "<%";
              ...
              L2: while (true) {
                L3: {
                  if (var6 >= var7) {
                    ...
                    if (var8 < 0) {
                      StringBuilder discarded$6 = var12.append(param0.substring(var6, var7));
                      break L3;
                    } else {
                      StringBuilder discarded$7 = var12.append(param0.substring(var6, var8));
                      var6 = var8;
                      ...
                      if (var8 >= 0) {
                        L4: {
                          ...
                          if (var10 == null) {
                            ...
                            StringBuilder discarded$8 = var12.append(var10);
                            break L4;
                          }
                        }
                        var6 = var8 - -1;
                        ...
                        StringBuilder discarded$9 = var12.append(param0.substring(var6, var7));
                        break L3;
                      }
                    }
                  }
                }
                stackOut_16_0 = var12.toString();
          ...
          L5: {
            ...
            stackOut_18_1 = new StringBuilder().append("fm.B(");
    ...
    fm(fm param0) {
        try {
            ...
            throw vk.a((Throwable) (Object) runtimeException, "fm.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
