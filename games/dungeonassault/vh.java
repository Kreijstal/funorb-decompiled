                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              ...
                              if (var14 != null) {
                                ...
                                var14_ref = new mk(new byte[128]);
                                ((vh) this).field_j.a((ne) (Object) var14_ref, 12460, (long)var13);
                                break L7;
                              }
                            }
          ...
          if (var13 >= var2) {
            ...
            L1: while (true) {
              if (var15 >= var14) {
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                      ...
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            var44++;
                                            var51.a(6, (int) param0.field_m[var44]);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var51.a(6, 3);
                              var50++;
                              var51.a(6, (int) param0.field_m[var50]);
                              var50++;
                              var51.a(6, (int) param0.field_m[var50]);
                              var50++;
                              var51.a(6, (int) param0.field_m[var50]);
                ...
                int discarded$1 = param0.e(-651413500);
                var15++;
                continue L1;
              }
            }
