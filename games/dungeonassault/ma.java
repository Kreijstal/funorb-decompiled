...
final class ma implements com.ms.directX.IEnumModesCallback {
    ...
    final void a(byte param0, java.awt.Frame param1, int param2, int param3, int param4, int param5) {
        ...
        if (param0 != 6) {
          ...
          ((ma) this).field_b.setCooperativeLevel((java.awt.Component) (Object) param1, 17);
          ((ma) this).field_b.setDisplayMode(param2, param3, param4, param5, 0);
    ...
    public ma() {
        ((ma) this).field_b = new com.ms.directX.DirectDraw();
        ((ma) this).field_b.initialize((com.ms.com._Guid) null);
    }
    ...
    final int[] a(int param0) {
        ...
        if (param0 != 10127) {
          ((ma) this).field_b = null;
          ((ma) this).field_b.enumDisplayModes(0, (com.ms.directX.DDSurfaceDesc) null, (com.ms.com.IUnknown) null, (com.ms.directX.IEnumModesCallback) this);
    ...
    final void a(int param0, java.awt.Frame param1) {
        ((ma) this).field_b.restoreDisplayMode();
        ((ma) this).field_b.setCooperativeLevel((java.awt.Component) (Object) param1, 8);
