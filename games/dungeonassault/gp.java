...
final class gp extends se {
    ...
    gp(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        ...
        ((gp) this).field_T = new byte[256][];
        ((gp) this).field_T = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (gf.field_g == null) {
                  gp.a(gf.field_b, ((gp) this).field_T[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  gp.a(gf.field_b, ((gp) this).field_T[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, gf.field_g, gf.field_l);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              gp.a(gf.field_b, ((gp) this).field_T[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  gf.field_b[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
