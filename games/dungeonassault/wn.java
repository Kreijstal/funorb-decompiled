...
final class wn extends vn {
    ...
    final void b() {
        try {
            ...
            int discarded$0 = this.field_w.write(this.field_v, 0, var1 << 1);
    ...
    final int f() {
        return this.field_x - (this.field_w.available() >> (field_g ? 2 : 1));
    }
    ...
    final void b(int param0) throws javax.sound.sampled.LineUnavailableException {
        ...
        try {
            var2 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, this.field_y, param0 << (field_g ? 2 : 1));
