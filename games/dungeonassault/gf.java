...
final class gf {
              ...
              if (var18 >= param8) {
                ...
                L8: while (true) {
                  if (var13 >= var18) {
                    ...
                    L26: {
                      if (var13 + param5 + param3 >= field_e) {
                        var14 = var14 + field_i;
                        break L26;
                      } else {
                        var20 = 0;
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4, int param5) {
        gf.a(field_b, 0, 0 * field_i, param0, 0, param4, field_i - param4, param5);
        gf.a(field_b, 0, 0 * field_i, param1, 0, param5, field_i - param4, 0, param4);
    }
                ...
                L6: while (true) {
                  if (var18 <= var20) {
                    L7: {
                      ...
                      var28 = var28 * var28;
                      var29 = var28 - var27;
                      if (!gf.a(0, 0, 0, 0, 0, var26, var5, var14 + var17, var17 - var18, field_b, 192, param4, 1, var24, var8 + var21)) {
                        break L7;
                      } else {
                        boolean discarded$1 = gf.a(0, 0, 0, 0, 0, var26, var5, var14 + var18 - 1, var17 - var18, field_b, 192, param4, -1, var29, var8 + var27);
                        break L7;
                      }
                    }
                    var14 = var14 + var15;
    ...
    private final static boolean a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int[] param9, int param10, int[] param11, int param12, int param13, int param14) {
        ...
        param4 = param13;
        while (param8 < 0) {
            param1 = (param6 - param3) * 192 / param6;
