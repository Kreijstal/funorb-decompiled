...
final class ob extends ok {
    ...
    final static void a(cn param0, int param1, int param2, int param3, boolean param4) {
        ...
        try {
          ...
          throw vk.a((Throwable) (Object) stackIn_21_0, stackIn_21_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    ob(long param0, ok param1, ok param2, ok param3, cn param4, String param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("ob.<init>(").append(param0).append(44);
