...
abstract class gj {
    ...
    final static void a(int param0, int param1, String[] param2, String param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_12_1 = new StringBuilder().append("gj.C(").append(param0).append(',').append(29120).append(',');
    ...
    final static int a(int param0, h param1) {
        ...
        try {
          L0: {
            stackOut_2_0 = ib.a(param1, 918) >> 1;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("gj.I(").append(-1704798751).append(',');
    ...
    final static void a(int[] param0, int param1, int param2, byte param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        try {
          ...
          throw vk.a((Throwable) (Object) stackIn_5_0, stackIn_5_2 + ',' + param1 + ',' + param2 + ',' + 33 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ',' + param9 + ',' + param10 + ')');
        }
    }
