    ...
    dg(int param0, int param1, int param2, int param3, lm param4, boolean param5, int param6, int param7, se param8, int param9, String param10) {
        ...
        try {
          L0: {
            ...
            L3: {
              if (!this.field_N) {
                stackOut_9_0 = this.field_J + this.field_F * 2;
        ...
        if (param0 != param2) {
          ...
          L0: {
            if (!this.field_N) {
              ...
              stackOut_2_0 = -(2 * this.field_F) + (-this.field_J + this.field_x);
              stackIn_4_0 = stackOut_2_0;
              break L0;
            }
          }
          L1: {
            ...
            stackOut_4_1 = this.field_K;
            stackOut_4_2 = this.field_F + (var7 + var5);
            stackOut_4_3 = var6 + this.field_F;
            stackOut_4_4 = -this.field_F + this.field_J;
            stackOut_4_5 = this.field_s - this.field_F * 2;
            stackOut_4_6 = this.field_I;
            stackOut_4_7 = -1;
          ...
          discarded$1 = ((se) (Object) stackIn_7_0).a(stackIn_7_1, stackIn_7_2, stackIn_7_3, stackIn_7_4, stackIn_7_5, stackIn_7_6, stackIn_7_7, stackIn_7_8, 1, this.field_M.field_H);
          return;
        }
    }
