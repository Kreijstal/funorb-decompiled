...
final class uc {
    ...
    final static int a(int param0, ih param1) {
        ...
        try {
          L0: {
            L1: {
              if (param0 == -1) {
                ...
                var3 = null;
                int discarded$2 = uc.a(88, (ih) null);
                break L1;
              }
            }
            stackOut_2_0 = param1.field_r;
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("uc.H(").append(param0).append(44);
    ...
    private final void a(int param0, mf param1, int param2, String param3, String param4, String param5) {
        ...
        try {
            ...
            qk var7_ref = var10;
            if (param2 != 1) {
                boolean discarded$0 = ((uc) this).a(20);
            }
            ...
            int fieldTemp$1 = ((uc) this).field_f;
            ((uc) this).field_f = ((uc) this).field_f + 1;
            ((uc) this).field_c[fieldTemp$1] = var8;
        } catch (RuntimeException runtimeException) {
            throw t.a((Throwable) (Object) runtimeException, "uc.G(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + (param3 != null ? "{...}" : "null") + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final void a(mf param0, String param1, String param2, String param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("uc.I(");
    ...
    private final void a(int param0, int param1, qk param2) {
        ...
        try {
            var4_float = (float)(((uc) this).field_e + 1) + (float)param0 / 100.0f;
            if (0 != param0) {
            ...
            if (param1 >= -7) {
                boolean discarded$0 = ((uc) this).a(-63);
            }
            ((uc) this).field_a = (float)((uc) this).field_g * var4_float / (float)(((uc) this).field_f - -1);
        } catch (RuntimeException runtimeException) {
            throw t.a((Throwable) (Object) runtimeException, "uc.C(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final void a(String param0, byte param1, String param2, mf param3) {
        ...
        try {
          ...
          L2: {
            runtimeException = decompiledCaughtException;
            stackOut_3_0 = (RuntimeException) runtimeException;
            stackOut_3_1 = new StringBuilder().append("uc.F(");
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
            stackIn_4_0 = stackOut_3_0;
            stackIn_4_1 = stackOut_3_1;
