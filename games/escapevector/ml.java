    ...
    final static ce a(int param0, mf param1, ec param2, int param3, int param4) {
        ...
        try {
          L0: {
            ...
            if (var6 != null) {
              if (param0 == -15618) {
                stackOut_6_0 = new ce(new n(var6), param2);
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("ml.B(").append(param0).append(',');
          ...
          throw t.a((Throwable) (Object) stackIn_14_0, stackIn_14_2 + ',' + param3 + ',' + param4 + ')');
        }
        return stackIn_7_0;
    }
    ...
    final static void a(ik param0) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_2_1 = new StringBuilder().append("ml.D(");
          ...
          throw t.a((Throwable) (Object) stackIn_5_0, stackIn_5_2 + ',' + 3 + ',' + 101 + ')');
        }
    }
