...
final class oi extends bj implements qn, qb {
    ...
    private final boolean l(int param0) {
        ...
        if (!this.a(this.field_I, -95)) {
          ...
          if (param0 <= 47) {
            var3 = (String) null;
            discarded$2 = this.a(-69, (String) null, (hm) null, -35, (byte) 72, (String) null);
            return true;
          } else {
            return true;
          }
    ...
    final static ih a(int param0, mf param1, String param2, String param3, mf param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("oi.L(").append(param0).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    private final boolean a(og param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("oi.F(");
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
