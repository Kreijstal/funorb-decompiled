    ...
    final static void a(int param0, int[] param1, int param2, int param3, byte param4, int param5, int param6, int param7, int[] param8, int param9) {
        ...
        try {
                      ...
                      L3: while (true) {
                        L4: {
                          if (param5 >= 0) {
                            ...
                            incrementValue$38 = param6;
                            param6++;
                            stackOut_8_0 = -1;
                            stackOut_8_1 = param1[incrementValue$38] ^ -1;
                            ...
                            if (var11 != 0) {
                              ...
                              L5: {
                                ...
                                incrementValue$39 = param9;
                                param9++;
                                param8[incrementValue$39] = -(ae.a(param2, 16579836) >> -1125526814) + param2;
                                break L5;
                              }
                              param5++;
                              continue L3;
          ...
          L8: {
            ...
            stackOut_20_1 = ((StringBuilder) (Object) stackIn_20_1).append(stackIn_20_2).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',');
