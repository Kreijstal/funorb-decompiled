...
final class ge implements Runnable {
    ...
    final static void a() {
        ...
        try {
          ...
          throw t.a((Throwable) (Object) var1, "ge.B(" + 124 + 41);
        }
    }
    ...
    final static void a(int param0, int[] param1, int param2, int param3, byte param4, int param5, int param6, int param7, int[] param8, int param9) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("ge.D(").append(param0).append(44);
          ...
          throw t.a((Throwable) (Object) stackIn_19_0, stackIn_19_2 + 44 + param9 + 41);
        }
    }
