    ...
    void a(int param0, int param1, int param2, int param3, hm param4, byte param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("r.MA(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
    ...
    private final boolean b(int param0, hm param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("r.OA(").append(param0).append(',');
    ...
    final void a(int param0, byte param1, Hashtable param2, StringBuilder param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (param0 < var5_int) {
                ...
                L3: {
                  if (this.field_C != null) {
                    discarded$10 = this.field_C.a(0, param2, param3, 1 + param0);
                    break L3;
                  } else {
                    discarded$11 = param3.append("null");
                    break L3;
                  }
                }
                break L0;
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("r.FA(").append(param0).append(',').append(param1).append(',');
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
    ...
    boolean a(int param0, int param1, byte param2, int param3, int param4, hm param5, int param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_7_1 = new StringBuilder().append("r.V(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',');
    ...
    final boolean a(int param0, hm param1) {
        ...
        try {
          ...
          L3: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) (var3);
            stackOut_8_1 = new StringBuilder().append("r.M(").append(param0).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    StringBuilder a(int param0, Hashtable param1, StringBuilder param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("r.AA(").append(param0).append(',');
            stackIn_8_0 = stackOut_6_0;
    ...
    final boolean b(int param0, int param1, byte param2, int param3, int param4, hm param5, int param6) {
        ...
        try {
          L0: {
            L1: {
              if (param2 <= -103) {
                ...
                var9 = (String[]) null;
                discarded$2 = r.a((String) null, -44, (String[]) null);
                break L1;
              }
            }
            L2: {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("r.JA(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    void a(int param0, int param1, int param2, hm param3) {
        ...
        try {
          L0: {
            ...
            L2: {
              if (param0 == -14472) {
                ...
                var6 = (String[]) null;
                discarded$2 = r.a((String) null, 17, (String[]) null);
                break L2;
              }
            }
            break L0;
          ...
          L3: {
            var5 = decompiledCaughtException;
            stackOut_6_0 = (RuntimeException) (var5);
            stackOut_6_1 = new StringBuilder().append("r.Q(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
    ...
    final static void a(int param0, bd param1, int param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("r.IA(").append(param0).append(',');
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
