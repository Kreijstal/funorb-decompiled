...
final class vm extends ie {
    ...
    final int a() {
        return this.field_v - (this.field_x.available() >> (field_o ? 2 : 1));
    }
    ...
    final void h() {
        try {
            ...
            int discarded$0 = this.field_x.write(this.field_w, 0, var1 << 1);
    ...
    final void b(int param0) throws javax.sound.sampled.LineUnavailableException {
        ...
        try {
            var2 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, this.field_y, param0 << (field_o ? 2 : 1));
    ...
    final void g() throws javax.sound.sampled.LineUnavailableException {
        ...
        if (this.field_z) {
            this.field_x.close();
            this.field_x = null;
            var1 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, this.field_y, this.field_v << (field_o ? 2 : 1));
