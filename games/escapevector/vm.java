...
final class vm extends ie {
    ...
    final void f() {
        if (((vm) this).field_x != null) {
            ((vm) this).field_x.close();
            ((vm) this).field_x = null;
        }
    }

    final int a() {
        return ((vm) this).field_v - (((vm) this).field_x.available() >> (field_o ? 2 : 1));
    }
    ...
    final void h() {
        try {
            ...
            for (var2 = 0; var2 < var1; var2++) {
                var3 = ((vm) this).field_f[var2];
                if ((var3 + 8388608 & -16777216) != 0) {
                    var3 = 8388607 ^ var3 >> 31;
                }
                ((vm) this).field_w[var2 * 2] = (byte)(var3 >> 8);
                ((vm) this).field_w[var2 * 2 + 1] = (byte)(var3 >> 16);
            }
            int discarded$0 = ((vm) this).field_x.write(((vm) this).field_w, 0, var1 << 1);
    ...
    final void a(java.awt.Component param0) {
        ...
        L3: {
          ((vm) this).field_y = new javax.sound.sampled.AudioFormat(stackIn_13_3, stackIn_13_4, stackIn_13_5, true, false);
          stackOut_13_0 = this;
          stackOut_13_1 = 256;
        ...
        ((vm) this).field_w = new byte[stackIn_16_1 << stackIn_16_2];
    }
    ...
    final void g() throws javax.sound.sampled.LineUnavailableException {
        ...
        ((vm) this).field_x.flush();
        if (((vm) this).field_z) {
            ((vm) this).field_x.close();
            ((vm) this).field_x = null;
            var1 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, ((vm) this).field_y, ((vm) this).field_v << (field_o ? 2 : 1));
            ((vm) this).field_x = (javax.sound.sampled.SourceDataLine) (Object) javax.sound.sampled.AudioSystem.getLine((javax.sound.sampled.Line.Info) (Object) var1);
            ((vm) this).field_x.open();
            ((vm) this).field_x.start();
        }
    }
