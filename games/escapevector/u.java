...
final class u {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((u) this).field_i.length;
        var4 = field_l[((u) this).field_a - 1];
        var5 = field_g;
        field_g[1] = true;
        var5[0] = true;
        var6 = 2;
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_c[var16];
                  var10 = field_b[var16] * ((u) this).field_a;
            ...
            L3: {
              var7 = u.b(field_c, var6);
              var8_int = u.a(field_c, var6);
              var9 = this.a(field_c[var7], field_b[var7], field_c[var8_int], field_b[var8_int], field_c[var6]);
              var10 = field_b[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean b() {
        ...
        int var2 = ((u) this).field_i.length;
        System.arraycopy((Object) (Object) ((u) this).field_i, 0, (Object) (Object) field_c, 0, var2);
        int var3 = field_l[((u) this).field_a - 1];
        int var4 = nm.a(var3 - 1, (byte) 78);
        field_b[0] = in.e(var4);
        field_b[1] = in.e(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((u) this).field_k.length; var6++) {
            var7 = ((u) this).field_k[var6];
            var8 = ((u) this).field_d[var7];
            var9 = ((u) this).field_f[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = in.field_k[((u) this).field_e[var7]].c();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((u) this).field_h[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_b[incrementValue$0] = var13 >= 0 ? in.field_k[var13].c() : 0;
            }
        }
        return true;
    }
    ...
    u() {
        ...
        if (var1 == 1) {
          var2 = in.e(5);
          var3 = 0;
          ((u) this).field_k = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((u) this).field_d = new int[var3];
              ((u) this).field_f = new int[var3];
              ((u) this).field_e = new int[var3];
              ((u) this).field_h = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((u) this).field_a = in.e(2) + 1;
                  var4 = in.e(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((u) this).field_i = new int[var5];
                      ((u) this).field_i[0] = 0;
                      ((u) this).field_i[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((u) this).field_d[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((u) this).field_i[incrementValue$2] = in.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((u) this).field_d[((u) this).field_k[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((u) this).field_d[var4] = in.e(3) + 1;
                    int dupTemp$3 = in.e(2);
                    ((u) this).field_f[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((u) this).field_e[var4] = in.e(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
