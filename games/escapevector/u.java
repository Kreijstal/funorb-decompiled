...
final class u {
    ...
    final boolean b() {
        ...
        field_b[1] = in.e(var4);
        int var5 = 2;
        for (var6 = 0; var6 < this.field_k.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = in.field_k[this.field_e[var7]].c();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_d[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_i[incrementValue$0] = in.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_d[this.field_k[var6]];
                      var6++;
                      continue L2;
                    }
                  }
