...
final class in extends hg {
    ...
    final hh a(int[] param0) {
        ...
        L1: {
          if (this.field_K != null) {
            ...
            this.field_J = 0;
            this.field_s = new float[field_m];
            this.field_K = new byte[this.field_y];
            this.field_G = 0;
            this.field_l = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (this.field_l >= this.field_h.length) {
            this.field_s = null;
            var12 = this.field_K;
            this.field_K = null;
            return new hh(this.field_v, var12, this.field_L, this.field_F, this.field_A);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - this.field_G);
                        break L7;
                      }
                    }
                    this.field_G = var3;
    ...
    final hh b() {
        ...
        this.field_J = 0;
        this.field_s = new float[field_m];
        var1 = new byte[this.field_y];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= this.field_h.length) {
            this.field_s = null;
            return new hh(this.field_v, var1, this.field_L, this.field_F, this.field_A);
          } else {
            var4 = this.f(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= this.field_y - var2) {
                  break L1;
                } else {
                  var5 = this.field_y - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    final static in a(mf param0, int param1, int param2) {
        try {
            ...
            in var4_ref = null;
            if (!in.a(param0)) {
                discarded$0 = param0.a(true, param1, param2);
                return null;
            }
    ...
    final static in a(mf param0, String param1, String param2) {
        try {
            ...
            in var4_ref = null;
            if (!in.a(param0)) {
                discarded$0 = param0.a(param2, param1, (byte) 98);
                return null;
            }
    ...
    private final void b(byte[] param0) throws IOException {
        ...
        byte[] var6 = null;
        n var2 = new n(param0);
        this.field_v = var2.g(-5053);
        this.field_y = var2.g(-5053);
        this.field_L = var2.g(-5053);
        this.field_F = var2.g(-5053);
        if (this.field_F < 0) {
                  ...
                  if (this.field_g) {
                    ...
                    L37: while (true) {
                      if (var19 >= this.field_r) {
                        ...
                        var20 = (this.field_J >> 1) + var19;
                        var40[var19] = var40[var19] + this.field_s[var20];
                        var19++;
                        continue L37;
                      }
                    }
