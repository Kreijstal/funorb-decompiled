...
final class in extends hg {
    private static int field_o;
    private static byte[] field_j;
    private float[] field_s;
    private int field_G;
    private static int[] field_w;
    private int field_v;
    private static ud[] field_N;
    ...
    private static pm[] field_H;
    private static u[] field_M;
    ...
    final hh a(int[] param0) {
        ...
        L1: {
          if (((in) this).field_K != null) {
            break L1;
          } else {
            ((in) this).field_J = 0;
            ((in) this).field_s = new float[field_m];
            ((in) this).field_K = new byte[((in) this).field_y];
            ((in) this).field_G = 0;
            ((in) this).field_l = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((in) this).field_l >= ((in) this).field_h.length) {
            ((in) this).field_s = null;
            var14 = ((in) this).field_K;
            ((in) this).field_K = null;
            return new hh(((in) this).field_v, var14, ((in) this).field_L, ((in) this).field_F, ((in) this).field_A);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((in) this).field_G;
                  var4 = var13.length;
                  if (var4 <= ((in) this).field_y - var3) {
                    break L5;
                  } else {
                    var4 = ((in) this).field_y - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((in) this).field_G);
                        break L7;
                      }
                    }
                    ((in) this).field_G = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((in) this).field_l = ((in) this).field_l + 1;
            continue L2;
          }
        }
    }
    ...
    final hh b() {
        ...
        ((in) this).field_J = 0;
        ((in) this).field_s = new float[field_m];
        var1 = new byte[((in) this).field_y];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((in) this).field_h.length) {
            ((in) this).field_s = null;
            return new hh(((in) this).field_v, var1, ((in) this).field_L, ((in) this).field_F, ((in) this).field_A);
          } else {
            var4 = this.f(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((in) this).field_y - var2) {
                  break L1;
                } else {
                  var5 = ((in) this).field_y - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    final static int c() {
        int var0 = field_j[field_o] >> field_C & 1;
        field_C = field_C + 1;
        field_o = field_o + (field_C >> 3);
        field_C = field_C & 7;
        return var0;
    }
    ...
    private final static boolean a(mf param0) {
        byte[] var1 = null;
        if (!field_n) {
            var1 = param0.a(0, (byte) -97, 0);
            if (var1 == null) {
                return false;
            }
            in.a(var1);
    ...
    private final void b(byte[] param0) throws IOException {
        ...
        byte[] var6 = null;
        n var2 = new n(param0);
        ((in) this).field_v = var2.g(-5053);
        ((in) this).field_y = var2.g(-5053);
        ...
        for (var4 = 0; var4 < var3; var4++) {
            ...
            var6 = new byte[var5];
            var2.a(var6, (byte) -96, 0, var5);
            ((in) this).field_h[var4] = var6;
        }
    }
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = in.e(16);
                                    int discarded$4 = in.e(16);
                                    field_w[var6] = in.e(8);
                                    var6++;
                                    continue L6;
                                  }
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = cm.a(var11, var10, (byte) 96);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    final static int e(int param0) {
        ...
        while (param0 >= 8 - field_C) {
            var3 = 8 - field_C;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_j[field_o] >> field_C & var4) << var2);
            field_C = 0;
            field_o = field_o + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_j[field_o] >> field_C & var3) << var2);
    ...
    private final float[] f(int param0) {
        ...
        L0: {
          in.a(((in) this).field_h[param0], 0);
          int discarded$1 = in.c();
          var2 = in.e(nm.a(field_w.length - 1, (byte) 78));
          var3 = field_t[var2] ? 1 : 0;
          if (var3 == 0) {
            stackOut_2_0 = field_q;
          ...
          L5: {
            ...
            if (var3 == 0) {
              ...
              if (var5 != 0) {
                ...
                var8 = (var4 >> 2) - (field_q >> 2);
                var9 = (var4 >> 2) + (field_q >> 2);
                var10 = field_q >> 1;
                break L4;
              }
            }
          ...
          L7: {
            if (var3 == 0) {
              ...
              if (var6 != 0) {
                ...
                var11 = var4 - (var4 >> 2) - (field_q >> 2);
                var12 = var4 - (var4 >> 2) + (field_q >> 2);
                var13 = field_q >> 1;
                break L6;
              }
            }
        ...
        L8: {
          var14 = field_H[field_w[var2]];
          var16 = var14.field_b;
          var17_int = var14.field_d[var16];
          if (field_M[var17_int].b()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_a) {
            L10: {
              if (var15 != 0) {
                ...
                field_M[var18_int].a(field_u, var4 >> 1);
                break L10;
              }
            }
            L11: {
                    ...
                    L13: while (true) {
                      if (var41 >= var4) {
                        ...
                        L15: {
                          var21 = stackIn_40_0;
                          if (var3 == 0) {
                            stackOut_42_0 = (float[]) field_z;
                            stackIn_43_0 = stackOut_42_0;
                            break L15;
                          } else {
                            stackOut_41_0 = (float[]) field_x;
                                                                          ...
                                                                          if (var26 >= var9) {
                                                                            ...
                                                                            L31: while (true) {
                                                                              if (var26 >= var12) {
                                                                                ...
                                                                                field_u[var26] = field_u[var26] * (float)Math.sin(1.5707963267948966 * (double)var27 * (double)var27);
                                                                                var26++;
                                                                                continue L31;
                                                                              }
                                                                            }
            ...
            L35: {
              var17 = null;
              if (((in) this).field_J <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((in) this).field_J + var4 >> 2;
                  ...
                  if (((in) this).field_g) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((in) this).field_r) {
                        break L36;
                      } else {
                        var20 = (((in) this).field_J >> 1) + var19;
                        var40[var19] = var40[var19] + ((in) this).field_s[var20];
                        var19++;
                        continue L37;
                      }
                    }
                ...
                if (var15 != 0) {
                  ...
                  L38: while (true) {
                    if (var19 >= var4 >> 1) {
                      ...
                      var40[var20] = var40[var20] + field_u[var19];
                      var19++;
                      continue L38;
                    }
                  }
            ...
            L39: {
              var18 = ((in) this).field_s;
              ((in) this).field_s = field_u;
              field_u = var18;
              ((in) this).field_J = var4;
              ((in) this).field_r = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    private in(byte[] param0) throws IOException {
        this.b(param0);
    }
