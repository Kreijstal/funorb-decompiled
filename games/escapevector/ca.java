...
abstract class ca {
    ...
    final static void a(int param0, int param1, bd param2) {
        try {
            ...
            throw t.a((Throwable) ((Object) runtimeException), "ca.E(" + param0 + ',' + param1 + ',' + (param2 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    public static void a(byte param0) {
        ...
        if (param0 != 104) {
            ...
            discarded$0 = ca.a(-29, 'ﾠ', (String) null, (String) null);
            field_c = null;
            field_d = null;
            field_a = null;
            return;
    ...
    final static String a(int param0, char param1, String param2, String param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("ca.D(").append(param0).append(',').append(param1).append(',');
