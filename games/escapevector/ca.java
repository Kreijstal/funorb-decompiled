    ...
    final static void a(int param0, int param1, bd param2) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_2_1 = new StringBuilder().append("ca.E(").append(1).append(44).append(6).append(44);
        ...
        try {
          L0: {
            ...
            L3: while (true) {
              ...
              if (var10 >= 0) {
                StringBuilder discarded$3 = var8.append(param2.substring(var9, var10));
                var9 = 1 + var10;
                StringBuilder discarded$4 = var8.append(param3);
                continue L3;
              } else {
                StringBuilder discarded$5 = var8.append(param2.substring(var9));
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("ca.D(").append(-1).append(44).append(95).append(44);
