    ...
    final static ja[] a(int param0, lk param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_19_1 = new StringBuilder().append("dh.A(").append(param0).append(',');
                    ...
                    if ((param2.field_g[1 + param2.field_m] ^ -1) == 116) {
                      ...
                      try {
                        L3: {
                          ...
                          discarded$2 = this.field_a.inflate(param1);
                          break L3;
                        }
