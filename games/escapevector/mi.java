...
final class mi extends hg {
    ...
    final void a(int param0, byte param1, int param2, int param3, int param4, int param5, int[] param6, int param7) {
        ...
        try {
            ...
            throw t.a((Throwable) (Object) runtimeException, "mi.D(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + (param6 != null ? "{...}" : "null") + 44 + param7 + 41);
        }
    }
    ...
    final static void a(int param0, String param1, String param2) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_2_1 = new StringBuilder().append("mi.C(").append(0).append(44);
    ...
    final static String a(byte[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 > 109) {
              stackOut_3_0 = qi.a(param0.length, 0, param0, (byte) -109);
