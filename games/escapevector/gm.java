...
final class gm {
    ...
    final static ed[] a(int param0, int param1, mf param2) {
        ...
        try {
          L0: {
            if (uc.a(param2, -80, param0, param1)) {
              stackOut_3_0 = g.e(15556);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("gm.C(").append(param0).append(',').append(param1).append(',');
          ...
          throw t.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + ',' + 8192 + ')');
        }
        return stackIn_4_0;
    }
