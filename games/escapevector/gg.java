...
final class gg {
    ...
    public final void enter(java.awt.Frame param0, int param1, int param2, int param3, int param4) {
        ...
        int var9 = 0;
        int var10 = 0;
        ((gg) this).field_b = ((gg) this).field_a.getDisplayMode();
        if (null == ((gg) this).field_b) {
          throw new NullPointerException();
        } else {
          L0: {
            param0.setUndecorated(true);
            param0.enableInputMethods(false);
            this.a(265181602, param0);
            if (param4 != 0) {
              break L0;
            } else {
              var6 = ((gg) this).field_b.getRefreshRate();
              var7 = ((gg) this).field_a.getDisplayModes();
              var8 = 0;
              var9 = 0;
              L1: while (true) {
                if (var7.length <= var9) {
          ...
          ((gg) this).field_a.setDisplayMode(new java.awt.DisplayMode(param1, param2, param3, param4));
          return;
        }
    }
    ...
    public final void exit() {
        if (null != ((gg) this).field_b) {
            ((gg) this).field_a.setDisplayMode(((gg) this).field_b);
            if (!((gg) this).field_a.getDisplayMode().equals(((gg) this).field_b)) {
                throw new RuntimeException("");
            }
            ((gg) this).field_b = null;
        }
        this.a(265181602, (java.awt.Frame) null);
    }
    ...
    public gg() throws Exception {
        ...
        ((gg) this).field_a = var1.getDefaultScreenDevice();
        if (((gg) this).field_a.isFullScreenSupported()) {
          return;
        } else {
          ...
          L0: while (true) {
            if (var4 >= var3.length) {
              throw gg.<RuntimeException>$cfr$sneakyThrow(new Exception());
            } else {
              var5 = var3[var4];
              if (var5 != null) {
                if (var5.isFullScreenSupported()) {
                  ((gg) this).field_a = var5;
                  return;
                } else {
                  var4++;
                  continue L0;
