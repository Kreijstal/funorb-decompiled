                              ...
                              if (!ie.field_o) {
                                      ...
                                      if (var16 >= 8) {
                                        ...
                                        L13: while (true) {
                                          if (var16 >= 4) {
                                            ...
                                            if (var28.field_a + 1 >= var28.field_b.length) {
                                              var28.field_a = 0;
                                              var16++;
                                              continue L13;
                                            } else {
                                ...
                                L15: while (true) {
                                  if (var13 >= var4) {
                                    ...
                                    var13++;
                                    var14 = ((wb) this).field_t[var13] >> var6;
                                    var13++;
                                    var15 = ((wb) this).field_t[var13] >> var6;
                                      ...
                                      if (var18 >= 8) {
                                        ...
                                        L17: while (true) {
                                          if (var18 >= 4) {
                                              ...
                                              if (var19 >= 8) {
                                                ...
                                                L19: while (true) {
                                                  if (var19 >= 4) {
                                                    ...
                                                    if (var26.field_a + 1 >= var26.field_b.length) {
                                                      var26.field_a = 0;
                                                      var19++;
                                                      continue L19;
                                                    } else {
                                            ...
                                            if (var24.field_a + 1 >= var24.field_b.length) {
                                              var24.field_a = 0;
                                              var18++;
                                              continue L17;
                                            } else {
