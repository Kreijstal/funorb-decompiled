...
final class di {
    ...
    final static void a(ed[] param0, int param1, int param2, int param3, int param4, int param5, wl param6, int param7, ed[] param8, boolean param9, int param10, int param11, wl param12) {
        ...
        try {
          var16 = null;
          ti.a(param8, 22, 22, 24, 0, 480, 0, 0, param3, lh.field_e, param12, pc.field_d, 24, 0, (ed[]) null, 2, 320, 0, gd.field_X, param6, param0);
          sm.a(false, param9);
          return;
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L0: {
            ...
            stackOut_2_1 = new StringBuilder().append("di.B(");
