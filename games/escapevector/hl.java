...
final class hl extends wg {
        ...
        L0: while (true) {
          if (this.field_v <= 0) {
            L1: {
              if (this.field_y != 256) {
                ...
                if ((this.field_u & 255) != 0) {
                  ...
                  if (ie.field_o) {
                    return hl.b(0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_x, this.field_s, 0, param3, param2, (hl) (this));
                  } else {
                    return hl.a(((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_m, 0, param3, param2, (hl) (this));
                  }
                }
              }
            }
            if (ie.field_o) {
              return hl.d(0, 0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_x, this.field_s, 0, param3, param2, (hl) (this), this.field_y, param4);
            } else {
              return hl.a(0, 0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_m, 0, param3, param2, (hl) (this), this.field_y, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_y != 256) {
                  ...
                  if ((this.field_u & 255) != 0) {
                    ...
                    if (!ie.field_o) {
                      param1 = hl.b(((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_m, this.field_k, 0, var6, param2, (hl) (this));
                      break L3;
                    } else {
                      param1 = hl.b(0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_x, this.field_s, this.field_t, this.field_p, 0, var6, param2, (hl) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!ie.field_o) {
                param1 = hl.b(0, 0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_m, this.field_k, 0, var6, param2, (hl) (this), this.field_y, param4);
                break L3;
              } else {
                param1 = hl.a(0, 0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_x, this.field_s, this.field_t, this.field_p, 0, var6, param2, (hl) (this), this.field_y, param4);
                break L3;
              }
            }
            this.field_v = this.field_v - param1;
    ...
    private final void g() {
        ...
        this.field_x = hl.d(this.field_o, this.field_n);
        this.field_s = hl.a(this.field_o, this.field_n);
    }
        ...
        L0: while (true) {
          if (this.field_v <= 0) {
            L1: {
              if (this.field_y != -256) {
                ...
                if ((this.field_u & 255) != 0) {
                  ...
                  if (ie.field_o) {
                    return hl.a(0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_x, this.field_s, 0, param3, param2, (hl) (this));
                  } else {
                    return hl.b(((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_m, 0, param3, param2, (hl) (this));
                  }
                }
              }
            }
            if (ie.field_o) {
              return hl.a(0, 0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_x, this.field_s, 0, param3, param2, (hl) (this), this.field_y, param4);
            } else {
              return hl.b(0, 0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_m, 0, param3, param2, (hl) (this), this.field_y, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_v;
            ...
            L3: {
              L4: {
                ...
                if (this.field_y != -256) {
                  ...
                  if ((this.field_u & 255) != 0) {
                    ...
                    if (!ie.field_o) {
                      param1 = hl.a(((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_m, this.field_k, 0, var6, param2, (hl) (this));
                      break L3;
                    } else {
                      param1 = hl.a(0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_x, this.field_s, this.field_t, this.field_p, 0, var6, param2, (hl) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!ie.field_o) {
                param1 = hl.c(0, 0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_m, this.field_k, 0, var6, param2, (hl) (this), this.field_y, param4);
                break L3;
              } else {
                param1 = hl.b(0, 0, ((hh) ((Object) this.field_g)).field_h, param0, this.field_u, param1, this.field_x, this.field_s, this.field_t, this.field_p, 0, var6, param2, (hl) (this), this.field_y, param4);
                break L3;
              }
            }
            this.field_v = this.field_v - param1;
    ...
    private final boolean i() {
        ...
        L0: {
          var1 = this.field_o;
          if (var1 != -2147483648) {
            var2 = hl.d(var1, this.field_n);
            var3 = hl.a(var1, this.field_n);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_m >= var1) {
            if (this.field_m <= var1) {
              ...
              this.field_k = -1;
              this.field_v = this.field_m - var1;
              break L2;
            }
          } else {
            this.field_k = 1;
            this.field_v = var1 - this.field_m;
            break L2;
          }
        }
        L3: {
          if (this.field_x >= var2) {
            if (this.field_x <= var2) {
              ...
              L4: {
                ...
                if (this.field_v == 0) {
                  ...
                  if (this.field_v <= this.field_x - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_v = this.field_x - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_v == 0) {
                ...
                if (this.field_v <= var2 - this.field_x) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_v = var2 - this.field_x;
            break L3;
          }
        }
        if (this.field_s < var3) {
        ...
        L0: {
          if (this.field_v <= 0) {
            ...
            if (param0 < this.field_v) {
              this.field_m = this.field_m + this.field_k * param0;
              this.field_x = this.field_x + this.field_t * param0;
                  ...
                  if (this.field_y >= 0) {
                    if (this.field_u >= var4) {
                      ...
                      if (var7 < this.field_r) {
                        ...
                        this.field_u = this.field_u - var6 * this.field_r;
                        this.field_r = 0;
                        break L5;
                      }
                    } else {
    ...
    final synchronized void e() {
        ...
        this.field_y = -this.field_y;
        this.field_u = ((hh) ((Object) this.field_g)).field_h.length - 1 << 8;
    }
    ...
    final synchronized void e(int param0) {
        param0 = param0 << 8;
        int var2 = ((hh) ((Object) this.field_g)).field_h.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
          ...
          L4: {
            if (this.field_r <= 0) {
              ...
              if (!this.field_w) {
                if (this.field_y >= 0) {
                  L5: while (true) {
                    var9 = this.a(param0, var9, var6, param2, (int) var4.field_h[this.field_q]);
                    if (this.field_u >= var6) {
                      ...
                      if (var10 < this.field_r) {
                        ...
                        this.field_u = this.field_u - var8 * this.field_r;
                        this.field_r = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_h[this.field_l - 1]);
                    if (this.field_u < var5) {
                ...
                L7: {
                  if (this.field_y >= 0) {
                    ...
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_h[this.field_q]);
                    if (this.field_u < var5) {
                ...
                L8: while (true) {
                  var9 = this.a(param0, var9, var6, param2, (int) var4.field_h[this.field_l - 1]);
                  if (this.field_u >= var6) {
    ...
    final int d() {
        int var1 = this.field_m * 3 >> 6;
        var1 = (var1 ^ var1 >> 31) + (var1 >>> 31);
        if (this.field_r == 0) {
            var1 = var1 - var1 * this.field_u / (((hh) ((Object) this.field_g)).field_h.length << 8);
        } else {
            if (this.field_r >= 0) {
                var1 = var1 - var1 * this.field_q / ((hh) ((Object) this.field_g)).field_h.length;
            }
        }
          ...
          if (this.field_x == var4) {
            if (this.field_s == var5) {
              ...
              L0: {
                ...
                if (this.field_m - param1 <= var6) {
                  break L0;
                } else {
                  var6 = this.field_m - param1;
                  break L0;
                }
              }
              L1: {
              ...
              this.field_o = param1;
              this.field_n = param2;
              this.field_k = (param1 - this.field_m) / param0;
              this.field_t = (var4 - this.field_x) / param0;
    ...
    final int a() {
        if (this.field_o == 0 && this.field_v == 0) {
            return 0;
        }
        return 1;
    }
        ...
        if (param0 != 0) {
          if (this.field_x == 0) {
            if (this.field_s == 0) {
              ...
              this.field_k = -this.field_m / param0;
              this.field_t = -this.field_x / param0;
    ...
    private hl(hh param0, int param1, int param2) {
        this.field_g = (nh) ((Object) param0);
        this.field_q = param0.field_k;
        this.field_l = param0.field_l;
        this.field_w = param0.field_i;
        this.field_y = param1;
        this.field_o = param2;
        this.field_n = 8192;
        this.field_u = 0;
