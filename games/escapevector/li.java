    ...
    private final boolean[] a(int[] param0, int param1, int param2, byte param3) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_31_1 = new StringBuilder().append("li.IA(");
    ...
    private final int[] a(int[] param0, int param1, boolean param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_17_1 = new StringBuilder().append("li.W(");
    ...
    private final String[] b(cn param0, int param1) {
        ...
        try {
              ...
              if (var6 == null) {
                L2: {
                  if (param1 == 11125) {
                    ...
                    discarded$4 = this.a(54, -100, (byte) 126, 78, 66, 10, 81);
                    break L2;
                  }
                }
                ...
                var5++;
                var4[incrementValue$5] = var7.field_g;
                var6 = param0.b((byte) 70);
                continue L1;
              }
            }
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("li.G(");
    ...
    private final boolean[] a(int param0, boolean[] param1) {
        ...
        try {
          ...
          L2: {
            var3 = decompiledCaughtException;
            stackOut_6_0 = (RuntimeException) (var3);
            stackOut_6_1 = new StringBuilder().append("li.Q(").append(param0).append(',');
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
