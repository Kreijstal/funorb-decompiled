          ...
          L0: while (true) {
            if ((var2 ^ -1) <= -257) {
              ...
              L1: {
                ...
                if (0 != (var2 & 2)) {
                  if ((1 & var2) != 0) {
                    this.field_b = this.field_b ^ this.field_b >>> 1122678928;
                    break L1;
                  } else {
                    this.field_b = this.field_b ^ this.field_b << -1966116830;
                    break L1;
                  }
                } else {
                  if ((var2 & 1) != 0) {
                    this.field_b = this.field_b ^ this.field_b >>> -1889161722;
                    break L1;
                  } else {
                    this.field_b = this.field_b ^ this.field_b << -1621742835;
                    break L1;
                  }
                }
              }
