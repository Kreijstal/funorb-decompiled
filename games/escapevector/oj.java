...
final class oj extends hc {
    ...
    final void a(int param0, int param1, int param2, hm param3) {
        try {
            ...
            throw t.a((Throwable) (Object) runtimeException, "oj.Q(" + param0 + 44 + param1 + 44 + param2 + 44 + (param3 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final boolean a(int param0, hm param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("oj.M(").append(param0).append(44);
    ...
    final void a(int param0, byte param1, int param2, int param3) {
        ...
        if (param1 >= 85) {
          if (param2 != 0) {
            ...
            L0: {
              var5 = ((oj) this).field_k + param3 + (((oj) this).field_g >> 1);
              var6 = ((oj) this).field_j + param0 - -(((oj) this).field_x >> 1);
              ...
              if (var8 == of.field_f) {
                ...
                if (ug.field_c == var8) {
                  ...
                  if (ob.field_a != var8) {
                    if (df.field_h == var8) {
                      var23 = ul.field_E[1];
                      var23.c(-(var23.field_s >> 1) + var5, var6 + -(var23.field_x >> 1), 256);
                      return;
                    } else {
                      return;
                    }
                    ...
                    var24 = ul.field_E[2];
                    var24.c(var5 + -(var24.field_s >> 1), var6 + -(var24.field_x >> 1), 256);
                    return;
                  }
                }
              }
            ...
            var25 = ul.field_E[0];
            var9 = var25.field_A << 1;
            var10 = var25.field_z << 1;
            if (pi.field_j != null) {
              if (pi.field_j.field_s >= var9) {
                if (var10 <= pi.field_j.field_x) {
                  eo.a(pi.field_j, (byte) -79);
                  em.d();
                  var25.b(112, 144, var25.field_A << 4, var25.field_z << 4, -((oj) this).field_R << 10, 4096);
                  dl.a((byte) 116);
            ...
            if (var8 != of.field_f) {
              if (ug.field_c != var8) {
                if (ob.field_a != var8) {
                  if (df.field_h == var8) {
                    var17 = ul.field_E[1];
                    var17.c(-(var17.field_s >> 1) + var5, var6 + -(var17.field_x >> 1), 256);
                    return;
                  } else {
                    return;
                  }
                  ...
                  var18 = ul.field_E[2];
                  var18.c(var5 + -(var18.field_s >> 1), var6 + -(var18.field_x >> 1), 256);
                  return;
                }
              } else {
                L1: {
                ...
                var16.b(112, 144, var16.field_A << 4, var16.field_z << 4, -((oj) this).field_R << 10, 4096);
                dl.a((byte) 116);
              ...
              var15.b(112, 144, var15.field_A << 4, var15.field_z << 4, -((oj) this).field_R << 10, 4096);
              dl.a((byte) 116);
    ...
    oj(el param0) {
        try {
            ...
            throw t.a((Throwable) (Object) runtimeException, "oj.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
