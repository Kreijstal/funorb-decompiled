...
final class rc {
    ...
    final static void a(java.awt.Canvas param0) {
        ...
        try {
          ...
          throw t.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + ',' + true + ')');
        }
    }
    ...
    final static fn a(int param0, byte param1, fn param2, fn param3) {
        ...
        try {
          L0: {
            ...
            stackOut_11_0 = new fn(var4_int, var5);
          ...
          L5: {
            ...
            stackOut_13_1 = new StringBuilder().append("rc.B(").append(param0).append(',').append(param1).append(',');
