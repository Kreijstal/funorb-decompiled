...
final class jm extends hm {
        ...
        try {
            ...
            try {
              ...
              L8: {
                ...
                stackOut_16_1 = new StringBuilder().append("jm.I(").append(param0).append(',');
                stackIn_18_0 = stackOut_16_0;
                stackIn_18_1 = stackOut_16_1;
    ...
    private final ed a(boolean param0, int param1, int param2) {
        ...
        L0: {
          ...
          var14 = new ed(2 * this.field_z, this.field_x);
          eo.a(var14, (byte) -90);
          var5 = this.field_x >> 910424289;
          var6 = 0;
          if (param0) {
            break L0;
          } else {
    ...
    final static byte[] a(int param0, int param1, c param2, byte[] param3) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_19_1 = new StringBuilder().append("jm.A(").append(param0).append(',').append(param1).append(',');
