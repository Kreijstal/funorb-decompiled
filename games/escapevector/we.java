...
final class we {
    ...
    final void a(n param0) {
        ...
        L3: while (true) {
          L4: {
            if (var3 >= 10) {
              ...
              if (var4 != 0) {
                ...
                this.field_v[var3] = param0.e((byte) 56);
                this.field_i[var3] = param0.b(true);
                var3++;
                continue L3;
              } else {
                break L4;
          ...
          this.field_w = param0.b(true);
          this.field_l = param0.f(1952);
          this.field_s = param0.f(1952);
          this.field_n = new cl();
          this.field_q = new wj();
          this.field_n.a(param0, this.field_q);
          return;
        }
    }
        ...
        if (param1 >= 10) {
          L0: {
            ...
            if (this.field_a == null) {
              ...
              this.field_a.a();
              this.field_d.a();
              var5 = (int)((double)(this.field_a.field_b - this.field_a.field_j) * 32.768 / var3);
              var6 = (int)((double)this.field_a.field_j * 32.768 / var3);
              break L0;
            }
          }
          L1: {
            ...
            if (this.field_p == null) {
              ...
              this.field_p.a();
              this.field_k.a();
              var8 = (int)((double)(this.field_p.field_b - this.field_p.field_j) * 32.768 / var3);
              var9 = (int)((double)this.field_p.field_j * 32.768 / var3);
              break L1;
            }
          }
          var11 = 0;
            ...
            if (var11 >= 5) {
              ...
              L3: while (true) {
                if (var11 >= param0) {
                      ...
                      L5: while (true) {
                        if (var14 >= param0) {
                          ...
                          L6: {
                            ...
                            if (var13 == 0) {
                              var12 = this.field_e.field_j + ((this.field_e.field_b - this.field_e.field_j) * var16 >> 8);
                              break L6;
                            } else {
                              var12 = this.field_e.field_j + ((this.field_e.field_b - this.field_e.field_j) * var15 >> 8);
                              break L6;
                            }
                          }
                          L7: {
                      ...
                      if (this.field_w <= 0) {
                        ...
                        L10: while (true) {
                          if (var12 >= param0) {
                            ...
                            field_y[var12] = field_y[var12] + field_y[var12 - var11] * this.field_w / 100;
                            var12++;
                            continue L10;
                          }
                        }
                  ...
                  L11: {
                    L12: {
                      if (this.field_n.field_g[0] > 0) {
                        break L12;
                      } else {
                        if (this.field_n.field_g[1] <= 0) {
                          break L11;
                        } else {
                          break L12;
                        }
                  ...
                  L27: {
                    ...
                    if (this.field_a == null) {
                      ...
                      var12 = var12 + (this.a(var7, var15, this.field_a.field_e) >> 1);
                  ...
                  L28: {
                    if (this.field_p == null) {
                      ...
                      var13 = var13 * ((this.a(var10, var15, this.field_p.field_e) >> 1) + 32768) >> 15;
                  ...
                  L29: while (true) {
                    if (var14 < 5) {
                      if (this.field_t[var14] != 0) {
                        ...
                        if (var15 < param0) {
                          field_y[var15] = field_y[var15] + this.a(field_c[var14], var13 * field_g[var14] >> 15, this.field_u.field_e);
              ...
              if (this.field_t[var11] != 0) {
                field_c[var11] = 0;
                field_j[var11] = (int)((double)this.field_i[var11] * var3);
                field_g[var11] = (this.field_t[var11] << 14) / 100;
                field_o[var11] = (int)((double)(this.field_u.field_b - this.field_u.field_j) * 32.768 * Math.pow(1.0057929410678534, (double)this.field_v[var11]) / var3);
                field_f[var11] = (int)((double)this.field_u.field_j * 32.768 / var3);
                var11++;
                continue L2;
              } else {
                var11++;
