        ...
        try {
          L0: {
            if (this.field_p.a(-1, param1) == ob.field_a) {
              stackOut_2_0 = this.field_p.a((byte) -53, param1);
    ...
    final static int a(int param0, int param1, int param2, CharSequence param3, byte[] param4, int param5) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_69_1 = new StringBuilder().append("dg.H(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw t.a((Throwable) ((Object) stackIn_75_0), stackIn_75_2 + ',' + param5 + ')');
        }
        return stackIn_68_0;
    }
