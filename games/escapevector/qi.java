...
final class qi extends bj implements qb {
          ...
          L0: {
            L1: {
              ...
              if (param1 == -67) {
                ...
                var6 = (byte[]) null;
                discarded$2 = qi.a(114, 51, (byte[]) null, (byte) 116);
                break L1;
              }
            }
    ...
    final void a(int param0, byte param1, int param2, int param3) {
        ...
        int discarded$0 = this.field_L.a(this.field_G, 14 + (this.field_k + param3), 10 + param0 + this.field_j, -28 + this.field_g, this.field_x, 16777215, -1, 0, 0, this.field_L.field_r);
    }
    ...
    final static String a(int param0, int param1, byte[] param2, byte param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_15_1 = new StringBuilder().append("qi.C(").append(param0).append(',').append(param1).append(',');
