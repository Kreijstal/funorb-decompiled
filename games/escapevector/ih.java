 ...
 */
final class ih extends wl {
    private byte[][] field_O;

    ih(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        super(param0, param1, param2, param3, param4);
        ((ih) this).field_O = new byte[256][];
        ((ih) this).field_O = param5;
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * em.field_l;
          var10 = em.field_l - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= em.field_k) {
            break L0;
          } else {
            var13 = em.field_k - param2;
            param4 = param4 - var13;
            param2 = em.field_k;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * em.field_l;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= em.field_j) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - em.field_j);
            break L1;
          }
        }
        L2: {
          if (param1 >= em.field_a) {
            break L2;
          } else {
            var13 = em.field_a - param1;
            param3 = param3 - var13;
            param1 = em.field_a;
            var12 = var12 + var13;
            var9 = var9 + var13;
        ...
        L3: {
          if (param1 + param3 <= em.field_b) {
            break L3;
          } else {
            var13 = param1 + param3 - em.field_b;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              ih.a(em.field_i, ((ih) this).field_O[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * em.field_l;
          var9 = em.field_l - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= em.field_k) {
            break L0;
          } else {
            var12 = em.field_k - param2;
            param4 = param4 - var12;
            param2 = em.field_k;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * em.field_l;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= em.field_b) {
            ...
            var12 = param1 + param3 - em.field_b;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (em.field_c == null) {
                  ih.a(em.field_i, ((ih) this).field_O[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  ih.a(em.field_i, ((ih) this).field_O[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, em.field_c, em.field_f);
                  break L5;
                }
              }
              return;
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19 = 0;
        int var20 = 0;
        var13 = param2 - em.field_a;
        var14 = param3 - em.field_k;
        var15 = var14;
        L0: while (true) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  em.field_i[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
