...
final class tm extends vg implements qb {
    ...
    public final void a(hc param0, int param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          throw t.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    private final hc a(int param0, String param1, wn param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("tm.D(").append(param0).append(44);
