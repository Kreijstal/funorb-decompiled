...
final class en {
    ...
    final boolean b() {
        ...
        int var2 = ((en) this).field_i.length;
        System.arraycopy((Object) (Object) ((en) this).field_i, 0, (Object) (Object) field_l, 0, var2);
        int var3 = field_k[((en) this).field_h - 1];
        int var4 = aq.a((byte) 6, var3 - 1);
        field_f[0] = qd.f(var4);
        field_f[1] = qd.f(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((en) this).field_a.length; var6++) {
            var7 = ((en) this).field_a[var6];
            var8 = ((en) this).field_e[var7];
            var9 = ((en) this).field_j[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = qd.field_q[((en) this).field_g[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((en) this).field_b[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_f[incrementValue$0] = var13 >= 0 ? qd.field_q[var13].a() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((en) this).field_i.length;
        var4 = field_k[((en) this).field_h - 1];
        var5 = field_d;
        field_d[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_f[0] * ((en) this).field_h;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_d[var16]) {
                  var9 = field_l[var16];
                  var10 = field_f[var16] * ((en) this).field_h;
            ...
            L3: {
              var7 = en.a(field_l, var6);
              var8_int = en.b(field_l, var6);
              var9 = this.a(field_l[var7], field_f[var7], field_l[var8_int], field_f[var8_int], field_l[var6]);
              var10 = field_f[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    en() {
        ...
        if (var1 == 1) {
          var2 = qd.f(5);
          var3 = 0;
          ((en) this).field_a = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((en) this).field_e = new int[var3];
              ((en) this).field_j = new int[var3];
              ((en) this).field_g = new int[var3];
              ((en) this).field_b = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((en) this).field_h = qd.f(2) + 1;
                  var4 = qd.f(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((en) this).field_i = new int[var5];
                      ((en) this).field_i[0] = 0;
                      ((en) this).field_i[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((en) this).field_e[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((en) this).field_i[incrementValue$2] = qd.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((en) this).field_e[((en) this).field_a[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((en) this).field_e[var4] = qd.f(3) + 1;
                    int dupTemp$3 = qd.f(2);
                    ((en) this).field_j[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((en) this).field_g[var4] = qd.f(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
