...
final class en {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_i, 0, field_l, 0, var2);
        int var3 = field_k[this.field_h - 1];
        ...
        for (var6 = 0; var6 < this.field_a.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = qd.field_q[this.field_g[var7]].a();
            }
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_d[var16]) {
                  var9 = field_l[var16];
                  var10 = field_f[var16] * this.field_h;
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_e[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_i[incrementValue$0] = qd.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_e[this.field_a[var6]];
                      var6++;
                      continue L2;
                    }
                  }
