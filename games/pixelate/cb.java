...
final class cb implements Runnable {
                                    ...
                                    if (((cb) this).field_x) {
                                      if (var2_int != 3) {
                                        if (21 != var2_int) {
                                          if (var2_int != 5) {
                                            if (var2_int == 6) {
                                              ...
                                              if (!((cb) this).field_v) {
                                                Object discarded$7 = Class.forName("gl").getMethod("enter", new Class[5]).invoke(((cb) this).field_g, new Object[5]);
                                                break L8;
                                              } else {
                                                ((cb) this).field_s.a(65535 & var8_ref.field_a, (byte) 122, 65535 & var8_ref.field_c, var8_ref.field_c >> 16, var8_ref.field_a >>> 16, var16);
                                                break L8;
                                              }
                                            } else {
                                              if (7 == var2_int) {
                                                if (((cb) this).field_v) {
                                                  ...
                                                  Object discarded$8 = Class.forName("gl").getMethod("exit", new Class[0]).invoke(((cb) this).field_g, new Object[0]);
                                                  break L8;
                                                }
                                              } else {
                                                if (var2_int != 12) {
                                                      ...
                                                      if (!((cb) this).field_x) {
                                                        ...
                                                        if (var2_int != 15) {
                                                          ...
                                                          if (((cb) this).field_v) {
                                                            ...
                                                            Object discarded$10 = Class.forName("cj").getDeclaredMethod("showcursor", new Class[2]).invoke(((cb) this).field_n, new Object[2]);
                                                            break L8;
                                                          }
                                                        }
                                                      }
                                                    ...
                                                    L12: {
                                                      if (((cb) this).field_v) {
                                                        ...
                                                        if (var2_int != 17) {
                                                          ...
                                                          Object discarded$11 = Class.forName("cj").getDeclaredMethod("setcustomcursor", new Class[5]).invoke(((cb) this).field_n, new Object[5]);
                                                          break L8;
                                                        }
                                                      }
                                                    }
                                        ...
                                        if (field_c > hm.a(64)) {
                                          ...
                                          var12 = (var8_ref.field_a >> 24 & 255) + "." + (255 & var8_ref.field_a >> 16) + "." + (255 & var8_ref.field_a >> 8) + "." + (var8_ref.field_a & 255);
                        ...
                        if (~hm.a(64) <= ~field_c) {
                          try {
                            L18: {
                              ...
                              var8_ref.field_e = (Object) (Object) qe.a((String) var8_ref.field_g, var8_ref.field_a).a(116);
                              break L18;
                            }
    ...
    final ei a(int param0, int param1, int param2, int param3, int param4) {
        ...
        return this.a(param4 + (param0 << 16), 6, param3 + -27832, (Object) null, param1 + (param2 << 16));
    }
    ...
    private final ei a(boolean param0, int param1, boolean param2, String param3) {
        return this.a(0, 1, 34, (Object) (Object) param3, param1);
    }
