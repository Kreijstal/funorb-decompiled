...
class ch extends ng implements j {
          ...
          L0: {
            ...
            L2: while (true) {
              if (var6 == null) {
                ...
                L3: while (true) {
                  if (var7 > param0) {
                    discarded$13 = var6.a(param3, false, param0 - -1, param1);
          ...
          L0: {
            ...
            L1: while (true) {
              ...
              if (80 == var6) {
                L4: {
                  if (!bc.field_m[81]) {
                    stackOut_13_0 = this.b(10, param2);
                    stackIn_14_0 = stackOut_13_0;
                    break L4;
                  } else {
              ...
              L1: while (true) {
                if (var4 == null) {
                  ...
                  L2: {
                    if (var4.b(true)) {
                      var5 = new nm(this.field_F);
                      discarded$5 = var5.b((byte) -87, var4);
                      var6 = (ng) ((Object) var5.a((byte) -104));
                      L3: while (true) {
                        if (var6 == null) {
                          break L2;
    ...
    final void h(int param0) {
        ...
        if (param0 != 2) {
            ng var5 = (ng) null;
            discarded$0 = this.a(-101, 97, (ng) null, '');
        }
    ...
    final static void a(boolean param0, String param1, int param2, int param3, tf[] param4, int param5, int param6, int param7, tf[] param8, boolean param9, jl param10, int param11, byte param12, int param13, int param14) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ch.V(").append(param0).append(',');
          ...
          L3: {
            stackOut_8_0 = (RuntimeException) ((Object) stackIn_8_0);
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',');
          ...
          L4: {
            stackOut_11_0 = (RuntimeException) ((Object) stackIn_11_0);
            stackOut_11_1 = ((StringBuilder) (Object) stackIn_11_1).append(stackIn_11_2).append(',').append(param9).append(',');
            stackIn_13_0 = stackOut_11_0;
            stackIn_13_1 = stackOut_11_1;
            stackIn_12_0 = stackOut_11_0;
            stackIn_12_1 = stackOut_11_1;
          ...
          throw aa.a((Throwable) ((Object) stackIn_14_0), stackIn_14_2 + ',' + param11 + ',' + param12 + ',' + param13 + ',' + param14 + ')');
        }
    }
