...
final class oi {
    ...
    final static void a(String param0, String param1, byte param2) {
        try {
            ...
            throw aa.a((Throwable) (Object) runtimeException, "oi.B(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + -33 + 41);
        }
    }
    ...
    final static void a(int param0, int param1, int param2, byte param3, uj param4, int param5, gp param6) {
        ...
        try {
            ...
            throw aa.a((Throwable) (Object) runtimeException, "oi.D(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + param5 + 44 + (param6 != null ? "{...}" : "null") + 41);
        }
    }
