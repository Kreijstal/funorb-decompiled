          ...
          if (((mn) this).field_g.length != 0) {
            ...
            L0: while (true) {
              if (((mn) this).field_g.length <= var3) {
                ...
                if (param0 >= ((mn) this).field_g[var3] + ((mn) this).field_g[-1 + var3] >> 1) {
                  var3++;
                  continue L0;
                } else {
                  return -1 + var3;
    ...
    final static cm a(int param0, pp param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("mn.B(").append(param0).append(44);
        ...
        try {
          L0: {
            if (!param1.b(-3)) {
              ...
              stackOut_6_0 = param2 + " - " + param1.c(109, param3) + "%";
              stackIn_7_0 = stackOut_6_0;
              break L0;
            }
          }
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("mn.D(").append(param0).append(44);
