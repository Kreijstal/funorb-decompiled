          ...
          if (this.field_g.length != 0) {
            ...
            L0: while (true) {
              if (this.field_g.length <= var3) {
                if (param1 != 27760) {
                  var5 = (String) null;
                  discarded$2 = mn.a(-39, (fm) null, (String) null, (String) null, (String) null);
                  return -1 + this.field_g.length;
                } else {
                  return -1 + this.field_g.length;
                }
              } else {
                if (param0 >= this.field_g[var3] + this.field_g[-1 + var3] >> 309538785) {
                  var3++;
                  continue L0;
                } else {
                  return -1 + var3;
    ...
    final static cm a(int param0, pp param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("mn.B(").append(param0).append(',');
