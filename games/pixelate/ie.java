...
abstract class ie extends ng implements j {
    ...
    private final boolean a(byte param0, ng param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("ie.V(").append(param0).append(44);
    ...
    boolean a(byte param0, ng param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_7_1 = new StringBuilder().append("ie.N(").append(param0).append(44);
    ...
    final boolean a(int param0, byte param1, int param2, int param3, int param4, int param5, ng param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("ie.FA(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44).append(param5).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    final static void a(int param0, int param1, boolean param2, int param3, int param4, int param5, int param6) {
        ...
        try {
              ...
              if (param0 > param4 + 1) {
                ...
                L2: {
                  if (param0 <= param4 + 5) {
                    ...
                    if (param1 != param3) {
                      var7_int = (param1 >> 1) - (-(param3 >> 1) + -(1 & (param3 & param1)));
                      var8 = param4;
                      var9 = param3;
                      var10 = param1;
                      var11 = param4;
                      L3: while (true) {
                        if (var11 >= param0) {
                          ...
                          L4: {
                            ...
                            if (!param2) {
                              stackOut_23_0 = nb.field_c[var12];
                              stackIn_24_0 = stackOut_23_0;
                              break L4;
                            } else {
                              stackOut_22_0 = ep.field_c[var12];
          ...
          throw aa.a((Throwable) (Object) var7, "ie.BA(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
    }
    ...
    private final boolean a(int param0, ng param1) {
        ...
        try {
          ...
          L4: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) var3;
            stackOut_8_1 = new StringBuilder().append("ie.T(").append(param0).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    final boolean a(ng param0, int param1) {
        ...
        try {
              ...
              L1: {
                L2: {
                  if (null == ((ie) this).field_H) {
                    ...
                    if (!((ie) this).field_H.a(param0, param1)) {
                      break L2;
                    } else {
                      stackOut_5_0 = 1;
                      stackIn_7_0 = stackOut_5_0;
          ...
          L3: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) var3;
            stackOut_8_1 = new StringBuilder().append("ie.HA(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    StringBuilder a(StringBuilder param0, boolean param1, int param2, Hashtable param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("ie.AA(");
    ...
    void a(int param0, int param1, int param2, ng param3) {
        ...
        try {
          ...
          L3: {
            var5 = decompiledCaughtException;
            stackOut_6_0 = (RuntimeException) var5;
            stackOut_6_1 = new StringBuilder().append("ie.L(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
    ...
    void a(int param0, int param1, ng param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ie.EA(").append(param0).append(44).append(param1).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
    ...
    final void a(Hashtable param0, byte param1, StringBuilder param2, int param3) {
        ...
        try {
            ...
            if (param1 < -79) {
              L1: while (true) {
                if (var5_int > param3) {
                  L2: {
                    if (((ie) this).field_H == null) {
                      StringBuilder discarded$15 = param2.append("null");
                      break L2;
                    } else {
                      StringBuilder discarded$16 = ((ie) this).field_H.a(param2, false, param3 - -1, param0);
                      break L2;
                    }
                  }
                  break L0;
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("ie.W(");
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
            stackIn_10_0 = stackOut_9_0;
            stackIn_10_1 = stackOut_9_1;
        ...
        try {
          L0: {
            L1: {
              if (null == ((ie) this).field_H) {
                ...
                if (!((ie) this).field_H.b(true)) {
                  ...
                  if (!((ie) this).field_H.a(param0, param1, param2, param3)) {
                    break L1;
                  } else {
                    stackOut_3_0 = 1;
            ...
            if (var5_int == 80) {
              L3: {
                if (bc.field_m[81]) {
                  stackOut_11_0 = this.a((byte) -127, param2);
                  stackIn_12_0 = stackOut_11_0;
                  break L3;
                } else {
                  stackOut_10_0 = this.a(11627, param2);
                  stackIn_12_0 = stackOut_10_0;
                  break L3;
                }
              }
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("ie.G(").append(param0).append(44).append(param1).append(44);
            stackIn_15_0 = stackOut_13_0;
            stackIn_15_1 = stackOut_13_1;
