...
final class wh extends de {
    ...
    private final void a(int param0, int param1, int param2, int param3, int param4, String param5, int param6, tc param7, int param8, int param9, int param10) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_13_1 = new StringBuilder().append("wh.J(").append(0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',');
    ...
    final static void e() {
        ...
        try {
          ...
          throw aa.a((Throwable) (Object) var1, "wh.I(" + -84 + ')');
        }
    }
    ...
    final static void a(java.math.BigInteger param0, we param1, java.math.BigInteger param2, we param3) {
        ...
        try {
          ...
          throw aa.a((Throwable) (Object) stackIn_14_0, stackIn_14_2 + ',' + 12556 + ')');
        }
    }
