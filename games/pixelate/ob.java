...
final class ob extends jl {
    ...
    final int g(int param0) {
        return ob.a(((ob) this).field_R[0], param0);
    }
    ...
    ob(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        ...
        ((ob) this).field_S = new byte[256][];
        ((ob) this).field_S = param6;
        ((ob) this).field_R = new int[4][];
        ((ob) this).field_R[0] = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  ob.a(0, t.field_k, ((ob) this).field_S[param0], ((ob) this).field_R[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  tc.a(t.field_k, ((ob) this).field_S[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  ob.a(0, t.field_k, ((ob) this).field_S[param0], ((ob) this).field_R[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  tc.a(t.field_k, ((ob) this).field_S[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
