...
final class on extends hb {
    ...
    final void c(ng param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("on.R(");
    ...
    final static String a(int param0, String param1, int param2) {
        ...
        try {
          L0: {
            if (param0 == 1) {
              stackOut_2_0 = sd.a(bg.field_f, 32, new String[1]);
              ...
              if (param0 != 2) {
                if (param0 != 3) {
                  if (param0 != 4) {
                    if (param0 == 5) {
                      stackOut_15_0 = sd.a(ll.field_p, 38, new String[1]);
                      ...
                      if (param0 != 6) {
                        if (param0 != 7) {
                          if (param0 != 8) {
                            if (param0 == 11) {
                              stackOut_28_0 = sd.a(vg.field_e, 73, new String[1]);
                              stackIn_29_0 = stackOut_28_0;
                              return stackIn_29_0;
                            } else {
                              if (param0 != 12) {
                                if (13 == param0) {
                                  stackOut_35_0 = sd.a(un.field_c, 118, new String[1]);
                                ...
                                stackOut_31_0 = sd.a(li.field_j, 59, new String[1]);
                                stackIn_32_0 = stackOut_31_0;
                                return stackIn_32_0;
                              }
                            }
                          } else {
                            stackOut_24_0 = sd.a(an.field_d, 75, new String[1]);
                            stackIn_25_0 = stackOut_24_0;
                            return stackIn_25_0;
                          }
                        } else {
                          stackOut_21_0 = sd.a(wi.field_e, 41, new String[1]);
                          stackIn_22_0 = stackOut_21_0;
                          return stackIn_22_0;
                        }
                      } else {
                        stackOut_18_0 = sd.a(kc.field_n, 123, new String[1]);
                        stackIn_19_0 = stackOut_18_0;
                        return stackIn_19_0;
                      }
                    }
                  } else {
                    stackOut_11_0 = sd.a(rp.field_b, 85, new String[1]);
                    stackIn_12_0 = stackOut_11_0;
                    return stackIn_12_0;
                  }
                } else {
                  stackOut_8_0 = sd.a(gg.field_v, 19, new String[1]);
                  stackIn_9_0 = stackOut_8_0;
                  return stackIn_9_0;
                }
              } else {
                stackOut_5_0 = sd.a(cf.field_w, 123, new String[1]);
                stackIn_6_0 = stackOut_5_0;
                return stackIn_6_0;
              }
            }
          ...
          L1: {
            ...
            stackOut_37_1 = new StringBuilder().append("on.RA(").append(param0).append(44);
          ...
          throw aa.a((Throwable) (Object) stackIn_40_0, stackIn_40_2 + 44 + -17279 + 41);
        }
        return stackIn_36_0;
    }
    ...
    final static ld a(byte[] param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("on.TA(");
    ...
    final static void a(boolean param0, boolean param1, java.awt.Color param2, int param3, String param4) {
        ...
        try {
          ...
          L9: {
            ...
            stackOut_21_1 = new StringBuilder().append("on.Q(").append(param0).append(44).append(param1).append(44);
