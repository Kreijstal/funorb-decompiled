...
final class kl implements Iterable {
    ...
    final fa a(int param0, long param1) {
        ...
        var4 = ((kl) this).field_e[(int)((long)(((kl) this).field_a - param0) & param1)];
        ((kl) this).field_b = var4.field_a;
        L0: while (true) {
          if (((kl) this).field_b != var4) {
            if (((kl) this).field_b.field_e != param1) {
              ((kl) this).field_b = ((kl) this).field_b.field_a;
              continue L0;
            } else {
              var5 = ((kl) this).field_b;
              ((kl) this).field_b = ((kl) this).field_b.field_a;
              return var5;
            }
          } else {
