...
final class t {
                  ...
                  L6: while (true) {
                    ...
                    L10: while (true) {
                      if (var15 > var13) {
                        ...
                        var14++;
                        field_k[incrementValue$2] = param3;
                        var15++;
                        continue L10;
                      }
                    }
                    ...
                    if (var10 > var7) {
                      ...
                      L15: while (true) {
                        if (var15 >= var13) {
                          ...
                          var14++;
                          field_k[incrementValue$4] = param3;
                          var15++;
                          continue L15;
                        }
                      }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
                      ...
                      if (param1 + param3 < field_f) {
                        ...
                        if (param1 < field_a) {
                          L3: {
                                                  ...
                                                  L8: while (true) {
                                                    if (var22 > var17) {
                                                      L9: while (true) {
                                                        ...
                                                        if (var18 >= var19) {
                                                          field_k[var10 - var19] = param5;
                                                          field_k[var11 + var19] = param5;
                                                          field_k[var12 - var18] = param5;
                                                          field_k[var13 + var18] = param5;
                                                          field_k[var14 - var18] = param5;
                                                          field_k[var15 + var18] = param5;
                                                          field_k[var16 - var19] = param5;
                                                          field_k[var17 + var19] = param5;
                                                          continue L9;
                                                        } else {
                                                          break L3;
                                                        }
                            ...
                            t.g(param0, param1 + var18, param3 - var18 - var18, param5);
                            t.g(param0 + param2 - 1, param1 + var18, param3 - var18 - var18, param5);
                            t.b(param0 + var18, param1, param2 - var18 - var18, param5);
                            t.b(param0 + var18, param1 + param3 - 1, param2 - var18 - var18, param5);
                            L11: while (true) {
                              L12: {
          ...
          t.a(param0, param1, param2, param3, param5);
          return;
        }
    }
            ...
            if (param2 <= param3) {
              L1: {
                ...
                if (param1 >= field_f) {
                  ...
                  param0 = param0 + var10 * (field_f - param1);
                  param1 = field_f;
                  break L1;
                }
              }
                  ...
                  L4: {
                    ...
                    if (var11 < field_e) {
                      ...
                      if (var11 >= field_h) {
                        ...
                        var13 = (field_k[var12] >> 16 & 255) * var6;
                        var14 = (field_k[var12] >> 8 & 255) * var6;
                        var15 = (field_k[var12] & 255) * var6;
              ...
              L5: {
                ...
                if (param0 >= field_e) {
                  ...
                  param1 = param1 + var10 * (field_e - param0);
                  param0 = field_e;
                  break L5;
                }
              }
        ...
        if (param2 > 0) {
            ...
            for (var5 = 0; var5 < param3; var5++) {
                for (var6 = 0; var6 < param2; var6++) {
                    ...
                    var4++;
                    field_k[incrementValue$0] = (var11 << 16) + (var11 << 8) + var11;
                }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        t.b(param0, param1, param2, param4);
        t.b(param0, param1 + param3 - 1, param2, param4);
        t.g(param0, param1, param3, param4);
        t.g(param0 + param2 - 1, param1, param3, param4);
    }
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        for (var10 = -param3; var10 < 0; var10++) {
            ...
            for (var14 = -param2; var14 < 0; var14++) {
                ...
                incrementValue$0 = var9;
                var9++;
                field_k[incrementValue$0] = var16 - var15 | var15 - (var15 >>> 8);
            }
            var9 = var9 + var8;
            var6 = var6 + var7;
        }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        for (var9 = 0; var9 < param3; var9++) {
            for (var10 = -param2; var10 < 0; var10++) {
                ...
                incrementValue$0 = var8;
                var8++;
                field_k[incrementValue$0] = param4 + var11;
            }
            var8 = var8 + var7;
        }
    }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param1 >= field_f) {
            ...
            for (var13 = 0; var13 < param2; var13++) {
                ...
                var10 = (field_k[var12] >> 8 & 255) * var5;
                var11 = (field_k[var12] & 255) * var5;
                var14 = (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8) + (var8 + var11 >> 8);
                incrementValue$0 = var12;
                var12++;
                field_k[incrementValue$0] = var14;
            }
            return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3) {
        ...
        t.a(var5, field_k, 0, param2, -param3, var4);
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        if (param6 != 256) {
          if (param4 != 0) {
                  ...
                  if (var13 >= var23) {
                        ...
                        L10: while (true) {
                          ...
                          L14: while (true) {
                            if (var22 > var20) {
                              ...
                              var21++;
                              field_k[incrementValue$2] = param5 + var23;
                              var22++;
                              continue L14;
                            }
                          }
                    ...
                    L15: while (true) {
                      if (var24 >= var20) {
                        ...
                        var21++;
                        field_k[incrementValue$3] = param5 + var25;
                        var24++;
                        continue L15;
                      }
                    }
                      ...
                      if (var17 > var14) {
                        ...
                        L20: while (true) {
                          if (var22 >= var20) {
                            ...
                            var21++;
                            field_k[incrementValue$5] = param5 + var23;
                            var22++;
                            continue L20;
                          }
                        }
            ...
            t.a(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          t.d(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int[] param4) {
        ...
        int var22 = var6 + var8 * field_j;
        int var23 = field_j + var6 - var7;
        t.a(0, 0, 0, 0, 0, var15, var5, var22, field_k, param3, param4, var23, var13, var6 - var7, var16 + var10, var19, var21, var8 - var9);
    }

    final static void a(int param0, int param1, int param2) {
        if (param0 >= field_e) {
            if (param1 < field_f || param0 >= field_h || param1 >= field_a) {
                return;
            }
            field_k[param0 + param1 * field_j] = param2;
            return;
        }
    }
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
                  ...
                  L4: {
                    ...
                    if (var6 < field_e) {
                      ...
                      if (var6 >= field_h) {
                        ...
                        field_k[var6 + param1 * field_j] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_f) {
                      ...
                      if (var6 >= field_a) {
                        ...
                        field_k[param0 + var6 * field_j] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                t.g(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                t.g(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              t.b(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              t.b(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
                ...
                if (var11 >= var21) {
                      ...
                      L10: while (true) {
                        ...
                        L14: while (true) {
                          if (var20 > var18) {
                            ...
                            var19++;
                            field_k[incrementValue$2] = param5;
                            var20++;
                            continue L14;
                          }
                        }
                  ...
                  L15: while (true) {
                    if (var22 >= var18) {
                      ...
                      var19++;
                      field_k[incrementValue$3] = param5;
                      var22++;
                      continue L15;
                    }
                  }
                    ...
                    if (var15 > var12) {
                      ...
                      L20: while (true) {
                        if (var20 >= var18) {
                          ...
                          var19++;
                          field_k[incrementValue$5] = param5;
                          var20++;
                          continue L20;
                        }
                      }
          ...
          t.d(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    final static void b() {
        int var1 = 0;
        int var0 = 0;
        int var2 = field_j * field_d;
        for (var1 = 0; var1 < var2; var1++) {
            var0 = field_k[var1] & 16777215;
            field_k[var1] = (var0 >>> 1 & 8355711) + (var0 >>> 2 & 4144959) + (var0 >>> 3 & 2039583) + (var0 >>> 4 & 986895);
        }
    }
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var7 = -param3; var7 < 0; var7++) {
            for (var8 = -param2; var8 < 0; var8++) {
                ...
                var6++;
                field_k[incrementValue$0] = param4;
            }
            var6 = var6 + var5;
        }
    }
    ...
    final static void d() {
        ...
        int incrementValue$8 = 0;
        int var0 = 0;
        int var1 = field_j * field_d - 7;
        while (var0 < var1) {
            incrementValue$0 = var0;
            var0++;
            field_k[incrementValue$0] = 0;
            incrementValue$1 = var0;
            var0++;
            field_k[incrementValue$1] = 0;
            incrementValue$2 = var0;
            var0++;
            field_k[incrementValue$2] = 0;
            incrementValue$3 = var0;
            var0++;
            field_k[incrementValue$3] = 0;
            incrementValue$4 = var0;
            var0++;
            field_k[incrementValue$4] = 0;
            incrementValue$5 = var0;
            var0++;
            field_k[incrementValue$5] = 0;
            incrementValue$6 = var0;
            var0++;
            field_k[incrementValue$6] = 0;
            incrementValue$7 = var0;
            var0++;
            field_k[incrementValue$7] = 0;
        }
        var1 += 7;
        while (var0 < var1) {
            incrementValue$8 = var0;
            var0++;
            field_k[incrementValue$8] = 0;
        }
    }
