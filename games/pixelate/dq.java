    ...
    final static void a(int param0, int param1, og param2) {
        ...
        try {
            ...
            if (param2.field_k != null) {
                ...
                var5.a(param2.field_k.length, 0, -3493, param2.field_k);
            } else {
                var5.e(160, 0);
            }
            int discarded$0 = var5.b(var4, (byte) 48);
            var5.field_m = var5.field_m - 4;
            param2.field_m = var5.k(0);
            var5.f(var5.field_m + -var4, -1);
        } catch (RuntimeException runtimeException) {
            throw aa.a((Throwable) (Object) runtimeException, "dq.C(" + 6 + 44 + -18989 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final static hh a(byte param0, String param1, String param2, fm param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("dq.B(").append(31).append(44);
