              ...
              if (var3 != 0) {
                if (mp.field_a.length() < 80) {
                  L5: {
                    ...
                    if (2 == ce.field_d) {
                          ...
                          if (io.field_c != null) {
                            if (!nc.field_b) {
                              ...
                              if (~vl.field_Q.c(mp.field_a.toString()) >= ~var6) {
                                ...
                                StringBuilder discarded$14 = nk.a(mp.field_a, -1 + mp.field_a.length(), ' ', 16736352);
                                return true;
                              }
                            } else {
                              if (mn.field_f != null) {
                                ...
                                if (~vl.field_Q.c(mp.field_a.toString()) < ~var6) {
                                  StringBuilder discarded$15 = nk.a(mp.field_a, -1 + mp.field_a.length(), ' ', 16736352);
                                  return true;
                                } else {
                                  return true;
                                }
                      ...
                      if (~vl.field_Q.c(mp.field_a.toString()) >= ~var6) {
                        ...
                        StringBuilder discarded$16 = nk.a(mp.field_a, -1 + mp.field_a.length(), ' ', 16736352);
                        return true;
                      }
                    }
                  }
                  if (~vl.field_Q.c(mp.field_a.toString()) >= ~var6) {
                    ...
                    StringBuilder discarded$17 = nk.a(mp.field_a, -1 + mp.field_a.length(), ' ', 16736352);
                    return true;
                  }
                } else {
                  return true;
