    ...
    final static void a(String[] args, int param1, fm param2, byte[] param3, tf[][] param4, int param5, String[][] param6, fm param7, byte[] param8, String[] param9, tf[][] param10, hh[] param11, String[][] param12, fm param13, String[] param14, int[] param15, int param16, boolean param17, int[] param18, byte param19) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ge.B(");
          ...
          L16: {
            ...
            stackOut_46_1 = ((StringBuilder) (Object) stackIn_46_1).append(stackIn_46_2).append(',').append(param16).append(',').append(true).append(',');
          ...
          throw aa.a((Throwable) (Object) stackIn_49_0, stackIn_49_2 + ',' + param19 + ')');
        }
    }
    ...
    final static int a(rh param0, ue param1, int param2, int param3) {
        ...
        try {
                ...
                if (null == param1.field_l) {
                  ...
                  if (param0 == null) {
                    ...
                    if (param1.field_o != param0.field_t) {
                      ...
                      var5 = param1.field_l[param2].length / var4_int;
                      var6 = 0;
                      L2: while (true) {
                        if (var6 >= var5) {
                          stackOut_24_0 = -1;
                              ...
                              if (sm.a(param1.field_r[param2][var6], -1)) {
                                ...
                                L4: while (true) {
                                  if (var4_int <= var7) {
                                    ...
                                    if (param0.field_k[var7] != param1.field_l[param2][var4_int * var6 + var7]) {
                                      break L3;
                                    } else {
                                      var7++;
                                      continue L4;
          ...
          L5: {
            ...
            stackOut_26_1 = new StringBuilder().append("ge.A(");
            stackIn_28_0 = stackOut_26_0;
            stackIn_28_1 = stackOut_26_1;
          ...
          throw aa.a((Throwable) (Object) stackIn_32_0, stackIn_32_2 + ',' + param2 + ',' + -7402 + ')');
        }
        return stackIn_25_0;
    }
