    ...
    final static void a(byte param0, byte[] param1) {
        ...
        try {
          L0: {
            ...
            var17.field_m = -7 + (param1.length - 8 * im.field_Qb);
            tj.field_y = var17.a((byte) 38);
            jb.field_a = var17.a((byte) 46);
            var3 = 1 + (var17.f(255) & 255);
            var4 = 0;
            L1: while (true) {
              if (var4 >= im.field_Qb) {
                var4 = 0;
                  ...
                  if (var4 >= im.field_Qb) {
                    ...
                    L3: while (true) {
                      if (im.field_Qb <= var4) {
                        ...
                        L4: while (true) {
                          if (var4 >= im.field_Qb) {
                            var17.field_m = param1.length - (7 - (-(8 * im.field_Qb) - 3 * (-1 + var3)));
                                ...
                                L6: while (true) {
                                  if (var4 >= im.field_Qb) {
                                    ...
                                    L7: {
                                      ...
                                      var18 = var20;
                                      var8 = var18;
                                      wo.field_f[var4] = var24;
                                      var25 = new byte[var7];
                                      var23 = var25;
                                      var21 = var23;
                                      var19 = var21;
                                      var9 = var19;
                                      gd.field_k[var4] = var25;
                                      var10 = 0;
                                      var11 = var17.f(255);
                                      if ((var11 & 1) != 0) {
                                        var12 = 0;
                                            ...
                                            if ((var11 & 2) == 0) {
                                              ...
                                              L14: while (true) {
                                                if (var12 >= var7) {
                                                  ...
                                                  L15: {
                                                    byte dupTemp$3 = var17.a(bn.a(-95, -95));
                ...
                fa.field_b[var4] = var16.a((byte) 88);
                var4++;
                continue L1;
              }
            }
