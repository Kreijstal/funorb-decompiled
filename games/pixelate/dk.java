    ...
    final static tf a(int param0, fm param1, int param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("dk.A(").append(param0).append(44);
          ...
          throw aa.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_7_0;
    }
    ...
    final static void a(boolean param0, fm param1) {
        ...
        try {
              ...
              if (var3 <= var4) {
                ...
                L2: while (true) {
                  if (var10 >= var3) {
                    ...
                    var5.a(6, 6, 6, true, 1);
                    var5.a((byte) -17);
                    var6 = new int[]{var5.field_b + var5.field_c >> 1, var5.field_F + var5.field_t >> 1, var5.field_x + var5.field_g >> 1};
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("dk.C(").append(param0).append(44);
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
    ...
    final static void a(int param0, int param1, byte param2, int param3, int param4, tf[] param5) {
        ...
        try {
          ...
          L23: {
            ...
            stackOut_73_1 = new StringBuilder().append("dk.E(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
