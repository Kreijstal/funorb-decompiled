                  ...
                  if (ha.a(param0)) {
                    ...
                    if (f.field_q >= 200) {
                      ...
                      if (!i.a(-640, param0)) {
                        ...
                        stackOut_26_0 = sd.a(bm.field_r, 85, new String[1]);
    ...
    final static el a(String param0) {
        ...
        try {
            ...
            if (0 == var2_int) {
              ...
              if (var2_int <= 255) {
                ...
                if (2 <= var3.length) {
                  ...
                  L1: while (true) {
                    if (var5 >= var4.length) {
                      stackOut_20_0 = uo.a(-58, var3[var3.length + -1]);
          ...
          L2: {
            ...
            stackOut_22_1 = new StringBuilder().append("jf.E(");
    ...
    final static ob a(fm param0, int param1, fm param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("jf.D(");
