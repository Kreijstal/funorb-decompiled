...
final class po {
    ...
    private final sp a(int param0, int[] param1, int param2, int param3) {
        ...
        try {
          L0: {
            var5_int = param2 ^ (param3 << 4 & 65521 | param3 >>> 12);
            ...
            if (var8 == null) {
              ...
              L2: {
                ...
                if (var9 != null) {
                  ...
                  var9 = qd.a(((po) this).field_i, param3, param2);
                  if (var9 != null) {
                    ((po) this).field_g.a(var6, 125, (fa) (Object) var9);
                    break L2;
                  } else {
                    return null;
                  }
              ...
              if (var8 != null) {
                var9.c(2779);
                ((po) this).field_h.a(var6, 126, (fa) (Object) var8);
          ...
          L3: {
            ...
            stackOut_17_1 = new StringBuilder().append("po.I(").append(65521).append(44);
    ...
    final sp a(byte param0, int[] param1, int param2) {
        ...
        try {
          if (1 == ((po) this).field_i.b((byte) -89)) {
            ...
            if (((po) this).field_i.b(param2, (byte) 100) == 1) {
          ...
          L1: {
            ...
            stackOut_11_1 = new StringBuilder().append("po.H(").append(param0).append(44);
    ...
    private final sp a(int param0, int param1, int[] param2, int param3) {
        ...
        try {
          L0: {
            var5_int = param1 ^ ((param3 & -1342173185) << 4 | param3 >>> 12);
            var5_int = var5_int | param3 << 16;
            var6 = (long)var5_int;
            var8 = (sp) (Object) ((po) this).field_h.a(-25484, var6);
            if (var8 != null) {
              stackOut_2_0 = (sp) var8;
              stackIn_3_0 = stackOut_2_0;
              return stackIn_3_0;
            } else {
              L1: {
              ...
              var9 = np.a(((po) this).field_a, param3, param1);
              if (var9 != null) {
                L2: {
                  var10 = var9.b();
                  var8 = var10;
                  ((po) this).field_h.a(var6, 127, (fa) (Object) var8);
                  if (param2 != null) {
          ...
          L3: {
            ...
            stackOut_16_1 = new StringBuilder().append("po.G(").append(0).append(44).append(param1).append(44);
          ...
          throw aa.a((Throwable) (Object) stackIn_19_0, stackIn_19_2 + 44 + param3 + 41);
        }
        return stackIn_15_0;
    }
    ...
    final sp a(int param0, int[] param1, byte param2) {
        ...
        try {
          if (((po) this).field_a.b((byte) 98) != 1) {
            if (param2 == 106) {
          ...
          L0: {
            ...
            stackOut_10_1 = new StringBuilder().append("po.C(").append(param0).append(44);
          ...
          throw aa.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + 44 + param2 + 41);
        }
    }
    ...
    final sp a(boolean param0, String param1, String param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("po.B(").append(param0).append(44);
    ...
    final static String a(int param0, long param1) {
        ...
        int var3 = pe.field_a.get(7);
        int var4 = pe.field_a.get(5);
        int var5 = pe.field_a.get(2);
        int var6 = pe.field_a.get(1);
        int var7 = pe.field_a.get(11);
        int var8 = pe.field_a.get(12);
        int var9 = pe.field_a.get(13);
    ...
    private final sp a(String param0, int[] param1, String param2, int param3) {
        ...
        try {
          L0: {
            if (param3 < -4) {
              var5_int = ((po) this).field_a.a(118, param0);
              if (var5_int >= 0) {
                var6 = ((po) this).field_a.a((byte) -117, param2, var5_int);
                if (var6 >= 0) {
    ...
    po(fm param0, fm param1) {
        ...
        try {
            ...
            throw aa.a((Throwable) (Object) runtimeException, "po.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
