...
final class ac {
    ...
    final int a() {
        ...
        while (this.field_f[var1] >= 0) {
            var1 = qd.c() != 0 ? this.field_f[var1] : var1 + 1;
        }
    ...
    ac() {
        ...
        L0: {
          discarded$2 = qd.f(24);
          this.field_c = qd.f(16);
          this.field_d = qd.f(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_d) {
                ...
                var4_int = qd.f(aq.a((byte) 69, this.field_d - var2));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_d * this.field_c;
                break L9;
              } else {
                var7 = ac.a(this.field_d, this.field_c);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_a = new float[this.field_d][this.field_c];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
