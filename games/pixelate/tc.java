 ...
 */
final class tc extends jl {
    private byte[][] field_R;

    tc(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        super(param0, param1, param2, param3, param4);
        ((tc) this).field_R = new byte[256][];
        ((tc) this).field_R = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (t.field_g == null) {
                  tc.a(t.field_k, ((tc) this).field_R[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  tc.a(t.field_k, ((tc) this).field_R[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, t.field_g, t.field_b);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              tc.a(t.field_k, ((tc) this).field_R[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19 = 0;
        int var20 = 0;
        var13 = param2 - t.field_e;
        var14 = param3 - t.field_f;
        var15 = var14;
        L0: while (true) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  t.field_k[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
