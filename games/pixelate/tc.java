...
final class tc extends jl {
            ...
            if (param4 > 0) {
              L5: {
                if (t.field_g == null) {
                  ...
                  tc.a(t.field_k, this.field_R[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, t.field_g, t.field_b);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        int var13 = 0;
        int var9 = param1 + param2 * t.field_j;
        int var10 = t.field_j - param3;
        int var11 = 0;
        int var12 = 0;
        if (param2 < t.field_f) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$0] == 0) {
                  ...
                  param8++;
                  t.field_k[incrementValue$1] = param6;
                  var20++;
                  continue L3;
                }
              }
