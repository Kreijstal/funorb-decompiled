            ...
            if (var2 >= this.field_B.field_h + 2) {
              ...
              L1: while (true) {
                if (var3 >= this.field_B.field_e + 2) {
                  ...
                  this.field_m[var4] = 1;
                  if ((this.field_B.field_r[var4] & 4) != 0) {
