...
final class bf extends fa {
        ...
        try {
          L0: {
            if (param0 == 0) {
              ...
              stackIn_4_0 = um.a(param3, param1, var5_int, 121, var6);
          ...
          L1: {
            ...
            stackIn_7_1 = new StringBuilder().append("bf.D(").append(param0).append(',');
          ...
          throw aa.a((Throwable) ((Object) stackIn_8_0), stackIn_17_2 + ')');
        }
    ...
    public static void a(byte param0) {
        ...
        if (param0 > -72) {
            ...
            bf.a(-17, (String) null, (String) null);
        }
        field_q = (String[][]) null;
    }
              ...
              L2: while (true) {
                if (var8 >= this.field_n) {
                  ...
                  if (-1 != (var6 ^ -1)) {
                    if (var6 != 256) {
                      L3: {
                        stackIn_21_0 = rg.field_e.field_a;

                        if (this.field_p[var8 - -(var7 * this.field_n)]) {
                          stackIn_22_0 = (tf[]) ((Object) stackIn_21_0);
                          stackIn_22_1 = 1;
                          break L3;
                        } else {
                          stackIn_22_0 = (tf[]) ((Object) stackIn_21_0);
                      ...
                      L4: {
                        ...
                        stackIn_24_0 = fq.field_o.field_a;

                        if (this.field_p[var7 * this.field_n + var8]) {
                          stackIn_25_0 = (tf[]) ((Object) stackIn_24_0);
                          stackIn_25_1 = 1;
                          break L4;
                        } else {
                          stackIn_25_0 = (tf[]) ((Object) stackIn_24_0);
                      ...
                      L5: {
                        stackIn_17_0 = fq.field_o.field_a;

                        if (this.field_p[var8 + var7 * this.field_n]) {
                          stackIn_18_0 = (tf[]) ((Object) stackIn_17_0);
                          stackIn_18_1 = 1;
                          break L5;
                        } else {
                          stackIn_18_0 = (tf[]) ((Object) stackIn_17_0);
