                    ...
                    L4: while (true) {
                      if (var4 <= var7_int) {
                        ...
                        L5: while (true) {
                          if (var4 <= var7_int) {
                            bc.a(var6, (byte) 31);
                            dupTemp$0 = new String[2][var6];
                            var3.field_o = dupTemp$0;
                            var7 = dupTemp$0;
                            dupTemp$1 = new int[2][var6 * 4];
                            var3.field_r = dupTemp$1;
                            var8 = dupTemp$1;
                            var9 = pg.field_e;
                            var10 = 0;
                            var11 = 0;
                              ...
                              if (var9 <= var10) {
                                ...
                                L7: while (true) {
                                  if (var10 >= var9) {
                                    ...
                                    L8: {
                                      var12 = gn.field_A[var10 + var6];
                                      var7[1][var14] = lg.field_b[var12];
                                      var8[1][4 * var14] = ep.field_c[var12];
                                      var8[1][1 + 4 * var14] = uc.field_b[var12];
                                      var8[1][4 * var14 + 2] = vp.field_Fb[var12];
                                      var8[1][4 * var14 + 3] = gh.field_q[var12];
    ...
    final boolean a(String param0, int param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackIn_4_1 = new StringBuilder().append("io.G(");
    ...
    final static void a(boolean param0, int param1, rg param2, int param3, boolean param4) {
        ...
        try {
          ...
          L9: {
            ...
            stackIn_24_1 = new StringBuilder().append("io.H(").append(param0).append(',').append(param1).append(',');
