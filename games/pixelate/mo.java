...
final class mo implements Runnable {
    ...
    final void a(int param0, int param1, int param2, byte[] param3) throws IOException {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_26_1 = new StringBuilder().append("mo.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    private mo(java.net.Socket param0, cb param1, int param2) throws IOException {
        ...
        try {
            ...
            throw aa.a((Throwable) (Object) runtimeException, "mo.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 41);
        }
    }
