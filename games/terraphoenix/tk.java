                      ...
                      L6: {
                        if (var9 != 144) {
                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              var13 = var18[var10];
                              var14 = (sb) ((Object) this.field_h.a((byte) 46, (long)var13));
                              if (var14 != null) {
                                break L7;
                              } else {
                                var14 = new sb(new byte[128]);
                                this.field_h.a(var14, (long)var13, (byte) -106);
                                break L7;
                              }
                            }
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51 = new dh(this.field_i);
                      var51.e(1297377380, 8959);
                      var51.e(6, 8959);
                      stackIn_66_0 = (dh) (var51);

                      stackIn_66_1 = -1564407352;

                      if (var2 <= 1) {
                        stackIn_67_0 = (dh) ((Object) stackIn_66_0);
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                      ...
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            var44++;
                                            var51.i((int) param0.field_i[incrementValue$1], -114);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var50++;
                              var51.i((int) param0.field_i[incrementValue$25], -91);
                              incrementValue$26 = var50;
                              var50++;
                              var51.i((int) param0.field_i[incrementValue$26], -103);
                              incrementValue$27 = var50;
                              var50++;
                              var51.i((int) param0.field_i[incrementValue$27], 122);
                              continue L5;
                            }
                          } else {
                            L18: {
