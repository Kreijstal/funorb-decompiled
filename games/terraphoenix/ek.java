...
final class ek {
    ...
    private final float b(int param0, int param1, float param2) {
        float var4 = (float)((ek) this).field_f[param0][0][param1] + param2 * (float)(((ek) this).field_f[param0][1][param1] - ((ek) this).field_f[param0][0][param1]);
    ...
    final void a(dh param0, fj param1) {
        ...
        L0: {
          var3 = param0.a(-16384);
          ((ek) this).field_a[0] = var3 >> 4;
          ((ek) this).field_a[1] = var3 & 15;
          if (var3 == 0) {
            var11 = ((ek) this).field_c;
            ((ek) this).field_c[1] = 0;
            var11[0] = 0;
            break L0;
          } else {
            ((ek) this).field_c[0] = param0.i(-25578);
            ((ek) this).field_c[1] = param0.i(-25578);
            var4 = param0.a(-16384);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                  ...
                  if (var5 >= 2) {
                    L3: {
                      if (var4 != 0) {
                        ...
                        if (((ek) this).field_c[1] == ((ek) this).field_c[0]) {
                          break L0;
                        } else {
                          break L3;
                        }
                    ...
                    var6 = var7;
                    L4: while (true) {
                      if (var7 >= ((ek) this).field_a[var5]) {
                        var5++;
                        continue L2;
                      } else {
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ((ek) this).field_b[var5][1][var7] = ((ek) this).field_b[var5][0][var7];
                          ((ek) this).field_f[var5][1][var7] = ((ek) this).field_f[var5][0][var7];
                          var7++;
                          continue L4;
                        } else {
                          ((ek) this).field_b[var5][1][var7] = param0.i(-25578);
                          ((ek) this).field_f[var5][1][var7] = param0.i(-25578);
                          var7++;
                          continue L4;
                        }
                      }
                ...
                var6 = 0;
                L5: while (true) {
                  if (var6 >= ((ek) this).field_a[var5]) {
                    var5++;
                    continue L1;
                  } else {
                    ((ek) this).field_b[var5][0][var6] = param0.i(-25578);
                    ((ek) this).field_f[var5][0][var6] = param0.i(-25578);
                    var6++;
                    continue L5;
                  }
                }
    ...
    private final float a(int param0, int param1, float param2) {
        float var4 = (float)((ek) this).field_b[param0][0][param1] + param2 * (float)(((ek) this).field_b[param0][1][param1] - ((ek) this).field_b[param0][0][param1]);
    ...
    final int a(int param0, float param1) {
        ...
        L0: {
          if (param0 != 0) {
            ...
            var3 = (float)((ek) this).field_c[0] + (float)(((ek) this).field_c[1] - ((ek) this).field_c[0]) * param1;
        ...
        if (((ek) this).field_a[param0] != 0) {
          ...
          var4 = 1;
          L1: while (true) {
            if (var4 >= ((ek) this).field_a[param0]) {
              L2: {
                if (param0 != 0) {
                  break L2;
                } else {
              ...
              var4 = 0;
              L4: while (true) {
                if (var4 >= ((ek) this).field_a[param0] * 2) {
                  return ((ek) this).field_a[param0] * 2;
                } else {
    ...
    ek() {
        ((ek) this).field_f = new int[2][2][4];
        ((ek) this).field_c = new int[2];
        ((ek) this).field_a = new int[2];
        ((ek) this).field_b = new int[2][2][4];
    }
