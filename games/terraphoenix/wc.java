                        ...
                        if (var12 < var15) {
                          ...
                          L16: {
                            if (p.field_a[var4_int].field_g + -31 <= 0) {
                              ...
                              stackOut_58_0 = -31 + p.field_a[var4_int].field_g;
                          ...
                          L17: {
                            ...
                            if (param1 <= 31 + p.field_a[var4_int].field_a) {
                              ...
                              stackOut_61_0 = p.field_a[var4_int].field_a + 31;
                          ...
                          L18: {
                            ...
                            if (~param2 < ~(p.field_a[var4_int].field_g + 31)) {
                              stackOut_65_0 = 31 + p.field_a[var4_int].field_g;
                          ...
                          L19: {
                            ...
                            if (p.field_a[var4_int].field_a + -31 <= 40) {
                              ...
                              stackOut_67_0 = p.field_a[var4_int].field_a - 31;
                      ...
                      if (p.field_a[var4_int].field_d == null) {
                        ...
                        if (p.field_a[var4_int].field_d.field_Z == null) {
                          ...
                          if (ce.field_e) {
                            ...
                            og.field_f.c(p.field_a[var4_int].field_d.field_Z.b(param3 + 11670), 16 + p.field_a[var4_int].field_f, p.field_a[var4_int].field_e + 23, 0, -1);
