...
final class qe {
        ...
        L0: while (true) {
          if (var2 >= 256) {
            ...
            L2: {
              ...
              if ((2 & var2) != 0) {
                if (0 != (var2 & 1)) {
                  this.field_b = this.field_b ^ this.field_b >>> 1332198768;
                  break L2;
                } else {
                  this.field_b = this.field_b ^ this.field_b << 1760828226;
                  break L2;
                }
              } else {
                if ((var2 & 1) == 0) {
                  this.field_b = this.field_b ^ this.field_b << 1080141645;
                  break L2;
                } else {
                  this.field_b = this.field_b ^ this.field_b >>> 1284776614;
                  break L2;
                }
              }
            }
            this.field_b = this.field_b + this.field_a[128 + var2 & 255];
            dupTemp$1 = this.field_e + (this.field_a[dg.a(var3, 1020) >> 870073890] - -this.field_b);
            var4 = dupTemp$1;
            this.field_a[var2] = dupTemp$1;
            dupTemp$2 = this.field_a[dg.a(var4, 261306) >> -475825944 >> -1282238686] + var3;
    ...
    private final void b(int param0) {
        int var2 = 0;
        int var11 = Terraphoenix.field_V;
        if (param0 != -1) {
    ...
    final static void a(int param0, fa param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_12_1 = new StringBuilder().append("qe.B(").append(param0).append(',');
