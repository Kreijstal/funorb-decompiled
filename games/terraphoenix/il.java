            ...
            if (!param0) {
              ...
              L0: while (true) {
                if (this.field_f < this.field_c) {
                  ...
                  var4 = this.field_d[fieldTemp$2].field_d;
                  var9 = var4;
          ...
          if (!param0) {
            ...
            L1: while (true) {
              if (this.field_f < this.field_c) {
                ...
                this.field_f = this.field_f + 1;
                var4 = this.field_d[fieldTemp$3].field_d;
                var5 = var4;
                if (var4 == this.field_d[this.field_f - 1]) {
                  continue L1;
                } else {
    ...
    final static byte[] a(byte param0, String param1) {
        ...
        try {
          L0: {
            L1: {
              if (param0 >= 70) {
                ...
                var3 = (fa) null;
                discarded$2 = il.a((String) null, (String) null, (fa) null, -14);
                break L1;
              }
            }
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("il.E(").append(param0).append(',');
