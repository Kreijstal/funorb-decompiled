...
final class tl extends uf {
    ...
    private int field_G;
    private static jk[] field_q;
    private static bf[] field_l;
    ...
    final static tl a(fa param0, String param1, String param2) {
        try {
            tl var4_ref = null;
            if (!tl.a(param0)) {
                param0.a(param2, (byte) 104, param1);
                return null;
            }
    ...
    final static int d(int param0) {
        ...
        while (param0 >= 8 - field_O) {
            var3 = 8 - field_O;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_D[field_k] >> field_O & var4) << var2);
            field_O = 0;
            field_k = field_k + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_D[field_k] >> field_O & var3) << var2);
    ...
    private final static boolean a(fa param0) {
        byte[] var1 = null;
        if (!field_I) {
            var1 = param0.b(0, -100, 0);
            if (var1 == null) {
                return false;
            }
            tl.a(var1);
    ...
    final static int c() {
        int var0 = field_D[field_k] >> field_O & 1;
        field_O = field_O + 1;
        field_k = field_k + (field_O >> 3);
        field_O = field_O & 7;
        return var0;
    }
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = re.a(var11, (byte) -109, var10);
                            var11++;
                            continue L12;
                          }
                        }
          ...
          if (var17_int >= var14.field_c) {
            L10: {
              if (var15 != 0) {
                ...
                field_q[var18_int].a(field_n, var4 >> 1);
                break L10;
              }
            }
            L11: {
    ...
    private tl(byte[] param0) throws IOException {
        this.b(param0);
    }
