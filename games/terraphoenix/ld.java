...
abstract class ld {
    ...
    final int c(int param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 5: {
                    try {
                        if (stackIn_5_0 < ((ld) this).field_f.length) {
                            statePc = 10;
                        } else {
                            statePc = 6;
                        }
                ...
                case 10: {
                    try {
                        stackOut_10_0 = ((ld) this).field_f[-1 + ((ld) this).field_f.length].field_a - ((ld) this).field_f[0].field_e;
    ...
    final static int a(char param0, CharSequence param1, int param2) {
        ...
        int stackOut_7_0 = 0;
        int stackOut_8_0 = 0;
        CharSequence stackOut_8_1 = null;
        int stackOut_16_0 = 0;
            ...
            switch (statePc) {
                ...
                case 8: {
                    try {
                        ...
                        stackOut_8_1 = (CharSequence) param1;
                ...
                case 9: {
                    try {
                        if (stackIn_9_0 != (((CharSequence) (Object) stackIn_9_1).charAt(var5) ^ -1)) {
                            statePc = 15;
                        } else {
                            statePc = 10;
                        }
                ...
                case 19: {
                    try {
                        ...
                        stackOut_19_1 = new StringBuilder().append("ld.H(").append(param0).append(44);
                ...
                case 23: {
                    throw qk.a((Throwable) (Object) stackIn_23_0, stackIn_23_2 + 44 + param2 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
    ...
    final int a(String param0, boolean param1, int param2, int param3) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 30: {
                    try {
                        stackOut_30_0 = (param2 - param3 << -96498200) / var5_int;
                ...
                case 35: {
                    try {
                        ...
                        stackOut_35_1 = new StringBuilder().append("ld.F(");
                ...
                case 39: {
                    throw qk.a((Throwable) (Object) stackIn_39_0, stackIn_39_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
    ...
    final int a(int param0, int param1) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 4: {
                    try {
                        stackOut_4_0 = var5.field_d.length;
                ...
                case 11: {
                    try {
                        stackOut_11_0 = var5.field_d[param0];
    ...
    final int b(int param0, int param1) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 4: {
                    try {
                        stackOut_4_0 = var4.field_d.length ^ -1;
                ...
                case 11: {
                    try {
                        stackOut_11_0 = ((ld) this).field_f.length;
                        stackIn_12_0 = stackOut_11_0;
                        statePc = 12;
                        continue stateLoop;
                    } catch (Throwable stateCaught_11) {
            ...
            switch (statePc) {
                ...
                case 4: {
                    try {
                        ...
                        stackOut_4_1 = new StringBuilder().append("ld.E(").append(param0).append(44);
    ...
    final int a(int param0, int param1, int param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 3: {
                    try {
                        if (stackIn_3_0 == (((ld) this).field_f.length ^ -1)) {
                            statePc = 12;
                        } else {
                            statePc = 4;
                        }
                ...
                case 7: {
                    try {
                        if (stackIn_7_0 < ((ld) this).field_f[0].field_e) {
                            statePc = 12;
                        } else {
                            statePc = 8;
                        }
                ...
                case 14: {
                    try {
                        if ((param2 ^ -1) < (((ld) this).field_f[((ld) this).field_f.length - 1].field_a ^ -1)) {
                            statePc = 17;
                        } else {
                            statePc = 15;
                        }
                ...
                case 26: {
                    try {
                        stackOut_26_0 = ((ld) this).field_f[0].a(param0, -119);
                ...
                case 29: {
                    try {
                        if ((((ld) this).field_f.length ^ -1) >= (var5 ^ -1)) {
                            statePc = 51;
                        } else {
                            statePc = 30;
                        }
                ...
                case 33: {
                    try {
                        if (stackIn_33_0 > (stackIn_33_1.field_e ^ -1)) {
                            statePc = 50;
                        } else {
                            statePc = 34;
                        }
                ...
                case 37: {
                    try {
                        if ((stackIn_37_0.field_a ^ -1) <= (param2 ^ -1)) {
                            statePc = 42;
                        } else {
                            statePc = 38;
                        }
    ...
    final static void a(int param0, boolean param1, ee param2, int param3, byte param4) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 26: {
                    try {
                        stackOut_26_0 = fc.field_e.length + -1;
                ...
                case 43: {
                    try {
                        if (stackIn_43_0 == (Object) (Object) param2.field_f) {
                            statePc = 49;
                        } else {
                            statePc = 44;
                        }
                ...
                case 67: {
                    try {
                        ...
                        stackOut_67_1 = new StringBuilder().append("ld.B(").append(param0).append(44).append(param1).append(44);
                ...
                case 71: {
                    throw qk.a((Throwable) (Object) stackIn_71_0, stackIn_71_2 + 44 + param3 + 44 + param4 + 41);
                }
                case 72: {
                    return;
                }
