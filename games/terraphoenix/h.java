...
abstract class h {
    ...
    final int a(byte param0) {
        if (param0 != -103) {
          ((h) this).b(109);
          return ((h) this).field_a.a(false) + ((h) this).field_g.a(false);
        } else {
          return ((h) this).field_a.a(false) + ((h) this).field_g.a(false);
        }
    }
    ...
    final nh a(int param0, boolean param1, int param2, byte param3, byte param4) {
        ...
        if (param3 < 55) {
            ...
            if (param1) {
                ...
                ((h) this).field_b.a(11152, (vh) (Object) var8);
            } else {
                if (!(-21 > ((h) this).a((byte) -103))) {
                    throw new RuntimeException();
                }
                ((h) this).field_a.a(11152, (vh) (Object) var8);
            }
            return var8;
        }
        var8.field_x = param1 ? true : false;
    ...
    final int c(int param0) {
        ...
        return ((h) this).field_b.a(false) - -((h) this).field_m.a(false);
    }

    h() {
        ((h) this).field_b = new hl();
        ((h) this).field_m = new hl();
        ((h) this).field_a = new hl();
        ((h) this).field_g = new hl();
        ((h) this).field_e = new dh(6);
        ((h) this).field_n = (byte) 0;
        ((h) this).field_i = 0;
        ((h) this).field_l = 0;
        ((h) this).field_o = new dh(10);
    }
