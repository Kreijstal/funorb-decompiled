    ...
    final static dj[] a(int param0, uc param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_17_1 = new StringBuilder().append("ig.A(").append(-25831).append(44);
    ...
    final static byte[] a(int param0, int param1, uc param2, byte[] param3) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_19_1 = new StringBuilder().append("ig.B(").append(16).append(44).append(125).append(44);
    ...
    final static ci[] a(fa param0, int param1, String param2, String param3) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = pb.a(var4_int, false, var5, param0);
