...
class hb extends nb {
    ...
    final static int a(gf param0, int param1, boolean param2) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = param0.a(param2, (byte) -50);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("hb.C(");
    ...
    final static void a(pk param0, int param1, int param2, String param3, em param4) {
        ...
        try {
                ...
                if (var7 >= param3.length()) {
                  ...
                  L2: {
                    ...
                    if (var8 != 60) {
                      ...
                      var6 = param4.field_d[0] + (var5_int >> 8) + param0.b(param3.substring(0, var7));
                      break L2;
                    }
                  }
                  L3: {
                    if (var6 != -1) {
                      ...
                      param4.field_d[var7] = (var5_int >> 8) - -param4.field_d[0] + param0.b(param3.substring(0, var7 - -1)) + -param0.a((char) var8);
                      break L3;
                    }
                  }
                  L5: {
          ...
          L6: {
            ...
            stackOut_17_1 = new StringBuilder().append("hb.A(");
    ...
    final void a(byte param0, dh param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("hb.E(").append(param0).append(44);
    ...
    hb(long param0, String param1) {
        try {
            ...
            throw qk.a((Throwable) (Object) runtimeException, "hb.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
