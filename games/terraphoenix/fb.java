...
final class fb extends uf {
    ...
    final static void a(int param0, dh param1) {
        ...
        lb.field_d = var2_int << -477257006 & 1835008;
        hb.field_j = hb.field_j + (var2_int >> 591903971);
        lb.field_d = lb.field_d + (param1.i(param0 + -4642) << 19319842);
        var2_int = param1.a(param0 + 4552);
        jc.field_D = (63 & var2_int) << 729064943;
        lb.field_d = lb.field_d + (var2_int >> -891227674);
        jc.field_D = jc.field_D + (param1.a(-16384) << -1051657785);
        var2_int = param1.a(-16384);
        jc.field_D = jc.field_D + (var2_int >> -673087743);
        if (param0 != -20936) {
            return;
        }
        try {
            dc.field_a = (var2_int & 1) << -2116216720;
            dc.field_a = dc.field_a + param1.i(-25578);
        } catch (RuntimeException runtimeException) {
            throw qk.a((Throwable) ((Object) runtimeException), "fb.B(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ')');
        }
    }
