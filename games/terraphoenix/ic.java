...
final class ic extends fd {
    ...
    public final void a(int param0, gl param1, int param2, int param3, boolean param4) {
        ...
        L0: {
          if (!param1.field_s) {
            if (param1.d(-120)) {
              ...
              L2: {
                if (!param4) {
                  stackOut_11_0 = ((ic) this).field_u;
                  stackIn_12_0 = stackOut_11_0;
                  break L2;
                } else {
                  if (var6 == 0) {
                    stackOut_10_0 = ((ic) this).field_v;
                    stackIn_12_0 = stackOut_10_0;
                    break L2;
                  } else {
                    stackOut_9_0 = ((ic) this).field_w;
              ...
              if (param3 != -24381) {
                ...
                var8 = stackIn_16_0;
                bk.a(param0 - -param1.field_u + (-((ic) this).field_y[0].field_u + param1.field_n >> -1947023327), var7, param1.field_w + param2, param1.field_p, ((ic) this).field_y, 0);
                int discarded$2 = ((ic) this).field_j.a(param1.field_o, param2 - -param1.field_w, param1.field_u + (param0 + -2), param1.field_p, param1.field_n, var8, -1, 1, 1, ((ic) this).field_j.field_s);
                return;
              }
            } else {
              stackOut_3_0 = 0;
        ...
        L5: {
          if (!param4) {
            stackOut_26_0 = ((ic) this).field_u;
            stackIn_27_0 = stackOut_26_0;
            break L5;
          } else {
            if (var6 == 0) {
              stackOut_25_0 = ((ic) this).field_v;
              stackIn_27_0 = stackOut_25_0;
              break L5;
            } else {
              stackOut_24_0 = ((ic) this).field_w;
