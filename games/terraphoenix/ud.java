...
final class ud extends pk {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              ud.a(l.field_i, ((ud) this).field_N[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  l.field_i[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    ud(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        super(param0, param1, param2, param3, param4);
        ((ud) this).field_N = new byte[256][];
        ((ud) this).field_N = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (l.field_l == null) {
                  ud.a(l.field_i, ((ud) this).field_N[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  ud.a(l.field_i, ((ud) this).field_N[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, l.field_l, l.field_a);
                  break L5;
                }
              }
              return;
