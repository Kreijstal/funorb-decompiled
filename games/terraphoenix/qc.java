    ...
    final static void a(int[] param0, int param1, int[] param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        try {
                  ...
                  L2: while (true) {
                    if (0 <= var12) {
                      ...
                      L3: {
                        ...
                        param3++;
                        param8 = param2[incrementValue$0];
                        if (-1 == (param8 ^ -1)) {
                          param10++;
                          break L3;
                        } else {
                          ...
                          param10++;
                          param0[incrementValue$1] = ei.b(ei.b(var13, var14) >>> 1233298696, 1);
                          break L3;
                        }
                      }
                      var12++;
          ...
          L4: {
            ...
            stackIn_16_0 = (RuntimeException) (var11);

            stackIn_16_1 = new StringBuilder().append("qc.H(");
          ...
          throw qk.a((Throwable) ((Object) stackIn_17_0), stackIn_20_2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ',' + param9 + ',' + param10 + ')');
        }
    ...
    final static boolean a(byte param0, String param1, String param2) {
        ...
        try {
                  ...
                  if (param2.length() != 0) {
                    L1: {
                      if (param0 == 80) {
                        ...
                        var4 = (String) null;
                        qc.a((String) null, (fa) null, (String) null, (byte) -43);
                        break L1;
                      }
                    }
          ...
          L2: {
            ...
            stackIn_29_1 = new StringBuilder().append("qc.C(").append(param0).append(',');
          ...
          throw qk.a((Throwable) ((Object) stackIn_30_0), stackIn_33_2 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
        ...
        try {
          L0: {
            if (!param1.a(0)) {
              ...
              if (param3 > 76) {
                stackIn_8_0 = param0 + " - " + param1.a((byte) 127) + "%";
                decompiledRegionSelector0 = 2;
                break L0;
              } else {
          ...
          L1: {
            ...
            stackIn_11_1 = new StringBuilder().append("qc.E(");
          ...
          throw qk.a((Throwable) ((Object) stackIn_12_0), stackIn_18_2 + ',' + param3 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_3_0;
        } else {
