...
final class ja extends uf {
    ...
    final static void c(byte param0) {
        ...
        vl.field_i.a((uf) (Object) var1, -16611);
    }
    ...
    final static void a(int param0, boolean param1, int param2) {
        ...
        L0: {
          ...
          if (0 == pe.field_e) {
            ...
            if (pe.field_e != 1) {
              if (2 == pe.field_e) {
                var4 = af.a(ij.a(new String[1], -1, hj.field_H), da.field_h, -3, kh.field_F, ch.field_c);
                var5 = -1;
                var6 = 0;
                L3: while (true) {
                  L4: {
                    if (var4 <= var6) {
                      ...
                      if (!"<%0>".equals((Object) (Object) kh.field_F[var6])) {
                        var6++;
                        continue L3;
                      } else {
                        var5 = var6;
                  ...
                  if (var5 != -1) {
                    ...
                    ka.a((Object[]) (Object) kh.field_F, 0, (Object[]) (Object) ia.field_r, 0, var5);
                    kj.field_c = new String[-1 + (var4 - var5)];
                    ka.a((Object[]) (Object) kh.field_F, 1 + var5, (Object[]) (Object) kj.field_c, 0, -1 + var4 - var5);
                    var4 = af.a(ij.a(new String[1], -1, wj.field_b), da.field_h, -3, kh.field_F, ch.field_c);
                    var5 = -1;
                    var6 = 0;
                    L5: while (true) {
                      L6: {
                      ...
                      if (var5 == -1) {
                        ...
                        L7: {
                          ...
                          ka.a((Object[]) (Object) kh.field_F, 0, (Object[]) (Object) km.field_c, 0, var5);
                          ec.field_d = new String[-1 + var4 + -var5];
                          ka.a((Object[]) (Object) kh.field_F, var5 + 1, (Object[]) (Object) ec.field_d, 0, -var5 + (var4 + -1));
                          if (ia.field_r.length >= km.field_c.length) {
                            stackOut_56_0 = ia.field_r.length;
                            stackIn_57_0 = stackOut_56_0;
                            break L7;
                          } else {
                            stackOut_55_0 = km.field_c.length;
                        ...
                        L8: {
                          ...
                          if (ec.field_d.length > kj.field_c.length) {
                            stackOut_59_0 = ec.field_d.length;
                            stackIn_60_0 = stackOut_59_0;
                            break L8;
                          } else {
                            stackOut_58_0 = kj.field_c.length;
                              ...
                              if (var9 >= var6) {
                                ...
                                L11: while (true) {
                                  if (var7 <= var9) {
                                    ...
                                    L12: {
                                      stackOut_71_0 = rb.field_d;
                                      stackOut_71_1 = var6 + 7 + var9;
                                ...
                                L13: {
                                  stackOut_65_0 = rb.field_d;
                                  stackOut_65_1 = 6 - -var9;
                                  ...
                                  if (0 <= km.field_c.length + var9 - var6) {
                                    ...
                                    stackOut_67_2 = km.field_c[km.field_c.length + var9 - var6];
        ...
        L23: while (true) {
          if (rb.field_d.length <= var5) {
            ...
            vi.field_o = nd.field_r - (var4 >> 1);
            ql.field_g = -(var4 >> 1) + (var4 + nd.field_r);
            ak.field_e = (dc.field_b - -hi.field_ab << 1) * ai.field_i.field_g;
            var5 = 0;
            L29: while (true) {
              if (var5 >= rb.field_d.length) {
                jh.field_m = -(ak.field_e >> 1) + ma.field_E;
                  ...
                  if (rb.field_d.length <= var5) {
                    ...
                    L32: {
                      ...
                      if (var7 >= 0) {
                        ...
                        var9 = -(var8 >> 1) + nd.field_r;
                        var6 = var6 + hi.field_ab;
                        ll.field_d[var5] = new int[4];
                        ll.field_d[var5][0] = -se.field_j + var9;
                        ll.field_d[var5][1] = var6;
                        ll.field_d[var5][2] = var8 - -(se.field_j << 1);
                        var6 = var6 + (lm.field_d + ((dc.field_b << 1) - -hi.field_ab));
                        ll.field_d[var5][3] = (dc.field_b << 1) + lm.field_d;
                        break L32;
                      } else {
                ...
                L33: {
                  stackOut_105_0 = ak.field_e;
                  stackIn_107_0 = stackOut_105_0;
                  stackIn_106_0 = stackOut_105_0;
                  if (0 > f.field_a[var5]) {
                    stackOut_107_0 = stackIn_107_0;
                    stackOut_107_1 = jm.field_b;
                    stackIn_108_0 = stackOut_107_0;
                    stackIn_108_1 = stackOut_107_1;
                    break L33;
                  } else {
                    stackOut_106_0 = stackIn_106_0;
                    stackOut_106_1 = lm.field_d;
                    stackIn_108_0 = stackOut_106_0;
                    stackIn_108_1 = stackOut_106_1;
                    break L33;
                  }
                }
                ak.field_e = stackIn_108_0 + stackIn_108_1;
                var5++;
                continue L29;
              }
            }
            ...
            L35: {
              var6 = bb.a((byte) stackIn_88_0, stackIn_88_1 != 0, rb.field_d[var5]);
              if (var4 < var6) {
                var4 = var6;
                break L35;
              } else {
