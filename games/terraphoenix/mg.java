    ...
    final String a(String param0, int param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_15_1 = new StringBuilder().append("mg.B(");
    ...
    final im b(String param0, int param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("mg.C(");
    ...
    final static void a(int param0, int param1, ci[] param2, int param3, int param4, int param5, int param6, int param7, int param8, ci[] param9, int param10, int param11, pk param12, int param13, ci[] param14) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("mg.D(").append(param0).append(',').append(param1).append(',');
          ...
          L2: {
            ...
            stackOut_5_1 = ((StringBuilder) (Object) stackIn_5_1).append(stackIn_5_2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',').append(param8).append(',');
