...
abstract class af implements rc {
    ...
    public final String b(byte param0) {
        ...
        if ((((af) this).field_c + 350L ^ -1L) < (ll.a(1000) ^ -1L)) {
            return null;
        }
    ...
    public final im a(int param0) {
        ...
        if ((ll.a(1000) ^ -1L) > (350L + ((af) this).field_c ^ -1L)) {
            return kj.field_d;
        }
        if (param0 != -16323) {
    ...
    final static int a(String param0, pk param1, int param2, String[] param3, int param4) {
        ...
        L1: {
          if (param2 == -3) {
            ...
            var14 = null;
            int discarded$1 = af.a((String) null, (pk) null, 80, (String[]) null, 47);
            break L1;
          }
        }
        var6 = (-1 + var5 - -param4) / param4;
        param4 = var5 / var6;
        var6 = 0;
        var7 = 0;
        var8 = param0.length();
