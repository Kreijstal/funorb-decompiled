    ...
    final static void a(int param0, int param1, int param2, pk param3, int param4, int param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("o.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw qk.a((Throwable) ((Object) stackIn_6_0), stackIn_6_2 + ',' + param4 + ',' + param5 + ')');
        }
    }
