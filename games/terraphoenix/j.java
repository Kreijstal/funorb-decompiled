    ...
    final static int a(int param0, int param1, byte[] param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("j.D(").append(param0).append(44).append(param1).append(44);
    ...
    j(int param0, int param1, int param2, int param3, gl param4, boolean param5, int param6, int param7, pk param8, int param9, String param10) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("j.<init>(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
