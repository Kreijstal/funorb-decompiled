...
final class j extends jc {
    ...
    final static int a(int param0, int param1, byte[] param2) {
        ...
        return gj.a(param1, 0, 255, param2);
    }
    ...
    j(int param0, int param1, int param2, int param3, gl param4, boolean param5, int param6, int param7, pk param8, int param9, String param10) {
        ...
        ((j) this).field_M = param5 ? true : false;
        ((j) this).field_L = param10;
        ((j) this).field_S = param9;
        ((j) this).field_F = param4;
        ((j) this).field_Q = param6;
        ((j) this).field_O = param7;
        int var12 = -((j) this).field_O + ((j) this).field_Q;
        int var13 = ((j) this).field_A.a(param10, var12, ((j) this).field_A.field_s) - -(((j) this).field_O * 2);
        if (var13 <= param3) {
            var13 = param3;
        } else {
            ((j) this).a(param1, (byte) 49, param2, param0, var13);
        }
        int var14 = ((j) this).field_M ? 0 : 2 * ((j) this).field_O + ((j) this).field_Q;
        ((j) this).field_F.a(((j) this).field_O + (-param3 + var13 >> -403823999), (byte) 61, param2 - ((j) this).field_Q - ((j) this).field_O * 3, var14, -(((j) this).field_O * 2) + param3);
    }
