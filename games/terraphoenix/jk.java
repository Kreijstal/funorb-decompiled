...
final class jk {
    ...
    final boolean b() {
        ...
        int var2 = ((jk) this).field_l.length;
        System.arraycopy((Object) (Object) ((jk) this).field_l, 0, (Object) (Object) field_i, 0, var2);
        int var3 = field_h[((jk) this).field_a - 1];
        int var4 = je.a(-124, var3 - 1);
        field_e[0] = tl.d(var4);
        field_e[1] = tl.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((jk) this).field_d.length; var6++) {
            var7 = ((jk) this).field_d[var6];
            var8 = ((jk) this).field_b[var7];
            var9 = ((jk) this).field_g[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = tl.field_H[((jk) this).field_c[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((jk) this).field_k[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_e[incrementValue$0] = var13 >= 0 ? tl.field_H[var13].a() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((jk) this).field_l.length;
        var4 = field_h[((jk) this).field_a - 1];
        var5 = field_f;
        field_f[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_e[0] * ((jk) this).field_a;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_i[var16];
                  var10 = field_e[var16] * ((jk) this).field_a;
            ...
            L3: {
              var7 = jk.b(field_i, var6);
              var8_int = jk.a(field_i, var6);
              var9 = this.a(field_i[var7], field_e[var7], field_i[var8_int], field_e[var8_int], field_i[var6]);
              var10 = field_e[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    jk() {
        ...
        if (var1 == 1) {
          ...
          L0: while (true) {
            if (var4 >= var2) {
              ((jk) this).field_b = new int[var3];
              ((jk) this).field_g = new int[var3];
              ((jk) this).field_c = new int[var3];
              ((jk) this).field_k = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((jk) this).field_a = tl.d(2) + 1;
                  var4 = tl.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((jk) this).field_l = new int[var5];
                      ((jk) this).field_l[0] = 0;
                      ((jk) this).field_l[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((jk) this).field_b[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((jk) this).field_l[incrementValue$2] = tl.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((jk) this).field_b[((jk) this).field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((jk) this).field_b[var4] = tl.d(3) + 1;
                    int dupTemp$3 = tl.d(2);
                    ((jk) this).field_g[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((jk) this).field_c[var4] = tl.d(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
