...
final class jk {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_l, 0, field_i, 0, var2);
        int var3 = field_h[this.field_a - 1];
        ...
        for (var6 = 0; var6 < this.field_d.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = tl.field_H[this.field_c[var7]].a();
            }
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_i[var16];
                  var10 = field_e[var16] * this.field_a;
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_b[var7]) {
                              ...
                              var5++;
                              this.field_l[incrementValue$2] = tl.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
