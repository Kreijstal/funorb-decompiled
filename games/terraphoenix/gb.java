...
class gb extends gl implements sf {
    ...
    private final void a(Hashtable param0, int param1, StringBuilder param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              var10 = new k(((gb) this).field_C);
              var6 = (gl) (Object) var10.a((byte) -13);
              if (param1 == 81) {
                break L1;
              } else {
                var9 = null;
                boolean discarded$14 = ((gb) this).a((byte) 44, (gl) null);
                break L1;
              }
            }
            L2: while (true) {
              if (var6 == null) {
                ...
                L3: while (true) {
                  if (param3 < var7) {
                    StringBuilder discarded$16 = var6.a(34, param2, param3 - -1, param0);
          ...
          throw qk.a((Throwable) (Object) stackIn_15_0, stackIn_15_2 + 44 + param3 + 41);
        }
    }
    ...
    final boolean a(byte param0, gl param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("gb.F(").append(param0).append(44);
    ...
    final void b(byte param0, gl param1) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param0 == 95) {
                ...
                boolean discarded$2 = gb.a((byte) -55, 'ﾬ');
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("gb.W(").append(param0).append(44);
    ...
    final static void a(byte param0, nd param1, int param2) {
        ...
        try {
            ...
            throw qk.a((Throwable) (Object) runtimeException, "gb.AA(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 41);
        }
    }
    ...
    final boolean a(boolean param0, int param1, int param2, int param3, int param4, gl param5, int param6) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("gb.U(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
            stackIn_15_0 = stackOut_13_0;
            stackIn_15_1 = stackOut_13_1;
            stackIn_14_0 = stackOut_13_0;
            stackIn_14_1 = stackOut_13_1;
          ...
          throw qk.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + 44 + param6 + 41);
        }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, gl param5) {
        ...
        try {
          L0: {
            L1: {
              var7 = new k(((gb) this).field_C);
              if (param0 >= 36) {
                break L1;
              } else {
                gl discarded$2 = ((gb) this).e((byte) -50);
                break L1;
              }
            }
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("gb.HA(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
    ...
    void a(gl param0, int param1, int param2, int param3) {
        ...
        try {
          ...
          throw qk.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
    }
    ...
    final StringBuilder a(int param0, StringBuilder param1, int param2, Hashtable param3) {
        ...
        try {
          L0: {
            ...
            L2: {
              if (param0 == 34) {
                ...
                var6 = null;
                boolean discarded$2 = ((gb) this).a('J', (gl) null, -124, 44);
                break L2;
              }
            }
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("gb.KA(").append(param0).append(44);
    ...
    final boolean a(gl param0, int param1, int param2, int param3, int param4, int param5, byte param6) {
        ...
        try {
          ...
          throw qk.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
                ...
                if (var4 == null) {
                  ...
                  L3: {
                    if (!var4.d(-126)) {
                      ...
                      var5 = new k(((gb) this).field_C);
                      uf discarded$2 = var5.a((byte) -113, (uf) (Object) var4);
    ...
    final boolean a(int param0, gl param1) {
        ...
        try {
          L0: {
            L1: {
              if (param0 == 48) {
                ...
                boolean discarded$4 = ((gb) this).d(115);
                break L1;
              }
            }
              ...
              L2: while (true) {
                if (var4 == null) {
                  ...
                  L3: {
                    if (var4.d(-109)) {
                      var5 = new k(((gb) this).field_C);
                      uf discarded$5 = var5.a(98, (uf) (Object) var4);
          ...
          L5: {
            ...
            stackOut_19_1 = new StringBuilder().append("gb.GA(").append(param0).append(44);
            stackIn_21_0 = stackOut_19_0;
            stackIn_21_1 = stackOut_19_1;
    ...
    boolean a(char param0, gl param1, int param2, int param3) {
        ...
        try {
            ...
            if (param2 == 30) {
              L1: while (true) {
                ...
                if (var6 == 80) {
                  L4: {
                    if (bh.field_e[81]) {
                      stackOut_15_0 = ((gb) this).a(48, param1);
                      stackIn_16_0 = stackOut_15_0;
                      break L4;
                    } else {
                      stackOut_14_0 = ((gb) this).a(param1, (byte) 88);
                      stackIn_16_0 = stackOut_14_0;
                      break L4;
                    }
                  }
          ...
          L5: {
            ...
            stackOut_17_1 = new StringBuilder().append("gb.K(").append(param0).append(44);
          ...
          throw qk.a((Throwable) (Object) stackIn_20_0, stackIn_20_2 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_16_0;
    }
