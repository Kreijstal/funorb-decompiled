...
final class ph extends di {
    ...
    final static java.awt.Frame a(he param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          throw qk.a((Throwable) (Object) stackIn_31_0, stackIn_31_2 + ',' + param1 + ',' + 0 + ',' + param3 + ',' + 10 + ',' + param5 + ')');
        }
        return stackIn_27_0;
    }
    ...
    final static void a(int param0, bm param1) {
        try {
            ...
            throw qk.a((Throwable) (Object) runtimeException, "ph.G(" + 12 + ',' + (param1 != null ? "{...}" : "null") + ',' + 12 + ',' + -1 + ')');
        }
    }
    ...
    private final boolean c(String param0) {
        ...
        try {
          ...
          throw qk.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + ',' + -1 + ')');
        }
