...
final class qj extends pk {
    ...
    qj(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((qj) this).field_N = new byte[256][];
        ((qj) this).field_N = qj.a(param5, param6);
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * l.field_k;
          var9 = l.field_k - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= l.field_d) {
            break L0;
          } else {
            var12 = l.field_d - param2;
            param4 = param4 - var12;
            param2 = l.field_d;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * l.field_k;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= l.field_c) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - l.field_c);
            break L1;
          }
        }
        L2: {
        ...
        L3: {
          if (param1 + param3 <= l.field_f) {
            break L3;
          } else {
            var12 = param1 + param3 - l.field_f;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  qj.a(l.field_i, ((qj) this).field_N[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  ud.a(l.field_i, ((qj) this).field_N[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * l.field_k;
          var10 = l.field_k - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= l.field_d) {
            break L0;
          } else {
            var13 = l.field_d - param2;
            param4 = param4 - var13;
            param2 = l.field_d;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * l.field_k;
            break L0;
          }
        }
        L1: {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  qj.a(l.field_i, ((qj) this).field_N[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  ud.a(l.field_i, ((qj) this).field_N[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
