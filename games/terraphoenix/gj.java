    ...
    final static void a(boolean param0, int param1, int param2, nb param3, boolean param4) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_21_1 = new StringBuilder().append("gj.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static void a(bm param0, bm param1, int param2, int param3, pk param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, bm param14, int param15, int param16, pk param17, int param18, int param19, int param20) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_13_1 = ((StringBuilder) (Object) stackIn_13_1).append(stackIn_13_2).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',').append(param8).append(',').append(param9).append(',').append(param10).append(',').append(param11).append(',').append(param12).append(',').append(param13).append(',');
          ...
          throw qk.a((Throwable) ((Object) stackIn_19_0), stackIn_19_2 + ',' + param18 + ',' + param19 + ',' + param20 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return;
        } else {
