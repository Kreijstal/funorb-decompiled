    ...
    private final boolean a(int param0, iq param1, int param2) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_22_1 = new StringBuilder().append("um.I(").append(param0).append(',');
            ...
            if (null != this.field_G) {
              L1: {
                ...
                if (param5 <= -107) {
                  ...
                  var12 = (iq) null;
                  discarded$2 = this.a(-62, 27, -12, -87, -46, (byte) -68, (iq) null);
                  break L1;
                }
              }
              L2: while (true) {
                    ...
                    if (var8 > param3) {
                      L4: {
                        if (var7 == null) {
                          ...
                          discarded$31 = var7.a(param0, param3 - -1, (byte) -79, param2);
                          break L4;
                        }
                      }
                      var6++;
          ...
          if (var7.length <= var3) {
            L1: {
              if (param0 == 2) {
                ...
                var6 = (iq) null;
                discarded$1 = this.a(101, -56, -30, -66, -25, (byte) -87, (iq) null);
                break L1;
              }
            }
            return;
    ...
    private final boolean a(iq param0, byte param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = this.a(1, param0, (byte) -127);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("um.P(");
    ...
    void a(byte param0, int param1, int param2, iq param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("um.E(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    private final boolean b(byte param0, iq param1) {
        ...
        try {
          ...
          L2: {
            var3 = decompiledCaughtException;
            stackOut_4_0 = (RuntimeException) (var3);
            stackOut_4_1 = new StringBuilder().append("um.O(").append(param0).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    private final boolean a(int param0, iq param1, byte param2) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_20_1 = new StringBuilder().append("um.L(").append(param0).append(',');
