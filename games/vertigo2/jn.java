...
final class jn {
    ...
    jn(int param0, r param1, r param2, jh param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (this.field_f == null) {
                ...
                discarded$4 = this.field_f.b(1, (byte) -99);
                break L1;
              }
            }
            if (this.field_a != null) {
              discarded$5 = this.field_a.b(1, (byte) -29);
              break L0;
            } else {
              return;
            }
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("jn.<init>(").append(param0).append(',');
    ...
    final static void a(int[] param0, int param1, fb param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        try {
          ...
          throw wn.a((Throwable) ((Object) stackIn_12_0), stackIn_12_2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ')');
        }
    }
