...
final class vg {
    ...
    final static ge a(int param0, int param1, int param2, r param3, r param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("vg.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static boolean a(int param0, int param1, int param2, int param3) {
        ...
        if (param0 == -4151) {
          ...
          discarded$8 = vg.a(-8, 109, 103, -122);
          if (-1 >= (param1 ^ -1)) {
            if (-12 <= (param1 ^ -1)) {
              if (param2 >= 1) {
                if (gf.b(param1, param3, param0 + -24480) < param2) {
