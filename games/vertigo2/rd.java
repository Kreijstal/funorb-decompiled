...
final class rd {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((rd) this).field_l.length;
        var4 = field_d[((rd) this).field_f - 1];
        var5 = field_h;
        field_h[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_i[0] * ((rd) this).field_f;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_h[var16]) {
                  var9 = field_e[var16];
                  var10 = field_i[var16] * ((rd) this).field_f;
            ...
            L3: {
              var7 = rd.a(field_e, var6);
              var8_int = rd.b(field_e, var6);
              var9 = this.a(field_e[var7], field_i[var7], field_e[var8_int], field_i[var8_int], field_e[var6]);
              var10 = field_i[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean a() {
        ...
        int var2 = ((rd) this).field_l.length;
        System.arraycopy((Object) (Object) ((rd) this).field_l, 0, (Object) (Object) field_e, 0, var2);
        int var3 = field_d[((rd) this).field_f - 1];
        int var4 = d.b(-80, var3 - 1);
        field_i[0] = vh.a(var4);
        field_i[1] = vh.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((rd) this).field_b.length; var6++) {
            var7 = ((rd) this).field_b[var6];
            var8 = ((rd) this).field_k[var7];
            var9 = ((rd) this).field_c[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = vh.field_o[((rd) this).field_j[var7]].c();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((rd) this).field_a[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_i[incrementValue$0] = var13 >= 0 ? vh.field_o[var13].c() : 0;
            }
        }
        return true;
    }
    ...
    rd() {
        ...
        if (var1 == 1) {
          var2 = vh.a(5);
          var3 = 0;
          ((rd) this).field_b = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((rd) this).field_k = new int[var3];
              ((rd) this).field_c = new int[var3];
              ((rd) this).field_j = new int[var3];
              ((rd) this).field_a = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((rd) this).field_f = vh.a(2) + 1;
                  var4 = vh.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((rd) this).field_l = new int[var5];
                      ((rd) this).field_l[0] = 0;
                      ((rd) this).field_l[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((rd) this).field_k[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((rd) this).field_l[incrementValue$2] = vh.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((rd) this).field_k[((rd) this).field_b[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((rd) this).field_k[var4] = vh.a(3) + 1;
                    int dupTemp$3 = vh.a(2);
                    ((rd) this).field_c[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((rd) this).field_j[var4] = vh.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
