...
final class rd {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_h[var16]) {
                  var9 = field_e[var16];
                  var10 = field_i[var16] * this.field_f;
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_l, 0, field_e, 0, var2);
        int var3 = field_d[this.field_f - 1];
        ...
        for (var6 = 0; var6 < this.field_b.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = vh.field_o[this.field_j[var7]].c();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_k[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_l[incrementValue$0] = vh.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_k[this.field_b[var6]];
                      var6++;
                      continue L2;
                    }
                  }
