...
final class vh extends li {
    ...
    private static pg[] field_x;
    private static rd[] field_E;
    private static pi[] field_u;
    private int field_v;
    private int field_n;
    private int field_B;
    private int field_K;
    ...
    private final static boolean a(r param0) {
        byte[] var1 = null;
        if (!field_M) {
            var1 = param0.a(0, 0, (byte) -54);
            if (var1 == null) {
                return false;
            }
            vh.a(var1);
    ...
    final static float f(int param0) {
    ...
    final static int a(int param0) {
        ...
        while (param0 >= 8 - field_Q) {
            var3 = 8 - field_Q;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_P[field_U] >> field_Q & var4) << var2);
            field_Q = 0;
            field_U = field_U + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_P[field_U] >> field_Q & var3) << var2);
            field_Q = field_Q + param0;
        }
        return var1;
    }
          ...
          if (var17_int >= var14.field_c) {
            L10: {
              if (var15 != 0) {
                ...
                field_E[var18_int].a(field_w, var4 >> 1);
                break L10;
              }
            }
            L11: {
                                                                          ...
                                                                          if (var26 >= var9) {
                                                                            ...
                                                                            L31: while (true) {
                                                                              if (var26 >= var12) {
                                                                                ...
                                                                                field_w[var26] = field_w[var26] * (float)Math.sin(1.5707963267948966 * (double)var27 * (double)var27);
                                                                                var26++;
                                                                                continue L31;
                                                                              }
                                                                            }
    ...
    final static int a() {
        int var0 = field_P[field_U] >> field_Q & 1;
        field_Q = field_Q + 1;
        field_U = field_U + (field_Q >> 3);
        field_Q = field_Q & 7;
        return var0;
    }
              ...
              if (var7 == null) {
                ...
                L6: while (true) {
                  if (var5 >= var4) {
                    ...
                    var3++;
                    this.field_T[incrementValue$0] = (byte)(var6 - 128);
                    var5++;
                    continue L6;
                  }
                }
    ...
    private vh(byte[] param0) throws IOException {
        this.b(param0);
    }
