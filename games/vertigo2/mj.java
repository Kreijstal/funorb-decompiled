...
final class mj {
    ...
    final static void a(int param0, u[] param1, r param2, String[][] param3, byte[] param4, int param5, er[][] param6, String[] param7, er[][] param8, r param9, int[] param10, byte[] param11, String[][] param12, String[] param13, boolean param14, String[] param15, int[] param16, int param17, int param18, r param19) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("mj.B(").append(param0).append(',');
          ...
          L16: {
            ...
            stackOut_46_1 = ((StringBuilder) (Object) stackIn_46_1).append(stackIn_46_2).append(',').append(param17).append(',').append(param18).append(',');
          ...
          throw wn.a((Throwable) ((Object) stackIn_49_0), stackIn_49_2 + ')');
        }
    }
    ...
    final static String a(int param0, byte[] param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var6 >= param3) {
                ...
                stackOut_12_0 = new String(var12, 0, var5);
                stackIn_13_0 = stackOut_12_0;
                break L0;
              } else {
          ...
          L4: {
            ...
            stackOut_14_1 = new StringBuilder().append("mj.C(").append(param0).append(',');
            stackIn_16_0 = stackOut_14_0;
            stackIn_16_1 = stackOut_14_1;
    ...
    final static int a(int param0, Random param1, int param2) {
        ...
        try {
          L0: {
            ...
            if ((param2 ^ -1) >= -1) {
              ...
              if (ko.b((byte) -75, param2)) {
                stackOut_7_0 = (int)(((long)param1.nextInt() & 4294967295L) * (long)param2 >> 1410607200);
                stackIn_8_0 = stackOut_7_0;
                ...
                L2: while (true) {
                  var4 = param1.nextInt();
                  if (var4 < var3_int) {
                    stackOut_12_0 = rg.a(57, var4, param2);
                    stackIn_13_0 = stackOut_12_0;
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("mj.A(").append(param0).append(',');
            stackIn_16_0 = stackOut_14_0;
            stackIn_16_1 = stackOut_14_1;
            stackIn_15_0 = stackOut_14_0;
            stackIn_15_1 = stackOut_14_1;
    ...
    final static void a(int param0, int param1, int param2, int param3, int[] param4, byte param5, int param6) {
        ...
        try {
          L0: {
            L1: {
              var7_int = oo.field_j[param2];
              var8 = oo.field_h[param2];
              var9 = oo.field_j[param3];
              var10 = oo.field_h[param3];
              var11 = (var7_int >> -694455839) * (var9 >> -67462463) >> -1207684850;
              var12 = (var9 >> -1852326815) * (var8 >> -917395743) >> -2111330578;
              if (param5 < -13) {
                break L1;
              } else {
                field_b = (r) null;
            ...
            var13 = (var10 >> 491243489) * (var7_int >> 115405761) >> 774638190;
            param4[9] = var12;
            param4[4] = 0;
            param4[1] = param6;
            param4[0] = param0;
            ...
            param4[3] = var10;
            param4[2] = param1;
            var14 = (var8 >> -1063648607) * (var10 >> 299347329) >> -1868061234;
            param4[5] = -var9;
            param4[11] = var14;
            break L0;
          }
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("mj.F(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
          ...
          throw wn.a((Throwable) ((Object) stackIn_7_0), stackIn_7_2 + ',' + param5 + ',' + param6 + ')');
        }
    }
    ...
    final static void a(byte param0) {
        ...
        if (param0 != 4) {
            byte[] var2 = (byte[]) null;
            discarded$0 = mj.a(31, (byte[]) null, -75, 56);
        }
        il.field_a = true;
    }
