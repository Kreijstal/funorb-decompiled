    ...
    void a(byte param0, int param1, ed param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("ji.C(").append(param0).append(',').append(param1).append(',');
