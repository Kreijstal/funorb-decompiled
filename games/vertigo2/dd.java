...
class dd {
    ...
    private final void a(int[] param0, int param1) {
        ...
        L1: {
          ...
          if (this.field_r == null) {
            ...
            if (this.field_c > 0) {
              ...
              this.field_c = this.field_c + (field_u >> 4);
              dd.b(this.field_r);
              this.a(this.field_r, this.field_r.b());
              var4 = 0;
              var5 = 255;
              var6 = 7;
              L2: while (true) {
                                ...
                                if (var4 < this.field_o) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_a[var7_int] = (sn) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((sn) (var7)).field_q;
                        ((sn) (var7)).field_q = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
        ...
        L17: {
          if (this.field_r == null) {
            ...
            this.field_r.b(param0, 0, param1);
            break L17;
          }
        }
        this.field_k = gk.a(113);
    }
                ...
                L0: {
                  ...
                  L2: while (true) {
                    if (var1 <= this.field_k + 5000L) {
                      ...
                      this.a(256);
                      this.field_k = this.field_k + (long)(256000 / field_u);
                      var1 = gk.a(99);
                      continue L2;
                    }
                  }
              ...
              if (this.field_i != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.g();
                      if (this.field_t - var3_int <= this.field_b) {
                        break L6;
                      } else {
                        this.field_b = this.field_t - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_d + this.field_l;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_m) {
                        ...
                        if (var4 + 256 <= this.field_m) {
                          ...
                          this.field_l = var4 - this.field_d;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_p) {
                            ...
                            L12: {
                              if (this.field_f) {
                                ...
                                this.field_l = Math.min(this.field_s, this.field_b);
    ...
    private final void a(sn param0, int param1) {
        int var3 = param1 >> 5;
        sn var4 = this.field_a[var3];
        if (var4 == null) {
            this.field_q[var3] = param0;
        } else {
            var4.field_q = param0;
        }
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new vr();
                          var4 = var5;
                          stackIn_10_0 = (vr) (var4);

                          stackIn_10_1 = 256;

                          if (!field_h) {
                            stackIn_11_0 = (vr) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_e <= 0) {
                            ...
                            if (field_j != null) {
                              ...
                              param0.a(field_e, (Runnable) ((Object) field_j), 0);
                              break L5;
                            }
                          }
                        }
    ...
    dd() {
        this.field_g = false;
        this.field_o = 32;
        this.field_k = gk.a(47);
        this.field_b = 0;
        this.field_a = new sn[8];
        this.field_q = new sn[8];
        this.field_f = true;
        this.field_s = 0;
        this.field_p = 0L;
        this.field_n = 0L;
