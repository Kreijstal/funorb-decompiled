    ...
    final void a(ed param0, pr param1) {
        ...
        L0: {
          ...
          if (var3 == 0) {
            ...
            this.field_a[0] = param0.a((byte) -11);
            this.field_a[1] = param0.a((byte) -11);
            var4 = param0.h(-11);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                    ...
                    L5: while (true) {
                      if (var7 >= this.field_e[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_c[var5][1][var7] = param0.a((byte) -11);
                          this.field_f[var5][1][var7] = param0.a((byte) -11);
                          var7++;
                          continue L5;
                        }
                      }
                ...
                L6: while (true) {
                  if (var6 >= this.field_e[var5]) {
                    ...
                    this.field_c[var5][0][var6] = param0.a((byte) -11);
                    this.field_f[var5][0][var6] = param0.a((byte) -11);
                    var6++;
                    continue L6;
                  }
                }
