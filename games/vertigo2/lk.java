          ...
          L0: {
            ...
            if (hi.a((byte) -3, var9)) {
              if (-3 != (ba.field_d ^ -1)) {
                ...
                var8 = vo.a(param2, 0);
                if (var8 != null) {
                  discarded$1 = tm.field_a.b(var8, (byte) -50);
                  L1: while (true) {
                  ...
                  stackOut_9_0 = Vertigo2.a(new String[]{param2}, tq.field_a, 26);
    ...
    final static boolean a(int param0, long param1, String param2, int param3, int[] param4) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_9_1 = new StringBuilder().append("lk.C(").append(param0).append(',').append(param1).append(',');
