...
final class ne extends cj implements nc, ij {
    ...
    final void a(byte param0, int param1, int param2, iq param3) {
        try {
            ...
            throw wn.a((Throwable) (Object) runtimeException, "ne.E(" + param0 + 44 + param1 + 44 + param2 + 44 + (param3 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    private final int a(int param0, int param1, String param2, int param3, int param4, String param5, iq param6) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ne.B(").append(param0).append(44).append(param1).append(44);
    ...
    public final void a(int param0, d param1, byte param2, int param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ne.C(").append(param0).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
          ...
          throw wn.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    private final int a(String param0, String param1, iq param2, int param3, int param4, boolean param5) {
        ...
        try {
          L0: {
            stackOut_0_0 = this.a(param4, param3, param0, -25, 35, param1, param2);
            stackIn_1_0 = stackOut_0_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ne.H(");
            stackIn_4_0 = stackOut_2_0;
            stackIn_4_1 = stackOut_2_1;
            stackIn_3_0 = stackOut_2_0;
            stackIn_3_1 = stackOut_2_1;
          ...
          throw wn.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + param3 + 44 + param4 + 44 + 0 + 41);
        }
        return stackIn_1_0;
    }
    ...
    public final void a(String param0, int param1) {
        ...
        try {
            ...
            if (param1 != 4944) {
                boolean discarded$0 = this.k(-123);
            }
            var4 = param0;
            ((kp) (Object) var3).a(var4, -86, false);
        } catch (RuntimeException runtimeException) {
            throw wn.a((Throwable) (Object) runtimeException, "ne.D(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final boolean a(char param0, int param1, int param2, iq param3) {
        ...
        try {
            ...
            if (super.a(param0, param1, param2, param3)) {
              ...
              if (param2 != 98) {
                if (param2 != 99) {
                  ...
                  stackOut_10_0 = ((ne) this).b((byte) -98, param3);
                  stackIn_11_0 = stackOut_10_0;
                  return stackIn_11_0;
                }
              } else {
                stackOut_7_0 = ((ne) this).a(32345, param3);
                stackIn_8_0 = stackOut_7_0;
                return stackIn_8_0;
              }
            }
          ...
          L2: {
            ...
            stackOut_14_1 = new StringBuilder().append("ne.M(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    private final boolean a(ik param0, boolean param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_9_1 = new StringBuilder().append("ne.J(");
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
          ...
          throw wn.a((Throwable) (Object) stackIn_12_0, stackIn_12_2 + 44 + 1 + 41);
        }
