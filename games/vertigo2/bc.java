    ...
    final static void a(int param0, int param1, byte param2, er[] param3, int param4, int param5) {
        ...
        try {
          ...
          L23: {
            ...
            stackIn_75_1 = new StringBuilder().append("bc.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
