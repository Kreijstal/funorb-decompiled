        ...
        try {
          L0: {
            if (!param2.b(0)) {
              ...
              if (!param0) {
                stackOut_7_0 = param4 + " - " + param2.b(param3, 100) + "%";
          ...
          L1: {
            ...
            stackOut_9_1 = new StringBuilder().append("en.A(").append(param0).append(44);
    ...
    final static byte[] a(byte param0, String param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = po.field_e.a("", param1, 0);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("en.B(").append(param0).append(44);
        ...
        try {
          L0: {
            ...
            if (!hi.a((byte) 126, var9)) {
              ...
              if (ba.field_d != 2) {
                stackOut_6_0 = t.field_n;
                stackIn_7_0 = stackOut_6_0;
                return stackIn_7_0;
              } else {
                var8 = or.a(90, param2);
                if (var8 == null) {
                  stackOut_10_0 = Vertigo2.a(new String[1], jp.field_R, -114);
          ...
          L1: {
            ...
            stackOut_14_1 = new StringBuilder().append("en.E(");
          ...
          throw wn.a((Throwable) (Object) stackIn_20_0, stackIn_20_2 + 44 + param3 + 41);
        }
