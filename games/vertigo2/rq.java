...
final class rq extends sn {
              ...
              if (var4 == null) {
                ...
                L1: while (true) {
                  if (var8 >= 7) {
                    ...
                    bi.e(var8, 1 + var8, -(var8 << 1) + 14, 16777215);
                    var8++;
                    continue L1;
                  }
                }
    ...
    final static er a(r param0, String param1, String param2) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = mf.a(param0, var5, (byte) -94, var4_int);
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("rq.B(");
          ...
          throw wn.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + 44 + 98 + 41);
        }
        return stackIn_3_0;
    }
    ...
    private final void a(int param0, int param1, pe param2) {
        ...
        try {
          L0: {
            L1: {
              if ((4 & ((rq) this).field_s.field_N[param2.field_q]) == 0) {
                break L1;
              } else {
                if (param2.field_E >= 0) {
                  break L1;
                } else {
                  var4_int = ((rq) this).field_s.field_B[param2.field_q] / dd.field_u;
                    ...
                    L2: {
                      if (0 == ((rq) this).field_s.field_H[param2.field_q]) {
                        ...
                        L3: {
                          ...
                          if (param2.field_K.field_n[param2.field_B] >= 0) {
          ...
          L5: {
            ...
            stackOut_15_1 = new StringBuilder().append("rq.F(").append(-1).append(44).append(param1).append(44);
            stackIn_17_0 = stackOut_15_0;
            stackIn_17_1 = stackOut_15_1;
    ...
    private final void a(int param0, int[] param1, int param2, byte param3, pe param4, int param5) {
        ...
        try {
            ...
            L1: {
              if (0 == (4 & ((rq) this).field_s.field_N[param4.field_q])) {
                ...
                if (param4.field_E >= 0) {
                  ...
                  var7_int = ((rq) this).field_s.field_B[param4.field_q] / dd.field_u;
                  L2: while (true) {
          ...
          L8: {
            ...
            stackOut_23_1 = new StringBuilder().append("rq.H(").append(param0).append(44);
          ...
          throw wn.a((Throwable) (Object) stackIn_29_0, stackIn_29_2 + 44 + param5 + 41);
        }
    }
    ...
    final static void a(boolean param0, byte param1, int param2, boolean param3, String param4) {
        ...
        try {
          L0: {
            ...
            L6: while (true) {
              if (al.field_y.length <= var9) {
                qp.field_d = -(var8 >> 1) + var8 + ni.field_a;
                pk.field_o = -(var8 >> 1) + ni.field_a;
                sf.field_d = kg.field_G.field_b * (vo.field_y + eb.field_h << 1);
                var9 = 0;
                L7: while (true) {
                  if (var9 >= al.field_y.length) {
                    ...
                    L8: {
                      stackOut_31_0 = sf.field_d;
                      stackIn_33_0 = stackOut_31_0;
                      stackIn_32_0 = stackOut_31_0;
                      if (dg.field_f[var9] >= 0) {
                        stackOut_33_0 = stackIn_33_0;
                        stackOut_33_1 = ml.field_v;
                        stackIn_34_0 = stackOut_33_0;
                        stackIn_34_1 = stackOut_33_1;
                        break L8;
                      } else {
                        stackOut_32_0 = stackIn_32_0;
                        stackOut_32_1 = cd.field_a;
                        stackIn_34_0 = stackOut_32_0;
                        stackIn_34_1 = stackOut_32_1;
                        break L8;
                      }
                    }
                    sf.field_d = stackIn_34_0 + stackIn_34_1;
                    var9++;
                    continue L7;
                  }
                }
                ...
                L10: {
                  var10 = ao.a(stackIn_23_0, stackIn_23_1, stackIn_23_2 != 0);
                  if (dg.field_f[var9] == -1) {
                    break L10;
                  } else {
          ...
          L12: {
            ...
            stackOut_37_1 = new StringBuilder().append("rq.K(").append(1).append(44).append(127).append(44).append(0).append(44).append(param3).append(44);
    ...
    final void b(int[] param0, int param1, int param2) {
        ...
        try {
          L0: {
            ...
            var6 = (pe) (Object) ((rq) this).field_w.a((byte) 100);
            L1: while (true) {
              if (var6 == null) {
                break L0;
              } else {
                  ...
                  if (((rq) this).field_s.a(-1, var6)) {
                    ...
                    L3: while (true) {
                      if (var5 <= var6.field_H) {
                        ...
                        if (((rq) this).field_s.a(var4_int, var6, var5, param0, (byte) 114)) {
                          break L2;
                        } else {
                          continue L3;
                        }
    ...
    rq(db param0) {
        ...
        try {
            ...
            throw wn.a((Throwable) (Object) runtimeException, "rq.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
