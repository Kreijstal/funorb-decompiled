        ...
        if (((qo) this).field_v.field_c) {
            ...
            for (var8 = 0; var8 < aa.field_Vb; var8++) {
                ...
                for (var14 = 0; we.field_M > var14; var14++) {
                    var15 = var32[var14];
                    var13[var14] = b.a(var15, 255) << 4;
                    var12[var14] = b.a(4080, var15 >> 4);
                    var11[var14] = b.a(var15 >> 12, 4080);
                }
            }
        }
        return var3;
          ...
          L0: {
            L1: {
              if (param1 != 0) {
                ...
                var4_int = 0;
                L3: while (true) {
                  if (~var4_int <= ~((qo) this).field_z.length) {
                    break L1;
                  } else {
                    L4: {
                      var5 = param2.h(-11);
                      ...
                      if (var6 != 0) {
                        if (var6 == 1) {
                          ...
                          if (var6 == 2) {
                            ((qo) this).field_z[var4_int] = (jq) (Object) td.a(false, param2);
                            break L4;
                          } else {
                            if (var6 != 3) {
                              break L4;
                            } else {
                              ((qo) this).field_z[var4_int] = (jq) (Object) rb.a((byte) 104, param2);
                              break L4;
                            }
                          }
                        }
