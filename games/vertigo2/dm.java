    ...
    final static void k(int param0) {
        ...
        L0: {
          ...
          if (param0 == 0) {
            ...
            int discarded$1 = dm.a(-79, 39, -11, -30);
            break L0;
          }
        }
        L1: {
            ...
            if (param5 >= ua.field_e) {
              ...
              L3: {
                if (ua.field_e <= param2) {
                  param2++;
                  ki.a(-93, param1, vl.field_e[param2], param3, param4);
                  break L3;
                } else {
                  param2 = ua.field_e;
                  break L3;
              ...
              L4: {
                if (param5 <= cj.field_D) {
                  param5--;
                  ki.a(-116, param1, vl.field_e[param5], param3, param4);
                  break L4;
                } else {
                  param5 = cj.field_D;
                  break L4;
