    ...
    final static void a(int param0, int param1, int param2, jp param3, int param4, int param5, int param6) {
        ...
        try {
          L0: {
            ...
            var62 = new int[param3.field_K];
            var57 = var62;
            var53 = var57;
            var49 = var53;
            var41 = var49;
            var8_array = var41;
            var63 = new int[param3.field_K];
            var59 = pk.field_w;
            var60 = dp.field_A;
            var61 = dh.field_d;
            var13 = 0;
            L3: while (true) {
              if (param3.field_K <= var13) {
                ...
                L14: {
                  var14 = var59[var13] * param4 - -(var60[var13] * param1) + param6 * var61[var13] >> 8;
                  if (0 <= var14) {
                    break L14;
                  } else {
                    var14 = -var14;
                ...
                L16: {
                  var14 = stackIn_15_0;
                  var15 = param2 * var60[var13] + (var59[var13] * param0 + var61[var13] * param5) >> 8;
          ...
          L17: {
            ...
            stackOut_50_1 = new StringBuilder().append("pb.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw wn.a((Throwable) (Object) stackIn_53_0, stackIn_53_2 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + 73 + ')');
        }
    }
