    ...
    final static void a(int param0, int param1, int param2, jp param3, int param4, int param5, int param6, int param7) {
        ...
        try {
          L0: {
            L1: {
              L2: {
                ...
                if (var44.field_x == null) {
                  ...
                  if (-2 > (var44.field_G ^ -1)) {
                    var60 = var44.field_x;
                    op.a(0, oq.field_F, 0, var60, false);
                    break L1;
                  } else {
                    break L2;
                  }
            ...
            L4: while (true) {
              if (param3.field_K <= var13) {
                  ...
                  if (var13 >= ja.field_a) {
                    ...
                    L7: {
                      ...
                      if (param3.field_P[var14] < pk.field_w.length) {
                        stackIn_29_0 = param3.field_P[var14];
                        break L7;
                      } else {
                        stackIn_29_0 = -1;
                        break L7;
                    ...
                    L8: {
                      ...
                      if (pk.field_w.length > param3.field_C[var14]) {
                        stackIn_32_0 = param3.field_C[var14];
                        break L8;
                      } else {
                        stackIn_32_0 = -1;
                        break L8;
                            ...
                            if (param3.field_J.length <= var14) {
                              ...
                              if ((param3.field_J[var14] ^ -1) == 0) {
                                ...
                                if (wc.field_o.length > param3.field_J[var14]) {
                                  stackIn_40_0 = wc.field_o[param3.field_J[var14]];
                                  break L9;
                                } else {
                                  break L10;
                                }
                ...
                L15: {
                  var14 = var61[var13] * param4 - -(var62[var13] * param1) + param6 * var63[var13] >> 1126490216;
                  if (0 <= var14) {
                    break L15;
                  } else {
                    var14 = -var14;
                ...
                L17: {
                  var14 = stackIn_17_0;
                  var15 = param2 * var62[var13] + (var61[var13] * param0 + var63[var13] * param5) >> 314446696;
                  stackIn_19_0 = bl.field_r;
          ...
          L18: {
            ...
            stackIn_54_1 = new StringBuilder().append("pb.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
