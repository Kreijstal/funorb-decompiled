...
final class ei extends gp {
    ...
    final boolean a(byte param0) {
        ...
        if (((ei) this).field_t != null) {
          ...
          L0: {
            if (null != ((ei) this).field_u) {
              break L0;
            } else {
              if (!oc.field_r.c(11321, ((ei) this).field_v)) {
                return false;
              } else {
                var28 = oc.field_r.a(0, ((ei) this).field_v);
                ((ei) this).field_u = new byte[var28.length][];
                var3_int = 0;
                L1: while (true) {
                  if (var28.length <= var3_int) {
                    break L0;
                  } else {
                    ((ei) this).field_u[var3_int] = oc.field_r.a(((ei) this).field_v, var28[var3_int], (byte) -107);
                    var3_int++;
                    continue L1;
                  }
                }
          ...
          var3_int = var14;
          L2: while (true) {
            if (((ei) this).field_u.length <= var14) {
              L3: {
                if (param0 >= 68) {
                  break L3;
                } else {
              ...
              if (var2 != 0) {
                var3 = new nj();
                var4 = oc.field_r.b(((ei) this).field_v, (byte) -47);
                ((ei) this).field_t = new ul[var4];
                var30 = oc.field_r.a(0, ((ei) this).field_v);
                var6 = 0;
                L4: while (true) {
                  if (var30.length <= var6) {
                    ((ei) this).field_u = null;
                    return true;
                  } else {
                    var31 = ((ei) this).field_u[var6];
                    var8 = new ed(var31);
                    var8.field_u = 1;
                    var9 = var8.a((byte) -11);
                    var10 = null;
