...
final class fc extends bn {
            ...
            L0: {
              if (param0 != 2) {
                        ...
                        if (this.field_g == null) {
                          ...
                          L2: while (true) {
                            if (var10 >= var9) {
                              ...
                              var11 = param1[var10];
                              if (var11 < this.field_g.length) {
                                var85 = this.field_g[var11];
                                var13 = 0;
                                L3: while (true) {
                                  if (var13 >= var85.length) {
                                    ...
                                    L5: {
                                      var15 = this.field_d[var14] & 65535;
                                      var16 = var15 >> 10 & 63;
                                      var17 = var15 >> 7 & 7;
                                      var18 = var15 & 127;
                                    ...
                                    this.field_d[var14] = (short)(var16 << 10 | var17 << 7 | var18);
                                    var13++;
                                    continue L3;
                                  }
                                }
                                ...
                                if (var11 < this.field_g.length) {
                                  ...
                                  L9: while (true) {
                                    if (var13 < var84.length) {
                                      ...
                                      L11: {
                                        var15 = (this.field_R[var14] & 255) + param2 * 8;
                                        if (var15 >= 0) {
                                          if (var15 <= 255) {
                                            break L11;
                                          } else {
                        ...
                        if (var11 < this.field_b.length) {
                          ...
                          L13: while (true) {
                            if (var13 < var83.length) {
                              ...
                              this.field_k[var14] = this.field_k[var14] - field_kb;
                              this.field_C[var14] = this.field_C[var14] - field_ib;
                              this.field_A[var14] = this.field_A[var14] - field_x;
                              this.field_k[var14] = this.field_k[var14] * param2 / 128;
                              this.field_C[var14] = this.field_C[var14] * param3 / 128;
                              this.field_A[var14] = this.field_A[var14] * param4 / 128;
                              this.field_k[var14] = this.field_k[var14] + field_kb;
                              this.field_C[var14] = this.field_C[var14] + field_ib;
                              this.field_A[var14] = this.field_A[var14] + field_x;
                              var13++;
                                ...
                                if (var36 < var82.length) {
                                  L19: {
                                    ...
                                    if (this.field_Y == null) {
                                      ...
                                      if ((param6 & this.field_Y[var37]) != 0) {
                                        break L19;
                                      } else {
                                        var36++;
                                        continue L18;
                                  ...
                                  var38 = var66[0] * this.field_k[var37] + var66[1] * this.field_C[var37] + var66[2] * this.field_A[var37] + 16384 >> 15;
                                  var39 = var66[3] * this.field_k[var37] + var66[4] * this.field_C[var37] + var66[5] * this.field_A[var37] + 16384 >> 15;
                                  var40 = var66[6] * this.field_k[var37] + var66[7] * this.field_C[var37] + var66[8] * this.field_A[var37] + 16384 >> 15;
                                  var38 = var38 + var30;
                                  var39 = var39 + var31;
                                  var40 = var40 + var32;
                                  this.field_k[var37] = var38;
                                  this.field_C[var37] = var39;
                ...
                if (param7 == null) {
                          ...
                          if (var13 < var81.length) {
                            ...
                            L25: {
                              ...
                              if (param4 == 0) {
                                ...
                                var17 = this.field_C[var14] * var15 + this.field_k[var14] * var16 + 32767 >> 16;
                                this.field_C[var14] = this.field_C[var14] * var16 - this.field_k[var14] * var15 + 32767 >> 16;
                                this.field_k[var14] = var17;
                                break L25;
                              }
                            }
                            L26: {
                              if (param2 == 0) {
                                ...
                                var17 = this.field_C[var14] * var16 - this.field_A[var14] * var15 + 32767 >> 16;
                                this.field_A[var14] = this.field_C[var14] * var15 + this.field_A[var14] * var16 + 32767 >> 16;
                                this.field_C[var14] = var17;
                                break L26;
                              }
                            }
                            L27: {
                              if (param3 == 0) {
                                ...
                                var17 = this.field_A[var14] * var15 + this.field_k[var14] * var16 + 32767 >> 16;
                                this.field_A[var14] = this.field_A[var14] * var16 - this.field_k[var14] * var15 + 32767 >> 16;
                                this.field_k[var14] = var17;
                                break L27;
                              }
                            }
                  ...
                  var25_int = var61[0] * -field_kb + var61[1] * -field_ib + var61[2] * -field_x + 16384 >> 15;
                  var26 = var61[3] * -field_kb + var61[4] * -field_ib + var61[5] * -field_x + 16384 >> 15;
                  var27 = var61[6] * -field_kb + var61[7] * -field_ib + var61[8] * -field_x + 16384 >> 15;
                                  ...
                                  if (var42 < var80.length) {
                                    L33: {
                                      ...
                                      if (this.field_Y == null) {
                                        ...
                                        if ((param6 & this.field_Y[var43]) != 0) {
                                          break L33;
                                        } else {
                                          var42++;
                                          continue L32;
                                    ...
                                    var44 = var63[0] * this.field_k[var43] + var63[1] * this.field_C[var43] + var63[2] * this.field_A[var43] + 16384 >> 15;
                                    var45 = var63[3] * this.field_k[var43] + var63[4] * this.field_C[var43] + var63[5] * this.field_A[var43] + 16384 >> 15;
                                    var46 = var63[6] * this.field_k[var43] + var63[7] * this.field_C[var43] + var63[8] * this.field_A[var43] + 16384 >> 15;
                                    var44 = var44 + var36;
                                    var45 = var45 + var37;
                                    var46 = var46 + var38;
                                    this.field_k[var43] = var44;
                                    this.field_C[var43] = var45;
                ...
                if (var11 < this.field_b.length) {
                  ...
                  L40: while (true) {
                    if (var13 < var79.length) {
                      ...
                      this.field_k[var14] = this.field_k[var14] + param2;
                      this.field_C[var14] = this.field_C[var14] + param3;
                      this.field_A[var14] = this.field_A[var14] + param4;
                      var13++;
                      continue L40;
                    } else {
                      var10++;
                  ...
                  if (var14 < var78.length) {
                    L45: {
                      ...
                      if (this.field_Y == null) {
                        ...
                        if ((param6 & this.field_Y[var15]) != 0) {
                          break L45;
                        } else {
                          var14++;
                          continue L44;
                    ...
                    field_kb = field_kb + this.field_k[var15];
                    field_ib = field_ib + this.field_C[var15];
                    field_x = field_x + this.field_A[var15];
                    var10++;
                    var14++;
                    continue L44;
                  } else {
          ...
          if (var4 >= this.field_w) {
            ...
            L1: {
              if (this.field_F == null) {
                ...
                stackIn_5_0 = this.field_F[var4];
                break L1;
              }
            }
            var3 = stackIn_5_0;
            if (var3 == -1) {
              var1 = this.field_d[var4] & 65535;
              if (this.field_bb[var4] != -1) {
                if (this.field_bb[var4] != -2) {
                  var2 = this.field_i[var4] & -131072;
                  this.field_i[var4] = var2 | fc.a(var1, var2 >> 17);
                  var2 = this.field_X[var4] & -131072;
                  this.field_X[var4] = var2 | fc.a(var1, var2 >> 17);
                  var2 = this.field_bb[var4] & -131072;
                  this.field_bb[var4] = var2 | fc.a(var1, var2 >> 17);
                  var4++;
                  continue L0;
                } else {
                  var4++;
    ...
    private final void a(int param0) {
        ...
        L0: {
          ...
          var3 = oo.field_e;
          var4 = 0;
          var5 = this.field_o[param0];
          var6 = this.field_a[param0];
          var7 = this.field_u[param0];
          var8 = field_q[var5];
          var9 = field_q[var6];
          var10 = field_q[var7];
          if (this.field_R != null) {
            oo.field_n = this.field_R[param0] & 255;
            break L0;
          } else {
            oo.field_n = 0;
            break L0;
        ...
        L1: {
          if (var8 < 50) {
            L2: {
              var11 = field_S[var5];
              var12 = field_fb[var5];
              var13 = this.field_i[param0] & 65535;
              if (var10 < 50) {
                break L2;
              } else {
        ...
        L3: {
          if (var9 < 50) {
            L4: {
              var11 = field_S[var6];
              var12 = field_fb[var6];
              var13 = this.field_X[param0] & 65535;
              if (var8 < 50) {
                break L4;
              } else {
        ...
        L5: {
          if (var10 < 50) {
            L6: {
              var11 = field_S[var7];
              var12 = field_fb[var7];
              var13 = this.field_bb[param0] & 65535;
              if (var9 < 50) {
                break L6;
              } else {
        ...
        L7: {
          ...
          if (var4 != 3) {
            ...
            L10: {
              if (this.field_F == null) {
                ...
                if (this.field_F[param0] != -1) {
                  L11: {
                    L12: {
                      if (this.field_eb == null) {
                        ...
                        if (this.field_eb[param0] == -1) {
                          break L12;
                        } else {
                          var20 = this.field_eb[param0] & 255;
                          var17 = this.field_N[var20];
                          var18 = this.field_D[var20];
                          var19 = this.field_E[var20];
                          break L11;
                        }
                      }
                    }
                  ...
                  if (this.field_bb[param0] != -1) {
                    oo.a(var14, var15, var16, var11, var12, var13, field_J[0], field_J[1], field_J[2], field_S[var17], field_S[var18], field_S[var19], field_fb[var17], field_fb[var18], field_fb[var19], field_q[var17], field_q[var18], field_q[var19], (int) this.field_F[param0]);
                    break L7;
                  } else {
                    oo.a(var14, var15, var16, var11, var12, var13, this.field_i[param0], this.field_i[param0], this.field_i[param0], field_S[var17], field_S[var18], field_S[var19], field_fb[var17], field_fb[var18], field_fb[var19], field_q[var17], field_q[var18], field_q[var19], (int) this.field_F[param0]);
                    break L7;
                  }
                } else {
                  break L10;
            ...
            if (this.field_bb[param0] != -1) {
              ...
              oo.a(var14, var15, var16, var11, var12, var13, oo.field_c[this.field_i[param0] & 65535]);
              break L7;
            }
          }
        }
        if (var4 != 4) {
          ...
          L15: {
              ...
              if (this.field_F == null) {
                ...
                if (this.field_F[param0] != -1) {
                  ...
                  if (this.field_bb[param0] != -1) {
                    ...
                    oo.a(var14, var15, var16, var11, var12, var13, this.field_i[param0], this.field_i[param0], this.field_i[param0], field_S[var17], field_S[var18], field_S[var19], field_fb[var17], field_fb[var18], field_fb[var19], field_q[var17], field_q[var18], field_q[var19], var20);
                    oo.a(var14, var16, field_l[3], var11, var13, field_O[3], this.field_i[param0], this.field_i[param0], this.field_i[param0], field_S[var17], field_S[var18], field_S[var19], field_fb[var17], field_fb[var18], field_fb[var19], field_q[var17], field_q[var18], field_q[var19], var20);
                    break L15;
                  }
                } else {
                  break L16;
            ...
            if (this.field_bb[param0] != -1) {
              ...
              var17 = oo.field_c[this.field_i[param0] & 65535];
        ...
        L0: {
          L1: {
            ...
            if (param2.field_k == null) {
              ...
              if (param2.field_k.length >= this.field_T) {
                break L0;
              } else {
                break L1;
              }
          ...
          param2.field_k = new int[this.field_T + 100];
          param2.field_C = new int[this.field_T + 100];
          param2.field_A = new int[this.field_T + 100];
          break L0;
        }
        var9 = 0;
        L2: while (true) {
          if (var9 >= this.field_T) {
              ...
              if (!param1) {
                ...
                L7: while (true) {
                  if (var9 >= this.field_w) {
                    ...
                    param2.field_d[var9] = this.field_d[var9];
                    param2.field_i[var9] = this.field_i[var9];
                    param2.field_X[var9] = this.field_X[var9];
                    param2.field_bb[var9] = this.field_bb[var9];
                    var9++;
                    continue L7;
                  }
                }
                ...
                param2.field_X = this.field_X;
                param2.field_bb = this.field_bb;
                break L6;
              }
            }
            param2.field_o = this.field_o;
            ...
            param2.field_k[var9] = this.field_k[var9];
            param2.field_C[var9] = this.field_C[var9];
            param2.field_A[var9] = this.field_A[var9];
            var9++;
            continue L2;
          }
        }
    ...
    final bn a(boolean param0, boolean param1, boolean param2) {
        L0: {
          if (!param0) {
            if (field_h.length < this.field_w) {
              field_h = new byte[this.field_w + 100];
              if (param1) {
                break L0;
              } else {
                if (field_m.length >= this.field_w) {
                  break L0;
                } else {
                  field_hb = new int[this.field_w + 100];
                  field_f = new int[this.field_w + 100];
                  field_s = new int[this.field_w + 100];
                  field_m = new short[this.field_w + 100];
                  break L0;
                }
              }
            } else {
    ...
    final void a(int[] param0, int[] param1) {
        ...
        if (var5 >= 50 - this.field_db) {
          var15 = this.field_db * 92682 >> 16;
          if (var3 >= -var5 - var15) {
            if (var3 <= var5 + var15) {
              if (var4 >= -var5 - var15) {
                if (var4 <= var5 + var15) {
                  ...
                  var21_int = var27;
                  L3: while (true) {
                    if (var27 >= this.field_T) {
                      try {
                        L4: {
                          this.a((var20 & var16) != 0, false, 0L, (int) this.field_db, this.field_db << 1);
                          break L4;
                        }
                      ...
                      L6: {
                        var22 = this.field_k[var27];
                        var23 = this.field_C[var27];
                        var24 = this.field_A[var27];
    ...
    private final void c(int param0) {
        ...
        if (!field_p[param0]) {
          L0: {
            var2 = this.field_o[param0];
            var3 = this.field_a[param0];
            var4 = this.field_u[param0];
          ...
          L1: {
            L2: {
              if (this.field_F == null) {
                ...
                if (this.field_F[param0] != -1) {
                    ...
                    L4: {
                      if (this.field_eb == null) {
                        ...
                        if (this.field_eb[param0] == -1) {
                          ...
                          var8 = this.field_eb[param0] & 255;
                          var5 = this.field_N[var8];
                          var6 = this.field_D[var8];
                          var7 = this.field_E[var8];
                          break L3;
                        }
                      }
                    }
                  ...
                  if (this.field_bb[param0] != -1) {
                    oo.a(field_cb[var2], field_cb[var3], field_cb[var4], field_v[var2], field_v[var3], field_v[var4], this.field_i[param0], this.field_X[param0], this.field_bb[param0], field_S[var5], field_S[var6], field_S[var7], field_fb[var5], field_fb[var6], field_fb[var7], field_q[var5], field_q[var6], field_q[var7], (int) this.field_F[param0]);
                    break L1;
                  } else {
                    oo.a(field_cb[var2], field_cb[var3], field_cb[var4], field_v[var2], field_v[var3], field_v[var4], this.field_i[param0], this.field_i[param0], this.field_i[param0], field_S[var5], field_S[var6], field_S[var7], field_fb[var5], field_fb[var6], field_fb[var7], field_q[var5], field_q[var6], field_q[var7], (int) this.field_F[param0]);
                    break L1;
                  }
                } else {
                  break L2;
            ...
            if (this.field_bb[param0] != -1) {
              oo.a(field_cb[var2], field_cb[var3], field_cb[var4], field_v[var2], field_v[var3], field_v[var4], this.field_i[param0] & 65535, this.field_X[param0] & 65535, this.field_bb[param0] & 65535);
              break L1;
            } else {
              oo.a(field_cb[var2], field_cb[var3], field_cb[var4], field_v[var2], field_v[var3], field_v[var4], oo.field_c[this.field_i[param0] & 65535]);
              break L1;
            }
          }
          return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, long param7) {
        ...
        try {
            ...
            for (var21 = 0; var21 < this.field_T; var21++) {
                var22 = this.field_k[var21];
                var23 = this.field_C[var21];
                var24 = this.field_A[var21];
                if (param2 != 0) {
            ...
            this.a(false, param7 >= 0L ? true : false, param7, (int) this.field_db, this.field_db << 1);
        ...
        if (param4 < 1600) {
          ...
          L3: while (true) {
            if (var8 >= this.field_w) {
              ...
              if (this.field_bb[var8] != -2) {
                L40: {
                  var9 = this.field_o[var8];
                  var10 = this.field_a[var8];
                  var11 = this.field_u[var8];
                  var12 = field_v[var9];
                  var13 = field_v[var10];
                ...
                L43: {
                  if (!param1) {
                    ...
                    if (!this.a(bj.field_h + oo.field_l, fb.field_E + oo.field_e, field_cb[var9], field_cb[var10], field_cb[var11], var12, var13, var14_int)) {
                      ...
                      fieldTemp$13 = ec.field_C;
                      ec.field_C = ec.field_C + 1;
                      un.field_Mb[fieldTemp$13] = param2;
                      param1 = false;
                      break L43;
                    }
                  }
                      ...
                      if (this.field_g == null) {
                        ...
                        L1: while (true) {
                          if (var8 >= var7) {
                            ...
                            var9 = param1[var8];
                            if (var9 < this.field_g.length) {
                              var40 = this.field_g[var9];
                              var11 = 0;
                              L2: while (true) {
                                if (var11 >= var40.length) {
                                  ...
                                  L3: {
                                    var12 = var40[var11];
                                    var13 = this.field_d[var12] & 65535;
                                    var14 = var13 >> 10 & 63;
                                    var15 = var13 >> 7 & 7;
                                    var16 = var13 & 127;
                                  ...
                                  this.field_d[var12] = (short)(var14 << 10 | var15 << 7 | var16);
                                  var11++;
                                  continue L2;
                                }
                              }
                        ...
                        if (this.field_R == null) {
                          ...
                          L6: while (true) {
                            if (var8 >= var7) {
                              ...
                              var9 = param1[var8];
                              if (var9 < this.field_g.length) {
                                var39 = this.field_g[var9];
                                var11 = 0;
                                L7: while (true) {
                                  if (var11 < var39.length) {
                                    L8: {
                                      var12 = var39[var11];
                                      var13 = (this.field_R[var12] & 255) + param2 * 8;
                                      if (var13 >= 0) {
                                        if (var13 <= 255) {
                                          break L8;
                                        } else {
                    ...
                    if (var9 < this.field_b.length) {
                      ...
                      L10: while (true) {
                        if (var11 < var38.length) {
                          var12 = var38[var11];
                          this.field_k[var12] = this.field_k[var12] - field_kb;
                          this.field_C[var12] = this.field_C[var12] - field_ib;
                          this.field_A[var12] = this.field_A[var12] - field_x;
                          this.field_k[var12] = this.field_k[var12] * param2 / 128;
                          this.field_C[var12] = this.field_C[var12] * param3 / 128;
                          this.field_A[var12] = this.field_A[var12] * param4 / 128;
                          this.field_k[var12] = this.field_k[var12] + field_kb;
                          this.field_C[var12] = this.field_C[var12] + field_ib;
                          this.field_A[var12] = this.field_A[var12] + field_x;
                          var11++;
                      ...
                      if (var11 < var37.length) {
                        L13: {
                          ...
                          if (param4 == 0) {
                            ...
                            var15 = this.field_C[var12] * var13 + this.field_k[var12] * var14 + 32767 >> 16;
                            this.field_C[var12] = this.field_C[var12] * var14 - this.field_k[var12] * var13 + 32767 >> 16;
                            this.field_k[var12] = var15;
                            break L13;
                          }
                        }
                        L14: {
                          if (param2 == 0) {
                            ...
                            var15 = this.field_C[var12] * var14 - this.field_A[var12] * var13 + 32767 >> 16;
                            this.field_A[var12] = this.field_C[var12] * var13 + this.field_A[var12] * var14 + 32767 >> 16;
                            this.field_C[var12] = var15;
                            break L14;
                          }
                        }
                        L15: {
                          if (param3 == 0) {
                            ...
                            var15 = this.field_A[var12] * var13 + this.field_k[var12] * var14 + 32767 >> 16;
                            this.field_A[var12] = this.field_A[var12] * var14 - this.field_k[var12] * var13 + 32767 >> 16;
                            this.field_k[var12] = var15;
                            break L15;
                          }
                        }
                ...
                if (var9 < this.field_b.length) {
                  ...
                  L17: while (true) {
                    if (var11 < var36.length) {
                      var12 = var36[var11];
                      this.field_k[var12] = this.field_k[var12] + param2;
                      this.field_C[var12] = this.field_C[var12] + param3;
                      this.field_A[var12] = this.field_A[var12] + param4;
                      var11++;
                      continue L17;
                    } else {
                      var8++;
              ...
              if (var10 < this.field_b.length) {
                ...
                L20: while (true) {
                  if (var12 < var35.length) {
                    var13 = var35[var12];
                    field_kb = field_kb + this.field_k[var13];
                    field_ib = field_ib + this.field_C[var13];
                    field_x = field_x + this.field_A[var13];
                    var8++;
                    var12++;
                    continue L20;
                  } else {
          ...
          if (var2 >= param0.field_w) {
              ...
              if (this.field_N == null) {
                ...
                L2: while (true) {
                  if (var2 >= param0.field_L) {
                    ...
                    this.field_N[this.field_L] = param0.field_N[var2] + this.field_T;
                    this.field_D[this.field_L] = param0.field_D[var2] + this.field_T;
                    this.field_E[this.field_L] = param0.field_E[var2] + this.field_T;
            ...
            L3: while (true) {
              if (var2 >= param0.field_T) {
                ...
                this.field_k[this.field_T] = param0.field_k[var2];
                this.field_C[this.field_T] = param0.field_C[var2];
                this.field_A[this.field_T] = param0.field_A[var2];
            ...
            L4: {
              this.field_o[this.field_w] = param0.field_o[var2] + this.field_T;
              this.field_a[this.field_w] = param0.field_a[var2] + this.field_T;
              this.field_u[this.field_w] = param0.field_u[var2] + this.field_T;
              this.field_i[this.field_w] = param0.field_i[var2];
    ...
    private final void e() {
        ...
        L0: while (true) {
          if (var9 >= this.field_W) {
            this.field_lb = (short)(int)(Math.sqrt((double)var7) + 0.99);
            this.field_db = (short)(int)(Math.sqrt((double)var8) + 0.99);
            this.field_K = true;
            return;
          } else {
            L1: {
    ...
    fc(lg param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        L0: {
          ...
          this.field_W = param0.field_O;
          this.field_k = param0.field_p;
          this.field_C = param0.field_D;
          this.field_A = param0.field_i;
          this.field_w = param0.field_z;
          this.field_o = param0.field_e;
          this.field_a = param0.field_H;
          this.field_u = param0.field_r;
          this.field_H = param0.field_k;
          this.field_R = param0.field_o;
          this.field_M = param0.field_A;
          this.field_d = param0.field_c;
          this.field_b = param0.field_n;
          this.field_g = param0.field_w;
          this.field_t = param0.field_K;
          this.field_Y = param0.field_f;
          var7 = (int)Math.sqrt((double)(param3 * param3 + param4 * param4 + param5 * param5));
          var8 = param2 * var7 >> 8;
          this.field_i = new int[this.field_w];
          this.field_X = new int[this.field_w];
          this.field_bb = new int[this.field_w];
          if (param0.field_N == null) {
            this.field_F = null;
            break L0;
          } else {
            this.field_F = new short[this.field_w];
            var9 = 0;
            L1: while (true) {
              if (var9 >= this.field_w) {
                break L0;
                ...
                L2: {
                  ...
                  if (var10 == -1) {
                    ...
                    if (!oo.field_o.d(-127, var10)) {
                      ...
                      this.field_F[var9] = (short)var10;
                      var9++;
                      continue L1;
                    }
                  }
                }
                this.field_F[var9] = (short)-1;
                var9++;
                continue L1;
              }
            }
                ...
                if (var10 >= this.field_w) {
                  ...
                  L5: while (true) {
                    if (var10 >= param0.field_L) {
                      ...
                      this.field_E = new int[this.field_L];
                      var10 = 0;
                      var11 = 0;
                      L6: while (true) {
                        if (var11 >= param0.field_L) {
                          this.field_eb = new byte[this.field_w];
                          var11 = 0;
                          L7: while (true) {
                            if (var11 >= this.field_w) {
                              ...
                              if (param0.field_x[var11] == -1) {
                                this.field_eb[var11] = (byte)-1;
                                var11++;
                                continue L7;
                              } else {
                                this.field_eb[var11] = (byte)var9_ref_int__[param0.field_x[var11] & 255];
                                if (this.field_eb[var11] == -1) {
                                  if (this.field_F != null) {
                                    this.field_F[var11] = (short)-1;
                                    var11++;
                                    continue L7;
                                  } else {
                                    var11++;
                          ...
                          L8: {
                            if (var20[var11] <= 0) {
                              ...
                              if (param0.field_E[var11] != 0) {
                                ...
                                this.field_N[var10] = param0.field_M[var11] & 65535;
                                this.field_D[var10] = param0.field_P[var11] & 65535;
                                this.field_E[var10] = param0.field_F[var11] & 65535;
                  ...
                  if (param0.field_x[var10] != -1) {
                    dupTemp$1 = param0.field_x[var10] & 255;
            ...
            if (var12 != -1) {
                ...
                L15: {
                  L16: {
                    if (param0.field_Q == null) {
                      ...
                      if (param0.field_Q[this.field_o[var16]] == null) {
                        break L16;
                      } else {
                        var13 = param0.field_Q[this.field_o[var16]];
                        break L15;
                      }
                    }
                  }
                  var13 = param0.field_B[this.field_o[var16]];
                  break L15;
                }
                L17: {
                  L18: {
                    ...
                    if (param0.field_Q == null) {
                      ...
                      if (param0.field_Q[this.field_a[var16]] == null) {
                        break L18;
                      } else {
                        var13 = param0.field_Q[this.field_a[var16]];
                        break L17;
                      }
                    }
                  }
                  var13 = param0.field_B[this.field_a[var16]];
                  break L17;
                }
                L19: {
                  L20: {
                    var14 = param1 + (param3 * var13.field_b + param4 * var13.field_h + param5 * var13.field_f) / (var8 * var13.field_g);
                    this.field_X[var16] = fc.b(var14);
                    if (param0.field_Q == null) {
                      break L20;
                    } else {
                      if (param0.field_Q[this.field_u[var16]] == null) {
                        break L20;
                      } else {
                        var13 = param0.field_Q[this.field_u[var16]];
                        break L19;
                      }
                    }
                  }
                  var13 = param0.field_B[this.field_u[var16]];
                  break L19;
                }
                var14 = param1 + (param3 * var13.field_b + param4 * var13.field_h + param5 * var13.field_f) / (var8 * var13.field_g);
                this.field_bb[var16] = fc.b(var14);
                var16++;
                continue L9;
              }
            } else {
              if (var10 != 0) {
                if (var10 != 1) {
                  ...
                  this.field_i[var16] = var14 | fc.a(param0.field_c[var16] & 65535, var14 >> 17);
                  this.field_bb[var16] = -1;
                  var16++;
                  continue L9;
                }
                ...
                L23: {
                  L24: {
                    ...
                    this.field_i[var16] = var14 | fc.a(var15, var14 >> 17);
                    if (param0.field_Q == null) {
                      break L24;
                    } else {
                      if (param0.field_Q[this.field_a[var16]] == null) {
                ...
                L25: {
                  L26: {
                    var14 = param1 + (param3 * var13.field_b + param4 * var13.field_h + param5 * var13.field_f) / (var8 * var13.field_g) << 17;
                    this.field_X[var16] = var14 | fc.a(var15, var14 >> 17);
                    if (param0.field_Q == null) {
                      break L26;
                    } else {
                      if (param0.field_Q[this.field_u[var16]] == null) {
                ...
                var14 = param1 + (param3 * var13.field_b + param4 * var13.field_h + param5 * var13.field_f) / (var8 * var13.field_g) << 17;
                this.field_bb[var16] = var14 | fc.a(var15, var14 >> 17);
                var16++;
                continue L9;
              }
            }
    ...
    fc(int param0, int param1, int param2, boolean param3, boolean param4, boolean param5, boolean param6, int param7, int param8) {
        ...
        this.field_a = new int[param1];
        this.field_u = new int[param1];
        this.field_i = new int[param1];
        this.field_X = new int[param1];
        this.field_bb = new int[param1];
        if (param3) {
        ...
        if (param5) {
            this.field_F = new short[param1];
        }
        if (param6) {
            this.field_eb = new byte[param1];
        }
        if (param2 > 0) {
            this.field_N = new int[param2];
            this.field_D = new int[param2];
            this.field_E = new int[param2];
        }
        this.field_d = new short[param1];
    }
