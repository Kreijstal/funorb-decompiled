    ...
    final static er[] a(int[] param0, boolean param1, er[] param2) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_20_1 = new StringBuilder().append("dk.F(");
    ...
    final String b(int param0, String param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_7_1 = new StringBuilder().append("dk.C(").append(param0).append(44);
    ...
    final ba a(int param0, String param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("dk.A(").append(param0).append(44);
