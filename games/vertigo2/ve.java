    ...
    final static ji a(byte param0, ed param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ve.C(").append(param0).append(',');
    ...
    final static void a(byte param0, uh param1, String param2, boolean param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_13_1 = new StringBuilder().append("ve.A(").append(param0).append(',');
