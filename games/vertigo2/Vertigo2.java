...
public final class Vertigo2 extends kd {
    ...
    private final void p(int param0) {
        ...
        for (var2 = 0; var2 < ap.field_d.field_k.length; var2++) {
            ap.field_d.field_k[var2] = Vertigo2.a(new String[1], dg.field_b, 103);
        }
    ...
    final void f(int param0) {
        ...
        L2: {
          ((Vertigo2) this).c(stackIn_6_1 != 0, -6);
          if (!hh.field_c) {
            break L2;
          } else {
            this.l((byte) 123);
            ...
            if (!fb.i(11)) {
              ...
              if (!kg.h(114)) {
                if (!pq.b(0)) {
                  ...
                  L7: {
                    var3 = ((Vertigo2) this).b(stackIn_32_1 != 0, 125);
                    if (-2 == (var3 ^ -1)) {
                      break L7;
                    } else {
                      if (var3 == -3) {
                        ...
                        if (!sp.field_V) {
                          ...
                          L26: while (true) {
                            if (hi.field_i.length <= var4) {
                              ...
                              if ((1 << var4 & var3) != 0) {
                                bg.field_b.a((li) (Object) new fa(var4), false);
                                var4++;
                                continue L26;
                              } else {
                                var4++;
                          ...
                          if (58 != lc.field_f) {
                            if (lc.field_f != 59) {
                              ...
                              L29: {
                                if (var3_ref != null) {
                                  if ((lc.field_f ^ -1) == -71) {
                                    var4_ref = new pp(var3_ref.field_D.field_z);
                                    var4_ref.a((byte) -8, var3_ref.field_B, id.field_f);
                                    var3_ref.a(10, var4_ref);
                                    continue L13;
                                  } else {
                                    if (lc.field_f != 62) {
                                      if (lc.field_f != 63) {
                                        if (-65 != (lc.field_f ^ -1)) {
                                          if (lc.field_f != 65) {
                                            if (-67 != (lc.field_f ^ -1)) {
                                              ...
                                              var3_ref.field_h = id.field_f.h(-11);
                                              if (null == ln.field_d) {
                                                continue L13;
                                              } else {
                                                mq.b(true);
                                            ...
                                            var3_ref.field_D.field_t = id.field_f.h(-11);
                                            if (ln.field_d != null) {
                                              mq.b(true);
                                              continue L13;
                                            } else {
                                          ...
                                          var3_ref.field_D.field_u = id.field_f.h(-11);
                                          continue L13;
                                        }
                                      } else {
                                        var3_ref.field_D.field_d = id.field_f.h(-11);
                                        if (ln.field_d == null) {
                                          continue L13;
                                        } else {
                                          jc.b(10);
                                      ...
                                      var3_ref.field_D.a((byte) 2, var4);
                                      var3_ref.field_D.field_g = var6;
                                      var3_ref.field_D.field_f = var5;
                                      var7 = var3_ref;
                                      if (2 != var7.field_D.field_j) {
    ...
    private final void n(byte param0) {
        ...
        qr.field_l = new rp(true, new er[6]);
    ...
    private final void q(int param0) {
        ...
        for (var2 = 0; var2 < up.field_B.length; var2++) {
            boolean discarded$3 = qc.field_v.a(0, jk.field_b, up.field_B[var2], re.field_d, (byte) 56);
        }
        mj.field_b = null;
        gp.field_s = null;
        ((Vertigo2) this).d(-17);
    ...
    private final void o(byte param0) {
        ...
        for (var2 = 0; var2 < qi.field_d.field_k.length; var2++) {
            qi.field_d.field_k[var2] = Vertigo2.a(new String[1], bl.field_o, -121);
        }
        qi.field_d.field_u = false;
    }

    final void b(int param0) {
        ((Vertigo2) this).a(4, 0, 19, 1, false, -16, 2, 64);
        db var3 = new db();
        var3.a(9, true, 128);
        ...
        ma.field_m = 16777215;
        vm.field_b = param0;
        ((Vertigo2) this).a(true, false, true, true, false, false, true);
        ok.field_d[9] = -1;
        ok.field_d[65] = 1;
        ok.field_d[64] = 1;
        ok.field_d[63] = 1;
    ...
    private final void j(byte param0) {
        ...
        L0: {
          ...
          tk.field_c.a((fq[]) (Object) var2, (int[]) null);
        ...
        va.field_s = new wn((cc) (Object) w.a(vi.field_n, rn.field_u, "interface_font", "", param0 + 96));
    ...
    private final void a(int param0, String param1, int param2, int param3) {
        int var5 = 0;
        int var6 = field_L ? 1 : 0;
        on.field_b[param3] = new ae[param0 + param2];
        on.field_b[param3][0] = hp.a(gp.field_s, "", param1).a();
        for (var5 = 1; param2 >= var5; var5++) {
            on.field_b[param3][var5] = hp.a(gp.field_s, "", param1 + var5).a();
        }
    }
        ...
        if (null == gp.field_s) {
          L0: {
            ...
            if (null != rn.field_u) {
              ...
              ((Vertigo2) this).d(-17);
              oo.a((ef) (Object) new nr(hi.field_o, ii.field_C, rn.field_u, 13, false));
              ii.field_C = null;
              this.j((byte) 31);
              break L0;
            } else {
          ...
          L1: {
            if (null == pp.field_s) {
              ...
              ((Vertigo2) this).d(param0 ^ -16777200);
              this.k((byte) 109);
              break L1;
            }
          }
          ...
          L3: {
            if (null == tl.field_c) {
              ...
              ((Vertigo2) this).d(param0 + -16777232);
          ...
          if (t.field_f != t.field_a) {
                    ...
                    L8: while (true) {
                      if (!gf.a(false)) {
                        ...
                        L9: {
                          if (eo.field_o) {
                            if (!am.field_b) {
                              boolean discarded$2 = gh.a(12, 12, 13, 15);
                              break L9;
                            } else {
            ...
            if (bg.field_b.a((byte) 100) == null) {
              ...
              if (335 != oa.field_l + 1) {
                ...
                oa.field_l = 0;
                li discarded$3 = bg.field_b.b((byte) -43);
                break L0;
              }
            }
          }
        ...
        L0: while (true) {
          ...
          if (-1 >= (var6_int ^ -1)) {
            ...
            L1: while (true) {
              ...
              if (!qb.a((CharSequence) (Object) var7_ref, -124)) {
                continue L0;
              } else {
                if (var5 >= var3) {
                  continue L0;
                  ...
                  if (param1.charAt(var5) == 62) {
                    var5++;
                    var8 = cf.a(109, (CharSequence) (Object) var7_ref);
                  ...
                  if (qb.a((CharSequence) (Object) var10, 112)) {
                    if (var3 <= var5) {
                      ...
                      if (param1.charAt(var5) == 62) {
                        ...
                        StringBuilder discarded$3 = var6.append(param1.substring(var7, var9));
                        var7 = var5;
                        StringBuilder discarded$4 = var6.append(args[var11]);
                        continue L3;
                      } else {
                        continue L3;
                      }
