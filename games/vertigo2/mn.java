          ...
          if (var2 >= bm.field_G.length) {
            ...
            L1: while (true) {
              if (var2 >= Vertigo2.field_J.length) {
                ...
                var4 = 0;
                var5 = 512;
                var1 = var1 + 0.07000000029802322f;
                var6 = var4 * 128;
                var7 = var4;
                L3: while (true) {
                  if (var7 >= var5) {
                    ...
                    var8 = (double)(var7 >> 983210691) / 64.0 + 0.0078125;
                    ...
                    L4: while (true) {
                      if ((var12 ^ -1) <= -129) {
                        ...
                        L11: {
                          var15 = Math.pow(var15, (double)var1);
                          var17 = Math.pow(var17, (double)var1);
                          var19 = Math.pow(var19, (double)var1);
                          var21 = (int)(256.0 * var15);
                          var22 = (int)(256.0 * var17);
                          var23 = (int)(var19 * 256.0);
                          var24 = (var22 << 106252808) + ((var21 << 445991056) - -var23);
                          if (0 != var24) {
                            break L11;
                          } else {
                            var24 = 1;
            ...
            var5 = 512;
            var6 = var4 * 128;
            var1 = var1 - 0.10000000149011612f;
            var7 = var4;
            L12: while (true) {
              if (var7 >= var5) {
                var2++;
                ...
                var8 = (double)(var7 >> -1724663261) / 64.0 + 0.0078125;
                ...
                L13: while (true) {
                  if (-129 >= (var12 ^ -1)) {
                    ...
                    L20: {
                      ...
                      var24 = var23 + (var21 << 1241838128) - -(var22 << -1097999416);
                      if (0 == var24) {
                        var24 = 1;
                        break L20;
                      } else {
