...
abstract class rl extends sp {
    ...
    final static ge a(r param0, int param1, r param2, String param3, String param4) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = vg.a(var5_int, var6, -1, param0, param2);
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("rl.G(");
          ...
          L2: {
            ...
            stackOut_7_1 = ((StringBuilder) (Object) stackIn_7_1).append(stackIn_7_2).append(',').append(12).append(',');
    ...
    boolean a(char param0, int param1, int param2, iq param3) {
        ...
        try {
          L0: {
            if (super.a(param0, 13, param2, param3)) {
              stackOut_2_0 = 1;
              stackIn_3_0 = stackOut_2_0;
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("rl.M(").append(param0).append(',').append(13).append(',').append(param2).append(',');
    ...
    void a(boolean param0, iq param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("rl.B(").append(param0).append(',');
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
            stackIn_8_0 = stackOut_7_0;
            stackIn_8_1 = stackOut_7_1;
