    ...
    final static void a(int param0, int param1, int param2, boolean param3, si param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("pd.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
        ...
        try {
            ...
            try {
              ...
              L4: {
                ...
                stackOut_9_1 = new StringBuilder().append("pd.A(");
