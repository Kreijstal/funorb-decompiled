    ...
    final String a(byte param0, iq param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("om.BA(").append(param0).append(',');
    ...
    final static int a(int param0, int param1, byte[] param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("om.GA(").append(param0).append(',').append(param1).append(',');
          ...
          throw wn.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + ',' + 255 + ')');
        }
        return stackIn_5_0;
    }
