...
final class ej {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_b[var16]) {
                  var9 = field_k[var16];
                  var10 = field_i[var16] * this.field_d;
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_c, 0, field_k, 0, var2);
        ...
        for (var6 = 0; var6 < this.field_f.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = bl.field_K[this.field_e[var7]].b();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_l[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_c[incrementValue$0] = bl.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_l[this.field_f[var6]];
                      var6++;
                      continue L2;
                    }
                  }
