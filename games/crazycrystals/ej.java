...
final class ej {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((ej) this).field_c.length;
        var4 = field_g[((ej) this).field_d - 1];
        var5 = field_b;
        field_b[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_i[0] * ((ej) this).field_d;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_b[var16]) {
                  var9 = field_k[var16];
                  var10 = field_i[var16] * ((ej) this).field_d;
            ...
            L3: {
              var7 = ej.b(field_k, var6);
              var8_int = ej.a(field_k, var6);
              var9 = this.a(field_k[var7], field_i[var7], field_k[var8_int], field_i[var8_int], field_k[var6]);
              var10 = field_i[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean a() {
        ...
        int var2 = ((ej) this).field_c.length;
        System.arraycopy((Object) (Object) ((ej) this).field_c, 0, (Object) (Object) field_k, 0, var2);
        int var3 = field_g[((ej) this).field_d - 1];
        int var4 = eq.c(var3 - 1, (byte) 100);
        field_i[0] = bl.a(var4);
        field_i[1] = bl.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((ej) this).field_f.length; var6++) {
            var7 = ((ej) this).field_f[var6];
            var8 = ((ej) this).field_l[var7];
            var9 = ((ej) this).field_j[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = bl.field_K[((ej) this).field_e[var7]].b();
            }
    ...
    ej() {
        ...
        if (var1 == 1) {
          var2 = bl.a(5);
          var3 = 0;
          ((ej) this).field_f = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((ej) this).field_l = new int[var3];
              ((ej) this).field_j = new int[var3];
              ((ej) this).field_e = new int[var3];
              ((ej) this).field_a = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((ej) this).field_d = bl.a(2) + 1;
                  var4 = bl.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((ej) this).field_c = new int[var5];
                      ((ej) this).field_c[0] = 0;
                      ((ej) this).field_c[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((ej) this).field_l[((ej) this).field_f[var6]];
                      var6++;
                      continue L2;
                    }
                  }
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_h[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_h[var11];
        }
    }
