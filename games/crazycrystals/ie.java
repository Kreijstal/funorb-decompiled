...
final class ie {
    ...
    final void a(float[] param0, int param1, boolean param2) {
        ...
        L0: while (true) {
          if (var4 >= param1) {
            if (!param2) {
              var4 = bl.field_K[this.field_a].field_b;
                    ...
                    if (var9 >= var6) {
                      ...
                      L3: {
                        if (var8 != 0) {
                          ...
                          var10 = bl.field_K[this.field_a].b();
                          var11 = var4 - 1;
                          L4: while (true) {
                            if (var11 < 0) {
                              break L3;
                        ...
                        if (var10 >= var4) {
                          ...
                          L7: {
                            ...
                            if (var12 < 0) {
                              ...
                              var13 = this.field_e + var9 * this.field_g;
    ...
    ie() {
        ...
        int var5 = 0;
        int var2 = 0;
        this.field_f = bl.a(16);
        this.field_e = bl.a(24);
        this.field_c = bl.a(24);
        this.field_g = bl.a(24) + 1;
        this.field_b = bl.a(6) + 1;
        this.field_a = bl.a(8);
        ...
        while (var6 < this.field_b * 8) {
            this.field_d[var6] = (var1[var6 >> 3] & 1 << (var6 & 7)) != 0 ? bl.a(8) : -1;
            var6++;
        }
    }
}
