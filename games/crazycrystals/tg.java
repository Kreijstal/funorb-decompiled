...
final class tg {
    ...
    final static void a(float param0, String param1, byte param2, boolean param3) {
        try {
            ...
            throw dn.a((Throwable) (Object) runtimeException, "tg.A(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + -41 + ',' + param3 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, jg param6, int param7) {
        ...
        try {
                ...
                L4: while (true) {
                  if (var44 >= pi.field_o) {
                    ...
                    L10: {
                      ...
                      var36 = var34 & 65280;
                      var37 = var36 * var28 >>> 8 & 1325465344 | (var35 * var28 & -16711693) >>> 8;
                      var38 = (var29 * var36 & 16711862) >>> 8 | -1224802049 & var29 * var35 >>> 8;
          ...
          L17: {
            ...
            stackOut_53_1 = new StringBuilder().append("tg.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(-9206).append(',').append(param4).append(',').append(param5).append(',');
