...
final class tg {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, jg param6, int param7) {
        ...
        try {
                  ...
                  if (var44 >= pi.field_o) {
                    ...
                    L6: {
                      ...
                      if (param6.field_A[var14] < cf.field_b.length) {
                        stackIn_26_0 = param6.field_A[var14];
                        break L6;
                      } else {
                        stackIn_26_0 = -1;
                        break L6;
                    ...
                    L7: {
                      ...
                      if (cf.field_b.length <= param6.field_v[var14]) {
                        ...
                        stackIn_29_0 = param6.field_v[var14];
                        break L7;
                      }
                    }
                    L8: {
                      ...
                      if (param6.field_R[var14] < cf.field_b.length) {
                        stackIn_32_0 = param6.field_R[var14];
                        break L8;
                      } else {
                        stackIn_32_0 = -1;
                        break L8;
                            ...
                            if (var14 >= param6.field_B.length) {
                              ...
                              if (-1 == param6.field_B[var14]) {
                                ...
                                if (param6.field_B[var14] < ud.field_S.length) {
                                  stackIn_40_0 = ud.field_S[param6.field_B[var14]];
                                  break L9;
                                } else {
                                  break L10;
                                }
          ...
          L18: {
            ...
            stackIn_55_1 = new StringBuilder().append("tg.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
    ...
    final static void a(ng param0, ng param1, java.math.BigInteger param2, int param3, java.math.BigInteger param4) {
        try {
            ...
            throw dn.a((Throwable) ((Object) runtimeException), "tg.C(" + (param0 != null ? "{...}" : "null") + ',' + (param1 != null ? "{...}" : "null") + ',' + (param2 != null ? "{...}" : "null") + ',' + param3 + ',' + (param4 != null ? "{...}" : "null") + ')');
        }
    }
