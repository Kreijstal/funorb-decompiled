...
final class vm {
    ...
    final static int a(byte param0, boolean param1, String param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("vm.D(").append(param0).append(44).append(param1).append(44);
    ...
    private final void a(lm param0, int param1, int param2) {
        ...
        try {
          L0: {
            L1: {
              var4_float = (float)(param1 + ((vm) this).field_i) + (float)param2 / 100.0f;
              ((vm) this).field_b = (float)((vm) this).field_a * var4_float / (float)(1 + ((vm) this).field_c);
              if (param2 == 0) {
