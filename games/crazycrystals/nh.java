...
final class nh extends og implements vd {
    ...
    public final void a(byte param0, int param1, int param2, int param3, pc param4) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("nh.BA(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
        ...
        try {
          L0: {
            if (!super.a(param0, param1, param2, param3)) {
              if (param0 != 98) {
                if (param0 == 99) {
                  stackOut_8_0 = ((nh) this).a(param2, -25911);
                ...
                stackOut_4_0 = ((nh) this).a((byte) -73, param2);
          ...
          L1: {
            ...
            stackOut_10_1 = new StringBuilder().append("nh.AA(").append(param0).append(44).append(param1).append(44);
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
    ...
    final static Class a(byte param0, String param1) throws ClassNotFoundException {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_29_1 = new StringBuilder().append("nh.E(").append(param0).append(44);
    ...
    final static void a(int param0, byte param1, ca param2) {
        ...
        try {
            ...
            throw dn.a((Throwable) (Object) runtimeException, "nh.A(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    nh(fd param0) {
        ...
        try {
            ...
            throw dn.a((Throwable) (Object) runtimeException, "nh.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
            ...
            L1: {
              ...
              if (param0 == null) {
                ...
                if (param0.length == 0) {
                  ...
                  ((nh) this).field_B = new String[var3_int];
                  var4_int = 0;
                  L2: while (true) {
                    if (var4_int >= var3_int) {
                      var4 = new ok(ai.field_h, 0, 1);
                      ((nh) this).field_D = new pc[var3_int - -1];
                      var5 = param1;
                      L3: while (true) {
                        if (var3_int <= var5) {
                          ((nh) this).field_D[var3_int] = new pc(qo.field_p, (bi) this);
                          ((nh) this).field_D[var3_int].field_i = (wo) (Object) var4;
                          ((nh) this).field_D[var3_int].a(15, 0, 20 - -((1 + var3_int) * 16), 100, (byte) -52);
                          ((nh) this).b((qm) (Object) ((nh) this).field_D[var3_int], param1 + -118);
                          break L0;
                        } else {
