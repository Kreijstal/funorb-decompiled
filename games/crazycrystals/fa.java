    ...
    final static void a(vc param0, vc param1, boolean param2, boolean param3, int param4, int param5, int param6, int param7, int param8, int param9, dl[] param10, dl[] param11, int param12, int param13, int param14, int param15, int param16) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = ((StringBuilder) (Object) stackIn_9_1).append(stackIn_9_2).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',').append(param8).append(',').append(param9).append(',');
          ...
          throw dn.a((Throwable) ((Object) stackIn_15_0), stackIn_15_2 + ',' + param12 + ',' + param13 + ',' + param14 + ',' + param15 + ',' + param16 + ')');
        }
    }
    ...
    final static String a(byte param0, byte[] param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = gd.a((byte) 102, param1, 0, param1.length);
