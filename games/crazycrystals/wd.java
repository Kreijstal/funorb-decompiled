...
final class wd extends ik {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        lo.field_b = new hp(param6, param1, fn.field_j, mb.field_g, field_j, ob.field_l, new int[1]);
        if (param0 > -74) {
            field_h = null;
        }
        if (!rc.a(-53)) {
    ...
    wd(int param0, int param1, int param2, int param3, boolean param4) {
        ...
        ((wd) this).field_c = param3;
        ((wd) this).field_d = param1;
        ((wd) this).field_i = param4 ? true : false;
        ((wd) this).field_b = param2;
    }
    ...
    final void a(boolean param0, int param1, int param2) {
        ...
        this.a(0, 1 + ((wd) this).field_d, 2, ((wd) this).field_a);
