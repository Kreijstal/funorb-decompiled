...
final class hg extends bc {
    ...
    final void a(int param0, int param1, java.awt.Component param2, int param3) {
        ...
        java.awt.image.DataBufferInt var6 = new java.awt.image.DataBufferInt(this.field_c, this.field_c.length);
        java.awt.image.DirectColorModel var7 = new java.awt.image.DirectColorModel(32, 16711680, 65280, 255);
        java.awt.image.WritableRaster var8 = java.awt.image.Raster.createWritableRaster(((java.awt.image.ColorModel) ((Object) var7)).createCompatibleSampleModel(this.field_d, this.field_e), (java.awt.image.DataBuffer) ((Object) var6), (java.awt.Point) null);
