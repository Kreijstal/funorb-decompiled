    ...
    final static int a(int param0, byte[] param1, int param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("gi.K(").append(param0).append(',');
    ...
    final nj a(int param0, nj param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ng.a(e.field_a, param1, new gi(this.field_p, new kp(-1)), (byte) -83, qd.field_p);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("gi.V(").append(param0).append(',');
    ...
    final boolean a(byte param0, f[][] param1, int param2, int param3, int param4, fq param5, int param6) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("gi.G(").append(param0).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    final void a(int param0, int param1, int param2, f[][] param3, int param4, int param5, int param6, int param7) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("gi.HA(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final void c(int param0, int param1, f[][] param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param1 == 0) {
                ...
                var6 = (byte[]) null;
                discarded$3 = gi.a(103, (byte[]) null, -64);
                break L1;
              }
            }
            L2: {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("gi.W(").append(param0).append(',').append(param1).append(',');
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
    ...
    final f a(int param0, ea param1, int param2, int param3, byte param4, int param5, f[][] param6) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (-1 + param6.length <= var10) {
                ...
                L4: {
                  if (ab.field_D == null) {
                    L5: {
                      ...
                      fieldTemp$1 = q.field_a[var15.field_u].field_m;
                ...
                stackOut_19_0 = this.field_l.a(param0, param1, param2, param3, (byte) -93, param5, param6);
          ...
          L7: {
            ...
            stackOut_21_1 = new StringBuilder().append("gi.Q(").append(param0).append(',');
          ...
          L8: {
            ...
            stackOut_24_1 = ((StringBuilder) (Object) stackIn_24_1).append(stackIn_24_2).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
