...
final class ei extends om {
    ...
    ei(int param0, int param1, int param2, int param3, qm param4, boolean param5, int param6, int param7, vc param8, int param9, String param10) {
        ...
        ((ei) this).field_y = param5 ? true : false;
        ((ei) this).field_H = param9;
        ((ei) this).field_B = param8;
        ((ei) this).field_C = param7;
        ((ei) this).field_z = param6;
        int var12 = -((ei) this).field_C + ((ei) this).field_z;
        int var13 = ((ei) this).field_B.b(param10, var12, ((ei) this).field_B.field_o) - -(((ei) this).field_C * 2);
        if (var13 > param3) {
            ((ei) this).a(var13, param0, param1, param2, (byte) -52);
        } else {
            var13 = param3;
        }
        int var14 = ((ei) this).field_y ? 0 : ((ei) this).field_C * 2 + ((ei) this).field_z;
        ((ei) this).field_w.a(-(((ei) this).field_C * 2) + param3, var14, (var13 + -param3 >> -1495820223) + ((ei) this).field_C, -((ei) this).field_z + param2 + -(3 * ((ei) this).field_C), (byte) -52);
    }
