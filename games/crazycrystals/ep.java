    ...
    final void b(int param0, int param1, f[][] param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("ep.CC(").append(param0).append(',').append(param1).append(',');
    ...
    final static wj[] a(db param0, String param1, String param2, boolean param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (!param3) {
                ...
                discarded$2 = ep.c((byte) -89);
                break L1;
              }
            }
            var5 = param0.a(-2862, param1, var4_int);
            stackOut_2_0 = qk.a(false, var4_int, param0, var5);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ep.I(");
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
    ...
    final void a(int param0, int param1, int param2, DataInputStream param3, byte param4) throws IOException {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_3_1 = new StringBuilder().append("ep.BC(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
            stackIn_4_0 = stackOut_3_0;
            stackIn_4_1 = stackOut_3_1;
    ...
    final int a(int param0, int param1, int param2, fq param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("ep.AC(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
    ...
    final nj a(int param0, nj param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ng.a(qh.field_g, param1, new ep(new kp(-1), this.field_k), (byte) -83, rb.field_j);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ep.V(").append(param0).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    final f a(int param0, int param1, f[][] param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("ep.EC(").append(param0).append(',').append(param1).append(',');
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
