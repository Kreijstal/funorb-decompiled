...
final class jo extends pn implements Cloneable {
    ...
    final void c(boolean param0, boolean param1) {
        ...
        if (param0) {
          if (param1) {
            ...
            gm.field_c[this.field_n] = gm.field_c[this.field_n] + 1;
            return;
          }
        } else {
          var4 = (db) null;
          discarded$5 = jo.a(false, -77, (db) null, -90);
          if (param1) {
            return;
          } else {
            fn.field_j = fn.field_j - ob.field_l;
    ...
    final static dl[] a(boolean param0, int param1, db param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("jo.K(").append(param0).append(',').append(param1).append(',');
        ...
        try {
          L0: {
            if (param0 == -21) {
              ...
              var9 = (fq) null;
              discarded$2 = this.a((byte) -96, (f[][]) null, 127, -74, -22, (fq) null, -77);
              return true;
            }
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("jo.G(").append(param0).append(',');
    ...
    jo(f param0, int param1) {
        ...
        try {
            ...
            throw dn.a((Throwable) ((Object) runtimeException), "jo.<init>(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ')');
        }
    }
    ...
    final void c(int param0, int param1, f[][] param2, int param3) {
        ...
        try {
          L0: {
            ...
            if (param1 == 0) {
              if (vp.field_i[this.field_n].length <= this.field_m) {
                this.field_m = 0;
                decompiledRegionSelector0 = 1;
                break L0;
              } else {
          ...
          L1: {
            ...
            stackOut_6_1 = new StringBuilder().append("jo.W(").append(param0).append(',').append(param1).append(',');
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
        ...
        try {
          L0: {
            ...
            L3: {
              ...
              sc.field_i[this.field_n].a(128, 12 * (param5 - -param2), 12 * (param3 - -param0), 0, (byte) -111);
              gm.field_c[this.field_n] = gm.field_c[this.field_n] - 1;
              ...
              if (null != ab.field_D) {
                ...
                L4: {
                  q.field_a[var10.field_u].field_e[this.field_n] = q.field_a[var10.field_u].field_e[this.field_n] + 1;
                  if (tm.field_e > jm.field_b) {
                    rl.field_h = 1 << var11.field_u;
                    jm.field_b = tm.field_e;
                    break L4;
                  } else {
                    rl.field_h = rl.field_h | 1 << var11.field_u;
                    break L4;
                  }
                }
                if (-1 == (this.field_n ^ -1)) {
            ...
            this.field_l.a(1 << var11.field_u, true, tm.field_e);
            stackOut_15_0 = this.field_l.a(param0, param1, param2, param3, (byte) -92, param5, param6);
          ...
          L5: {
            ...
            stackOut_17_1 = new StringBuilder().append("jo.Q(").append(param0).append(',');
          ...
          L6: {
            ...
            stackOut_20_1 = ((StringBuilder) (Object) stackIn_20_1).append(stackIn_20_2).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
    ...
    final void b(int param0, int param1, int param2, boolean param3, int param4, int param5) {
        ...
        if (-25 == (param1 ^ -1)) {
          if (24 != param2) {
            vp.field_i[this.field_n][this.field_m].b(param4, -param2 + param5, 2 * param1, param2 * 3);
            return;
          } else {
            vp.field_i[this.field_n][this.field_m].a(param4, -param2 + param5);
            return;
          }
        } else {
          vp.field_i[this.field_n][this.field_m].b(param4, -param2 + param5, 2 * param1, param2 * 3);
    ...
    final void a(int param0, int param1, int param2, f[][] param3, int param4, int param5, int param6, int param7) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("jo.HA(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final nj a(int param0, nj param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ng.a(cj.field_y, param1, new jo(new kp(-1), this.field_n), (byte) -83, fa.field_k);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("jo.V(").append(param0).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
