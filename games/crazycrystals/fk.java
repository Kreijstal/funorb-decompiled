...
final class fk extends lb {
    ...
    private final void a(fk param0, int param1, boolean param2) {
        ...
        try {
          ...
          throw dn.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + ',' + 6 + ',' + param2 + ')');
        }
    }
    ...
    public final void a(int param0, boolean param1, int param2, qm param3, boolean param4) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_33_1 = new StringBuilder().append("fk.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
