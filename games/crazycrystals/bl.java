...
final class bl extends jb {
    ...
    final static bl a(db param0, int param1, int param2) {
        try {
            ...
            bl var4_ref = null;
            if (!bl.a(param0)) {
                discarded$0 = param0.a(param1, (byte) 127, param2);
                return null;
            }
    ...
    final ko a(int[] param0) {
        ...
        L1: {
          if (this.field_C != null) {
            ...
            this.field_z = 0;
            this.field_B = new float[field_m];
            this.field_C = new byte[this.field_u];
            this.field_o = 0;
            this.field_F = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (this.field_F >= this.field_A.length) {
            this.field_B = null;
            var12 = this.field_C;
            this.field_C = null;
            return new ko(this.field_H, var12, this.field_D, this.field_k, this.field_r);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
    ...
    final static bl a(db param0, String param1, String param2) {
        try {
            ...
            bl var4_ref = null;
            if (!bl.a(param0)) {
                discarded$0 = param0.a((byte) 43, param1, param2);
                return null;
            }
    ...
    final ko a() {
        ...
        L0: while (true) {
          if (var3 >= this.field_A.length) {
            this.field_B = null;
            return new ko(this.field_H, var1, this.field_D, this.field_k, this.field_r);
          } else {
            var4 = this.d(var3);
            if (var4 != null) {
              L1: {
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        this.field_H = var2.b((byte) -58);
        this.field_u = var2.b((byte) -126);
        this.field_D = var2.b((byte) 127);
        this.field_k = var2.b((byte) 126);
        if (this.field_k < 0) {
              ...
              if (this.field_z <= 0) {
                ...
                L36: {
                  ...
                  if (this.field_q) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= this.field_v) {
                        break L36;
                      } else {
                        var20 = (this.field_z >> 1) + var19;
                        var40[var19] = var40[var19] + this.field_B[var20];
                        var19++;
                        continue L37;
                      }
                    }
