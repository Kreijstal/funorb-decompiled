...
final class bl extends jb {
    private boolean field_r;
    private float[] field_B;
    private static ej[] field_E;
    ...
    private int field_F;
    private static np[] field_M;
    private static ie[] field_I;
    ...
    private final static boolean a(db param0) {
        byte[] var1 = null;
        if (!field_w) {
            var1 = param0.b(0, 0, 0);
            if (var1 == null) {
                        ...
                        L4: while (true) {
                          if (var4 >= var3) {
                            ...
                            L5: while (true) {
                              if (var5 >= var4) {
                                var5 = bl.a(6) + 1;
                                field_y = new boolean[var5];
                                field_s = new int[var5];
                                var6 = 0;
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    field_w = true;
                                    ...
                                    int discarded$3 = bl.a(16);
                                    int discarded$4 = bl.a(16);
                                    field_s[var6] = bl.a(8);
                                    var6++;
                                    continue L6;
                                  }
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = sl.a((byte) -24, var11, var10);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    final static int a(int param0) {
        ...
        while (param0 >= 8 - field_J) {
            var3 = 8 - field_J;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_x[field_j] >> field_J & var4) << var2);
            field_J = 0;
            field_j = field_j + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_x[field_j] >> field_J & var3) << var2);
    ...
    final static int b() {
        int var0 = field_x[field_j] >> field_J & 1;
        field_J = field_J + 1;
        field_j = field_j + (field_J >> 3);
        field_J = field_J & 7;
        return var0;
    }
    ...
    final ko a(int[] param0) {
        ...
        L1: {
          if (((bl) this).field_C != null) {
            ...
            ((bl) this).field_z = 0;
            ((bl) this).field_B = new float[field_m];
            ((bl) this).field_C = new byte[((bl) this).field_u];
            ((bl) this).field_o = 0;
            ((bl) this).field_F = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((bl) this).field_F >= ((bl) this).field_A.length) {
            ((bl) this).field_B = null;
            var14 = ((bl) this).field_C;
            ((bl) this).field_C = null;
            return new ko(((bl) this).field_H, var14, ((bl) this).field_D, ((bl) this).field_k, ((bl) this).field_r);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((bl) this).field_o;
                  var4 = var13.length;
                  if (var4 <= ((bl) this).field_u - var3) {
                    break L5;
                  } else {
                    var4 = ((bl) this).field_u - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((bl) this).field_o);
                        break L7;
                      }
                    }
                    ((bl) this).field_o = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((bl) this).field_F = ((bl) this).field_F + 1;
            continue L2;
          }
        }
    }
    ...
    final ko a() {
        ...
        ((bl) this).field_z = 0;
        ((bl) this).field_B = new float[field_m];
        var1 = new byte[((bl) this).field_u];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((bl) this).field_A.length) {
            ((bl) this).field_B = null;
            return new ko(((bl) this).field_H, var1, ((bl) this).field_D, ((bl) this).field_k, ((bl) this).field_r);
          } else {
            var4 = this.d(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((bl) this).field_u - var2) {
                  break L1;
                } else {
                  var5 = ((bl) this).field_u - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    private bl(byte[] param0) throws IOException {
        this.a(param0);
    }
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        ng var2 = new ng(param0);
        ((bl) this).field_H = var2.b((byte) -58);
        ((bl) this).field_u = var2.b((byte) -126);
        ...
        for (var4 = 0; var4 < var3; var4++) {
            ...
            var6 = new byte[var5];
            var2.a(var5, var6, (byte) -64, 0);
            ((bl) this).field_A[var4] = var6;
        }
    }
    ...
    private final float[] d(int param0) {
        ...
        L0: {
          bl.a(((bl) this).field_A[param0], 0);
          int discarded$1 = bl.b();
          var2 = bl.a(eq.c(field_s.length - 1, (byte) 100));
        ...
        L8: {
          var14 = field_M[field_s[var2]];
          var16 = var14.field_a;
          var17_int = var14.field_c[var16];
          if (field_E[var17_int].a()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_b) {
            L10: {
              if (var15 != 0) {
                ...
                field_E[var18_int].a(field_G, var4 >> 1);
                break L10;
              }
            }
            L11: {
                                                                          ...
                                                                          if (var26 >= var9) {
                                                                            ...
                                                                            L31: while (true) {
                                                                              if (var26 >= var12) {
                                                                                ...
                                                                                field_G[var26] = field_G[var26] * (float)Math.sin(1.5707963267948966 * (double)var27 * (double)var27);
                                                                                var26++;
                                                                                continue L31;
                                                                              }
                                                                            }
            ...
            L35: {
              var17 = null;
              if (((bl) this).field_z <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((bl) this).field_z + var4 >> 2;
                  ...
                  if (((bl) this).field_q) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((bl) this).field_v) {
                        break L36;
                      } else {
                        var20 = (((bl) this).field_z >> 1) + var19;
                        var40[var19] = var40[var19] + ((bl) this).field_B[var20];
                        var19++;
                        continue L37;
                      }
                    }
                ...
                if (var15 != 0) {
                  ...
                  L38: while (true) {
                    if (var19 >= var4 >> 1) {
                      ...
                      var40[var20] = var40[var20] + field_G[var19];
                      var19++;
                      continue L38;
                    }
                  }
            ...
            L39: {
              var18 = ((bl) this).field_B;
              ((bl) this).field_B = field_G;
              field_G = var18;
              ((bl) this).field_z = var4;
              ((bl) this).field_v = var12 - (var4 >> 1);
              stackOut_108_0 = this;
