...
final class kg extends od {
        ...
        L0: while (true) {
          if (this.field_v <= 0) {
            L1: {
              if (this.field_m != -256) {
                ...
                if ((this.field_p & 255) != 0) {
                  ...
                  if (id.field_o) {
                    return kg.a(0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_u, this.field_q, 0, param3, param2, (kg) (this));
                  } else {
                    return kg.a(((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_s, 0, param3, param2, (kg) (this));
                  }
                }
              }
            }
            if (id.field_o) {
              return kg.a(0, 0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_u, this.field_q, 0, param3, param2, (kg) (this), this.field_m, param4);
            } else {
              return kg.a(0, 0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_s, 0, param3, param2, (kg) (this), this.field_m, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_m != -256) {
                  ...
                  if ((this.field_p & 255) != 0) {
                    ...
                    if (!id.field_o) {
                      param1 = kg.a(((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_s, this.field_j, 0, var6, param2, (kg) (this));
                      break L3;
                    } else {
                      param1 = kg.b(0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_u, this.field_q, this.field_t, this.field_r, 0, var6, param2, (kg) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!id.field_o) {
                param1 = kg.d(0, 0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_s, this.field_j, 0, var6, param2, (kg) (this), this.field_m, param4);
                break L3;
              } else {
                param1 = kg.a(0, 0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_u, this.field_q, this.field_t, this.field_r, 0, var6, param2, (kg) (this), this.field_m, param4);
                break L3;
              }
            }
            this.field_v = this.field_v - param1;
          ...
          L4: {
            if (this.field_w <= 0) {
              ...
              if (!this.field_n) {
                if (this.field_m >= 0) {
                  L5: while (true) {
                    var9 = this.b(param0, var9, var6, param2, (int) var4.field_k[this.field_l]);
                    if (this.field_p >= var6) {
                      ...
                      if (var10 < this.field_w) {
                        ...
                        this.field_p = this.field_p - var8 * this.field_w;
                        this.field_w = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_k[this.field_x - 1]);
                ...
                L7: {
                  if (this.field_m >= 0) {
                    ...
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_k[this.field_l]);
                    if (this.field_p < var5) {
                ...
                L8: while (true) {
                  var9 = this.b(param0, var9, var6, param2, (int) var4.field_k[this.field_x - 1]);
                  if (this.field_p >= var6) {
        ...
        L0: while (true) {
          if (this.field_v <= 0) {
            L1: {
              if (this.field_m != 256) {
                ...
                if ((this.field_p & 255) != 0) {
                  ...
                  if (id.field_o) {
                    return kg.b(0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_u, this.field_q, 0, param3, param2, (kg) (this));
                  } else {
                    return kg.b(((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_s, 0, param3, param2, (kg) (this));
                  }
                }
              }
            }
            if (id.field_o) {
              return kg.c(0, 0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_u, this.field_q, 0, param3, param2, (kg) (this), this.field_m, param4);
            } else {
              return kg.b(0, 0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_s, 0, param3, param2, (kg) (this), this.field_m, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_v;
            ...
            L3: {
              L4: {
                ...
                if (this.field_m != 256) {
                  ...
                  if ((this.field_p & 255) != 0) {
                    ...
                    if (!id.field_o) {
                      param1 = kg.b(((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_s, this.field_j, 0, var6, param2, (kg) (this));
                      break L3;
                    } else {
                      param1 = kg.a(0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_u, this.field_q, this.field_t, this.field_r, 0, var6, param2, (kg) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!id.field_o) {
                param1 = kg.b(0, 0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_s, this.field_j, 0, var6, param2, (kg) (this), this.field_m, param4);
                break L3;
              } else {
                param1 = kg.b(0, 0, ((ko) ((Object) this.field_h)).field_k, param0, this.field_p, param1, this.field_u, this.field_q, this.field_t, this.field_r, 0, var6, param2, (kg) (this), this.field_m, param4);
                break L3;
              }
            }
            this.field_v = this.field_v - param1;
    ...
    final synchronized void g(int param0) {
        int var2 = ((ko) ((Object) this.field_h)).field_k.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
        ...
        if (param0 != 0) {
          ...
          if (this.field_u == var4) {
            if (this.field_q == var5) {
              ...
              this.field_o = param1;
              this.field_k = param2;
              this.field_j = (param1 - this.field_s) / param0;
              this.field_t = (var4 - this.field_u) / param0;
              this.field_r = (var5 - this.field_q) / param0;
              return;
            }
          } else {
            L6: {
    ...
    final int b() {
        ...
        if (this.field_w == 0) {
            var1 = var1 - var1 * this.field_p / (((ko) ((Object) this.field_h)).field_k.length << 8);
        } else {
            if (this.field_w >= 0) {
                var1 = var1 - var1 * this.field_l / ((ko) ((Object) this.field_h)).field_k.length;
            }
        }
    ...
    final synchronized boolean h() {
        return this.field_p < 0 || this.field_p >= ((ko) ((Object) this.field_h)).field_k.length << 8;
    }
    ...
    private final boolean g() {
        ...
        L0: {
          var1 = this.field_o;
          if (var1 != -2147483648) {
            var2 = kg.d(var1, this.field_k);
            var3 = kg.a(var1, this.field_k);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L3: {
          if (this.field_u >= var2) {
            if (this.field_u <= var2) {
              ...
              L4: {
                ...
                if (this.field_v == 0) {
                  ...
                  if (this.field_v <= this.field_u - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_v = this.field_u - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_v == 0) {
                ...
                if (this.field_v <= var2 - this.field_u) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_v = var2 - this.field_u;
            break L3;
          }
        }
        if (this.field_q < var3) {
          this.field_r = 1;
          if (this.field_v != 0) {
            if (this.field_v > var3 - this.field_q) {
              this.field_v = var3 - this.field_q;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_q <= var3) {
              ...
              L7: {
                ...
                if (this.field_v == 0) {
                  ...
                  if (this.field_v <= this.field_q - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_v = this.field_q - var3;
              break L6;
            }
          }
          return false;
    ...
    final synchronized void a(int param0) {
        ...
        this.field_p = this.field_p + this.field_m * param0;
        if (this.field_w >= 0) {
          L5: {
            if (this.field_w <= 0) {
              break L5;
                  ...
                  if (this.field_m >= 0) {
                    if (this.field_p >= var4) {
                      ...
                      if (var7 < this.field_w) {
                        ...
                        this.field_p = this.field_p - var6 * this.field_w;
                        this.field_w = 0;
                        break L5;
                      }
                    } else {
    ...
    private final void l() {
        ...
        this.field_u = kg.d(this.field_o, this.field_k);
        this.field_q = kg.a(this.field_o, this.field_k);
    }

    private kg(ko param0, int param1, int param2) {
        this.field_h = (cg) ((Object) param0);
        this.field_l = param0.field_g;
        this.field_x = param0.field_h;
