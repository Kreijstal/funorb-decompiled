    ...
    final static void a(dl[] param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L24: {
            ...
            stackIn_74_1 = new StringBuilder().append("oc.A(");
