...
final class lj {
    ...
    final static dh a(db param0, String param1, db param2, String param3, int param4) {
        ...
        try {
          L0: {
            var5_int = param0.a(param1, -1);
            var6 = param0.a(-2862, param3, var5_int);
            stackOut_0_0 = ve.a(103, param0, var6, param2, var5_int);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("lj.C(");
          ...
          throw dn.a((Throwable) (Object) stackIn_14_0, stackIn_14_2 + ',' + 17153 + ')');
        }
        return stackIn_1_0;
    }
    ...
    final static void a(int param0, we param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("lj.A(").append(5).append(',');
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
