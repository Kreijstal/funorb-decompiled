    ...
    final boolean a(boolean param0, f[][] param1, mj param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("de.A(").append(param0).append(44);
    ...
    final boolean a(byte param0, f[][] param1, int param2, int param3, int param4, fq param5, int param6) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("de.G(").append(param0).append(44);
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
          ...
          throw dn.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + param6 + 41);
        }
    ...
    final nj a(int param0, nj param1) {
        ...
        try {
          L0: {
            if (param0 == 23525) {
              ...
              if (null != ((de) this).field_j) {
                ...
                stackOut_6_0 = ng.a(mg.field_h, param1, (f) (Object) var3, (byte) -83, wa.field_j);
                stackIn_7_0 = stackOut_6_0;
                break L0;
              } else {
                stackOut_4_0 = ng.a(mg.field_h, param1, (f) (Object) var3, (byte) -83, hl.field_e);
                stackIn_5_0 = stackOut_4_0;
                return stackIn_5_0;
              }
            } else {
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("de.V(").append(param0).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    final boolean a(int param0, f[][] param1, boolean param2, int param3, int param4, int param5, ea param6, int param7) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("de.M(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    final f a(f param0, int param1, int param2, f[][] param3, dl[] param4, byte param5) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_9_1 = new StringBuilder().append("de.H(");
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
            stackIn_10_0 = stackOut_9_0;
            stackIn_10_1 = stackOut_9_1;
