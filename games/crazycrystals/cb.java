...
final class cb extends pn implements Cloneable {
    ...
    final f a(int param0, f[][] param1, boolean param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("cb.HB(").append(param0).append(44);
          ...
          throw dn.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + param2 + 44 + param3 + 41);
        }
        return (f) this;
    }
    ...
    final void c(int param0, int param1, f[][] param2, int param3) {
        try {
            if (param1 != 0) {
                Object var6 = null;
                boolean discarded$0 = ((cb) this).a((byte) 80, (f[][]) null, -107, 58, -4, (fq) null, -78);
            }
            ((cb) this).field_s = (((cb) this).field_s + 1) % 48;
        } catch (RuntimeException runtimeException) {
            throw dn.a((Throwable) (Object) runtimeException, "cb.W(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 41);
        }
    }
    ...
    final nj a(int param0, nj param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ng.a(f.field_f, param1, (f) (Object) new cb((f) (Object) new kp(-1), 0, 0), (byte) -83, jh.field_d);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("cb.V(").append(param0).append(44);
        ...
        if (param1 == 24) {
          if (param2 != 24) {
            L0: {
              ...
              if (param3) {
                ...
                stackOut_25_1 = ((cb) this).field_s >> 2;
            ...
            L3: {
              ...
              if (!param3) {
                ...
                stackOut_16_1 = ((cb) this).field_s >> 2;
          ...
          L6: {
            ...
            if (param3) {
              ...
              stackOut_2_1 = ((cb) this).field_s >> 2;
    ...
    final boolean a(byte param0, f[][] param1, int param2, int param3, int param4, fq param5, int param6) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ((cb) this).field_l.a((byte) -21, param1, param2, param3, param4, param5, param6);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("cb.G(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    cb(f param0, int param1, int param2) {
        ...
        try {
            ...
            throw dn.a((Throwable) (Object) runtimeException, "cb.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 41);
        }
    }
    ...
    final boolean a(int param0, f[][] param1, boolean param2, int param3, int param4, int param5, ea param6, int param7) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ((cb) this).field_l.a(16736352, param1, param2, param3, param4, param5, param6, param7);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("cb.M(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    final boolean a(boolean param0, f[][] param1, mj param2) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = ((cb) this).field_l.a(false, param1, param2);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("cb.A(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    final void a(int param0, f[][] param1, int param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("cb.KC(").append(param0).append(44);
    ...
    final void a(int param0, DataInputStream param1, int param2, byte param3, int param4) throws IOException {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_3_1 = new StringBuilder().append("cb.JC(").append(param0).append(44);
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
            stackIn_4_0 = stackOut_3_0;
            stackIn_4_1 = stackOut_3_1;
    ...
    final f a(f param0, int param1, int param2, f[][] param3, dl[] param4, byte param5) {
        ...
        try {
          ...
          throw dn.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + 44 + param5 + 41);
        }
