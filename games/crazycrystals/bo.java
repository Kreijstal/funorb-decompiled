    ...
    final void a(int param0, int param1, int param2, f[][] param3, int param4, int param5, int param6, int param7) {
        ...
        try {
          L0: {
            L1: {
              if (param0 >= 92) {
                ...
                Object discarded$2 = ((bo) this).clone();
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("bo.HA(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final static void a(un param0, java.awt.Frame param1, int param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("bo.P(");
