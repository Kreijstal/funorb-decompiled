 ...
 */
final class rm extends jb {
    byte[] field_g;
    fc field_f;

    final static rm a(db param0, String param1, String param2) {
        byte[] var3 = param0.a(7693, param2, param1);
        if (var3 == null) {
            return null;
        }
        return new rm(new ng(var3));
    }
                      ...
                      L6: {
                        if (var9 != 144) {
                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              var13 = var19[var10];
                              var14 = (dm) ((Object) this.field_f.a((long)var13, 0));
                              if (var14 != null) {
                                break L7;
                              } else {
                                var15 = new dm(new byte[128]);
                                var14 = var15;
                                this.field_f.a(-22072, (long)var13, var15);
                                break L7;
                              }
                            }
    ...
    private rm(ng param0) {
        ...
        ng stackIn_66_0 = null;
        int stackIn_66_1 = 0;
        ng stackIn_67_0 = null;
        int stackIn_67_1 = 0;
        int stackIn_67_2 = 0;
        int stackIn_73_0 = 0;
        int var2;
        ...
        int var66;
        int[] var70;
        param0.field_f = param0.field_h.length - 3;
        var2 = param0.h(255);
        var3 = param0.c((byte) -7);
        var4 = 14 + var2 * 10;
        param0.field_f = 0;
        var5 = 0;
        var6 = 0;
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51 = new ng(this.field_g);
                      var51.a(1297377380, -16384);
                      var51.a(6, -16384);
                      stackIn_66_0 = (ng) (var51);

                      stackIn_66_1 = -161478600;

                      if (var2 <= 1) {
                        stackIn_67_0 = (ng) ((Object) stackIn_66_0);
                    ...
                    ((ng) (Object) stackIn_67_0).c(stackIn_67_1, stackIn_67_2);
                    var51.c(-161478600, var2);
                    var51.c(-161478600, var3);
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                    ...
                                    if (var62 != 3) {
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            L7: {
                                              if (var65 == 0) {
                                                ...
                                                var51.a(true, 192 + var52);
                                                break L7;
                                              }
                                            }
                                            incrementValue$1 = var44;
                                            var44++;
                                            var51.a(true, (int) param0.field_h[incrementValue$1]);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                                          ...
                                          var51.a(true, var53 & 127);
                                          var51.a(true, var58 & 127);
                                          continue L5;
                                        }
                                      } else {
                                        L9: {
                                      ...
                                      var51.a(true, var56 & 127);
                                      var51.a(true, var56 >> 7 & 127);
                                      continue L5;
                                    }
                                  } else {
                                    L11: {
                              ...
                              var50++;
                              var51.a(true, (int) param0.field_h[incrementValue$25]);
                              incrementValue$26 = var50;
                              var50++;
                              var51.a(true, (int) param0.field_h[incrementValue$26]);
                              incrementValue$27 = var50;
                              var50++;
                              var51.a(true, (int) param0.field_h[incrementValue$27]);
                              continue L5;
                            }
                          } else {
                            L18: {
                            ...
                            var51.a(true, 47);
                            var51.a(true, 0);
                            var51.b(var51.field_f - var61, false);
                            var60++;
                            continue L4;
                          }
                        }
