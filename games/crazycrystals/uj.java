...
final class uj extends vc {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * kh.field_l;
          var10 = kh.field_l - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= kh.field_b) {
            break L0;
          } else {
            var13 = kh.field_b - param2;
            param4 = param4 - var13;
            param2 = kh.field_b;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * kh.field_l;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= kh.field_j) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - kh.field_j);
            break L1;
          }
        }
        L2: {
          if (param1 >= kh.field_c) {
            break L2;
          } else {
            var13 = kh.field_c - param1;
            param3 = param3 - var13;
            param1 = kh.field_c;
            var12 = var12 + var13;
            var9 = var9 + var13;
        ...
        L3: {
          if (param1 + param3 <= kh.field_g) {
            break L3;
          } else {
            var13 = param1 + param3 - kh.field_g;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  uj.a(0, kh.field_i, ((uj) this).field_J[param0], ((uj) this).field_K[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  ef.a(kh.field_i, ((uj) this).field_J[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * kh.field_l;
          var9 = kh.field_l - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= kh.field_b) {
            break L0;
          } else {
            var12 = kh.field_b - param2;
            param4 = param4 - var12;
            param2 = kh.field_b;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * kh.field_l;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= kh.field_g) {
            ...
            var12 = param1 + param3 - kh.field_g;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  uj.a(0, kh.field_i, ((uj) this).field_J[param0], ((uj) this).field_K[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  ef.a(kh.field_i, ((uj) this).field_J[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
    ...
    uj(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((uj) this).field_J = new byte[256][];
        ((uj) this).field_J = param6;
        ((uj) this).field_K = new int[4][];
        ((uj) this).field_K[0] = param5;
    }
