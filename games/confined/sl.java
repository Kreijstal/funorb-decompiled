...
final class sl {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_e[var16]) {
                  var9 = field_f[var16];
                  var10 = field_a[var16] * this.field_l;
    ...
    final boolean a() {
        ...
        int var3 = field_c[this.field_l - 1];
        ...
        for (var6 = 0; var6 < this.field_b.length; var6++) {
            ...
            var9 = this.field_i[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ph.field_s[this.field_d[var7]].a();
            }
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_g[var7]) {
                              ...
                              var5++;
                              this.field_h[incrementValue$2] = ph.b(var4);
                              var8++;
                              continue L6;
                            }
                          }
