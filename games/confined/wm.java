...
final class wm extends hf {
    ...
    final void a(mn param0, double param1, int param2, vg param3, oi param4) {
        ...
        try {
          L0: {
            L1: {
              ((wm) this).a(-116, cd.field_o[(((wm) this).field_eb & 15) >> 1], param1, param3);
              if (param2 < -5) {
                break L1;
              } else {
                field_bb = 59;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("wm.QA(");
    ...
    final void a(hm param0, boolean param1) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (((wm) this).field_cb.length <= var3_int) {
                break L0;
              } else {
                L3: {
                  var4 = ((wm) this).field_cb[var3_int];
                  if (var4.c((byte) 125)) {
                    break L3;
                  } else {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("wm.CA(");
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
            stackIn_10_0 = stackOut_9_0;
            stackIn_10_1 = stackOut_9_1;
    ...
    wm(hn param0, dj param1, double[] param2, double param3, boolean param4) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (!param4) {
                ...
                L2: {
                  var7_double = Math.sqrt(((wm) this).field_K * ((wm) this).field_K + ((wm) this).field_G * ((wm) this).field_G + ((wm) this).field_L * ((wm) this).field_L);
                ...
                ((wm) this).field_W = param1.a(((wm) this).field_K / var7_double, ((wm) this).field_G / var7_double, ((wm) this).field_L / var7_double, false);
                break L1;
              }
            }
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("wm.<init>(");
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
    ...
    final boolean a(pm param0, byte param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = param0.f(param1 ^ -61);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("wm.WA(");
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
    ...
    final void b(ee param0, int param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("wm.B(");
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
    ...
    final void a(mn param0, byte param1) {
        try {
            ...
            throw sd.a((Throwable) (Object) runtimeException, "wm.OA(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final static byte[] a(String param0, byte param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = mn.field_e.a(-98, "", param0);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("wm.H(");
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
