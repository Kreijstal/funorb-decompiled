...
final class cn {
    ...
    final void a(float[] param0, int param1, boolean param2) {
        ...
        L0: while (true) {
          if (var4 >= param1) {
            if (!param2) {
              var4 = ph.field_s[this.field_f].field_f;
                    ...
                    if (var9 >= var6) {
                      ...
                      L3: {
                        if (var8 != 0) {
                          ...
                          var10 = ph.field_s[this.field_f].a();
                          var11 = var4 - 1;
                          L4: while (true) {
                            if (var11 < 0) {
                              break L3;
    ...
    cn() {
        ...
        int var5 = 0;
        int var2 = 0;
        this.field_d = ph.b(16);
        this.field_a = ph.b(24);
        this.field_c = ph.b(24);
        this.field_e = ph.b(24) + 1;
        this.field_b = ph.b(6) + 1;
        this.field_f = ph.b(8);
        ...
        this.field_g = new int[this.field_b * 8];
        int var6 = 0;
        var2 = var6;
        while (var6 < this.field_b * 8) {
            this.field_g[var6] = (var1[var6 >> 3] & 1 << (var6 & 7)) != 0 ? ph.b(8) : -1;
            var6++;
        }
    }
}
