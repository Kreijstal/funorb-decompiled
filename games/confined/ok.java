...
abstract class ok extends jl {
    ...
    private final void a(String param0, int param1, int param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_ld.field_i;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
                ...
                case 47: {
                    field_J = field_J + field_L;
                    param1 = param1 + (field_J >> 8);
                    field_J = field_J & 255;
                    statePc = 48;
                    continue stateLoop;
                }
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                ...
                var2++;
                ((ok) this).field_Q[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = ol.a(field_s, 0, -1046, ' ');
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
    ...
    ok(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((ok) this).field_v = 0;
