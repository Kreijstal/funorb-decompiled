...
final class mj implements com.ms.directX.IEnumModesCallback {
    ...
    final void a(int param0, java.awt.Frame param1, int param2, int param3, int param4, int param5) {
        ...
        ((mj) this).field_c.setCooperativeLevel((java.awt.Component) (Object) param1, 17);
        ((mj) this).field_c.setDisplayMode(param0, param4, param3, param2, 0);
    ...
    final int[] a(int param0) {
        ((mj) this).field_c.enumDisplayModes(0, (com.ms.directX.DDSurfaceDesc) null, (com.ms.com.IUnknown) null, (com.ms.directX.IEnumModesCallback) this);
    ...
    final void a(byte param0, java.awt.Frame param1) {
        ((mj) this).field_c.restoreDisplayMode();
        int var3 = -5 % ((3 - param0) / 32);
        ((mj) this).field_c.setCooperativeLevel((java.awt.Component) (Object) param1, 8);
    }

    public mj() {
        ((mj) this).field_c = new com.ms.directX.DirectDraw();
        ((mj) this).field_c.initialize((com.ms.com._Guid) null);
    }
}
