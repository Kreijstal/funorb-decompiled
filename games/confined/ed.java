...
final class ed {
    ...
    final int a() {
        ...
        while (this.field_b[var1] >= 0) {
            var1 = ph.a() != 0 ? this.field_b[var1] : var1 + 1;
        }
    ...
    ed() {
        ...
        L0: {
          discarded$2 = ph.b(24);
          this.field_f = ph.b(16);
          this.field_a = ph.b(24);
          ...
          if (var1 == 0) {
                ...
                L4: {
                  if (var2 == 0) {
                    ...
                    if (ph.a() != 0) {
                      ...
                      this.field_c[var14] = 0;
                      var14++;
                      continue L3;
                    }
                  }
                }
                this.field_c[var14] = ph.b(5) + 1;
                var14++;
                continue L3;
              }
            }
            ...
            L5: while (true) {
              if (var2 >= this.field_a) {
                ...
                var4_int = ph.b(km.b(4, this.field_a - var2));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
                    ...
                    var2++;
                    this.field_c[incrementValue$3] = var3_int;
                    var5++;
                    continue L6;
                  }
                }
          ...
          if (var2 <= 0) {
            ...
            L9: {
              ...
              if (var2 != 1) {
                ...
                var7 = ed.a(this.field_a, this.field_f);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_d = new float[this.field_a][this.field_f];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
