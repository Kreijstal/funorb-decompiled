...
final class nm extends gk {
    ...
    final static nf[] a(mi param0, String param1, int param2, String param3) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = hf.a(param0, var4_int, (byte) -127, var5);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("nm.F(");
    ...
    nm(pm param0, bi param1, dc param2, int param3) {
        super(param0, param1);
        try {
            ((nm) this).field_n.e(param1.field_o.length * param3 >> 8);
            ((nm) this).field_w = 0.2;
    ...
    final void e(int param0) {
        ...
        if (!((nm) this).field_H.c((byte) 105)) {
          ...
          L6: {
            ...
            ((nm) this).field_n.b(16384 + eg.field_i * var21 * fa.field_S >> 15, var29);
