          ...
          if (var8 < 50) {
            L2: {
              ...
              if (var10 < 50) {
                ...
                var4++;
                field_o[incrementValue$0] = var13 + (((this.field_l[param0] & 65535) - var13) * var14 >> 16);
                break L2;
              }
            }
            if (var9 < 50) {
              ...
              var4++;
              field_o[incrementValue$1] = var13 + (((this.field_q[param0] & 65535) - var13) * var14 >> 16);
              break L1;
            }
          } else {
            ...
            var4++;
            field_o[incrementValue$2] = this.field_i[param0] & 65535;
            break L1;
          }
        }
        L3: {
          if (var9 < 50) {
            L4: {
              ...
              if (var8 < 50) {
                ...
                var4++;
                field_o[incrementValue$3] = var13 + (((this.field_i[param0] & 65535) - var13) * var14 >> 16);
                break L4;
              }
            }
            if (var10 < 50) {
              ...
              var4++;
              field_o[incrementValue$4] = var13 + (((this.field_l[param0] & 65535) - var13) * var14 >> 16);
              break L3;
            }
          } else {
            ...
            var4++;
            field_o[incrementValue$5] = this.field_q[param0] & 65535;
            break L3;
          }
        }
        L5: {
          if (var10 < 50) {
            L6: {
              ...
              if (var9 < 50) {
                ...
                var4++;
                field_o[incrementValue$6] = var13 + (((this.field_q[param0] & 65535) - var13) * var14 >> 16);
                break L6;
              }
            }
            if (var8 < 50) {
              ...
              var4++;
              field_o[incrementValue$7] = var13 + (((this.field_i[param0] & 65535) - var13) * var14 >> 16);
              break L5;
            }
          } else {
            ...
            var4++;
            field_o[incrementValue$8] = this.field_l[param0] & 65535;
            break L5;
          }
        }
        L7: {
