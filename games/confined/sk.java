...
final class sk extends wj {
    ...
    private final void e(int param0) {
        ...
        if (!field_L[param0]) {
          L0: {
            var2 = this.field_t[param0];
            var3 = this.field_M[param0];
            var4 = this.field_y[param0];
            ti.field_c = field_z[param0];
            if (this.field_p != null) {
              ti.field_h = this.field_p[param0] & 255;
              break L0;
            } else {
              ti.field_h = 0;
              break L0;
          ...
          L1: {
            L2: {
              if (this.field_F == null) {
                ...
                if (this.field_F[param0] != -1) {
                  L3: {
                    L4: {
                      if (this.field_db == null) {
                        ...
                        if (this.field_db[param0] == -1) {
                          break L4;
                        } else {
                          var8 = this.field_db[param0] & 255;
                          var5 = this.field_Y[var8];
                          var6 = this.field_R[var8];
                          var7 = this.field_x[var8];
                          break L3;
                        }
                      }
                    }
                  ...
                  if (this.field_l[param0] != -1) {
                    ti.a(field_J[var2], field_J[var3], field_J[var4], field_eb[var2], field_eb[var3], field_eb[var4], this.field_i[param0], this.field_q[param0], this.field_l[param0], field_H[var5], field_H[var6], field_H[var7], field_V[var5], field_V[var6], field_V[var7], field_N[var5], field_N[var6], field_N[var7], (int) this.field_F[param0]);
                    break L1;
                  } else {
                    ti.a(field_J[var2], field_J[var3], field_J[var4], field_eb[var2], field_eb[var3], field_eb[var4], this.field_i[param0], this.field_i[param0], this.field_i[param0], field_H[var5], field_H[var6], field_H[var7], field_V[var5], field_V[var6], field_V[var7], field_N[var5], field_N[var6], field_N[var7], (int) this.field_F[param0]);
                    break L1;
                  }
                } else {
                  break L2;
            ...
            if (this.field_l[param0] != -1) {
              ti.a(field_J[var2], field_J[var3], field_J[var4], field_eb[var2], field_eb[var3], field_eb[var4], this.field_i[param0] & 65535, this.field_q[param0] & 65535, this.field_l[param0] & 65535);
              break L1;
            } else {
              ti.a(field_J[var2], field_J[var3], field_J[var4], field_eb[var2], field_eb[var3], field_eb[var4], ti.field_o[this.field_i[param0] & 65535]);
              break L1;
            }
          }
          return;
    ...
    private final void b() {
        ...
        L0: while (true) {
          if (var9 >= this.field_m) {
            ...
            L1: {
              var10 = this.field_W[var9];
              var11 = this.field_C[var9];
              var12 = this.field_B[var9];
              if (var10 >= var1) {
                break L1;
              } else {
                var1 = var10;
    ...
    private final void c(int param0) {
        ...
        L0: {
          ...
          var3 = ti.field_f;
          var4 = 0;
          var5 = this.field_t[param0];
          var6 = this.field_M[param0];
          var7 = this.field_y[param0];
          var8 = field_N[var5];
          var9 = field_N[var6];
          var10 = field_N[var7];
          if (this.field_p != null) {
          ...
          if (var8 < 50) {
            L2: {
              ...
              if (var10 < 50) {
                ...
                var4++;
                field_o[incrementValue$9] = var13 + (((this.field_l[param0] & 65535) - var13) * var14 >> 16);
                break L2;
              }
            }
            if (var9 < 50) {
              ...
              var4++;
              field_o[incrementValue$10] = var13 + (((this.field_q[param0] & 65535) - var13) * var14 >> 16);
              break L1;
            }
          } else {
            ...
            var4++;
            field_o[incrementValue$11] = this.field_i[param0] & 65535;
            break L1;
          }
        }
        L3: {
          if (var9 < 50) {
            L4: {
              var11 = field_H[var6];
              var12 = field_V[var6];
              var13 = this.field_q[param0] & 65535;
              if (var8 < 50) {
                break L4;
              } else {
                ...
                var4++;
                field_o[incrementValue$12] = var13 + (((this.field_i[param0] & 65535) - var13) * var14 >> 16);
                break L4;
              }
            }
            if (var10 < 50) {
              ...
              var4++;
              field_o[incrementValue$13] = var13 + (((this.field_l[param0] & 65535) - var13) * var14 >> 16);
              break L3;
            }
          } else {
            ...
            var4++;
            field_o[incrementValue$14] = this.field_q[param0] & 65535;
            break L3;
          }
        }
        L5: {
          if (var10 < 50) {
            L6: {
              var11 = field_H[var7];
              var12 = field_V[var7];
              var13 = this.field_l[param0] & 65535;
              if (var9 < 50) {
                break L6;
              } else {
                ...
                var4++;
                field_o[incrementValue$15] = var13 + (((this.field_q[param0] & 65535) - var13) * var14 >> 16);
                break L6;
              }
            }
            if (var8 < 50) {
              ...
              var4++;
              field_o[incrementValue$16] = var13 + (((this.field_i[param0] & 65535) - var13) * var14 >> 16);
              break L5;
            }
          } else {
            ...
            var4++;
            field_o[incrementValue$17] = this.field_l[param0] & 65535;
            break L5;
          }
        }
        L7: {
          ...
          if (var4 != 3) {
            ...
            L10: {
              if (this.field_F == null) {
                ...
                if (this.field_F[param0] != -1) {
                    ...
                    L12: {
                      if (this.field_db == null) {
                        ...
                        if (this.field_db[param0] == -1) {
                          ...
                          var20 = this.field_db[param0] & 255;
                          var17 = this.field_Y[var20];
                          var18 = this.field_R[var20];
                          var19 = this.field_x[var20];
                          break L11;
                        }
                      }
                    }
                  ...
                  if (this.field_l[param0] != -1) {
                    ti.a(var14, var15, var16, var11, var12, var13, field_o[0], field_o[1], field_o[2], field_H[var17], field_H[var18], field_H[var19], field_V[var17], field_V[var18], field_V[var19], field_N[var17], field_N[var18], field_N[var19], (int) this.field_F[param0]);
                    break L7;
                  } else {
                    ti.a(var14, var15, var16, var11, var12, var13, this.field_i[param0], this.field_i[param0], this.field_i[param0], field_H[var17], field_H[var18], field_H[var19], field_V[var17], field_V[var18], field_V[var19], field_N[var17], field_N[var18], field_N[var19], (int) this.field_F[param0]);
                    break L7;
                  }
                } else {
                  break L10;
            ...
            if (this.field_l[param0] != -1) {
              ...
              ti.a(var14, var15, var16, var11, var12, var13, ti.field_o[this.field_i[param0] & 65535]);
              break L7;
            }
          }
        }
        if (var4 != 4) {
          ...
          L15: {
              ...
              if (this.field_F == null) {
                ...
                if (this.field_F[param0] != -1) {
                  ...
                  if (this.field_l[param0] != -1) {
                    ...
                    ti.a(var14, var15, var16, var11, var12, var13, this.field_i[param0], this.field_i[param0], this.field_i[param0], field_H[var17], field_H[var18], field_H[var19], field_V[var17], field_V[var18], field_V[var19], field_N[var17], field_N[var18], field_N[var19], var20);
                    ti.a(var14, var16, field_ab[3], var11, var13, field_k[3], this.field_i[param0], this.field_i[param0], this.field_i[param0], field_H[var17], field_H[var18], field_H[var19], field_V[var17], field_V[var18], field_V[var19], field_N[var17], field_N[var18], field_N[var19], var20);
                    break L15;
                  }
                } else {
                  break L16;
            ...
            if (this.field_l[param0] != -1) {
              ...
              var17 = ti.field_o[this.field_i[param0] & 65535];
        ...
        if (param4 < 1600) {
          ...
          L3: while (true) {
            if (var8 >= this.field_E) {
              ...
              if (this.field_l[var8] != -2) {
                L40: {
                  var9 = this.field_t[var8];
                  var10 = this.field_M[var8];
                  var11 = this.field_y[var8];
                  var12 = field_eb[var9];
                  ...
                  if (!param0) {
                    ...
                    if (var16 * var24 + var19 * var25 + var22 * var26 > 0) {
                      ...
                      if (!field_X) {
                        ...
                        if (field_cb[var27] >= 64) {
                          L42: {
                            ...
                            if (var28 != 64) {
                              ...
                              if (field_fb != 512) {
                                fieldTemp$7 = field_fb;
                                field_fb = field_fb + 1;
                                var28 = 65 + fieldTemp$7;
                                field_cb[var27] = 65 + fieldTemp$7;
                                break L42;
                              } else {
                                var8++;
                                continue L3;
                          ...
                          var28 -= 65;
                          dupTemp$8 = field_Z[var28];
                          arrayValue$9 = field_A[var28];
                          field_Z[var28] = dupTemp$8 + 1;
                          arrayValue$9[dupTemp$8] = var8;
                          var8++;
                          continue L3;
                        } else {
                          dupTemp$10 = field_cb[var27];
                          arrayValue$11 = field_P[var27];
                          field_cb[var27] = dupTemp$10 + 1;
                        ...
                        var7++;
                        field_n[incrementValue$12] = var8;
                        var8++;
                        continue L3;
                      }
                    } else {
                ...
                L43: {
                  if (!param1) {
                    ...
                    if (!this.a(on.field_a + ti.field_k, bj.field_q + ti.field_f, field_J[var9], field_J[var10], field_J[var11], var12, var13, var14_int)) {
                      ...
                      fieldTemp$13 = tk.field_g;
                      tk.field_g = tk.field_g + 1;
                      la.field_S[fieldTemp$13] = param2;
                      param1 = false;
                      break L43;
                    }
                  }
                ...
                if ((var12 - var13) * (field_J[var11] - field_J[var10]) - (field_J[var9] - field_J[var10]) * (var14_int - var13) > 0) {
                  ...
                  if (!field_X) {
                    ...
                    if (field_cb[var15_int] >= 64) {
                      L46: {
                        ...
                        if (var16 != 64) {
                          ...
                          if (field_fb != 512) {
                            fieldTemp$14 = field_fb;
                            field_fb = field_fb + 1;
                            var16 = 65 + fieldTemp$14;
                            field_cb[var15_int] = 65 + fieldTemp$14;
                            break L46;
                          } else {
                            var8++;
                            continue L3;
                      ...
                      var16 -= 65;
                      dupTemp$15 = field_Z[var16];
                      arrayValue$16 = field_A[var16];
                      field_Z[var16] = dupTemp$15 + 1;
                      arrayValue$16[dupTemp$15] = var8;
                      var8++;
                      continue L3;
                    } else {
                      dupTemp$17 = field_cb[var15_int];
                      arrayValue$18 = field_P[var15_int];
                      field_cb[var15_int] = dupTemp$17 + 1;
                    ...
                    var7++;
                    field_n[incrementValue$19] = var8;
                    var8++;
                    continue L3;
                  }
                } else {
    ...
    final void a(int[] param0, int[] param1) {
        ...
        if (var5 >= 50 - this.field_O) {
          var15 = this.field_O * 92682 >> 16;
          if (var3 >= -var5 - var15) {
            if (var3 <= var5 + var15) {
              if (var4 >= -var5 - var15) {
                if (var4 <= var5 + var15) {
                  ...
                  L3: while (true) {
                    if (var27 >= this.field_S) {
                      try {
                        L4: {
                          this.a((var20 & var16) != 0, false, 0L, (int) this.field_O, this.field_O << 1);
                          break L4;
                        }
                      } catch (java.lang.Exception decompiledCaughtParameter0) {
                        decompiledCaughtException = decompiledCaughtParameter0;
                      ...
                      L6: {
                        var22 = this.field_W[var27];
                        var23 = this.field_C[var27];
                        var24 = this.field_B[var27];
    ...
    sk(od param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        L0: {
          ...
          param0.d();
          param0.b();
          this.field_S = param0.field_j;
          this.field_m = param0.field_R;
          this.field_W = param0.field_v;
          this.field_C = param0.field_s;
          this.field_B = param0.field_h;
          this.field_E = param0.field_t;
          this.field_t = param0.field_S;
          this.field_M = param0.field_q;
          this.field_y = param0.field_i;
          this.field_Q = param0.field_G;
          this.field_p = param0.field_n;
          ...
          if (param0.field_p == null) {
            ...
            this.field_F = new short[this.field_E];
            var9 = 0;
            L1: while (true) {
                ...
                if (var10 >= this.field_E) {
                  ...
                  L5: while (true) {
                    if (var10 >= param0.field_Q) {
                      this.field_Y = new int[this.field_r];
                      this.field_R = new int[this.field_r];
                      this.field_x = new int[this.field_r];
                      var10 = 0;
                      var11 = 0;
                      L6: while (true) {
                        if (var11 >= param0.field_Q) {
                          this.field_db = new byte[this.field_E];
                          var11 = 0;
                          L7: while (true) {
                            if (var11 >= this.field_E) {
                              ...
                              if (param0.field_y[var11] == -1) {
                                this.field_db[var11] = (byte)-1;
                                var11++;
                                continue L7;
                              } else {
                                this.field_db[var11] = (byte)var9_ref_int__[param0.field_y[var11] & 255];
                                if (this.field_db[var11] == -1) {
                                  if (this.field_F != null) {
                          ...
                          L8: {
                            if (var20[var11] <= 0) {
                              ...
                              if (param0.field_z[var11] != 0) {
                                ...
                                this.field_Y[var10] = param0.field_g[var11] & 65535;
                                this.field_R[var10] = param0.field_U[var11] & 65535;
                                this.field_x[var10] = param0.field_T[var11] & 65535;
                  ...
                  if (param0.field_y[var10] != -1) {
                    dupTemp$1 = param0.field_y[var10] & 255;
            ...
            if (var12 != -1) {
                ...
                L15: {
                  L16: {
                    if (param0.field_r == null) {
                      ...
                      if (param0.field_r[this.field_t[var16]] == null) {
                        break L16;
                      } else {
                        var13 = param0.field_r[this.field_t[var16]];
                        break L15;
                      }
                    }
                  }
                  var13 = param0.field_I[this.field_t[var16]];
                  break L15;
                }
                L17: {
                  L18: {
                    ...
                    if (param0.field_r == null) {
                      ...
                      if (param0.field_r[this.field_M[var16]] == null) {
                        break L18;
                      } else {
                        var13 = param0.field_r[this.field_M[var16]];
                        break L17;
                      }
                    }
                  }
                  var13 = param0.field_I[this.field_M[var16]];
                  break L17;
                }
                L19: {
                  L20: {
                    var14 = param1 + (param3 * var13.field_b + param4 * var13.field_c + param5 * var13.field_f) / (var8 * var13.field_g);
                    this.field_q[var16] = sk.d(var14);
                    if (param0.field_r == null) {
                      break L20;
                    } else {
                      if (param0.field_r[this.field_y[var16]] == null) {
                        break L20;
                      } else {
                        var13 = param0.field_r[this.field_y[var16]];
                        break L19;
                      }
                    }
                  }
                  var13 = param0.field_I[this.field_y[var16]];
                  break L19;
                }
                var14 = param1 + (param3 * var13.field_b + param4 * var13.field_c + param5 * var13.field_f) / (var8 * var13.field_g);
                this.field_l[var16] = sk.d(var14);
                var16++;
                continue L9;
              }
            } else {
              if (var10 != 0) {
                if (var10 != 1) {
                  ...
                  this.field_i[var16] = var14 | sk.a(param0.field_M[var16] & 65535, var14 >> 17);
                  this.field_l[var16] = -1;
                  var16++;
                  continue L9;
                }
                ...
                L23: {
                  L24: {
                    ...
                    this.field_i[var16] = var14 | sk.a(var15, var14 >> 17);
                    if (param0.field_r == null) {
                      break L24;
                    } else {
                      if (param0.field_r[this.field_M[var16]] == null) {
                ...
                L25: {
                  L26: {
                    var14 = param1 + (param3 * var13.field_b + param4 * var13.field_c + param5 * var13.field_f) / (var8 * var13.field_g) << 17;
                    this.field_q[var16] = var14 | sk.a(var15, var14 >> 17);
                    if (param0.field_r == null) {
                      break L26;
                    } else {
                      if (param0.field_r[this.field_y[var16]] == null) {
                ...
                var14 = param1 + (param3 * var13.field_b + param4 * var13.field_c + param5 * var13.field_f) / (var8 * var13.field_g) << 17;
                this.field_l[var16] = var14 | sk.a(var15, var14 >> 17);
                var16++;
                continue L9;
              }
            }
