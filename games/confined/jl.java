...
class jl extends rk {
    ...
    final void b(boolean param0) {
        ...
        this.field_q.field_o = this.field_o;
        this.field_o.field_q = this.field_q;
        this.field_o = null;
        this.field_q = null;
        if (!param0) {
            field_p = (int[]) null;
    ...
    final static nf[] a(int param0, int param1, int param2, mi param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_6_1 = new StringBuilder().append("jl.VC(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static void a(byte param0) {
        ...
        dn.field_b.a((fj) (ki.field_b), (byte) -72);
    }
    ...
    final static bm a(int[] param0, bm param1, int param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("jl.TC(");
