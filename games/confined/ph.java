...
final class ph extends rk {
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        kg var2 = new kg(param0);
        ((ph) this).field_r = var2.f((byte) 44);
        ((ph) this).field_F = var2.f((byte) 78);
        ...
        for (var4 = 0; var4 < var3; var4++) {
            ...
            var6 = new byte[var5];
            var2.a(0, (byte) 74, var5, var6);
            ((ph) this).field_N[var4] = var6;
        }
    }
    ...
    final bi b() {
        ...
        int var7 = 0;
        ((ph) this).field_T = 0;
        ((ph) this).field_q = new float[field_O];
        var1 = new byte[((ph) this).field_F];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((ph) this).field_N.length) {
            ((ph) this).field_q = null;
            return new bi(((ph) this).field_r, var1, ((ph) this).field_m, ((ph) this).field_I, ((ph) this).field_R);
          } else {
            var4 = this.c(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((ph) this).field_F - var2) {
                  break L1;
                } else {
                  var5 = ((ph) this).field_F - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    final static int a() {
        int var0 = field_Q[field_H] >> field_z & 1;
        field_z = field_z + 1;
        field_H = field_H + (field_z >> 3);
        field_z = field_z & 7;
        return var0;
    }
    ...
    final static ph a(mi param0, String param1, String param2) {
        try {
            ...
            byte[] var3 = param0.a(-51, param1, param2);
            if (var3 == null) {
                return null;
            }
            Object var4 = null;
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = ph.b(16);
                                    int discarded$4 = ph.b(16);
                                    field_u[var6] = ph.b(8);
                                    var6++;
                                    continue L6;
                                  }
    ...
    final static int b(int param0) {
        ...
        while (param0 >= 8 - field_z) {
            var3 = 8 - field_z;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_Q[field_H] >> field_z & var4) << var2);
            field_z = 0;
            field_H = field_H + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_Q[field_H] >> field_z & var3) << var2);
    ...
    private ph(byte[] param0) throws IOException {
        this.a(param0);
    }
    ...
    private final float[] c(int param0) {
        ...
        L0: {
          ph.a(((ph) this).field_N[param0], 0);
          int discarded$1 = ph.a();
          var2 = ph.b(km.b(4, field_u.length - 1));
        ...
        L8: {
          var14 = field_x[field_u[var2]];
          var16 = var14.field_c;
          var17_int = var14.field_b[var16];
          if (field_L[var17_int].a()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_a) {
            L10: {
              if (var15 != 0) {
                ...
                field_L[var18_int].a(field_v, var4 >> 1);
                break L10;
              }
            }
            L11: {
            ...
            L35: {
              var17 = null;
              if (((ph) this).field_T <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((ph) this).field_T + var4 >> 2;
                  ...
                  if (((ph) this).field_P) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((ph) this).field_w) {
                        break L36;
                      } else {
                        var20 = (((ph) this).field_T >> 1) + var19;
                        var40[var19] = var40[var19] + ((ph) this).field_q[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((ph) this).field_q;
              ((ph) this).field_q = field_v;
              field_v = var18;
              ((ph) this).field_T = var4;
              ((ph) this).field_w = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    private final static boolean a(mi param0) {
        byte[] var1 = null;
        if (!field_y) {
            var1 = param0.a((byte) -2, 0, 0);
            if (var1 == null) {
                return false;
            }
            ph.b(var1);
    ...
    final bi a(int[] param0) {
        ...
        L1: {
          if (((ph) this).field_M != null) {
            break L1;
          } else {
            ((ph) this).field_T = 0;
            ((ph) this).field_q = new float[field_O];
            ((ph) this).field_M = new byte[((ph) this).field_F];
            ((ph) this).field_J = 0;
            ((ph) this).field_t = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((ph) this).field_t >= ((ph) this).field_N.length) {
            ((ph) this).field_q = null;
            var14 = ((ph) this).field_M;
            ((ph) this).field_M = null;
            return new bi(((ph) this).field_r, var14, ((ph) this).field_m, ((ph) this).field_I, ((ph) this).field_R);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((ph) this).field_J;
                  var4 = var13.length;
                  if (var4 <= ((ph) this).field_F - var3) {
                    break L5;
                  } else {
                    var4 = ((ph) this).field_F - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((ph) this).field_J);
                        break L7;
                      }
                    }
                    ((ph) this).field_J = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((ph) this).field_t = ((ph) this).field_t + 1;
            continue L2;
          }
        }
    }
