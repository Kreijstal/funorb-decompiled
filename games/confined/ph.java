...
final class ph extends rk {
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        this.field_r = var2.f((byte) 44);
        this.field_F = var2.f((byte) 78);
        this.field_m = var2.f((byte) 46);
        this.field_I = var2.f((byte) 51);
        if (this.field_I < 0) {
    ...
    final bi b() {
        ...
        int var7 = 0;
        this.field_T = 0;
        this.field_q = new float[field_O];
        ...
        L0: while (true) {
          if (var3 >= this.field_N.length) {
            this.field_q = null;
            return new bi(this.field_r, var1, this.field_m, this.field_I, this.field_R);
          } else {
            var4 = this.c(var3);
            if (var4 != null) {
              L1: {
    ...
    final static ph a(mi param0, String param1, String param2) {
        try {
            ...
            ph var4_ref = null;
            if (!ph.a(param0)) {
                discarded$0 = param0.a(param1, param2, 255);
                return null;
            }
    ...
    final static ph a(mi param0, int param1, int param2) {
        try {
            ...
            ph var4_ref = null;
            if (!ph.a(param0)) {
                discarded$0 = param0.a(param1, param2, 0);
                return null;
            }
              ...
              if (this.field_T <= 0) {
                ...
                L36: {
                  ...
                  if (this.field_P) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= this.field_w) {
                        break L36;
                      } else {
                        var20 = (this.field_T >> 1) + var19;
                        var40[var19] = var40[var19] + this.field_q[var20];
                        var19++;
                        continue L37;
                      }
                    }
    ...
    final bi a(int[] param0) {
        ...
        L2: while (true) {
          if (this.field_t >= this.field_N.length) {
            this.field_q = null;
            var12 = this.field_M;
            this.field_M = null;
            return new bi(this.field_r, var12, this.field_m, this.field_I, this.field_R);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
              ...
              if (var7 == null) {
                ...
                L6: while (true) {
                  if (var5 >= var4) {
                    ...
                    var3++;
                    this.field_M[incrementValue$1] = (byte)(var6 - 128);
                    var5++;
                    continue L6;
                  }
                }
