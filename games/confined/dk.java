...
class dk {
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new hg();
                          var4 = var5;
                          stackIn_10_0 = (hg) (var4);

                          stackIn_10_1 = 256;

                          if (!field_j) {
                            stackIn_11_0 = (hg) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_g <= 0) {
                            ...
                            if (field_f != null) {
                              ...
                              param0.a((byte) 50, (Runnable) ((Object) field_f), field_g);
                              break L5;
                            }
                          }
                        }
                ...
                L0: {
                  ...
                  L2: while (true) {
                    if (var1 <= this.field_h + 5000L) {
                      ...
                      this.a(256);
                      this.field_h = this.field_h + (long)(256000 / field_k);
                      var1 = ri.a(-3);
                      continue L2;
                    }
                  }
              ...
              if (this.field_l != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.b();
                      if (this.field_o - var3_int <= this.field_p) {
                        break L6;
                      } else {
                        this.field_p = this.field_o - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_s + this.field_a;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_i) {
                        break L8;
                      } else {
                        L9: {
                          this.field_i = this.field_i + 1024;
                          if (this.field_i <= 16384) {
                            break L9;
                          } else {
                            this.field_i = 16384;
                            break L9;
                        ...
                        if (var4 + 256 <= this.field_i) {
                          ...
                          var4 = this.field_i - 256;
                          this.field_a = var4 - this.field_s;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_d) {
                            ...
                            L12: {
                              if (this.field_u) {
                                ...
                                this.field_a = Math.min(this.field_b, this.field_p);
        ...
        L1: {
          ...
          if (this.field_m == null) {
            ...
            if (this.field_q > 0) {
              ...
              this.field_q = this.field_q + (field_k >> 4);
              dk.a(this.field_m);
                                ...
                                if (var4 < this.field_r) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_e[var7_int] = (gf) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((gf) (var7)).field_p;
                        ((gf) (var7)).field_p = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
    ...
    dk() {
        ...
        this.field_p = 0;
        this.field_b = 0;
        this.field_c = new gf[8];
        this.field_d = 0L;
        this.field_o = 0;
        this.field_e = new gf[8];
        this.field_u = true;
        this.field_t = 0L;
        this.field_q = 0;
    }
