...
final class vc extends gf {
    ...
    final int b() {
        int var1 = this.field_C * 3 >> 6;
        var1 = (var1 ^ var1 >> 31) + (var1 >>> 31);
        if (this.field_D == 0) {
            var1 = var1 - var1 * this.field_t / (((bi) ((Object) this.field_n)).field_o.length << 8);
        } else {
            if (this.field_D >= 0) {
                var1 = var1 - var1 * this.field_u / ((bi) ((Object) this.field_n)).field_o.length;
            }
        }
          ...
          if (this.field_r == var4) {
            if (this.field_x == var5) {
              ...
              L0: {
                ...
                if (this.field_C - param1 <= var6) {
                  break L0;
                } else {
                  var6 = this.field_C - param1;
                  break L0;
                }
              }
              L1: {
              ...
              this.field_A = param1;
              this.field_w = param2;
              this.field_z = (param1 - this.field_C) / param0;
              this.field_E = (var4 - this.field_r) / param0;
              this.field_y = (var5 - this.field_x) / param0;
              return;
            }
          } else {
            L6: {
        ...
        L0: while (true) {
          if (this.field_q <= 0) {
            L1: {
              if (this.field_B != -256) {
                ...
                if ((this.field_t & 255) != 0) {
                  ...
                  if (dk.field_j) {
                    return vc.a(0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_r, this.field_x, 0, param3, param2, (vc) (this));
                  } else {
                    return vc.a(((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_C, 0, param3, param2, (vc) (this));
                  }
                }
              }
            }
            if (dk.field_j) {
              return vc.c(0, 0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_r, this.field_x, 0, param3, param2, (vc) (this), this.field_B, param4);
            } else {
              return vc.a(0, 0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_C, 0, param3, param2, (vc) (this), this.field_B, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_B != -256) {
                  ...
                  if ((this.field_t & 255) != 0) {
                    ...
                    if (!dk.field_j) {
                      param1 = vc.a(((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_C, this.field_z, 0, var6, param2, (vc) (this));
                      break L3;
                    } else {
                      param1 = vc.a(0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_r, this.field_x, this.field_E, this.field_y, 0, var6, param2, (vc) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!dk.field_j) {
                param1 = vc.a(0, 0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_C, this.field_z, 0, var6, param2, (vc) (this), this.field_B, param4);
                break L3;
              } else {
                param1 = vc.a(0, 0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_r, this.field_x, this.field_E, this.field_y, 0, var6, param2, (vc) (this), this.field_B, param4);
                break L3;
              }
            }
            this.field_q = this.field_q - param1;
    ...
    final synchronized void e(int param0) {
        param0 = param0 << 8;
        int var2 = ((bi) ((Object) this.field_n)).field_o.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
    ...
    private final boolean g() {
        ...
        L0: {
          var1 = this.field_A;
          if (var1 != -2147483648) {
            var2 = vc.a(var1, this.field_w);
            var3 = vc.e(var1, this.field_w);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_C >= var1) {
            if (this.field_C <= var1) {
              ...
              this.field_z = -1;
              this.field_q = this.field_C - var1;
              break L2;
            }
          } else {
            this.field_z = 1;
            this.field_q = var1 - this.field_C;
            break L2;
          }
        }
        L3: {
          if (this.field_r >= var2) {
            if (this.field_r <= var2) {
              ...
              L4: {
                ...
                if (this.field_q == 0) {
                  ...
                  if (this.field_q <= this.field_r - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_q = this.field_r - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_q == 0) {
                ...
                if (this.field_q <= var2 - this.field_r) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_q = var2 - this.field_r;
            break L3;
          }
        }
        if (this.field_x < var3) {
          this.field_y = 1;
          if (this.field_q != 0) {
            if (this.field_q > var3 - this.field_x) {
              this.field_q = var3 - this.field_x;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_x <= var3) {
              ...
              L7: {
                ...
                if (this.field_q == 0) {
                  ...
                  if (this.field_q <= this.field_x - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_q = this.field_x - var3;
              break L6;
            }
          }
          return false;
    ...
    final int c() {
        if (this.field_A == 0 && this.field_q == 0) {
            return 0;
        }
        return 1;
    }
        ...
        L0: while (true) {
          if (this.field_q <= 0) {
            L1: {
              if (this.field_B != 256) {
                ...
                if ((this.field_t & 255) != 0) {
                  ...
                  if (dk.field_j) {
                    return vc.b(0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_r, this.field_x, 0, param3, param2, (vc) (this));
                  } else {
                    return vc.b(((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_C, 0, param3, param2, (vc) (this));
                  }
                }
              }
            }
            if (dk.field_j) {
              return vc.d(0, 0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_r, this.field_x, 0, param3, param2, (vc) (this), this.field_B, param4);
            } else {
              return vc.b(0, 0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_C, 0, param3, param2, (vc) (this), this.field_B, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_q;
            ...
            L3: {
              L4: {
                ...
                if (this.field_B != 256) {
                  ...
                  if ((this.field_t & 255) != 0) {
                    ...
                    if (!dk.field_j) {
                      param1 = vc.b(((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_C, this.field_z, 0, var6, param2, (vc) (this));
                      break L3;
                    } else {
                      param1 = vc.b(0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_r, this.field_x, this.field_E, this.field_y, 0, var6, param2, (vc) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!dk.field_j) {
                param1 = vc.b(0, 0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_C, this.field_z, 0, var6, param2, (vc) (this), this.field_B, param4);
                break L3;
              } else {
                param1 = vc.b(0, 0, ((bi) ((Object) this.field_n)).field_o, param0, this.field_t, param1, this.field_r, this.field_x, this.field_E, this.field_y, 0, var6, param2, (vc) (this), this.field_B, param4);
                break L3;
              }
            }
            this.field_q = this.field_q - param1;
        ...
        if (param0 != 0) {
          if (this.field_r == 0) {
            if (this.field_x == 0) {
              ...
              this.field_z = -this.field_C / param0;
              this.field_E = -this.field_r / param0;
              this.field_y = -this.field_x / param0;
              return;
            }
          } else {
            L6: {
    ...
    final synchronized void b(int param0, int param1) {
        this.field_A = param0 << 6;
        this.field_w = param1 << 6;
        this.field_q = 0;
        this.h();
    }
    ...
    final static vc a(bi param0, int param1, int param2) {
        if (param0.field_o != null) {
          if (param0.field_o.length == 0) {
            ...
            return new vc(param0, param1, param2 << 6);
          }
        } else {
          return null;
        }
    ...
    private final void h() {
        ...
        this.field_r = vc.a(this.field_A, this.field_w);
        this.field_x = vc.e(this.field_A, this.field_w);
    }
          ...
          L4: {
            if (this.field_D <= 0) {
              ...
              if (!this.field_v) {
                if (this.field_B >= 0) {
                  L5: while (true) {
                    var9 = this.a(param0, var9, var6, param2, (int) var4.field_o[this.field_u]);
                    if (this.field_t >= var6) {
                      ...
                      if (var10 < this.field_D) {
                        ...
                        this.field_t = this.field_t - var8 * this.field_D;
                        this.field_D = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_o[this.field_s - 1]);
                ...
                L7: {
                  if (this.field_B >= 0) {
                    ...
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_o[this.field_u]);
                    if (this.field_t < var5) {
                ...
                L8: while (true) {
                  var9 = this.a(param0, var9, var6, param2, (int) var4.field_o[this.field_s - 1]);
                  if (this.field_t >= var6) {
    ...
    final synchronized void b(int param0) {
        ...
        L0: {
          if (this.field_q <= 0) {
            ...
            if (param0 < this.field_q) {
              this.field_C = this.field_C + this.field_z * param0;
              this.field_r = this.field_r + this.field_E * param0;
              this.field_x = this.field_x + this.field_y * param0;
        ...
        this.field_t = this.field_t + this.field_B * param0;
        if (this.field_D >= 0) {
          L5: {
            if (this.field_D <= 0) {
              break L5;
                  ...
                  if (this.field_B >= 0) {
                    if (this.field_t >= var4) {
                      ...
                      if (var7 < this.field_D) {
                        ...
                        this.field_t = this.field_t - var6 * this.field_D;
                        this.field_D = 0;
                        break L5;
                      }
                    } else {
    ...
    private vc(bi param0, int param1, int param2) {
        this.field_n = (ob) ((Object) param0);
        this.field_u = param0.field_p;
        this.field_s = param0.field_r;
        this.field_v = param0.field_q;
        this.field_B = param1;
        this.field_A = param2;
        this.field_w = 8192;
        this.field_t = 0;
