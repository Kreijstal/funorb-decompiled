...
class nf extends pl {
    ...
    final void a(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            nf.a(0, fn.field_h, this.field_z, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    void d(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            nf.b(fn.field_h, this.field_z, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    void b(int param0, int param1) {
        ...
        int var4 = param0 + (this.field_u >> 1) > fn.field_i ? fn.field_i - param0 << 1 : this.field_u;
        int var5 = param1 < fn.field_b ? fn.field_b - param1 << 1 : 0;
        int var6 = param1 + (this.field_w >> 1) > fn.field_j ? fn.field_j - param1 << 1 : this.field_w;
        nf.a(this.field_z, var5 * this.field_u + var3, (param1 + (var5 >> 1)) * fn.field_g + (param0 + (var3 >> 1)), (this.field_u << 1) - (var4 - var3) + (this.field_u & 1), fn.field_g - (var4 - var3 >> 1), this.field_u, var4 - var3 >> 1, var6 - var5 >> 1);
    }
    ...
    final void d() {
        fn.a(this.field_z, this.field_u, this.field_w);
    }
        ...
        L0: {
          if (param2 > this.field_t) {
            ...
            if (param3 <= this.field_x) {
              L1: {
                var5 = param0 + this.field_s * param2 / this.field_t;
                var6 = param0 + ((this.field_s + this.field_u) * param2 + this.field_t - 1) / this.field_t;
                var7 = param1 + this.field_v * param3 / this.field_x;
                var8 = param1 + ((this.field_v + this.field_w) * param3 + this.field_x - 1) / this.field_x;
                if (var5 >= fn.field_c) {
                  break L1;
                } else {
                  var5 = fn.field_c;
                    ...
                    if (var11 >= var8) {
                      ...
                      L6: while (true) {
                        if (var12 >= var6) {
                          ...
                          var15 = var13 * this.field_t / param2 - (this.field_s << 4);
                          var16 = (var13 + 16) * this.field_t / param2 - (this.field_s << 4);
                          var17 = var14 * this.field_x / param3 - (this.field_v << 4);
                          var18 = (var14 + 16) * this.field_x / param3 - (this.field_v << 4);
                              ...
                              if (var29 > var18) {
                                ...
                                L16: while (true) {
                                  if (var31 > var16) {
                                    ...
                                    L17: {
                                      var32 = this.field_z[var29 * this.field_u + var31];
                                      if (var32 != 0) {
                                        break L17;
                                      } else {
                                        var32 = var28;
    ...
    final void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            if (param4 == 256) {
                nf.a(0, 0, 0, var8, this.field_z, fn.field_h, 0, 0, -param3, var9, var14, var15, param2, var12, var13, var6);
            } else {
                nf.a(0, 0, 0, var8, this.field_z, fn.field_h, 0, 0, -param3, var9, var14, var15, param2, var12, var13, var6, param4);
            }
            return;
        }
    }
          ...
          if (param2 >= this.field_w - 1) {
            ...
            L5: {
              if (param1 < 0) {
                ...
                L6: {
                  var9 = this.field_z[var6 + this.field_u];
                  if (var9 == 0) {
                    stackIn_19_0 = 0;
                    break L6;
                  } else {
            ...
            if (param1 >= this.field_u - 1) {
              ...
              L7: {
                var10 = this.field_z[var6 + this.field_u + 1];
                if (var10 == 0) {
                  stackIn_25_0 = 0;
                  break L7;
                } else {
    ...
    final nf c() {
        int var3 = 0;
        nf var1 = new nf(this.field_u, this.field_w);
    ...
    void b(int param0, int param1, int param2, int param3) {
        ...
        if (param2 > 0) {
            ...
            nf.a(fn.field_h, this.field_z, 0, var7, var8, var13, var14, param2, param3, var11, var12, var5);
            return;
        }
    }
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                param2++;
                fn.field_h[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
          ...
          if (param3 > 0) {
            ...
            L8: while (true) {
              if (!k.d()) {
                ...
                if (param4 != 256) {
                  nf.a(0, 0, 0, var22, this.field_z, fn.field_h, 0, 0, -1, var23, var21, 0, var19 - var18, var12, var13, var6, param4);
                  continue L8;
                } else {
                  nf.a(0, 0, 0, var22, this.field_z, fn.field_h, 0, 0, -1, var23, var21, 0, var19 - var18, var12, var13, var6);
                  continue L8;
                }
              }
            }
    ...
    void c(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            nf.a(fn.field_h, this.field_z, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    void a(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            nf.b(fn.field_h, this.field_z, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    void c(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            if (param2 == 256) {
                nf.a(0, 0, 0, fn.field_h, this.field_z, var5, 0, var4, 0, var7, var6, var8, var9);
            } else {
                nf.a(0, 0, 0, fn.field_h, this.field_z, var5, 0, var4, 0, var7, var6, var8, var9, param2);
            }
            return;
        }
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          L0: {
            ...
            var17 = ((this.field_u << 4) - param0) * var10 + ((this.field_w << 4) - param1) * var9;
            var18 = -((this.field_u << 4) - param0) * var9 + ((this.field_w << 4) - param1) * var10;
            if (var11 >= var13) {
              var19 = var13;
              var20 = var11;
              break L0;
                              ...
                              if (var28 > var18) {
                                ...
                                L15: while (true) {
                                  if (var30 > var16) {
                                    ...
                                    var31 = this.field_z[var28 * this.field_u + var30];
                                    if (var31 != 0) {
                                      L16: {
                                        var32 = var29;
                                        if (var30 != var15) {
    ...
    final void d(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            nf.a(fn.field_h, this.field_z, param2, var5, var4, var7, var6, var8, var9);
            return;
        }
    }
    ...
    void b(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            nf.a(fn.field_h, this.field_z, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    final nf b() {
        ...
        var1.field_t = this.field_t;
        var1.field_x = this.field_x;
        var1.field_s = this.field_t - this.field_u - this.field_s;
        var1.field_v = this.field_v;
        for (var2 = 0; var2 < this.field_w; var2++) {
            for (var3 = 0; var3 < this.field_u; var3++) {
                var1.field_z[var2 * this.field_u + var3] = this.field_z[var2 * this.field_u + this.field_u - 1 - var3];
            }
        }
        return var1;
    }
    ...
    final void a() {
        ...
        int incrementValue$0 = 0;
        int var3 = 0;
        int[] var1 = new int[this.field_u * this.field_w];
        int var2 = 0;
        for (var3 = 0; var3 < this.field_u; var3++) {
            for (var4 = this.field_w - 1; var4 >= 0; var4--) {
                incrementValue$0 = var2;
                var2++;
                var1[incrementValue$0] = this.field_z[var3 + var4 * this.field_u];
            }
        }
        this.field_z = var1;
        var3 = this.field_v;
        this.field_v = this.field_s;
        this.field_s = this.field_x - this.field_w - var3;
        var3 = this.field_w;
    ...
    nf(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            this.field_s = 0;
            this.field_v = 0;
            this.field_z = new int[this.field_u * this.field_w];
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_u, this.field_w, this.field_z, 0, this.field_u);
            var5.grabPixels();
            break L0;
          }
    ...
    void c(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            nf.a(fn.field_h, this.field_z, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
            return;
        }
    }
