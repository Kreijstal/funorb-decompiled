    ...
    final int f(byte param0) {
        ...
        try {
          L0: {
            ...
            stackOut_3_0 = (this.field_m[this.field_n - 1] & 255) + (((this.field_m[-4 + this.field_n] & 255) << 66763768) + (this.field_m[this.field_n + -3] << -1741991600 & 16711680)) - -(this.field_m[this.field_n - 2] << -1539204536 & 65280);
    ...
    final void a(int param0, byte param1, int param2, byte[] param3) {
        ...
        try {
              ...
              L3: {
                L4: {
                  if (var5_int >= param0 - -param2) {
                    ...
                    param3[var5_int] = this.field_m[fieldTemp$2];
                    var5_int++;
                    if (var6 != 0) {
                      break L3;
                    } else {
          ...
          L5: {
            ...
            stackOut_11_1 = new StringBuilder().append("kg.E(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            ...
            if (0 != var2) {
              ...
              L17: {
                if (var5_ref != null) {
                  ...
                  if (null == var5_ref) {
                    ...
                    ij.field_t.a((long)var7.hashCode(), var5_ref, 117);
                    break L17;
                  }
                }
              }
              L18: {
                if (null != var5_ref) {
                  ...
                  var5_ref = new fg();
                  ij.field_t.a((long)var7.hashCode(), var5_ref, param0 ^ -71);
                  fieldTemp$5 = Confined.field_E;
        ...
        try {
          L0: {
            L1: {
              ...
              this.field_n = this.field_n + 1;
              this.field_m[fieldTemp$8] = (byte)(param1 >> 2050146744);
              if (param0 < -81) {
                break L1;
              } else {
                this.field_n = -111;
            ...
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$9] = (byte)(param1 >> -4146832);
            fieldTemp$10 = this.field_n;
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$10] = (byte)(param1 >> -481940536);
            fieldTemp$11 = this.field_n;
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$11] = (byte)param1;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
        ...
        try {
          L0: {
            if (param0 == -11) {
              ...
              if ((var2_int ^ -1) > -129) {
                stackOut_6_0 = this.c(32);
                stackIn_7_0 = stackOut_6_0;
                decompiledRegionSelector0 = 2;
                break L0;
              } else {
                stackOut_4_0 = this.a((byte) 25) + -32768;
    ...
    final int f(int param0) {
        ...
        try {
          L0: {
            ...
            stackOut_3_0 = (255 & this.field_m[this.field_n + -1]) + (16711680 & this.field_m[this.field_n - 3] << -1603816944) - -((this.field_m[-2 + this.field_n] & 255) << -1034845784);
            stackIn_4_0 = stackOut_3_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    final int b(int param0) {
        ...
        try {
          L0: {
            ...
            if (var2_int < 128) {
              stackOut_6_0 = -64 + this.c(32);
              stackIn_7_0 = stackOut_6_0;
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
              stackOut_4_0 = this.a((byte) 25) + -49152;
              stackIn_5_0 = stackOut_4_0;
              decompiledRegionSelector0 = 0;
              break L0;
            }
    ...
    final void c(int param0, int param1) {
        ...
        try {
          L0: {
            ...
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$4] = (byte)(param0 >> -419425656);
            fieldTemp$5 = this.field_n;
            this.field_n = this.field_n + 1;
        ...
        try {
          L0: {
            ...
            if ((this.field_m[this.field_n] ^ -1) <= -1) {
              stackOut_3_0 = this.a((byte) 25);
              stackIn_4_0 = stackOut_3_0;
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
              stackOut_1_0 = this.f((byte) 37) & 2147483647;
              stackIn_2_0 = stackOut_1_0;
              decompiledRegionSelector0 = 0;
              break L0;
            }
    ...
    final void a(long param0, byte param1) {
        ...
        try {
          L0: {
            fieldTemp$8 = this.field_n;
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$8] = (byte)(int)(param0 >> 1157207480);
            fieldTemp$9 = this.field_n;
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$9] = (byte)(int)(param0 >> -545494096);
            fieldTemp$10 = this.field_n;
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$10] = (byte)(int)(param0 >> -605213976);
            fieldTemp$11 = this.field_n;
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$11] = (byte)(int)(param0 >> 1754237280);
            var4_int = -85 / ((param1 - 40) / 62);
            fieldTemp$12 = this.field_n;
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$12] = (byte)(int)(param0 >> 594611736);
            fieldTemp$13 = this.field_n;
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$13] = (byte)(int)(param0 >> -907947184);
            fieldTemp$14 = this.field_n;
            this.field_n = this.field_n + 1;
            this.field_m[fieldTemp$14] = (byte)(int)(param0 >> -1561113400);
          ...
          throw sd.a((Throwable) ((Object) var4), "kg.H(" + param0 + ',' + param1 + ')');
        }
    }
    ...
    final void a(int param0, int[] param1) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_16_1 = new StringBuilder().append("kg.W(").append(param0).append(',');
    ...
    final void a(int param0, int[] param1, int param2, byte param3) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_17_1 = new StringBuilder().append("kg.C(").append(param0).append(',');
            stackIn_20_0 = stackOut_17_0;
            stackIn_20_1 = stackOut_17_1;
    ...
    final void a(int param0, String param1) {
        ...
        try {
          ...
          L10: {
            ...
            stackOut_35_1 = new StringBuilder().append("kg.KA(").append(param0).append(',');
          ...
          L0: {
            ...
            L1: while (true) {
              ...
              if (-1 == (this.field_m[fieldTemp$2] ^ -1)) {
                ...
                if (param0) {
                  if (0 != var3) {
                    stackOut_10_0 = kh.a(this.field_m, var3, 0, var2_int);
                    stackIn_11_0 = stackOut_10_0;
                    decompiledRegionSelector0 = 2;
                    break L0;
                  } else {
    ...
    final void a(int param0, int param1, byte[] param2, int param3) {
        ...
        try {
              ...
              L3: {
                L4: {
                  if ((var5_int ^ -1) <= (param0 + param1 ^ -1)) {
                    ...
                    fieldTemp$2 = this.field_n;
                    this.field_n = this.field_n + 1;
                    this.field_m[fieldTemp$2] = param2[var5_int];
                    var5_int++;
                    if (var6 != 0) {
                      break L3;
                    } else {
          ...
          L5: {
            var5 = decompiledCaughtException;
            stackOut_11_0 = (RuntimeException) (var5);
            stackOut_11_1 = new StringBuilder().append("kg.FA(").append(param0).append(',').append(param1).append(',');
            stackIn_14_0 = stackOut_11_0;
            stackIn_14_1 = stackOut_11_1;
            stackIn_12_0 = stackOut_11_0;
            stackIn_12_1 = stackOut_11_1;
          ...
          L0: {
            L1: {
              if (param0 == 32) {
                ...
                discarded$4 = this.e(84, -126);
                break L1;
              }
            }
            fieldTemp$5 = this.field_n;
            this.field_n = this.field_n + 1;
            stackOut_3_0 = this.field_m[fieldTemp$5] & 255;
            stackIn_4_0 = stackOut_3_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    final int a(byte param0) {
        ...
        try {
          L0: {
            ...
            stackOut_3_0 = (this.field_m[this.field_n + -2] << 2085600552 & 65280) + (this.field_m[this.field_n - 1] & 255);
            stackIn_4_0 = stackOut_3_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L0: {
            ...
            if ((var2_int ^ -1) != -1) {
              ...
              L1: while (true) {
                fieldTemp$5 = this.field_n;
                this.field_n = this.field_n + 1;
                if ((this.field_m[fieldTemp$5] ^ -1) == -1) {
                  L2: {
                    if (param0 == 31) {
                      break L2;
                    } else {
                  ...
                  if (0 == var4) {
                    ...
                    stackOut_16_0 = kh.a(this.field_m, var4, 0, var3);
                    stackIn_17_0 = stackOut_16_0;
                    decompiledRegionSelector0 = 1;
                    break L0;
                  }
