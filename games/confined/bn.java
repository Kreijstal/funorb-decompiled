    ...
    final static short[] a(int param0, hb param1, short[] param2, int param3) {
        ...
        try {
                ...
                if (var5 > 0) {
                  ...
                  L4: while (true) {
                    if (var7 >= var4_int) {
                      ...
                      param2[var7] = (short)(var6 + param1.g(var5, param0));
                      var7++;
                      continue L4;
                    }
                  }
          ...
          L6: {
            ...
            stackOut_17_1 = new StringBuilder().append("bn.B(").append(param0).append(44);
    ...
    bn(String param0, boolean param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("bn.<init>(");
