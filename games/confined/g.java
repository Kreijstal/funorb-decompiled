    ...
    final static em a(int param0, long param1, boolean param2, String param3, String param4) {
        ...
        try {
          L0: {
            L1: {
              if (param1 != 0L) {
                ...
                if (param3 != null) {
                  stackOut_6_0 = new ii(param3, param4);
                  stackIn_7_0 = stackOut_6_0;
                  return (em) (Object) stackIn_7_0;
                } else {
                  break L1;
                }
              }
            }
            stackOut_10_0 = new ai(param1, param4);
          ...
          L2: {
            ...
            stackOut_12_1 = new StringBuilder().append("g.A(").append(-26547).append(',').append(param1).append(',').append(false).append(',');
