    ...
    final void a(kg param0, nk param1) {
        ...
        L0: {
          ...
          if (var3 == 0) {
            ...
            this.field_h[0] = param0.a((byte) 25);
            this.field_h[1] = param0.a((byte) 25);
            var4 = param0.c(32);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                    ...
                    L4: while (true) {
                      if (var7 >= this.field_g[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_a[var5][1][var7] = param0.a((byte) 25);
                          this.field_d[var5][1][var7] = param0.a((byte) 25);
                          var7++;
                          continue L4;
                        }
                      }
                ...
                L5: while (true) {
                  if (var6 >= this.field_g[var5]) {
                    ...
                    this.field_a[var5][0][var6] = param0.a((byte) 25);
                    this.field_d[var5][0][var6] = param0.a((byte) 25);
                    var6++;
                    continue L5;
                  }
                }
