...
final class hb extends kg {
    ...
    final void a(byte[] param0, int param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (param2 <= var5_int) {
                ...
                param0[var5_int + param3] = (byte)(this.field_m[fieldTemp$2] + -this.field_q.c(km.a(param1, 256)));
                var5_int++;
                continue L1;
              }
            }
          ...
          L2: {
            ...
            stackIn_7_1 = new StringBuilder().append("hb.NA(");
    ...
    final static void a(byte param0, String param1) {
        ...
        try {
          ...
          L9: {
            ...
            stackIn_44_1 = new StringBuilder().append("hb.VA(").append(param0).append(',');
    ...
    final int h(int param0) {
        ...
        if (param0 != -1) {
          ...
          fieldTemp$2 = this.field_n;
          this.field_n = this.field_n + 1;
          return this.field_m[fieldTemp$2] + -this.field_q.c(param0 ^ -257) & 255;
        } else {
          fieldTemp$3 = this.field_n;
          this.field_n = this.field_n + 1;
          return this.field_m[fieldTemp$3] + -this.field_q.c(param0 ^ -257) & 255;
        }
    }
