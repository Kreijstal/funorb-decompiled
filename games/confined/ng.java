...
final class ng {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, df param6, String param7, int param8) {
        try {
            ...
            throw sd.a((Throwable) (Object) runtimeException, "ng.B(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + (param6 != null ? "{...}" : "null") + 44 + (param7 != null ? "{...}" : "null") + 44 + param8 + 41);
        }
    }
    ...
    final static void a(mi param0, int param1, mi param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("ng.C(");
