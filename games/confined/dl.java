        ...
        if (param0 != 100) {
          if (param0 != 5000) {
            if (param1 < -98) {
              if (30000 != param0) {
                ...
                if ((sc.field_f ^ -1) < -1) {
                  ...
                  var2_ref_byte__ = hf.field_Z[sc.field_f - 1];
            ...
            if (-1 <= (rj.field_a ^ -1)) {
              ...
              var2_ref_byte__ = rk.field_c[rj.field_a - 1];
          ...
          if (fi.field_c <= 0) {
            ...
            var2_ref_byte__ = wd.field_d[fi.field_c - 1];
