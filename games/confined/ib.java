...
final class ib extends fj {
    ...
    final static void b(boolean param0) {
        ...
        var1.field_s = null;
        m.field_d.a((rk) (Object) var1, (byte) -108);
    }

    final void a(int param0, boolean param1, int param2) {
        ((ib) this).field_Y = (param2 & 16711422) >> 1183576513;
        ((ib) this).field_Z = param0;
        ((ib) this).field_I = param2;
        ((ib) this).field_S = (16711422 & param0) >> -1535752223;
        if (param1) {
            return;
        }
        this.g((byte) -127);
    ...
    final void a(fj param0, int param1, int param2, int param3) {
        if (((ib) this).field_N) {
            ((ib) this).field_H = ((ib) this).field_H + 1;
            if (((ib) this).field_P * 2 < ((ib) this).field_H) {
                ((ib) this).field_H = ((ib) this).field_H - 2 * ((ib) this).field_P;
            }
        }
        if (param1 != 11579568) {
            this.g((byte) 88);
    ...
    private final nf b(int param0, byte param1, int param2) {
        ...
        vm.a(var14, -8409);
        var5 = ((ib) this).field_z >> -1325943167;
        var6 = 0;
        L1: while (true) {
          if (((ib) this).field_z <= var6) {
            ...
            L2: {
              var7 = (2 * ((ib) this).field_P - 1) * (var6 >> 692616481) % (2 * ((ib) this).field_P);
            ...
            L3: {
              var12 = stackIn_7_0;
              fn.b(var7, var6, ((ib) this).field_P, var12);
              var9 = param2 & 65280;
              var8 = param2 & 16711935;
              fn.b(var7 + -(((ib) this).field_P * 2), var6, ((ib) this).field_P, var12);
              if (256 > var11) {
            ...
            var12 = stackIn_10_0;
            fn.b(((ib) this).field_P + var7, var6, ((ib) this).field_P, var12);
            fn.b(var7 + -((ib) this).field_P, var6, ((ib) this).field_P, var12);
            var6++;
            continue L1;
          }
        }
    ...
    private final void a(byte param0, nf param1, int param2, int param3) {
        ...
        var5 = ((ib) this).field_F + param2;
        lc.a(param2 + ((ib) this).field_K.field_u, -((ib) this).field_K.field_u + var5, param3 + ((ib) this).field_z, param3, 14907);
        ...
        L0: while (true) {
          if (var6 >= var5) {
            ...
            L2: {
              if (fn.field_i >= var5 + -((ib) this).field_K.field_u) {
                vm.a(((ib) this).field_L, -8409);
                ...
                L3: while (true) {
                  if (2 * ((ib) this).field_P >= var7) {
                    ...
                    ib.b(false);
                    ((ib) this).field_L.d(var5 + -((ib) this).field_K.field_u, param3);
                    break L2;
                  } else {
                    var7 = var7 - ((ib) this).field_P * 2;
                    continue L3;
                  }
                }
              } else {
    ...
    private final nf f(int param0) {
        ...
        int var2 = ((ib) this).field_z >> 1390068513;
        ...
        while (((ib) this).field_z > var4) {
            for (var6 = 0; var2 > var6; var6++) {
                var7 = (double)var6 * (double)var6 / (double)(var4 * (((ib) this).field_z - var4));
                var9 = 1;
                if (!(var7 >= 1.0)) {
    ...
    final static void c(boolean param0) {
        ...
        hb.field_u = new bf();
        dn.field_b.a((fj) (Object) hb.field_u, (byte) -72);
    }
    ...
    final void a(int param0, int param1, byte param2, int param3) {
        ...
        int var5 = ((ib) this).field_q + param3;
        int var6 = ((ib) this).field_m + param0;
        this.a((byte) -80, ((ib) this).field_X[0], var5, var6);
        if (65536 > ((ib) this).field_R) {
            lc.a((((ib) this).field_F * ((ib) this).field_R >> -216969712) + var5, ((ib) this).field_F + var5, var6 + ((ib) this).field_z, var6, 14907);
    ...
    private final void g(byte param0) {
        ((ib) this).field_X = new nf[]{this.b(((ib) this).field_Z, (byte) -81, ((ib) this).field_I), this.b(((ib) this).field_S, (byte) -120, ((ib) this).field_Y)};
        ((ib) this).field_K = this.f(124);
        ((ib) this).field_U = ((ib) this).field_K.b();
        ((ib) this).field_L = new nf(((ib) this).field_z >> 1572873025, ((ib) this).field_z);
        if (param0 >= -105) {
            ((ib) this).field_S = -14;
        }
    }
    ...
    private ib(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ((ib) this).field_P = param4;
        ((ib) this).field_Y = param8;
        ((ib) this).field_S = param7;
        ((ib) this).field_Z = param5;
        ((ib) this).field_I = param6;
        ((ib) this).a(-126, param2, param1, param3, param0);
    }
