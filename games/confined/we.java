...
final class we {
    ...
    public static void a(byte param0) {
        field_b = null;
        if (param0 != -21) {
            we.a(86, false, (byte) 113, true, -103, true);
        }
    }
        ...
        try {
            ...
            try {
              L0: {
                ...
                stackIn_15_0 = new mi(var8, param3, param4);
                break L0;
              }
    ...
    private final void a(int param0, byte[] param1) {
        ...
        try {
                    ...
                    if (7 > var4) {
                      ...
                      L7: while (true) {
                        if (this.field_p <= var10) {
                          ...
                          L8: {
                            dupTemp$0 = var8 + var17.a((byte) 25);
                            var8 = dupTemp$0;
                            this.field_u[var10] = dupTemp$0;
                      ...
                      L9: while (true) {
                        if (var10 >= this.field_p) {
                          ...
                          dupTemp$1 = var8 + var17.j((byte) -19);
                          var8 = dupTemp$1;
                          this.field_u[var10] = dupTemp$1;
                                ...
                                if (this.field_p <= var10) {
                                  ...
                                  L22: while (true) {
                                    if (var12 <= var14) {
                                      ...
                                      dupTemp$3 = var8 + var17.j((byte) 108);
                                      var8 = dupTemp$3;
                                ...
                                if (var10 >= this.field_p) {
                                  ...
                                  L26: while (true) {
                                    if (var14 >= var12) {
                                      ...
                                      dupTemp$6 = var8 + var17.a((byte) 25);
                                      var8 = dupTemp$6;
                        ...
                        if (var6 == 0) {
                          ...
                          L29: while (true) {
                            if (this.field_p <= var10) {
                              ...
                              var11 = this.field_u[var10];
                              var12 = this.field_t[var11];
                              array$8 = new int[this.field_q[var11]];
                              this.field_f[var11] = array$8;
                              var13 = 0;
                              L30: while (true) {
          ...
          L33: {
            ...
            stackIn_97_1 = new StringBuilder().append("we.C(").append(param0).append(',');
