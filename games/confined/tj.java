...
final class tj extends tk {
    ...
    private final rl a(int param0, int param1, int param2) {
        ...
        L0: {
          ...
          var4 = (Object) (Object) (rl) (Object) ((tj) this).field_i.a(1, (long)param2);
          if (var4 == null) {
            break L0;
          } else {
            if (param1 != 0) {
        ...
        if (!((rl) var4).field_v) {
          ...
          if (var4 instanceof sm) {
            ...
            L17: {
              ...
              if (((tj) this).field_s != null) {
                sm discarded$1 = ((tj) this).field_o.a(((tj) this).field_s, -127, var5, param2);
                if (((tj) this).field_p[param2] != 1) {
                  ((tj) this).field_p[param2] = (byte) 1;
                  break L17;
                } else {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          throw sd.a((Throwable) (Object) var5, "tj.L(" + param0 + 44 + 1 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
                  ...
                  if (((tj) this).field_m) {
                    ...
                    L3: while (true) {
                      if (var3 == null) {
                        L4: while (true) {
                          L5: {
                            if (((tj) this).field_j >= ((tj) this).field_h.field_t.length) {
                              break L5;
                            } else {
                              L6: {
                                if (((tj) this).field_h.field_t[((tj) this).field_j] == 0) {
                                  break L6;
                                } else {
                                  if (((tj) this).field_o.field_b >= 250) {
                                    ...
                                    L7: {
                                      if (((tj) this).field_p[((tj) this).field_j] != 0) {
                                        ...
                                        rl discarded$4 = this.a(13860, 1, ((tj) this).field_j);
                                        break L7;
                                      }
                                    }
                        ...
                        L8: {
                          ...
                          if (((tj) this).field_p[var4] != 0) {
                            ...
                            rl discarded$5 = this.a(13860, 1, var4);
                            break L8;
                          }
                        }
                        L9: {
                                ...
                                L13: {
                                  if (((tj) this).field_h.field_t[((tj) this).field_j] == 0) {
                                    ...
                                    if (((tj) this).field_q.b(-124)) {
                                      ...
                                      L14: {
                                        if (-2 == ((tj) this).field_p[((tj) this).field_j]) {
                                          break L14;
                                        } else {
                ...
                if (((tj) this).field_h.field_i <= var3) {
                    ...
                    if (((tj) this).field_h.field_t[var3] == 0) {
                        ...
                        if (((tj) this).field_p[var3] == 0) {
                            rl discarded$0 = this.a(13860, 1, var3);
                        }
                        if (!(((tj) this).field_p[var3] != -1)) {
                            rl discarded$1 = this.a(13860, 2, var3);
                        }
                        if (((tj) this).field_p[var3] == 1) {
                            var2.a(true);
                        }
