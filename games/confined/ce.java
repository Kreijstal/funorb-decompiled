...
final class ce extends ok {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * fn.field_g;
          var10 = fn.field_g - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= fn.field_b) {
            break L0;
          } else {
            var13 = fn.field_b - param2;
            param4 = param4 - var13;
            param2 = fn.field_b;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * fn.field_g;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= fn.field_j) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - fn.field_j);
            break L1;
          }
        }
        L2: {
          if (param1 >= fn.field_c) {
            break L2;
          } else {
            var13 = fn.field_c - param1;
            param3 = param3 - var13;
            param1 = fn.field_c;
            var12 = var12 + var13;
            var9 = var9 + var13;
        ...
        L3: {
          if (param1 + param3 <= fn.field_i) {
            break L3;
          } else {
            var13 = param1 + param3 - fn.field_i;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              ce.a(fn.field_h, ((ce) this).field_N[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19 = 0;
        int var20 = 0;
        var13 = param2 - fn.field_c;
        var14 = param3 - fn.field_b;
        var15 = var14;
        L0: while (true) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  fn.field_h[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * fn.field_g;
          var9 = fn.field_g - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= fn.field_b) {
            break L0;
          } else {
            var12 = fn.field_b - param2;
            param4 = param4 - var12;
            param2 = fn.field_b;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * fn.field_g;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= fn.field_i) {
            ...
            var12 = param1 + param3 - fn.field_i;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (fn.field_e == null) {
                  ce.a(fn.field_h, ((ce) this).field_N[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  ce.a(fn.field_h, ((ce) this).field_N[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, fn.field_e, fn.field_f);
                  break L5;
                }
              }
              return;
    ...
    ce(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        super(param0, param1, param2, param3, param4);
        ((ce) this).field_N = new byte[256][];
        ((ce) this).field_N = param5;
    }
}
