        ...
        try {
          L0: {
            ...
            L3: {
              var7 = this.field_B[0];
              this.field_v.b(2585);
              var7.a(param4, this.field_v, param1, 2147483647, param3, (qh) (this));
              if (param0 < -97) {
                break L3;
              } else {
                this.field_B = (pn[]) null;
                break L3;
              }
            }
            L4: {
              if (var10 != null) {
                L5: {
                  if (var10.field_O) {
                    var11 = this.field_B[1];
                    if (var11 == null) {
                      break L5;
                    } else {
                      var11.a(param4, this.field_v, param1, 2147483647, param3, (qh) (this));
                      break L5;
                    }
                  } else {
                    break L5;
                ...
                if (!var10.field_w) {
                  ...
                  L6: {
                    ...
                    if (var10.field_o == 0) {
                      ...
                      if (var12 == null) {
                        ...
                        var12.a(param4, this.field_v, param1, 2147483647, param3, (qh) (this));
                        break L4;
                      }
                    }
                  }
                  var9 = this.field_B[2];
                  if (var9 != null) {
                    var9.a(param4, this.field_v, param1, 2147483647, param3, (qh) (this));
                    break L4;
                  } else {
                    break L4;
                  }
            ...
            L7: {
              if (param3.e((byte) -125)) {
                var13 = this.field_B[5];
                if (var13 == null) {
                  break L7;
                } else {
                  var13.a(param4, this.field_v, param1, 2147483647, param3, (qh) (this));
                  break L7;
                }
              } else {
                break L7;
            ...
            L8: {
              if (!param2) {
                var14 = this.field_B[4];
                if (var14 != null) {
                  var14.a(param4, this.field_v, param1, 2147483647, param3, (qh) (this));
                  break L8;
                } else {
                  break L8;
                }
            ...
            this.field_v.a(param1, param4, param3, (byte) 100, (qh) (this));
            ib.b(false);
            break L0;
          }
    ...
    final static jb a(boolean param0, byte param1) {
        ...
        L1: {
          ...
          if (tj.a(true)) {
            ...
            var8.a((byte) -90, new bd(19, dn.field_e[1], pn.field_a));
          ...
          L0: {
            ...
            L2: {
              if (param2) {
                  ...
                  if (6 <= var4_int) {
                    ...
                    L4: {
                      ...
                      if (var5 != null) {
                        ...
                        ((pn) (Object) stackIn_12_0).a(stackIn_12_1 != 0, stackIn_12_2);
                        break L4;
                      } else {
                ...
                lj.a(this.field_B, 0, param1.field_B, 0, 6);
                break L2;
              }
            }
            break L0;
    ...
    final void a(byte param0, nf[] param1, int param2) {
        ...
        try {
            ...
            if (null == this.field_B[var4_int]) {
                this.field_B[var4_int] = new pn();
            }
            this.field_B[param2].field_g = param1;
