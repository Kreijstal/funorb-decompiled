...
final class lg {
    ...
    final void a(kg param0) {
        ...
        for (var3 = 0; var3 < 10; var3++) {
            ...
            this.field_p[var3] = param0.b(1647);
            this.field_l[var3] = param0.k((byte) -11);
        }
        this.field_i = param0.k((byte) -11);
        this.field_e = param0.k((byte) -11);
        this.field_d = param0.a((byte) 25);
        this.field_y = param0.a((byte) 25);
        this.field_x = new uf();
        this.field_g = new nk();
        this.field_x.a(param0, this.field_g);
    }
        ...
        if (param1 >= 10) {
          L0: {
            ...
            if (this.field_q == null) {
              ...
              this.field_q.a();
              this.field_h.a();
              var5 = (int)((double)(this.field_q.field_j - this.field_q.field_i) * 32.768 / var3);
              var6 = (int)((double)this.field_q.field_i * 32.768 / var3);
              break L0;
            }
          }
          L1: {
            ...
            if (this.field_k == null) {
              ...
              this.field_k.a();
              this.field_b.a();
              var8 = (int)((double)(this.field_k.field_j - this.field_k.field_i) * 32.768 / var3);
              var9 = (int)((double)this.field_k.field_i * 32.768 / var3);
              break L1;
            }
          }
          var11 = 0;
            ...
            if (var11 >= 5) {
              ...
              L3: while (true) {
                if (var11 >= param0) {
                      ...
                      L5: while (true) {
                        if (var14 >= param0) {
                          ...
                          L6: {
                            ...
                            if (var13 == 0) {
                              var12 = this.field_n.field_i + ((this.field_n.field_j - this.field_n.field_i) * var16 >> 8);
                              break L6;
                            } else {
                              var12 = this.field_n.field_i + ((this.field_n.field_j - this.field_n.field_i) * var15 >> 8);
                              break L6;
                            }
                          }
                          L7: {
                      ...
                      if (this.field_e <= 0) {
                        ...
                        L10: while (true) {
                          if (var12 >= param0) {
                            ...
                            field_v[var12] = field_v[var12] + field_v[var12 - var11] * this.field_e / 100;
                            var12++;
                            continue L10;
                          }
                        }
                  ...
                  L11: {
                    L12: {
                      if (this.field_x.field_g[0] > 0) {
                        break L12;
                      } else {
                        if (this.field_x.field_g[1] <= 0) {
                          break L11;
                        } else {
                          break L12;
                        }
                  ...
                  L27: {
                    ...
                    if (this.field_q == null) {
                      ...
                      var12 = var12 + (this.a(var7, var15, this.field_q.field_d) >> 1);
                  ...
                  L28: {
                    if (this.field_k == null) {
                      ...
                      var13 = var13 * ((this.a(var10, var15, this.field_k.field_d) >> 1) + 32768) >> 15;
                  ...
                  L29: while (true) {
                    if (var14 < 5) {
                      if (this.field_r[var14] != 0) {
                        ...
                        if (var15 < param0) {
                          field_v[var15] = field_v[var15] + this.a(field_w[var14], var13 * field_a[var14] >> 15, this.field_t.field_d);
              ...
              if (this.field_r[var11] != 0) {
                field_w[var11] = 0;
                field_s[var11] = (int)((double)this.field_l[var11] * var3);
                field_a[var11] = (this.field_r[var11] << 14) / 100;
                field_j[var11] = (int)((double)(this.field_t.field_j - this.field_t.field_i) * 32.768 * Math.pow(1.0057929410678534, (double)this.field_p[var11]) / var3);
                field_f[var11] = (int)((double)this.field_t.field_i * 32.768 / var3);
                var11++;
                continue L2;
              } else {
                var11++;
