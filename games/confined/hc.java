...
final class hc extends rk {
    ...
    final static String a(int param0, CharSequence param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("hc.C(").append(-24682).append(44);
    ...
    hc(long param0, int param1, byte[] param2) {
        try {
            ...
            throw sd.a((Throwable) (Object) runtimeException, "hc.<init>(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
