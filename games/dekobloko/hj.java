...
final class hj {
    ...
    private final float b(int param0, int param1, float param2) {
        float var4 = (float)((hj) this).field_b[param0][0][param1] + param2 * (float)(((hj) this).field_b[param0][1][param1] - ((hj) this).field_b[param0][0][param1]);
    ...
    final void a(wl param0, sd param1) {
        ...
        L0: {
          ...
          ((hj) this).field_g[0] = var3 >> 4;
          ((hj) this).field_g[1] = var3 & 15;
          if (var3 == 0) {
            var11 = ((hj) this).field_f;
            ((hj) this).field_f[1] = 0;
            var11[0] = 0;
            break L0;
          } else {
            ((hj) this).field_f[0] = param0.e(3);
            ((hj) this).field_f[1] = param0.e(3);
            ...
            L1: while (true) {
              if (var5 >= 2) {
                  ...
                  if (var5 >= 2) {
                    L3: {
                      if (var4 != 0) {
                        ...
                        if (((hj) this).field_f[1] == ((hj) this).field_f[0]) {
                          break L0;
                        } else {
                          break L3;
                        }
                    ...
                    var6 = var7;
                    L4: while (true) {
                      if (var7 >= ((hj) this).field_g[var5]) {
                        var5++;
                        continue L2;
                      } else {
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ((hj) this).field_e[var5][1][var7] = ((hj) this).field_e[var5][0][var7];
                          ((hj) this).field_b[var5][1][var7] = ((hj) this).field_b[var5][0][var7];
                          var7++;
                          continue L4;
                        } else {
                          ((hj) this).field_e[var5][1][var7] = param0.e(3);
                          ((hj) this).field_b[var5][1][var7] = param0.e(3);
                          var7++;
                          continue L4;
                        }
                      }
                ...
                var6 = 0;
                L5: while (true) {
                  if (var6 >= ((hj) this).field_g[var5]) {
                    var5++;
                    continue L1;
                  } else {
                    ((hj) this).field_e[var5][0][var6] = param0.e(3);
                    ((hj) this).field_b[var5][0][var6] = param0.e(3);
                    var6++;
                    continue L5;
                  }
                }
    ...
    final int a(int param0, float param1) {
        ...
        L0: {
          if (param0 != 0) {
            ...
            var3 = (float)((hj) this).field_f[0] + (float)(((hj) this).field_f[1] - ((hj) this).field_f[0]) * param1;
        ...
        if (((hj) this).field_g[param0] != 0) {
          ...
          var4 = 1;
          L1: while (true) {
            if (var4 >= ((hj) this).field_g[param0]) {
              L2: {
                if (param0 != 0) {
                  break L2;
                } else {
              ...
              var4 = 0;
              L4: while (true) {
                if (var4 >= ((hj) this).field_g[param0] * 2) {
                  return ((hj) this).field_g[param0] * 2;
                } else {
    ...
    private final float a(int param0, int param1, float param2) {
        float var4 = (float)((hj) this).field_e[param0][0][param1] + param2 * (float)(((hj) this).field_e[param0][1][param1] - ((hj) this).field_e[param0][0][param1]);
        var4 = var4 * 0.0001220703125f;
        return hj.a(var4);
    }

    hj() {
        ((hj) this).field_b = new int[2][2][4];
        ((hj) this).field_f = new int[2];
        ((hj) this).field_e = new int[2][2][4];
        ((hj) this).field_g = new int[2];
    }
