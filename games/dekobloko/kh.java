        ...
        try {
            ...
            try {
              ...
              L23: {
                ...
                stackIn_74_1 = new StringBuilder().append("kh.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
                                                  ...
                                                  L8: {
                                                    L9: {
                                                      if (var15 <= var16) {
                                                        ...
                                                        var7++;
                                                        var6[incrementValue$0] = jb.field_b[var16];
                                                        var16++;
                                                        if (var18 != 0) {
                                                          break L8;
                                                        } else {
