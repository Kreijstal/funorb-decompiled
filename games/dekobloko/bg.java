...
final class bg {
    ...
    final static void a(int param0) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (256 <= var1_int) {
                ...
                var2 = 15.0;
                ch.field_b[var1_int] = (int)(255.0 * Math.pow((double)((float)var1_int / 256.0f), var2));
                var1_int++;
                continue L2;
              }
            }
          ...
          throw dh.a((Throwable) (Object) var1, "bg.A(" + param0 + ')');
        }
    }
    ...
    final static void a(byte[] param0, int[] param1, String[] param2, byte[] param3, int param4, String[][] param5, ji param6, int param7, int param8, ji param9, ck[][] param10, ck[][] param11, boolean param12, ji param13, String[][] param14) {
        ...
        try {
          var17 = null;
          var16 = null;
          s.a(72, 8, param11, param3, param10, 5, true, param14, param1, param0, param6, (int[]) null, param9, (pi[]) null, param2, param5, param13);
          return;
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L0: {
            ...
            stackOut_2_1 = new StringBuilder().append("bg.C(");
          ...
          L6: {
            ...
            stackOut_20_1 = ((StringBuilder) (Object) stackIn_20_1).append(stackIn_20_2).append(',').append(5).append(',').append(25150).append(',');
