    ...
    final static void a(nf param0, mm param1, int param2, String param3, int param4) {
        ...
        try {
            ...
            L1: while (true) {
              if (param3.length() <= var7) {
                ...
                L2: {
                  ...
                  if (var8 == 60) {
                    var6 = param0.field_a[0] + ((var5_int >> 8) - -param1.a(param3.substring(0, var7)));
                    break L2;
                  } else {
                    break L2;
                  }
                ...
                L3: {
                  if (-1 != var6) {
                    ...
                    param0.field_a[var7] = (var5_int >> 8) - -param0.field_a[0] - (-param1.a(param3.substring(0, var7 + 1)) + param1.a((char) var8));
                    break L3;
                  }
                }
                L5: {
          ...
          L6: {
            ...
            stackOut_19_1 = new StringBuilder().append("hm.B(");
          ...
          throw dh.a((Throwable) (Object) stackIn_28_0, stackIn_28_2 + ',' + param4 + ')');
        }
    }
    ...
    final static fm a(boolean param0, String param1, String param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("hm.D(").append(false).append(',');
          ...
          throw dh.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + ',' + 9507 + ')');
        }
        return stackIn_4_0;
    }
