        ...
        if (param1 >= 10) {
          L0: {
            ...
            if (this.field_y == null) {
              ...
              this.field_y.a();
              this.field_a.a();
              var5 = (int)((double)(this.field_y.field_i - this.field_y.field_e) * 32.768 / var3);
              var6 = (int)((double)this.field_y.field_e * 32.768 / var3);
              break L0;
            }
          }
          L1: {
            ...
            if (this.field_f == null) {
              ...
              this.field_f.a();
              this.field_v.a();
              var8 = (int)((double)(this.field_f.field_i - this.field_f.field_e) * 32.768 / var3);
              var9 = (int)((double)this.field_f.field_e * 32.768 / var3);
              break L1;
            }
          }
          var11 = 0;
            ...
            if (var11 >= 5) {
              ...
              L3: while (true) {
                if (var11 >= param0) {
                      ...
                      L5: while (true) {
                        if (var14 >= param0) {
                          ...
                          L6: {
                            ...
                            if (var13 == 0) {
                              var12 = this.field_s.field_e + ((this.field_s.field_i - this.field_s.field_e) * var16 >> 8);
                              break L6;
                            } else {
                              var12 = this.field_s.field_e + ((this.field_s.field_i - this.field_s.field_e) * var15 >> 8);
                              break L6;
                            }
                          }
                          L7: {
                  ...
                  L11: {
                    L12: {
                      if (this.field_q.field_g[0] > 0) {
                        break L12;
                      } else {
                        if (this.field_q.field_g[1] <= 0) {
                          break L11;
                        } else {
                          break L12;
                        }
                  ...
                  L27: {
                    ...
                    if (this.field_y == null) {
                      ...
                      var12 = var12 + (this.a(var7, var15, this.field_y.field_a) >> 1);
                  ...
                  L28: {
                    if (this.field_f == null) {
                      ...
                      var13 = var13 * ((this.a(var10, var15, this.field_f.field_a) >> 1) + 32768) >> 15;
                  ...
                  L29: while (true) {
                    if (var14 < 5) {
                      if (this.field_g[var14] != 0) {
                        ...
                        if (var15 < param0) {
                          field_c[var15] = field_c[var15] + this.a(field_w[var14], var13 * field_d[var14] >> 15, this.field_b.field_a);
              ...
              if (this.field_g[var11] != 0) {
                field_w[var11] = 0;
                field_x[var11] = (int)((double)this.field_i[var11] * var3);
                field_d[var11] = (this.field_g[var11] << 14) / 100;
                field_m[var11] = (int)((double)(this.field_b.field_i - this.field_b.field_e) * 32.768 * Math.pow(1.0057929410678534, (double)this.field_e[var11]) / var3);
                field_p[var11] = (int)((double)this.field_b.field_e * 32.768 / var3);
                var11++;
                continue L2;
              } else {
                var11++;
