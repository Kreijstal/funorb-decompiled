...
final class ta {
    ...
    final static int a(CharSequence param0, int param1) {
        ...
        try {
            ...
            L1: while (true) {
              L2: {
                if (var5 >= var3) {
                  ...
                  stackOut_3_0 = (var4 << -397216347) + (-var4 - -j.a(param0.charAt(var5), (byte) 28));
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("ta.A(");
    ...
    final static boolean a(ji param0, ji param1, int param2, ji param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_19_1 = new StringBuilder().append("ta.I(");
    ...
    final static ck[] a(boolean param0, int param1, int param2, int param3, int param4) {
        ck[] discarded$2 = null;
        if (param0) {
          discarded$2 = ta.a(false, 17, -88, -29, -62);
