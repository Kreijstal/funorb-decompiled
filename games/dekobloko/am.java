        ...
        if (!param1) {
          ...
          L0: while (true) {
            if (var5_ref != null) {
              if (param3 != var5_ref.field_n) {
                L1: {
                  stackIn_18_0 = dg.field_e;

                  if (param1) {
                    stackIn_19_0 = (vj) ((Object) stackIn_18_0);
                    stackIn_19_1 = 0;
                    break L1;
                  } else {
                    stackIn_19_0 = (vj) ((Object) stackIn_18_0);
          ...
          L2: while (true) {
            if (var5_ref != null) {
              if (param3 != var5_ref.field_n) {
                L3: {
                  stackIn_8_0 = dg.field_e;

                  if (param1) {
                    stackIn_9_0 = (vj) ((Object) stackIn_8_0);
                    stackIn_9_1 = 0;
                    break L3;
                  } else {
                    stackIn_9_0 = (vj) ((Object) stackIn_8_0);
