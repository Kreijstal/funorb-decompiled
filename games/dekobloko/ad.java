...
final class ad {
        ...
        try {
          L0: {
            if (param0.a((byte) 121)) {
              ...
              stackOut_5_0 = param3 + " - " + param0.b((byte) -89) + "%";
    ...
    final static void a(byte[] param0, int param1, boolean param2, int param3, int param4, boolean param5) {
        ...
        try {
            ...
            throw dh.a((Throwable) (Object) runtimeException, "ad.A(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + 1 + 41);
        }
    }
    ...
    private final void a(byte[] param0, int param1) {
        ...
        try {
                    ...
                    if (var4 < 7) {
                      ...
                      L7: while (true) {
                        if (((ad) this).field_w <= var10) {
                          ...
                          L8: {
                            int dupTemp$4 = var8 + var17.e(qm.b(0, 3));
                            var8 = dupTemp$4;
                            ((ad) this).field_f[var10] = dupTemp$4;
                      ...
                      L9: while (true) {
                        if (((ad) this).field_w <= var10) {
                          ...
                          L10: {
                            int dupTemp$5 = var8 + var17.f(21663);
                            var8 = dupTemp$5;
                            ((ad) this).field_f[var10] = dupTemp$5;
                            if (~((ad) this).field_f[var10] >= ~var9) {
                              break L10;
                            } else {
                              var9 = ((ad) this).field_f[var10];
                        ...
                        if (((ad) this).field_n <= var10) {
                          ...
                          L14: while (true) {
                            if (~((ad) this).field_w >= ~var10) {
                              ...
                              ((ad) this).field_p[((ad) this).field_f[var10]] = var17.i(7553);
                              var10++;
                              continue L14;
                            }
                          }
                                    ...
                                    if (((ad) this).field_w <= var10) {
                                      ...
                                      L22: while (true) {
                                        if (~var14 <= ~var12) {
                                          ...
                                          L24: {
                                            int dupTemp$6 = var8 + var17.f(21663);
                                            var8 = dupTemp$6;
                                            ((ad) this).field_v[var11][var14] = dupTemp$6;
                                            var15 = dupTemp$6;
                                            if (var15 > var13) {
                                              var13 = var15;
                                              break L24;
                                    ...
                                    if (((ad) this).field_w <= var10) {
                                      ...
                                      L27: while (true) {
                                        if (~var14 <= ~var12) {
                                          ...
                                          L29: {
                                            int dupTemp$7 = var8 + var17.e(3);
                                            var8 = dupTemp$7;
                                            ((ad) this).field_v[var11][var14] = dupTemp$7;
                                            var15 = dupTemp$7;
                                            if (~var15 >= ~var13) {
                                              break L29;
                                            } else {
                                    ...
                                    if (((ad) this).field_k[var11] <= var13) {
                                      ...
                                      L33: while (true) {
                                        if (~var13 <= ~var12) {
                                          ...
                                          ((ad) this).field_r[var11][var14] = var17.i(qm.b(0, 7553));
                                          var13++;
                                          continue L33;
                                        }
                                      }
          ...
          L35: {
            ...
            stackOut_93_1 = new StringBuilder().append("ad.D(");
        ...
        try {
            ...
            if (param2 != null) {
                ...
                for (var4_int = 0; var4_int < 64; var4_int++) {
                    if (param2[var4_int] != ((ad) this).field_h[var4_int]) {
                        throw new RuntimeException();
                    }
                }
            }
