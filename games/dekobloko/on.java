    ...
    final static void a(boolean param0, int[] param1, boolean param2, int[] param3, boolean param4, boolean param5, vg param6) {
        ...
        try {
                  ...
                  L3: {
                    L4: {
                      if ((var23 ^ -1) <= (param6.field_l ^ -1)) {
                        ...
                        stackOut_5_0 = -51;
                        stackOut_5_1 = var29 ^ -1;
                        stackIn_61_0 = stackOut_5_0;
                        stackIn_61_1 = stackOut_5_1;
          ...
          L13: {
            ...
            stackOut_68_1 = new StringBuilder().append("on.G(").append(param0).append(',');
          ...
          L15: {
            ...
            stackOut_76_1 = ((StringBuilder) (Object) stackIn_76_1).append(stackIn_76_2).append(',').append(param4).append(',').append(param5).append(',');
    ...
    public final void a(boolean param0, int param1, int param2, byte param3, ce param4) {
        ...
        try {
          L0: {
            ...
            if (param3 <= -60) {
              L3: {
                discarded$1 = this.field_j.a("<u=" + Integer.toString(var6_int, 16) + ">" + param4.field_E + "</u>", param4.field_u + param1, param4.field_D + param2, param4.field_t, param4.field_y, var6_int, -1, this.field_b, this.field_f, this.field_j.field_K + this.field_j.field_R);
                if (!param4.a(true)) {
                  break L3;
                } else {
                  L4: {
    ...
    final static pi[] a(int param0, byte param1, int param2, ji param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("on.F(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static void a(ck[] param0, int param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("on.E(");
            stackIn_14_0 = stackOut_11_0;
            stackIn_14_1 = stackOut_11_1;
            stackIn_12_0 = stackOut_11_0;
            stackIn_12_1 = stackOut_11_1;
