...
final class ea extends cf {
    ...
    final void a(String param0, int param1, mm param2, int param3, int param4, int param5, int param6, int param7) {
        ...
        try {
          L0: {
            ...
            if (param0 != null) {
              ...
              L5: {
                ...
                if (this.field_q != 0) {
                  if (this.field_q == 1) {
                    var11 = (-(var10 * this.field_B) + this.field_v >> 1) + param2.field_R;
                    break L5;
                  } else {
                    if (this.field_q == 2) {
                    ...
                    if (var13 != null) {
                      L10: {
                        ...
                        if (param5 == 3) {
                          ...
                          stackOut_42_2 = this.a((byte) 64, param2.a(var13), var13, param3);
          ...
          throw dh.a((Throwable) ((Object) stackIn_52_0), stackIn_52_2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ')');
        }
    }
