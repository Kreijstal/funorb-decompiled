...
final class sh {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, ck param7, int param8) {
        ...
        try {
          L0: {
            var9_int = param3 + (param7.field_F + param6);
            var10 = 30 + (param3 + param7.field_F) + param6;
            var11 = param8 + param7.field_z + (param7.field_H >> 1);
            hk.f(var9_int, 0, var10, var11);
            param7.f(-1 + param3, param8 + -1, 80);
            param7.f(param3 - 1, param8 + 1, 80);
            hk.a(he.field_V);
            hk.f(var9_int - -1, 0, var10 + 1, var11);
            param7.f(param3 - -1, -1 + param8, 80);
            param7.f(1 + param3, param8 - -1, 80);
            hk.a(he.field_V);
            var10 = -param6 + param3 + param7.field_F + param7.field_I;
            var9_int = -30 + (-param6 + param7.field_I + param7.field_F) - -param3;
            hk.f(var9_int, var11, var10, 480);
            param7.f(param3 - 1, -1 + param8, 80);
            param7.f(param3 - 1, 1 + param8, 80);
            hk.a(he.field_V);
            hk.f(1 + var9_int, var11, var10 + 1, 480);
            param7.f(1 + param3, -1 + param8, 80);
            param7.f(param3 + 1, param8 - -1, 80);
            hk.a(he.field_V);
            break L0;
          }
    ...
    final static void a(boolean param0, ji param1) {
        ...
        L60: {
          ...
          if (var2 != null) {
            int discarded$318 = 2;
            String discarded$319 = qj.a(var2);
            break L60;
          } else {
            break L60;
          }
