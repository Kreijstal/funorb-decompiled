...
final class id extends ma {
    ...
    final void a(int param0, int param1, int param2, ce param3, int param4, int param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("id.IB(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    private id(int param0, int param1, int param2, int param3, gl param4, kg param5, ce param6) {
        ...
        try {
            ...
            throw dh.a((Throwable) (Object) runtimeException, "id.<init>(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + (param6 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final static ck a(ji param0, String param1, String param2, int param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = af.a(var5, 50, param0, var4_int);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("id.F(");
          ...
          throw dh.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + 44 + param3 + 41);
        }
        return stackIn_3_0;
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, ck param7, int param8) {
        try {
            ...
            throw dh.a((Throwable) (Object) runtimeException, "id.E(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + (param7 != null ? "{...}" : "null") + 44 + param8 + 41);
        }
    }
