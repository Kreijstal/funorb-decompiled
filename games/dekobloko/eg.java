            ...
            if (1 == param0) {
              if (wh.field_d != param2) {
                L0: {
                  rg.field_c = true;
                  wh.field_d = param2;
                  mf.a((byte) 108, param1);
                  if (2 != param0) {
                    break L0;
                  } else {
                    if (param2 != wl.field_o) {
                      wl.field_o = param2;
                      rg.field_c = true;
                      mf.a((byte) 120, param1);
                      break L0;
                    } else {
                      if (param3 > 67) {
                        return;
    ...
    final static int[] a(int[] param0, int[] param1, byte param2) {
        ...
        try {
              ...
              L3: {
                L4: {
                  if (-9 >= (var4 ^ -1)) {
                    ...
                    stackOut_5_0 = (int[]) (var7);
                    stackIn_9_0 = stackOut_5_0;
                    stackIn_6_0 = stackOut_5_0;
                    if (var5 != 0) {
                      break L3;
                    } else {
                      stackIn_6_0[var4] = lb.a(param1[var4], param0[var4]);
                      var4++;
                      if (var5 == 0) {
                        continue L2;
                      } else {
          ...
          L5: {
            ...
            stackOut_10_1 = new StringBuilder().append("eg.B(");
