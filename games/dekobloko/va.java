...
final class va extends bh {
    ...
    private static ih[] field_R;
    private static bm[] field_o;
    ...
    final static void b(byte[] param0) {
        ...
        L0: while (true) {
          if (var1 >= 2) {
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = va.c(16);
                                    int discarded$4 = va.c(16);
                                    field_x[var6] = va.c(8);
                                    var6++;
                                    continue L6;
                                  }
            ...
            L8: {
              if (var1 == 0) {
                stackOut_4_0 = field_y;
                stackIn_5_0 = stackOut_4_0;
                break L8;
              } else {
                stackOut_3_0 = field_B;
                ...
                L10: while (true) {
                  if (var8_int >= var4) {
                    ...
                    L11: while (true) {
                      if (var9_int >= var5) {
                        var9 = new int[var5];
                        var10 = s.b((byte) -57, var5 - 1);
                        var11 = 0;
                        L12: while (true) {
                          if (var11 >= var5) {
                            if (var1 == 0) {
                              field_v = var6_ref_float__;
                              field_p = var7;
                              field_A = var8;
                              field_Q = var9;
                              var1++;
                            ...
                            var9[var11] = rd.a((byte) 16, var10, var11);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    final static int b() {
        int var0 = field_w[field_T] >> field_u & 1;
        field_u = field_u + 1;
        field_T = field_T + (field_u >> 3);
        field_u = field_u & 7;
        return var0;
    }
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        wl var2 = new wl(param0);
        ((va) this).field_O = var2.i(7553);
        ((va) this).field_I = var2.i(7553);
        ((va) this).field_P = var2.i(7553);
        ((va) this).field_L = var2.i(7553);
        if (((va) this).field_L < 0) {
            ((va) this).field_L = ((va) this).field_L ^ -1;
            ((va) this).field_q = true;
        }
        int var3 = var2.i(7553);
        if (var3 < 0) {
            throw new IOException();
        }
        ((va) this).field_t = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            var5 = 0;
            do {
                var6_int = var2.d((byte) -64);
                var5 = var5 + var6_int;
            } while (var6_int >= 255);
            var6 = new byte[var5];
            var2.a(var6, 0, (byte) 125, var5);
            ((va) this).field_t[var4] = var6;
        }
    }
    ...
    final ud a(int[] param0) {
        ...
        L1: {
          if (((va) this).field_E != null) {
            break L1;
          } else {
            ((va) this).field_s = 0;
            ((va) this).field_z = new float[field_B];
            ((va) this).field_E = new byte[((va) this).field_I];
            ((va) this).field_F = 0;
            ((va) this).field_N = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((va) this).field_N >= ((va) this).field_t.length) {
            ((va) this).field_z = null;
            var14 = ((va) this).field_E;
            ((va) this).field_E = null;
            return new ud(((va) this).field_O, var14, ((va) this).field_P, ((va) this).field_L, ((va) this).field_q);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((va) this).field_F;
                  var4 = var13.length;
                  if (var4 <= ((va) this).field_I - var3) {
                    break L5;
                  } else {
                    var4 = ((va) this).field_I - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((va) this).field_F);
                        break L7;
                      }
                    }
                    ((va) this).field_F = var3;
                    break L4;
                  } else {
                    L8: {
    ...
    final ud a() {
        ...
        ((va) this).field_s = 0;
        ((va) this).field_z = new float[field_B];
        var1 = new byte[((va) this).field_I];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((va) this).field_t.length) {
            ((va) this).field_z = null;
            return new ud(((va) this).field_O, var1, ((va) this).field_P, ((va) this).field_L, ((va) this).field_q);
          } else {
            var4 = this.d(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((va) this).field_I - var2) {
                  break L1;
                } else {
                  var5 = ((va) this).field_I - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    private final float[] d(int param0) {
        ...
        L0: {
          va.a(((va) this).field_t[param0], 0);
          int discarded$1 = va.b();
          var2 = va.c(s.b((byte) -26, field_x.length - 1));
          var3 = field_K[var2] ? 1 : 0;
          if (var3 == 0) {
            stackOut_2_0 = field_y;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          } else {
            stackOut_1_0 = field_B;
          ...
          L5: {
            ...
            if (var3 == 0) {
              ...
              if (var5 != 0) {
                ...
                var8 = (var4 >> 2) - (field_y >> 2);
                var9 = (var4 >> 2) + (field_y >> 2);
                var10 = field_y >> 1;
                break L4;
              }
            }
          ...
          L7: {
            if (var3 == 0) {
              ...
              if (var6 != 0) {
                ...
                var11 = var4 - (var4 >> 2) - (field_y >> 2);
                var12 = var4 - (var4 >> 2) + (field_y >> 2);
                var13 = field_y >> 1;
                break L6;
              }
            }
        ...
        L8: {
          var14 = field_r[field_x[var2]];
          var16 = var14.field_c;
          var17_int = var14.field_a[var16];
          if (field_R[var17_int].a()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_b) {
            L10: {
              if (var15 != 0) {
                ...
                field_R[var18_int].a(field_H, var4 >> 1);
                break L10;
              }
            }
            L11: {
                                                                          ...
                                                                          if (var26 >= var9) {
                                                                            ...
                                                                            L31: while (true) {
                                                                              if (var26 >= var12) {
                                                                                ...
                                                                                field_H[var26] = field_H[var26] * (float)Math.sin(1.5707963267948966 * (double)var27 * (double)var27);
                                                                                var26++;
                                                                                continue L31;
                                                                              }
                                                                            }
            ...
            L35: {
              ...
              if (((va) this).field_s <= 0) {
                ...
                L36: {
                  var18_int = ((va) this).field_s + var4 >> 2;
                  ...
                  if (((va) this).field_G) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((va) this).field_C) {
                        break L36;
                      } else {
                        var20 = (((va) this).field_s >> 1) + var19;
                        var40[var19] = var40[var19] + ((va) this).field_z[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((va) this).field_z;
              ((va) this).field_z = field_H;
              field_H = var18;
              ((va) this).field_s = var4;
              ((va) this).field_C = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    final static int c(int param0) {
        ...
        while (param0 >= 8 - field_u) {
            var3 = 8 - field_u;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_w[field_T] >> field_u & var4) << var2);
            field_u = 0;
            field_T = field_T + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_w[field_T] >> field_u & var3) << var2);
            field_u = field_u + param0;
        }
        return var1;
    }
    ...
    final static va a(ji param0, int param1, int param2) {
        try {
            ...
            byte[] var3 = param0.a(param2, -124, param1);
            if (var3 == null) {
                return null;
            }
            Object var4 = null;
    ...
    private final static boolean a(ji param0) {
        byte[] var1 = null;
        if (!field_n) {
            var1 = param0.a(0, -121, 0);
            if (var1 == null) {
                return false;
            }
            va.b(var1);
    ...
    private va(byte[] param0) throws IOException {
        this.a(param0);
    }
