...
final class cg {
    ...
    final static void a(int param0, w param1, int param2) {
        ...
        try {
            ...
            throw dh.a((Throwable) ((Object) runtimeException), "cg.A(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + param2 + ')');
        }
    }
    ...
    final static ck[] a(byte param0, ck[] param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_10_1 = new StringBuilder().append("cg.E(").append(param0).append(',');
    ...
    final static Class a(String param0, byte param1) throws ClassNotFoundException {
        ...
        try {
          ...
          L1: {
            ...
            stackIn_31_1 = new StringBuilder().append("cg.I(");
          ...
          throw dh.a((Throwable) ((Object) stackIn_32_0), stackIn_32_2 + ',' + param1 + ')');
        }
