...
final class hk {
          ...
          L0: {
            if (param1 < field_h) {
              ...
              if (param0 >= field_g) {
                ...
                if (param1 < field_b) {
                  field_l[param0 + param1 * field_j] = param2;
                  return;
                } else {
                  break L0;
                }
    ...
    final static void a(int[] param0, int param1, int param2) {
        ...
        field_j = param1;
        field_i = param2;
        hk.b(0, 0, param1, param2);
    }

    final static void b() {
        int var0 = 0;
        int var1 = field_j * field_i - 7;
        while (var0 < var1) {
            var0++;
            field_l[var0] = 0;
            var0++;
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        hk.a(field_l, 0, param2 + param3 * field_j, param0, param2, param4, field_j - param4, param5);
        hk.a(field_l, 0, param2 + param3 * field_j, param1, param3, param5, field_j - param4, param2, param4);
    }
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4) {
        hk.a(param0, param1, param2, param4);
        hk.a(param0, param1 + param3 - 1, param2, param4);
        hk.g(param0, param1, param3, param4);
        hk.g(param0 + param2 - 1, param1, param3, param4);
    }
    ...
    final static void d(int param0, int param1, int param2, int param3) {
        ...
        hk.a(var5, field_l, 0, param2, -param3, var4);
    }
    ...
    final static void c(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
          ...
          hk.a(param0, param1, param2, param3, param5);
          return;
        }
    }
            ...
            L5: while (true) {
              if (var18 >= param8) {
                ...
                L8: while (true) {
                  if (var13 >= var18) {
                    L9: {
                      var18 = field_i - param4 - param5 - param3;
                      if (0 >= var18) {
                        break L9;
                      } else {
                        var18 = 0;
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        if (param6 != 256) {
          if (param4 != 0) {
            ...
            hk.a(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          hk.c(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
        ...
        if (param2 > 0) {
            ...
            for (var5 = 0; var5 < param3; var5++) {
                for (var6 = 0; var6 < param2; var6++) {
                    ...
                    var4++;
                    field_l[var4] = (var11 << 16) + (var11 << 8) + var11;
                }
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            if (param2 <= param3) {
              L1: {
                ...
                if (param1 >= field_h) {
                  ...
                  param0 = param0 + var5 * (field_h - param1);
                  param1 = field_h;
                  break L1;
                }
              }
                  ...
                  L4: {
                    ...
                    if (var6 < field_c) {
                      ...
                      if (var6 >= field_g) {
                        ...
                        field_l[var6 + param1 * field_j] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_h) {
                      ...
                      if (var6 >= field_b) {
                        ...
                        field_l[param0 + var6 * field_j] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                hk.g(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                hk.g(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              hk.a(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              hk.a(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var6 = 0; var6 < 4; var6++) {
            var5 = 128 - (var6 << 5);
            hk.c(param0 + var6, param1 + param3 + var6, param2, param4, var5);
            hk.e(param0 + param2 + var6, param1 + var6, param3 + 1, param4, var5);
        }
    }
