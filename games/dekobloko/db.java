...
final class db extends IOException {
    ...
    final static void a(int param0, String param1, String param2, boolean param3) {
        try {
            ...
            throw dh.a((Throwable) (Object) runtimeException, "db.A(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 41);
        }
    }
    ...
    final static void a(java.awt.Component param0, boolean param1) {
        try {
            ...
            throw dh.a((Throwable) (Object) runtimeException, "db.B(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
