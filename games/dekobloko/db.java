...
final class db extends IOException {
    ...
    final static void a(int param0, String param1, String param2, boolean param3) {
        try {
            ...
            throw dh.a((Throwable) (Object) runtimeException, "db.A(" + -127 + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 41);
        }
    }
    ...
    final static void a(java.awt.Component param0) {
        try {
            ...
            throw dh.a((Throwable) (Object) runtimeException, "db.B(" + (param0 != null ? "{...}" : "null") + 44 + 0 + 41);
        }
    }
    ...
    final static void a(int param0, Object param1, fd param2) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_14_1 = new StringBuilder().append("db.F(").append(param0).append(44);
    ...
    final static ck[] a(String param0, String param1, ji param2, boolean param3, String param4) {
        ...
        try {
          L0: {
            var5 = new ck[9];
            ck dupTemp$6 = id.a(param2, param4, "", 8192);
            var5[8] = dupTemp$6;
            var5[6] = dupTemp$6;
            var5[2] = dupTemp$6;
            var5[0] = dupTemp$6;
            ck dupTemp$7 = id.a(param2, param1, "", 8192);
            var5[7] = dupTemp$7;
            var5[1] = dupTemp$7;
            ck dupTemp$8 = id.a(param2, param0, "", 8192);
            var5[5] = dupTemp$8;
            var5[3] = dupTemp$8;
            stackOut_2_0 = (ck[]) var5;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("db.D(");
