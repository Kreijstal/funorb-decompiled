...
final class se extends ma {
    ...
    final boolean a(int param0, int param1, ce param2, int param3, int param4, int param5, byte param6) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("se.LB(").append(param0).append(44).append(param1).append(44);
          ...
          throw dh.a((Throwable) (Object) stackIn_14_0, stackIn_14_2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
    ...
    final void a(ce param0, int param1, int param2, int param3) {
        ...
        try {
            ...
            L1: {
              L2: {
                ...
                if (1 == ((se) this).field_o) {
                  L4: {
                    var5_int = bh.field_g - (((se) this).field_N - -param3);
                    var6 = pm.field_f - ((se) this).field_R - param2;
                    if (((se) this).field_u != var5_int) {
                      break L4;
                    } else {
              ...
              if (!((se) this).field_T) {
                ...
                L5: {
                  if (((se) this).field_M != ((se) this).field_u) {
                    L6: {
                      var5_int = -((se) this).field_u + ((se) this).field_M;
                      stackOut_8_0 = this;
                      stackOut_8_1 = ((se) this).field_u;
                      stackIn_10_0 = stackOut_8_0;
                ...
                if (((se) this).field_D == ((se) this).field_O) {
                  ...
                  L7: {
                    var5_int = ((se) this).field_O + -((se) this).field_D;
                    stackOut_15_0 = this;
                    stackOut_15_1 = ((se) this).field_D;
          ...
          throw dh.a((Throwable) (Object) stackIn_32_0, stackIn_32_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
    }
    ...
    final static void a(ji param0, ji param1, byte param2, boolean param3, ji param4) {
        try {
            ...
            throw dh.a((Throwable) (Object) runtimeException, "se.GB(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 41);
        }
    }
          ...
          L0: {
            L1: {
              if (param3) {
                ...
                var6 = null;
                boolean discarded$28 = ((se) this).a(-91, 66, (ce) null, 112, 104, 72, (byte) -16);
                break L1;
              }
            }
            L2: {
              if (((se) this).a(0, param1, param0, param2)) {
                ...
                StringBuilder discarded$29 = param2.append(" revert=").append(((se) this).field_T);
                if (((se) this).field_M == 2147483647) {
                  break L2;
                } else {
                  if (((se) this).field_O != 2147483647) {
                    StringBuilder discarded$30 = param2.append(" to ").append(((se) this).field_M).append(44).append(((se) this).field_O);
                    break L2;
                  } else {
                    break L2;
                  }
    ...
    final void a(int param0, int param1, int param2, ce param3, int param4, int param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("se.IB(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_5_0 = stackOut_3_0;
    ...
    private se(int param0, int param1, int param2, int param3, gl param4, kg param5, ce param6, boolean param7, boolean param8) {
        ...
        try {
            ...
            throw dh.a((Throwable) (Object) runtimeException, "se.<init>(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + (param6 != null ? "{...}" : "null") + 44 + param7 + 44 + param8 + 41);
        }
    }
