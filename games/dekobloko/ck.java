...
class ck extends gg {
    ...
    private final void e(int param0, int param1, int param2, int param3, int param4) {
        ...
        int var18;
        L0: {
          var6 = param2 * this.field_I + param1;
          param3 = param3 & 4095;
          param4 = param4 & 4095;
          if (param2 < 0) {
            var12 = 0;
          ...
          if (param2 >= this.field_H - 1) {
            ...
            L5: {
              if (param1 < 0) {
                ...
                L6: {
                  var9 = this.field_D[var6 + this.field_I];
                  if (var9 == 0) {
                    stackIn_19_0 = 0;
                    break L6;
                  } else {
            ...
            if (param1 >= this.field_I - 1) {
              ...
              L7: {
                var10 = this.field_D[var6 + this.field_I + 1];
                if (var10 == 0) {
                  stackIn_25_0 = 0;
                  break L7;
                } else {
                ...
                if (var3 < 0) {
                  ...
                  L8: while (true) {
                    if (var4 > var1) {
                      ...
                      if (this.field_D[var4 * this.field_I + var3] == 0) {
                        var4++;
                        continue L8;
                      } else {
                        break L7;
              ...
              L9: while (true) {
                  ...
                  if (var4 >= var3) {
                    ...
                    L11: while (true) {
                      if (var5 > var1) {
                        ...
                        if (this.field_D[var5 * this.field_I + var4] == 0) {
                          var5++;
                          continue L11;
                        } else {
                          break L10;
                ...
                L12: {
                  if (var4 != 0) {
                    ...
                    if (var3 != this.field_I - 1) {
                      break L12;
                    } else {
                      if (var2 != 0) {
                        break L12;
                      } else {
                        if (var1 != this.field_H - 1) {
                          break L12;
                        } else {
                          return;
                        }
                  ...
                  if (var8 >= var6) {
                    ...
                    L14: while (true) {
                      if (var9 >= var5) {
                        ...
                        var7[var8 * var5 + var9] = this.field_D[(var8 + var2) * this.field_I + (var9 + var4)];
                        var9++;
                        continue L14;
                      }
                    }
    ...
    void e(int param0, int param1) {
        ...
        int var3 = param0 + param1 * hk.field_j;
        int var4 = 0;
        int var5 = this.field_H;
        int var6 = this.field_I;
        int var7 = hk.field_j - var6;
        int var8 = 0;
        ...
        if (var6 > 0) {
            ...
            ck.a(hk.field_l, this.field_D, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final void c(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            if (param2 == this.field_I && param3 == this.field_H) {
                this.d(param0, param1, param4);
                return;
            }
            var6 = this.field_I;
            var7 = this.field_H;
            ...
            ck.c(hk.field_l, this.field_D, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
            return;
        }
    }

    final void a() {
        hk.a(this.field_D, this.field_I, this.field_H);
    }
    ...
    final ck e() {
        int var2 = 0;
        int var3 = 0;
        ck var1 = new ck(this.field_I, this.field_H);
        var1.field_K = this.field_K;
        var1.field_C = this.field_C;
        var1.field_F = this.field_K - this.field_I - this.field_F;
        var1.field_z = this.field_z;
        for (var2 = 0; var2 < this.field_H; var2++) {
            for (var3 = 0; var3 < this.field_I; var3++) {
                var1.field_D[var2 * this.field_I + var3] = this.field_D[var2 * this.field_I + this.field_I - 1 - var3];
            }
        }
        return var1;
    }
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                param2++;
                hk.field_l[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
    ...
    void c(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            ck.b(hk.field_l, this.field_D, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
        ...
        L0: {
          if (param2 > this.field_K) {
            ...
            if (param3 <= this.field_C) {
              L1: {
                var5 = param0 + this.field_F * param2 / this.field_K;
                var6 = param0 + ((this.field_F + this.field_I) * param2 + this.field_K - 1) / this.field_K;
                var7 = param1 + this.field_z * param3 / this.field_C;
                var8 = param1 + ((this.field_z + this.field_H) * param3 + this.field_C - 1) / this.field_C;
                if (var5 >= hk.field_c) {
                  break L1;
                } else {
                  var5 = hk.field_c;
                    ...
                    if (var11 >= var8) {
                      ...
                      L6: while (true) {
                        if (var12 >= var6) {
                          ...
                          var15 = var13 * this.field_K / param2 - (this.field_F << 4);
                          var16 = (var13 + 16) * this.field_K / param2 - (this.field_F << 4);
                          var17 = var14 * this.field_C / param3 - (this.field_z << 4);
                          var18 = (var14 + 16) * this.field_C / param3 - (this.field_z << 4);
                          ...
                          if (var19 != 0) {
                            ...
                            L8: {
                              if (var16 <= this.field_I << 4) {
                                break L8;
                              } else {
                                var16 = this.field_I << 4;
                                break L8;
                              }
                            }
                            L9: {
                            ...
                            L10: {
                              if (var18 <= this.field_H << 4) {
                                break L10;
                              } else {
                                var18 = this.field_H << 4;
                                break L10;
                              }
                            }
                            var16--;
                              ...
                              if (var29 > var18) {
                                ...
                                L16: while (true) {
                                  if (var31 > var16) {
                                    ...
                                    L17: {
                                      var32 = this.field_D[var29 * this.field_I + var31];
                                      if (var32 != 0) {
                                        break L17;
                                      } else {
                                        var32 = var28;
    ...
    void f(int param0, int param1, int param2) {
        ...
        param0 = param0 + this.field_F;
        param1 = param1 + this.field_z;
        int var4 = param0 + param1 * hk.field_j;
        int var5 = 0;
        int var6 = this.field_H;
        int var7 = this.field_I;
        int var8 = hk.field_j - var7;
        int var9 = 0;
        if (param1 < hk.field_h) {
        ...
        if (var7 > 0) {
            ...
            if (param2 == 256) {
                ck.a(0, 0, 0, hk.field_l, this.field_D, var5, 0, var4, 0, var7, var6, var8, var9);
            } else {
                ck.a(0, 0, 0, hk.field_l, this.field_D, var5, 0, var4, 0, var7, var6, var8, var9, param2);
            }
            return;
        }
    }
    ...
    final void f(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            ck.a(0, hk.field_l, this.field_D, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    void d(int param0, int param1) {
        param0 = param0 + (this.field_F >> 1);
        param1 = param1 + (this.field_z >> 1);
        int var3 = param0 < hk.field_c ? hk.field_c - param0 << 1 : 0;
        int var4 = param0 + (this.field_I >> 1) > hk.field_g ? hk.field_g - param0 << 1 : this.field_I;
        int var5 = param1 < hk.field_h ? hk.field_h - param1 << 1 : 0;
        int var6 = param1 + (this.field_H >> 1) > hk.field_b ? hk.field_b - param1 << 1 : this.field_H;
        ck.a(this.field_D, var5 * this.field_I + var3, (param1 + (var5 >> 1)) * hk.field_j + (param0 + (var3 >> 1)), (this.field_I << 1) - (var4 - var3) + (this.field_I & 1), hk.field_j - (var4 - var3 >> 1), this.field_I, var4 - var3 >> 1, var6 - var5 >> 1);
    }
    ...
    final void b() {
        int var2 = 0;
        int var3 = 0;
        if (this.field_I == this.field_K && this.field_H == this.field_C) {
            return;
        }
        int[] var1 = new int[this.field_K * this.field_C];
        for (var2 = 0; var2 < this.field_H; var2++) {
            for (var3 = 0; var3 < this.field_I; var3++) {
                var1[(var2 + this.field_z) * this.field_K + (var3 + this.field_F)] = this.field_D[var2 * this.field_I + var3];
            }
        }
        this.field_D = var1;
    ...
    void e(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            ck.c(hk.field_l, this.field_D, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    final void d(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            ck.a(hk.field_l, this.field_D, param2, var5, var4, var7, var6, var8, var9);
            return;
        }
    }
    ...
    final void d() {
        ...
        int incrementValue$0 = 0;
        int var3 = 0;
        int[] var1 = new int[this.field_I * this.field_H];
        int var2 = 0;
        for (var3 = 0; var3 < this.field_I; var3++) {
            for (var4 = this.field_H - 1; var4 >= 0; var4--) {
                incrementValue$0 = var2;
                var2++;
                var1[incrementValue$0] = this.field_D[var3 + var4 * this.field_I];
            }
        }
        this.field_D = var1;
        var3 = this.field_z;
        this.field_z = this.field_F;
        this.field_F = this.field_C - this.field_H - var3;
        var3 = this.field_H;
    ...
    void b(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            ck.b(hk.field_l, this.field_D, 0, var5, var4, 0, 0, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          L0: {
            ...
            var13 = ((this.field_I << 4) - param0) * var10 + -param1 * var9;
            var14 = -((this.field_I << 4) - param0) * var9 + -param1 * var10;
            var15 = -param0 * var10 + ((this.field_H << 4) - param1) * var9;
            var16 = --param0 * var9 + ((this.field_H << 4) - param1) * var10;
            var17 = ((this.field_I << 4) - param0) * var10 + ((this.field_H << 4) - param1) * var9;
            var18 = -((this.field_I << 4) - param0) * var9 + ((this.field_H << 4) - param1) * var10;
            if (var11 >= var13) {
              var19 = var13;
              var20 = var11;
              break L0;
                              ...
                              L19: while (true) {
                                L20: {
                                  if (var39 >= 0) {
                                    ...
                                    var33 = var37 >> 12;
                                    if (var37 >> 12 >= this.field_I) {
                                      break L20;
                                    } else {
                                      var34 = var38 >> 12;
                                      if (var38 >> 12 < this.field_H) {
    ...
    void a(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            ck.b(hk.field_l, this.field_D, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
                              ...
                              if (var28 > var18) {
                                ...
                                L15: while (true) {
                                  if (var30 > var16) {
                                    ...
                                    var31 = this.field_D[var28 * this.field_I + var30];
                                    if (var31 != 0) {
                                      L16: {
                                        var32 = var29;
                                        if (var30 != var15) {
    ...
    void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            ck.b(hk.field_l, this.field_D, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
            return;
        }
    }
    ...
    void c(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            ck.a(hk.field_l, this.field_D, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    ck(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            var4.waitForAll();
            this.field_I = var3.getWidth((java.awt.image.ImageObserver) ((Object) param1));
            this.field_H = var3.getHeight((java.awt.image.ImageObserver) ((Object) param1));
            this.field_K = this.field_I;
            this.field_C = this.field_H;
            this.field_F = 0;
            this.field_z = 0;
            this.field_D = new int[this.field_I * this.field_H];
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_I, this.field_H, this.field_D, 0, this.field_I);
            var5.grabPixels();
            break L0;
          }
    ...
    void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            ck.a(hk.field_l, this.field_D, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
            return;
        }
    }
    ...
    void c(int param0, int param1, int param2, int param3) {
        ...
        if (param2 > 0) {
            ...
            ck.a(hk.field_l, this.field_D, 0, var7, var8, var13, var14, param2, param3, var11, var12, var5);
            return;
        }
    }
}
