...
final class cl extends bh {
              ...
              if (var31 != 0) {
                ...
                L21: {
                  ...
                  if (!var12.g((byte) 101)) {
                    ...
                    L33: {
                      stackOut_92_0 = var12.field_Zb;
                      stackOut_92_1 = var12.field_mb;
                    ...
                    L34: {
                      L35: {
                        L36: {
                          ((w) (Object) stackIn_95_0).a(stackIn_95_1 + -stackIn_95_2 + -var25_int, 0, var19, kf.field_O, var25_int);
            ...
            if (var3 >= rk.field_P.length) {
              ...
              if (var10 != 0) {
                    ...
                    if ((var2 ^ -1) == -2) {
                      L8: {
                        if (vb.field_U.length <= tg.field_g.length) {
                          stackOut_18_0 = tg.field_g.length;
                          stackIn_19_0 = stackOut_18_0;
                          break L8;
                        } else {
                          stackOut_17_0 = vb.field_U.length;
                          ...
                          if (var7 + 6 <= var3) {
                            ...
                            L10: {
                              if (-var7 + var3 - (6 - tg.field_g.length) < 0) {
                                ...
                                stackOut_22_0 = tg.field_g[-6 + (var3 - -tg.field_g.length - var7)];
                      ...
                      L11: {
                        if (wb.field_Qb.length <= dh.field_b.length) {
                          stackOut_27_0 = dh.field_b.length;
                          stackIn_28_0 = stackOut_27_0;
                          break L11;
                        } else {
                          stackOut_26_0 = wb.field_Qb.length;
                        ...
                        if (var8 + 7 + var7 <= var3) {
                          ...
                          L12: {
                            if (-7 + (var3 - var7) >= dh.field_b.length) {
                              ...
                              stackOut_31_0 = dh.field_b[-7 + var3 + -var7];
                ...
                L15: {
                  ...
                  if ((var4 ^ -1) <= -1) {
                    L16: {
                      var1 = var1 + qk.field_m;
                      if (k.field_f.field_h != var4) {
                        stackOut_44_0 = da.field_c;
                        stackIn_45_0 = stackOut_44_0;
                        break L16;
                      } else {
                        stackOut_43_0 = nf.field_g;
                    ...
                    L17: {
                      var9 = stackIn_45_0;
                      if (var9 != null) {
                        var9.a(var7 - -(mb.field_c << -795183135), 102, var8 + -mb.field_c, var1, (pa.field_Y << 327376481) + cc.field_a);
                        break L17;
                      } else {
                        break L17;
                      }
                    }
                    var1 = var1 + pa.field_Y;
                    break L15;
                  } else {
                    break L15;
                  }
                ...
                L18: {
                  L19: {
                    if (0 <= var4) {
                      ...
                      rk.field_R.a(var6, var8, nd.field_b + var1, var5, -1);
                      var1 = var1 + ke.field_d;
                      if (var10 == 0) {
                        break L18;
                      } else {
                        break L19;
                  ...
                  bg.field_g.a(var6, var8, a.field_k + var1, var5, -1);
                  var1 = var1 + (pa.field_Y - (-qk.field_m - cc.field_a));
                  break L18;
                }
                var3++;
                continue L2;
    ...
    final static void a(hl param0, boolean param1) {
        ...
        if (param0.field_h != null) {
          ...
          L3: while (true) {
            if (var2 < ic.field_c) {
              var3 = pd.field_g[var2];
              stackOut_17_0 = -3;
              stackIn_19_0 = stackOut_17_0;
              stackIn_18_0 = stackOut_17_0;
              if (var4 == 0) {
                L4: {
                  if (stackIn_19_0 != (var3.field_m ^ -1)) {
                    break L4;
                  } else {
