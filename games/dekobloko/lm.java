...
final class lm extends mm {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$0] == 0) {
                  ...
                  param8++;
                  hk.field_l[incrementValue$1] = param6;
                  var20++;
                  continue L3;
                }
              }
            ...
            if (param4 > 0) {
              L5: {
                if (hk.field_k == null) {
                  ...
                  lm.a(hk.field_l, this.field_M[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, hk.field_k, hk.field_f);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        int var13 = 0;
        int var9 = param1 + param2 * hk.field_j;
        int var10 = hk.field_j - param3;
        int var11 = 0;
        int var12 = 0;
        if (param2 < hk.field_h) {
