    ...
    final int a(int param0, byte param1, int param2, byte[] param3, byte[] param4, int param5) {
        ...
        try {
          ...
          L19: {
            ...
            stackIn_69_1 = new StringBuilder().append("jk.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw dh.a((Throwable) ((Object) stackIn_70_0), stackIn_73_2 + ',' + param5 + ')');
        }
    ...
    final int a(byte[] param0, byte[] param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (param2 <= param4) {
                stackIn_17_0 = -param3 + (var8 + 7 >> -1057081885);
                break L0;
              } else {
          ...
          L4: {
            ...
            stackIn_20_1 = new StringBuilder().append("jk.B(");
          ...
          throw dh.a((Throwable) ((Object) stackIn_21_0), stackIn_24_2 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ')');
        }
        return stackIn_17_0;
    }
    ...
    jk(byte[] param0) {
        ...
        try {
          ...
          L13: {
            ...
            stackIn_38_1 = new StringBuilder().append("jk.<init>(");
