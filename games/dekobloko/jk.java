...
final class jk {
    ...
    final int a(int param0, byte param1, int param2, byte[] param3, byte[] param4, int param5) {
        ...
        try {
              ...
              L2: while (true) {
                L3: {
                  ...
                  if (0 <= var9) {
                    ...
                    var7_int = ((jk) this).field_f[var7_int];
                    break L3;
                  }
                }
                L4: {
                  L5: {
                    var10 = ((jk) this).field_f[var7_int];
                    if (((jk) this).field_f[var7_int] >= 0) {
                      break L5;
                    } else {
          ...
          L20: {
            ...
            stackOut_66_1 = new StringBuilder().append("jk.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
          ...
          throw dh.a((Throwable) (Object) stackIn_72_0, stackIn_72_2 + 44 + param5 + 41);
        }
        return stackIn_65_0;
    }
    ...
    final int a(byte[] param0, byte[] param1, int param2, int param3, int param4, int param5) {
        ...
        try {
              ...
              if (param2 <= param4) {
                ...
                if (var11 == 0) {
                  ...
                  L3: {
                    ...
                    var13 += 24;
                    int dupTemp$1 = de.b(var7_int, var10 >>> var13);
                    var7_int = dupTemp$1;
          ...
          throw dh.a((Throwable) (Object) stackIn_24_0, stackIn_24_2 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
        return stackIn_17_0;
    }
    ...
    jk(byte[] param0) {
        ...
        try {
          L0: {
            ...
            ((jk) this).field_d = new int[var2_int];
          ...
          throw dh.a((Throwable) (Object) stackIn_39_0, stackIn_39_2 + 41);
        }
    }
