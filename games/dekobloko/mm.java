...
abstract class mm extends be {
    ...
    final static String a(mm param0, String param1, int param2) {
        int var3 = 0;
        int var4 = 0;
        int var5 = 0;
        int var6 = 0;
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = vf.a(field_J, -23510, 0, ' ');
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
    ...
    final void a(lc[] param0, int[] param1) {
        if (param1 != null) {
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                ...
                var2++;
                ((mm) this).field_L[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
    ...
    mm(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((mm) this).field_S = 0;
