...
final class bb {
    ...
    final static void a(boolean param0, ji param1, pi[] param2, int[] param3, ji param4) {
        ...
        try {
          L0: {
            L1: {
              var5_array = t.a("crowns", param1, false, "lobby");
              n.field_c = var5_array.length;
              if (param2 != null) {
                ...
                L2: while (true) {
                  if (n.field_c <= var7_int) {
                    ...
                    var6[var7_int] = var5_array[var7_int];
                    var7_int++;
                    continue L2;
                  }
                }
            ...
            var19 = new int[var5_array.length];
            var6_array = var19;
            var7_int = 0;
            L4: while (true) {
              if (var7_int >= n.field_c) {
                ...
                var7.a(var5_array, var6_array);
                tg.field_a.a(var5_array, var6_array);
                nf.field_d.a(var5_array, var6_array);
                ...
                fc.field_c.field_lb = qe.a(false, 16, false, 2236962, 2236962, -26198);
          ...
          L8: {
            ...
            stackOut_24_1 = new StringBuilder().append("bb.C(").append(false).append(',');
