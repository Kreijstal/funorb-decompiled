...
final class s extends w {
    ...
    final static int a(boolean param0, int param1, int param2, CharSequence param3) {
        ...
        try {
          ...
          L13: {
            ...
            stackOut_46_1 = new StringBuilder().append("s.E(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static void b(boolean param0) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param0) {
                ...
                discarded$3 = s.a(true, -23, -56, (CharSequence) null);
                break L1;
              }
            }
            jm.field_r = new vj();
          ...
          throw dh.a((Throwable) ((Object) var1_ref), "s.A(" + param0 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, ck[][] param2, byte[] param3, ck[][] param4, int param5, boolean param6, String[][] param7, int[] param8, byte[] param9, ji param10, int[] param11, ji param12, pi[] param13, String[] param14, String[][] param15, ji param16) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("s.I(").append(param0).append(',').append(param1).append(',');
