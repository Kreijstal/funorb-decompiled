 ...
 */
final class ni extends mm {
    private byte[][] field_M;
    int[][] field_X;

    ni(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((ni) this).field_M = new byte[256][];
        ((ni) this).field_M = param6;
        ((ni) this).field_X = new int[4][];
        ((ni) this).field_X[0] = param5;
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * hk.field_j;
          var10 = hk.field_j - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= hk.field_h) {
            break L0;
          } else {
            var13 = hk.field_h - param2;
            param4 = param4 - var13;
            param2 = hk.field_h;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * hk.field_j;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= hk.field_b) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - hk.field_b);
            break L1;
          }
        }
        L2: {
        ...
        L3: {
          if (param1 + param3 <= hk.field_g) {
            break L3;
          } else {
            var13 = param1 + param3 - hk.field_g;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  ni.a(0, hk.field_l, ((ni) this).field_M[param0], ((ni) this).field_X[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  lm.a(hk.field_l, ((ni) this).field_M[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * hk.field_j;
          var9 = hk.field_j - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= hk.field_h) {
            break L0;
          } else {
            var12 = hk.field_h - param2;
            param4 = param4 - var12;
            param2 = hk.field_h;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * hk.field_j;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= hk.field_g) {
            ...
            var12 = param1 + param3 - hk.field_g;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  ni.a(0, hk.field_l, ((ni) this).field_M[param0], ((ni) this).field_X[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  lm.a(hk.field_l, ((ni) this).field_M[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
