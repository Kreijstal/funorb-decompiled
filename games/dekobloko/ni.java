        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  ni.a(0, hk.field_l, this.field_M[param0], this.field_X[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  ni.a(0, hk.field_l, this.field_M[param0], this.field_X[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
