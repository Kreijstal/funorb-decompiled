                ...
                switch (statePc) {
                    ...
                    case 9: {
                        try {
                            ...
                            stackOut_9_1 = new StringBuilder().append("bh.VA(").append(param0).append(44);
    ...
    final static int a(int param0, boolean param1, CharSequence param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 4: {
                    try {
                        stackOut_4_0 = s.a(true, 4, param0, param2);
                ...
                case 7: {
                    try {
                        ...
                        stackOut_7_1 = new StringBuilder().append("bh.BB(").append(param0).append(44).append(param1).append(44);
    ...
    final static String a(int param0, String param1, String param2, String param3) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 8: {
                    try {
                        var4_int = ((String) (Object) stackIn_8_0).indexOf(param3, param2.length() + var4_int);
                        if (var5 == 0) {
                            statePc = 6;
                        } else {
                            statePc = 9;
