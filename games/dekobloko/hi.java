 ...
 */
final class hi implements ej {
    private com.ms.directX.DSBufferDesc[] field_a;
    private com.ms.directX.DSCursors[] field_b;

    public hi() throws Exception {
        int var1 = 0;
        ((hi) this).field_b = new com.ms.directX.DSCursors[2];
        ((hi) this).field_a = new com.ms.directX.DSBufferDesc[2];
        ...
        for (var1 = 0; 2 > var1; var1++) {
            ((hi) this).field_a[var1] = new com.ms.directX.DSBufferDesc();
        }
        for (var1 = 0; var1 < 2; var1++) {
            ((hi) this).field_b[var1] = new com.ms.directX.DSCursors();
        }
    }
}
