...
final class ld extends ck {
    ...
    final void d(int param0, int param1) {
        ...
        int stackOut_19_2 = 0;
        L0: {
          var3 = ((ld) this).field_I >> 1;
          var4 = ((ld) this).field_H >> 1;
          param0 = param0 + ((ld) this).field_F / 2;
          param1 = param1 + ((ld) this).field_z / 2;
        ...
        L1: {
          ...
          if (param0 + var3 <= hk.field_g) {
            stackOut_5_0 = ((ld) this).field_I - 2;
        ...
        L3: {
          ...
          if (param1 + var4 <= hk.field_b) {
            stackOut_11_0 = ((ld) this).field_H - 2;
        ...
        L4: while (true) {
          if (var9 > var8) {
            ...
            var10 = var9 * ((ld) this).field_I + var5;
    ...
    final void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        L0: {
          if (param2 <= 0) {
            ...
            if (param3 > 0) {
              L1: {
                var6 = ((ld) this).field_I;
                var7 = ((ld) this).field_H;
                var8 = 0;
                var9 = 0;
                var10 = ((ld) this).field_K;
                var11 = ((ld) this).field_C;
                var12 = (var10 << 16) / param2;
                var13 = (var11 << 16) / param3;
                if (((ld) this).field_F <= 0) {
                  break L1;
                } else {
                  var14 = ((((ld) this).field_F << 16) + var12 - 1) / var12;
                  param0 = param0 + var14;
                  var8 = var8 + (var14 * var12 - (((ld) this).field_F << 16));
                  break L1;
                }
              }
              L2: {
                if (((ld) this).field_z <= 0) {
                  break L2;
                } else {
                  var14 = ((((ld) this).field_z << 16) + var13 - 1) / var13;
                  param1 = param1 + var14;
                  var9 = var9 + (var14 * var13 - (((ld) this).field_z << 16));
                  break L2;
                }
              }
              L3: {
              ...
              ld.e(hk.field_l, ((ld) this).field_D, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
              return;
            } else {
              break L0;
            }
    ...
    final void e(int param0, int param1, int param2) {
        ...
        if (param2 != 256) {
          L0: {
            param0 = param0 + ((ld) this).field_F;
            param1 = param1 + ((ld) this).field_z;
            var4 = param0 + param1 * hk.field_j;
            var5 = 0;
            var6 = ((ld) this).field_H;
            var7 = ((ld) this).field_I;
          ...
          L4: {
            if (var7 <= 0) {
              ...
              if (var6 > 0) {
                ld.f(hk.field_l, ((ld) this).field_D, 0, var5, var4, var7, var6, var8, var9, param2);
                return;
              } else {
                break L4;
              }
    ...
    final void a(int param0, int param1, int param2) {
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              ld.e(hk.field_l, ((ld) this).field_D, 0, var5, var4, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
    ...
    final void c(int param0, int param1, int param2) {
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              ld.d(hk.field_l, ((ld) this).field_D, 0, var5, var4, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
    ...
    final void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param4 != 256) {
          L0: {
            if (param2 <= 0) {
              ...
              if (param3 > 0) {
                ...
                ld.d(hk.field_l, ((ld) this).field_D, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
                return;
              } else {
                break L0;
              }
          ...
          ((ld) this).c(param0, param1, param2, param3);
          return;
        }
    }
    ...
    final void b(int param0, int param1, int param2) {
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              ld.d(hk.field_l, ((ld) this).field_D, 0, var5, var4, 0, 0, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
    ...
    final void f(int param0, int param1, int param2) {
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              ld.b(0, 0, 0, hk.field_l, ((ld) this).field_D, var5, 0, var4, 0, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
    ...
    final void e(int param0, int param1) {
        ...
        L4: {
          if (var6 <= 0) {
            ...
            if (var5 > 0) {
              ld.c(hk.field_l, ((ld) this).field_D, 0, var4, var3, var6, var5, var7, var8);
              return;
            } else {
              break L4;
            }
    ...
    final void c(int param0, int param1, int param2, int param3) {
        ...
        L0: {
          if (param2 <= 0) {
            ...
            if (param3 > 0) {
              L1: {
                var5 = ((ld) this).field_I;
                var6 = ((ld) this).field_H;
                var7 = 0;
                var8 = 0;
                var9 = ((ld) this).field_K;
                var10 = ((ld) this).field_C;
                var11 = (var9 << 16) / param2;
                var12 = (var10 << 16) / param3;
                if (((ld) this).field_F <= 0) {
                  break L1;
                } else {
                  var13 = ((((ld) this).field_F << 16) + var11 - 1) / var11;
                  param0 = param0 + var13;
                  var7 = var7 + (var13 * var11 - (((ld) this).field_F << 16));
                  break L1;
                }
              }
              L2: {
                if (((ld) this).field_z <= 0) {
                  ...
                  var13 = ((((ld) this).field_z << 16) + var12 - 1) / var12;
                  param1 = param1 + var13;
                  var8 = var8 + (var13 * var12 - (((ld) this).field_z << 16));
                  break L2;
                }
              }
              L3: {
              ...
              ld.c(hk.field_l, ((ld) this).field_D, 0, var7, var8, var13, var14, param2, param3, var11, var12, var5);
              return;
            } else {
              break L0;
            }
