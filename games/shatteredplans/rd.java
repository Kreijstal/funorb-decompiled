...
final class rd implements fo {
    ...
    public final l a(byte param0) throws jn {
        ...
        var12 = new l(pe.a((byte) 34, ((rd) this).field_f), ls.a(((rd) this).field_c, 2), ((rd) this).field_a, ((rd) this).field_b);
        var3 = new hs(((rd) this).field_f, ((rd) this).field_c, ((rd) this).field_a, ((rd) this).field_b, 1);
        var3.a(false, var12);
            ...
            L1: while (true) {
              if (var7 <= var8) {
                ...
                L2: while (true) {
                  ...
                  L4: {
                    var6.field_x = ((rd) this).field_e.f(-20976);
    ...
    final static qr a(int param0, int param1, int param2, int param3, int param4, byte param5, int param6, int param7, nq param8, int param9, int param10, int param11, int param12) {
        ...
        try {
          L0: {
            ...
            var13.field_vb = qp.a(param10, 127, param6);
            var13.field_sb = qp.a(param1, -102, param4);
            var13.field_wb = qp.a(param0, -114, param2);
            var13.field_nb = param8;
            var13.field_x = param9;
            stackOut_2_0 = (qr) var13;
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("rd.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44).append(99).append(44).append(param6).append(44).append(param7).append(44);
          ...
          throw r.a((Throwable) (Object) stackIn_7_0, stackIn_7_2 + 44 + param9 + 44 + param10 + 44 + param11 + 44 + param12 + 41);
        }
        return stackIn_3_0;
    }
