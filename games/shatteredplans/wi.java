...
final class wi {
    ...
    final static wa a(int param0, int param1, wa param2, int param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("wi.B(").append(param0).append(',').append(param1).append(',');
          ...
          throw r.a((Throwable) (Object) stackIn_10_0, stackIn_10_2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + -3903 + ')');
        }
        return stackIn_6_0;
    }
    ...
    final static void a(int param0, byte param1, v param2, int param3, v param4, int param5) {
        try {
            ...
            throw r.a((Throwable) (Object) runtimeException, "wi.D(" + 2 + ',' + 67 + ',' + (param2 != null ? "{...}" : "null") + ',' + param3 + ',' + (param4 != null ? "{...}" : "null") + ',' + param5 + ')');
        }
    }
    ...
    final static int a(e param0, e param1, int param2) {
        ...
        try {
          L0: {
            var4 = null;
            stackOut_0_0 = si.a(0, 0, param0, param1, 120, (String) null, false);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("wi.A(");
