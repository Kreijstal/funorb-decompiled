...
final class cj extends j {
    ...
    final int a(ln param0, byte param1) {
        int var3 = param0.field_x;
        if (!(!param0.field_u)) {
            var3 = var3 * 2 + 5;
        }
        var3 = var3 + param0.field_D.length;
        if (param1 > -49) {
            field_v = null;
        }
        var3 = var3 + ((cj) this).a((byte) -64, param0);
        if ((var3 ^ -1) > -2) {
            var3 = 1;
        }
        return var3;
    ...
    final int d(ln param0, int param1) {
        ...
        int var3 = param0.field_x - -param0.field_D.length;
          ...
          if (var3 >= var2) {
            ...
            if (((cj) this).field_n.field_x != var4) {
              if (!((cj) this).field_n.field_h[var4]) {
                if (-1 == (((cj) this).field_g.field_w & 1 << var4 ^ -1)) {
                  var5 = 1;
                  var6 = 0;
                  L2: while (true) {
                    if (((cj) this).field_g.field_r <= var6) {
                      ...
                      L5: {
                        ...
                        if (-1 != (1 << var6 & ((cj) this).field_g.field_w ^ -1)) {
                          break L5;
                        } else {
                          var6++;
                          continue L2;
    ...
    final static void a(int param0, int param1, qr param2) {
        ...
        L1: {
          if ((param0 ^ -1) == -2) {
            var20 = hp.field_m;
            var21_ref = bh.field_m[0];
            var30 = var21_ref;
            var30 = var21_ref;
            var22 = hk.field_pb;
            var20.field_j.a(false, var21_ref, var22, 11);
            var23 = hp.field_m;
            var24 = bh.field_m[1];
            var30 = var24;
            var30 = var24;
        ...
        L2: {
          if (2 == param0) {
            var29 = hp.field_m;
            var30_ref = bh.field_m[0];
            var31 = sj.field_d;
            var29.field_j.a(false, var30_ref, var31, 11);
            var32 = hp.field_m;
            var33 = bh.field_m[1];
            var34 = field_w;
