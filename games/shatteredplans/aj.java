...
final class aj {
    ...
    final static StringBuilder a(StringBuilder param0, int param1, int param2) {
        ...
        try {
          ...
          throw r.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + param1 + 44 + param2 + 44 + 32 + 41);
        }
        return stackIn_5_0;
    }
    ...
    final static void a(boolean param0, byte param1, fb param2, String param3) {
        ...
        try {
          L0: {
            L1: {
              tp.a((int[]) null, 0L, (String) null, (String) null, 293, qs.field_y, (qr) (Object) param2, -1, param2.g(-77));
              if (!param2.field_Ab) {
                break L1;
              } else {
                L2: {
                ...
                var7 = hp.field_m;
                var8 = re.a(fk.field_o, 4371, new String[1]);
            ...
            L3: {
              ...
              if (kf.field_g == hp.field_m.field_f) {
                var11 = hp.field_m;
                var12 = re.a(id.field_e, 4371, new String[1]);
                var11.field_j.a(1, 16, var12);
                break L3;
              } else {
                var9 = hp.field_m;
                var10 = re.a(cb.field_g, 4371, new String[1]);
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("aj.F(").append(1).append(44).append(-100).append(44);
    ...
    final static boolean a(int param0, int param1, int param2, int[] param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("aj.E(").append(1).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final static ms a(String param0, boolean param1, boolean param2, String param3) {
        ...
        try {
          L0: {
            ...
            stackOut_4_0 = dd.a(false, param3, (String) var6, 4684, var4_long);
            stackIn_5_0 = stackOut_4_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L3: {
            ...
            stackOut_9_1 = ((StringBuilder) (Object) stackIn_9_1).append(stackIn_9_2).append(44).append(0).append(44).append(0).append(44);
