...
final class ln extends df {
    ...
    final void a(ln param0, byte param1) {
        ...
        try {
            ...
            ln[] var3 = var8;
            var4 = 0;
            for (var5 = 0; ((ln) this).field_D.length > var5; var5++) {
                if (param0 != ((ln) this).field_D[var5]) {
                    int incrementValue$0 = var4;
                    var4++;
                    var7[incrementValue$0] = ((ln) this).field_D[var5];
                }
            }
            if (param1 >= -122) {
            ...
            throw r.a((Throwable) (Object) runtimeException, "ln.D(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final void a(byte param0, ln param1) {
        ...
        try {
          L0: {
            L1: {
              if (null == ((ln) this).field_D) {
                ...
                var4 = 0;
                L2: while (true) {
                  if (var4 >= ((ln) this).field_D.length) {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("ln.F(").append(param0).append(44);
    ...
    final boolean b(ln param0, byte param1) {
        ...
        try {
          ...
          throw r.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + 44 + param1 + 41);
        }
