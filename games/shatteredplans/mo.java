 ...
 */
final class mo implements pm {
    private com.ms.directX.DSCursors[] field_a;
    private com.ms.directX.DSBufferDesc[] field_b;

    public mo() throws Exception {
        int var1 = 0;
        ((mo) this).field_a = new com.ms.directX.DSCursors[2];
        ((mo) this).field_b = new com.ms.directX.DSBufferDesc[2];
        ...
        for (var1 = 0; (var1 ^ -1) > -3; var1++) {
            ((mo) this).field_b[var1] = new com.ms.directX.DSBufferDesc();
        }
        for (var1 = 0; (var1 ^ -1) > -3; var1++) {
            ((mo) this).field_a[var1] = new com.ms.directX.DSCursors();
        }
    }
}
