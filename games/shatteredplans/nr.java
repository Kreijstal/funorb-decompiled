...
final class nr extends oh {
    ...
    nr(ln param0, int param1) {
        try {
            ...
            throw r.a((Throwable) (Object) runtimeException, "nr.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    nr(ln param0, int[] param1, ln[] param2) {
        ...
        try {
          L0: {
            ...
            var4_int = 0;
            L1: while (true) {
              if (var4_int >= ((nr) this).field_i.length) {
                break L0;
              } else {
                var4_int++;
                continue L1;
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("nr.<init>(");
