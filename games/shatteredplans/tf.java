...
final class tf implements iq {
            ...
            switch (statePc) {
                ...
                case 7: {
                    try {
                        ...
                        stackOut_7_1 = new StringBuilder().append("tf.B(");
    ...
    final static wa a(byte param0) {
        ...
        int stackIn_37_0 = 0;
        int stackIn_47_0 = 0;
        wa stackIn_53_0 = null;
        int stackIn_56_0 = 0;
        int stackIn_56_1 = 0;
        wa stackIn_60_0 = null;
        int stackOut_2_0 = 0;
        int stackOut_3_0 = 0;
        int stackOut_3_1 = 0;
        ...
        int stackOut_36_0 = 0;
        int stackOut_46_0 = 0;
        wa stackOut_52_0 = null;
        int stackOut_55_0 = 0;
        int stackOut_55_1 = 0;
        wa stackOut_59_0 = null;
        int statePc = 0;
        Throwable caughtException = null;
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 7: {
                    try {
                        ...
                        rd.field_g = bj.field_J[ui.field_p];
                        if (var4 == 0) {
                            statePc = 1;
                        } else {
                            statePc = 8;
                ...
                case 24: {
                    try {
                        stackOut_24_0 = -1;
                        stackOut_24_1 = var2 ^ -1;
                        stackIn_56_0 = stackOut_24_0;
                        stackIn_56_1 = stackOut_24_1;
                ...
                case 37: {
                    try {
                        if (stackIn_37_0 == rd.field_g.field_a) {
                            statePc = 42;
                        } else {
                            statePc = 38;
                        }
                ...
                case 55: {
                    try {
                        stackOut_55_0 = var1_ref.field_g + -rd.field_g.field_g;
                        stackOut_55_1 = rd.field_g.field_h;
            ...
            switch (statePc) {
                ...
                case 21: {
                    try {
                        ...
                        int discarded$1 = ((tf) this).field_i.a(param0.field_s, var10 + (param0.field_m + param1), ((tf) this).field_g + (param3 + param0.field_q), param0.field_x - var10 - ((tf) this).field_q, -(((tf) this).field_q << 403882081) + param0.field_n, ((tf) this).field_f, ((tf) this).field_d, ((tf) this).field_o, ((tf) this).field_r, 0);
                        statePc = 29;
                        continue stateLoop;
                    } catch (Throwable stateCaught_21) {
                        caughtException = stateCaught_21;
                ...
                case 24: {
                    try {
                        ...
                        stackOut_24_1 = new StringBuilder().append("tf.E(");
                ...
                case 28: {
                    throw r.a((Throwable) (Object) stackIn_28_0, stackIn_28_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
                }
                case 29: {
                    return;
                }
    ...
    tf(nq param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 8: {
                    throw r.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 44 + param8 + 44 + param9 + 41);
                }
                case 9: {
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
