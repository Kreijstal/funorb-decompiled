    ...
    final static nk[] a(int param0, bc param1, int param2, int param3) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_5_1 = new StringBuilder().append("lg.F(").append(-20435).append(',');
    ...
    final static nk a(int param0, int param1, int param2, bc param3) {
        ...
        try {
          ...
          L0: {
            var4 = decompiledCaughtException;
            stackOut_5_0 = (RuntimeException) var4;
            stackOut_5_1 = new StringBuilder().append("lg.C(").append(-78).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
            stackIn_6_0 = stackOut_5_0;
            stackIn_6_1 = stackOut_5_1;
    ...
    final static bi a(int param0, String param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("lg.D(").append(0).append(',');
