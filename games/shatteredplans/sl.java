...
final class sl extends ob {
    ...
    final static lp a(int param0, int param1, fs param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("sl.L(").append(param0).append(',').append(-30577).append(',');
          ...
          throw r.a((Throwable) (Object) stackIn_5_0, stackIn_5_2 + ',' + param3 + ')');
        }
        return stackIn_1_0;
    }
    ...
    final static void a(int param0, vm param1) {
        ...
        try {
            mr.field_h = param1;
            ua.field_f.field_M.a(0);
            ua.field_f.a(4, (qr) (Object) mr.field_h);
            dp.field_t = true;
        } catch (RuntimeException runtimeException) {
            throw r.a((Throwable) (Object) runtimeException, "sl.A(" + 0 + ',' + (param1 != null ? "{...}" : "null") + ')');
        }
    }
