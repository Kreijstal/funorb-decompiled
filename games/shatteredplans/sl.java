...
final class sl extends ob {
    ...
    final void b(int param0, int param1, int param2, byte[] param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (param0 <= var5_int) {
                ...
                this.field_j = this.field_j + 1;
                param3[param2 + var5_int] = (byte)(this.field_h[fieldTemp$5] + -this.field_o.d(13));
                var5_int++;
                continue L1;
              }
            }
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("sl.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static lp a(int param0, int param1, fs param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("sl.L(").append(param0).append(',').append(param1).append(',');
    ...
    final int h(byte param0) {
        ...
        if (param0 != 126) {
          ...
          this.field_j = this.field_j + 1;
          return this.field_h[fieldTemp$2] + -this.field_o.d(13) & 255;
        }
    }
