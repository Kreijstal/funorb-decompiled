...
final class pa extends li {
    ...
    final static byte[] a(byte[] param0, int param1) {
        ...
        try {
                    ...
                    if (0 > var5_int) {
                      ...
                      L6: {
                        ...
                        if (var3 != 1) {
                          ...
                          discarded$1 = lb.a(var12, var5_int, param0, var4, 9);
                          break L6;
                        }
                      }
          ...
          L8: {
            ...
            stackOut_24_1 = new StringBuilder().append("pa.I(");
    ...
    private final java.net.Socket a(int param0, String param1, String param2, int param3) throws IOException {
        ...
        try {
          ...
          throw r.a((Throwable) ((Object) stackIn_36_0), stackIn_36_2 + ',' + param3 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_6_0;
        } else {
    ...
    final static void a(String[] args, sq param1, byte param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("pa.E(");
    ...
    private final java.net.Socket a(int param0, java.net.Proxy param1) throws IOException {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_23_1 = new StringBuilder().append("pa.A(").append(param0).append(',');
    ...
    final static String a(ln param0, int param1) {
        ...
        try {
          L0: {
            ...
            stackOut_5_0 = re.a("<col=<%0>>" + param0.field_I + "</col>", 4371, new String[]{Integer.toString(var2_int, 16)});
            stackIn_6_0 = stackOut_5_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
