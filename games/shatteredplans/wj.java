...
final class wj extends oh {
            ...
            L1: {
              ...
              if (1 == je.field_d) {
                ...
                if (rf.field_n == 1) {
                  ...
                  if (rs.field_Db == null) {
                    var2 = (-pd.field_k + am.field_Gb) * (am.field_Gb - pd.field_k) - -((-bb.field_b + tc.field_C) * (tc.field_C + -bb.field_b));
                    if (5 >= jb.field_b) {
                      break L1;
                    } else {
                      if (25 >= var2) {
    ...
    final static void a(int param0) {
        ...
        if (param0 == 128) {
          L3: {
            ac.field_s.f(var1, var2);
            tg.a(var2, oe.field_c, (byte) 15, var1);
          ...
          ((bi) (Object) stackIn_15_0).c(stackIn_15_1, stackIn_15_2, stackIn_15_3 * stackIn_15_4 >> 1705641288);
          ...
          L4: while (true) {
            if (var11.length <= var8) {
                  ...
                  L6: while (true) {
                    if (var8 >= 50) {
                      ...
                      L7: {
                        ...
                        gf.b(var1 << 1931902500, var2 << 1231932036, -var8 + 50, -(var8 * 2) + 100, fe.field_u);
                        if ((var9 ^ -1) > -1) {
                          var9 += 50;
                          break L7;
                        } else {
                      ...
                      var1 = (int)var7_ref.field_o[var9];
              ...
              if (0 != var9_ref_nd.field_a) {
                gf.b(var9_ref_nd.field_e + var1 << 1035740484, var9_ref_nd.field_j - -var2 << 1755684804, var9_ref_nd.field_f, var9_ref_nd.field_a, fe.field_u);
                var8++;
                continue L4;
              } else {
                var8++;
