...
final class og implements iq {
    ...
    final static uj a(int param0, mn param1, fs param2, dc param3, int param4) {
        ...
        try {
          L0: {
            stackOut_2_0 = new cj(param3, param2, param1);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("og.C(").append(2).append(',');
          ...
          throw r.a((Throwable) (Object) stackIn_14_0, stackIn_14_2 + ',' + -114 + ')');
        }
              ...
              L1: {
                ...
                if (!(param0 instanceof kg)) {
                  ...
                  if (((kg) (Object) param0).field_z) {
                    var8.c(1 + (var6_int + (param0.field_x - var8.field_o >> 1)), (-var8.field_p + param0.field_n >> 1) + 1 + var7, 256);
                    break L1;
                  } else {
                    break L1;
                  }
