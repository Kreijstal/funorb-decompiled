...
class bi extends ii {
    ...
    final void d() {
        int incrementValue$0 = 0;
        int var1 = 0;
        int var2 = this.field_z * this.field_w;
        int[] var3 = new int[var2];
        while (var2 > 0) {
            incrementValue$0 = var1;
            var1++;
            var2--;
            var3[incrementValue$0] = this.field_B[var2];
        }
        this.field_B = var3;
        this.field_t = this.field_o - this.field_z - this.field_t;
        this.field_x = this.field_p - this.field_w - this.field_x;
    }
    ...
    void a(int param0, int param1, int param2) {
        ...
        int var4 = param0 + param1 * gf.field_b;
        int var5 = 0;
        int var6 = this.field_w;
        int var7 = this.field_z;
        int var8 = gf.field_b - var7;
        int var9 = 0;
        ...
        if (var7 > 0) {
            ...
            bi.b(gf.field_h, this.field_B, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          L0: {
            ...
            var17 = ((this.field_z << 4) - param0) * var10 + ((this.field_w << 4) - param1) * var9;
            var18 = -((this.field_z << 4) - param0) * var9 + ((this.field_w << 4) - param1) * var10;
            if (var11 >= var13) {
              var19 = var13;
              var20 = var11;
              break L0;
                              ...
                              if (var37 >= 0) {
                                ...
                                L21: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    gf.field_h[incrementValue$0] = var38;
                                    break L21;
                                  }
                                }
                                var35 = var35 + var27;
                              ...
                              if (var37 >= 0) {
                                ...
                                L28: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    gf.field_h[incrementValue$1] = var38;
                                    break L28;
                                  }
                                }
                                var35 = var35 + var27;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L34: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        gf.field_h[incrementValue$2] = var38;
                                        break L34;
                                      }
                                    }
                                    var35 = var35 + var27;
                              ...
                              if (var37 >= 0) {
                                ...
                                L41: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    gf.field_h[incrementValue$3] = var38;
                                    break L41;
                                  }
                                }
                                var35 = var35 + var27;
                              ...
                              if (var37 >= 0) {
                                ...
                                L48: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    gf.field_h[incrementValue$4] = var38;
                                    break L48;
                                  }
                                }
                                var35 = var35 + var27;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L54: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        gf.field_h[incrementValue$5] = var38;
                                        break L54;
                                      }
                                    }
                                    var35 = var35 + var27;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L60: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        gf.field_h[incrementValue$6] = var38;
                                        break L60;
                                      }
                                    }
                                    var36 = var36 + var26;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L66: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        gf.field_h[incrementValue$7] = var38;
                                        break L66;
                                      }
                                    }
                                    var36 = var36 + var26;
                                  ...
                                  L69: while (true) {
                                    if (var37 >= 0) {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        gf.field_h[incrementValue$8] = var38;
                                        var37++;
                                        continue L69;
                                      }
                                    }
    ...
    final void e(int param0, int param1) {
        ...
        param0 = param0 + this.field_t;
        param1 = param1 + this.field_x;
        int var3 = param0 + param1 * gf.field_b;
        int var4 = 0;
        ...
        if (var6 > 0) {
            ...
            bi.a(0, gf.field_h, this.field_B, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    void d(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            bi.a(gf.field_h, this.field_B, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    final void b() {
        ...
        for (var2 = (this.field_w >> 1) - 1; var2 >= 0; var2--) {
            var3 = var2 * this.field_z;
            var4 = (this.field_w - var2 - 1) * this.field_z;
    ...
    final void f() {
        ...
        int incrementValue$0 = 0;
        int var3 = 0;
        int[] var1 = new int[this.field_z * this.field_w];
        int var2 = 0;
        ...
        this.field_t = this.field_p - this.field_w - var3;
        var3 = this.field_w;
    ...
    void c(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            if (param2 == 256) {
                bi.a(0, 0, 0, gf.field_h, this.field_B, var5, 0, var4, 0, var7, var6, var8, var9);
            } else {
                bi.a(0, 0, 0, gf.field_h, this.field_B, var5, 0, var4, 0, var7, var6, var8, var9, param2);
            }
            return;
        }
    }
    ...
    void f(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            bi.a(gf.field_h, this.field_B, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final bi c() {
        int var2 = 0;
        int var3 = 0;
        bi var1 = new bi(this.field_z, this.field_w);
        var1.field_o = this.field_o;
        var1.field_p = this.field_p;
        var1.field_t = this.field_o - this.field_z - this.field_t;
    ...
    final void e(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            bi.b(gf.field_h, this.field_B, param2, var5, var4, var7, var6, var8, var9);
            return;
        }
    }
    ...
    void d(int param0, int param1) {
        ...
        int var4 = param0 + (this.field_z >> 1) > gf.field_l ? gf.field_l - param0 << 1 : this.field_z;
        int var5 = param1 < gf.field_a ? gf.field_a - param1 << 1 : 0;
        int var6 = param1 + (this.field_w >> 1) > gf.field_f ? gf.field_f - param1 << 1 : this.field_w;
        bi.a(this.field_B, var5 * this.field_z + var3, (param1 + (var5 >> 1)) * gf.field_b + (param0 + (var3 >> 1)), (this.field_z << 1) - (var4 - var3) + (this.field_z & 1), gf.field_b - (var4 - var3 >> 1), this.field_z, var4 - var3 >> 1, var6 - var5 >> 1);
    }

    final void a(int param0, int param1, int param2, int param3) {
        int var5 = this.field_o << 3;
        int var6 = this.field_p << 3;
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                param2++;
                gf.field_h[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
    ...
    void b(int param0, int param1, int param2, int param3) {
        ...
        if (param2 > 0) {
            ...
            bi.b(gf.field_h, this.field_B, 0, var7, var8, var13, var14, param2, param3, var11, var12, var5);
            return;
        }
    }

    final void e() {
        gf.a(this.field_B, this.field_z, this.field_w);
    }
        ...
        L0: {
          if (param2 > this.field_o) {
            ...
            if (param3 <= this.field_p) {
              L1: {
                var5 = param0 + this.field_t * param2 / this.field_o;
                var6 = param0 + ((this.field_t + this.field_z) * param2 + this.field_o - 1) / this.field_o;
                var7 = param1 + this.field_x * param3 / this.field_p;
                var8 = param1 + ((this.field_x + this.field_w) * param3 + this.field_p - 1) / this.field_p;
                if (var5 >= gf.field_i) {
                  break L1;
                } else {
                  var5 = gf.field_i;
                    ...
                    if (var11 >= var8) {
                      ...
                      L6: while (true) {
                        if (var12 >= var6) {
                          ...
                          var15 = var13 * this.field_o / param2 - (this.field_t << 4);
                          var16 = (var13 + 16) * this.field_o / param2 - (this.field_t << 4);
                          var17 = var14 * this.field_p / param3 - (this.field_x << 4);
                          var18 = (var14 + 16) * this.field_p / param3 - (this.field_x << 4);
                          ...
                          if (var19 != 0) {
                            ...
                            L10: {
                              if (var18 <= this.field_w << 4) {
                                break L10;
                              } else {
                                var18 = this.field_w << 4;
                                break L10;
                              }
                            }
                            var16--;
    ...
    void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            bi.a(gf.field_h, this.field_B, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
            return;
        }
    }
    ...
    final void c(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            if (param4 == 256) {
                bi.a(0, 0, 0, var8, this.field_B, gf.field_h, 0, 0, -param3, var9, var14, var15, param2, var12, var13, var6);
            } else {
                bi.a(0, 0, 0, var8, this.field_B, gf.field_h, 0, 0, -param3, var9, var14, var15, param2, var12, var13, var6, param4);
            }
            return;
        }
    }
    ...
    bi(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            this.field_o = this.field_z;
            this.field_p = this.field_w;
            this.field_t = 0;
            this.field_x = 0;
            this.field_B = new int[this.field_z * this.field_w];
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_z, this.field_w, this.field_B, 0, this.field_z);
            var5.grabPixels();
            break L0;
          }
    ...
    void b(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            bi.a(gf.field_h, this.field_B, 0, var5, var4, 0, 0, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    void g(int param0, int param1) {
        ...
        L0: {
          ...
          if (param0 >= gf.field_i) {
            ...
            stackIn_3_0 = gf.field_i - param0 << 2;
            break L0;
          }
        }
        L1: {
          ...
          if (param0 + var3 <= gf.field_l) {
            ...
            stackIn_6_0 = (gf.field_l - param0 << 2) - 4;
            break L1;
          }
        }
        L2: {
          ...
          if (param1 >= gf.field_a) {
            ...
            stackIn_9_0 = gf.field_a - param1 << 2;
            break L2;
          }
        }
        L3: {
          ...
          if (param1 + var4 <= gf.field_f) {
            stackIn_12_0 = this.field_w - 4;
            break L3;
          } else {
            stackIn_12_0 = (gf.field_f - param1 << 2) - 4;
            break L3;
          }
        }
        var8 = stackIn_12_0;
    ...
    void c(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            bi.a(gf.field_h, this.field_B, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final void a() {
        ...
        int var5 = 0;
        int[] var1 = this.field_B;
        for (var2 = this.field_w - 1; var2 >= 0; var2--) {
            var3 = var2 * this.field_z;
    ...
    final void f(int param0) {
        ...
        int var5;
        int var6;
        var2 = new int[this.field_z * this.field_w];
        var3 = 0;
        var4 = 0;
        L0: while (true) {
                  ...
                  if (var6 != 0) {
                    ...
                    L4: {
                      if (var4 <= 0) {
                        ...
                        if (this.field_B[var3 - this.field_z] == 0) {
                          break L4;
                        } else {
                          var6 = param0;
                          break L2;
