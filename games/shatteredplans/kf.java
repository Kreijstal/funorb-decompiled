          ...
          L0: {
            L1: {
              ...
              if (param0 > 113) {
                ...
                discarded$2 = kf.a((String) null, 22, (bc) null, (String) null);
                break L1;
              }
            }
            field_h = null;
        ...
        try {
            ...
            try {
                ...
                try {
                  L1: {
                    if (null != ts.field_G) {
                      ...
                      dupTemp$1 = new qb(param3, param4, param1, true);
              ...
              L7: {
                ...
                stackOut_21_1 = new StringBuilder().append("kf.AB(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
                      ...
                      if (-1001L > (pr.a(14274) - nh.field_m ^ -1L)) {
                        L3: {
                          ...
                          if (null == var2_ref) {
                            ...
                            if ((var2_ref.width ^ -1) > (tj.field_h ^ -1)) {
                              break L2;
                            } else {
                              if ((var2_ref.height ^ -1) > (b.field_u ^ -1)) {
                                break L2;
                              } else {
                                break L3;
                              }
            ...
            try {
              L0: {
                if (!this.field_e) {
                  ...
                  try {
                    L1: {
                      discarded$1 = ll.a("loggedout", kq.f((byte) 126), (byte) 55);
                      break L1;
                    }
                  } catch (java.lang.Throwable decompiledCaughtParameter0) {
                    decompiledCaughtException = decompiledCaughtParameter0;
            ...
            L1: while (true) {
              ...
              L4: {
                if (stackIn_12_0 >= stackIn_12_1) {
                  ...
                  discarded$1 = kf.a((String) null, -57, (bc) null, (String) null);
                  break L4;
                }
              }
          ...
          L0: {
            ...
            L7: {
              L8: {
                ...
                discarded$6 = ((java.awt.Container) (var2)).add((java.awt.Component) ((Object) tm.field_i));
                tm.field_i.setSize(me.field_e, nn.field_b);
                tm.field_i.setVisible(true);
                if (uf.field_b != var2) {
                  break L8;
