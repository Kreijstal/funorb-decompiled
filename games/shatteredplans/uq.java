    ...
    final static boolean a(bc param0, int param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("uq.B(");
    ...
    final static dc a(int param0, int param1, int param2, String[] param3, vr param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("uq.D(").append(param0).append(',').append(param1).append(',').append(-27579).append(',');
