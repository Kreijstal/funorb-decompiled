...
final class vb {
    ...
    final int a() {
        ...
        while (this.field_f[var1] >= 0) {
            var1 = fd.c() != 0 ? this.field_f[var1] : var1 + 1;
        }
    ...
    vb() {
        ...
        L0: {
          fd.a(24);
          this.field_a = fd.a(16);
          this.field_c = fd.a(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_c) {
                ...
                var4_int = fd.a(rj.c(10, this.field_c - var2));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_c * this.field_a;
                break L9;
              } else {
                var7 = vb.a(this.field_c, this.field_a);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_d = new float[this.field_c][this.field_a];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
