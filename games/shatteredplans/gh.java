                      ...
                      L6: {
                        if (var9 != 144) {
                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              var13 = var18[var10];
                              var14 = (be) ((Object) this.field_i.a((long)var13, -25064));
                              if (var14 != null) {
                                break L7;
                              } else {
                                var14 = new be(new byte[128]);
                                this.field_i.a(var14, 89, (long)var13);
                                break L7;
                              }
                            }
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51 = new ob(this.field_h);
                      var51.e(11135, 1297377380);
                      var51.e(11135, 6);
                      stackIn_66_0 = (ob) (var51);

                      if (var2 <= 1) {
                        stackIn_67_0 = (ob) ((Object) stackIn_66_0);
                        stackIn_67_1 = 0;
                        break L3;
                      } else {
                        stackIn_67_0 = (ob) ((Object) stackIn_66_0);
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                      ...
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            var44++;
                                            var51.c((int) param0.field_h[incrementValue$1], (byte) -71);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var50++;
                              var51.c((int) param0.field_h[incrementValue$25], (byte) -78);
                              incrementValue$26 = var50;
                              var50++;
                              var51.c((int) param0.field_h[incrementValue$26], (byte) -101);
                              incrementValue$27 = var50;
                              var50++;
                              var51.c((int) param0.field_h[incrementValue$27], (byte) -92);
                              continue L5;
                            }
                          } else {
                            L18: {
