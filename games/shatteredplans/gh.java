                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              ...
                              if (var14 != null) {
                                ...
                                ((gh) this).field_i.a((oh) (Object) var14_ref, 89, (long)var13);
                                break L7;
                              }
                            }
                            var14_ref.field_j[var11] = (byte) 1;
                            break L6;
                          }
                        }
                      }
          ...
          if (var13 >= var2) {
            ...
            L1: while (true) {
              if (var15 >= var14) {
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                      ...
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            var44++;
                                            var51.c((int) param0.field_h[var44], (byte) -71);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var51.c(3, (byte) -68);
                              var50++;
                              var51.c((int) param0.field_h[var50], (byte) -78);
                              var50++;
                              var51.c((int) param0.field_h[var50], (byte) -101);
                              var50++;
                              var51.c((int) param0.field_h[var50], (byte) -92);
                              continue L5;
                            }
                          } else {
                            L18: {
                ...
                int discarded$1 = param0.c(false);
                var15++;
                continue L1;
              }
            }
