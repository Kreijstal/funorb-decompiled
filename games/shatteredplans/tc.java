...
final class tc extends qs {
          ...
          if (var10 == var12) {
            ...
            L8: while (true) {
              if (var12 <= var22) {
                ...
                L12: {
                  var23 = var4 + var8 * (16 * (-var10 + var22) - (-16 + var11)) / var9;
    ...
    final static void a(boolean param0, boolean param1) {
        ...
        if (!param0) {
            boolean discarded$0 = tc.a('x', 117);
        }
