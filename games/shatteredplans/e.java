    ...
    final static lp a(int param0, byte param1, int param2, rh param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param1 <= -22) {
                ...
                var10 = (kk) null;
                discarded$2 = e.a(-126, -120, (kk) null);
                break L1;
              }
            }
            L2: {
              ...
              var12.a(var8, 8);
              if ((param0 ^ -1) != -6) {
                dupTemp$3 = re.a(ur.field_yb, 4371, new String[]{Integer.toString(param0)});
                var8.field_o = dupTemp$3;
                var7.field_o = dupTemp$3;
                var6.field_o = dupTemp$3;
                var5.field_o = dupTemp$3;
                var12.field_o = dupTemp$3;
                break L2;
              } else {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("e.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static gm a(int param0, int param1, kk param2) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = da.a(-128, al.a(param2, 100, param0));
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("e.E(").append(param0).append(',').append(param1).append(',');
    ...
    e(String param0, boolean param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("e.<init>(");
