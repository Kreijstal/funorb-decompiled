              ...
              if (po.field_b == 2) {
                if (!jp.a(param0, (byte) -105)) {
                  if (da.a(-30106, param0)) {
                    stackOut_11_0 = re.a(tr.field_pb, 4371, new String[]{param0});
                    ...
                    L2: {
                      if (param2 <= -57) {
                        ...
                        var5 = (String) null;
                        discarded$1 = nj.a((String) null, -114, (byte) -20);
                        break L2;
                      }
                    }
                    if (-201 < (r.field_c ^ -1)) {
                      if (ti.a(param0, true)) {
                        stackOut_25_0 = re.a(go.field_G, 4371, new String[]{param0});
    ...
    final static void a(float param0, int param1, String param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("nj.B(").append(param0).append(',').append(param1).append(',');
