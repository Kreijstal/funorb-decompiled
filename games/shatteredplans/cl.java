...
final class cl extends oh {
    ...
    final void a(int param0, int param1, int[] param2, int param3, int param4, int param5, int param6, int param7) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_5_1 = new StringBuilder().append("cl.A(").append(param0).append(',').append(param1).append(',');
          ...
          throw r.a((Throwable) ((Object) stackIn_6_0), stackIn_6_2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        try {
                ...
                L3: while (true) {
                  if (var9_int >= -1 + param4) {
                    ...
                    L4: {
                      ...
                      if (var9_int >= 2) {
                        stackIn_18_0 = ui.a(param6, param1, param2 + 22363, var11);
                        break L4;
                      } else {
                        stackIn_18_0 = param5;
                        break L4;
          ...
          throw r.a((Throwable) ((Object) var9), "cl.C(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ')');
        }
    }
