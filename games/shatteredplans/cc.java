...
final class cc extends ml {
              ...
              L0: {
                ...
                L2: {
                  ...
                  if (null == dh.field_a.field_k) {
                    ...
                    var6 = (Object) (Object) new ua(255, oq.field_g, new ej(dh.field_a.field_n, 12000, 0), 2097152);
                    break L2;
                  }
                }
                L3: {
                  if (oq.field_g != null) {
                    ...
                    var7 = (Object) (Object) new ua(param2, oq.field_g, tr.field_Eb[param2], 2097152);
                    break L3;
                  } else {
                    break L3;
                  }
    ...
    final u b(int param0, String param1) {
        ...
        try {
          L0: {
            if (param0 == -11196) {
              var3 = ((cc) this).field_q.field_s.toLowerCase();
              var4 = param1.toLowerCase();
              if (var4.length() == 0) {
