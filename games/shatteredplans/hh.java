...
final class hh extends nq {
    ...
    final void b(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * gf.field_b;
          var9 = gf.field_b - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= gf.field_a) {
            break L0;
          } else {
            var12 = gf.field_a - param2;
            param4 = param4 - var12;
            param2 = gf.field_a;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * gf.field_b;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= gf.field_f) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - gf.field_f);
            break L1;
          }
        }
        L2: {
        ...
        L3: {
          if (param1 + param3 <= gf.field_l) {
            break L3;
          } else {
            var12 = param1 + param3 - gf.field_l;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (gf.field_c == null) {
                  hh.a(gf.field_h, ((hh) this).field_H[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  hh.a(gf.field_h, ((hh) this).field_H[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, gf.field_c, gf.field_d);
                  break L5;
                }
              }
              return;
    ...
    final void b(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * gf.field_b;
          var10 = gf.field_b - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= gf.field_a) {
            break L0;
          } else {
            var13 = gf.field_a - param2;
            param4 = param4 - var13;
            param2 = gf.field_a;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * gf.field_b;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= gf.field_l) {
            ...
            var13 = param1 + param3 - gf.field_l;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              hh.b(gf.field_h, ((hh) this).field_H[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    hh(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        super(param0, param1, param2, param3, param4);
        ((hh) this).field_H = new byte[256][];
        ((hh) this).field_H = param5;
    }
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19 = 0;
        int var20 = 0;
        var13 = param2 - gf.field_i;
        var14 = param3 - gf.field_a;
        var15 = var14;
        L0: while (true) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              ...
              hh.a(gf.field_h, ((hh) this).field_H[param0], param5, var12, var8, var10, param3, param4, var9, var11);
              return;
            } else {
              break L4;
            }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L0: {
          ...
          if (param2 >= gf.field_a) {
            ...
            var14 = gf.field_a - param2;
            param4 = param4 - var14;
            param2 = gf.field_a;
            var13 = var13 - var14;
            var9 = var9 + var14 * gf.field_b;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= gf.field_l) {
            ...
            var14 = param1 + param3 - gf.field_l;
            param3 = param3 - var14;
            var10 = var10 + var14;
            break L3;
          }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              ...
              hh.a(gf.field_h, ((hh) this).field_H[param0], param5, var13, var9, var11, param3, param4, var10, var12, param6);
              return;
            } else {
              break L4;
            }
