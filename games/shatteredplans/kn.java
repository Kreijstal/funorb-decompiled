...
final class kn {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_f, 0, field_d, 0, var2);
        int var3 = field_a[this.field_b - 1];
        ...
        for (var6 = 0; var6 < this.field_l.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = fd.field_L[this.field_h[var7]].a();
            }
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_d[var16];
                  var10 = field_i[var16] * this.field_b;
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_e[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_f[incrementValue$0] = fd.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
