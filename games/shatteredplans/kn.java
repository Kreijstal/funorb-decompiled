...
final class kn {
    ...
    final boolean b() {
        ...
        int var2 = ((kn) this).field_f.length;
        System.arraycopy((Object) (Object) ((kn) this).field_f, 0, (Object) (Object) field_d, 0, var2);
        int var3 = field_a[((kn) this).field_b - 1];
        int var4 = rj.c(60, var3 - 1);
        field_i[0] = fd.a(var4);
        field_i[1] = fd.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((kn) this).field_l.length; var6++) {
            var7 = ((kn) this).field_l[var6];
            var8 = ((kn) this).field_e[var7];
            var9 = ((kn) this).field_c[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = fd.field_L[((kn) this).field_h[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((kn) this).field_k[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_i[incrementValue$0] = var13 >= 0 ? fd.field_L[var13].a() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((kn) this).field_f.length;
        var4 = field_a[((kn) this).field_b - 1];
        var5 = field_g;
        field_g[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_i[0] * ((kn) this).field_b;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_d[var16];
                  var10 = field_i[var16] * ((kn) this).field_b;
            ...
            L3: {
              var7 = kn.a(field_d, var6);
              var8_int = kn.b(field_d, var6);
              var9 = this.a(field_d[var7], field_i[var7], field_d[var8_int], field_i[var8_int], field_d[var6]);
              var10 = field_i[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    kn() {
        ...
        if (var1 == 1) {
          var2 = fd.a(5);
          var3 = 0;
          ((kn) this).field_l = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((kn) this).field_e = new int[var3];
              ((kn) this).field_c = new int[var3];
              ((kn) this).field_h = new int[var3];
              ((kn) this).field_k = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((kn) this).field_b = fd.a(2) + 1;
                  var4 = fd.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((kn) this).field_f = new int[var5];
                      ((kn) this).field_f[0] = 0;
                      ((kn) this).field_f[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((kn) this).field_e[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((kn) this).field_f[incrementValue$2] = fd.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((kn) this).field_e[((kn) this).field_l[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((kn) this).field_e[var4] = fd.a(3) + 1;
                    int dupTemp$3 = fd.a(2);
                    ((kn) this).field_c[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((kn) this).field_h[var4] = fd.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
