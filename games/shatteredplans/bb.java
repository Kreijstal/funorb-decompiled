...
final class bb {
    ...
    final static as a(int param0, mg param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("bb.E(").append(param0).append(44);
    ...
    final static void a(int param0, long param1, int param2, boolean param3, String param4, int param5) {
        ...
        try {
            ...
            throw r.a((Throwable) (Object) runtimeException, "bb.A(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + param5 + 41);
        }
    }
    ...
    final static void a(boolean param0, boolean param1, byte param2, int param3) {
        ...
        try {
            ...
            L2: {
              if (he.field_p != null) {
                ...
                if (k.field_i) {
                  ...
                  L16: {
                    stackIn_29_0.field_z = re.a(stackIn_29_1, 4371, new String[1]);
          ...
          throw r.a((Throwable) (Object) var4, "bb.C(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
    }
