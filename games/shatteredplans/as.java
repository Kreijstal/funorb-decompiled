...
final class as extends oh {
    ...
    final static void a(int param0, int param1, int param2, v param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("as.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    as(mg param0) {
        try {
            ...
            throw r.a((Throwable) (Object) runtimeException, "as.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
