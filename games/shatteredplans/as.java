    ...
    final static vd a(pf param0, int param1, byte param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_15_1 = new StringBuilder().append("as.C(");
    ...
    final static void a(int param0, int param1, int param2, v param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_5_1 = new StringBuilder().append("as.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
