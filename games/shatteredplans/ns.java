...
class ns extends il implements bp {
    ...
    ns(tc param0, nq param1, String param2, boolean param3, boolean param4) {
        ...
        try {
            ...
            throw r.a((Throwable) (Object) runtimeException, "ns.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 44 + param4 + 41);
        }
    }
        ...
        try {
          L0: {
            if (param0 == param2) {
              ...
              stackOut_4_0 = super.a(param0, param1, param2, param3);
          ...
          L1: {
            ...
            stackOut_6_1 = new StringBuilder().append("ns.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
        ...
        try {
          L0: {
            if (!((ns) this).field_wb) {
              ...
              L2: {
                ((ns) this).field_sb = stackIn_6_1 != 0;
                ...
                if (5 == param1) {
                  ...
                  if (param1 == 256) {
                    kg discarded$2 = var6.a((ko) this, 121, ts.field_E);
                    break L2;
                  } else {
                    L3: {
                    ...
                    ((cf) (Object) stackIn_11_0).a(stackIn_11_1, (byte) 119, -1);
                    break L2;
                  }
                }
              }
                  ...
                  if (3 == param1) {
                    ...
                    if (param1 != 4) {
                      if (param1 == 6) {
                        ...
                        if (param1 == 9) {
                          kg discarded$3 = var6.a((ko) this, 126, ib.field_d);
                          break L4;
                        } else {
