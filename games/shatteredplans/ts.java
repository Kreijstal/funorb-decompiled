...
class ts extends kg {
    ...
    final void a(int param0, boolean param1, String param2) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_13_1 = new StringBuilder().append("ts.L(").append(param0).append(44).append(param1).append(44);
    ...
    ts(String param0, iq param1) {
        ...
        try {
            ...
            throw r.a((Throwable) (Object) runtimeException, "ts.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    boolean a(byte param0, vg param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ts.CA(").append(param0).append(44);
    ...
    final static boolean a(boolean param0, int param1) {
        try {
            ...
            if (-1 == da.field_e.field_d) {
              return false;
            } else {
              long dupTemp$2 = pr.a(14274);
              mj.field_Pb = dupTemp$2;
              pf.field_e = dupTemp$2;
              if (-2 != da.field_e.field_d) {
    ...
    final static void a(java.applet.Applet param0) {
        try {
            ...
            try {
              ...
              throw r.a((Throwable) (Object) stackIn_7_0, stackIn_7_2 + 44 + 51 + 41);
            }
        } catch (RuntimeException | Error decompiledUncheckedException) {
            throw decompiledUncheckedException;
        } catch (Throwable decompiledCheckedException) {
    ...
    final static void a(int param0, int param1, int param2) {
        ...
        if (param1 != -1) {
          ...
          param2 += 30;
          ga.a(param2, -param2 + 480 >> 1, -param0 + 640 >> 1, (byte) -70, param0);
          return;
        }
    }
    ...
    void a(int param0, int param1, vg param2, byte param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (!((ts) this).field_k) {
                ...
                var5_int = -((ts) this).field_m + (-param0 + pd.field_k);
                var6 = bb.field_b - param1 + -((ts) this).field_q;
                ((ts) this).field_I = this.b(var5_int, var6, (byte) -66);
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("ts.PA(").append(param0).append(44).append(param1).append(44);
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
    ...
    final void a(int param0, int param1, int param2, byte param3) {
        ...
        ql var7 = null;
        super.a(param0, param1, param2, param3);
        var5 = -((ts) this).field_m + param1;
        var6 = -((ts) this).field_q + param2;
