...
abstract class ia {
    ...
    final void b(boolean param0) {
        ...
        L0: {
          ...
          var2 = this.field_O.field_e.length;
          if (!param0) {
            break L0;
          } else {
            this.field_X = false;
        ...
        L1: {
          L2: {
            if (this.field_Q == null) {
              ...
              if (this.field_Q.length >= this.field_O.field_e.length) {
                break L1;
              } else {
                break L2;
              }
    ...
    private final bh a(int param0, sd param1) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_19_1 = new StringBuilder().append("ia.S(").append(param0).append(',');
            stackIn_21_0 = stackOut_19_0;
            stackIn_21_1 = stackOut_19_1;
    ...
    final void e(int param0) {
        ...
        if (param0 != -18641) {
            discarded$0 = this.a(17, false, -42);
        }
    }
        ...
        L0: {
          L1: {
            ...
            if (null == this.field_R) {
              ...
              if (this.field_R.length >= this.field_O.field_e.length) {
                break L0;
              } else {
                break L1;
              }
                ...
                if (0 == param0) {
                  ...
                  if ((param0 ^ -1) != -2) {
                    if (param0 != 2) {
                      ...
                      L8: {
                        if (this.field_C) {
                          var4_ref2 = (vn) ((Object) this.field_m.d(0));
                          L9: while (true) {
                            if (var4_ref2 == null) {
                              var5 = param1.d(0);
                              L10: while (true) {
                              ...
                              this.field_Z[var5_int] = var4_ref2.field_k;
                              this.field_eb[var5_int] = var4_ref2.field_n;
                              this.field_r[var5_int] = var4_ref2.field_h;
                              var4_ref2 = (vn) ((Object) this.field_m.a((byte) -71));
                              continue L9;
                            }
                          }
                        } else {
        ...
        L0: {
          ...
          L2: while (true) {
            if (var4_int <= var5) {
              ...
              array$1 = new int[2 * this.field_O.field_e[var5].field_r.length];
