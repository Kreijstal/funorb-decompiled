...
abstract class ia {
    ...
    final void a(ln param0, int param1, int param2, fs param3) {
        ...
        var5 = 0;
        L1: while (true) {
          if (!this.a(var5, 0, param0)) {
            var5++;
            continue L1;
          } else {
            L2: {
              ((ia) this).field_ab.a((byte) -113, (oh) (Object) new es(param0, param3, param2, var5));
              if (((ia) this).field_W <= var5) {
                ((ia) this).field_W = 1 + var5;
                break L2;
              } else {
                break L2;
              }
    ...
    final void b(boolean param0) {
        ...
        int var2 = ((ia) this).field_O.field_e.length;
        if (param0) {
    ...
    final void a(l param0, int param1) {
        ...
        int[] var7 = new int[((ia) this).field_O.field_e.length];
        int[] var3 = var7;
        boolean[] var4 = new boolean[((ia) this).field_O.field_e.length];
        ...
        if (param0.e(param1 + 27649)) {
          ...
          L0: {
            if (((ia) this).field_fb == param0) {
              ...
              var3 = ((ia) this).field_o.d((byte) 14);
              var4_int = 320;
              var5 = var3 / 2;
              var6_ref = param0.j(18229);
              L1: while (true) {
                L2: {
                  if (var6_ref == null) {
                    break L2;
                    ...
                    L3: {
                      var7_int = (int)((-((ia) this).field_k + (float)var6_ref.field_A) * (300.0f / (((ia) this).field_I + (float)var6_ref.field_z))) + var4_int;
                      var8_int = var5 + (int)((-((ia) this).field_E + (float)var6_ref.field_S) * (300.0f / ((float)var6_ref.field_z + ((ia) this).field_I)));
                      if ((var7_int ^ -1) > -1) {
                        break L3;
                      } else {
                        if (var8_int > -1) {
          ...
          var8 = var8 * var7;
          ((ia) this).field_f = -var8 + (float)(var10.field_o + var10.field_l >> 1881719393);
          var8 = (float)(var4.field_q + var4.field_i + -((ia) this).field_o.d((byte) 14) >> 771986881);
          var8 = var8 * var7;
          ((ia) this).field_x = true;
          ((ia) this).field_fb = param0;
          ((ia) this).field_lb = (float)(var10.field_i + var10.field_q >> -1485041759) - var8;
    ...
    final void a(fs param0, ln param1, boolean param2, int param3) {
        ...
        if (!param2) {
          var5 = 0;
          L0: while (true) {
            if (this.a(var5, 0, param1)) {
              ((ia) this).field_ab.a((byte) -113, (oh) (Object) new es(param1, param0, -1, param3, var5));
              if (var5 < ((ia) this).field_W) {
                return;
              } else {
                ((ia) this).field_W = var5 - -1;
                return;
              }
            } else {
              var5++;
    ...
    final void a(fs param0, ln param1, byte param2, ln param3) {
        ...
        L1: while (true) {
          if (this.a(-4, var5)) {
            if (this.a(var5, 0, param3)) {
              if (this.a(var5, 0, param1)) {
                ((ia) this).field_ab.a((byte) -113, (oh) (Object) new es(param3, param0, 3, var5));
                ((ia) this).field_ab.a((byte) -113, (oh) (Object) new es(param1, param0, 3, var5));
                if (var5 < ((ia) this).field_W) {
                  return;
                } else {
                  ((ia) this).field_W = 1 + var5;
    ...
    final void a(ln param0, int param1) {
        bh var3 = ((ia) this).field_o.b((byte) 51);
        float var4 = 24000.0f / (float)(var3.field_o - var3.field_l) - 3.0f * (float)param0.field_z;
    ...
    private final boolean a(int param0, int param1, ln param2) {
        int var5 = ShatteredPlansClient.field_F ? 1 : 0;
        es var4 = (es) (Object) ((ia) this).field_ab.d(param1 + param1);
        while (var4 != null) {
    ...
    final void a(int param0, ln param1, float param2) {
        bh var6 = ((ia) this).field_o.b((byte) 52);
        float var5 = (float)(-640 + var6.field_o + var6.field_l >> 877524417);
        ...
        var5 = (float)(var6.field_i + (var6.field_q - ((ia) this).field_o.d((byte) 14)) >> -2111832383);
    ...
    final void d(int param0) {
        ...
        ln[] var7 = ((ia) this).field_O.field_e;
        ln[] var2 = var7;
    ...
    final void b(int param0) {
        ...
        int var4 = -(((int)((ia) this).field_k - 0) * (var2 << 1744658852)) / (0 + ((ia) this).field_O.field_k);
        int var6 = -(((int)((ia) this).field_E + 0) * (var3 << -1383320668)) / (0 + ((ia) this).field_O.field_b);
            ...
            if (0 == param0) {
              ...
              if ((param0 ^ -1) != -2) {
                if (param0 != 2) {
                  ...
                  L7: {
                    if (((ia) this).field_C) {
                      var4_ref_vn = (vn) (Object) ((ia) this).field_m.d(0);
                      L8: while (true) {
                        if (var4_ref_vn == null) {
                          var5 = param1.d(0);
                          L9: while (true) {
                          ...
                          var5_int = var4_ref_vn.field_o.field_p;
                          ((ia) this).field_Z[var5_int] = var4_ref_vn.field_k;
                          ((ia) this).field_eb[var5_int] = var4_ref_vn.field_n;
                          ((ia) this).field_r[var5_int] = var4_ref_vn.field_h;
                          var4_ref_vn = (vn) (Object) ((ia) this).field_m.a((byte) -71);
                          continue L8;
                        }
                      }
                    } else {
