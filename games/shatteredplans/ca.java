    ...
    final static void a(int param0, int param1, int param2, String param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("ca.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw r.a((Throwable) ((Object) stackIn_8_0), stackIn_8_2 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ')');
        }
    }
    ...
    final static void a(java.applet.Applet param0, bc param1, bc param2, bc param3, boolean param4, bc param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("ca.C(");
