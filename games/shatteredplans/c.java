...
final class c {
            ...
            if (var6 >= var7) {
              L4: {
                if (var7 >= var6) {
                  ...
                  fieldTemp$0 = field_g;
                  field_g = field_g + 1;
                  field_f[fieldTemp$0] = param0[var8];
                  fieldTemp$1 = field_g;
                  field_g = field_g + 1;
                  field_f[fieldTemp$1] = var7;
                  fieldTemp$2 = field_g;
                  field_g = field_g + 1;
                  field_f[fieldTemp$2] = param0[var4];
                  fieldTemp$3 = field_g;
                  field_g = field_g + 1;
                  field_f[fieldTemp$3] = var6;
                  break L4;
                }
              }
              var4 = var8;
              ...
              fieldTemp$4 = field_g;
              field_g = field_g + 1;
              field_f[fieldTemp$4] = param0[var4];
              fieldTemp$5 = field_g;
              field_g = field_g + 1;
              field_f[fieldTemp$5] = var6;
              fieldTemp$6 = field_g;
              field_g = field_g + 1;
              field_f[fieldTemp$6] = param0[var8];
              fieldTemp$7 = field_g;
              field_g = field_g + 1;
              field_f[fieldTemp$7] = var7;
              var4 = var8;
              var8 += 2;
              continue L3;
            }
    ...
    final static void d() {
        ...
        int var1 = 0;
        for (var2 = 0; var2 < field_g; var2 += 4) {
            var3 = field_f[var2 + 1];
            if (var0 < var3) {
                break;
            }
    ...
    final static boolean a() {
        ...
        L0: while (true) {
          if (var1 < var0) {
            field_e = field_f[var1] >> 16;
            field_a = field_f[var1 + 4] >> 16;
