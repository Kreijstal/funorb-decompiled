...
final class lj {
    ...
    public final void movemouse(int param0, int param1) {
        ((lj) this).field_a.mouseMove(param0, param1);
    }
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            if (!param1) {
              if (param0 != null) {
                if (((lj) this).field_b == param0) {
                  return;
                } else {
                  if (null != ((lj) this).field_b) {
                    L0: {
                      ((lj) this).field_b.setCursor((java.awt.Cursor) null);
                      ((lj) this).field_b = null;
                      if (param0 != null) {
