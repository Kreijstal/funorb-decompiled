...
abstract class ob extends m {
    ...
    final int c(byte param0) {
        ...
        L8: {
          if (param0 <= -103) {
            ...
            var3 = null;
            int discarded$14 = ob.a((byte) -21, (pf) null, (pf) null);
            break L8;
          }
        }
        return var2;
        ...
        if (param1 == 18808) {
          ...
          L17: {
            if (af.field_u == 1) {
              ...
              int discarded$31 = 1;
              int discarded$32 = 0;
              hj.field_i = eb.a(true, fn.field_p);
              int discarded$33 = 1;
              int discarded$34 = 1;
              int discarded$35 = 0;
              pb.field_r = eb.a(true, se.field_N);
              int discarded$36 = 1;
              int discarded$37 = 1;
              int discarded$38 = 0;
              oh.field_C = eb.a(true, da.field_c);
          ...
          L21: {
            if (3 != af.field_u) {
              ...
              if (!eg.a(pb.field_r, 4, hj.field_i, oh.field_C)) {
                ...
                int discarded$39 = 124;
                if (eb.a(oh.field_C)) {
                  L22: {
                    L23: {
                      int discarded$40 = 123;
                      bh.h();
                      int discarded$41 = -1719110238;
                      em.g();
    ...
    private final int d(byte param0) {
        ...
        if (((ob) this).field_i) {
          ...
          if (ci.a(101)) {
            if (!nd.field_e) {
              var2 = re.a(((ob) this).field_A, false, ((ob) this).field_p, fc.b((byte) 119), true, ii.b((byte) -42));
              if (var2 != -1) {
                L0: {
                  if (var2 == 0) {
                    break L0;
    ...
    final void a(String param0, int param1, int param2) {
        ...
        try {
          ...
          throw lj.a((Throwable) (Object) stackIn_6_0, stackIn_6_2 + 44 + param1 + 44 + param2 + 41);
        }
    }
    ...
    private final void a(String param0, int param1, int param2, int param3, int param4) {
        ...
        try {
            ...
            try {
              L1: {
                if (!((ob) this).a((byte) -50)) {
                  ...
                  ((ob) this).a(640, param1, ((ob) this).field_B, 3, param0, 480, 32);
                  break L1;
                }
              }
          ...
          throw lj.a((Throwable) (Object) stackIn_26_0, stackIn_26_2 + 44 + param1 + 44 + 640 + 44 + 480 + 44 + param4 + 41);
        }
    }
    ...
    final void k(int param0) {
        ...
        int discarded$5 = -11;
        if (bi.a()) {
            int discarded$7 = this.a(true, false, kf.field_d != null ? true : false);
        } else {
            if (10 <= af.field_u) {
                if (!fe.j(param0 ^ -94)) {
                    int discarded$9 = 127;
                    ...
                    if (fh.field_b != 0) {
                        ...
                        int discarded$10 = this.a(true, false, false);
                    }
                }
            }
        }
    ...
    private final void g(int param0) {
        ...
        if (param0 != -18) {
            int discarded$0 = ((ob) this).c((byte) 99);
        }
    }
    ...
    private final int a(boolean param0, boolean param1, boolean param2) {
        try {
            ...
            int discarded$7 = 65;
            var4 = bj.a(ki.field_n, kb.field_c, param2);
            if (var4 != 0) {
              L0: {
                if (var4 != 1) {
                  break L0;
                  ...
                  var9 = aj.a();
                  if (var9 != null) {
                    jc.a((byte) 17, var9.booleanValue());
                    break L0;
                  } else {
                    break L0;
                  }
              ...
              L2: {
                if (var4 != 2) {
                  ...
                  int discarded$9 = -95;
                  var5_int = dn.a(lm.n(-124), fa.a(true), mb.b(), fc.b((byte) 123), ii.b((byte) 63), ((ob) this).field_A, -14543);
                  if (-1 != var5_int) {
                    ...
                    L15: {
                      ...
                      L17: {
                        if (hf.field_u.a((byte) 105)) {
                          L18: {
                            var10 = hf.field_u.a(0);
                            if (var10 != null) {
                              var7 = ph.a((byte) 31, var10.field_o, var10.field_u, 0);
                              int discarded$11 = 0;
                              fm.a(var7);
                              break L18;
                            } else {
                            ...
                            if (var2 == 6) {
                              ...
                              if (var2 != 7) {
                                if (var2 != 8) {
                                  ...
                                  int discarded$17 = 1;
                                  ff.a(qa.field_a, (sb) (Object) kj.field_a, rj.field_d);
                                  break L2;
                                }
                              } else {
                                this.g(-18);
    ...
    private final static int a(byte param0, pf param1, pf param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ob.G(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
