...
final class vc extends pi {
    ...
    final void a(int param0) {
        ...
        if (param0 != 12361) {
            int[] var3 = (int[]) null;
            this.a((ri) null, (byte) -77, (byte[]) null, (int[]) null);
        }
    }
    ...
    final boolean a(ri param0, byte param1, byte[] param2, int[] param3) {
        ...
        try {
          ...
          L7: {
            ...
            stackIn_27_1 = new StringBuilder().append("vc.E(");
    ...
    vc(byte[] param0) {
        ...
        try {
                                                                      ...
                                                                      if (this.field_n[var25_int] == 0) {
                                                                        ...
                                                                        L71: {
                                                                          if (var20 != 0) {
                                                                            ...
                                                                            var8++;
                                                                            var24 = 16 + var38.field_u[incrementValue$4] << 1270177378;
                                                                            break L71;
                                                                          }
                                                                        }
                                                                  ...
                                                                  if (0 == this.field_n[var24]) {
                                                                    ...
                                                                    L74: {
                                                                      if (0 != var20) {
                                                                        ...
                                                                        var5++;
                                                                        var23 = var38.field_u[incrementValue$6] + -1;
                                                                        break L74;
                                                                      }
                                                                    }
          ...
          L80: {
            ...
            stackIn_207_1 = new StringBuilder().append("vc.<init>(");
