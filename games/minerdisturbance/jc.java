...
abstract class jc extends fe implements rk {
    ...
    void a(int param0, int param1, byte param2, fe param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("jc.V(").append(param0).append(',').append(param1).append(',').append(61).append(',');
    ...
    final static int a(byte param0, we param1, String[] param2, int param3, String param4) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_22_1 = new StringBuilder().append("jc.W(").append(106).append(',');
          ...
          throw lj.a((Throwable) (Object) stackIn_31_0, stackIn_31_2 + ')');
        }
        return stackIn_21_0;
    }
    ...
    final void a(Hashtable param0, int param1, StringBuilder param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              StringBuilder discarded$24 = param2.append('\n');
              if (param3 <= -24) {
                break L1;
              } else {
                field_D = null;
            ...
            L2: while (true) {
              if (var5_int > param1) {
                ...
                StringBuilder discarded$27 = param2.append(' ');
                var5_int++;
                continue L2;
              }
            }
    ...
    private final boolean a(int param0, fe param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("jc.GB(").append(-13).append(',');
