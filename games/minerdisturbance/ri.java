...
final class ri {
            ...
            switch (statePc) {
                ...
                case 5: {
                    try {
                        ...
                        stackOut_5_1 = new StringBuilder().append("ri.C(").append(param0).append(44);
    ...
    final ji a(int param0, int[] param1, int param2) {
        ...
        ji stackOut_7_0 = null;
        ji stackOut_12_0 = null;
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 7: {
                    try {
                        stackOut_7_0 = this.a(-31093, 0, param2, param1);
                ...
                case 12: {
                    try {
                        stackOut_12_0 = this.a(param0 ^ 7866, param2, 0, param1);
                ...
                case 16: {
                    try {
                        ...
                        stackOut_16_1 = new StringBuilder().append("ri.A(").append(param0).append(44);
                ...
                case 20: {
                    throw lj.a((Throwable) (Object) stackIn_20_0, stackIn_20_2 + 44 + param2 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
    ...
    final static void a(boolean param0, int param1, int param2, pb param3, int param4) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 35: {
                    try {
                        var16 = -stackIn_35_0 + (mg.field_e.length - 1);
                ...
                case 37: {
                    try {
                        ...
                        stackOut_37_1 = -1;
                        stackIn_45_0 = stackOut_37_0;
                        stackIn_45_1 = stackOut_37_1;
                ...
                case 44: {
                    try {
                        stackOut_44_0 = var17;
                        stackOut_44_1 = var16 << 1611167972;
                ...
                case 57: {
                    try {
                        if (stackIn_57_0 >= param3.field_E) {
                            statePc = 78;
                        } else {
                            statePc = 58;
                        }
                ...
                case 59: {
                    try {
                        if (stackIn_59_0 != (Object) (Object) param3.field_x) {
                            statePc = 64;
                        } else {
                            statePc = 60;
                        }
                ...
                case 73: {
                    try {
                        ...
                        stackOut_73_1 = new StringBuilder().append("ri.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
                ...
                case 77: {
                    throw lj.a((Throwable) (Object) stackIn_77_0, stackIn_77_2 + 44 + param4 + 41);
                }
                case 78: {
                    return;
                }
    ...
    private final ji a(int[] param0, byte param1, int param2, int param3) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 17: {
                    return (ji) (Object) stackIn_17_0;
                }
                case 18: {
                    try {
                        var8_ref = var9.a();
                        ((ri) this).field_g.a(param1 ^ -72, var6, (pi) (Object) var8_ref);
                        if (param1 == -72) {
                            statePc = 21;
                        } else {
                            statePc = 19;
                ...
                case 22: {
                    try {
                        param0[0] = param0[0] - var8_ref.field_r.length;
                        statePc = 23;
                        continue stateLoop;
                    } catch (Throwable stateCaught_22) {
                        caughtException = stateCaught_22;
                ...
                case 28: {
                    try {
                        ...
                        stackOut_28_1 = new StringBuilder().append("ri.I(");
                ...
                case 32: {
                    throw lj.a((Throwable) (Object) stackIn_32_0, stackIn_32_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
            ...
            switch (statePc) {
                ...
                case 12: {
                    try {
                        ...
                        stackOut_12_1 = new StringBuilder().append("ri.E(").append(param0).append(44);
    ...
    private final ji a(int param0, int param1, int param2, int[] param3) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 16: {
                    try {
                        var9_ref = b.a(((ri) this).field_a, param1, param2);
                        statePc = 17;
                        continue stateLoop;
                    } catch (Throwable stateCaught_16) {
                        caughtException = stateCaught_16;
                ...
                case 21: {
                    return (ji) (Object) stackIn_21_0;
                }
                case 22: {
                    try {
                        ((ri) this).field_e.a(0, var6, (pi) (Object) var9_ref);
                        statePc = 23;
                        continue stateLoop;
                    } catch (Throwable stateCaught_22) {
                        caughtException = stateCaught_22;
                ...
                case 25: {
                    return (ji) (Object) stackIn_25_0;
                }
                case 26: {
                    try {
                        var9_ref.b(34);
                        ((ri) this).field_g.a(0, var6, (pi) (Object) var8_ref);
                        stackOut_26_0 = (ji) var8_ref;
                ...
                case 29: {
                    try {
                        ...
                        stackOut_29_1 = new StringBuilder().append("ri.H(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
                        stackIn_32_0 = stackOut_29_0;
                        stackIn_32_1 = stackOut_29_1;
            ...
            switch (statePc) {
                ...
                case 4: {
                    try {
                        ...
                        stackOut_4_1 = new StringBuilder().append("ri.<init>(");
