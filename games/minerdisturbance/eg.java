...
class eg implements ad, cf {
    ...
    public final int a(int param0, fe param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("eg.R(").append(param0).append(',');
    ...
    public final int a(int param0, fe param1) {
        ...
        try {
          L0: {
            if (param0 == 14463) {
              discarded$2 = this.c(0, param1);
              stackOut_3_0 = param1.field_B.a(-1) + this.field_n - -this.field_i;
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("eg.M(").append(param0).append(',');
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
        ...
        try {
            ...
            try {
              L0: {
                ...
                stackOut_11_0 = new bj(var9, param4, param5);
    ...
    public final nf c(int param0, fe param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("eg.P(").append(param0).append(',');
    ...
    public final int b(int param0, fe param1, int param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("eg.Q(").append(param0).append(',');
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
            stackIn_6_0 = stackOut_5_0;
            stackIn_6_1 = stackOut_5_1;
    ...
    public final void a(int param0, int param1, int param2, int param3, fe param4) {
        ...
        try {
            ...
            L1: {
              if (param4.k(42)) {
                L2: {
                  ...
                  stackOut_2_0 = this.b(100, param4, param3);
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("eg.O(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
            stackIn_10_0 = stackOut_9_0;
            stackIn_10_1 = stackOut_9_1;
    ...
    private final void a(int param0, boolean param1, int param2, int param3, int param4, int param5, int param6, fe param7) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (!this.field_f) {
                ...
                discarded$1 = this.field_k.a(this.a(param7, (byte) 67), this.a(param7, param6, -4, param5), this.a(param7, param0, (byte) 26, param4), var9_int, var10, param3, param2, this.field_j, this.field_d, this.field_e);
                break L1;
              }
            }
            tk.b(param1);
          ...
          L5: {
            ...
            stackOut_23_1 = new StringBuilder().append("eg.HA(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',');
    ...
    private final int a(fe param0, int param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = param0.field_q - (this.field_c - -this.field_l);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("eg.DA(");
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
          ...
          L0: {
            L1: {
              if (param2 == 26) {
                ...
                var6 = (fe) null;
                discarded$2 = this.a((fe) null, (byte) 74);
                break L1;
              }
            }
            stackOut_2_0 = param1 + (param0.field_o + param3 + param0.field_t + this.field_c);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    final static boolean a(bj param0, int param1, bj param2, bj param3) {
        ...
        try {
          ...
          throw lj.a((Throwable) ((Object) stackIn_27_0), stackIn_27_2 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          ...
          L0: {
            L1: {
              if (!param2) {
                ...
                var8 = (fe) null;
                discarded$4 = this.b(77, (fe) null);
                break L1;
              }
            }
            discarded$5 = this.c(0, param0);
            stackOut_2_0 = param0.field_B.a(true, -this.a(28793, param0, param1) + param4, -this.b(100, param0, param5) + param3);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    public final void a(int param0, fe param1, int param2, int param3, int param4, boolean param5) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_23_1 = new StringBuilder().append("eg.S(").append(param0).append(',');
            stackIn_25_0 = stackOut_23_0;
            stackIn_25_1 = stackOut_23_1;
            stackIn_24_0 = stackOut_23_0;
            stackIn_24_1 = stackOut_23_1;
    ...
    private final void d(int param0, fe param1) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_27_1 = new StringBuilder().append("eg.IA(").append(param0).append(',');
          ...
          L0: {
            L1: {
              if (!param1) {
                ...
                var4 = (fe) null;
                discarded$2 = this.b(10, (fe) null);
                break L1;
              }
            }
            stackOut_2_0 = -this.field_i + (-this.field_n + param0.field_v);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    private final int a(fe param0, int param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = param0.field_p + param0.field_u + (param1 + this.field_n + param3);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    public final int b(int param0, fe param1) {
        ...
        try {
          L0: {
            if (param0 >= 13) {
              discarded$2 = this.c(0, param1);
              stackOut_3_0 = param1.field_B.b(102) - (-this.field_c - this.field_l);
              stackIn_4_0 = stackOut_3_0;
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
          ...
          L1: {
            var3 = decompiledCaughtException;
            stackOut_5_0 = (RuntimeException) (var3);
            stackOut_5_1 = new StringBuilder().append("eg.N(").append(param0).append(',');
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
            stackIn_6_0 = stackOut_5_0;
            stackIn_6_1 = stackOut_5_1;
    ...
    final static void a(int param0, byte param1, byte[] param2, int param3, java.math.BigInteger param4, sb param5, java.math.BigInteger param6) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_22_1 = new StringBuilder().append("eg.EA(").append(param0).append(',').append(param1).append(',');
            stackIn_24_0 = stackOut_22_0;
            stackIn_24_1 = stackOut_22_1;
