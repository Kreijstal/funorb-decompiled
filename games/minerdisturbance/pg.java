...
final class pg {
    ...
    final boolean b() {
        ...
        field_l[1] = b.f(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((pg) this).field_j.length; var6++) {
            var7 = ((pg) this).field_j[var6];
            var8 = ((pg) this).field_d[var7];
            var9 = ((pg) this).field_i[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = b.field_O[((pg) this).field_g[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((pg) this).field_a[var7][var11 & var10];
                var11 = var11 >>> var9;
                var5++;
                field_l[var5] = var13 >= 0 ? b.field_O[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((pg) this).field_e.length;
        var4 = field_b[((pg) this).field_c - 1];
        var5 = field_f;
        field_f[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_l[0] * ((pg) this).field_c;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_k[var16];
                  var10 = field_l[var16] * ((pg) this).field_c;
            ...
            L3: {
              var7 = pg.b(field_k, var6);
              var8_int = pg.a(field_k, var6);
              var9 = this.a(field_k[var7], field_l[var7], field_k[var8_int], field_l[var8_int], field_k[var6]);
              var10 = field_l[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    pg() {
        ...
        if (var1 == 1) {
          var2 = b.f(5);
          var3 = 0;
          ((pg) this).field_j = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((pg) this).field_d = new int[var3];
              ((pg) this).field_i = new int[var3];
              ((pg) this).field_g = new int[var3];
              ((pg) this).field_a = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((pg) this).field_c = b.f(2) + 1;
                  var4 = b.f(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((pg) this).field_e = new int[var5];
                      ((pg) this).field_e[0] = 0;
                      ((pg) this).field_e[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((pg) this).field_d[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              var5++;
                              ((pg) this).field_e[var5] = b.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((pg) this).field_d[((pg) this).field_j[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((pg) this).field_d[var4] = b.f(3) + 1;
                    ((pg) this).field_i[var4] = b.f(2);
                    var5 = b.f(2);
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((pg) this).field_g[var4] = b.f(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
