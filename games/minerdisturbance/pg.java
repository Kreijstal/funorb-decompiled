...
final class pg {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_e, 0, field_k, 0, var2);
        int var3 = field_b[this.field_c - 1];
        ...
        for (var6 = 0; var6 < this.field_j.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = b.field_O[this.field_g[var7]].b();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                      ...
                      var5 = var5 + this.field_d[this.field_j[var6]];
                      var6++;
                      continue L2;
                    }
                  }
