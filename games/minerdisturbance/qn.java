...
final class qn extends hc {
    ...
    final static int a(int param0, int param1, int param2, byte[] param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param0 == -1648911295) {
                ...
                var7 = null;
                int discarded$2 = qn.a(74, 37, -101, (byte[]) null);
                break L1;
              }
            }
            var5 = param1;
            L2: while (true) {
              if (param2 <= var5) {
                ...
                var4_int = ei.field_J[(var4_int ^ param3[var5]) & 255] ^ var4_int >>> 8;
                var5++;
                continue L2;
              }
            }
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("qn.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final void a(int param0, int param1, byte param2, fe param3) {
        try {
            ...
            throw lj.a((Throwable) (Object) runtimeException, "qn.V(" + param0 + 44 + param1 + 44 + param2 + 44 + (param3 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final void a(byte param0, int param1, int param2, int param3) {
        ...
        if (param3 != 0) {
          ...
          var5 = (((qn) this).field_v >> 1) + ((qn) this).field_u + param1;
          var6 = (((qn) this).field_q >> 1) + (((qn) this).field_t + param2);
          ...
          if (nn.field_f != var8) {
            if (bm.field_o != var8) {
              if (var8 != fg.field_d) {
                if (var8 == sc.field_a) {
                  var12 = ed.field_g[1];
                  var12.g(-(var12.field_y >> 1) + var5, var6 - (var12.field_C >> 1), 256);
                  return;
                } else {
                  return;
                }
                ...
                var13 = ed.field_g[2];
                var13.g(-(var13.field_y >> 1) + var5, -(var13.field_C >> 1) + var6, 256);
                return;
              }
            } else {
              var16 = ed.field_g[0];
              ...
              if (ha.field_d != null) {
                if (ha.field_d.field_y >= var9) {
                  if (ha.field_d.field_C < var10) {
                    ...
                    vb.a(ha.field_d, 127);
                    var16.b(112, 144, var16.field_x << 4, var16.field_A << 4, -((qn) this).field_L << 10, 4096);
                    tk.b(true);
            ...
            var10 = var15.field_A << 1;
            if (ha.field_d != null) {
              if (ha.field_d.field_y >= var9) {
                if (ha.field_d.field_C < var10) {
                  ha.field_d = new ea(var9, var10);
                  vb.a(ha.field_d, 127);
                  var15.b(112, 144, var15.field_x << 4, var15.field_A << 4, -((qn) this).field_L << 10, 4096);
                  tk.b(true);
    ...
    qn(jm param0) {
        try {
            ...
            throw lj.a((Throwable) (Object) runtimeException, "qn.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
        ...
        try {
          L0: {
            if (param1 > 119) {
              ...
              var4 = null;
              boolean discarded$2 = ((qn) this).a((fe) null, -111);
              return false;
            }
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
        ...
        try {
          L0: {
            if (param3.a((byte) 126)) {
              stackOut_3_0 = param1 + " - " + param3.c(-14858) + "%";
