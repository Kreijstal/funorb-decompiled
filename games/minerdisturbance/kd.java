...
final class kd {
    ...
    private final void a(boolean param0, String param1, java.applet.Applet param2, boolean param3, ln[] param4, String[] param5) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("kd.I(").append(param0).append(44);
    ...
    private final void a(int param0, String param1, we param2, byte param3, int[] param4, int param5, int param6, int param7) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (param6 <= var9_int) {
                ...
                int discarded$2 = param2.a(param1, 0, param5, param0, param6, var11, -1, 1, 1, 0);
                var9_int++;
                continue L1;
              }
            }
          ...
          throw lj.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + 44 + param5 + 44 + param6 + 44 + 0 + 41);
        }
    }
