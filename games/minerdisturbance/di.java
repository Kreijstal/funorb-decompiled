...
final class di extends um {
              ...
              L5: {
                ...
                if (var12 == null) {
                  ...
                  if (var13 == null) {
                    ...
                    if (var13.a(param2, (byte) -31, var8.field_s, var7_array)) {
                      break L5;
                    } else {
                      var6 = 0;
                      break L5;
                  ...
                  if (var12.a(param2, (byte) -31, var8.field_s, var7_array)) {
                    break L5;
                  } else {
                    var6 = 0;
    ...
    private final void a(int param0, int param1) {
        int var4 = MinerDisturbance.field_ab;
        cg var3 = (cg) (Object) ((di) this).field_z.field_v.b(64);
        while (var3 != null) {
            if ((param0 ^ -1) <= -1) {
                // if_icmpne L158
            }
        ...
        try {
            ...
            stateLoop: while (true) {
                switch (statePc) {
                    ...
                    case 13: {
                        try {
                            new java.net.URL(stackIn_13_4, stackIn_13_6 + "&v1=" + vf.field_s + "&v2=" + vf.field_b + "&e=" + var7);
                            var4 = ((vf) (Object) stackIn_13_0).a((byte) stackIn_13_1, stackIn_13_2);
                            statePc = 14;
                            continue stateLoop;
    ...
    private final void e(int param0, int param1) {
        int var4 = MinerDisturbance.field_ab;
        cg var3 = (cg) (Object) ((di) this).field_z.field_v.b(71);
        while (var3 != null) {
            if ((param0 ^ -1) <= -1) {
                // if_icmpne L88
            }
