...
final class hh {
    ...
    final pi a(boolean param0, pi param1) {
        ...
        try {
          L0: {
            ...
            L2: {
              if (param1 == null) {
                var3 = this.field_e.field_c.field_c;
                break L2;
              } else {
                var3 = param1;
                break L2;
    ...
    hh(ta param0) {
        try {
            ...
            throw lj.a((Throwable) ((Object) runtimeException), "hh.<init>(" + (param0 != null ? "{...}" : "null") + ')');
        }
    }
        ...
        try {
          L0: {
            L1: {
              ...
              if (param0 == null) {
                var4 = this.field_e.field_c.field_f;
                break L1;
              } else {
                var4 = param0;
                break L1;
