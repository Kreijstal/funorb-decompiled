    ...
    final static gj a(String param0, boolean param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_25_1 = new StringBuilder().append("rg.C(");
              ...
              L3: {
                ...
                if (5 != param1) {
                  if (-257 != (param1 ^ -1)) {
                    ...
                    discarded$2 = var6.a(af.field_s, 95, (rm) (this));
                    break L3;
                  }
                } else {
                  ...
                  if (4 == param1) {
                    ...
                    if (-7 != (param1 ^ -1)) {
                      if (param1 != 9) {
                        ...
                        discarded$3 = var6.a(bm.field_k, 66, (rm) (this));
                        break L5;
                      }
                    } else {
