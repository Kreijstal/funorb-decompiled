...
final class ue extends com.ms.dll.Callback {
    ...
    final void a(int param0, java.awt.Component param1, boolean param2) {
        ...
        if (this.field_d == var5) {
          ...
          discarded$42 = com.ms.win32.User32.SendMessage(var5, 101024, param0, 0);
          return;
        } else {
          L4: {
            if (this.field_d != 0) {
              ...
              synchronized (var6) {
                L5: {
                  discarded$44 = com.ms.win32.User32.SetWindowLong(this.field_d, -4, this.field_b);
                  break L5;
                }
              }
              break L4;
          ...
          discarded$45 = com.ms.win32.User32.SendMessage(var5, 101024, param0, 0);
          return;
        }
    }
