                  ...
                  L2: while (true) {
                    ...
                    if (var8 == 0) {
                      ...
                      try {
                        ...
                        throw lj.a((Throwable) ((Object) stackIn_38_0), (stackIn_38_2 != 0) + " " + param0 + " " + param3.length + " " + gn.a(param3.length, var9, true) + " " + gn.a(param3.length + -2, var9, true) + " " + this.field_f.field_h[param0] + " " + this.field_f.field_b);
                      }
                      L10: {
                        if (!this.field_d) {
                          break L10;
    ...
    final static void a(int param0, wh param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_5_1 = new StringBuilder().append("bj.O(").append(param0).append(',');
