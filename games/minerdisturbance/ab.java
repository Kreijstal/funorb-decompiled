...
final class ab {
    ...
    final static void a(int param0, int param1, wb param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("ab.B(").append(-20680).append(',').append(param1).append(',');
    ...
    final static String a(int param0, int param1, boolean param2, long param3) {
        ...
        L3: while (true) {
          var11 = (int)param3;
          param3 = param3 / 10L;
          StringBuilder discarded$18 = var9.append((char)(48 + (var11 - 10 * (int)param3)));
          if (param3 == 0L) {
            L4: {
              if (var8 == 0) {
                break L4;
              } else {
                StringBuilder discarded$19 = var9.append('-');
                break L4;
              }
            }
            ...
            var10++;
            if (0 == var10 % 3) {
              StringBuilder discarded$20 = var9.append((char) var7);
              continue L3;
            } else {
              continue L3;
            }
    ...
    final static void a() {
        ...
        try {
          ...
          throw lj.a((Throwable) (Object) var1_ref, "ab.A(" + -20707 + ')');
        }
    }
        ...
        try {
            ...
            try {
              ...
              L0: {
                ...
                stackOut_4_1 = new StringBuilder().append("ab.G(").append(-98).append(',').append(param1).append(',');
    ...
    final static void a(byte param0, java.awt.Canvas param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ab.F(").append(-13).append(',');
