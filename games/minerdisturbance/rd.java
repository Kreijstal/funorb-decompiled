        ...
        try {
            ...
            try {
              L0: {
                L1: {
                  if (param0 == 27) {
                    ...
                    discarded$2 = rd.a((byte) -104, (java.applet.Applet) null);
                    break L1;
                  }
                }
                if (!nn.field_q) {
              ...
              L7: {
                ...
                stackOut_20_1 = new StringBuilder().append("rd.B(").append(param0).append(',');
    ...
    final static vm a(String param0, int param1, bj param2, bj param3, String param4) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = dl.a(param2, var6, var5_int, (byte) 122, param3);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("rd.A(");
