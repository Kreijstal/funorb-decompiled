...
final class jj {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            ...
            if (((jj) this).field_a == param0) {
              return;
            } else {
              if (null != ((jj) this).field_a) {
                L1: {
                  ((jj) this).field_a.setCursor((java.awt.Cursor) null);
                  ((jj) this).field_a = null;
                  if (param0 != null) {
