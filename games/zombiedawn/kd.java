                  ...
                  if (var8 instanceof ah) {
                    ...
                    if (var8 instanceof kd) {
                      L9: {
                        ...
                        if (((kd) this).field_fb == -1) {
                          stackOut_19_0 = 0;
                          stackIn_20_0 = stackOut_19_0;
                          break L9;
                        } else {
                          stackOut_18_0 = ((kd) this).field_fb;
                        ...
                        if (!var15.field_ob) {
                          L11: {
                            ...
                            if (var15.field_V) {
                              ...
                              var3 = var15.a(true) - ((kd) this).a(true);
                              var4 = var15.f(237239984) - ((kd) this).f(237239984);
                              var5 = var4 * var4 + var3 * var3;
                              if (529 <= var5) {
                                break L11;
                              } else {
                                if (var6.a(var15.f(237239984), ((kd) this).f(237239984), var15.a(true), ((kd) this).a(true), 106) == -1) {
                                  break L11;
                                } else {
                                  L13: {
                                    ((kd) this).e(21, -6904);
                                  ...
                                  L15: {
                                    var12 = var15.field_y + (var3 << 15);
                                    var13 = var15.field_x + (var4 << 15);
                                    if (var6.a(var13 >> 16, var15.f(237239984), var12 >> 16, var15.a(true), 120) == -1) {
                                      var15.field_Y = var15.a(true);
                                      var15.field_X = var15.f(237239984);
                                      break L15;
                                    } else {
                                      var15.field_X = var13 >> 16;
                                      var15.field_Y = var12 >> 16;
                                      break L15;
                                    }
                                  }
                                  L16: {
                                    var13 = ((kd) this).field_x - (var4 << 15);
                                    var12 = ((kd) this).field_y - (var3 << 15);
