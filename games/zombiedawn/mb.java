...
final class mb extends le {
    ...
    final static int c() {
        int var0 = field_B[field_D] >> field_L & 1;
        field_L = field_L + 1;
        field_D = field_D + (field_L >> 3);
        field_L = field_L & 7;
        return var0;
    }
    ...
    final gi a(int[] param0) {
        ...
        L1: {
          if (((mb) this).field_h != null) {
            break L1;
          } else {
            ((mb) this).field_u = 0;
            ((mb) this).field_s = new float[field_K];
            ((mb) this).field_h = new byte[((mb) this).field_y];
            ((mb) this).field_z = 0;
            ((mb) this).field_A = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((mb) this).field_A >= ((mb) this).field_t.length) {
            ((mb) this).field_s = null;
            var14 = ((mb) this).field_h;
            ((mb) this).field_h = null;
            return new gi(((mb) this).field_x, var14, ((mb) this).field_w, ((mb) this).field_J, ((mb) this).field_F);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((mb) this).field_z;
                  var4 = var13.length;
                  if (var4 <= ((mb) this).field_y - var3) {
                    break L5;
                  } else {
                    var4 = ((mb) this).field_y - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((mb) this).field_z);
                        break L7;
                      }
                    }
                    ((mb) this).field_z = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((mb) this).field_A = ((mb) this).field_A + 1;
            continue L2;
          }
        }
    }
    ...
    final gi b() {
        ...
        ((mb) this).field_u = 0;
        ((mb) this).field_s = new float[field_K];
        var1 = new byte[((mb) this).field_y];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((mb) this).field_t.length) {
            ((mb) this).field_s = null;
            return new gi(((mb) this).field_x, var1, ((mb) this).field_w, ((mb) this).field_J, ((mb) this).field_F);
          } else {
            var4 = this.c(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((mb) this).field_y - var2) {
                  break L1;
                } else {
                  var5 = ((mb) this).field_y - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    private final void b(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        de var2 = new de(param0);
        ((mb) this).field_x = var2.c(125);
        ((mb) this).field_y = var2.c(101);
        ((mb) this).field_w = var2.c(109);
        ((mb) this).field_J = var2.c(121);
        if (((mb) this).field_J < 0) {
            ((mb) this).field_J = ((mb) this).field_J ^ -1;
            ((mb) this).field_F = true;
        }
        int var3 = var2.c(103);
        if (var3 < 0) {
            throw new IOException();
        }
        ((mb) this).field_t = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            var5 = 0;
            do {
                var6_int = var2.d((byte) -123);
                var5 = var5 + var6_int;
            } while (var6_int >= 255);
            var6 = new byte[var5];
            var2.a(var5, 0, var6, 11240);
            ((mb) this).field_t[var4] = var6;
        }
    }
    ...
    private final static boolean a(dj param0) {
        byte[] var1 = null;
        if (!field_n) {
            var1 = param0.a((byte) 51, 0, 0);
            if (var1 == null) {
                return false;
            }
            mb.a(var1);
    ...
    final static int d(int param0) {
        ...
        while (param0 >= 8 - field_L) {
            var3 = 8 - field_L;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_B[field_D] >> field_L & var4) << var2);
            field_L = 0;
            field_D = field_D + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_B[field_D] >> field_L & var3) << var2);
    ...
    final static mb a(dj param0, String param1, String param2) {
        try {
            ...
            byte[] var3 = param0.a(param2, -116, param1);
            if (var3 == null) {
                return null;
            }
            mb var4 = null;
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = mb.d(16);
                                    int discarded$4 = mb.d(16);
                                    field_N[var6] = mb.d(8);
                                    var6++;
                                    continue L6;
                                  }
                ...
                L10: while (true) {
                  if (var8_int >= var4) {
                    ...
                    L11: while (true) {
                      if (var9_int >= var5) {
                        var9 = new int[var5];
                        var10 = wm.a(var5 - 1, (byte) 113);
                        var11 = 0;
                        L12: while (true) {
                          if (var11 >= var5) {
                            if (var1 == 0) {
                              field_q = var6_ref_float__;
                              field_E = var7;
                              field_H = var8;
                              field_G = var9;
                              var1++;
                            ...
                            var9[var11] = ij.a(var11, true, var10);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    private final float[] c(int param0) {
        ...
        L0: {
          mb.a(((mb) this).field_t[param0], 0);
          int discarded$1 = mb.c();
          var2 = mb.d(wm.a(field_N.length - 1, (byte) 26));
          var3 = field_M[var2] ? 1 : 0;
          if (var3 == 0) {
            stackOut_2_0 = field_l;
          ...
          L5: {
            ...
            if (var3 == 0) {
              ...
              if (var5 != 0) {
                ...
                var8 = (var4 >> 2) - (field_l >> 2);
                var9 = (var4 >> 2) + (field_l >> 2);
                var10 = field_l >> 1;
                break L4;
              }
            }
          ...
          L7: {
            if (var3 == 0) {
              ...
              if (var6 != 0) {
                ...
                var11 = var4 - (var4 >> 2) - (field_l >> 2);
                var12 = var4 - (var4 >> 2) + (field_l >> 2);
                var13 = field_l >> 1;
                break L6;
              }
            }
          ...
          if (var17_int >= var14.field_d) {
            ...
            L35: {
              ...
              if (((mb) this).field_u <= 0) {
                ...
                L36: {
                  var18_int = ((mb) this).field_u + var4 >> 2;
                  ...
                  if (((mb) this).field_r) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((mb) this).field_p) {
                        break L36;
                      } else {
                        var20 = (((mb) this).field_u >> 1) + var19;
                        var40[var19] = var40[var19] + ((mb) this).field_s[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((mb) this).field_s;
              ((mb) this).field_s = field_C;
              field_C = var18;
              ((mb) this).field_u = var4;
              ((mb) this).field_p = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    private mb(byte[] param0) throws IOException {
        this.b(param0);
    }
