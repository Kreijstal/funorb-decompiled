    ...
    public final void a(int param0, boolean param1, int param2, ga param3, int param4) {
        ...
        try {
          L0: {
            ...
            L5: {
              ...
              if (null == this.field_g) {
                ...
                discarded$1 = this.field_g.a(param3.field_o, var13 + param4 + param3.field_k, this.field_k + param3.field_j + param2, -this.field_e - (var13 - param3.field_i), param3.field_n - (this.field_e << -1077052639), this.field_l, this.field_f, 1, 1, 0);
                break L5;
              }
            }
            break L0;
          ...
          L6: {
            ...
            stackOut_11_1 = new StringBuilder().append("t.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
