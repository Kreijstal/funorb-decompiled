...
final class fn extends sp {
    ...
    private final boolean h() {
        ...
        L0: {
          var1 = this.field_o;
          if (var1 != -2147483648) {
            var2 = fn.a(var1, this.field_v);
            var3 = fn.c(var1, this.field_v);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L3: {
          if (this.field_u >= var2) {
            if (this.field_u <= var2) {
              ...
              L4: {
                ...
                if (this.field_l == 0) {
                  ...
                  if (this.field_l <= this.field_u - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_l = this.field_u - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_l == 0) {
                ...
                if (this.field_l <= var2 - this.field_u) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_l = var2 - this.field_u;
            break L3;
          }
        }
        if (this.field_n < var3) {
          this.field_q = 1;
          if (this.field_l != 0) {
            if (this.field_l > var3 - this.field_n) {
              this.field_l = var3 - this.field_n;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_n <= var3) {
              ...
              L7: {
                ...
                if (this.field_l == 0) {
                  ...
                  if (this.field_l <= this.field_n - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_l = this.field_n - var3;
              break L6;
            }
          }
          return false;
    ...
    final synchronized boolean l() {
        return this.field_t < 0 || this.field_t >= ((gi) ((Object) this.field_h)).field_l.length << 8;
    }
    ...
    final synchronized void d(int param0) {
        int var2 = ((gi) ((Object) this.field_h)).field_l.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
    ...
    final int a() {
        if (this.field_o == 0 && this.field_l == 0) {
            return 0;
        }
        return 1;
    }
        ...
        L0: while (true) {
          if (this.field_l <= 0) {
            L1: {
              if (this.field_m != -256) {
                ...
                if ((this.field_t & 255) != 0) {
                  ...
                  if (qf.field_l) {
                    return fn.a(0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_u, this.field_n, 0, param3, param2, (fn) (this));
                  } else {
                    return fn.a(((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_y, 0, param3, param2, (fn) (this));
                  }
                }
              }
            }
            if (qf.field_l) {
              return fn.b(0, 0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_u, this.field_n, 0, param3, param2, (fn) (this), this.field_m, param4);
            } else {
              return fn.b(0, 0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_y, 0, param3, param2, (fn) (this), this.field_m, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_m != -256) {
                  ...
                  if ((this.field_t & 255) != 0) {
                    ...
                    if (!qf.field_l) {
                      param1 = fn.b(((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_y, this.field_w, 0, var6, param2, (fn) (this));
                      break L3;
                    } else {
                      param1 = fn.b(0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_u, this.field_n, this.field_z, this.field_q, 0, var6, param2, (fn) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!qf.field_l) {
                param1 = fn.d(0, 0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_y, this.field_w, 0, var6, param2, (fn) (this), this.field_m, param4);
                break L3;
              } else {
                param1 = fn.b(0, 0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_u, this.field_n, this.field_z, this.field_q, 0, var6, param2, (fn) (this), this.field_m, param4);
                break L3;
              }
            }
            this.field_l = this.field_l - param1;
        ...
        L0: {
          if (this.field_l <= 0) {
            ...
            if (param0 < this.field_l) {
              this.field_y = this.field_y + this.field_w * param0;
              this.field_u = this.field_u + this.field_z * param0;
    ...
    private final void i() {
        this.field_y = this.field_o;
        this.field_u = fn.a(this.field_o, this.field_v);
        this.field_n = fn.c(this.field_o, this.field_v);
    }
          ...
          L4: {
            if (this.field_s <= 0) {
              ...
              if (!this.field_r) {
                if (this.field_m >= 0) {
                  L5: while (true) {
                    var9 = this.b(param0, var9, var6, param2, (int) var4.field_l[this.field_x]);
                  ...
                  L6: while (true) {
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_l[this.field_p - 1]);
                    if (this.field_t < var5) {
                ...
                L7: {
                  if (this.field_m >= 0) {
                    ...
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_l[this.field_x]);
                    if (this.field_t < var5) {
                ...
                L8: while (true) {
                  var9 = this.b(param0, var9, var6, param2, (int) var4.field_l[this.field_p - 1]);
                  if (this.field_t >= var6) {
    ...
    final int b() {
        ...
        if (this.field_s == 0) {
            var1 = var1 - var1 * this.field_t / (((gi) ((Object) this.field_h)).field_l.length << 8);
        } else {
            if (this.field_s >= 0) {
                var1 = var1 - var1 * this.field_x / ((gi) ((Object) this.field_h)).field_l.length;
            }
        }
    ...
    final synchronized int j() {
        return this.field_o == -2147483648 ? 0 : this.field_o + 32 >> 6;
    }
        ...
        if (param0 != 0) {
          ...
          if (this.field_u == var4) {
            if (this.field_n == var5) {
              ...
              this.field_o = param1;
              this.field_v = param2;
              this.field_w = (param1 - this.field_y) / param0;
              this.field_z = (var4 - this.field_u) / param0;
        ...
        L0: while (true) {
          if (this.field_l <= 0) {
            L1: {
              if (this.field_m != 256) {
                ...
                if ((this.field_t & 255) != 0) {
                  ...
                  if (qf.field_l) {
                    return fn.b(0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_u, this.field_n, 0, param3, param2, (fn) (this));
                  } else {
                    return fn.b(((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_y, 0, param3, param2, (fn) (this));
                  }
                }
              }
            }
            if (qf.field_l) {
              return fn.a(0, 0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_u, this.field_n, 0, param3, param2, (fn) (this), this.field_m, param4);
            } else {
              return fn.a(0, 0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_y, 0, param3, param2, (fn) (this), this.field_m, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_l;
            ...
            L3: {
              L4: {
                ...
                if (this.field_m != 256) {
                  ...
                  if ((this.field_t & 255) != 0) {
                    ...
                    if (!qf.field_l) {
                      param1 = fn.a(((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_y, this.field_w, 0, var6, param2, (fn) (this));
                      break L3;
                    } else {
                      param1 = fn.a(0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_u, this.field_n, this.field_z, this.field_q, 0, var6, param2, (fn) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!qf.field_l) {
                param1 = fn.c(0, 0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_y, this.field_w, 0, var6, param2, (fn) (this), this.field_m, param4);
                break L3;
              } else {
                param1 = fn.a(0, 0, ((gi) ((Object) this.field_h)).field_l, param0, this.field_t, param1, this.field_u, this.field_n, this.field_z, this.field_q, 0, var6, param2, (fn) (this), this.field_m, param4);
                break L3;
              }
            }
            this.field_l = this.field_l - param1;
        ...
        if (param0 != 0) {
          if (this.field_u == 0) {
            if (this.field_n == 0) {
              ...
              this.field_w = -this.field_y / param0;
              this.field_z = -this.field_u / param0;
    ...
    private fn(gi param0, int param1, int param2) {
        this.field_h = (ik) ((Object) param0);
        this.field_x = param0.field_i;
