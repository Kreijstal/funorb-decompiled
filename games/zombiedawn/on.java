...
final class on {
                  ...
                  if (((on) this).field_h.length <= var3_int) {
                    ...
                    if (var7 != 0) {
                      ...
                      L5: while (true) {
                        L6: {
                          L7: {
                            if (~((on) this).field_h[0].length >= ~var4) {
                              break L7;
                            } else {
                              var5 = 127 & ((on) this).field_f[var3_int][var4];
                              var6 = ub.a(127, var5);
                              if (var7 != 0) {
                                break L6;
                              } else {
    ...
    public static void a() {
        ...
        try {
          ...
          throw sh.a((Throwable) (Object) var1, "on.L(" + 122 + ')');
        }
    }
    ...
    private final void a(int[][] param0) {
        ...
        try {
          ...
          throw sh.a((Throwable) (Object) stackIn_38_0, stackIn_38_2 + ',' + -39 + ')');
        }
    }
    ...
    private final fb a(int param0, int param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            if (param3 != 0) {
              ...
              if (var7 == null) {
                ...
                ((fb) var7).field_z = (param2 & 25165824) >> 23;
                stackOut_39_0 = var7;
                stackIn_40_0 = stackOut_39_0;
                return (fb) (Object) stackIn_40_0;
              }
            } else {
              stackOut_1_0 = new kd(param0, param1, 3 & param2, param2 >> 2 & 3);
          ...
          throw sh.a((Throwable) (Object) var6, "on.W(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + 1 + ')');
        }
        ...
        try {
          L0: {
            if (param1 < -43) {
              L1: {
                L2: {
                  var4_int = (33488896 & this.a(param0, param2, 1)) >> 16;
                  if (var4_int > 64) {
                    break L2;
                  } else {
                    if (var4_int != 0) {
    ...
    private final boolean a(int param0, boolean param1, int param2) {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var4 = decompiledCaughtException;
          throw sh.a((Throwable) (Object) var4, "on.O(" + param0 + ',' + true + ',' + param2 + ')');
        }
        return stackIn_10_0 != 0;
    }
    ...
    private final void a(int param0, int[][] param1) {
        ...
        try {
                                ...
                                L7: {
                                  if (stackIn_8_0 == stackIn_8_1) {
                                    ...
                                    L8: {
                                      ...
                                      if ((this.c(var4, 1 + var3_int, -65) & 65408) >> 7 == 16) {
                                        break L8;
                                      } else {
                                        break L7;
                                      }
          ...
          L13: {
            ...
            stackOut_38_1 = new StringBuilder().append("on.T(").append(108).append(',');
    ...
    private final int c(byte param0, int param1, int param2) {
        ...
        try {
          L0: {
            ...
            L2: {
              L3: {
                var4_int = 511 & this.a(param2, param1, 1) >> 7;
                if (8 == ((on) this).field_a) {
                  break L3;
                } else {
                  if (((on) this).field_a == 7) {
                    break L3;
                  } else {
                    if (((on) this).field_a == 5) {
                      break L3;
                    } else {
                      break L2;
                    }
              ...
              if (param2 < 0) {
                ...
                if (param1 < 0) {
                  ...
                  if (~((on) this).field_f.length < ~param1) {
                    if (((on) this).field_f[0].length <= param2) {
                      ...
                      L4: {
                        var5 = 511 & ((on) this).field_h[param1][param2] >> 7;
                        if (0 < var5) {
                          var4_int = var5;
                          break L4;
                        } else {
    ...
    private final boolean b(int param0, int param1) {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var4 = decompiledCaughtException;
          throw sh.a((Throwable) (Object) var4, "on.F(" + param0 + ',' + param1 + ',' + -1777127001 + ')');
        }
        return stackIn_10_0 != 0;
    }
    ...
    final static boolean a(byte param0, String param1, String param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_32_1 = new StringBuilder().append("on.I(").append(-23).append(',');
    ...
    private final boolean a(byte param0, int param1, int param2) {
        ...
        try {
          L0: {
            if ((33554432 & this.a(param1, param2, 1)) != 0) {
              L1: {
                if (param0 < -78) {
                  break L1;
                } else {
              ...
              L2: {
                if (this.c((byte) 41, param2, param1) != -1) {
                  stackOut_9_0 = 0;
                  stackIn_10_0 = stackOut_9_0;
                  break L2;
                } else {
    ...
    private final boolean d(int param0, int param1, int param2) {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var4 = decompiledCaughtException;
          throw sh.a((Throwable) (Object) var4, "on.D(" + param0 + ',' + 1 + ',' + param2 + ')');
        }
        return stackIn_10_0 != 0;
    }
    ...
    private final int a(int param0, int param1, int param2) {
        ...
        try {
          L0: {
            L1: {
              if (param0 < 0) {
                ...
                if (~param0 <= ~((on) this).field_f[0].length) {
                  break L1;
                } else {
                  if (param1 < 0) {
                    break L1;
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var4 = decompiledCaughtException;
          throw sh.a((Throwable) (Object) var4, "on.U(" + param0 + ',' + param1 + ',' + 1 + ')');
        }
        return stackIn_18_0;
    }
        ...
        try {
          L0: {
            ...
            L3: {
              if (!param3) {
                L4: {
                  stackOut_10_0 = ((on) this).field_t[param2];
                ...
                stackIn_14_0[stackIn_14_1] = hi.a(stackIn_14_2, eg.a(14, ((on) this).field_t[param2][param4]));
                break L3;
              } else {
                break L3;
              }
            ...
            L5: {
              if (~((on) this).field_p[param2].length < ~(1 + param4)) {
                L6: {
                  stackOut_18_0 = ((on) this).field_p[param2];
                  stackOut_18_1 = 1 + param4;
                  stackOut_18_2 = eg.a(-3, ((on) this).field_p[param2][param4 - -1]);
                ...
                if (param3) {
                  ...
                  L7: {
                    stackOut_23_0 = ((on) this).field_t[param2];
                    stackOut_23_1 = param4 - -1;
                    stackOut_23_2 = eg.a(((on) this).field_t[param2][1 + param4], -3);
            ...
            L8: {
              if (param4 - 1 <= 0) {
                ...
                L9: {
                  stackOut_31_0 = ((on) this).field_p[param2];
                ...
                stackIn_37_0[stackIn_37_1] = hi.a(stackIn_37_2, eg.a(-5, ((on) this).field_p[param2][-1 + param4]));
                if (param3) {
                  break L8;
                } else {
                  L10: {
                    stackOut_38_0 = ((on) this).field_t[param2];
                  ...
                  stackIn_44_0[stackIn_44_1] = hi.a(stackIn_44_2, eg.a(-5, ((on) this).field_t[param2][-1 + param4]));
                  break L8;
                }
              }
            }
    ...
    private final int b(byte param0, int param1, int param2) {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var4 = decompiledCaughtException;
          throw sh.a((Throwable) (Object) var4, "on.C(" + -61 + ',' + param1 + ',' + param2 + ')');
        }
