...
abstract class ln {
    ...
    final static aa a(boolean param0, int param1) {
        ...
        L4: {
          if (cg.field_e == 1) {
            discarded$4 = var3.f(2);
            discarded$5 = var3.a(true);
            break L4;
          } else {
            if ((cg.field_e ^ -1) == -5) {
              discarded$6 = var3.f(2);
              discarded$7 = var3.a(true);
              break L4;
            } else {
              break L4;
            }
    ...
    final static void a(int param0, int param1, String param2, String[] param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_15_1 = new StringBuilder().append("ln.I(").append(param0).append(',').append(param1).append(',');
