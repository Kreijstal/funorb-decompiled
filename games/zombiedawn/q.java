...
final class q extends pa {
    ...
    q(int param0, int param1, int param2, int param3, ga param4, boolean param5, int param6, int param7, rb param8, int param9, String param10) {
        ...
        try {
          L0: {
            ...
            L3: {
              if (!this.field_K) {
                stackOut_9_0 = this.field_D - -(2 * this.field_I);
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("q.<init>(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
    ...
    final void a(int param0, int param1, int param2, int param3) {
        ...
        int discarded$0 = this.field_E.a(this.field_F, this.field_I + (var5 + var7), this.field_I + var6, this.field_D + -this.field_I, -(this.field_I * 2) + this.field_n, this.field_J, -1, !this.field_K ? 2 : 0, 1, this.field_E.field_I);
    }
