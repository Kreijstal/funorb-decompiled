...
public final class ZombieDawn extends m {
          ...
          if (sg.field_eb != ke.field_c) {
            L1: {
              if (ke.field_c.field_d == 0) {
                stackIn_5_0 = sg.field_eb;
                break L1;
              } else {
                stackIn_5_0 = ke.field_c;
                break L1;
              }
            }
            L2: {
    ...
    final boolean a(am param0, int param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("ZombieDawn.HA(");
    ...
    final void c(boolean param0) {
        ...
        id.i(-72);
        tf.c(-12220);
        kc.c(!param0 ? true : false);
        mm.e((byte) 47);
        ck.d(1);
        be.c(true);
        ea.a((byte) 82);
        no.b(!param0 ? true : false);
        gn.a(127);
        hk.b(true);
        we.x(16777215);
        ao.i(-106);
        ...
        wf.h(102);
        fm.a(12959);
        pm.a(!param0 ? true : false);
        fe.a(67);
        ho.a((byte) 118);
        bd.a(!param0 ? true : false);
        vb.f((byte) -104);
        po.v(-31113);
        cn.a(92);
        hf.d((byte) -34);
