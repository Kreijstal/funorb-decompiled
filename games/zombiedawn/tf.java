...
final class tf {
    ...
    final static int a(boolean param0, int param1, CharSequence param2, int param3) {
        ...
        try {
          ...
          throw sh.a((Throwable) ((Object) stackIn_47_0), stackIn_47_2 + ',' + param3 + ')');
        }
        return stackIn_43_0;
    }
    ...
    public tf() {
        this.field_a = new fa();
        this.field_a.field_q = this.field_a;
