...
final class wj extends le {
    ...
    final static wj a(dj param0, String param1, String param2) {
        byte[] var3 = param0.a(param2, -105, param1);
        if (var3 == null) {
            return null;
        }
        return new wj(new de(var3));
    }

    private wj(de param0) {
        ...
        de stackIn_66_0 = null;
        de stackIn_67_0 = null;
        int stackIn_67_1 = 0;
        int stackIn_73_0 = 0;
        int var2;
        int var3;
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51 = new de(this.field_i);
                      var51.h(-122, 1297377380);
                      var51.h(104, 6);
                      stackIn_66_0 = (de) (var51);

                      if (var2 <= 1) {
                        stackIn_67_0 = (de) ((Object) stackIn_66_0);
                        stackIn_67_1 = 0;
                        break L3;
                      } else {
                        stackIn_67_0 = (de) ((Object) stackIn_66_0);
                    ...
                    ((de) (Object) stackIn_67_0).a(stackIn_67_1, (byte) 105);
                    var51.a(var2, (byte) 105);
                    var51.a(var3, (byte) 105);
                      ...
                      if (var60 >= var2) {
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                              ...
                              if (var62 != 0) {
                                if (var62 != 1) {
                                    ...
                                    if (var62 != 3) {
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            L7: {
                                              if (var65 == 0) {
                                                ...
                                                var51.i(192 + var52, 77);
                                                break L7;
                                              }
                                            }
                                            incrementValue$1 = var44;
                                            var44++;
                                            var51.i((int) param0.field_h[incrementValue$1], 71);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                                          ...
                                          var51.i(var53 & 127, -121);
                                          var51.i(var58 & 127, 106);
                                          continue L5;
                                        }
                                      } else {
                                        L9: {
                                      ...
                                      var51.i(var56 & 127, 61);
                                      var51.i(var56 >> 7 & 127, -108);
                                      continue L5;
                                    }
                                  } else {
                                    L11: {
                                  ...
                                  var51.i(var53 & 127, 112);
                                  var51.i(var55 & 127, 62);
                                  continue L5;
                                }
                              } else {
                                L16: {
                                ...
                                var51.i(var53 & 127, 72);
                                var51.i(var54 & 127, -98);
                                continue L5;
                              }
                            } else {
                              L17: {
                              ...
                              var50++;
                              var51.i((int) param0.field_h[incrementValue$25], -127);
                              incrementValue$26 = var50;
                              var50++;
                              var51.i((int) param0.field_h[incrementValue$26], 102);
                              incrementValue$27 = var50;
                              var50++;
                              var51.i((int) param0.field_h[incrementValue$27], -104);
                              continue L5;
                            }
                          } else {
                            L18: {
                            ...
                            var51.i(47, 63);
                            var51.i(0, -80);
                            var51.f(var51.field_j - var61, -72);
                            var60++;
                            continue L4;
                          }
                        }
                    ...
                    var28 = var28 + param0.d((byte) -122) & 127;
                    if (var28 != 0) {
                      if (var28 != 32) {
                        if (var28 != 1) {
                          if (var28 != 33) {
                      ...
                      L6: {
                        if (var9 != 144) {
                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              var13 = var19[var10];
                              var14 = (bh) ((Object) this.field_h.a((long)var13, 102));
                              if (var14 != null) {
                                break L7;
                              } else {
                                var15 = new bh(new byte[128]);
                                var14 = var15;
                                this.field_h.a(-114, (long)var13, var15);
                                break L7;
                              }
                            }
