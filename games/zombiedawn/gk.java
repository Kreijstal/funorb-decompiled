...
final class gk extends fb {
    ...
    final static void a(int param0, vn[] param1) {
        ...
        try {
          ...
          throw sh.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + ',' + true + ')');
        }
    }
    ...
    final static void j() {
        ...
        try {
          ...
          throw sh.a((Throwable) (Object) var1, "gk.F(" + 30549 + ')');
        }
    }
    ...
    final static on a(byte param0, byte[] param1) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (param1.length / 4 <= var6) {
                stackOut_6_0 = fc.a(var5, (byte) 126);
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("gk.E(").append(-81).append(',');
