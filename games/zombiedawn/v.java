...
final class v extends qb {
    ...
    final void a(int param0, int param1) {
        ...
        int var9 = 0;
        L0: {
          param0 = param0 + ((v) this).field_g;
          param1 = param1 + ((v) this).field_h;
        ...
        L4: {
          if (var6 <= 0) {
            ...
            if (var5 > 0) {
              v.a(bi.field_c, ((v) this).field_k, ((v) this).field_l, 0, var4, var3, var6, var5, var7, var8);
              return;
            } else {
              break L4;
            }
    ...
    final void a(int param0, int param1, int param2) {
        ...
        L4: {
          if (var7 <= 0) {
            ...
            if (var6 > 0) {
              v.b(bi.field_c, ((v) this).field_k, ((v) this).field_l, var5, var4, var7, var6, var8, var9, param2);
              return;
            } else {
              break L4;
            }
    ...
    v(int param0, int param1, int param2, int param3, int param4, int param5, byte[] param6, int[] param7) {
        ((v) this).field_a = param0;
        ((v) this).field_e = param1;
        ((v) this).field_g = param2;
        ((v) this).field_h = param3;
        ((v) this).field_j = param4;
        ((v) this).field_d = param5;
        ((v) this).field_k = param6;
        ((v) this).field_l = param7;
    }

    v(int param0, int param1, int param2) {
        ((v) this).field_j = param0;
        ((v) this).field_a = param0;
        ((v) this).field_d = param1;
        ((v) this).field_e = param1;
        ((v) this).field_h = 0;
        ((v) this).field_g = 0;
        ((v) this).field_k = new byte[param0 * param1];
        ((v) this).field_l = new int[param2];
    }
}
