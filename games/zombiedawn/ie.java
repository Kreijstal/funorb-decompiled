...
final class ie {
    ...
    final void a(de param0, ko param1) {
        ...
        L0: {
          ...
          if (var3 == 0) {
            ...
            this.field_b[0] = param0.f(2);
            this.field_b[1] = param0.f(2);
              ...
              if (var5 >= 2) {
                    ...
                    L5: while (true) {
                      if (var7 >= this.field_c[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_g[var5][1][var7] = param0.f(2);
                          this.field_a[var5][1][var7] = param0.f(2);
                          var7++;
                          continue L5;
                        }
                      }
                ...
                L6: while (true) {
                  if (var6 >= this.field_c[var5]) {
                    ...
                    this.field_g[var5][0][var6] = param0.f(2);
                    this.field_a[var5][0][var6] = param0.f(2);
                    var6++;
                    continue L6;
                  }
                }
    ...
    final int a(int param0, float param1) {
        ...
        for (var4 = 1; var4 < this.field_c[param0]; var4++) {
            ...
            for (var7 = var4 * 2 - 1; var7 >= 2; var7--) {
                dupTemp$0 = field_d[param0];
                dupTemp$0[var7] = dupTemp$0[var7] + (field_d[param0][var7 - 1] * var5 + field_d[param0][var7 - 2] * var6);
            }
            dupTemp$1 = field_d[param0];
            dupTemp$1[1] = dupTemp$1[1] + (field_d[param0][0] * var5 + var6);
            dupTemp$2 = field_d[param0];
            dupTemp$2[0] = dupTemp$2[0] + var5;
        }
        if (param0 == 0) {
            for (var4 = 0; var4 < this.field_c[0] * 2; var4++) {
                dupTemp$3 = field_d[0];
                dupTemp$3[var4] = dupTemp$3[var4] * field_f;
            }
        }
        for (var4 = 0; var4 < this.field_c[param0] * 2; var4++) {
    ...
    private final float a(int param0, int param1, float param2) {
        float var4 = (float)this.field_a[param0][0][param1] + param2 * (float)(this.field_a[param0][1][param1] - this.field_a[param0][0][param1]);
