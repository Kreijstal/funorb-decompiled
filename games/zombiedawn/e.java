...
final class e extends hp implements hh {
    ...
    final void a(byte param0, String param1, int param2) {
        ...
        try {
          L0: {
            L1: {
              var4_int = ((e) this).field_N;
              this.a(-128, 1 + var4_int);
              ((e) this).field_F[var4_int] = ((e) this).a(param1, 125, (sk) this);
              ((e) this).field_J[var4_int] = param2;
              if (param0 >= 88) {
                break L1;
              } else {
                ((e) this).field_F = null;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("e.H(").append(param0).append(44);
    ...
    e(sg param0, rb param1, String param2) {
        ...
        try {
            ...
            var4_int = ((e) this).field_Q != null ? ((e) this).field_L.b(((e) this).field_Q, 260, ((e) this).field_L.field_I) : 0;
            ((e) this).a(44, 0, 0, 288, var4_int + 22);
        } catch (RuntimeException runtimeException) {
            throw sh.a((Throwable) (Object) runtimeException, "e.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    public final void a(int param0, int param1, an param2, int param3, int param4) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              L3: {
                if (var6_int >= ((e) this).field_N) {
                  break L3;
                } else {
                  if (param2 != ((e) this).field_F[var6_int]) {
                    var6_int++;
                    continue L2;
                  } else {
                    var7 = ((e) this).field_J[var6_int];
                    if (var7 == -1) {
                      ((e) this).field_R.h((byte) -126);
                      break L3;
                    } else {
                      og.b(param1 ^ 120, ((e) this).field_J[var6_int]);
                      break L3;
                    }
                  }
                }
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("e.K(").append(param0).append(44).append(param1).append(44);
