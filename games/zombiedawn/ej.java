...
final class ej {
    ...
    final int[][] a(int param0) {
        ...
        int[][] var6 = new int[this.field_A.field_r][this.field_A.field_k];
        int[][] var2 = var6;
        int var3 = 0;
        if (param0 != 8728) {
            return (int[][]) null;
        }
        while (this.field_A.field_r > var3) {
            for (var4 = 0; var4 < this.field_A.field_k; var4++) {
        ...
        L0: {
          ...
          if ((var5 ^ -1) > -1) {
            ...
            if ((var6 ^ -1) > -1) {
              ...
              if (this.field_A.field_r <= var6) {
                break L0;
              } else {
                if (this.field_A.field_k <= var5) {
                  break L0;
                } else {
                  L1: {
                    var7 = param2 % 24;
                  ...
                  L4: {
                    var9 = (byte)(7 & this.field_A.field_p[var6][var5]);
                    if ((var8 & var9) != var8) {
                      stackIn_18_0 = 0;
                      break L4;
                    } else {
    ...
    private final void b(int param0) {
        this.field_u = 24 * this.field_A.field_k;
        if (param0 != -1) {
            wk var3 = (wk) null;
            this.a(49, (wk) null);
        }
        this.field_p = this.field_A.field_r * 24;
    }
    ...
    final void a(wk param0, int param1, boolean param2, boolean param3) {
        ...
        try {
          L0: {
            ...
            L3: {
              L4: {
                if (this.field_v.length < nh.field_I) {
                  break L4;
                } else {
                  if (bd.field_a > this.field_v[0].length) {
                    break L4;
                  } else {
                    break L3;
                  }
              ...
              this.field_v = new int[nh.field_I][bd.field_a];
              break L3;
            }
            var7 = var5_int;
            if (param2) {
                ...
                if (var8 >= nh.field_I) {
                  ...
                  L6: while (true) {
                    if (var9 >= bd.field_a) {
                      ...
                      if ((this.field_b[0].length ^ -1) < (var9 + this.field_f ^ -1)) {
                        if (this.field_b.length > var8 - -this.field_j) {
                          L7: {
                            L8: {
                              var10 = this.field_v[var8][var9];
                              if (param1 == 1) {
                                if (!this.field_b[this.field_j + var8][var9 + this.field_f]) {
                                  L9: {
          ...
          L18: {
            ...
            stackIn_90_1 = new StringBuilder().append("ej.Q(");
          ...
          throw sh.a((Throwable) ((Object) stackIn_91_0), stackIn_91_2 + ',' + param1 + ',' + param2 + ',' + param3 + ')');
        }
    ...
    final static void a(byte param0) {
        ...
        try {
                                      ...
                                      if (var19 >= var6) {
                                        ...
                                        L8: while (true) {
                                          if (var25 >= var7) {
                                            ...
                                            var15++;
                                            var11[0][incrementValue$3] = var27.c(126);
                                            var25++;
                                            continue L8;
                                          }
                                        }
                                        ...
                                        if (!l.a(89, var21)) {
                                          ...
                                          L10: while (true) {
                                            if (var7 <= var25) {
                                              ...
                                              var16++;
                                              var11[1][incrementValue$4] = var27.c(-43);
                                              var25++;
                                              continue L10;
                                            }
                                          }
                                        ...
                                        if (cm.field_b[var20].field_a) {
                                          ...
                                          L12: while (true) {
                                            if (var25 >= var7) {
                                              ...
                                              var17++;
                                              var11[2][incrementValue$5] = var27.c(-89);
                                              var25++;
                                              continue L12;
                                            }
                                          }
          ...
          throw sh.a((Throwable) ((Object) var1), "ej.B(" + param0 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return;
        } else {
    ...
    private final void c(byte param0) {
        ...
        L0: {
          ...
          if (3 != (this.field_l ^ -1)) {
            if (this.field_l == -3) {
              this.field_E = new int[this.field_C.length][this.field_C.length];
              var2 = 1;
              L1: while (true) {
                if (this.field_C.length / 2 <= var2) {
                  break L0;
                } else {
                  var3 = 0;
                  L2: while (true) {
                    if (var2 <= var3) {
                      ...
                      dupTemp$1 = this.a((byte) -128, this.field_C[var2], this.field_C[var3]);
                      arrayValue$2 = this.field_E[var3];
                      dupTemp$0[var3] = dupTemp$1;
                      arrayValue$2[var2] = dupTemp$1;
                      var3++;
                      continue L2;
                    }
                  }
              ...
              if ((this.field_l ^ -1) != 1) {
                if ((this.field_l ^ -1) != 0) {
                  ...
                  L3: while (true) {
                    if (var4 >= var3 - -3) {
                      ...
                      if ((var2 ^ -1) >= (var4 ^ -1)) {
                        ...
                        this.field_w = this.field_E;
                        this.field_k = this.field_B;
                        this.field_e = new int[this.field_C.length];
                        this.field_m = new int[this.field_C.length];
                        return;
                      } else {
                        var5 = 0;
                        L4: while (true) {
                          if (var5 >= var2) {
                            ...
                            L5: while (true) {
                              if (var2 <= var6) {
                                ...
                                L6: {
                                  var7 = this.field_D[var5][var6];
                                  var8 = this.field_D[var5][var4] - -this.field_D[var4][var6];
                                  if ((var7 ^ -1) == 0) {
                                    break L6;
                                  } else {
                                    if (var7 > var8) {
                                ...
                                if (0 <= this.field_D[var5][var4]) {
                                  if ((this.field_D[var4][var6] ^ -1) <= -1) {
                                    this.field_D[var5][var6] = var8;
                                    this.field_B[var5][var6] = this.field_B[var5][var4];
                                    var6++;
                                    continue L5;
                                  } else {
                                    var6++;
                  ...
                  var2 = this.field_C.length;
                  this.field_B = new int[var2][var2];
                  this.field_D = new int[var2][var2];
                  var3 = 0;
                  L7: while (true) {
                    if (var2 <= var3) {
                      break L0;
                      ...
                      L8: while (true) {
                        if (this.field_C.length <= var4) {
                          ...
                          var5 = this.field_E[var3][var4];
                          this.field_D[var3][var4] = var5;
                          this.field_B[var3][var4] = var4;
                          var4++;
                          continue L8;
                        }
                      }
                  ...
                  if (this.field_C.length <= var2) {
                    ...
                    L10: while (true) {
                      if (var2 <= var3) {
                        ...
                        dupTemp$3 = this.field_E[var2];
                        dupTemp$4 = this.a((byte) -128, this.field_C[var2], this.field_C[var3]);
                        arrayValue$5 = this.field_E[var3];
                        dupTemp$3[var3] = dupTemp$4;
                        arrayValue$5[var2] = dupTemp$4;
                        var3++;
                        continue L10;
                      }
                    }
            ...
            var2 = 0;
            L11: while (true) {
              if (var2 >= this.field_A.field_r) {
                break L0;
              } else {
                var3 = 0;
                L12: while (true) {
                  if (var3 >= this.field_A.field_k) {
                    var2++;
                    continue L11;
                  } else {
                    L13: {
                        ...
                        if (!this.b(0, 1 + var3, var2)) {
                          ...
                          if (!this.b(0, var3, 1 + var2)) {
                            ...
                            if (this.b(0, 1 + var3, 1 + var2)) {
                              ...
                              this.field_C = this.a(this.field_C, (byte) -97, new kk(24 * var3 - -1, 12 + var2 * 24));
                              break L13;
                            }
                          }
                        }
                        ...
                        if (!this.b(0, var3 + 1, var2)) {
                          ...
                          if (this.b(0, var3, 1 + var2)) {
                            ...
                            if (!this.b(param0 ^ -88, 1 + var3, 1 + var2)) {
                              ...
                              this.field_C = this.a(this.field_C, (byte) -87, new kk((var3 + 2) * 24 + -1, 12 + 24 * var2));
                              break L14;
                            }
                          }
                        }
                        ...
                        if (!this.b(param0 ^ -88, 1 + var3, var2)) {
                          ...
                          if (!this.b(0, var3, var2 + -1)) {
                            ...
                            if (!this.b(0, var3 + 1, -1 + var2)) {
                              this.field_C = this.a(this.field_C, (byte) -111, new kk(var3 * 24 - -1, (var2 + 1) * 24 - 12));
                              break L15;
                            } else {
                              break L15;
                            }
                      ...
                      if (this.b(0, 1 + var3, var2)) {
                        if (!this.b(0, var3, var2 + -1)) {
                          if (this.b(0, 1 + var3, var2 - 1)) {
                            this.field_C = this.a(this.field_C, (byte) -105, new kk(24 * var3 + 48 - 1, 12 + 24 * var2));
                            var3++;
                            continue L12;
                          } else {
                            var3++;
    ...
    final int a(int param0, int param1, int param2, byte param3, boolean param4, int param5) {
        ...
        if (!this.a(false, param0, param5, param4)) {
          return -1;
        } else {
          var7 = 12.0f;
          var8 = -param1 + param5;
          var9 = param0 - param2;
          var10 = so.b(var9 * var9 + var8 * var8);
          if (var10 != 0) {
            L0: {
              var11 = var7 / (float)var10;
              var12 = var11 * (float)var8;
              var13 = var11 * (float)var9;
              if (param3 <= -90) {
                break L0;
              } else {
                this.a(80, -57, 113, (byte) -23, true, 59);
                break L0;
              }
            }
            var14 = (float)param1;
            ...
            L1: while (true) {
              if (var7 >= (float)var16) {
                ...
                var15 = var15 + var13;
                var14 = var14 + var12;
                if (this.a(false, (int)var15, (int)var14, param4)) {
    ...
    final int c(int param0, int param1, int param2) {
        ...
        if (param0 >= this.field_A.field_r) {
            return 0;
        }
        if (param2 >= this.field_A.field_k) {
            return 0;
        }
        return this.field_A.field_h[param0][param2];
    }
    ...
    private final kk[] a(kk[] param0, byte param1, kk param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_10_1 = new StringBuilder().append("ej.N(");
          ...
          throw sh.a((Throwable) ((Object) stackIn_11_0), stackIn_14_2 + ')');
        }
        return stackIn_7_0;
    }
        ...
        try {
          L0: {
            ...
            L5: {
              ...
              if (this.field_A.field_k >= var8) {
                break L5;
              } else {
                var8 = this.field_A.field_k;
                break L5;
              }
            }
            L6: {
              var9 = nh.field_I + var6;
              if (this.field_A.field_r >= var9) {
                break L6;
              } else {
                var9 = this.field_A.field_r;
                break L6;
              }
            }
            L7: {
              ...
              if (param0 == -19795) {
                ...
                var18 = (kk) null;
                discarded$0 = this.a((byte) 93, (kk) null, (kk) null);
                break L7;
              }
            }
            L8: {
            ...
            L10: {
              if (this.field_y >= 0) {
                L11: {
                  var13 = var5 + -this.field_y;
                  var14 = var6 - this.field_c;
                  if (var13 != 0) {
                    break L11;
                  } else {
                    if (var14 != 0) {
                ...
                this.field_n = var6;
                var7 = 1;
                this.field_g = var6 - -(m.field_A.field_t / 24);
                this.field_z = var5 + m.field_A.field_w / 24;
                break L10;
              } else {
                var7 = 1;
                this.field_n = var6;
                this.field_z = m.field_A.field_w / 24 + var5;
                this.field_r = var5;
                this.field_g = m.field_A.field_t / 24 + var6;
                break L10;
              }
            }
            L12: {
                  ...
                  if (var9 <= var6) {
                    ...
                    L18: while (true) {
                      if (var5 >= var8) {
                        ...
                        L19: {
                          L20: {
                            var15_int = this.c(var6, -39, var5);
                            if (ub.a(127, this.field_A.field_f[var6][var5]) != null) {
                              break L20;
                            } else {
                              L21: {
                        ...
                        this.field_v[var12][var11] = var15_int;
                        var13 += 24;
                        var11++;
                        var5++;
                        continue L18;
          ...
          L23: {
            ...
            stackIn_58_1 = new StringBuilder().append("ej.L(").append(param0).append(',');
          ...
          throw sh.a((Throwable) ((Object) stackIn_59_0), stackIn_59_2 + ')');
        }
    }
    ...
    final qh a(boolean param0, int param1, int param2, int param3, int param4) {
        ...
        if (this.b(0, var6, var7)) {
          ...
          L2: {
            if (this.a(stackIn_17_1 != 0, param2, param3, param0)) {
              break L2;
            } else {
              if (this.b(0, var6 + -1, var7)) {
                if (!this.b(0, 1 + var6, var7)) {
          ...
          if (0 <= var11) {
            ...
            L3: while (true) {
              if (this.field_e.length <= var12) {
                  ...
                  if (this.field_e.length <= var12) {
                    ...
                    L5: while (true) {
                      if (var14 >= this.field_e.length) {
                        if ((var13 ^ -1) != 0) {
                          ...
                          L6: while (true) {
                            if (0 == (var12 ^ -1)) {
                              ...
                              if (this.field_m[var12] != var12) {
                                var10.a(this.field_i[var12].c(49), -112);
                                var12 = this.field_m[var12];
                                continue L6;
                              } else {
                                return null;
                              }
                        ...
                        var15 = this.a((byte) -128, var9, this.field_i[var14]);
                        if (-1 >= (var15 ^ -1)) {
                          if (0 != (this.field_e[var14] ^ -1)) {
                            L7: {
                              if (var13 == -1) {
                                break L7;
                              } else {
                                if (var13 > var15 + this.field_e[var14]) {
                                  break L7;
                                } else {
                                  var14++;
                                  continue L5;
                            ...
                            var13 = var15 - -this.field_e[var14];
                            var12 = var14;
                            var14++;
                            continue L5;
                          } else {
                    ...
                    if (this.field_e[var12] >= 0) {
                      var13 = 0;
                      L8: while (true) {
                        if (var13 < this.field_e.length) {
                          if (var13 != var12) {
                            if (-1 != this.field_h[var12][var13]) {
                              L9: {
                                if ((this.field_e[var13] ^ -1) == 0) {
                                  break L9;
                                } else {
                                  if (this.field_e[var13] > this.field_h[var12][var13] + this.field_e[var12]) {
                                    break L9;
                                  } else {
                                    var13++;
                                    continue L8;
                              ...
                              this.field_e[var13] = this.field_e[var12] - -this.field_h[var12][var13];
                              this.field_m[var13] = this.field_k[var13][var12];
                              var13++;
                              continue L8;
                            } else {
                              var13++;
                ...
                L10: {
                  var13 = this.a((byte) -128, var8, this.field_i[var12]);
                  this.field_e[var12] = var13;
                  stackIn_30_0 = this.field_m;

                  stackIn_30_1 = var12;

                  if (var13 < 0) {
                    stackIn_31_0 = (int[]) ((Object) stackIn_30_0);
    ...
    private final boolean b(int param0, int param1, int param2) {
        ...
        if (param2 >= this.field_A.field_r - 1) {
            return false;
        }
        if (param1 >= this.field_A.field_k + -1) {
            return false;
        }
        return (1 & this.field_A.field_p[param2][param1]) != 0 ? true : false;
    }
    ...
    private final int a(byte param0, kk param1, kk param2) {
        ...
        try {
          L0: {
            if (param0 == -128) {
              stackIn_4_0 = this.a(param1.field_h, param2.field_h, param1.field_l, param2.field_l, 117);
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
              stackIn_2_0 = -108;
          ...
          L1: {
            ...
            stackIn_7_1 = new StringBuilder().append("ej.E(").append(param0).append(',');
    ...
    final boolean a(int param0, int param1, int param2) {
        ...
        if (this.b(0, var4, var5)) {
          L0: {
            ...
            var8 = param1 % 24;
            if (-1 != (var4 ^ -1)) {
              stackIn_5_0 = this.b(0, -1 + var4, var5) ? 1 : 0;
              break L0;
            } else {
              stackIn_5_0 = 0;
              break L0;
          ...
          L1: {
            var9 = stackIn_5_0;
            if (this.field_A.field_k + -1 == var4) {
              stackIn_8_0 = 0;
              break L1;
            } else {
              stackIn_8_0 = this.b(0, var4 - -1, var5) ? 1 : 0;
              break L1;
            }
          }
          L2: {
            ...
            if (param2 > 8) {
              ...
              this.a(-111, -117, 12, 52, 71);
              break L2;
            }
          }
          L3: {
            if (var5 != -1 + this.field_A.field_r) {
              stackIn_13_0 = this.b(0, var4, 1 + var5) ? 1 : 0;
              break L3;
            } else {
              stackIn_13_0 = 0;
              break L3;
    ...
    final void a(wk param0, boolean param1) {
        ...
        try {
                ...
                if (var13 >= nh.field_I) {
                  ...
                  L6: while (true) {
                    if (var8 <= var6) {
                      ...
                      if ((var6 ^ -1) <= (this.field_A.field_r ^ -1)) {
                        break L1;
                      } else {
                        L7: while (true) {
                          L8: {
                            if (var7 <= var5) {
                              ...
                              if ((this.field_A.field_k ^ -1) >= (var5 ^ -1)) {
                                break L8;
                              } else {
                                L9: {
                                  L10: {
                                    var13 = this.c(var6, 123, var5);
                                ...
                                this.field_v[var12][var11] = var13;
                                var3_int += 24;
                                var11++;
                                var5++;
                                continue L7;
                    ...
                    if (this.field_i.length <= var5) {
                      ...
                      L14: while (true) {
                        if (var5 >= this.field_i.length) {
                                ...
                                if (var5 >= this.field_C.length) {
                                  ...
                                  L16: while (true) {
                                    if (var5 >= this.field_C.length) {
                                      ...
                                      var6 = bd.field_d + (-param0.field_u + this.field_C[var5].field_l);
                                      var7 = this.field_C[var5].field_h + (-param0.field_c - -nh.field_G);
                                  ...
                                  var6 = param0.a(this.field_C[var5].field_l, (byte) -99);
                                  var7 = param0.a(this.field_C[var5].field_h, 0);
                                  var8 = 0;
                                  L17: while (true) {
                                    if (var8 >= this.field_C.length) {
                                      ...
                                      L18: {
                                        var9 = param0.a(this.field_C[var8].field_l, (byte) -75);
                                        var10 = param0.a(this.field_C[var8].field_h, 0);
                                        if ((this.field_E[var5][var8] ^ -1) < -1) {
                          ...
                          var6 = bd.field_d + -param0.field_u + this.field_i[var5].field_l;
                          var7 = -param0.field_c + this.field_i[var5].field_h + nh.field_G;
                      ...
                      var6 = param0.a(this.field_i[var5].field_l, (byte) -104);
                      var7 = param0.a(this.field_i[var5].field_h, 0);
                      var8 = 0;
                      L19: while (true) {
                        if (this.field_i.length <= var8) {
                          L20: {
                            if (0 != (this.a(var4, this.field_i[var5].field_h, var3_int, this.field_i[var5].field_l, 112) ^ -1)) {
                          ...
                          L21: {
                            var9 = param0.a(this.field_i[var8].field_l, (byte) -82);
                            var10 = param0.a(this.field_i[var8].field_h, 0);
                            if (-1 <= (this.field_w[var5][var8] ^ -1)) {
                              break L21;
                            } else {
          ...
          L22: {
            ...
            stackIn_64_1 = new StringBuilder().append("ej.M(");
    ...
    final int a(int param0, int param1, int param2, int param3, int param4) {
        ...
        return this.a(param0, param3, param1, (byte) -126, true, param2);
    }
    ...
    ej(on param0) {
        ...
        try {
            ...
            this.b(-1);
            this.field_c = -1;
            this.field_b = new boolean[this.field_A.field_r][this.field_A.field_k];
            this.field_y = -1;
