...
final class tj extends rb {
    ...
    final int d(int param0) {
        return tj.a(((tj) this).field_O[0], param0);
    }

    tj(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((tj) this).field_D = new byte[256][];
        ((tj) this).field_D = param6;
        ((tj) this).field_O = new int[4][];
        ((tj) this).field_O[0] = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  tj.a(0, bi.field_c, ((tj) this).field_D[param0], ((tj) this).field_O[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  oi.a(bi.field_c, ((tj) this).field_D[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  tj.a(0, bi.field_c, ((tj) this).field_D[param0], ((tj) this).field_O[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  oi.a(bi.field_c, ((tj) this).field_D[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
