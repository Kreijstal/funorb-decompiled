          ...
          L0: {
            if (null == this.field_a) {
              L1: {
                ...
                if (null != this.field_k) {
                  stackIn_38_0 = this;
                  stackIn_38_1 = this.field_k.b(29);
                  break L1;
                } else {
                  stackIn_38_0 = this;
                  stackIn_38_1 = null;
            ...
            if (null != this.field_a) {
              ...
              L5: {
                ...
                if (this.field_k != null) {
                  stackIn_49_0 = this;
                  stackIn_49_1 = this.field_k.b(45);
                  break L5;
                } else {
                  stackIn_49_0 = this;
                  stackIn_49_1 = null;
              ...
              L7: {
                if (null != this.field_a) {
                  ...
                  L9: {
                    ...
                    if (this.field_k != null) {
                      stackIn_28_0 = this;
                      stackIn_28_1 = this.field_k.b(45);
                      break L9;
                    } else {
                      stackIn_28_0 = this;
                      stackIn_28_1 = null;
              ...
              L13: {
                if (null != this.field_a) {
                  ...
                  L15: {
                    ...
                    if (this.field_k != null) {
                      stackIn_14_0 = this;
                      stackIn_14_1 = this.field_k.b(45);
                      break L15;
                    } else {
                      stackIn_14_0 = this;
                      stackIn_14_1 = null;
    ...
    final void a(int param0, int param1, fa param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_7_1 = new StringBuilder().append("mj.B(").append(param0).append(',').append(param1).append(',');
