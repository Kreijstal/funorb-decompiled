        ...
        if (param2 > 0) {
            ...
            for (var5 = 0; var5 < param3; var5++) {
                for (var6 = 0; var6 < param2; var6++) {
                    ...
                    var4++;
                    field_c[var4] = (var11 << 16) + (var11 << 8) + var11;
                }
          ...
          if (var10 >= 0) {
            ...
            L5: while (true) {
              if (var14 >= 0) {
                ...
                var9++;
                field_c[var9] = var16 - var15 | var15 - (var15 >>> 8);
                var14++;
                continue L5;
              }
            }
