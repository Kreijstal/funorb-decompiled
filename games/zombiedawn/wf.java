...
final class wf extends hm {
    ...
    final boolean a(byte param0, ga param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackIn_6_1 = new StringBuilder().append("wf.B(").append(param0).append(',');
    ...
    final void a(int param0, int param1, int param2, int param3) {
        ...
        rh var6 = this.field_R.a((byte) -73);
        if (var6 == se.field_l) {
            var17 = no.field_E;
            ...
            if (var6 != se.field_l && gj.field_v != var6) {
                if (var6 == uc.field_b) {
                    var20 = dj.field_k[2];
        ...
        String var5 = this.field_R.b((byte) 78);
        if (var5 == null) {
            var27 = this.field_Q;
            var5 = var27;
        ...
        super.a(param0, param1, param2, param3);
        var6 = this.field_R.a((byte) -120);
        ak var42 = (ak) ((Object) this.field_h);
        var9 = this.field_k + param2;
        ...
        vn var38 = dj.field_k[0];
        var11 = var38.field_r << -1320692991;
        var12 = var38.field_q << 1842606081;
        if (this.field_O == null || var11 > this.field_O.field_w || var12 > this.field_O.field_t) {
            this.field_O = new vn(var11, var12);
            ki.a((byte) -118, this.field_O);
