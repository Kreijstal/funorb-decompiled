...
final class hj {
    ...
    final boolean b() {
        ...
        int var2 = ((hj) this).field_i.length;
        System.arraycopy((Object) (Object) ((hj) this).field_i, 0, (Object) (Object) field_c, 0, var2);
        int var3 = field_h[((hj) this).field_e - 1];
        int var4 = wm.a(var3 - 1, (byte) -109);
        field_l[0] = mb.d(var4);
        field_l[1] = mb.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((hj) this).field_d.length; var6++) {
            var7 = ((hj) this).field_d[var6];
            var8 = ((hj) this).field_k[var7];
            var9 = ((hj) this).field_a[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = mb.field_i[((hj) this).field_b[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((hj) this).field_f[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_l[incrementValue$0] = var13 >= 0 ? mb.field_i[var13].a() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((hj) this).field_i.length;
        var4 = field_h[((hj) this).field_e - 1];
        var5 = field_g;
        field_g[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_l[0] * ((hj) this).field_e;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_c[var16];
                  var10 = field_l[var16] * ((hj) this).field_e;
            ...
            L3: {
              var7 = hj.b(field_c, var6);
              var8_int = hj.a(field_c, var6);
              var9 = this.a(field_c[var7], field_l[var7], field_c[var8_int], field_l[var8_int], field_c[var6]);
              var10 = field_l[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    hj() {
        ...
        if (var1 == 1) {
          var2 = mb.d(5);
          var3 = 0;
          ((hj) this).field_d = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((hj) this).field_k = new int[var3];
              ((hj) this).field_a = new int[var3];
              ((hj) this).field_b = new int[var3];
              ((hj) this).field_f = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((hj) this).field_e = mb.d(2) + 1;
                  var4 = mb.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((hj) this).field_i = new int[var5];
                      ((hj) this).field_i[0] = 0;
                      ((hj) this).field_i[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((hj) this).field_k[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((hj) this).field_i[incrementValue$2] = mb.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((hj) this).field_k[((hj) this).field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((hj) this).field_k[var4] = mb.d(3) + 1;
                    int dupTemp$3 = mb.d(2);
                    ((hj) this).field_a[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((hj) this).field_b[var4] = mb.d(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
