...
final class hj {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_i, 0, field_c, 0, var2);
        int var3 = field_h[this.field_e - 1];
        ...
        for (var6 = 0; var6 < this.field_d.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = mb.field_i[this.field_b[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = this.field_f[var7][var11 & var10];
                var11 = var11 >>> var9;
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_c[var16];
                  var10 = field_l[var16] * this.field_e;
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_k[var7]) {
                              ...
                              var5++;
                              this.field_i[incrementValue$2] = mb.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
