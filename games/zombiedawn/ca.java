...
final class ca {
    ...
    final static void a(byte param0, String param1) {
        ...
        try {
            pa.a(param1, false);
            if (param0 != 2) {
                discarded$0 = ca.a(11, -83, 78, 21, -117, 67, 107, -114, 29);
            }
            ti.a(md.field_wb, false, false);
        } catch (RuntimeException runtimeException) {
            throw sh.a((Throwable) ((Object) runtimeException), "ca.A(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final static void a(byte param0, java.applet.Applet param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("ca.F(").append(param0).append(',');
    ...
    final static vn[] a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        var13 = 0;
        L0: while (true) {
          if ((var13 ^ -1) <= (var12_ref_vn__.length ^ -1)) {
            var12 = 0;
            L1: while (true) {
              if ((param2 ^ -1) >= (var12 ^ -1)) {
                var12 = 0;
                  ...
                  if ((param2 ^ -1) >= (var12 ^ -1)) {
                    ...
                    L3: while (true) {
                      if ((param6 ^ -1) >= (var12 ^ -1)) {
                        var12 = 0;
                        L4: while (true) {
                          if ((var12 ^ -1) <= (param6 >> -1969225855 ^ -1)) {
                            return var10;
                          } else {
                            var13 = 0;
                            L5: while (true) {
