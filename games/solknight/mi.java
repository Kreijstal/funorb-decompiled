...
final class mi {
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param1 + param3 > field_e) {
            param3 = field_e - param1;
        }
        int var5 = field_a - param2;
        int var6 = param0 + param1 * field_a;
        for (var7 = -param3; var7 < 0; var7++) {
            for (var8 = -param2; var8 < 0; var8++) {
                incrementValue$0 = var6;
                var6++;
                field_f[incrementValue$0] = param4;
            }
            var6 = var6 + var5;
        }
    }
    ...
    final static void g(int param0, int param1, int param2, int param3, int param4) {
        mi.b(param0, param1, param2, param4);
        mi.b(param0, param1 + param3 - 1, param2, param4);
        mi.h(param0, param1, param3, param4);
        mi.h(param0 + param2 - 1, param1, param3, param4);
    }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
                  ...
                  L4: {
                    ...
                    if (var6 < field_b) {
                      ...
                      if (var6 >= field_k) {
                        ...
                        field_f[var6 + param1 * field_a] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_l) {
                      ...
                      if (var6 >= field_e) {
                        ...
                        field_f[param0 + var6 * field_a] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                mi.h(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                mi.h(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              mi.b(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              mi.b(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
          ...
          if (var13 > var15) {
            ...
            L5: while (true) {
              if (var18 >= param8) {
                ...
                L7: {
                  var19 = param7 + (param4 - param3) * field_a;
                  if (var13 >= var18) {
                    break L7;
                  } else {
                    var19 = var19 + (var18 - var13) * field_a;
                    break L7;
                  }
                }
                L8: while (true) {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        int var6 = 256 - param5;
        int var7 = field_a - param2;
        int var8 = param0 + param1 * field_a;
        for (var9 = 0; var9 < param3; var9++) {
            for (var10 = -param2; var10 < 0; var10++) {
                ...
                var8++;
                field_f[incrementValue$0] = param4 + var11;
            }
            var8 = var8 + var7;
        }
    }
        ...
        if (param4 != 0) {
          ...
          L4: while (true) {
            if (var11 >= var7) {
              ...
              L7: {
                var19 = var17 + var11 * field_a;
                var20 = field_a + var17 - var18;
                ...
                if (var11 >= var21) {
                      ...
                      L10: while (true) {
                        ...
                        L14: while (true) {
                          if (var20 > var18) {
                            ...
                            var19++;
                            field_f[incrementValue$2] = param5;
                            var20++;
                            continue L14;
                          }
                        }
                  ...
                  L15: while (true) {
                    if (var22 >= var18) {
                      ...
                      var19++;
                      field_f[incrementValue$3] = param5;
                      var22++;
                      continue L15;
                    }
                  }
                    ...
                    if (var15 > var12) {
                      ...
                      L20: while (true) {
                        if (var20 >= var18) {
                          ...
                          var19++;
                          field_f[incrementValue$5] = param5;
                          var20++;
                          continue L20;
                        }
                      }
          ...
          mi.b(param0, param1, param2, param3, param5);
          return;
        }
    }
          ...
          if (var10 >= 0) {
            ...
            L5: while (true) {
              if (var14 >= 0) {
                ...
                var9++;
                field_f[incrementValue$0] = var13;
                var14++;
                continue L5;
              }
            }
    ...
    private final static void f(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param0 >= field_b) {
            ...
            var12 = param0 + param1 * field_a;
            for (var13 = 0; var13 < param2; var13++) {
                var9 = (field_f[var12] >> 16 & 255) * var5;
                var10 = (field_f[var12] >> 8 & 255) * var5;
                var11 = (field_f[var12] & 255) * var5;
    ...
    final static void a() {
        ...
        int incrementValue$8 = 0;
        int var0 = 0;
        int var1 = field_a * field_d - 7;
        while (var0 < var1) {
            incrementValue$0 = var0;
            var0++;
            field_f[incrementValue$0] = 0;
            incrementValue$1 = var0;
            var0++;
            field_f[incrementValue$1] = 0;
            incrementValue$2 = var0;
            var0++;
            field_f[incrementValue$2] = 0;
            incrementValue$3 = var0;
            var0++;
            field_f[incrementValue$3] = 0;
            incrementValue$4 = var0;
            var0++;
            field_f[incrementValue$4] = 0;
            incrementValue$5 = var0;
            var0++;
            field_f[incrementValue$5] = 0;
            incrementValue$6 = var0;
            var0++;
            field_f[incrementValue$6] = 0;
            incrementValue$7 = var0;
            var0++;
            field_f[incrementValue$7] = 0;
        }
        var1 += 7;
        while (var0 < var1) {
            incrementValue$8 = var0;
            var0++;
            field_f[incrementValue$8] = 0;
        }
    }
    ...
    private final static void c(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param1 >= field_l) {
            ...
            for (var13 = 0; var13 < param2; var13++) {
                ...
                var12++;
                field_f[incrementValue$0] = var14;
            }
            return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3) {
        ...
        int var4 = field_a - param2;
        int var5 = param0 + param1 * field_a;
        mi.a(var5, field_f, 0, param2, -param3, var4);
    }
                  ...
                  L6: while (true) {
                    ...
                    L10: while (true) {
                      if (var15 > var13) {
                        ...
                        var14++;
                        field_f[incrementValue$2] = param3;
                        var15++;
                        continue L10;
                      }
                    }
                    ...
                    if (var10 > var7) {
                      ...
                      L15: while (true) {
                        if (var15 >= var13) {
                          ...
                          incrementValue$4 = var14;
                          var14++;
                          field_f[incrementValue$4] = param3;
                          var15++;
                          continue L15;
                        }
                      }
    ...
    final static void a(int param0, int param1, int param2) {
        if (param0 >= field_b) {
            if (param1 < field_l || param0 >= field_k || param1 >= field_e) {
                return;
            }
            field_f[param0 + param1 * field_a] = param2;
            return;
        }
    }
    ...
    final static void c(int param0, int param1, int param2, int param3) {
        ...
        int var4 = param0 + param1 * field_a;
        if (param2 > 0) {
            if (param3 <= 0) {
                return;
            }
            for (var5 = 0; var5 < param3; var5++) {
                for (var6 = 0; var6 < param2; var6++) {
                    ...
                    var4++;
                    field_f[incrementValue$0] = (var11 << 16) + (var11 << 8) + var11;
                }
                var4 = var4 + (field_a - param2);
            }
            return;
        }
    }
          ...
          if (param4 != 0) {
            ...
            L4: while (true) {
              if (var13 >= var9) {
                ...
                L7: {
                  var21 = var19 + var13 * field_a;
                  var22 = field_a + var19 - var20;
                  ...
                  if (var13 >= var23) {
                        ...
                        L10: while (true) {
                          ...
                          L14: while (true) {
                            if (var22 > var20) {
                              ...
                              var21++;
                              field_f[incrementValue$2] = param5 + var23;
                              var22++;
                              continue L14;
                            }
                          }
                    ...
                    L15: while (true) {
                      if (var24 >= var20) {
                        ...
                        var21++;
                        field_f[incrementValue$3] = param5 + var25;
                        var24++;
                        continue L15;
                      }
                    }
                      ...
                      if (var17 > var14) {
                        ...
                        L20: while (true) {
                          if (var22 >= var20) {
                            ...
                            var21++;
                            field_f[incrementValue$5] = param5 + var23;
                            var22++;
                            continue L20;
                          }
                        }
            ...
            mi.a(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          mi.c(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param4 != 0) {
          if (param4 != 256) {
                    ...
                    L6: while (true) {
                      ...
                      L10: while (true) {
                        if (var23 > var21) {
                          ...
                          var9 = (field_f[var25] >> 16 & 255) * var5;
                          var10 = (field_f[var25] >> 8 & 255) * var5;
                          var11 = (field_f[var25] & 255) * var5;
                          var24 = (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8) + (var8 + var11 >> 8);
                          incrementValue$2 = var25;
                          var25++;
                          field_f[incrementValue$2] = var24;
                          var23++;
                          continue L10;
                        }
                      }
                      ...
                      if (var18 > var15) {
                        ...
                        L15: while (true) {
                          if (var23 >= var21) {
                            ...
                            var9 = (field_f[var22] >> 16 & 255) * var5;
                            var10 = (field_f[var22] >> 8 & 255) * var5;
                            var11 = (field_f[var22] & 255) * var5;
                            var24 = (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8) + (var8 + var11 >> 8);
                            incrementValue$4 = var22;
                            var22++;
                            field_f[incrementValue$4] = var24;
                            var23++;
                            continue L15;
                          }
                        }
            ...
            mi.e(param0, param1, param2, param3);
            return;
          }
        } else {
          return;
                        ...
                        if (param1 - param2 < field_e) {
                          L3: {
                            L4: {
                              var4 = param0 + param1 * field_a;
                              var5 = var4;
                              var6 = var4 - param2 * field_a;
                              var7 = var4 + param2 * field_a;
                              var8 = param2;
                              var9 = 0;
    ...
    private final static void a(int[] param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7) {
        ...
        L1: {
          var10 = field_a - param4 - param5 - param3;
          if (0 >= var10) {
            break L1;
          } else {
            var10 = 0;
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
                    ...
                    if (param0 >= field_k) {
                      ...
                      if (param1 + param3 < field_l) {
                        ...
                        if (param1 < field_e) {
                          L3: {
                            L4: {
                              var10 = var6 + (var7 - param4) * field_a;
                              var11 = var8 + (var7 - param4) * field_a;
                              var12 = var6 + var7 * field_a;
                              var13 = var8 + var7 * field_a;
                              var14 = var6 + var9 * field_a;
                              var15 = var8 + var9 * field_a;
                              var16 = var6 + (var9 + param4) * field_a;
                              var17 = var8 + (var9 + param4) * field_a;
                              var18 = param4;
                              var19 = 0;
                              var20 = param4 * param4;
                              var21 = var20 - var18;
                                                  ...
                                                  L8: while (true) {
                                                    if (var22 > var17) {
                                                      L9: while (true) {
                                                        ...
                                                        if (var18 >= var19) {
                                                          field_f[var10 - var19] = param5;
                                                          field_f[var11 + var19] = param5;
                                                          field_f[var12 - var18] = param5;
                                                          field_f[var13 + var18] = param5;
                                                          field_f[var14 - var18] = param5;
                                                          field_f[var15 + var18] = param5;
                                                          field_f[var16 - var19] = param5;
                                                          field_f[var17 + var19] = param5;
                                                          continue L9;
                                                        } else {
                                                          break L3;
                                                        }
                            ...
                            mi.h(param0, param1 + var18, param3 - var18 - var18, param5);
                            mi.h(param0 + param2 - 1, param1 + var18, param3 - var18 - var18, param5);
                            mi.b(param0 + var18, param1, param2 - var18 - var18, param5);
                            mi.b(param0 + var18, param1 + param3 - 1, param2 - var18 - var18, param5);
                            L11: while (true) {
                              L12: {
                                incrementValue$1 = var19;
                                var19++;
          ...
          mi.g(param0, param1, param2, param3, param5);
          return;
        }
    }
