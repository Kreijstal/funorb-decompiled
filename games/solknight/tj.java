...
final class tj {
    ...
    final void a(gb param0, vi param1) {
        ...
        L0: {
          var3 = param0.j(255);
          ((tj) this).field_e[0] = var3 >> 4;
          ((tj) this).field_e[1] = var3 & 15;
          if (var3 == 0) {
            var11 = ((tj) this).field_g;
            ((tj) this).field_g[1] = 0;
            var11[0] = 0;
            break L0;
          } else {
            ((tj) this).field_g[0] = param0.i(-121);
            ((tj) this).field_g[1] = param0.i(-124);
            var4 = param0.j(255);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                  ...
                  if (var5 >= 2) {
                    L3: {
                      if (var4 != 0) {
                        ...
                        if (((tj) this).field_g[1] == ((tj) this).field_g[0]) {
                          break L0;
                        } else {
                          break L3;
                        }
                    ...
                    var6 = var7;
                    L4: while (true) {
                      if (var7 >= ((tj) this).field_e[var5]) {
                        var5++;
                        continue L2;
                      } else {
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ((tj) this).field_d[var5][1][var7] = ((tj) this).field_d[var5][0][var7];
                          ((tj) this).field_h[var5][1][var7] = ((tj) this).field_h[var5][0][var7];
                          var7++;
                          continue L4;
                        } else {
                          ((tj) this).field_d[var5][1][var7] = param0.i(36);
                          ((tj) this).field_h[var5][1][var7] = param0.i(-103);
                          var7++;
                          continue L4;
                        }
                      }
                ...
                var6 = 0;
                L5: while (true) {
                  if (var6 >= ((tj) this).field_e[var5]) {
                    var5++;
                    continue L1;
                  } else {
                    ((tj) this).field_d[var5][0][var6] = param0.i(119);
                    ((tj) this).field_h[var5][0][var6] = param0.i(12);
                    var6++;
                    continue L5;
                  }
                }
    ...
    final int a(int param0, float param1) {
        ...
        L0: {
          if (param0 != 0) {
            ...
            var3 = (float)((tj) this).field_g[0] + (float)(((tj) this).field_g[1] - ((tj) this).field_g[0]) * param1;
        ...
        if (((tj) this).field_e[param0] != 0) {
          ...
          var4 = 1;
          L1: while (true) {
            if (var4 >= ((tj) this).field_e[param0]) {
              L2: {
                if (param0 != 0) {
                  break L2;
                } else {
              ...
              var4 = 0;
              L4: while (true) {
                if (var4 >= ((tj) this).field_e[param0] * 2) {
                  return ((tj) this).field_e[param0] * 2;
                } else {
    ...
    private final float a(int param0, int param1, float param2) {
        float var4 = (float)((tj) this).field_h[param0][0][param1] + param2 * (float)(((tj) this).field_h[param0][1][param1] - ((tj) this).field_h[param0][0][param1]);
    ...
    private final float b(int param0, int param1, float param2) {
        float var4 = (float)((tj) this).field_d[param0][0][param1] + param2 * (float)(((tj) this).field_d[param0][1][param1] - ((tj) this).field_d[param0][0][param1]);
        var4 = var4 * 0.0001220703125f;
        return tj.a(var4);
    }

    tj() {
        ((tj) this).field_e = new int[2];
        ((tj) this).field_d = new int[2][2][4];
        ((tj) this).field_g = new int[2];
        ((tj) this).field_h = new int[2][2][4];
    }
