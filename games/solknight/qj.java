    ...
    final static void a(int param0, byte[] param1, int[] param2, int param3, int param4) {
        ...
        try {
              ...
              if (var5_int >= fb.field_b.length) {
                ...
                L2: while (true) {
                  ...
                  if (incrementValue$12 == 0) {
                    ...
                    var6++;
                    param4 = he.field_a[incrementValue$13];
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("qj.A(").append(0).append(',');
          ...
          throw fc.a((Throwable) (Object) stackIn_14_0, stackIn_14_2 + ',' + param3 + ',' + param4 + ')');
        }
    }
