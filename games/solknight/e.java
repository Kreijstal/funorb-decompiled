...
final class e extends ej {
        ...
        L0: while (true) {
          if (this.field_o >= 0) {
            if (this.field_m + param2 >= this.field_o) {
              ...
              this.e();
              var5 = (ag) ((Object) this.field_n.a((byte) 51));
              var6 = var5;
              synchronized (var6) {
                L1: {
                  L2: {
    ...
    private final void d(int param0) {
        ej var2 = (ej) ((Object) this.field_l.a((byte) 51));
        while (var2 != null) {
            var2.a(param0);
            var2 = (ej) ((Object) this.field_l.b(-79));
        }
    }

    final synchronized void a(ej param0) {
        this.field_l.a(-3024, param0);
    }

    final ej a() {
        return (ej) ((Object) this.field_l.a((byte) 51));
    }

    private final void a(ag param0) {
        param0.c(10);
        param0.a();
        gg var2 = this.field_n.field_e.field_d;
        if (var2 == this.field_n.field_e) {
            this.field_o = -1;
        } else {
            this.field_o = ((ag) ((Object) var2)).field_h;
        }
    }
        ...
        L0: while (true) {
          if (this.field_o >= 0) {
            if (this.field_m + param0 >= this.field_o) {
              ...
              this.e();
              var3 = (ag) ((Object) this.field_n.a((byte) 51));
              var4 = var3;
              synchronized (var4) {
                L1: {
                  L2: {
    ...
    final ej b() {
        return (ej) ((Object) this.field_l.b(-51));
    }
    ...
    private final void e() {
        ag var1 = null;
        if (this.field_m > 0) {
            var1 = (ag) ((Object) this.field_n.a((byte) 51));
            while (var1 != null) {
                var1.field_h = var1.field_h - this.field_m;
                var1 = (ag) ((Object) this.field_n.b(-31));
            }
        ...
        L0: while (true) {
          if (param0 != this.field_n.field_e) {
            if (((ag) ((Object) param0)).field_h <= param1.field_h) {
              ...
              ha.a(param1, (byte) 93, param0);
              this.field_o = ((ag) ((Object) this.field_n.field_e.field_d)).field_h;
              return;
            }
          } else {
            ha.a(param1, (byte) 93, param0);
    ...
    private final void c(int[] param0, int param1, int param2) {
        ej var4 = (ej) ((Object) this.field_l.a((byte) 51));
        while (var4 != null) {
            var4.b(param0, param1, param2);
            var4 = (ej) ((Object) this.field_l.b(-27));
        }
    }
