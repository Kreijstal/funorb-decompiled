    ...
    final static String a(int param0, int param1, int param2, CharSequence[] param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackIn_30_1 = new StringBuilder().append("la.F(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
