    ...
    private final void a(String param0, int param1, int param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_ph.field_l;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                ...
                var2++;
                ((mg) this).field_C[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = k.a(field_G, 0, ' ', 0);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
