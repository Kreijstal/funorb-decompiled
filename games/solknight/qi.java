...
final class qi extends ej {
    ...
    private final static int a(int param0, byte[] param1, int[] param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, qi param12) {
        ...
        param12.field_v = param12.field_v + param12.field_m * (param9 - param4);
        param4 = param4 << 1;
        param9 = param9 << 1;
        param9 -= 6;
        while (param4 < param9) {
    ...
    private final static int c(int param0, int param1, byte[] param2, int[] param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, qi param11, int param12, int param13) {
        ...
        L0: {
          L1: {
            ...
            param11.field_o = param11.field_o - param11.field_r * param5;
            if (param12 == 0) {
              break L1;
            } else {
    ...
    final int d() {
        if (this.field_y == 0 && this.field_p == 0) {
            return 0;
        }
        return 1;
    }
    ...
    private final static int b(byte[] param0, int[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, qi param9) {
        ...
        param9.field_t = param9.field_t + param9.field_w * (param6 - param3);
        param9.field_o = param9.field_o + param9.field_r * (param6 - param3);
        param6 -= 3;
        while (param3 < param6) {
            incrementValue$0 = param3;
            param3++;
    ...
    final static qi a(sh param0, int param1, int param2, int param3) {
        if (param0.field_i != null) {
          if (param0.field_i.length == 0) {
            return null;
          } else {
            return new qi(param0, param1, param2, param3);
          }
        } else {
          return null;
        }
