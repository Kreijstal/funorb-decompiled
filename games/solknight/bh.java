...
final class bh {
    ...
    final void a(float[] param0, int param1, boolean param2) {
        ...
        L0: while (true) {
          if (var4 >= param1) {
            if (!param2) {
              var4 = sl.field_h[this.field_c].field_e;
              var5 = this.field_b - this.field_e;
                    ...
                    if (var9 >= var6) {
                      ...
                      L3: {
                        if (var8 != 0) {
                          ...
                          var10 = sl.field_h[this.field_c].b();
                          var11 = var4 - 1;
                          L4: while (true) {
                            if (var11 < 0) {
                              break L3;
                        ...
                        if (var10 >= var4) {
                          ...
                          L7: {
                            ...
                            if (var12 < 0) {
                              ...
                              var13 = this.field_e + var9 * this.field_d;
                              ...
                              if (this.field_a != 0) {
                                ...
                                var15 = this.field_d / var14.field_e;
                                var16 = 0;
                                L10: while (true) {
                                  if (var16 >= var15) {
                                    break L7;
    ...
    bh() {
        ...
        int var5 = 0;
        int var2 = 0;
        this.field_a = sl.d(16);
        this.field_e = sl.d(24);
        this.field_b = sl.d(24);
        this.field_d = sl.d(24) + 1;
        this.field_f = sl.d(6) + 1;
        this.field_c = sl.d(8);
        ...
        this.field_g = new int[this.field_f * 8];
        int var6 = 0;
        var2 = var6;
        while (var6 < this.field_f * 8) {
            this.field_g[var6] = (var1[var6 >> 3] & 1 << (var6 & 7)) != 0 ? sl.d(8) : -1;
            var6++;
        }
    }
}
