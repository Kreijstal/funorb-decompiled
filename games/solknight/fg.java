    ...
    final static void a(int param0, int param1, int param2, int param3, o[] param4, byte param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("fg.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
          ...
          throw fc.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + ',' + 104 + ')');
        }
    }
