 ...
 */
final class tf implements pa {
    private com.ms.directX.DSCursors[] field_b;
    private com.ms.directX.DSBufferDesc[] field_a;

    public tf() throws Exception {
        int var1 = 0;
        ((tf) this).field_b = new com.ms.directX.DSCursors[2];
        ((tf) this).field_a = new com.ms.directX.DSBufferDesc[2];
        ...
        for (var1 = 0; -3 < (var1 ^ -1); var1++) {
            ((tf) this).field_a[var1] = new com.ms.directX.DSBufferDesc();
        }
        for (var1 = 0; 2 > var1; var1++) {
            ((tf) this).field_b[var1] = new com.ms.directX.DSCursors();
        }
    }
}
