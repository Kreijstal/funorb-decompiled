...
final class tc {
          ...
          L0: while (true) {
            if (var7 > param1) {
              ...
              if (var8 < var4) {
                ...
                field_l[var3] = field_l[var7];
                var3++;
                field_a[var7] = field_a[var3];
                field_k[var7] = field_k[var3];
                field_l[var7] = field_l[var3];
                var7++;
                continue L0;
              } else {
                var7++;
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((tc) this).field_i.length;
        var4 = field_h[((tc) this).field_b - 1];
        var5 = field_l;
        field_l[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_k[0] * ((tc) this).field_b;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_l[var16]) {
                  var9 = field_a[var16];
                  var10 = field_k[var16] * ((tc) this).field_b;
            ...
            L3: {
              var7 = tc.b(field_a, var6);
              var8_int = tc.a(field_a, var6);
              var9 = this.a(field_a[var7], field_k[var7], field_a[var8_int], field_k[var8_int], field_a[var6]);
              var10 = field_k[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
            ...
            if (var10 == 0) {
              ...
              var14 = field_l;
              var15 = var7;
              field_l[var8_int] = true;
              var14[var15] = true;
              field_l[var6] = true;
              if (var10 < var13) {
                L4: {
                  stackOut_11_0 = (int[]) field_k;
                  stackOut_11_1 = var6;
    ...
    final boolean b() {
        ...
        int var2 = ((tc) this).field_i.length;
        System.arraycopy((Object) (Object) ((tc) this).field_i, 0, (Object) (Object) field_a, 0, var2);
        int var3 = field_h[((tc) this).field_b - 1];
        int var4 = wi.b(113, var3 - 1);
        field_k[0] = sl.d(var4);
        field_k[1] = sl.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((tc) this).field_e.length; var6++) {
            var7 = ((tc) this).field_e[var6];
            var8 = ((tc) this).field_j[var7];
            var9 = ((tc) this).field_g[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = sl.field_h[((tc) this).field_c[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((tc) this).field_d[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_k[incrementValue$0] = var13 >= 0 ? sl.field_h[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    tc() {
        ...
        if (var1 == 1) {
          var2 = sl.d(5);
          var3 = 0;
          ((tc) this).field_e = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((tc) this).field_j = new int[var3];
              ((tc) this).field_g = new int[var3];
              ((tc) this).field_c = new int[var3];
              ((tc) this).field_d = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((tc) this).field_b = sl.d(2) + 1;
                  var4 = sl.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((tc) this).field_i = new int[var5];
                      ((tc) this).field_i[0] = 0;
                      ((tc) this).field_i[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((tc) this).field_j[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((tc) this).field_i[incrementValue$2] = sl.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((tc) this).field_j[((tc) this).field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((tc) this).field_j[var4] = sl.d(3) + 1;
                    int dupTemp$3 = sl.d(2);
                    ((tc) this).field_g[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((tc) this).field_c[var4] = sl.d(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
