...
final class tc {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_l[var16]) {
                  var9 = field_a[var16];
                  var10 = field_k[var16] * this.field_b;
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_i, 0, field_a, 0, var2);
        int var3 = field_h[this.field_b - 1];
        int var4 = wi.b(113, var3 - 1);
        field_k[0] = sl.d(var4);
        field_k[1] = sl.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < this.field_e.length; var6++) {
            var7 = this.field_e[var6];
            var8 = this.field_j[var7];
            var9 = this.field_g[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = sl.field_h[this.field_c[var7]].b();
            }
            ...
            if (var4 >= var2) {
              ...
              L1: while (true) {
                if (var4 >= var3) {
                    ...
                    if (var6 >= var2) {
                      ...
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= this.field_j[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              incrementValue$2 = var5;
                              var5++;
                              this.field_i[incrementValue$2] = sl.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_j[this.field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    this.field_j[var4] = sl.d(3) + 1;
                    dupTemp$3 = sl.d(2);
                    this.field_g[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      this.field_c[var4] = sl.d(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
