    ...
    final static void a(byte param0, hf param1) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_21_1 = new StringBuilder().append("al.C(").append(param0).append(',');
