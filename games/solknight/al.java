...
final class al extends gg {
    ...
    final static void a(byte param0, hf param1) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_19_1 = new StringBuilder().append("al.C(").append(param0).append(44);
    ...
    final void a(int param0, int param1, int param2, byte param3, int[] param4, int param5, int param6, int param7) {
        try {
            ...
            throw fc.a((Throwable) (Object) runtimeException, "al.A(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + param5 + 44 + param6 + 44 + param7 + 41);
        }
    }
