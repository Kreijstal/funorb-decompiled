    ...
    final static void a(da param0) {
        ...
        L98: {
          if (!dh.field_l) {
            ...
            SolKnight.field_L = stackIn_255_0 != 0;
            break L98;
          }
        }
    }
    ...
    final static int a(int param0, CharSequence param1, int param2, int param3, byte[] param4, int param5) {
        ...
        try {
          ...
          L36: {
            ...
            stackOut_192_1 = ((StringBuilder) (Object) stackIn_192_1).append(stackIn_192_2).append(',').append(param2).append(',').append(352).append(',');
