...
abstract class si extends rc implements oh {
    ...
    final void a(Hashtable param0, StringBuilder param1, int param2, int param3) {
        ...
        try {
                ...
                if (var5_int > param2) {
                  L2: {
                    if (null == ((si) this).field_G) {
                      StringBuilder discarded$21 = param1.append("null");
                      break L2;
                    } else {
                      StringBuilder discarded$22 = ((si) this).field_G.a(-62, param0, param1, 1 + param2);
                      break L2;
                    }
                  }
                  break L0;
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("si.T(");
    ...
    final static int a(mb param0, mb param1, int param2) {
        ...
        try {
          L0: {
            L1: {
              if (param2 < -75) {
                ...
                var4 = null;
                int discarded$2 = si.a((mb) null, (mb) null, -96);
                break L1;
              }
            }
            var5 = null;
            stackOut_2_0 = vb.a(0, 0, false, (String) null, param0, param1, -21760);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("si.R(");
        ...
        try {
          L0: {
            if (param2) {
              ...
              stackOut_3_0 = cd.a(param4, var6, var5_int, true, param0);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("si.U(");
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
            stackIn_6_0 = stackOut_5_0;
    ...
    final static void a(int param0, byte param1, int param2, int param3, gb param4) {
        try {
            ...
            throw fc.a((Throwable) (Object) runtimeException, "si.CA(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 41);
        }
    }
          ...
          L0: {
            L1: {
              if (((si) this).field_G == null) {
                ...
                ((si) this).field_G.a(param0, param1, param2, param3 - -((si) this).field_j, param4, ((si) this).field_m + param5);
                break L1;
              }
            }
            L2: {
              if (param1 == 0) {
                ...
                var8 = null;
                boolean discarded$2 = this.b(-57, (rc) null);
                break L2;
              }
            }
            break L0;
    ...
    private final boolean a(rc param0, int param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("si.P(");
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
