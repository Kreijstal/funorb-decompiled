    ...
    final static void a(byte param0, boolean param1, boolean param2) {
        ...
        if (param1) {
          ...
          if (param0 < -28) {
            ...
            var4 = (String) null;
            discarded$3 = nh.a((da) null, (String) null, 2, (String) null);
            uf.a(false, param1);
            return;
          }
        } else {
          ...
          if (!SolKnight.field_L) {
            if (param0 >= -28) {
              var4 = (String) null;
              discarded$4 = nh.a((da) null, (String) null, 2, (String) null);
              uf.a(false, param1);
              return;
            } else {
              uf.a(false, param1);
            ...
            if (param0 < -28) {
              ...
              var4 = (String) null;
              discarded$5 = nh.a((da) null, (String) null, 2, (String) null);
              uf.a(false, param1);
              return;
            }
          }
    ...
    final static o[] a(da param0, String param1, int param2, String param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = de.a(var4_int, var5, -17042, param0);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("nh.B(");
