...
final class vb {
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var6 = 0; var6 < 4; var6++) {
            var5 = 128 - (var6 << 5);
            vb.b(param0 + var6, param1 + param3 + var6, param2, 5592405, var5);
            vb.c(param0 + param2 + var6, param1 + var6, param3 + 1, 5592405, var5);
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
          ...
          L1: {
            var6 = param0 + param4;
            var7 = param1 + param4;
            var8 = param0 + 28 - param4 - 1;
            var9 = param1 + 28 - param4 - 1;
            if (field_k <= field_e) {
              break L1;
            } else {
              if (field_d > field_i) {
                if (param0 + 28 <= field_e) {
                  break L1;
                } else {
                  L2: {
                    if (param0 >= field_k) {
                          ...
                          L3: {
                            L4: {
                              ...
                              if (param0 < field_e) {
                                ...
                                if (param0 + 28 >= field_k) {
                                  break L4;
                                } else {
                                  if (param1 < field_i) {
                                    break L4;
                                  } else {
                                    if (param1 + 28 < field_d) {
                                      var22 = var12;
                                      L5: while (true) {
                                        if (var22 > var14) {
                                          var22 = var13;
                                                  ...
                                                  L8: while (true) {
                                                    if (var22 > var17) {
                                                      L9: while (true) {
                                                        ...
                                                        if (var18 >= var19) {
                                                          field_c[var10 - var19] = 16777215;
                                                          field_c[var11 + var19] = 16777215;
                                                          field_c[var12 - var18] = 16777215;
                                                          field_c[var13 + var18] = 16777215;
                                                          field_c[var14 - var18] = 16777215;
                                                          field_c[var15 + var18] = 16777215;
                                                          field_c[var16 - var19] = 16777215;
                                                          field_c[var17 + var19] = 16777215;
                                                          continue L9;
                                                        } else {
                                                          break L3;
                                                        }
                            ...
                            vb.g(param0, param1 + var18, 28 - var18 - var18, 16777215);
                            vb.g(param0 + 27, param1 + var18, 28 - var18 - var18, 16777215);
                            vb.c(param0 + var18, param1, 28 - var18 - var18, 16777215);
                            vb.c(param0 + var18, param1 + 27, 28 - var18 - var18, 16777215);
                            L11: while (true) {
                              L12: {
          ...
          vb.d(param0, param1, 28, 28, 16777215);
          return;
        }
    }
              ...
              if (var19 >= var12) {
                ...
                L6: while (true) {
                  if (var19 >= var9) {
                    ...
                    L18: {
                      var18++;
                      if (param5 + var19 + param3 >= field_k) {
                        break L18;
                      } else {
                        param1 = param0[var17];
                        var17++;
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4, int param5) {
        vb.a(field_c, 0, 0 * field_f, param0, 0, param4, field_f - param4, param5);
        vb.a(field_c, 0, 0 * field_f, param1, 0, param5, field_f - param4, 0, param4);
    }
    ...
    final static void c(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
          ...
          vb.a(param0, param1, 32, 32, param5);
          return;
        }
    }
              ...
              if (var18 >= param8) {
                ...
                L8: while (true) {
                  if (var13 >= var18) {
                    ...
                    L26: {
                      if (var13 + param5 + param3 >= field_d) {
                        var14 = var14 + field_f;
                        break L26;
                      } else {
                        var20 = 0;
