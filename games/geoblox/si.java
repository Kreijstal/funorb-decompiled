...
final class si {
    ...
    final void a(rd param0, int param1, int param2, el param3, int param4) {
        ...
        try {
          L0: {
            L1: {
              ma.a(param3.field_m + param2, param1 - -param3.field_v, param3.field_h, (byte) -92, param3.field_r, ((si) this).field_a);
              if (((si) this).field_l == null) {
                break L1;
              } else {
                L2: {
                  var6_int = ((si) this).field_b + (param3.field_v + param1);
                  var7 = ((si) this).field_f + param2 + param3.field_m;
                  if (param0.field_g != 1) {
                    break L2;
                  } else {
                    var6_int = var6_int + (-((si) this).field_l.field_s + param3.field_r) / 2;
                    break L2;
                  }
                }
                L3: {
                  if (2 != param0.field_g) {
                    ...
                    var6_int = var6_int + (-((si) this).field_l.field_s + param3.field_r);
                    break L3;
                  }
                }
                L4: {
                  if (param0.field_i == 1) {
                    var7 = var7 + (param3.field_h - ((si) this).field_l.field_o) / 2;
                    break L4;
                  } else {
                    break L4;
                  }
                ...
                L5: {
                  if (2 == param0.field_i) {
                    var7 = var7 + (-((si) this).field_l.field_o + param3.field_h);
                    break L5;
                  } else {
                    break L5;
                  }
                }
                ((si) this).field_l.b(var6_int, var7);
                break L1;
              }
            }
            L6: {
                ...
                if (null == param0.field_n) {
                  ...
                  if (((si) this).field_e >= 0) {
                    ...
                    L10: {
                      ...
                      stackOut_24_6 = ((si) this).field_e;
                      stackOut_24_7 = ((si) this).field_d;
                    ...
                    int discarded$1 = ((m) (Object) stackIn_27_0).a(stackIn_27_1, stackIn_27_2, stackIn_27_3, stackIn_27_4, stackIn_27_5, stackIn_27_6, stackIn_27_7, stackIn_27_8, param0.field_g, param0.field_i, param0.field_f);
                    break L7;
                  } else {
                    return;
                  }
          ...
          throw t.a((Throwable) (Object) stackIn_35_0, stackIn_35_2 + 44 + param4 + 41);
        }
    }

    final si a(byte param0, int param1) {
        ((si) this).field_d = param1;
        if (param0 != 16) {
            return null;
        }
        return (si) this;
    ...
    final void a(int param0, int param1, si param2, rd param3, int param4, el param5) {
        ...
        try {
            ...
            if (param4 == -16566) {
              L2: {
                if (((si) this).field_f == -2147483648) {
                  ...
                  param2.field_f = ((si) this).field_f;
                  break L2;
                }
              }
              L3: {
                if (((si) this).field_d < -1) {
                  break L3;
                } else {
                  param2.field_d = ((si) this).field_d;
                  break L3;
                }
              }
              L4: {
                if (((si) this).field_k != -2147483648) {
                  param2.field_k = ((si) this).field_k;
                  break L4;
                } else {
                  break L4;
                }
              ...
              L5: {
                if (null == ((si) this).field_a) {
                  break L5;
                } else {
                  param2.field_a = ((si) this).field_a;
                  break L5;
                }
              }
              L6: {
                if (null == ((si) this).field_l) {
                  ...
                  param2.field_l = ((si) this).field_l;
                  break L6;
                }
              }
              L7: {
                if (((si) this).field_e < -1) {
                  break L7;
                } else {
                  param2.field_e = ((si) this).field_e;
                  break L7;
                }
              }
              if (((si) this).field_b == -2147483648) {
                ...
                param2.field_b = ((si) this).field_b;
                return;
              }
            } else {
              return;
          ...
          L8: {
            ...
            stackOut_21_1 = new StringBuilder().append("si.F(").append(param0).append(44).append(param1).append(44);
            stackIn_23_0 = stackOut_21_0;
            stackIn_23_1 = stackOut_21_1;
            stackIn_22_0 = stackOut_21_0;
            stackIn_22_1 = stackOut_21_1;
    ...
    final void a(int param0, si param1) {
        try {
            param1.field_e = ((si) this).field_e;
            if (param0 != 2) {
                Object var4 = null;
                si discarded$0 = ((si) this).a((dm[]) null, true);
            }
            param1.field_k = ((si) this).field_k;
            param1.field_b = ((si) this).field_b;
            param1.field_a = ((si) this).field_a;
            param1.field_l = ((si) this).field_l;
            param1.field_h = ((si) this).field_h;
            param1.field_f = ((si) this).field_f;
            param1.field_d = ((si) this).field_d;
        } catch (RuntimeException runtimeException) {
            throw t.a((Throwable) (Object) runtimeException, "si.G(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
          ...
          L0: {
            L1: {
              if (param1) {
                ...
                si discarded$2 = ((si) this).a((byte) 66, -18);
                break L1;
              }
            }
    ...
    si() {
        ...
        ((si) this).field_h = false;
        ((si) this).field_e = -2;
        ((si) this).field_f = -2147483648;
        ((si) this).field_l = null;
        ((si) this).field_b = -2147483648;
    }
