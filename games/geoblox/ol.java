...
final class ol extends hk {
    ...
    final static void a(int param0, p param1, int param2) {
        ...
        try {
            ...
            throw t.a((Throwable) (Object) runtimeException, "ol.A(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + 30175 + 41);
        }
    }
    ...
    final static int a(boolean param0, CharSequence param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ol.G(").append(param0).append(44);
