...
final class u {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((u) this).field_c.length;
        var4 = field_b[((u) this).field_d - 1];
        var5 = field_e;
        field_e[1] = true;
        var5[0] = true;
        var6 = 2;
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_e[var16]) {
                  var9 = field_a[var16];
                  var10 = field_g[var16] * ((u) this).field_d;
    ...
    final boolean b() {
        ...
        int var2 = ((u) this).field_c.length;
        System.arraycopy((Object) (Object) ((u) this).field_c, 0, (Object) (Object) field_a, 0, var2);
        int var3 = field_b[((u) this).field_d - 1];
        int var4 = hj.a((byte) 58, var3 - 1);
        field_g[0] = ua.b(var4);
        field_g[1] = ua.b(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((u) this).field_l.length; var6++) {
            var7 = ((u) this).field_l[var6];
            var8 = ((u) this).field_i[var7];
            var9 = ((u) this).field_h[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ua.field_u[((u) this).field_f[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((u) this).field_j[var7][var11 & var10];
                var11 = var11 >>> var9;
                var5++;
                field_g[var5] = var13 >= 0 ? ua.field_u[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    u() {
        ...
        if (var1 == 1) {
          var2 = ua.b(5);
          var3 = 0;
          ((u) this).field_l = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((u) this).field_i = new int[var3];
              ((u) this).field_h = new int[var3];
              ((u) this).field_f = new int[var3];
              ((u) this).field_j = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((u) this).field_d = ua.b(2) + 1;
                  var4 = ua.b(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((u) this).field_c = new int[var5];
                      ((u) this).field_c[0] = 0;
                      ((u) this).field_c[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((u) this).field_i[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              var5++;
                              ((u) this).field_c[var5] = ua.b(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((u) this).field_i[((u) this).field_l[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((u) this).field_i[var4] = ua.b(3) + 1;
                    ((u) this).field_h[var4] = ua.b(2);
                    var5 = ua.b(2);
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((u) this).field_f[var4] = ua.b(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
