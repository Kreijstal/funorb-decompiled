...
final class c extends ka {
          ...
          L1: {
            L2: {
              L3: {
                ...
                var3 = t.field_i[this.field_K][param0];
                if ((var3 ^ -1) != -9) {
                  break L3;
                } else {
                  if (var4 == 0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    ...
                    var2 = -ee.field_A.field_s + this.field_W;
                    statePc = 3;
                    continue stateLoop;
                }
                case 3: {
                ...
                case 4: {
                    stackIn_13_0 = ee.field_A.field_o + this.field_O + 480;
                ...
                case 12: {
                    ...
                    stackIn_13_0 = this.field_u + (vc.field_j.field_s + 640);
                    statePc = 13;
                    continue stateLoop;
                }
                case 13: {
    ...
    private final void b(int param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 18: {
                    var16 = ca.field_f.field_h[da.field_c];
                    var13 = var16;
                    var11 = var13;
                    var5 = var11;
                ...
                case 21: {
                    if (stackIn_21_0 != var3_ref_String__[var8_int]) {
                        statePc = 23;
                    } else {
                        statePc = 29;
                    }
                ...
                case 25: {
                    if (var16[var8_int] != Math.abs(el.field_o.field_o)) {
                        statePc = 28;
                    } else {
                        statePc = 26;
                    }
                ...
                case 27: {
                    ...
                    var4.c(Integer.toString(var16[var8_int]), 500, var6, 16610816, -1);
                    if (var10 == 0) {
                        statePc = 29;
                    } else {
                        statePc = 28;
                ...
                case 28: {
                    ...
                    var4.c(Integer.toString(var16[var8_int]), 500, var6, 1, -1);
                    statePc = 29;
                    continue stateLoop;
                }
                case 29: {
                ...
                case 46: {
                    var15 = ue.field_b;
                    fi.field_d.a(var15, 140, 325, 360, 300, 0, -1, 1, 0, 16);
                    statePc = 47;
                    continue stateLoop;
                }
                case 47: {
    ...
    final void a(int param0, int param1, boolean param2, int param3, boolean param4, int param5) {
        ...
        L1: {
          L2: {
            L3: {
              var7 = t.field_i[this.field_K][param0];
              var8 = var7;
              if ((var8 ^ -1) == -9) {
                L4: {
                  L5: {
    ...
    c(Geoblox param0, int param1) {
        ...
        try {
            ...
            throw t.a((Throwable) ((Object) runtimeException), "c.<init>(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ')');
        }
    }
            ...
            if (var3 != 0) {
              ...
              if (ca.field_f == null) {
                ...
                if (ca.field_f.field_j) {
                  ...
                  pg.a(param1 ^ -9410);
                  el.field_o = new gh(this.field_p, var3 != 0);
                  le.a((byte) -39);
                  ai.field_p = -1;
                  break L1;
                }
    ...
    final void a(byte param0, int param1) {
        ...
        L0: {
          L1: {
            var4 = Geoblox.field_C;
            var3 = t.field_i[this.field_K][param1];
            if (var3 == 8) {
              L2: {
                if (j.field_gb < 70) {
                  break L2;
                            ...
                            if (this.field_K == 4) {
                              ...
                              L17: {
                                ...
                                if (!param0) {
                                  ...
                                  stackIn_54_0 = stackIn_53_0;
                                  stackIn_54_1 = stackIn_53_1;
                                  stackIn_54_2 = this.field_T;
                                  break L17;
                                }
                              }
                              ma.a(stackIn_54_0, stackIn_54_1 + stackIn_54_2, 36, (byte) -92, var11 + 20, eb.field_g);
                              if (var14 == 0) {
                                break L12;
                              } else {
                                break L15;
          ...
          L33: {
            L34: {
              ...
              L36: {
                ...
                if (var6 == 8) {
                  stackIn_95_0 = j.field_gb;
                  break L36;
                } else {
                  stackIn_95_0 = oc.field_c;
                  break L36;
                }
              }
              var13 = stackIn_95_0;
