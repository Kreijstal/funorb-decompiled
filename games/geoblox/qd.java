...
final class qd extends m {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  qd.a(vb.field_c, ((qd) this).field_K[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  bg.a(vb.field_c, ((qd) this).field_K[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  qd.a(vb.field_c, ((qd) this).field_K[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  bg.a(vb.field_c, ((qd) this).field_K[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
    ...
    qd(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        ...
        ((qd) this).field_K = new byte[256][];
        ((qd) this).field_K = qd.a(param5, param6);
    }
