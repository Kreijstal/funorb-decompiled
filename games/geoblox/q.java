...
abstract class q extends ib implements ga {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, d param5, String param6, int param7, int param8) {
        try {
            ...
            throw t.a((Throwable) (Object) runtimeException, "q.N(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + -23949 + ',' + (param5 != null ? "{...}" : "null") + ',' + (param6 != null ? "{...}" : "null") + ',' + param7 + ',' + param8 + ')');
        }
    }
    ...
    final static void a(byte param0, int param1, String param2) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_25_1 = new StringBuilder().append("q.O(").append(124).append(',').append(param1).append(',');
