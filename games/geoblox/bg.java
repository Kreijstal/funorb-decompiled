...
final class bg extends m {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (vb.field_a == null) {
                  bg.a(vb.field_c, ((bg) this).field_K[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  bg.a(vb.field_c, ((bg) this).field_K[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, vb.field_a, vb.field_l);
                  break L5;
                }
              }
              return;
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  vb.field_c[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              bg.a(vb.field_c, ((bg) this).field_K[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    bg(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        ...
        ((bg) this).field_K = new byte[256][];
        ((bg) this).field_K = param5;
    }
