...
class f extends qf implements pl {
    ...
    public void a(int param0, byte param1, int param2, int param3, hk param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("f.Q(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
    ...
    final static void b(String param0, String param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("f.HA(");
          ...
          throw t.a((Throwable) (Object) stackIn_10_0, stackIn_10_2 + 44 + 7697781 + 41);
        }
    }
    ...
    f(ng param0, m param1, String param2, boolean param3, boolean param4) {
        ...
        try {
            ...
            throw t.a((Throwable) (Object) runtimeException, "f.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    final boolean a(int param0, int param1, char param2, el param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("f.I(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
    ...
    final static void o(int param0) {
        ...
        if (0 > fieldTemp$39) {
          L0: {
            ...
            if (~uf.field_b == ~ka.field_h) {
              ...
              if (1 == jk.field_d) {
                ...
                var1 = (float)(50 - jf.field_j) * 0.0066999997943639755f;
                int fieldTemp$48 = wa.field_a;
                wa.field_a = wa.field_a - 1;
                if (fieldTemp$48 <= 0) {
                  int fieldTemp$49 = jf.field_j;
                  jf.field_j = jf.field_j - 1;
                  if (fieldTemp$49 <= 0) {
                    return;
                  } else {
          ...
          if (el.field_o.field_x) {
              ...
              if (gi.field_e % 18 == 0) {
                if (gg.field_b == 0) {
                  if (!pf.field_D) {
                    ...
                    g.field_j = g.field_j + 1;
                    var1 = (float)(50 - jf.field_j) * 0.0066999997943639755f;
                    int fieldTemp$51 = wa.field_a;
                    wa.field_a = wa.field_a - 1;
                    if (fieldTemp$51 <= 0) {
                      int fieldTemp$52 = jf.field_j;
                      jf.field_j = jf.field_j - 1;
                      if (fieldTemp$52 <= 0) {
                        return;
                      } else {
                    ...
                    g.field_j = g.field_j + 1;
                    var1 = (float)(50 - jf.field_j) * 0.0066999997943639755f;
                    int fieldTemp$54 = wa.field_a;
                    wa.field_a = wa.field_a - 1;
                    if (fieldTemp$54 <= 0) {
                      int fieldTemp$55 = jf.field_j;
                      jf.field_j = jf.field_j - 1;
                      if (fieldTemp$55 <= 0) {
                        return;
                      } else {
            ...
            var1 = (float)(50 - jf.field_j) * 0.0066999997943639755f;
            int fieldTemp$61 = wa.field_a;
            wa.field_a = wa.field_a - 1;
            if (fieldTemp$61 <= 0) {
              int fieldTemp$62 = jf.field_j;
              jf.field_j = jf.field_j - 1;
              if (fieldTemp$62 <= 0) {
                return;
              } else {
            ...
            var1 = (float)(50 - jf.field_j) * 0.0066999997943639755f;
            int fieldTemp$64 = wa.field_a;
            wa.field_a = wa.field_a - 1;
            if (fieldTemp$64 <= 0) {
              int fieldTemp$65 = jf.field_j;
              jf.field_j = jf.field_j - 1;
              if (fieldTemp$65 <= 0) {
                return;
              } else {
          ...
          var1 = (float)(50 - jf.field_j) * 0.0066999997943639755f;
          int fieldTemp$75 = wa.field_a;
          wa.field_a = wa.field_a - 1;
          if (fieldTemp$75 <= 0) {
            int fieldTemp$76 = jf.field_j;
            jf.field_j = jf.field_j - 1;
            if (fieldTemp$76 <= 0) {
              return;
            } else {
    ...
    final void a(int param0, int param1, String param2) {
        ...
        try {
                ...
                L2: {
                  ...
                  if (param0 == 5) {
                    ...
                    if (param0 != 256) {
                      ...
                      hk discarded$2 = var6.a(-2, a.field_b, (bb) this);
                      break L2;
                    }
                  }
                }
                  ...
                  if (param0 == 3) {
                    ...
                    if (param0 != 4) {
                      if (param0 == 6) {
                        ...
                        if (param0 == 9) {
                          hk discarded$3 = var6.a(-2, fi.field_h, (bb) this);
                          break L4;
                        } else {
          ...
          L5: {
            ...
            stackOut_28_1 = new StringBuilder().append("f.KA(").append(param0).append(44).append(param1).append(44);
    ...
    final static boolean b(byte param0, CharSequence param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("f.JA(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
