    ...
    final static h a(byte param0, String param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("bf.A(").append(param0).append(',');
    ...
    final void a(int param0, java.awt.Graphics param1, int param2, int param3) {
        ...
        try {
            if (param3 != 0) {
                ...
                discarded$0 = this.imageUpdate((java.awt.Image) null, 94, -33, 114, 59, 88);
            }
            this.a(true);
            discarded$1 = param1.drawImage(this.field_e, param2, param0, (java.awt.image.ImageObserver) (this));
        ...
        try {
          L0: {
            L1: {
              ...
              this.a(true);
              discarded$6 = param1.prepareImage(this.field_e, (java.awt.image.ImageObserver) (this));
              this.a(true);
              discarded$7 = param1.prepareImage(this.field_e, (java.awt.image.ImageObserver) (this));
              this.a(true);
              discarded$8 = param1.prepareImage(this.field_e, (java.awt.image.ImageObserver) (this));
              this.a(255);
              if (param3 > 116) {
                break L1;
              } else {
