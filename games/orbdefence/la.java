...
class la {
                ...
                L0: {
                  ...
                  L2: while (true) {
                    if (var1 <= this.field_t + 5000L) {
                      ...
                      this.b(256);
                      this.field_t = this.field_t + (long)(256000 / field_c);
                      var1 = ji.b(-117);
                      continue L2;
                    }
                  }
              ...
              if (this.field_r != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.f();
                      if (this.field_i - var3_int <= this.field_q) {
                        break L6;
                      } else {
                        this.field_q = this.field_i - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_d + this.field_k;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_a) {
                        ...
                        if (var4 + 256 <= this.field_a) {
                          ...
                          this.field_k = var4 - this.field_d;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_o) {
                            ...
                            L12: {
                              if (this.field_f) {
                                ...
                                this.field_k = Math.min(this.field_h, this.field_q);
                                this.field_h = this.field_q;
                                break L12;
                              }
                            }
                            this.field_q = 0;
        ...
        L1: {
          ...
          if (this.field_n == null) {
            ...
            if (this.field_m > 0) {
              ...
              this.field_m = this.field_m + (field_c >> 4);
              la.b(this.field_n);
              this.a(this.field_n, this.field_n.b());
              var4 = 0;
              var5 = 255;
              var6 = 7;
              L2: while (true) {
                                ...
                                if (var4 < this.field_b) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_s[var7_int] = (di) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((di) (var7)).field_f;
                        ((di) (var7)).field_f = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
    ...
    private final void a(di param0, int param1) {
        int var3 = param1 >> 5;
        di var4 = this.field_s[var3];
        if (var4 == null) {
            this.field_e[var3] = param0;
        } else {
            var4.field_f = param0;
        }
        this.field_s[var3] = param0;
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new ni();
                          var4 = var5;
                          stackIn_10_0 = (ni) (var4);

                          stackIn_10_1 = 256;

                          if (!field_g) {
                            stackIn_11_0 = (ni) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_l <= 0) {
                            ...
                            if (field_u != null) {
                              ...
                              param0.a(314572800, field_l, (Runnable) ((Object) field_u));
                              break L5;
                            }
                          }
                        }
    ...
    la() {
        this.field_j = false;
        this.field_b = 32;
        this.field_t = ji.b(124);
        this.field_o = 0L;
        this.field_h = 0;
        this.field_f = true;
        this.field_e = new di[8];
        this.field_i = 0;
        this.field_m = 0;
        this.field_p = 0L;
        this.field_s = new di[8];
        this.field_q = 0;
    }
}
