...
final class de {
        ...
        try {
          L0: {
            if (pk.a(107, param1, param0, param3)) {
              stackOut_3_0 = ok.a(-3362, param4.b(param1, false, param3));
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("de.C(");
    ...
    final static void a(int param0, hj param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("de.A(").append(param0).append(44);
    ...
    final static pe a() {
        try {
            ...
            try {
              L0: {
                stackOut_1_0 = (pe) Class.forName("ma").newInstance();
                stackIn_2_0 = stackOut_1_0;
                break L0;
              }
