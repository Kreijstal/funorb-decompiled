    ...
    final static void a(int param0, byte param1, java.applet.Applet param2, String[] param3, int param4, int param5) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_16_1 = new StringBuilder().append("o.GA(").append(param0).append(',').append(param1).append(',');
          ...
          throw dd.a((Throwable) (Object) stackIn_22_0, stackIn_22_2 + ',' + param4 + ',' + param5 + ')');
        }
    }
