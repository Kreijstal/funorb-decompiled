    ...
    final static byte[] a(Object param0, boolean param1, int param2) {
        ...
        try {
          L0: {
            if (param0 != null) {
              ...
              if (param0 instanceof byte[]) {
                var3 = (byte[]) (param0);
                if (param1) {
                  stackIn_11_0 = n.a(var3, (byte) 117);
          ...
          L2: {
            ...
            stackIn_18_1 = new StringBuilder().append("e.D(");
    ...
    final static qg a(int param0, int param1, ki param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackIn_8_1 = new StringBuilder().append("e.C(").append(param0).append(',').append(param1).append(',');
