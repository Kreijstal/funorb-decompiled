...
class sf extends ie {
    ...
    final static StringBuilder a(int param0, StringBuilder param1, char param2, byte param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("sf.J(").append(param0).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
    ...
    private final void a(sf param0, byte param1) {
        ...
        try {
          ...
          throw dd.a((Throwable) (Object) stackIn_98_0, stackIn_98_2 + 44 + -117 + 41);
        }
    }
    ...
    private sf(long param0, sf param1, int param2, int param3, int param4, int param5, String param6) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("sf.<init>(").append(param0).append(44);
