...
final class lj extends di {
            ...
            L1: {
              L2: {
                if (!((lj) this).field_S.b()) {
                  ...
                  var4_int = ((lj) this).field_K * ((lj) this).field_S.field_f / la.field_c;
                  L3: while (true) {
                    var5 = (long)param2 * (long)var4_int + ((lj) this).field_l;
                    if (0L <= -var5 + ((lj) this).field_R) {
                      ((lj) this).field_l = var5;
                      break L2;
                    } else {
                      var7 = (int)((-1L + ((long)var4_int + -((lj) this).field_l) + ((lj) this).field_R) / (long)var4_int);
                      ((lj) this).field_l = ((lj) this).field_l + (long)var7 * (long)var4_int;
        ...
        try {
          L0: {
            L1: {
              L2: {
                ...
                if (!param1) {
                  ...
                  if (!param0.field_D.field_k) {
                    ...
                    var5 = (int)((long)((lj) this).field_D[param0.field_F] * (long)var6 >> 6);
                    var4_int = var4_int << 8;
                    if (var4_int <= var5) {
              ...
              var5 = (int)((long)((lj) this).field_D[param0.field_F] * (long)var4_int >> 6);
              break L1;
            }
            L3: {
              if (param2 == 9929) {
    ...
    private final int a(byte param0, he param1) {
        ...
        try {
          L0: {
            L1: {
              var3_int = param1.field_k + (param1.field_z * param1.field_A >> 12);
              var3_int = var3_int + (((lj) this).field_v[param1.field_F] * (-8192 + ((lj) this).field_Q[param1.field_F]) >> 12);
              var4 = param1.field_x;
              if (var4.field_h <= 0) {
                break L1;
              } else {
                L2: {
                  if (0 < var4.field_j) {
                    ...
                    if (((lj) this).field_n[param1.field_F] <= 0) {
                      break L1;
                    } else {
                      break L2;
                    }
                ...
                var5 = var5 + (((lj) this).field_n[param1.field_F] >> 7);
          ...
          L5: {
            ...
            stackOut_12_1 = new StringBuilder().append("lj.EA(").append(54).append(44);
    ...
    private final synchronized void a(boolean param0, int param1, boolean param2, fj param3) {
        ...
        try {
            ...
            throw dd.a((Throwable) (Object) runtimeException, "lj.QA(" + param0 + 44 + param1 + 44 + param2 + 44 + (param3 != null ? "{...}" : "null") + 41);
        }
    }
              ...
              if (var3 == 160) {
                ...
                if (var3 == 176) {
                  L1: {
                    var4 = 15 & param0;
                    var5 = param0 >> 8 & 127;
                    var6 = (8354193 & param0) >> 16;
                    if (var5 != 0) {
                      break L1;
                    } else {
                      ((lj) this).field_H[var4] = vi.a(-2080769, ((lj) this).field_H[var4]) + (var6 << 14);
                      break L1;
                    }
                  }
                  L2: {
                    if (var5 != 32) {
                      ...
                      ((lj) this).field_H[var4] = (var6 << 7) + vi.a(((lj) this).field_H[var4], -16257);
                      break L2;
                    }
                  }
                  L3: {
                    if (var5 != 1) {
                      ...
                      ((lj) this).field_n[var4] = vi.a(((lj) this).field_n[var4], -16257) + (var6 << 7);
                      break L3;
                    }
                  }
                  L4: {
                  ...
                  L5: {
                    if (var5 == 5) {
                      ((lj) this).field_G[var4] = (var6 << 7) + vi.a(((lj) this).field_G[var4], -16257);
                      break L5;
                    } else {
                      break L5;
                    }
                  ...
                  L7: {
                    if (var5 == 7) {
                      ((lj) this).field_w[var4] = vi.a(((lj) this).field_w[var4], -16257) - -(var6 << 7);
                      break L7;
                    } else {
                      break L7;
                    }
                  ...
                  L9: {
                    if (var5 == 10) {
                      ((lj) this).field_y[var4] = (var6 << 7) + vi.a(-16257, ((lj) this).field_y[var4]);
                      break L9;
                    } else {
                      break L9;
                    }
                  ...
                  L11: {
                    if (11 != var5) {
                      ...
                      ((lj) this).field_x[var4] = (var6 << 7) + vi.a(((lj) this).field_x[var4], -16257);
                      break L11;
                    }
                  }
                  L12: {
                  ...
                  L15: {
                    if (var5 != 99) {
                      ...
                      ((lj) this).field_p[var4] = (var6 << 7) + vi.a(((lj) this).field_p[var4], 127);
                      break L15;
                    }
                  }
                  L16: {
                  ...
                  L17: {
                    if (var5 != 101) {
                      ...
                      ((lj) this).field_p[var4] = (var6 << 7) + 16384 - -vi.a(127, ((lj) this).field_p[var4]);
                      break L17;
                    }
                  }
                  L18: {
                  ...
                  L22: {
                    if (6 == var5) {
                      ...
                      if (var7 != 16384) {
                        ...
                        ((lj) this).field_v[var4] = (var6 << 7) + vi.a(-16257, ((lj) this).field_v[var4]);
                        break L22;
                      }
                    } else {
                      break L22;
                  ...
                  L24: {
                    if (var5 == 16) {
                      ((lj) this).field_D[var4] = vi.a(((lj) this).field_D[var4], -16257) + (var6 << 7);
                      break L24;
                    } else {
                      break L24;
                    }
                  ...
                  L27: {
                    if (var5 != 17) {
                      ...
                      this.b(var4, (var6 << 7) + (-16257 & ((lj) this).field_C[var4]), -73);
                      break L27;
                    }
                  }
                  if (var5 != 49) {
                    ...
                    this.b(var4, (-128 & ((lj) this).field_C[var4]) - -var6, -115);
                    return;
                  }
                } else {
                  if (var3 != 192) {
    ...
    final synchronized void a(boolean param0, fj param1, int param2, boolean param3, int param4, int param5) {
        ...
        try {
            ...
            var7_int = ((lj) this).field_S.a(((lj) this).field_l) * param4;
            var8 = ((lj) this).field_S.field_f * param2;
            var7_int = (-1 + (var7_int - -var8)) / var8 * var8;
            ((lj) this).field_P = ((param4 >> 1) + var7_int) / param4;
        } catch (RuntimeException runtimeException) {
            throw dd.a((Throwable) (Object) runtimeException, "lj.R(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
    }
                ...
                L2: {
                  if (param0 != var5.field_F) {
                    ...
                    if (var5.field_n < 0) {
                      ...
                      var6_int = var5.field_k + (var5.field_z * var5.field_A >> 12);
                      var5.field_k = var5.field_k + (param1 + -var5.field_h << 8);
                      var5.field_A = 4096;
        ...
        if (var12 == null) {
          ...
          if (var6 != null) {
            L3: {
              ...
              var7.field_h = param1;
              var8 = -7;
              var7.field_t = var11.field_j[param1] * (var12.field_l * param3 * param3) - -1024 >> 11;
              var7.field_q = 255 & var11.field_k[param1];
              var7.field_k = -(32767 & var11.field_m[param1]) + (param1 << 8);
              var7.field_m = 0;
              var7.field_B = 0;
              var7.field_j = 0;
              var7.field_n = -1;
    ...
    private final void a(int param0, byte param1) {
        ...
        var4 = OrbDefence.field_D ? 1 : 0;
        if (param1 < -66) {
          var3 = (he) (Object) ((lj) this).field_O.field_k.b((byte) 114);
          L0: while (true) {
            if (var3 == null) {
              return;
            } else {
    ...
    final boolean a(int param0, he param1, int param2, int param3, int[] param4) {
        ...
        try {
          L0: {
            ...
            L4: {
              ...
              if (var6_int <= 0) {
                ...
                L5: {
                  var6_int = var6_int - (int)(0.5 + Math.pow(2.0, 0.0004921259842519685 * (double)((lj) this).field_G[param1.field_F]) * 16.0);
                  if (0 <= var6_int) {
                    break L5;
                  } else {
                    var6_int = 0;
            ...
            L7: {
              ...
              var8 = 0;
              var9 = 0.000005086263020833333 * (double)((param1.field_A * param1.field_z >> 12) + (param1.field_h + -60 << 8));
              if (var7.field_c > 0) {
                L8: {
                  if (0 < var7.field_k) {
                ...
                L11: while (true) {
                  L12: {
                    if (var7.field_l.length - 2 <= param1.field_m) {
                      ...
                      if ((var7.field_l[param1.field_m + 2] << 8 & 65280) >= param1.field_B) {
                        break L12;
                      } else {
                    ...
                    L16: while (true) {
                      L17: {
                        if (param1.field_j >= var7.field_e.length + -2) {
                          ...
                          if ((var7.field_e[param1.field_j + 2] & 255) << 8 >= param1.field_n) {
                            break L17;
                          } else {
          ...
          L21: {
            ...
            stackOut_67_1 = new StringBuilder().append("lj.W(").append(param0).append(44);
          ...
          throw dd.a((Throwable) (Object) stackIn_73_0, stackIn_73_2 + 41);
        }
    ...
    final static void c(boolean param0) {
        ...
        try {
          ...
          throw dd.a((Throwable) (Object) var1_ref, "lj.OA(" + 0 + 41);
        }
    }

    final static java.net.URL a(String param0, java.net.URL param1, int param2, String param3) {
        try {
            ...
            try {
              ...
              L11: {
                ...
                stackOut_38_1 = new StringBuilder().append("lj.TA(");
              ...
              throw dd.a((Throwable) (Object) stackIn_47_0, stackIn_47_2 + 44 + 72 + 41);
            }
    ...
    private final int a(int param0, he param1) {
        ...
        try {
          L0: {
            if (((lj) this).field_A[param1.field_F] != 0) {
              L1: {
                var9 = param1.field_x;
                var10 = var9;
                var4 = ((lj) this).field_w[param1.field_F] * ((lj) this).field_x[param1.field_F] + 4096 >> 13;
                var4 = var4 * var4 + 16384 >> 15;
                var4 = 16384 + var4 * param1.field_t >> 15;
                var4 = ((lj) this).field_k * var4 + 128 >> 8;
                var4 = 128 + ((lj) this).field_A[param1.field_F] * var4 >> 8;
                if (var10.field_c > 0) {
                ...
                if (null == var10.field_l) {
                  ...
                  L3: {
                    ...
                    if (param1.field_m >= -2 + var10.field_l.length) {
                      ...
                      var7 = var9.field_l[param1.field_m] << 8 & 65280;
                      var8 = var10.field_l[2 + param1.field_m] << 8 & 65280;
                  ...
                  if (null == var10.field_e) {
                    ...
                    L5: {
                      ...
                      if (param1.field_j < -2 + var10.field_e.length) {
                        var7 = var9.field_e[param1.field_j] << 8 & 65280;
                        var8 = (var10.field_e[param1.field_j + 2] & 255) << 8;
          ...
          L6: {
            ...
            stackOut_18_1 = new StringBuilder().append("lj.HA(").append(-24531).append(44);
    ...
    final boolean a(he param0, byte param1) {
        ...
        try {
          ...
          throw dd.a((Throwable) (Object) stackIn_15_0, stackIn_15_2 + 44 + param1 + 41);
        }
    ...
    private final int b(int param0, he param1) {
        ...
        try {
          L0: {
            var3_int = ((lj) this).field_y[param1.field_F];
            if (var3_int >= 8192) {
              stackOut_3_0 = 16384 + -((16384 + -var3_int) * (128 + -param1.field_q) + 32 >> 6);
              stackIn_4_0 = stackOut_3_0;
              break L0;
            } else {
              stackOut_1_0 = param1.field_q * var3_int - -32 >> 6;
              stackIn_2_0 = stackOut_1_0;
              return stackIn_2_0;
            }
          }
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("lj.BA(").append(2).append(44);
    ...
    final synchronized boolean a(ki param0, vd param1, byte param2, fj param3, int param4) {
        ...
        try {
          ...
          throw dd.a((Throwable) (Object) stackIn_31_0, stackIn_31_2 + 44 + param4 + 41);
        }
    ...
    private final void b(byte param0, int param1) {
        ...
        int var4 = 0;
        var4 = OrbDefence.field_D ? 1 : 0;
        var3 = (he) (Object) ((lj) this).field_O.field_k.b((byte) 126);
        L0: while (true) {
          if (var3 == null) {
            return;
          } else {
    ...
    private final synchronized void a(int param0, boolean param1, fj param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("lj.M(").append(param0).append(44).append(param1).append(44);
