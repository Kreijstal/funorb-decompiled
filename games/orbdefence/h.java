...
final class h extends kj {
    ...
    final static void k(int param0) {
        ...
        if (param0 <= 120) {
          ...
          le.field_a.a(-115, (ca) (Object) var1);
          return;
        } else {
          var1.a(ul.field_b, 95, ul.field_i, ul.field_a, ul.field_f, ul.field_l, ul.field_d, ul.field_e);
          le.field_a.a(-115, (ca) (Object) var1);
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              var12_int = -((h) this).field_D + ((h) this).field_B;
              var13 = ((h) this).field_C.a(param10, var12_int, ((h) this).field_C.field_H) - -(2 * ((h) this).field_D);
              if (param3 < var13) {
            ...
            L3: {
              if (!((h) this).field_F) {
                stackOut_9_0 = 2 * ((h) this).field_D + ((h) this).field_B;
            ...
            var14 = stackIn_10_0;
            ((h) this).field_y.a(var14, ((h) this).field_D + (-param3 + var13 >> 1), param3 + -(2 * ((h) this).field_D), (byte) -90, -((h) this).field_B + param2 + -(3 * ((h) this).field_D));
            break L0;
          }
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("h.<init>(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
    ...
    final static qg a(qg param0, byte param1, int[] param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("h.G(");
          ...
          L2: {
            ...
            stackOut_7_1 = ((StringBuilder) (Object) stackIn_7_1).append(stackIn_7_2).append(44).append(37).append(44);
