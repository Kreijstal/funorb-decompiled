          ...
          if (!(var4 instanceof uc)) {
            ...
            L10: {
              ...
              if (null == this.field_l) {
                ...
                stackIn_91_0 = 1;
                stackIn_91_1 = this.field_g[param0];
                            ...
                            L12: {
                              if (this.field_o >= this.field_i.field_d.length) {
                                ...
                                if (0 != this.field_i.field_d[this.field_o]) {
                                  L13: {
                                    stackIn_21_0 = this.field_n;

                                    if (param0) {
                                      stackIn_22_0 = (ge) ((Object) stackIn_21_0);
                                      stackIn_22_1 = 0;
                                      break L13;
                                    } else {
                                      stackIn_22_0 = (ge) ((Object) stackIn_21_0);
    ...
    ak(int param0, eh param1, eh param2, ge param3, vl param4, int param5, byte[] param6, int param7, boolean param8) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_12_1 = new StringBuilder().append("ak.<init>(").append(param0).append(',');
          ...
          throw dd.a((Throwable) ((Object) stackIn_13_0), stackIn_25_2 + ',' + param7 + ',' + param8 + ')');
        }
    }
