...
final class nj extends ca {
    ...
    private int field_A;
    private static hk[] field_l;
    private static int field_g;
    private static w[] field_o;
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        mg var2 = new mg(param0);
        ((nj) this).field_A = var2.l(0);
        ((nj) this).field_p = var2.l(0);
        ...
        ((nj) this).field_s = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            var5 = 0;
            do {
                var6_int = var2.b((byte) 90);
                var5 = var5 + var6_int;
            } while (var6_int >= 255);
            var6 = new byte[var5];
            var2.a((byte) 123, var6, 0, var5);
            ((nj) this).field_s[var4] = var6;
        }
    }
    ...
    final static int c(int param0) {
        ...
        int var1 = 0;
        int var2 = 0;
        while (param0 >= 8 - field_D) {
            var3 = 8 - field_D;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_v[field_I] >> field_D & var4) << var2);
            field_D = 0;
            field_I = field_I + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_v[field_I] >> field_D & var3) << var2);
            field_D = field_D + param0;
        }
        return var1;
    }

    final dl a(int[] param0) {
        int var3 = 0;
        int var4 = 0;
        int var5 = 0;
        int var6 = 0;
        ...
        L1: {
          if (((nj) this).field_q != null) {
            break L1;
          } else {
            ((nj) this).field_H = 0;
            ((nj) this).field_z = new float[field_g];
            ((nj) this).field_q = new byte[((nj) this).field_p];
            ((nj) this).field_f = 0;
            ((nj) this).field_i = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((nj) this).field_i >= ((nj) this).field_s.length) {
            ((nj) this).field_z = null;
            var14 = ((nj) this).field_q;
            ((nj) this).field_q = null;
            return new dl(((nj) this).field_A, var14, ((nj) this).field_F, ((nj) this).field_k, ((nj) this).field_G);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((nj) this).field_f;
                  var4 = var13.length;
                  if (var4 <= ((nj) this).field_p - var3) {
                    break L5;
                  } else {
                    var4 = ((nj) this).field_p - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((nj) this).field_f);
                        break L7;
                      }
                    }
                    ((nj) this).field_f = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((nj) this).field_i = ((nj) this).field_i + 1;
            continue L2;
          }
        }
    }
    ...
    private final float[] e(int param0) {
        ...
        L0: {
          nj.a(((nj) this).field_s[param0], 0);
          int discarded$1 = nj.b();
          var2 = nj.c(uh.a((byte) -89, field_L.length - 1));
        ...
        L8: {
          var14 = field_l[field_L[var2]];
          var16 = var14.field_b;
          var17_int = var14.field_d[var16];
          if (field_w[var17_int].a()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_a) {
            L10: {
              if (var15 != 0) {
                ...
                field_w[var18_int].a(field_B, var4 >> 1);
                break L10;
              }
            }
            L11: {
            ...
            L35: {
              var17 = null;
              if (((nj) this).field_H <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((nj) this).field_H + var4 >> 2;
                  ...
                  if (((nj) this).field_u) {
                    ...
                    L37: while (true) {
                      if (var19 >= ((nj) this).field_h) {
                        ...
                        var20 = (((nj) this).field_H >> 1) + var19;
                        var40[var19] = var40[var19] + ((nj) this).field_z[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((nj) this).field_z;
              ((nj) this).field_z = field_B;
              field_B = var18;
              ((nj) this).field_H = var4;
    ...
    final dl a() {
        ...
        ((nj) this).field_H = 0;
        ((nj) this).field_z = new float[field_g];
        var1 = new byte[((nj) this).field_p];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((nj) this).field_s.length) {
            ((nj) this).field_z = null;
            return new dl(((nj) this).field_A, var1, ((nj) this).field_F, ((nj) this).field_k, ((nj) this).field_G);
          } else {
            var4 = this.e(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((nj) this).field_p - var2) {
                  break L1;
                } else {
                  var5 = ((nj) this).field_p - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    final static int b() {
        int var0 = field_v[field_I] >> field_D & 1;
        field_D = field_D + 1;
        field_I = field_I + (field_D >> 3);
        field_D = field_D & 7;
        return var0;
    }
    ...
    private nj(byte[] param0) throws IOException {
        this.a(param0);
    }
