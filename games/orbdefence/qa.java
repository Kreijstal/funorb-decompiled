...
final class qa {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_k[var16]) {
                  var9 = field_e[var16];
                  var10 = field_b[var16] * this.field_a;
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_g, 0, field_e, 0, var2);
        int var3 = field_l[this.field_a - 1];
        int var4 = uh.a((byte) -122, var3 - 1);
        field_b[0] = nj.c(var4);
        field_b[1] = nj.c(var4);
        int var5 = 2;
        for (var6 = 0; var6 < this.field_c.length; var6++) {
            var7 = this.field_c[var6];
            var8 = this.field_h[var7];
            var9 = this.field_f[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = nj.field_x[this.field_j[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = this.field_d[var7][var11 & var10];
                var11 = var11 >>> var9;
            ...
            if (var4 >= var2) {
              ...
              L1: while (true) {
                if (var4 >= var3) {
                    ...
                    if (var6 >= var2) {
                      ...
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= this.field_h[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              incrementValue$0 = var5;
                              var5++;
                              this.field_g[incrementValue$0] = nj.c(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_h[this.field_c[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    this.field_h[var4] = nj.c(3) + 1;
                    dupTemp$1 = nj.c(2);
                    this.field_f[var4] = dupTemp$1;
                    var5 = dupTemp$1;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      this.field_j[var4] = nj.c(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
