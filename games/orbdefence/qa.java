...
final class qa {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((qa) this).field_g.length;
        var4 = field_l[((qa) this).field_a - 1];
        var5 = field_k;
        field_k[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_b[0] * ((qa) this).field_a;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_k[var16]) {
                  var9 = field_e[var16];
                  var10 = field_b[var16] * ((qa) this).field_a;
            ...
            L3: {
              var7 = qa.a(field_e, var6);
              var8_int = qa.b(field_e, var6);
              var9 = this.a(field_e[var7], field_b[var7], field_e[var8_int], field_b[var8_int], field_e[var6]);
              var10 = field_b[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean a() {
        ...
        int var2 = ((qa) this).field_g.length;
        System.arraycopy((Object) (Object) ((qa) this).field_g, 0, (Object) (Object) field_e, 0, var2);
        int var3 = field_l[((qa) this).field_a - 1];
        int var4 = uh.a((byte) -122, var3 - 1);
        field_b[0] = nj.c(var4);
        field_b[1] = nj.c(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((qa) this).field_c.length; var6++) {
            var7 = ((qa) this).field_c[var6];
            var8 = ((qa) this).field_h[var7];
            var9 = ((qa) this).field_f[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = nj.field_x[((qa) this).field_j[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((qa) this).field_d[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_b[incrementValue$0] = var13 >= 0 ? nj.field_x[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_i[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_i[var11];
        }
    }
    ...
    qa() {
        ...
        if (var1 == 1) {
          var2 = nj.c(5);
          var3 = 0;
          ((qa) this).field_c = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((qa) this).field_h = new int[var3];
              ((qa) this).field_f = new int[var3];
              ((qa) this).field_j = new int[var3];
              ((qa) this).field_d = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((qa) this).field_a = nj.c(2) + 1;
                  var4 = nj.c(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((qa) this).field_g = new int[var5];
                      ((qa) this).field_g[0] = 0;
                      ((qa) this).field_g[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((qa) this).field_h[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((qa) this).field_g[incrementValue$2] = nj.c(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((qa) this).field_h[((qa) this).field_c[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((qa) this).field_h[var4] = nj.c(3) + 1;
                    int dupTemp$3 = nj.c(2);
                    ((qa) this).field_f[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((qa) this).field_j[var4] = nj.c(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
