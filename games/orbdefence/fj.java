                      ...
                      L6: {
                        if (var9 != 144) {
                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              var13 = var19[var10];
                              var14 = (mc) ((Object) this.field_g.a((long)var13, -1));
                              if (var14 != null) {
                                break L7;
                              } else {
                                var15 = new mc(new byte[128]);
                                var14 = var15;
                                this.field_g.a((long)var13, (byte) -119, var15);
                                break L7;
                              }
                            }
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51 = new mg(this.field_f);
                      var51.b(1297377380, -1);
                      var51.b(6, -1);
                      stackIn_66_0 = (mg) (var51);

                      stackIn_66_1 = -60;

                      if (var2 <= 1) {
                        stackIn_67_0 = (mg) ((Object) stackIn_66_0);
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                      ...
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            var44++;
                                            var51.a((int) param0.field_j[incrementValue$1], -93);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var50++;
                              var51.a((int) param0.field_j[incrementValue$25], -84);
                              incrementValue$26 = var50;
                              var50++;
                              var51.a((int) param0.field_j[incrementValue$26], -44);
                              incrementValue$27 = var50;
                              var50++;
                              var51.a((int) param0.field_j[incrementValue$27], -90);
                              continue L5;
                            }
                          } else {
                            L18: {
