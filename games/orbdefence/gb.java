...
final class gb {
    ...
    private final void a(int param0, Object param1, int param2, long param3) {
        ...
        lc var6_ref = new lc(param1, param2);
    ...
    final static void a(boolean param0, int param1, boolean param2) {
        ...
        L1: {
          ...
          if (kg.field_m == 0) {
            var3 = th.a(jd.field_a, ta.field_y, li.field_c, vi.field_I, -60);
            var4 = var3 + 3;
            ...
            if ((kg.field_m ^ -1) != -2) {
              if (kg.field_m != 2) {
                if (3 == kg.field_m) {
                  L4: {
                    if (wc.field_c.field_q) {
                      var3 = th.a(jd.field_a, am.field_c, li.field_c, vi.field_I, -62);
                      break L4;
                    } else {
                      var3 = th.a(jd.field_a, dg.field_C, li.field_c, vi.field_I, -98);
                      break L4;
                    }
                  }
                  var4 = 2 - -var3;
                  ...
                  if (4 != kg.field_m) {
                    if ((kg.field_m ^ -1) == -6) {
                      var3 = th.a(jd.field_a, lh.field_a, li.field_c, vi.field_I, -52);
                      var4 = var3 + 3;
                      dd.field_B = new int[var4];
                      ea.field_d = new String[var4];
                      var5 = 0;
                    ...
                    var3 = th.a(jd.field_a, fi.field_a, li.field_c, vi.field_I, -89);
                    var4 = var3 + 2;
                    ea.field_d = new String[var4];
                    dd.field_B = new int[var4];
                    var5 = 0;
                ...
                var3 = th.a(jd.field_a, t.a(-415993727, new String[1], mc.field_f), li.field_c, vi.field_I, -105);
                var4 = -1;
                var5 = 0;
                L11: while (true) {
                  L12: {
                  ...
                  if ((var4 ^ -1) != 0) {
                    ...
                    bc.field_t = new String[var3 + -var4 + -1];
                    mk.a((Object[]) (Object) li.field_c, 1 + var4, (Object[]) (Object) bc.field_t, 0, var3 + (-var4 + -1));
                    var4 = -1;
                    var3 = th.a(jd.field_a, t.a(-415993727, new String[1], qk.field_c), li.field_c, vi.field_I, -108);
                    var5 = 0;
                    L13: while (true) {
                      L14: {
                        if (var5 >= var3) {
                      ...
                      if (-1 != var4) {
                        L15: {
                          ...
                          sj.field_u = new String[-1 + var3 - var4];
                          mk.a((Object[]) (Object) li.field_c, var4 - -1, (Object[]) (Object) sj.field_u, 0, -1 + (-var4 + var3));
              ...
              var3 = th.a(jd.field_a, ta.field_y, li.field_c, vi.field_I, -77);
              var4 = var3 + 2;
              ea.field_d = new String[var4];
              dd.field_B = new int[var4];
              var5 = 0;
        ...
        L24: while (true) {
          if (var4 >= ea.field_d.length) {
            ...
            ha.field_o = -(var3 >> 515316481) + fd.field_c;
            lc.field_q = -(var3 >> -1860705023) + (fd.field_c - -var3);
            ...
            L28: while (true) {
              if (var4 >= ea.field_d.length) {
                ...
                L31: {
                  stackOut_108_0 = rf.field_C;
                  stackIn_110_0 = stackOut_108_0;
                  stackIn_109_0 = stackOut_108_0;
                  if (-1 >= (dd.field_B[var4] ^ -1)) {
                    stackOut_110_0 = stackIn_110_0;
                    stackOut_110_1 = el.field_D;
                    stackIn_111_0 = stackOut_110_0;
                    stackIn_111_1 = stackOut_110_1;
                    break L31;
                  } else {
                    stackOut_109_0 = stackIn_109_0;
                    stackOut_109_1 = d.field_j;
                    stackIn_111_0 = stackOut_109_0;
                    stackIn_111_1 = stackOut_109_1;
                    break L31;
                  }
                }
                rf.field_C = stackIn_111_0 + stackIn_111_1;
                var4++;
                continue L28;
              }
            }
