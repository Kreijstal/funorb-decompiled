...
final class mh {
    ...
    final void a(long param0, byte param1, ca param2) {
        ...
        ca var5 = ((mh) this).field_e[(int)((long)(((mh) this).field_d + -1) & param0)];
    ...
    final ca c(byte param0) {
        ...
        if ((((mh) this).field_h ^ -1) < -1) {
          if (((mh) this).field_e[-1 + ((mh) this).field_h] != ((mh) this).field_c) {
            ...
            if (param0 >= -55) {
              ca discarded$2 = ((mh) this).a((byte) 19);
              L0: while (true) {
                if (((mh) this).field_h < ((mh) this).field_d) {
                  ((mh) this).field_h = ((mh) this).field_h + 1;
                  var4 = ((mh) this).field_e[((mh) this).field_h].field_e;
                  var22 = var4;
          ...
          if (param0 < -55) {
            ...
            ca discarded$3 = ((mh) this).a((byte) 19);
            L3: while (true) {
              if (((mh) this).field_h < ((mh) this).field_d) {
                ((mh) this).field_h = ((mh) this).field_h + 1;
                var4 = ((mh) this).field_e[((mh) this).field_h].field_e;
