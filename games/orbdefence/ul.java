...
final class ul {
    ...
    final static void a(int param0, int param1, int param2, int param3, int[] param4) {
        ...
        int var22 = var6 + var8 * field_f;
        int var23 = field_f + var6 - var7;
        ul.a(0, 0, 0, 0, 0, var15, var5, var22, field_b, param3, param4, var23, var13, var6 - var7, var16 + var10, var19, var21, var8 - var9);
    }

    final static void d(int param0, int param1, int param2, int param3, int param4) {
        ul.d(param0, param1, param2, param4);
        ul.d(param0, param1 + param3 - 1, param2, param4);
        ul.j(param0, param1, param3, param4);
        ul.j(param0 + param2 - 1, param1, param3, param4);
    }

    final static void i(int param0, int param1, int param2, int param3, int param4) {
        int incrementValue$0 = 0;
        ...
        if (param4 != 0) {
          if (param4 != 256) {
                    ...
                    L6: while (true) {
                      ...
                      L10: while (true) {
                        if (var23 > var21) {
                          ...
                          var25++;
                          field_b[incrementValue$2] = var24;
                          var23++;
                          continue L10;
                        }
                      }
                      ...
                      if (var18 > var15) {
                        ...
                        L15: while (true) {
                          if (var23 >= var21) {
                            ...
                            var22++;
                            field_b[incrementValue$4] = var24;
                            var23++;
                            continue L15;
                          }
                        }
            ...
            ul.f(param0, param1, param2, param3);
            return;
          }
        } else {
          return;
    ...
    final static void c(int param0, int param1, int param2, int param3) {
        ...
        if (param1 + param3 > field_a) {
            param3 = field_a - param1;
        }
        int var4 = field_f - param2;
        int var5 = param0 + param1 * field_f;
        ul.a(var5, field_b, 0, param2, -param3, var4);
    }
    ...
    private final static void j(int param0, int param1, int param2, int param3) {
        int var4 = 0;
        int var5 = 0;
        if (param0 >= field_i) {
            if (param0 >= field_e) {
    ...
    final static void c(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        int var8 = field_f - param2;
        int var9 = param0 + param1 * field_f;
        for (var10 = -param3; var10 < 0; var10++) {
            ...
            for (var14 = -param2; var14 < 0; var14++) {
                ...
                incrementValue$0 = var9;
                var9++;
                field_b[incrementValue$0] = var16 - var15 | var15 - (var15 >>> 8);
            }
            var9 = var9 + var8;
            var6 = var6 + var7;
        }
    ...
    private final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
                ...
                if (var11 >= var21) {
                      ...
                      L10: while (true) {
                        ...
                        L14: while (true) {
                          if (var20 > var18) {
                            ...
                            var19++;
                            field_b[incrementValue$2] = param5;
                            var20++;
                            continue L14;
                          }
                        }
                  ...
                  L15: while (true) {
                    if (var22 >= var18) {
                      ...
                      var19++;
                      field_b[incrementValue$3] = param5;
                      var22++;
                      continue L15;
                    }
                  }
                    ...
                    if (var15 > var12) {
                      ...
                      L20: while (true) {
                        if (var20 >= var18) {
                          ...
                          var19++;
                          field_b[incrementValue$5] = param5;
                          var20++;
                          continue L20;
                        }
                      }
          ...
          ul.h(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    private final static void g(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param0 >= field_i) {
            ...
            for (var7 = 0; var7 < param2; var7++) {
                ...
                field_b[var5] = var8 - var6 | var6 - (var6 >>> 8);
                var5 = var5 + field_f;
            }
            return;
        }
    ...
    final static void a(int param0, int param1, int param2) {
        if (param0 >= field_i) {
            if (param1 < field_d || param0 >= field_e || param1 >= field_a) {
                return;
            }
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            if (param2 <= param3) {
              L1: {
                ...
                if (param1 >= field_d) {
                  ...
                  param0 = param0 + var9 * (field_d - param1);
                  param1 = field_d;
                  break L1;
                }
              }
            ...
            L9: {
              if (param3 < 0) {
                ul.g(param0, param1 + param3, -param3 + 1, param4, param5);
                break L9;
              } else {
                ul.g(param0, param1, param3 + 1, param4, param5);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              ul.c(param0 + param2, param1, -param2 + 1, param4, param5);
              break L10;
            } else {
              ul.c(param0, param1, param2 + 1, param4, param5);
              break L10;
            }
          }
          return;
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            L9: {
              if (param3 < 0) {
                ul.j(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                ul.j(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              ul.d(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              ul.d(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4, int param5) {
        ul.a(field_b, 0, param2 + param3 * field_f, param0, param2, param4, field_f - param4, param5);
        ul.a(field_b, 0, param2 + param3 * field_f, param1, param3, param5, field_f - param4, param2, param4);
    }
                ...
                L6: while (true) {
                  if (var18 <= var20) {
                    L7: {
                      ...
                      var28 = var28 * var28;
                      var29 = var28 - var27;
                      if (!ul.a(0, 0, 0, 0, 0, var26, var5, var14 + var17, var17 - var18, field_b, param3, param4, 1, var24, var8 + var21)) {
                        break L7;
                      } else {
                        ul.a(0, 0, 0, 0, 0, var26, var5, var14 + var18 - 1, var17 - var18, field_b, param3, param4, -1, var29, var8 + var27);
                        break L7;
                      }
                    }
                    var14 = var14 + var15;
          ...
          if (param4 != 0) {
            ...
            L4: while (true) {
              if (var13 >= var9) {
                ...
                L7: {
                  var21 = var19 + var13 * field_f;
                  var22 = field_f + var19 - var20;
                  ...
                  if (var13 >= var23) {
                        ...
                        L10: while (true) {
                          ...
                          L14: while (true) {
                            if (var22 > var20) {
                              ...
                              var21++;
                              field_b[incrementValue$2] = param5 + var23;
                              var22++;
                              continue L14;
                            }
                          }
                    ...
                    L15: while (true) {
                      if (var24 >= var20) {
                        ...
                        var21++;
                        field_b[incrementValue$3] = param5 + var25;
                        var24++;
                        continue L15;
                      }
                    }
                      ...
                      if (var17 > var14) {
                        ...
                        L20: while (true) {
                          if (var22 >= var20) {
                            ...
                            var21++;
                            field_b[incrementValue$5] = param5 + var23;
                            var22++;
                            continue L20;
                          }
                        }
            ...
            ul.d(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          ul.b(param0, param1, param2, param3, param4, param5);
          return;
        }
    }

    final static void g(int param0, int param1, int param2, int param3, int param4, int param5) {
        ul.f(param0, param1, param2, param4, param5);
        ul.f(param0, param1 + param3 - 1, param2, param4, param5);
        if (param3 >= 3) {
            ul.e(param0, param1 + 1, param3 - 2, param4, param5);
            ul.e(param0 + param2 - 1, param1 + 1, param3 - 2, param4, param5);
            return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3) {
        ...
        if (param1 >= field_d) {
            ...
            for (var5 = 0; var5 < param2; var5++) {
                ...
                incrementValue$0 = var4;
                var4++;
                field_b[incrementValue$0] = var7 - var6 | var6 - (var6 >>> 8);
            }
            return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var6 = 0; var6 < 4; var6++) {
            var5 = 128 - (var6 << 5);
            ul.f(param0 + var6, param1 + param3 + var6, param2, param4, var5);
            ul.e(param0 + param2 + var6, param1 + var6, param3 + 1, param4, var5);
        }
    }
    ...
    final static void c(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param1 >= field_d) {
            ...
            for (var7 = 0; var7 < param2; var7++) {
                ...
                var5++;
                field_b[incrementValue$0] = var8 - var6 | var6 - (var6 >>> 8);
            }
            return;
        }
    }
                  ...
                  L6: while (true) {
                    ...
                    L10: while (true) {
                      if (var15 > var13) {
                        ...
                        var14++;
                        field_b[incrementValue$2] = param3;
                        var15++;
                        continue L10;
                      }
                    }
                    ...
                    if (var10 > var7) {
                      ...
                      L15: while (true) {
                        if (var15 >= var13) {
                          ...
                          incrementValue$4 = var14;
                          var14++;
                          field_b[incrementValue$4] = param3;
                          var15++;
                          continue L15;
                        }
                      }
    ...
    final static void b(int param0, int param1, int param2, int param3) {
        ...
        if (param0 >= field_i) {
            ...
            for (var5 = 0; var5 < param2; var5++) {
                ...
                var6 = (param3 & 16711935) + (var6 & 16711935);
                var6 = (var6 & 16777472) + (var7 - var6 & 65536);
                field_b[var4] = var7 - var6 | var6 - (var6 >>> 8);
                var4 = var4 + field_f;
            }
            return;
        }
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        for (var7 = 0; var7 < param4; var7++) {
            ul.g(param0 + var7, param1 + var7, param2 - (var7 << 1), param3 - (var7 << 1), param5, param6);
        }
    }
