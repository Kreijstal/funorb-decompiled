...
final class r {
    ...
    final int b() {
        ...
        while (this.field_b[var1] >= 0) {
            var1 = nj.b() != 0 ? this.field_b[var1] : var1 + 1;
        }
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_d) {
                ...
                var4_int = nj.c(uh.a((byte) -86, this.field_d - var2));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
          ...
          if (var2 <= 0) {
            ...
            L9: {
              ...
              if (var2 != 1) {
                ...
                var7 = r.a(this.field_d, this.field_f);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_e = new float[this.field_d][this.field_f];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
