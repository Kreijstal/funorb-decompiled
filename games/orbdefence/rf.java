...
final class rf extends ta implements ff, ai, bf {
    ...
    private final int a(int param0, int param1, String param2, int param3, String param4, byte param5, pj param6) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("rf.R(").append(param0).append(',').append(param1).append(',');
        ...
        try {
          L0: {
            if (super.a(param0, param1, param2, param3)) {
              ...
              if (98 == param1) {
                stackOut_6_0 = this.a(param2, false);
                stackIn_7_0 = stackOut_6_0;
                decompiledRegionSelector0 = 1;
                break L0;
              } else {
                if (param1 == 99) {
                  stackOut_10_0 = this.b(param2, false);
                  stackIn_11_0 = stackOut_10_0;
        ...
        try {
          L0: {
            ...
            if (param0 >= 104) {
              ...
              var5 = (pj) null;
              discarded$2 = this.a('k', 11, (pj) null, -124);
              return;
            }
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
    ...
    private final int a(int param0, int param1, String param2, pj param3, int param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("rf.S(").append(param0).append(',').append(param1).append(',');
          ...
          throw dd.a((Throwable) ((Object) stackIn_8_0), stackIn_8_2 + ',' + param4 + ')');
        }
        return stackIn_1_0;
    }
    ...
    private final int a(int param0, int param1, String param2, String param3, pj param4, boolean param5) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = this.a(35, param1, param3, param0, param2, (byte) -81, param4);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("rf.G(").append(param0).append(',').append(param1).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
          ...
          throw dd.a((Throwable) ((Object) stackIn_13_0), stackIn_13_2 + ',' + param5 + ')');
        }
        return stackIn_3_0;
    }
    ...
    private final boolean k(int param0) {
        ...
        if (param0 == 20) {
          ...
          var3 = (pj) null;
          discarded$1 = this.a(77, -40, (String) null, (String) null, (pj) null, false);
          if (this.a(this.field_B, -94)) {
            if (this.a(this.field_O, param0 ^ 73)) {
              if (this.a(this.field_G, param0 ^ 59)) {
                if (this.a(this.field_D, -98)) {
    ...
    public final void a(int param0, int param1, byte param2, te param3) {
        ...
        try {
          ...
          L4: {
            var5 = decompiledCaughtException;
            stackOut_12_0 = (RuntimeException) (var5);
            stackOut_12_1 = new StringBuilder().append("rf.H(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_14_0 = stackOut_12_0;
            stackIn_14_1 = stackOut_12_1;
            stackIn_13_0 = stackOut_12_0;
            stackIn_13_1 = stackOut_12_1;
