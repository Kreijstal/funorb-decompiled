...
final class be implements Runnable {
    ...
    final eb a(int param0, int param1, int param2, int param3, int param4) {
        ...
        return this.a(param3 ^ 28252, (param1 << 16) - -param4, (Object) null, 6, (param0 << 16) - -param2);
    }
                    ...
                    if (var2_int != 1) {
                      if (22 == var2_int) {
                        ...
                        if (2 != var2_int) {
                          if (var2_int == 4) {
                            if (~ji.b(106) <= ~field_w) {
                              var8_ref.field_g = (Object) (Object) new DataInputStream(((java.net.URL) var8_ref.field_e).openStream());
                              break L8;
                            } else {
                              throw new IOException();
                            }
                            ...
                            if (var2_int == 8) {
                              ...
                              var8_ref.field_g = (Object) (Object) ((Class) var18[0]).getDeclaredMethod((String) var18[1], (Class[]) var18[2]);
                              break L8;
                            } else {
                              if (var2_int != 9) {
                                if (18 != var2_int) {
                                  if (var2_int != 19) {
                                    if (((be) this).field_q) {
                                      if (3 == var2_int) {
                                        if (~field_w >= ~ji.b(126)) {
                                          var17 = (var8_ref.field_b >> 24 & 255) + "." + ((var8_ref.field_b & 16767812) >> 16) + "." + ((var8_ref.field_b & 65280) >> 8) + "." + (var8_ref.field_b & 255);
                                        ...
                                        if (21 != var2_int) {
                                          if (var2_int != 5) {
                                            ...
                                            if (!((be) this).field_m) {
                                              var8_ref.field_g = Class.forName("oi").getMethod("listmodes", new Class[0]).invoke(((be) this).field_i, new Object[0]);
                                              break L8;
                                            } else {
                                              var8_ref.field_g = (Object) (Object) ((be) this).field_o.a(109);
                                              break L8;
                                            }
                                          }
                                        } else {
                                          if (~field_w >= ~ji.b(-81)) {
                                            var8_ref.field_g = (Object) (Object) java.net.InetAddress.getByName((String) var8_ref.field_e).getAddress();
                                            break L8;
                                          } else {
                                            throw new IOException();
                                          }
                      ...
                      if (~field_w >= ~ji.b(-60)) {
                        var8_ref.field_g = (Object) (Object) new java.net.Socket(java.net.InetAddress.getByName((String) var8_ref.field_e), var8_ref.field_b);
                        break L8;
                      } else {
                        throw new IOException();
                      }
