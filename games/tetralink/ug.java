...
final class ug extends nb {
            ...
            if (dg.field_e != 85) {
                ...
                L8: {
                  if (var3 == 0) {
                    ...
                    if (io.field_h.length() < 80) {
                      L9: {
                        L10: {
                          StringBuilder discarded$5 = io.field_h.append(var4);
                          var5 = 485;
                          var13 = ph.field_w;
                          var7 = var13;
                          var7 = var13;
                          var12 = rh.a(var13, param0 ^ -125);
                          var7 = var12;
                          var7 = var12;
                          var15 = var12;
                          var7 = var15;
                          ...
                          if (sf.field_d != 2) {
                            ...
                            L11: {
                              L12: {
                                var18 = (CharSequence) (Object) ka.field_m;
                                var14 = sk.a(new String[1], vd.field_b, param0 ^ 94);
                                var7 = var14;
                                var7 = var14;
                                var8 = sk.a(new String[1], mc.field_h, 127);
                                var7 = var8;
                                var7 = var8;
                                var9 = we.field_k.b(var14);
                        ...
                        if (sf.field_d == 0) {
                            ...
                            if (qb.field_N != null) {
                              ...
                              if (go.field_c) {
                                ...
                                L16: {
                                  ...
                                  var7 = var16;
                                  var7 = var16;
                                  var5 = var5 - we.field_k.b(var16);
                                  if (we.field_k.b(io.field_h.toString()) > var5) {
                                    StringBuilder discarded$6 = lo.a(-26750, io.field_h, io.field_h.length() - 1, ' ');
                                    break L16;
                                  } else {
                                    break L16;
                                  }
                          ...
                          L19: {
                            ...
                            var5 = var5 - we.field_k.b(var16);
                            if (we.field_k.b(io.field_h.toString()) > var5) {
                              StringBuilder discarded$7 = lo.a(-26750, io.field_h, io.field_h.length() - 1, ' ');
                              break L19;
                            } else {
                              break L19;
                            }
                      ...
                      if (we.field_k.b(io.field_h.toString()) > var5) {
                        StringBuilder discarded$8 = lo.a(-26750, io.field_h, io.field_h.length() - 1, ' ');
                        break L8;
                      } else {
                        return true;
                      }
              ...
              L20: {
                if (var3 == 0) {
                  ...
                  if (io.field_h.length() > 0) {
                    StringBuilder discarded$9 = lo.a(-26750, io.field_h, -1 + io.field_h.length(), ' ');
                    break L20;
                  } else {
                    return true;
                  }
    ...
    ug(pk param0, String param1) {
        ...
        try {
            ...
            throw oi.a((Throwable) (Object) runtimeException, "ug.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final void a(String param0, byte param1, float param2, boolean param3) {
        ...
        try {
          ...
          throw oi.a((Throwable) (Object) stackIn_21_0, stackIn_21_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
    }
    ...
    final static void a(int param0, ah param1) {
        ...
        try {
            ...
            wf discarded$0 = var2.b();
        } catch (RuntimeException runtimeException) {
            throw oi.a((Throwable) (Object) runtimeException, "ug.U(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final static hm a(long param0, String param1, boolean param2, String param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_9_1 = new StringBuilder().append("ug.Q(").append(param0).append(44);
          ...
          throw oi.a((Throwable) (Object) stackIn_15_0, stackIn_15_2 + 44 + 121 + 41);
        }
