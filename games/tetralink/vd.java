...
final class vd {
    ...
    private final void a(boolean param0, int param1) {
        ...
        if (!param0) {
          ...
          var3 = var4;
          rd.a(((vd) this).field_d, 0, var4, 0, ((vd) this).field_d.length);
          ((vd) this).field_d = var4;
          return;
        } else {
          var4 = new int[this.b(0, param1)];
          var3 = var4;
    ...
    final int a(int param0, byte param1) {
        if (((vd) this).field_j < param0) {
          throw new ArrayIndexOutOfBoundsException(param0);
        } else {
          if (param1 != 11) {
            vd.b(true, 17);
            return ((vd) this).field_d[param0];
          } else {
            return ((vd) this).field_d[param0];
          }
        }
    ...
    final void a(byte param0, int param1) {
        if (param0 <= 79) {
          int discarded$2 = ((vd) this).a(-79, (byte) 90);
          this.a(false, param1, ((vd) this).field_j - -1);
          return;
        } else {
          this.a(false, param1, ((vd) this).field_j - -1);
          return;
