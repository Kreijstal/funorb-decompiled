...
final class nh extends hl {
    ...
    final void b(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ((nh) this).a((byte) -121, param1, param2, param6, param4);
        if (param0 != 0) {
            return;
        }
        try {
            ...
            throw oi.a((Throwable) (Object) runtimeException, "nh.B(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
    }
    ...
    nh(long param0, hl param1, hl param2, hl param3, oh param4, String param5) {
        ...
        try {
          L0: {
            L1: {
              if (null != param4) {
                ((nh) this).field_Qb = new hl(0L, param2);
                ((nh) this).field_Qb.field_vb = param4;
                ((nh) this).a((byte) -89, ((nh) this).field_Qb);
                break L1;
              } else {
                break L1;
              }
            ...
            L2: {
              if (null != param5) {
                ((nh) this).field_Rb = new hl(0L, param3, param5);
                ((nh) this).a((byte) 87, ((nh) this).field_Rb);
                break L2;
              } else {
                break L2;
              }
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("nh.<init>(").append(param0).append(44);
    ...
    final static void a(int param0, int param1, id param2, boolean param3, boolean param4) {
        ...
        try {
                                ...
                                L13: {
                                  ...
                                  if (param2.field_Q <= 0) {
                                    ...
                                    if (param2.field_u == null) {
                                      ...
                                      c.field_m[param2.field_u[var8]] = c.field_m[param2.field_u[var8]] + 1;
                                      break L13;
                                    }
                                  }
                                }
          ...
          L17: {
            ...
            stackOut_61_1 = new StringBuilder().append("nh.D(").append(param0).append(44).append(param1).append(44);
          ...
          throw oi.a((Throwable) (Object) stackIn_65_0, stackIn_65_2 + 44 + param3 + 44 + param4 + 41);
        }
    }
          ...
          L0: {
            L1: {
              ...
              if (((nh) this).field_Qb == null) {
                ...
                var4_int = ((nh) this).field_Qb.f(-76);
                break L1;
              }
            }
            L2: {
              if (((nh) this).field_Rb == null) {
                break L2;
              } else {
                var5 = ((nh) this).field_Rb.c(125, -param0 + (((nh) this).field_Hb + -param1) - (var4_int - -param1));
                break L2;
              }
            }
    ...
    final int b(int param0, int param1, int param2) {
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              if (null == ((nh) this).field_Qb) {
                ...
                var4_int = ((nh) this).field_Qb.f(param0 + 26480);
                break L2;
              }
            }
            L3: {
              if (null == ((nh) this).field_Rb) {
                ...
                var5 = ((nh) this).field_Rb.f(-64);
                break L3;
              }
            }
            stackOut_7_0 = param2 + var5 + (param1 + param2 + var4_int);
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var4 = decompiledCaughtException;
          throw oi.a((Throwable) (Object) var4, "nh.A(" + param0 + 44 + param1 + 44 + param2 + 41);
        }
        return stackIn_8_0;
    }
