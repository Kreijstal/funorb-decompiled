...
final class ob extends fc {
          ...
          if (var8 < 50) {
            L2: {
              ...
              if (var10 < 50) {
                ...
                var4++;
                field_w[incrementValue$0] = var13 + (((this.field_j[param0] & 65535) - var13) * var14 >> 16);
                break L2;
              }
            }
            if (var9 < 50) {
              ...
              var4++;
              field_w[incrementValue$1] = var13 + (((this.field_M[param0] & 65535) - var13) * var14 >> 16);
              break L1;
            }
          } else {
            ...
            var4++;
            field_w[incrementValue$2] = this.field_hb[param0] & 65535;
            break L1;
          }
        }
        L3: {
          if (var9 < 50) {
            L4: {
              ...
              if (var8 < 50) {
                ...
                var4++;
                field_w[incrementValue$3] = var13 + (((this.field_hb[param0] & 65535) - var13) * var14 >> 16);
                break L4;
              }
            }
            if (var10 < 50) {
              ...
              var4++;
              field_w[incrementValue$4] = var13 + (((this.field_j[param0] & 65535) - var13) * var14 >> 16);
              break L3;
            }
          } else {
            ...
            var4++;
            field_w[incrementValue$5] = this.field_M[param0] & 65535;
            break L3;
          }
        }
        L5: {
          if (var10 < 50) {
            L6: {
              ...
              if (var9 < 50) {
                ...
                var4++;
                field_w[incrementValue$6] = var13 + (((this.field_M[param0] & 65535) - var13) * var14 >> 16);
                break L6;
              }
            }
            if (var8 < 50) {
              ...
              var4++;
              field_w[incrementValue$7] = var13 + (((this.field_hb[param0] & 65535) - var13) * var14 >> 16);
              break L5;
            }
          } else {
            ...
            var4++;
            field_w[incrementValue$8] = this.field_j[param0] & 65535;
            break L5;
          }
        }
        L7: {
    ...
    final fc a(boolean param0, boolean param1, boolean param2) {
        if (!param0 && field_cb.length < this.field_ob) {
            field_cb = new byte[this.field_ob + 100];
        }
        if (!param1 && field_h.length < this.field_ob) {
                              ...
                              if (var9 <= 0) {
                                ...
                                L9: while (true) {
                                  if (var12 >= var10) {
                                    ...
                                    dupTemp$0 = field_W[var14_int];
                                    field_W[var14_int] = dupTemp$0 + 1;
                                    var15_int = dupTemp$0;
                            ...
                            if (var9 > 64) {
                              ...
                              L10: while (true) {
                                if (var12 < field_P[var10]) {
                                  var13 = var48[var12];
                                  var14_int = this.field_U[var13];
                                  dupTemp$1 = field_W[var14_int];
                                  field_W[var14_int] = dupTemp$1 + 1;
                                  var15_int = dupTemp$1;
                                  field_g[var14_int][var15_int] = var13;
                                  if (var14_int >= 10) {
                                    if (var14_int != 10) {
                      ...
                      if (var8 >= 12) {
                        ...
                        L17: while (true) {
                          if (var8 >= var7) {
                            ...
                            dupTemp$2 = field_W[var11];
                            field_W[var11] = dupTemp$2 + 1;
                            var12 = dupTemp$2;
                    ...
                    if (var16 * var24 + var19 * var25 + var22 * var26 > 0) {
                      ...
                      if (!field_Z) {
                        ...
                        if (field_H[var27] >= 64) {
                          ...
                          arrayValue$9 = field_f[var28];
                          field_P[var28] = dupTemp$8 + 1;
                          arrayValue$9[dupTemp$8] = var8;
                          var8++;
                          continue L3;
                        } else {
                          dupTemp$10 = field_H[var27];
                          arrayValue$11 = field_ab[var27];
                          field_H[var27] = dupTemp$10 + 1;
                        ...
                        var7++;
                        field_z[incrementValue$12] = var8;
                        var8++;
                        continue L3;
                      }
                    } else {
                ...
                L43: {
                  if (!param1) {
                    ...
                    if (!this.a(bl.field_Mb + vn.field_a, li.field_b + vn.field_f, field_G[var9], field_G[var10], field_G[var11], var12, var13, var14_int)) {
                      ...
                      fieldTemp$13 = fd.field_I;
                      fd.field_I = fd.field_I + 1;
                      cb.field_r[fieldTemp$13] = param2;
                      param1 = false;
                      break L43;
                    }
                  }
                ...
                if ((var12 - var13) * (field_G[var11] - field_G[var10]) - (field_G[var9] - field_G[var10]) * (var14_int - var13) > 0) {
                  ...
                  if (!field_Z) {
                    ...
                    if (field_H[var15_int] >= 64) {
                      L46: {
                        ...
                        if (var16 != 64) {
                          ...
                          if (field_X != 512) {
                            ...
                            field_H[var15_int] = 65 + fieldTemp$14;
                            break L46;
                          } else {
                            var8++;
                            continue L3;
                      ...
                      arrayValue$16 = field_f[var16];
                      field_P[var16] = dupTemp$15 + 1;
                      arrayValue$16[dupTemp$15] = var8;
                      var8++;
                      continue L3;
                    } else {
                      dupTemp$17 = field_H[var15_int];
                      arrayValue$18 = field_ab[var15_int];
                      field_H[var15_int] = dupTemp$17 + 1;
                    ...
                    var7++;
                    field_z[incrementValue$19] = var8;
                    var8++;
                    continue L3;
                  }
                } else {
              ...
              L4: while (true) {
                if (var10 >= this.field_ob) {
                  ...
                  if (param0.field_q[var10] != -1) {
                    dupTemp$1 = param0.field_q[var10] & 255;
                    ...
                    if (var9_int >= var14.field_ob) {
                      ...
                      L21: {
                        if (var6 == 0) {
                          ...
                          L22: {
                            L23: {
                              stackIn_51_0 = this.field_u;

                              stackIn_51_1 = this.field_ob;
                              ...
                              if (var14.field_u == null) {
                                ...
                                if (var11.field_u[var9_int] == -1) {
                                  ...
                                  stackIn_52_2 = var11.field_u[var9_int] + this.field_E;
                                  break L22;
                                }
                              }
                            }
