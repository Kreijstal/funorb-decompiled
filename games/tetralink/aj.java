...
final class aj {
    ...
    public final void movemouse(int param0, int param1) {
        ((aj) this).field_b.mouseMove(param0, param1);
    }

    public aj() throws Exception {
        java.awt.Robot var2 = new java.awt.Robot();
        ((aj) this).field_b = var2;
    }
              ...
              if (param0 != null) {
                if (((aj) this).field_a != param0) {
                  if (null == ((aj) this).field_a) {
                    ...
                    L1: {
                      ((aj) this).field_a.setCursor((java.awt.Cursor) null);
                      ((aj) this).field_a = null;
                      if (param0 != null) {
                        param0.setCursor(param0.getToolkit().createCustomCursor((java.awt.Image) (Object) new java.awt.image.BufferedImage(1, 1, 2), new java.awt.Point(0, 0), (String) null));
                        ((aj) this).field_a = param0;
                        break L1;
