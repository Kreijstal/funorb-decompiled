...
class ka extends hm {
    ...
    final static void b(int param0) {
        ...
        ei stackIn_66_0 = null;
        double stackIn_66_1 = 0.0;
        ei stackIn_67_0 = null;
        double stackIn_67_1 = 0.0;
        ei stackIn_68_0 = null;
        double stackIn_68_1 = 0.0;
        int stackIn_68_2 = 0;
        ei stackIn_69_0 = null;
        double stackIn_69_1 = 0.0;
        int stackIn_69_2 = 0;
        double stackIn_69_3 = 0.0;
        ei stackIn_70_0 = null;
        double stackIn_70_1 = 0.0;
        int stackIn_70_2 = 0;
        double stackIn_70_3 = 0.0;
        ei stackIn_71_0 = null;
        double stackIn_71_1 = 0.0;
        int stackIn_71_2 = 0;
        ...
        ei stackOut_65_0 = null;
        double stackOut_65_1 = 0.0;
        ei stackOut_67_0 = null;
        double stackOut_67_1 = 0.0;
        int stackOut_67_2 = 0;
        ei stackOut_66_0 = null;
        double stackOut_66_1 = 0.0;
        int stackOut_66_2 = 0;
        ei stackOut_68_0 = null;
        double stackOut_68_1 = 0.0;
        int stackOut_68_2 = 0;
        double stackOut_68_3 = 0.0;
        ei stackOut_70_0 = null;
        double stackOut_70_1 = 0.0;
        int stackOut_70_2 = 0;
        double stackOut_70_3 = 0.0;
        int stackOut_70_4 = 0;
        ei stackOut_69_0 = null;
        double stackOut_69_1 = 0.0;
        int stackOut_69_2 = 0;
                      ...
                      L3: {
                        ...
                        if (dd.field_a != 0) {
                          ...
                          if (wk.field_u != 0) {
                            ...
                            wb.a(qb.a(kb.field_t, (byte) 114), param0 ^ -7865);
                            break L2;
                          } else {
                            break L3;
                          }
                  ...
                  if (param0 == 4) {
                    ...
                    L8: {
                      ...
                      if (wk.field_i.field_c) {
                        ...
                        ua.field_i = (double)(200 + (-ik.field_a + a.field_a));
                        wh.field_c = (double)aa.field_Nb;
                        break L8;
                      }
                    }
                    L12: {
                      if (null == aa.field_bc) {
                        stackOut_62_0 = ud.field_Qb;
                        stackIn_63_0 = stackOut_62_0;
                        break L12;
                      } else {
                        stackOut_61_0 = aa.field_bc;
                    ...
                    L13: {
                      ...
                      if (var2 != null) {
                        ...
                        ((ei) (Object) stackIn_71_0).a(stackIn_71_1, stackIn_71_2 != 0, stackIn_71_3, stackIn_71_4 != 0, (byte) -115, var1 != 0, ho.field_X, tm.field_t);
                        break L13;
                      } else {
                        break L13;
                      }
                    ...
                    L16: {
                      if (!fd.a(kb.field_t, (byte) 99)) {
                        break L16;
                      } else {
                        kk.field_X[kb.field_t].a(var1 != 0, ua.field_i, tm.field_t, wh.field_c, tm.field_t, -128);
                        break L16;
                      }
                    }
                    L17: {
                            ...
                            if (ab.field_T == -1) {
                              ...
                              if (aa.field_Nb == -1) {
                                ...
                                if (a.field_a != -1) {
                                  ...
                                  ab.field_T = aa.field_Nb;
                                  wh.field_i = a.field_a;
                                  break L17;
                                }
                              }
                            }
    ...
    final static String c(byte param0) {
        if (ma.field_d == ll.field_C) {
            return ek.field_s;
        }
        int var1 = -115 % ((-27 - param0) / 33);
        return ll.field_w;
    }
    ...
    ka(long param0, String param1) {
        try {
            ...
            throw oi.a((Throwable) (Object) runtimeException, "ka.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
