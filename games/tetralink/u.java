    ...
    final static String a(int param0, fj param1) {
        ...
        try {
              ...
              if (-3 == (param1.field_i ^ -1)) {
                  ...
                  L5: {
                    if (param1.field_g != 0) {
                      ...
                      if (0 != param1.field_s) {
                        ...
                        var3 = sk.a(new String[]{(String) (var2)}, vd.field_b, 119);
                        break L4;
                      }
                    }
                  }
                  var3 = sk.a(new String[]{(String) (var2)}, mc.field_h, param0 ^ 18544);
                  break L4;
                } else {
                  break L4;
                }
                ...
                L7: {
                  if (param1.field_i != 1) {
                    ...
                    var3 = "[" + sk.a(new String[]{param1.field_c}, qe.field_e, 127) + "] ";
                    break L7;
                  }
                }
                L8: {
          ...
          L10: {
            ...
            stackOut_31_0 = var2;
            stackOut_31_1 = new StringBuilder().append("u.D(").append(param0).append(',');
    ...
    u(int param0, ah param1, ah param2, sm param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (this.field_e == null) {
                ...
                discarded$4 = this.field_e.b(-23126, 1);
                break L1;
              }
            }
            if (null != this.field_c) {
              discarded$5 = this.field_c.b(-23126, 1);
              break L0;
            } else {
              return;
            }
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("u.<init>(").append(param0).append(',');
