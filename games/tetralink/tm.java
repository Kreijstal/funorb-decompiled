    ...
    final static void a(byte param0, int param1, hl param2, int param3, int param4, hl param5, byte[] param6, hl param7, int param8, int param9) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_15_1 = new StringBuilder().append("tm.T(").append(param0).append(44).append(param1).append(44);
            stackIn_17_0 = stackOut_15_0;
          ...
          throw oi.a((Throwable) (Object) stackIn_27_0, stackIn_27_2 + 44 + param8 + 44 + param9 + 41);
        }
    }
