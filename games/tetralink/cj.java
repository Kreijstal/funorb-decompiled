...
final class cj {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((cj) this).field_e.length;
        var4 = field_c[((cj) this).field_d - 1];
        var5 = field_g;
        field_g[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_h[0] * ((cj) this).field_d;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_i[var16];
                  var10 = field_h[var16] * ((cj) this).field_d;
            ...
            L3: {
              var7 = cj.a(field_i, var6);
              var8_int = cj.b(field_i, var6);
    ...
    cj() {
        ...
        if (var1 == 1) {
          var2 = ag.d(5);
          var3 = 0;
          ((cj) this).field_j = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((cj) this).field_a = new int[var3];
              ((cj) this).field_l = new int[var3];
              ((cj) this).field_k = new int[var3];
              ((cj) this).field_f = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((cj) this).field_d = ag.d(2) + 1;
                  var4 = ag.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((cj) this).field_e = new int[var5];
                      ((cj) this).field_e[0] = 0;
                      ((cj) this).field_e[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((cj) this).field_a[((cj) this).field_j[var6]];
                      var6++;
                      continue L2;
                    }
                  }
    ...
    final boolean a() {
        ...
        int var2 = ((cj) this).field_e.length;
        System.arraycopy((Object) (Object) ((cj) this).field_e, 0, (Object) (Object) field_i, 0, var2);
        int var3 = field_c[((cj) this).field_d - 1];
        int var4 = ja.c(-7422, var3 - 1);
        field_h[0] = ag.d(var4);
        field_h[1] = ag.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((cj) this).field_j.length; var6++) {
            var7 = ((cj) this).field_j[var6];
            var8 = ((cj) this).field_a[var7];
            var9 = ((cj) this).field_l[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ag.field_Q[((cj) this).field_k[var7]].b();
            }
