...
final class cj {
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_a[var7]) {
                              ...
                              var5++;
                              this.field_e[incrementValue$2] = ag.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_a[this.field_j[var6]];
                      var6++;
                      continue L2;
                    }
                  }
    ...
    final boolean a() {
        ...
        int var3 = field_c[this.field_d - 1];
        ...
        for (var6 = 0; var6 < this.field_j.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = ag.field_Q[this.field_k[var7]].b();
            }
