...
final class ji extends hl {
        ...
        try {
          L0: {
            if (param1.c(103)) {
              ...
              stackOut_5_0 = param0 + " - " + param1.a(param3, true) + "%";
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("ji.D(");
          ...
          throw oi.a((Throwable) (Object) stackIn_19_0, stackIn_19_2 + 44 + param4 + 41);
        }
        return stackIn_6_0;
    }
    ...
    ji(long param0, hl param1, hl param2, bl param3, hl param4, String param5, String param6) {
        ...
        try {
            ...
            throw oi.a((Throwable) (Object) runtimeException, "ji.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 44 + (param3 != null ? "{...}" : "null") + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + (param6 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final static void a(ah param0) {
        ...
        try {
              ...
              if (var4 >= var3) {
                ...
                L2: while (true) {
                  if (var3 <= var9) {
                    ...
                    var5.a(1, 6, true, 6, 6);
                    var5.b(false);
                    var6 = new int[]{var5.field_a - -var5.field_j >> 1, var5.field_L + var5.field_f >> 1, var5.field_P + var5.field_m >> 1};
                    da.field_b[var9] = var6;
                    var5.a(-var6[2], 5336, -var6[0], -var6[1]);
                    var9++;
                    continue L2;
                  }
                }
              } else {
                wa.field_f[var4] = lj.a(-16483, var8);
                var4++;
                continue L1;
              }
            }
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("ji.F(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
