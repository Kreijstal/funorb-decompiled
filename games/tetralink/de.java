...
final class de extends jb {
            ...
            if (param4 > 0) {
              L5: {
                if (ra.field_k == null) {
                  ...
                  de.a(ra.field_b, this.field_R[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, ra.field_k, ra.field_h);
                  break L5;
                }
              }
              return;
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$0] == 0) {
                  ...
                  param8++;
                  ra.field_b[incrementValue$1] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        int var13 = 0;
        int var9 = param1 + param2 * ra.field_f;
        int var10 = ra.field_f - param3;
        int var11 = 0;
        int var12 = 0;
        if (param2 < ra.field_i) {
