...
final class de extends jb {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * ra.field_f;
          var9 = ra.field_f - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= ra.field_i) {
            break L0;
          } else {
            var12 = ra.field_i - param2;
            param4 = param4 - var12;
            param2 = ra.field_i;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * ra.field_f;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= ra.field_g) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - ra.field_g);
            break L1;
          }
        }
        L2: {
          if (param1 >= ra.field_j) {
            break L2;
          } else {
            var12 = ra.field_j - param1;
            param3 = param3 - var12;
            param1 = ra.field_j;
            var11 = var11 + var12;
            var8 = var8 + var12;
        ...
        L3: {
          if (param1 + param3 <= ra.field_l) {
            break L3;
          } else {
            var12 = param1 + param3 - ra.field_l;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (ra.field_k == null) {
                  de.a(ra.field_b, ((de) this).field_R[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  de.a(ra.field_b, ((de) this).field_R[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, ra.field_k, ra.field_h);
                  break L5;
                }
              }
              return;
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19 = 0;
        int var20 = 0;
        var13 = param2 - ra.field_j;
        var14 = param3 - ra.field_i;
        var15 = var14;
        L0: while (true) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  ra.field_b[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * ra.field_f;
          var10 = ra.field_f - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= ra.field_i) {
            break L0;
          } else {
            var13 = ra.field_i - param2;
            param4 = param4 - var13;
            param2 = ra.field_i;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * ra.field_f;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= ra.field_l) {
            ...
            var13 = param1 + param3 - ra.field_l;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              de.a(ra.field_b, ((de) this).field_R[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    de(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        super(param0, param1, param2, param3, param4);
        ((de) this).field_R = new byte[256][];
        ((de) this).field_R = param5;
    }
}
