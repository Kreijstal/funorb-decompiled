    ...
    final static kh a(boolean param0, int[] param1, kh param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("gb.TA(").append(param0).append(',');
    ...
    final static void a(byte param0, boolean param1) {
        ...
        L3: {
          if (param0 <= -68) {
            ...
            var4 = (kh) null;
            discarded$1 = gb.a(false, (int[]) null, (kh) null);
            break L3;
          }
        }
    }
    ...
    final static dk a(byte param0, java.applet.Applet param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_14_1 = new StringBuilder().append("gb.UA(").append(param0).append(',');
