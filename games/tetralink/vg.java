            ...
            L1: while (true) {
              if (!nj.b((byte) 28)) {
                ...
                L2: {
                  if (dg.field_e != 85) {
                    ...
                    if ((this.field_Tb.length() ^ -1) < -1) {
                      discarded$26 = lo.a(-26750, this.field_Tb, this.field_Tb.length() - 1, ' ');
                      break L2;
                    } else {
                      break L2;
                    }
                ...
                L3: {
                  ...
                  discarded$27 = this.field_Tb.append(tb.field_m);
                  break L3;
                }
                if (dg.field_e != 84) {
                  if (13 == dg.field_e) {
        ...
        if (-1 != (this.field_Qb ^ -1)) {
          ...
          L1: {
            if (dg.field_e != 85) {
              ...
              if (0 < this.field_Tb.length()) {
                discarded$6 = lo.a(-26750, this.field_Tb, this.field_Tb.length() + -1, ' ');
                break L1;
              } else {
                break L1;
              }
          ...
          L2: {
            if (-13 >= (this.field_Tb.length() ^ -1)) {
              ...
              L4: {
                if (95 != var2) {
                  ...
                  if (this.field_Tb.length() > 0) {
                    discarded$7 = this.field_Tb.append((char) var2);
                    break L4;
                  } else {
                    break L4;
                  }
              ...
              discarded$8 = this.field_Tb.append((char) var2);
              break L2;
            }
          }
          L6: {
    ...
    final static void a(byte param0, ah param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("vg.E(").append(param0).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
