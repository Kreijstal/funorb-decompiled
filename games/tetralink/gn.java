...
class gn extends na implements nf {
    ...
    final void c(na param0, int param1) {
        ...
        try {
            if (param1 != 10) {
                na var4 = (na) null;
                discarded$0 = this.a(-79, 'Y', -110, (na) null);
            }
    ...
    final boolean a(int param0, na param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_14_1 = new StringBuilder().append("gn.NA(").append(param0).append(',');
    ...
    private final void a(byte param0, StringBuilder param1, int param2, Hashtable param3) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (var6 == null) {
                ...
                L3: while (true) {
                  if (param2 < var7) {
                    discarded$13 = var6.a(param3, param1, 1 + param2, -372494750);
                    var6 = (na) ((Object) var5.b((byte) -58));
                    continue L2;
                  } else {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("gn.CC(").append(param0).append(',');
    ...
    final static void a(int param0, int param1, int param2, byte[] param3, int[] param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("gn.EC(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final void a(int param0, boolean param1, na param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("gn.AB(").append(param0).append(',').append(param1).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    boolean a(int param0, char param1, int param2, na param3) {
        ...
        try {
            ...
            if (param2 == 1) {
              ...
              L1: while (true) {
                ...
                if (var6 == 80) {
                  L4: {
                    if (!sn.field_a[81]) {
                      stackOut_17_0 = this.b(param3, param2 ^ 114);
                      stackIn_18_0 = stackOut_17_0;
                      break L4;
                    } else {
                      stackOut_16_0 = this.d(param3, -99);
          ...
          L5: {
            ...
            stackOut_19_1 = new StringBuilder().append("gn.DB(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_21_0 = stackOut_19_0;
            stackIn_21_1 = stackOut_19_1;
            stackIn_20_0 = stackOut_19_0;
