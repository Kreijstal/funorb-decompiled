            ...
            if (1 != param1) {
              if (param1 != 2) {
                if (param1 != 3) {
                  if (param1 != 4) {
                    if (param1 == 5) {
                      stackOut_14_0 = sk.a(new String[1], sn.field_f, 120);
                      stackIn_15_0 = stackOut_14_0;
                      return stackIn_15_0;
                    } else {
                      if (param1 != 6) {
                        if (param1 == 7) {
                          stackOut_21_0 = sk.a(new String[1], hm.field_c, 119);
                          stackIn_22_0 = stackOut_21_0;
                          return stackIn_22_0;
                        } else {
                          if (param1 == 8) {
                            stackOut_25_0 = sk.a(new String[1], field_i, 121);
                            stackIn_26_0 = stackOut_25_0;
                            return stackIn_26_0;
                          } else {
                            if (param1 == 11) {
                              stackOut_29_0 = sk.a(new String[1], pm.field_d, 123);
                              stackIn_30_0 = stackOut_29_0;
                              return stackIn_30_0;
                            } else {
                              if (param1 != 12) {
                                if (param1 == 13) {
                                  stackOut_36_0 = sk.a(new String[1], hb.field_e, 120);
                                ...
                                stackOut_32_0 = sk.a(new String[1], im.field_a, 126);
                        ...
                        stackOut_17_0 = sk.a(new String[1], eo.field_d, 124);
                        stackIn_18_0 = stackOut_17_0;
                        return stackIn_18_0;
                      }
                    }
                  } else {
                    stackOut_10_0 = sk.a(new String[1], jg.field_d, 125);
                    stackIn_11_0 = stackOut_10_0;
                    return stackIn_11_0;
                  }
                } else {
                  stackOut_7_0 = sk.a(new String[1], hd.field_z, 124);
                  stackIn_8_0 = stackOut_7_0;
                  return stackIn_8_0;
                }
              } else {
                stackOut_4_0 = sk.a(new String[1], mi.field_Mb, 127);
                stackIn_5_0 = stackOut_4_0;
                return stackIn_5_0;
              }
            } else {
              stackOut_1_0 = sk.a(new String[1], kd.field_k, 121);
