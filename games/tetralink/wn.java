...
final class wn extends eb {
    ...
    private final void a(boolean param0, int param1, oc param2) {
        ...
        try {
            ...
            L1: {
              if ((((wn) this).field_r.field_I[param2.field_n] & 4) == 0) {
                ...
                if (0 <= param2.field_v) {
                  ...
                  var4_int = ((wn) this).field_r.field_T[param2.field_n] / nk.field_k;
                  var5 = (1048575 + var4_int - param2.field_F) / var4_int;
                  param2.field_F = param2.field_F - -(var4_int * param1) & 1048575;
                  if (var5 <= param1) {
                    L2: {
                      if (((wn) this).field_r.field_G[param2.field_n] == 0) {
                        ...
                        L3: {
                          ...
                          if (param2.field_B.field_o[param2.field_E] >= 0) {
          ...
          L5: {
            ...
            stackOut_17_1 = new StringBuilder().append("wn.D(").append(0).append(44).append(param1).append(44);
    ...
    private final void a(oc param0, int[] param1, int param2, int param3, boolean param4, int param5) {
        ...
        try {
            ...
            L1: {
              if ((((wn) this).field_r.field_I[param0.field_n] & 4) == 0) {
                ...
                if (param0.field_v >= 0) {
                  ...
                  var7_int = ((wn) this).field_r.field_T[param0.field_n] / nk.field_k;
                  L2: while (true) {
          ...
          L7: {
            ...
            stackOut_23_1 = new StringBuilder().append("wn.A(");
          ...
          throw oi.a((Throwable) (Object) stackIn_29_0, stackIn_29_2 + 44 + param2 + 44 + param3 + 44 + 0 + 44 + param5 + 41);
        }
    }
                  ...
                  if (((wn) this).field_r.b((byte) 127, var6)) {
                    ...
                    L3: while (true) {
                      if (var6.field_s >= var5) {
                        ...
                        if (((wn) this).field_r.a(var4_int, param0, var5, var6, 21107)) {
                          break L2;
                        } else {
                          continue L3;
                        }
    ...
    wn(g param0) {
        ...
        try {
            ...
            throw oi.a((Throwable) (Object) runtimeException, "wn.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
