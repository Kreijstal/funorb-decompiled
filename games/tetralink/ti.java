...
final class ti {
    ...
    final static boolean a(int param0, CharSequence param1, boolean param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_18_1 = new StringBuilder().append("ti.E(").append(param0).append(',');
    ...
    public static void a(int param0) {
        ...
        try {
          ...
          throw oi.a((Throwable) (Object) var1, "ti.A(" + param0 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, int param2, ve param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("ti.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
