...
abstract class jb extends gb {
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$0 = field_D.append('<');
                        discarded$1 = field_D.append(var15);
                        discarded$2 = field_D.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$3 = field_D.append((char) var14);
                        var14 = (char)(rh.a((char) var14, false) & 255);
                        var4 = var4 + this.field_F[var14];
                        if (this.field_E == null) {
                          break L15;
                        } else {
                          if (var10 == 0) {
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        if (param0 != null) {
          ...
          L1: {
            ...
            if (param4 >= this.field_N + this.field_K + param10) {
              break L1;
            } else {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - this.field_N - this.field_K - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + this.field_N + var15;
                ...
                var14 = param2 + this.field_N + (param4 - this.field_N - this.field_K - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + this.field_N;
              break L3;
            }
          }
          var15 = 0;
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.a(field_C[var15], param1 + param3 - this.b(field_C[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.a(field_C[var15], param1 + (param3 - this.b(field_C[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                                      ...
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_E[(var7 << 8) + var8] = (byte)jb.a(var15, var16, var17, this.field_F, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                this.field_F[var3_int] = param0[incrementValue$6] & 255;
                var3_int++;
                continue L1;
              }
            }
            ...
            L10: while (true) {
              if (var2 >= this.field_F.length) {
                ...
                this.field_F[var2] = param0[var2] & 255;
                var2++;
                continue L10;
              }
            }
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var10 = rc.a(var13, 10);
                                            var11_ref_oi = this.field_z[var10];
                                            if (this.field_J == null) {
                                              stackIn_26_0 = var11_ref_oi.field_f;
                                              break L3;
                                            } else {
                                              stackIn_26_0 = this.field_J[var10];
                                              break L3;
                                            }
                                          }
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_A != 256) {
                                              var11_ref_oi.a(param1, param2 + this.field_H - var12, field_A);
                                              break L4;
                                            } else {
                                              var11_ref_oi.a(param1, param2 + this.field_H - var12);
                                              break L4;
                                            }
                                          }
                    ...
                    if (field_A != 256) {
                      L8: {
                        if (field_v == -1) {
                          ...
                          this.a(var8, param1 + this.field_G[var8] + 1, param2 + this.field_M[var8] + 1, var9, var10, field_v, field_A, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_G[var8], param2 + this.field_M[var8], var9, var10, field_y, field_A, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_v == -1) {
                          ...
                          this.a(var8, param1 + this.field_G[var8] + 1, param2 + this.field_M[var8] + 1, var9, var10, field_v, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_G[var8], param2 + this.field_M[var8], var9, var10, field_y, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  param1 = param1 + this.field_F[var8];
                  if (field_I == -1) {
                    break L10;
                  } else {
                    ra.g(var11, param2 + (int)((double)this.field_H * 0.7), param1 - var11, field_I);
                    break L10;
                  }
                }
                L11: {
                  if (field_t == -1) {
                    ...
                    ra.g(var11, param2 + this.field_H + 1, param1 - var11, field_t);
                    break L11;
                  }
                }
                var5 = var8;
    ...
    final int b(String param0, int param1, int param2) {
        ...
        return this.field_N + var5 + this.field_K;
    }
    ...
    final int a(char param0) {
        return this.field_F[rh.a(param0, false) & 255];
    }
    ...
    jb(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_N = this.field_H - var6;
            this.field_K = var7 - this.field_H;
            this.field_u = this.field_H - this.field_M[88];
            return;
          } else {
            L1: {
            ...
            if (this.field_M[var8] + this.field_Q[var8] > var7) {
              var7 = this.field_M[var8] + this.field_Q[var8];
              var8++;
              continue L0;
            } else {
              var8++;
