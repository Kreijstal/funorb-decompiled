            ...
            if (gi.a(false, var6)) {
              if (ji.field_Tb == 2) {
                if (ej.a(param1, 4)) {
                  ...
                  if (oj.a(1, param1)) {
                    stackOut_12_0 = sk.a(new String[1], tc.field_n, 123);
                    ...
                    if (qi.field_q < 200) {
                      if (!sb.a((byte) 2, param1)) {
                        ...
                        stackOut_22_0 = sk.a(new String[1], rh.field_J, 126);
                        stackIn_23_0 = stackOut_22_0;
                        return stackIn_23_0;
                      }
                    } else {
                      stackOut_19_0 = ha.field_g;
                                        ...
                                        if (var6_int != 3) {
                                          ...
                                          L8: while (true) {
                                            if (var12_int >= var9) {
                                              ...
                                              param2.b(var13, 0, var24[var12_int], -25);
                                              var12_int++;
                                              continue L8;
                                            }
                                          }
