...
final class ci extends mf {
    ...
    final static void a(int param0, rb param1, boolean param2, int param3, int param4) {
        ...
        int stackIn_40_0 = 0;
        int stackIn_51_0 = 0;
        hl stackIn_86_0 = null;
        int stackIn_86_1 = 0;
        int stackIn_86_2 = 0;
        hl stackIn_87_0 = null;
        int stackIn_87_1 = 0;
        int stackIn_87_2 = 0;
            ...
            L17: {
              ...
              if (var12.d((byte) -1)) {
                ...
                L21: {
                  ...
                  if (param1 != v.field_x) {
                    if (var12.field_cc) {
                      var12.field_Wb.field_jb = sk.a(new String[1], bj.field_a, 126);
                        ...
                        if (var12.field_Vb.field_jb != null) {
                          L24: {
                            if (v.field_x == param1) {
                              ...
                              var26 = var12.field_Vb.f(-64) - -(2 * fn.field_Q);
                              break L24;
                            }
                          }
                ...
                L25: {
                  stackOut_85_0 = var12.field_Wb;
                  stackOut_85_1 = -108;
                  stackOut_85_2 = -var25_int;
                  ...
                  if (kj.field_b) {
                    stackOut_87_0 = (hl) (Object) stackIn_87_0;
                    ...
                    stackOut_86_0 = (hl) (Object) stackIn_86_0;
                ...
                L26: {
                  ((hl) (Object) stackIn_88_0).a((byte) stackIn_88_1, stackIn_88_2 + -stackIn_88_3 + var12.field_Hb, var19, qe.field_d, var25_int);
              ...
              if (var12.field_F == 0) {
                ...
                if (var12.d((byte) -1)) {
                  ...
                  if (var12.field_ac.field_F == 0) {
                    ...
                    q.a(11, (byte) -118, var12.field_Nb);
                    break L30;
                  }
                }
              }
                        ...
                        if (~var6 >= ~var12.field_Pb) {
                          if ((~var12.field_Ub & var8) == 0) {
                            ...
                            L35: {
                              ...
                              var24 = sk.a(new String[1], o.field_o, 122);
                              if (0 >= var25_int) {
                                break L35;
                              } else {
                                if (null == pd.field_t) {
                                  ...
                                  if (~pd.field_t.length > ~var25_int) {
                                    ...
                                    if (null == pd.field_t[-1 + var25_int]) {
                                      ...
                                      var24 = sk.a(new String[1], pd.field_t[var25_int + -1][2], 126);
                                      break L35;
                                    }
                                  }
                                }
                      ...
                      if (var12.field_Qb < var7) {
                        ...
                        if (var12.field_Pb >= var6) {
                          if ((var8 & ~var12.field_Ub) != 0) {
                            L38: {
                              var25_int = fa.a(~var12.field_Ub & var8, -24338);
                              var24 = jo.field_b;
                              if (var25_int <= 0) {
                                break L38;
                              } else {
    ...
    final static void a(String param0, int param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ci.B(");
          ...
          throw oi.a((Throwable) (Object) stackIn_5_0, stackIn_5_2 + ',' + -14710 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, oh[] param4, int param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("ci.G(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
          ...
          throw oi.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + ',' + -119 + ')');
        }
    }
