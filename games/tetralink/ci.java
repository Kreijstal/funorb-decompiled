...
final class ci extends mf {
    ...
    final static void a(int param0, rb param1, boolean param2, int param3, int param4) {
        ...
        int stackIn_38_2;
        int stackIn_38_3;
        boolean stackIn_38_4;
        rb stackIn_39_0 = null;
        int stackIn_39_1 = 0;
        int stackIn_39_2 = 0;
        int stackIn_39_3 = 0;
        ...
        try {
          L0: {
            ...
            L9: {
              stackIn_38_0 = (rb) (param1);

              stackIn_38_1 = 2;

              stackIn_38_2 = (qe.field_d - -2) * 2;
            ...
            L10: {
              if (!((rb) (Object) stackIn_39_0).a(stackIn_39_1, stackIn_39_2, stackIn_39_3, stackIn_39_4, stackIn_39_5 != 0, param0 * (4 * qe.field_d + 8))) {
                stackIn_42_0 = 0;
                break L10;
              } else {
                stackIn_42_0 = 1;
              ...
              if (var12 == null) {
                ...
                L18: {
                  ...
                  if (var12.d((byte) -1)) {
                    ...
                    L22: {
                      ...
                      if (param1 != v.field_x) {
                        if (var12.field_cc) {
                          var12.field_Wb.field_jb = sk.a(new String[]{var20}, bj.field_a, param3 ^ -127);
                          ...
                          if (!var12.field_Kb) {
                            ...
                            var12.field_Wb.field_jb = sk.a(new String[]{var20}, qh.field_l, 125);
                    ...
                    L26: {
                      stackIn_91_0 = var12.field_Wb;

                      stackIn_91_1 = -108;

                      stackIn_91_2 = -var25_int;

                      if (kj.field_b) {
                        stackIn_92_0 = (hl) ((Object) stackIn_91_0);
                    ...
                    L27: {
                      ((hl) (Object) stackIn_92_0).a((byte) stackIn_92_1, stackIn_92_2 + -stackIn_92_3 + var12.field_Hb, var19, qe.field_d, var25_int);
                ...
                L30: {
                  if (var13 == 0) {
                    ...
                    param1.field_Pb.a((hl) (var11), true, var12, 2);
                    break L30;
                  }
                }
                L31: {
                      ...
                      L33: {
                        ...
                        if (var12.field_Nb != oj.field_c) {
                          L34: {
                            if (var5_int == 0) {
                              ...
                              if (var12.field_Tb) {
                                ...
                                var24 = sk.a(new String[]{var20}, lh.field_w, 124);
                                break L33;
                              }
                            }
                          }
                          if (var7 > var12.field_Qb) {
                            L35: {
                              ...
                              if (var25_int != 1) {
                                ...
                                var24 = sk.a(new String[]{var20}, k.field_b, 121);
                                break L35;
                              }
                            }
                            var24 = sk.a(new String[]{var20, Integer.toString(var25_int)}, field_C, 123);
                            var30 = var24;
                            var25 = var30;
                            var24 = var25;
                            var30 = var24;
                            ...
                            if (var6 <= var12.field_Pb) {
                              if (((var12.field_Ub ^ -1) & var8) == 0) {
                                ...
                                var24 = sk.a(new String[]{var20}, o.field_o, param3 + 123);
                                if (0 >= var25_int) {
                                  break L33;
                                } else {
                                  if (null == pd.field_t) {
                                    ...
                                    if (pd.field_t.length < var25_int) {
                                      ...
                                      if (null == pd.field_t[-1 + var25_int]) {
                                        ...
                                        var24 = sk.a(new String[]{var20}, pd.field_t[var25_int + -1][2], param3 + 127);
                                        break L33;
                                      }
                                    }
                                  }
                              ...
                              var24 = sk.a(new String[]{var20, Integer.toString(var6)}, tl.field_Y, 121);
                              break L33;
                            }
                          }
                        } else {
                          ...
                          if (var12.field_Qb < var7) {
                            ...
                            var24 = sk.a(new String[]{null, Integer.toString(var25_int)}, tk.field_d, 124);
                            break L33;
                          } else {
                            if (var12.field_Pb >= var6) {
                              ...
                              var24 = sk.a(new String[]{null, Integer.toString(var6)}, ae.field_M, 121);
                              break L33;
                            }
                          }
                        }
                        ...
                        L38: while (true) {
                          if (var27_int >= hg.field_k) {
                            L39: {
                              L40: {
                                if (param1 != v.field_x) {
                                  ...
                                  if (!s.b(63)) {
                                    ...
                                    if (var26 == 0) {
                                      var24 = var34 + "<br>" + sk.a(new String[]{(String) (var25)}, tl.field_O, 123);
                                      break L39;
                                    } else {
                                      var24 = var34 + "<br>" + t.field_p + (String) (var25);
                                      break L39;
                                    }
                                  }
                                }
                              ...
                              if (var26 != 0) {
                                var24 = var34 + "<br>" + ve.field_f + (String) (var25);
                                break L39;
                              } else {
                                var24 = var34 + "<br>" + sk.a(new String[]{(String) (var25)}, qk.field_c, 126);
                                break L39;
                              }
                            }
                            L41: {
                              if (param1 != v.field_x) {
                                ...
                                if (s.b(63)) {
                                  ...
                                  var24 = (String) (var24) + "<br>" + sk.a(new String[]{var27}, vd.field_i, 126);
                                  break L41;
                                }
                              }
                            }
                            re.field_P = (String) (var24);
                            break L32;
                          } else {
                            L42: {
                            ...
                            if (var29 != 0) {
                              L48: {
                                var30_ref = "<col=A00000>" + ll.field_y[var27_int] + "</col>";
                                var25 = var30_ref;
                                var24 = var25;
                                var25 = var30_ref;
                                if (var25 != null) {
          ...
          L49: {
            ...
            stackIn_210_0 = (RuntimeException) (var5);

            stackIn_210_1 = new StringBuilder().append("ci.H(").append(param0).append(',');

            if (param1 == null) {
              stackIn_211_0 = (RuntimeException) ((Object) stackIn_210_0);
              stackIn_211_1 = (StringBuilder) ((Object) stackIn_210_1);
              stackIn_211_2 = "null";
              break L49;
            } else {
              stackIn_211_0 = (RuntimeException) ((Object) stackIn_210_0);
          ...
          throw oi.a((Throwable) ((Object) stackIn_211_0), stackIn_211_2 + ',' + param2 + ',' + param3 + ',' + param4 + ')');
        }
    }
    ...
    final static void a(String param0, int param1) {
        try {
            ...
            throw oi.a((Throwable) ((Object) runtimeException), "ci.B(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, oh[] param4, int param5) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_14_1 = new StringBuilder().append("ci.G(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
          ...
          throw oi.a((Throwable) ((Object) stackIn_15_0), stackIn_15_2 + ',' + param5 + ')');
        }
    ...
    final String c(na param0, int param1) {
        ...
        try {
          L0: {
            ...
            stackIn_3_0 = nl.a((byte) 52, '*', param0.field_A.length());
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("ci.C(");
        ...
        L0: while (true) {
          if (var2 >= vj.field_n) {
            ...
            if (!gm.field_g[var2]) {
              ...
              L2: while (true) {
                if (var3 <= var6) {
                  var1[var2] = new oh(wm.field_l, mm.field_w, qa.field_x[var2], i.field_t[var2], je.field_h[var2], sn.field_e[var2], var22);
                  var2++;
                  continue L0;
                } else {
                  var10[var6] = ti.field_c[pl.a((int) var21[var6], 255)];
                  var6++;
                  continue L2;
                }
              }
            } else {
              var15 = jg.field_i[var2];
              var11 = var15;
              var9 = var11;
              var5 = var9;
              var17 = new int[var3];
              ...
              L3: while (true) {
                if (var7 >= var3) {
                  var1[var2] = (oh) ((Object) new ue(wm.field_l, mm.field_w, qa.field_x[var2], i.field_t[var2], je.field_h[var2], sn.field_e[var2], var17));
                  var2++;
                  continue L0;
                } else {
                  var6_ref_int__[var7] = mc.a(pl.a(-16777216, var15[var7] << 774392088), ti.field_c[pl.a(255, (int) var21[var7])]);
                  var7++;
                  continue L3;
                }
              }
