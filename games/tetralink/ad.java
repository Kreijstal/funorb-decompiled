          ...
          if (this.field_Mb.length <= var4) {
            ...
            L1: while (true) {
              if (var8 >= this.field_Kb.length) {
                ...
                if (this.field_Lb != var8) {
                  this.field_Kb[var8].field_M = this.field_Kb[var8].field_M + 10000;
                  var8++;
                  continue L1;
                } else {
                  var8++;
          ...
          if (this.field_Mb.length <= var2) {
            ...
            if (this.field_Lb != var2) {
              if (0 != this.field_Mb[var2].field_F) {
                ...
                this.field_Kb[this.field_Lb].field_M = this.field_Kb[this.field_Lb].field_M + 10000;
                this.field_Lb = var2;
                this.field_Mb[var2].field_zb = true;
                this.field_Kb[var2].field_M = this.field_Kb[var2].field_M - 10000;
                var2++;
                continue L1;
              } else {
                var2++;
