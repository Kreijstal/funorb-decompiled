    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, jb param5, int param6, int param7, ve param8, ve param9, int param10, int param11, ve param12, int param13, jb param14, int param15, int param16, int param17, int param18, int param19) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("bo.I(").append(240).append(',').append(320).append(',').append(param2).append(',').append(8).append(',').append(-1).append(',');
          ...
          L2: {
            ...
            stackOut_5_1 = ((StringBuilder) (Object) stackIn_5_1).append(stackIn_5_2).append(',').append(param6).append(',').append(param7).append(',');
          ...
          throw oi.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + ',' + 2 + ',' + param16 + ',' + param17 + ',' + param18 + ',' + param19 + ')');
        }
    }
