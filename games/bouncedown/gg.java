...
final class gg {
        ...
        if (param1 >= 10) {
          L0: {
            ...
            if (this.field_h == null) {
              ...
              this.field_h.a();
              this.field_q.a();
              var5 = (int)((double)(this.field_h.field_a - this.field_h.field_e) * 32.768 / var3);
              var6 = (int)((double)this.field_h.field_e * 32.768 / var3);
              break L0;
            }
          }
          L1: {
            ...
            if (this.field_s == null) {
              ...
              this.field_s.a();
              this.field_t.a();
              var8 = (int)((double)(this.field_s.field_a - this.field_s.field_e) * 32.768 / var3);
              var9 = (int)((double)this.field_s.field_e * 32.768 / var3);
              break L1;
            }
          }
          var11 = 0;
          L2: while (true) {
            if (var11 >= 5) {
                ...
                if (var11 >= param0) {
                      ...
                      L5: while (true) {
                        if (var14 >= param0) {
                          ...
                          L6: {
                            ...
                            if (var13 == 0) {
                              var12 = this.field_r.field_e + ((this.field_r.field_a - this.field_r.field_e) * var16 >> 8);
                              break L6;
                            } else {
                              var12 = this.field_r.field_e + ((this.field_r.field_a - this.field_r.field_e) * var15 >> 8);
                              break L6;
                            }
                          }
                          L7: {
                      ...
                      if (this.field_c <= 0) {
                        ...
                        L10: while (true) {
                          if (var12 >= param0) {
                            ...
                            field_x[var12] = field_x[var12] + field_x[var12 - var11] * this.field_c / 100;
                            var12++;
                            continue L10;
                          }
                        }
                  ...
                  L28: {
                    if (this.field_s == null) {
                      ...
                      var13 = var13 * ((this.a(var10, var15, this.field_s.field_h) >> 1) + 32768) >> 15;
                  ...
                  L29: while (true) {
                    if (var14 < 5) {
                      if (this.field_b[var14] != 0) {
                        ...
                        if (var15 < param0) {
                          field_x[var15] = field_x[var15] + this.a(field_d[var14], var13 * field_a[var14] >> 15, this.field_e.field_h);
              ...
              if (this.field_b[var11] != 0) {
                field_d[var11] = 0;
                field_m[var11] = (int)((double)this.field_p[var11] * var3);
                field_a[var11] = (this.field_b[var11] << 14) / 100;
                field_i[var11] = (int)((double)(this.field_e.field_a - this.field_e.field_e) * 32.768 * Math.pow(1.0057929410678534, (double)this.field_w[var11]) / var3);
                field_j[var11] = (int)((double)this.field_e.field_e * 32.768 / var3);
                var11++;
                continue L2;
              } else {
                var11++;
    ...
    final void a(wi param0) {
        ...
        for (var3 = 0; var3 < 10; var3++) {
            ...
            this.field_w[var3] = param0.i(128);
            this.field_p[var3] = param0.f(114);
        }
        this.field_g = param0.f(95);
        this.field_c = param0.f(97);
        this.field_n = param0.a(-1640531527);
        this.field_f = param0.a(-1640531527);
        this.field_k = new cd();
        this.field_l = new hl();
        this.field_k.a(param0, this.field_l);
    }
