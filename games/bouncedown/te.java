...
final class te extends ai {
    private static vj[] field_q;
    ...
    private static tf[] field_F;
    private static fg[] field_z;
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = mi.a(var10, (byte) 122, var11);
                            var11++;
                            continue L12;
                          }
                        }
          ...
          if (var17_int >= var14.field_b) {
            L10: {
              if (var15 != 0) {
                ...
                field_z[var18_int].a(field_m, var4 >> 1);
                break L10;
              }
            }
            L11: {
                                                                          ...
                                                                          if (var26 >= var9) {
                                                                            ...
                                                                            L31: while (true) {
                                                                              if (var26 >= var12) {
                                                                                ...
                                                                                field_m[var26] = field_m[var26] * (float)Math.sin(1.5707963267948966 * (double)var27 * (double)var27);
                                                                                var26++;
                                                                                continue L31;
                                                                              }
                                                                            }
    ...
    final static int b() {
        int var0 = field_B[field_i] >> field_I & 1;
        field_I = field_I + 1;
    ...
    final static te a(gk param0, int param1, int param2) {
        try {
            te var4_ref = null;
            if (!te.a(param0)) {
                param0.a(param1, param2, (byte) -14);
                return null;
            }
    ...
    final static int d(int param0) {
        ...
        while (param0 >= 8 - field_I) {
            var3 = 8 - field_I;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_B[field_i] >> field_I & var4) << var2);
            field_I = 0;
            field_i = field_i + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_B[field_i] >> field_I & var3) << var2);
    ...
    private te(byte[] param0) throws IOException {
        this.a(param0);
    }
