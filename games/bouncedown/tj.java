...
abstract class tj extends ug {
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_m = (param1 - ((tj) this).b(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        var17 = null;
        if (param0 != null) {
          StringBuilder discarded$5 = a.a(0, ' ', 246, field_z);
          var4 = 0;
          var5 = 0;
          var6 = -1;
          var7 = 0;
    ...
    final int a(String param0, int param1) {
        return ((tj) this).a(param0, new int[1], field_n);
    }
        ...
        if (param0 != null) {
          L0: {
            ...
            if (param10 != 0) {
              ...
              param10 = ((tj) this).field_p;
              break L0;
            }
          }
          L1: {
            var12 = new int[]{param3};
            if (param4 >= ((tj) this).field_s + ((tj) this).field_x + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = ((tj) this).a(param0, var12, field_n);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - ((tj) this).field_s - ((tj) this).field_x - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + ((tj) this).field_s + var15;
                  param10 = param10 + var15;
                  break L3;
                } else {
                  var14 = param2 + param4 - ((tj) this).field_x - (var13 - 1) * param10;
                  break L3;
                }
              } else {
                var14 = param2 + ((tj) this).field_s + (param4 - ((tj) this).field_s - ((tj) this).field_x - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + ((tj) this).field_s;
              break L3;
            }
          }
          var15 = 0;
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.a(field_n[var15], param1 + param3 - ((tj) this).b(field_n[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.a(field_n[var15], param1 + (param3 - ((tj) this).b(field_n[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    final int b(String param0, int param1, int param2) {
        if (param2 == 0) {
            param2 = ((tj) this).field_p;
        }
        int var4 = ((tj) this).a(param0, new int[1], field_n);
        int var5 = (var4 - 1) * param2;
        return ((tj) this).field_s + var5 + ((tj) this).field_x;
    }
    ...
    final void a(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.a(param0, param1 - ((tj) this).b(param0) / 2, param2);
    }
    ...
    private final void a(byte[] param0) {
        ...
        L0: {
          ...
          if (param0.length != 257) {
                      ...
                      if (var5_int >= 256) {
                        ...
                        L4: while (true) {
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ((tj) this).field_t = new byte[65536];
                                var7 = 0;
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    ((tj) this).field_p = var25[32] + var22[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                ((tj) this).field_t[(var7 << 8) + var8] = (byte)tj.a(var23, var24, var25, ((tj) this).field_q, var22, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
            ...
            var2 = 0;
            L10: while (true) {
              if (var2 >= ((tj) this).field_q.length) {
                ((tj) this).field_p = param0[256] & 255;
                break L0;
              } else {
                ((tj) this).field_q[var2] = param0[var2] & 255;
                var2++;
                continue L10;
              }
            }
    ...
    final int a(char param0) {
        return ((tj) this).field_q[lf.a(param0, (byte) 124) & 255];
    }
    ...
    final void c(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.a(param0, param1 - ((tj) this).b(param0), param2);
    }
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9) {
        return ((tj) this).a(param0, param1, param2, param3, param4, param5, param6, 256, param7, param8, param9);
    }
    ...
    tj(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        ((tj) this).field_H = param2;
        ((tj) this).field_A = param3;
        ((tj) this).field_y = param4;
        this.a(param0);
        var6 = 2147483647;
        var7 = -2147483648;
        var8 = 0;
          ...
          if (var8 >= 256) {
            ...
            L1: {
              if (((tj) this).field_H[var8] >= var6) {
                ...
                if (((tj) this).field_y[var8] == 0) {
                  break L1;
                } else {
                  var6 = ((tj) this).field_H[var8];
                  break L1;
                }
              }
            }
            if (((tj) this).field_H[var8] + ((tj) this).field_y[var8] > var7) {
              var7 = ((tj) this).field_H[var8] + ((tj) this).field_y[var8];
              var8++;
              continue L0;
            } else {
              var8++;
