...
abstract class tj extends ug {
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                                      ...
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_t[(var7 << 8) + var8] = (byte)tj.a(var15, var16, var17, this.field_q, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                this.field_q[var3_int] = param0[incrementValue$6] & 255;
                var3_int++;
                continue L1;
              }
            }
    ...
    final int a(char param0) {
        return this.field_q[lf.a(param0, (byte) 124) & 255];
    }
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var10 = gf.a(10, var13);
                                            var11_ref_li = this.field_B[var10];
                                            if (this.field_o == null) {
                                              stackIn_26_0 = var11_ref_li.field_d;
                                              break L3;
                                            } else {
                                          ...
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_u != 256) {
                                              var11_ref_li.a(param1, param2 + this.field_p - var12, field_u);
                                              break L4;
                                            } else {
                                              var11_ref_li.a(param1, param2 + this.field_p - var12);
                                              break L4;
                                            }
                                          }
              ...
              if (var4 == -1) {
                    ...
                    if (field_u != 256) {
                      L8: {
                        if (field_v == -1) {
                          ...
                          this.a(var8, param1 + this.field_E[var8] + 1, param2 + this.field_H[var8] + 1, var9, var10, field_v, field_u, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_E[var8], param2 + this.field_H[var8], var9, var10, field_J, field_u, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_v == -1) {
                          ...
                          this.a(var8, param1 + this.field_E[var8] + 1, param2 + this.field_H[var8] + 1, var9, var10, field_v, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_E[var8], param2 + this.field_H[var8], var9, var10, field_J, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  ...
                  if (field_C == -1) {
                    ...
                    na.a(var11, param2 + (int)((double)this.field_p * 0.7), param1 - var11, field_C);
                    break L10;
                  }
                }
                L11: {
                  if (field_w == -1) {
                    ...
                    na.a(var11, param2 + this.field_p + 1, param1 - var11, field_w);
                    break L11;
                  }
                }
                var5 = var8;
    ...
    tj(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6;
        int var7;
        int var8;
        this.field_p = 0;
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_s = this.field_p - var6;
            this.field_x = var7 - this.field_p;
            this.field_F = this.field_p - this.field_H[88];
            return;
          } else {
            L1: {
            ...
            if (this.field_H[var8] + this.field_y[var8] > var7) {
              var7 = this.field_H[var8] + this.field_y[var8];
              var8++;
              continue L0;
            } else {
              var8++;
