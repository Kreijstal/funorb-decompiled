...
final class p {
    ...
    final int c() {
        ...
        while (this.field_a[var1] >= 0) {
            var1 = te.b() != 0 ? this.field_a[var1] : var1 + 1;
        }
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_d) {
                ...
                var4_int = te.d(wb.a((byte) 100, this.field_d - var2));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
          ...
          if (var2 <= 0) {
            ...
            L9: {
              ...
              if (var2 != 1) {
                ...
                var7 = p.a(this.field_d, this.field_b);
                break L9;
              }
            }
