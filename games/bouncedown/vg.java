...
final class vg implements fc {
    ...
    final static bl a(boolean param0) {
        ...
        L4: {
          if (eg.field_o == 1) {
            int discarded$4 = var8.a(-1640531527);
            String discarded$5 = var8.b(true);
            break L4;
          } else {
            if (eg.field_o != 4) {
              break L4;
            } else {
              int discarded$6 = var8.a(-1640531527);
              String discarded$7 = var8.b(true);
              break L4;
            }
          }
        }
        if (param0) {
          ...
          jg.field_D = mf.a(80, -2808, (wi) (Object) var8);
          uf.field_c = null;
          return new bl(param0);
        }
    }
    ...
    final static void a(byte param0) {
        ...
        try {
          ...
          throw ii.a((Throwable) (Object) var1_ref, "vg.C(" + param0 + 41);
        }
    }
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              na.e(param1.field_r + param4, param1.field_i + param0, param1.field_k, param1.field_m, ((vg) this).field_b);
              if (var13 == null) {
                break L2;
              } else {
                break L2;
            ...
            na.a(var8, var9, var7 + var8, var9, ((vg) this).field_i);
            var10 = 8 / ((-60 - param2) / 56);
            var11 = -1 + var13.d((byte) -116);
            L3: while (true) {
              if (var11 < 0) {
                if (((vg) this).field_d != null) {
                  ((vg) this).field_d.a(var13.field_h, var8 - -(var7 / 2), ((vg) this).field_d.field_p + (var9 + var13.field_G), ((vg) this).field_k, ((vg) this).field_e);
                  break L0;
                } else {
                  return;
                }
              } else {
                na.b(var8 + var13.b(87, var11) * var7 / var13.a(false), var9, ((vg) this).field_h, ((vg) this).field_c);
                var11--;
                continue L3;
              }
            }
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("vg.B(").append(param0).append(44);
          ...
          throw ii.a((Throwable) (Object) stackIn_15_0, stackIn_15_2 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    vg(tj param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        try {
            ((vg) this).field_e = param2;
            ((vg) this).field_b = param4;
            ((vg) this).field_k = param1;
            ((vg) this).field_c = param6;
            ((vg) this).field_d = param0;
            ((vg) this).field_i = param3;
            ((vg) this).field_h = param5;
        } catch (RuntimeException runtimeException) {
            throw ii.a((Throwable) (Object) runtimeException, "vg.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
    }
