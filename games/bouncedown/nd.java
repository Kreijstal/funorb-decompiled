        ...
        try {
          L0: {
            if (!super.a(param0, param1, param2, param3)) {
              if (param2 == 98) {
                stackOut_5_0 = ((nd) this).a((byte) -126, param0);
                ...
                if (99 != param2) {
                  ...
                  stackOut_8_0 = ((nd) this).a(param0, param3 ^ -30160);
          ...
          L1: {
            ...
            stackOut_12_1 = new StringBuilder().append("nd.E(");
    ...
    final static boolean a(String param0, int param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("nd.A(");
            stackIn_14_0 = stackOut_12_0;
            stackIn_14_1 = stackOut_12_1;
            stackIn_13_0 = stackOut_12_0;
            stackIn_13_1 = stackOut_12_1;
        ...
        try {
            ...
            try {
              ...
              L3: {
                ...
                stackOut_6_1 = new StringBuilder().append("nd.H(");
                ...
                if (param1.length == 0) {
                  ...
                  L3: while (true) {
                    if (var3_int <= var4_int) {
                      ...
                      ((nd) this).field_z = new wd[1 + var3_int];
                      var5 = 0;
                      L4: while (true) {
                        if (var5 >= var3_int) {
                          ((nd) this).field_z[var3_int] = new wd(kj.field_g, (sk) this);
                          ((nd) this).field_z[var3_int].field_j = (fc) (Object) var4;
                          ((nd) this).field_z[var3_int].b(15, 80, 100, 0, var3_int * 16 - -36);
                          ((nd) this).b((lk) (Object) ((nd) this).field_z[var3_int], true);
                          break L0;
                        } else {
            ...
            if (param0 > 6) {
              ...
              L1: while (true) {
                if (((nd) this).field_D.length <= var6_int) {
                  ...
                  L3: {
                    if (((nd) this).field_z[var6_int] == param4) {
                      ((nd) this).field_C.a(((nd) this).field_D[var6_int], (byte) 43);
                      break L3;
                    } else {
                      break L3;
                    }
