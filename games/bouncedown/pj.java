...
final class pj implements fc {
    ...
    final static void a(gk param0, int param1, boolean param2, rb param3) {
        try {
            ...
            throw ii.a((Throwable) (Object) runtimeException, "pj.F(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + (param3 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final static int a(boolean param0, char param1, CharSequence param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("pj.E(").append(param0).append(44).append(param1).append(44);
