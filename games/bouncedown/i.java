...
final class i {
    ...
    final ue a(int param0, int param1, int[] param2) {
        ...
        try {
          if (((i) this).field_b.a(true) == 1) {
            ...
            if (1 == ((i) this).field_b.a((byte) 47, param1)) {
          ...
          L1: {
            ...
            stackOut_11_1 = new StringBuilder().append("i.F(").append(param0).append(44).append(param1).append(44);
    ...
    private final ue a(int[] param0, int param1, int param2, int param3) {
        ...
        try {
          L0: {
            var5_int = param1 ^ (param2 >>> 12 | 65532 & param2 << 4);
            var5_int = var5_int | param2 << 16;
            var6 = (long)var5_int ^ 4294967296L;
            var8 = (ue) (Object) ((i) this).field_e.a(param3 ^ -1911228517, var6);
            if (var8 == null) {
              L1: {
                if (param0 == null) {
                  break L1;
              ...
              L2: {
                if (param3 == -1911228444) {
                  ...
                  var10 = null;
                  ue discarded$1 = this.a((int[]) null, -26, -39, -29);
                  break L2;
                }
              }
              L3: {
          ...
          throw ii.a((Throwable) (Object) stackIn_23_0, stackIn_23_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_19_0;
    }
    ...
    private final ue a(int param0, int param1, int[] param2, byte param3) {
        ...
        try {
          L0: {
            var5_int = ((-805302273 & param1) << 4 | param1 >>> 12) ^ param0;
            var5_int = var5_int | param1 << 16;
            var6 = -109 % ((param3 - 18) / 61);
            var7 = (long)var5_int;
            var9 = (ue) (Object) ((i) this).field_e.a(45, var7);
            if (var9 == null) {
              L1: {
                if (param2 == null) {
                  break L1;
              ...
              var10 = ei.a(((i) this).field_b, param1, param0);
              if (var10 != null) {
                L2: {
                  var11 = var10.b();
                  var9 = var11;
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("i.A(").append(param0).append(44).append(param1).append(44);
          ...
          throw ii.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + 44 + param3 + 41);
        }
        return stackIn_13_0;
    }
    ...
    final ue a(int[] param0, int param1, int param2) {
        ...
        try {
          if (((i) this).field_i.a(true) != 1) {
            if (param1 == 0) {
              if (((i) this).field_i.a((byte) 47, param2) != 1) {
                throw new RuntimeException();
              } else {
    ...
    i(gk param0, gk param1) {
        ((i) this).field_d = new uk(256);
        ((i) this).field_e = new uk(256);
        try {
            ((i) this).field_b = param0;
            ((i) this).field_i = param1;
        } catch (RuntimeException runtimeException) {
            throw ii.a((Throwable) (Object) runtimeException, "i.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
