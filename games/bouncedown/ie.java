...
final class ie extends tj {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * na.field_e;
          var9 = na.field_e - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= na.field_i) {
            break L0;
          } else {
            var12 = na.field_i - param2;
            param4 = param4 - var12;
            param2 = na.field_i;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * na.field_e;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= na.field_f) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - na.field_f);
            break L1;
          }
        }
        L2: {
          if (param1 >= na.field_g) {
            break L2;
          } else {
            var12 = na.field_g - param1;
            param3 = param3 - var12;
            param1 = na.field_g;
            var11 = var11 + var12;
            var8 = var8 + var12;
        ...
        L3: {
          if (param1 + param3 <= na.field_b) {
            break L3;
          } else {
            var12 = param1 + param3 - na.field_b;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (na.field_c == null) {
                  ie.a(na.field_d, ((ie) this).field_K[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  ie.a(na.field_d, ((ie) this).field_K[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, na.field_c, na.field_h);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * na.field_e;
          var10 = na.field_e - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= na.field_i) {
            break L0;
          } else {
            var13 = na.field_i - param2;
            param4 = param4 - var13;
            param2 = na.field_i;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * na.field_e;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= na.field_b) {
            ...
            var13 = param1 + param3 - na.field_b;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              ie.a(na.field_d, ((ie) this).field_K[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19 = 0;
        int var20 = 0;
        var13 = param2 - na.field_g;
        var14 = param3 - na.field_i;
        var15 = var14;
        L0: while (true) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  na.field_d[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    ie(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        super(param0, param1, param2, param3, param4);
        ((ie) this).field_K = new byte[256][];
        ((ie) this).field_K = param5;
    }
}
