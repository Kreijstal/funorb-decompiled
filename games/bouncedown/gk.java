                ...
                L3: while (true) {
                  ...
                  if (var8 != 0) {
                    ...
                    try {
                      ...
                      throw ii.a((Throwable) ((Object) stackIn_37_0), (stackIn_37_2 != 0) + " " + param0 + " " + var9.length + " " + nb.a(var9, var9.length, (byte) -86) + " " + nb.a(var9, -2 + var9.length, (byte) -82) + " " + this.field_l.field_j[param0] + " " + this.field_l.field_b);
                    }
                    L11: {
                      if (!this.field_b) {
                        break L11;
