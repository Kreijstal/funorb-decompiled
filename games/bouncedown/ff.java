...
final class ff extends wd {
    ...
    ff(String param0, sk param1, boolean param2) {
        ...
        try {
            ...
            throw ii.a((Throwable) (Object) runtimeException, "ff.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 41);
        }
    }
    ...
    final static we[] a(String param0, gk param1, byte param2, String param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = la.a(var5, var4_int, param1, (byte) -72);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ff.B(");
    ...
    private ff(String param0, fc param1, sk param2) {
        ...
        try {
            ...
            throw ii.a((Throwable) (Object) runtimeException, "ff.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    private ff(String param0, sk param1) {
        ...
        try {
            ...
            throw ii.a((Throwable) (Object) runtimeException, "ff.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
