...
final class he extends ai {
    ...
    final static void a(int param0) {
        ...
        try {
                          ...
                          if (var4 <= var6_int) {
                            ...
                            L11: {
                              ...
                              if (var6_int != 0) {
                                ...
                                ij.a(de.field_b, var6_int, qe.field_i, param0 ^ 1, ed.field_b, kf.field_a);
                                break L11;
                              }
                            }
                            var6_int++;
          ...
          throw ii.a((Throwable) ((Object) var1), "he.A(" + param0 + ')');
        }
    ...
    he(int param0, int param1, int param2, int param3, int param4, int param5, int[] param6) {
        ...
        try {
            this.field_q = param4;
            this.field_r = param1;
            fieldTemp$0 = el.field_k;
            el.field_k = el.field_k + 1;
            this.field_j = 65535 & fieldTemp$0;
            this.field_t = param5;
            this.field_h = param3;
            this.field_g = param6;
            this.field_s = param2;
