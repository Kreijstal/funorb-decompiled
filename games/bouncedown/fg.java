...
final class fg {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((fg) this).field_k.length;
        var4 = field_g[((fg) this).field_f - 1];
        var5 = field_a;
        field_a[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_l[0] * ((fg) this).field_f;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_a[var16]) {
                  var9 = field_h[var16];
                  var10 = field_l[var16] * ((fg) this).field_f;
            ...
            L3: {
              var7 = fg.b(field_h, var6);
              var8_int = fg.a(field_h, var6);
              var9 = this.a(field_h[var7], field_l[var7], field_h[var8_int], field_l[var8_int], field_h[var6]);
              var10 = field_l[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean b() {
        ...
        int var2 = ((fg) this).field_k.length;
        System.arraycopy((Object) (Object) ((fg) this).field_k, 0, (Object) (Object) field_h, 0, var2);
        int var3 = field_g[((fg) this).field_f - 1];
        int var4 = wb.a((byte) 100, var3 - 1);
        field_l[0] = te.d(var4);
        field_l[1] = te.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((fg) this).field_e.length; var6++) {
            var7 = ((fg) this).field_e[var6];
            var8 = ((fg) this).field_d[var7];
            var9 = ((fg) this).field_j[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = te.field_N[((fg) this).field_c[var7]].c();
            }
            for (var12 = 0; var12 < var8; var12++) {
                ...
                var5++;
                field_l[incrementValue$0] = var13 >= 0 ? te.field_N[var13].c() : 0;
            }
        }
        return true;
    }
    ...
    fg() {
        ...
        if (var1 == 1) {
          var2 = te.d(5);
          var3 = 0;
          ((fg) this).field_e = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((fg) this).field_d = new int[var3];
              ((fg) this).field_j = new int[var3];
              ((fg) this).field_c = new int[var3];
              ((fg) this).field_b = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((fg) this).field_f = te.d(2) + 1;
                  var4 = te.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((fg) this).field_k = new int[var5];
                      ((fg) this).field_k[0] = 0;
                      ((fg) this).field_k[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((fg) this).field_d[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((fg) this).field_k[incrementValue$2] = te.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((fg) this).field_d[((fg) this).field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((fg) this).field_d[var4] = te.d(3) + 1;
                    int dupTemp$3 = te.d(2);
                    ((fg) this).field_j[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((fg) this).field_c[var4] = te.d(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
