...
final class fg {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_a[var16]) {
                  var9 = field_h[var16];
                  var10 = field_l[var16] * this.field_f;
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_k, 0, field_h, 0, var2);
        int var3 = field_g[this.field_f - 1];
        ...
        for (var6 = 0; var6 < this.field_e.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = te.field_N[this.field_c[var7]].c();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_d[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_k[incrementValue$0] = te.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_d[this.field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
