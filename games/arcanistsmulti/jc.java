    ...
    final void a(wk param0, rh param1) {
        ...
        L0: {
          ...
          if (var3 == 0) {
            ...
            this.field_a[0] = param0.n(-98);
            this.field_a[1] = param0.n(-98);
              ...
              if (var5 >= 2) {
                    ...
                    L4: while (true) {
                      if (var7 >= this.field_e[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_h[var5][1][var7] = param0.n(-98);
                          this.field_d[var5][1][var7] = param0.n(-98);
                          var7++;
                          continue L4;
                        }
                      }
                ...
                L5: while (true) {
                  if (var6 >= this.field_e[var5]) {
                    ...
                    this.field_h[var5][0][var6] = param0.n(-98);
                    this.field_d[var5][0][var6] = param0.n(-98);
                    var6++;
                    continue L5;
                  }
                }
