    ...
    final static int a(int param0, boolean param1, byte[] param2, int param3) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (param0 <= var5) {
                ...
                var4_int = bl.field_i[255 & (param2[var5] ^ var4_int)] ^ var4_int >>> 288187208;
                var5++;
                continue L2;
              }
            }
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("db.B(").append(param0).append(',').append(param1).append(',');
