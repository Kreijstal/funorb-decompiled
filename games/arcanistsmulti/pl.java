...
final class pl {
    ...
    final wf a() {
        byte[] var1 = this.b();
        return new wf(22050, var1, 22050 * this.field_a / 1000, 22050 * this.field_c / 1000);
    }
        ...
        L0: while (true) {
          if (var2 >= 10) {
            ...
            if (this.field_b[var2] != null) {
              if (this.field_b[var2].field_s + this.field_b[var2].field_p > var1) {
                var1 = this.field_b[var2].field_s + this.field_b[var2].field_p;
                var2++;
                continue L0;
              } else {
                var2++;
    ...
    private pl(wk param0) {
        int var2 = 0;
        int var3 = 0;
        this.field_b = new jj[10];
        var2 = 0;
        L0: while (true) {
          if (var2 >= 10) {
            this.field_a = param0.n(-98);
            this.field_c = param0.n(-98);
            return;
          } else {
            var3 = param0.e((byte) 110);
            if (var3 != 0) {
              param0.field_g = param0.field_g - 1;
              this.field_b[var2] = new jj();
