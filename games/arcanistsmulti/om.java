...
final class om extends qm {
    ...
    private final qb a(int param0, int param1, int param2) {
        ...
        var14 = new qb(this.field_z * 2, this.field_k);
        fk.a(var14, -23095);
        var5 = this.field_k >> -385446591;
        var6 = 0;
        L1: while (true) {
    ...
    final static qb[] a(int param0, int param1, byte param2, eg param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("om.F(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_10_0 = stackOut_8_0;
