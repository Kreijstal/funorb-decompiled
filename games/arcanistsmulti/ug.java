...
final class ug {
    ...
    final static void a(byte param0, int param1, int param2, int param3, dj param4, int param5, int param6, int param7, int param8, int param9, int param10, ec param11, int param12, dj param13, ec param14, int param15, int param16, int param17, int param18, ec param19, int param20) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = ((StringBuilder) (Object) stackIn_7_1).append(stackIn_7_2).append(44).append(param5).append(44).append(param6).append(44).append(param7).append(44).append(param8).append(44).append(param9).append(44).append(param10).append(44);
          ...
          L3: {
            ...
            stackOut_10_1 = ((StringBuilder) (Object) stackIn_10_1).append(stackIn_10_2).append(44).append(param12).append(44);
          ...
          throw aa.a((Throwable) (Object) stackIn_19_0, stackIn_19_2 + 44 + param20 + 41);
        }
    }
    ...
    private final void b(boolean param0) {
        ...
        L0: {
          ...
          ((ug) this).field_j = ((ug) this).field_j + fieldTemp$3;
          var2 = 0;
          if (!param0) {
            break L0;
          } else {
        ...
        L1: while (true) {
          if (var2 >= 256) {
            ...
            L2: {
              ...
              if ((2 & var2) == 0) {
                if ((1 & var2) != 0) {
                  ((ug) this).field_a = ((ug) this).field_a ^ ((ug) this).field_a >>> 6;
                  break L2;
                } else {
                  ((ug) this).field_a = ((ug) this).field_a ^ ((ug) this).field_a << 13;
                  break L2;
                }
              } else {
                if ((var2 & 1) != 0) {
                  ((ug) this).field_a = ((ug) this).field_a ^ ((ug) this).field_a >>> 16;
                  break L2;
                } else {
                  ((ug) this).field_a = ((ug) this).field_a ^ ((ug) this).field_a << 2;
                  break L2;
                }
              }
            }
            ((ug) this).field_a = ((ug) this).field_a + ((ug) this).field_g[255 & var2 - -128];
            int dupTemp$4 = ((ug) this).field_a + (((ug) this).field_g[dg.a(var3 >> 2, 255)] - -((ug) this).field_j);
            var4 = dupTemp$4;
            ((ug) this).field_g[var2] = dupTemp$4;
            int dupTemp$5 = var3 + ((ug) this).field_g[dg.a(var4, 261203) >> 8 >> 2];
            ((ug) this).field_j = dupTemp$5;
    ...
    final int a(boolean param0) {
        ...
        int fieldTemp$0 = ((ug) this).field_b - 1;
        ((ug) this).field_b = ((ug) this).field_b - 1;
        return ((ug) this).field_e[fieldTemp$0];
    }
