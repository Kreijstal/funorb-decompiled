    ...
    final static void a(byte param0, int param1, int param2, int param3, dj param4, int param5, int param6, int param7, int param8, int param9, int param10, ec param11, int param12, dj param13, ec param14, int param15, int param16, int param17, int param18, ec param19, int param20) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("ug.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
    ...
    private final void b(boolean param0) {
        ...
        L1: while (true) {
          if ((var2 ^ -1) <= -257) {
            ...
            dupTemp$4 = this.field_a + (this.field_g[dg.a(var3 >> -1170177854, 255)] - -this.field_j);
            var4 = dupTemp$4;
            this.field_g[var2] = dupTemp$4;
            dupTemp$5 = var3 + this.field_g[dg.a(var4, 261203) >> -1588828664 >> 1085753954];
