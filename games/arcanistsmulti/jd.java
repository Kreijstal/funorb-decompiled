...
final class jd {
        ...
        L1: while (true) {
          if (-257 >= (var2 ^ -1)) {
            ...
            L2: {
              ...
              if (-1 != (2 & var2 ^ -1)) {
                if (0 != (1 & var2)) {
                  this.field_h = this.field_h ^ this.field_h >>> -533837616;
                  break L2;
                } else {
                  this.field_h = this.field_h ^ this.field_h << 1649781730;
                  break L2;
                }
              } else {
                if (-1 != (var2 & 1 ^ -1)) {
                  this.field_h = this.field_h ^ this.field_h >>> 61505094;
                  break L2;
                } else {
                  this.field_h = this.field_h ^ this.field_h << -1625450995;
                  break L2;
                }
              }
            }
            this.field_h = this.field_h + this.field_f[var2 + 128 & 255];
            dupTemp$4 = this.field_h + this.field_f[dg.a(var3 >> 160291746, 255)] + this.field_k;
            var4 = dupTemp$4;
            this.field_f[var2] = dupTemp$4;
            dupTemp$5 = var3 + this.field_f[dg.a(255, var4 >> -147818776 >> 1203664194)];
    ...
    final jd b(byte param0) {
        ...
        var2.field_b = this.field_b;
        sf.a(this.field_a, 0, var2.field_a, 0, 256);
        sf.a(this.field_f, 0, var2.field_f, 0, 256);
        var2.field_d = this.field_d;
        var2.field_k = this.field_k;
