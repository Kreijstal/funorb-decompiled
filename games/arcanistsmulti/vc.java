...
final class vc {
    ...
    final void a(vc param0, boolean param1) {
        if (param1) {
          ((vc) this).field_m = -107;
          param0.field_b = ((vc) this).field_b;
          param0.field_d = ((vc) this).field_d;
          param0.field_i = ((vc) this).field_i;
          param0.field_a = ((vc) this).field_a;
          param0.field_m = ((vc) this).field_m;
          param0.field_k = ((vc) this).field_k;
          param0.field_g = ((vc) this).field_g;
          param0.field_h = ((vc) this).field_h;
          return;
        } else {
          param0.field_b = ((vc) this).field_b;
          param0.field_d = ((vc) this).field_d;
    ...
    final vc a(boolean param0, int param1) {
        ...
        if (param1 != -5859) {
          L0: {
            vc discarded$13 = ((vc) this).b(21, 109);
            stackOut_5_0 = this;
    ...
    final void a(int param0, mj param1, byte param2, qm param3, int param4) {
        ...
        int stackOut_25_8 = 0;
        L0: {
          gl.a(param3.field_k, param4 - -param3.field_n, -27327, param3.field_v, ((vc) this).field_b, param3.field_j + param0);
          var6 = -37 / ((38 - param2) / 59);
          if (null == ((vc) this).field_d) {
            break L0;
          } else {
            L1: {
              var7_int = param3.field_n + param4 - -((vc) this).field_g;
              if (param1.field_i == 1) {
                var7_int = var7_int + (-((vc) this).field_d.field_n + param3.field_v) / 2;
                break L1;
              } else {
                break L1;
              }
            ...
            L2: {
              var8 = param0 + (param3.field_j + ((vc) this).field_a);
              if (2 == param1.field_i) {
                var7_int = var7_int + (param3.field_v - ((vc) this).field_d.field_n);
                break L2;
              } else {
                break L2;
              }
            ...
            L3: {
              if (param1.field_a == 1) {
                var8 = var8 + (-((vc) this).field_d.field_w + param3.field_k) / 2;
                break L3;
              } else {
                break L3;
              }
            ...
            L4: {
              if (param1.field_a != 2) {
                ...
                var8 = var8 + (-((vc) this).field_d.field_w + param3.field_k);
                break L4;
              }
            }
            ((vc) this).field_d.c(var7_int, var8);
            break L0;
          }
        }
        ...
        if (var7 != null) {
          if (null != param1.field_g) {
            if ((((vc) this).field_m ^ -1) > -1) {
              return;
            } else {
              L5: {
                stackOut_18_0 = param1.field_g;
                stackOut_18_1 = (String) var7;
                stackOut_18_2 = param1.field_m + (param4 - -param3.field_n);
              ...
              L7: {
                ...
                stackOut_24_3 = stackIn_24_3 + param1.field_f + (param0 + param3.field_j);
                stackOut_24_4 = -param1.field_l + (-param1.field_m + param3.field_v);
                stackOut_24_5 = -param1.field_f + param3.field_k + -param1.field_d;
                stackOut_24_6 = ((vc) this).field_m;
                stackOut_24_7 = ((vc) this).field_h;
                ...
                if (2147483647 != (((vc) this).field_i ^ -1)) {
                  stackOut_26_0 = (dj) (Object) stackIn_26_0;
              ...
              int discarded$1 = ((dj) (Object) stackIn_27_0).a((String) (Object) stackIn_27_1, stackIn_27_2, stackIn_27_3, stackIn_27_4, stackIn_27_5, stackIn_27_6, stackIn_27_7, stackIn_27_8, param1.field_i, param1.field_a, param1.field_h);
              return;
            }
          } else {
            return;
    ...
    final vc c(int param0, int param1) {
        if (param0 != -1) {
            vc discarded$0 = ((vc) this).a(35, -108);
            ((vc) this).field_g = param1;
            return (vc) this;
        }
        ((vc) this).field_g = param1;
        return (vc) this;
    ...
    final vc b(int param0, int param1) {
        if (param0 != 0) {
            vc discarded$0 = ((vc) this).a(-22, -123);
            ((vc) this).field_m = param1;
            return (vc) this;
        }
        ((vc) this).field_m = param1;
        return (vc) this;
    ...
    final void a(qm param0, int param1, vc param2, mj param3, int param4, int param5) {
        ...
        L1: {
          if ((((vc) this).field_m ^ -1) <= 0) {
            param2.field_m = ((vc) this).field_m;
            break L1;
          } else {
            break L1;
          }
        ...
        if ((((vc) this).field_g ^ -1) == 2147483647) {
          L2: {
            if ((((vc) this).field_h ^ -1) <= 0) {
              param2.field_h = ((vc) this).field_h;
              break L2;
            } else {
              break L2;
            }
          ...
          L3: {
            if ((((vc) this).field_i ^ -1) != 2147483647) {
              param2.field_i = ((vc) this).field_i;
              break L3;
            } else {
              break L3;
            }
          ...
          if (null == ((vc) this).field_d) {
            if (param4 == ((vc) this).field_a) {
              if (null != ((vc) this).field_b) {
                param2.field_b = ((vc) this).field_b;
                return;
              } else {
                return;
              }
            } else {
              param2.field_a = ((vc) this).field_a;
              if (null != ((vc) this).field_b) {
                param2.field_b = ((vc) this).field_b;
                return;
              } else {
            ...
            param2.field_d = ((vc) this).field_d;
            if (param4 == ((vc) this).field_a) {
              if (null != ((vc) this).field_b) {
                param2.field_b = ((vc) this).field_b;
                return;
          ...
          L4: {
            param2.field_g = ((vc) this).field_g;
            if ((((vc) this).field_h ^ -1) <= 0) {
              param2.field_h = ((vc) this).field_h;
              break L4;
            } else {
    ...
    vc() {
        ((vc) this).field_m = -2;
        ((vc) this).field_k = false;
        ((vc) this).field_g = -2147483648;
        ((vc) this).field_a = -2147483648;
        ((vc) this).field_i = -2147483648;
        ((vc) this).field_h = -2;
        ((vc) this).field_d = null;
        ((vc) this).field_b = null;
    }
