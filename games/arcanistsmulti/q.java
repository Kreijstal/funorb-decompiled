...
final class q extends wn {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, qm param5) {
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              if (var7 == null) {
                ...
                if (!((q) this).a((byte) -47, param3, param0, param4, param2)) {
                  break L2;
                } else {
                  if (!(((q) this).field_o instanceof em)) {
                    if (var7.field_o instanceof em) {
                      ((em) (Object) var7.field_o).a(var7, (byte) 75, (q) this);
                      so.field_i = null;
                      break L2;
                    } else {
                      return;
                    ...
                    ((em) (Object) ((q) this).field_o).a(var7, (byte) 125, (q) this);
                    so.field_i = null;
                    return;
                  }
                }
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("q.IA(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
    ...
    final static qb[] a(int param0, int param1) {
        qb[] var2 = new qb[9];
        var2[4] = ce.b(64, param0, hh.a(0, 21385));
        return var2;
    }
        ...
        try {
          L0: {
            if (wd.field_a != null) {
              ...
              var7 = null;
              rb.a(jk.field_u, var5_ref, 0, (String) null, 97);
              lo.field_y = sa.field_Cb;
              wd.field_a = wn.field_D;
              wn.field_D.field_J = jk.field_u + (-(8355711 & jk.field_u >> 1) + ((16711422 & nf.field_A.field_J) >> 1));
              wn.field_D.field_eb = -((16711423 & jk.field_u) >> 1) + jk.field_u - -(8355711 & nf.field_A.field_eb >> 1);
              wn.field_D.field_zb = ((nf.field_A.field_zb & 16711422) >> 1) + (-(8355711 & jk.field_u >> 1) + jk.field_u);
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("q.F(");
            stackIn_13_0 = stackOut_11_0;
            stackIn_13_1 = stackOut_11_1;
    ...
    private q(int param0, int param1, int param2, int param3, pf param4, wc param5, qm param6) {
        ...
        try {
            ((q) this).field_B = param6;
        } catch (RuntimeException runtimeException) {
            throw aa.a((Throwable) (Object) runtimeException, "q.<init>(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + (param6 != null ? "{...}" : "null") + 41);
        }
    }
