    ...
    final static void a(qb[] param0, boolean param1, dj param2, int param3, qb[] param4, int param5, int param6, int param7, int param8, int param9, int param10, String param11, boolean param12, int param13, int param14) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ke.G(");
          ...
          L5: {
            ...
            stackOut_13_1 = ((StringBuilder) (Object) stackIn_13_1).append(stackIn_13_2).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',').append(param8).append(',').append(param9).append(',').append(param10).append(',');
          ...
          throw aa.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + ',' + true + ',' + param13 + ',' + param14 + ')');
        }
    }
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              var12_int = -((ke) this).field_G + ((ke) this).field_H;
              var13 = ((ke) this).field_L.a(param10, var12_int, ((ke) this).field_L.field_C) - -(((ke) this).field_G * 2);
              if (var13 > param3) {
            ...
            L3: {
              if (((ke) this).field_J) {
                ...
                stackOut_8_0 = ((ke) this).field_H + ((ke) this).field_G * 2;
                stackIn_10_0 = stackOut_8_0;
                break L3;
              }
            }
            var14 = stackIn_10_0;
            ((ke) this).field_B.a(param3 + -(2 * ((ke) this).field_G), ((ke) this).field_G - -(-param3 + var13 >> 1), param2 - (((ke) this).field_H + 3 * ((ke) this).field_G), var14, -60);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
