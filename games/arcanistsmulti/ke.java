...
final class ke extends wn {
    ...
    final void a(byte param0, int param1, int param2, int param3) {
        ...
        int discarded$0 = this.field_L.a(this.field_N, this.field_G + (var7 + var5), this.field_G + var6, -this.field_G + this.field_H, this.field_k + -(this.field_G * 2), this.field_I, -1, this.field_J ? 0 : 2, 1, this.field_L.field_C);
    }
    ...
    final static void a(qb[] param0, boolean param1, dj param2, int param3, qb[] param4, int param5, int param6, int param7, int param8, int param9, int param10, String param11, boolean param12, int param13, int param14) {
        ...
        try {
          ...
          throw aa.a((Throwable) ((Object) stackIn_16_0), stackIn_16_2 + ',' + param12 + ',' + param13 + ',' + param14 + ')');
        }
    }
          ...
          L0: {
            ...
            L3: {
              if (this.field_J) {
                ...
                stackOut_8_0 = this.field_H + this.field_G * 2;
                stackIn_10_0 = stackOut_8_0;
                break L3;
              }
            }
