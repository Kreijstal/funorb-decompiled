...
final class ni {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((ni) this).field_a.length;
        var4 = field_b[((ni) this).field_k - 1];
        var5 = field_c;
        field_c[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_i[0] * ((ni) this).field_k;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_c[var16]) {
                  var9 = field_h[var16];
                  var10 = field_i[var16] * ((ni) this).field_k;
            ...
            L3: {
              var7 = ni.b(field_h, var6);
              var8_int = ni.a(field_h, var6);
              var9 = this.a(field_h[var7], field_i[var7], field_h[var8_int], field_i[var8_int], field_h[var6]);
              var10 = field_i[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean b() {
        ...
        int var2 = ((ni) this).field_a.length;
        System.arraycopy((Object) (Object) ((ni) this).field_a, 0, (Object) (Object) field_h, 0, var2);
        int var3 = field_b[((ni) this).field_k - 1];
        int var4 = jl.a((byte) -79, var3 - 1);
        field_i[0] = ai.d(var4);
        field_i[1] = ai.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((ni) this).field_d.length; var6++) {
            var7 = ((ni) this).field_d[var6];
            var8 = ((ni) this).field_e[var7];
            var9 = ((ni) this).field_j[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ai.field_L[((ni) this).field_l[var7]].a();
            }
    ...
    ni() {
        ...
        if (var1 == 1) {
          var2 = ai.d(5);
          var3 = 0;
          ((ni) this).field_d = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((ni) this).field_e = new int[var3];
              ((ni) this).field_j = new int[var3];
              ((ni) this).field_l = new int[var3];
              ((ni) this).field_f = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((ni) this).field_k = ai.d(2) + 1;
                  var4 = ai.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((ni) this).field_a = new int[var5];
                      ((ni) this).field_a[0] = 0;
                      ((ni) this).field_a[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((ni) this).field_e[((ni) this).field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
