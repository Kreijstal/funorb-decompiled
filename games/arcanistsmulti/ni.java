...
final class ni {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_c[var16]) {
                  var9 = field_h[var16];
                  var10 = field_i[var16] * this.field_k;
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_a, 0, field_h, 0, var2);
        int var3 = field_b[this.field_k - 1];
        ...
        for (var6 = 0; var6 < this.field_d.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = ai.field_L[this.field_l[var7]].a();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_e[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_a[incrementValue$0] = ai.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_e[this.field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
