...
final class ai extends pg {
    ...
    final wf a(int[] param0) {
        ...
        L1: {
          if (this.field_G != null) {
            ...
            this.field_G = new byte[this.field_t];
            this.field_K = 0;
            this.field_x = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (this.field_x >= this.field_j.length) {
            this.field_q = null;
            var12 = this.field_G;
            this.field_G = null;
            return new wf(this.field_h, var12, this.field_w, this.field_M, this.field_z);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
    ...
    private final void b(byte[] param0) throws IOException {
        ...
        this.field_h = var2.d(-10674);
        this.field_t = var2.d(-10674);
        this.field_w = var2.d(-10674);
        this.field_M = var2.d(-10674);
        if (this.field_M < 0) {
    ...
    final wf c() {
        ...
        L0: while (true) {
          if (var3 >= this.field_j.length) {
            this.field_q = null;
            return new wf(this.field_h, var1, this.field_w, this.field_M, this.field_z);
          } else {
            var4 = this.c(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= this.field_t - var2) {
                  break L1;
                } else {
