...
final class ai extends pg {
    ...
    private int field_I;
    private static qd[] field_k;
    private float[] field_q;
    private static float[] field_D;
    private int field_C;
    private static ni[] field_A;
    ...
    final wf a(int[] param0) {
        ...
        L1: {
          if (((ai) this).field_G != null) {
            ...
            ((ai) this).field_C = 0;
            ((ai) this).field_q = new float[field_u];
            ((ai) this).field_G = new byte[((ai) this).field_t];
            ((ai) this).field_K = 0;
            ((ai) this).field_x = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((ai) this).field_x >= ((ai) this).field_j.length) {
            ((ai) this).field_q = null;
            var14 = ((ai) this).field_G;
            ((ai) this).field_G = null;
            return new wf(((ai) this).field_h, var14, ((ai) this).field_w, ((ai) this).field_M, ((ai) this).field_z);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((ai) this).field_K;
                  var4 = var13.length;
                  if (var4 <= ((ai) this).field_t - var3) {
                    break L5;
                  } else {
                    var4 = ((ai) this).field_t - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((ai) this).field_K);
                        break L7;
                      }
                    }
                    ((ai) this).field_K = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((ai) this).field_x = ((ai) this).field_x + 1;
            continue L2;
          }
        }
    }
    ...
    private final void b(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        wk var2 = new wk(param0);
        ((ai) this).field_h = var2.d(-10674);
        ((ai) this).field_t = var2.d(-10674);
        ...
        ((ai) this).field_j = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            var5 = 0;
            do {
                var6_int = var2.e((byte) 115);
                var5 = var5 + var6_int;
            } while (var6_int >= 255);
            var6 = new byte[var5];
            var2.a((byte) 53, 0, var6, var5);
            ((ai) this).field_j[var4] = var6;
        }
    }
    ...
    final wf c() {
        ...
        ((ai) this).field_C = 0;
        ((ai) this).field_q = new float[field_u];
        var1 = new byte[((ai) this).field_t];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((ai) this).field_j.length) {
            ((ai) this).field_q = null;
            return new wf(((ai) this).field_h, var1, ((ai) this).field_w, ((ai) this).field_M, ((ai) this).field_z);
          } else {
            var4 = this.c(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((ai) this).field_t - var2) {
                  break L1;
                } else {
                  var5 = ((ai) this).field_t - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    private final float[] c(int param0) {
        ...
        L0: {
          ai.a(((ai) this).field_j[param0], 0);
          int discarded$1 = ai.a();
          ...
          if (var17_int >= var14.field_b) {
            L10: {
              if (var15 != 0) {
                ...
                field_A[var18_int].a(field_D, var4 >> 1);
                break L10;
              }
            }
            L11: {
                                                                          ...
                                                                          if (var26 >= var9) {
                                                                            ...
                                                                            L31: while (true) {
                                                                              if (var26 >= var12) {
                                                                                ...
                                                                                field_D[var26] = field_D[var26] * (float)Math.sin(1.5707963267948966 * (double)var27 * (double)var27);
                                                                                var26++;
                                                                                continue L31;
                                                                              }
                                                                            }
            ...
            L35: {
              var17 = null;
              if (((ai) this).field_C <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((ai) this).field_C + var4 >> 2;
                  ...
                  if (((ai) this).field_g) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((ai) this).field_I) {
                        break L36;
                      } else {
                        var20 = (((ai) this).field_C >> 1) + var19;
                        var40[var19] = var40[var19] + ((ai) this).field_q[var20];
                        var19++;
                        continue L37;
                      }
                    }
                ...
                if (var15 != 0) {
                  ...
                  L38: while (true) {
                    if (var19 >= var4 >> 1) {
                      ...
                      var40[var20] = var40[var20] + field_D[var19];
                      var19++;
                      continue L38;
                    }
                  }
            ...
            L39: {
              var18 = ((ai) this).field_q;
              ((ai) this).field_q = field_D;
              field_D = var18;
              ((ai) this).field_C = var4;
              ((ai) this).field_I = var12 - (var4 >> 1);
              stackOut_108_0 = this;
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = ai.d(16);
                                    int discarded$4 = ai.d(16);
                                    field_J[var6] = ai.d(8);
                                    var6++;
                                    continue L6;
                                  }
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = jo.a(var10, (byte) -73, var11);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    final static int d(int param0) {
        ...
        while (param0 >= 8 - field_l) {
            var3 = 8 - field_l;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_i[field_s] >> field_l & var4) << var2);
            field_l = 0;
            field_s = field_s + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_i[field_s] >> field_l & var3) << var2);
    ...
    final static int a() {
        int var0 = field_i[field_s] >> field_l & 1;
        field_l = field_l + 1;
        field_s = field_s + (field_l >> 3);
        field_l = field_l & 7;
        return var0;
    }

    private final static boolean a(eg param0) {
        byte[] var1 = null;
        if (!field_B) {
            var1 = param0.b(0, 26219, 0);
            if (var1 == null) {
                return false;
            }
            ai.a(var1);
    ...
    private ai(byte[] param0) throws IOException {
        this.b(param0);
    }
