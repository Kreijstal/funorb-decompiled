...
final class th {
    ...
    final void a(int param0, int param1, String param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("th.E(").append(param0).append(44).append(param1).append(44);
    ...
    final static qb[] a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        var9 = 3;
        var10 = new qb[]{new qb(var9, var9), new qb(3, var9), new qb(var9, var9), new qb(var9, 3), new qb(64, 64), new qb(var9, 3), new qb(var9, var9), new qb(3, var9), new qb(var9, var9)};
              ...
              if (1 <= var11) {
                  ...
                  if (var11 >= 1) {
                    ...
                    L3: while (true) {
                      if (var11 >= 3) {
                          ...
                          if (1 <= var11) {
                            ...
                            L5: while (true) {
                              if (var12 >= 1) {
                                ...
                                var10[1].field_A[var11 + (-1 + -var12 + var9) * 3] = 65793;
                                var10[3].field_A[var9 - 1 + (-var12 + var11 * var9)] = 65793;
                                var10[7].field_A[3 * var12 + var11] = 65793;
                                var10[5].field_A[var11 * var9 + var12] = 65793;
                                var12++;
                                continue L5;
                              }
                            }
                        ...
                        L6: while (true) {
                          if (var12 < 1) {
                            var10[7].field_A[var11 + 3 * (-1 + var9 - var12)] = 0;
                            var10[5].field_A[var9 - 1 - (var12 - var9 * var11)] = 0;
                            var10[1].field_A[var11 + var12 * 3] = 0;
                            var10[3].field_A[var11 * var9 + var12] = 0;
                            var12++;
                            continue L6;
                          } else {
                            var11++;
                    ...
                    L7: while (true) {
                      if (var12 < var9) {
                        var10[0].field_A[var12 - -(var11 * var9)] = 0;
                        var10[0].field_A[var9 * var12 - -var11] = 0;
                        if (var9 - var11 > var12) {
                          var10[2].field_A[var12 + var9 * var11] = 0;
                          var10[6].field_A[var9 * var12 + var11] = 0;
                          var12++;
                          continue L7;
                        } else {
                          var12++;
                ...
                L8: while (true) {
                  if (var12 >= var9) {
                    ...
                    var10[6].field_A[var12 + (-1 + var9 - var11) * var9] = 0;
                    var10[8].field_A[var12 + (-var11 + var9 + -1) * var9] = 0;
                    var10[2].field_A[-1 - -var9 - (var11 - var12 * var9)] = 0;
                    var10[8].field_A[-var11 - (-var9 + 1) + var12 * var9] = 0;
                    var12++;
                    continue L8;
                  }
                }
    ...
    final static void a(eg param0, eg param1, eg param2, byte param3, boolean param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("th.C(");
          ...
          throw aa.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + -40 + 44 + param4 + 41);
        }
    }
    ...
    final static void a(nf param0, ll param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          throw aa.a((Throwable) (Object) stackIn_53_0, stackIn_53_2 + 44 + -1 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
    }
