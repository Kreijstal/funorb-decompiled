...
final class gf extends ob implements vb {
    ...
    final static void a(ll[] param0, boolean param1, byte param2, eg param3, byte[] param4, String[][] param5, byte[] param6, eg param7, int param8, eg param9, int[] param10, int param11, int param12, qb[][] param13, qb[][] param14, String[] param15, String[] param16, int[] param17, String[][] param18) {
        ...
        try {
          L0: {
            var20 = null;
            gd.a(param10, param0, param14, 3, param5, param15, 6, param9, param4, (String[]) null, param7, param16, 17292, param13, true, 1, param18, param3, param6, param17);
            break L0;
          }
          ...
          L2: {
            ...
            stackOut_5_1 = ((StringBuilder) (Object) stackIn_5_1).append(stackIn_5_2).append(44).append(1).append(44).append(74).append(44);
          ...
          L9: {
            ...
            stackOut_26_1 = ((StringBuilder) (Object) stackIn_26_1).append(stackIn_26_2).append(44).append(1).append(44).append(3).append(44);
    ...
    gf(h param0) {
        ...
        try {
            ...
            throw aa.a((Throwable) (Object) runtimeException, "gf.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final static int a(int param0, byte param1, int param2, int param3) {
        ...
        var5 = -param0 + 1024;
        var6 = (var5 * (param2 >> 16 & 255) - -(((param3 & 16748890) >> 16) * param0)) / 1024;
        if (var6 < 0) {
          var6 = 0;
          var7 = (((65292 & param3) >> 8) * param0 + var5 * (255 & param2 >> 8)) / 1024;
          if (var7 >= 0) {
            L0: {
              if (255 >= var7) {
                break L0;
          ...
          if ((long)param0 < 256L) {
            ...
            if ((long)param0 < 4096L) {
              if ((long)param0 < 1024L) {
                return gj.field_g[param0 >> 2] >> 11;
              } else {
                return gj.field_g[param0 >> 4] >> 10;
              }
            } else {
              if ((long)param0 >= 16384L) {
                return gj.field_g[param0 >> 8] >> 8;
              } else {
                return gj.field_g[param0 >> 6] >> 9;
              }
            }
          }
        } else {
          if ((long)param0 < 16777216L) {
            if (1048576L > (long)param0) {
              if ((long)param0 >= 262144L) {
                return gj.field_g[param0 >> 12] >> 6;
              } else {
                return gj.field_g[param0 >> 10] >> 7;
              }
            } else {
              if ((long)param0 >= 4194304L) {
                return gj.field_g[param0 >> 16] >> 4;
              } else {
                return gj.field_g[param0 >> 14] >> 5;
              }
            }
          } else {
            if ((long)param0 >= 268435456L) {
              if ((long)param0 < 1073741824L) {
                return gj.field_g[param0 >> 22] >> 1;
              } else {
                return gj.field_g[param0 >> 24];
              }
            } else {
              if ((long)param0 < 67108864L) {
                return gj.field_g[param0 >> 18] >> 3;
              } else {
                return gj.field_g[param0 >> 20] >> 2;
              }
            }
          }
        }
          ...
          L0: {
            if (param3 == 98) {
              if (((gf) this).field_lb != null) {
                boolean discarded$6 = ((gf) this).field_lb.a(0, (qm) this);
                stackOut_4_0 = 1;
                stackIn_5_0 = stackOut_4_0;
                return stackIn_5_0 != 0;
              } else {
                boolean discarded$7 = ((gf) this).field_kb.a(0, (qm) this);
                return true;
              }
            } else {
              if (param3 == 99) {
    ...
    final static void a(byte param0, eg param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("gf.K(").append(param0).append(44);
    ...
    private final ag a(byte param0, String param1, wc param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("gf.H(").append(103).append(44);
            stackIn_4_0 = stackOut_2_0;
            stackIn_4_1 = stackOut_2_1;
            stackIn_3_0 = stackOut_2_0;
            stackIn_3_1 = stackOut_2_1;
    ...
    public final void a(boolean param0, int param1, int param2, int param3, ag param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("gf.U(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
