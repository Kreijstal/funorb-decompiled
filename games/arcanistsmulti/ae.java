...
final class ae {
            ...
            L0: {
              ...
              if (!hi.field_a) {
                if (mj.field_w) {
                  ...
                  if (me.field_C) {
                    ke.a(wd.field_h, true, (dj) (Object) mi.field_B, 1, ve.field_t, 1, an.field_j / 2, 16, mi.field_B.field_o, 10, an.field_f / 2, dg.field_t, true, mi.field_B.field_m + mi.field_B.field_o, -21071);
                    me.field_C = false;
                    return;
                  } else {
                    return;
    ...
    private static void $cfr$clinit() {
        ...
        field_d = "It is currently your turn!<br>Click 'Start' to enter the game.";
    }
}
