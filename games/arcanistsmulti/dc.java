...
public abstract class dc extends java.applet.Applet implements Runnable, java.awt.event.FocusListener, java.awt.event.WindowListener {
                ...
                try {
                  L1: {
                    L2: {
                            ...
                            if (dl.field_l != null) {
                              ...
                              if (var2.startsWith("1.6.0_")) {
                                ...
                                L9: while (true) {
                                  ...
                                  if (!fi.a((CharSequence) ((Object) var4), 10)) {
                                    break L5;
                                  } else {
                                    if (10 > dc.a((CharSequence) ((Object) var4), 126)) {
                                      this.a("wrongjava", (byte) -121);
                                      if (var5 == 0) {
                                        break L2;
                                      } else {
                                        break L5;
                      ...
                      ee.b(true);
                      this.a(-11232);
                      ce.field_m = se.a(o.field_r, (java.awt.Component) ((Object) on.field_c), co.field_c, (byte) -123);
                      this.e((byte) -116);
                      tg.field_e = ki.e((byte) -126);
                      L18: while (true) {
                        L19: {
                          L20: {
                            if (-1L == (wd.field_b ^ -1L)) {
                              ...
                              stackOut_94_0 = ((wd.field_b ^ -1L) < (qj.b(-26572) ^ -1L) ? -1 : ((wd.field_b ^ -1L) == (qj.b(-26572) ^ -1L) ? 0 : 1));
                  ...
                  L24: {
                    ...
                    jh.a((Throwable) (var1), (String) null, (byte) 20);
                        ...
                        L3: {
                          ...
                          if (var2_ref == null) {
                            ...
                            if (var2_ref.width < tn.field_Eb) {
                              ...
                              if ((wh.field_c ^ -1) < (var2_ref.height ^ -1)) {
                                break L2;
                              } else {
                                break L3;
                              }
              ...
              L0: {
                if (this.field_d) {
                  ...
                  try {
                    L1: {
                      L2: {
                        discarded$1 = ei.a(cd.e(126), 114, "loggedout");
                        if (param1 < -115) {
                          break L2;
                        } else {
                          field_k = (int[]) null;
          ...
          L0: {
            ...
            L6: {
              L7: {
                ...
                discarded$6 = ((java.awt.Container) (var2)).add((java.awt.Component) ((Object) on.field_c));
    ...
    private final void b(int param0) {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          runtimeException = decompiledCaughtException;
          throw aa.a((Throwable) ((Object) runtimeException), "dc.I(" + param0 + ')');
        }
    }
    ...
    private final void b(byte param0) {
        ...
        try {
          ...
          throw aa.a((Throwable) ((Object) var2), "dc.H(" + param0 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return;
        } else {
                ...
                try {
                  L1: {
                    if (null != ug.field_k) {
                      ...
                      ge.field_i = 0;
                      hh.field_e = cd.e(104);
                      dupTemp$1 = new dl(param0, param2, param6, true);
                      fi.field_d = dupTemp$1;
                      rb.field_k = dupTemp$1;
                      var8_ref2 = fi.field_d.a(127, 1, (Runnable) (this));
                      L3: while (true) {
                        L4: {
                          L5: {
                            if (-1 != (var8_ref2.field_e ^ -1)) {
                              break L5;
                            } else {
                              ao.a(10L, 1);
                              if (var9 != 0) {
                  ...
                  L6: {
                    ...
                    jh.a(var8, (String) null, (byte) 20);
                    this.a("crash", (byte) -119);
                    decompiledRegionSelector0 = 2;
                    break L6;
                  }
                }
