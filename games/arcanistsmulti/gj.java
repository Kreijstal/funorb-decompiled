...
final class gj {
    ...
    static {
        ...
        field_c[31] = new int[]{84, 85, 149, 87, 88, 89, 95};
        field_c[10] = new int[]{80, 132};
        field_c[29] = new int[]{150};
        field_c[11] = new int[]{139, 120};
        field_c[7] = new int[]{130, 62};
        field_c[4] = new int[]{121, 54};
        field_c[6] = new int[]{};
        field_c[14] = new int[]{129};
        field_c[28] = new int[]{150};
        field_c[8] = new int[]{131};
        field_c[2] = new int[]{137, 25, 29, 28};
        field_c[17] = new int[]{135};
        field_c[36] = new int[]{151};
        field_c[26] = new int[]{136};
        field_c[3] = new int[]{126, 37};
        field_c[39] = new int[]{155};
        field_c[13] = new int[]{127};
        field_c[30] = new int[]{150};
        field_c[1] = new int[]{124, 125};
        field_c[37] = new int[]{154};
        field_c[33] = new int[]{148, 93};
        field_c[5] = new int[]{123, 122, 49, 52};
        field_c[25] = new int[]{134, 133, 153};
        field_c[9] = new int[]{138, 135, 76, 80};
        field_c[15] = new int[]{128};
        field_c[32] = new int[]{96, 98, 99, 150};
