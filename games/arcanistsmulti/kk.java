 ...
 */
final class kk {
    final static boolean a(qb param0, int param1, int param2, ll param3, int param4, int param5) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        int var9 = 0;
        ...
        L0: {
          ...
          if (var6 >= param0.field_q) {
            ...
            var8 = param3.field_h;
            if (var6 > -param3.field_h) {
              L1: {
                param2 = param2 + param0.field_o;
