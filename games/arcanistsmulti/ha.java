...
final class ha extends pg {
    ...
    private ha(wk param0) {
        ...
        int var66;
        int[] var70;
        param0.field_g = param0.field_j.length - 3;
        var2 = param0.e((byte) 91);
        var3 = param0.n(-98);
        var4 = 14 + var2 * 10;
        param0.field_g = 0;
        var5 = 0;
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51.a(6, (byte) -101);
                      stackIn_66_0 = (wk) (var51);

                      if (var2 <= 1) {
                        stackIn_67_0 = (wk) ((Object) stackIn_66_0);
                        stackIn_67_1 = 0;
                        break L3;
                      } else {
                        stackIn_67_0 = (wk) ((Object) stackIn_66_0);
                    ...
                    ((wk) (Object) stackIn_67_0).c(stackIn_67_1, (byte) -110);
                    var51.c(var2, (byte) -94);
                    var51.c(var3, (byte) -82);
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                          ...
                                          if (var62 != 6) {
                                            ...
                                            L7: {
                                              if (var65 == 0) {
                                                ...
                                                var51.f(192 + var52, (byte) -91);
                                                break L7;
                                              }
                                            }
                                            incrementValue$1 = var44;
                                            var44++;
                                            var51.f((int) param0.field_j[incrementValue$1], (byte) -6);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var50++;
                              var51.f((int) param0.field_j[incrementValue$25], (byte) -30);
                              incrementValue$26 = var50;
                              var50++;
                              var51.f((int) param0.field_j[incrementValue$26], (byte) -111);
                              incrementValue$27 = var50;
                              var50++;
                              var51.f((int) param0.field_j[incrementValue$27], (byte) -80);
                              continue L5;
                            }
                          } else {
                            L18: {
                            ...
                            var51.f(47, (byte) -80);
                            var51.f(0, (byte) -38);
                            var51.c(10089, var51.field_g - var61);
                            var60++;
                            continue L4;
                          }
                        }
                    ...
                    var28 = var28 + param0.e((byte) 93) & 127;
                    if (var28 != 0) {
                      if (var28 != 32) {
                        if (var28 != 1) {
                          if (var28 != 33) {
