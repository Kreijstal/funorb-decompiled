...
final class nb {
    ...
    final static void a(boolean param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
                    ...
                    if (param6 == param1) {
                      ...
                      L2: while (true) {
                        if (var11 >= param4) {
                          ...
                          nb.a(param0, param1, param2, var8, param4, param5, var10);
                          break L0;
                        } else {
                          L3: {
          ...
          throw aa.a((Throwable) (Object) var7, "nb.E(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
    }
    ...
    final static void a(String param0, long param1, int param2) {
        ...
        try {
            ...
            throw aa.a((Throwable) (Object) runtimeException, "nb.B(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + -26510 + 41);
        }
    }
        ...
        try {
            ...
            try {
                    ...
                    if (param2.field_j[1 + param2.field_g] != -117) {
                      ...
                      try {
                        L3: {
                          ...
                          int discarded$2 = ((nb) this).field_b.inflate(param1);
                          break L3;
                        }
              ...
              L4: {
                ...
                stackOut_13_1 = new StringBuilder().append("nb.A(").append(param0).append(44);
