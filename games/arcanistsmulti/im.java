...
class im extends bd {
    ...
    final static void a(int param0, gh param1, dl param2, java.awt.Component param3, int param4, boolean param5) {
        try {
            ...
            sm.a(param4 ^ 22876, true, param0, param1, param3, 1024, param2, param0);
        } catch (RuntimeException runtimeException) {
            throw aa.a((Throwable) (Object) runtimeException, "im.M(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 44 + (param3 != null ? "{...}" : "null") + 44 + param4 + 44 + 1 + 41);
        }
    }
    ...
    final static nc a(eg param0, int param1, eg param2, int param3, int param4) {
        ...
        try {
          ...
          throw aa.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + 44 + param3 + 44 + param4 + 41);
        }
        return stackIn_6_0;
    }
