        ...
        try {
          L0: {
            if (param2.c(param0 + -28076)) {
              ...
              stackOut_5_0 = param1 + " - " + param2.b(param4, 119) + "%";
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("nm.B(").append(param0).append(44);
    ...
    final static java.net.URL a(java.applet.Applet param0, java.net.URL param1, int param2) {
        ...
        try {
          L0: {
            ...
            if (param2 == -31843) {
              stackOut_10_0 = si.a((byte) 115, (String) var3, (String) var4, -1, param1);
              stackIn_11_0 = stackOut_10_0;
              break L0;
            } else {
              stackOut_8_0 = null;
          ...
          L3: {
            ...
            stackOut_12_0 = var3;
            stackOut_12_1 = new StringBuilder().append("nm.A(");
          ...
          throw aa.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + 44 + param2 + 41);
        }
        return stackIn_11_0;
    }
