...
final class un {
    ...
    final int a() {
        ...
        while (this.field_f[var1] >= 0) {
            var1 = ai.a() != 0 ? this.field_f[var1] : var1 + 1;
        }
    ...
    un() {
        ...
        L0: {
          discarded$2 = ai.d(24);
          this.field_a = ai.d(16);
          this.field_b = ai.d(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_b) {
                ...
                var4_int = ai.d(jl.a((byte) -79, this.field_b - var2));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_b * this.field_a;
                break L9;
              } else {
                var7 = un.a(this.field_b, this.field_a);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_d = new float[this.field_b][this.field_a];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
