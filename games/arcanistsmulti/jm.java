    ...
    final static void a(int param0, byte param1, boolean param2, na param3, int param4, int param5, int param6, int param7) {
        ...
        try {
          ...
          L26: {
            ...
            stackOut_102_1 = new StringBuilder().append("jm.G(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    private final void b(byte param0, qm param1) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_31_1 = new StringBuilder().append("jm.H(").append(param0).append(44);
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              if (((jm) this).field_n) {
                int discarded$1 = ((jm) this).field_g.a(((jm) this).a(false, param4), this.a(param6, 9293, param0, param4), this.a(param5, param3, (byte) 120, param4), var9_int, var10, param2, param7, ((jm) this).field_i, ((jm) this).field_a, ((jm) this).field_h);
                break L2;
              } else {
                L3: {
                ...
                L5: {
                  ...
                  if (var12 != 0) {
                    if (var12 == 3) {
                      ...
                      if (var12 == 1) {
                        ((jm) this).field_g.b(((jm) this).a(false, param4), (var9_int >> 1) + this.a(param6, 9293, param0, param4), this.a(param5, param3, (byte) 120, param4) + var11, param2, param7);
                        break L2;
                      } else {
                        if (var12 != 2) {
                          break L2;
                        } else {
                          ((jm) this).field_g.c(((jm) this).a(false, param4), this.a(param6, param1 + -13741, param0, param4) + var9_int, var11 + this.a(param5, param3, (byte) 120, param4), param2, param7);
                          break L2;
                        }
                      }
                    }
          ...
          L6: {
            ...
            stackOut_25_1 = new StringBuilder().append("jm.M(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
            stackIn_27_0 = stackOut_25_0;
            stackIn_27_1 = stackOut_25_1;
          ...
          throw aa.a((Throwable) (Object) stackIn_28_0, stackIn_28_2 + 44 + param5 + 44 + param6 + 44 + param7 + 41);
        }
    }
    ...
    private final int a(int param0, int param1, byte param2, qm param3) {
        ...
        try {
          L0: {
            L1: {
              if (param2 == 120) {
                ...
                var6 = null;
                int discarded$2 = ((jm) this).a((qm) null, (byte) 0, -49);
                break L1;
              }
            }
            stackOut_2_0 = param1 + (((jm) this).field_f + param0) + param3.field_j + param3.field_i;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            var5 = decompiledCaughtException;
            stackOut_4_0 = (RuntimeException) var5;
            stackOut_4_1 = new StringBuilder().append("jm.I(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
