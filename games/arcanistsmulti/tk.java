...
final class tk extends tf {
    ...
    final static int a(int param0, int param1) {
        ...
        if (param0 != -4) {
            ...
            discarded$0 = tk.a(true, 5, (String) null, (String) null, 9, (String) null, (byte) 92);
        }
        if (param1 < 0) {
            if (param1 >= -65536) {
    ...
    final static int a(boolean param0, int param1, String param2, String param3, int param4, String param5, byte param6) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("tk.C(").append(param0).append(',').append(param1).append(',');
          ...
          throw aa.a((Throwable) ((Object) stackIn_14_0), stackIn_14_2 + ',' + param6 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_2_0;
        } else {
