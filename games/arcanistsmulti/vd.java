            ...
            if (-1 == (this.field_f.length ^ -1)) {
              ...
              L1: while (true) {
                if (var3 >= this.field_f.length) {
                  ...
                  if (param0 >= this.field_f[var3] + this.field_f[var3 + -1] >> -959517631) {
                    var3++;
                    continue L1;
                  } else {
                    return -1 + var3;
                    ...
                    if (var2_int >= gb.field_f) {
                      ...
                      L6: {
                        if (g.field_d[var2_int].field_m != param0.field_m) {
                          ...
                          dupTemp$7 = g.field_d[var2_int].b(-62);
          ...
          L2: {
            if (this.field_f == null) {
              ...
              if (0 != this.field_f.length) {
                stackOut_6_0 = this.field_f[this.field_f.length + -1];
                stackIn_7_0 = stackOut_6_0;
                break L1;
              } else {
                break L2;
