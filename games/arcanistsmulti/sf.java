...
final class sf {
    ...
    final static void a(int[] param0, int param1, int param2, int param3) {
        ...
        while (param1 < param2) {
            ...
            param1++;
            param0[incrementValue$0] = 1;
            int incrementValue$1 = param1;
            param1++;
            param0[incrementValue$1] = 1;
            int incrementValue$2 = param1;
            param1++;
            param0[incrementValue$2] = 1;
            int incrementValue$3 = param1;
            param1++;
            param0[incrementValue$3] = 1;
            int incrementValue$4 = param1;
            param1++;
            param0[incrementValue$4] = 1;
            int incrementValue$5 = param1;
            param1++;
            param0[incrementValue$5] = 1;
            int incrementValue$6 = param1;
            param1++;
            param0[incrementValue$6] = 1;
            int incrementValue$7 = param1;
            param1++;
            param0[incrementValue$7] = 1;
        }
        param2 += 7;
        while (param1 < param2) {
            int incrementValue$8 = param1;
            param1++;
            param0[incrementValue$8] = 1;
        }
    }
