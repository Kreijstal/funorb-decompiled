...
final class sm {
    ...
    final static boolean a(int param0, String param1, String param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("sm.B(").append(22230).append(',');
        ...
        try {
            ...
            try {
              ...
              L2: {
                ...
                stackOut_7_1 = new StringBuilder().append("sm.E(").append(param0).append(',');
              ...
              L4: {
                stackOut_13_0 = (RuntimeException) (Object) stackIn_13_0;
                stackOut_13_1 = ((StringBuilder) (Object) stackIn_13_1).append(stackIn_13_2).append(',').append(-15367).append(',');
    ...
    final static void a(int param0, boolean param1, int param2, gh param3, java.awt.Component param4, int param5, dl param6, int param7) {
        try {
            ...
            throw aa.a((Throwable) (Object) runtimeException, "sm.D(" + -112 + ',' + true + ',' + 22050 + ',' + (param3 != null ? "{...}" : "null") + ',' + (param4 != null ? "{...}" : "null") + ',' + 1024 + ',' + (param6 != null ? "{...}" : "null") + ',' + 22050 + ')');
        }
    }
