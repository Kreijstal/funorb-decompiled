...
abstract class hr implements bu {
    ...
    private final void a(float param0, float param1, float param2, float param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        if (param4 == 0) {
          ...
          var16 = (((float)this.b() - param2) * var13 + -param3 * var12) / 4096.0f + param0;
          var17 = (-((float)this.b() - param2) * var12 + -param3 * var13) / 4096.0f + param1;
          var18 = (-param2 * var13 + ((float)this.d() - param3) * var12) / 4096.0f + param0;
          var19 = (--param2 * var12 + ((float)this.d() - param3) * var13) / 4096.0f + param1;
    ...
    final void a(float param0, float param1, int param2, int param3) {
        this.a(param0, param1, (float)this.b() / 2.0f, (float)this.d() / 2.0f, param2, param3, 1, 0, 1);
    }
    ...
    final void a(float param0, float param1, int param2, int param3, int param4, int param5, int param6) {
        this.a(param0, param1, (float)this.b() / 2.0f, (float)this.d() / 2.0f, param2, param3, param4, param5, param6);
    }
}
