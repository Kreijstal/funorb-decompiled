...
final class q extends ms {
    ...
    final static q a(ki param0, String param1, String param2) {
        try {
            ...
            q var4_ref = null;
            if (!q.a(param0)) {
                discarded$0 = param0.a(param1, -1158, param2);
                return null;
            }
    ...
    final static q a(ki param0, int param1, int param2) {
        try {
            ...
            q var4_ref = null;
            if (!q.a(param0)) {
                discarded$0 = param0.a(param1, false, param2);
                return null;
            }
    ...
    private final void b(byte[] param0) throws IOException {
        ...
        this.field_B = var2.c(true);
        this.field_r = var2.c(true);
        this.field_F = var2.c(true);
        if (this.field_F < 0) {
    ...
    final qp c() {
        ...
        int var7 = 0;
        this.field_A = 0;
        this.field_P = new float[field_l];
        ...
        L0: while (true) {
          if (var3 >= this.field_v.length) {
            this.field_P = null;
            return new qp(this.field_H, var1, this.field_r, this.field_F, this.field_M);
          } else {
            var4 = this.c(var3);
            if (var4 != null) {
              L1: {
    ...
    final qp a(int[] param0) {
        ...
        L2: while (true) {
          if (this.field_R >= this.field_v.length) {
            ...
            var12 = this.field_D;
            this.field_D = null;
            return new qp(this.field_H, var12, this.field_r, this.field_F, this.field_M);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
