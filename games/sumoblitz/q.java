...
final class q extends ms {
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = q.a(16);
                                    int discarded$4 = q.a(16);
                                    field_J[var6] = q.a(8);
                                    var6++;
                                    continue L6;
                                  }
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = mi.a((byte) 72, var11, var10);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    final static q a(ki param0, String param1, String param2) {
        try {
            q var4_ref = null;
            if (!q.a(param0)) {
                boolean discarded$0 = param0.a(param1, -1158, param2);
                return null;
            }
    ...
    final static q a(ki param0, int param1, int param2) {
        try {
            q var4_ref = null;
            if (!q.a(param0)) {
                boolean discarded$0 = param0.a(param1, false, param2);
                return null;
            }
            byte[] var3 = param0.a((byte) 112, param2, param1);
            if (var3 == null) {
                return null;
            }
            Object var4 = null;
    ...
    final static int b() {
        int var0 = field_p[field_y] >> field_m & 1;
        field_m = field_m + 1;
        field_y = field_y + (field_m >> 3);
        field_m = field_m & 7;
        return var0;
    }
    ...
    private final void b(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        fs var2 = new fs(param0);
        ((q) this).field_H = var2.c(true);
        ((q) this).field_B = var2.c(true);
        ((q) this).field_r = var2.c(true);
        ((q) this).field_F = var2.c(true);
        if (((q) this).field_F < 0) {
            ((q) this).field_F = ~((q) this).field_F;
            ((q) this).field_M = true;
        }
        int var3 = var2.c(true);
        if (var3 < 0) {
            throw new IOException();
        }
        ((q) this).field_v = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            var5 = 0;
            do {
                var6_int = var2.e(-31302);
                var5 = var5 + var6_int;
            } while (var6_int >= 255);
            var6 = new byte[var5];
            var2.a(var6, var5, 0, (byte) -87);
            ((q) this).field_v[var4] = var6;
        }
    }
    ...
    final qp c() {
        ...
        int var7 = 0;
        ((q) this).field_A = 0;
        ((q) this).field_P = new float[field_l];
        var1 = new byte[((q) this).field_B];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((q) this).field_v.length) {
            ((q) this).field_P = null;
            return new qp(((q) this).field_H, var1, ((q) this).field_r, ((q) this).field_F, ((q) this).field_M);
          } else {
            var4 = this.c(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((q) this).field_B - var2) {
                  break L1;
                } else {
                  var5 = ((q) this).field_B - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    final qp a(int[] param0) {
        ...
        L1: {
          if (((q) this).field_D != null) {
            break L1;
          } else {
            ((q) this).field_A = 0;
            ((q) this).field_P = new float[field_l];
            ((q) this).field_D = new byte[((q) this).field_B];
            ((q) this).field_K = 0;
            ((q) this).field_R = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((q) this).field_R >= ((q) this).field_v.length) {
            ((q) this).field_P = null;
            var14 = ((q) this).field_D;
            ((q) this).field_D = null;
            return new qp(((q) this).field_H, var14, ((q) this).field_r, ((q) this).field_F, ((q) this).field_M);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((q) this).field_K;
                  var4 = var13.length;
                  if (var4 <= ((q) this).field_B - var3) {
                    break L5;
                  } else {
                    var4 = ((q) this).field_B - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((q) this).field_K);
                        break L7;
                      }
                    }
                    ((q) this).field_K = var3;
                    ...
                    var3++;
                    ((q) this).field_D[incrementValue$1] = (byte)(var6 - 128);
                    var5++;
                    continue L6;
                  }
                }
            ...
            ((q) this).field_R = ((q) this).field_R + 1;
            continue L2;
          }
        }
    }
    ...
    private final float[] c(int param0) {
        ...
        L0: {
          q.a(((q) this).field_v[param0], 0);
          int discarded$1 = q.b();
          var2 = q.a(mr.a(field_J.length - 1, (byte) -115));
          ...
          if (var17_int >= var14.field_b) {
            L10: {
              if (var15 != 0) {
                ...
                field_L[var18_int].a(field_E, var4 >> 1);
                break L10;
              }
            }
            L11: {
                    ...
                    L13: while (true) {
                      if (var41 >= var4) {
                        ...
                        L15: {
                          var21 = stackIn_40_0;
                          if (var3 == 0) {
                            stackOut_42_0 = (float[]) field_q;
                            stackIn_43_0 = stackOut_42_0;
                            break L15;
                          } else {
                            stackOut_41_0 = (float[]) field_z;
                                                                          ...
                                                                          if (var26 >= var9) {
                                                                            ...
                                                                            L31: while (true) {
                                                                              if (var26 >= var12) {
                                                                                ...
                                                                                field_E[var26] = field_E[var26] * (float)Math.sin(1.5707963267948966 * (double)var27 * (double)var27);
                                                                                var26++;
                                                                                continue L31;
                                                                              }
                                                                            }
            ...
            L35: {
              ...
              if (((q) this).field_A <= 0) {
                ...
                L36: {
                  var18_int = ((q) this).field_A + var4 >> 2;
                  ...
                  if (((q) this).field_n) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((q) this).field_G) {
                        break L36;
                      } else {
                        var20 = (((q) this).field_A >> 1) + var19;
                        var40[var19] = var40[var19] + ((q) this).field_P[var20];
                        var19++;
                        continue L37;
                      }
                    }
                ...
                if (var15 != 0) {
                  ...
                  L38: while (true) {
                    if (var19 >= var4 >> 1) {
                      ...
                      var40[var20] = var40[var20] + field_E[var19];
                      var19++;
                      continue L38;
                    }
                  }
            ...
            L39: {
              var18 = ((q) this).field_P;
              ((q) this).field_P = field_E;
              field_E = var18;
              ((q) this).field_A = var4;
              ((q) this).field_G = var12 - (var4 >> 1);
              stackOut_108_0 = this;
            ...
            ((q) this).field_n = stackIn_111_1 != 0;
            return (float[]) var17;
          } else {
    ...
    final static int a(int param0) {
        ...
        while (param0 >= 8 - field_m) {
            var3 = 8 - field_m;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_p[field_y] >> field_m & var4) << var2);
            field_m = 0;
            field_y = field_y + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_p[field_y] >> field_m & var3) << var2);
            field_m = field_m + param0;
        }
        return var1;
    }

    private final static boolean a(ki param0) {
        byte[] var1 = null;
        if (!field_t) {
            var1 = param0.a((byte) 95, 0, 0);
            if (var1 == null) {
                return false;
            }
            q.a(var1);
    ...
    private q(byte[] param0) throws IOException {
        this.b(param0);
    }
