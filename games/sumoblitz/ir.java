...
public final class ir extends aw {
    ...
    final void SA(int param0, int param1, int param2, int param3, int[] param4, int param5, int param6) {
        ...
        this.field_Cc.StretchRect(var9, 0, 0, param2, param3, var12, param0, param1, param2, param3, 0);
        var9.a(-22671);
        var12.a(-22671);
    }
    ...
    final void F(int param0) {
        ...
        this.field_Cc.SetScissorRect(this.field_r - -this.field_v, this.field_y - -this.field_vb, this.field_F, this.field_yc);
    }
    ...
    final void l(byte param0) {
        ...
        if (!(!this.field_Ec[this.field_mc])) {
            ...
            this.field_Cc.SetTexture(this.field_mc, (jagdx.IDirect3DBaseTexture) null);
            this.X(-109);
            this.q((byte) -93);
        }
    }
    ...
    final void a(int param0, hq param1) {
        ...
        this.field_Cc.SetVertexDeclaration(var4.field_d);
    }

    final void a(int param0, qs param1) {
        this.a((fj) (param1), 1);
        if (!this.field_Uc[this.field_mc]) {
            this.field_Cc.SetSamplerState(this.field_mc, 1, 1);
            this.field_Uc[this.field_mc] = true;
        }
        if (!(this.field_Bc[this.field_mc])) {
            this.field_Cc.SetSamplerState(this.field_mc, 2, 1);
    ...
    final void V(int param0) {
        ...
        L1: {
              ...
              if (ar.field_L != this.field_wb[this.field_mc]) {
                L3: {
                  if (this.field_wb[this.field_mc] != rs.field_c) {
                    this.field_Cc.SetTransform(this.field_mc + 16, this.field_V[this.field_mc].b(-68, field_Mc));
                    break L3;
                  } else {
                    this.field_Cc.SetTransform(this.field_mc + 16, this.field_V[this.field_mc].a(field_Mc, 111));
                    break L3;
                  }
                }
                var2 = ir.b(this.field_wb[this.field_mc], param0 + -23700);
                if (var2 != this.field_Gc[this.field_mc]) {
                  this.field_Cc.SetTextureStageState(this.field_mc, 24, var2);
          ...
          this.field_Cc.SetTextureStageState(this.field_mc, 24, 0);
    ...
    final void q(byte param0) {
        ...
        this.field_Cc.SetTextureStageState(this.field_mc, 1, var2);
    }
    ...
    final void Y(int param0) {
        ...
        for (var2 = 0; this.field_ub > var2; var2++) {
            ...
            this.field_Cc.SetLight(var4, this.field_Ac);
            this.field_Cc.LightEnable(var4, true);
        }
        while (this.field_Ab > var2) {
            this.field_Cc.LightEnable(2 + var2, false);
            var2++;
        }
        if (param0 > -83) {
            this.field_zc = -101;
    ...
    final void q(int param0) {
        this.field_Cc.a(7, this.field_p);
        if (param0 <= 19) {
            this.A(30);
        }
    }
    ...
    final void r(int param0) {
        this.field_Cc.SetRenderState(60, this.field_Ub);
        if (param0 != 1) {
    ...
    final void a(fj param0, int param1) {
        ...
        int stackIn_7_1 = 0;
        int stackIn_7_2 = 0;
        jagdx.IDirect3DDevice stackIn_8_0;
        int stackIn_8_1;
        int stackIn_8_2;
        int stackIn_8_3;
        ...
        int stackIn_15_1 = 0;
        int stackIn_15_2 = 0;
        jagdx.IDirect3DDevice stackIn_16_0;
        int stackIn_16_1;
        int stackIn_16_2;
        int stackIn_16_3;
        int var3;
        L0: {
          this.field_Cc.SetTexture(this.field_mc, param0.d(-22689));
          if (this.field_Dc[this.field_mc] != param0.field_a) {
            L1: {
              var3 = ir.a(param0.field_a, false);
              this.field_Cc.SetSamplerState(this.field_mc, 6, var3);
              this.field_Cc.SetSamplerState(this.field_mc, 5, var3);
              this.field_Dc[this.field_mc] = param0.field_a;
              stackIn_11_0 = this.field_ad[this.field_mc];
            ...
            if ((stackIn_12_0 ? 1 : 0) != stackIn_12_1) {
              ...
              L2: {
                stackIn_15_0 = this.field_Cc;

                stackIn_15_1 = this.field_mc;

                stackIn_15_2 = 7;

                if (!param0.field_e) {
                  stackIn_16_0 = (jagdx.IDirect3DDevice) ((Object) stackIn_15_0);
                  ...
                  stackIn_16_1 = stackIn_15_1;
                  stackIn_16_2 = stackIn_15_2;
                  stackIn_16_3 = ir.a(param0.field_a, false);
                  break L2;
                }
              }
              ((jagdx.IDirect3DDevice) (Object) stackIn_16_0).SetSamplerState(stackIn_16_1, stackIn_16_2, stackIn_16_3);
              this.field_ad[this.field_mc] = param0.field_e;
              break L0;
            }
          } else {
            L3: {
              stackIn_3_0 = this.field_ad[this.field_mc];
            ...
            if ((stackIn_4_0 ? 1 : 0) != stackIn_4_1) {
              ...
              L4: {
                stackIn_7_0 = this.field_Cc;

                stackIn_7_1 = this.field_mc;

                stackIn_7_2 = 7;

                if (param0.field_e) {
                  stackIn_8_0 = (jagdx.IDirect3DDevice) ((Object) stackIn_7_0);
                  stackIn_8_1 = stackIn_7_1;
                  stackIn_8_2 = stackIn_7_2;
                  stackIn_8_3 = ir.a(param0.field_a, false);
                  break L4;
                } else {
                  stackIn_8_0 = (jagdx.IDirect3DDevice) ((Object) stackIn_7_0);
                  stackIn_8_1 = stackIn_7_1;
              ...
              ((jagdx.IDirect3DDevice) (Object) stackIn_8_0).SetSamplerState(stackIn_8_1, stackIn_8_2, stackIn_8_3);
              this.field_ad[this.field_mc] = param0.field_e;
              break L0;
            }
          }
    ...
    final void GA(int param0) {
        this.field_Cc.Clear(1, param0, 0.0f, 0);
    }

    private final boolean h(boolean param0) {
        kg var3 = null;
        int var4 = 0;
        int var2 = this.field_Cc.TestCooperativeLevel();
        if (var2 == 0 || (var2 ^ -1) == 2005530518) {
    ...
    final void c(int param0, int param1) {
        if (param1 < 83) {
            byte[] var4 = (byte[]) null;
            this.a(true, (iw) null, -117, -19, (byte[]) null, 96);
        }
        this.field_Cc.SetTextureStageState(this.field_mc, 11, param0);
    }
    ...
    final void a(int param0, int param1, pv param2) {
        ...
        this.field_Cc.SetStreamSource(param0, var4.field_b, 0, var4.c(98));
    }
    ...
    final void s(int param0) {
        this.field_Cc.a(15, this.field_u);
    ...
    final void N(int param0) {
        ...
        if (!this.field_s.a(param0 ^ 10036)) {
            ...
            this.field_Gb.b(-110, field_Mc);
        }
        this.field_Cc.SetTransform(2, field_Mc);
    }
    ...
    final void a(int param0, ec param1) {
        ...
        if (this.field_Uc[this.field_mc] != param1.field_g) {
            this.field_Cc.SetSamplerState(this.field_mc, 1, !param1.field_g ? 3 : 1);
            this.field_Uc[this.field_mc] = param1.field_g;
        }
        if (param1.field_h != this.field_Bc[this.field_mc]) {
            this.field_Cc.SetSamplerState(this.field_mc, 2, !param1.field_h ? 3 : 1);
    ...
    final void a(int param0, jagdx.IDirect3DVertexShader param1) {
        ...
        this.field_Cc.SetVertexShader(param1);
        this.V(26803);
    }
    ...
    final void a(int param0, boolean param1, byte param2, mi param3) {
        ...
        this.field_Cc.SetTextureStageState(this.field_mc, var6, ir.a(param3, 21) | var7);
    }
    ...
    final void b(boolean param0) {
        ...
        this.field_Cc.a(36, this.field_E);
        this.field_Cc.a(37, this.field_Tb);
        this.field_Cc.SetRenderState(34, this.field_C);
    }

    final void bb(int param0) {
        L0: {
          if (sr.field_a == this.field_l) {
            this.field_Cc.SetRenderState(19, 5);
            this.field_Cc.SetRenderState(20, 6);
            break L0;
          } else {
            if (lh.field_n != this.field_l) {
              if (this.field_l != gb.field_t) {
                ...
                this.field_Cc.SetRenderState(19, 9);
                this.field_Cc.SetRenderState(20, 2);
                break L0;
              }
            } else {
              this.field_Cc.SetRenderState(19, 2);
              this.field_Cc.SetRenderState(20, 2);
              break L0;
            }
          }
    ...
    final void i(int param0) {
        this.field_Cc.SetViewport(this.field_r, this.field_y, this.field_rb, this.field_Sb, (float)param0, 1.0f);
    }
    ...
    final void x(int param0) {
        if (!this.field_Db) {
            this.field_Lb.b(param0 + -79, field_Mc);
        } else {
            field_Mc[3] = 0.0f;
            field_Mc[10] = 1.0f;
            field_Mc[5] = 1.0f;
        ...
        this.field_Cc.SetTransform(256, field_Mc);
    }
    ...
    final void X(int param0) {
        ...
        this.field_Cc.SetTextureStageState(this.field_mc, 4, var2);
    }
    ...
    final void J(int param0) {
        ...
        if (!(this.field_Tc)) {
            this.field_Cc.LightEnable(0, false);
            this.field_Cc.LightEnable(1, false);
            this.field_Cc.SetLight(0, this.field_Nc);
            this.field_Cc.SetLight(1, this.field_Rc);
            this.field_Cc.LightEnable(0, true);
            this.field_Cc.LightEnable(1, true);
            this.field_Tc = true;
        }
    }
    ...
    final void D(int param0) {
        ...
        boolean[] var3 = null;
        int var4 = 0;
        for (var2 = 0; var2 < this.field_cc; var2++) {
            this.field_Cc.SetSamplerState(var2, 7, 0);
            this.field_Cc.SetSamplerState(var2, 6, 2);
            this.field_Cc.SetSamplerState(var2, 5, 2);
            this.field_Cc.SetSamplerState(var2, 1, 1);
            this.field_Cc.SetSamplerState(var2, 2, 1);
        ...
        this.field_Cc.SetTextureStageState(0, 6, param0);
        this.field_Cc.SetRenderState(9, 2);
        this.field_Cc.SetRenderState(23, 4);
        this.field_Cc.SetRenderState(25, 5);
        this.field_Cc.SetRenderState(24, 0);
        this.field_Cc.SetRenderState(22, 2);
        this.field_Cc.SetRenderState(147, 1);
        this.field_Cc.SetRenderState(145, 1);
        this.field_Cc.a(38, 0.949999988079071f);
        this.field_Cc.SetRenderState(140, 3);
    ...
    final void p(byte param0) {
        ...
        this.field_Cc.a(27, this.field_ob);
    }
    ...
    final void a(byte param0, int param1, boolean param2, boolean param3, mi param4) {
        ...
        this.field_Cc.SetTextureStageState(this.field_mc, var6, ir.a(param4, 21) | var7);
    }

    final void a(byte param0, jagdx.IDirect3DPixelShader param1) {
        int var3 = 106 / ((param0 - -30) / 33);
        this.field_Cc.SetPixelShader(param1);
    }

    final void a(int param0, int param1, int param2, ck param3) {
        if (param1 != 0) {
            Integer var6 = (Integer) null;
            ir.createToolkit((java.awt.Canvas) null, (d) null, (ki) null, (Integer) null);
        }
        this.field_Cc.DrawPrimitive(ir.a(param3, (byte) -121), param0, param2);
    }

    final void A(int param0) {
        int var2 = -106 % ((param0 - 0) / 55);
        this.field_Cc.a(174, this.field_wc);
    }
    ...
    final void o(int param0) {
        this.field_Cc.SetTransform(3, this.field_A);
        if (param0 != -2) {
            field_Fc = (int[]) null;
        }
    }
        ...
        try {
          L0: {
            L1: {
              ...
              discarded$0 = new jagdx.GeometryBuffer(this.field_Wc);
              stackIn_3_0 = this;
            ...
            L3: {
              ...
              if (this.field_Kc.MaxActiveLights > 0) {
                stackIn_10_0 = this;
                stackIn_10_1 = this.field_Kc.MaxActiveLights;
                break L3;
              } else {
                stackIn_10_0 = this;
                stackIn_10_1 = 8;
            ...
            L7: {
              ...
              if ((this.field_Y ^ -1) < -1) {
                ...
                this.field_Xc.CheckDeviceMultiSampleType(this.field_zc, this.field_Ic, this.field_Pc.BackBufferFormat, true, 2);
                break L7;
              }
            }
    ...
    final void a(int param0, mp param1) {
        ...
        this.field_Cc.SetTextureStageState(this.field_mc, 11, this.field_mc | var3);
    }
    ...
    final void b(int param0, int param1) throws rf {
        ...
        this.field_Cc.EndScene();
        if (!this.field_Hc.a(-22169)) {
            fieldTemp$1 = this.field_Lc + 1;
                            ...
                            if ((32 & (var9.DestBlendCaps & var9.SrcBlendCaps)) == 0) {
                              ...
                              if (0 != (2 & (var9.DestBlendCaps & var9.SrcBlendCaps))) {
                                ...
                                if (-6 >= (var9.MaxStreams ^ -1)) {
                                  ...
                                  if (ir.a(var8, var6, var5_int, param3.intValue(), 6, var10)) {
                                    L2: {
                                    ...
                                    try {
                                      L3: {
                                        var12_ref = var8.a(var5_int, var6, param0, 64 | var11, var10);
                                        break L3;
                                      }
                                    ...
                                    var13 = new kg(var12_ref.b(0), var12_ref.b());
                                    var15 = new ir(var5_int, var6, param0, var7, var8, var12_ref, var13, var10, var9, param1, param2, param3.intValue());
                                    var4 = var15;
                                    var15.e(false);
                                    stackIn_42_0 = (ir) (var15);
                                    break L0;
                                  } else {
                                    throw new RuntimeException("");
                                  }
