    ...
    final void a(int param0, StringBuilder param1, Hashtable param2, byte param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param3 == -43) {
                ...
                int discarded$16 = ((ie) this).e(-119);
                break L1;
              }
            }
            var5_int = 0;
            L2: while (true) {
              if (param0 < var5_int) {
                if (null != ((ie) this).field_y) {
                  StringBuilder discarded$17 = ((ie) this).field_y.a(1 + param0, param2, param1, 0);
                  break L0;
                } else {
                  StringBuilder discarded$18 = param1.append("null");
                  return;
                }
              } else {
                StringBuilder discarded$19 = param1.append(32);
                var5_int++;
                continue L2;
              }
            }
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("ie.L(").append(param0).append(44);
          ...
          throw qo.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + 44 + param3 + 41);
        }
    }
    ...
    boolean a(pk param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("ie.R(");
          ...
          throw qo.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
    ...
    final boolean a(pk param0, byte param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_7_1 = new StringBuilder().append("ie.Q(");
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
        ...
        try {
          L0: {
            ...
            if (var5_int != 80) {
              ...
              L2: {
                if (hw.field_b[81]) {
                  stackOut_8_0 = this.a(false, param0);
                  stackIn_9_0 = stackOut_8_0;
                  break L2;
                } else {
                  int discarded$3 = 0;
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("ie.KA(");
            stackIn_16_0 = stackOut_14_0;
            stackIn_16_1 = stackOut_14_1;
    ...
    final static void a(int param0, String param1, java.applet.Applet param2) {
        try {
            ...
            try {
                ...
                throw qo.a((Throwable) (Object) runtimeException, "ie.M(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 41);
            }
    ...
    StringBuilder a(int param0, Hashtable param1, StringBuilder param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("ie.S(").append(param0).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
    ...
    void a(pk param0, boolean param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ie.T(");
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
          ...
          throw qo.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
    }
    ...
    private final boolean a(pk param0) {
        ...
        try {
          ...
          L3: {
            var3 = decompiledCaughtException;
            stackOut_6_0 = (RuntimeException) var3;
            stackOut_6_1 = new StringBuilder().append("ie.N(");
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
    ...
    final boolean a(int param0, int param1, int param2, int param3, int param4, pk param5, int param6) {
        ...
        try {
                ...
                L2: {
                  if (null == ((ie) this).field_y) {
                    ...
                    if (!((ie) this).field_y.d(-1)) {
                      ...
                      if (!((ie) this).field_y.a(param0, param1, param2, param3, param4, param5, param6)) {
                        break L2;
                      } else {
                        stackOut_6_0 = 1;
                        stackIn_8_0 = stackOut_6_0;
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("ie.RA(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
            stackIn_10_0 = stackOut_9_0;
            stackIn_10_1 = stackOut_9_1;
          ...
          throw qo.a((Throwable) (Object) stackIn_12_0, stackIn_12_2 + 44 + param6 + 41);
        }
