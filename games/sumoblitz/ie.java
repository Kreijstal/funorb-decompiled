...
abstract class ie extends pk implements ug {
    ...
    private final boolean a(boolean param0, pk param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("ie.K(").append(param0).append(',');
    ...
    final void a(int param0, StringBuilder param1, Hashtable param2, byte param3) {
        ...
        try {
          L0: {
            L1: {
              discarded$27 = param1.append('\n');
              if (param3 == -43) {
                break L1;
              } else {
                discarded$28 = this.e(-119);
                break L1;
              }
            }
            var5_int = 0;
            L2: while (true) {
              L3: {
                L4: {
                  if (param0 < var5_int) {
                    if (null != this.field_y) {
                      ...
                      discarded$29 = param1.append("null");
                      if (var6 == 0) {
                        break L3;
                      } else {
                        break L4;
                ...
                discarded$31 = this.field_y.a(1 + param0, param2, param1, 0);
                break L3;
              }
              break L0;
            }
          ...
          L5: {
            ...
            stackOut_13_1 = new StringBuilder().append("ie.L(").append(param0).append(',');
            ...
            if (this.field_w != null) {
              ...
              if (null != this.field_y) {
                ...
                if (param2 <= -35) {
                  ...
                  discarded$8 = this.e(31);
                  return;
                }
              } else {
                if (param2 > -35) {
                  discarded$9 = this.e(31);
                  return;
                } else {
                  return;
                }
    ...
    void a(int param0, int param1, pk param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("ie.U(").append(param0).append(',').append(param1).append(',');
            stackIn_6_0 = stackOut_4_0;
    ...
    private final boolean a(pk param0, boolean param1) {
        ...
        try {
          ...
          L4: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) (var3);
            stackOut_8_1 = new StringBuilder().append("ie.N(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
