    ...
    final static void a(int[] param0, int[] param1, boolean param2, boolean param3, gk param4, boolean param5, int param6) {
        ...
        try {
              ...
              L1: while (true) {
                L2: {
                  L3: {
                            ...
                            L6: while (true) {
                              if (stackIn_62_0 >= stackIn_62_1) {
                                ...
                                if (var30 != 0) {
                                  ...
                                  if (stackIn_66_0 >= of.field_t.length) {
                                    break L4;
                                  } else {
                    ...
                    stackOut_70_0 = param2;
                    stackIn_71_0 = stackOut_70_0 ? 1 : 0;
                    break L3;
                  }
                  ih.a(stackIn_71_0 != 0, param4, -1, var8, var7_int);
                  break L2;
                }
                break L0;
              }
          ...
          L14: {
            ...
            stackOut_73_1 = new StringBuilder().append("up.A(");
          ...
          throw qo.a((Throwable) (Object) stackIn_85_0, stackIn_85_2 + ',' + param5 + ',' + param6 + ')');
        }
    }
