...
final class ss {
    ...
    final static void a(al param0, byte param1, ki param2, int param3) {
        try {
            ...
            throw qo.a((Throwable) (Object) runtimeException, "ss.C(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 41);
        }
    }
    ...
    final static void a(int param0, int param1, qv param2) {
        ...
        try {
            ...
            throw qo.a((Throwable) (Object) runtimeException, "ss.A(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
