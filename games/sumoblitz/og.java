...
final class og {
    ...
    private final qp a(String param0, int param1, int[] param2) {
        ...
        qp stackOut_3_0 = null;
        qp stackOut_1_0 = null;
        ...
        try {
          L0: {
            if (!((og) this).field_a.b((byte) -125, "")) {
              stackOut_3_0 = this.a(88, param0, param2, "");
              stackIn_4_0 = stackOut_3_0;
              break L0;
            } else {
              stackOut_1_0 = this.a(45, "", param2, param0);
          ...
          L2: {
            ...
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(44).append(80).append(44);
    ...
    final qp b(int param0, String param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = this.a(-2, param1, (int[]) null);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("og.I(").append(param0).append(44);
    ...
    final static boolean a(int param0) {
        if (param0 >= -5) {
            og.a(true);
            return oh.field_e == 24 ? true : false;
        }
        return oh.field_e == 24 ? true : false;
    }
    ...
    final qp a(int param0, String param1) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = this.a(param1, 80, (int[]) null);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("og.B(").append(param0).append(44);
    ...
    private final qp a(String param0, int param1, int[] param2, String param3) {
        ...
        try {
          L0: {
            var5_int = ((og) this).field_e.a(0, param3);
            if (var5_int >= param1) {
              var6 = ((og) this).field_e.a(var5_int, param0, (byte) 127);
              if (var6 >= 0) {
                stackOut_6_0 = this.a(param2, param1 ^ 1026562700, var5_int, var6);
                stackIn_7_0 = stackOut_6_0;
                break L0;
              } else {
                return null;
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("og.E(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    private final qp a(int[] param0, int param1, int param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              var5_int = ((-2147479553 & param2) << 4 | param2 >>> 12) ^ param3;
            ...
            if (var8 != null) {
              ...
              var9 = ae.a(((og) this).field_e, param2, param3);
              if (var9 != null) {
                L3: {
                  var11 = var9.b();
                  var8 = var11;
                  ((og) this).field_c.a((ms) (Object) var8, -1, var6);
                  if (param0 != null) {
          ...
          L4: {
            ...
            stackOut_18_1 = new StringBuilder().append("og.J(");
    ...
    private final qp a(int param0, int param1, boolean param2, int[] param3) {
        ...
        try {
          L0: {
            ...
            if (var8 != null) {
              ...
              L2: {
                ...
                if (var9 == null) {
                  var9 = q.a(((og) this).field_a, param1, param0);
                  if (var9 != null) {
                    ((og) this).field_b.a((ms) (Object) var9, -1, var6);
                    break L2;
                  } else {
                    return null;
                  }
          ...
          L3: {
            ...
            stackOut_19_1 = new StringBuilder().append("og.A(").append(param0).append(44).append(param1).append(44).append(0).append(44);
            stackIn_21_0 = stackOut_19_0;
            stackIn_21_1 = stackOut_19_1;
    ...
    private final qp a(int param0, String param1, int[] param2, String param3) {
        ...
        try {
          L0: {
            L1: {
              var5_int = ((og) this).field_a.a(0, param1);
              if (param0 >= 33) {
                break L1;
              } else {
                boolean discarded$2 = og.a(30);
                break L1;
              }
            }
            if (var5_int >= 0) {
              var6 = ((og) this).field_a.a(var5_int, param3, (byte) 127);
              if (var6 >= 0) {
                stackOut_8_0 = this.a(var6, var5_int, false, param2);
                stackIn_9_0 = stackOut_8_0;
                break L0;
              } else {
                return null;
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("og.K(").append(param0).append(44);
    ...
    final qp a(int param0, int[] param1, int param2) {
        ...
        try {
          if (((og) this).field_e.b(true) == -2) {
            stackOut_2_0 = this.a(param1, 1026562700, 0, param0);
            stackIn_3_0 = stackOut_2_0;
            return stackIn_3_0;
          } else {
            if (-2 != ((og) this).field_e.a((byte) -65, param0)) {
              ...
              stackOut_5_0 = this.a(param1, param2 + 1026551991, param0, 0);
              stackIn_6_0 = stackOut_5_0;
              return stackIn_6_0;
            }
          }
          ...
          L0: {
            ...
            stackOut_11_1 = new StringBuilder().append("og.G(").append(param0).append(44);
            stackIn_13_0 = stackOut_11_0;
            stackIn_13_1 = stackOut_11_1;
            stackIn_12_0 = stackOut_11_0;
            stackIn_12_1 = stackOut_11_1;
          ...
          throw qo.a((Throwable) (Object) stackIn_14_0, stackIn_14_2 + 44 + param2 + 41);
        }
    }
        ...
        try {
          L0: {
            if (!((og) this).field_e.b((byte) 116, "")) {
              stackOut_5_0 = this.a("", 0, param2, param1);
              stackIn_6_0 = stackOut_5_0;
              break L0;
            } else {
          ...
          L1: {
            ...
            stackOut_7_1 = new StringBuilder().append("og.H(").append(-2).append(44);
        ...
        try {
          if (((og) this).field_a.b(true) != 1) {
            if (1 != ((og) this).field_a.a((byte) -65, param2)) {
              ...
              stackOut_4_0 = this.a(0, param2, false, param1);
              stackIn_5_0 = stackOut_4_0;
              return stackIn_5_0;
            }
          } else {
            stackOut_1_0 = this.a(param2, 0, false, param1);
            stackIn_2_0 = stackOut_1_0;
            return stackIn_2_0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L1: {
            ...
            stackOut_9_1 = new StringBuilder().append("og.F(").append(param0).append(44);
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
            stackIn_10_0 = stackOut_9_0;
            stackIn_10_1 = stackOut_9_1;
    ...
    og(ki param0, ki param1) {
        ...
        try {
            ...
            throw qo.a((Throwable) (Object) runtimeException, "og.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
