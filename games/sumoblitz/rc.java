...
final class rc extends bp implements ef {
    ...
    rc(on param0, int param1, boolean param2, int[][] param3) {
        ...
        try {
              ...
              if (!param2) {
                ...
                L3: while (true) {
                  if (6 <= var5_int) {
                    ...
                    ((rc) this).a(param1, param1, param3[var5_int], 34069 - -var5_int, -1);
                    var5_int++;
                    continue L3;
                  }
                }
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("rc.<init>(");
    ...
    final static byte[] a(String param0) {
        ...
        try {
          L0: {
            stackOut_2_0 = ce.field_q.a(param0, "", -1);
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("rc.M(");
