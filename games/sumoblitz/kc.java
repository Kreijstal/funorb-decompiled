        ...
        try {
            ...
            try {
                  ...
                  L1: {
                    if (ke.field_a != null) {
                      ...
                      if (param2 == 44) {
                        ...
                        lw.field_b = param1;
                        ct.field_z = ra.c(2);
                        dupTemp$1 = new wi(param0, param5, param6, true);
              ...
              L6: {
                ...
                stackOut_22_1 = new StringBuilder().append("kc.P(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',');
          ...
          L0: {
            ...
            L6: {
              L7: {
                ...
                discarded$2 = ((java.awt.Container) (var2)).add((java.awt.Component) ((Object) qn.field_f));
                qn.field_f.setSize(gi.field_h, wq.field_b);
                qn.field_f.setVisible(true);
                if (ck.field_c == var2) {
                  break L7;
            ...
            try {
              L0: {
                if (!this.field_d) {
                  ...
                  try {
                    L1: {
                      discarded$3 = tw.a(ra.c(2), param1 ^ -21354, "loggedout");
                      break L1;
                    }
                  } catch (java.lang.Throwable decompiledCaughtParameter0) {
                    decompiledCaughtException = decompiledCaughtParameter0;
                        ...
                        L20: {
                          L21: {
                            if ((fd.field_k ^ -1L) == -1L) {
                              ...
                              stackOut_99_0 = ((wq.a(-122) ^ -1L) < (fd.field_k ^ -1L) ? -1 : ((wq.a(-122) ^ -1L) == (fd.field_k ^ -1L) ? 0 : 1));
