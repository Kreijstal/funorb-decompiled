    ...
    final void a(int param0, ha param1, int param2) {
        ...
        try {
          L0: {
            ...
            discarded$2 = qv.field_k.a(100, 5023231 | param0 << 730099416, 0, 200, 220, (int[]) null, (hr[]) null, 90, -1, 0, 0, -8787, ps.field_b.toUpperCase() + " " + in.field_z + "<br>" + tj.field_l.toUpperCase() + " " + dp.b(jk.field_a, -23620), (aa) null, 1, 1);
            discarded$3 = uq.field_a.a(100, -1, 0, 200, 220, (int[]) null, (hr[]) null, 90, -1, 0, 0, -8787, ps.field_b.toUpperCase() + " " + in.field_z + "<br>" + tj.field_l.toUpperCase() + " " + dp.b(jk.field_a, param2 + -21265), (aa) null, 1, 1);
