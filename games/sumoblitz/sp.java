...
class sp extends pk implements ug {
    ...
    private final void a(StringBuilder param0, byte param1, Hashtable param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param1 < -30) {
                ...
                var9 = null;
                boolean discarded$14 = ((sp) this).a((pk) null, (byte) -17);
                break L1;
              }
            }
            L2: while (true) {
              if (var6 == null) {
                ...
                L3: while (true) {
                  if (var7 > param3) {
                    StringBuilder discarded$16 = var6.a(param3 - -1, param2, param0, 0);
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("sp.SA(");
    ...
    boolean a(pk param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          throw qo.a((Throwable) (Object) stackIn_15_0, stackIn_15_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
