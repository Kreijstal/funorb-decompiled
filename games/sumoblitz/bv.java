        ...
        try {
          L0: {
            ...
            L3: {
              ...
              discarded$1 = this.field_c.a("<u=" + Integer.toString(var6_int, 16) + ">" + param0.field_m + "</u>", param4 - -param0.field_r, param0.field_v + param1, param0.field_q, param0.field_p, var6_int, -1, this.field_d, this.field_a, this.field_c.field_s + this.field_c.field_I);
              if (!param0.d(-1)) {
                break L3;
              } else {
                L4: {
