...
final class vu extends ab {
    ...
    vu(int param0) {
        ...
        while (var8 < 256) {
            ...
            dupTemp$0 = this.field_f[var8];
            this.field_f[256 + var4] = dupTemp$0;
            this.field_f[var4] = dupTemp$0;
            this.field_f[var8 + 256] = var5;
            this.field_f[var8] = var5;
            var8++;
        }
    }
    ...
    final void a(float param0, int param1, float param2, float param3, int param4, int param5, int param6, float[] param7, int param8, float param9, int param10) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_10_1 = new StringBuilder().append("vu.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',');
