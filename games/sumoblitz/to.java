...
final class to extends ms {
    ...
    final boolean a(int param0) {
        ...
        if (param0 != 80) {
          L0: {
            ...
            if (this.field_l + this.field_n + this.field_r >= fieldTemp$2) {
              stackIn_8_0 = 0;
              break L0;
            } else {
              stackIn_8_0 = 1;
          ...
          L1: {
            ...
            this.field_u = this.field_u + 1;
            if (this.field_l + this.field_n + this.field_r >= fieldTemp$3) {
              stackIn_4_0 = 0;
              break L1;
            } else {
              stackIn_4_0 = 1;
    ...
    final void a(byte param0) {
        ...
        if (this.field_r > this.field_u) {
          ...
          if (this.field_v) {
            qv.field_k.a(100, 5023231 | var2 << 1010733112, 0, 320, 160, (int[]) null, (hr[]) null, this.field_p + var3, -1, 0, 0, -8787, this.field_o, (aa) null, 1, 1);
            uq.field_a.a(100, var2 << -533908456 | 16777215, 0, 320, 160, (int[]) null, (hr[]) null, this.field_p + var3, -1, 0, 0, -8787, this.field_o, (aa) null, 1, 1);
            return;
          } else {
          ...
          if (this.field_u < this.field_n + this.field_r) {
            ...
            if (!this.field_v) {
              ...
              qv.field_k.a(100, var2 << -1531396040 | 5023231, 0, 320, 160, (int[]) null, (hr[]) null, this.field_p, -1, 0, 0, -8787, this.field_o, (aa) null, 1, 1);
              uq.field_a.a(100, 16777215 | var2 << 459093464, 0, 320, 160, (int[]) null, (hr[]) null, this.field_p, -1, 0, 0, -8787, this.field_o, (aa) null, 1, 1);
              return;
            }
          } else {
            ...
            if (-1 > (var3 ^ -1)) {
              ...
              if (!this.field_v) {
                ...
                qv.field_k.a(100, 5023231 | var3 << -586897256, 0, 320, 160, (int[]) null, (hr[]) null, -var4 + this.field_p, -1, 0, 0, param0 + -8717, this.field_o, (aa) null, 1, 1);
                uq.field_a.a(100, var3 << 1075943736 | 16777215, 0, 320, 160, (int[]) null, (hr[]) null, -var4 + this.field_p, -1, 0, 0, -8787, this.field_o, (aa) null, 1, 1);
                return;
              }
            } else {
              return;
