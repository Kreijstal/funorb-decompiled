...
abstract class vn extends pj {
    ...
    final int a(char param0) {
        return ((vn) this).field_L[uo.a(true, param0) & 255];
    }
            ...
            switch (statePc) {
                ...
                case 26: {
                    try {
                        ...
                        var9_int = no.a((byte) -128, var10);
                        var4 = var4 + ((vn) this).field_P[var9_int].field_f;
                        var3 = 0;
                        statePc = 27;
                        continue stateLoop;
                ...
                case 31: {
                    var7 = (char)(uo.a(true, (char) var7) & 255);
                    var4 = var4 + ((vn) this).field_L[var7];
                ...
                case 33: {
                    var4 = var4 + ((vn) this).field_D[(var3 << 8) + var7];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                      ...
                      if (var5_int >= 256) {
                        ...
                        L4: while (true) {
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ((vn) this).field_D = new byte[65536];
                                var7 = 0;
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    ((vn) this).field_F = var25[32] + var22[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                ((vn) this).field_D[(var7 << 8) + var8] = (byte)vn.a(var23, var24, var25, ((vn) this).field_L, var22, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                ((vn) this).field_L[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
            ...
            var2 = 0;
            L10: while (true) {
              if (var2 >= ((vn) this).field_L.length) {
                ((vn) this).field_F = param0[256] & 255;
                break L0;
              } else {
                ((vn) this).field_L[var2] = param0[var2] & 255;
                var2++;
                continue L10;
              }
            }
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_E = (param1 - ((vn) this).a(param0) << 8) / var3;
                break L1;
              }
            }
            return;
        ...
        if (param0 != null) {
          L0: {
            ...
            if (param10 != 0) {
              ...
              param10 = ((vn) this).field_F;
              break L0;
            }
          }
          L1: {
            var12 = new int[]{param3};
            if (param4 >= ((vn) this).field_s + ((vn) this).field_I + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = ((vn) this).a(param0, var12, field_N);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - ((vn) this).field_s - ((vn) this).field_I - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + ((vn) this).field_s + var15;
                  param10 = param10 + var15;
                  break L3;
                } else {
                  var14 = param2 + param4 - ((vn) this).field_I - (var13 - 1) * param10;
                  break L3;
                }
              } else {
                var14 = param2 + ((vn) this).field_s + (param4 - ((vn) this).field_s - ((vn) this).field_I - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + ((vn) this).field_s;
              break L3;
            }
          }
          var15 = 0;
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.b(field_N[var15], param1 + param3 - ((vn) this).a(field_N[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_N[var15], param1 + (param3 - ((vn) this).a(field_N[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
            ...
            switch (statePc) {
                ...
                case 23: {
                    try {
                        ...
                        var10 = no.a((byte) -128, var13);
                        var11_ref_pb = ((vn) this).field_P[var10];
                        if (((vn) this).field_u == null) {
                            statePc = 25;
                        } else {
                            statePc = 24;
                        }
                ...
                case 24: {
                    try {
                        stackOut_24_0 = ((vn) this).field_u[var10];
                ...
                case 25: {
                    try {
                        stackOut_25_0 = var11_ref_pb.field_d;
                ...
                case 27: {
                    try {
                        var11_ref_pb.a(param1, param2 + ((vn) this).field_F - var12);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 28: {
                    try {
                        var11_ref_pb.a(param1, param2 + ((vn) this).field_F - var12, field_C);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_pb.field_f;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
                ...
                case 35: {
                    var8 = (char)(uo.a(true, (char) var8) & 255);
                    if (((vn) this).field_D == null) {
                        statePc = 38;
                    } else {
                        statePc = 36;
                ...
                case 37: {
                    param1 = param1 + ((vn) this).field_D[(var5 << 8) + var8];
                    statePc = 38;
                    continue stateLoop;
                }
                case 38: {
                    var9 = ((vn) this).field_O[var8];
                    var10 = ((vn) this).field_K[var8];
                    var11 = param1;
                    if (var8 == 32) {
                        statePc = 46;
                    } else {
                ...
                case 41: {
                    ((vn) this).a(var8, param1 + ((vn) this).field_A[var8] + 1, param2 + ((vn) this).field_t[var8] + 1, var9, var10, field_J, true);
                    statePc = 42;
                    continue stateLoop;
                }
                case 42: {
                    ((vn) this).a(var8, param1 + ((vn) this).field_A[var8], param2 + ((vn) this).field_t[var8], var9, var10, field_H, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 43: {
                ...
                case 44: {
                    ((vn) this).a(var8, param1 + ((vn) this).field_A[var8] + 1, param2 + ((vn) this).field_t[var8] + 1, var9, var10, field_J, field_C, true);
                    statePc = 45;
                    continue stateLoop;
                }
                case 45: {
                    ((vn) this).a(var8, param1 + ((vn) this).field_A[var8], param2 + ((vn) this).field_t[var8], var9, var10, field_H, field_C, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 46: {
                ...
                case 48: {
                    param1 = param1 + ((vn) this).field_L[var8];
                    if (field_x == -1) {
                        statePc = 50;
                    } else {
                        statePc = 49;
                ...
                case 49: {
                    lk.f(var11, param2 + (int)((double)((vn) this).field_F * 0.7), param1 - var11, field_x);
                    statePc = 50;
                    continue stateLoop;
                }
                case 50: {
                ...
                case 51: {
                    lk.f(var11, param2 + ((vn) this).field_F + 1, param1 - var11, field_v);
                    statePc = 52;
                    continue stateLoop;
                }
                case 52: {
    ...
    final int a(String param0, int param1, int param2) {
        if (param2 == 0) {
            param2 = ((vn) this).field_F;
        }
        int var4 = ((vn) this).a(param0, new int[1], field_N);
        int var5 = (var4 - 1) * param2;
        return ((vn) this).field_s + var5 + ((vn) this).field_I;
    }
    ...
    final void a(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.b(param0, param1 - ((vn) this).a(param0) / 2, param2);
    }
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9) {
        return ((vn) this).a(param0, param1, param2, param3, param4, param5, param6, 256, param7, param8, param9);
    }

    final int b(String param0, int param1) {
        return ((vn) this).a(param0, new int[1], field_N);
    }
    ...
    private final void b(String param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 27: {
                    try {
                        this.a(field_r, field_z, field_M);
                        statePc = 30;
                        continue stateLoop;
                    } catch (Throwable stateCaught_27) {
                        caughtException = stateCaught_27;
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = lb.a(field_w, 60, ' ', 0);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
                ...
                case 13: {
                    var4 = var4 + ((vn) this).field_D[(var10 << 8) + 60];
                    statePc = 14;
                    continue stateLoop;
                }
                case 14: {
                ...
                case 18: {
                    var4 = var4 + ((vn) this).field_D[(var10 << 8) + 62];
                    statePc = 19;
                    continue stateLoop;
                }
                case 19: {
                ...
                case 23: {
                    var4 = var4 + ((vn) this).field_D[(var10 << 8) + 160];
                    statePc = 24;
                    continue stateLoop;
                }
                case 24: {
                ...
                case 28: {
                    var4 = var4 + ((vn) this).field_D[(var10 << 8) + 173];
                    statePc = 29;
                    continue stateLoop;
                }
                case 29: {
                ...
                case 33: {
                    var4 = var4 + ((vn) this).field_D[(var10 << 8) + 215];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
                ...
                case 38: {
                    var4 = var4 + ((vn) this).field_D[(var10 << 8) + 128];
                    statePc = 39;
                    continue stateLoop;
                }
                case 39: {
                ...
                case 43: {
                    var4 = var4 + ((vn) this).field_D[(var10 << 8) + 169];
                    statePc = 44;
                    continue stateLoop;
                }
                case 44: {
                ...
                case 48: {
                    var4 = var4 + ((vn) this).field_D[(var10 << 8) + 174];
                    statePc = 49;
                    continue stateLoop;
                }
                case 49: {
                ...
                case 51: {
                    try {
                        ...
                        var16_int = no.a((byte) -127, var18);
                        var4 = var4 + ((vn) this).field_P[var16_int].field_f;
                        var10 = 0;
                        statePc = 54;
                        continue stateLoop;
                ...
                case 60: {
                    var4 = var4 + ((vn) this).field_D[(var10 << 8) + var14];
                    statePc = 61;
                    continue stateLoop;
                }
                case 61: {
    ...
    final void c(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.b(param0, param1 - ((vn) this).a(param0), param2);
    }

    abstract void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6);

    vn(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((vn) this).field_F = 0;
        ((vn) this).field_A = param1;
        ((vn) this).field_t = param2;
        ((vn) this).field_O = param3;
        ((vn) this).field_K = param4;
        this.a(param0);
        var6 = 2147483647;
        var7 = -2147483648;
        var8 = 0;
        L0: while (true) {
          if (var8 >= 256) {
            ((vn) this).field_s = ((vn) this).field_F - var6;
            ((vn) this).field_I = var7 - ((vn) this).field_F;
            ((vn) this).field_y = ((vn) this).field_F - ((vn) this).field_t[88];
          } else {
            L1: {
              if (((vn) this).field_t[var8] >= var6) {
                break L1;
              } else {
                if (((vn) this).field_K[var8] == 0) {
                  break L1;
                } else {
                  var6 = ((vn) this).field_t[var8];
                  break L1;
                }
              }
            }
            if (((vn) this).field_t[var8] + ((vn) this).field_K[var8] > var7) {
              var7 = ((vn) this).field_t[var8] + ((vn) this).field_K[var8];
              var8++;
              continue L0;
            } else {
              var8++;
