...
final class jh extends ie {
          ...
          L0: {
            L1: {
              if (param3 == 0) {
                ...
                ((jh) this).field_C = true;
                break L1;
              }
            }
            L2: {
              if (!((jh) this).a(param0, param1, 115, param2)) {
                break L2;
              } else {
                ((jh) this).a(param0, (byte) -128, param2, param1);
                ((jh) this).a(param0, param2, param1, (byte) -43);
                StringBuilder discarded$26 = param2.append(" revert=").append(((jh) this).field_G);
                if (((jh) this).field_F == 2147483647) {
                  break L2;
                } else {
        ...
        try {
          L0: {
            L1: {
              L2: {
                L3: {
                  if (!(((jh) this).field_y instanceof wp)) {
                    break L3;
                  } else {
                    if (!((wp) (Object) ((jh) this).field_y).field_x) {
                      break L2;
                    } else {
                      break L3;
                    }
                ...
                if (((jh) this).field_l != 1) {
                  ...
                  L4: {
                    var5_int = -param0 + -((jh) this).field_H + ko.field_p;
                    var6 = -param3 + -((jh) this).field_J + pi.field_e;
                    if (var5_int != ((jh) this).field_r) {
                      break L4;
                    } else {
                      if (((jh) this).field_v != var6) {
                        break L4;
                      } else {
                  ...
                  ((jh) this).field_r = var5_int;
                  ((jh) this).field_v = var6;
                  if (!(((jh) this).field_o instanceof mt)) {
                    break L1;
                  } else {
                    ((mt) (Object) ((jh) this).field_o).a((jh) this, param0, -18285, param3);
                    break L1;
                  }
                }
              }
              if (!((jh) this).field_G) {
                ...
                L5: {
                  if (((jh) this).field_F == ((jh) this).field_r) {
                    break L5;
                  } else {
                    L6: {
                      var5_int = ((jh) this).field_F - ((jh) this).field_r;
                      stackOut_11_0 = this;
                      stackOut_11_1 = ((jh) this).field_r;
                      stackIn_13_0 = stackOut_11_0;
                      stackIn_13_1 = stackOut_11_1;
                      stackIn_12_0 = stackOut_11_0;
                      stackIn_12_1 = stackOut_11_1;
                ...
                if (((jh) this).field_D != ((jh) this).field_v) {
                  L7: {
                    var5_int = -((jh) this).field_v + ((jh) this).field_D;
                    stackOut_19_0 = this;
                    stackOut_19_1 = ((jh) this).field_v;
    ...
    jh(int param0, int param1, int param2, int param3, mh param4, qm param5, pk param6, boolean param7, boolean param8) {
        ...
        ((jh) this).field_F = 2147483647;
        ((jh) this).field_D = 2147483647;
        try {
            ((jh) this).field_C = param8 ? true : false;
    ...
    final boolean a(pk param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
          L0: {
            ...
            if (((jh) this).b(param5, -1, param4, param2, param6)) {
              L3: {
                if (param3 != 1) {
                  break L3;
                } else {
                  gt.field_gb = (jh) this;
                  ((jh) this).field_H = -param4 + (-((jh) this).field_r + param5);
                  ((jh) this).field_J = -param6 + (param2 + -((jh) this).field_v);
                  break L3;
                }
              }
              ((jh) this).field_l = param3;
              stackOut_11_0 = 1;
              stackIn_12_0 = stackOut_11_0;
              break L0;
            } else {
    ...
    final void d(boolean param0) {
        super.d(param0);
        ((jh) this).field_y.a(-111, 0, 0, ((jh) this).field_p, ((jh) this).field_q);
        ((jh) this).field_F = ((jh) this).field_r;
        ((jh) this).field_D = ((jh) this).field_v;
        if (param0) {
            Object var3 = null;
            boolean discarded$0 = ((jh) this).a((pk) null, 44, -30, 20, 44, -100, 90);
        }
    }
