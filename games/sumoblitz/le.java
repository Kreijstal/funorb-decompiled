...
final class le extends ms {
    ...
    final void a(int param0, int param1) {
        ...
        if (field_k == null || field_k.length != this.field_l.length) {
            field_k = new int[this.field_l.length];
        }
        int var3 = this.field_l.length;
        int var4 = param0;
        int var5 = this.field_n - 1;
        int var6 = this.field_n * param1;
        int var7 = var3 - 1;
        for (var8_int = 0; var8_int < var3; var8_int = var8_int + this.field_n) {
            var9 = var8_int + var6 & var7;
            for (var10 = 0; var10 < this.field_n; var10++) {
                var11 = var8_int + var10;
                var12 = var9 + (var10 + var4 & var5);
                field_k[var11] = this.field_l[var12];
            }
        }
        int[] var8 = this.field_l;
