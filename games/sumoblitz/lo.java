...
final class lo {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_e[var16]) {
                  var9 = field_j[var16];
                  var10 = field_l[var16] * this.field_d;
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_i, 0, field_j, 0, var2);
        int var3 = field_f[this.field_d - 1];
        ...
        for (var6 = 0; var6 < this.field_b.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = q.field_I[this.field_k[var7]].b();
            }
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_g[var7]) {
                              ...
                              var5++;
                              this.field_i[incrementValue$2] = q.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
