...
final class lo {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((lo) this).field_i.length;
        var4 = field_f[((lo) this).field_d - 1];
        var5 = field_e;
        field_e[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_l[0] * ((lo) this).field_d;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_e[var16]) {
                  var9 = field_j[var16];
                  var10 = field_l[var16] * ((lo) this).field_d;
            ...
            L3: {
              var7 = lo.a(field_j, var6);
              var8_int = lo.b(field_j, var6);
              var9 = this.a(field_j[var7], field_l[var7], field_j[var8_int], field_l[var8_int], field_j[var6]);
              var10 = field_l[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean b() {
        ...
        int var2 = ((lo) this).field_i.length;
        System.arraycopy((Object) (Object) ((lo) this).field_i, 0, (Object) (Object) field_j, 0, var2);
        int var3 = field_f[((lo) this).field_d - 1];
        int var4 = mr.a(var3 - 1, (byte) -115);
        field_l[0] = q.a(var4);
        field_l[1] = q.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((lo) this).field_b.length; var6++) {
            var7 = ((lo) this).field_b[var6];
            var8 = ((lo) this).field_g[var7];
            var9 = ((lo) this).field_a[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = q.field_I[((lo) this).field_k[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((lo) this).field_h[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_l[incrementValue$0] = var13 >= 0 ? q.field_I[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    lo() {
        ...
        if (var1 == 1) {
          var2 = q.a(5);
          var3 = 0;
          ((lo) this).field_b = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((lo) this).field_g = new int[var3];
              ((lo) this).field_a = new int[var3];
              ((lo) this).field_k = new int[var3];
              ((lo) this).field_h = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((lo) this).field_d = q.a(2) + 1;
                  var4 = q.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((lo) this).field_i = new int[var5];
                      ((lo) this).field_i[0] = 0;
                      ((lo) this).field_i[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((lo) this).field_g[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((lo) this).field_i[incrementValue$2] = q.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((lo) this).field_g[((lo) this).field_b[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((lo) this).field_g[var4] = q.a(3) + 1;
                    int dupTemp$3 = q.a(2);
                    ((lo) this).field_a[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((lo) this).field_k[var4] = q.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
