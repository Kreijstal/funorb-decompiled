    ...
    final di a(int param0, la param1, boolean param2, byte param3, la param4) {
        ...
        try {
                ...
                if ((param0 ^ -1) > -1) {
                  ...
                  if (param0 >= this.field_b.length) {
                    ...
                    if (this.field_b[param0] == null) {
                      ...
                      stackOut_8_0 = this.field_b[param0];
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("oa.F(").append(param0).append(',');
    ...
    final static bf a(boolean param0, boolean param1) {
        ...
        L2: {
          if (param1) {
            ...
            var8 = (Random) null;
            discarded$5 = oa.a((byte) -112, 80, (Random) null);
            break L2;
          }
        }
        L3: {
        ...
        L5: {
          if (-2 == (uk.field_L ^ -1)) {
            discarded$6 = var9.c(false);
            discarded$7 = var9.b(false);
            break L5;
          } else {
            if ((uk.field_L ^ -1) == -5) {
              discarded$8 = var9.c(false);
              discarded$9 = var9.b(false);
              break L5;
            } else {
              break L5;
            }
        ...
        try {
          L0: {
            if (-1 <= (param1 ^ -1)) {
              ...
              if (i.a(17004, param1)) {
                stackOut_6_0 = (int)((4294967295L & (long)param2.nextInt()) * (long)param1 >> 949195872);
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("oa.D(").append(param0).append(',').append(param1).append(',');
            stackIn_16_0 = stackOut_14_0;
            stackIn_16_1 = stackOut_14_1;
            stackIn_15_0 = stackOut_14_0;
            stackIn_15_1 = stackOut_14_1;
