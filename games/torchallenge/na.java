...
class na extends t {
    ...
    final static void a(byte param0, da param1, da param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("na.C(").append(param0).append(44);
    ...
    final void a(uf param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("na.A(");
    ...
    na(long param0, String param1) {
        try {
            ...
            throw oj.a((Throwable) (Object) runtimeException, "na.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
