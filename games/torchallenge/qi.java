            ...
            if (-1 == (this.field_g.length ^ -1)) {
              ...
              L1: while (true) {
                if (var3 >= this.field_g.length) {
                  ...
                  if (param1 < this.field_g[var3] + this.field_g[-1 + var3] >> 287087041) {
                    return -1 + var3;
                  } else {
                    var3++;
                    continue L1;
          ...
          L2: {
            if (this.field_g == null) {
              ...
              if (0 != this.field_g.length) {
                stackOut_6_0 = this.field_g[-1 + this.field_g.length];
          ...
          L0: {
            L1: {
              ...
              if (param4 == 0) {
                ...
                var7 = (String) null;
                discarded$2 = qi.a((lj) null, (String) null, (lj) null, (String) null, 9);
                break L1;
              }
            }
