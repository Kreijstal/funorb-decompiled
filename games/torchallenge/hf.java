    ...
    final static void a(byte param0, boolean param1, int param2, String param3, String param4, boolean param5) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_17_1 = new StringBuilder().append("hf.B(").append(-73).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw oj.a((Throwable) (Object) stackIn_23_0, stackIn_23_2 + ',' + param5 + ')');
        }
    }
    ...
    final static byte[] a(int param0, byte[] param1, int param2, pa param3) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_17_1 = new StringBuilder().append("hf.C(").append(-1).append(',');
            stackIn_19_0 = stackOut_17_0;
            stackIn_19_1 = stackOut_17_1;
            stackIn_18_0 = stackOut_17_0;
            stackIn_18_1 = stackOut_17_1;
