                ...
                L6: while (true) {
                  if (param1 >= 0) {
                    ...
                    if (var14 == 0) {
                      ...
                      var12++;
                      qg.field_i[var12] = var16 - var15 | var15 - (var15 >>> 8);
                      param1++;
                      continue L6;
                    }
                  }
              ...
              if (var13 > 0) {
                L2: {
                  if (param11 <= 0) {
                    ...
                    param7 = param7 + (param2 & 255);
                    param3++;
                    param0[param3] = param5 >> 1 << 16 | param6 >> 1 << 8 | param7 >> 1;
                ...
                L5: while (true) {
                  if (var14 >= 0) {
                    ...
                    L6: while (true) {
                      if (var14 >= 0) {
                        param3++;
                        param0[param3] = param5 >> 2 << 16 | param6 >> 2 << 8 | param7 >> 2;
                        param4 = param4 - param10;
                        var13 += 2;
                        continue L1;
                      } else {
