...
final class l {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((l) this).field_f.length;
        var4 = field_j[((l) this).field_e - 1];
        var5 = field_k;
        field_k[1] = true;
        var5[0] = true;
        var6 = 2;
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_k[var16]) {
                  var9 = field_c[var16];
                  var10 = field_a[var16] * ((l) this).field_e;
            ...
            L3: {
              var7 = l.b(field_c, var6);
              var8_int = l.a(field_c, var6);
              var9 = this.a(field_c[var7], field_a[var7], field_c[var8_int], field_a[var8_int], field_c[var6]);
              var10 = field_a[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean a() {
        ...
        int var2 = ((l) this).field_f.length;
        System.arraycopy((Object) (Object) ((l) this).field_f, 0, (Object) (Object) field_c, 0, var2);
        int var3 = field_j[((l) this).field_e - 1];
        int var4 = sa.a((byte) 94, var3 - 1);
        field_a[0] = wg.d(var4);
        field_a[1] = wg.d(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((l) this).field_d.length; var6++) {
            var7 = ((l) this).field_d[var6];
            var8 = ((l) this).field_b[var7];
            var9 = ((l) this).field_h[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = wg.field_q[((l) this).field_i[var7]].c();
            }
        ...
        if (var1 == 1) {
          ...
          L0: while (true) {
            if (var4 >= var2) {
              ...
              ((l) this).field_i = new int[var3];
              ((l) this).field_g = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((l) this).field_e = wg.d(2) + 1;
                  var4 = wg.d(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((l) this).field_f = new int[var5];
                      ((l) this).field_f[0] = 0;
                      ((l) this).field_f[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((l) this).field_b[((l) this).field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
