...
final class l {
    ...
    final boolean a() {
        ...
        System.arraycopy(this.field_f, 0, field_c, 0, var2);
        int var3 = field_j[this.field_e - 1];
        ...
        for (var6 = 0; var6 < this.field_d.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = wg.field_q[this.field_i[var7]].c();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_b[var7]) {
                              ...
                              var5++;
                              this.field_f[incrementValue$2] = wg.d(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_b[this.field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
