...
final class jg {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            if (!param1) {
              if (param0 != null) {
                if (((jg) this).field_a != param0) {
                  if (((jg) this).field_a != null) {
                    L0: {
                      ((jg) this).field_a.setCursor((java.awt.Cursor) null);
