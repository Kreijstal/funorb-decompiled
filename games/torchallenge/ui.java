...
abstract class ui implements wd {
    ...
    public final void a(boolean param0) {
        rj discarded$0 = null;
        if (!param0) {
            discarded$0 = this.b(66);
        }
        this.field_a = ol.a(256);
    }
    ...
    public final String a(byte param0) {
        ...
        if (param0 != -10) {
            discarded$0 = this.a((byte) 50);
        }
        if (this.a(6650)) {
            return null;
        }
        if (ol.a(256) < 350L + this.field_a) {
            return null;
        }
        return this.d(5);
    }
    ...
    final static void c(int param0) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var1_int >= 8) {
                ag.field_e.a(qf.field_e, wc.field_d);
                if (param0 <= -89) {
                ...
                L2: {
                  ...
                  array$1 = new int[qf.field_e[var1_int].field_l.length];
                  e.field_p[var1_int] = array$1;
                  var2 = 0;
                  L4: while (true) {
    ...
    public final rj b(int param0) {
        ...
        if (ol.a(256) < this.field_a + 350L) {
            return bl.field_S;
        }
        int var2 = -47 / ((param0 - 33) / 61);
        return this.b((byte) 109);
    }
