...
abstract class v extends b {
        ...
        if (jc.field_c >= 0) {
          ...
          L6: {
            ...
            if (0 < var6) {
              ...
              td.field_o.d(15 + var3, var4 + 10, var5 * var7 >> 8);
              break L6;
            } else {
              break L6;
            }
    ...
    final static void a(boolean param0, byte param1, boolean param2, String param3) {
        ...
        try {
            ...
            throw oj.a((Throwable) (Object) runtimeException, "v.QA(" + param0 + ',' + -24 + ',' + param2 + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    boolean j(int param0) {
        ...
        if (((v) this).field_Q <= 0) {
            ...
            var3 = ((v) this).field_V;
            int fieldTemp$0 = ((v) this).field_T + 1;
            ((v) this).field_T = ((v) this).field_T + 1;
            if (((v) this).field_Q <= fieldTemp$0) {
                ((v) this).field_Q = 0;
                ((v) this).k(0);
            } else {
    ...
    final static void a(byte param0, jk param1, int param2, lj param3) {
        try {
            ...
            throw oj.a((Throwable) (Object) runtimeException, "v.FA(" + 127 + ',' + (param1 != null ? "{...}" : "null") + ',' + param2 + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final static java.awt.Frame a(int param0, int param1, int param2, int param3, uj param4, int param5) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_27_1 = new StringBuilder().append("v.JA(").append(param0).append(',').append(0).append(',').append(param2).append(',').append(80).append(',');
          ...
          throw oj.a((Throwable) (Object) stackIn_30_0, stackIn_30_2 + ',' + param5 + ')');
        }
        return stackIn_26_0;
    }
