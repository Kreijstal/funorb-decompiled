...
final class gj {
    ...
    final gj a(byte param0, ka[] param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("gj.D(").append(param0).append(44);
    ...
    final void a(gj param0, byte param1) {
        ...
        try {
            ...
            throw oj.a((Throwable) (Object) runtimeException, "gj.B(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
          ...
          if (param0 != ~nd.field_c) {
            if (nd.field_c == 1) {
              ...
              if (nd.field_c != 2) {
                if (3 != nd.field_c) {
                  if (nd.field_c == 4) {
                    var3_int = ga.a(~param0, pf.field_c, wf.field_e, aj.field_b, uc.field_T);
                    var4 = 2 + var3_int;
                    gf.field_s = new String[var4];
                    dl.field_s = new int[var4];
                    var5 = 0;
                ...
                L10: while (true) {
                  ...
                  if (var4 != -1) {
                    ...
                    var3_int = ga.a(~param0, pf.field_c, wf.field_e, aj.field_b, ni.a(new String[1], 0, wb.field_q));
                    var4 = -1;
                    var5 = 0;
                    L12: while (true) {
                      L13: {
          ...
          if (var4 >= gf.field_s.length) {
            ...
            L29: while (true) {
              if (gf.field_s.length <= var4) {
                ...
                L33: {
                  stackOut_105_0 = fh.field_c;
                  stackIn_107_0 = stackOut_105_0;
                  stackIn_106_0 = stackOut_105_0;
                  if (dl.field_s[var4] >= 0) {
                    stackOut_107_0 = stackIn_107_0;
                    stackOut_107_1 = sl.field_f;
                    stackIn_108_0 = stackOut_107_0;
                    stackIn_108_1 = stackOut_107_1;
                    break L33;
                  } else {
                    stackOut_106_0 = stackIn_106_0;
                    stackOut_106_1 = ok.field_e;
                    stackIn_108_0 = stackOut_106_0;
                    stackIn_108_1 = stackOut_106_1;
                    break L33;
                  }
                }
                fh.field_c = stackIn_108_0 + stackIn_108_1;
                var4++;
                continue L29;
              }
            }
    ...
    final void a(int param0, ee param1, int param2, ga param3, byte param4) {
        ...
        try {
          ...
          L11: {
            ...
            stackOut_29_1 = new StringBuilder().append("gj.A(").append(param0).append(44);
            stackIn_31_0 = stackOut_29_0;
          ...
          throw oj.a((Throwable) (Object) stackIn_35_0, stackIn_35_2 + 44 + param4 + 41);
        }
    }
    ...
    final void a(int param0, gj param1, ga param2, int param3, int param4, ee param5) {
        ...
        try {
          ...
          L9: {
            ...
            stackOut_23_1 = new StringBuilder().append("gj.I(").append(param0).append(44);
