...
final class eh extends da {
    ...
    final static boolean a(int param0, int param1, int[] param2, int param3, qe param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_17_1 = new StringBuilder().append("eh.C(").append(param0).append(44).append(param1).append(44);
    ...
    eh(byte[] param0) {
        try {
            ...
            throw oj.a((Throwable) (Object) runtimeException, "eh.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
