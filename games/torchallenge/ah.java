...
final class ah {
    ...
    final static void a(byte param0, int param1) {
        ...
        try {
          ...
          throw oj.a((Throwable) ((Object) var2), "ah.D(" + param0 + ',' + param1 + ')');
        }
    }

    static {
        field_a = new int[][]{new int[]{3, 2, 2, 6, 2, 0, 6}, new int[]{2, 4, 6, 6, 5, 5, 0}, new int[]{3, 2, 4, 6, 3, 0, 6}};
        field_i = false;
        ...
        field_j = new int[][][]{new int[][]{new int[]{40, 40, 40, 40, 40, 40}, new int[]{0}, new int[]{0}, new int[]{40, 40, 40, 40, 40, 40}, new int[]{0}, new int[]{0}, new int[]{0}}, new int[][]{new int[]{60, 60, 60, 60, 60, 60}, new int[]{60, 60, 60, 60, 60}, new int[]{60, 60, 60, 60}, new int[]{0}, new int[]{0}, new int[]{60, 60, 60, 60, 60, 60, 60}, new int[]{0}}, new int[][]{new int[]{30, 30, 30, 30, 30, 30}, new int[]{0}, new int[]{0}, new int[]{0}, new int[]{30, 30, 30, 30, 30, 30}, new int[]{0}, new int[]{30, 30, 30, 30, 30, 30}}};
    }
}
