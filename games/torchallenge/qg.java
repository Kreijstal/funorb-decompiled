...
final class qg {
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4) {
        qg.b(param0, param1, param2, param4);
        qg.b(param0, param1 + param3 - 1, param2, param4);
        qg.c(param0, param1, param3, param4);
        qg.c(param0 + param2 - 1, param1, param3, param4);
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int[] param4) {
        ...
        int var22 = var6 + var8 * field_g;
        int var23 = field_g + var6 - var7;
        qg.a(0, 0, 0, 0, 0, var15, var5, var22, field_i, param3, param4, var23, var13, var6 - var7, var16 + var10, var19, var21, var8 - var9);
    }
    ...
    private final static void e(int param0, int param1, int param2, int param3, int param4) {
        int var5 = 0;
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var6 = 0; var6 < 4; var6++) {
            var5 = 128 - (var6 << 5);
            qg.e(param0 + var6, param1 + param3 + var6, param2, param4, var5);
            qg.c(param0 + param2 + var6, param1 + var6, param3 + 1, param4, var5);
        }
    }

    final static void a(int param0, int param1, int param2) {
        if (param0 >= field_a) {
            if (param1 < field_k || param0 >= field_c || param1 >= field_l) {
                return;
            }
            field_i[param0 + param1 * field_g] = param2;
            return;
        }
    }
    ...
    final static void a() {
        int var1 = 0;
        int var0 = 0;
        int var2 = field_g * field_f;
        for (var1 = 0; var1 < var2; var1++) {
            var0 = field_i[var1] & 16777215;
            field_i[var1] = (var0 >>> 1 & 8355711) + (var0 >>> 2 & 4144959) + (var0 >>> 3 & 2039583) + (var0 >>> 4 & 986895);
        }
    }
    ...
    final static void d(int param0, int param1, int param2, int param3) {
        ...
        qg.a(var5, field_i, 0, param2, -param3, var4);
    }
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
          ...
          qg.f(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        if (param6 != 256) {
          if (param4 != 0) {
            ...
            qg.a(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          qg.b(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
                  ...
                  L4: {
                    ...
                    if (var6 < field_a) {
                      ...
                      if (var6 >= field_c) {
                        ...
                        field_i[var6 + param1 * field_g] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_k) {
                      ...
                      if (var6 >= field_l) {
                        ...
                        field_i[param0 + var6 * field_g] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                qg.c(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                qg.c(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              qg.b(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              qg.b(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
