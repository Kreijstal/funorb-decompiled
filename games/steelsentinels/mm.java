...
final class mm {
    ...
    final static byte[] a(byte param0, String param1) {
        ...
        try {
          L0: {
            stackOut_0_0 = ok.field_e.a(param1, -742, "");
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("mm.F(").append(9).append(44);
    ...
    final static int a(byte param0, int param1) {
        ...
        param1 = (858993459 & param1) - -((param1 & -858993459) >>> 2);
    ...
    final static boolean a(int param0, nk param1) {
        ...
        try {
          L0: {
            L1: {
              if (nk.f((byte) -23)) {
                ...
                if (oc.a(param1.field_N, -87, false)) {
                  stackOut_4_0 = 0;
                  stackIn_5_0 = stackOut_4_0;
            ...
            if (!t.a(rn.field_D, param1.field_N, -20370)) {
              if (param1.field_Q != 1) {
                var5 = nl.a(uc.field_b[0], (byte) 125);
                var2 = var5;
                var3 = 0;
                L2: while (true) {
                  if (var3 >= var5.length + -8) {
                    stackOut_21_0 = 0;
          ...
          L3: {
            ...
            stackOut_23_1 = new StringBuilder().append("mm.B(").append(-16242).append(44);
