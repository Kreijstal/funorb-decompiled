...
final class pb {
    ...
    final static void b(int param0, int param1, int param2) {
        if (param0 >= field_i) {
            if (param1 < field_l || param0 >= field_b || param1 >= field_d) {
                return;
            }
            field_g[param0 + param1 * field_c] = param2;
            return;
        }
    }
    ...
    final static void b() {
        ...
        int var0 = 0;
        int var1 = field_c * field_j - 7;
        while (var0 < var1) {
            incrementValue$0 = var0;
            var0++;
            field_g[incrementValue$0] = 0;
            incrementValue$1 = var0;
            var0++;
            field_g[incrementValue$1] = 0;
            incrementValue$2 = var0;
            var0++;
            field_g[incrementValue$2] = 0;
            incrementValue$3 = var0;
            var0++;
            field_g[incrementValue$3] = 0;
            incrementValue$4 = var0;
            var0++;
            field_g[incrementValue$4] = 0;
            incrementValue$5 = var0;
            var0++;
            field_g[incrementValue$5] = 0;
            incrementValue$6 = var0;
            var0++;
            field_g[incrementValue$6] = 0;
            incrementValue$7 = var0;
            var0++;
            field_g[incrementValue$7] = 0;
        }
        var1 += 7;
        while (var0 < var1) {
            incrementValue$8 = var0;
            var0++;
            field_g[incrementValue$8] = 0;
        }
    }
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            if (param2 <= param3) {
              L1: {
                ...
                if (param1 >= field_l) {
                  ...
                  param0 = param0 + var5 * (field_l - param1);
                  param1 = field_l;
                  break L1;
                }
              }
                  ...
                  L4: {
                    ...
                    if (var6 < field_i) {
                      ...
                      if (var6 >= field_b) {
                        ...
                        field_g[var6 + param1 * field_c] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_l) {
                      ...
                      if (var6 >= field_d) {
                        ...
                        field_g[param0 + var6 * field_c] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                pb.d(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                pb.d(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              pb.g(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              pb.g(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        if (param6 != 256) {
          if (param4 != 0) {
                  ...
                  if (var13 >= var23) {
                        ...
                        L10: while (true) {
                          ...
                          L14: while (true) {
                            if (var22 > var20) {
                              ...
                              var21++;
                              field_g[incrementValue$2] = param5 + var23;
                              var22++;
                              continue L14;
                            }
                          }
                    ...
                    L15: while (true) {
                      if (var24 >= var20) {
                        ...
                        var21++;
                        field_g[incrementValue$3] = param5 + var25;
                        var24++;
                        continue L15;
                      }
                    }
                      ...
                      if (var17 > var14) {
                        ...
                        L20: while (true) {
                          if (var22 >= var20) {
                            ...
                            var21++;
                            field_g[incrementValue$5] = param5 + var23;
                            var22++;
                            continue L20;
                          }
                        }
            ...
            pb.c(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          pb.g(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            if (param2 <= param3) {
              ...
              L2: {
                if (param1 >= field_l) {
                  ...
                  param0 = param0 + var11 * (field_l - param1);
                  param1 = field_l;
                  break L2;
                }
              }
                  ...
                  L6: {
                    ...
                    if (var12 < field_i) {
                      ...
                      if (var12 >= field_b) {
                        ...
                        var13 = var12 + param1 * field_c;
                        var14 = (field_g[var13] >> 16 & 255) * var7;
                        var15 = (field_g[var13] >> 8 & 255) * var7;
                        var16 = (field_g[var13] & 255) * var7;
            ...
            L13: {
              if (param3 < 0) {
                pb.f(param0, param1 + param3 + 1, -param3, param4, param5);
                break L13;
              } else {
                pb.f(param0, param1, param3, param4, param5);
                break L13;
              }
            }
            return;
          ...
          L14: {
            if (param2 < 0) {
              pb.c(param0 + param2 + 1, param1, -param2, param4, param5);
              break L14;
            } else {
              pb.c(param0, param1, param2, param4, param5);
              break L14;
            }
          }
          return;
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        L1: {
          if (param1 >= field_l) {
            ...
            var6 = var6 + (field_l - param1) * var7;
            param3 = param3 - (field_l - param1);
            param1 = field_l;
            break L1;
          }
        }
          ...
          if (var10 >= 0) {
            ...
            L5: while (true) {
              if (var14 >= 0) {
                ...
                var9++;
                field_g[incrementValue$0] = var13;
                var14++;
                continue L5;
              }
            }
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4, int param5) {
        pb.a(field_g, 0, param2 + param3 * field_c, param0, param2, param4, field_c - param4, param5);
        pb.a(field_g, 0, param2 + param3 * field_c, param1, param3, param5, field_c - param4, param2, param4);
    }
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            if (param2 <= param3) {
              L1: {
                ...
                if (param1 >= field_l) {
                  ...
                  param0 = param0 + var10 * (field_l - param1);
                  param1 = field_l;
                  break L1;
                }
              }
                  ...
                  L4: {
                    ...
                    if (var11 < field_i) {
                      ...
                      if (var11 >= field_b) {
                        ...
                        var12 = var11 + param1 * field_c;
                        var13 = (field_g[var12] >> 16 & 255) * var6;
                        var14 = (field_g[var12] >> 8 & 255) * var6;
                        var15 = (field_g[var12] & 255) * var6;
            ...
            L9: {
              if (param3 < 0) {
                pb.f(param0, param1 + param3, -param3 + 1, param4, param5);
                break L9;
              } else {
                pb.f(param0, param1, param3 + 1, param4, param5);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              pb.c(param0 + param2, param1, -param2 + 1, param4, param5);
              break L10;
            } else {
              pb.c(param0, param1, param2 + 1, param4, param5);
              break L10;
            }
          }
          return;
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param0 >= field_i) {
            ...
            for (var13 = 0; var13 < param2; var13++) {
                var9 = (field_g[var12] >> 16 & 255) * var5;
                var10 = (field_g[var12] >> 8 & 255) * var5;
                var11 = (field_g[var12] & 255) * var5;
    ...
    private final static void i(int param0, int param1, int param2, int param3, int param4) {
        int var5 = 0;
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ...
        if (param0 >= field_i) {
            ...
            for (var7 = 0; var7 < param2; var7++) {
                ...
                field_g[var5] = var8 - var6 | var6 - (var6 >>> 8);
                var5 = var5 + field_c;
            }
            return;
        }
    ...
    final static void c(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        for (var9 = 0; var9 < param3; var9++) {
            for (var10 = -param2; var10 < 0; var10++) {
                ...
                var8++;
                field_g[incrementValue$0] = param4 + var11;
            }
            var8 = var8 + var7;
        }
    }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var6 = 0; var6 < 4; var6++) {
            var5 = 128 - (var6 << 5);
            pb.c(param0 + var6, param1 + param3 + var6, param2, param4, var5);
            pb.f(param0 + param2 + var6, param1 + var6, param3 + 1, param4, var5);
        }
    }
                  ...
                  L6: while (true) {
                    ...
                    L10: while (true) {
                      if (var15 > var13) {
                        ...
                        var14++;
                        field_g[incrementValue$2] = param3;
                        var15++;
                        continue L10;
                      }
                    }
                    ...
                    if (var10 > var7) {
                      ...
                      L15: while (true) {
                        if (var15 >= var13) {
                          ...
                          var14++;
                          field_g[incrementValue$4] = param3;
                          var15++;
                          continue L15;
                        }
                      }
                        ...
                        if (param1 - param2 < field_d) {
                          L3: {
                            L4: {
                              var4 = param0 + param1 * field_c;
                              var5 = var4;
                              var6 = var4 - param2 * field_c;
                              var7 = var4 + param2 * field_c;
                              var8 = param2;
                              var9 = 0;
                                  ...
                                  if (param1 - var8 < field_l) {
                                    ...
                                    if (param1 + var8 < field_d) {
                                      ...
                                      L5: while (true) {
                                        ...
                                        if (var8 >= var9) {
                                          field_g[var6 - var9] = param3;
                                          field_g[var6 + var9] = param3;
                                          field_g[var4 - var8] = param3;
                                          field_g[var4 + var8] = param3;
                                          field_g[var5 - var8] = param3;
                                          field_g[var5 + var8] = param3;
                                          field_g[var7 - var9] = param3;
                                          field_g[var7 + var9] = param3;
                                          continue L5;
                                        } else {
                                          break L3;
    ...
    final static void h(int param0, int param1, int param2, int param3, int param4, int param5) {
        pb.c(param0, param1, param2, param4, param5);
        pb.c(param0, param1 + param3 - 1, param2, param4, param5);
        if (param3 >= 3) {
            pb.f(param0, param1 + 1, param3 - 2, param4, param5);
            pb.f(param0 + param2 - 1, param1 + 1, param3 - 2, param4, param5);
            return;
        }
    }
    ...
    final static void f(int param0, int param1, int param2, int param3) {
        ...
        pb.a(var5, field_g, 0, param2, -param3, var4);
    }
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            if (param2 <= param3) {
              L1: {
                ...
                if (param1 >= field_l) {
                  ...
                  param0 = param0 + var9 * (field_l - param1);
                  param1 = field_l;
                  break L1;
                }
              }
                  ...
                  L4: {
                    ...
                    if (var10 < field_i) {
                      ...
                      if (var10 >= field_b) {
                        ...
                        field_g[var8] = var7 - var6 | var6 - (var6 >>> 8);
                        break L4;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                pb.i(param0, param1 + param3, -param3 + 1, param4, param5);
                break L9;
              } else {
                pb.i(param0, param1, param3 + 1, param4, param5);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              pb.g(param0 + param2, param1, -param2 + 1, param4, param5);
              break L10;
            } else {
              pb.g(param0, param1, param2 + 1, param4, param5);
              break L10;
            }
          }
          return;
    ...
    private final static void g(int param0, int param1, int param2, int param3, int param4) {
        int var5 = 0;
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ...
        if (param1 >= field_l) {
            ...
            for (var7 = 0; var7 < param2; var7++) {
                ...
                var5++;
                field_g[incrementValue$0] = var8 - var6 | var6 - (var6 >>> 8);
            }
            return;
        }
    }
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param4 != 0) {
          if (param4 != 256) {
                    ...
                    L6: while (true) {
                      ...
                      L10: while (true) {
                        if (var23 > var21) {
                          ...
                          var9 = (field_g[var25] >> 16 & 255) * var5;
                          var10 = (field_g[var25] >> 8 & 255) * var5;
                          var11 = (field_g[var25] & 255) * var5;
                          var24 = (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8) + (var8 + var11 >> 8);
                          incrementValue$2 = var25;
                          var25++;
                          field_g[incrementValue$2] = var24;
                          var23++;
                          continue L10;
                        }
                      }
                      ...
                      if (var18 > var15) {
                        ...
                        L15: while (true) {
                          if (var23 >= var21) {
                            ...
                            var9 = (field_g[var22] >> 16 & 255) * var5;
                            var10 = (field_g[var22] >> 8 & 255) * var5;
                            var11 = (field_g[var22] & 255) * var5;
                            var24 = (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8) + (var8 + var11 >> 8);
                            incrementValue$4 = var22;
                            var22++;
                            field_g[incrementValue$4] = var24;
                            var23++;
                            continue L15;
                          }
                        }
            ...
            pb.e(param0, param1, param2, param3);
            return;
          }
        } else {
          return;
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var7 = -param3; var7 < 0; var7++) {
            for (var8 = -param2; var8 < 0; var8++) {
                ...
                var6++;
                field_g[incrementValue$0] = param4;
            }
            var6 = var6 + var5;
        }
    }
        ...
        if (param2 > 0) {
            ...
            for (var5 = 0; var5 < param3; var5++) {
                for (var6 = 0; var6 < param2; var6++) {
                    ...
                    var4++;
                    field_g[incrementValue$0] = (var11 << 16) + (var11 << 8) + var11;
                }
    ...
    final static void a(int[] param0, int param1, int param2) {
        ...
        field_c = param1;
        field_j = param2;
        pb.a(0, 0, param1, param2);
    }

    final static void h(int param0, int param1, int param2, int param3, int param4) {
        pb.g(param0, param1, param2, param4);
        pb.g(param0, param1 + param3 - 1, param2, param4);
        pb.d(param0, param1, param3, param4);
        pb.d(param0 + param2 - 1, param1, param3, param4);
    }
    ...
    final static void a(int param0, int param1, int param2, int param3, int[] param4) {
        ...
        int var22 = var6 + var8 * field_c;
        int var23 = field_c + var6 - var7;
        pb.a(0, 0, 0, 0, 0, var15, var5, var22, field_g, param3, param4, var23, var13, var6 - var7, var16 + var10, var19, var21, var8 - var9);
    }
    ...
    final static void g(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
                ...
                if (var11 >= var21) {
                      ...
                      L10: while (true) {
                        ...
                        L14: while (true) {
                          if (var20 > var18) {
                            ...
                            var19++;
                            field_g[incrementValue$2] = param5;
                            var20++;
                            continue L14;
                          }
                        }
                  ...
                  L15: while (true) {
                    if (var22 >= var18) {
                      ...
                      var19++;
                      field_g[incrementValue$3] = param5;
                      var22++;
                      continue L15;
                    }
                  }
                    ...
                    if (var15 > var12) {
                      ...
                      L20: while (true) {
                        if (var20 >= var18) {
                          ...
                          var19++;
                          field_g[incrementValue$5] = param5;
                          var20++;
                          continue L20;
                        }
                      }
          ...
          pb.a(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    final static void c(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param1 >= field_l) {
            ...
            for (var13 = 0; var13 < param2; var13++) {
                ...
                var12++;
                field_g[incrementValue$0] = var14;
            }
            return;
        }
    }
