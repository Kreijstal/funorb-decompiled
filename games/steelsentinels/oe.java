    ...
    final static void a(int param0, String param1, int param2, int param3, int param4, String param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("oe.A(").append(param0).append(44);
    ...
    final static wk a(int param0, int param1, int param2, cm param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_6_1 = new StringBuilder().append("oe.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
