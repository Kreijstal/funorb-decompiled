    ...
    final static void a(int param0, String param1, int param2, int param3, int param4, String param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("oe.A(").append(param0).append(',');
    ...
    final static wk a(int param0, int param1, int param2, cm param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_6_1 = new StringBuilder().append("oe.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          L0: {
            L1: {
              ...
              if (null == this.field_k) {
                ...
                discarded$4 = this.field_k.a(true, 1);
                break L1;
              }
            }
            if (this.field_c != null) {
              discarded$5 = this.field_c.a(true, 1);
              break L0;
            } else {
              return;
            }
