...
final class vn extends v implements fd, aa {
    ...
    final String b(byte param0) {
        ...
        try {
          L0: {
            L1: {
              var2_int = this.field_n.j(-88);
              var3 = this.field_n.k(14879);
              var4 = this.field_n.h((byte) 17);
              var5 = rg.d(-1900);
              if (var4 < 1890) {
                break L1;
              } else {
