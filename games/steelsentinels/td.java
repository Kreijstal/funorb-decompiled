...
final class td extends gh {
    ...
    private final int a(int param0, int param1, gh param2, int param3, gh param4) {
        param0 += 8;
        int var6 = param4.field_L.a(param4.field_S, -(param4.field_ub * 2) + param3, param4.field_Ib);
        param4.a(param1, param0, var6, 0, param3);
    ...
    td(int param0, int param1, int param2, int param3, int param4, gh param5, gh param6, gh param7, gh param8, id param9, gh param10, String param11, long param12) {
        ...
        L0: {
          ...
          if (param11 == null) {
            ...
            var15 = 226;
            var16 = 10;
            var17 = ((td) this).field_cc.field_L.b(((td) this).field_cc.field_S, var15);
            ((td) this).field_cc.a(0, var16, db.field_b * var17, 13, var15);
            var16 = var16 + var17 * db.field_b;
            ((td) this).field_jc.a(0, 24, 10 - -var16, 0, 13 + (var15 + 13));
            ...
            L1: {
              ...
              new id(stackIn_7_3, stackIn_7_4, stackIn_7_5);
              ((td) this).field_dc = stackIn_7_1;
              ((td) this).field_jc.a((gh) (Object) ((td) this).field_dc, 119);
              break L1;
            }
            var28 = new gh[3];
            var15_ref_gh__ = var28;
              ...
              if (fc.field_d <= var16) {
                ...
                if (null != hh.field_g[var16]) {
                  L18: {
                    ...
                    stackOut_12_0 = ((td) this).field_Ub[var16];
