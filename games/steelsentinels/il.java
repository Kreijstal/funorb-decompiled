    ...
    final static wk[] a(int param0, int param1, int param2, cm param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("il.H(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            ...
            if (this.field_f.length == 0) {
              ...
              L1: while (true) {
                if (var3 >= this.field_f.length) {
                  ...
                  if (param1 < this.field_f[var3 + -1] + this.field_f[var3] >> -1125118719) {
                    return var3 - 1;
                  } else {
                    var3++;
                    continue L1;
        ...
        L1: {
          L2: {
            if (this.field_f == null) {
              ...
              if (this.field_f.length != 0) {
                stackOut_6_0 = this.field_f[-1 + this.field_f.length];
