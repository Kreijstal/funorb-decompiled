...
final class pd extends dl implements ae {
    ...
    public static void i(int param0) {
        ...
        if (param0 != -48) {
            ...
            discarded$0 = pd.a(115, (CharSequence) null);
        }
        field_R = null;
        field_U = null;
        field_T = null;
    ...
    final void a(int param0, byte param1, int param2, int param3) {
        ...
        int discarded$0 = tj.field_e.a(qj.field_j, var5 + 20, var6 - -20, -40 + this.field_x, -50 + this.field_E, 16777215, -1, 1, 0, tj.field_e.field_G);
    ...
    final static String a(int param0, CharSequence param1) {
        ...
        try {
          ...
          L9: {
            ...
            stackOut_22_1 = new StringBuilder().append("pd.A(").append(param0).append(',');
    ...
    final static int a(int param0, CharSequence param1, char param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("pd.B(").append(param0).append(',');
        ...
        try {
          L0: {
            if (!super.a(param0, param1, param2, param3)) {
              if (-99 == (param1 ^ -1)) {
                stackOut_5_0 = this.b(param3, 121);
                stackIn_6_0 = stackOut_5_0;
                decompiledRegionSelector0 = 1;
                break L0;
              } else {
                if ((param1 ^ -1) == -100) {
                  stackOut_9_0 = this.b(-11963, param3);
                  stackIn_10_0 = stackOut_9_0;
