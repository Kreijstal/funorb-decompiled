...
final class em extends we {
    ...
    final synchronized void d(int param0) {
        ...
        L0: {
          if (this.field_x <= 0) {
            ...
            if (param0 < this.field_x) {
              this.field_s = this.field_s + this.field_C * param0;
              this.field_t = this.field_t + this.field_u * param0;
              this.field_w = this.field_w + this.field_A * param0;
        ...
        this.field_v = this.field_v + this.field_E * param0;
        if (this.field_B >= 0) {
          L5: {
            if (this.field_B <= 0) {
              break L5;
                  ...
                  if (this.field_E >= 0) {
                    if (this.field_v >= var4) {
                      ...
                      if (var7 < this.field_B) {
                        ...
                        this.field_v = this.field_v - var6 * this.field_B;
                        this.field_B = 0;
                        break L5;
                      }
                    } else {
    ...
    final synchronized int j() {
        return this.field_E < 0 ? -this.field_E : this.field_E;
    }
        ...
        if (param0 != 0) {
          ...
          if (this.field_t == var4) {
            if (this.field_w == var5) {
              ...
              L3: {
                if (var5 - this.field_w <= var6) {
                  break L3;
                } else {
                  var6 = var5 - this.field_w;
                  break L3;
                }
              }
              L4: {
                if (this.field_w - var5 <= var6) {
                  break L4;
                } else {
              ...
              this.field_G = param1;
              this.field_F = param2;
              this.field_C = (param1 - this.field_s) / param0;
              this.field_u = (var4 - this.field_t) / param0;
              this.field_A = (var5 - this.field_w) / param0;
              return;
            }
          } else {
            L6: {
    ...
    final synchronized void i(int param0) {
        int var2 = ((sk) ((Object) this.field_r)).field_r.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
        ...
        L0: while (true) {
          if (this.field_x <= 0) {
            L1: {
              if (this.field_E != -256) {
                ...
                if ((this.field_v & 255) != 0) {
                  ...
                  if (tb.field_b) {
                    return em.b(0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_t, this.field_w, 0, param3, param2, (em) (this));
                  } else {
                    return em.b(((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_s, 0, param3, param2, (em) (this));
                  }
                }
              }
            }
            if (tb.field_b) {
              return em.a(0, 0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_t, this.field_w, 0, param3, param2, (em) (this), this.field_E, param4);
            } else {
              return em.a(0, 0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_s, 0, param3, param2, (em) (this), this.field_E, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_E != -256) {
                  ...
                  if ((this.field_v & 255) != 0) {
                    ...
                    if (!tb.field_b) {
                      param1 = em.b(((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_s, this.field_C, 0, var6, param2, (em) (this));
                      break L3;
                    } else {
                      param1 = em.a(0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_t, this.field_w, this.field_u, this.field_A, 0, var6, param2, (em) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!tb.field_b) {
                param1 = em.c(0, 0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_s, this.field_C, 0, var6, param2, (em) (this), this.field_E, param4);
                break L3;
              } else {
                param1 = em.a(0, 0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_t, this.field_w, this.field_u, this.field_A, 0, var6, param2, (em) (this), this.field_E, param4);
                break L3;
              }
            }
            this.field_x = this.field_x - param1;
          ...
          L4: {
            if (this.field_B <= 0) {
              ...
              if (!this.field_z) {
                if (this.field_E >= 0) {
                  L5: while (true) {
                    var9 = this.b(param0, var9, var6, param2, (int) var4.field_r[this.field_y]);
                    if (this.field_v >= var6) {
                      ...
                      if (var10 < this.field_B) {
                        ...
                        this.field_v = this.field_v - var8 * this.field_B;
                        this.field_B = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_r[this.field_D - 1]);
                    if (this.field_v < var5) {
                ...
                L7: {
                  if (this.field_E >= 0) {
                    ...
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_r[this.field_y]);
                    if (this.field_v < var5) {
                ...
                L8: while (true) {
                  var9 = this.b(param0, var9, var6, param2, (int) var4.field_r[this.field_D - 1]);
                  if (this.field_v >= var6) {
    ...
    final synchronized int f() {
        return this.field_G == -2147483648 ? 0 : this.field_G;
    }
    ...
    private final boolean h() {
        ...
        L0: {
          var1 = this.field_G;
          if (var1 != -2147483648) {
            var2 = em.d(var1, this.field_F);
            var3 = em.a(var1, this.field_F);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_s >= var1) {
            if (this.field_s <= var1) {
              ...
              this.field_C = -1;
              this.field_x = this.field_s - var1;
              break L2;
            }
          } else {
            this.field_C = 1;
            this.field_x = var1 - this.field_s;
            break L2;
          }
        }
        L3: {
          if (this.field_t >= var2) {
            if (this.field_t <= var2) {
              ...
              L4: {
                ...
                if (this.field_x == 0) {
                  ...
                  if (this.field_x <= this.field_t - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_x = this.field_t - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_x == 0) {
                ...
                if (this.field_x <= var2 - this.field_t) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_x = var2 - this.field_t;
            break L3;
          }
        }
        if (this.field_w < var3) {
          this.field_A = 1;
          if (this.field_x != 0) {
            if (this.field_x > var3 - this.field_w) {
              this.field_x = var3 - this.field_w;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_w <= var3) {
              ...
              L7: {
                ...
                if (this.field_x == 0) {
                  ...
                  if (this.field_x <= this.field_w - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_x = this.field_w - var3;
              break L6;
            }
          }
          return false;
    ...
    final synchronized void a(boolean param0) {
        this.field_E = (this.field_E ^ this.field_E >> 31) + (this.field_E >>> 31);
        if (param0) {
          this.field_E = -this.field_E;
          return;
        } else {
        ...
        if (param0 != 0) {
          if (this.field_t == 0) {
            if (this.field_w == 0) {
              ...
              this.field_C = -this.field_s / param0;
              this.field_u = -this.field_t / param0;
              this.field_A = -this.field_w / param0;
              return;
            }
          } else {
            L6: {
    ...
    final int a() {
        if (this.field_G == 0 && this.field_x == 0) {
            return 0;
        }
        return 1;
    }
    ...
    private final void e() {
        ...
        this.field_t = em.d(this.field_G, this.field_F);
        this.field_w = em.a(this.field_G, this.field_F);
    }

    final synchronized int i() {
        return this.field_F < 0 ? -1 : this.field_F;
    }
    ...
    final int c() {
        ...
        if (this.field_B == 0) {
            var1 = var1 - var1 * this.field_v / (((sk) ((Object) this.field_r)).field_r.length << 8);
        } else {
            if (this.field_B >= 0) {
                var1 = var1 - var1 * this.field_y / ((sk) ((Object) this.field_r)).field_r.length;
            }
        }
        ...
        L0: while (true) {
          if (this.field_x <= 0) {
            L1: {
              if (this.field_E != 256) {
                ...
                if ((this.field_v & 255) != 0) {
                  ...
                  if (tb.field_b) {
                    return em.a(0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_t, this.field_w, 0, param3, param2, (em) (this));
                  } else {
                    return em.a(((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_s, 0, param3, param2, (em) (this));
                  }
                }
              }
            }
            if (tb.field_b) {
              return em.d(0, 0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_t, this.field_w, 0, param3, param2, (em) (this), this.field_E, param4);
            } else {
              return em.b(0, 0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_s, 0, param3, param2, (em) (this), this.field_E, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_x;
            ...
            L3: {
              L4: {
                ...
                if (this.field_E != 256) {
                  ...
                  if ((this.field_v & 255) != 0) {
                    ...
                    if (!tb.field_b) {
                      param1 = em.a(((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_s, this.field_C, 0, var6, param2, (em) (this));
                      break L3;
                    } else {
                      param1 = em.b(0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_t, this.field_w, this.field_u, this.field_A, 0, var6, param2, (em) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!tb.field_b) {
                param1 = em.b(0, 0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_s, this.field_C, 0, var6, param2, (em) (this), this.field_E, param4);
                break L3;
              } else {
                param1 = em.b(0, 0, ((sk) ((Object) this.field_r)).field_r, param0, this.field_v, param1, this.field_t, this.field_w, this.field_u, this.field_A, 0, var6, param2, (em) (this), this.field_E, param4);
                break L3;
              }
            }
            this.field_x = this.field_x - param1;
    ...
    final synchronized boolean g() {
        return this.field_v < 0 || this.field_v >= ((sk) ((Object) this.field_r)).field_r.length << 8;
    }
    ...
    private em(sk param0, int param1, int param2) {
        this.field_r = (md) ((Object) param0);
        this.field_y = param0.field_q;
        this.field_D = param0.field_t;
        this.field_z = param0.field_s;
        this.field_E = param1;
        this.field_G = param2;
        this.field_F = 8192;
        this.field_v = 0;
