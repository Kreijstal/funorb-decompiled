...
final class ci {
    ...
    final static String a() {
        ...
        String var1 = "(" + di.field_d + " " + ma.field_W + " " + aj.field_u + ") " + ch.field_N;
        if (jg.field_f <= 0) {
        } else {
            var1 = var1 + ":";
    ...
    final static void a(cm param0, byte param1, cm param2, cm param3) {
        ...
        try {
          L0: {
            ...
            int discarded$3 = 0;
            jb.field_L = rl.a(param0, "commonui", "jagex_logo_grey");
            ...
            gk discarded$4 = gl.a(param0, (byte) 85, "commonui", "dropdown");
                  ...
                  if (var9 >= 3) {
                    ...
                    L3: while (true) {
                      if (var14.length <= var11_int) {
                        ...
                        int discarded$5 = 0;
                        var14[var11_int] = uh.a(var5[var9], var7[var11_int]);
                        var11_int++;
                        continue L3;
                      }
                    }
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("ci.B(");
          ...
          L5: {
            ...
            stackOut_15_1 = ((StringBuilder) (Object) stackIn_15_1).append(stackIn_15_2).append(44).append(99).append(44);
