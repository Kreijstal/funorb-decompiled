                    ...
                    if (-4 == (wh.field_d ^ -1)) {
                      if ((nf.field_c.a(-124) ^ -1) < -1) {
                        ...
                        if (0 == var1_int) {
                          ...
                          stackIn_29_0 = gf.a(var1_int, 16777215);
                          decompiledRegionSelector0 = 2;
                          break L0;
                        }
                      } else {
                        if (na.field_f < mm.a(40)) {
                          stackIn_26_0 = gf.a(-2, 16777215);
    ...
    qh(long param0, gh param1, gh param2, gh param3, wk param4, String param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_9_1 = new StringBuilder().append("qh.<init>(").append(param0).append(',');
          ...
          throw ci.a((Throwable) ((Object) stackIn_10_0), stackIn_22_2 + ')');
        }
    }
