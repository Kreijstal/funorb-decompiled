...
final class wa extends cn {
    ...
    final static void a(cm param0, int param1, cm param2) {
        ...
        try {
          ...
          L4: {
            stackOut_10_0 = (RuntimeException) (Object) stackIn_10_0;
            stackOut_10_1 = ((StringBuilder) (Object) stackIn_10_1).append(stackIn_10_2).append(',').append(2).append(',');
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
    ...
    final static boolean a(byte param0, int param1, int param2, cm param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("wa.C(").append(30).append(',').append(param1).append(',').append(param2).append(',');
    ...
    private final void a(wa param0, int param1, boolean param2) {
        ...
        try {
          ...
          throw ci.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + ',' + 65535 + ',' + param2 + ')');
        }
    }
