...
abstract class mi extends kd {
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_z = (param1 - this.c(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    final int a(char param0) {
        return this.field_B[e.a(param0, 732) & 255];
    }
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var11_ref_ea = this.field_E[var10];
                                            if (this.field_C == null) {
                                              stackIn_26_0 = var11_ref_ea.field_d;
                                              break L3;
                                            } else {
                                          ...
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_A != 256) {
                                              var11_ref_ea.a(param1, param2 + this.field_W - var12, field_A);
                                              break L4;
                                            } else {
                                              var11_ref_ea.a(param1, param2 + this.field_W - var12);
                                              break L4;
                                            }
                                          }
              ...
              if (var4 == -1) {
                    ...
                    if (field_A != 256) {
                      L8: {
                        if (field_N == -1) {
                          ...
                          this.a(var8, param1 + this.field_y[var8] + 1, param2 + this.field_K[var8] + 1, var9, var10, field_N, field_A, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_y[var8], param2 + this.field_K[var8], var9, var10, field_T, field_A, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_N == -1) {
                          ...
                          this.a(var8, param1 + this.field_y[var8] + 1, param2 + this.field_K[var8] + 1, var9, var10, field_N, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_y[var8], param2 + this.field_K[var8], var9, var10, field_T, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  ...
                  if (field_S == -1) {
                    ...
                    pb.g(var11, param2 + (int)((double)this.field_W * 0.7), param1 - var11, field_S);
                    break L10;
                  }
                }
                L11: {
                  if (field_V == -1) {
                    ...
                    pb.g(var11, param2 + this.field_W + 1, param1 - var11, field_V);
                    break L11;
                  }
                }
                var5 = var8;
    ...
    final int b(String param0, int param1) {
        return this.a(param0, new int[]{param1}, field_M);
    }
    ...
    final int a(String param0, int param1, int param2) {
        ...
        int var4 = this.a(param0, new int[]{param1}, field_M);
        int var5 = (var4 - 1) * param2;
        return this.field_G + var5 + this.field_F;
    }
                                      ...
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_J[(var7 << 8) + var8] = (byte)mi.a(var15, var16, var17, this.field_B, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$0 = field_I.append('<');
                        discarded$1 = field_I.append(var15);
                        discarded$2 = field_I.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$3 = field_I.append((char) var14);
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        if (param0 != null) {
          ...
          L1: {
            ...
            if (param4 >= this.field_G + this.field_F + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = this.a(param0, var12, field_M);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - this.field_G - this.field_F - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                ...
                var14 = param2 + this.field_G + (param4 - this.field_G - this.field_F - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.b(field_M[var15], param1 + param3 - this.c(field_M[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_M[var15], param1 + (param3 - this.c(field_M[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    final int a(String param0, int param1) {
        ...
        int var5;
        int var6;
        var3 = this.a(param0, new int[]{param1}, field_M);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (var5 >= var3) {
    ...
    mi(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_G = this.field_W - var6;
            this.field_F = var7 - this.field_W;
            this.field_U = this.field_W - this.field_K[88];
            return;
          } else {
            L1: {
              if (this.field_K[var8] >= var6) {
                break L1;
              } else {
                if (this.field_R[var8] == 0) {
                  break L1;
                } else {
                  var6 = this.field_K[var8];
                  break L1;
                }
              }
            }
            if (this.field_K[var8] + this.field_R[var8] > var7) {
              var7 = this.field_K[var8] + this.field_R[var8];
              var8++;
              continue L0;
            } else {
              var8++;
