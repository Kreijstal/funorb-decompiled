...
final class rm {
        ...
        if (this.field_m <= param1) {
          ...
          if (param2 < this.field_m) {
            L0: {
              ...
              this.field_k = 0;
              if (lb.field_gc != 0) {
                this.field_d = lb.field_gc;
                this.field_e = param2;
                this.field_k = lb.field_gc;
                this.field_a = tc.field_x;
                this.field_l = true;
                break L0;
              } else {
                break L0;
    ...
    final boolean a(byte param0) {
        ...
        return 103 == this.field_b ? true : false;
    }
