...
final class oh {
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              stackIn_5_3 = rm.field_j;

              if (rm.field_p) {
                stackIn_6_0 = null;
                stackIn_6_1 = null;
                stackIn_6_2 = stackIn_5_2;
                stackIn_6_3 = (gh) ((Object) stackIn_5_3);
                stackIn_6_4 = q.field_c;
                break L2;
              } else {
                stackIn_6_0 = null;
                stackIn_6_1 = null;
                stackIn_6_2 = stackIn_5_2;
                stackIn_6_3 = (gh) ((Object) stackIn_5_3);
                stackIn_6_4 = kc.field_C;
                break L2;
              }
            }
            L3: {
              uc.field_j = new gh(stackIn_6_2, stackIn_6_3, ((String) (Object) stackIn_6_4).toUpperCase());
            ...
            L4: {
              ...
              q.field_d.a(rn.field_y, param5 + 124);
              if (rm.field_p) {
              ...
              if (5 <= var17_int) {
                L7: {
                  if (-3 >= (jg.field_l.length ^ -1)) {
                    ...
                    array$0 = new qh[jg.field_l.length - -1];
                    un.field_h[1] = array$0;
                ...
                L9: {
                  ...
                  un.field_h[2] = new qh[]{new qh(0L, bf.field_Ab, (gh) null, qb.field_K, (wk) null, cb.field_e), new qh(0L, bf.field_Ab, (gh) null, qb.field_K, bm.field_Z[0], id.field_Sb), new qh(0L, bf.field_Ab, (gh) null, qb.field_K, bm.field_Z[1], m.field_g)};
                  if (-2 > (tc.field_z ^ -1)) {
                    sl.field_k[3] = new gh(0L, dj.field_b, pc.field_o);
                    array$1 = new qh[1 + tc.field_z];
                    un.field_h[3] = array$1;
                  ...
                  if (param10 <= var17_int) {
                    ...
                    L12: while (true) {
                      if (param10 - -4 <= var17_int) {
                            ...
                            L14: {
                              ...
                              L17: while (true) {
                                if (un.field_h[var18].length <= var19) {
                                  ...
                                  L18: {
                                    if (null != un.field_h[var18][var19]) {
                                      qa.field_L.a(un.field_h[var18][var19], 122);
                                      break L18;
                                    } else {
                                      break L18;
                                    }
                        ...
                        L20: {
                          if (null == un.field_h[var17_int]) {
                            break L20;
                          } else {
                            var18 = 0;
                            L21: while (true) {
                              if (var18 >= un.field_h[var17_int].length) {
                                break L20;
                              } else {
                                L22: {
                                  if (un.field_h[var17_int][var18] == null) {
                                    break L22;
                                  } else {
                                    if (un.field_h[var17_int][var18].field_Tb == null) {
                                      break L22;
                                    } else {
                    ...
                    array$2 = new qh[ec.a((int) ub.field_f[var17_int], 255) + 1];
                    un.field_h[var17_int + 4] = array$2;
                      ...
                      if ((255 & ub.field_f[var17_int]) <= var18) {
                        ...
                        L24: {
                          if (null != dc.field_b) {
                            if (dc.field_b[var17_int] == null) {
                              ...
                              var19_ref = dc.field_b[var17_int][var18];
                              break L24;
                            }
                          } else {
                            var19_ref = null;
                        ...
                        L25: {
                          if (bl.field_h == null) {
                            ...
                            if (null == bl.field_h[var17_int]) {
                              var20 = null;
                              break L25;
                            } else {
                              var20 = bl.field_h[var17_int][var18];
                              break L25;
                            }
                          }
                        }
                        un.field_h[4 - -var17_int][1 + var18] = new qh(0L, bf.field_Ab, (gh) null, qb.field_K, (wk) (var19_ref), (String) (var20));
                        var18++;
                        continue L23;
                      }
                    }
          ...
          L26: {
            ...
            stackIn_73_0 = (RuntimeException) (var15);

            stackIn_73_1 = new StringBuilder().append("oh.D(").append(param0).append(',');
          ...
          L30: {
            ...
            stackIn_85_1 = ((StringBuilder) (Object) stackIn_83_1).append(stackIn_83_2).append(',').append(param5).append(',');
          ...
          L31: {
            ...
            stackIn_88_1 = ((StringBuilder) (Object) stackIn_86_1).append(stackIn_86_2).append(',').append(param7).append(',');
          ...
          L33: {
            ...
            stackIn_94_1 = ((StringBuilder) (Object) stackIn_92_1).append(stackIn_92_2).append(',').append(param10).append(',');
          ...
          throw ci.a((Throwable) ((Object) stackIn_74_0), stackIn_104_2 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, boolean param2, int param3, int param4, byte param5, int param6, int param7, boolean param8, boolean param9, boolean param10, boolean param11, int param12, int param13) {
        ...
        if (param5 > -121) {
            java.applet.Applet var15 = (java.applet.Applet) null;
    ...
    final static void a(int[] param0, boolean param1, cm param2, gk[] param3, cm param4) {
        ...
        try {
          L0: {
            L1: {
              var20 = cj.a(-115, "lobby", param2, "crowns");
              var5 = var20;
              uc.field_l = var20.length;
              if (param3 != null) {
            ...
            L4: while (true) {
              if (uc.field_l <= var7_int) {
                ...
                var7.a(var5, var24);
                gd.field_kb.a(var5, var24);
                nh.field_d.a(var5, var24);
                ...
                dupTemp$0 = ei.a(0, cf.a("smallbutton_active", "lobby", (byte) -79, param2));
                gd.field_wb.field_bb = dupTemp$0;
                gd.field_wb.field_mb = dupTemp$0;
                ...
                dupTemp$1 = ei.a(0, cf.a("gameoptionbutton_active", "lobby", (byte) -52, param2));
                bf.field_Ab.field_bb = dupTemp$1;
                bf.field_Ab.field_mb = dupTemp$1;
                ...
                dupTemp$2 = ei.a(0, cf.a("chatbutton_active", "lobby", (byte) -107, param2));
                ei.field_o.field_bb = dupTemp$2;
                ei.field_o.field_mb = dupTemp$2;
                ...
                dupTemp$3 = ei.a(0, cf.a("chatfilterbutton_active", "lobby", (byte) -64, param2));
                jl.field_s.field_bb = dupTemp$3;
                jl.field_s.field_mb = dupTemp$3;
          ...
          L8: {
            ...
            stackIn_25_1 = new StringBuilder().append("oh.C(");
          ...
          throw ci.a((Throwable) ((Object) stackIn_26_0), stackIn_35_2 + ')');
        }
    }
        ...
        try {
            ...
            try {
                ...
                try {
                  L1: {
                    L2: {
                      ...
                      var3 = ge.a(0, var4, param0).getFile();
                      hn.a("updatelinks", (byte) -41, param0, new Object[]{"home", var3 + "home.ws"});
                      hn.a("updatelinks", (byte) -41, param0, new Object[]{"gamelist", var3 + "togamelist.ws"});
                      hn.a("updatelinks", (byte) -41, param0, new Object[]{"serverlist", var3 + "toserverlist.ws"});
                      if (param1 > 115) {
                        break L2;
                      } else {
                        field_a = (cm) null;
                    ...
                    hn.a("updatelinks", (byte) -41, param0, new Object[]{"options", var3 + "options.ws"});
                    hn.a("updatelinks", (byte) -41, param0, new Object[]{"terms", var3 + "terms.ws"});
                    hn.a("updatelinks", (byte) -41, param0, new Object[]{"privacy", var3 + "privacy.ws"});
                    break L1;
                  }
              ...
              L4: {
                ...
                stackIn_8_1 = new StringBuilder().append("oh.B(");
