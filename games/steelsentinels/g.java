            ...
            L1: {
              ...
              if (var2 == 0) {
                                    ...
                                    if (var19 >= var6) {
                                      ...
                                      L8: while (true) {
                                        if (var7 <= var25) {
                                          ...
                                          var15++;
                                          var11[0][incrementValue$10] = var28.i(0);
                                          var25++;
                                          continue L8;
                                        }
                                      }
                                      ...
                                      if (!wl.a(67, var21)) {
                                        ...
                                        L10: while (true) {
                                          if (var25 >= var7) {
                                            ...
                                            var16++;
                                            var11[1][incrementValue$11] = var28.i(0);
                                            var25++;
                                            continue L10;
                                          }
                                        }
                                      ...
                                      if (sa.field_f[var20].field_d) {
                                        ...
                                        L12: while (true) {
                                          if (var25 >= var7) {
                                            ...
                                            var17++;
                                            var11[2][incrementValue$12] = var28.i(0);
                                            var25++;
                                            continue L12;
                                          }
                                        }
                ...
                if (var2 == 1) {
                  ...
                  int discarded$13 = 94;
                  sj.a("HS1: " + ci.a(), -37, (Throwable) null);
                  pm.m(86);
                  break L1;
                }
              }
