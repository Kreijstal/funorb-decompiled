                ...
                if (var4 != null) {
                  L3: {
                    ...
                    if (var5 != 0) {
                      ...
                      L4: while (true) {
                        if (var8_int >= var5) {
                          var4.field_x = new String[3][var6];
                          var8 = new String[3][var6];
                          var9 = new String[3][var6];
                          var4.field_D = new long[3][var6];
                          var10 = new long[3][var6];
                          var4.field_z = new int[3][var7 * var6];
