...
final class fh extends mi {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  pb.field_g[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    fh(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        ...
        ((fh) this).field_D = new byte[256][];
        ((fh) this).field_D = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (pb.field_a == null) {
                  fh.a(pb.field_g, ((fh) this).field_D[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  fh.a(pb.field_g, ((fh) this).field_D[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, pb.field_a, pb.field_k);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              fh.a(pb.field_g, ((fh) this).field_D[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
