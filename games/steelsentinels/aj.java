...
final class aj extends ck {
    ...
    final static boolean a(int[] param0, byte param1, int[] param2, int param3, boolean param4) {
        ...
        try {
              ...
              L3: while (true) {
                if (var6 >= var18.length) {
                  ...
                  L4: {
                    ...
                    var19 = nl.a(var7, (byte) 124);
                    var9 = 0;
                    L6: while (true) {
                      if (var9 >= -8 + var19.length) {
                        break L4;
                      } else {
                        if (var19[var9] != param3) {
                          var9++;
                          continue L6;
                        } else {
                          stackOut_16_0 = 1;
          ...
          throw ci.a((Throwable) (Object) stackIn_28_0, stackIn_28_2 + 44 + param3 + 44 + param4 + 41);
        }
    ...
    final void a(int param0, int param1, int param2, int param3, int[] param4, int param5, int param6, byte param7) {
        try {
            ...
            throw ci.a((Throwable) (Object) runtimeException, "aj.B(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + param5 + 44 + param6 + 44 + param7 + 41);
        }
    }
