...
final class r extends db {
          ...
          if (var9_array.length <= var10) {
            ...
            try {
              L6: {
                ...
                if (var13_ref2 != null) {
                  stackOut_22_0 = (java.net.Socket) var13_ref2;
            ...
            if (param1.type() == java.net.Proxy.Type.DIRECT) {
              ...
              if ((Object) var3_ref instanceof java.net.InetSocketAddress) {
                ...
                if (param1.type() == java.net.Proxy.Type.HTTP) {
                  ...
                  int discarded$1 = -126;
                  stackOut_25_0 = this.a(var4_ref.getPort(), (String) var5, var4_ref.getHostName());
                  ...
                  if (param1.type() == java.net.Proxy.Type.SOCKS) {
                    ...
                    return (java.net.Socket) (Object) stackIn_16_0;
                  } else {
                    return null;
                  }
                }
    ...
    final static int a(gi param0, String param1) {
        int var3_int = 0;
        RuntimeException var3 = null;
        byte[] var4 = null;
