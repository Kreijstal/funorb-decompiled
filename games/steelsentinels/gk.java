...
final class gk extends ea {
    ...
    final wk a() {
        int var3 = 0;
        int var1 = this.field_a * this.field_i;
        int[] var2 = new int[var1];
        for (var3 = 0; var3 < var1; var3++) {
            var2[var3] = this.field_o[this.field_p[var3] & 255];
        }
        return new wk(this.field_g, this.field_d, this.field_j, this.field_n, this.field_a, this.field_i, var2);
    }
    ...
    final void a(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            gk.a(pb.field_g, this.field_p, this.field_o, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    final gk b() {
        int var4 = 0;
        int var3 = 0;
        gk var1 = new gk(this.field_a, this.field_i, this.field_o.length);
        var1.field_g = this.field_g;
        var1.field_d = this.field_d;
        var1.field_j = this.field_g - this.field_a - this.field_j;
        var1.field_n = this.field_n;
        int var2 = this.field_o.length;
        for (var3 = 0; var3 < var2; var3++) {
            var1.field_o[var3] = this.field_o[var3];
        }
        for (var3 = 0; var3 < this.field_i; var3++) {
            for (var4 = 0; var4 < this.field_a; var4++) {
                var1.field_p[var3 * this.field_a + var4] = this.field_p[var3 * this.field_a + this.field_a - 1 - var4];
            }
        }
        return var1;
    }
                  ...
                  if (var16 >= 4) {
                    ...
                    L7: while (true) {
                      if (var17 >= 4) {
                        ...
                        L8: {
                          var13 = this.field_o[this.field_p[var11 + var16 * this.field_a + var17] & 255];
                          if (var13 != 0) {
                            break L8;
                          } else {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        int var8 = 0;
        int var9 = 0;
        int var10 = this.field_g;
        int var11 = this.field_d;
        int var12 = (var10 << 16) / param2;
        int var13 = (var11 << 16) / param3;
        if (this.field_j > 0) {
            var14 = ((this.field_j << 16) + var12 - 1) / var12;
            param0 = param0 + var14;
            var8 = var8 + (var14 * var12 - (this.field_j << 16));
        }
        if (this.field_n > 0) {
        ...
        gk.a(pb.field_g, this.field_p, this.field_o, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
    }
    ...
    final void c(int param0, int param1) {
        ...
        L0: {
          ...
          if (param0 >= pb.field_i) {
            ...
            stackIn_3_0 = pb.field_i - param0 << 1;
            break L0;
          }
        }
        L1: {
          var5 = stackIn_3_0;
          if (param0 + var3 <= pb.field_b) {
            stackIn_6_0 = this.field_a - 2;
            break L1;
          } else {
            stackIn_6_0 = (pb.field_b - param0 << 1) - 2;
            break L1;
          }
        }
        L2: {
          ...
          if (param1 >= pb.field_l) {
            ...
            stackIn_9_0 = pb.field_l - param1 << 1;
            break L2;
          }
        }
        L3: {
          var7 = stackIn_9_0;
          if (param1 + var4 <= pb.field_d) {
            stackIn_12_0 = this.field_i - 2;
            break L3;
          } else {
            stackIn_12_0 = (pb.field_d - param1 << 1) - 2;
            break L3;
          }
        }
        var8 = stackIn_12_0;
          ...
          if (var10 > var8) {
            ...
            L5: while (true) {
              if (var11 > var6) {
                ...
                var12 = var10 * this.field_a + var11;
                var13 = (param1 + (var10 >> 1)) * pb.field_c + (param0 + (var11 >> 1));
                var9[0] = this.field_o[this.field_p[var12] & 255];
                var9[1] = this.field_o[this.field_p[var12 + 1] & 255];
                var9[2] = this.field_o[this.field_p[var12 + this.field_a] & 255];
                var9[3] = this.field_o[this.field_p[var12 + 1] & 255];
                var14 = 0;
                var15 = 0;
                var16 = 0;
                var17 = 0;
    ...
    final void b(int param0, int param1, int param2, int param3) {
        ...
        gk.a(pb.field_g, this.field_p, this.field_o, var7, var8, var13, var14, param2, param3, var11, var12, var5);
    }
    ...
    final void a(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            gk.b(pb.field_g, this.field_p, this.field_o, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          L0: {
            ...
            var15 = -param0 * var10 + ((this.field_i << 4) - param1) * var9;
            var16 = --param0 * var9 + ((this.field_i << 4) - param1) * var10;
            var17 = ((this.field_a << 4) - param0) * var10 + ((this.field_i << 4) - param1) * var9;
            var18 = -((this.field_a << 4) - param0) * var9 + ((this.field_i << 4) - param1) * var10;
            if (var11 >= var13) {
              var19 = var13;
              var20 = var11;
              break L0;
                      ...
                      if (var26 >= 0) {
                        ...
                        L15: while (true) {
                          if (var33 >= 0) {
                            ...
                            L17: {
                              var32 = (1 + var35 - (this.field_a << 12) - var27) / var27;
                              if ((1 + var35 - (this.field_a << 12) - var27) / var27 <= var37) {
                                break L17;
                              } else {
                                var37 = var32;
                                break L17;
                            ...
                            L19: {
                              var32 = (1 + var36 - (this.field_i << 12) - var26) / var26;
                              if ((1 + var36 - (this.field_i << 12) - var26) / var26 <= var37) {
                                break L19;
                              } else {
                                var37 = var32;
                                break L19;
                            ...
                            L20: while (true) {
                              if (var37 >= 0) {
                                ...
                                L21: {
                                  var38 = this.field_o[this.field_p[(var36 >> 12) * this.field_a + (var35 >> 12)]];
                                  if (var38 == 0) {
                                    var34++;
                                    break L21;
                                  } else {
                                    ...
                                    var34++;
                                    pb.field_g[incrementValue$0] = var38;
                                    break L21;
                                  }
                                }
                                var35 = var35 + var27;
                        ...
                        L22: while (true) {
                          if (var33 >= 0) {
                            ...
                            L25: {
                              var32 = var36 - (this.field_i << 12);
                              if (var36 - (this.field_i << 12) < 0) {
                                break L25;
                              } else {
                              ...
                              if (var37 >= 0) {
                                ...
                                L28: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    pb.field_g[incrementValue$1] = var38;
                                    break L28;
                                  }
                                }
                                var35 = var35 + var27;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L34: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        pb.field_g[incrementValue$2] = var38;
                                        break L34;
                                      }
                                    }
                                    var35 = var35 + var27;
                        ...
                        L35: while (true) {
                          if (var33 >= 0) {
                            ...
                            L36: {
                              ...
                              var36 = var31 + (var28 * var26 >> 4);
                              var37 = var20;
                              var32 = var35 - (this.field_a << 12);
                              if (var35 - (this.field_a << 12) < 0) {
                                break L36;
                              } else {
                              ...
                              if (var37 >= 0) {
                                ...
                                L41: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    pb.field_g[incrementValue$3] = var38;
                                    break L41;
                                  }
                                }
                                var35 = var35 + var27;
                              ...
                              if (var37 >= 0) {
                                ...
                                L48: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    pb.field_g[incrementValue$4] = var38;
                                    break L48;
                                  }
                                }
                                var35 = var35 + var27;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L54: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        pb.field_g[incrementValue$5] = var38;
                                        break L54;
                                      }
                                    }
                                    var35 = var35 + var27;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L60: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        pb.field_g[incrementValue$6] = var38;
                                        break L60;
                                      }
                                    }
                                    var36 = var36 + var26;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L66: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        pb.field_g[incrementValue$7] = var38;
                                        break L66;
                                      }
                                    }
                                    var36 = var36 + var26;
                                  ...
                                  L69: while (true) {
                                    if (var37 >= 0) {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        pb.field_g[incrementValue$8] = var38;
                                        var37++;
                                        continue L69;
                                      }
                                    }
    ...
    gk(int param0, int param1, int param2) {
        ...
        this.field_n = 0;
        this.field_j = 0;
        this.field_p = new byte[param0 * param1];
        this.field_o = new int[param2];
    }
