    ...
    final void a(gi param0, kl param1) {
        ...
        L0: {
          ...
          if (var3 == 0) {
            ...
            this.field_h[0] = param0.c((byte) -60);
            this.field_h[1] = param0.c((byte) -60);
              ...
              if (var5 >= 2) {
                    ...
                    L4: while (true) {
                      if (var7 >= this.field_a[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_c[var5][1][var7] = param0.c((byte) -60);
                          this.field_b[var5][1][var7] = param0.c((byte) -60);
                          var7++;
                          continue L4;
                        }
                      }
                ...
                L5: while (true) {
                  if (var6 >= this.field_a[var5]) {
                    ...
                    this.field_c[var5][0][var6] = param0.c((byte) -60);
                    this.field_b[var5][0][var6] = param0.c((byte) -60);
                    var6++;
                    continue L5;
                  }
                }
