...
final class qi {
    ...
    final static me a(boolean param0, long param1, String param2, int param3, String param4) {
        ...
        try {
          L0: {
            ...
            stackOut_9_0 = new fb(param1, param2);
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("qi.C(").append(false).append(',').append(param1).append(',');
    ...
    final static void a(java.math.BigInteger param0, gi param1, gi param2, java.math.BigInteger param3) {
        ...
        try {
          ...
          throw ci.a((Throwable) (Object) stackIn_20_0, stackIn_20_2 + ',' + 5 + ')');
        }
    }
