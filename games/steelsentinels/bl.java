    ...
    public final void a(int param0, lh param1, byte param2, boolean param3, int param4) {
        ...
        try {
          L0: {
            ...
            discarded$1 = this.field_l.a("<u=" + Integer.toString(var6_int, 16) + ">" + param1.field_y + "</u>", param0 - -param1.field_o, param4 - -param1.field_z, param1.field_x, param1.field_E, var6_int, -1, this.field_n, this.field_i, this.field_l.field_G - -this.field_l.field_F);
            if (param1.d(0)) {
              L4: {
    ...
    final static void a(int param0, int param1, gh param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("bl.E(").append(param0).append(',').append(param1).append(',');
