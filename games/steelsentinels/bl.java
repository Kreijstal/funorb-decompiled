...
final class bl implements qk {
    ...
    final static void a(int param0, int param1, boolean param2, int param3, int param4, int param5, boolean param6, int param7, boolean param8, int param9, boolean param10, boolean param11) {
        ...
        oh.a(16777215, param7, param2, param0, param3, (byte) -125, param4, param1, param11, param6, param10, param8, param9, 16777215);
    }
    ...
    public final void a(int param0, lh param1, byte param2, boolean param3, int param4) {
        ...
        try {
          L0: {
            ...
            this.field_l.a("<u=" + Integer.toString(var6_int, 16) + ">" + param1.field_y + "</u>", param0 - -param1.field_o, param4 - -param1.field_z, param1.field_x, param1.field_E, var6_int, -1, this.field_n, this.field_i, this.field_l.field_G - -this.field_l.field_F);
            if (param1.d(0)) {
              L4: {
                var7 = this.field_l.c(param1.field_y);
                var8 = this.field_l.field_G + this.field_l.field_F;
                ...
                if (this.field_n == 2) {
                  ...
                  if (-2 == (this.field_n ^ -1)) {
                    var9 = var9 + (param1.field_x + -var7 >> -802398559);
                    break L4;
                  } else {
                    break L4;
                  }
              ...
              L5: {
                if (this.field_i != 2) {
                  if (-2 != (this.field_i ^ -1)) {
                    ...
                    var10 = var10 + (-var8 + param1.field_E >> 292591873);
                    break L5;
                  }
                } else {
          ...
          L6: {
            ...
            stackIn_22_1 = new StringBuilder().append("bl.A(").append(param0).append(',');
    ...
    final static void a(int param0, int param1, gh param2) {
        ...
        try {
            ...
            throw ci.a((Throwable) ((Object) runtimeException), "bl.E(" + param0 + ',' + param1 + ',' + (param2 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    public static void a(boolean param0) {
        ...
        field_f = null;
        if (param0) {
          bl.a(93, -44, false, 19, -111, -38, true, -64, false, 87, true, true);
          field_d = null;
          field_k = null;
          field_c = null;
          field_p = null;
