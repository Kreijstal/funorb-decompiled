...
final class uk extends ck {
    private static pj[] field_q;
    private static int[] field_S;
    private static wf[] field_O;
    ...
    private final static boolean a(cm param0) {
        byte[] var1 = null;
        if (!field_t) {
            var1 = param0.a(0, (byte) 71, 0);
            if (var1 == null) {
                return false;
            }
            uk.b(var1);
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = kg.a(var11, var10, 22025);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    final static int e(int param0) {
        ...
        while (param0 >= 8 - field_U) {
            var3 = 8 - field_U;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_B[field_o] >> field_U & var4) << var2);
            field_U = 0;
            field_o = field_o + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_B[field_o] >> field_U & var3) << var2);
    ...
    final static int b() {
        int var0 = field_B[field_o] >> field_U & 1;
        field_U = field_U + 1;
        field_o = field_o + (field_U >> 3);
        field_U = field_U & 7;
        return var0;
    }

    private uk(byte[] param0) throws IOException {
        this.a(param0);
    }
