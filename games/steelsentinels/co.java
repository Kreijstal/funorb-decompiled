    ...
    final mn a(byte param0, int param1) {
        ...
        if (var3 != null) {
          ...
          if (param0 != -13) {
            ...
            ((co) this).field_a.a((long)param1, (Object) (Object) var3, 1);
            return var3;
          }
        }
    }
    ...
    final static byte[] a(byte param0, int param1, int param2, byte[] param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("co.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    co(int param0, cm param1, cm param2) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (((co) this).field_b == null) {
                ...
                int discarded$4 = ((co) this).field_b.a(true, 0);
                break L1;
              }
            }
            if (null == ((co) this).field_e) {
              ...
              int discarded$5 = ((co) this).field_e.a(true, 0);
              return;
            }
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("co.<init>(").append(param0).append(44);
