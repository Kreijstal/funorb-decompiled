...
final class qc extends dl implements oj, ae {
    ...
    private final int a(int param0, int param1, int param2, lh param3, String param4, String param5) {
        ...
        try {
          L0: {
            stackOut_0_0 = this.a(param4, 70, param3, 35, param5, 3, 170);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("qc.CA(").append(170).append(44).append(70).append(44).append(-95).append(44);
