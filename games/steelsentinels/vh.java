    ...
    final static void a(int param0, tc param1, byte param2) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var6 >= param1.field_q.length) {
                int discarded$1 = var9.f(-103, var4);
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("vh.B(").append(param0).append(44);
          ...
          throw ci.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + param2 + 41);
        }
    }
    ...
    final static wk[] a(int param0, cm param1, int param2, byte param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("vh.C(").append(param0).append(44);
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
