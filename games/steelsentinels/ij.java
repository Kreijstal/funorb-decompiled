...
final class ij extends dl implements ae {
    ...
    final void a(boolean param0, String[] param1) {
        ...
        try {
          ...
          L5: {
            ...
            stackIn_18_1 = new StringBuilder().append("ij.K(").append(param0).append(',');
    ...
    public final void a(int param0, byte param1, int param2, oa param3, int param4) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_13_1 = new StringBuilder().append("ij.BA(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw ci.a((Throwable) ((Object) stackIn_14_0), stackIn_14_2 + ',' + param4 + ')');
        }
    }
    ...
    final boolean a(int param0, int param1, char param2, lh param3) {
        ...
        try {
            ...
            if (super.a(param0, param1, param2, param3)) {
              ...
              if ((param1 ^ -1) != -99) {
                if ((param1 ^ -1) != -100) {
                  ...
                  stackIn_9_0 = this.b(param0 ^ -22560, param3);
                  decompiledRegionSelector0 = 2;
                  break L0;
                }
              } else {
                stackIn_6_0 = this.b(param3, 92);
                decompiledRegionSelector0 = 1;
                break L0;
              }
            }
          ...
          L1: {
            ...
            stackIn_14_1 = new StringBuilder().append("ij.R(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static int a(CharSequence param0, boolean param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_11_1 = new StringBuilder().append("ij.M(");
    ...
    final void a(int param0, byte param1, int param2, int param3) {
        ...
        if (null != this.field_Z) {
            var5.a(qi.field_h, param2 + this.field_o, this.field_z + param0, this.field_x, 20, 16777215, -1, 0, 0, var5.field_F + var5.field_G);
        }
    }
