...
final class pj {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((pj) this).field_a.length;
        var4 = field_j[((pj) this).field_e - 1];
        var5 = field_g;
        field_g[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_f[0] * ((pj) this).field_e;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_c[var16];
                  var10 = field_f[var16] * ((pj) this).field_e;
            ...
            L3: {
              var7 = pj.b(field_c, var6);
              var8_int = pj.a(field_c, var6);
              var9 = this.a(field_c[var7], field_f[var7], field_c[var8_int], field_f[var8_int], field_c[var6]);
              var10 = field_f[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_b[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_b[var11];
        }
    }
    ...
    final boolean b() {
        ...
        int var2 = ((pj) this).field_a.length;
        System.arraycopy((Object) (Object) ((pj) this).field_a, 0, (Object) (Object) field_c, 0, var2);
        int var3 = field_j[((pj) this).field_e - 1];
        int var4 = ve.a(-94, var3 - 1);
        field_f[0] = uk.e(var4);
        field_f[1] = uk.e(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((pj) this).field_d.length; var6++) {
            var7 = ((pj) this).field_d[var6];
            var8 = ((pj) this).field_i[var7];
            var9 = ((pj) this).field_h[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = uk.field_N[((pj) this).field_l[var7]].c();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((pj) this).field_k[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_f[incrementValue$0] = var13 >= 0 ? uk.field_N[var13].c() : 0;
            }
        }
        return true;
    }
    ...
    pj() {
        ...
        if (var1 == 1) {
          var2 = uk.e(5);
          var3 = 0;
          ((pj) this).field_d = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((pj) this).field_i = new int[var3];
              ((pj) this).field_h = new int[var3];
              ((pj) this).field_l = new int[var3];
              ((pj) this).field_k = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((pj) this).field_e = uk.e(2) + 1;
                  var4 = uk.e(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((pj) this).field_a = new int[var5];
                      ((pj) this).field_a[0] = 0;
                      ((pj) this).field_a[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((pj) this).field_i[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((pj) this).field_a[incrementValue$2] = uk.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((pj) this).field_i[((pj) this).field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((pj) this).field_i[var4] = uk.e(3) + 1;
                    int dupTemp$3 = uk.e(2);
                    ((pj) this).field_h[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((pj) this).field_l[var4] = uk.e(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
