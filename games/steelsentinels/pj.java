...
final class pj {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_c[var16];
                  var10 = field_f[var16] * this.field_e;
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_a, 0, field_c, 0, var2);
        ...
        for (var6 = 0; var6 < this.field_d.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = uk.field_N[this.field_l[var7]].c();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_i[var7]) {
                              ...
                              var5++;
                              this.field_a[incrementValue$2] = uk.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_i[this.field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
