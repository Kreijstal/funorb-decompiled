...
final class th {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            if (!param1) {
              if (param0 != null) {
                if (((th) this).field_a == param0) {
                  return;
                } else {
                  if (((th) this).field_a != null) {
                    L0: {
                      ((th) this).field_a.setCursor((java.awt.Cursor) null);
                      ((th) this).field_a = null;
                      if (param0 != null) {
    ...
    public final void movemouse(int param0, int param1) {
        ((th) this).field_b.mouseMove(param0, param1);
    }

    public th() throws Exception {
        java.awt.Robot var2 = new java.awt.Robot();
        ((th) this).field_b = var2;
    }
