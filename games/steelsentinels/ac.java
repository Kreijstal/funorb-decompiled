...
abstract class ac extends bb {
    ...
    void i(byte param0) {
        ...
        this.a((byte) -90, this.field_cb, this.field_Y);
        this.field_db = 0;
        this.j((byte) 12);
    ...
    void a(int param0, int param1, boolean param2) {
        ...
        pb.e(6 + param0, param1 - -35, -12 + this.field_x, this.field_E + -40, 2105376, 0);
        var5 = 211;
        var4 = 35;
        var6 = 194;
        var7 = 0;
        ...
        L0: while (true) {
          if (var7 >= var4) {
            ...
            L1: while (true) {
              if (var4 <= var7) {
                jb.field_L.a(this.field_x + param0 - 90, param1 + 10);
                if (!param2) {
                  field_gb = (String) null;
                  uc.a(jj.field_k, this.field_x + -10, 35 + param1, (byte) -39, param0 - -5);
                  uc.a(jb.field_J, this.field_x, this.field_E + (param1 - 22), (byte) -39, param0);
                  var5 = 169;
                  var4 = -79 + this.field_E;
                  var6 = 127;
                  var7 = 0;
                  var8 = param1 - -57;
                  L2: while (true) {
                    if (var4 <= var7) {
                      ...
                      pb.g(-6 + param0 - -this.field_x, var8, 6, var9);
                      var8++;
                      var7++;
                      continue L2;
                    }
                ...
                pb.g(param0, var8, 6, var9);
                pb.g(this.field_x + (param0 - 6), var8, 6, var9);
                var7++;
                var8++;
                continue L1;
              }
    ...
    boolean i(int param0) {
        ...
        if (0 >= this.field_db) {
          ...
          if (fieldTemp$1 >= this.field_db) {
            this.field_db = 0;
            this.j((byte) 59);
            this.a((byte) -70, var2, var3);
            if (param0 == -8350) {
              return super.i(-8350);
            } else {
              this.i(-53);
            ...
            var4 = this.field_eb * (this.field_db * 2 - this.field_eb);
            var5 = this.field_db * this.field_db;
            var3 = this.field_hb - -((-this.field_hb + this.field_Y) * var4 / var5);
            var2 = (-this.field_fb + this.field_cb) * var4 / var5 + this.field_fb;
            this.a((byte) -70, var2, var3);
            if (param0 == -8350) {
              return super.i(-8350);
            } else {
    ...
    final static void a(int param0, int param1, int param2, String param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        try {
            ...
            throw ci.a((Throwable) ((Object) runtimeException), "ac.DA(" + param0 + ',' + param1 + ',' + param2 + ',' + (param3 != null ? "{...}" : "null") + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ')');
        }
    }
