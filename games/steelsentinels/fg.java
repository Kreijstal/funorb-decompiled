...
final class fg extends k implements ae {
    ...
    final static void n(int param0) {
        ...
        if (param0 != -6) {
            ...
            discarded$0 = fg.a((CharSequence) null, -105);
        }
    }
    ...
    final static pc a(int param0, int param1, int param2, sk param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = on.a(em.b(param3, 100, param0, param1), -48);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("fg.FB(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    private final void a(int param0, boolean param1, e param2) {
        ...
        try {
          L0: {
            ...
            L4: {
              L5: {
                ...
                if (param2.field_d) {
                  if (!param2.field_f) {
                    discarded$2 = var5.a(-122, (tn) (this), ah.field_Sb);
                    break L5;
                  } else {
                    this.c(new nj((fg) (this)), -22908735);
                  ...
                  L6: {
                    if (!this.field_Sb) {
                      ...
                      discarded$3 = var5.a(param0 ^ -105, (tn) (this), ah.field_Sb);
                      break L6;
                    }
                  }
                  if (3 != param2.field_a) {
          ...
          L7: {
            ...
            stackOut_31_1 = new StringBuilder().append("fg.UA(").append(param0).append(',').append(param1).append(',');
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          L0: {
            L1: {
              var6_int = 8 + param4 + (485 + param3 + param0);
              ...
              if ((var12 ^ -1) <= -7) {
                ...
                L3: {
                  ...
                  if ((var12 ^ -1) > -6) {
                    ...
                    fm.field_b.a(param0 + -10, var13, var7, var6_int, var8);
                    break L3;
                  }
                }
                var12++;
          ...
          throw ci.a((Throwable) ((Object) var6), "fg.BB(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ')');
        }
    }
