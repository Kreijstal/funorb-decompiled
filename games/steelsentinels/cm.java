...
final class cm {
            ...
            L0: {
              if (-1 < (param0 ^ -1)) {
                ...
                if ((param1 ^ -1) > -1) {
                  ...
                  if (this.field_a.field_g.length <= param0) {
                    break L0;
                  } else {
                    if (param1 < this.field_a.field_g[param0]) {
                      return true;
                    } else {
                      break L0;
                    }
    ...
    private final synchronized boolean a(int param0, int param1, int param2, int[] param3) {
        ...
        try {
              ...
              if (null == this.field_k[param1]) {
                ...
                L1: {
                  ...
                  if (null != this.field_i[param1]) {
                    ...
                    array$2 = new Object[this.field_a.field_g[param1]];
                ...
                L2: while (true) {
                  ...
                  if (var8 == 0) {
                    L5: {
                      ...
                      var9_array = dk.a(false, this.field_k[param1], 0);
                      break L5;
                    }
                    try {
                      L8: {
                        var36 = ln.a(var9_array, (byte) 127);
                        var27 = var36;
                        var23 = var27;
                        var43 = var23;
                        break L8;
                      ...
                      throw ci.a((Throwable) ((Object) stackIn_36_0), (stackIn_36_2 != 0) + " " + param1 + " " + param3.length + " " + ba.a((byte) -107, var9_array, param3.length) + " " + ba.a((byte) -107, var9_array, param3.length + -2) + " " + this.field_a.field_a[param1] + " " + this.field_a.field_e);
                    }
                    L10: {
                      if (this.field_f) {
          ...
          L29: {
            ...
            stackOut_103_1 = new StringBuilder().append("cm.V(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    private final synchronized boolean b(int param0, boolean param1) {
        ...
        if ((param0 ^ -1) <= -1) {
            if (param0 < this.field_a.field_g.length) {
                if (-1 != (this.field_a.field_g[param0] ^ -1)) {
                    return true;
                }
            }
        }
            ...
            if (this.b(param0, true)) {
              L1: {
                ...
                if (param1 == -32759) {
                  ...
                  var5 = (String) null;
                  discarded$2 = this.a((byte) -29, (String) null);
                  break L1;
                }
              }
          ...
          L0: {
            if (!this.a(true)) {
              ...
              if (this.b(var4_int, true)) {
                ...
                stackOut_7_0 = this.a((byte) 97, var5, var4_int);
                stackIn_8_0 = stackOut_7_0;
                decompiledRegionSelector0 = 2;
                break L0;
              } else {
          ...
          L0: {
            if (param1 == 90) {
              if (!this.a(true)) {
                ...
                stackOut_7_0 = this.a(var3_int, true);
                stackIn_8_0 = stackOut_7_0;
                decompiledRegionSelector0 = 2;
                break L0;
              }
          ...
          L0: {
            L1: {
              if (param0 == 12145) {
                ...
                discarded$2 = this.b(((int[]) (((Object[]) (this.field_k[29]))[8]))[0], -80, -37);
                break L1;
              }
            }
            if (this.a(true)) {
    ...
    final synchronized boolean a(boolean param0) {
        ...
        if (!param0) {
            discarded$0 = this.b(((byte[]) (this.field_k[0]))[10]);
            return true;
        }
        return true;
    }
            ...
            if (this.a(true)) {
              L1: {
                ...
                if (param0 > 66) {
                  ...
                  discarded$2 = this.a((String) (this.field_k[20]), (byte) -91);
                  break L1;
                }
              }
              stackOut_5_0 = this.b(10407, var3_int);
              stackIn_6_0 = stackOut_5_0;
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
    ...
    private final synchronized byte[] b(int param0, int param1, int param2, int[] param3) {
        ...
        try {
          ...
          L6: {
            var5 = decompiledCaughtException;
            stackOut_27_0 = var5;
            stackOut_27_1 = new StringBuilder().append("cm.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            ...
            if (this.a(true)) {
              ...
              if (param1 == -742) {
                ...
                if (this.b(var4_int, true)) {
                  ...
                  stackOut_9_0 = this.a(var4_int, (byte) 56, var5);
                  stackIn_10_0 = stackOut_9_0;
                  decompiledRegionSelector0 = 3;
                  break L0;
                } else {
