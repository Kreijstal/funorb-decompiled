    ...
    public final void a(int param0, int param1, boolean param2, w param3, int param4) {
        ...
        try {
          L0: {
            ...
            L6: {
              if (null != this.field_b) {
                ...
                discarded$1 = this.field_b.a(param3.field_u, param3.field_t + param1 - -var10, param0 + (param3.field_o - -this.field_e), -var10 - this.field_k + param3.field_j, param3.field_v - (this.field_k << -1437509631), this.field_c, this.field_i, this.field_d, this.field_s, 0);
                break L6;
              } else {
                break L6;
              }
          ...
          L7: {
            ...
            stackOut_16_1 = new StringBuilder().append("fb.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
