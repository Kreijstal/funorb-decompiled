...
class db extends ed {
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                param2++;
                lf.field_b[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
    ...
    final void e() {
        int var2 = 0;
        int var3 = 0;
        if (this.field_p == this.field_r && this.field_u == this.field_x) {
            return;
        }
    ...
    db(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_p, this.field_u, this.field_y, 0, this.field_p);
            var5.grabPixels();
            break L0;
          }
