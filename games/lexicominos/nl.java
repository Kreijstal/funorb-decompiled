    ...
    final static byte[] a(Object param0, byte param1, boolean param2) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_16_1 = new StringBuilder().append("nl.H(");
          ...
          throw ld.a((Throwable) (Object) stackIn_19_0, stackIn_19_2 + ',' + -74 + ',' + param2 + ')');
        }
    }
    ...
    final static void a(int param0, int param1, String param2, String[] param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param0 == 255) {
                ...
                li.field_T = mc.b(stackIn_9_0 != 0, 102);
                break L1;
              } else {
                L3: {
                  if (param0 < 100) {
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("nl.I(").append(param0).append(',').append(-6258).append(',');
    ...
    final static int a(int param0, int param1, byte param2, byte[] param3, CharSequence param4, int param5) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_70_1 = new StringBuilder().append("nl.K(").append(param0).append(',').append(0).append(',').append(param2).append(',');
          ...
          throw ld.a((Throwable) (Object) stackIn_76_0, stackIn_76_2 + ',' + param5 + ')');
        }
        return stackIn_69_0;
    }
