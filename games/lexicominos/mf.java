...
final class mf {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((mf) this).field_a.length;
        var4 = field_b[((mf) this).field_d - 1];
        var5 = field_k;
        field_k[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_g[0] * ((mf) this).field_d;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_k[var16]) {
                  var9 = field_i[var16];
                  var10 = field_g[var16] * ((mf) this).field_d;
            ...
            L3: {
              var7 = mf.b(field_i, var6);
              var8_int = mf.a(field_i, var6);
    ...
    final boolean b() {
        ...
        int var2 = ((mf) this).field_a.length;
        System.arraycopy((Object) (Object) ((mf) this).field_a, 0, (Object) (Object) field_i, 0, var2);
        int var3 = field_b[((mf) this).field_d - 1];
        int var4 = kb.a(var3 - 1, 16);
        field_g[0] = sd.a(var4);
        field_g[1] = sd.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((mf) this).field_e.length; var6++) {
            var7 = ((mf) this).field_e[var6];
            var8 = ((mf) this).field_h[var7];
            var9 = ((mf) this).field_j[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = sd.field_p[((mf) this).field_c[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((mf) this).field_l[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_g[incrementValue$0] = var13 >= 0 ? sd.field_p[var13].a() : 0;
            }
        }
        return true;
    }
    ...
    mf() {
        ...
        if (var1 == 1) {
          var2 = sd.a(5);
          var3 = 0;
          ((mf) this).field_e = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((mf) this).field_h = new int[var3];
              ((mf) this).field_j = new int[var3];
              ((mf) this).field_c = new int[var3];
              ((mf) this).field_l = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((mf) this).field_d = sd.a(2) + 1;
                  var4 = sd.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((mf) this).field_a = new int[var5];
                      ((mf) this).field_a[0] = 0;
                      ((mf) this).field_a[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((mf) this).field_h[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((mf) this).field_a[incrementValue$2] = sd.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((mf) this).field_h[((mf) this).field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((mf) this).field_h[var4] = sd.a(3) + 1;
                    int dupTemp$3 = sd.a(2);
                    ((mf) this).field_j[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((mf) this).field_c[var4] = sd.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
