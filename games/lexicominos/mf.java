...
final class mf {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_a, 0, field_i, 0, var2);
        ...
        for (var6 = 0; var6 < this.field_e.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = sd.field_p[this.field_c[var7]].a();
            }
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_h[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_a[incrementValue$0] = sd.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
