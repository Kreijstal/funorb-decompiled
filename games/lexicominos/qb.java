...
public abstract class qb extends java.applet.Applet implements Runnable, java.awt.event.FocusListener, java.awt.event.WindowListener {
    ...
    public final void start() {
        ...
        try {
          L0: {
            L1: {
              if ((Object) (Object) c.field_j != this) {
                break L1;
              } else {
                if (!ee.field_d) {
                  rf.field_a = 0L;
            ...
            if (ck.field_d == null) {
              L1: {
                if (pg.field_b == null) {
                  ...
                  if ((Object) (Object) pg.field_b == this) {
                    break L1;
                  } else {
        ...
        try {
            ...
            stateLoop: while (true) {
                switch (statePc) {
                    ...
                    case 7: {
                        try {
                            ((qb) this).getAppletContext().showDocument(((qb) this).getDocumentBase(), "_self");
                            statePc = 8;
                            continue stateLoop;
                    ...
                    case 9: {
                        try {
                            ...
                            ab dupTemp$1 = new ab(param5, param6, param1, true);
                    ...
                    case 21: {
                        ...
                        stackOut_21_1 = new StringBuilder().append("qb.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44).append(param5).append(44);
            ...
            try {
              L0: {
                if (!((qb) this).field_g) {
                  ...
                  try {
                    L2: {
                      Object discarded$1 = oa.a(true, kk.c(-14047), "loggedout");
                      break L2;
                    }
                  ...
                  try {
                    L4: {
                      ((qb) this).getAppletContext().showDocument(new java.net.URL(((qb) this).getCodeBase(), "error_game_" + param0 + ".ws"), "_top");
                      break L4;
                    }
        ...
        try {
          L0: {
            L1: {
              ...
              qg.field_c = 31 & qg.field_c + 1;
              if (var4 == 0L) {
                break L1;
              } else {
                if (var4 < var2_long) {
                  var6_int = (int)(var2_long - var4);
                  ij.field_j = ((var6_int >> 1) + 32000) / var6_int;
                  break L1;
                } else {
                  break L1;
                }
          ...
          throw ld.a((Throwable) (Object) runtimeException, "qb.E(" + 1 + 41);
        }
    }
    ...
    private final void a(boolean param0, int param1) {
        ...
        try {
          ...
          throw ld.a((Throwable) (Object) var3_ref3, "qb.B(" + param0 + 44 + -23646 + 41);
        }
    }
    ...
    public final synchronized void paint(java.awt.Graphics param0) {
        ...
        try {
          L0: {
            L1: {
              if (this != (Object) (Object) c.field_j) {
                break L1;
              } else {
                if (!ee.field_d) {
                  L2: {
    ...
    final synchronized void f(int param0) {
        ...
        try {
          L0: {
            ...
            L6: {
              L7: {
                ...
                java.awt.Component discarded$2 = ((java.awt.Container) var2).add((java.awt.Component) (Object) ug.field_y);
                ug.field_y.setSize(u.field_sb, bk.field_d);
                ug.field_y.setVisible(true);
                if (var2 == (Object) (Object) ck.field_d) {
                  break L7;
                } else {
          ...
          throw ld.a((Throwable) var2, "qb.J(" + param0 + 41);
        }
    }
                ...
                try {
                  L1: {
                    L2: {
                      L3: {
                        L4: {
                          L5: {
                            if (ab.field_j != null) {
                              L6: {
                                var1 = (Object) (Object) ab.field_j.toLowerCase();
                              ...
                              if (var2.startsWith("1.6.0_")) {
                                ...
                                L9: while (true) {
                                  ...
                                  if (!bc.a(false, (CharSequence) (Object) var4)) {
                                    ...
                                    if (si.a((byte) 117, (CharSequence) (Object) var4) < 10) {
                                      ((qb) this).a("wrongjava", 68);
                                      if (var5 == 0) {
                                        break L2;
                                      } else {
                                        break L5;
                      ...
                      L14: {
                        var1 = (Object) (Object) c.field_j;
                        if (null != pg.field_b) {
                          var1 = (Object) (Object) pg.field_b;
                          break L14;
                        } else {
                          break L14;
                        }
                      ...
                      L18: while (true) {
                        L19: {
                          L20: {
                            if (rf.field_a == 0L) {
                              ...
                              stackOut_96_0 = (~rf.c(0) < ~rf.field_a ? -1 : (~rf.c(0) == ~rf.field_a ? 0 : 1));
                        ...
                        L21: while (true) {
                          L22: {
                            ...
                            int discarded$6 = 24344;
                            this.b();
                            int discarded$7 = 50;
                            ki.a((Object) (Object) ug.field_y, jh.field_a);
                            break L22;
                          }
                          if (var5 == 0) {
                            continue L18;
    ...
    private final void b() {
        ...
        try {
            ...
            L1: {
              ...
              if (var4 == 0L) {
                ...
                if (~var4 <= ~var2_long) {
                  ...
                  tj.field_i = (32000 - -(var6_int >> 1)) / var6_int;
                  break L1;
                }
              }
            }
            L2: {
              int fieldTemp$1 = wj.field_o;
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var2 = decompiledCaughtException;
          throw ld.a((Throwable) (Object) var2, "qb.A(" + 24344 + 41);
        }
    }
    ...
    public static void e(int param0) {
        try {
            ...
            throw ld.a((Throwable) (Object) runtimeException, "qb.H(" + param0 + 41);
        }
    }
    ...
    private static void $cfr$clinit() {
        ...
        field_l = new int[][]{new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10], new int[10]};
    }
}
