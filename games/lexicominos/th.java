...
final class th extends wf {
    ...
    final static int a(CharSequence param0, int param1, int param2) {
        ...
        try {
          ...
          throw ld.a((Throwable) (Object) stackIn_7_0, stackIn_7_2 + ',' + 8 + ',' + 16 + ')');
        }
        return stackIn_3_0;
    }
    ...
    final void b(int param0, int param1, int param2, byte[] param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("th.F(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
