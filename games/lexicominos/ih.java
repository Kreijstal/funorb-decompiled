 ...
 */
final class ih extends kd {
    byte[] field_h;
    na field_i;

    final static ih a(sh param0, String param1, String param2) {
        byte[] var3 = param0.a((byte) 127, param2, param1);
        if (var3 == null) {
            return null;
        }
        return new ih(new wf(var3));
    }

    private ih(wf param0) {
        ...
        wf stackIn_66_0 = null;
        int stackIn_66_1 = 0;
        wf stackIn_67_0 = null;
        int stackIn_67_1 = 0;
        int stackIn_67_2 = 0;
        int stackIn_73_0 = 0;
        int var2;
        ...
        int var66;
        int[] var70;
        param0.field_h = param0.field_j.length - 3;
        var2 = param0.d(true);
        var3 = param0.b(-1698573656);
        var4 = 14 + var2 * 10;
        param0.field_h = 0;
        var5 = 0;
        var6 = 0;
                ...
                L2: while (true) {
                  if (var29 >= var6) {
                    L3: {
                      ...
                      var51 = new wf(this.field_h);
                      var51.f(1297377380, -32287);
                      var51.f(6, -32287);
                      stackIn_66_0 = (wf) (var51);

                      stackIn_66_1 = 52;

                      if (var2 <= 1) {
                        stackIn_67_0 = (wf) ((Object) stackIn_66_0);
                    ...
                    ((wf) (Object) stackIn_67_0).e(stackIn_67_1, stackIn_67_2);
                    var51.e(69, var2);
                    var51.e(84, var3);
                        ...
                        L5: while (true) {
                          ...
                          if (var64 != 7) {
                            if (var64 != 23) {
                                      ...
                                      if (var62 != 4) {
                                        if (var62 != 5) {
                                          if (var62 != 6) {
                                            ...
                                            var44++;
                                            var51.c((int) param0.field_j[incrementValue$1], -1);
                                            continue L5;
                                          }
                                        } else {
                                          L8: {
                              ...
                              var50++;
                              var51.c((int) param0.field_j[incrementValue$25], -1);
                              incrementValue$26 = var50;
                              var50++;
                              var51.c((int) param0.field_j[incrementValue$26], -1);
                              incrementValue$27 = var50;
                              var50++;
                              var51.c((int) param0.field_j[incrementValue$27], -1);
                              continue L5;
                            }
                          } else {
                            L18: {
                            ...
                            var51.c(47, -1);
                            var51.c(0, -1);
                            var51.b(var51.field_h - var61, -14820);
                            var60++;
                            continue L4;
                          }
                        }
                      ...
                      L6: {
                        if (var9 != 144) {
                          ...
                          if (var12 <= 0) {
                            ...
                            L7: {
                              var13 = var18[var10];
                              var14 = (cj) ((Object) this.field_i.a((long)var13, (byte) 121));
                              if (var14 != null) {
                                break L7;
                              } else {
                                var14 = new cj(new byte[128]);
                                this.field_i.a(var14, (byte) -49, (long)var13);
                                break L7;
                              }
                            }
