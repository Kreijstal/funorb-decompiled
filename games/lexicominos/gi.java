    ...
    final void a(wf param0, se param1) {
        ...
        L0: {
          ...
          if (var3 == 0) {
            ...
            this.field_b[0] = param0.b(-1698573656);
            this.field_b[1] = param0.b(-1698573656);
            var4 = param0.d(true);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                    ...
                    L4: while (true) {
                      if (var7 >= this.field_c[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_d[var5][1][var7] = param0.b(-1698573656);
                          this.field_e[var5][1][var7] = param0.b(-1698573656);
                          var7++;
                          continue L4;
                        }
                      }
                ...
                L5: while (true) {
                  if (var6 >= this.field_c[var5]) {
                    ...
                    this.field_d[var5][0][var6] = param0.b(-1698573656);
                    this.field_e[var5][0][var6] = param0.b(-1698573656);
                    var6++;
                    continue L5;
                  }
                }
