...
final class mj extends le {
    ...
    mj(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((mj) this).field_N = new byte[256][];
        ((mj) this).field_N = param6;
        ((mj) this).field_O = new int[4][];
        ((mj) this).field_O[0] = param5;
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        int var13 = 0;
        L0: {
          var9 = param1 + param2 * lf.field_f;
          var10 = lf.field_f - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= lf.field_c) {
            break L0;
          } else {
            var13 = lf.field_c - param2;
            param4 = param4 - var13;
            param2 = lf.field_c;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * lf.field_f;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= lf.field_h) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - lf.field_h);
            break L1;
          }
        }
        L2: {
          if (param1 >= lf.field_g) {
            break L2;
          } else {
            var13 = lf.field_g - param1;
            param3 = param3 - var13;
            param1 = lf.field_g;
            var12 = var12 + var13;
            var9 = var9 + var13;
        ...
        L3: {
          if (param1 + param3 <= lf.field_e) {
            break L3;
          } else {
            var13 = param1 + param3 - lf.field_e;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  mj.a(0, lf.field_b, ((mj) this).field_N[param0], ((mj) this).field_O[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  cd.a(lf.field_b, ((mj) this).field_N[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * lf.field_f;
          var9 = lf.field_f - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= lf.field_c) {
            break L0;
          } else {
            var12 = lf.field_c - param2;
            param4 = param4 - var12;
            param2 = lf.field_c;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * lf.field_f;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= lf.field_e) {
            ...
            var12 = param1 + param3 - lf.field_e;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  mj.a(0, lf.field_b, ((mj) this).field_N[param0], ((mj) this).field_O[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  cd.a(lf.field_b, ((mj) this).field_N[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
