    ...
    final static int a(int param0, Random param1, int param2) {
        ...
        try {
          L0: {
            if (param2 <= 0) {
              ...
              if (pa.a(param2, (byte) 65)) {
                stackOut_5_0 = (int)((long)param2 * ((long)param1.nextInt() & 4294967295L) >> 32);
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("rh.F(").append(param0).append(44);
          ...
          throw ld.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + 44 + param2 + 41);
        }
        return stackIn_12_0;
    }
    ...
    final static String a(sh param0, byte param1, String param2, String param3, String param4) {
        ...
        try {
          L0: {
            if (param1 > 36) {
              if (!param0.c(90)) {
                ...
                stackOut_7_0 = param3 + " - " + param0.b(param2, (byte) 115) + "%";
          ...
          L1: {
            ...
            stackOut_9_1 = new StringBuilder().append("rh.P(");
