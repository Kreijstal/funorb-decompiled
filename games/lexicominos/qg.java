        ...
        try {
          L0: {
            if (!param1.c(127)) {
              ...
              stackOut_4_0 = param2 + " - " + param1.b((byte) -102, 0) + "%";
          ...
          L1: {
            ...
            stackOut_6_1 = new StringBuilder().append("qg.C(").append(100).append(',');
          ...
          L3: {
            ...
            stackOut_12_1 = ((StringBuilder) (Object) stackIn_12_1).append(stackIn_12_2).append(',').append(0).append(',');
