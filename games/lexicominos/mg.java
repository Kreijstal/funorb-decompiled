...
abstract class mg extends w implements dh {
    ...
    final void b(StringBuilder param0, int param1, int param2, Hashtable param3) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              L3: {
                L4: {
                  if (var5_int > param2) {
                    if (this.field_A != null) {
                      ...
                      discarded$25 = param0.append("null");
                      if (var6 == 0) {
                        break L3;
                      } else {
                        break L4;
                ...
                discarded$27 = this.field_A.a(1 + param2, param3, param0, -15992);
                break L3;
              }
              break L0;
            }
          ...
          L5: {
            ...
            stackOut_13_1 = new StringBuilder().append("mg.IB(");
    ...
    final static int a(int param0, gb param1, gb param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("mg.KB(").append(param0).append(',');
            stackIn_6_0 = stackOut_4_0;
    ...
    private final boolean b(w param0, int param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("mg.JB(");
    ...
    final int c(int param0) {
        ...
        if (param0 != 15508) {
          L0: {
            ...
            if (null != this.field_A) {
              stackOut_7_0 = this.field_A.c(15508);
              stackIn_8_0 = stackOut_7_0;
              break L0;
            } else {
              stackOut_6_0 = 0;
          ...
          L1: {
            if (null != this.field_A) {
              stackOut_3_0 = this.field_A.c(15508);
              stackIn_4_0 = stackOut_3_0;
              break L1;
            } else {
              stackOut_2_0 = 0;
    ...
    private final boolean a(w param0, int param1) {
        ...
        try {
          ...
          L3: {
            var3 = decompiledCaughtException;
            stackOut_9_0 = (RuntimeException) (var3);
            stackOut_9_1 = new StringBuilder().append("mg.MB(");
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
            stackIn_10_0 = stackOut_9_0;
            stackIn_10_1 = stackOut_9_1;
    ...
    String b(int param0) {
        ...
        if (null == this.field_A) {
          if (param0 <= 121) {
            var4 = (w) null;
            discarded$4 = this.a((byte) 45, (w) null);
            return var2;
          } else {
            return var2;
          }
          ...
          if (var3 == null) {
            if (param0 > 121) {
              ...
              var4 = (w) null;
              discarded$5 = this.a((byte) 45, (w) null);
              return var2;
            }
          } else {
            return var3;
