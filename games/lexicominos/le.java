...
abstract class le extends ca {
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        var17 = null;
        if (param0 != null) {
          discarded$5 = ob.a(0, field_r, (byte) 22, ' ');
          var4 = 0;
          var5 = 0;
          var6 = -1;
          var7 = 0;
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$6 = field_r.append('<');
                        discarded$7 = field_r.append(var15);
                        discarded$8 = field_r.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                                          ...
                                          if (!var15.startsWith("img=")) {
                                            ...
                                            try {
                                              L4: {
                                                ...
                                                var4 = var4 + this.field_H[var16_int].field_h;
                                                var10 = 0;
                                                break L4;
                                              }
                                          ...
                                          L6: {
                                            ...
                                            if (this.field_u == null) {
                                              ...
                                              if (var10 == 0) {
                                                ...
                                                var4 = var4 + this.field_u[(var10 << 8) + 174];
                                                break L6;
                                              }
                                            }
                                          }
                                        ...
                                        L7: {
                                          ...
                                          if (this.field_u == null) {
                                            ...
                                            if (var10 == 0) {
                                              ...
                                              var4 = var4 + this.field_u[(var10 << 8) + 169];
                                              break L7;
                                            }
                                          }
                                        }
                                      ...
                                      L8: {
                                        ...
                                        if (this.field_u == null) {
                                          ...
                                          if (var10 == 0) {
                                            ...
                                            var4 = var4 + this.field_u[(var10 << 8) + 128];
                                            break L8;
                                          }
                                        }
                                      }
                                    ...
                                    L9: {
                                      ...
                                      if (this.field_u == null) {
                                        ...
                                        if (var10 == 0) {
                                          ...
                                          var4 = var4 + this.field_u[(var10 << 8) + 215];
                                          break L9;
                                        }
                                      }
                                    }
                                  ...
                                  L10: {
                                    ...
                                    if (this.field_u == null) {
                                      ...
                                      if (var10 == 0) {
                                        ...
                                        var4 = var4 + this.field_u[(var10 << 8) + 173];
                                        break L10;
                                      }
                                    }
                                  }
                                ...
                                L11: {
                                  ...
                                  if (this.field_u == null) {
                                    ...
                                    if (var10 == 0) {
                                      ...
                                      var4 = var4 + this.field_u[(var10 << 8) + 160];
                                      break L11;
                                    }
                                  }
                                }
                              ...
                              L12: {
                                ...
                                if (this.field_u == null) {
                                  ...
                                  if (var10 == 0) {
                                    ...
                                    var4 = var4 + this.field_u[(var10 << 8) + 62];
                                    break L12;
                                  }
                                }
                              }
                            ...
                            L13: {
                              ...
                              if (this.field_u == null) {
                                ...
                                if (var10 == 0) {
                                  ...
                                  var4 = var4 + this.field_u[(var10 << 8) + 60];
                                  break L13;
                                }
                              }
                            }
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$9 = field_r.append((char) var14);
                        ...
                        if (this.field_u == null) {
                          ...
                          if (var10 == 0) {
                            ...
                            var4 = var4 + this.field_u[(var10 << 8) + var14];
                            break L15;
                          }
                        }
                      }
                                      ...
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_u[(var7 << 8) + var8] = (byte)le.a(var15, var16, var17, this.field_K, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
    ...
    final int a(char param0) {
        return this.field_K[ua.a(true, param0) & 255];
    }

    final int a(String param0, int param1) {
        return this.a(param0, new int[]{param1}, field_q);
    }
                                      ...
                                      if (var8.startsWith("img=")) {
                                        try {
                                          L2: {
                                            ...
                                            var4 = var4 + this.field_H[var9_int].field_h;
                                            var3 = 0;
                                            var6++;
                                            break L2;
                                          }
                  ...
                  L4: {
                    ...
                    if (this.field_u == null) {
                      ...
                      if (var3 == 0) {
                        ...
                        var4 = var4 + this.field_u[(var3 << 8) + var7];
                        break L4;
                      }
                    }
                  }
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_L = (param1 - this.b(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        if (param0 != null) {
          ...
          L1: {
            ...
            if (param4 >= this.field_E + this.field_G + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = this.a(param0, var12, field_q);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - this.field_E - this.field_G - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + this.field_E + var15;
                ...
                var14 = param2 + this.field_E + (param4 - this.field_E - this.field_G - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + this.field_E;
              break L3;
            }
          }
          var15 = 0;
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.b(field_q[var15], param1 + param3 - this.b(field_q[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_q[var15], param1 + (param3 - this.b(field_q[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    final int a(String param0, int param1, int param2) {
        ...
        int var4 = this.a(param0, new int[]{param1}, field_q);
        int var5 = (var4 - 1) * param2;
        return this.field_E + var5 + this.field_G;
    }
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var11_ref_q = this.field_H[var10];
                                            if (this.field_v == null) {
                                              stackOut_25_0 = var11_ref_q.field_g;
                                              stackIn_26_0 = stackOut_25_0;
                                              break L3;
                                            } else {
                                              stackOut_24_0 = this.field_v[var10];
                                          ...
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_I != 256) {
                                              var11_ref_q.a(param1, param2 + this.field_C - var12, field_I);
                                              break L4;
                                            } else {
                                              var11_ref_q.a(param1, param2 + this.field_C - var12);
                                              break L4;
                                            }
                                          }
              ...
              if (var4 == -1) {
                L6: {
                  ...
                  if (this.field_u == null) {
                    ...
                    if (var5 == 0) {
                      ...
                      param1 = param1 + this.field_u[(var5 << 8) + var8];
                      break L6;
                    }
                  }
                }
                    ...
                    if (field_I != 256) {
                      L8: {
                        if (field_z == -1) {
                          ...
                          this.a(var8, param1 + this.field_B[var8] + 1, param2 + this.field_M[var8] + 1, var9, var10, field_z, field_I, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_B[var8], param2 + this.field_M[var8], var9, var10, field_F, field_I, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_z == -1) {
                          ...
                          this.a(var8, param1 + this.field_B[var8] + 1, param2 + this.field_M[var8] + 1, var9, var10, field_z, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_B[var8], param2 + this.field_M[var8], var9, var10, field_F, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  ...
                  if (field_y == -1) {
                    ...
                    lf.a(var11, param2 + (int)((double)this.field_C * 0.7), param1 - var11, field_y);
                    break L10;
                  }
                }
                L11: {
                  if (field_w == -1) {
                    ...
                    lf.a(var11, param2 + this.field_C + 1, param1 - var11, field_w);
                    break L11;
                  }
                }
                var5 = var8;
    ...
    le(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_E = this.field_C - var6;
            this.field_G = var7 - this.field_C;
            this.field_t = this.field_C - this.field_M[88];
            return;
          } else {
            L1: {
              if (this.field_M[var8] >= var6) {
                break L1;
              } else {
                if (this.field_x[var8] == 0) {
                  break L1;
                } else {
                  var6 = this.field_M[var8];
                  break L1;
                }
              }
            }
            if (this.field_M[var8] + this.field_x[var8] > var7) {
              var7 = this.field_M[var8] + this.field_x[var8];
              var8++;
              continue L0;
            } else {
              var8++;
    ...
    final void a(char param0, int param1, int param2, int param3) {
        ...
        if (param0 != 32) {
            ...
            this.a(var5, param1 + this.field_B[var5] - (this.field_K[var5] >> 1), param2 + this.field_M[var5], this.field_s[var5], this.field_x[var5], param3, false);
        }
    }
    ...
    final void a(char param0, int param1, int param2, int param3, int param4) {
        ...
        if (param0 != 32) {
            ...
            this.a(var6, param1 + this.field_B[var6] - (this.field_K[var6] >> 1), param2 + this.field_M[var6], this.field_s[var6], this.field_x[var6], param3, param4, false);
        }
    }
