...
final class ck extends qg {
    ...
    final void a(int param0, int param1, int param2, int param3) {
        ...
        int discarded$0 = this.field_E.a(this.field_D, var7 + var5 + this.field_A, var6 + this.field_A, -this.field_A + this.field_C, -(2 * this.field_A) + this.field_q, this.field_B, param2, !this.field_H ? 2 : 0, 1, this.field_E.field_s);
    }
    ...
    ck(int param0, int param1, int param2, int param3, lk param4, boolean param5, int param6, int param7, ee param8, int param9, String param10) {
        ...
        try {
          L0: {
            ...
            L3: {
              if (this.field_H) {
                ...
                stackOut_8_0 = 2 * this.field_A + this.field_C;
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("ck.<init>(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
