        ...
        try {
          L0: {
            if (param0 < -78) {
              ...
              stackOut_10_0 = new mi(param2, param4);
          ...
          L2: {
            ...
            stackOut_12_1 = new StringBuilder().append("nk.C(").append(param0).append(44).append(0).append(44).append(param2).append(44);
    ...
    final static void a(int param0, int param1, String param2) {
        ...
        try {
                  ...
                  L5: {
                    if (var3_int == 0) {
                      ...
                      L6: {
                        if (cg.field_f) {
                          int discarded$3 = -50;
                          param2 = re.a(lk.field_p, new String[1]);
                          break L6;
                        } else {
                          break L6;
                        }
          ...
          L8: {
            ...
            stackOut_30_1 = new StringBuilder().append("nk.A(").append(param0).append(44).append(-9).append(44);
    ...
    final static lb a(boolean param0, String param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("nk.D(").append(0).append(44);
