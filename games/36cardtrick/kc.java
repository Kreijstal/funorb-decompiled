...
class kc extends ie {
    ...
    void e(int param0, int param1, int param2) {
        ...
        int var4 = param0 + param1 * vj.field_l;
        int var5 = 0;
        int var6 = this.field_o;
        int var7 = this.field_p;
        int var8 = vj.field_l - var7;
        int var9 = 0;
          ...
          if (param2 > this.field_l) {
            ...
            if (param3 <= this.field_k) {
              ...
              if (var5 >= var6) {
                ...
                if (var7 < var8) {
                  var9 = var7 * vj.field_l + var5;
                  var10 = vj.field_l - (var6 - var5);
                  var11 = var7;
                  L5: while (true) {
                    if (var11 >= var8) {
                      return;
    ...
    final static void a(kc param0, kc param1, int param2, int param3, int param4, int param5, int param6, int param7) {
        if (param0 != param1) {
          L0: {
          ...
          L5: {
            if (param7 <= param0.field_o - param3) {
              break L5;
            } else {
              param7 = param0.field_o - param3;
              break L5;
            }
          }
          L6: {
    ...
    void a(int param0, int param1) {
        ...
        L0: {
          ...
          if (param0 >= vj.field_f) {
            ...
            stackIn_3_0 = vj.field_f - param0 << 2;
            break L0;
          }
        }
        L1: {
          ...
          if (param0 + var3 <= vj.field_a) {
            ...
            stackIn_6_0 = (vj.field_a - param0 << 2) - 4;
            break L1;
          }
        }
        L2: {
          ...
          if (param1 >= vj.field_h) {
            ...
            stackIn_9_0 = vj.field_h - param1 << 2;
            break L2;
          }
        }
        L3: {
          ...
          if (param1 + var4 <= vj.field_b) {
            stackIn_12_0 = this.field_o - 4;
            break L3;
          } else {
            stackIn_12_0 = (vj.field_b - param1 << 2) - 4;
            break L3;
          }
        }
        var8 = stackIn_12_0;
          ...
          if (var9 > var8) {
            ...
            L5: while (true) {
              if (var12 > var6) {
                ...
                L6: while (true) {
                  if (var16 >= 4) {
                    vj.field_j[var11] = (var14 & 267390960 | var15 & 1044480) >> 4;
                    var12 += 4;
                    var10 += 4;
                    var11++;
                    continue L5;
    ...
    final void e(int param0, int param1) {
        ...
        param0 = param0 + this.field_q;
        param1 = param1 + this.field_n;
        int var3 = param0 + param1 * vj.field_l;
        int var4 = 0;
        int var5 = this.field_o;
        int var6 = this.field_p;
        int var7 = vj.field_l - var6;
        int var8 = 0;
        if (param1 < vj.field_h) {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          ...
          if (var20 < 0) {
            ...
            if (var22 < 0) {
              L14: {
                var23 = var21 * vj.field_l + var19;
                var24 = vj.field_l + var20;
    ...
    void b(int param0, int param1, int param2, int param3) {
        ...
        if (param2 > 0) {
            ...
            var13 = param0 + param1 * vj.field_l;
            var14 = vj.field_l - param2;
            if (param1 + param3 > vj.field_b) {
                param3 = param3 - (param1 + param3 - vj.field_b);
            }
            if (param1 < vj.field_h) {
                var15 = vj.field_h - param1;
                param3 = param3 - var15;
                var13 = var13 + var15 * vj.field_l;
                var8 = var8 + var12 * var15;
            }
            if (param0 + param2 > vj.field_a) {
                var15 = param0 + param2 - vj.field_a;
                param2 = param2 - var15;
                var14 = var14 + var15;
            }
            if (param0 < vj.field_f) {
                var15 = vj.field_f - param0;
                param2 = param2 - var15;
                var13 = var13 + var15;
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                L2: {
                  var11 = vj.field_j[param2] & 16711935;
                  var12 = vj.field_j[param2] & 65280;
                  var13 = 0;
                  var14 = 0;
                ...
                param2++;
                vj.field_j[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
    ...
    kc(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            var4.waitForAll();
            this.field_p = var3.getWidth((java.awt.image.ImageObserver) ((Object) param1));
            this.field_o = var3.getHeight((java.awt.image.ImageObserver) ((Object) param1));
            this.field_l = this.field_p;
            this.field_k = this.field_o;
            this.field_q = 0;
            this.field_n = 0;
            this.field_r = new int[this.field_p * this.field_o];
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_p, this.field_o, this.field_r, 0, this.field_p);
            var5.grabPixels();
            break L0;
          }
