...
final class tc {
    ...
    public static void a(byte param0) {
        ...
        if (param0 >= -82) {
          var2 = (qk) null;
          discarded$2 = tc.a(51, -63, -35, (qk) null);
          field_a = null;
          return;
        } else {
          field_a = null;
    ...
    final static void a(int param0, kc[] param1, int param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("tc.A(").append(param0).append(',');
    ...
    final static boolean a(int param0, int param1, int param2, qk param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("tc.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
