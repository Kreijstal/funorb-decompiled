    ...
    final static void a(int param0, kc[] param1, int param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("tc.A(").append(param0).append(44);
    ...
    final static boolean a(int param0, int param1, int param2, qk param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("tc.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
