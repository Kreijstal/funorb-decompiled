...
final class tb implements ci {
    ...
    public final void a(int param0, lk param1, int param2, int param3, boolean param4) {
        ...
        if (param2 == 11447) {
          vj.c(param0 + ((lk) param1).field_o, ((lk) param1).field_i + param3, ((lk) param1).field_h, ((lk) param1).field_q, ((tb) this).field_f);
          var7 = -(2 * ((h) var12).field_K) + ((lk) param1).field_h;
          var8 = ((lk) param1).field_o + (param0 - -((h) var12).field_K);
          var9 = ((h) var12).field_J + param3 - -((lk) param1).field_i;
          vj.e(var8, var9, var8 + var7, var9, ((tb) this).field_l);
          var10 = var12.a(true) + -1;
          L2: while (true) {
            if (0 > var10) {
              if (((tb) this).field_g != null) {
                ((tb) this).field_g.a(((h) var12).field_r, var7 / 2 + var8, ((tb) this).field_g.field_E + var9 + ((h) var12).field_J, ((tb) this).field_k, ((tb) this).field_i);
                return;
              } else {
                return;
              }
    ...
    final static void a(int param0, int param1) {
        ...
        dh var5 = (dh) vb.field_c.a((byte) 74);
        while (var5 != null) {
            ke.a(var5, param0, 21719);
            var5 = (dh) vb.field_c.b((byte) -104);
        }
    ...
    final static ff a(String param0, String param1, byte param2, boolean param3) {
        ...
        if (param2 != -18) {
          ...
          return nk.a(-116, param3, var4, var6, param0);
        }
    }
