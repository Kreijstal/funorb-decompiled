          ...
          if (param1 != null) {
            if (param1[0] > 0) {
              if (param0 >= 100) {
                ...
                if (var20 != null) {
                  ...
                  if (param1 != null) {
                    param1[0] = param1[0] - var21.field_h.length;
                    return var8;
                  } else {
                    return var8;
                  }
                ...
                if (var18 != null) {
                  ...
                  ((da) this).field_d.a(var6, (byte) 44, (qb) (Object) var8);
                  if (param1 != null) {
                    param1[0] = param1[0] - var19.field_h.length;
                    return var8;
                  } else {
                    return var8;
                  }
            ...
            if (param0 >= 100) {
              ...
              if (var16 != null) {
                ...
                ((da) this).field_d.a(var6, (byte) 44, (qb) (Object) var8);
                if (param1 != null) {
                  param1[0] = param1[0] - var17.field_h.length;
                  return var8;
                } else {
                  return var8;
                }
              ...
              if (var11 != null) {
                ...
                ((da) this).field_d.a(var6, (byte) 44, (qb) (Object) var8);
                if (param1 != null) {
                  param1[0] = param1[0] - var12.field_h.length;
                  return var8;
                } else {
                  return var8;
                }
