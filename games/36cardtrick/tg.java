...
final class tg implements ci {
    ...
    public final void a(int param0, lk param1, int param2, int param3, boolean param4) {
        ...
        kc var8 = null;
        Object var9 = null;
        var6 = param1.field_o + param0;
        var7 = param1.field_i + param3;
        kl.b(param1.field_q, var7, var6, 48, param1.field_h);
        var8 = gh.field_n[1];
        if (param2 == 11447) {
          L0: {
            if (!(param1 instanceof hl)) {
              ...
              if (((hl) (Object) param1).field_D) {
                var8.b(1 + (var6 - -(-var8.field_l + param1.field_h >> 1005956513)), (-var8.field_k + param1.field_q >> 343228385) + 1 + var7, 256);
                break L0;
              } else {
                if (param1.d(82)) {
                  na.a(2 + var7, 71, -4 + param1.field_h, -4 + param1.field_q, var6 - -2);
                  return;
                } else {
                  return;
                }
