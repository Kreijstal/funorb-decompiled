...
final class ob {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            if (!param1) {
              if (param0 != null) {
                if (param0 == ((ob) this).field_a) {
                  return;
                } else {
                  L0: {
                    if (((ob) this).field_a != null) {
                      ((ob) this).field_a.setCursor((java.awt.Cursor) null);
