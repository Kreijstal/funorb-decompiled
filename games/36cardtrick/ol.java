    ...
    final static wb[] a(int param0, qk param1, int param2, int param3) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_4_1 = new StringBuilder().append("ol.H(").append(param0).append(',');
          ...
          throw ma.a((Throwable) (Object) stackIn_7_0, stackIn_7_2 + ',' + param2 + ',' + 505437496 + ')');
        }
    }
    ...
    public final void a(int param0, int param1, int param2, hl param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("ol.I(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    private final hl a(String param0, int param1, pl param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ol.GA(");
          ...
          L2: {
            stackOut_5_0 = (RuntimeException) (Object) stackIn_5_0;
            stackOut_5_1 = ((StringBuilder) (Object) stackIn_5_1).append(stackIn_5_2).append(',').append(-29995).append(',');
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
            stackIn_6_0 = stackOut_5_0;
            stackIn_6_1 = stackOut_5_1;
    ...
    ol(j param0, ml param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_10_0 = var3;
            stackOut_10_1 = new StringBuilder().append("ol.<init>(");
            ...
            if (!hl.field_y[var2]) {
              ...
              L3: while (true) {
                if (var3 <= var7) {
                  ...
                  var6_ref_int__[var7] = fj.a(bc.a(255, (int) var23[var7]) << 24, jf.field_i[bc.a((int) var24[var7], 255)]);
                  var7++;
                  continue L3;
                }
              }
