...
class ek implements ci, ne {
    ...
    private final void a(lk param0, boolean param1) {
        ...
        L2: {
          ...
          if (var6 == 0) {
            ...
            if (var6 == 2) {
              ...
              var5 = (-((ek) this).field_c.field_x + var4 - ((ek) this).field_c.field_s >> 1669038433) + ((ek) this).field_c.field_s;
              break L2;
            }
          }
        }
        L4: {
          L5: {
            ...
            if (-1 != var6) {
              if (-4 == var6) {
                ...
                if (1 != var6) {
                  if ((var6 ^ -1) == -3) {
                    if (((lk) param0).field_s instanceof ub) {
                      ((ub) ((lk) param0).field_s).a(((ek) this).b(69, param0), (byte) -109, var5, ((ek) this).field_c, var3);
                      break L4;
                    } else {
                      break L4;
                    }
                  ...
                  if (!(((lk) param0).field_s instanceof ub)) {
                    ...
                    ((ub) ((lk) param0).field_s).a(((ek) this).field_c, var5, ((ek) this).b(-123, param0), -102, var3 >> -1115151007);
                    break L4;
                  }
                }
              }
          ...
          if (((lk) param0).field_s instanceof ub) {
            ((ub) ((lk) param0).field_s).a(((ek) this).b(96, param0), 1, ((ek) this).field_c, var5, 0);
            break L4;
          } else {
            break L4;
          }
    ...
    String b(int param0, lk param1) {
        int var3 = 87 / ((param0 - -48) / 42);
        return ((lk) param1).field_r;
    }
        ...
        if (param5 != param4) {
          L1: {
            if (param0.d(69)) {
              ...
              ek.a(((lk) param0).field_i + param2, param3 - (-((lk) param0).field_o - ((lk) param0).field_h), ((lk) param0).field_o + param3, (byte) 125, param2 - -((lk) param0).field_i + ((lk) param0).field_q);
              var12 = var10;
              L3: while (true) {
                if (var12 > var11) {
                  gg.a(14756);
                  ...
                  L4: {
                    var13 = ((mj) var17).field_d[var12];
                    if (var10 == var12) {
                      stackOut_13_0 = var18.a(true, var8);
                      stackIn_14_0 = stackOut_13_0;
                      break L4;
                    } else {
                      stackOut_12_0 = ((di) var13).field_a[0];
                  ...
                  L5: {
                    var14 = stackIn_14_0;
                    if (var11 == var12) {
                      stackOut_18_0 = var18.a(true, var9);
                      stackIn_19_0 = stackOut_18_0;
                      break L5;
                    } else {
                      if (var13 != null) {
                        stackOut_17_0 = ((di) var13).field_a[-1 + ((di) var13).field_a.length];
                  ...
                  var15 = stackIn_19_0;
                  pj.field_a.a(((ek) this).field_o, 10066329, this.a(param0, var14, param3, -3), param2 - (-((lk) param0).field_i - (((ek) this).field_m - -((lk) param0).field_m) - ((di) var13).field_b), ((di) var13).field_c, var15 + -var14, ((ek) this).field_o >>> -2137256488);
                  var12++;
                  continue L3;
                }
              }
    ...
    private final int b(lk param0, int param1) {
        ...
        return ((lk) param0).field_q + -((ek) this).field_m - ((ek) this).field_j;
    }
    ...
    public final void a(int param0, int param1, int param2, byte param3, lk param4) {
        ...
        if (!(!param4.d(111))) {
            ...
            var8 = ((mj) var13).field_d[var7];
            var9 = var14.a(true, param1);
            var10 = this.a(param4, var9, param0, -3);
            var11 = ((ek) this).a(param4, -1815612287, param2) + Math.max(0, ((di) var8).field_b);
            var12 = ((ek) this).a(param4, -1815612287, param2) + Math.min(this.b(param4, -32260), Math.min(((di) var8).field_c, ((mj) var14).field_d.length <= 1 + var7 ? ((di) var8).field_c : ((mj) var13).field_d[1 + var7].field_b));
            ek.a(param2 - -((lk) param4).field_i, param0 - (-((lk) param4).field_o - ((lk) param4).field_h), ((lk) param4).field_o + param0, (byte) 55, param2 - -((lk) param4).field_i + ((lk) param4).field_q);
    ...
    public final int a(lk param0, byte param1) {
        int var3 = 91 / ((param1 - -70) / 40);
        mj discarded$0 = ((ek) this).a((byte) 42, param0);
        return ((lk) param0).field_s.b((byte) -5) + (((ek) this).field_k + ((ek) this).field_n);
    }

    private final int a(lk param0, int param1, int param2, int param3) {
        if (param3 != -3) {
            lk var6 = (lk) null;
            String discarded$0 = ((ek) this).b(-108, (lk) null);
        }
        return ((lk) param0).field_o + (param2 - (-((ek) this).field_k - ((lk) param0).field_l) - -param1);
    }
    ...
    private final void a(int param0, int param1, byte param2, int param3, int param4, int param5, int param6, lk param7) {
        ...
        L0: {
          var13 = Main.field_T;
          ek.a(((lk) param7).field_i + param5, param4 + (((lk) param7).field_o - -((lk) param7).field_h), param4 + ((lk) param7).field_o, (byte) 61, param5 - (-((lk) param7).field_i + -((lk) param7).field_q));
          var9 = ((ek) this).a(param7, 0);
        ...
        L1: {
          if (((ek) this).field_g) {
            int discarded$1 = ((ek) this).field_c.a(((ek) this).b(11, param7), this.a(param7, param0, param4, -3), this.b(param7, 116, param5, param1), var9, var10, param3, param6, ((ek) this).field_i, ((ek) this).field_f, ((ek) this).field_b);
            break L1;
          } else {
            L2: {
              ...
              if (0 == var12) {
                ...
                if (2 != var12) {
                  ...
                  var11 = (-((ek) this).field_c.field_x + (-((ek) this).field_c.field_s + var10) >> 298623745) + ((ek) this).field_c.field_s;
                  break L2;
                } else {
            ...
            L4: {
              ...
              if (var12 == 0) {
                ...
                if (3 == var12) {
                  ...
                  if (var12 == 1) {
                    ((ek) this).field_c.a(((ek) this).b(param2 + 1, param7), (var9 >> -1815612287) + this.a(param7, param0, param4, param2 + -111), this.b(param7, 126, param5, param1) + var11, param3, param6);
                    break L1;
                  } else {
                    if (2 == var12) {
                      ((ek) this).field_c.c(((ek) this).b(95, param7), this.a(param7, param0, param4, -3) + var9, this.b(param7, 116, param5, param1) + var11, param3, param6);
                      break L1;
                    } else {
                      break L1;
                    }
    ...
    public final int a(lk param0, int param1, int param2) {
        ...
        return this.b(param0, 115, param2, 0);
    }
    ...
    public final mj a(byte param0, lk param1) {
        int var3 = 38 % ((-8 - param0) / 49);
        if (!(((lk) param1).field_s != null)) {
            param1.field_s = (mj) (Object) new ub();
        }
        if (((ek) this).field_g) {
            ((ub) ((lk) param1).field_s).a(this.b(param1, -32260), 841570337, ((ek) this).field_f, ((ek) this).a(param1, 0), ((ek) this).field_c, ((ek) this).field_i, ((ek) this).b(75, param1), ((ek) this).field_b);
        } else {
            this.a(param1, true);
        }
        return ((lk) param1).field_s;
    }

    public final int a(lk param0, int param1) {
        if (param1 != 0) {
            lk var4 = (lk) null;
            int discarded$0 = this.a((lk) null, 75, 43, -98);
        }
        return ((lk) param0).field_h - (((ek) this).field_k + ((ek) this).field_n);
    }
    ...
    private final int b(lk param0, int param1, int param2, int param3) {
        ...
        return ((ek) this).field_m + ((lk) param0).field_i + (param2 + ((lk) param0).field_m + param3);
    }
    ...
    public final int a(int param0, int param1, int param2, int param3, lk param4, int param5) {
        ...
        mj discarded$0 = ((ek) this).a((byte) -109, param4);
        return ((lk) param4).field_s.a(param5 - ((ek) this).a(param4, -1815612287, param1), -((ek) this).a(param3, (byte) -77, param4) + param0, param2 ^ 10969);
    }
    ...
    public void a(int param0, lk param1, int param2, int param3, boolean param4) {
        ...
        if (param2 != 11447) {
            lk var7 = (lk) null;
            int discarded$0 = this.a((lk) null, -92, 108, -40);
        }
    }

    public final int a(int param0, lk param1) {
        mj discarded$6 = ((ek) this).a((byte) -99, param1);
        if (param0 != -2) {
            return 6;
        }
        return ((lk) param1).field_s.b(param0 ^ -2) - -((ek) this).field_m + ((ek) this).field_j;
    }
    ...
    public final int a(int param0, byte param1, lk param2) {
        int var4 = 55 / ((param1 - 51) / 35);
        return this.a(param2, 0, param0, -3);
    }
