...
final class df {
    ...
    final boolean b() {
        ...
        System.arraycopy((Object) (Object) ((df) this).field_a, 0, (Object) (Object) field_d, 0, var2);
        int var3 = field_h[((df) this).field_i - 1];
        int var4 = ia.a(var3 - 1, 2);
        field_e[0] = ig.e(var4);
        field_e[1] = ig.e(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((df) this).field_l.length; var6++) {
            var7 = ((df) this).field_l[var6];
            var8 = ((df) this).field_f[var7];
            var9 = ((df) this).field_b[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ig.field_E[((df) this).field_g[var7]].a();
            }
    ...
    final void a(float[] param0, int param1) {
        ...
        var4 = field_h[((df) this).field_i - 1];
        var5 = field_k;
        field_k[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_e[0] * ((df) this).field_i;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_k[var16]) {
                  var9 = field_d[var16];
                  var10 = field_e[var16] * ((df) this).field_i;
            ...
            L3: {
              var7 = df.a(field_d, var6);
              var8_int = df.b(field_d, var6);
              var9 = this.a(field_d[var7], field_e[var7], field_d[var8_int], field_e[var8_int], field_d[var6]);
              var10 = field_e[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    df() {
        ...
        if (var1 == 1) {
          var2 = ig.e(5);
          var3 = 0;
          ((df) this).field_l = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((df) this).field_f = new int[var3];
              ((df) this).field_b = new int[var3];
              ((df) this).field_g = new int[var3];
              ((df) this).field_j = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((df) this).field_i = ig.e(2) + 1;
                  var4 = ig.e(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ...
                      var5 = var5 + ((df) this).field_f[((df) this).field_l[var6]];
                      var6++;
                      continue L2;
                    }
                  }
