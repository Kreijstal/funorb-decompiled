...
final class df {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_a, 0, field_d, 0, var2);
        int var3 = field_h[this.field_i - 1];
        ...
        for (var6 = 0; var6 < this.field_l.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = ig.field_E[this.field_g[var7]].a();
            }
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_k[var16]) {
                  var9 = field_d[var16];
                  var10 = field_e[var16] * this.field_i;
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_f[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_a[incrementValue$0] = ig.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_f[this.field_l[var6]];
                      var6++;
                      continue L2;
                    }
                  }
