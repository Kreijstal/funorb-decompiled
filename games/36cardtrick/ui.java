...
final class ui extends g implements qh {
    ...
    final void a(int param0, int param1, int param2, int param3) {
        ...
        int discarded$0 = this.field_J.a(this.field_L, this.field_o + param0 + 14, 10 + param1 + this.field_i, this.field_h - 28, this.field_q, 16777215, -1, 0, 0, this.field_J.field_s);
    }
    ...
    final void a(String param0, int param1, int param2) {
        ...
        try {
            if (param2 != -14) {
                ...
                discarded$0 = this.a((pl) null, true, (String) null);
            }
