    ...
    final static int a(int param0, int param1, Random param2) {
        ...
        try {
          L0: {
            if (param1 > 0) {
              if (ng.a(param1, (byte) -101)) {
                stackOut_5_0 = (int)((4294967295L & (long)param2.nextInt()) * (long)param1 >> -1558177248);
                ...
                L2: while (true) {
                  ...
                  if (var4 >= var3_int) {
                    ...
                    stackOut_10_0 = sk.a(param0 + -10970, param1, var4);
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("sj.A(").append(param0).append(',').append(param1).append(',');
    ...
    final static Object a(boolean param0, int param1, byte[] param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_12_1 = new StringBuilder().append("sj.G(").append(param0).append(',').append(param1).append(',');
            stackIn_14_0 = stackOut_12_0;
            stackIn_14_1 = stackOut_12_1;
            stackIn_13_0 = stackOut_12_0;
            stackIn_13_1 = stackOut_12_1;
    ...
    final static nc a(String param0, byte param1) {
        ...
        try {
              ...
              if (-64 > (var2_int ^ -1)) {
                ...
                L1: while (true) {
                  if (var3 >= var2_int) {
                    if (param1 != 8) {
                      var6 = (byte[]) null;
                      discarded$2 = sj.a(true, 21, (byte[]) null);
                      stackOut_23_0 = null;
          ...
          L4: {
            ...
            stackOut_25_1 = new StringBuilder().append("sj.C(");
    ...
    final static void a(int param0, String param1, String[] param2, int param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_14_1 = new StringBuilder().append("sj.D(").append(param0).append(',');
          ...
          throw ma.a((Throwable) ((Object) stackIn_20_0), stackIn_20_2 + ',' + param3 + ')');
        }
    }
