    ...
    final static void a(ad param0, int param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("aa.H(");
