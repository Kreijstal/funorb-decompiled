        ...
        try {
            ...
            try {
              L0: {
                if (param1 < -101) {
                  var18_ref = new fd();
                  var18_ref.field_o = param0.f(38);
                  var18_ref.field_j = param0.e((byte) 126);
                  var18_ref.field_l = new byte[var18_ref.field_o][][];
                  var18_ref.field_k = new int[var18_ref.field_o];
                  var18_ref.field_p = new vi[var18_ref.field_o];
                  var18_ref.field_i = new int[var18_ref.field_o];
                  var18_ref.field_m = new int[var18_ref.field_o];
                  var18_ref.field_r = new vi[var18_ref.field_o];
                  var5 = 0;
                  L1: while (true) {
                    if (var18_ref.field_o <= var5) {
                      vb.field_e.a(var18_ref, 27362);
                      ...
                      try {
                        L2: {
                          L3: {
                                  ...
                                  if (2 != var6_int) {
                                    ...
                                    L6: while (true) {
                                      if (var11_int >= var9) {
                                        ...
                                        L9: while (true) {
                                          if (var17 >= var9) {
                                            var18_ref.field_r[var5] = param3.a((byte) 99, t.a(var20, -122), var21, var12);
                            ...
                            var18_ref.field_p[var5] = param3.a(t.a(var15, -107), var16, 115);
                            break L3;
                          }
                          break L2;
                        }
