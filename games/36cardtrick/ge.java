...
final class ge {
    ...
    final void a(pb param0, int param1, byte[] param2) {
        try {
            ...
            try {
              L0: {
                L1: {
                  if (param0.field_g[param0.field_i] != 31) {
                    break L1;
                  } else {
              ...
              L5: {
                ...
                stackOut_13_1 = new StringBuilder().append("ge.A(");
    ...
    final static void a(int param0, kc[] param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("ge.F(").append(param0).append(44);
          ...
          throw ma.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + -10 + 41);
        }
    }
    ...
    final static String a(byte[] param0, byte param1) {
        ...
        try {
          L0: {
            if (param1 >= 77) {
              stackOut_3_0 = bd.a(255, 0, param0, param0.length);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("ge.D(");
