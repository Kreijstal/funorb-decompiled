...
final class ef extends ee {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L0: {
          ...
          var10 = vj.field_l - param3;
          var11 = 0;
          var12 = 0;
          if (param2 >= vj.field_h) {
            break L0;
          } else {
            var13 = vj.field_h - param2;
            param4 = param4 - var13;
            param2 = vj.field_h;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * vj.field_l;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= vj.field_b) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - vj.field_b);
            break L1;
          }
        }
        L2: {
        ...
        L3: {
          if (param1 + param3 <= vj.field_a) {
            break L3;
          } else {
            var13 = param1 + param3 - vj.field_a;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  ef.a(0, vj.field_j, ((ef) this).field_I[param0], ((ef) this).field_J[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  oh.a(vj.field_j, ((ef) this).field_I[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
    ...
    ef(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((ef) this).field_I = new byte[256][];
        ((ef) this).field_I = param6;
        ((ef) this).field_J = new int[4][];
        ((ef) this).field_J[0] = param5;
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        int var12 = 0;
        L0: {
          var8 = param1 + param2 * vj.field_l;
          var9 = vj.field_l - param3;
          var10 = 0;
          var11 = 0;
          if (param2 >= vj.field_h) {
            break L0;
          } else {
            var12 = vj.field_h - param2;
            param4 = param4 - var12;
            param2 = vj.field_h;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * vj.field_l;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= vj.field_a) {
            ...
            var12 = param1 + param3 - vj.field_a;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  ef.a(0, vj.field_j, ((ef) this).field_I[param0], ((ef) this).field_J[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  oh.a(vj.field_j, ((ef) this).field_I[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
