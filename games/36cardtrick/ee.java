...
abstract class ee extends he {
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        var17 = null;
        if (param0 != null) {
          int discarded$8 = 2053368837;
          int discarded$9 = 0;
          int discarded$10 = 32;
          StringBuilder discarded$11 = bc.a(field_H);
          var4 = 0;
          var5 = 0;
          var6 = -1;
          var7 = 0;
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var11_ref_uk = ((ee) this).field_t[var10];
                                            if (((ee) this).field_r == null) {
                                              stackOut_25_0 = var11_ref_uk.field_f;
                                          ...
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_m != 256) {
                                              var11_ref_uk.a(param1, param2 + ((ee) this).field_E - var12, field_m);
                                              break L4;
                                            } else {
                                              var11_ref_uk.a(param1, param2 + ((ee) this).field_E - var12);
                                              break L4;
                                            }
                                          }
                                          param1 = param1 + var11_ref_uk.field_e;
                                          var5 = 0;
                                          var7++;
                                          break L2;
                                        }
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                ...
                var2++;
                ((ee) this).field_p[var3_int] = param0[incrementValue$9] & 255;
                var3_int++;
                continue L1;
              }
            }
