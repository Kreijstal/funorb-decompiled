...
final class lj {
    ...
    private final float b(int param0, int param1, float param2) {
        float var4 = (float)((lj) this).field_c[param0][0][param1] + param2 * (float)(((lj) this).field_c[param0][1][param1] - ((lj) this).field_c[param0][0][param1]);
    ...
    final int a(int param0, float param1) {
        ...
        L0: {
          if (param0 != 0) {
            ...
            var3 = (float)((lj) this).field_h[0] + (float)(((lj) this).field_h[1] - ((lj) this).field_h[0]) * param1;
            var3 = var3 * 0.0030517578125f;
            field_d = (float)Math.pow(0.1, (double)(var3 / 20.0f));
            field_b = (int)(field_d * 65536.0f);
            break L0;
          }
        }
        if (((lj) this).field_e[param0] != 0) {
          ...
          var4 = 1;
          L1: while (true) {
            if (var4 >= ((lj) this).field_e[param0]) {
              L2: {
                if (param0 != 0) {
                  break L2;
                } else {
                  var4 = 0;
                  L3: while (true) {
                    if (var4 >= ((lj) this).field_e[0] * 2) {
                      break L2;
                    } else {
                      field_g[0][var4] = field_g[0][var4] * field_d;
                      var4++;
                      continue L3;
                    }
                  }
              ...
              var4 = 0;
              L4: while (true) {
                if (var4 >= ((lj) this).field_e[param0] * 2) {
                  return ((lj) this).field_e[param0] * 2;
                } else {
    ...
    final void a(pb param0, ih param1) {
        ...
        L0: {
          var3 = param0.f(78);
          ((lj) this).field_e[0] = var3 >> 4;
          ((lj) this).field_e[1] = var3 & 15;
          if (var3 == 0) {
            var11 = ((lj) this).field_h;
            ((lj) this).field_h[1] = 0;
            var11[0] = 0;
            break L0;
          } else {
            ((lj) this).field_h[0] = param0.d((byte) 72);
            ((lj) this).field_h[1] = param0.d((byte) 72);
            var4 = param0.f(-105);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                  ...
                  if (var5 >= 2) {
                    L3: {
                      if (var4 != 0) {
                        ...
                        if (((lj) this).field_h[1] == ((lj) this).field_h[0]) {
                          break L0;
                        } else {
                          break L3;
                        }
                    ...
                    var6 = var7;
                    L4: while (true) {
                      if (var7 >= ((lj) this).field_e[var5]) {
                        var5++;
                        continue L2;
                      } else {
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ((lj) this).field_c[var5][1][var7] = ((lj) this).field_c[var5][0][var7];
                          ((lj) this).field_f[var5][1][var7] = ((lj) this).field_f[var5][0][var7];
                          var7++;
                          continue L4;
                        } else {
                          ((lj) this).field_c[var5][1][var7] = param0.d((byte) 72);
                          ((lj) this).field_f[var5][1][var7] = param0.d((byte) 72);
                          var7++;
                          continue L4;
                        }
                      }
                ...
                var6 = 0;
                L5: while (true) {
                  if (var6 >= ((lj) this).field_e[var5]) {
                    var5++;
                    continue L1;
                  } else {
                    ((lj) this).field_c[var5][0][var6] = param0.d((byte) 72);
                    ((lj) this).field_f[var5][0][var6] = param0.d((byte) 72);
                    var6++;
                    continue L5;
                  }
                }
    ...
    lj() {
        ((lj) this).field_c = new int[2][2][4];
        ((lj) this).field_e = new int[2];
        ((lj) this).field_f = new int[2][2][4];
        ((lj) this).field_h = new int[2];
    }
