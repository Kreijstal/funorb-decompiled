...
final class pf extends qb {
    ...
    final static void d(int param0) {
        ...
        try {
          ...
          throw ma.a((Throwable) (Object) var1, "pf.E(" + 260 + 41);
        }
    }
    ...
    final static String a(qk param0, String param1, String param2, boolean param3) {
        ...
        try {
          L0: {
            if (param0.b(4)) {
              stackOut_3_0 = param2 + " - " + param0.a(2) + "%";
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("pf.D(");
