...
final class ig extends qb {
    private static wj[] field_t;
    private boolean field_v;
    private int field_n;
    private static int[] field_q;
    private byte[][] field_l;
    private int field_I;
    private static ld[] field_A;
    ...
    final static int a() {
        int var0 = field_k[field_H] >> field_M & 1;
        field_M = field_M + 1;
        field_H = field_H + (field_M >> 3);
        field_M = field_M & 7;
        return var0;
    }
    ...
    final ib c() {
        ...
        int var7 = 0;
        ((ig) this).field_i = 0;
        ((ig) this).field_w = new float[field_u];
        var1 = new byte[((ig) this).field_x];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((ig) this).field_l.length) {
            ((ig) this).field_w = null;
            return new ib(((ig) this).field_C, var1, ((ig) this).field_G, ((ig) this).field_m, ((ig) this).field_v);
          } else {
            var4 = this.d(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((ig) this).field_x - var2) {
                  break L1;
                } else {
                  var5 = ((ig) this).field_x - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    final ib a(int[] param0) {
        ...
        L1: {
          if (((ig) this).field_p != null) {
            break L1;
          } else {
            ((ig) this).field_i = 0;
            ((ig) this).field_w = new float[field_u];
            ((ig) this).field_p = new byte[((ig) this).field_x];
            ((ig) this).field_I = 0;
            ((ig) this).field_D = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((ig) this).field_D >= ((ig) this).field_l.length) {
            ((ig) this).field_w = null;
            var14 = ((ig) this).field_p;
            ((ig) this).field_p = null;
            return new ib(((ig) this).field_C, var14, ((ig) this).field_G, ((ig) this).field_m, ((ig) this).field_v);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((ig) this).field_I;
                  var4 = var13.length;
                  if (var4 <= ((ig) this).field_x - var3) {
                    break L5;
                  } else {
                    var4 = ((ig) this).field_x - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((ig) this).field_I);
                        break L7;
                      }
                    }
                    ((ig) this).field_I = var3;
                    break L4;
                  } else {
                    L8: {
            ...
            ((ig) this).field_D = ((ig) this).field_D + 1;
            continue L2;
          }
        }
    }
    ...
    final static int e(int param0) {
        ...
        while (param0 >= 8 - field_M) {
            var3 = 8 - field_M;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_k[field_H] >> field_M & var4) << var2);
            field_M = 0;
            field_H = field_H + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_k[field_H] >> field_M & var3) << var2);
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = ig.e(16);
                                    int discarded$4 = ig.e(16);
                                    field_r[var6] = ig.e(8);
                                    var6++;
                                    continue L6;
                                  }
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = kk.a(var11, 127, var10);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    private final static boolean a(qk param0) {
        byte[] var1 = null;
        if (!field_N) {
            var1 = param0.a(0, (byte) -115, 0);
            if (var1 == null) {
                return false;
            }
            ig.a(var1);
    ...
    private final void b(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        pb var2 = new pb(param0);
        ((ig) this).field_C = var2.e((byte) 125);
        ((ig) this).field_x = var2.e((byte) 125);
        ...
        for (var4 = 0; var4 < var3; var4++) {
            ...
            var6 = new byte[var5];
            var2.a(30, var6, 0, var5);
            ((ig) this).field_l[var4] = var6;
        }
    }
    ...
    private final float[] d(int param0) {
        ...
        L0: {
          ig.a(((ig) this).field_l[param0], 0);
          int discarded$1 = ig.a();
          var2 = ig.e(ia.a(field_r.length - 1, 2));
          var3 = field_j[var2] ? 1 : 0;
          if (var3 == 0) {
            stackOut_2_0 = field_g;
          ...
          L5: {
            ...
            if (var3 == 0) {
              ...
              if (var5 != 0) {
                ...
                var8 = (var4 >> 2) - (field_g >> 2);
                var9 = (var4 >> 2) + (field_g >> 2);
                var10 = field_g >> 1;
                break L4;
              }
            }
          ...
          L7: {
            if (var3 == 0) {
              ...
              if (var6 != 0) {
                ...
                var11 = var4 - (var4 >> 2) - (field_g >> 2);
                var12 = var4 - (var4 >> 2) + (field_g >> 2);
                var13 = field_g >> 1;
                break L6;
              }
            }
        ...
        L9: while (true) {
          if (var17_int >= var14.field_b) {
            ...
            L35: {
              var17 = null;
              if (((ig) this).field_i <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((ig) this).field_i + var4 >> 2;
                  ...
                  if (((ig) this).field_z) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((ig) this).field_n) {
                        break L36;
                      } else {
                        var20 = (((ig) this).field_i >> 1) + var19;
                        var40[var19] = var40[var19] + ((ig) this).field_w[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((ig) this).field_w;
              ((ig) this).field_w = field_o;
              field_o = var18;
              ((ig) this).field_i = var4;
              ((ig) this).field_n = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    private ig(byte[] param0) throws IOException {
        this.b(param0);
    }
