...
final class ig extends qb {
              ...
              if (var7 == null) {
                ...
                L6: while (true) {
                  if (var5 >= var4) {
                    ...
                    var3++;
                    this.field_p[incrementValue$0] = (byte)(var6 - 128);
                    var5++;
                    continue L6;
                  }
                }
    ...
    final static ig a(qk param0, String param1, String param2) {
        try {
            ig var4_ref = null;
            if (!ig.a(param0)) {
                param0.a(param1, param2, (byte) -44);
                return null;
            }
