        ...
        try {
            ...
            try {
              L0: {
                if (!this.field_b) {
                  ...
                  if (param0 <= -30) {
                    ...
                    try {
                      L1: {
                        discarded$1 = vh.a("loggedout", -12151, mk.g(-125));
                        break L1;
                      }
                    } catch (java.lang.Throwable decompiledCaughtParameter0) {
                      decompiledCaughtException = decompiledCaughtParameter0;
              ...
              L5: {
                ...
                stackOut_12_1 = new StringBuilder().append("fj.RB(").append(param0).append(',');
        ...
        try {
          L0: {
            ...
            if (param0 == -1775094552) {
              L6: {
                L7: {
                  discarded$7 = ((java.awt.Container) (var2)).add((java.awt.Component) ((Object) tb.field_c));
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, mg param6, int param7) {
        ...
        try {
          ...
          L21: {
            ...
            stackOut_80_1 = new StringBuilder().append("fj.SB(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
        ...
        try {
            ...
            try {
                  ...
                  L1: {
                    if (jj.field_a == null) {
                      L2: {
                        ...
                        rh.field_k = 0;
                        tk.field_o = mk.g(-118);
                        dupTemp$1 = new le(param6, param1, param2, true);
              ...
              L7: {
                ...
                stackOut_23_1 = new StringBuilder().append("fj.QB(").append(param0).append(',');
