...
final class ql {
    ...
    final int a() {
        ...
        while (this.field_a[var1] >= 0) {
            var1 = ig.a() != 0 ? this.field_a[var1] : var1 + 1;
        }
        return this.field_a[var1] ^ -1;
    }

    final float[] c() {
        return this.field_b[this.a()];
    }
    ...
    ql() {
        ...
        L0: {
          discarded$2 = ig.e(24);
          this.field_f = ig.e(16);
          this.field_d = ig.e(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_d) {
                ...
                var4_int = ig.e(ia.a(this.field_d - var2, 2));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_d * this.field_f;
                break L9;
              } else {
                var7 = ql.a(this.field_d, this.field_f);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_b = new float[this.field_d][this.field_f];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
