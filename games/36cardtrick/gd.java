...
class gd {
        ...
        try {
            ...
            if (!this.field_p) {
              ...
              try {
                L0: {
                  L1: {
                    if (var1 <= this.field_l + 6000L) {
                      break L1;
                    } else {
                      this.field_l = var1 - 6000L;
                      break L1;
                    }
                  }
                  L2: while (true) {
                    if (var1 <= this.field_l + 5000L) {
                      break L0;
                    } else {
                      this.b(256);
                      this.field_l = this.field_l + (long)(256000 / field_m);
                      var1 = id.a(97);
                      continue L2;
                    }
                  }
              ...
              if (this.field_e != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.b();
                      if (this.field_b - var3_int <= this.field_r) {
                        break L6;
                      } else {
                        this.field_r = this.field_b - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_s) {
                        break L8;
                      } else {
                        L9: {
                          this.field_s = this.field_s + 1024;
                          if (this.field_s <= 16384) {
                            break L9;
                          } else {
                            this.field_s = 16384;
                            break L9;
                        ...
                        if (var4 + 256 <= this.field_s) {
                          ...
                          var4 = this.field_s - 256;
                          this.field_f = var4 - this.field_d;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_a) {
                            ...
                            L12: {
                              if (this.field_c) {
                                ...
                                this.field_f = Math.min(this.field_g, this.field_r);
                                this.field_g = this.field_r;
                                break L12;
                              }
                            }
                            this.field_r = 0;
                            this.field_a = var1 + 2000L;
                            break L11;
                          }
                        }
    ...
    private final void a(je param0, int param1) {
        int var3 = param1 >> 5;
        je var4 = this.field_t[var3];
        if (var4 == null) {
            this.field_k[var3] = param0;
        } else {
            var4.field_g = param0;
        }
    ...
    private final void a(int[] param0, int param1) {
        ...
        L1: {
          ...
          if (this.field_h == null) {
            ...
            if (this.field_u > 0) {
              ...
              this.field_u = this.field_u + (field_m >> 4);
              gd.a(this.field_h);
              this.a(this.field_h, this.field_h.d());
              var4 = 0;
              var5 = 255;
              var6 = 7;
              L2: while (true) {
                                ...
                                if (var4 < this.field_i) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_t[var7_int] = (je) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((je) (var7)).field_g;
                        ((je) (var7)).field_g = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
        ...
        L17: {
          if (this.field_h == null) {
            ...
            this.field_h.a(param0, 0, param1);
            break L17;
          }
        }
        this.field_l = id.a(113);
    }
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new kd();
                          var4 = var5;
                          stackIn_10_0 = (kd) (var4);

                          stackIn_10_1 = 256;

                          if (!field_q) {
                            stackIn_11_0 = (kd) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_n <= 0) {
                            ...
                            if (field_o != null) {
                              ...
                              param0.a(0, field_n, (Runnable) ((Object) field_o));
                              break L5;
                            }
                          }
                        }
    ...
    gd() {
        this.field_p = false;
        this.field_i = 32;
        this.field_l = id.a(35);
        this.field_g = 0;
        this.field_u = 0;
        this.field_k = new je[8];
        this.field_b = 0;
        this.field_r = 0;
        this.field_c = true;
        this.field_a = 0L;
        this.field_j = 0L;
        this.field_t = new je[8];
    }
}
