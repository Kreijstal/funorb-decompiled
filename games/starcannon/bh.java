...
final class bh implements Iterable {
    ...
    final static String a(String param0, ue param1, byte param2, String param3, String param4) {
        ...
        try {
          L0: {
            ...
            if (param1.b((byte) 93)) {
              stackOut_5_0 = param3 + " - " + param1.a(param4, (byte) 75) + "%";
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("bh.B(");
    ...
    final void a(uh param0, int param1) {
        try {
            ...
            throw sd.a((Throwable) (Object) runtimeException, "bh.A(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
