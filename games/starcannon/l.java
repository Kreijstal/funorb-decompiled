...
final class l {
    ...
    final boolean b() {
        ...
        int var2 = ((l) this).field_c.length;
        System.arraycopy((Object) (Object) ((l) this).field_c, 0, (Object) (Object) field_e, 0, var2);
        int var3 = field_i[((l) this).field_f - 1];
        int var4 = td.a(var3 - 1, (byte) 100);
        field_g[0] = nj.a(var4);
        field_g[1] = nj.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((l) this).field_d.length; var6++) {
            var7 = ((l) this).field_d[var6];
            var8 = ((l) this).field_a[var7];
            var9 = ((l) this).field_l[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = nj.field_y[((l) this).field_b[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((l) this).field_h[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_g[incrementValue$0] = var13 >= 0 ? nj.field_y[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((l) this).field_c.length;
        var4 = field_i[((l) this).field_f - 1];
        var5 = field_k;
        field_k[1] = true;
        var5[0] = true;
        var6 = 2;
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_k[var16]) {
                  var9 = field_e[var16];
                  var10 = field_g[var16] * ((l) this).field_f;
            ...
            L3: {
              var7 = l.a(field_e, var6);
              var8_int = l.b(field_e, var6);
              var9 = this.a(field_e[var7], field_g[var7], field_e[var8_int], field_g[var8_int], field_e[var6]);
              var10 = field_g[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    l() {
        ...
        if (var1 == 1) {
          var2 = nj.a(5);
          var3 = 0;
          ((l) this).field_d = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((l) this).field_a = new int[var3];
              ((l) this).field_l = new int[var3];
              ((l) this).field_b = new int[var3];
              ((l) this).field_h = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((l) this).field_f = nj.a(2) + 1;
                  var4 = nj.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((l) this).field_c = new int[var5];
                      ((l) this).field_c[0] = 0;
                      ((l) this).field_c[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((l) this).field_a[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((l) this).field_c[incrementValue$2] = nj.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((l) this).field_a[((l) this).field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((l) this).field_a[var4] = nj.a(3) + 1;
                    int dupTemp$3 = nj.a(2);
                    ((l) this).field_l[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((l) this).field_b[var4] = nj.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
