...
final class l {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_c, 0, field_e, 0, var2);
        int var3 = field_i[this.field_f - 1];
        ...
        for (var6 = 0; var6 < this.field_d.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = nj.field_y[this.field_b[var7]].b();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_a[var7]) {
                              ...
                              var5++;
                              this.field_c[incrementValue$2] = nj.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_a[this.field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
