...
final class ib {
    ...
    ib() {
        ...
        L0: {
          discarded$2 = nj.a(24);
          this.field_d = nj.a(16);
          this.field_f = nj.a(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_f) {
                ...
                var4_int = nj.a(td.a(this.field_f - var2, (byte) 110));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_f * this.field_d;
                break L9;
              } else {
                var7 = ib.a(this.field_f, this.field_d);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_a = new float[this.field_f][this.field_d];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
