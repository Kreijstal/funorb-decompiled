...
abstract class qe extends uh {
                                          ...
                                          if (!var15.startsWith("img=")) {
                                            ...
                                            try {
                                              L4: {
                                                ...
                                                var4 = var4 + this.field_M[var16_int].field_k;
                                                var10 = 0;
                                                break L4;
                                              }
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var10 = pd.a(var13, 10);
                                            var11_ref_ne = this.field_M[var10];
                                            if (this.field_u == null) {
                                              stackIn_26_0 = var11_ref_ne.field_e;
                                              break L3;
                                            } else {
                                          ...
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_z != 256) {
                                              var11_ref_ne.a(param1, param2 + this.field_x - var12, field_z);
                                              break L4;
                                            } else {
                                              var11_ref_ne.c(param1, param2 + this.field_x - var12);
                                              break L4;
                                            }
                                          }
              ...
              if (var4 == -1) {
                    ...
                    if (field_z != 256) {
                      L8: {
                        if (field_I == -1) {
                          ...
                          this.a(var8, param1 + this.field_J[var8] + 1, param2 + this.field_y[var8] + 1, var9, var10, field_I, field_z, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_J[var8], param2 + this.field_y[var8], var9, var10, field_G, field_z, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_I == -1) {
                          ...
                          this.a(var8, param1 + this.field_J[var8] + 1, param2 + this.field_y[var8] + 1, var9, var10, field_I, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_J[var8], param2 + this.field_y[var8], var9, var10, field_G, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  ...
                  if (field_B == -1) {
                    ...
                    ki.b(var11, param2 + (int)((double)this.field_x * 0.7), param1 - var11, field_B);
                    break L10;
                  }
                }
                L11: {
                  if (field_C == -1) {
                    ...
                    ki.b(var11, param2 + this.field_x + 1, param1 - var11, field_C);
                    break L11;
                  }
                }
                var5 = var8;
    ...
    final int a(char param0) {
        return this.field_v[ma.a(-127, param0) & 255];
    }

    final int a(String param0, int param1) {
        return this.a(param0, new int[]{param1}, field_K);
    }
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10) {
        ...
        if (param0 != null) {
          ...
          L1: {
            ...
            if (param4 >= this.field_p + this.field_q + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = this.a(param0, var12, field_K);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - this.field_p - this.field_q - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + this.field_p + var15;
                ...
                var14 = param2 + this.field_p + (param4 - this.field_p - this.field_q - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + this.field_p;
              break L3;
            }
          }
          var15 = 0;
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.b(field_K[var15], param1 + param3 - this.a(field_K[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_K[var15], param1 + (param3 - this.a(field_K[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
                                      ...
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_H[(var7 << 8) + var8] = (byte)qe.a(var15, var16, var17, this.field_v, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                                      ...
                                      if (var8.startsWith("img=")) {
                                        try {
                                          L2: {
                                            ...
                                            var4 = var4 + this.field_M[var9_int].field_k;
                                            var3 = 0;
                                            var6++;
                                            break L2;
                                          }
    ...
    final int a(String param0, int param1, int param2) {
        ...
        int var4 = this.a(param0, new int[]{param1}, field_K);
        int var5 = (var4 - 1) * param2;
        return this.field_p + var5 + this.field_q;
    }
    ...
    final int c(String param0, int param1) {
        ...
        int var5;
        int var6;
        var3 = this.a(param0, new int[]{param1}, field_K);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (var5 >= var3) {
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_s = (param1 - this.a(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    qe(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_p = this.field_x - var6;
            this.field_q = var7 - this.field_x;
            this.field_r = this.field_x - this.field_y[88];
            return;
          } else {
            L1: {
            ...
            if (this.field_y[var8] + this.field_D[var8] > var7) {
              var7 = this.field_y[var8] + this.field_D[var8];
              var8++;
              continue L0;
            } else {
              var8++;
