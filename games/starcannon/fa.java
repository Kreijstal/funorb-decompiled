...
final class fa extends uj {
    ...
    final void a(int param0, int param1, byte param2, int param3) {
        ...
        if (!((((fa) this).field_x ^ -1) <= -65537)) {
            cl.a(true, ((fa) this).field_f + var6, (((fa) this).field_x * ((fa) this).field_i >> -1567160656) + var5, var6, var5 - -((fa) this).field_i);
    ...
    final void b(int param0, int param1, int param2) {
        ...
        ((fa) this).field_w = (param2 & 16711422) >> -432435807;
        ((fa) this).field_u = 8355711 & param0 >> -1336455359;
        this.e((byte) 34);
        if (param1 != 2) {
    ...
    private final hl a(int param0, int param1, int param2) {
        ...
        L0: while (true) {
          if (var6 >= ((fa) this).field_f) {
            ...
            L1: {
              var7 = (var6 >> -842823295) * (((fa) this).field_C * 2 - 1) % (2 * ((fa) this).field_C);
    ...
    private final void e(byte param0) {
        ((fa) this).field_y = new hl[]{this.a(0, ((fa) this).field_F, ((fa) this).field_B), this.a(param0 ^ 34, ((fa) this).field_w, ((fa) this).field_u)};
        ((fa) this).field_v = this.a(true);
        if (param0 != 34) {
            ((fa) this).field_x = -4;
        }
        ((fa) this).field_J = ((fa) this).field_v.g();
        ((fa) this).field_H = new hl(((fa) this).field_f >> 2048628833, ((fa) this).field_f);
    }
    ...
    private final hl a(boolean param0) {
        ...
        double var6 = 0.0;
        int var8 = 0;
        int var2 = ((fa) this).field_f >> 1284095585;
    ...
    private final void a(hl param0, int param1, int param2, int param3) {
        ...
        var5 = ((fa) this).field_i + param1;
        cl.a(true, ((fa) this).field_f + param2, ((fa) this).field_v.field_u + param1, param2, var5 - ((fa) this).field_v.field_u);
        ...
        L0: while (true) {
          if (var6 >= var5) {
            ...
            L3: {
              if (var5 - ((fa) this).field_v.field_u > ki.field_g) {
                break L3;
              } else {
                bc.a(((fa) this).field_H, 26095);
                ...
                L4: while (true) {
                  if (2 * ((fa) this).field_C >= var7) {
                    ...
                    wf.a(-72);
                    ((fa) this).field_H.e(var5 - ((fa) this).field_v.field_u, param2);
                    break L3;
                  } else {
