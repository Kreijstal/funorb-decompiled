...
final class af extends kf {
    ...
    final void a(int param0, int param1, int param2, uj param3, byte param4, int param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("af.OA(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    private af(int param0, int param1, int param2, int param3, de param4, qg param5, uj param6) {
        ...
        try {
            ...
            throw sd.a((Throwable) (Object) runtimeException, "af.<init>(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + (param6 != null ? "{...}" : "null") + 41);
        }
    }
