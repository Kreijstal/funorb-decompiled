...
final class sf {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            ...
            if (param0 == ((sf) this).field_b) {
              return;
            } else {
              L1: {
                if (null != ((sf) this).field_b) {
                  ((sf) this).field_b.setCursor((java.awt.Cursor) null);
