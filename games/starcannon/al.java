...
final class al extends df {
    ...
    final int c() {
        return ((al) this).field_v - (((al) this).field_w.available() >> (field_l ? 2 : 1));
    }

    final void f() {
        if (((al) this).field_w != null) {
            ((al) this).field_w.close();
    ...
    final void e() {
        try {
            ...
            for (var2 = 0; var2 < var1; var2++) {
                var3 = ((al) this).field_o[var2];
                if ((var3 + 8388608 & -16777216) != 0) {
                    var3 = 8388607 ^ var3 >> 31;
                }
                ((al) this).field_x[var2 * 2] = (byte)(var3 >> 8);
                ((al) this).field_x[var2 * 2 + 1] = (byte)(var3 >> 16);
            }
            int discarded$0 = ((al) this).field_w.write(((al) this).field_x, 0, var1 << 1);
