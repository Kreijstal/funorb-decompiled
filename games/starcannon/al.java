...
final class al extends df {
    ...
    final int c() {
        return this.field_v - (this.field_w.available() >> (field_l ? 2 : 1));
    }
    ...
    final void a(int param0) throws javax.sound.sampled.LineUnavailableException {
        ...
        try {
            var2 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, this.field_y, param0 << (field_l ? 2 : 1));
    ...
    final void a(java.awt.Component param0) {
        ...
        ((al) (this)).field_x = new byte[stackIn_16_1 << stackIn_16_2];
    }
