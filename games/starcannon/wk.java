...
final class wk implements java.awt.event.MouseListener, java.awt.event.MouseMotionListener, java.awt.event.FocusListener {
    ...
    final static void a(java.awt.Component param0) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("wk.D(");
          ...
          throw sd.a((Throwable) (Object) stackIn_5_0, stackIn_5_2 + 44 + -64 + 41);
        }
    }
    ...
    final static void a(int param0, rb param1, ka param2) {
        try {
            ...
            try {
              L0: {
                var18 = (Object) (Object) new va();
                ((va) var18).field_n = param1.j(7909);
                ((va) var18).field_k = param1.f((byte) -79);
                ((va) var18).field_r = new int[((va) var18).field_n];
                ((va) var18).field_i = new bk[((va) var18).field_n];
                ((va) var18).field_l = new byte[((va) var18).field_n][][];
                ((va) var18).field_g = new int[((va) var18).field_n];
                ((va) var18).field_p = new bk[((va) var18).field_n];
                ((va) var18).field_q = new int[((va) var18).field_n];
                var5 = 0;
                L1: while (true) {
                  if (var5 >= ((va) var18).field_n) {
                    ee.field_a.b(84, (rf) var18);
                    break L0;
                  } else {
                    try {
                      L2: {
              ...
              L16: {
                ...
                stackOut_36_1 = new StringBuilder().append("wk.A(").append(param0).append(44);
              ...
              throw sd.a((Throwable) (Object) stackIn_42_0, stackIn_42_2 + 44 + 0 + 41);
            }
