    ...
    final static int a(boolean param0, int param1, String param2, String param3, int param4, String param5, byte param6) {
        ...
        try {
          L0: {
            ...
            var8 = new ma(param5);
            if (param6 == -3) {
              stackOut_3_0 = bf.a(param4, param0, param3, (byte) 6, var8, var7, param1);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("fi.H(").append(param0).append(',').append(param1).append(',');
          ...
          throw sd.a((Throwable) ((Object) stackIn_14_0), stackIn_14_2 + ',' + param6 + ')');
        }
