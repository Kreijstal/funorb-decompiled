...
final class eg implements de {
    ...
    final static void a(java.awt.Frame param0, byte param1, ka param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("eg.D(");
    ...
    final static ed a(int param0, int param1, c param2) {
        ...
        try {
          L0: {
            if (param0 == 29723) {
              stackOut_3_0 = new ed(param2, param1 * df.field_n / 1000);
          ...
          L0: {
            ...
            L4: {
              ...
              if (this.field_k == null) {
                ...
                discarded$1 = this.field_k.a(param4.field_k, var14 + param4.field_s + param0, this.field_e + param4.field_j + param3, -this.field_d + (-var14 + param4.field_i), param4.field_f - (this.field_d << -2004493151), this.field_c, this.field_m, 1, 1, 0);
                break L4;
              }
            }
            break L0;
