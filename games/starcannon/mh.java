    ...
    final p a(String param0, int param1) {
        ...
        try {
          L0: {
            L1: {
              if (param1 == -26188) {
                ...
                var4 = null;
                String discarded$2 = ((mh) this).a((String) null, true);
                break L1;
              }
            }
            L2: {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("mh.B(");
    ...
    final static StringBuilder a(int param0, char param1, StringBuilder param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("mh.C(").append(0).append(',').append(' ').append(',');
          ...
          throw sd.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + ',' + 31917 + ')');
        }
        return stackIn_4_0;
    }
