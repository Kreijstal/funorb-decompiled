...
final class h {
    ...
    private final float a(int param0, int param1, float param2) {
        float var4 = (float)((h) this).field_g[param0][0][param1] + param2 * (float)(((h) this).field_g[param0][1][param1] - ((h) this).field_g[param0][0][param1]);
    ...
    final void a(rb param0, mk param1) {
        ...
        L0: {
          var3 = param0.j(7909);
          ((h) this).field_d[0] = var3 >> 4;
          ((h) this).field_d[1] = var3 & 15;
          if (var3 == 0) {
            var11 = ((h) this).field_c;
            ((h) this).field_c[1] = 0;
            var11[0] = 0;
            break L0;
          } else {
            ((h) this).field_c[0] = param0.i(-1174051992);
            ((h) this).field_c[1] = param0.i(-1174051992);
            var4 = param0.j(7909);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                  ...
                  if (var5 >= 2) {
                    L3: {
                      if (var4 != 0) {
                        ...
                        if (((h) this).field_c[1] == ((h) this).field_c[0]) {
                          break L0;
                        } else {
                          break L3;
                        }
                    ...
                    var6 = var7;
                    L4: while (true) {
                      if (var7 >= ((h) this).field_d[var5]) {
                        var5++;
                        continue L2;
                      } else {
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ((h) this).field_h[var5][1][var7] = ((h) this).field_h[var5][0][var7];
                          ((h) this).field_g[var5][1][var7] = ((h) this).field_g[var5][0][var7];
                          var7++;
                          continue L4;
                        } else {
                          ((h) this).field_h[var5][1][var7] = param0.i(-1174051992);
                          ((h) this).field_g[var5][1][var7] = param0.i(-1174051992);
                          var7++;
                          continue L4;
                        }
                      }
                ...
                var6 = 0;
                L5: while (true) {
                  if (var6 >= ((h) this).field_d[var5]) {
                    var5++;
                    continue L1;
                  } else {
                    ((h) this).field_h[var5][0][var6] = param0.i(-1174051992);
                    ((h) this).field_g[var5][0][var6] = param0.i(-1174051992);
                    var6++;
                    continue L5;
                  }
                }
    ...
    private final float b(int param0, int param1, float param2) {
        float var4 = (float)((h) this).field_h[param0][0][param1] + param2 * (float)(((h) this).field_h[param0][1][param1] - ((h) this).field_h[param0][0][param1]);
        var4 = var4 * 0.0001220703125f;
        return h.a(var4);
    }

    h() {
        ((h) this).field_h = new int[2][2][4];
        ((h) this).field_c = new int[2];
        ((h) this).field_d = new int[2];
        ((h) this).field_g = new int[2][2][4];
    }
    ...
    final int a(int param0, float param1) {
        ...
        L0: {
          if (param0 != 0) {
            ...
            var3 = (float)((h) this).field_c[0] + (float)(((h) this).field_c[1] - ((h) this).field_c[0]) * param1;
        ...
        if (((h) this).field_d[param0] != 0) {
          ...
          L1: while (true) {
            if (var4 >= ((h) this).field_d[param0]) {
              ...
              var4 = 0;
              L4: while (true) {
                if (var4 >= ((h) this).field_d[param0] * 2) {
                  return ((h) this).field_d[param0] * 2;
                } else {
