...
final class lf extends kc {
    ...
    lf(tc param0, String param1) {
        ...
        if (null != ((lf) this).field_X) {
            var3 = tk.field_a.a(((lf) this).field_X, 260, tk.field_a.field_p);
            ((lf) this).b(300, (byte) 57, var3 + 150);
        }
    ...
    final void c(int param0, byte param1, int param2) {
        ...
        tk.field_a.b(((lf) this).field_db, param0 - -(((lf) this).field_i >> 1073291777), param2 + 103, 16777215, -1);
        if (null != ((lf) this).field_X) {
