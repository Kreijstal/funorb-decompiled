        ...
        try {
            ...
            L0: {
              if (param1 == 95) {
                ...
                var3 = (kh) null;
                discarded$2 = nf.a(true, (String) null, (String) null, 96, (String) null, 67, (kh) null);
                break L0;
              }
            }
            L1: {
          ...
          if (8 <= var2) {
            ...
            L1: while (true) {
              if (var2 >= 8) {
                ...
                this.field_n[var2] = this.field_a[var2];
                this.field_m[var2] = ba.a(this.field_c[var2], this.field_a[var2]);
                var2++;
                continue L1;
              }
            }
    ...
    final static boolean a(boolean param0, String param1, String param2, int param3, String param4, int param5, kh param6) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("nf.C(").append(param0).append(',');
