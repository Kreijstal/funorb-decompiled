...
final class sg {
    ...
    private final void a(int param0, int param1, String param2, int param3) {
        ...
        try {
          L0: {
            ...
            discarded$1 = this.field_l.a(param2, var12 - -this.field_r, var13 - -this.field_u, var9, var10, this.field_a, -1, 0, 0, var7);
            break L0;
          }
    ...
    private final void a(int param0, boolean param1, String param2, int param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("sg.D(").append(param0).append(',').append(param1).append(',');
    ...
    final void a(byte param0, qe param1) {
        il discarded$10 = null;
        il discarded$11 = null;
        il discarded$12 = null;
        il discarded$13 = null;
        il discarded$14 = null;
        il discarded$15 = null;
        eg discarded$16 = null;
        ci discarded$17 = null;
        il discarded$18 = null;
        il discarded$19 = null;
        ...
        try {
          L0: {
            ...
            this.field_b = -1;
            this.field_r = 3;
            discarded$10 = var4.a(0, (byte) -76).c(15658734, 2).a(el.b(10066329, 22396, 7829367, 8947848), (byte) -74);
            discarded$11 = var4.a(1, (byte) -76).a(el.b(10066329, 22396, 13421772, 11184810), (byte) -74);
            discarded$12 = var4.a(3, (byte) -76).a(el.b(7829367, 22396, 10066329, 8947848), (byte) -74).b(1, -86).a(256, 1);
            var5 = new hl[9];
            var17 = new pj(32, 32);
            var19 = var17;
            var7_int = 0;
            L2: while (true) {
              if (var7_int >= var19.field_B.length) {
                ...
                discarded$13 = var4.a(4, (byte) -76).a(-38, true).a(var5, (byte) -74);
                discarded$14 = var4.a(5, (byte) -76).a(ab.b(0, -25343, 0, 0, 65793), (byte) -74).a(-52, true).c(-1, 2);
                ...
                discarded$15 = var7.a(1, (byte) -76).a(gi.a(4477, 11184810), (byte) -74).c(2236962, 2);
                this.field_p = (de) ((Object) new ni(param1, 2, 2, 16777215, -1, 5, 5, 15, 15, 4473924));
                discarded$16 = new eg(param1, 2, 2, 16777215, -1, 16777215, 16729156, 4473924);
                discarded$17 = new ci(param1, 16777215, -1, 125269879, 4473924, 3, 268435455);
                var8 = new w();
                var18.a(-121, var8);
                discarded$18 = var8.a(0, (byte) -76).a(el.b(7829367, 22396, 10066329, 15658734), (byte) -74).c(1118481, 2).a((byte) -104, -1);
                discarded$19 = var8.a(4, (byte) -76).a(-120, true).a(var5, (byte) -74);
