...
class hl extends ui {
    ...
    void b(int param0, int param1) {
        ...
        param1 = param1 + (this.field_q - this.field_v - this.field_y);
        int var3 = param0 + (param1 + this.field_v - 1) * ki.field_j;
        int var4 = 0;
        int var5 = this.field_v;
        int var6 = this.field_u;
        int var7 = -ki.field_j - var6;
        int var8 = 0;
        ...
        if (var6 > 0) {
            ...
            hl.c(ki.field_a, this.field_B, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final void f() {
        int var2 = 0;
        int var3 = 0;
        if (this.field_u == this.field_x && this.field_v == this.field_q) {
            return;
        }
        int[] var1 = new int[this.field_x * this.field_q];
        for (var2 = 0; var2 < this.field_v; var2++) {
            for (var3 = 0; var3 < this.field_u; var3++) {
                var1[(var2 + this.field_y) * this.field_x + (var3 + this.field_w)] = this.field_B[var2 * this.field_u + var3];
            }
        }
        this.field_B = var1;
    ...
    void e(int param0, int param1, int param2) {
        ...
        int var4 = param0 + param1 * ki.field_j;
        int var5 = 0;
        int var6 = this.field_v;
        int var7 = this.field_u;
        int var8 = ki.field_j - var7;
        int var9 = 0;
        if (param1 < ki.field_e) {
        ...
        if (var7 > 0) {
            ...
            hl.c(ki.field_a, this.field_B, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    void a(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            hl.b(ki.field_a, this.field_B, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    final hl g() {
        int var2 = 0;
        int var3 = 0;
        hl var1 = new hl(this.field_u, this.field_v);
        var1.field_x = this.field_x;
        var1.field_q = this.field_q;
        var1.field_w = this.field_x - this.field_u - this.field_w;
        var1.field_y = this.field_y;
        for (var2 = 0; var2 < this.field_v; var2++) {
            for (var3 = 0; var3 < this.field_u; var3++) {
                var1.field_B[var2 * this.field_u + var3] = this.field_B[var2 * this.field_u + this.field_u - 1 - var3];
            }
        }
        return var1;
    }
    ...
    final void e() {
        ki.a(this.field_B, this.field_u, this.field_v);
    }
        ...
        L0: {
          if (param2 > this.field_x) {
            ...
            if (param3 <= this.field_q) {
              L1: {
                var5 = param0 + this.field_w * param2 / this.field_x;
                var6 = param0 + ((this.field_w + this.field_u) * param2 + this.field_x - 1) / this.field_x;
                var7 = param1 + this.field_y * param3 / this.field_q;
                var8 = param1 + ((this.field_y + this.field_v) * param3 + this.field_q - 1) / this.field_q;
                if (var5 >= ki.field_l) {
                  break L1;
                } else {
                  var5 = ki.field_l;
                    ...
                    if (var11 >= var8) {
                      ...
                      L6: while (true) {
                        if (var12 >= var6) {
                          ...
                          var15 = var13 * this.field_x / param2 - (this.field_w << 4);
                          var16 = (var13 + 16) * this.field_x / param2 - (this.field_w << 4);
                          var17 = var14 * this.field_q / param3 - (this.field_y << 4);
                          var18 = (var14 + 16) * this.field_q / param3 - (this.field_y << 4);
                          ...
                          if (var19 != 0) {
                            ...
                            L10: {
                              if (var18 <= this.field_v << 4) {
                                break L10;
                              } else {
                                var18 = this.field_v << 4;
                                break L10;
                              }
                            }
                            var16--;
                              ...
                              if (var28 > var18) {
                                ...
                                L15: while (true) {
                                  if (var30 > var16) {
                                    ...
                                    var31 = this.field_B[var28 * this.field_u + var30];
                                    if (var31 != 0) {
                                      L16: {
                                        var32 = var29;
                                        if (var30 != var15) {
    ...
    void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          L0: {
            ...
            var15 = -param0 * var10 + ((this.field_v << 4) - param1) * var9;
            var16 = --param0 * var9 + ((this.field_v << 4) - param1) * var10;
            var17 = ((this.field_u << 4) - param0) * var10 + ((this.field_v << 4) - param1) * var9;
            var18 = -((this.field_u << 4) - param0) * var9 + ((this.field_v << 4) - param1) * var10;
            if (var11 >= var13) {
              var19 = var13;
              var20 = var11;
              break L0;
                      ...
                      if (var26 >= 0) {
                        ...
                        L15: while (true) {
                          if (var33 >= 0) {
                            ...
                            L19: {
                              var32 = (1 + var36 - (this.field_v << 12) - var26) / var26;
                              if ((1 + var36 - (this.field_v << 12) - var26) / var26 <= var37) {
                                break L19;
                              } else {
                                var37 = var32;
                                break L19;
                            ...
                            L20: while (true) {
                              if (var37 >= 0) {
                                ...
                                L21: {
                                  var38 = this.field_B[(var36 >> 12) * this.field_u + (var35 >> 12)];
                                  if (var38 == 0) {
                                    var34++;
                                    break L21;
                                  } else {
                                    ...
                                    var34++;
                                    ki.field_a[incrementValue$0] = var38;
                                    break L21;
                                  }
                                }
                                var35 = var35 + var27;
                        ...
                        L22: while (true) {
                          if (var33 >= 0) {
                            ...
                            L25: {
                              var32 = var36 - (this.field_v << 12);
                              if (var36 - (this.field_v << 12) < 0) {
                                break L25;
                              } else {
                              ...
                              if (var37 >= 0) {
                                ...
                                L28: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    ki.field_a[incrementValue$1] = var38;
                                    break L28;
                                  }
                                }
                                var35 = var35 + var27;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L34: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        ki.field_a[incrementValue$2] = var38;
                                        break L34;
                                      }
                                    }
                                    var35 = var35 + var27;
                              ...
                              if (var37 >= 0) {
                                ...
                                L41: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    ki.field_a[incrementValue$3] = var38;
                                    break L41;
                                  }
                                }
                                var35 = var35 + var27;
                              ...
                              if (var37 >= 0) {
                                ...
                                L48: {
                                  ...
                                  if (var38 == 0) {
                                    ...
                                    var34++;
                                    ki.field_a[incrementValue$4] = var38;
                                    break L48;
                                  }
                                }
                                var35 = var35 + var27;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L54: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        ki.field_a[incrementValue$5] = var38;
                                        break L54;
                                      }
                                    }
                                    var35 = var35 + var27;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L60: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        ki.field_a[incrementValue$6] = var38;
                                        break L60;
                                      }
                                    }
                                    var36 = var36 + var26;
                                  ...
                                  if (var37 >= 0) {
                                    ...
                                    L66: {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        ki.field_a[incrementValue$7] = var38;
                                        break L66;
                                      }
                                    }
                                    var36 = var36 + var26;
                                  ...
                                  L69: while (true) {
                                    if (var37 >= 0) {
                                      ...
                                      if (var38 == 0) {
                                        ...
                                        var34++;
                                        ki.field_a[incrementValue$8] = var38;
                                        var37++;
                                        continue L69;
                                      }
                                    }
    ...
    void c(int param0, int param1) {
        ...
        L0: {
          ...
          if (param0 >= ki.field_l) {
            ...
            stackIn_3_0 = ki.field_l - param0 << 2;
            break L0;
          }
        }
        L1: {
          ...
          if (param0 + var3 <= ki.field_g) {
            stackIn_6_0 = this.field_u - 4;
            break L1;
          } else {
            stackIn_6_0 = (ki.field_g - param0 << 2) - 4;
            break L1;
          }
        }
        L2: {
          ...
          if (param1 >= ki.field_e) {
            ...
            stackIn_9_0 = ki.field_e - param1 << 2;
            break L2;
          }
        }
        L3: {
          ...
          if (param1 + var4 <= ki.field_i) {
            ...
            stackIn_12_0 = (ki.field_i - param1 << 2) - 4;
            break L3;
          }
        }
        var8 = stackIn_12_0;
                  ...
                  if (var16 >= 4) {
                    ...
                    L7: while (true) {
                      if (var17 >= 4) {
                        ...
                        L8: {
                          var13 = this.field_B[var10 + var16 * this.field_u + var17];
                          if (var13 != 0) {
                            break L8;
                          } else {
          ...
          if (param2 >= this.field_v - 1) {
            ...
            L5: {
              if (param1 < 0) {
                ...
                L6: {
                  var9 = this.field_B[var6 + this.field_u];
                  if (var9 == 0) {
                    stackIn_19_0 = 0;
                    break L6;
                  } else {
            ...
            if (param1 >= this.field_u - 1) {
              ...
              L7: {
                var10 = this.field_B[var6 + this.field_u + 1];
                if (var10 == 0) {
                  stackIn_25_0 = 0;
                  break L7;
                } else {
    ...
    void c(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            hl.a(ki.field_a, this.field_B, 0, var5, var4, 0, 0, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            hl.a(ki.field_a, this.field_B, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
            return;
        }
    }
    ...
    final void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 > 0) {
            ...
            if (param4 == 256) {
                hl.a(0, 0, 0, var8, this.field_B, ki.field_a, 0, 0, -param3, var9, var14, var15, param2, var12, var13, var6);
            } else {
                hl.a(0, 0, 0, var8, this.field_B, ki.field_a, 0, 0, -param3, var9, var14, var15, param2, var12, var13, var6, param4);
            }
            return;
        }
    }
    ...
    void a(int param0, int param1, int param2, int param3) {
        ...
        if (param2 > 0) {
            ...
            hl.b(ki.field_a, this.field_B, 0, var7, var8, var13, var14, param2, param3, var11, var12, var5);
            return;
        }
    }

    void a(int param0, int param1) {
        param0 = param0 + (this.field_w >> 1);
        param1 = param1 + (this.field_y >> 1);
        int var3 = param0 < ki.field_l ? ki.field_l - param0 << 1 : 0;
        int var4 = param0 + (this.field_u >> 1) > ki.field_g ? ki.field_g - param0 << 1 : this.field_u;
        int var5 = param1 < ki.field_e ? ki.field_e - param1 << 1 : 0;
        int var6 = param1 + (this.field_v >> 1) > ki.field_i ? ki.field_i - param1 << 1 : this.field_v;
        hl.a(this.field_B, var5 * this.field_u + var3, (param1 + (var5 >> 1)) * ki.field_j + (param0 + (var3 >> 1)), (this.field_u << 1) - (var4 - var3) + (this.field_u & 1), ki.field_j - (var4 - var3 >> 1), this.field_u, var4 - var3 >> 1, var6 - var5 >> 1);
    }
    ...
    final void b(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            hl.a(ki.field_a, this.field_B, param2, var5, var4, var7, var6, var8, var9);
            return;
        }
    }
    ...
    void d(int param0, int param1) {
        ...
        param0 = param0 + this.field_w;
        param1 = param1 + this.field_y;
        int var3 = param0 + param1 * ki.field_j;
        int var4 = 0;
        int var5 = this.field_v;
        int var6 = this.field_u;
        int var7 = ki.field_j - var6;
        ...
        if (var6 > 0) {
            ...
            hl.a(ki.field_a, this.field_B, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
                ...
                if (var3 < 0) {
                  ...
                  L8: while (true) {
                    if (var4 > var1) {
                      ...
                      if (this.field_B[var4 * this.field_u + var3] == 0) {
                        var4++;
                        continue L8;
                      } else {
                        break L7;
              ...
              L9: while (true) {
                  ...
                  if (var4 >= var3) {
                    ...
                    L11: while (true) {
                      if (var5 > var1) {
                        ...
                        if (this.field_B[var5 * this.field_u + var4] == 0) {
                          var5++;
                          continue L11;
                        } else {
                          break L10;
                ...
                L13: while (true) {
                  if (var8 >= var6) {
                    ...
                    this.field_u = var5;
                    this.field_v = var6;
                    this.field_w = this.field_w + var4;
                    this.field_y = this.field_y + var2;
                    return;
                  } else {
                    var9 = 0;
                    L14: while (true) {
                      if (var9 >= var5) {
                        ...
                        var7[var8 * var5 + var9] = this.field_B[(var8 + var2) * this.field_u + (var9 + var4)];
                        var9++;
                        continue L14;
                      }
                    }
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                param2++;
                ki.field_a[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
    ...
    final void f(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            hl.a(0, ki.field_a, this.field_B, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    void g(int param0, int param1) {
        int var9 = 0;
        param0 = param0 + (this.field_x - this.field_u - this.field_w);
        param1 = param1 + this.field_y;
        int var3 = param0 + param1 * ki.field_j;
        int var4 = this.field_u - 1;
        int var5 = this.field_v;
        int var6 = this.field_u;
        int var7 = ki.field_j - var6;
        int var8 = var6 + var6;
        ...
        if (var6 > 0) {
            ...
            hl.b(ki.field_a, this.field_B, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final boolean c(int param0, int param1, int param2, int param3) {
        ...
        if (param2 < 0 || param2 >= this.field_u) {
            return false;
        }
        ...
        return this.field_B[param3 * this.field_u + param2] != 0 ? true : false;
    }
    ...
    final void a() {
        ...
        int incrementValue$0 = 0;
        int var3 = 0;
        int[] var1 = new int[this.field_u * this.field_v];
        int var2 = 0;
        for (var3 = 0; var3 < this.field_u; var3++) {
            for (var4 = this.field_v - 1; var4 >= 0; var4--) {
                incrementValue$0 = var2;
                var2++;
                var1[incrementValue$0] = this.field_B[var3 + var4 * this.field_u];
            }
        }
        this.field_B = var1;
        var3 = this.field_y;
        this.field_y = this.field_w;
        this.field_w = this.field_q - this.field_v - var3;
        var3 = this.field_v;
        this.field_v = this.field_u;
        this.field_u = var3;
        var3 = this.field_q;
        this.field_q = this.field_x;
        this.field_x = var3;
    }
    ...
    void d(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            hl.a(ki.field_a, this.field_B, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    final void b() {
        ...
        this.field_y = this.field_x - this.field_u - var3;
        var3 = this.field_v;
        this.field_v = this.field_u;
        this.field_u = var3;
        var3 = this.field_q;
    ...
    void f(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            if (param2 == 256) {
                hl.a(0, 0, 0, ki.field_a, this.field_B, var5, 0, var4, 0, var7, var6, var8, var9);
            } else {
                hl.a(0, 0, 0, ki.field_a, this.field_B, var5, 0, var4, 0, var7, var6, var8, var9, param2);
            }
            return;
        }
    }
    ...
    hl(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            var4.waitForAll();
            this.field_u = var3.getWidth((java.awt.image.ImageObserver) ((Object) param1));
            this.field_v = var3.getHeight((java.awt.image.ImageObserver) ((Object) param1));
            this.field_x = this.field_u;
            this.field_q = this.field_v;
            this.field_w = 0;
            this.field_y = 0;
            this.field_B = new int[this.field_u * this.field_v];
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_u, this.field_v, this.field_B, 0, this.field_u);
            var5.grabPixels();
            break L0;
          }
