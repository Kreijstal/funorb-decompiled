...
abstract class ag extends th {
        ...
        try {
            ...
            try {
              ...
              L5: {
                ...
                stackIn_10_1 = new StringBuilder().append("ag.FB(").append(param0).append(',');
                              ...
                              if ((var2 ^ -1) == -7) {
                                ...
                                if (var2 != 7) {
                                  if (8 != var2) {
                                    ...
                                    wk.a(il.field_g, se.field_p, nb.field_e, false);
                                    break L1;
                                  }
                                } else {
                                  this.g((byte) -47);
            ...
            if (0 != qb.field_j) {
              if (-11 < (rk.field_d ^ -1)) {
                if (qb.field_j != 3) {
                  if (-5 != (qb.field_j ^ -1)) {
                    if ((qb.field_j ^ -1) == -3) {
                      this.a("js5connect_full", false);
                      break L10;
                    } else {
                      if (qb.field_j != 5) {
                        this.a("js5connect", false);
                        break L10;
                      } else {
                        this.a("outofdate", false);
                        break L10;
                      }
                    }
                  } else {
            ...
            if (!kb.a(li.field_b, fk.field_k, (byte) 107, bf.field_y)) {
              ...
              if (!pa.a(li.field_b, -206)) {
                ...
                L22: {
                  ...
                  L24: {
                    stackIn_104_0 = qb.field_g;

                    if (vj.field_X) {
                      stackIn_105_0 = (String) ((Object) stackIn_104_0);
                      stackIn_105_1 = 0;
                      break L24;
                    } else {
                      stackIn_105_0 = (String) ((Object) stackIn_104_0);
                  ...
                  L25: {
                    ...
                    if (vj.field_X) {
                      stackIn_105_0 = (String) ((Object) stackIn_105_0);
                  ...
                  ae.a(stackIn_105_0, stackIn_105_1 != 0, stackIn_108_2, stackIn_108_3 != 0);
                  break L22;
                }
                L26: {
                  if (!cc.field_l) {
    ...
    final void a(int param0, int param1, int param2, int param3, boolean param4, int param5, boolean param6, int param7) {
        ...
        vg.field_b = this.field_n;
        jh.a(vg.field_b, param4);
        le.a(this.field_u, vg.field_b, 5000, nb.field_e, param6, 22692, this.field_l, this.field_s, this.field_w, this.field_v, this.field_p, 5000, param0, this.field_q);
        hj.a(vg.field_b, this.field_p, nb.field_e, this.field_q, 78, this.field_w, param0, this.field_u, this.field_v);
        ge.b(4039);
            ...
            if (0 != var4) {
              ...
              L2: {
                if (-3 != (var4 ^ -1)) {
                  ...
                  var5_int = fi.a(kk.b((byte) 123), this.field_x, ff.g(111), hc.a((byte) 96), dg.b((byte) -18), we.a(29084), (byte) -3);
                  if ((var5_int ^ -1) == 0) {
                    break L2;
                  } else {
              ...
              L3: {
                if (-4 == (var4 ^ -1)) {
                  ...
                  if (param1) {
                    ...
                    var5_int = qc.a(hc.a((byte) 117), this.field_r, this.field_x, false, -1, ff.g(9));
                    if (0 != (var5_int ^ -1)) {
                      if (var5_int != 0) {
                    ...
                    L15: {
                      L16: {
                        if (null != qa.field_b) {
                          ...
                          qa.field_b = new gg(nb.field_e, new java.net.URL(this.getCodeBase(), "countrylist.ws"), 5000);
                          break L16;
                        }
                      }
                      L17: {
    ...
    final void f(byte param0) {
        ...
        L0: {
          ...
          if (ai.a((byte) -21)) {
            ...
            discarded$33 = this.a(stackIn_10_1, stackIn_10_2 != 0, stackIn_10_3 != 0);
            break L0;
          } else {
            if ((rk.field_d ^ -1) > -11) {
              break L0;
              ...
              if (!m.a(-35)) {
                ...
                if (bl.field_a != 0) {
                  ...
                  discarded$34 = this.a(11, false, false);
                  break L0;
                }
              }
            }
    ...
    private final int m(int param0) {
        ...
        if (this.field_b) {
          ...
          if (se.b((byte) -91)) {
            if (!fi.field_h) {
              var2 = qc.a(hc.a((byte) 108), this.field_r, this.field_x, true, -1, ff.g(114));
              if (var2 != -1) {
                L0: {
                  if (0 == var2) {
                    break L0;
    ...
    private final void a(int param0, String param1, int param2, int param3, byte param4) {
        ...
        try {
          L0: {
            try {
              L1: {
                if (this.d(57)) {
                  ...
                  L8: {
                    ...
                    if (var9 != null) {
                      this.field_x = Integer.parseInt(var9);
                      break L8;
                    } else {
                      break L8;
                    }
                  }
                  cc.field_l = Boolean.valueOf(this.getParameter("simplemode")).booleanValue();
                  this.a((byte) 126, param1, this.field_w, 32, param2, param3, param0);
                  decompiledRegionSelector0 = 1;
                  break L1;
                } else {
                  decompiledRegionSelector0 = 0;
              ...
              L9: {
                ...
                var10 = (String) null;
                hc.a((Throwable) ((Object) var6_ref), (String) null, (byte) 100);
                this.a("crash", false);
                decompiledRegionSelector0 = 1;
                break L9;
              }
          ...
          L10: {
            ...
            stackIn_26_1 = new StringBuilder().append("ag.PA(").append(param0).append(',');
          ...
          throw sd.a((Throwable) ((Object) stackIn_27_0), stackIn_27_2 + ',' + param2 + ',' + param3 + ',' + param4 + ')');
        }
