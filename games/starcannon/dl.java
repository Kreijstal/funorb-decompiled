...
final class dl {
    ...
    final int a(byte param0, int param1) {
        ...
        int var5 = 0;
        int var6 = 0;
        var3 = -1 + (((dl) this).field_e.length >> 1);
    ...
    final static lh a(ja param0, byte param1, String param2, String param3, ue param4) {
        ...
        try {
          L0: {
            ...
            stackOut_0_0 = qd.a(var5_int, var6, param0, (byte) 108, param4);
    ...
    final static void a(byte param0, String[] param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("dl.C(").append(-12).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    dl(int[] param0) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var2_int > (param0.length >> 1) + param0.length) {
                ((dl) this).field_e = new int[var2_int + var2_int];
                var3 = 0;
                L2: while (true) {
                  if (var2_int - -var2_int <= var3) {
                    ...
                    L3: while (true) {
                      if (var3 >= param0.length) {
                        ...
                        L4: while (true) {
                          if (-1 == ((dl) this).field_e[var4 + var4 - -1]) {
          ...
          L5: {
            ...
            stackOut_14_1 = new StringBuilder().append("dl.<init>(");
