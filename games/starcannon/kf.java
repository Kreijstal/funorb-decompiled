...
abstract class kf extends uj implements ch {
    ...
    final void a(int param0, int param1, byte param2, int param3, int param4) {
        ...
        if (param2 <= 115) {
            ...
            discarded$0 = this.a((Hashtable) null, (StringBuilder) null, (byte) -25, 62);
        }
    ...
    private final boolean c(int param0, uj param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("kf.BB(").append(param0).append(',');
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
    ...
    final void a(Hashtable param0, int param1, int param2, StringBuilder param3) {
        ...
        try {
          L0: {
            L1: {
              discarded$33 = param3.append('\n');
              if (param2 == -349) {
                break L1;
              } else {
                var6 = (uj) null;
                discarded$34 = this.a(-87, -65, -10, 79, (uj) null, 82, 123);
                break L1;
              }
            }
            var5_int = 0;
            L2: while (true) {
              if (var5_int > param1) {
                L3: {
                  if (null != this.field_t) {
                    discarded$35 = this.field_t.a(param0, param3, (byte) 39, 1 + param1);
                    break L3;
                  } else {
                    discarded$36 = param3.append("null");
                    break L3;
                  }
                }
                break L0;
              } else {
                discarded$37 = param3.append(' ');
                var5_int++;
                continue L2;
              }
            }
    ...
    final boolean a(int param0, uj param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("kf.PA(").append(param0).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    final boolean a(int param0, int param1, int param2, int param3, uj param4, int param5, int param6) {
        ...
        try {
          ...
          L4: {
            var8 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) (var8);
            stackOut_8_1 = new StringBuilder().append("kf.AB(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    void a(int param0, int param1, int param2, uj param3, byte param4, int param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_5_1 = new StringBuilder().append("kf.OA(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_7_0 = stackOut_5_0;
    ...
    private final boolean b(int param0, uj param1) {
        ...
        try {
          ...
          L4: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) (var3);
            stackOut_8_1 = new StringBuilder().append("kf.GB(").append(param0).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    void a(int param0, int param1, uj param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("kf.U(").append(param0).append(',').append(param1).append(',');
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
