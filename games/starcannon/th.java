                ...
                try {
                  L1: {
                    if (null != ic.field_b) {
                      ...
                      dupTemp$1 = new ka(param3, param1, param6, true);
            ...
            try {
              L0: {
                if (!this.field_b) {
                  ...
                  try {
                    L1: {
                      discarded$1 = mb.a(ll.b(104), "loggedout", true);
                      break L1;
                    }
                  } catch (java.lang.Throwable decompiledCaughtParameter0) {
                    decompiledCaughtException = decompiledCaughtParameter0;
                        ...
                        L20: {
                          L21: {
                            if (0L == ci.field_b) {
                              ...
                              stackOut_92_0 = ((dd.b(72) ^ -1L) < (ci.field_b ^ -1L) ? -1 : ((dd.b(72) ^ -1L) == (ci.field_b ^ -1L) ? 0 : 1));
                      ...
                      if (-1001L > (-nh.field_b + dd.b(82) ^ -1L)) {
                        L3: {
                          ...
                          if (var2_ref == null) {
                            ...
                            if ((var2_ref.width ^ -1) > (cg.field_b ^ -1)) {
                              break L2;
                            } else {
                              if ((var2_ref.height ^ -1) <= (ig.field_i ^ -1)) {
                                break L3;
                              } else {
                                break L2;
                              }
          ...
          L0: {
            ...
            L6: {
              L7: {
                ...
                discarded$6 = ((java.awt.Container) (var2)).add((java.awt.Component) ((Object) kj.field_E));
                kj.field_E.setSize(eh.field_n, ef.field_d);
                kj.field_E.setVisible(true);
                if (ic.field_d != var2) {
                  break L7;
