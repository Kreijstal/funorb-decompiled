...
final class f implements cj {
    ...
    public f() throws Exception {
        int var1 = 0;
        ((f) this).field_b = new com.ms.directX.DSBufferDesc[2];
        ((f) this).field_a = new com.ms.directX.DSCursors[2];
        ...
        for (var1 = 0; (var1 ^ -1) > -3; var1++) {
            ((f) this).field_b[var1] = new com.ms.directX.DSBufferDesc();
        }
        for (var1 = 0; (var1 ^ -1) > -3; var1++) {
            ((f) this).field_a[var1] = new com.ms.directX.DSCursors();
        }
    }
}
