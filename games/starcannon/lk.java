...
final class lk extends qe {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              lk.a(ki.field_a, ((lk) this).field_A[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  ki.field_a[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    lk(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        ...
        ((lk) this).field_A = new byte[256][];
        ((lk) this).field_A = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (ki.field_h == null) {
                  lk.a(ki.field_a, ((lk) this).field_A[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  lk.a(ki.field_a, ((lk) this).field_A[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, ki.field_h, ki.field_d);
                  break L5;
                }
              }
              return;
