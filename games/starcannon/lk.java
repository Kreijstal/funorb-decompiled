...
final class lk extends qe {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        lk.a(ki.field_a, this.field_A[param0], param5, var12, var9, param3, param4, var10, var11, param6);
    }
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19;
        int var20;
        var13 = param2 - ki.field_l;
        var14 = param3 - ki.field_e;
        var15 = var14;
        L0: while (true) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$0] == 0) {
                  ...
                  param8++;
                  ki.field_a[incrementValue$1] = param6;
                  var20++;
                  continue L3;
                }
              }
    ...
    lk(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (ki.field_h == null) {
                  lk.a(ki.field_a, this.field_A[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  lk.a(ki.field_a, this.field_A[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, ki.field_h, ki.field_d);
                  break L5;
                }
              }
              return;
