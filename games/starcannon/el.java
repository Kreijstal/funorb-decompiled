...
final class el extends dk {
    ...
    final static void a(gi param0, int param1, int param2) {
        try {
            ...
            throw sd.a((Throwable) (Object) runtimeException, "el.A(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ',' + param2 + ',' + true + ')');
        }
    }
    ...
    final static jk[] a(boolean param0, ka param1) {
        ...
        try {
          L0: {
            if (!param1.a((byte) -68)) {
              ...
              L1: while (true) {
                if (var7.field_b != 0) {
                  if (var7.field_b != 2) {
                    var11 = (int[]) var7.field_f;
                    var10 = var11;
                    var9 = var10;
                    var8 = var9;
                    var3 = var8;
                    var4 = new jk[var11.length >> 2];
                    var5 = 0;
                    L2: while (true) {
                      if (var4.length <= var5) {
                        stackOut_13_0 = (jk[]) var4;
          ...
          L3: {
            ...
            stackOut_15_1 = new StringBuilder().append("el.D(").append(false).append(',');
