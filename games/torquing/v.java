...
final class v {
    ...
    final v a(int param0, boolean param1) {
        ((v) this).field_e = param1 ? true : false;
        if (param0 >= -69) {
            ((v) this).field_c = -25;
            return (v) this;
        }
    ...
    final void a(int param0, byte param1, gm param2, v param3, int param4, se param5) {
        ...
        try {
          L0: {
            ...
            L2: {
              if (null == ((v) this).field_g) {
                ...
                param3.field_g = ((v) this).field_g;
                break L2;
              }
            }
            L3: {
              if (((v) this).field_k >= -1) {
                param3.field_k = ((v) this).field_k;
                break L3;
              } else {
                break L3;
              }
            ...
            if (param1 == 115) {
              L4: {
                if (((v) this).field_d != -2147483648) {
                  param3.field_d = ((v) this).field_d;
                  break L4;
                } else {
                  break L4;
                }
              ...
              L5: {
                if (((v) this).field_i != -2147483648) {
                  param3.field_i = ((v) this).field_i;
                  break L5;
                } else {
                  break L5;
                }
              ...
              L6: {
                if (-1 > ((v) this).field_c) {
                  ...
                  param3.field_c = ((v) this).field_c;
                  break L6;
                }
              }
              L7: {
                if (((v) this).field_h != -2147483648) {
                  param3.field_h = ((v) this).field_h;
                  break L7;
                } else {
                  break L7;
                }
              }
              if (null == ((v) this).field_f) {
                break L0;
              } else {
                param3.field_f = ((v) this).field_f;
                return;
              }
            } else {
              return;
          ...
          L8: {
            ...
            stackOut_24_1 = new StringBuilder().append("v.B(").append(param0).append(44).append(param1).append(44);
          ...
          L10: {
            ...
            stackOut_30_1 = ((StringBuilder) (Object) stackIn_30_1).append(stackIn_30_2).append(44).append(param4).append(44);
    ...
    final void a(byte param0, v param1) {
        try {
            param1.field_i = ((v) this).field_i;
            param1.field_e = ((v) this).field_e;
            param1.field_k = ((v) this).field_k;
            param1.field_c = ((v) this).field_c;
            param1.field_d = ((v) this).field_d;
            param1.field_g = ((v) this).field_g;
            param1.field_f = ((v) this).field_f;
            if (param0 > -84) {
                ((v) this).field_d = -106;
            }
            param1.field_h = ((v) this).field_h;
        } catch (RuntimeException runtimeException) {
            throw rb.a((Throwable) (Object) runtimeException, "v.E(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final v b(byte param0, int param1) {
        ...
        ((v) this).field_i = param1;
        return (v) this;
    }

    final v a(int param0, byte param1) {
        if (param1 != -113) {
            v discarded$0 = ((v) this).a(-26, true);
            ((v) this).field_h = param0;
            return (v) this;
        }
        ((v) this).field_h = param0;
        return (v) this;
    ...
    final v a(int param0, int param1) {
        ...
        if (param1 != -26249) {
          var4 = null;
          ((v) this).a(-73, (se) null, (gm) null, -90, (byte) 73);
    ...
    final void a(int param0, se param1, gm param2, int param3, byte param4) {
        ...
        int stackIn_23_2 = 0;
        int stackIn_23_3 = 0;
        uc stackIn_24_0 = null;
        String stackIn_24_1 = null;
        int stackIn_24_2 = 0;
        int stackIn_24_3 = 0;
        int stackIn_24_4 = 0;
        uc stackIn_25_0 = null;
        String stackIn_25_1 = null;
        int stackIn_25_2 = 0;
        int stackIn_25_3 = 0;
        int stackIn_25_4 = 0;
        uc stackIn_26_0 = null;
        String stackIn_26_1 = null;
        int stackIn_26_2 = 0;
        int stackIn_26_3 = 0;
        int stackIn_26_4 = 0;
        int stackIn_26_5 = 0;
        uc stackIn_27_0 = null;
        ...
        RuntimeException decompiledCaughtException = null;
        uc stackOut_20_0 = null;
        String stackOut_20_1 = null;
        int stackOut_20_2 = 0;
        uc stackOut_22_0 = null;
        String stackOut_22_1 = null;
        int stackOut_22_2 = 0;
        int stackOut_22_3 = 0;
        uc stackOut_21_0 = null;
        String stackOut_21_1 = null;
        int stackOut_21_2 = 0;
        int stackOut_21_3 = 0;
        uc stackOut_23_0 = null;
        String stackOut_23_1 = null;
        int stackOut_23_2 = 0;
        int stackOut_23_3 = 0;
        int stackOut_23_4 = 0;
        uc stackOut_25_0 = null;
        String stackOut_25_1 = null;
        int stackOut_25_2 = 0;
        int stackOut_25_3 = 0;
        int stackOut_25_4 = 0;
        int stackOut_25_5 = 0;
        uc stackOut_24_0 = null;
        String stackOut_24_1 = null;
        int stackOut_24_2 = 0;
        int stackOut_24_3 = 0;
        int stackOut_24_4 = 0;
        int stackOut_24_5 = 0;
        uc stackOut_26_0 = null;
        ...
        try {
          L0: {
            L1: {
              rh.a(param3 - -param2.field_w, param2.field_o, (byte) 71, param2.field_k + param0, param2.field_p, ((v) this).field_g);
              if (param4 >= 108) {
                break L1;
              } else {
                ((v) this).field_f = null;
            ...
            L2: {
              if (null != ((v) this).field_f) {
                L3: {
                  var6_int = param3 + (param2.field_w - -((v) this).field_h);
                  var7 = ((v) this).field_i + param2.field_k + param0;
                  if (param1.field_f == 1) {
                    var6_int = var6_int + (param2.field_p - ((v) this).field_f.field_w) / 2;
                    break L3;
                  } else {
                    break L3;
                  }
                ...
                L4: {
                  if (param1.field_g == 1) {
                    var7 = var7 + (param2.field_o + -((v) this).field_f.field_u) / 2;
                    break L4;
                  } else {
                    break L4;
                  }
                ...
                L5: {
                  if (param1.field_f == 2) {
                    var6_int = var6_int + (-((v) this).field_f.field_w + param2.field_p);
                    break L5;
                  } else {
                    break L5;
                  }
                ...
                L6: {
                  if (param1.field_g != 2) {
                    ...
                    var7 = var7 + (param2.field_o - ((v) this).field_f.field_u);
                    break L6;
                  }
                }
                ((v) this).field_f.d(var6_int, var7);
                break L2;
              } else {
                break L2;
              }
            ...
            L7: {
              var6_ref = param1.c((byte) 65, param2);
              if (var6_ref == null) {
                break L7;
              } else {
                if (null == param1.field_m) {
                  ...
                  if (0 <= ((v) this).field_k) {
                    L8: {
                      stackOut_20_0 = param1.field_m;
                      stackOut_20_1 = (String) var6_ref;
                      stackOut_20_2 = param2.field_w + param3 - -param1.field_k;
                      ...
                      if (((v) this).field_h != -2147483648) {
                        stackOut_22_0 = (uc) (Object) stackIn_22_0;
                        stackOut_22_1 = (String) (Object) stackIn_22_1;
                        stackOut_22_2 = stackIn_22_2;
                        stackOut_22_3 = ((v) this).field_h;
                        ...
                        stackOut_21_0 = (uc) (Object) stackIn_21_0;
                    ...
                    L9: {
                      stackOut_23_0 = (uc) (Object) stackIn_23_0;
                      stackOut_23_1 = (String) (Object) stackIn_23_1;
                      stackOut_23_2 = stackIn_23_2 + stackIn_23_3;
                      stackOut_23_3 = param1.field_p + param0;
                      stackOut_23_4 = param2.field_k;
                      ...
                      if (((v) this).field_i == -2147483648) {
                        stackOut_25_0 = (uc) (Object) stackIn_25_0;
                    ...
                    L10: {
                      stackOut_26_0 = (uc) (Object) stackIn_26_0;
                      stackOut_26_1 = (String) (Object) stackIn_26_1;
                      stackOut_26_2 = stackIn_26_2;
                      stackOut_26_3 = stackIn_26_3 + (stackIn_26_4 - -stackIn_26_5);
                      stackOut_26_4 = -param1.field_e + -param1.field_k + param2.field_p;
                      stackOut_26_5 = -param1.field_p + param2.field_o - param1.field_o;
                      stackOut_26_6 = ((v) this).field_k;
                      stackOut_26_7 = ((v) this).field_c;
                      ...
                      if (((v) this).field_d == -2147483648) {
                        stackOut_28_0 = (uc) (Object) stackIn_28_0;
                        ...
                        stackOut_27_0 = (uc) (Object) stackIn_27_0;
                    ...
                    int discarded$1 = ((uc) (Object) stackIn_29_0).a(stackIn_29_1, stackIn_29_2, stackIn_29_3, stackIn_29_4, stackIn_29_5, stackIn_29_6, stackIn_29_7, stackIn_29_8, param1.field_f, param1.field_g, param1.field_a);
                    break L7;
                  } else {
                    return;
                  }
          ...
          L11: {
            ...
            stackOut_31_1 = new StringBuilder().append("v.H(").append(param0).append(44);
            stackIn_33_0 = stackOut_31_0;
            stackIn_33_1 = stackOut_31_1;
          ...
          throw rb.a((Throwable) (Object) stackIn_37_0, stackIn_37_2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    final v a(byte param0, int param1) {
        if (param0 < 90) {
            v discarded$0 = ((v) this).a(-70, true);
            ((v) this).field_k = param1;
            return (v) this;
        }
        ((v) this).field_k = param1;
        return (v) this;
    ...
    final v a(int param0, t[] param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("v.J(").append(param0).append(44);
    ...
    v() {
        ((v) this).field_f = null;
        ((v) this).field_k = -2;
        ((v) this).field_h = -2147483648;
        ((v) this).field_c = -2;
        ((v) this).field_g = null;
        ((v) this).field_i = -2147483648;
        ((v) this).field_d = -2147483648;
