...
abstract class kj {
    ...
    final static void a(int param0) {
        ...
        try {
          ...
          throw rb.a((Throwable) ((Object) var1_ref), "kj.I(" + param0 + ')');
        }
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int[] param5, int param6, int param7, int param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16) {
        ...
        try {
                  ...
                  if (param7 == 388870384) {
                        ...
                        L8: {
                          ...
                          L10: while (true) {
                            if (param11 <= param15) {
                              ...
                              L11: {
                                var37 = var17_int >> 1226328784;
                                if (be.field_p <= var37) {
                                  break L11;
                                } else {
                                  var38 = (var18 >> -110285936) - (var17_int >> -1130554480);
                                  if (-1 == (var38 ^ -1)) {
                                    if ((var37 ^ -1) > -1) {
                                      break L11;
                                    } else {
                    ...
                    L15: while (true) {
                      if (param16 <= param15) {
                        ...
                        L16: {
                          var36 = var17_int >> -1995230992;
                          if (var36 < be.field_p) {
                            var37 = -(var17_int >> -1365673520) + (var18 >> 911130832);
                            if (0 == var37) {
                              if (-1 < (var36 ^ -1)) {
                                break L16;
                              } else {
          ...
          L18: {
            ...
            stackIn_80_1 = new StringBuilder().append("kj.G(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',');
          ...
          throw rb.a((Throwable) ((Object) stackIn_81_0), stackIn_81_2 + ',' + param6 + ',' + param7 + ',' + param8 + ',' + param9 + ',' + param10 + ',' + param11 + ',' + param12 + ',' + param13 + ',' + param14 + ',' + param15 + ',' + param16 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return;
        } else {
