 ...
 */
final class ic implements iq {
    private com.ms.directX.DSBufferDesc[] field_b;
    private com.ms.directX.DSCursors[] field_a;

    public ic() throws Exception {
        int var1 = 0;
        ((ic) this).field_a = new com.ms.directX.DSCursors[2];
        ((ic) this).field_b = new com.ms.directX.DSBufferDesc[2];
        ...
        for (var1 = 0; -3 < (var1 ^ -1); var1++) {
            ((ic) this).field_b[var1] = new com.ms.directX.DSBufferDesc();
        }
        for (var1 = 0; (var1 ^ -1) > -3; var1++) {
            ((ic) this).field_a[var1] = new com.ms.directX.DSCursors();
        }
    }
}
