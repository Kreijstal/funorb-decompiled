    ...
    final static t a(int param0, byte param1, la param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("wi.C(").append(param0).append(',').append(param1).append(',');
    ...
    final static String a(int param0, int param1, int param2, CharSequence[] param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_23_1 = new StringBuilder().append("wi.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
