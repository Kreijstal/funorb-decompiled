...
final class th extends hn implements ba, ng {
    ...
    private final int a(int param0, int param1, String param2, gm param3, int param4, boolean param5, String param6) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("th.M(").append(param0).append(',').append(param1).append(',');
    ...
    public final void a(byte param0, lg param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("th.NA(").append(param0).append(',');
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
            stackIn_8_0 = stackOut_7_0;
            stackIn_8_1 = stackOut_7_1;
    ...
    private final int a(String param0, int param1, gm param2, String param3, int param4, int param5) {
        ...
        try {
          L0: {
            if (param5 >= 111) {
              stackOut_3_0 = this.a(param4, param1, param3, param2, 35, true, param0);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("th.I(");
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
          ...
          throw rb.a((Throwable) ((Object) stackIn_14_0), stackIn_14_2 + ',' + param4 + ',' + param5 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_2_0;
        } else {
    ...
    private final void g(byte param0) {
        ...
        if (param0 > 119) {
          ...
          discarded$2 = this.a(23, (gm) null, 'ﾚ', -1);
          if (!this.b(true)) {
            return;
          } else {
            cm.a((byte) -21, this.field_H.field_m);
          ...
          L0: {
            if (!super.a(param0, param1, param2, 107)) {
              if ((param0 ^ -1) != -99) {
                ...
                stackOut_4_0 = this.a((byte) -120, param1);
                stackIn_5_0 = stackOut_4_0;
                decompiledRegionSelector0 = 1;
                break L0;
              }
