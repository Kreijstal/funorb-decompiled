...
final class uo {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_h[var16]) {
                  var9 = field_d[var16];
                  var10 = field_a[var16] * this.field_j;
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_e, 0, field_d, 0, var2);
        int var3 = field_i[this.field_j - 1];
        ...
        for (var6 = 0; var6 < this.field_c.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = ho.field_v[this.field_l[var7]].c();
            }
                    ...
                    if (var6 >= var2) {
                      ...
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= this.field_f[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              incrementValue$2 = var5;
                              var5++;
                              this.field_e[incrementValue$2] = ho.c(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_f[this.field_c[var6]];
                      var6++;
                      continue L2;
                    }
                  }
