...
final class uo {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((uo) this).field_e.length;
        var4 = field_i[((uo) this).field_j - 1];
        var5 = field_h;
        field_h[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_a[0] * ((uo) this).field_j;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_h[var16]) {
                  var9 = field_d[var16];
                  var10 = field_a[var16] * ((uo) this).field_j;
            ...
            L3: {
              var7 = uo.b(field_d, var6);
              var8_int = uo.a(field_d, var6);
              var9 = this.a(field_d[var7], field_a[var7], field_d[var8_int], field_a[var8_int], field_d[var6]);
              var10 = field_a[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean b() {
        ...
        int var2 = ((uo) this).field_e.length;
        System.arraycopy((Object) (Object) ((uo) this).field_e, 0, (Object) (Object) field_d, 0, var2);
        int var3 = field_i[((uo) this).field_j - 1];
        int var4 = ke.a(var3 - 1, (byte) -90);
        field_a[0] = ho.c(var4);
        field_a[1] = ho.c(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((uo) this).field_c.length; var6++) {
            var7 = ((uo) this).field_c[var6];
            var8 = ((uo) this).field_f[var7];
            var9 = ((uo) this).field_k[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ho.field_v[((uo) this).field_l[var7]].c();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((uo) this).field_b[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_a[incrementValue$0] = var13 >= 0 ? ho.field_v[var13].c() : 0;
            }
        }
        return true;
    }
    ...
    uo() {
        ...
        if (var1 == 1) {
          var2 = ho.c(5);
          var3 = 0;
          ((uo) this).field_c = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((uo) this).field_f = new int[var3];
              ((uo) this).field_k = new int[var3];
              ((uo) this).field_l = new int[var3];
              ((uo) this).field_b = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((uo) this).field_j = ho.c(2) + 1;
                  var4 = ho.c(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((uo) this).field_e = new int[var5];
                      ((uo) this).field_e[0] = 0;
                      ((uo) this).field_e[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((uo) this).field_f[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((uo) this).field_e[incrementValue$2] = ho.c(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((uo) this).field_f[((uo) this).field_c[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((uo) this).field_f[var4] = ho.c(3) + 1;
                    int dupTemp$3 = ho.c(2);
                    ((uo) this).field_k[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((uo) this).field_l[var4] = ho.c(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
