...
final class pk extends uc {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  pk.a(0, ph.field_e, ((pk) this).field_P[param0], ((pk) this).field_O[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  vn.a(ph.field_e, ((pk) this).field_P[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  pk.a(0, ph.field_e, ((pk) this).field_P[param0], ((pk) this).field_O[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  vn.a(ph.field_e, ((pk) this).field_P[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
    ...
    pk(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((pk) this).field_P = new byte[256][];
        ((pk) this).field_P = param6;
        ((pk) this).field_O = new int[4][];
        ((pk) this).field_O[0] = param5;
    }
}
