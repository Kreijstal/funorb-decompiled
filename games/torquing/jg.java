                  ...
                  L4: {
                    ...
                    if (this.field_s > var6) {
                      ...
                      if (var6 <= this.field_x) {
                        ...
                        stackIn_9_0 = (int[]) ((Object) stackIn_9_0);
    ...
    final void a(fj param0, int param1, int param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_12_1 = new StringBuilder().append("jg.H(");
                        ...
                        L2: while (true) {
                          if (var11 >= param6) {
                            ...
                            L3: {
                              ...
                              if (param2) {
                                stackIn_26_0 = il.field_o[var12];
                                break L3;
                              } else {
                                stackIn_26_0 = ji.field_a[var12];
                                break L3;
                              }
                            }
                            L4: {
                              ...
                              if (var13 <= var7_int) {
                                ...
                                var8++;
                                lp.field_g[incrementValue$0] = var12;
                                if (var9 > var13) {
                                  var9 = var13;
                                  break L4;
                                } else {
