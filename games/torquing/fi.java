...
final class fi {
    ...
    final gg b(int param0, int param1, byte param2) {
        ...
        if (param2 != 122) {
          var5 = (int[]) null;
          discarded$2 = this.a((int[]) null, -25, -2, -31);
    ...
    final static bp a(byte param0, String param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_20_1 = new StringBuilder().append("fi.E(").append(param0).append(',');
    ...
    public static void a(int param0) {
        ...
        if (param0 < 62) {
            byte[] var2 = (byte[]) null;
            discarded$0 = fi.a((byte) 36, (byte[]) null);
            field_c = null;
            return;
        }
        field_c = null;
            ...
            if (param1 != null) {
              L1: {
                ...
                if (param0 == -9) {
                  ...
                  var3 = (byte[]) null;
                  discarded$2 = fi.a((byte) 17, (byte[]) null);
                  break L1;
                }
              }
              go.b(0);
