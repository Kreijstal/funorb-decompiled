        ...
        try {
          L0: {
            ...
            if (255 == param3) {
              ...
              ua.field_b = pa.b(stackIn_10_0, stackIn_10_1 != 0);
              break L0;
            } else {
              L2: {
                if (param3 < 100) {
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("gk.B(").append(-5006).append(44);
    ...
    final static t[] a(int param0, int param1, la param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("gk.A(").append(param0).append(44).append(param1).append(44);
            stackIn_9_0 = stackOut_7_0;
