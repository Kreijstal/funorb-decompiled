...
final class wb extends am {
    ...
    final static void a(int param0, String[] param1, byte param2, String param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_14_1 = new StringBuilder().append("wb.A(").append(param0).append(',');
    ...
    final void a(fj param0, int param1, int param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_7_1 = new StringBuilder().append("wb.H(");
          ...
          throw rb.a((Throwable) ((Object) stackIn_8_0), stackIn_8_2 + ',' + param1 + ',' + param2 + ')');
        }
    }
    ...
    final static void b(int param0) {
        ...
        try {
                    ...
                    if (ae.field_mb == null) {
                      ...
                      if (!ae.field_mb.a(-12749)) {
                        ...
                        if (ae.field_mb.a(true, "benefits")) {
                          ...
                          var12.e();
                          lh.field_O.c(ff.a(new String[]{hc.field_u}, 0, eo.field_c), var6, 40, 16777215, -1);
                          kl.field_o.c(ff.a(new String[]{hc.field_u}, 0, wd.field_r), var6, 60, 16777215, -1);
                          lh.field_O.c(ff.a(new String[]{rj.field_y}, 0, di.field_c), var6, 110, 16777215, -1);
                          kl.field_o.c(ff.a(new String[]{rj.field_y}, 0, lc.field_B), var6, 130, 16777215, -1);
                          ...
                          L2: while (true) {
                            if (ik.field_k.length <= var7) {
                              ...
                              ln.field_H[var7].e();
                              kl.field_o.a(ik.field_k[var7], 3, 3, ln.field_H[var7].field_s - 6, ln.field_H[var7].field_t - 6, fa.field_c, -1, 1, 1, kl.field_o.field_t + kl.field_o.field_x);
                ...
                if (j.field_F == null) {
                  ...
                  if (null != lh.field_O) {
                    L5: {
                      ...
                      var3 = ph.field_d;
                      ph.b(mo.field_w);
                      var14 = ff.a(new String[]{rl.field_b[gj.field_j]}, 0, wc.field_t);
                    ...
                    var9.e();
                    lh.field_O.a(var14, up.field_d, lb.field_y, hn.field_x, wh.field_w, 16777215, -1, 1, 1, lh.field_O.field_x - -lh.field_O.field_t);
              ...
              L9: {
                if (null == hf.field_a) {
                  ...
                  if (kl.field_o == null) {
                    ...
                    ph.b(mo.field_w);
                    var16 = new t(412, 43);
                    var5_ref_String = ff.a(new String[]{hf.field_a}, 0, co.field_d);
                    hf.field_a = null;
                    var16.e();
                    kl.field_o.a(var5_ref_String, 3, 3, var16.field_s - 6, -6 + var16.field_t, 16777215, -1, 0, 1, kl.field_o.field_t + kl.field_o.field_x);
              ...
              L14: {
                if (vk.field_s == null) {
                  ...
                  if (jg.field_t == null) {
                    ...
                    L17: {
                      var2 = (cd.a(stackIn_53_0, stackIn_53_1 << stackIn_53_2) * 40 >> -934588624) + 40;
                      if ((var2 ^ -1) < -1) {
                    ...
                    L18: {
                      stackIn_58_0 = we.field_h;

                      stackIn_58_1 = na.field_E;
                    ...
                    eh.a(stackIn_59_0, stackIn_59_1, stackIn_59_2, stackIn_59_3 != 0);
                    break L14;
                  }
                }
              }
              L19: {
                if (vk.field_s == null) {
                  ...
                  if (null == jg.field_t) {
                    ...
                    L21: {
                      stackIn_66_0 = nc.field_a;

                      stackIn_66_1 = db.field_j;
                    ...
                    eh.a(stackIn_67_0, stackIn_67_1, stackIn_67_2, stackIn_67_3 != 0);
                    break L19;
                  }
                }
              }
                          ...
                          L24: {
                            if (n.field_t <= -qc.field_db.field_s + 269) {
                              ...
                              if (n.field_t >= 269) {
                                ...
                                qc.field_db.a(-qc.field_db.field_w + 269 - -1, 1 + var1_int, var2);
                                break L23;
                              }
                            }
                          }
          ...
          throw rb.a((Throwable) ((Object) var1_ref), "wb.D(" + param0 + ')');
        }
    ...
    final int[] a(byte param0, int param1) {
        ...
        L0: {
          ...
          var17 = this.field_l.a(param1, 25657);
          var3 = var17;
          if (this.field_l.field_b) {
            var25 = this.b(0, 0, vp.field_I & -1 + param1);
            var5 = this.b(0, 0, param1);
            var24 = this.b(0, 0, 1 + param1 & vp.field_I);
            var7 = 0;
            L1: while (true) {
              if (ci.field_c <= var7) {
                break L0;
                ...
                L2: {
                  var8 = this.field_s * (var24[var7] + -var25[var7]);
                  var9 = this.field_s * (var5[jh.field_A & 1 + var7] - var5[var7 + -1 & jh.field_A]);
    ...
    final static void a(String param0, int param1) {
        try {
            ...
            throw rb.a((Throwable) ((Object) runtimeException), "wb.E(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ')');
        }
    }
