          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                ...
                var2++;
                ((uc) this).field_N[var3_int] = param0[incrementValue$9] & 255;
                var3_int++;
                continue L1;
              }
            }
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        StringBuilder discarded$6 = field_L.append('<');
                        StringBuilder discarded$7 = field_L.append(var15);
                        StringBuilder discarded$8 = field_L.append('>');
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        StringBuilder discarded$9 = field_L.append((char) var14);
