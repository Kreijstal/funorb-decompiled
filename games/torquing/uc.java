 ...
 */
abstract class uc extends ta {
    private byte[] field_z;
    private int[] field_H;
    private int[] field_M;
    int field_s;
    int field_x;
    private static StringBuilder field_L;
    private int[] field_v;
    private int[] field_K;
    private int[] field_I;
    private bn[] field_B;
    ...
    final int a(char param0) {
        return ((uc) this).field_N[ka.a(false, param0) & 255];
    }
    ...
    final int c(String param0, int param1) {
        return ((uc) this).a(param0, new int[1], field_E);
    }
            ...
            switch (statePc) {
                ...
                case 26: {
                    try {
                        ...
                        var9_int = kc.a((byte) 123, var10);
                        var4 = var4 + ((uc) this).field_B[var9_int].field_j;
                        var3 = 0;
                        statePc = 27;
                        continue stateLoop;
                ...
                case 31: {
                    var7 = (char)(ka.a(false, (char) var7) & 255);
                    var4 = var4 + ((uc) this).field_N[var7];
                ...
                case 33: {
                    var4 = var4 + ((uc) this).field_z[(var3 << 8) + var7];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
    ...
    final int a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9) {
        return ((uc) this).a(param0, param1, param2, param3, param4, param5, param6, 256, param7, param8, param9);
    }
    ...
    final void a(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.b(param0, param1 - ((uc) this).a(param0), param2);
    }
    ...
    final int a(String param0, int param1, int param2) {
        if (param2 == 0) {
            param2 = ((uc) this).field_q;
        }
        int var4 = ((uc) this).a(param0, new int[1], field_E);
        int var5 = (var4 - 1) * param2;
        return ((uc) this).field_x + var5 + ((uc) this).field_t;
    }
        ...
        if (param0 != null) {
          L0: {
            ...
            if (param10 != 0) {
              ...
              param10 = ((uc) this).field_q;
              break L0;
            }
          }
          L1: {
            var12 = new int[]{param3};
            if (param4 >= ((uc) this).field_x + ((uc) this).field_t + param10) {
              break L1;
            } else {
          ...
          L2: {
            var13 = ((uc) this).a(param0, var12, field_E);
            if (param9 != 3) {
              break L2;
            } else {
              if (var13 != 1) {
          ...
          L3: {
            if (param9 != 0) {
              if (param9 != 1) {
                if (param9 != 2) {
                  L4: {
                    var15 = (param4 - ((uc) this).field_x - ((uc) this).field_t - (var13 - 1) * param10) / (var13 + 1);
                    if (var15 >= 0) {
                      break L4;
                    } else {
                      var15 = 0;
                  ...
                  var14 = param2 + ((uc) this).field_x + var15;
                  param10 = param10 + var15;
                  break L3;
                } else {
                  var14 = param2 + param4 - ((uc) this).field_t - (var13 - 1) * param10;
                  break L3;
                }
              } else {
                var14 = param2 + ((uc) this).field_x + (param4 - ((uc) this).field_x - ((uc) this).field_t - (var13 - 1) * param10) / 2;
                break L3;
              }
            } else {
              var14 = param2 + ((uc) this).field_x;
              break L3;
            }
          }
          var15 = 0;
                  ...
                  if (param8 != 2) {
                    L6: {
                      if (var15 != var13 - 1) {
                        ...
                        this.b(field_E[var15], param1, var14);
                        field_D = 0;
                        break L6;
                      } else {
                        this.b(field_E[var15], param1, var14);
                    ...
                    this.b(field_E[var15], param1 + param3 - ((uc) this).a(field_E[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_E[var15], param1 + (param3 - ((uc) this).a(field_E[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
    ...
    final void c(String param0, int param1, int param2, int param3, int param4) {
        ...
        this.a(param3, param4);
        this.b(param0, param1 - ((uc) this).a(param0) / 2, param2);
    }
    ...
    private final void b(String param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 27: {
                    try {
                        this.a(field_F, field_u, field_r);
                        statePc = 30;
                        continue stateLoop;
    ...
    final int b(String param0, int param1) {
        ...
        int var5 = 0;
        int var6 = 0;
        var3 = ((uc) this).a(param0, new int[1], field_E);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (var5 >= var3) {
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_D = (param1 - ((uc) this).a(param0) << 8) / var3;
                break L1;
              }
            }
            return;
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                      ...
                      if (var5_int >= 256) {
                        ...
                        L4: while (true) {
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ((uc) this).field_z = new byte[65536];
                                var7 = 0;
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    ((uc) this).field_q = var25[32] + var22[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                ((uc) this).field_z[(var7 << 8) + var8] = (byte)uc.a(var23, var24, var25, ((uc) this).field_N, var22, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
                ...
                var2++;
                ((uc) this).field_N[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
            ...
            var2 = 0;
            L10: while (true) {
              if (var2 >= ((uc) this).field_N.length) {
                ((uc) this).field_q = param0[256] & 255;
                break L0;
              } else {
                ((uc) this).field_N[var2] = param0[var2] & 255;
                var2++;
                continue L10;
              }
            }
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = ke.a(field_L, ' ', false, 0);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
                ...
                case 8: {
                    ...
                    var9 = -1;
                    StringBuilder discarded$11 = field_L.append(60);
                    StringBuilder discarded$12 = field_L.append(var15);
                    StringBuilder discarded$13 = field_L.append(62);
                ...
                case 9: {
                    param2[var11] = field_L.toString().substring(var5, field_L.length());
                    var11++;
                    var5 = field_L.length();
                    var4 = 0;
                    var6 = -1;
                ...
                case 13: {
                    var4 = var4 + ((uc) this).field_z[(var10 << 8) + 60];
                    statePc = 14;
                    continue stateLoop;
                }
                case 14: {
                ...
                case 18: {
                    var4 = var4 + ((uc) this).field_z[(var10 << 8) + 62];
                    statePc = 19;
                    continue stateLoop;
                }
                case 19: {
                ...
                case 23: {
                    var4 = var4 + ((uc) this).field_z[(var10 << 8) + 160];
                    statePc = 24;
                    continue stateLoop;
                }
                case 24: {
                ...
                case 28: {
                    var4 = var4 + ((uc) this).field_z[(var10 << 8) + 173];
                    statePc = 29;
                    continue stateLoop;
                }
                case 29: {
                ...
                case 33: {
                    var4 = var4 + ((uc) this).field_z[(var10 << 8) + 215];
                    statePc = 34;
                    continue stateLoop;
                }
                case 34: {
                ...
                case 38: {
                    var4 = var4 + ((uc) this).field_z[(var10 << 8) + 128];
                    statePc = 39;
                    continue stateLoop;
                }
                case 39: {
                ...
                case 43: {
                    var4 = var4 + ((uc) this).field_z[(var10 << 8) + 169];
                    statePc = 44;
                    continue stateLoop;
                }
                case 44: {
                ...
                case 48: {
                    var4 = var4 + ((uc) this).field_z[(var10 << 8) + 174];
                    statePc = 49;
                    continue stateLoop;
                }
                case 49: {
                ...
                case 51: {
                    try {
                        ...
                        var16_int = kc.a((byte) 116, var18);
                        var4 = var4 + ((uc) this).field_B[var16_int].field_j;
                        var10 = 0;
                        statePc = 54;
                        continue stateLoop;
                ...
                case 58: {
                    StringBuilder discarded$14 = field_L.append(var14);
                ...
                case 60: {
                    var4 = var4 + ((uc) this).field_z[(var10 << 8) + var14];
                    statePc = 61;
                    continue stateLoop;
                }
                case 61: {
                ...
                case 70: {
                    param2[var11] = field_L.toString().substring(var5, var6 - var8);
                    var11++;
                    var5 = var6;
                    var6 = -1;
                    var4 = var4 - var7;
    ...
    uc(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((uc) this).field_q = 0;
        ((uc) this).field_H = param1;
        ((uc) this).field_M = param2;
        ((uc) this).field_K = param3;
        ((uc) this).field_I = param4;
        this.a(param0);
        var6 = 2147483647;
        var7 = -2147483648;
        var8 = 0;
        L0: while (true) {
          if (var8 >= 256) {
            ((uc) this).field_x = ((uc) this).field_q - var6;
            ((uc) this).field_t = var7 - ((uc) this).field_q;
            ((uc) this).field_s = ((uc) this).field_q - ((uc) this).field_M[88];
          } else {
            L1: {
              if (((uc) this).field_M[var8] >= var6) {
                break L1;
              } else {
                if (((uc) this).field_I[var8] == 0) {
                  break L1;
                } else {
                  var6 = ((uc) this).field_M[var8];
                  break L1;
                }
              }
            }
            if (((uc) this).field_M[var8] + ((uc) this).field_I[var8] > var7) {
              var7 = ((uc) this).field_M[var8] + ((uc) this).field_I[var8];
              var8++;
              continue L0;
            } else {
              var8++;
            ...
            switch (statePc) {
                ...
                case 23: {
                    try {
                        ...
                        var10 = kc.a((byte) 120, var13);
                        var11_ref_bn = ((uc) this).field_B[var10];
                        if (((uc) this).field_v == null) {
                            statePc = 25;
                        } else {
                            statePc = 24;
                        }
                ...
                case 24: {
                    try {
                        stackOut_24_0 = ((uc) this).field_v[var10];
                ...
                case 25: {
                    try {
                        stackOut_25_0 = var11_ref_bn.field_e;
                ...
                case 27: {
                    try {
                        var11_ref_bn.a(param1, param2 + ((uc) this).field_q - var12);
                        statePc = 29;
                        continue stateLoop;
                    } catch (Throwable stateCaught_27) {
                        caughtException = stateCaught_27;
                ...
                case 28: {
                    try {
                        var11_ref_bn.a(param1, param2 + ((uc) this).field_q - var12, field_y);
                        statePc = 29;
                        continue stateLoop;
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_bn.field_j;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
                ...
                case 35: {
                    var8 = (char)(ka.a(false, (char) var8) & 255);
                    if (((uc) this).field_z == null) {
                        statePc = 38;
                    } else {
                        statePc = 36;
                ...
                case 37: {
                    param1 = param1 + ((uc) this).field_z[(var5 << 8) + var8];
                    statePc = 38;
                    continue stateLoop;
                }
                case 38: {
                    var9 = ((uc) this).field_K[var8];
                    var10 = ((uc) this).field_I[var8];
                    var11 = param1;
                    if (var8 == 32) {
                        statePc = 46;
                    } else {
                ...
                case 41: {
                    ((uc) this).a(var8, param1 + ((uc) this).field_H[var8] + 1, param2 + ((uc) this).field_M[var8] + 1, var9, var10, field_J, true);
                    statePc = 42;
                    continue stateLoop;
                }
                case 42: {
                    ((uc) this).a(var8, param1 + ((uc) this).field_H[var8], param2 + ((uc) this).field_M[var8], var9, var10, field_G, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 43: {
                ...
                case 44: {
                    ((uc) this).a(var8, param1 + ((uc) this).field_H[var8] + 1, param2 + ((uc) this).field_M[var8] + 1, var9, var10, field_J, field_y, true);
                    statePc = 45;
                    continue stateLoop;
                }
                case 45: {
                    ((uc) this).a(var8, param1 + ((uc) this).field_H[var8], param2 + ((uc) this).field_M[var8], var9, var10, field_G, field_y, false);
                    statePc = 48;
                    continue stateLoop;
                }
                case 46: {
                ...
                case 47: {
                    field_A = field_A + field_D;
                    param1 = param1 + (field_A >> 8);
                    field_A = field_A & 255;
                    statePc = 48;
                    continue stateLoop;
                }
                case 48: {
                    param1 = param1 + ((uc) this).field_N[var8];
                    if (field_C == -1) {
                        statePc = 50;
                    } else {
                        statePc = 49;
                ...
                case 49: {
                    ph.b(var11, param2 + (int)((double)((uc) this).field_q * 0.7), param1 - var11, field_C);
                    statePc = 50;
                    continue stateLoop;
                }
                case 50: {
                ...
                case 51: {
                    ph.b(var11, param2 + ((uc) this).field_q + 1, param1 - var11, field_w);
                    statePc = 52;
                    continue stateLoop;
                }
                case 52: {
