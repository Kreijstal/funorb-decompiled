            ...
            switch (statePc) {
                ...
                case 9: {
                    try {
                        ...
                        stackOut_9_1 = new StringBuilder().append("ab.H(").append(param0).append(44);
            ...
            switch (statePc) {
                ...
                case 12: {
                    try {
                        ...
                        stackOut_12_1 = new StringBuilder().append("ab.K(").append(param0).append(44);
    ...
    final cd a(int param0, String param1) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                case 0: {
                    try {
                        if (!ip.a((byte) -31, (CharSequence) (Object) param1)) {
                            statePc = 3;
                        } else {
                            statePc = 1;
                        }
                ...
                case 9: {
                    try {
                        var3_int = kc.a((byte) 121, (CharSequence) (Object) param1);
                        statePc = 10;
                        continue stateLoop;
                    } catch (Throwable stateCaught_9) {
                        caughtException = stateCaught_9;
                ...
                case 19: {
                    try {
                        ...
                        stackOut_19_1 = new StringBuilder().append("ab.F(").append(param0).append(44);
    ...
    final static bc a(String param0, String param1, int param2, boolean param3) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 4: {
                    try {
                        var4_long = mm.a((CharSequence) (Object) param0, (byte) 91);
                ...
                case 6: {
                    try {
                        stackOut_6_0 = tp.a((byte) -51, param3, param1, var6, var4_long);
                        stackIn_7_0 = stackOut_6_0;
                        statePc = 7;
                        continue stateLoop;
                    } catch (Throwable stateCaught_6) {
                ...
                case 9: {
                    try {
                        ...
                        stackOut_9_1 = new StringBuilder().append("ab.J(");
                        stackIn_12_0 = stackOut_9_0;
                        stackIn_12_1 = stackOut_9_1;
                        stackIn_10_0 = stackOut_9_0;
                        stackIn_10_1 = stackOut_9_1;
                ...
                case 17: {
                    throw rb.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + 44 + param2 + 44 + param3 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
