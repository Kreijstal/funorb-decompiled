                  ...
                  if (this.field_w == this.field_D) {
                    ...
                    L6: {
                      ...
                      if (Math.abs(var5_int) <= 2) {
                        ...
                        stackOut_8_2 = var5_int >> 1279222241;
                ...
                if (this.field_k == this.field_I) {
                  ...
                  L7: {
                    ...
                    if (-3 > (Math.abs(var5_int) ^ -1)) {
                      ...
                      stackOut_18_2 = var5_int >> -655719295;
          ...
          L0: {
            L1: {
              if (param1 == 117) {
                ...
                var6 = (gm) null;
                discarded$30 = this.a(68, -37, 53, -107, -120, (gm) null, (byte) 32);
                break L1;
              }
            }
            L2: {
              if (!this.a(param1 ^ -31757, param0, param2, param3)) {
                ...
                discarded$31 = param0.append(" revert=").append(this.field_H);
                if (2147483647 == this.field_D) {
                  break L2;
                } else {
                  if ((this.field_I ^ -1) != -2147483648) {
                    discarded$32 = param0.append(" to ").append(this.field_D).append(',').append(this.field_I);
                    break L2;
                  } else {
                    break L2;
                  }
    ...
    final static void a(byte param0, boolean param1, double[] param2, double param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_17_1 = new StringBuilder().append("aj.I(").append(param0).append(',').append(param1).append(',');
            stackIn_19_0 = stackOut_17_0;
            stackIn_19_1 = stackOut_17_1;
