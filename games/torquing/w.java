...
class w extends to {
    ...
    final static void a(byte param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
            ...
            throw rb.a((Throwable) (Object) runtimeException, "w.H(" + 72 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ')');
        }
    }
    ...
    private final void a(int param0, w param1) {
        ...
        try {
          ...
          L38: {
            ...
            stackOut_96_1 = new StringBuilder().append("w.F(").append(-1).append(',');
