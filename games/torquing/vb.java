...
final class vb {
    ...
    final static int a(String param0, String param1, byte param2, boolean param3, boolean param4, int param5) {
        try {
            ...
            try {
                  ...
                  if (p.field_t != ef.field_a) {
                    ...
                    if (ah.a(2)) {
                      ...
                      L19: {
                        L20: {
                          if (wp.field_w > 0) {
                            ...
                            if (!fj.field_l) {
                              try {
                                L21: {
                                  Object discarded$10 = hp.a(ip.a(9), (byte) -85, "unzap");
                                  break L21;
                                }
                        ...
                        try {
                          L23: {
                            Object discarded$11 = hp.a(ip.a(param2 + -18), new Object[1], 28989, "zap");
                            break L23;
                          }
              ...
              throw rb.a((Throwable) (Object) stackIn_159_0, stackIn_159_2 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
            }
    ...
    final static bp a(int param0, String param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_17_1 = new StringBuilder().append("vb.F(").append(param0).append(44);
    ...
    static long a(long param0, long param1) {
        ...
        try {
          ...
          throw rb.a((Throwable) (Object) var4, "vb.C(" + param0 + 44 + param1 + 41);
        }
        return stackIn_1_0;
    }
    ...
    final static void a(of param0, byte param1, boolean param2, int[] param3, int[] param4, boolean param5, boolean param6) {
        ...
        try {
          ...
          throw rb.a((Throwable) (Object) stackIn_77_0, stackIn_77_2 + 44 + param5 + 44 + param6 + 41);
        }
    }
    ...
    final static void a(boolean param0, String param1, boolean param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("vb.H(").append(param0).append(44);
    ...
    public static void a(int param0) {
        ...
        try {
          ...
          throw rb.a((Throwable) (Object) var1, "vb.G(" + param0 + 41);
        }
    }
    ...
    final static int a(int param0, int param1, boolean param2, int param3) {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var4 = decompiledCaughtException;
          throw rb.a((Throwable) (Object) var4, "vb.A(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_4_0;
    }
