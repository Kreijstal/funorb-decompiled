                  ...
                  L2: while (true) {
                    ...
                    if (var8 != 0) {
                      ...
                      try {
                        ...
                        throw rb.a((Throwable) ((Object) stackIn_40_0), (stackIn_40_2 != 0) + " " + param2 + " " + param3.length + " " + wf.a((byte) -117, param3.length, var9) + " " + wf.a((byte) -117, param3.length + -2, var9) + " " + this.field_e.field_p[param2] + " " + this.field_e.field_o);
                      }
                      L10: {
                        if (!this.field_i) {
                          break L10;
