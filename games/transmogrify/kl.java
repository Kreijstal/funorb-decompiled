...
final class kl extends RuntimeException {
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, byte param9, int param10, int param11, int param12, int param13, int param14, int param15) {
        ...
        try {
          ...
          throw ch.a((Throwable) (Object) var16, "kl.A(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ',' + 44 + ',' + param10 + ',' + param11 + ',' + param12 + ',' + param13 + ',' + param14 + ',' + param15 + ')');
        }
    }
    ...
    final static java.awt.Frame a(int param0, int param1, fe param2, int param3, int param4) {
        ...
        try {
          ...
          L9: {
            ...
            stackOut_51_1 = new StringBuilder().append("kl.E(").append(param0).append(',').append(-3).append(',');
          ...
          throw ch.a((Throwable) (Object) stackIn_55_0, stackIn_55_2 + ',' + param3 + ',' + param4 + ',' + 0 + ')');
        }
        return stackIn_50_0;
    }
