...
final class na {
    ...
    public final void movemouse(int param0, int param1) {
        ((na) this).field_b.mouseMove(param0, param1);
    }
    ...
    public na() throws Exception {
        java.awt.Robot var2 = new java.awt.Robot();
        ((na) this).field_b = var2;
    }
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            if (!param1) {
              if (param0 != null) {
                if (((na) this).field_a == param0) {
                  return;
                } else {
                  L0: {
                    if (null != ((na) this).field_a) {
                      ((na) this).field_a.setCursor((java.awt.Cursor) null);
