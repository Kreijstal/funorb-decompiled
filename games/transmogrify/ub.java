        ...
        if (si.field_l < 0) {
          ...
          L0: {
            ...
            if (75 <= si.field_l) {
              ...
              var5 = (si.field_l << -2012130360) / 75;
              break L0;
            }
          }
          L1: {
            if (200 < si.field_l) {
              var5 = (-si.field_l + 250 << 1365281800) / 50;
              break L1;
            } else {
              break L1;
            }
          ...
          if (param2 == 116) {
            ...
            if (256 <= var5) {
              ...
              if (150 > si.field_l) {
                        ...
                        if (var8 != 0) {
                          ...
                          L3: {
                            ...
                            if (var6 > 0) {
                              ...
                              tb.field_e.e(15 + var3, var4 - -10, var7 * var5 >> 1541162536);
                              break L3;
                            } else {
                              break L3;
                            }
                ...
                ch.field_c.e(var3 + 15, var4 - -10, var5);
                if (var8 == 0) {
                  var6 = si.field_l - 125;
                  if (-1 > (var6 ^ -1)) {
                    if ((var6 ^ -1) > -51) {
              ...
              L41: {
                sb.c(0, 0, sb.field_c, sb.field_g, 0, 256 - var5);
                fi.c(true);
                if (150 > si.field_l) {
                  ug.field_f.d(var3, var4);
                  break L41;
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 10: {
                    ...
                    stackIn_12_1 = new StringBuilder().append("ub.A(");
