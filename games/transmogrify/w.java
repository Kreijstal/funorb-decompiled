          ...
          L0: {
            L1: {
              if (param3 > 24) {
                ...
                var7 = (nf) null;
                discarded$1 = w.a((j) null, -111, (nf) null, (byte) -120, '￬');
                break L1;
              }
            }
            L2: {
          ...
          if (12 <= var5) {
            ...
            L2: while (true) {
              if ((var5 ^ -1) <= -9) {
                ...
                stackOut_18_0 = si.field_i.field_e[var5];
    ...
    final static boolean a(int param0, hj param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("w.D(").append(param0).append(',');
