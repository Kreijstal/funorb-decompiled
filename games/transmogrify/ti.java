...
class ti extends se {
    ...
    final void e() {
        sb.a(this.field_w, this.field_n, this.field_m);
    }
                  ...
                  if (var16 >= 4) {
                    ...
                    L7: while (true) {
                      if (var17 >= 4) {
                        ...
                        L8: {
                          var13 = this.field_w[var10 + var16 * this.field_n + var17];
                          if (var13 != 0) {
                            break L8;
                          } else {
    ...
    void c(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            if (param2 == 256) {
                ti.a(0, 0, 0, sb.field_h, this.field_w, var5, 0, var4, 0, var7, var6, var8, var9);
            } else {
                ti.a(0, 0, 0, sb.field_h, this.field_w, var5, 0, var4, 0, var7, var6, var8, var9, param2);
            }
            return;
        }
    }
    ...
    void f(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            ti.a(sb.field_h, this.field_w, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
        ...
        L0: {
          if (param2 > this.field_r) {
            ...
            if (param3 <= this.field_s) {
              L1: {
                var5 = param0 + this.field_u * param2 / this.field_r;
                var6 = param0 + ((this.field_u + this.field_n) * param2 + this.field_r - 1) / this.field_r;
                var7 = param1 + this.field_l * param3 / this.field_s;
                var8 = param1 + ((this.field_l + this.field_m) * param3 + this.field_s - 1) / this.field_s;
                if (var5 >= sb.field_d) {
                  break L1;
                } else {
                  var5 = sb.field_d;
                    ...
                    if (var11 >= var8) {
                      ...
                      L6: while (true) {
                        if (var12 >= var6) {
                          ...
                          var15 = var13 * this.field_r / param2 - (this.field_u << 4);
                          var16 = (var13 + 16) * this.field_r / param2 - (this.field_u << 4);
                          var17 = var14 * this.field_s / param3 - (this.field_l << 4);
                          var18 = (var14 + 16) * this.field_s / param3 - (this.field_l << 4);
                          ...
                          if (var19 != 0) {
                            ...
                            L8: {
                              if (var16 <= this.field_n << 4) {
                                break L8;
                              } else {
                                var16 = this.field_n << 4;
                                break L8;
                              }
                            }
                            L9: {
                            ...
                            L10: {
                              if (var18 <= this.field_m << 4) {
                                break L10;
                              } else {
                                var18 = this.field_m << 4;
                                break L10;
                              }
                            }
                            var16--;
                              ...
                              if (var28 > var18) {
                                ...
                                L15: while (true) {
                                  if (var30 > var16) {
                                    ...
                                    var31 = this.field_w[var28 * this.field_n + var30];
                                    if (var31 != 0) {
                                      L16: {
                                        var32 = var29;
                                        if (var30 != var15) {
    ...
    void b(int param0, int param1, int param2, int param3) {
        ...
        if (param2 > 0) {
            ...
            ti.a(sb.field_h, this.field_w, 0, var7, var8, var13, var14, param2, param3, var11, var12, var5);
            return;
        }
    }
          ...
          if (var8 >= param7) {
            ...
            L1: while (true) {
              if (var9 >= param6) {
                ...
                param2++;
                sb.field_h[incrementValue$4] = (var13 & 66847740 | var14 & 261120) >> 2;
                var9++;
                param1 += 2;
                continue L1;
              }
    ...
    final ti c() {
        int var2 = 0;
        int var3 = 0;
        ti var1 = new ti(this.field_n, this.field_m);
        var1.field_r = this.field_r;
        var1.field_s = this.field_s;
        var1.field_u = this.field_r - this.field_n - this.field_u;
        var1.field_l = this.field_l;
        for (var2 = 0; var2 < this.field_m; var2++) {
            for (var3 = 0; var3 < this.field_n; var3++) {
                var1.field_w[var2 * this.field_n + var3] = this.field_w[var2 * this.field_n + this.field_n - 1 - var3];
            }
        }
        return var1;
    }
    ...
    void d(int param0, int param1) {
        ...
        int var4 = param0 + (this.field_n >> 1) > sb.field_b ? sb.field_b - param0 << 1 : this.field_n;
        int var5 = param1 < sb.field_e ? sb.field_e - param1 << 1 : 0;
        int var6 = param1 + (this.field_m >> 1) > sb.field_f ? sb.field_f - param1 << 1 : this.field_m;
        ti.a(this.field_w, var5 * this.field_n + var3, (param1 + (var5 >> 1)) * sb.field_c + (param0 + (var3 >> 1)), (this.field_n << 1) - (var4 - var3) + (this.field_n & 1), sb.field_c - (var4 - var3 >> 1), this.field_n, var4 - var3 >> 1, var6 - var5 >> 1);
    }
    ...
    void c(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            ti.b(sb.field_h, this.field_w, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final void d() {
        int var2 = 0;
        int var3 = 0;
        if (this.field_n == this.field_r && this.field_m == this.field_s) {
            return;
        }
        int[] var1 = new int[this.field_r * this.field_s];
        for (var2 = 0; var2 < this.field_m; var2++) {
            for (var3 = 0; var3 < this.field_n; var3++) {
                var1[(var2 + this.field_l) * this.field_r + (var3 + this.field_u)] = this.field_w[var2 * this.field_n + var3];
            }
        }
        this.field_w = var1;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          L0: {
            ...
            var13 = ((this.field_n << 4) - param0) * var10 + -param1 * var9;
            var14 = -((this.field_n << 4) - param0) * var9 + -param1 * var10;
            var15 = -param0 * var10 + ((this.field_m << 4) - param1) * var9;
            var16 = --param0 * var9 + ((this.field_m << 4) - param1) * var10;
            var17 = ((this.field_n << 4) - param0) * var10 + ((this.field_m << 4) - param1) * var9;
            var18 = -((this.field_n << 4) - param0) * var9 + ((this.field_m << 4) - param1) * var10;
            if (var11 >= var13) {
              var19 = var13;
              var20 = var11;
              break L0;
    ...
    void a(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            ti.a(sb.field_h, this.field_w, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
                ...
                if (var3 < 0) {
                  ...
                  L8: while (true) {
                    if (var4 > var1) {
                      ...
                      if (this.field_w[var4 * this.field_n + var3] == 0) {
                        var4++;
                        continue L8;
                      } else {
                        break L7;
                  ...
                  if (var4 >= var3) {
                    ...
                    L11: while (true) {
                      if (var5 > var1) {
                        ...
                        if (this.field_w[var5 * this.field_n + var4] == 0) {
                          var5++;
                          continue L11;
                        } else {
                          break L10;
                  ...
                  if (var8 >= var6) {
                    ...
                    L14: while (true) {
                      if (var9 >= var5) {
                        ...
                        var7[var8 * var5 + var9] = this.field_w[(var8 + var2) * this.field_n + (var9 + var4)];
                        var9++;
                        continue L14;
                      }
                    }
    ...
    void b(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            ti.b(sb.field_h, this.field_w, 0, var5, var4, 0, 0, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    private final void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        int var18;
        L0: {
          var6 = param2 * this.field_n + param1;
          param3 = param3 & 4095;
          param4 = param4 & 4095;
          if (param2 < 0) {
            var12 = 0;
          ...
          if (param2 >= this.field_m - 1) {
            ...
            L5: {
              if (param1 < 0) {
                ...
                L6: {
                  var9 = this.field_w[var6 + this.field_n];
                  if (var9 == 0) {
                    stackIn_19_0 = 0;
                    break L6;
                  } else {
            ...
            if (param1 >= this.field_n - 1) {
              ...
              L7: {
                var10 = this.field_w[var6 + this.field_n + 1];
                if (var10 == 0) {
                  stackIn_25_0 = 0;
                  break L7;
                } else {
    ...
    final void f() {
        ...
        int incrementValue$0 = 0;
        int var3 = 0;
        int[] var1 = new int[this.field_n * this.field_m];
        int var2 = 0;
        for (var3 = 0; var3 < this.field_n; var3++) {
            for (var4 = this.field_m - 1; var4 >= 0; var4--) {
                incrementValue$0 = var2;
                var2++;
                var1[incrementValue$0] = this.field_w[var3 + var4 * this.field_n];
            }
        }
        this.field_w = var1;
        var3 = this.field_l;
        this.field_l = this.field_u;
        this.field_u = this.field_s - this.field_m - var3;
        var3 = this.field_m;
    ...
    final void b(int param0, int param1) {
        ...
        if (var6 > 0) {
            ...
            ti.a(0, sb.field_h, this.field_w, 0, var4, var3, var6, var5, var7, var8);
            return;
        }
    }
    ...
    final void d(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            ti.a(sb.field_h, this.field_w, param2, var5, var4, var7, var6, var8, var9);
            return;
        }
    }
    ...
    void e(int param0, int param1, int param2) {
        ...
        if (var7 > 0) {
            ...
            ti.b(sb.field_h, this.field_w, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
        }
    }
    ...
    ti(byte[] param0, java.awt.Component param1) {
        ...
        try {
          L0: {
            ...
            var4.waitForAll();
            this.field_n = var3.getWidth((java.awt.image.ImageObserver) ((Object) param1));
            this.field_m = var3.getHeight((java.awt.image.ImageObserver) ((Object) param1));
            this.field_r = this.field_n;
            this.field_s = this.field_m;
            this.field_u = 0;
            this.field_l = 0;
            this.field_w = new int[this.field_n * this.field_m];
            var5 = new java.awt.image.PixelGrabber(var3, 0, 0, this.field_n, this.field_m, this.field_w, 0, this.field_n);
            var5.grabPixels();
            break L0;
          }
