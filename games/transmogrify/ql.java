    ...
    final static dg a(int param0, int param1, fe param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("ql.C(").append(param0).append(',').append(param1).append(',');
    ...
    final static od a(int param0, int param1, int param2, hb param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ql.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
