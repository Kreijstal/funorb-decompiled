...
final class sb {
    ...
    private final static void f(int param0, int param1, int param2, int param3) {
        int var4 = 0;
        int var5 = 0;
        if (param0 >= field_d) {
            if (param0 >= field_b) {
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4) {
        sb.d(param0, param1, param2, param4);
        sb.d(param0, param1 + param3 - 1, param2, param4);
        sb.f(param0, param1, param3, param4);
        sb.f(param0 + param2 - 1, param1, param3, param4);
    }

    final static void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        sb.a(field_h, 0, param2 + param3 * field_c, param0, param2, param4, field_c - param4, 140);
        sb.a(field_h, 0, param2 + param3 * field_c, param1, param3, 140, field_c - param4, param2, param4);
    }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
                  ...
                  L4: {
                    ...
                    if (var6 < field_d) {
                      ...
                      if (var6 >= field_b) {
                        ...
                        field_h[var6 + param1 * field_c] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_e) {
                      ...
                      if (var6 >= field_f) {
                        ...
                        field_h[param0 + var6 * field_c] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                sb.f(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                sb.f(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              sb.d(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              sb.d(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
          ...
          L0: {
            if (param1 < field_e) {
              ...
              if (param0 >= field_b) {
                ...
                if (param1 < field_f) {
                  field_h[param0 + param1 * field_c] = param2;
                  return;
                } else {
                  break L0;
                }
    ...
    final static void e(int param0, int param1, int param2, int param3) {
        ...
        sb.a(var5, field_h, 0, param2, -param3, var4);
    }
