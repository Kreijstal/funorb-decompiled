...
final class ph extends qh {
    ...
    final void e() {
        try {
            ...
            for (var2 = 0; var2 < var1; var2++) {
                var3 = ((ph) this).field_i[var2];
                if ((var3 + 8388608 & -16777216) != 0) {
                    var3 = 8388607 ^ var3 >> 31;
                }
                ((ph) this).field_v[var2 * 2] = (byte)(var3 >> 8);
                ((ph) this).field_v[var2 * 2 + 1] = (byte)(var3 >> 16);
            }
            int discarded$0 = ((ph) this).field_w.write(((ph) this).field_v, 0, var1 << 1);
    ...
    final int b() {
        return ((ph) this).field_y - (((ph) this).field_w.available() >> (field_g ? 2 : 1));
    }

    final void h() {
        if (((ph) this).field_w != null) {
            ((ph) this).field_w.close();
            ((ph) this).field_w = null;
        }
    }

    ph() {
        ((ph) this).field_x = false;
    }

    final void g() throws javax.sound.sampled.LineUnavailableException {
        javax.sound.sampled.DataLine.Info var1 = null;
        ((ph) this).field_w.flush();
        if (((ph) this).field_x) {
            ((ph) this).field_w.close();
            ((ph) this).field_w = null;
            var1 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, ((ph) this).field_z, ((ph) this).field_y << (field_g ? 2 : 1));
            ((ph) this).field_w = (javax.sound.sampled.SourceDataLine) (Object) javax.sound.sampled.AudioSystem.getLine((javax.sound.sampled.Line.Info) (Object) var1);
            ((ph) this).field_w.open();
            ((ph) this).field_w.start();
        }
    }
    ...
    final void b(int param0) throws javax.sound.sampled.LineUnavailableException {
        ...
        try {
            var2 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, ((ph) this).field_z, param0 << (field_g ? 2 : 1));
            ((ph) this).field_w = (javax.sound.sampled.SourceDataLine) (Object) javax.sound.sampled.AudioSystem.getLine((javax.sound.sampled.Line.Info) (Object) var2);
            ((ph) this).field_w.open();
            ((ph) this).field_w.start();
            ((ph) this).field_y = param0;
        } catch (javax.sound.sampled.LineUnavailableException lineUnavailableException) {
            if (hi.a(false, param0) != 1) {
                ((ph) this).b(u.a(-816856703, param0));
                return;
            }
            ((ph) this).field_w = null;
