    ...
    final static fc a(int param0, String param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("pi.B(").append(param0).append(',');
    ...
    final static byte[] a(byte param0, byte[] param1) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param0 == -29) {
                ...
                var4 = (String) null;
                discarded$2 = pi.a(-109, (String) null);
                break L1;
              }
            }
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("pi.C(").append(param0).append(',');
