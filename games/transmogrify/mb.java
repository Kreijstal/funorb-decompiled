...
final class mb {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_k[var16]) {
                  var9 = field_c[var16];
                  var10 = field_d[var16] * this.field_b;
    ...
    final boolean b() {
        ...
        for (var6 = 0; var6 < this.field_l.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = ml.field_y[this.field_j[var7]].c();
            }
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_i[var7]) {
                              ...
                              var5++;
                              this.field_f[incrementValue$2] = ml.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
