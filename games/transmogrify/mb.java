...
final class mb {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((mb) this).field_f.length;
        var4 = field_h[((mb) this).field_b - 1];
        var5 = field_k;
        field_k[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_d[0] * ((mb) this).field_b;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_k[var16]) {
                  var9 = field_c[var16];
                  var10 = field_d[var16] * ((mb) this).field_b;
            ...
            L3: {
              var7 = mb.a(field_c, var6);
              var8_int = mb.b(field_c, var6);
              var9 = this.a(field_c[var7], field_d[var7], field_c[var8_int], field_d[var8_int], field_c[var6]);
              var10 = field_d[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
            ...
            if (var10 == 0) {
              ...
              var14 = field_k;
              var15 = var7;
              field_k[var8_int] = true;
              var14[var15] = true;
              field_k[var6] = true;
              if (var10 < var13) {
                L4: {
                  stackOut_11_0 = (int[]) field_d;
                  stackOut_11_1 = var6;
        ...
        if (param0 < param1) {
          ...
          L0: while (true) {
            if (var7 > param1) {
              ...
              if (var8 < var4) {
                field_c[var3] = var8;
                field_d[var3] = field_d[var7];
                field_k[var3] = field_k[var7];
                var3++;
                field_c[var7] = field_c[var3];
                field_d[var7] = field_d[var3];
                field_k[var7] = field_k[var3];
                var7++;
                continue L0;
              } else {
                var7++;
    ...
    final boolean b() {
        ...
        int var2 = ((mb) this).field_f.length;
        System.arraycopy((Object) (Object) ((mb) this).field_f, 0, (Object) (Object) field_c, 0, var2);
        int var3 = field_h[((mb) this).field_b - 1];
        int var4 = qg.a((byte) 117, var3 - 1);
        field_d[0] = ml.f(var4);
        field_d[1] = ml.f(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((mb) this).field_l.length; var6++) {
            var7 = ((mb) this).field_l[var6];
            var8 = ((mb) this).field_i[var7];
            var9 = ((mb) this).field_a[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ml.field_y[((mb) this).field_j[var7]].c();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((mb) this).field_g[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_d[incrementValue$0] = var13 >= 0 ? ml.field_y[var13].c() : 0;
            }
        }
        return true;
    }
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_e[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_e[var11];
        }
    }
    ...
    mb() {
        ...
        if (var1 == 1) {
          var2 = ml.f(5);
          var3 = 0;
          ((mb) this).field_l = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((mb) this).field_i = new int[var3];
              ((mb) this).field_a = new int[var3];
              ((mb) this).field_j = new int[var3];
              ((mb) this).field_g = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((mb) this).field_b = ml.f(2) + 1;
                  var4 = ml.f(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((mb) this).field_f = new int[var5];
                      ((mb) this).field_f[0] = 0;
                      ((mb) this).field_f[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((mb) this).field_i[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((mb) this).field_f[incrementValue$2] = ml.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((mb) this).field_i[((mb) this).field_l[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((mb) this).field_i[var4] = ml.f(3) + 1;
                    int dupTemp$3 = ml.f(2);
                    ((mb) this).field_a[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((mb) this).field_j[var4] = ml.f(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
