                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$0 = field_E.append('<');
                        discarded$1 = field_E.append(var15);
                        discarded$2 = field_E.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$3 = field_E.append((char) var14);
                                        ...
                                        L2: {
                                          ...
                                          L5: {
                                            ...
                                            if (this.field_B == null) {
                                              stackIn_32_0 = var16_ref_k.field_h;
                                              break L5;
                                            } else {
                                              stackIn_32_0 = this.field_B[var15];
                                              break L5;
                                            }
                                          }
                                          L6: {
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            if (this.field_B == null) {
                                              stackIn_26_0 = var11_ref_k.field_h;
                                              break L3;
                                            } else {
                                              stackIn_26_0 = this.field_B[var10];
                                              break L3;
                                            }
                                          }
                                          L4: {
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                ...
                var2++;
                this.field_x[var3_int] = param0[incrementValue$6] & 255;
                var3_int++;
                continue L1;
              }
            }
