 ...
 */
abstract class kg extends ri {
    private byte[] field_p;
    private int[] field_x;
    private k[] field_A;
    int field_y;
    private static StringBuilder field_E;
    private int[] field_z;
    private int[] field_G;
    int field_D;
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = ub.a(field_E, 117, ' ', 0);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
                ...
                case 8: {
                    ...
                    var9 = -1;
                    StringBuilder discarded$11 = field_E.append(60);
                    StringBuilder discarded$12 = field_E.append(var15);
                    StringBuilder discarded$13 = field_E.append(62);
                ...
                case 9: {
                    param2[var11] = field_E.toString().substring(var5, field_E.length());
                    var11++;
                    var5 = field_E.length();
                    var4 = 0;
                    var6 = -1;
                ...
                case 58: {
                    StringBuilder discarded$14 = field_E.append(var14);
                ...
                case 70: {
                    param2[var11] = field_E.toString().substring(var5, var6 - var8);
                    var11++;
                    var5 = var6;
                    var6 = -1;
                    var4 = var4 - var7;
    ...
    final void a(String param0, int param1, int param2, int[] param3, int[] param4) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 35: {
                    try {
                        param1 = param1 + var16_ref_k.field_d;
                        var7 = 0;
                        statePc = 36;
                        continue stateLoop;
    ...
    private final void b(String param0, int param1, int param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_k.field_d;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
                    } catch (Throwable stateCaught_29) {
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    L6: {
                      if (var15 != var13 - 1) {
                        this.a(field_s[var15], param3);
                        this.b(field_s[var15], param1, var14);
                        field_l = 0;
                        break L6;
                      } else {
                        this.b(field_s[var15], param1, var14);
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                ...
                var2++;
                ((kg) this).field_x[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
    ...
    kg(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((kg) this).field_C = 0;
