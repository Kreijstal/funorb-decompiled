...
final class nb {
    ...
    final static void a(int param0, gh param1, int param2) {
        ...
        try {
            ...
            throw ch.a((Throwable) (Object) runtimeException, "nb.B(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 41);
        }
    }
    ...
    final static e a(boolean param0, hj param1) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_23_1 = new StringBuilder().append("nb.A(").append(param0).append(44);
