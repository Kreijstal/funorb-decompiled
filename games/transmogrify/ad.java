...
final class ad {
    ...
    private final boolean b(byte param0, char[] param1) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_26_1 = new StringBuilder().append("ad.E(").append(-119).append(',');
    ...
    private final int a(int param0, int param1, byte param2, byte[][] param3) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (var5_int <= var6) {
                ...
                var7 = am.field_q.i(17783);
                if (var7 == 0) {
                  var6 = var6 + (am.field_q.i(17783) - -1);
                  continue L2;
                } else {
                  var6++;
                  continue L2;
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("ad.H(").append(0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_15_0 = stackOut_13_0;
            stackIn_15_1 = stackOut_13_1;
    ...
    private final int a(int param0, char[] param1) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_14_1 = new StringBuilder().append("ad.J(").append(0).append(',');
            stackIn_16_0 = stackOut_14_0;
            stackIn_16_1 = stackOut_14_1;
            stackIn_15_0 = stackOut_14_0;
            stackIn_15_1 = stackOut_14_1;
          ...
          throw ch.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + ',' + -118 + ')');
        }
        return stackIn_13_0;
    }
    ...
    final static void a(jc param0, int param1, int param2, ci param3) {
        try {
            ...
            throw ch.a((Throwable) (Object) runtimeException, "ad.I(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ',' + 22313 + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
