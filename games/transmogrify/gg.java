...
final class gg {
    ...
    final static void a(byte param0, int[] param1, boolean param2, boolean param3, e param4, boolean param5, int[] param6) {
        ...
        try {
                ...
                L4: while (true) {
                  L5: {
                    if (var18 >= param4.field_l) {
                      ...
                      stackOut_59_0 = ~var18;
                      stackOut_59_1 = ~mk.field_w.length;
                  ...
                  ej.a(var8, (byte) -128, param4, false, var7_int);
                  break L0;
                }
              } else {
                L6: {
          ...
          L8: {
            ...
            stackOut_67_1 = new StringBuilder().append("gg.E(").append(119).append(',');
          ...
          L9: {
            ...
            stackOut_71_1 = ((StringBuilder) (Object) stackIn_71_1).append(stackIn_71_2).append(',').append(true).append(',').append(false).append(',');
          ...
          throw ch.a((Throwable) (Object) stackIn_79_0, stackIn_79_2 + ')');
        }
    }
    ...
    final static void b() {
        try {
            ...
            throw ch.a((Throwable) (Object) runtimeException, "gg.D(" + 4 + ')');
        }
    }
