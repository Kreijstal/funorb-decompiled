...
final class ml extends wf {
    ...
    final static int a() {
        int var0 = field_I[field_j] >> field_v & 1;
        field_v = field_v + 1;
        field_j = field_j + (field_v >> 3);
        field_v = field_v & 7;
        return var0;
    }
    ...
    private final static boolean a(ci param0) {
        byte[] var1 = null;
        if (!field_x) {
            var1 = param0.a((byte) -93, 0, 0);
            if (var1 == null) {
                return false;
            }
            ml.b(var1);
          ...
          if (var17_int >= var14.field_b) {
            L10: {
              if (var15 != 0) {
                ...
                field_N[var18_int].a(field_K, var4 >> 1);
                break L10;
              }
            }
            L11: {
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = dj.a(true, var10, var11);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    final static int f(int param0) {
        ...
        while (param0 >= 8 - field_v) {
            var3 = 8 - field_v;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_I[field_j] >> field_v & var4) << var2);
            field_v = 0;
            field_j = field_j + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_I[field_j] >> field_v & var3) << var2);
    ...
    final static ml a(ci param0, String param1, String param2) {
        try {
            ml var4_ref = null;
            if (!ml.a(param0)) {
                param0.a((byte) 35, param2, param1);
                return null;
            }
