...
final class oj {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_g, 0, field_h, 0, var2);
        int var3 = field_a[this.field_k - 1];
        ...
        for (var6 = 0; var6 < this.field_e.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = sf.field_F[this.field_c[var7]].c();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = this.field_b[var7][var11 & var10];
                var11 = var11 >>> var9;
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_i[var7]) {
                              ...
                              incrementValue$0 = var5;
                              var5++;
                              this.field_g[incrementValue$0] = sf.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_i[this.field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    this.field_i[var4] = sf.f(3) + 1;
                    dupTemp$1 = sf.f(2);
                    this.field_j[var4] = dupTemp$1;
                    var5 = dupTemp$1;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      this.field_c[var4] = sf.f(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_d[var16]) {
                  var9 = field_h[var16];
                  var10 = field_f[var16] * this.field_k;
