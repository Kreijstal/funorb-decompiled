...
final class oj {
    ...
    final boolean b() {
        ...
        int var2 = ((oj) this).field_g.length;
        System.arraycopy((Object) (Object) ((oj) this).field_g, 0, (Object) (Object) field_h, 0, var2);
        int var3 = field_a[((oj) this).field_k - 1];
        int var4 = nf.a(var3 - 1, true);
        field_f[0] = sf.f(var4);
        field_f[1] = sf.f(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((oj) this).field_e.length; var6++) {
            var7 = ((oj) this).field_e[var6];
            var8 = ((oj) this).field_i[var7];
            var9 = ((oj) this).field_j[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = sf.field_F[((oj) this).field_c[var7]].c();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((oj) this).field_b[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_f[incrementValue$0] = var13 >= 0 ? sf.field_F[var13].c() : 0;
            }
        }
        return true;
    }
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_l[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_l[var11];
        }
    }
    ...
    oj() {
        ...
        if (var1 == 1) {
          var2 = sf.f(5);
          var3 = 0;
          ((oj) this).field_e = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((oj) this).field_i = new int[var3];
              ((oj) this).field_j = new int[var3];
              ((oj) this).field_c = new int[var3];
              ((oj) this).field_b = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((oj) this).field_k = sf.f(2) + 1;
                  var4 = sf.f(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((oj) this).field_g = new int[var5];
                      ((oj) this).field_g[0] = 0;
                      ((oj) this).field_g[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((oj) this).field_i[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((oj) this).field_g[incrementValue$2] = sf.f(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((oj) this).field_i[((oj) this).field_e[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((oj) this).field_i[var4] = sf.f(3) + 1;
                    int dupTemp$3 = sf.f(2);
                    ((oj) this).field_j[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((oj) this).field_c[var4] = sf.f(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((oj) this).field_g.length;
        var4 = field_a[((oj) this).field_k - 1];
        var5 = field_d;
        field_d[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_f[0] * ((oj) this).field_k;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_d[var16]) {
                  var9 = field_h[var16];
                  var10 = field_f[var16] * ((oj) this).field_k;
            ...
            L3: {
              var7 = oj.b(field_h, var6);
              var8_int = oj.a(field_h, var6);
              var9 = this.a(field_h[var7], field_f[var7], field_h[var8_int], field_f[var8_int], field_h[var6]);
              var10 = field_f[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
            ...
            if (var10 == 0) {
              ...
              var14 = field_d;
              var15 = var7;
              field_d[var8_int] = true;
              var14[var15] = true;
              field_d[var6] = true;
              if (var10 < var13) {
                L4: {
                  stackOut_11_0 = (int[]) field_f;
                  stackOut_11_1 = var6;
