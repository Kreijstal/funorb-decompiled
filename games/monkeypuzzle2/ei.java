...
final class ei {
    ...
    final static cd a(java.applet.Applet param0, byte param1) {
        ...
        try {
                ...
                L2: {
                  L3: {
                    if (var5 >= var4.length) {
                      ...
                      var6 = var4[var5];
                      stackOut_7_0 = (cd) (var6);
                      stackIn_14_0 = stackOut_7_0;
                      stackIn_8_0 = stackOut_7_0;
                      if (var7 != 0) {
                        break L2;
                      } else {
                        if (((cd) (Object) stackIn_8_0).a(var2, -1)) {
                          stackOut_10_0 = (cd) (var6);
          ...
          L4: {
            ...
            stackOut_15_1 = new StringBuilder().append("ei.A(");
    ...
    public static void a(int param0) {
        ...
        if (param0 != -22787) {
          var2 = (ud) null;
          discarded$2 = ei.a((ad) null, (byte) 11, (ud) null, 44, -94);
          field_b = null;
          return;
        } else {
          field_b = null;
