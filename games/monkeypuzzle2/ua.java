...
class ua extends we implements ga {
    ...
    private final void b(Hashtable param0, int param1, StringBuilder param2, int param3) {
        ...
        try {
          ...
          throw la.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + ',' + 13467 + ')');
        }
    }
    ...
    final boolean a(int param0, int param1, int param2, int param3, we param4, int param5, int param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("ua.H(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
            stackIn_14_0 = stackOut_12_0;
    ...
    final void a(int param0, int param1, we param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("ua.I(").append(param0).append(',').append(param1).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
    ...
    final boolean a(int param0, we param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_15_1 = new StringBuilder().append("ua.F(").append(param0).append(',');
    ...
    final boolean a(byte param0, we param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_20_1 = new StringBuilder().append("ua.RB(").append(param0).append(',');
