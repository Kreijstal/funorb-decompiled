...
final class tb extends ta {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  tb.a(ge.field_i, ((tb) this).field_G[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  vk.a(ge.field_i, ((tb) this).field_G[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
    ...
    tb(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((tb) this).field_G = new byte[256][];
        ((tb) this).field_G = tb.a(param5, param6);
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  tb.a(ge.field_i, ((tb) this).field_G[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  vk.a(ge.field_i, ((tb) this).field_G[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
