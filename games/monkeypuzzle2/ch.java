    ...
    final void a(byte[] param0, int param1, byte param2, int param3) throws IOException {
        ...
        try {
          ...
          L17: {
            ...
            stackOut_52_1 = new StringBuilder().append("ch.C(");
    ...
    final void a(byte[] param0, int param1, int param2, byte param3) throws IOException {
        ...
        try {
                          ...
                          if ((param1 ^ -1) >= (this.field_k.length ^ -1)) {
                            ...
                            L8: while (true) {
                              if (param1 <= 0) {
                                ...
                                stackOut_20_0 = 0;
                                stackOut_20_1 = var9_int ^ -1;
                                stackIn_61_0 = stackOut_20_0;
                                stackIn_61_1 = stackOut_20_1;
          ...
          L20: {
            ...
            stackOut_65_1 = new StringBuilder().append("ch.H(");
    ...
    private final void b(byte param0) throws IOException {
        ...
        L0: {
          ...
          if (param0 == -109) {
            ...
            var8 = (String) null;
            discarded$1 = ch.a((String) null, 104);
            break L0;
          }
        }
        L1: {
    ...
    final static rb a(String param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_24_1 = new StringBuilder().append("ch.I(");
