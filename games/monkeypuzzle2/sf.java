...
final class sf extends ug {
    ...
    final static int f(int param0) {
        ...
        while (param0 >= 8 - field_r) {
            var3 = 8 - field_r;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_H[field_I] >> field_r & var4) << var2);
            field_r = 0;
            field_I = field_I + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_H[field_I] >> field_r & var3) << var2);
    ...
    private final static boolean a(ad param0) {
        byte[] var1 = null;
        if (!field_C) {
            var1 = param0.b(255, 0, 0);
            if (var1 == null) {
                return false;
            }
            sf.a(var1);
          ...
          L5: {
            ...
            if (var3 == 0) {
              ...
              if (var5 != 0) {
                ...
                var8 = (var4 >> 2) - (field_z >> 2);
                var9 = (var4 >> 2) + (field_z >> 2);
                var10 = field_z >> 1;
                break L4;
              }
            }
          ...
          L7: {
            if (var3 == 0) {
              ...
              if (var6 != 0) {
                ...
                var11 = var4 - (var4 >> 2) - (field_z >> 2);
                var12 = var4 - (var4 >> 2) + (field_z >> 2);
                var13 = field_z >> 1;
                break L6;
              }
            }
          ...
          if (var17_int >= var14.field_c) {
            L10: {
              if (var15 != 0) {
                ...
                field_h[var18_int].a(field_w, var4 >> 1);
                break L10;
              }
            }
            L11: {
              ...
              if (var7 == null) {
                ...
                L6: while (true) {
                  if (var5 >= var4) {
                    ...
                    var3++;
                    this.field_v[incrementValue$0] = (byte)(var6 - 128);
                    var5++;
                    continue L6;
                  }
                }
    ...
    final static int b() {
        int var0 = field_H[field_I] >> field_r & 1;
        field_r = field_r + 1;
        field_I = field_I + (field_r >> 3);
        field_r = field_r & 7;
        return var0;
    }
    ...
    private sf(byte[] param0) throws IOException {
        this.b(param0);
    }
