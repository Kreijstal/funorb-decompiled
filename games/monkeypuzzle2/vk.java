...
final class vk extends ta {
            ...
            if (param4 > 0) {
              L5: {
                if (ge.field_c == null) {
                  ...
                  vk.a(ge.field_i, this.field_G[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, ge.field_c, ge.field_l);
                  break L5;
                }
              }
              return;
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        int var13 = 0;
        int var9 = param1 + param2 * ge.field_h;
        int var10 = ge.field_h - param3;
        int var11 = 0;
        int var12 = 0;
        if (param2 < ge.field_f) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$0] == 0) {
                  ...
                  param8++;
                  ge.field_i[incrementValue$1] = param6;
                  var20++;
                  continue L3;
                }
              }
