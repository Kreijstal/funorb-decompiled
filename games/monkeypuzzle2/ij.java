...
final class ij extends va {
    ...
    final int a() {
        return this.field_y - (this.field_x.available() >> (field_n ? 2 : 1));
    }
    ...
    final void a(int param0) throws javax.sound.sampled.LineUnavailableException {
        ...
        try {
            var2 = new javax.sound.sampled.DataLine.Info(javax.sound.sampled.SourceDataLine.class, this.field_v, param0 << (field_n ? 2 : 1));
