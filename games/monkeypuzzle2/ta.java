...
abstract class ta extends bf {
                                      ...
                                      try {
                                        L2: {
                                          L3: {
                                            ...
                                            var11_ref_bh = this.field_B[var10];
                                          ...
                                          L4: {
                                            var12 = stackIn_26_0;
                                            if (field_w != 256) {
                                              var11_ref_bh.a(param1, param2 + this.field_t - var12, field_w);
                                              break L4;
                                            } else {
                                              var11_ref_bh.a(param1, param2 + this.field_t - var12);
                                              break L4;
                                            }
                                          }
              ...
              if (var4 == -1) {
                    ...
                    if (field_w != 256) {
                      L8: {
                        if (field_F == -1) {
                          ...
                          this.a(var8, param1 + this.field_r[var8] + 1, param2 + this.field_i[var8] + 1, var9, var10, field_F, field_w, true);
                          break L8;
                        }
                      }
                      this.a(var8, param1 + this.field_r[var8], param2 + this.field_i[var8], var9, var10, field_y, field_w, false);
                      break L7;
                    } else {
                      L9: {
                        if (field_F == -1) {
                          ...
                          this.a(var8, param1 + this.field_r[var8] + 1, param2 + this.field_i[var8] + 1, var9, var10, field_F, true);
                          break L9;
                        }
                      }
                      this.a(var8, param1 + this.field_r[var8], param2 + this.field_i[var8], var9, var10, field_y, false);
                      break L7;
                    }
                  }
                }
                L10: {
                  ...
                  if (field_x == -1) {
                    ...
                    ge.a(var11, param2 + (int)((double)this.field_t * 0.7), param1 - var11, field_x);
                    break L10;
                  }
                }
                L11: {
                  if (field_o == -1) {
                    ...
                    ge.a(var11, param2 + this.field_t + 1, param1 - var11, field_o);
                    break L11;
                  }
                }
                var5 = var8;
          ...
          if (var6 >= var5) {
            L1: {
              if (var3 <= 0) {
                ...
                field_p = (param1 - this.a(param0) << 8) / var3;
                break L1;
              }
            }
            return;
    ...
    final int a(char param0) {
        return this.field_n[m.a(1, param0) & 255];
    }
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        var17 = null;
        if (param0 != null) {
          discarded$5 = od.a(field_m, 0, -118, ' ');
          var4 = 0;
          var5 = 0;
          var6 = -1;
          var7 = 0;
                  ...
                  if (var14 != 62) {
                    ...
                    if (var9 == -1) {
                      ...
                      L3: {
                        ...
                        var9 = -1;
                        discarded$6 = field_m.append('<');
                        discarded$7 = field_m.append(var15);
                        discarded$8 = field_m.append('>');
                        if (!var15.equals("br")) {
                          if (!var15.equals("lt")) {
                            if (!var15.equals("gt")) {
                                          ...
                                          if (!var15.startsWith("img=")) {
                                            ...
                                            try {
                                              L4: {
                                                ...
                                                var4 = var4 + this.field_B[var16_int].field_c;
                                                var10 = 0;
                                                break L4;
                                              }
                                            } catch (java.lang.Exception decompiledCaughtParameter0) {
                ...
                if (var9 == -1) {
                  L14: {
                    if (var14 == 0) {
                      ...
                      L15: {
                        discarded$9 = field_m.append((char) var14);
              ...
              if (param8 != 0) {
                if (param8 != 1) {
                  if (param8 != 2) {
                    ...
                    this.b(field_z[var15], param1 + param3 - this.a(field_z[var15]), var14);
                    var14 = var14 + param10;
                    var15++;
                    continue L5;
                  }
                } else {
                  this.b(field_z[var15], param1 + (param3 - this.a(field_z[var15])) / 2, var14);
                  var14 = var14 + param10;
                  var15++;
                  continue L5;
                }
                                      ...
                                      if (var8.startsWith("img=")) {
                                        try {
                                          L2: {
                                            ...
                                            var4 = var4 + this.field_B[var9_int].field_c;
                                            var3 = 0;
                                            var6++;
                                            break L2;
                                          }
    ...
    final int b(String param0, int param1) {
        ...
        int var5 = 0;
        int var6 = 0;
        var3 = this.a(param0, new int[]{param1}, field_z);
        var4 = 0;
        var5 = 0;
        L0: while (true) {
          if (var5 >= var3) {
                          ...
                          if (var6_int >= 256) {
                            ...
                            L5: while (true) {
                              if (var7 >= 256) {
                                ...
                                L6: while (true) {
                                  if (var7 >= 256) {
                                    this.field_t = var17[32] + var14[32];
                                    break L0;
                                  } else {
                                    if (var7 != 32) {
                                      if (var7 != 160) {
                                        ...
                                        L7: while (true) {
                                          if (var8 < 256) {
                                            if (var8 != 32) {
                                              if (var8 != 160) {
                                                this.field_A[(var7 << 8) + var8] = (byte)ta.a(var15, var16, var17, this.field_n, var14, var7, var8);
                                                var8++;
                                                continue L7;
                                              } else {
                                                var8++;
    ...
    ta(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        ...
        L0: while (true) {
          if (var8 >= 256) {
            this.field_C = this.field_t - var6;
            this.field_D = var7 - this.field_t;
            this.field_j = this.field_t - this.field_i[88];
            return;
          } else {
            L1: {
