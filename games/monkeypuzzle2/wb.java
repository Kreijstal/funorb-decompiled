...
final class wb {
    ...
    final int c() {
        ...
        while (this.field_f[var1] >= 0) {
            var1 = sf.b() != 0 ? this.field_f[var1] : var1 + 1;
        }
    ...
    wb() {
        ...
        L0: {
          discarded$2 = sf.f(24);
          this.field_e = sf.f(16);
          this.field_b = sf.f(24);
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_b) {
                ...
                var4_int = sf.f(nf.a(this.field_b - var2, true));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
          ...
          if (var2 <= 0) {
            ...
            L9: {
              ...
              if (var2 != 1) {
                ...
                var7 = wb.a(this.field_b, this.field_e);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_d = new float[this.field_b][this.field_e];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
