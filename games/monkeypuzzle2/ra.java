...
final class ra extends pc {
    ...
    final void c(byte param0, we param1) {
        try {
            ...
            throw la.a((Throwable) (Object) runtimeException, "ra.C(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final static int a(byte param0, CharSequence param1) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var2_int <= var4) {
                ...
                var3 = m.a(1, param1.charAt(var4)) + (-var3 + (var3 << 5));
                var4++;
                continue L1;
              }
            }
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ra.J(").append(param0).append(44);
