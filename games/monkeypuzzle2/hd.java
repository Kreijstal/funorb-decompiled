    ...
    public final void a(boolean param0, we param1, int param2, int param3, int param4) {
        ...
        try {
          L0: {
            ...
            var8 = stackIn_16_0;
            if (param4 > 19) {
              discarded$1 = this.field_p.a(param1.field_s, param1.field_r + param3, param2 + (param1.field_e + -2), param1.field_l, param1.field_p, var8, -1, 1, 1, this.field_p.field_C);
