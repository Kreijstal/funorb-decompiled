    ...
    final static String a(boolean param0, CharSequence param1, int param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_20_1 = new StringBuilder().append("wg.H(").append(param0).append(',');
    ...
    final static int a(boolean param0, CharSequence param1, char param2) {
        ...
        try {
                ...
                L2: {
                  L3: {
                    if (var5 >= var4) {
                      ...
                      stackIn_11_0 = param2 ^ -1;

                      if (var6 != 0) {
                        break L2;
                      } else {
                        L4: {
                          if (stackIn_11_0 != (param1.charAt(var5) ^ -1)) {
                            break L4;
                          } else {
                            var3_int++;
                            break L4;
          ...
          L5: {
            ...
            stackIn_14_1 = new StringBuilder().append("wg.B(").append(param0).append(',');
