...
final class ud {
    ...
    private final td a(int param0, int[] param1, String param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("ud.F(").append(param0).append(44);
    ...
    private final td a(byte param0, int param1, int[] param2, int param3) {
        ...
        try {
          L0: {
            var5_int = (param3 >>> 12 | param3 << 4 & 65528) ^ param1;
            ...
            if (var8 != null) {
              ...
              var9 = g.a(((ud) this).field_c, param3, param1);
              if (var9 != null) {
                L2: {
                  var11 = var9.b();
                  var8 = var11;
                  ((ud) this).field_f.a((ug) (Object) var8, var6, (byte) -36);
                  if (param2 == null) {
                    break L2;
                  } else {
          ...
          L3: {
            ...
            stackOut_15_1 = new StringBuilder().append("ud.D(").append(param0).append(44).append(param1).append(44);
          ...
          throw la.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + 44 + param3 + 41);
        }
        return stackIn_14_0;
    }
    ...
    private final td a(int[] param0, int param1, int param2, int param3) {
        ...
        try {
          L0: {
            var5_int = (param3 << 4 & 65526 | param3 >>> 12) ^ param2;
            var5_int = var5_int | param3 << 16;
            ...
            if (var8 == null) {
              ...
              L2: {
                ...
                if (var9 == null) {
                  var9 = sf.a(((ud) this).field_h, param3, param2);
                  if (var9 != null) {
                    ((ud) this).field_g.a((ug) (Object) var9, var6, (byte) -36);
                    break L2;
                  } else {
                    return null;
                  }
          ...
          L3: {
            ...
            stackOut_18_1 = new StringBuilder().append("ud.H(");
          ...
          throw la.a((Throwable) (Object) stackIn_21_0, stackIn_21_2 + 44 + 34 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_17_0;
    }
    ...
    private final td a(int param0, String param1, int[] param2, String param3) {
        ...
        try {
          L0: {
            var5_int = ((ud) this).field_c.c(param1, (byte) -105);
            if (var5_int >= 0) {
              var6 = ((ud) this).field_c.a(param3, var5_int, -28459);
              if (var6 >= 0) {
                stackOut_6_0 = this.a((byte) 13, var6, param2, var5_int);
                stackIn_7_0 = stackOut_6_0;
                break L0;
              } else {
                stackOut_4_0 = null;
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("ud.E(").append(1620678500).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    ud(ad param0, ad param1) {
        ...
        try {
            ...
            throw la.a((Throwable) (Object) runtimeException, "ud.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
