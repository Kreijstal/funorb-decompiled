...
final class dm {
    ...
    final void a(gk param0) {
        ...
        for (var3 = 0; var3 < 10; var3++) {
            ...
            this.field_v[var3] = param0.h(-129);
            this.field_o[var3] = param0.o(-1);
        }
        this.field_m = param0.o(-1);
        this.field_d = param0.o(-1);
        this.field_i = param0.j(17277);
        this.field_h = param0.j(17277);
        this.field_j = new lj();
        this.field_x = new dg();
        this.field_j.a(param0, this.field_x);
    }
        ...
        if (param1 >= 10) {
          L0: {
            ...
            if (this.field_k == null) {
              ...
              this.field_k.a();
              this.field_c.a();
              var5 = (int)((double)(this.field_k.field_d - this.field_k.field_j) * 32.768 / var3);
              var6 = (int)((double)this.field_k.field_j * 32.768 / var3);
              break L0;
            }
          }
          L1: {
            ...
            if (this.field_n == null) {
              ...
              this.field_n.a();
              this.field_y.a();
              var8 = (int)((double)(this.field_n.field_d - this.field_n.field_j) * 32.768 / var3);
              var9 = (int)((double)this.field_n.field_j * 32.768 / var3);
              break L1;
            }
          }
          var11 = 0;
          L2: while (true) {
            if (var11 >= 5) {
                ...
                if (var11 >= param0) {
                      ...
                      L5: while (true) {
                        if (var14 >= param0) {
                          ...
                          L6: {
                            ...
                            if (var13 == 0) {
                              var12 = this.field_e.field_j + ((this.field_e.field_d - this.field_e.field_j) * var16 >> 8);
                              break L6;
                            } else {
                              var12 = this.field_e.field_j + ((this.field_e.field_d - this.field_e.field_j) * var15 >> 8);
                              break L6;
                            }
                          }
                          L7: {
                      ...
                      if (this.field_d <= 0) {
                        ...
                        L10: while (true) {
                          if (var12 >= param0) {
                            ...
                            field_w[var12] = field_w[var12] + field_w[var12 - var11] * this.field_d / 100;
                            var12++;
                            continue L10;
                          }
                        }
                  ...
                  L27: {
                    ...
                    if (this.field_k == null) {
                      ...
                      var12 = var12 + (this.a(var7, var15, this.field_k.field_f) >> 1);
                  ...
                  L28: {
                    if (this.field_n == null) {
                      ...
                      var13 = var13 * ((this.a(var10, var15, this.field_n.field_f) >> 1) + 32768) >> 15;
                  ...
                  L29: while (true) {
                    if (var14 < 5) {
                      if (this.field_q[var14] != 0) {
                        ...
                        if (var15 < param0) {
                          field_w[var15] = field_w[var15] + this.a(field_g[var14], var13 * field_t[var14] >> 15, this.field_f.field_f);
              ...
              if (this.field_q[var11] != 0) {
                field_g[var11] = 0;
                field_s[var11] = (int)((double)this.field_o[var11] * var3);
                field_t[var11] = (this.field_q[var11] << 14) / 100;
                field_u[var11] = (int)((double)(this.field_f.field_d - this.field_f.field_j) * 32.768 * Math.pow(1.0057929410678534, (double)this.field_v[var11]) / var3);
                field_p[var11] = (int)((double)this.field_f.field_j * 32.768 / var3);
                var11++;
                continue L2;
              } else {
                var11++;
