...
class va {
                    ...
                    try {
                      L2: {
                        L3: {
                          ...
                          if (!field_n) {
                            stackIn_11_0 = (ij) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_a <= 0) {
                            ...
                            if (field_g != null) {
                              ...
                              param0.a((Runnable) ((Object) field_g), field_a, 0);
                              break L5;
                            }
                          }
                        }
        ...
        L1: {
          ...
          if (this.field_b == null) {
            ...
            if (this.field_j > 0) {
              ...
              this.field_j = this.field_j + (field_i >> 4);
              va.a(this.field_b);
              this.a(this.field_b, this.field_b.c());
              var4 = 0;
              var5 = 255;
              var6 = 7;
              L2: while (true) {
                                ...
                                if (var4 < this.field_t) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_p[var7_int] = (fh) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((fh) (var7)).field_g;
                        ((fh) (var7)).field_g = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
        ...
        try {
            ...
            if (!this.field_u) {
              ...
              try {
                L0: {
                  L1: {
                    if (var1 <= this.field_d + 6000L) {
                      break L1;
                    } else {
                      this.field_d = var1 - 6000L;
                      break L1;
                    }
                  }
                  L2: while (true) {
                    if (var1 <= this.field_d + 5000L) {
                      break L0;
                    } else {
                      this.b(256);
                      this.field_d = this.field_d + (long)(256000 / field_i);
                      var1 = pf.a(0);
                      continue L2;
                    }
                  }
              ...
              if (this.field_h != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.a();
                      if (this.field_c - var3_int <= this.field_m) {
                        break L6;
                      } else {
                        this.field_m = this.field_c - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_l + this.field_q;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_k) {
                        ...
                        if (var4 + 256 <= this.field_k) {
                          ...
                          this.field_q = var4 - this.field_l;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_e) {
                            ...
                            L12: {
                              if (this.field_s) {
                                ...
                                this.field_q = Math.min(this.field_r, this.field_m);
                                this.field_r = this.field_m;
                                break L12;
                              }
                            }
                            this.field_m = 0;
    ...
    va() {
        ...
        this.field_t = 32;
        this.field_d = pf.a(0);
        this.field_p = new fh[8];
        this.field_m = 0;
        this.field_r = 0;
        this.field_j = 0;
        this.field_c = 0;
        this.field_o = 0L;
        this.field_f = new fh[8];
        this.field_s = true;
        this.field_e = 0L;
    }
}
