          ...
          if (!((c) this).field_a.field_j) {
            ...
            if (param0 <= -49) {
              ...
              if (var5.length != 65) {
                ...
                L3: while (true) {
                  if (var7 < 64) {
                    stackOut_20_0 = var17[var7];
                    stackIn_22_0 = stackOut_20_0;
                    stackIn_21_0 = stackOut_20_0;
                    if (var8 == 0) {
                      if (stackIn_22_0 != var5[var7 + 1]) {
                        throw new RuntimeException();
                      } else {
                        var7++;
                        continue L3;
                ...
                L5: {
                  if (var2 >= ((c) this).field_g.length) {
                    ...
                    if (var3 != 0) {
                      ...
                      L6: {
                        if (((c) this).field_g[var2] == null) {
                          break L6;
                        } else {
                          ((c) this).field_g[var2].c(16311);
                          break L6;
                        }
                      }
                      var2++;
    ...
    final ca a(int param0, gf param1, int param2, gf param3, boolean param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_14_1 = new StringBuilder().append("c.C(").append(param0).append(44);
