...
final class bm {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            ...
            if (((bm) this).field_b != param0) {
              if (((bm) this).field_b != null) {
                L1: {
                  ((bm) this).field_b.setCursor((java.awt.Cursor) null);
    ...
    public final void movemouse(int param0, int param1) {
        ((bm) this).field_a.mouseMove(param0, param1);
    }
