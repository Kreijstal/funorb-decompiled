...
final class ie {
    ...
    final static byte[] a(int param0, byte[] param1, int param2, int param3) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("ie.A(").append(param0).append(44);
          ...
          throw la.a((Throwable) (Object) stackIn_13_0, stackIn_13_2 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_9_0;
    }
    ...
    final int a(boolean param0, int param1) {
        ...
        var3 = -1 + (((ie) this).field_a.length >> 1);
        var4 = var3 & param1;
        L1: while (true) {
    ...
    ie(int[] param0) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (param0.length - -(param0.length >> 1) < var2_int) {
                ((ie) this).field_a = new int[var2_int + var2_int];
                var3 = 0;
                L2: while (true) {
                  if (var3 >= var2_int + var2_int) {
                    ...
                    L3: while (true) {
                      if (param0.length <= var3) {
                        ...
                        L4: while (true) {
                          if (((ie) this).field_a[1 + (var4 + var4)] == -1) {
          ...
          L5: {
            ...
            stackOut_14_1 = new StringBuilder().append("ie.<init>(");
