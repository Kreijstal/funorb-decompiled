...
final class jk extends gn {
    ...
    final static void a(int param0) {
        ...
        L1: {
          var1 = -pq.field_Q.field_o + gp.field_i;
          var2 = hq.field_d;
          if (param0 == 16777215) {
            break L1;
          } else {
        ...
        L2: {
          pq.field_Q.b(var1, var2, al.a(false, (byte) 51));
          if (tb.field_w != null) {
            pt.a(1 + var1 - -jt.field_yb, param0 ^ -16754303, 1 + var1, 1 + var2 - -om.field_Bb, 1 + var2);
            var3_int = 0;
            L3: while (true) {
              if (2 <= var3_int) {
                L4: {
                  var3 = (ob) (Object) tb.field_w.field_V;
                  var4 = var3.field_N >> -2049910736;
                  var5 = var3.field_E >> -563529040;
                  if (tb.field_w.field_V.field_m == -1) {
                    ...
                    var7 = stackIn_33_0;
                    var5 = (var12.field_bb >> -2061881744) + var12.field_n * var7;
                    var4 = var12.field_j * var7 + (var12.field_kb >> -1986186096);
                    break L4;
                  }
                }
                L6: {
                ...
                var5 = var5 * 23 >> 649663976;
                var4 = var4 * 23 >> 463618504;
                on.d(var4 + (1 + var1), var5 + (var2 + 1), 3, 16777215);
                on.c(var4 + 1 + var1, 1 + (var2 - -var5), 3, 65793);
                ta.e(125);
                break L2;
              } else {
                L7: {
                  if (1 != (mk.field_c ^ -1)) {
                    if ((var3_int ^ -1) != (tb.field_w.field_g[mk.field_c].field_p ^ -1)) {
                      stackOut_15_0 = 0;
                ...
                L8: while (true) {
                  if (var5 >= 5) {
                    ...
                    L9: {
                      ...
                      if (var4 != 0) {
                        stackOut_20_0 = 2271999;
                        stackIn_21_0 = stackOut_20_0;
                        break L9;
                      } else {
                        stackOut_19_0 = 16716032;
                    ...
                    L11: {
                      var8 = var11.field_kb >> 328604976;
                      var9 = var11.field_bb >> 1965186512;
                      if (ia.field_c) {
                        var8 = -var8 + 896;
                        var9 = -var9 + 1344;
                        break L11;
                    ...
                    var9 = 23 * var9 >> -2047353240;
                    var8 = var8 * 23 >> -408104344;
                    on.d(var8 + (var1 + 1), var9 + (1 + var2), 3, var7);
                    on.c(var8 + var1 + 1, var9 + 1 + var2, 3, 65793);
                    var5++;
                    continue L8;
                  }
                }
        ...
        L1: while (true) {
          if (var8 >= 128) {
            ...
            if (0 != var9) {
              L3: {
                if (var6 != var9) {
                  L4: {
                    ...
                    var9--;
                    if (-1 == (var9 & 1 ^ -1)) {
                      var7 = (Object) (Object) param0.b(10, var9 >> -429252126, param1);
                      break L4;
                    } else {
                      var7 = (Object) (Object) param0.a(var9 >> 2095561442, 10, param1);
                      break L4;
                    }
                  }
                  if (var7 != null) {
              ...
              if (var7 != null) {
                ((jk) this).field_l[var8] = (to) var7;
                ((jk) this).field_q[var8] = 0;
                var8++;
                continue L1;
              } else {
                var8++;
          ...
          if (0 == var38.field_f[var3 + var38.field_n]) {
            ...
            L1: while (true) {
              if (var3 <= var5) {
                ...
                var6 = 0;
                L2: while (true) {
                  if ((var38.field_f[var6 + var38.field_n] ^ -1) == -1) {
                    var68 = new byte[var6];
                    var62 = var68;
                    var56 = var62;
                    var43 = var56;
                                                  ...
                                                  if ((var20 ^ -1) <= -129) {
                                                    ...
                                                    L17: while (true) {
                                                      if ((var23 ^ -1) <= -129) {
                                                          ...
                                                          if ((var24 ^ -1) <= -129) {
                                                            ...
                                                            L19: while (true) {
                                                              if (128 <= var25_int) {
                                                                                  ...
                                                                                  if ((var27 ^ -1) <= (var12 ^ -1)) {
                                                                                          ...
                                                                                          if (var70.length <= var27) {
                                                                                            ...
                                                                                            L31: while (true) {
                                                                                              if (var27 <= var29) {
                                                                                                  ...
                                                                                                  if (var70.length <= var29) {
                                                                                                    ...
                                                                                                    L33: while (true) {
                                                                                                      if ((var30 ^ -1) <= -129) {
                                                                                                        ...
                                                                                                        ((jk) this).field_n[var30] = (byte)(var28 * ((jk) this).field_n[var30] - -32 >> -1571724922);
                                                                                                        var30++;
                                                                                                        continue L33;
                                                                                                      }
                                                                                                    }
                                                                                                    ...
                                                                                                    L34: while (true) {
                                                                                                      if (var30 <= var33) {
                                                                                                        ...
                                                                                                        ((jk) this).field_n[var33] = (byte)(var34 * ((jk) this).field_n[var33] - -32 >> -1513466618);
                                                                                                ...
                                                                                                ((jk) this).field_n[var29] = (byte)(((jk) this).field_n[var29] * var28 + 32 >> -1050468218);
                                                                                                var29++;
                                                                                                continue L31;
                                                                                              }
                                                                                            }
                                                                                    ...
                                                                                    L57: {
                                                                                      ...
                                                                                      if (var49.field_m == null) {
                                                                                        ...
                                                                                        var29 = 2;
                                                                                        L58: while (true) {
                                                                                          if ((var49.field_m.length ^ -1) >= (var29 ^ -1)) {
                                                                                            break L57;
                                                                                          } else {
                                                                ...
                                                                L69: {
                                                                  if ((((jk) this).field_q[var25_int] ^ -1) == -1) {
                                                                    break L69;
                                                                  } else {
                                                                    L70: {
                                                                      if (0 != var20) {
                                                        ...
                                                        ((jk) this).field_r[var23] = (short)(((jk) this).field_r[var23] + (qj.b(-1 + var22, 2) << 1724281838));
                                                    ...
                                                    ((jk) this).field_r[var20] = (short)(((jk) this).field_r[var20] + (var19 << 472284776));
                                                    var20++;
                                                    continue L16;
                                                  }
                                                }
