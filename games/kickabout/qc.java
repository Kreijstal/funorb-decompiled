    ...
    private final void a(je param0, db param1, db param2, int param3, int param4, boolean[] param5, boolean param6, boolean param7, int param8, int[] param9) {
        ...
        L17: while (true) {
          if (var11 >= param1.field_i) {
            ...
            if (var14 == 65535) {
              this.a(param0.field_o[var12], param0.field_q[var12], (int) param1.field_c[var11], (int) param1.field_f[var11], (int) param1.field_d[var11], param7);
              var11++;
              continue L17;
            } else {
              this.a(param0.field_o[var12], param0.field_q[var12], (int) param1.field_c[var11], (int) param1.field_f[var11], (int) param1.field_d[var11], param7, var14, param9);
              var11++;
              continue L17;
            }
          }
