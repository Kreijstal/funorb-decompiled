...
final class km {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_e[var16];
                  var10 = field_d[var16] * this.field_l;
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_a, 0, field_e, 0, var2);
        int var3 = field_h[this.field_l - 1];
        int var4 = cm.a(true, var3 - 1);
        field_d[0] = tg.e(var4);
        field_d[1] = tg.e(var4);
        int var5 = 2;
        for (var6 = 0; var6 < this.field_i.length; var6++) {
            var7 = this.field_i[var6];
            var8 = this.field_b[var7];
            var9 = this.field_k[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = tg.field_F[this.field_c[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = this.field_g[var7][var11 & var10];
                var11 = var11 >>> var9;
        ...
        if (var1 == 1) {
          ...
          L0: while (true) {
            if (var4 >= var2) {
              ...
              this.field_c = new int[var3];
              this.field_g = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  this.field_l = tg.e(2) + 1;
                  var4 = tg.e(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ...
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= this.field_b[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              incrementValue$2 = var5;
                              var5++;
                              this.field_a[incrementValue$2] = tg.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_b[this.field_i[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    this.field_b[var4] = tg.e(3) + 1;
                    dupTemp$3 = tg.e(2);
                    this.field_k[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      this.field_c[var4] = tg.e(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
