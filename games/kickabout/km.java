...
final class km {
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_j[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_j[var11];
        }
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((km) this).field_a.length;
        var4 = field_h[((km) this).field_l - 1];
        var5 = field_f;
        field_f[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_d[0] * ((km) this).field_l;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_f[var16]) {
                  var9 = field_e[var16];
                  var10 = field_d[var16] * ((km) this).field_l;
            ...
            L3: {
              var7 = km.b(field_e, var6);
              var8_int = km.a(field_e, var6);
              var9 = this.a(field_e[var7], field_d[var7], field_e[var8_int], field_d[var8_int], field_e[var6]);
              var10 = field_d[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean b() {
        ...
        int var2 = ((km) this).field_a.length;
        System.arraycopy((Object) (Object) ((km) this).field_a, 0, (Object) (Object) field_e, 0, var2);
        int var3 = field_h[((km) this).field_l - 1];
        int var4 = cm.a(true, var3 - 1);
        field_d[0] = tg.e(var4);
        field_d[1] = tg.e(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((km) this).field_i.length; var6++) {
            var7 = ((km) this).field_i[var6];
            var8 = ((km) this).field_b[var7];
            var9 = ((km) this).field_k[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = tg.field_F[((km) this).field_c[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((km) this).field_g[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_d[incrementValue$0] = var13 >= 0 ? tg.field_F[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    km() {
        ...
        if (var1 == 1) {
          var2 = tg.e(5);
          var3 = 0;
          ((km) this).field_i = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((km) this).field_b = new int[var3];
              ((km) this).field_k = new int[var3];
              ((km) this).field_c = new int[var3];
              ((km) this).field_g = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((km) this).field_l = tg.e(2) + 1;
                  var4 = tg.e(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((km) this).field_a = new int[var5];
                      ((km) this).field_a[0] = 0;
                      ((km) this).field_a[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((km) this).field_b[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((km) this).field_a[incrementValue$2] = tg.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((km) this).field_b[((km) this).field_i[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((km) this).field_b[var4] = tg.e(3) + 1;
                    int dupTemp$3 = tg.e(2);
                    ((km) this).field_k[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((km) this).field_c[var4] = tg.e(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
