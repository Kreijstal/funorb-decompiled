    ...
    final static kk a(byte param0, ml param1) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_27_1 = new StringBuilder().append("vi.I(").append(param0).append(44);
    ...
    final static boolean a(int param0, int param1, int[][] param2, byte[] param3) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_20_1 = new StringBuilder().append("vi.H(").append(param0).append(44).append(param1).append(44);
