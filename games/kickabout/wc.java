...
final class wc {
    ...
    private final void a(int param0, int param1, byte param2, String param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("wc.A(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final void a(int param0, byte param1, int param2, String param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("wc.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final void a(hu param0, int param1) {
        hf discarded$10 = null;
        hf discarded$11 = null;
        hf discarded$12 = null;
        hf discarded$13 = null;
        hf discarded$14 = null;
        hf discarded$15 = null;
        ei discarded$16 = null;
        du discarded$17 = null;
        hf discarded$18 = null;
        hf discarded$19 = null;
        ...
        try {
          L0: {
            ...
            this.field_f = -1;
            discarded$10 = var4.a(0, param1 ^ -8811).b(-2, 15658734).a(true, ba.a(7829367, 10066329, 8947848, (byte) -88));
            discarded$11 = var4.a(1, -12085).a(true, ba.a(13421772, 10066329, 11184810, (byte) 46));
            discarded$12 = var4.a(3, -12085).a(true, ba.a(10066329, 7829367, 8947848, (byte) 46)).a((byte) -90, 1).b((byte) 111, 1);
            var5 = new ut[9];
            var16 = new ot(32, 32);
            var18 = var16;
            var7_int = 0;
            L1: while (true) {
              if (var18.field_y.length <= var7_int) {
                if (param1 == 3422) {
                  ...
                  discarded$13 = var4.a(4, -12085).a(true, (byte) 113).a(true, var5);
                  discarded$14 = var4.a(5, -12085).a(true, gl.a(65793, (byte) 115, 0, 0, 0)).a(true, (byte) -90).b(param1 + -3424, -1);
                  ...
                  discarded$15 = var7.a(1, -12085).a(true, sp.a((byte) 26, 11184810)).b(-2, 2236962);
                  this.field_o = (gj) ((Object) new re(param0, 2, 2, 16777215, -1, 5, 5, 15, 15, 4473924));
                  discarded$16 = new ei(param0, 2, 2, 16777215, -1, 16777215, 16729156, 4473924);
                  discarded$17 = new du(param0, 16777215, -1, 125269879, 4473924, 3, 268435455);
                  var8 = new id();
                  var17.a(var8, (byte) -87);
                  discarded$18 = var8.a(0, param1 ^ -8811).a(true, ba.a(10066329, 7829367, 15658734, (byte) -118)).b(-2, 1118481).a(-1, true);
                  discarded$19 = var8.a(4, param1 ^ -8811).a(true, (byte) -58).a(true, var5);
    ...
    private final void a(int param0, String param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            discarded$1 = this.field_a.a(param1, var12 - -this.field_i, this.field_m + var13, var9, var10, this.field_b, -1, 0, 0, var7);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L11: {
            ...
            stackOut_26_1 = new StringBuilder().append("wc.F(").append(param0).append(',');
