                  ...
                  if (5 <= var6) {
                    ...
                    L13: {
                      if (var4 == 0) {
                        ...
                        if ((rf.field_c[0][var6 - -1].field_sb ^ -1) == -1) {
                          break L13;
                        } else {
                          if ((param2.field_Wb ^ -1) != (var6 ^ -1)) {
                            var5 = 1;
                ...
                if (param3) {
                  if ((var7 ^ -1) != 0) {
                    L28: {
                      ...
                      if ((er.field_h[var7 / 8] & 1 << (var7 & 7) ^ -1) == -1) {
                        ...
                        if ((var17.field_sb ^ -1) == -1) {
                          ...
                          if (param3) {
                            ...
                            if (var16 != 0) {
                              ...
                              if ((param2.field_Eb[var7] ^ -1) == ((byte)var9 ^ -1)) {
                                break L63;
                              } else {
                                var5 = 1;
                                  ...
                                  L73: {
                                    ...
                                    if ((var15 ^ -1) >= -1) {
                                      ...
                                      if (um.field_a == null) {
                                        ...
                                        if ((um.field_a.length ^ -1) > (var15 ^ -1)) {
                                          break L73;
                                        } else {
