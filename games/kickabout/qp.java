...
final class qp extends wj implements vh {
    ...
    final void a(int param0, int param1, int param2, int param3) {
        ...
        int discarded$0 = this.field_B.a(this.field_D, 14 + (param2 + this.field_t), 10 + (this.field_g + param3), -28 + this.field_n, this.field_i, 16777215, -1, 0, 0, this.field_B.field_G);
    }
