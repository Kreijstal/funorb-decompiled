...
final class gw {
    ...
    final static String a(int param0, byte param1, iw param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("gw.F(").append(param0).append(',').append(param1).append(',');
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, ut[] param5) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("gw.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',');
    ...
    final static void a(int param0) {
        fb.field_J = new bo(tv.field_e, ai.field_H, hl.field_f, dw.field_e, hs.field_d, ul.field_c);
        if (param0 != 8) {
            field_a = (hd) null;
        }
    }
