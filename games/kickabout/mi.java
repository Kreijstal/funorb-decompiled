    ...
    final static int a(int param0, lk[] param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("mi.A(").append(param0).append(',');
          ...
          throw nb.a((Throwable) (Object) stackIn_14_0, stackIn_14_2 + ',' + 1 + ')');
        }
        return stackIn_10_0;
    }
    ...
    final static boolean a(long param0, String param1, byte param2, int param3, int[] param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_10_1 = new StringBuilder().append("mi.C(").append(param0).append(',');
