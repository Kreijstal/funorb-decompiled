...
final class rs {
    ...
    final void d() {
        this.field_a.field_n = -1;
    }

    final void b(int param0) {
        this.field_b[param0] = this.field_a.field_n;
    }

    final void c(int param0) {
        this.field_a.field_n = this.field_b[param0];
    }

    final long e(int param0) {
        return this.field_f + (long)param0 * (long)this.field_c;
    }

    final void d(int param0) {
        int var2 = this.field_a.l(120);
        this.field_e[param0] = this.field_e[param0] + var2;
    }
    ...
    private final int a(int param0, int param1) {
        ...
        int var4 = 0;
        if (param1 == 255) {
            var3 = this.field_a.h((byte) -117);
            var4 = this.field_a.l(9);
            if (var3 == 47) {
                this.field_a.field_n = this.field_a.field_n + var4;
                return 1;
            }
            if (var3 == 81) {
                var5 = this.field_a.i(-90);
                var4 -= 3;
                var6 = this.field_e[param0];
                this.field_f = this.field_f + (long)var6 * (long)(this.field_c - var5);
                this.field_c = var5;
                this.field_a.field_n = this.field_a.field_n + var4;
                return 2;
            }
        ...
        var4 = param1;
        if (var3 >= 1) {
            var4 = var4 | this.field_a.h((byte) -125) << 8;
        }
        if (var3 >= 2) {
            var4 = var4 | this.field_a.h((byte) -117) << 16;
        }
        return var4;
    }
    ...
    final void a(long param0) {
        ...
        for (var4 = 0; var4 < var3; var4++) {
            this.field_e[var4] = 0;
            this.field_g[var4] = 0;
            this.field_a.field_n = this.field_d[var4];
            this.d(var4);
            this.field_b[var4] = this.field_a.field_n;
        }
    }
    ...
    final void a(byte[] param0) {
        ...
        this.field_a.field_n = 10;
        int var2 = this.field_a.a((byte) 81);
        this.field_h = this.field_a.a((byte) 81);
        this.field_c = 500000;
        this.field_d = new int[var2];
        int var3 = 0;
        while (var3 < var2) {
            var4 = this.field_a.k(4);
            var5 = this.field_a.k(4);
            if (var4 == 1297379947) {
                this.field_d[var3] = this.field_a.field_n;
                var3++;
            }
            this.field_a.field_n = this.field_a.field_n + var5;
        }
        this.field_f = 0L;
    ...
    private final int a(int param0) {
        ...
        L0: {
          ...
          if (var2 >= 0) {
            ...
            this.field_a.field_n = this.field_a.field_n + 1;
            break L0;
          }
        }
        L1: {
        ...
        L2: {
          ...
          if (var2 != 247) {
            ...
            if (var3 <= 0) {
              ...
              L3: {
                L4: {
                  var4 = this.field_a.field_f[this.field_a.field_n] & 255;
                  if (var4 < 241) {
                    break L4;
                  } else {
                    if (var4 <= 243) {
        ...
        this.field_a.field_n = this.field_a.field_n + var3;
        return 0;
    }
