...
final class fl {
            ...
            if (!param1) {
              if (param0 != null) {
                if (((fl) this).field_b == param0) {
                  ...
                  if (((fl) this).field_b != null) {
                    L0: {
                      ((fl) this).field_b.setCursor((java.awt.Cursor) null);
    ...
    public fl() throws Exception {
        ...
        ((fl) this).field_a = var2;
    }

    public final void movemouse(int param0, int param1) {
        ((fl) this).field_a.mouseMove(param0, param1);
    }
}
