          ...
          if (-2 != (this.field_i ^ -1)) {
            if (2 != this.field_i) {
              if (this.field_i != 3) {
                    ...
                    if (this.field_i != 6) {
                      if (7 != this.field_i) {
                        if ((this.field_i ^ -1) != -9) {
                          if (9 != this.field_i) {
                            ...
                            L0: while (true) {
                              if (this.field_g.length <= var3) {
                                var6 = var2 + "]";
                                discarded$40 = var7.append("Changed Render Order to " + var6);
                                discarded$41 = var7.append(")");
                                return var7.toString();
                              } else {
                          ...
                          discarded$42 = var7.append("Selected Stadium Surface " + this.field_g[0] + ", Tier " + this.field_g[1]);
                          discarded$43 = var7.append(")");
                          return var7.toString();
                        }
                      } else {
                        discarded$44 = var7.append("Bought Stadium Surface " + this.field_g[0] + ", Tier " + this.field_g[1]);
                        discarded$45 = var7.append(")");
                        return var7.toString();
                      }
                    } else {
                      discarded$46 = var7.append("Selected Secondary Colour " + this.field_g[0]);
                      discarded$47 = var7.append(")");
                      return var7.toString();
                    }
                  } else {
                    discarded$48 = var7.append("Selected Primary Colour " + this.field_g[0]);
                    discarded$49 = var7.append(")");
                    return var7.toString();
                  }
                } else {
                  discarded$50 = var7.append("Selected Kit " + this.field_g[0]);
                  discarded$51 = var7.append(")");
                  return var7.toString();
                }
              } else {
                L1: {
                ...
                discarded$52 = var7.append("Levelled up player " + this.field_g[0] + ", stat: " + var2);
                discarded$53 = var7.append(")");
                return var7.toString();
              }
            } else {
              discarded$54 = var7.append("Bought a trinket for player " + this.field_g[0] + ", slot " + this.field_g[1] + ", trinket id" + this.field_g[2]);
              discarded$55 = var7.append(")");
              return var7.toString();
            }
          } else {
            discarded$56 = var7.append("Sold Player " + this.field_g[0]);
            discarded$57 = var7.append(")");
            return var7.toString();
          }
        } else {
          discarded$58 = var7.append("Bought Player from shop " + (this.field_g[0] - 1) + ", index " + this.field_g[1]);
          discarded$59 = var7.append(")");
          return var7.toString();
        }
    }
            ...
            if (!param3.d(-55)) {
              ...
              L1: {
                if (param2 <= -9) {
                  ...
                  var5 = (sj) null;
                  discarded$2 = hn.a((String) null, (String) null, 74, (sj) null);
                  break L1;
                }
              }
