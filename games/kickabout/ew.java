...
final class ew {
    ...
    final static void a(int param0, int param1, hu param2, hu param3) {
        try {
            ...
            throw nb.a((Throwable) (Object) runtimeException, "ew.G(" + 126 + ',' + 320 + ',' + (param2 != null ? "{...}" : "null") + ',' + (param3 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final static void a(boolean param0, sj param1, sj param2, int param3) {
        try {
            ...
            throw nb.a((Throwable) (Object) runtimeException, "ew.B(" + true + ',' + (param1 != null ? "{...}" : "null") + ',' + (param2 != null ? "{...}" : "null") + ',' + 0 + ')');
        }
    }
    ...
    final static int a(byte param0, int param1, ml param2, int param3, int param4, int param5) {
        ...
        try {
          L0: {
            ...
            stackOut_11_0 = fs.a(stackIn_11_0, stackIn_11_1, stackIn_11_2, stackIn_11_3, stackIn_11_4, stackIn_11_5, stackIn_11_6, param2, param5, 0);
            stackIn_12_0 = stackOut_11_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("ew.D(").append(125).append(',').append(param1).append(',');
          ...
          throw nb.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + ',' + 0 + ',' + param4 + ',' + param5 + ')');
        }
        return stackIn_12_0;
    }
