...
final class ng {
    ...
    final static kg[] a(int param0, int param1, int param2, int param3, boolean param4, int param5) {
        ...
        var6 = var15;
        if (!vi.field_n) {
          var7_ref_kg = eo.a(bt.a(-126, param4, 11));
          var8_int = 0;
          L0: while (true) {
            if (6 <= var8_int) {
              return var6;
    ...
    final static ut[] a(String param0, String param1, int param2, sj param3) {
        ...
        try {
          L0: {
            var4_int = param3.b(param1, -1);
            var5 = param3.a((byte) -104, param0, var4_int);
            stackOut_0_0 = dk.a(var4_int, var5, (byte) -123, param3);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ng.G(");
