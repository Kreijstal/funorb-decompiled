...
final class q {
            ...
            switch (statePc) {
                ...
                case 27: {
                    try {
                        ...
                        stackOut_27_1 = new StringBuilder().append("q.C(");
                ...
                case 43: {
                    throw nb.a((Throwable) (Object) stackIn_43_0, stackIn_43_2 + 44 + param7 + 44 + param8 + 44 + param9 + 41);
                }
                case 44: {
                    return;
                }
    ...
    final lk a(byte param0) {
        ...
        try {
          ...
          stackOut_3_0 = ((q) this).field_g[((q) this).field_a];
    ...
    public static void b(int param0) {
        try {
            ...
            throw nb.a((Throwable) (Object) runtimeException, "q.B(" + param0 + 41);
        }
    }
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 9: {
                    ...
                    throw nb.a((Throwable) (Object) var2, "q.A(" + param0 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
    ...
    final static ut[] a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    try {
                        if ((var12 ^ -1) <= (var11_ref_ut__.length ^ -1)) {
                            statePc = 12;
                        } else {
                            statePc = 3;
                        }
                ...
                case 5: {
                    try {
                        if ((var14 ^ -1) <= (var13.field_y.length ^ -1)) {
                            statePc = 10;
                        } else {
                            statePc = 6;
                        }
                ...
                case 66: {
                    ...
                    throw nb.a((Throwable) (Object) var9, "q.D(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 44 + param8 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
            ...
            switch (statePc) {
                ...
                case 10: {
                    try {
                        ...
                        stackOut_10_1 = new StringBuilder().append("q.<init>(");
