    ...
    kf(long param0, hd param1, String[] param2, hd param3, hd[] param4, int param5) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var8_int >= param2.length) {
                ...
                ((kf) this).field_Bb[var8_int] = var9;
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("kf.<init>(").append(param0).append(44);
          ...
          throw nb.a((Throwable) (Object) stackIn_21_0, stackIn_21_2 + 44 + param5 + 41);
        }
    }
        ...
        L1: while (true) {
          if (((kf) this).field_Bb.length <= var2) {
            ...
            if (((kf) this).field_Db != var2) {
              if (((kf) this).field_Bb[var2].field_sb != 0) {
