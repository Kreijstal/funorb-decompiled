            ...
            if (!(var4 instanceof hi)) {
              ...
              L8: {
                ...
                if (null == this.field_k) {
                  ...
                  stackIn_89_0 = this.field_r[param1] ^ -1;
                  stackIn_89_1 = -2;
    ...
    final static ut a(byte param0, ut param1, int param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("wm.H(").append(param0).append(',');
    ...
    wm(int param0, qh param1, qh param2, bi param3, eb param4, int param5, byte[] param6, int param7, boolean param8) {
        ...
        try {
          ...
          L4: {
            ...
            stackIn_12_1 = new StringBuilder().append("wm.<init>(").append(param0).append(',');
          ...
          throw nb.a((Throwable) ((Object) stackIn_13_0), stackIn_25_2 + ',' + param7 + ',' + param8 + ')');
        }
    }
