...
final class bf extends hs {
    ...
    private final boolean a(boolean param0, hd param1) {
        ...
        L1: {
          L2: {
            var4 = us.field_j;
            if (var3 <= param1.field_F) {
              break L2;
            } else {
              if (param1.field_T >= var4) {
                break L2;
              } else {
                if (var3 >= param1.field_F - -param1.field_q) {
                  break L2;
                } else {
          ...
          if (!((bf) this).a((byte) 13)) {
            ...
            L1: while (true) {
              if (9 <= var3) {
                ...
                L4: {
                  if (-2 == (((bf) this).field_o.field_sb ^ -1)) {
                    this.i(74, -1);
                      ...
                      if (!((bf) this).field_v) {
                        ...
                        L12: while (true) {
                          if (4 <= var4) {
                            ...
                            var6 = (((bf) this).field_t[var4].field_q >> -1876754175) + ((bf) this).field_t[var4].field_F;
                            var7 = -16 + ((bf) this).field_t[var4].field_T - -((bf) this).field_t[var4].field_mb;
                            iw.a(67, ff.field_b);
                            on.b();
                            q.field_d.d(((bf) this).field_a.field_S[var5_int].toLowerCase(), on.field_g >> -670779135, -1 + on.field_f, 16777062, -1);
                            ta.e(param0 + 116);
    ...
    final static void a(int param0, String[] param1, int param2, java.applet.Applet param3, int param4, int param5) {
        ...
        if (var6 != null) {
            if (!(!gr.a((byte) 15, (CharSequence) (Object) var6))) {
                int discarded$0 = rr.a(10, (CharSequence) (Object) var6);
            }
        }
        ...
        L0: while (true) {
          if (-1 < (var7 ^ -1)) {
            ...
            L4: {
              ...
              if (-1 == (1 << param0.field_i[((bf) this).field_h][var7] & param0.field_c ^ -1)) {
                stackOut_4_0 = 0;
                stackIn_5_0 = stackOut_4_0;
                break L4;
              } else {
            ...
            L5: {
              var9 = stackIn_5_0;
              stackOut_5_0 = ((bf) this).field_z[var7].field_Eb;
              stackIn_7_0 = stackOut_5_0;
              stackIn_6_0 = stackOut_5_0;
              if (var9 == 0) {
            ...
            stackIn_8_0.field_i = stackIn_8_1;
            var7--;
            continue L0;
          }
        }
