...
final class up implements lv {
        ...
        if (!param1.c(-2)) {
          L0: {
            ...
            if (param1.field_h.length != ((up) this).field_h.length) {
              ...
              var3 = 0;
              L2: while (true) {
                if (((up) this).field_h.length <= var3) {
                  break L0;
                } else {
                  ((up) this).field_h[var3] = param1.field_h[var3];
                  var3++;
                  continue L2;
                }
              }
    ...
    final boolean f(int param0) {
        if (-1 == (((up) this).field_i ^ -1)) {
            return jd.f(-1);
        }
        if (param0 != 13467) {
            return true;
        }
        return (((up) this).field_i ^ -1) == -2 ? true : false;
    }
    ...
    final void a(int param0, iw param1) {
        ...
        int discarded$2 = param1.h((byte) -126);
    ...
    final void a(byte param0, iw param1) {
        ...
        L1: while (true) {
          if ((var3 ^ -1) <= -4) {
            ...
            if (var3 >= ((up) this).field_h.length) {
              param1.a(param0 + 62, 0);
              var3++;
              continue L1;
            } else {
              param1.a(125, 1 + ((up) this).field_h[var3]);
              var3++;
              continue L1;
            }
          }
                      ...
                      if (((up) this).field_h.length != param1.field_h.length) {
                        ...
                        L1: while (true) {
                          if (var3 >= ((up) this).field_h.length) {
                            ...
                            if (param1.field_h[var3] != ((up) this).field_h[var3]) {
                              return false;
                            } else {
                              var3++;
                              continue L1;
    ...
    public final void a(int param0, int param1, int param2) {
        ...
        ((up) this).a((byte) 70, -(((up) this).b(0) >> 621549153) + param2, false, var6, var4, var5, -(((up) this).a(param1 ^ 24) >> -1397897279) + param0, false);
    }
    ...
    final boolean c(boolean param0, byte param1) {
        ...
        return (((up) this).field_q ^ -1) == -2 ? true : false;
    }
    ...
    final int a(boolean param0, boolean param1, byte param2) {
        ...
        int var4 = 0;
        var4 += 50;
        var4 = var4 + (60 - -(!param1 ? 0 : ((up) this).field_r < -101 ? 23 : 15));
        var4 = var4 + ((-1 < ((up) this).field_h.length ? (!((up) this).f(13467) ? 0 : 12) + 6 : 0) + ((up) this).field_h.length * 18);
    ...
    final void a(byte param0, int param1, boolean param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L0: {
          ...
          if (((up) this).field_n != -101) {
            break L0;
          } else {
            if (-101 != ((up) this).field_o) {
              break L0;
            } else {
              if (((up) this).field_g != 100) {
                break L0;
          ...
          if (-5 >= (var16_int ^ -1)) {
            ...
            L9: {
              L10: {
                ...
                if (((up) this).c((byte) stackIn_30_6, stackIn_30_7 == 0)) {
                  break L10;
                } else {
              ...
              if (stackIn_41_0 <= var17_int) {
                ...
                L16: {
                  if (((up) this).f(13467)) {
                    ...
                    q.field_d.d(oo.field_h, (var13 >> -528534815) + param1, -4 + var28[2] + param6, 16777215, 65793);
                    break L16;
                  } else {
                    break L16;
                  }
                ...
                L18: {
                  if (var17_int != -1) {
                    if (-2 != var17_int) {
                      if (2 == var17_int) {
                        stackOut_48_0 = ((up) this).field_o;
                        stackIn_49_0 = stackOut_48_0;
                        break L18;
                      } else {
                        stackOut_47_0 = ((up) this).field_r;
                        stackIn_49_0 = stackOut_47_0;
                        break L18;
                      }
                    } else {
                      stackOut_45_0 = ((up) this).field_g;
                      stackIn_49_0 = stackOut_45_0;
                      break L18;
                    }
                  } else {
                    stackOut_43_0 = ((up) this).field_n;
                ...
                L19: {
                  var18 = stackIn_49_0;
                  if (0 == var17_int) {
                    stackOut_55_0 = ((up) this).c(true, oi.b(-89));
                    stackIn_56_0 = stackOut_55_0;
                    break L19;
                  } else {
                    if (-2 == (var17_int ^ -1)) {
                      stackOut_54_0 = ((up) this).a(5205, oi.b(-120));
                      stackIn_56_0 = stackOut_54_0;
                      break L19;
                    } else {
                      if ((var17_int ^ -1) == -3) {
                        stackOut_53_0 = ((up) this).b((byte) -118, oi.b(-110));
