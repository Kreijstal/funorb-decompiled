...
final class rm extends qt {
    ...
    private final void a(int param0, int param1, byte param2, String param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_15_1 = new StringBuilder().append("rm.H(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
          ...
          throw nb.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ')');
        }
    }
    ...
    final static void a() {
        ...
        if (!dr.field_a) {
            ...
            wu discarded$1 = oo.field_c.a((byte) 76, 240, 320, (java.awt.Component) (Object) var1);
            wu discarded$2 = oo.field_c.a(-126, (java.awt.Component) (Object) var1, false);
            el.field_A = 320;
            n.field_m = 240;
        }
    }
          ...
          if (ug.field_e != null) {
            ...
            if (ug.field_e.field_e) {
              if (null == ug.field_e.field_i) {
                ...
                un.field_d.d(var15.toLowerCase(), ((rm) this).field_j + 185, 260, 16777215, -1);
                return;
              } else {
                var5 = jw.field_Fb;
                var14 = ug.field_e.field_i[wv.field_ib];
                ...
                L0: while (true) {
                  if (var9 >= 10) {
                    ...
                    if (null != var14[var9]) {
                      ...
                      var5 = "";
                      this.a(var7[4 * var9], var7[2 + 4 * var9], (byte) 104, var14[var9], var7[1 + 4 * var9], var4, var7[4 * var9 - -3], var9, var3);
                      var3 += 25;
                      var9++;
                      continue L0;
                    } else {
