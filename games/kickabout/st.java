    ...
    private final qj a(int param0, boolean param1, hu param2, String param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("st.J(").append(param0).append(',').append(param1).append(',');
    ...
    final void a(int param0, hu param1, int param2, int param3, int param4, byte param5, String param6, int param7) {
        ...
        try {
                      ...
                      if (var13 == null) {
                        ...
                        L9: {
                          ...
                          if ((param4 ^ -1) == -4) {
                            ...
                            stackOut_40_3 = this.a(param0, -61, param1.a(var13), var13);
          ...
          L10: {
            ...
            stackOut_44_1 = new StringBuilder().append("st.L(").append(param0).append(',');
          ...
          L11: {
            ...
            stackOut_47_1 = ((StringBuilder) (Object) stackIn_47_1).append(stackIn_47_2).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
          ...
          throw nb.a((Throwable) ((Object) stackIn_50_0), stackIn_50_2 + ',' + param7 + ')');
        }
