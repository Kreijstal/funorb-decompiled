    ...
    final static int a(ea param0, int[][][] param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("fr.G(");
            ...
            L1: {
              ...
              if (param0 == null) {
                ...
                if (param0.length == 0) {
                  ...
                  ((fr) this).field_H = new String[var3_int];
                  var4_int = 0;
                  L2: while (true) {
                    if (var4_int >= var3_int) {
                      ...
                      ((fr) this).field_F = new wi[var3_int - -1];
                      var5 = 0;
                      L4: while (true) {
                        if (var3_int <= var5) {
                          ((fr) this).field_F[var3_int] = new wi(va.field_K, (jv) this);
                          ((fr) this).field_F[var3_int].field_r = (gj) (Object) var4;
                          ((fr) this).field_F[var3_int].a(15, 1, 0, 100, 20 - -(16 * (var3_int + 1)));
                          ((fr) this).a(-52, (fd) (Object) ((fr) this).field_F[var3_int]);
                          break L0;
                        } else {
        ...
        try {
          L0: {
            ...
            if (super.a(param0, (byte) -87, param2, param3)) {
              ...
              if (param3 == 98) {
                stackOut_8_0 = ((fr) this).a(param2, (byte) -100);
                stackIn_9_0 = stackOut_8_0;
                return stackIn_9_0;
              } else {
                if (99 == param3) {
                  stackOut_12_0 = ((fr) this).b(param2, (byte) 127);
        ...
        try {
          L0: {
            if (param3 > 64) {
              var6_int = 0;
              L1: while (true) {
                if (((fr) this).field_H.length <= var6_int) {
                  L2: {
                  ...
                  L3: {
                    if (param1 != ((fr) this).field_F[var6_int]) {
                      break L3;
                    } else {
                      ((fr) this).field_C.a(((fr) this).field_H[var6_int], 15);
                      break L3;
                    }
                  }
                  var6_int++;
