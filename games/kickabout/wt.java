    ...
    final StringBuilder a(int param0, int param1, Hashtable param2, StringBuilder param3) {
        ...
        try {
          L0: {
            L1: {
              if (param0 == 17883) {
                ...
                var6 = (fd) null;
                discarded$2 = this.a(125, (fd) null, 11, -44, 107, -118, 34);
                break L1;
              }
            }
            L2: {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("wt.GA(").append(param0).append(',').append(param1).append(',');
                ...
                if (var6 >= var11.length) {
                  ...
                  L3: while (true) {
                    if (param2 < var8) {
                      L4: {
                        if (var7 != null) {
                          discarded$30 = var7.a(17883, param2 - -1, param0, param3);
                          break L4;
                        } else {
                          discarded$31 = param3.append("null");
                          break L4;
                        }
                      }
                      var6++;
          ...
          L0: {
            L1: {
              if (param1 >= 84) {
                ...
                discarded$2 = this.f((byte) 119);
                break L1;
              }
            }
            stackOut_2_0 = this.a(param0, -28, 1);
    ...
    final boolean a(char param0, byte param1, fd param2, int param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_20_1 = new StringBuilder().append("wt.E(").append(param0).append(',').append(param1).append(',');
            stackIn_22_0 = stackOut_20_0;
            stackIn_22_1 = stackOut_20_1;
    ...
    final static void a(int param0, nu param1, int param2, ut[] param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("wt.G(").append(param0).append(',');
                ...
                if (0 == param0.field_h) {
                  ...
                  L2: {
                    ...
                    if (param2 == -75) {
                      ...
                      var8 = (String[]) null;
                      discarded$1 = wt.a(69, (String[]) null);
                      break L2;
                    }
                  }
                  L3: {
          ...
          if (var3.length <= var4) {
            L1: {
              if (param0 == 118) {
                ...
                var8 = (fd) null;
                discarded$1 = this.a(20, (fd) null, 22, -126, -123, 63, -127);
                break L1;
              }
            }
            return var2;
    ...
    final boolean a(boolean param0, int param1, int param2, fd param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_16_1 = new StringBuilder().append("wt.EA(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_18_0 = stackOut_16_0;
            stackIn_18_1 = stackOut_16_1;
            stackIn_17_0 = stackOut_16_0;
            stackIn_17_1 = stackOut_16_1;
    ...
    final void a(int param0, int param1, int param2, fd param3, int param4, int param5) {
        ...
        try {
                ...
                if (var11.length <= var8) {
                  L2: {
                    if (param4 == -1) {
                      ...
                      discarded$2 = wt.a(-45, false, false, 110, 69, -102);
                      break L2;
                    }
                  }
                  decompiledRegionSelector0 = 1;
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("wt.T(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_13_0 = stackOut_11_0;
            stackIn_13_1 = stackOut_11_1;
            stackIn_12_0 = stackOut_11_0;
            stackIn_12_1 = stackOut_11_1;
    ...
    private final boolean a(int param0, fd param1, int param2) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_21_1 = new StringBuilder().append("wt.K(").append(param0).append(',');
            stackIn_23_0 = stackOut_21_0;
            stackIn_23_1 = stackOut_21_1;
            stackIn_22_0 = stackOut_21_0;
            stackIn_22_1 = stackOut_21_1;
    ...
    final boolean a(int param0, fd param1, int param2, int param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          L3: {
            var8_ref = decompiledCaughtException;
            stackOut_16_0 = (RuntimeException) (var8_ref);
            stackOut_16_1 = new StringBuilder().append("wt.BA(").append(param0).append(',');
            stackIn_18_0 = stackOut_16_0;
            stackIn_18_1 = stackOut_16_1;
            stackIn_17_0 = stackOut_16_0;
            stackIn_17_1 = stackOut_16_1;
