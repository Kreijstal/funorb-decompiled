...
final class nr extends gn {
    ...
    final static void a(int param0, int param1, byte param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, hu param10, hu param11, dg param12, int param13, int param14, int param15, dg param16, int param17, int param18, dg param19, int param20) {
        ...
        try {
          L0: {
            ...
            bi.a(16777215, 16777215, 16777215, 20);
            break L0;
          }
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("nr.B(").append(6).append(',').append(10).append(',').append(54).append(',').append(20).append(',').append(320).append(',').append(320).append(',').append(6).append(',').append(18).append(',').append(240).append(',').append(13).append(',');
          ...
          L4: {
            ...
            stackOut_11_1 = ((StringBuilder) (Object) stackIn_11_1).append(stackIn_11_2).append(',').append(20).append(',').append(16777215).append(',').append(30).append(',');
          ...
          L5: {
            ...
            stackOut_14_1 = ((StringBuilder) (Object) stackIn_14_1).append(stackIn_14_2).append(',').append(16777215).append(',').append(9).append(',');
          ...
          throw nb.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + ',' + 16777215 + ')');
        }
    }
    ...
    final void a(int param0, int param1) {
        ...
        nh.a(param1 + ((nr) this).field_g << 4, ((nr) this).field_i << 4, 320, -4 + fd.field_f.length, fd.field_f);
        iw.a(103, ok.field_d);
        on.b();
        t.c();
        int var4 = 950;
        t.b(128, 240);
        var5.a(0, ((nr) this).field_n << 8, 0, 300, 0, 0, 0, var4);
        ta.e(param1 ^ -124);
        ...
        try {
          L0: {
            ...
            if (0 == var6_int) {
              L1: {
                if (param5 != 0) {
                  stackOut_12_0 = aq.a(param5, -30273, param1);
              ...
              if (var6_int == 1) {
                L2: {
                  if (0 == param2) {
                    ...
                    stackOut_4_0 = aq.a(param2, -30273, param1);
                ...
                L3: {
                  ...
                  var8 = param4;
                  if (var7 >= 0) {
                    stackOut_8_0 = var8 + var7;
                    stackIn_9_0 = stackOut_8_0;
                    break L3;
                  } else {
                    stackOut_7_0 = -var8 + var7;
          ...
          L4: {
            ...
            stackOut_14_1 = new StringBuilder().append("nr.A(").append(param0).append(',');
            stackIn_16_0 = stackOut_14_0;
            stackIn_16_1 = stackOut_14_1;
            stackIn_15_0 = stackOut_14_0;
            stackIn_15_1 = stackOut_14_1;
          ...
          throw nb.a((Throwable) (Object) stackIn_17_0, stackIn_17_2 + ',' + param2 + ',' + 0 + ',' + param4 + ',' + param5 + ')');
        }
        return stackIn_13_0;
    }
