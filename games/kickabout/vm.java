...
final class vm extends lq {
        ...
        L0: while (true) {
          if (this.field_k <= 0) {
            L1: {
              if (this.field_r != 256) {
                ...
                if ((this.field_l & 255) != 0) {
                  ...
                  if (uh.field_o) {
                    return vm.b(0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_s, this.field_q, 0, param3, param2, (vm) (this));
                  } else {
                    return vm.b(((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_v, 0, param3, param2, (vm) (this));
                  }
                }
              }
            }
            if (uh.field_o) {
              return vm.b(0, 0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_s, this.field_q, 0, param3, param2, (vm) (this), this.field_r, param4);
            } else {
              return vm.b(0, 0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_v, 0, param3, param2, (vm) (this), this.field_r, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_r != 256) {
                  ...
                  if ((this.field_l & 255) != 0) {
                    ...
                    if (!uh.field_o) {
                      param1 = vm.a(((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_v, this.field_t, 0, var6, param2, (vm) (this));
                      break L3;
                    } else {
                      param1 = vm.a(0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_s, this.field_q, this.field_o, this.field_w, 0, var6, param2, (vm) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!uh.field_o) {
                param1 = vm.d(0, 0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_v, this.field_t, 0, var6, param2, (vm) (this), this.field_r, param4);
                break L3;
              } else {
                param1 = vm.b(0, 0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_s, this.field_q, this.field_o, this.field_w, 0, var6, param2, (vm) (this), this.field_r, param4);
                break L3;
              }
            }
            this.field_k = this.field_k - param1;
    ...
    final synchronized boolean f() {
        return this.field_l < 0 || this.field_l >= ((to) ((Object) this.field_h)).field_i.length << 8;
    }
    ...
    private final void h() {
        this.field_v = this.field_j;
        this.field_s = vm.a(this.field_j, this.field_i);
        this.field_q = vm.d(this.field_j, this.field_i);
    }
        ...
        L0: while (true) {
          if (this.field_k <= 0) {
            L1: {
              if (this.field_r != -256) {
                ...
                if ((this.field_l & 255) != 0) {
                  ...
                  if (uh.field_o) {
                    return vm.a(0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_s, this.field_q, 0, param3, param2, (vm) (this));
                  } else {
                    return vm.a(((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_v, 0, param3, param2, (vm) (this));
                  }
                }
              }
            }
            if (uh.field_o) {
              return vm.a(0, 0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_s, this.field_q, 0, param3, param2, (vm) (this), this.field_r, param4);
            } else {
              return vm.a(0, 0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_v, 0, param3, param2, (vm) (this), this.field_r, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_k;
            ...
            L3: {
              L4: {
                ...
                if (this.field_r != -256) {
                  ...
                  if ((this.field_l & 255) != 0) {
                    ...
                    if (!uh.field_o) {
                      param1 = vm.b(((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_v, this.field_t, 0, var6, param2, (vm) (this));
                      break L3;
                    } else {
                      param1 = vm.b(0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_s, this.field_q, this.field_o, this.field_w, 0, var6, param2, (vm) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!uh.field_o) {
                param1 = vm.c(0, 0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_v, this.field_t, 0, var6, param2, (vm) (this), this.field_r, param4);
                break L3;
              } else {
                param1 = vm.a(0, 0, ((to) ((Object) this.field_h)).field_i, param0, this.field_l, param1, this.field_s, this.field_q, this.field_o, this.field_w, 0, var6, param2, (vm) (this), this.field_r, param4);
                break L3;
              }
            }
            this.field_k = this.field_k - param1;
          ...
          L4: {
            if (this.field_p <= 0) {
              ...
              if (!this.field_m) {
                if (this.field_r >= 0) {
                  L5: while (true) {
                    var9 = this.a(param0, var9, var6, param2, (int) var4.field_i[this.field_n]);
                    if (this.field_l >= var6) {
                      ...
                      if (var10 < this.field_p) {
                        ...
                        this.field_l = this.field_l - var8 * this.field_p;
                        this.field_p = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_i[this.field_u - 1]);
                ...
                L7: {
                  if (this.field_r >= 0) {
                    ...
                    var9 = this.b(param0, var9, var5, param2, (int) var4.field_i[this.field_n]);
                    if (this.field_l < var5) {
                ...
                L8: while (true) {
                  var9 = this.a(param0, var9, var6, param2, (int) var4.field_i[this.field_u - 1]);
                  if (this.field_l >= var6) {
    ...
    private final boolean j() {
        ...
        L0: {
          var1 = this.field_j;
          if (var1 != -2147483648) {
            var2 = vm.a(var1, this.field_i);
            var3 = vm.d(var1, this.field_i);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_v >= var1) {
            if (this.field_v <= var1) {
              ...
              this.field_t = -1;
              this.field_k = this.field_v - var1;
              break L2;
            }
          } else {
            this.field_t = 1;
            this.field_k = var1 - this.field_v;
            break L2;
          }
        }
        L3: {
          if (this.field_s >= var2) {
            if (this.field_s <= var2) {
              ...
              L4: {
                ...
                if (this.field_k == 0) {
                  ...
                  if (this.field_k <= this.field_s - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_k = this.field_s - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_k == 0) {
                ...
                if (this.field_k <= var2 - this.field_s) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_k = var2 - this.field_s;
            break L3;
          }
        }
        if (this.field_q < var3) {
          this.field_w = 1;
          if (this.field_k != 0) {
            if (this.field_k > var3 - this.field_q) {
              this.field_k = var3 - this.field_q;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_q <= var3) {
              ...
              L7: {
                ...
                if (this.field_k == 0) {
                  ...
                  if (this.field_k <= this.field_q - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_k = this.field_q - var3;
              break L6;
            }
          }
          return false;
        ...
        if (param0 != 0) {
          if (this.field_s == 0) {
            if (this.field_q == 0) {
              ...
              this.field_o = -this.field_s / param0;
              this.field_w = -this.field_q / param0;
              return;
            }
          } else {
            L6: {
    ...
    final synchronized int k() {
        return this.field_i < 0 ? -1 : this.field_i;
    }
    ...
    final int d() {
        if (this.field_j == 0 && this.field_k == 0) {
            return 0;
        }
        return 1;
    }
        ...
        if (param0 != 0) {
          ...
          if (this.field_s == var4) {
            if (this.field_q == var5) {
              ...
              this.field_o = (var4 - this.field_s) / param0;
              this.field_w = (var5 - this.field_q) / param0;
              return;
            }
          } else {
            L6: {
    ...
    final synchronized void i() {
        this.field_r = (this.field_r ^ this.field_r >> 31) + (this.field_r >>> 31);
        this.field_r = -this.field_r;
        this.field_l = ((to) ((Object) this.field_h)).field_i.length - 1 << 8;
    }

    final synchronized void i(int param0) {
        int var2 = ((to) ((Object) this.field_h)).field_i.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
    ...
    final int a() {
        ...
        if (this.field_p == 0) {
            var1 = var1 - var1 * this.field_l / (((to) ((Object) this.field_h)).field_i.length << 8);
        } else {
            if (this.field_p >= 0) {
                var1 = var1 - var1 * this.field_n / ((to) ((Object) this.field_h)).field_i.length;
            }
        }
        ...
        L0: {
          if (this.field_k <= 0) {
            ...
            if (param0 < this.field_k) {
              ...
              this.field_q = this.field_q + this.field_w * param0;
                  ...
                  if (this.field_r >= 0) {
                    if (this.field_l >= var4) {
                      ...
                      if (var7 < this.field_p) {
                        ...
                        this.field_l = this.field_l - var6 * this.field_p;
                        this.field_p = 0;
                        break L5;
                      }
                    } else {
    ...
    private vm(to param0, int param1, int param2, int param3) {
        this.field_h = (dm) ((Object) param0);
        this.field_n = param0.field_h;
        this.field_u = param0.field_j;
