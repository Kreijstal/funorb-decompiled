    ...
    final static double a(byte param0, ea param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("er.A(").append(param0).append(44);
    ...
    final static int a(boolean param0, int param1, byte[] param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("er.B(").append(param0).append(44).append(param1).append(44);
