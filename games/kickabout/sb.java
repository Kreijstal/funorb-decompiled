...
final class sb {
    ...
    public final String toString() {
        return this.field_f.substring(0, this.field_c) + "|" + this.field_f.substring(this.field_c);
    }
    ...
    final char b(int param0) {
        ...
        if (param0 >= -50) {
          ...
          return this.field_f.charAt(fieldTemp$4);
        } else {
          fieldTemp$5 = this.field_c;
          this.field_c = this.field_c + 1;
          return this.field_f.charAt(fieldTemp$5);
        }
    }
    ...
    sb(String param0) {
        ...
        try {
            this.field_f = param0;
            this.field_d = this.field_f.length();
