    ...
    final static Class a(int param0, String param1) throws ClassNotFoundException {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_31_1 = new StringBuilder().append("il.D(").append(param0).append(',');
    ...
    final static String a(String param0, int param1, byte param2) {
        ...
        try {
                  ...
                  if (!hi.a(0, param0)) {
                    if (ou.field_y >= 100) {
                      ...
                      if (!lf.a(param0, 108)) {
                        ...
                        stackOut_19_0 = vo.a((byte) -18, pt.field_i, new String[]{param0});
                    ...
                    stackOut_12_0 = vo.a((byte) -18, of.field_b, new String[]{param0});
                    stackIn_13_0 = stackOut_12_0;
                    decompiledRegionSelector0 = 3;
                    break L0;
                  }
          ...
          L1: {
            ...
            stackOut_26_1 = new StringBuilder().append("il.B(");
