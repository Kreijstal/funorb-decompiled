...
final class cg extends ct {
    ...
    final void a(int param0, int param1, int param2, int param3) {
        ...
        int discarded$0 = this.field_I.a(this.field_A, var5 + (var7 + this.field_J), this.field_J + var6, -this.field_J + this.field_M, this.field_i - this.field_J * 2, this.field_C, -1, this.field_B ? 0 : 2, 1, this.field_I.field_G);
    }
    ...
    cg(int param0, int param1, int param2, int param3, fd param4, boolean param5, int param6, int param7, hu param8, int param9, String param10) {
        ...
        try {
          L0: {
            ...
            L3: {
              if (!this.field_B) {
                stackOut_9_0 = this.field_M + 2 * this.field_J;
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("cg.<init>(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
