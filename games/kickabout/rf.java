...
final class rf {
        ...
        L0: while (true) {
          if (var2 >= var13.length) {
            ...
            L1: while (true) {
              if (var3 >= var14.length) {
                ...
                L4: {
                  ...
                  if ((var4 ^ -1) > -129) {
                    stackOut_13_0 = var4 << 233511841;
                    stackIn_14_0 = stackOut_13_0;
                    break L4;
                  } else {
                    stackOut_12_0 = -(var4 << -984280127) + 511;
            ...
            L6: {
              ...
              if (var3 <= 128) {
                stackOut_4_0 = var3 << 1073683457;
                stackIn_5_0 = stackOut_4_0;
                break L6;
              } else {
                stackOut_3_0 = 511 - (var3 << 2073551969);
    ...
    final static void a(hr param0, int param1, boolean param2) {
        ...
        int discarded$0 = var5.a(var4, !param2 ? true : false);
    ...
    rf(String param0, hd param1) {
        String[] var3 = new String[]{param0, lk.field_n, at.field_Jb};
        hd[] var4 = new hd[]{param1, kk.field_R, (hd) (Object) nq.field_F};
