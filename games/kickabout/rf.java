...
final class rf {
    ...
    final static void a(int param0, sj param1, sj param2, sj param3) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_16_1 = new StringBuilder().append("rf.B(").append(param0).append(44);
    ...
    final void a(int param0, int param1, int param2, int param3, byte param4) {
        int var6 = 24;
        int var7 = 5;
        ((rf) this).field_b.a(true, param3, param0, var6, var7, param2, param1);
    ...
    final static void a() {
        ...
        try {
              ...
              if (var2 >= var13.length) {
                ...
                L2: while (true) {
                  if (var3 >= var14.length) {
                      ...
                      if (var3 >= 210) {
                        ...
                        L4: while (true) {
                          if (var3 >= 16) {
                            ...
                            qi.field_n[var3] = (-(90 * var3) + 1440 >> 4) + 72;
                    ...
                    L5: {
                      var4 = Math.min(255, 5 * var3 >> 2);
                      if (var4 < 128) {
                        stackOut_14_0 = var4 << 1;
                        stackIn_15_0 = stackOut_14_0;
                        break L5;
                      } else {
                        stackOut_13_0 = -(var4 << 1) + 511;
                ...
                L7: {
                  var3 = Math.min(255, 3 * var2 >> 1);
                  if (var3 <= 128) {
                    stackOut_5_0 = var3 << 1;
                    stackIn_6_0 = stackOut_5_0;
                    break L7;
                  } else {
                    stackOut_4_0 = 511 - (var3 << 1);
          ...
          throw nb.a((Throwable) (Object) var1, "rf.C(" + -124 + 41);
        }
    }
    ...
    rf(String param0, hd param1) {
        ...
        try {
            ...
            ((rf) this).field_b = new kf(0L, ge.field_n, var3, ku.field_b, var4, 0);
        } catch (RuntimeException runtimeException) {
            throw nb.a((Throwable) (Object) runtimeException, "rf.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
