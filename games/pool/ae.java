...
final class ae {
    ...
    final static String a(int param0, String param1, String param2, int param3) {
        ...
        eo var8 = hl.a(param1, 1);
        if (!(var8 != null)) {
            return nr.a(new String[1], -1, sg.field_Q);
        }
        var8.a((byte) -117);
        var8.a(false);
        ...
        if (param0 != -3266) {
            Object var7 = null;
            String discarded$0 = ae.a(-62, (String) null, (String) null, 67);
        }
        oq var5 = ej.field_j;
        var5.b(false, param3);
        var5.field_v = var5.field_v + 1;
        int var6 = var5.field_v;
        var5.a(3, false);
        var5.a(-9946, param2);
                    ...
                    if (!rl.field_c.a("benefits", 0)) {
                      ...
                      L1: while (true) {
                        if ((var7 ^ -1) <= (mk.field_a.length ^ -1)) {
                          ...
                          jr.field_m[var7].e();
                          int discarded$6 = so.field_h.a(mk.field_a[var7], 3, 3, -6 + jr.field_m[var7].field_z, -6 + jr.field_m[var7].field_A, er.field_X, -1, 1, 1, so.field_h.field_w + so.field_h.field_C);
            ...
            if (null == vn.field_j) {
              ...
              if (null != de.field_d) {
                L3: {
                  ...
                  var3 = qh.field_f;
                  qh.a(ka.field_o);
                  var14 = nr.a(new String[1], param0 ^ 1, sh.field_S);
                ...
                L4: {
                  var6 += 6;
                  var8 -= 3;
                  if ((var7 - -var5 ^ -1) < (vn.field_j.field_w ^ -1)) {
                ...
                var9.e();
                int discarded$7 = de.field_d.a(var14, se.field_h, rf.field_c, jc.field_h, li.field_e, 16777215, -1, 1, 1, de.field_d.field_C - -de.field_d.field_w);
          ...
          L13: {
            if (ph.field_f == null) {
              ...
              if (null == o.field_C) {
                ...
                L16: {
                  var2 = stackIn_52_0 + (stackIn_52_1 * ao.a(stackIn_52_2 << stackIn_52_3, true) >> -970655312);
                  if (var2 <= 0) {
                    break L16;
                  } else {
                ...
                L17: {
                  stackOut_54_0 = param0 ^ -2;
                  stackOut_54_1 = ir.field_n;
                ...
                hg.a(stackIn_57_0, stackIn_57_1, stackIn_57_2 != 0, oj.field_s);
                break L13;
              }
            }
          }
          L18: {
            if (null == ph.field_f) {
              ...
              if (o.field_C != null) {
                ...
                hg.a(stackIn_66_0, stackIn_66_1, stackIn_66_2 != 0, ln.field_o);
                break L18;
              } else {
                break L18;
              }
          ...
          L21: {
            L22: {
              if (vq.field_Yb == null) {
                ...
                var1 = 357 - vq.field_Yb.field_y / 2;
                vq.field_Yb.c(-vq.field_Yb.field_w + 269, var1);
                w.field_f.c(586, var1);
                if ((gg.field_f ^ -1) >= (var1 ^ -1)) {
                  break L22;
                } else {
                  if (gg.field_f < vq.field_Yb.field_A + var1) {
                    var2 = (ao.a(uf.field_X << -1660496540, true) * 40 >> 1747688432) + 40;
                    if ((var2 ^ -1) < -1) {
                      L23: {
                        if ((wn.field_i ^ -1) >= (-vq.field_Yb.field_z + 269 ^ -1)) {
                          break L23;
                        } else {
                          if (wn.field_i >= 269) {
                            break L23;
                          } else {
                            vq.field_Yb.c(-vq.field_Yb.field_w + 268, var1 - 1, var2);
                            vq.field_Yb.c(269 - (vq.field_Yb.field_w + -1), -1 + var1, var2);
                            vq.field_Yb.c(-vq.field_Yb.field_w + 269 - 1, var1 - -1, var2);
                            vq.field_Yb.c(1 + (-vq.field_Yb.field_w + 269), var1 - -1, var2);
                            break L22;
                          }
                        }
                      }
                      if (wn.field_i <= 586) {
                        ...
                        if (wn.field_i < vq.field_Yb.field_z + 586) {
                          w.field_f.c(585, -1 + var1, var2);
                          w.field_f.c(587, var1 - 1, var2);
                          w.field_f.c(585, var1 - -1, var2);
                          w.field_f.c(587, 1 + var1, var2);
                          break L22;
                        } else {
                          break L22;
                        }
