...
final class ae {
        ...
        try {
          L0: {
            ...
            if (!gj.a(-25908, var9)) {
              ...
              if (2 != th.field_a) {
                stackIn_7_0 = ig.field_k;
                decompiledRegionSelector0 = 1;
                break L0;
              } else {
                var8 = hl.a(param1, 1);
                if (var8 == null) {
                  stackIn_11_0 = nr.a(new String[]{param1}, -1, sg.field_Q);
                  ...
                  L1: {
                    ...
                    if (param0 == -3266) {
                      ...
                      var7 = (String) null;
                      ae.a(-62, (String) null, (String) null, 67);
                      break L1;
                    }
                  }
                  var5 = ej.field_j;
          ...
          L2: {
            ...
            stackIn_18_1 = new StringBuilder().append("ae.C(").append(param0).append(',');
          ...
          throw wm.a((Throwable) ((Object) stackIn_19_0), stackIn_22_2 + ',' + param3 + ')');
        }
    ...
    final static void a(int param0) {
        ...
        try {
                    ...
                    if (null == rl.field_c) {
                      ...
                      if (!rl.field_c.d(-62)) {
                        ...
                        if (!rl.field_c.a("benefits", 0)) {
                          ...
                          var12.e();
                          de.field_d.b(nr.a(new String[]{sa.field_o}, -1, ul.field_l), var6, 40, 16777215, -1);
                          so.field_h.b(nr.a(new String[]{sa.field_o}, -1, vb.field_c), var6, 60, 16777215, -1);
                          de.field_d.b(nr.a(new String[]{pd.field_e}, -1, up.field_w), var6, 110, 16777215, -1);
                          so.field_h.b(nr.a(new String[]{pd.field_e}, -1, cr.field_t), var6, 130, 16777215, -1);
                          ...
                          L2: while (true) {
                            if (var7 >= mk.field_a.length) {
                              ...
                              jr.field_m[var7].e();
                              so.field_h.a(mk.field_a[var7], 3, 3, -6 + jr.field_m[var7].field_z, -6 + jr.field_m[var7].field_A, er.field_X, -1, 1, 1, so.field_h.field_w + so.field_h.field_C);
                ...
                if (null == vn.field_j) {
                  ...
                  if (null != de.field_d) {
                    L4: {
                      ...
                      var3 = qh.field_f;
                      qh.a(ka.field_o);
                      var14 = nr.a(new String[]{bc.field_i[qg.field_e]}, param0 ^ 1, sh.field_S);
                    ...
                    var9.e();
                    de.field_d.a(var14, se.field_h, rf.field_c, jc.field_h, li.field_e, 16777215, -1, 1, 1, de.field_d.field_C - -de.field_d.field_w);
                    hd.a(1, 3, var9.field_y, var9, param0 + 6, var9.field_w, 0, 0);
                    vn.field_j.e();
                    var9.c(0, 0);
                    ua.field_u = new dd(640, 480);
                    ua.field_u.e();
                    vn.field_j.b((vn.field_j.field_w >> -1446458143) - -pq.field_m, (vn.field_j.field_y >> -1393688767) + ad.field_r, ej.field_g, 4096);
                    vn.field_j = null;
                    ua.field_u.b();
              ...
              L8: {
                if (nr.field_N == null) {
                  ...
                  if (so.field_h == null) {
                    ...
                    qh.a(ka.field_o);
                    var16 = new dd(412, 43);
                    var5_ref_String = nr.a(new String[]{nr.field_N}, -1, wm.field_cc);
                    nr.field_N = null;
                    var16.e();
                    so.field_h.a(var5_ref_String, 3, 3, -6 + var16.field_z, var16.field_A + -6, 16777215, -1, 0, 1, so.field_h.field_C + so.field_h.field_w);
              ...
              L14: {
                if (ph.field_f == null) {
                  ...
                  if (null == o.field_C) {
                    ...
                    L17: {
                      var2 = stackIn_53_0 + (stackIn_53_1 * ao.a(stackIn_53_2 << stackIn_53_3, true) >> -970655312);
                      if (var2 <= 0) {
                        break L17;
                      } else {
                    ...
                    L18: {
                      stackIn_57_0 = param0 ^ -2;

                      stackIn_57_1 = ir.field_n;
                    ...
                    hg.a(stackIn_58_0, stackIn_58_1, stackIn_58_2 != 0, oj.field_s);
                    break L14;
                  }
                }
              }
              L19: {
                if (null == ph.field_f) {
                  ...
                  if (o.field_C != null) {
                    ...
                    hg.a(stackIn_67_0, stackIn_67_1, stackIn_67_2 != 0, ln.field_o);
                    break L19;
                  } else {
                    break L19;
                  }
                  ...
                  if (vq.field_Yb == null) {
                    ...
                    if (gg.field_f <= var1_int) {
                      ...
                      if (gg.field_f < vq.field_Yb.field_A + var1_int) {
                        var2 = (ao.a(uf.field_X << -1660496540, true) * 40 >> 1747688432) + 40;
                        if ((var2 ^ -1) < -1) {
                          L24: {
                            if (wn.field_i <= -vq.field_Yb.field_z + 269) {
                              ...
                              if (wn.field_i >= 269) {
                                ...
                                vq.field_Yb.c(-vq.field_Yb.field_w + 269 - 1, var1_int - -1, var2);
          ...
          throw wm.a((Throwable) ((Object) var1_ref), "ae.B(" + param0 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return;
        } else {
