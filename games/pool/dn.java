...
final class dn extends ma {
    ...
    final static int a(int param0, int param1, int param2, or param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_11_1 = new StringBuilder().append("dn.E(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    dn(int param0, int[] param1) {
        try {
            ...
            throw wm.a((Throwable) (Object) runtimeException, "dn.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
