...
final class ki {
    ...
    final void a(float[] param0, int param1, boolean param2) {
        ...
        L0: while (true) {
          if (var4 >= param1) {
            if (!param2) {
              var4 = gm.field_t[this.field_d].field_e;
                    ...
                    if (var9 >= var6) {
                      ...
                      L3: {
                        if (var8 != 0) {
                          ...
                          var10 = gm.field_t[this.field_d].b();
                          var11 = var4 - 1;
                          L4: while (true) {
                            if (var11 < 0) {
                              break L3;
    ...
    ki() {
        ...
        int var5 = 0;
        int var2 = 0;
        this.field_g = gm.a(16);
        this.field_c = gm.a(24);
        this.field_a = gm.a(24);
        this.field_f = gm.a(24) + 1;
        this.field_e = gm.a(6) + 1;
        this.field_d = gm.a(8);
        ...
        this.field_b = new int[this.field_e * 8];
        int var6 = 0;
        var2 = var6;
        while (var6 < this.field_e * 8) {
            this.field_b[var6] = (var1[var6 >> 3] & 1 << (var6 & 7)) != 0 ? gm.a(8) : -1;
            var6++;
        }
    }
}
