    ...
    final static void a(boolean param0, byte[] param1) {
        ...
        try {
          L0: {
            var15 = new ge(param1);
            var16 = var15;
            var16.field_v = -2 + param1.length;
            wf.field_d = var16.d(-1034);
            ...
            var16.field_v = param1.length - 7 + -(wf.field_d * 8);
            vd.field_c = var16.d(-1034);
            tq.field_r = var16.d(-1034);
            var3 = (var16.g(-97) & 255) - -1;
            var4 = 0;
            L1: while (true) {
              if (wf.field_d <= var4) {
                var4 = 0;
                  ...
                  if (wf.field_d <= var4) {
                    ...
                    L3: while (true) {
                      if (wf.field_d <= var4) {
                        ...
                        L4: while (true) {
                          if (wf.field_d <= var4) {
                            var16.field_v = -(3 * (-1 + var3)) + (-(8 * wf.field_d) + (-7 + param1.length));
                                ...
                                L6: while (true) {
                                  if (wf.field_d <= var4) {
                                    ...
                                    L7: {
                                      ...
                                      var17 = var19;
                                      var8 = var17;
                                      v.field_b[var4] = var23;
                                      var24 = new byte[var7];
                                      var22 = var24;
                                      var20 = var22;
                                      var18 = var20;
                                      var9 = var18;
                                      wg.field_Sb[var4] = var24;
                                      var10 = 0;
                                      var11 = var16.g(-121);
                                      if ((1 & var11) == 0) {
                                        var12 = 0;
                                            ...
                                            if ((var11 & 2) != 0) {
                                              ...
                                              L9: while (true) {
                                                if (var7 <= var12) {
                                                  ...
                                                  L10: {
                                                    byte dupTemp$2 = var15.e((byte) 105);
                                          ...
                                          if (var12 >= var5) {
                                                ...
                                                if (var5 <= var12) {
                                                  ...
                                                  L13: while (true) {
                                                    if (var6 <= var13) {
                                                      ...
                                                      L14: {
                                                        byte dupTemp$3 = var15.e((byte) 105);
                                            ...
                                            L15: while (true) {
                                              if (var13 >= var6) {
                                                ...
                                                var8[var13 * var5 + var12] = var15.e((byte) 105);
                                                var13++;
                                                continue L15;
                                              }
                                            }
                            ...
                            rc.field_f[var4] = var15.d(-1034);
                            var4++;
                            continue L4;
                          }
                        }
                      } else {
                        pd.field_a[var4] = var15.d(-1034);
                        var4++;
                        continue L3;
                      }
                    }
                  } else {
                    ih.field_d[var4] = var15.d(-1034);
                    var4++;
                    continue L2;
                  }
                }
              } else {
                el.field_I[var4] = var15.d(-1034);
                var4++;
                continue L1;
              }
            }
