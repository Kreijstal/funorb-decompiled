...
final class mr {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_k, 0, field_g, 0, var2);
        int var3 = field_i[this.field_e - 1];
        ...
        for (var6 = 0; var6 < this.field_f.length; var6++) {
            ...
            var8 = this.field_c[var7];
            var9 = this.field_h[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = gm.field_t[this.field_l[var7]].b();
            }
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_j[var16]) {
                  var9 = field_g[var16];
                  var10 = field_a[var16] * this.field_e;
                    ...
                    if (var6 >= var2) {
                      ...
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= this.field_c[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              incrementValue$2 = var5;
                              var5++;
                              this.field_k[incrementValue$2] = gm.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_c[this.field_f[var6]];
                      var6++;
                      continue L2;
                    }
                  }
