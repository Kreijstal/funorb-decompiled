...
final class mr {
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_d[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_d[var11];
        }
    }
    ...
    final boolean b() {
        ...
        int var2 = ((mr) this).field_k.length;
        System.arraycopy((Object) (Object) ((mr) this).field_k, 0, (Object) (Object) field_g, 0, var2);
        int var3 = field_i[((mr) this).field_e - 1];
        int var4 = gi.a(var3 - 1, 0);
        field_a[0] = gm.a(var4);
        field_a[1] = gm.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((mr) this).field_f.length; var6++) {
            var7 = ((mr) this).field_f[var6];
            var8 = ((mr) this).field_c[var7];
            var9 = ((mr) this).field_h[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = gm.field_t[((mr) this).field_l[var7]].b();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((mr) this).field_b[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_a[incrementValue$0] = var13 >= 0 ? gm.field_t[var13].b() : 0;
            }
        }
        return true;
    }
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((mr) this).field_k.length;
        var4 = field_i[((mr) this).field_e - 1];
        var5 = field_j;
        field_j[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_a[0] * ((mr) this).field_e;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_j[var16]) {
                  var9 = field_g[var16];
                  var10 = field_a[var16] * ((mr) this).field_e;
            ...
            L3: {
              var7 = mr.b(field_g, var6);
              var8_int = mr.a(field_g, var6);
              var9 = this.a(field_g[var7], field_a[var7], field_g[var8_int], field_a[var8_int], field_g[var6]);
              var10 = field_a[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
            ...
            if (var10 == 0) {
              ...
              var14 = field_j;
              var15 = var7;
              field_j[var8_int] = true;
              var14[var15] = true;
              field_j[var6] = true;
              if (var10 < var13) {
                L4: {
                  stackOut_11_0 = (int[]) field_a;
                  stackOut_11_1 = var6;
    ...
    mr() {
        ...
        if (var1 == 1) {
          var2 = gm.a(5);
          var3 = 0;
          ((mr) this).field_f = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((mr) this).field_c = new int[var3];
              ((mr) this).field_h = new int[var3];
              ((mr) this).field_l = new int[var3];
              ((mr) this).field_b = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((mr) this).field_e = gm.a(2) + 1;
                  var4 = gm.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((mr) this).field_k = new int[var5];
                      ((mr) this).field_k[0] = 0;
                      ((mr) this).field_k[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((mr) this).field_c[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((mr) this).field_k[incrementValue$2] = gm.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((mr) this).field_c[((mr) this).field_f[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((mr) this).field_c[var4] = gm.a(3) + 1;
                    int dupTemp$3 = gm.a(2);
                    ((mr) this).field_h[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((mr) this).field_l[var4] = gm.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
