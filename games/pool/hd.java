    ...
    final static void a(int param0, int param1, boolean param2, int[] param3, int[] param4, int[] param5, int[] param6) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("hd.E(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final static void a(int param0, int param1, int param2, dd param3, int param4, int param5, int param6, int param7) {
        ...
        try {
          ...
          L12: {
            ...
            stackOut_40_1 = new StringBuilder().append("hd.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
