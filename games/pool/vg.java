...
final class vg {
    ...
    public final void showcursor(java.awt.Component param0, boolean param1) {
        try {
            ...
            if (((vg) this).field_a == param0) {
              return;
            } else {
              if (null != ((vg) this).field_a) {
                L1: {
                  ((vg) this).field_a.setCursor((java.awt.Cursor) null);
