...
final class oc {
    ...
    final static void a(int param0) {
        ...
        if (param0 <= 111) {
            field_t = (java.applet.Applet) null;
        }
        var1.field_q = null;
        cb.field_e.b((byte) -23, var1);
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        for (var6 = 0; var6 < this.field_k; var6++) {
            this.field_m[var6] = (short)(this.field_m[var6] * param2 / param4);
            this.field_s[var6] = (short)(this.field_s[var6] * param3 / param4);
            this.field_l[var6] = (short)(this.field_l[var6] * param0 / param4);
        }
        this.b(32767);
        if (param1 != 1) {
    ...
    final void a(int param0, int param1, int param2, int param3) {
        int var5 = 0;
        for (var5 = param0; this.field_k > var5; var5++) {
