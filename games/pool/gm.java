...
final class gm extends ma {
    ...
    final static int a(int param0) {
        ...
        while (param0 >= 8 - field_p) {
            var3 = 8 - field_p;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_H[field_O] >> field_p & var4) << var2);
            field_p = 0;
            field_O = field_O + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_H[field_O] >> field_p & var3) << var2);
    ...
    private final float[] d(int param0) {
        ...
        L0: {
          gm.a(((gm) this).field_B[param0], 0);
          int discarded$1 = gm.c();
          var2 = gm.a(gi.a(field_G.length - 1, 0));
        ...
        L8: {
          var14 = field_L[field_G[var2]];
          var16 = var14.field_b;
          var17_int = var14.field_a[var16];
          if (field_C[var17_int].b()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_d) {
            L10: {
              if (var15 != 0) {
                ...
                field_C[var18_int].a(field_R, var4 >> 1);
                break L10;
              }
            }
            L11: {
            ...
            L35: {
              var17 = null;
              if (((gm) this).field_y <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((gm) this).field_y + var4 >> 2;
                  ...
                  if (((gm) this).field_D) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((gm) this).field_u) {
                        break L36;
                      } else {
                        var20 = (((gm) this).field_y >> 1) + var19;
                        var40[var19] = var40[var19] + ((gm) this).field_A[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((gm) this).field_A;
              ((gm) this).field_A = field_R;
              field_R = var18;
              ((gm) this).field_y = var4;
              ((gm) this).field_u = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    private final static boolean a(di param0) {
        byte[] var1 = null;
        if (!field_r) {
            var1 = param0.a(112, 0, 0);
            if (var1 == null) {
                return false;
            }
            gm.b(var1);
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        ge var2 = new ge(param0);
        ((gm) this).field_x = var2.b(true);
        ((gm) this).field_o = var2.b(true);
        ...
        for (var4 = 0; var4 < var3; var4++) {
            ...
            var6 = new byte[var5];
            var2.a(0, (byte) -116, var6, var5);
            ((gm) this).field_B[var4] = var6;
        }
    }

    final jg a(int[] param0) {
        int var3 = 0;
        int var4 = 0;
        int var5 = 0;
        int var6 = 0;
        ...
        L1: {
          if (((gm) this).field_S != null) {
            break L1;
          } else {
            ((gm) this).field_y = 0;
            ((gm) this).field_A = new float[field_I];
            ((gm) this).field_S = new byte[((gm) this).field_o];
            ((gm) this).field_q = 0;
            ((gm) this).field_m = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((gm) this).field_m >= ((gm) this).field_B.length) {
            ((gm) this).field_A = null;
            var14 = ((gm) this).field_S;
            ((gm) this).field_S = null;
            return new jg(((gm) this).field_x, var14, ((gm) this).field_s, ((gm) this).field_M, ((gm) this).field_T);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((gm) this).field_q;
                  var4 = var13.length;
                  if (var4 <= ((gm) this).field_o - var3) {
                    break L5;
                  } else {
                    var4 = ((gm) this).field_o - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((gm) this).field_q);
                        break L7;
                      }
                    }
                    ((gm) this).field_q = var3;
                    break L4;
                  } else {
                    L8: {
    ...
    final static int c() {
        int var0 = field_H[field_O] >> field_p & 1;
        field_p = field_p + 1;
        field_O = field_O + (field_p >> 3);
        field_p = field_p & 7;
        return var0;
    }
    ...
    final static gm a(di param0, int param1, int param2) {
        try {
            ...
            byte[] var3 = param0.a(121, param2, param1);
            if (var3 == null) {
                return null;
            }
            gm var4 = null;
    ...
    final jg b() {
        ...
        ((gm) this).field_y = 0;
        ((gm) this).field_A = new float[field_I];
        var1 = new byte[((gm) this).field_o];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((gm) this).field_B.length) {
            ((gm) this).field_A = null;
            return new jg(((gm) this).field_x, var1, ((gm) this).field_s, ((gm) this).field_M, ((gm) this).field_T);
          } else {
            var4 = this.d(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((gm) this).field_o - var2) {
                  break L1;
                } else {
                  var5 = ((gm) this).field_o - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    private gm(byte[] param0) throws IOException {
        this.a(param0);
    }
