...
final class rn implements Runnable {
    ...
    final dg a(int param0, np param1, int param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_17_1 = new StringBuilder().append("rn.D(").append(param0).append(44);
          ...
          throw wm.a((Throwable) (Object) stackIn_20_0, stackIn_20_2 + 44 + param2 + 41);
        }
        return stackIn_16_0;
    }
    ...
    private final void a(dg param0, int param1) {
        ...
        try {
          ...
          throw wm.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + -19789 + 41);
        }
    }
    ...
    final static void a(int param0, int param1, boolean param2, int param3, boolean param4, boolean param5, boolean param6, boolean param7, int param8, int param9, int param10, int param11, int param12, int param13) {
        ...
        mp.a(param1, param6, param8, 16777215, param5, 13375, param2, param4, param7, param3);
    ...
    rn(sj param0) {
        ...
        try {
            ...
            throw wm.a((Throwable) (Object) runtimeException, "rn.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
