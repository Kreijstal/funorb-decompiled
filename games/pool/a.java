...
final class a {
    ...
    final static eg a(boolean param0, eg param1) {
        ...
        try {
          L0: {
            var2_int = 0;
            L1: while (true) {
              if (param1.field_Y.length <= var2_int) {
                L2: {
                  if (param0) {
                    break L2;
                  } else {
                ...
                param1.field_Y[var2_int] = -param1.field_Y[var2_int];
                var2_int++;
                continue L1;
              }
            }
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("a.D(").append(param0).append(',');
    ...
    final static String a(byte[] param0, int param1) {
        ...
        try {
          L0: {
            var2_int = -3 % ((69 - param1) / 54);
            stackOut_0_0 = tl.a(param0.length, -7510, param0, 0);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("a.A(");
    ...
    final static void a(String param0, boolean param1, boolean param2, float param3) {
        try {
            ...
            throw wm.a((Throwable) ((Object) runtimeException), "a.B(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ',' + param2 + ',' + param3 + ')');
        }
    }
