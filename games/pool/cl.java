...
final class cl {
    ...
    final static boolean a(int param0, vh param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("cl.D(").append(param0).append(44);
    ...
    final static wl a(byte[] param0, boolean param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("cl.B(");
          ...
          throw wm.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + 44 + 1 + 41);
        }
        return stackIn_4_0;
    }
    ...
    final static void a(int param0, int param1, int[] param2, float[] param3, float[] param4) {
        ...
        try {
            ...
            throw wm.a((Throwable) (Object) runtimeException, "cl.C(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 44 + (param3 != null ? "{...}" : "null") + 44 + (param4 != null ? "{...}" : "null") + 41);
        }
    }
