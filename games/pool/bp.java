...
class bp {
    ...
    private final void a(kd param0, int param1) {
        int var3 = param1 >> 5;
        kd var4 = this.field_j[var3];
        if (var4 == null) {
            this.field_f[var3] = param0;
        } else {
            var4.field_o = param0;
        }
        this.field_j[var3] = param0;
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new pg();
                          var4 = var5;
                          stackIn_10_0 = (pg) (var4);

                          stackIn_10_1 = 256;

                          if (!field_r) {
                            stackIn_11_0 = (pg) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_m <= 0) {
                            ...
                            if (field_u != null) {
                              ...
                              param0.a(102, field_m, (Runnable) ((Object) field_u));
                              break L5;
                            }
                          }
                        }
        ...
        try {
            ...
            if (!this.field_s) {
              ...
              try {
                L0: {
                  L1: {
                    if (var1 <= this.field_g + 6000L) {
                      break L1;
                    } else {
                      this.field_g = var1 - 6000L;
                      break L1;
                    }
                  }
                  L2: while (true) {
                    if (var1 <= this.field_g + 5000L) {
                      break L0;
                    } else {
                      this.b(256);
                      this.field_g = this.field_g + (long)(256000 / field_h);
                      var1 = rl.a((byte) -120);
                      continue L2;
                    }
                  }
              ...
              if (this.field_l != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.e();
                      if (this.field_i - var3_int <= this.field_k) {
                        break L6;
                      } else {
                        this.field_k = this.field_i - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_t + this.field_q;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_a) {
                        ...
                        if (var4 + 256 <= this.field_a) {
                          ...
                          this.field_q = var4 - this.field_t;
                          break L8;
                        }
                      }
                    }
                                ...
                                L13: {
                                  if (this.field_k != 0) {
                                    ...
                                    if (this.field_c != 0) {
                                      ...
                                      this.a();
                                      this.field_b = var1 + 2000L;
                                      decompiledRegionSelector0 = 1;
                                      break L4;
                                    }
                                  }
                                }
                                this.field_q = Math.min(this.field_c, this.field_k);
    ...
    private final void a(int[] param0, int param1) {
        ...
        L1: {
          ...
          if (this.field_p == null) {
            ...
            if (this.field_o > 0) {
              ...
              this.field_o = this.field_o + (field_h >> 4);
              bp.b(this.field_p);
              this.a(this.field_p, this.field_p.c());
              var4 = 0;
              var5 = 255;
              var6 = 7;
              L2: while (true) {
                                ...
                                if (var4 < this.field_e) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_j[var7_int] = (kd) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((kd) (var7)).field_o;
                        ((kd) (var7)).field_o = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
        ...
        L17: {
          if (this.field_p == null) {
            ...
            this.field_p.a(param0, 0, param1);
            break L17;
          }
        }
        this.field_g = rl.a((byte) -125);
    }
    ...
    bp() {
        this.field_e = 32;
        this.field_s = false;
        this.field_g = rl.a((byte) -104);
        this.field_b = 0L;
        this.field_d = 0L;
        this.field_c = 0;
        this.field_o = 0;
        this.field_j = new kd[8];
        this.field_n = true;
        this.field_k = 0;
        this.field_f = new kd[8];
        this.field_i = 0;
    }
}
