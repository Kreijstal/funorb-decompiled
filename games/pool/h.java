...
final class h {
    ...
    final float[] c() {
        return ((h) this).field_b[((h) this).b()];
    }

    private final static int a(int param0, int param1) {
        int var2 = 0;
        for (var2 = (int)Math.pow((double)param0, 1.0 / (double)param1) + 1; me.a(param1, var2, -1) > param0; var2--) {
        }
        return var2;
    }
    ...
    h() {
        ...
        int stackOut_21_0 = 0;
        L0: {
          int discarded$2 = gm.a(24);
          ((h) this).field_e = gm.a(16);
          ((h) this).field_d = gm.a(24);
          ((h) this).field_a = new int[((h) this).field_d];
          if (gm.c() == 0) {
            stackOut_2_0 = 0;
        ...
        L1: {
          ...
          if (var1 == 0) {
                ...
                L4: {
                  if (var2 == 0) {
                    ...
                    if (gm.c() != 0) {
                      ...
                      ((h) this).field_a[var14] = 0;
                      var14++;
                      continue L3;
                    }
                  }
                }
                ((h) this).field_a[var14] = gm.a(5) + 1;
                var14++;
                continue L3;
              }
            }
            ...
            var3_int = gm.a(5) + 1;
            L5: while (true) {
              if (var2 >= ((h) this).field_d) {
                break L1;
              } else {
                var4_int = gm.a(gi.a(((h) this).field_d - var2, 0));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
                    ...
                    var2++;
                    ((h) this).field_a[incrementValue$3] = var3_int;
                    var5++;
                    continue L6;
                  }
                }
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = ((h) this).field_d * ((h) this).field_e;
                break L9;
              } else {
                var7 = h.a(((h) this).field_d, ((h) this).field_e);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                ((h) this).field_b = new float[((h) this).field_d][((h) this).field_e];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
                    if (var8 >= ((h) this).field_d) {
                      break L7;
                    } else {
                      var9 = 0.0f;
                      ...
                      L12: while (true) {
                        if (var11 >= ((h) this).field_e) {
                          ...
                          ((h) this).field_b[var8][var11] = var12;
                          if (var6 != 0) {
                            var9 = var12;
                            var10++;
                            var11++;
                      ...
                      L14: while (true) {
                        if (var11 >= ((h) this).field_e) {
                          ...
                          L15: {
                            ...
                            ((h) this).field_b[var8][var11] = var13;
                            if (var6 == 0) {
                              break L15;
                            } else {
                              var9 = var13;
