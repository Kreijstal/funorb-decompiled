...
abstract class bb {
    ...
    final static void a(int param0, int[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        int var9_int = param7 * param1[11] + (param1[9] * param2 + param1[10] * param6) >> 1239012016;
        if (!(var9_int > 0)) {
            return;
        }
        int var10 = param1[10] * param0 + param5 * param1[9] + param1[11] * param8 >> 1606936624;
        if (-1 <= (var10 ^ -1)) {
            return;
        }
        try {
            ...
            throw wm.a((Throwable) ((Object) runtimeException), "bb.G(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ',' + param8 + ')');
        }
    }
                        ...
                        L2: while (true) {
                          if (var11 >= param1) {
                            ...
                            L3: {
                              ...
                              if (param6) {
                                stackIn_27_0 = kb.field_g[var12];
                                break L3;
                              } else {
                                stackIn_27_0 = ah.field_c[var12];
                                break L3;
                              }
                            }
                            L4: {
                              ...
                              if (var13 <= var7_int) {
                                ...
                                var8++;
                                ep.field_H[incrementValue$0] = var12;
                                if (var9 > var13) {
                                  var9 = var13;
                                  break L4;
                                } else {
