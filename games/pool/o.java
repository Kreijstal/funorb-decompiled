...
class o extends rg {
    ...
    final static String a(char param0, String param1, String param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("o.R(").append(param0).append(',');
          ...
          throw wm.a((Throwable) (Object) stackIn_19_0, stackIn_19_2 + ',' + 1 + ')');
        }
        return stackIn_12_0;
    }
    ...
    final static int a(byte[] param0, CharSequence param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          throw wm.a((Throwable) (Object) stackIn_75_0, stackIn_75_2 + ',' + param2 + ',' + param3 + ',' + 0 + ',' + param5 + ')');
        }
        return stackIn_68_0;
    }
