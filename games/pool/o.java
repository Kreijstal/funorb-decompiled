...
class o extends rg {
    ...
    final static String a(char param0, String param1, String param2, int param3) {
        ...
        try {
          L0: {
            ...
            if (param3 == 1) {
              ...
              L3: while (true) {
                ...
                if ((var10 ^ -1) <= -1) {
                  discarded$13 = var8.append(param2.substring(var9, var10));
                  discarded$14 = var8.append(param1);
                  var9 = 1 + var10;
                  continue L3;
                } else {
                  discarded$15 = var8.append(param2.substring(var9));
          ...
          L4: {
            ...
            stackOut_14_1 = new StringBuilder().append("o.R(").append(param0).append(',');
          ...
          throw wm.a((Throwable) ((Object) stackIn_20_0), stackIn_20_2 + ',' + param3 + ')');
        }
    ...
    final static int a(byte[] param0, CharSequence param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          throw wm.a((Throwable) ((Object) stackIn_75_0), stackIn_75_2 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ')');
        }
        return stackIn_68_0;
    }
