...
class o extends rg {
    ...
    final static int a(int param0, byte param1) {
        ...
        if (-4097 >= (param0 ^ -1)) {
          L0: {
            if (-6145 >= (param0 ^ -1)) {
              stackIn_8_0 = wf.field_b[-6144 + param0];
              break L0;
            } else {
              stackIn_8_0 = -wf.field_b[6144 - param0];
              break L0;
          ...
          L1: {
            if (param0 < 2048) {
              stackIn_4_0 = wf.field_b[2048 - param0];
              break L1;
            } else {
              stackIn_4_0 = -wf.field_b[param0 + -2048];
              break L1;
            }
          }
          return stackIn_4_0;
    ...
    final static String a(char param0, String param1, String param2, int param3) {
        ...
        try {
          L0: {
            ...
            if (param3 == 1) {
              ...
              L3: while (true) {
                ...
                if ((var10 ^ -1) <= -1) {
                  discarded$2 = var8.append(param2.substring(var9, var10));
                  discarded$3 = var8.append(param1);
                  var9 = 1 + var10;
                  continue L3;
                } else {
                  discarded$4 = var8.append(param2.substring(var9));
          ...
          L4: {
            ...
            stackIn_16_1 = new StringBuilder().append("o.R(").append(param0).append(',');
          ...
          throw wm.a((Throwable) ((Object) stackIn_17_0), stackIn_20_2 + ',' + param3 + ')');
        }
    ...
    final static int a(byte[] param0, CharSequence param1, int param2, int param3, int param4, int param5) {
        ...
        try {
          ...
          L7: {
            ...
            stackIn_71_1 = new StringBuilder().append("o.P(");
          ...
          throw wm.a((Throwable) ((Object) stackIn_72_0), stackIn_75_2 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ')');
        }
        return stackIn_68_0;
    }
