...
class fe extends ei {
    ...
    final static void a(boolean param0, boolean param1, boolean param2, int param3, int param4) {
        ...
        try {
                                                      ...
                                                      L31: while (true) {
                                                        L32: {
                                                          if (var23.length <= var15) {
                                                            ...
                                                            var16 = var23[var15];
                                                            stackOut_55_0 = var16 ^ -1;
                                                            stackOut_55_1 = var14 ^ -1;
          ...
          throw wm.a((Throwable) ((Object) var5), "fe.GA(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ')');
        }
    }
          ...
          L0: {
            L1: {
              if (param1 == -13671) {
                ...
                discarded$2 = fe.a((int[]) null, 103, 77);
                break L1;
              }
            }
            L2: {
    ...
    boolean a(char param0, int param1, boolean param2, ei param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("fe.U(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
              ...
              L1: {
                if (!this.field_I) {
                  ...
                  if (!this.a(param1, param5, param6, -1, param4)) {
                    ...
                    L2: {
                      discarded$2 = this.a(param0, (byte) 122);
                      this.field_n = param3;
                      if (this.field_t == null) {
                        break L2;
                      } else {
    ...
    final static String a(boolean param0, byte param1, CharSequence param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_18_1 = new StringBuilder().append("fe.DA(").append(param0).append(',').append(param1).append(',');
            stackIn_20_0 = stackOut_18_0;
    ...
    final void a(int param0, int param1, int param2, int param3, byte param4, ei param5) {
        ...
        try {
            ...
            if (param4 <= 62) {
                discarded$0 = this.a((ei) null, -88, true, 21, -27, 5, -59);
            }
            this.field_n = 0;
