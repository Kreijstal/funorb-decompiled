...
final class nb extends kd {
    ...
    final synchronized int n() {
        return this.field_B < 0 ? -1 : this.field_B + 32 >> 6;
    }

    private final void h() {
        this.field_v = this.field_x;
        this.field_r = nb.a(this.field_x, this.field_B);
        this.field_s = nb.e(this.field_x, this.field_B);
    }
    ...
    final int d() {
        if (this.field_x == 0 && this.field_A == 0) {
            return 0;
        }
        return 1;
    }
          ...
          L4: {
            if (this.field_p <= 0) {
              ...
              if (!this.field_y) {
                if (this.field_w >= 0) {
                  L5: while (true) {
                    var9 = this.b(param0, var9, var6, param2, (int) var4.field_n[this.field_C]);
                  ...
                  L6: while (true) {
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_n[this.field_z - 1]);
                ...
                L7: {
                  if (this.field_w >= 0) {
                    ...
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_n[this.field_C]);
                    if (this.field_t < var5) {
                ...
                L8: while (true) {
                  var9 = this.b(param0, var9, var6, param2, (int) var4.field_n[this.field_z - 1]);
                  if (this.field_t >= var6) {
        ...
        if (param0 != 0) {
          ...
          if (this.field_r == var4) {
            if (this.field_s == var5) {
              ...
              this.field_x = param1;
              this.field_B = param2;
              this.field_D = (param1 - this.field_v) / param0;
              this.field_u = (var4 - this.field_r) / param0;
    ...
    final synchronized void g(int param0) {
        int var2 = ((jg) ((Object) this.field_n)).field_n.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
        ...
        if (param0 != 0) {
          if (this.field_r == 0) {
            if (this.field_s == 0) {
              ...
              this.field_D = -this.field_v / param0;
              this.field_u = -this.field_r / param0;
        ...
        L0: {
          if (this.field_A <= 0) {
            ...
            if (param0 < this.field_A) {
              this.field_v = this.field_v + this.field_D * param0;
              this.field_r = this.field_r + this.field_u * param0;
    ...
    private final boolean e() {
        ...
        L0: {
          var1 = this.field_x;
          if (var1 != -2147483648) {
            var2 = nb.a(var1, this.field_B);
            var3 = nb.e(var1, this.field_B);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L3: {
          if (this.field_r >= var2) {
            if (this.field_r <= var2) {
              ...
              L4: {
                ...
                if (this.field_A == 0) {
                  ...
                  if (this.field_A <= this.field_r - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_A = this.field_r - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_A == 0) {
                ...
                if (this.field_A <= var2 - this.field_r) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_A = var2 - this.field_r;
            break L3;
          }
        }
        if (this.field_s < var3) {
          this.field_q = 1;
          if (this.field_A != 0) {
            if (this.field_A > var3 - this.field_s) {
              this.field_A = var3 - this.field_s;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_s <= var3) {
              ...
              L7: {
                ...
                if (this.field_A == 0) {
                  ...
                  if (this.field_A <= this.field_s - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_A = this.field_s - var3;
              break L6;
            }
          }
          return false;
    ...
    final synchronized int l() {
        return this.field_x == -2147483648 ? 0 : this.field_x + 32 >> 6;
    }
    ...
    final synchronized int f() {
        return this.field_B < 0 ? -1 : this.field_B;
    }
    ...
    final int c() {
        ...
        if (this.field_p == 0) {
            var1 = var1 - var1 * this.field_t / (((jg) ((Object) this.field_n)).field_n.length << 8);
        } else {
            if (this.field_p >= 0) {
                var1 = var1 - var1 * this.field_C / ((jg) ((Object) this.field_n)).field_n.length;
            }
        }
        ...
        L0: while (true) {
          if (this.field_A <= 0) {
            L1: {
              if (this.field_w != -256) {
                ...
                if ((this.field_t & 255) != 0) {
                  ...
                  if (bp.field_r) {
                    return nb.a(0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_r, this.field_s, 0, param3, param2, (nb) (this));
                  } else {
                    return nb.b(((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_v, 0, param3, param2, (nb) (this));
                  }
                }
              }
            }
            if (bp.field_r) {
              return nb.a(0, 0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_r, this.field_s, 0, param3, param2, (nb) (this), this.field_w, param4);
            } else {
              return nb.b(0, 0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_v, 0, param3, param2, (nb) (this), this.field_w, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_w != -256) {
                  ...
                  if ((this.field_t & 255) != 0) {
                    ...
                    if (!bp.field_r) {
                      param1 = nb.a(((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_v, this.field_D, 0, var6, param2, (nb) (this));
                      break L3;
                    } else {
                      param1 = nb.a(0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_r, this.field_s, this.field_u, this.field_q, 0, var6, param2, (nb) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!bp.field_r) {
                param1 = nb.b(0, 0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_v, this.field_D, 0, var6, param2, (nb) (this), this.field_w, param4);
                break L3;
              } else {
                param1 = nb.b(0, 0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_r, this.field_s, this.field_u, this.field_q, 0, var6, param2, (nb) (this), this.field_w, param4);
                break L3;
              }
            }
            this.field_A = this.field_A - param1;
        ...
        L0: while (true) {
          if (this.field_A <= 0) {
            L1: {
              if (this.field_w != 256) {
                ...
                if ((this.field_t & 255) != 0) {
                  ...
                  if (bp.field_r) {
                    return nb.b(0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_r, this.field_s, 0, param3, param2, (nb) (this));
                  } else {
                    return nb.a(((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_v, 0, param3, param2, (nb) (this));
                  }
                }
              }
            }
            if (bp.field_r) {
              return nb.c(0, 0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_r, this.field_s, 0, param3, param2, (nb) (this), this.field_w, param4);
            } else {
              return nb.a(0, 0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_v, 0, param3, param2, (nb) (this), this.field_w, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_A;
            ...
            L3: {
              L4: {
                ...
                if (this.field_w != 256) {
                  ...
                  if ((this.field_t & 255) != 0) {
                    ...
                    if (!bp.field_r) {
                      param1 = nb.b(((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_v, this.field_D, 0, var6, param2, (nb) (this));
                      break L3;
                    } else {
                      param1 = nb.b(0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_r, this.field_s, this.field_u, this.field_q, 0, var6, param2, (nb) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!bp.field_r) {
                param1 = nb.d(0, 0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_v, this.field_D, 0, var6, param2, (nb) (this), this.field_w, param4);
                break L3;
              } else {
                param1 = nb.a(0, 0, ((jg) ((Object) this.field_n)).field_n, param0, this.field_t, param1, this.field_r, this.field_s, this.field_u, this.field_q, 0, var6, param2, (nb) (this), this.field_w, param4);
                break L3;
              }
            }
            this.field_A = this.field_A - param1;
    ...
    final synchronized boolean i() {
        return this.field_t < 0 || this.field_t >= ((jg) ((Object) this.field_n)).field_n.length << 8;
    }
    ...
    private nb(jg param0, int param1, int param2) {
        this.field_n = (qm) ((Object) param0);
        this.field_C = param0.field_m;
        this.field_z = param0.field_q;
