...
final class c {
        ...
        try {
          L0: {
            ...
            if (param2 == null) {
              ...
              L1: {
                stackIn_7_0 = (di) (param2);

                if (!param1) {
                  stackIn_8_0 = (di) ((Object) stackIn_7_0);
                  stackIn_8_1 = 0;
                  break L1;
                } else {
                  stackIn_8_0 = (di) ((Object) stackIn_7_0);
              ...
              o.field_x = new wh(var3_int, param2, param2, new wp());
              var4 = nk.c(2);
              if (var4 != null) {
                gp.a((byte) 58, var4);
                var12 = (lr) null;
          ...
          L3: {
            ...
            stackIn_18_1 = new StringBuilder().append("c.B(");
    ...
    final static int a(int param0, int param1, byte param2) {
        ...
        try {
          L0: {
            var3_int = 0;
            var4 = -31 % ((param2 - -32) / 54);
            L1: while (true) {
              if (0 >= param1) {
                stackIn_4_0 = var3_int;
                break L0;
              } else {
                var3_int = var3_int << 460871489 | 1 & param0;
                param0 = param0 >>> 1;
                param1--;
                continue L1;
              }
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var3 = decompiledCaughtException;
          throw wm.a((Throwable) ((Object) var3), "c.D(" + param0 + ',' + param1 + ',' + param2 + ')');
        }
        return stackIn_4_0;
    }
