    ...
    final static qp a(byte param0, vh param1, int[] param2, vh param3, vh param4) {
        ...
        try {
          L0: {
            ...
            stackOut_10_0 = new qp(0L, param1, param3, param4, var8, param2, var6, var14);
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("ld.A(").append(param0).append(',');
          ...
          if (var2 >= 8) {
            ...
            L1: while (true) {
              if ((var2 ^ -1) <= -9) {
                ...
                this.field_m[var2] = this.field_o[var2];
                this.field_l[var2] = im.a(this.field_n[var2], this.field_o[var2]);
                var2++;
                continue L1;
              }
            }
