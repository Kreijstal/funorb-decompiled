...
final class ve extends op {
    ...
    final static void a(int param0, int param1, int param2, nm param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("ve.L(").append(111).append(44).append(param1).append(44).append(param2).append(44);
    ...
    private final vj a(lr param0, int param1, boolean param2, String param3) {
        ...
        try {
          L0: {
            var5_ref = new vj(param1 - param0.field_C, param1 + param0.field_w, param3.length());
            ((ve) this).field_b = new vj[]{var5_ref};
            stackOut_3_0 = (vj) var5_ref;
          ...
          L2: {
            ...
            stackOut_9_1 = ((StringBuilder) (Object) stackIn_9_1).append(stackIn_9_2).append(44).append(param1).append(44).append(1).append(44);
    ...
    final void a(int param0, String param1, lr param2, boolean param3, int param4) {
        ...
        try {
          L0: {
            if (null != param1) {
              L1: {
                if (param2 != ((ve) this).field_i) {
                  break L1;
                } else {
                  if (!((ve) this).field_k) {
                    break L1;
                  } else {
                    if (0 != ((ve) this).field_s) {
                      break L1;
                    } else {
                      if (((ve) this).field_t == null) {
                        break L1;
                      } else {
                        if (!((ve) this).field_t.equals((Object) (Object) param1)) {
                          break L1;
                        } else {
                          return;
                        }
              ...
              ((ve) this).field_t = param1;
              ((ve) this).field_s = 0;
              ((ve) this).field_i = param2;
              ((ve) this).field_k = param3;
          ...
          L2: {
            ...
            stackOut_19_1 = new StringBuilder().append("ve.Q(").append(param0).append(44);
          ...
          throw wm.a((Throwable) (Object) stackIn_27_0, stackIn_27_2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    final static void b(byte param0) {
        ...
        try {
          ...
          throw wm.a((Throwable) (Object) var1, "ve.M(" + -14 + 41);
        }
    }
    ...
    final static String d() {
        ...
        try {
          ...
          throw wm.a((Throwable) (Object) var1_ref, "ve.J(" + 120 + 41);
        }
        return stackIn_14_0;
    }
        ...
        try {
          L0: {
            ...
            if (null == param3) {
              ...
              L2: {
                if (param0 != ((ve) this).field_i) {
                  break L2;
                } else {
                  if (!((ve) this).field_k) {
                    break L2;
                  } else {
                    if (((ve) this).field_s != 1) {
                      break L2;
                    } else {
                      if (null == ((ve) this).field_t) {
                        break L2;
                      } else {
                        if (!((ve) this).field_t.equals((Object) (Object) param3)) {
                          break L2;
                        } else {
                          return;
                        }
          ...
          throw wm.a((Throwable) (Object) stackIn_32_0, stackIn_32_2 + 44 + param4 + 41);
        }
    }
    ...
    final void a(String param0, lr param1, boolean param2, int param3, int param4) {
        ...
        try {
                    ...
                    if (!((ve) this).field_k) {
                      ...
                      if (((ve) this).field_s != 2) {
                        ...
                        if (((ve) this).field_t == null) {
                          ...
                          if (((ve) this).field_t.equals((Object) (Object) param0)) {
                            return;
                          } else {
                            break L1;
                          }
          ...
          throw wm.a((Throwable) (Object) stackIn_33_0, stackIn_33_2 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
        ...
        try {
          L0: {
            ...
            if (param1 != null) {
              ...
              L3: {
                ((ve) this).field_n = param5;
                ((ve) this).field_s = param0;
                ((ve) this).field_u = param3;
                ((ve) this).field_v = param4;
                ((ve) this).field_t = param1;
                ((ve) this).field_r = param6;
                ((ve) this).field_k = false;
                ((ve) this).field_i = param2;
                var9_array = new String[1 + param2.b(param1, param5)];
                var10 = Math.max(1, param2.a(param1, new int[1], var9_array));
                  ...
                  if (((ve) this).field_r == 1) {
                    ...
                    L7: {
                      if (((ve) this).field_r == 2) {
                        ...
                        ((ve) this).field_v = ((ve) this).field_v + var12;
                        if (var15 == 0) {
                          break L4;
                        } else {
                          break L7;
                    ...
                    var11 = -(((ve) this).field_v * var10) + -param2.field_w + ((ve) this).field_u;
                    if (var15 == 0) {
                      break L4;
                    } else {
                      break L6;
                          ...
                          if (null != var13) {
                            L14: {
                              ...
                              if (param0 == 3) {
                                ...
                                stackOut_70_3 = ((ve) this).a(param2.b(var13), (byte) 105, var13, param5);
          ...
          L15: {
            ...
            stackOut_74_1 = new StringBuilder().append("ve.O(").append(param0).append(44);
          ...
          throw wm.a((Throwable) (Object) stackIn_82_0, stackIn_82_2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 41);
        }
    }
    ...
    final static void a(int param0, boolean param1, int[] param2, boolean param3, boolean param4, int[] param5, oc param6) {
        ...
        try {
            ...
            L1: while (true) {
              if (param6.field_k <= var23) {
                ...
                L4: while (true) {
                  ...
                  ej.a(false, var8, var7_int, (byte) 48, param6);
                  break L0;
                }
              } else {
                L6: {
          ...
          L9: {
            ...
            stackOut_60_0 = (RuntimeException) var7;
            stackOut_60_1 = new StringBuilder().append("ve.N(").append(-3).append(44).append(0).append(44);
          ...
          L10: {
            ...
            stackOut_64_1 = ((StringBuilder) (Object) stackIn_64_1).append(stackIn_64_2).append(44).append(0).append(44).append(1).append(44);
    ...
    public static void c() {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var1 = decompiledCaughtException;
          throw wm.a((Throwable) (Object) var1, "ve.K(" + -13268 + 41);
        }
    }
    ...
    private static void $cfr$clinit() {
        field_q = new String[][]{new String[6], null, null, null};
