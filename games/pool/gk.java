    ...
    private final fe a(int param0, String param1, cc param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("gk.T(").append(2391).append(',');
    ...
    public final void a(boolean param0, int param1, int param2, fe param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("gk.P(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
