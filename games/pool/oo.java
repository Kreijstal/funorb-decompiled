...
abstract class oo {
    ...
    final fa b(int[] param0, eg param1, int param2) {
        ...
        try {
          L0: {
            ...
            stackIn_3_0 = param1.a(this.field_d, this.field_t, this.field_q, this.field_e, this.field_u, param0);
            break L0;
          }
          ...
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("oo.FC(");
          ...
          throw wm.a((Throwable) ((Object) stackIn_7_0), stackIn_10_2 + ',' + param2 + ')');
        }
        return stackIn_3_0;
    }
    ...
    final void a(int[] param0, int param1, int param2, int[] param3) {
        ...
        try {
            this.a(param1, mn.field_g, (byte) -118, br.field_I);
        } catch (RuntimeException runtimeException) {
    ...
    private final void a(dl param0, int param1, uf param2, int param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackIn_17_1 = new StringBuilder().append("oo.FB(");
          ...
          throw wm.a((Throwable) ((Object) stackIn_18_0), stackIn_21_2 + ',' + param3 + ')');
        }
    ...
    private final void a(int param0, int param1, int param2, int param3, byte param4, int param5) {
        ...
        for (var16 = 0; var12.length > var16; var16++) {
            ...
            var18.a(var25, var27, var26, (byte) 1, hh.a((byte) -123, this.e(31761)), this.c(99));
            var18.a(var28, var26, var27, (byte) 1, hh.a((byte) 94, this.e(31761)), this.c(97));
            var18.a(var25, var26, var27, (byte) 1, hh.a((byte) 93, this.e(31761)), this.c(100));
            var18.a(var28, var27, var26, (byte) 1, hh.a((byte) 42, this.e(31761)), this.c(95));
            var12[var16] = var18;
            var13[var16] = new p((nc) ((Object) var12[var16].a(this.field_C, this.field_x, this.field_q, this.field_e, this.field_u)), new int[]{var23, var24, 0});
        }
        this.field_f[param5] = var12;
        this.field_o[param5] = var13;
    }
        ...
        if (param1.field_j <= -524288) {
          L0: {
            if (dq.field_a.field_g) {
              var3 = this.field_q + (param1.field_g >> 13);
              var4 = this.field_e + (param1.field_k >> 13);
              var5 = this.field_u + (param1.field_j >> 13);
              break L0;
            } else {
              var3 = this.field_q + 2304;
              var4 = this.field_e + 1152;
              var5 = this.field_u;
              break L0;
            }
          }
                            ...
                            L37: while (true) {
                              if (var52 >= var43) {
                                ...
                                if (var57 < 16384) {
                                  ...
                                  L39: {
                                    var58 = (this.field_C << 1) + (var57 * this.field_x >> 13);
                                    if (var58 >= 0) {
                                      break L39;
                                    } else {
                                      var58 = 0;
    ...
    final fa a(int[] param0, byte param1, eg param2) {
        ...
        try {
          L0: {
            if (param1 == 103) {
              stackIn_4_0 = param2.a(this.field_d, this.field_t, -param0[0] + (2304 + this.field_q), 1152 + (this.field_e + -param0[1]), this.field_u - param0[2], param0);
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
              stackIn_2_0 = (fa) null;
          ...
          L1: {
            ...
            stackIn_7_1 = new StringBuilder().append("oo.DC(");
    ...
    final void a(int param0, cf param1, di param2) {
        ...
        try {
          L0: {
            L1: {
              if (param0 == 3) {
                ...
                var5 = (kf[]) null;
                this.a(-23, -100, (byte) -87, (jg[]) null, (kf[]) null);
                break L1;
              }
            }
            L2: {
              if (this.field_b != null) {
                tl.field_N.a(param1, param2, this.field_b, param0 ^ 79, 0);
                break L2;
              } else {
                break L2;
              }
          ...
          L3: {
            ...
            stackIn_8_1 = new StringBuilder().append("oo.VB(").append(param0).append(',');
    ...
    void a(int param0, di param1) {
        try {
            ...
            throw wm.a((Throwable) ((Object) runtimeException), "oo.Q(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final String c(byte param0) {
        if (param0 != 32) {
            int[] var3 = (int[]) null;
            this.a(-106, (int[]) null, 4, (int[]) null, 62);
        }
        return "lighting amb=" + this.field_d + ", cont=" + this.field_m;
    }
    ...
    final fa a(int[] param0, eg param1, int param2) {
        ...
        try {
          L0: {
            L1: {
              if (param2 <= -52) {
                ...
                var5 = (pq[]) null;
                this.a(true, (int[]) null, (pq[]) null);
                break L1;
              }
            }
            stackIn_3_0 = param1.a(this.field_C, this.field_F, this.field_q, this.field_e, this.field_u, param0);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("oo.RB(");
    ...
    void c(boolean param0) {
        if (!param0) {
            this.field_z = -0.5056021213531494f;
        }
    }
    ...
    private final void a(dl[] param0, int param1) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (-17 >= (var3_int ^ -1)) {
                var12 = (nc) ((Object) this.a(-113, d.field_b));
                var3 = var12;
                ...
                if (param1 < -16) {
                  ...
                  L2: while (true) {
                    if (v.field_g.length <= var4) {
                      ...
                      v.field_g[var4] = new p(var12, new int[]{param0[var4].field_g >> -1359700307, param0[var4].field_f >> -1764693267, 0});
                      var4++;
                      continue L2;
                    }
                  }
                ...
                d.field_b.a(d.field_b.a(0, 0, 0), d.field_b.a(cr.a(4885, 18.0 * var10), cr.a(4885, var8 * 18.0), 0), d.field_b.a(cr.a(4885, 18.0 * var6), cr.a(4885, 18.0 * var4_double), 0), (byte) 1, (short) 127, (byte) 127);
                var3_int++;
                continue L1;
              }
            }
          ...
          L3: {
            ...
            stackIn_11_1 = new StringBuilder().append("oo.CB(");
    ...
    private final void a(byte param0, bf[] param1) {
        ...
        try {
          L0: {
            this.field_f = new eg[param1.length][];
            this.field_o = new p[param1.length][];
            if (param0 == -92) {
              var3_int = 0;
              L1: while (true) {
                if (var3_int >= this.field_f.length) {
                  ...
                  this.a(param1[var3_int].field_a >> -1370415795, param1[var3_int].field_l >> 2102003661, param1[var3_int].field_j >> -1443369875, param1[var3_int].field_f >> 805761805, (byte) -57, var3_int);
                  var3_int++;
                  continue L1;
                }
              }
          ...
          L2: {
            ...
            stackIn_8_1 = new StringBuilder().append("oo.GC(").append(param0).append(',');
    ...
    void a(di param0, int param1) {
        try {
            ...
            throw wm.a((Throwable) ((Object) runtimeException), "oo.KA(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ')');
        }
    }
    ...
    final void a(int param0, int param1, byte param2, jg[] param3, kf[] param4) {
        ...
        try {
          L0: {
            var6_int = 6114 * param0 >> -1033188473;
            var7 = 0;
            L1: while (true) {
              if (var7 >= 2) {
          ...
          L6: {
            ...
            stackIn_21_1 = new StringBuilder().append("oo.GB(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    void a(al param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_7_1 = new StringBuilder().append("oo.B(");
    ...
    final fa a(int param0, eg param1) {
        ...
        try {
          L0: {
            ...
            stackIn_1_0 = param1.a(this.field_C, this.field_F, this.field_q, this.field_e, this.field_u);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L1: {
            ...
            stackIn_4_1 = new StringBuilder().append("oo.BC(").append(param0).append(',');
    ...
    final void a(int param0, int[] param1) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (var3_int >= this.field_y.length) {
                break L0;
              } else {
                this.field_y[var3_int].c(6710886, param1);
                var3_int++;
                continue L2;
              }
            }
          ...
          L3: {
            ...
            stackIn_8_1 = new StringBuilder().append("oo.BB(").append(param0).append(',');
    ...
    final void a(int param0, int[] param1, int param2, int[] param3, int param4) {
        try {
            ...
            this.a(param4, mn.field_g * param2 >> 1336449640, (byte) -111, br.field_I);
            if (param0 != 1336449640) {
                this.field_j = 1.1224327362689441;
            }
        } catch (RuntimeException runtimeException) {
            throw wm.a((Throwable) ((Object) runtimeException), "oo.QB(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ',' + param2 + ',' + (param3 != null ? "{...}" : "null") + ',' + param4 + ')');
        }
    }
    ...
    final void a(int[] param0, byte param1, boolean param2, pq[] param3, boolean param4) {
        ...
        try {
          ...
          L6: {
            ...
            stackIn_21_1 = new StringBuilder().append("oo.LB(");
    ...
    final String b(byte param0) {
        ...
        return "lighting amb=" + this.field_C + ", cont=" + this.field_x + ", ang=[" + (int)(this.field_j * 180.0 / 3.141592653589793) + ", " + (int)(this.field_p * 180.0 / 3.141592653589793) + "], dist=" + (int)this.field_E + " => pos=[" + this.field_q + "," + this.field_e + "," + this.field_u + "], gamma=" + this.field_z;
    }
          ...
          if ((var6 ^ -1) != -16) {
            if ((var6 ^ -1) != -17) {
              if (var6 != 10) {
                  ...
                  if ((var6 ^ -1) != -18) {
                    if (-19 != (var6 ^ -1)) {
                      ...
                      if (null != this.field_n) {
                        ac.a(256, false, false, this.field_n);
                        break L1;
                      } else {
                        if (null == this.field_i) {
                          break L1;
                        } else {
                          ac.a(256, false, false, this.field_i);
                          break L0;
                        }
                      }
                    }
                ...
                ac.a(256, true, true, this.field_b);
                break L0;
              }
            } else {
              this.a(3, param1, (byte) -117, param3);
              break L0;
            }
          } else {
            this.a(2, param1, (byte) -105, param3);
            break L0;
          }
        }
    }
    ...
    void c(int param0, di param1) {
        try {
            ...
            throw wm.a((Throwable) ((Object) runtimeException), "oo.OA(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final void b(int param0) {
        L0: while (true) {
          if (this.field_j >= 0.0) {
            L1: {
              if (16.0 > this.field_E) {
                this.field_E = 16.0;
                break L1;
              } else {
                if (16384.0 >= this.field_E) {
                  break L1;
                } else {
            ...
            L2: while (true) {
              if (this.field_j < 6.283185307179586) {
                L3: {
                  if (0.0 <= this.field_p) {
                    if (1.5707963267948966 >= this.field_p) {
                      break L3;
                    } else {
                      this.field_p = 1.5707963267948966;
                      break L3;
                    }
                  } else {
                    this.field_p = 0.0;
                ...
                this.field_q = (int)(this.field_E * Math.cos(this.field_j) * Math.cos(this.field_p));
                if (param0 >= 109) {
                  L4: {
                    this.field_e = (int)(this.field_E * Math.sin(this.field_j) * Math.cos(this.field_p));
                    this.field_u = -(int)(this.field_E * Math.sin(this.field_p));
                    if (-1 > (this.field_x ^ -1)) {
                      break L4;
                    } else {
                      this.field_x = 1;
                  ...
                  L5: {
                    this.field_F = 132072 / (this.field_x * 3);
                    if (-1 > (this.field_m ^ -1)) {
                      break L5;
                    } else {
                      this.field_m = 1;
                  ...
                  fb.field_p = this.field_z;
                  this.field_t = 132072 / (3 * this.field_m);
                  fb.b(this.field_z);
                  return;
                } else {
                  return;
                ...
                this.field_j = this.field_j - 6.283185307179586;
                continue L2;
              }
            }
          } else {
    ...
    private final void a(bf[] param0, int param1) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (param0.length <= var7) {
                this.field_a = new int[var6][2];
                this.field_g = new int[var6][2];
                var15 = 0;
                var7 = var15;
                L2: while (true) {
                  if (var15 >= this.field_a.length) {
                    break L0;
                  } else {
                    L3: {
                      var8 = param0[var17[var15][1]].a(123) + -param0[var17[var15][0]].a(109);
                      var9 = param0[var17[var15][1]].a((byte) -127) - param0[var17[var15][0]].a((byte) -127);
                      this.field_a[var15][0] = -var9 >> -1419726515;
                      this.field_a[var15][1] = var8 >> -772657139;
                      ...
                      if ((var10 ^ -1L) < -2147483648L) {
                        ...
                        if ((var10 ^ -1L) <= 2147483647L) {
                          this.field_a[var15][0] = lh.a((int)var10, (byte) -74, (long)this.field_a[var15][0]);
                          this.field_a[var15][1] = lh.a((int)var10, (byte) -95, (long)this.field_a[var15][1]);
                          this.field_g[var15][0] = var17[var15][0];
                          this.field_g[var15][1] = var17[var15][1];
                          var15++;
                          continue L2;
                        } else {
                          break L3;
                  ...
                  if (param0.length <= var8) {
                    ...
                    L5: {
                      ...
                      if (var3_long < var13) {
                        ...
                        var6++;
                        var5[incrementValue$0] = new int[]{var7, var8};
                        break L5;
                      } else {
                        if ((var3_long ^ -1L) == (var13 ^ -1L)) {
                          incrementValue$1 = var6;
                          var6++;
                          var5[incrementValue$1] = new int[]{var7, var8};
                          break L5;
                        } else {
                          var8++;
                          continue L4;
          ...
          L6: {
            ...
            stackIn_21_1 = new StringBuilder().append("oo.PB(");
    ...
    void a(boolean param0, mm param1) {
        ...
        try {
          L0: {
            ...
            L3: {
              if (!param0) {
                ...
                var5 = (pq[]) null;
                this.a((int[]) null, (byte) -29, true, (pq[]) null, false);
                break L3;
              }
            }
            L4: {
          ...
          L5: {
            ...
            stackIn_17_1 = new StringBuilder().append("oo.VA(").append(param0).append(',');
    ...
    private final void f(int param0) {
        ...
        this.field_s = new eg(4, param0, 1);
        int var11 = this.field_s.a(-var9, -var10, 0);
        int var12 = this.field_s.a(var9, -var10, 0);
        int var13 = this.field_s.a(-var9, var10, 0);
        int var14 = this.field_s.a(var9, var10, 0);
        this.field_s.a(var11, var13, var12, (byte) 1, hh.a((byte) -105, this.h(684)), this.g(-56));
        this.field_s.a(var14, var12, var13, (byte) 1, hh.a((byte) -127, this.h(684)), this.g(91));
        nc var15 = (nc) ((Object) this.a(103, this.field_s));
        for (var16 = 0; var16 < var4; var16++) {
            var17 = var7 * (double)(1 + 2 * var16) / 2.0;
            for (var19 = 0; var3 > var19; var19++) {
                var20 = var5 * (double)(1 + var19 * 2) / 2.0;
                this.field_y[var16 * var3 - -var19] = new p(var15, ib.a(new double[]{var20, var17, 0.0}, -30100));
            }
        }
    }
    ...
    void b(int param0, di param1) {
        try {
            ...
            throw wm.a((Throwable) ((Object) runtimeException), "oo.JA(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    oo() {
        this.field_q = -1024;
        this.field_u = -10240;
        this.field_p = 0.7853981633974483;
        this.field_z = 1.0f;
        this.field_G = 0;
        this.field_x = 32;
        this.field_F = 1031;
        ...
        this.field_h = false;
        this.field_e = -1024;
        this.field_j = 0.7853981633974483;
        this.field_t = 1031;
        this.b(115);
    }
    ...
    void a(int param0, uf param1) {
        ...
        try {
          ...
          L7: {
            ...
            stackIn_23_1 = new StringBuilder().append("oo.T(").append(param0).append(',');
