...
final class tq extends ma {
    ...
    final static boolean a(boolean param0, long param1, String param2) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_11_1 = new StringBuilder().append("tq.A(").append(param0).append(44).append(param1).append(44);
    ...
    final static void a(long param0, byte param1, String param2) {
        ...
        try {
            ...
            throw wm.a((Throwable) (Object) runtimeException, "tq.G(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final static int[] a(int param0, int param1, double[] param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("tq.D(").append(param0).append(44).append(param1).append(44);
