...
final class lf {
    ...
    final static double[] a(int param0, double[] param1, double[] param2) {
        ...
        try {
          L0: {
            stackOut_0_0 = new double[]{-(param1[1] * param2[2]) + param2[1] * param1[2], -(param1[2] * param2[0]) + param2[2] * param1[0], -(param2[1] * param1[0]) + param1[1] * param2[0]};
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("lf.C(").append(2).append(44);
    ...
    final static void a(java.math.BigInteger param0, byte[] param1, java.math.BigInteger param2, ge param3, int param4) {
        ...
        try {
              ...
              if (var9 >= 4) {
                ...
                L5: {
                  L6: {
                    ...
                    gd.field_f.a(param1, (byte) 0, 0, param4);
          ...
          L8: {
            ...
            stackOut_19_1 = new StringBuilder().append("lf.B(");
          ...
          throw wm.a((Throwable) (Object) stackIn_31_0, stackIn_31_2 + 44 + param4 + 44 + 0 + 44 + 0 + 41);
        }
    }
