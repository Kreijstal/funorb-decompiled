            ...
            L2: while (true) {
              if (this.field_Nb.length <= var8) {
                ...
                if (var8 != this.field_Mb) {
                  this.field_Nb[var8].field_qb = this.field_Nb[var8].field_qb + 10000;
                  var8++;
                  continue L2;
                } else {
                  var8++;
            ...
            if (var2 >= this.field_Pb.length) {
              ...
              if (this.field_Mb != var2) {
                if (this.field_Pb[var2].field_R != 0) {
                  ...
                  this.field_Nb[this.field_Mb].field_qb = this.field_Nb[this.field_Mb].field_qb + 10000;
                  this.field_Mb = var2;
                  this.field_Pb[var2].field_Ib = true;
                  this.field_Nb[var2].field_qb = this.field_Nb[var2].field_qb - 10000;
                  var2++;
                  continue L0;
                } else {
                  var2++;
