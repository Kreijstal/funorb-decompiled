    ...
    final static double[] a(int param0, double[] param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("n.B(").append(param0).append(44);
    ...
    n(int param0, int param1, int param2, int param3, ei param4, boolean param5, int param6, int param7, lr param8, int param9, String param10) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("n.<init>(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
