...
public final class Pool extends ep {
    ...
    private final void k(int param0) {
        ...
        int stackIn_45_0 = 0;
        int stackIn_48_0 = 0;
        uf stackIn_52_0 = null;
        uf stackIn_52_1 = null;
        int stackIn_52_2 = 0;
        int stackIn_52_3 = 0;
        int stackIn_52_4 = 0;
        int stackIn_52_5 = 0;
        ...
        int stackOut_47_0 = 0;
        int stackOut_46_0 = 0;
        uf stackOut_51_0 = null;
        uf stackOut_51_1 = null;
        int stackOut_51_2 = 0;
        int stackOut_51_3 = 0;
        int stackOut_51_4 = 0;
        int stackOut_51_5 = 0;
              ...
              if (uq.field_c == 14) {
                ...
                if (15 != uq.field_c) {
                  ...
                  if (uq.field_c != 74) {
                                          ...
                                          if (uq.field_c != 75) {
                                            if (uq.field_c != 77) {
                                              if (uq.field_c != 69) {
                                                if (uq.field_c != 70) {
                                                  if (uq.field_c == 71) {
                                                    ((uf) var2).field_I.field_p = kn.field_e.g(-60);
                                                    ((uf) var2).field_I.field_x = ((uf) var2).field_I.field_x & ~((uf) var2).field_I.field_p;
                                                    continue L0;
                                                  } else {
                                                    if (uq.field_c == 72) {
                                                      ((uf) var2).field_I.field_b = kn.field_e.g(-116);
                                                      if (ba.field_ub == null) {
                                                        continue L0;
                                                      } else {
                                                        ni.f((byte) -119);
                                                  ...
                                                  ((uf) var2).field_I.field_x = kn.field_e.g(-89);
                                                  if (ba.field_ub == null) {
                                                    continue L0;
                                                  } else {
                                                    bm.a(false);
                                                ...
                                                fq.a(stackIn_98_0, stackIn_98_1, stackIn_98_2, false);
                                                ((uf) var20).a(-23095);
                    ...
                    var5 = stackIn_48_0;
                    kn.field_e.o(8);
                    var6 = new String[kn.field_e.g(-71)];
                    var7_int = 0;
                    L13: while (true) {
                      if (var7_int >= var6.length) {
                        L14: {
                          ...
                          stackOut_51_0 = null;
                          stackOut_51_1 = null;
                          stackOut_51_2 = hq.field_c;
                          stackOut_51_3 = la.field_a;
                          stackOut_51_4 = er.field_W;
                          stackOut_51_5 = re.field_f;
                          stackOut_51_6 = var3;
                        ...
                        L15: {
                          var7 = new uf(stackIn_54_2, stackIn_54_3, stackIn_54_4, stackIn_54_5, stackIn_54_6, stackIn_54_7 != 0, var6, var2_int, var4 != 0);
                        ...
                        var6[var7_int] = kn.field_e.a(cq.a(3, 10761));
                        var7_int++;
                        continue L13;
                      }
                    }
