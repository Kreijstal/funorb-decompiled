...
final class uh extends ig {
        ...
        try {
          L0: {
            if (oq.field_z != null) {
              ...
              var7 = null;
              dr.a((String) null, 11468, mc.field_g, 0, var5_ref);
              pa.field_J.field_P = (8355711 & kb.field_h.field_P >> 1) + (mc.field_g - (8355711 & mc.field_g >> 1));
              lh.field_i = fj.field_j;
              pa.field_J.field_K = ((kb.field_h.field_K & 16711423) >> 1) + (-((16711423 & mc.field_g) >> 1) + mc.field_g);
              pa.field_J.field_Bb = -((mc.field_g & 16711422) >> 1) + (mc.field_g - -(8355711 & kb.field_h.field_Bb >> 1));
          ...
          L2: {
            ...
            stackOut_10_1 = new StringBuilder().append("uh.O(").append(param0).append(44);
    ...
    final na a(String param0, boolean param1) {
        ...
        try {
          L0: {
            L1: {
              var3 = ((uh) this).field_v.field_m.toLowerCase();
              if (param1) {
                break L1;
              } else {
                field_p = null;
          ...
          L2: {
            ...
            stackOut_14_1 = new StringBuilder().append("uh.K(");
            stackIn_16_0 = stackOut_14_0;
            stackIn_16_1 = stackOut_14_1;
    ...
    uh(sl param0, sl param1, sl param2) {
        super(param0);
        try {
            ((uh) this).field_v = param1;
            ((uh) this).field_m = param2;
        } catch (RuntimeException runtimeException) {
            throw wm.a((Throwable) (Object) runtimeException, "uh.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    private final boolean a(int param0, String param1) {
        ...
        try {
          L0: {
            ...
            L2: {
              var3 = ((uh) this).field_m.field_m.toLowerCase();
          ...
          L4: {
            ...
            stackOut_18_1 = new StringBuilder().append("uh.M(").append(param0).append(44);
    ...
    final String a(String param0, int param1) {
        ...
        try {
          L0: {
            var7 = ((uh) this).field_v.field_m.toLowerCase();
            var4 = param0.toLowerCase();
            if (var4.length() != 0) {
              var5 = var4;
              if (!gh.a(var5, 28350)) {
                ...
                if (!qa.a(1, var5)) {
                  if (bm.a(var5, -113)) {
                    stackOut_13_0 = lh.field_b;
                    stackIn_14_0 = stackOut_13_0;
                    return stackIn_14_0;
                  } else {
                    if (this.a(-31894, param0)) {
                      stackOut_17_0 = l.field_b;
                      ...
                      if (var7.length() > 0) {
                        if (!hq.a(var5, var7, 17924)) {
                          ...
                          stackOut_23_0 = nk.field_o;
                          stackIn_24_0 = stackOut_23_0;
                          return stackIn_24_0;
                        }
                      } else {
                        stackOut_20_0 = hb.field_r;
                        stackIn_21_0 = stackOut_20_0;
                        return stackIn_21_0;
                      }
                    }
                  ...
                  stackOut_9_0 = bm.field_a;
                  stackIn_10_0 = stackOut_9_0;
                  return stackIn_10_0;
                }
              } else {
                stackOut_4_0 = uq.field_K;
                stackIn_5_0 = stackOut_4_0;
                return stackIn_5_0;
              }
            } else {
          ...
          L2: {
            ...
            stackOut_33_1 = new StringBuilder().append("uh.L(");
