    ...
    final void a(ge param0, ed param1) {
        ...
        L0: {
          ...
          if (var3 == 0) {
            ...
            this.field_c[0] = param0.d(-1034);
            this.field_c[1] = param0.d(-1034);
            var4 = param0.g(-108);
            var5 = 0;
            L1: while (true) {
              if (var5 >= 2) {
                    ...
                    L5: while (true) {
                      if (var7 >= this.field_d[var5]) {
                        ...
                        if ((var4 & 1 << var5 * 4 << var7) == 0) {
                          ...
                          this.field_b[var5][1][var7] = param0.d(-1034);
                          this.field_g[var5][1][var7] = param0.d(-1034);
                          var7++;
                          continue L5;
                        }
                      }
                ...
                L6: while (true) {
                  if (var6 >= this.field_d[var5]) {
                    ...
                    this.field_b[var5][0][var6] = param0.d(-1034);
                    this.field_g[var5][0][var6] = param0.d(-1034);
                    var6++;
                    continue L6;
                  }
                }
