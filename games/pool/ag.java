    ...
    final static gi a(int param0, ko param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var5 == null) {
                if (param3 != 15395) {
                  var8 = null;
                  gi discarded$2 = ag.a(15, (ko) null, 110, 38);
                  stackOut_15_0 = null;
          ...
          L4: {
            ...
            stackOut_17_1 = new StringBuilder().append("ag.A(").append(param0).append(44);
    ...
    final static dd a(byte param0, int param1, String param2) {
        ...
        try {
          ...
          L1: {
            var3 = decompiledCaughtException;
            stackOut_2_0 = (RuntimeException) var3;
            stackOut_2_1 = new StringBuilder().append("ag.C(").append(89).append(44).append(param1).append(44);
            stackIn_4_0 = stackOut_2_0;
            stackIn_4_1 = stackOut_2_1;
            stackIn_3_0 = stackOut_2_0;
            stackIn_3_1 = stackOut_2_1;
