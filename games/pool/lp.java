 ...
 */
final class lp extends dd {
    lp(int param0, int param1, int param2, int param3, int param4, int param5, int[] param6) {
    ...
    final void d(int param0, int param1, int param2, int param3) {
        ...
        int var16 = 0;
        int var17 = 0;
        if (((lp) this).field_A != 0) {
          L0: {
            var5 = ((lp) this).field_A;
            var6 = ((lp) this).field_z;
            var7 = param2 << 8;
            ...
            if (param0 >= qh.field_b) {
              ...
              var6 = var6 - (qh.field_b - param0);
              var9 = var9 + (qh.field_b - param0);
              param0 = qh.field_b;
              break L0;
            }
          }
          L1: {
            if (param1 >= qh.field_c) {
              ...
              var9 = var9 + (qh.field_c - param1) * qh.field_l;
              param1 = qh.field_c;
              break L1;
            }
          }
          ...
          L3: {
            if (param1 + var5 <= qh.field_g) {
              ...
              var5 = qh.field_g - param1;
              break L3;
            }
          }
          var10 = qh.field_l - var6;
          var11 = ((lp) this).field_z - var6;
    ...
    final void c(int param0, int param1, int param2) {
        ...
        int var10 = 0;
        L0: {
          param0 = param0 + ((lp) this).field_G;
          param1 = param1 + ((lp) this).field_B;
          var4 = param0 + param1 * qh.field_l;
          var5 = 0;
          var6 = ((lp) this).field_A;
          var7 = ((lp) this).field_z;
        ...
        if (var7 <= 0) {
          ...
          if (var6 > 0) {
            lp.b(0, 0, 0, qh.field_d, ((lp) this).field_D, var5, 0, var4, 0, var7, var6, var8, var9, param2);
            return;
          } else {
            return;
          }
    ...
    final void a(int param0, int param1) {
        ...
        if (var6 <= 0) {
          ...
          if (var5 > 0) {
            lp.c(qh.field_d, ((lp) this).field_D, 0, var4, var3, var6, var5, var7, var8);
            return;
          } else {
            return;
          }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param5 != 0) {
          L0: {
            param0 = param0 - (((lp) this).field_G << 4);
            param1 = param1 - (((lp) this).field_B << 4);
            ...
            var13 = ((((lp) this).field_z << 4) - param0) * var10 + -param1 * var9;
            var14 = -((((lp) this).field_z << 4) - param0) * var9 + -param1 * var10;
            var15 = -param0 * var10 + ((((lp) this).field_A << 4) - param1) * var9;
            var16 = --param0 * var9 + ((((lp) this).field_A << 4) - param1) * var10;
            var17 = ((((lp) this).field_z << 4) - param0) * var10 + ((((lp) this).field_A << 4) - param1) * var9;
            var18 = -((((lp) this).field_z << 4) - param0) * var9 + ((((lp) this).field_A << 4) - param1) * var10;
            if (var11 >= var13) {
              var19 = var13;
              var20 = var11;
              break L0;
                      ...
                      if (var26 >= 0) {
                        ...
                        L15: while (true) {
                          if (var33 >= 0) {
                            ...
                            L17: {
                              var32 = (1 + var35 - (((lp) this).field_z << 12) - var27) / var27;
                              if ((1 + var35 - (((lp) this).field_z << 12) - var27) / var27 <= var37) {
                                break L17;
                              } else {
                                var37 = var32;
                                break L17;
                            ...
                            L19: {
                              var32 = (1 + var36 - (((lp) this).field_A << 12) - var26) / var26;
                              if ((1 + var36 - (((lp) this).field_A << 12) - var26) / var26 <= var37) {
                                break L19;
                              } else {
                                var37 = var32;
                                break L19;
                            ...
                            L20: while (true) {
                              if (var37 >= 0) {
                                ...
                                var30 = var30 - var26;
                                var31 = var31 + var27;
                                var23 = var23 + qh.field_l;
                                continue L15;
                              } else {
                                var38 = ((lp) this).field_D[(var36 >> 12) * ((lp) this).field_z + (var35 >> 12)];
                        ...
                        L21: while (true) {
                          if (var33 >= 0) {
                            ...
                            L24: {
                              var32 = var36 - (((lp) this).field_A << 12);
                              if (var36 - (((lp) this).field_A << 12) < 0) {
                                break L24;
                              } else {
                        ...
                        L32: while (true) {
                          if (var33 >= 0) {
                            ...
                            L33: {
                              ...
                              var36 = var31 + (var28 * var26 >> 4);
                              var37 = var20;
                              var32 = var35 - (((lp) this).field_z << 12);
                              if (var35 - (((lp) this).field_z << 12) < 0) {
                                break L33;
                              } else {
    ...
    final void e(int param0, int param1, int param2) {
        ...
        if (var7 <= 0) {
          ...
          if (var6 > 0) {
            lp.c(qh.field_d, ((lp) this).field_D, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
          } else {
            return;
          }
    ...
    final void b(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param2 <= 0) {
          ...
          if (param3 > 0) {
            L0: {
              var6 = ((lp) this).field_z;
              var7 = ((lp) this).field_A;
              var8 = 0;
              var9 = 0;
              var10 = ((lp) this).field_w;
              var11 = ((lp) this).field_y;
              var12 = (var10 << 16) / param2;
              var13 = (var11 << 16) / param3;
              if (((lp) this).field_G <= 0) {
                break L0;
              } else {
                var14 = ((((lp) this).field_G << 16) + var12 - 1) / var12;
                param0 = param0 + var14;
                var8 = var8 + (var14 * var12 - (((lp) this).field_G << 16));
                break L0;
              }
            }
            L1: {
              if (((lp) this).field_B <= 0) {
                break L1;
              } else {
                var14 = ((((lp) this).field_B << 16) + var13 - 1) / var13;
                param1 = param1 + var14;
                var9 = var9 + (var14 * var13 - (((lp) this).field_B << 16));
                break L1;
              }
            }
            L2: {
            ...
            L4: {
              var14 = param0 + param1 * qh.field_l;
              var15 = qh.field_l - param2;
              if (param1 + param3 <= qh.field_g) {
                break L4;
              } else {
                param3 = param3 - (param1 + param3 - qh.field_g);
                break L4;
              }
            }
            L5: {
              if (param1 >= qh.field_c) {
                ...
                var16 = qh.field_c - param1;
                param3 = param3 - var16;
                var14 = var14 + var16 * qh.field_l;
                var9 = var9 + var13 * var16;
                break L5;
              }
            }
            L6: {
              if (param0 + param2 <= qh.field_j) {
                break L6;
              } else {
                var16 = param0 + param2 - qh.field_j;
                param2 = param2 - var16;
                var15 = var15 + var16;
                break L6;
              }
            ...
            lp.b(qh.field_d, ((lp) this).field_D, 0, var8, var9, var14, var15, param2, param3, var12, var13, var6, param4);
            return;
          } else {
            return;
          }
    ...
    final void c(int param0, int param1, int param2, int param3) {
        ...
        if (param2 <= 0) {
          ...
          if (param3 > 0) {
            L0: {
              var5 = ((lp) this).field_z;
              var6 = ((lp) this).field_A;
              var7 = 0;
              var8 = 0;
              var9 = ((lp) this).field_w;
              var10 = ((lp) this).field_y;
              var11 = (var9 << 16) / param2;
              var12 = (var10 << 16) / param3;
              if (((lp) this).field_G <= 0) {
                break L0;
              } else {
                var13 = ((((lp) this).field_G << 16) + var11 - 1) / var11;
                param0 = param0 + var13;
                var7 = var7 + (var13 * var11 - (((lp) this).field_G << 16));
                break L0;
              }
            }
            L1: {
              if (((lp) this).field_B <= 0) {
                ...
                var13 = ((((lp) this).field_B << 16) + var12 - 1) / var12;
                param1 = param1 + var13;
                var8 = var8 + (var13 * var12 - (((lp) this).field_B << 16));
                break L1;
              }
            }
            L2: {
            ...
            L4: {
              var13 = param0 + param1 * qh.field_l;
              var14 = qh.field_l - param2;
              if (param1 + param3 <= qh.field_g) {
                break L4;
              } else {
                param3 = param3 - (param1 + param3 - qh.field_g);
            ...
            L5: {
              if (param1 >= qh.field_c) {
                ...
                var15 = qh.field_c - param1;
                param3 = param3 - var15;
                var13 = var13 + var15 * qh.field_l;
            ...
            L6: {
              if (param0 + param2 <= qh.field_j) {
                ...
                var15 = param0 + param2 - qh.field_j;
                param2 = param2 - var15;
                var14 = var14 + var15;
                break L6;
              }
            ...
            lp.c(qh.field_d, ((lp) this).field_D, 0, var7, var8, var13, var14, param2, param3, var11, var12, var5);
            return;
          } else {
            return;
          }
    ...
    final void b(int param0, int param1) {
        ...
        int stackOut_19_2 = 0;
        L0: {
          var3 = ((lp) this).field_z >> 1;
          var4 = ((lp) this).field_A >> 1;
          param0 = param0 + ((lp) this).field_G / 2;
          param1 = param1 + ((lp) this).field_B / 2;
          if (param0 >= qh.field_b) {
            stackOut_2_0 = 0;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          } else {
            stackOut_1_0 = qh.field_b - param0 << 1;
        ...
        L1: {
          ...
          if (param0 + var3 <= qh.field_j) {
            stackOut_5_0 = ((lp) this).field_z - 2;
            stackIn_6_0 = stackOut_5_0;
            break L1;
          } else {
            stackOut_4_0 = (qh.field_j - param0 << 1) - 2;
        ...
        L2: {
          ...
          if (param1 >= qh.field_c) {
            ...
            stackOut_7_0 = qh.field_c - param1 << 1;
        ...
        L3: {
          ...
          if (param1 + var4 <= qh.field_g) {
            stackOut_11_0 = ((lp) this).field_A - 2;
            stackIn_12_0 = stackOut_11_0;
            break L3;
          } else {
            stackOut_10_0 = (qh.field_g - param1 << 1) - 2;
        ...
        L4: while (true) {
          if (var9 > var8) {
            ...
            var10 = var9 * ((lp) this).field_z + var5;
            var11 = (param1 + (var9 >> 1)) * qh.field_l + (param0 + (var5 >> 1));
            var12 = var5;
            L5: while (true) {
              if (var12 > var6) {
                var9 += 2;
                ...
                L6: while (true) {
                  if (var19 >= 4) {
                    if (var18 != 0) {
                      ...
                      var19 = var18 >> 2;
                      var20 = 256 - var19;
                      var21 = qh.field_d[var11];
                      qh.field_d[var11] = (var19 * var15 + var20 * (var21 & 16711935) & -16711936) + (var19 * var16 + var20 * (var21 & 65280) & 16711680) >>> 8;
                      var12 += 2;
                      var11++;
                      var10 += 2;
                      continue L5;
    ...
    final void e(int param0, int param1) {
        ...
        int stackOut_10_0 = 0;
        L0: {
          var3 = ((lp) this).field_z >> 2;
          var4 = ((lp) this).field_A >> 2;
          param0 = param0 + ((lp) this).field_G / 4;
          param1 = param1 + ((lp) this).field_B / 4;
          if (param0 >= qh.field_b) {
            stackOut_2_0 = 0;
            ...
            stackOut_1_0 = qh.field_b - param0 << 2;
            stackIn_3_0 = stackOut_1_0;
            break L0;
          }
        }
        L1: {
          var5 = stackIn_3_0;
          if (param0 + var3 <= qh.field_j) {
            stackOut_5_0 = ((lp) this).field_z - 4;
            stackIn_6_0 = stackOut_5_0;
            break L1;
          } else {
            stackOut_4_0 = (qh.field_j - param0 << 2) - 4;
            stackIn_6_0 = stackOut_4_0;
            break L1;
          }
        }
        L2: {
          ...
          if (param1 >= qh.field_c) {
            ...
            stackOut_7_0 = qh.field_c - param1 << 2;
            stackIn_9_0 = stackOut_7_0;
            break L2;
          }
        }
        L3: {
          var7 = stackIn_9_0;
          if (param1 + var4 <= qh.field_g) {
            stackOut_11_0 = ((lp) this).field_A - 4;
            stackIn_12_0 = stackOut_11_0;
            break L3;
          } else {
            stackOut_10_0 = (qh.field_g - param1 << 2) - 4;
            stackIn_12_0 = stackOut_10_0;
            break L3;
          }
        }
          ...
          if (var10 > var8) {
            ...
            L5: while (true) {
              if (var11 > var6) {
                ...
                var12 = var10 * ((lp) this).field_z + var11;
                var13 = (param1 + (var10 >> 2)) * qh.field_l + (param0 + (var11 >> 2));
                var14 = 0;
                L6: while (true) {
                  if (var14 >= 4) {
                    var25 = var24;
                    ...
                    L7: while (true) {
                      if (var19 >= 16) {
                        if (var15 != 0) {
                          ...
                          var19 = var15 >> 4;
                          var20 = 256 - var19;
                          var21 = qh.field_d[var13];
                          qh.field_d[var13] = (var19 * var16 + var20 * (var21 & 16711935) & -16711936) + (var19 * var17 + var20 * (var21 & 65280) & 16711680) >>> 8;
                          var11 += 4;
                          continue L5;
                        } else {
                          var11 += 4;
                    ...
                    L8: while (true) {
                      if (var15 >= 4) {
                        ...
                        var9[(var14 << 2) + var15] = ((lp) this).field_D[var12 + var14 * ((lp) this).field_z + var15];
                        var15++;
                        continue L8;
                      }
                    }
    ...
    final void a(int param0, int param1, int param2) {
        ...
        if (var7 <= 0) {
          ...
          if (var6 > 0) {
            lp.d(qh.field_d, ((lp) this).field_D, 0, var5, var4, var7, var6, var8, var9, param2);
            return;
          } else {
            return;
          }
    ...
    final void d(int param0, int param1, int param2) {
        ...
        int var6 = 0;
        int var7 = 0;
        param1 = param1 + ((lp) this).field_G;
        param0 = param0 - ((lp) this).field_B;
        if (param0 < 0) {
          return;
        } else {
          L0: {
            if (param0 >= ((lp) this).field_A) {
              break L0;
            } else {
              if (param2 < qh.field_c) {
                ...
                if (param2 < qh.field_g) {
                  L1: {
                    ...
                    var5 = param0 * ((lp) this).field_z;
                    var6 = ((lp) this).field_z;
                    if (param1 >= qh.field_b) {
                      break L1;
                    } else {
                      var7 = qh.field_b - param1;
                      var6 = var6 - var7;
                      param1 = qh.field_b;
                      var5 = var5 + var7;
                      var4 = var4 + var7;
                  ...
                  L2: {
                    if (param1 + var6 <= qh.field_j) {
                      break L2;
                    } else {
                      var7 = param1 + var6 - qh.field_j;
                      var6 = var6 - var7;
                      break L2;
                    }
                  }
                  if (var6 > 0) {
                    lp.b(qh.field_d, ((lp) this).field_D, var5, var4, var6);
                    return;
                  } else {
                    return;
                  }
    ...
    final void b(int param0, int param1, int param2) {
        ...
        if (var7 <= 0) {
          ...
          if (var6 > 0) {
            lp.d(qh.field_d, ((lp) this).field_D, 0, var5, var4, 0, 0, var7, var6, var8, var9, param2);
            return;
          } else {
            return;
          }
