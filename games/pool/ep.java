    ...
    final void a(int param0, String param1, int param2, int param3, int param4) {
        ...
        try {
          ...
          L9: {
            ...
            stackOut_22_1 = new StringBuilder().append("ep.CA(").append(param0).append(44);
          ...
          throw wm.a((Throwable) (Object) stackIn_25_0, stackIn_25_2 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
            ...
            if (0 != var4) {
              L0: {
                if (var4 != 1) {
                  ...
                  L1: {
                    int discarded$12 = 8388;
                    var5_int = kb.a(9539, lg.c(5), eh.c());
                    if (-1 != var5_int) {
              ...
              L2: {
                if (var4 == 2) {
                  ...
                  int discarded$16 = 12854;
                  var5_int = fn.a(gd.a(true), ((ep) this).field_w, sa.a(), 50, cn.a(), kg.c((byte) 64), ng.c());
                  if (-1 == var5_int) {
                    break L2;
                  } else {
                    int discarded$17 = -16;
                    ke.a(ke.field_g, var5_int, bi.field_b);
                    bi.field_b = null;
                    ke.field_g = null;
                    break L2;
                  }
              ...
              L3: {
                if (var4 != 3) {
                  ...
                  if (!param0) {
                    int discarded$19 = 0;
                    var5_int = np.a(false, sa.a(), false, ((ep) this).field_x, ((ep) this).field_w, kg.c((byte) 54));
                    if (var5_int == -1) {
                      break L3;
                    } else {
                      if (var5_int == 0) {
                    ...
                    L16: {
                      ...
                      L18: {
                        if (l.field_d.a((byte) -118)) {
                          L19: {
                            var10 = l.field_d.a(-25955);
                            if (var10 != null) {
                              var7 = tl.a(var10.field_v, -7510, var10.field_t, 0);
                              int discarded$21 = 1;
                              hg.a(var7);
                              break L19;
                            } else {
              ...
              if (var2 == 0) {
                ...
                L4: {
                  if (param0 == 15000) {
                    ...
                    int discarded$15 = ((ep) this).a(true, true);
                    break L4;
                  }
                }
                return;
    ...
    final static void a(byte param0, uf param1) {
        ...
        try {
              ...
              if (!nd.field_i.c(0)) {
                ...
                L4: {
                  ...
                  if (var6.field_H - -var6.field_B + var6.field_y <= kg.field_m) {
                    L5: {
                      ij dupTemp$5 = (ij) (Object) nd.field_i.e((byte) -41);
                      var2_ref = dupTemp$5;
                      if (dupTemp$5 != null) {
                        stackOut_13_0 = 0;
                ...
                if (var7 != null) {
                  L6: {
                    if (((ij) var7).field_I != null) {
                      ((ij) var7).field_L[1] = (((ij) var7).field_I.field_Db >> 1) + ((ij) var7).field_I.field_ib;
                      ((ij) var7).field_L[0] = (((ij) var7).field_I.field_gb >> 1) + ((ij) var7).field_I.field_sb;
                      break L6;
                    } else {
                      break L6;
                    }
                  ...
                  L7: {
                    if (null == ((ij) var7).field_l) {
                      ...
                      ((ij) var7).field_z[0] = (((ij) var7).field_l.field_gb >> 1) + ((ij) var7).field_l.field_sb;
                      ((ij) var7).field_z[1] = (((ij) var7).field_l.field_Db >> 1) + ((ij) var7).field_l.field_ib;
                      break L7;
                    }
                  }
                  L8: {
                    if (null == ((ij) var7).field_q) {
                      ...
                      ((ij) var7).field_x[1] = ((ij) var7).field_q.field_ib - -(((ij) var7).field_q.field_Db >> 1);
                      ((ij) var7).field_x[0] = ((ij) var7).field_q.field_sb + (((ij) var7).field_q.field_gb >> 1);
                      break L8;
                    }
                  }
                  L9: {
                    if (null == ((ij) var7).field_p) {
                      ...
                      int discarded$6 = 1;
                      uj.a(param1, (ij) var7, ((ij) var7).field_L, ((ij) var7).field_p);
                      break L9;
                    }
                  }
                  L10: {
                    if (((ij) var7).field_F != null) {
                      int discarded$7 = 1;
                      uj.a(param1, (ij) var7, ((ij) var7).field_z, ((ij) var7).field_F);
                      break L10;
                    } else {
                      break L10;
                    }
                  ...
                  L11: {
                    if (((ij) var7).field_D == null) {
                      ...
                      int discarded$8 = 1;
                      uj.a(param1, (ij) var7, ((ij) var7).field_x, ((ij) var7).field_D);
                      break L11;
                    }
                  }
                  if (kg.field_m < ((ij) var7).field_H) {
                    L12: {
                      if ((1 & ((ij) var7).field_v) != 0) {
                      ...
                      if (((ij) var7).field_y + ((ij) var7).field_H + ((ij) var7).field_B > kg.field_m) {
                        ...
                        L15: {
                          if ((8 & ((ij) var7).field_r) != 0) {
                            int discarded$9 = 256;
                            ((ij) var7).field_w = ec.a(32635, ((ij) var7).field_y, -var3 + ((ij) var7).field_y);
                            break L15;
                          } else {
                            ((ij) var7).field_w = 256;
                            break L15;
          ...
          L17: {
            ...
            stackOut_61_1 = new StringBuilder().append("ep.HA(").append(param0).append(44);
          ...
          throw wm.a((Throwable) (Object) stackIn_64_0, stackIn_64_2 + 41);
        }
    }
        ...
        if (param0 > -64) {
          ...
          L0: {
            if (gg.a(true)) {
              ...
              int discarded$371 = this.a(stackIn_11_1 != 0, stackIn_11_2 != 0, -114);
              break L0;
            } else {
              if (sf.field_y < 10) {
                break L0;
                ...
                if (!u.a(77)) {
                  ...
                  if (fk.field_ab != 0) {
                    ...
                    int discarded$373 = this.a(false, false, -124);
                    break L0;
                  }
                }
              }
    ...
    private final int e() {
        ...
        if (!((ep) this).field_n) {
          if (pk.b((byte) 109)) {
            if (!rg.field_v) {
              int discarded$2 = 0;
              var2 = np.a(false, sa.a(), true, ((ep) this).field_x, ((ep) this).field_w, kg.c((byte) 121));
              if (var2 == -1) {
                return -1;
              } else {
                L0: {
    ...
    final void c(int param0, boolean param1) {
        ...
        L6: {
          if (param0 == -4) {
            ...
            int discarded$20 = ((ep) this).a(true, false);
            break L6;
          }
        }
        L7: {
        ...
        L22: {
          if (sf.field_y == 3) {
            int discarded$23 = 1;
            if (!k.a(uj.field_d, vf.field_nb, rg.field_r)) {
              break L22;
            } else {
              int discarded$24 = 1;
              if (ab.a(rg.field_r)) {
          ...
          if (sf.field_y == 11) {
            L32: {
              if (kq.field_m == null) {
                ...
                int discarded$30 = 0;
                fo.a(hp.a(kq.field_m, ir.field_b, -641, ud.field_F), 0.0f);
                break L31;
              }
            }
            od.field_c = true;
          ...
          if (sf.field_y == 13) {
            L36: {
              ...
              if (jl.field_e == null) {
                ...
                var3 = stackIn_138_0;
                int discarded$31 = 0;
                fo.a(jl.field_e.field_m, jl.field_e.field_c);
                break L36;
              }
            }
            if (var3 == 0) {
    ...
    final static dd[] a(int param0, di param1, String param2, String param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("ep.DA(").append(param0).append(44);
