...
abstract class mp {
    ...
    final int a(int param0, int param1) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 8: {
                    try {
                        if (stackIn_8_0 <= (var5.field_e.length ^ -1)) {
                            statePc = 13;
                        } else {
                            statePc = 9;
                        }
                ...
                case 11: {
                    try {
                        stackOut_11_0 = var5.field_e[param1];
    ...
    final int a(byte param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 6: {
                    try {
                        if (stackIn_6_0 > (((mp) this).field_e.length ^ -1)) {
                            statePc = 11;
                        } else {
                            statePc = 7;
                        }
                ...
                case 11: {
                    try {
                        stackOut_11_0 = ((mp) this).field_e[((mp) this).field_e.length - 1].field_h - ((mp) this).field_e[0].field_d;
                        stackIn_12_0 = stackOut_11_0;
                        statePc = 12;
                        continue stateLoop;
                    } catch (Throwable stateCaught_11) {
    ...
    final static ml a(int param0, boolean param1, byte param2) {
        ...
        int stackIn_5_4 = 0;
        int stackIn_16_0 = 0;
        ml stackIn_25_0 = null;
        cj stackIn_37_0 = null;
        cj stackIn_39_0 = null;
        cj stackIn_40_0 = null;
        ...
        int stackIn_48_0 = 0;
        ml stackIn_59_0 = null;
        int stackIn_69_0 = 0;
        jb stackIn_78_0 = null;
        ...
        int stackOut_45_0 = 0;
        int stackOut_47_0 = 0;
        ml stackOut_58_0 = null;
        int stackOut_68_0 = 0;
        jb stackOut_77_0 = null;
        boolean stackOut_81_0 = false;
        ml stackOut_117_0 = null;
        int statePc = 0;
        Throwable caughtException = null;
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 25: {
                    try {
                        if (!((String) (Object) stackIn_25_0.field_Kb).equals((Object) (Object) "")) {
                            statePc = 30;
                        } else {
                            statePc = 26;
                        }
                ...
                case 37: {
                    try {
                        ...
                        stackOut_37_1 = fm.a(var7.field_Ib.field_yb, var7.field_Hb, var14);
                ...
                case 40: {
                    try {
                        stackIn_40_0.field_wb = stackIn_40_1;
                        var7.field_Ib.a(jk.field_f, var9, var14, var13, -3344);
                        stackOut_40_0 = var7.field_Fb;
                ...
                case 44: {
                    try {
                        stackIn_44_0.field_wb = stackIn_44_1;
                ...
                case 56: {
                    try {
                        eg.field_B.field_Ib.a(2, (cj) (Object) var7, 1300, (cj) (Object) var6);
                        statePc = 57;
                        continue stateLoop;
                ...
                case 59: {
                    try {
                        if (stackIn_59_0.field_Gb.field_L) {
                            statePc = 92;
                        } else {
                            statePc = 60;
                        }
                ...
                case 78: {
                    try {
                        if (cq.a(stackIn_78_0.field_f, -124)) {
                            statePc = 90;
                        } else {
                            statePc = 79;
                        }
                ...
                case 118: {
                    return (ml) (Object) stackIn_118_0;
                }
                case 119: {
    ...
    final int a(String param0, int param1, int param2, int param3) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 29: {
                    try {
                        stackOut_29_0 = (param3 + -param2 << 431260488) / var5_int;
                ...
                case 34: {
                    try {
                        ...
                        stackOut_34_1 = new StringBuilder().append("mp.F(");
                ...
                case 38: {
                    throw fa.a((Throwable) (Object) stackIn_38_0, stackIn_38_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
                }
                default: throw new IllegalStateException("invalid CFG state " + statePc);
            }
        }
    ...
    final int a(byte param0, int param1) {
        ...
        int stackIn_9_0 = 0;
        int stackIn_10_0 = 0;
        td stackIn_10_1 = null;
        int stackIn_16_0 = 0;
        int stackIn_19_0 = 0;
        int stackOut_8_0 = 0;
        int stackOut_9_0 = 0;
        td stackOut_9_1 = null;
        int stackOut_15_0 = 0;
        int stackOut_18_0 = 0;
        int statePc = 0;
        Throwable caughtException = null;
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 6: {
                    try {
                        if ((((mp) this).field_e.length ^ -1) >= (var3_int ^ -1)) {
                            statePc = 18;
                        } else {
                            statePc = 7;
                        }
                ...
                case 10: {
                    try {
                        if (stackIn_10_0 > (stackIn_10_1.field_e.length ^ -1)) {
                            statePc = 15;
                        } else {
                            statePc = 11;
                        }
                ...
                case 18: {
                    try {
                        stackOut_18_0 = ((mp) this).field_e.length;
                        stackIn_19_0 = stackOut_18_0;
                        statePc = 19;
                        continue stateLoop;
                    } catch (Throwable stateCaught_18) {
    ...
    final int a(int param0, byte param1, int param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 20: {
                    try {
                        stackOut_20_0 = ((mp) this).field_e[0].a(false, param0);
                ...
                case 23: {
                    try {
                        if ((var5 ^ -1) <= (((mp) this).field_e.length ^ -1)) {
                            statePc = 42;
                        } else {
                            statePc = 24;
                        }
                ...
                case 27: {
                    try {
                        if (stackIn_27_0 < stackIn_27_1.field_d) {
                            statePc = 41;
                        } else {
                            statePc = 28;
                        }
