...
final class gd extends gq {
    ...
    final static void a(boolean param0, int param1, ja[] param2) {
        try {
            ...
            throw fa.a((Throwable) (Object) runtimeException, "gd.Q(" + false + ',' + param1 + ',' + (param2 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final static bm a(byte[] param0) {
        ...
        try {
          ...
          throw fa.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + ',' + 46 + ')');
        }
        return stackIn_7_0;
    }
    ...
    final void a(boolean param0, byte param1, mb param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("gd.R(").append(param0).append(',').append(param1).append(',');
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
    ...
    private final void a(int param0, int param1, int param2, int param3) {
        ...
        var10 = (po) (Object) ((gd) this).field_G.a(0, (long)((gd) this).field_C[param3]);
        var11 = var10;
        if (var11 != null) {
          ...
          if (var6 == null) {
            ...
            L3: {
              ...
              var7.field_p = param0;
              var7.field_v = 1024 + var10.field_h[param0] * param2 * (param2 * var11.field_o) >> 11;
              var7.field_E = 255 & var10.field_j[param0];
              var7.field_z = (param0 << 8) - (var10.field_g[param0] & 32767);
              var7.field_A = 0;
              var7.field_i = 0;
              var7.field_y = 0;
              var7.field_l = -1;
    ...
    private final int a(byte param0, mb param1) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_17_1 = new StringBuilder().append("gd.DA(").append(92).append(',');
    ...
    private final int b(mb param0) {
        ...
        try {
          ...
          throw fa.a((Throwable) (Object) stackIn_15_0, stackIn_15_2 + ',' + -916428895 + ')');
        }
        return stackIn_11_0;
    }
    ...
    private final int a(mb param0) {
        ...
        try {
          ...
          throw fa.a((Throwable) (Object) stackIn_8_0, stackIn_8_2 + ',' + 81682502 + ')');
        }
        return stackIn_4_0;
    }
    ...
    final synchronized boolean a(int param0, me param1, int param2, ug param3, ul param4) {
        ...
        try {
          ...
          L7: {
            ...
            stackOut_22_1 = new StringBuilder().append("gd.P(").append(param0).append(',');
    ...
    private final synchronized void a(boolean param0, int param1, ug param2, boolean param3) {
        ...
        try {
            ...
            throw fa.a((Throwable) (Object) runtimeException, "gd.LA(" + param0 + ',' + 8695 + ',' + (param2 != null ? "{...}" : "null") + ',' + param3 + ')');
        }
    }
          ...
          if (144 != var3) {
            if (var3 == 160) {
              ...
              if (var3 == 176) {
                ...
                L27: {
                  if (var5 == 49) {
                    this.b(15, var4, var6 + (((gd) this).field_x[var4] & -128));
                    break L27;
                  } else {
                    break L27;
                  }
    ...
    final boolean a(mb param0, int param1, int param2, int[] param3, int param4) {
        ...
        try {
          ...
          throw fa.a((Throwable) (Object) stackIn_71_0, stackIn_71_2 + ',' + param4 + ')');
        }
