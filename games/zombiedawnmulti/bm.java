          ...
          L0: {
            L1: {
              ...
              if (param2 == -8130) {
                ...
                discarded$1 = this.b(-33, (byte) 40, -88);
                break L1;
              }
            }
            L2: {
              ...
              if (-1 >= (param0 ^ -1)) {
                if ((this.field_g.length ^ -1) >= (param0 ^ -1)) {
                  ...
                  if ((param2 ^ -1) > (this.field_g[0].length ^ -1)) {
                    stackOut_17_0 = this.field_g[param0][param2];
          ...
          L0: {
            L1: {
              if (param1 == 0) {
                ...
                discarded$2 = this.b(-118, (byte) -56, 0);
                break L1;
              }
            }
            stackOut_3_0 = param0 << 634971815;
            stackIn_4_0 = stackOut_3_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
