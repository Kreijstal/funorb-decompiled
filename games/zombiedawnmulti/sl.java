...
final class sl extends fm {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  sl.a(0, oo.field_i, ((sl) this).field_O[param0], ((sl) this).field_P[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  ef.a(oo.field_i, ((sl) this).field_O[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
    ...
    sl(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        ...
        ((sl) this).field_O = new byte[256][];
        ((sl) this).field_O = param6;
        ((sl) this).field_P = new int[4][];
        ((sl) this).field_P[0] = param5;
    }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  sl.a(0, oo.field_i, ((sl) this).field_O[param0], ((sl) this).field_P[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  ef.a(oo.field_i, ((sl) this).field_O[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
    ...
    final int e(int param0) {
        return sl.a(((sl) this).field_P[0], param0);
    }
}
