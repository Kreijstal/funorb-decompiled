...
final class ok {
    ...
    final void b(int param0) {
        if (null != rn.field_f) {
          ...
          if (!((ok) this).field_a) {
            L1: {
              if (ng.field_d >= ((ok) this).field_b) {
                if (-1 > (((ok) this).field_b ^ -1)) {
                  bl.field_a = 0;
                  break L1;
                } else {
                  break L1;
                ...
                bl.field_a = (-ng.field_d + ((ok) this).field_b) / 2;
                break L1;
              }
            }
            L2: {
              L3: {
                if (((ok) this).field_k != ng.field_d) {
                  break L3;
                } else {
                  if (pi.field_i == ((ok) this).field_w) {
                    break L2;
                  } else {
                    break L3;
                  }
              ...
              ((ok) this).field_u.a((byte) -89, ((ok) this).field_w, ((ok) this).field_k);
              break L2;
            }
            return;
          } else {
            ((ok) this).field_v = ((ok) this).field_v - 1;
            if (-1 > (((ok) this).field_v - 1 ^ -1)) {
              return;
            } else {
              ((ok) this).field_v = ((ok) this).field_g;
              if (((ok) this).field_f > mk.field_d) {
                ((ok) this).field_a = false;
                return;
              } else {
                if (param0 != -12371) {
    ...
    final static void a(boolean param0) {
                ...
                if (lb.field_d == null) {
                  ...
                  if (!lb.field_d.a((byte) -108)) {
                    ...
                    if (lb.field_d.a(false, "benefits")) {
                      ...
                      var12.a();
                      dc.field_Lb.b(vl.a(t.field_b, new String[1], 2), var6, 40, 16777215, -1);
                      gf.field_e.b(vl.a(ob.field_w, new String[1], 2), var6, 60, 16777215, -1);
                      dc.field_Lb.b(vl.a(ck.field_c, new String[1], 2), var6, 110, 16777215, -1);
                      gf.field_e.b(vl.a(wc.field_G, new String[1], 2), var6, 130, 16777215, -1);
                      ...
                      L1: while (true) {
                        if (nj.field_a.length <= var7) {
                          ...
                          ao.field_h[var7].a();
                          int discarded$6 = gf.field_e.a(nj.field_a[var7], 3, 3, ao.field_h[var7].field_x - 6, -6 + ao.field_h[var7].field_w, hk.field_e, -1, 1, 1, gf.field_e.field_C - -gf.field_e.field_r);
        ...
        if (rq.field_v == null) {
            ...
            if (q.field_c == null) {
              ...
              if (dc.field_Lb == null) {
                ...
                L3: {
                  ...
                  var3 = oo.field_l;
                  oo.a(b.field_f);
                  var14 = vl.a(eh.field_h, new String[1], 2);
                ...
                var9.a();
                int discarded$7 = dc.field_Lb.a(var14, pg.field_c, em.field_bb, ol.field_p, ai.field_a, 16777215, -1, 1, 1, dc.field_Lb.field_r + dc.field_Lb.field_C);
          ...
          L7: {
            if (null == ie.field_ib) {
              ...
              if (null != gf.field_e) {
                ...
                oo.a(b.field_f);
                var16 = new ja(412, 43);
                var5_ref = vl.a(vk.field_F, new String[1], 2);
                ie.field_ib = null;
                var16.a();
                int discarded$8 = gf.field_e.a(var5_ref, 3, 3, var16.field_x + -6, -6 + var16.field_w, 16777215, -1, 0, 1, gf.field_e.field_C - -gf.field_e.field_r);
          ...
          L12: {
            if (ha.field_l == null) {
              ...
              if (er.field_j == null) {
                ...
                L15: {
                  var2 = (q.a((byte) stackIn_49_0, stackIn_49_1 << stackIn_49_2) * 40 >> 505315792) + 40;
                  if ((var2 ^ -1) < -1) {
                ...
                L16: {
                  stackOut_52_0 = jp.field_d;
                  stackOut_52_1 = cr.field_j;
                  stackOut_52_2 = -59;
                ...
                bc.a(stackIn_55_0, stackIn_55_1, (byte) stackIn_55_2, stackIn_55_3 != 0);
                break L12;
              }
            }
          }
          L17: {
            if (null == ha.field_l) {
              ...
              if (er.field_j == null) {
                ...
                L19: {
                  stackOut_60_0 = il.field_k;
                  stackOut_60_1 = sq.field_O;
                  stackOut_60_2 = -59;
                ...
                bc.a(stackIn_63_0, stackIn_63_1, (byte) stackIn_63_2, stackIn_63_3 != 0);
                break L17;
              }
            }
          }
          L20: {
            if (null != fa.field_Tb) {
              var1 = -(fa.field_Tb.field_u / 2) + 357;
              fa.field_Tb.g(269 - fa.field_Tb.field_z, var1);
              mb.field_j.g(586, var1);
              if (var1 >= bo.field_d) {
                break L20;
              } else {
                if (bo.field_d >= var1 - -fa.field_Tb.field_w) {
                  break L20;
                } else {
                  ...
                  if ((var2 ^ -1) < -1) {
                    L21: {
                      if (269 - fa.field_Tb.field_x >= bd.field_g) {
                        ...
                        if (269 > bd.field_g) {
                          fa.field_Tb.e(-fa.field_Tb.field_z + 268, var1 + -1, var2);
                          fa.field_Tb.e(1 + (-fa.field_Tb.field_z + 269), var1 + -1, var2);
                          fa.field_Tb.e(-fa.field_Tb.field_z + 268, 1 + var1, var2);
                          fa.field_Tb.e(269 - fa.field_Tb.field_z + 1, var1 - -1, var2);
                          break L20;
                        } else {
                          break L21;
                        }
                    ...
                    if (bd.field_g <= 586) {
                      ...
                      if (586 + fa.field_Tb.field_x <= bd.field_g) {
                        ...
                        mb.field_j.e(585, -1 + var1, var2);
                        mb.field_j.e(587, var1 - 1, var2);
                        mb.field_j.e(585, var1 - -1, var2);
                        mb.field_j.e(587, 1 + var1, var2);
                        break L20;
                      }
                    }
                  } else {
    ...
    final ll f(int param0) {
        ((ok) this).field_x = pi.field_i;
        ((ok) this).field_j = ng.field_d;
        ((ok) this).field_u.a((byte) -26, ((ok) this).field_q, ((ok) this).field_e);
        hn.field_h = false;
        ll var2 = u.a(param0 + 10386, pl.field_J, ((ok) this).field_q, 0, param0, ((ok) this).field_e);
        if (var2 == null) {
            ((ok) this).d(param0 + -44);
        }
        return var2;
    ...
    private final void c(int param0) {
        ...
        var3 = ((ok) this).field_d;
        if (!((ok) this).a(0)) {
          ((ok) this).field_a = false;
          return;
        } else {
          L0: {
            if (var2 <= ((ok) this).field_o) {
              if (var2 >= ((ok) this).field_s) {
                break L0;
              } else {
                var2 = ((ok) this).field_s;
                break L0;
              }
            } else {
              var2 = ((ok) this).field_o;
              break L0;
            }
          }
          L1: {
            if (var3 > ((ok) this).field_n) {
              var3 = ((ok) this).field_n;
              break L1;
            } else {
              if (var3 < ((ok) this).field_h) {
                var3 = ((ok) this).field_h;
                break L1;
              } else {
                break L1;
              }
          ...
          L2: {
            if (0.0f >= ((ok) this).field_c) {
              break L2;
            } else {
              var4 = (int)(0.5f + (float)var3 * ((ok) this).field_c);
              if (var4 > var2) {
                var3 = (int)((float)var2 / ((ok) this).field_c);
                break L2;
              } else {
                if (var2 > var4) {
                  var2 = var4;
          ...
          L3: {
            ...
            ((ok) this).field_u.a((byte) -27, var3, var2);
            break L3;
          }
          L5: {
            if (((ok) this).field_b <= param0) {
              break L5;
            } else {
              bl.field_a = (-ng.field_d + ((ok) this).field_b) / 2;
              break L5;
    ...
    final void d(int param0) {
        ...
        ((ok) this).field_u.a((byte) -85, ((ok) this).field_x, ((ok) this).field_j);
    }
