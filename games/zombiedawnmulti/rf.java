              ...
              if (var13 >= 0) {
                ...
                L5: while (true) {
                  if (param0 >= 0) {
                    ...
                    var9++;
                    var16 = ((rf) this).field_B[incrementValue$2];
                    var17 = oo.field_i[var12];
                    int incrementValue$3 = var12;
                    var12++;
                    oo.field_i[incrementValue$3] = ((var16 & 16711935) * var14 + (var17 & 16711935) * var15 & -16711936) + ((var16 & 65280) * var14 + (var17 & 65280) * var15 & 16711680) >>> 8;
                    param0++;
                    continue L5;
                  }
                }
