...
final class vm extends al implements in {
        ...
        try {
          L0: {
            L1: {
              ...
              var4.b(15, var5, 28972, -16 + (-14 + this.field_n), 30);
              this.b((byte) 83, var4);
              if (param0 < -71) {
                break L1;
              } else {
          ...
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("vm.B(").append(param0).append(',');
    ...
    public final void a(int param0, int param1, gn param2, int param3, int param4) {
        ...
        try {
            if (this.field_kb == param2) {
                this.l(0);
            }
        } catch (RuntimeException runtimeException) {
            throw fa.a((Throwable) ((Object) runtimeException), "vm.E(" + param0 + ',' + param1 + ',' + (param2 != null ? "{...}" : "null") + ',' + param3 + ',' + param4 + ')');
        }
    }
