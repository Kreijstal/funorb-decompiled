    ...
    final static ca a(boolean param0, byte[] param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("hc.B(").append(true).append(',');
    ...
    final static ae a(int param0, ga param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = new aj(var2_int, var3);
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("hc.A(").append(0).append(',');
