    ...
    final static ca a(boolean param0, byte[] param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("hc.B(").append(param0).append(',');
    ...
    final static ja[] a(ja[] param0, int param1) {
        ...
        try {
              ...
              L2: {
                L3: {
                  if (param0.length <= var2_int) {
                    ...
                    stackOut_3_0 = (ja[]) (param0);
                    stackIn_7_0 = stackOut_3_0;
                    stackIn_4_0 = stackOut_3_0;
                    if (var4 != 0) {
                      break L2;
                    } else {
                      stackIn_4_0[var2_int].field_u = param0[var2_int].field_w;
                      var2_int++;
                      if (var4 == 0) {
                        continue L1;
                      } else {
          ...
          L4: {
            ...
            stackOut_8_1 = new StringBuilder().append("hc.D(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
        ...
        try {
          L0: {
            if (param0 == 0) {
              ...
              stackOut_3_0 = new aj(var2_int, var3);
              stackIn_4_0 = stackOut_3_0;
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
              stackOut_1_0 = (ae) null;
              stackIn_2_0 = stackOut_1_0;
              decompiledRegionSelector0 = 0;
              break L0;
            }
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("hc.A(").append(param0).append(',');
