        ...
        if ((this.field_e ^ -1) < -1) {
          if (this.field_h != this.field_d[this.field_e + -1]) {
            ...
            L0: while (true) {
              if (this.field_g <= this.field_e) {
                ...
                var6 = this.field_d[fieldTemp$3].field_d;
                if (this.field_d[-1 + this.field_e] != var6) {
                  this.field_h = var6.field_d;
                  return var6;
                } else {
                  continue L0;
                }
          ...
          L1: while (true) {
            if (this.field_g <= this.field_e) {
              ...
              this.field_e = this.field_e + 1;
              var5 = this.field_d[fieldTemp$4].field_d;
              if (this.field_d[-1 + this.field_e] != var5) {
