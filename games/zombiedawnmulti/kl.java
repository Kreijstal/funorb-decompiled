...
final class kl {
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_g, 0, field_b, 0, var2);
        int var3 = field_i[this.field_h - 1];
        int var4 = mb.a((byte) -31, var3 - 1);
        field_j[0] = ac.a(var4);
        field_j[1] = ac.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < this.field_d.length; var6++) {
            var7 = this.field_d[var6];
            var8 = this.field_k[var7];
            var9 = this.field_c[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ac.field_o[this.field_e[var7]].a();
            }
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_a[var16]) {
                  var9 = field_b[var16];
                  var10 = field_j[var16] * this.field_h;
            ...
            if (var4 >= var2) {
              ...
              L1: while (true) {
                if (var4 >= var3) {
                    ...
                    if (var6 >= var2) {
                      ...
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= this.field_k[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              incrementValue$2 = var5;
                              var5++;
                              this.field_g[incrementValue$2] = ac.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_k[this.field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    this.field_k[var4] = ac.a(3) + 1;
                    dupTemp$3 = ac.a(2);
                    this.field_c[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      this.field_e[var4] = ac.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
