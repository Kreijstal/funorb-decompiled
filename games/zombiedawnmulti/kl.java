...
final class kl {
    ...
    final boolean b() {
        ...
        int var2 = ((kl) this).field_g.length;
        System.arraycopy((Object) (Object) ((kl) this).field_g, 0, (Object) (Object) field_b, 0, var2);
        int var3 = field_i[((kl) this).field_h - 1];
        int var4 = mb.a((byte) -31, var3 - 1);
        field_j[0] = ac.a(var4);
        field_j[1] = ac.a(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((kl) this).field_d.length; var6++) {
            var7 = ((kl) this).field_d[var6];
            var8 = ((kl) this).field_k[var7];
            var9 = ((kl) this).field_c[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = ac.field_o[((kl) this).field_e[var7]].a();
            }
            for (var12 = 0; var12 < var8; var12++) {
                var13 = ((kl) this).field_l[var7][var11 & var10];
                var11 = var11 >>> var9;
                int incrementValue$0 = var5;
                var5++;
                field_j[incrementValue$0] = var13 >= 0 ? ac.field_o[var13].a() : 0;
            }
        }
        return true;
    }
    ...
    private final void a(int param0, int param1, int param2, int param3, float[] param4, int param5) {
        ...
        param4[param0] = param4[param0] * field_f[var11];
        if (param2 > param5) {
            param2 = param5;
        }
        for (var14 = param0 + 1; var14 < param2; var14++) {
            ...
            param4[var14] = param4[var14] * field_f[var11];
        }
    }
        ...
        if (param0 < param1) {
          ...
          L0: while (true) {
            if (var7 > param1) {
              ...
              if (var8 < var4) {
                field_b[var3] = var8;
                field_j[var3] = field_j[var7];
                field_a[var3] = field_a[var7];
                var3++;
                field_b[var7] = field_b[var3];
                field_j[var7] = field_j[var3];
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((kl) this).field_g.length;
        var4 = field_i[((kl) this).field_h - 1];
        var5 = field_a;
        field_a[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_j[0] * ((kl) this).field_h;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_a[var16]) {
                  var9 = field_b[var16];
                  var10 = field_j[var16] * ((kl) this).field_h;
            ...
            L3: {
              var7 = kl.b(field_b, var6);
              var8_int = kl.a(field_b, var6);
              var9 = this.a(field_b[var7], field_j[var7], field_b[var8_int], field_j[var8_int], field_b[var6]);
              var10 = field_j[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
            ...
            if (var10 == 0) {
              ...
              var14 = field_a;
              var15 = var7;
              field_a[var8_int] = true;
              var14[var15] = true;
              field_a[var6] = true;
              if (var10 < var13) {
                L4: {
                  stackOut_11_0 = (int[]) field_j;
                  stackOut_11_1 = var6;
    ...
    kl() {
        ...
        if (var1 == 1) {
          var2 = ac.a(5);
          var3 = 0;
          ((kl) this).field_d = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((kl) this).field_k = new int[var3];
              ((kl) this).field_c = new int[var3];
              ((kl) this).field_e = new int[var3];
              ((kl) this).field_l = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((kl) this).field_h = ac.a(2) + 1;
                  var4 = ac.a(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((kl) this).field_g = new int[var5];
                      ((kl) this).field_g[0] = 0;
                      ((kl) this).field_g[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                          ...
                          var8 = 0;
                          L6: while (true) {
                            if (var8 >= ((kl) this).field_k[var7]) {
                              var6++;
                              continue L3;
                            } else {
                              int incrementValue$2 = var5;
                              var5++;
                              ((kl) this).field_g[incrementValue$2] = ac.a(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + ((kl) this).field_k[((kl) this).field_d[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    ((kl) this).field_k[var4] = ac.a(3) + 1;
                    int dupTemp$3 = ac.a(2);
                    ((kl) this).field_c[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      ((kl) this).field_e[var4] = ac.a(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
