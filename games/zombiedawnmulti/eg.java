...
final class eg extends kk {
    ...
    final static ic a(int param0, long param1, String param2, boolean param3, String param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("eg.I(").append(param0).append(44).append(param1).append(44);
    ...
    eg(Object param0, int param1) {
        ...
        try {
            ...
            throw fa.a((Throwable) (Object) runtimeException, "eg.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
