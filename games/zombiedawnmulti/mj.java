...
final class mj extends cj {
    ...
    mj(long param0, cj param1, ja param2, ja param3, cj param4, cj param5, boolean param6) {
        ...
        try {
            ...
            throw fa.a((Throwable) (Object) runtimeException, "mj.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + (param2 != null ? "{...}" : "null") + 44 + (param3 != null ? "{...}" : "null") + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + param6 + 41);
        }
    }
    ...
    private mj(long param0, cj param1, cj param2, cj param3, cj param4, boolean param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("mj.<init>(").append(param0).append(44);
            stackIn_8_0 = stackOut_6_0;
            stackIn_8_1 = stackOut_6_1;
            stackIn_7_0 = stackOut_6_0;
            stackIn_7_1 = stackOut_6_1;
          ...
          throw fa.a((Throwable) (Object) stackIn_18_0, stackIn_18_2 + 44 + param5 + 41);
        }
    }
