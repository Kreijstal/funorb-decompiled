...
final class pn {
    ...
    final static void b() {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (hl.field_e.length <= var2) {
                ...
                d.a(ah.field_f, var2 << 4, ah.field_f, var1_int, var3);
          ...
          throw fa.a((Throwable) (Object) var1, "pn.A(" + 8 + 41);
        }
    }
    ...
    final static boolean a(int param0, go param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("pn.D(").append(-9).append(44);
