...
final class ef extends fm {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              ef.a(oo.field_i, ((ef) this).field_O[param0], param5, var12, var9, param3, param4, var10, var11, param6);
              return;
            } else {
              break L4;
            }
    ...
    private final static void a(int[] param0, byte[] param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int[] param11, int[] param12) {
        ...
        int var19 = 0;
        int var20 = 0;
        var13 = param2 - oo.field_f;
        var14 = param3 - oo.field_e;
        var15 = var14;
        L0: while (true) {
            ...
            L3: while (true) {
              if (var20 >= 0) {
                ...
                if (param1[incrementValue$2] == 0) {
                  ...
                  param8++;
                  oo.field_i[incrementValue$3] = param6;
                  var20++;
                  continue L3;
                }
              }
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (oo.field_h == null) {
                  ef.a(oo.field_i, ((ef) this).field_O[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  ef.a(oo.field_i, ((ef) this).field_O[param0], param1, param2, param3, param4, param5, var11, var8, var9, var10, oo.field_h, oo.field_a);
                  break L5;
                }
              }
              return;
    ...
    ef(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, byte[][] param5) {
        ...
        ((ef) this).field_O = new byte[256][];
        ((ef) this).field_O = param5;
    }
}
