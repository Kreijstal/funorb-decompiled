...
final class fq extends ae {
    ...
    final static boolean a(int param0, int param1, int[] param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("fq.B(").append(param0).append(44).append(param1).append(44);
    ...
    final static void a(boolean param0, int param1, ug param2, int param3, int param4) {
        try {
            ...
            throw fa.a((Throwable) (Object) runtimeException, "fq.F(" + param0 + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 44 + param4 + 41);
        }
    }
