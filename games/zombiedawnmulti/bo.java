...
final class bo {
    ...
    final static af[] a(int param0, ga param1) {
        ...
        try {
            ...
            if (0 >= var2_int) {
              L1: {
                if (param0 == 30816) {
                  ...
                  var8 = null;
                  bm discarded$7 = bo.a((byte[]) null, 106);
                  break L1;
                }
              }
                ...
                if (var5 >= var3) {
                  ...
                  L3: {
                    if (!fq.a(68, param1)) {
                      ...
                      var6_ref_af = new af();
                      int discarded$8 = param1.h(24, 14862);
                      int discarded$9 = param1.h(24, 14862);
                      var6_ref_af.field_f = param1.h(24, 14862);
                      int discarded$10 = param1.h(9, param0 ^ 17006);
                      int discarded$11 = param1.h(12, 14862);
                      int discarded$12 = param1.h(12, 14862);
                      int discarded$13 = param1.h(12, 14862);
          ...
          L4: {
            ...
            stackOut_14_1 = new StringBuilder().append("bo.A(").append(param0).append(44);
    ...
    final void a(int param0, java.applet.Applet param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("bo.F(").append(param0).append(44);
    ...
    final static void a(int param0, int param1, int param2, String[] param3, int param4, java.applet.Applet param5) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_16_1 = new StringBuilder().append("bo.G(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
          ...
          L6: {
            ...
            stackOut_19_1 = ((StringBuilder) (Object) stackIn_19_1).append(stackIn_19_2).append(44).append(param4).append(44);
    ...
    final static bm a(byte[] param0, int param1) {
        ...
        try {
              ...
              if (var2_int >= 4) {
                ...
                L3: while (true) {
                  if (param0.length / 4 <= var2_int) {
                    stackOut_9_0 = no.a((byte) 104, var10);
          ...
          L4: {
            ...
            stackOut_11_1 = new StringBuilder().append("bo.E(");
    ...
    final boolean a(String param0, byte param1) {
        ...
        try {
          ...
          throw fa.a((Throwable) (Object) stackIn_5_0, stackIn_5_2 + 44 + param1 + 41);
        }
        return stackIn_1_0;
    }
    ...
    bo(String param0) {
        try {
            ...
            throw fa.a((Throwable) (Object) runtimeException, "bo.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
