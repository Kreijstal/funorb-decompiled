...
final class me {
    ...
    final jd a(int param0, byte param1, int[] param2) {
        ...
        try {
          if (1 != ((me) this).field_l.c(-1)) {
            if (((me) this).field_l.d(param0, -2) != 1) {
              L0: {
                if (param1 == -64) {
                  break L0;
                } else {
                  var5 = null;
                  sl discarded$2 = me.a((byte[]) null, false);
                  break L0;
                }
              }
          ...
          L1: {
            ...
            stackOut_9_1 = new StringBuilder().append("me.G(").append(param0).append(44).append(param1).append(44);
    ...
    final jd a(int param0, int[] param1, int param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_11_1 = new StringBuilder().append("me.C(").append(param0).append(44);
        ...
        try {
          L0: {
            ...
            if (var2 == null) {
              ...
              L1: while (true) {
                if (var5 >= var3.length) {
                  stackOut_12_0 = wi.field_h;
                  stackIn_13_0 = stackOut_12_0;
                  break L0;
                } else {
                  var6 = var3[var5];
                  if (var6.a(var2, (byte) -107)) {
                    stackOut_9_0 = (bo) var6;
                    stackIn_10_0 = stackOut_9_0;
                    return stackIn_10_0;
                  } else {
                    var5++;
          ...
          L2: {
            ...
            stackOut_14_1 = new StringBuilder().append("me.D(").append(-57).append(44);
    ...
    private final jd a(int param0, int param1, boolean param2, int[] param3) {
        ...
        try {
          L0: {
            var5_int = ((536875007 & param0) << 4 | param0 >>> 12) ^ param1;
            var5_int = var5_int | param0 << 16;
            var6 = 4294967296L ^ (long)var5_int;
            var8 = (jd) (Object) ((me) this).field_a.a(0, var6);
            if (var8 == null) {
              L1: {
                if (param3 == null) {
                  break L1;
                  ...
                  if (param3[0] > 0) {
                    ...
                    stackOut_5_0 = null;
                    stackIn_6_0 = stackOut_5_0;
                    return (jd) (Object) stackIn_6_0;
                  }
                }
              }
              L2: {
                var9 = (ac) (Object) ((me) this).field_i.a(0, var6);
                if (var9 != null) {
                  break L2;
                } else {
                  var9 = ac.a(((me) this).field_l, param0, param1);
                  if (var9 != null) {
                    ((me) this).field_i.a(true, var6, (br) (Object) var9);
                    break L2;
                  } else {
                    return null;
                  }
              ...
              if (var8 != null) {
                var9.a(true);
                ((me) this).field_a.a(true, var6, (br) (Object) var8);
          ...
          L3: {
            ...
            stackOut_17_1 = new StringBuilder().append("me.F(").append(param0).append(44).append(param1).append(44).append(0).append(44);
    ...
    private final jd a(int param0, int[] param1, int param2, int param3) {
        ...
        String stackOut_15_2 = null;
        try {
          var5_int = (param2 << 4 & 65526 | param2 >>> 12) ^ param3;
          ...
          if (var8 == null) {
            ...
            var9 = jc.a(((me) this).field_b, param2, param3);
            if (var9 != null) {
              L1: {
                var10 = var9.a();
                var8 = var10;
          ...
          L2: {
            ...
            stackOut_14_1 = new StringBuilder().append("me.E(").append(-1991540092).append(44);
            stackIn_16_0 = stackOut_14_0;
            stackIn_16_1 = stackOut_14_1;
            stackIn_15_0 = stackOut_14_0;
            stackIn_15_1 = stackOut_14_1;
    ...
    me(ul param0, ul param1) {
        ...
        try {
            ...
            throw fa.a((Throwable) (Object) runtimeException, "me.<init>(" + (param0 != null ? "{...}" : "null") + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
