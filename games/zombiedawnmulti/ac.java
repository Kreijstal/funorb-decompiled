...
final class ac extends br {
    private int field_h;
    private boolean field_K;
    private int field_N;
    private static int[] field_q;
    private static boolean field_u;
    private static oc[] field_l;
    ...
    final jd c() {
        ...
        int var7 = 0;
        ((ac) this).field_p = 0;
        ((ac) this).field_w = new float[field_M];
        var1 = new byte[((ac) this).field_j];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((ac) this).field_v.length) {
            ((ac) this).field_w = null;
            return new jd(((ac) this).field_h, var1, ((ac) this).field_z, ((ac) this).field_N, ((ac) this).field_n);
          } else {
            var4 = this.c(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((ac) this).field_j - var2) {
                  break L1;
                } else {
                  var5 = ((ac) this).field_j - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        byte[] var6 = null;
        k var2 = new k(param0);
        ((ac) this).field_h = var2.i(-1478490344);
        ((ac) this).field_j = var2.i(-1478490344);
        ...
        ((ac) this).field_v = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            var5 = 0;
            do {
                var6_int = var2.g(31365);
                var5 = var5 + var6_int;
            } while (var6_int >= 255);
            var6 = new byte[var5];
            var2.a(0, -6351, var5, var6);
            ((ac) this).field_v[var4] = var6;
        }
    }
    ...
    final static int a(int param0) {
        ...
        while (param0 >= 8 - field_I) {
            var3 = 8 - field_I;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_L[field_i] >> field_I & var4) << var2);
            field_I = 0;
            field_i = field_i + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_L[field_i] >> field_I & var3) << var2);
            field_I = field_I + param0;
        }
        return var1;
    }

    private final static boolean a(ul param0) {
        byte[] var1 = null;
        if (!field_u) {
    ...
    final static int b() {
        int var0 = field_L[field_i] >> field_I & 1;
        field_I = field_I + 1;
        field_i = field_i + (field_I >> 3);
        field_I = field_I & 7;
        return var0;
    }
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = ac.a(16);
                                    int discarded$4 = ac.a(16);
                                    field_q[var6] = ac.a(8);
                                    var6++;
                                    continue L6;
                                  }
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = lm.a(var11, -19863, var10);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    final jd a(int[] param0) {
        ...
        L1: {
          if (((ac) this).field_C != null) {
            ...
            ((ac) this).field_p = 0;
            ((ac) this).field_w = new float[field_M];
            ((ac) this).field_C = new byte[((ac) this).field_j];
            ((ac) this).field_t = 0;
            ((ac) this).field_r = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((ac) this).field_r >= ((ac) this).field_v.length) {
            ((ac) this).field_w = null;
            var14 = ((ac) this).field_C;
            ((ac) this).field_C = null;
            return new jd(((ac) this).field_h, var14, ((ac) this).field_z, ((ac) this).field_N, ((ac) this).field_n);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((ac) this).field_t;
                  var4 = var13.length;
                  if (var4 <= ((ac) this).field_j - var3) {
                    break L5;
                  } else {
                    var4 = ((ac) this).field_j - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((ac) this).field_t);
                        break L7;
                      }
                    }
                    ((ac) this).field_t = var3;
                    break L4;
                  } else {
                    L8: {
    ...
    private final float[] c(int param0) {
        ...
        L0: {
          ac.a(((ac) this).field_v[param0], 0);
          int discarded$1 = ac.b();
          var2 = ac.a(mb.a((byte) -31, field_q.length - 1));
          var3 = field_B[var2] ? 1 : 0;
          if (var3 == 0) {
            stackOut_2_0 = field_J;
          ...
          L5: {
            ...
            if (var3 == 0) {
              ...
              if (var5 != 0) {
                ...
                var8 = (var4 >> 2) - (field_J >> 2);
                var9 = (var4 >> 2) + (field_J >> 2);
                var10 = field_J >> 1;
                break L4;
              }
            }
          ...
          L7: {
            if (var3 == 0) {
              ...
              if (var6 != 0) {
                ...
                var11 = var4 - (var4 >> 2) - (field_J >> 2);
                var12 = var4 - (var4 >> 2) + (field_J >> 2);
                var13 = field_J >> 1;
                break L6;
              }
            }
        ...
        L8: {
          var14 = field_k[field_q[var2]];
          var16 = var14.field_d;
          var17_int = var14.field_b[var16];
          if (field_x[var17_int].b()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_c) {
            L10: {
              if (var15 != 0) {
                ...
                field_x[var18_int].a(field_E, var4 >> 1);
                break L10;
              }
            }
            L11: {
            ...
            L35: {
              var17 = null;
              if (((ac) this).field_p <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((ac) this).field_p + var4 >> 2;
                  ...
                  if (((ac) this).field_K) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((ac) this).field_m) {
                        break L36;
                      } else {
                        var20 = (((ac) this).field_p >> 1) + var19;
                        var40[var19] = var40[var19] + ((ac) this).field_w[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((ac) this).field_w;
              ((ac) this).field_w = field_E;
              field_E = var18;
              ((ac) this).field_p = var4;
              ((ac) this).field_m = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    private ac(byte[] param0) throws IOException {
        this.a(param0);
    }
