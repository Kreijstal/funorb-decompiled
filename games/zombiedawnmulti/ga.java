...
final class ga extends k {
    ...
    final void b(byte param0, int param1) {
        ...
        ((ga) this).field_m[((ga) this).field_j] = (byte)(param1 + ((ga) this).field_p.a(-48));
    }
    ...
    final void b(int param0, int param1, int param2, byte[] param3) {
        ...
        for (var5 = param1; param0 > var5; var5++) {
            ((ga) this).field_j = ((ga) this).field_j + 1;
            param3[var5 + param2] = (byte)(((ga) this).field_m[((ga) this).field_j] + -((ga) this).field_p.a(-90));
        }
    }
    ...
    final static uc a(String param0, boolean param1) {
        if (tg.field_g.d(-99)) {
            if (!(param0.equals((Object) (Object) tg.field_g.a(31027)))) {
                tg.field_g = tg.a(param0, !param1 ? true : false);
            }
        }
        if (param1) {
            return null;
    ...
    final int h(int param0, int param1) {
        ...
        int var3 = ((ga) this).field_o >> 1350894083;
        int var4 = 8 - (7 & ((ga) this).field_o);
        int var5 = 0;
        ((ga) this).field_o = ((ga) this).field_o + param0;
        while (var4 < param0) {
            var3++;
            var5 = var5 + ((mb.field_n[var4] & ((ga) this).field_m[var3]) << param0 + -var4);
            param0 = param0 - var4;
            var4 = 8;
        }
        if (param0 != var4) {
    ...
    final int m(int param0) {
        ...
        ((ga) this).field_j = ((ga) this).field_j + 1;
        return ((ga) this).field_m[((ga) this).field_j] + -((ga) this).field_p.a(-25) & 255;
    }
