...
final class e implements Iterable {
    ...
    final static void a(ul param0, byte[] param1, int param2, String[] param3, int[] param4, int param5, ja[][] param6, String[] param7, boolean param8, String[][] param9, int param10, String[][] param11, ul param12, byte[] param13, int[] param14, ri[] param15, ja[][] param16, ul param17, boolean param18) {
        ...
        try {
          L0: {
            var20 = null;
            vb.a(param10, param11, (String[]) null, param3, true, param9, param4, param7, param1, param17, param14, 1, param6, param5, param0, false, param16, param12, param13, param15);
            break L0;
          }
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("e.A(");
          ...
          L3: {
            ...
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(',').append(1).append(',');
          ...
          L8: {
            ...
            stackOut_23_1 = ((StringBuilder) (Object) stackIn_23_1).append(stackIn_23_2).append(',').append(param10).append(',');
          ...
          throw fa.a((Throwable) (Object) stackIn_44_0, stackIn_44_2 + ',' + true + ')');
        }
    }
    ...
    final void a(qa param0, byte param1) {
        ...
        try {
            ...
            throw fa.a((Throwable) (Object) runtimeException, "e.B(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ')');
        }
    }
    ...
    final static void a(byte param0, ri param1) {
        ...
        try {
          L0: {
            if ((3 & (param1.field_h | (param1.field_b | param1.field_e | param1.field_j))) != 0) {
              var2_int = param1.field_e - -(param1.field_j & 3);
              var2_int = 4 + (-(var2_int & 3) + var2_int);
              var3 = (param1.field_h & 3) + param1.field_b;
              var3 = 4 - (3 & var3) + var3;
              var4 = new byte[var3 * var2_int];
              var5 = 0;
              var6 = var2_int * (param1.field_h & 3) + (3 & param1.field_j);
              var7 = 0;
              L1: while (true) {
                if (var7 >= param1.field_b) {
                  param1.field_e = var2_int;
                  ...
                  L2: while (true) {
                    if (param1.field_e <= var8) {
                      var6 = var6 + (-param1.field_e + var2_int);
                      var7++;
                      continue L1;
                    } else {
                      ...
                      var5++;
                      var4[incrementValue$2] = param1.field_m[incrementValue$3];
                      var8++;
                      continue L2;
                    }
                  }
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("e.C(").append(48).append(',');
