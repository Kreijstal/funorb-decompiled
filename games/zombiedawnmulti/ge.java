    ...
    private final void n(byte param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 10: {
                    stackIn_42_0 = -1 + this.field_B;
                    stackIn_11_0 = stackIn_42_0;
                    if (var12 != 0) {
                        statePc = 42;
                    } else {
                        statePc = 11;
    ...
    private final void n(int param0) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 9: {
                    stackIn_47_0 = this.field_B - 1;
                    stackIn_10_0 = stackIn_47_0;
                    if (var12 != 0) {
                        statePc = 47;
                    } else {
                        statePc = 10;
