    ...
    final static void a(byte param0, ld param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("an.C(").append(param0).append(44);
    ...
    an(int param0, ul param1, ul param2, dr param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (((an) this).field_c == null) {
                ...
                int discarded$4 = ((an) this).field_c.d(1, -2);
                break L1;
              }
            }
            if (((an) this).field_b != null) {
              int discarded$5 = ((an) this).field_b.d(1, -2);
              break L0;
            } else {
              return;
            }
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("an.<init>(").append(param0).append(44);
