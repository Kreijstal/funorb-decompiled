...
abstract class lm extends pa {
    ...
    final boolean a(boolean param0, pa param1) {
        ...
        L1: {
          ...
          var3 = (param1.e((byte) -112) + ((lm) this).e((byte) -112)) / 2;
          var4 = (param1.g(1829947600) - -((lm) this).g(1829947600)) / 2;
          var5 = var3 - ((lm) this).e((byte) -112);
          var6 = -((lm) this).g(1829947600) + var4;
          var7 = 400;
          if (var7 <= var5 * var5 + var6 * var6) {
            L2: {
              var8 = 8;
              if (this.a((byte) 117, var4, var3)) {
                break L2;
              } else {
                var3 = var3 + (hp.a((byte) -107, g.field_a, 2 * var8) + (12 - var8));
                var4 = var4 + (12 + (hp.a((byte) 108, g.field_a, 2 * var8) + -var8));
                break L2;
              }
            }
            if (!this.a((byte) 125, var4, var3)) {
              break L1;
            } else {
              if (0 == (((lm) this).field_A.field_b.a(((lm) this).g(1829947600), ((lm) this).e((byte) -112), -17201, var3, var4, false, false) ^ -1)) {
                break L1;
              } else {
                this.b(((lm) this).field_N, -94, ((lm) this).field_ab);
                ((lm) this).field_N = var3;
                    ...
                    if (var6 * var6 + var7 * var7 >= param1 * param1) {
                      ...
                      L3: {
                        if (param0) {
                          ...
                          if (0 == (((lm) this).field_A.field_b.a(var5.g(1829947600), var5.e((byte) -112), param2 ^ -21771, ((lm) this).e((byte) -112), ((lm) this).g(param2 + 1829941910), false, true) ^ -1)) {
                            break L2;
                          } else {
                            break L3;
                          }
    ...
    private final boolean m(int param0) {
        ...
        while (var3 != null) {
            ...
            var3 = (ek) (Object) ((lm) this).field_A.field_u.b(param0 ^ -1);
        }
        return var2 != 0;
    }
    ...
    final void h(int param0) {
        ...
        L1: {
          ...
          if (-1 == (((lm) this).field_Q ^ -1)) {
            L2: {
              ((lm) this).field_ib = ((lm) this).field_ib + 1;
              if (((lm) this).field_rb >= ((lm) this).field_ib + 1) {
                break L2;
              } else {
                L3: {
                  ((lm) this).field_ib = 0;
            ...
            if (((lm) this).field_Q != 2) {
              if (((lm) this).field_Q == 1) {
                        ...
                        L8: {
                          L9: {
                            if (((lm) this).field_wb) {
                              ...
                              if (var2 != 0) {
                                ((lm) this).c(-110, ((lm) this).field_cb >> -233368862);
                                break L8;
                              } else {
                                break L9;
                              }
                ...
                if (-4 == (((lm) this).field_Q ^ -1)) {
                  ((lm) this).field_kb = ((lm) this).field_kb + 1;
                  if ((((lm) this).field_kb ^ -1) <= -21) {
                    ((lm) this).field_kb = 0;
                    ((lm) this).l((byte) 111);
                    break L1;
                  } else {
                  ...
                  if (((lm) this).field_Q == 16) {
                    ...
                    if (((lm) this).field_Q != 20) {
                      if (((lm) this).field_Q == -26) {
                        ((lm) this).field_tb = ((lm) this).field_tb - 1;
                        if ((((lm) this).field_tb - 1 ^ -1) >= -1) {
                          ((lm) this).a(0, (byte) -89);
                          ((lm) this).field_S = true;
                          ((lm) this).field_kb = 0;
                          break L1;
              ...
              if (!((lm) this).field_A.field_b.a(((lm) this).field_G - -((lm) this).field_R >> -337878192, true, true, ((lm) this).field_W + ((lm) this).field_E >> 717214000)) {
        ...
        L1: {
          if (!(param1 instanceof ge)) {
            if (param1 instanceof og) {
              L2: {
                var5 = ((lm) this).field_ub[param2] + -param1.e((byte) -112);
                var6 = ((lm) this).field_qb[param2] - param1.g(param3 ^ 1829947602);
    ...
    final static int a(int param0, int param1, int param2) {
        ...
        if (param1 != -19863) {
            int discarded$0 = lm.a(-75, -66, 106);
        }
        int var3 = 0;
        while (-1 > (param2 ^ -1)) {
            var3 = param0 & 1 | var3 << 90930017;
            param0 = param0 >>> 1;
            param2--;
        }
        return var3;
                  ...
                  L4: while (true) {
                    if (var13 instanceof ek) {
                      L5: {
                        L6: {
                          L7: {
                            var14 = (ek) (Object) var13;
                            if (!(var13 instanceof ge)) {
                              break L7;
                            } else {
                              if (((ge) (Object) var13).q(-127)) {
                                break L6;
                              } else {
                                break L7;
                              }
                        ...
                        if (var4 <= var17 * var17 - -(var18 * var18)) {
                          ...
                          L8: {
                            if (param0) {
                              ...
                              if ((((lm) this).field_A.field_b.a(var16, var15, -17201, var8, var9, false, true) ^ -1) != 0) {
                                break L8;
                              } else {
                                break L5;
                              }
                      ...
                      var13 = (ff) (Object) ((br) (Object) var13).field_d;
                      continue L4;
                    } else {
                      var11++;
                      continue L3;
