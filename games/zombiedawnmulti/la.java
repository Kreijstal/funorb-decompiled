...
final class la {
    ...
    private final void a(int param0, int param1, int param2) {
        if (param0 <= ((la) this).field_a) {
          if (((la) this).field_o.length > param0) {
            if (param2 != 0) {
              return;
            } else {
              ((la) this).field_o[param0] = param1;
              return;
            }
          } else {
    ...
    final void b(byte param0, int param1) {
        ...
        this.a(1 + ((la) this).field_a, param1, param0 ^ -7);
    }
    ...
    final int a(byte param0, int param1) {
        ...
        if (!(((la) this).field_a >= param1)) {
            throw new ArrayIndexOutOfBoundsException(param1);
        }
        return ((la) this).field_o[param1];
    }

    final int b(int param0) {
        if (param0 != 1) {
            int discarded$0 = this.a(-120, (byte) 109);
    ...
    final void a(int param0, int param1) {
        ...
        if (0 <= param1) {
          if (((la) this).field_a >= param1) {
            if (((la) this).field_a != param1) {
              d.a(((la) this).field_o, param1 + 1, ((la) this).field_o, param1, -param1 + ((la) this).field_a);
              var3 = -95 / ((param0 - 37) / 32);
              ((la) this).field_a = ((la) this).field_a - 1;
              return;
            } else {
              var3 = -95 / ((param0 - 37) / 32);
              ((la) this).field_a = ((la) this).field_a - 1;
