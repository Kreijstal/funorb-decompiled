...
class tj {
                ...
                L0: {
                  ...
                  L2: while (true) {
                    if (var1 <= this.field_m + 5000L) {
                      ...
                      this.a(256);
                      this.field_m = this.field_m + (long)(256000 / field_q);
                      var1 = ue.a(false);
                      continue L2;
                    }
                  }
              ...
              if (this.field_n != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.a();
                      if (this.field_h - var3_int <= this.field_t) {
                        break L6;
                      } else {
                        this.field_t = this.field_h - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_s + this.field_o;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_a) {
                        ...
                        if (var4 + 256 <= this.field_a) {
                          ...
                          this.field_o = var4 - this.field_s;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_b) {
                            ...
                            L12: {
                              if (this.field_k) {
                                ...
                                this.field_o = Math.min(this.field_f, this.field_t);
    ...
    private final void a(int[] param0, int param1) {
        ...
        L1: {
          ...
          if (this.field_e == null) {
            ...
            if (this.field_i > 0) {
              ...
              this.field_i = this.field_i + (field_q >> 4);
              tj.a(this.field_e);
              this.a(this.field_e, this.field_e.c());
              var4 = 0;
              var5 = 255;
              var6 = 7;
              L2: while (true) {
                                ...
                                if (var4 < this.field_j) {
                                  ...
                                  L13: {
                                    if (var15 != null) {
                                      ...
                                      this.field_u[var7_int] = (qd) (var10);
                                      break L13;
                                    }
                                  }
                                  var11 = var15;
                  ...
                  if (var6 >= 8) {
                    ...
                    L15: while (true) {
                      if (var7 == null) {
                        ...
                        var10 = ((qd) (var7)).field_l;
                        ((qd) (var7)).field_l = null;
                        var7 = var10;
                        continue L15;
                      }
                    }
        ...
        L17: {
          if (this.field_e == null) {
            ...
            this.field_e.b(param0, 0, param1);
            break L17;
          }
        }
        this.field_m = ue.a(false);
    }
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new pd();
                          var4 = var5;
                          stackIn_10_0 = (pd) (var4);

                          stackIn_10_1 = 256;

                          if (!field_g) {
                            stackIn_11_0 = (pd) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_l <= 0) {
                            ...
                            if (field_c != null) {
                              ...
                              param0.a(field_l, (Runnable) ((Object) field_c), (byte) -94);
                              break L5;
                            }
                          }
                        }
    ...
    tj() {
        ...
        this.field_m = ue.a(false);
        this.field_r = 0L;
        this.field_p = new qd[8];
        this.field_b = 0L;
        this.field_u = new qd[8];
        this.field_i = 0;
        this.field_f = 0;
        this.field_k = true;
        this.field_h = 0;
