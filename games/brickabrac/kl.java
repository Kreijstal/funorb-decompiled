...
final class kl extends qd {
    ...
    final int b() {
        if (this.field_w == 0 && this.field_x == 0) {
            return 0;
        }
        return 1;
    }
    ...
    final synchronized void a(int param0) {
        ...
        L0: {
          if (this.field_x <= 0) {
            ...
            if (param0 < this.field_x) {
              this.field_A = this.field_A + this.field_u * param0;
              this.field_q = this.field_q + this.field_v * param0;
        ...
        this.field_r = this.field_r + this.field_p * param0;
        if (this.field_s >= 0) {
          L5: {
            if (this.field_s <= 0) {
              break L5;
                  ...
                  if (this.field_p >= 0) {
                    if (this.field_r >= var4) {
                      ...
                      if (var7 < this.field_s) {
                        ...
                        this.field_r = this.field_r - var6 * this.field_s;
                        this.field_s = 0;
                        break L5;
                      }
                    } else {
    ...
    final synchronized void h(int param0) {
        int var2 = ((oe) ((Object) this.field_k)).field_m.length << 8;
        if (param0 < -1) {
            param0 = -1;
        }
        if (param0 > var2) {
    ...
    final synchronized int h() {
        return this.field_w == -2147483648 ? 0 : this.field_w + 32 >> 6;
    }
    ...
    private final boolean j() {
        ...
        L0: {
          var1 = this.field_w;
          if (var1 != -2147483648) {
            var2 = kl.b(var1, this.field_n);
            var3 = kl.d(var1, this.field_n);
            break L0;
          } else {
            var3 = 0;
            var2 = 0;
        ...
        L2: {
          if (this.field_A >= var1) {
            if (this.field_A <= var1) {
              ...
              this.field_u = -1;
              this.field_x = this.field_A - var1;
              break L2;
            }
          } else {
            this.field_u = 1;
            this.field_x = var1 - this.field_A;
            break L2;
          }
        }
        L3: {
          if (this.field_q >= var2) {
            if (this.field_q <= var2) {
              ...
              L4: {
                ...
                if (this.field_x == 0) {
                  ...
                  if (this.field_x <= this.field_q - var2) {
                    break L3;
                  } else {
                    break L4;
                  }
              ...
              this.field_x = this.field_q - var2;
              break L3;
            }
          } else {
            L5: {
              ...
              if (this.field_x == 0) {
                ...
                if (this.field_x <= var2 - this.field_q) {
                  break L3;
                } else {
                  break L5;
                }
            ...
            this.field_x = var2 - this.field_q;
            break L3;
          }
        }
        if (this.field_o < var3) {
          this.field_z = 1;
          if (this.field_x != 0) {
            if (this.field_x > var3 - this.field_o) {
              this.field_x = var3 - this.field_o;
              return false;
            } else {
              return false;
            }
            ...
            if (this.field_o <= var3) {
              ...
              L7: {
                ...
                if (this.field_x == 0) {
                  ...
                  if (this.field_x <= this.field_o - var3) {
                    break L6;
                  } else {
                    break L7;
                  }
              ...
              this.field_x = this.field_o - var3;
              break L6;
            }
          }
          return false;
    ...
    final synchronized boolean l() {
        return this.field_r < 0 || this.field_r >= ((oe) ((Object) this.field_k)).field_m.length << 8;
    }
        ...
        if (param0 != 0) {
          if (this.field_q == 0) {
            if (this.field_o == 0) {
              ...
              this.field_u = -this.field_A / param0;
              this.field_v = -this.field_q / param0;
              this.field_z = -this.field_o / param0;
              return;
            }
          } else {
            L6: {
    ...
    final int c() {
        int var1 = this.field_A * 3 >> 6;
        var1 = (var1 ^ var1 >> 31) + (var1 >>> 31);
        if (this.field_s == 0) {
            var1 = var1 - var1 * this.field_r / (((oe) ((Object) this.field_k)).field_m.length << 8);
        } else {
            if (this.field_s >= 0) {
                var1 = var1 - var1 * this.field_m / ((oe) ((Object) this.field_k)).field_m.length;
            }
        }
          ...
          if (this.field_q == var4) {
            if (this.field_o == var5) {
              ...
              L0: {
                ...
                if (this.field_A - param1 <= var6) {
                  break L0;
                } else {
                  var6 = this.field_A - param1;
                  break L0;
                }
              }
              L1: {
                if (var4 - this.field_q <= var6) {
                  break L1;
                } else {
                  var6 = var4 - this.field_q;
                  break L1;
                }
              }
              L2: {
                if (this.field_q - var4 <= var6) {
                  break L2;
                } else {
                  var6 = this.field_q - var4;
                  break L2;
                }
              }
              L3: {
              ...
              this.field_w = param1;
              this.field_n = param2;
              this.field_u = (param1 - this.field_A) / param0;
              this.field_v = (var4 - this.field_q) / param0;
              this.field_z = (var5 - this.field_o) / param0;
              return;
            }
          } else {
            L6: {
        ...
        L0: while (true) {
          if (this.field_x <= 0) {
            L1: {
              if (this.field_p != 256) {
                ...
                if ((this.field_r & 255) != 0) {
                  ...
                  if (tj.field_g) {
                    return kl.b(0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_q, this.field_o, 0, param3, param2, (kl) (this));
                  } else {
                    return kl.a(((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_A, 0, param3, param2, (kl) (this));
                  }
                }
              }
            }
            if (tj.field_g) {
              return kl.c(0, 0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_q, this.field_o, 0, param3, param2, (kl) (this), this.field_p, param4);
            } else {
              return kl.b(0, 0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_A, 0, param3, param2, (kl) (this), this.field_p, param4);
            }
          } else {
            L2: {
            ...
            L3: {
              L4: {
                ...
                if (this.field_p != 256) {
                  ...
                  if ((this.field_r & 255) != 0) {
                    ...
                    if (!tj.field_g) {
                      param1 = kl.b(((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_A, this.field_u, 0, var6, param2, (kl) (this));
                      break L3;
                    } else {
                      param1 = kl.b(0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_q, this.field_o, this.field_v, this.field_z, 0, var6, param2, (kl) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!tj.field_g) {
                param1 = kl.a(0, 0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_A, this.field_u, 0, var6, param2, (kl) (this), this.field_p, param4);
                break L3;
              } else {
                param1 = kl.a(0, 0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_q, this.field_o, this.field_v, this.field_z, 0, var6, param2, (kl) (this), this.field_p, param4);
                break L3;
              }
            }
            this.field_x = this.field_x - param1;
          ...
          L4: {
            if (this.field_s <= 0) {
              ...
              if (!this.field_t) {
                if (this.field_p >= 0) {
                  L5: while (true) {
                    var9 = this.b(param0, var9, var6, param2, (int) var4.field_m[this.field_m]);
                    if (this.field_r >= var6) {
                      ...
                      if (var10 < this.field_s) {
                        ...
                        this.field_r = this.field_r - var8 * this.field_s;
                        this.field_s = 0;
                        break L4;
                      }
                    } else {
                  ...
                  L6: while (true) {
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_m[this.field_y - 1]);
                    if (this.field_r < var5) {
                ...
                L7: {
                  if (this.field_p >= 0) {
                    ...
                    var9 = this.a(param0, var9, var5, param2, (int) var4.field_m[this.field_m]);
                    if (this.field_r < var5) {
                ...
                L8: while (true) {
                  var9 = this.b(param0, var9, var6, param2, (int) var4.field_m[this.field_y - 1]);
                  if (this.field_r >= var6) {
        ...
        L0: while (true) {
          if (this.field_x <= 0) {
            L1: {
              if (this.field_p != -256) {
                ...
                if ((this.field_r & 255) != 0) {
                  ...
                  if (tj.field_g) {
                    return kl.a(0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_q, this.field_o, 0, param3, param2, (kl) (this));
                  } else {
                    return kl.b(((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_A, 0, param3, param2, (kl) (this));
                  }
                }
              }
            }
            if (tj.field_g) {
              return kl.d(0, 0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_q, this.field_o, 0, param3, param2, (kl) (this), this.field_p, param4);
            } else {
              return kl.a(0, 0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_A, 0, param3, param2, (kl) (this), this.field_p, param4);
            }
          } else {
            L2: {
              var6 = param1 + this.field_x;
            ...
            L3: {
              L4: {
                ...
                if (this.field_p != -256) {
                  ...
                  if ((this.field_r & 255) != 0) {
                    ...
                    if (!tj.field_g) {
                      param1 = kl.a(((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_A, this.field_u, 0, var6, param2, (kl) (this));
                      break L3;
                    } else {
                      param1 = kl.a(0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_q, this.field_o, this.field_v, this.field_z, 0, var6, param2, (kl) (this));
                      break L3;
                    }
                  }
                }
              ...
              if (!tj.field_g) {
                param1 = kl.b(0, 0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_A, this.field_u, 0, var6, param2, (kl) (this), this.field_p, param4);
                break L3;
              } else {
                param1 = kl.b(0, 0, ((oe) ((Object) this.field_k)).field_m, param0, this.field_r, param1, this.field_q, this.field_o, this.field_v, this.field_z, 0, var6, param2, (kl) (this), this.field_p, param4);
                break L3;
              }
            }
            this.field_x = this.field_x - param1;
    ...
    private final void m() {
        ...
        this.field_q = kl.b(this.field_w, this.field_n);
        this.field_o = kl.d(this.field_w, this.field_n);
    }
