...
final class ln extends nm {
    ...
    final static int a(nc param0, int param1, boolean param2, int param3) {
        ...
        try {
          ...
          throw qb.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + ',' + param1 + ',' + true + ',' + param3 + ')');
        }
        return stackIn_5_0;
    }
    ...
    final static void a(mf param0, wp param1, mf param2, mf param3, mf param4, int param5, mf param6) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_23_1 = ((StringBuilder) (Object) stackIn_23_1).append(stackIn_23_2).append(',').append(-10).append(',');
    ...
    final static boolean a(int param0, int param1, mf param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("ln.C(").append(param0).append(',').append(param1).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
