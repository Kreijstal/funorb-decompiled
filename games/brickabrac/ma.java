...
final class ma extends h {
    ...
    final void a(int param0, int param1, int param2, byte param3) {
        ...
        int discarded$0 = this.field_H.a(this.field_M, this.field_L + var5 - -var7, this.field_L + var6, this.field_N + -this.field_L, -(2 * this.field_L) + this.field_s, this.field_K, -1, !this.field_J ? 2 : 0, 1, this.field_H.field_F);
    }
    ...
    ma(int param0, int param1, int param2, int param3, oc param4, boolean param5, int param6, int param7, dh param8, int param9, String param10) {
        ...
        try {
          L0: {
            ...
            L3: {
              if (this.field_J) {
                ...
                stackOut_8_0 = 2 * this.field_L + this.field_N;
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("ma.<init>(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
