...
final class mo extends ag implements en {
    ...
    public final void a(int param0, int param1, byte param2, int param3, d param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_5_1 = new StringBuilder().append("mo.Q(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
    ...
    final void a(oc param0, byte param1, int param2, int param3) {
        try {
            ...
            throw qb.a((Throwable) (Object) runtimeException, "mo.WA(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
    }
