...
final class ae implements Iterator {
    ...
    public final Object next() {
        tk var1 = this.field_e;
        if (this.field_a.field_a == var1) {
            var1 = null;
            this.field_e = null;
        } else {
            this.field_e = var1.field_s;
        }
        this.field_h = var1;
        return var1;
    }
    ...
    final static jp[] a(int param0, int param1, int param2, mf param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("ae.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
