...
final class lq {
    ...
    final void a(tk param0, boolean param1) {
        try {
            ...
            if (param1) {
                Object var4 = null;
                tp discarded$0 = lq.a(-17, 78, 86, (mf) null);
            }
    ...
    final static void a(mf param0, mf param1, byte param2, mf param3, mf param4) {
        ...
        try {
          ...
          L0: {
            ...
            stackOut_2_1 = new StringBuilder().append("lq.G(");
          ...
          L2: {
            ...
            stackOut_8_1 = ((StringBuilder) (Object) stackIn_8_1).append(stackIn_8_2).append(',').append(-38).append(',');
    ...
    final static tp a(int param0, int param1, int param2, mf param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("lq.E(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
