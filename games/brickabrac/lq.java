...
final class lq {
    ...
    final void a(tk param0, boolean param1) {
        try {
            ...
            throw qb.a((Throwable) (Object) runtimeException, "lq.I(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final static void a(mf param0, mf param1, byte param2, mf param3, mf param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("lq.G(");
    ...
    final static tp a(int param0, int param1, int param2, mf param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("lq.E(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
