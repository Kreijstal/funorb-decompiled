...
final class nh {
    ...
    final static void a(int param0, int param1, int param2, int param3, jp[] param4, int param5) {
        ...
        try {
          ...
          L30: {
            ...
            stackOut_86_1 = new StringBuilder().append("nh.D(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
          ...
          throw qb.a((Throwable) (Object) stackIn_89_0, stackIn_89_2 + 44 + param5 + 41);
        }
    }
    ...
    final static void a(jp[] param0, int param1, int param2, int param3, int param4, dh param5, int param6, int param7, int param8, jp[] param9, int param10, jp[] param11, int param12, byte param13, int param14) {
        ...
        try {
          L0: {
            ...
            oa.a(param3, var15_int, param10, param2, var15_int, param12, param1, param7, param4, param0, param5, param11, param8, param6, var16, false, -119, param9, param5, var16);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          ...
          throw qb.a((Throwable) (Object) stackIn_16_0, stackIn_16_2 + 44 + param12 + 44 + param13 + 44 + -119 + 41);
        }
    }
    ...
    final static void a(boolean param0, boolean param1, boolean param2, int param3, boolean param4) {
        ...
        try {
          ...
          throw qb.a((Throwable) (Object) var5, "nh.E(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
                              ...
                              if (var1_ref == null) {
                                ...
                                if (var2 != 0) {
                                  ...
                                  if (var1_ref.field_ic > 0) {
                                    ...
                                    stackOut_28_0 = -1;
                                    stackOut_28_1 = ~var1_ref.field_ic;
