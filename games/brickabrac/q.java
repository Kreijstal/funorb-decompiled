...
final class q {
    ...
    final boolean a(int param0, int param1, int param2) {
        ...
        return bg.a(((q) this).field_c, ((q) this).field_d, ((q) this).field_j, (byte) 126, param1, param0, ((q) this).field_a);
    }

    final void a(int param0) {
        ((q) this).field_b = false;
        if (param0 > -63) {
            ((q) this).field_d = -50;
        }
    }
    ...
    final void a(byte param0, boolean param1) {
        ...
        int stackOut_36_3 = 0;
        String stackOut_36_4 = null;
        String stackOut_35_0 = null;
        String[] stackOut_35_1 = null;
        String[] stackOut_35_2 = null;
        int stackOut_35_3 = 0;
        String stackOut_35_4 = null;
        int stackOut_46_0 = 0;
        int stackOut_45_0 = 0;
        int stackOut_43_0 = 0;
        int stackOut_55_0 = 0;
        ...
        L0: {
          ...
          if (31 == ((q) this).field_f) {
            break L0;
          } else {
            if (40 == ((q) this).field_f) {
              break L0;
            } else {
              if (-42 == ((q) this).field_f) {
                break L0;
              } else {
                if (-44 != ((q) this).field_f) {
                  L1: {
                    if (!((q) this).field_b) {
                      if (!param1) {
                        var3 = vn.field_G;
                  ...
                  L2: {
                    nh.a(((q) this).field_j, ((q) this).field_d, -40, ((q) this).field_c, var3, ((q) this).field_a);
                    if (29 == ((q) this).field_f) {
                      break L2;
                    } else {
                      if (((q) this).field_f == 30) {
                        break L2;
                      } else {
                        L3: {
                          if (44 == ((q) this).field_f) {
                            ...
                            if (((q) this).field_f == 45) {
                              break L3;
                            } else {
                              L4: {
                                var4_ref = ag.field_D[((q) this).field_f];
                                if (((q) this).field_f != 8) {
                                  break L4;
                                } else {
                                  var4_ref = ((q) this).field_e.e((byte) 87);
                                  break L4;
                                }
                              }
                              L5: {
                                if (((q) this).field_f != 36) {
                                  break L5;
                                } else {
                                  L6: {
                                    stackOut_34_0 = gj.field_d;
                                    stackOut_34_1 = new String[1];
                                  ...
                                  var4_ref = rd.a(stackIn_37_0, stackIn_37_1, (byte) 103);
                                  break L5;
                                }
                              }
                              L7: {
                                L8: {
                                  var5 = nn.field_g.c(var4_ref);
                                  if (20 == ((q) this).field_f) {
                                    break L8;
                                  } else {
                                    if (((q) this).field_f == 21) {
                                      break L8;
                                    } else {
                                      break L7;
                                    }
                              ...
                              L9: {
                                var6 = -var5 + (((q) this).field_j + 2 * ((q) this).field_c) >> 1;
                                if (!((q) this).field_h) {
                                  if (!param1) {
                                    stackOut_46_0 = 0;
                              ...
                              L11: {
                                ...
                                L14: {
                                  var8 = stackIn_56_0;
                                  if (!param1) {
                                    stackOut_58_0 = g.field_l[0];
                                    stackIn_59_0 = stackOut_58_0;
                                    break L14;
                                  } else {
                                    stackOut_57_0 = g.field_l[1];
                                    stackIn_59_0 = stackOut_57_0;
                                    break L14;
                                  }
                                }
                                var9 = stackIn_59_0;
                                var9.c(var8 + (var6 + (-1 - var9.field_x / 2)), (-var9.field_z + ((q) this).field_d) / 2 + ((q) this).field_a);
                                break L11;
                              }
                              L15: {
                                if (param0 == 4) {
                        ...
                        L16: {
                          stackOut_24_0 = pa.field_l;
                          stackIn_26_0 = stackOut_24_0;
                          stackIn_25_0 = stackOut_24_0;
                          if (!param1) {
                            stackOut_26_0 = (jp[]) (Object) stackIn_26_0;
                            stackOut_26_1 = 0;
                            stackIn_27_0 = stackOut_26_0;
                            stackIn_27_1 = stackOut_26_1;
                            break L16;
                          } else {
                            stackOut_25_0 = (jp[]) (Object) stackIn_25_0;
                            stackOut_25_1 = 1;
                        ...
                        L17: {
                          ...
                          var4 = var12;
                          if (44 == ((q) this).field_f) {
                            var4.c((((q) this).field_j - var12.field_x) / 2 + ((q) this).field_c, ((q) this).field_a + (-var12.field_z + ((q) this).field_d) / 2);
                            break L17;
                          } else {
                            var4.f((-var12.field_x + ((q) this).field_j) / 2 + ((q) this).field_c, ((q) this).field_a + (-var12.field_z + ((q) this).field_d) / 2);
                            break L17;
                          }
                        }
                        return;
                  ...
                  L18: {
                    stackOut_14_0 = mp.field_Vb;
                    stackIn_16_0 = stackOut_14_0;
                    stackIn_15_0 = stackOut_14_0;
                    if (!param1) {
                      stackOut_16_0 = (jp[]) (Object) stackIn_16_0;
                      stackOut_16_1 = 0;
                  ...
                  L19: {
                    ...
                    var4 = var11;
                    if (((q) this).field_f == 29) {
                      var4.c(((q) this).field_c + (((q) this).field_j + -var11.field_x) / 2, ((q) this).field_a - -((-var11.field_z + ((q) this).field_d) / 2));
                      break L19;
                    } else {
                      var4.g((-var11.field_x + ((q) this).field_j) / 2 + ((q) this).field_c, ((q) this).field_a - -((-var11.field_z + ((q) this).field_d) / 2));
                      break L19;
                    }
                  }
                  return;
    ...
    final static boolean a(String param0, int param1, String param2) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param1 == 0) {
                ...
                var4 = null;
                boolean discarded$2 = q.a((String) null, 78, (String) null);
                break L1;
              }
            }
            L2: {
          ...
          L5: {
            ...
            stackOut_15_1 = new StringBuilder().append("q.E(");
            stackIn_17_0 = stackOut_15_0;
            stackIn_17_1 = stackOut_15_1;
    ...
    q(int param0, km param1) {
        try {
            ((q) this).field_f = param0;
            ((q) this).field_e = param1;
        } catch (RuntimeException runtimeException) {
            throw qb.a((Throwable) (Object) runtimeException, "q.<init>(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
              ...
              L2: {
                L3: {
                  ...
                  if (!var2.a(false)) {
                    ...
                    if (!((q) this).a(pq.field_k, po.field_a, -56)) {
                      break L3;
                    } else {
                      stackOut_10_0 = this;
                      stackOut_10_1 = 1;
    ...
    final static String a(byte[] param0, byte param1) {
        ...
        try {
          L0: {
            if (param1 > 69) {
              stackOut_3_0 = df.a(param0.length, 117, param0, 0);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("q.B(");
