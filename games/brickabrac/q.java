                ...
                if (-44 != (this.field_f ^ -1)) {
                    ...
                    if (29 == this.field_f) {
                      ...
                      if (this.field_f == 30) {
                        ...
                        L3: {
                          if (44 == this.field_f) {
                            ...
                            if ((this.field_f ^ -1) == -46) {
                              ...
                              L4: {
                                var4_ref = ag.field_D[this.field_f];
                                if (this.field_f != 8) {
                                  break L4;
                                } else {
                                  var4_ref = this.field_e.e((byte) 87);
                                  break L4;
                                }
                              }
                              L5: {
                              ...
                              L10: {
                                ...
                                if (this.field_f == 42) {
                                  ...
                                  discarded$2 = nn.field_g.a(var8_ref_String, 8 + this.field_c, this.field_a - 5, var9_int, this.field_d, var7, -1, 1, 1, 3 + nn.field_g.field_B);
                                  break L10;
                                } else {
                                  nn.field_g.c(var4_ref.toLowerCase(), var6, 2 + (this.field_a + (-nn.field_g.field_P + nn.field_g.field_B + this.field_d) / 2), var7, -1);
                                  break L10;
                                }
                              }
                              L11: {
                        ...
                        L17: {
                          ...
                          var4 = var12;
                          if (44 == this.field_f) {
                            var4.c((this.field_j - var12.field_x) / 2 + this.field_c, this.field_a + (-var12.field_z + this.field_d) / 2);
                            break L17;
                          } else {
                            var4.f((-var12.field_x + this.field_j) / 2 + this.field_c, this.field_a + (-var12.field_z + this.field_d) / 2);
                            break L17;
                          }
                        }
                        return;
                  ...
                  L19: {
                    ...
                    if (-30 == (this.field_f ^ -1)) {
                      var4.c(this.field_c + (this.field_j + -var11.field_x) / 2, this.field_a - -((-var11.field_z + this.field_d) / 2));
                      break L19;
                    } else {
                      var4.g((-var11.field_x + this.field_j) / 2 + this.field_c, this.field_a - -((-var11.field_z + this.field_d) / 2));
                      break L19;
                    }
                  }
                  return;
          ...
          L0: {
            L1: {
              ...
              if (param1 == 0) {
                ...
                var4 = (String) null;
                discarded$2 = q.a((String) null, 78, (String) null);
                break L1;
              }
            }
            L2: {
