...
final class oj extends ep {
    ...
    final void a(String param0, int param1, dh param2, int param3, int param4) {
        ...
        if (param2 == ((oj) this).field_u) {
            if (((oj) this).field_x) {
                if (((oj) this).field_l == 1) {
                    if (((oj) this).field_w != null) {
                        if (((oj) this).field_w.equals((Object) (Object) param0)) {
                            return;
                        }
                    }
                }
        ...
        try {
            ...
            ((oj) this).field_u = param2;
            ((oj) this).field_l = param4;
            var8 = this.a(param0, param2, (byte) -72, param1);
            var7 = param2.c(param0);
            var8.field_g[0] = param3 + -(var7 >> 1);
            var8.field_g[param0.length()] = param3 + (var7 >> 1);
            dn.a(25293, param0, var8, 0, param2);
        } catch (RuntimeException runtimeException) {
            throw qb.a((Throwable) (Object) runtimeException, "oj.J(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    final static void a(boolean param0, byte param1) {
        ...
        int stackOut_64_1 = 0;
        int stackOut_64_2 = 0;
        vi.a((byte) 74, 640 + lb.field_c >> 1, -640 + lb.field_c >> 1, 0, lb.field_d);
        if (ml.field_b > 0) {
          L0: {
            if (null == c.field_e) {
              break L0;
    ...
    final void a(dh param0, int param1, int param2, String param3, int param4) {
        ...
        if (((oj) this).field_u == param0) {
            if (((oj) this).field_x) {
                if (((oj) this).field_l == 0) {
                    if (((oj) this).field_w != null) {
                        if (!(!((oj) this).field_w.equals((Object) (Object) param3))) {
                            return;
                        }
                    }
                }
        ...
        try {
            ...
            throw qb.a((Throwable) (Object) runtimeException, "oj.N(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + (param3 != null ? "{...}" : "null") + 44 + param4 + 41);
        }
    }
    ...
    final static void a(int param0, vo param1, int param2, int param3, byte param4, j param5, int param6) {
        ...
        try {
          L0: {
            ...
            if (param4 >= 54) {
              L4: {
                var10 = param1.field_m >> 8;
                var11 = param1.field_j >> 8;
                if (param0 != 2) {
                  break L4;
                } else {
          ...
          L12: {
            ...
            stackOut_38_1 = new StringBuilder().append("oj.P(").append(param0).append(44);
            stackIn_40_0 = stackOut_38_0;
            stackIn_40_1 = stackOut_38_1;
          ...
          L13: {
            ...
            stackOut_41_1 = ((StringBuilder) (Object) stackIn_41_1).append(stackIn_41_2).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
            stackIn_43_0 = stackOut_41_0;
            stackIn_43_1 = stackOut_41_1;
            stackIn_42_0 = stackOut_41_0;
            stackIn_42_1 = stackOut_41_1;
          ...
          throw qb.a((Throwable) (Object) stackIn_44_0, stackIn_44_2 + 44 + param6 + 41);
        }
    }
        ...
        try {
          L0: {
            if (param0 == null) {
              ...
              L1: {
                if (param1 != ((oj) this).field_u) {
                  break L1;
                } else {
                  if (!((oj) this).field_x) {
                    break L1;
                  } else {
                    if (2 != ((oj) this).field_l) {
                      break L1;
                    } else {
              ...
              L2: {
                if (param3 <= -90) {
                  ...
                  var7 = null;
                  ((oj) this).a((String) null, -87, (dh) null, 2, -3);
                  break L2;
                }
              }
              ((oj) this).field_u = param1;
              ((oj) this).field_w = param0;
              ((oj) this).field_x = true;
              ((oj) this).field_l = 2;
          ...
          throw qb.a((Throwable) (Object) stackIn_21_0, stackIn_21_2 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    final void a(String param0, int param1, int param2, int param3, int param4, int param5, int param6, dh param7) {
        ...
        try {
          L0: {
            ...
            if (param0 != null) {
              L2: {
                if (param7 != ((oj) this).field_u) {
                  break L2;
                } else {
                  if (((oj) this).field_x) {
                    break L2;
                  } else {
                    if (param1 != ((oj) this).field_l) {
                      break L2;
                    } else {
                      if (param6 != ((oj) this).field_v) {
                        break L2;
                      } else {
                        if (((oj) this).field_p != param4) {
                          break L2;
                        } else {
                          if (((oj) this).field_y != param3) {
                            break L2;
                          } else {
                            if (param5 != ((oj) this).field_n) {
                              break L2;
                            } else {
                              if (((oj) this).field_w == null) {
                                break L2;
              ...
              L3: {
                ...
                ((oj) this).field_l = param1;
                ((oj) this).field_x = false;
                ((oj) this).field_w = param0;
                ((oj) this).field_y = param3;
                ((oj) this).field_v = param6;
                ((oj) this).field_p = param4;
                ((oj) this).field_n = param5;
                ((oj) this).field_u = param7;
                var10 = new String[1 + param7.a(param0, param5)];
                var11 = Math.max(1, param7.a(param0, new int[1], var10));
                if (((oj) this).field_v != 3) {
                  break L3;
                } else {
                  if (var11 == 1) {
                    ((oj) this).field_v = 1;
              ...
              L4: {
                ((oj) this).field_c = new ml[var11];
                if (-1 == ((oj) this).field_v) {
                  var12 = param7.field_F;
                  break L4;
                } else {
                  if (-2 == ((oj) this).field_v) {
                    var12 = (-(var11 * ((oj) this).field_p) + ((oj) this).field_y >> 1) + param7.field_F;
                    break L4;
                  } else {
                    if (2 != ((oj) this).field_v) {
                      L5: {
                        var13 = (((oj) this).field_y - ((oj) this).field_p * var11) / (var11 - -1);
                        if (var13 >= 0) {
                          break L5;
                        } else {
                          var13 = 0;
                      ...
                      ((oj) this).field_p = ((oj) this).field_p + var13;
                      break L4;
                    } else {
                      var12 = ((oj) this).field_y - param7.field_P - var11 * ((oj) this).field_p;
                      break L4;
                    }
                  }
                }
                    ...
                    if (var14 != null) {
                      L9: {
                        ...
                        if (param1 != 3) {
                          ...
                          stackOut_38_3 = ((oj) this).a(param5, param7.c(var14), var14, true);
                          stackIn_40_0 = stackOut_38_0;
                          stackIn_40_1 = stackOut_38_1;
                          stackIn_40_2 = stackOut_38_2;
          ...
          L11: {
            ...
            stackOut_46_1 = ((StringBuilder) (Object) stackIn_46_1).append(stackIn_46_2).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44).append(param5).append(44).append(param6).append(44);
            stackIn_48_0 = stackOut_46_0;
            stackIn_48_1 = stackOut_46_1;
            stackIn_47_0 = stackOut_46_0;
            stackIn_47_1 = stackOut_46_1;
          ...
          throw qb.a((Throwable) (Object) stackIn_49_0, stackIn_49_2 + 41);
        }
    }
