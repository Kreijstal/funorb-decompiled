...
abstract class vi extends nm {
    ...
    final static void a(int param0, int[] param1, int param2, fo param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_10_1 = new StringBuilder().append("vi.G(").append(param0).append(',');
        ...
        try {
          L0: {
            L1: {
              ...
              if (0 != (128 & var3_int)) {
                var4 = param1.l(255);
                var5 = (var3_int & 7) << -1426136509;
                var5 = var5 | (224 & var4) >> -1162655419;
                var6 = 31 & var4;
                this.field_j = var6 * 34 << 1418235528;
                this.field_m = var5 * 16 << -450919800;
                break L1;
              } else {
                var4 = var3_int & 12;
                var5 = var3_int & 3;
                this.field_j = var4 << -1263652434 | param1.i(65280);
                this.field_m = var5 << 1215528720 | param1.i(65280);
                break L1;
              }
            }
            L2: {
              if (-1 == (64 & var3_int ^ -1)) {
                ...
                this.field_k = param1.a(127);
                this.field_o = param1.a(127);
                break L2;
              }
            }
            L3: {
          ...
          L5: {
            ...
            stackIn_18_1 = new StringBuilder().append("vi.L(").append(param0).append(',');
    ...
    final static int c(byte param0) {
        ...
        try {
          L0: {
            mf.field_f.a(v.field_e, tk.field_r, -114, true);
            mf.field_f.i(79);
            L1: while (true) {
              if (!jl.a((byte) 5)) {
                ...
                mf.field_f.a(go.field_b, dc.field_b, true);
                continue L1;
              }
            }
          }
    ...
    final static void a(int param0, int param1, int param2, byte param3, int param4, int param5, int param6, int param7, int param8, int[] param9, int param10, int param11, int param12, int param13, int param14, int param15, int param16) {
        ...
        try {
                ...
                if (param2 < mg.field_b) {
                      ...
                      L9: {
                        ...
                        L11: while (true) {
                          if (param2 >= param14) {
                            ...
                            L12: {
                              var37 = var17_int >> 1401003120;
                              if (mg.field_e > var37) {
                                var38 = -(var17_int >> 457728304) + (var18 >> -368317744);
                                if (0 == var38) {
                                  if (var37 < 0) {
                                    break L12;
                                  } else {
                  ...
                  L16: while (true) {
                    if (param15 <= param2) {
                      ...
                      L17: {
                        var36 = var17_int >> 1019217744;
                        if (mg.field_e > var36) {
                          var37 = (var18 >> 2099679728) - (var17_int >> -649612432);
                          if (var37 == 0) {
                            if ((var36 ^ -1) > -1) {
                              break L17;
                            } else {
          ...
          L19: {
            ...
            stackIn_78_1 = new StringBuilder().append("vi.K(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',').append(param8).append(',');
          ...
          throw qb.a((Throwable) ((Object) stackIn_79_0), stackIn_79_2 + ',' + param10 + ',' + param11 + ',' + param12 + ',' + param13 + ',' + param14 + ',' + param15 + ',' + param16 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return;
        } else {
    ...
    int a(int param0, StringBuilder param1) {
        ...
        try {
          L0: {
            ...
            stackIn_3_0 = (11 * this.field_l - -666 << -1533397033 | 3 * (this.field_i - -5) << 1758093959) ^ (this.field_m * 17 - -10855845 << 2001979587 ^ this.field_j * 31 - -15790320) + (58339 + 11 * this.field_k | 29 * this.field_o << -725590579);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("vi.A(").append(param0).append(',');
