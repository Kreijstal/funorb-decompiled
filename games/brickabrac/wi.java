    ...
    private final java.net.Socket a(int param0, int param1, String param2, String param3) throws IOException {
        ...
        try {
          ...
          L9: {
            ...
            stackOut_26_1 = new StringBuilder().append("wi.F(").append(param0).append(',').append(param1).append(',');
          ...
          L0: {
            if (param1.type() != java.net.Proxy.Type.DIRECT) {
              ...
              if (param0 == 8) {
                ...
                stackOut_4_0 = (java.net.Socket) null;
                stackIn_5_0 = stackOut_4_0;
                decompiledRegionSelector0 = 1;
                break L0;
              }
            } else {
              stackOut_1_0 = this.a((byte) -76);
