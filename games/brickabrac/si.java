...
final class si {
    ...
    final static mb a(byte param0, String param1, String param2, mf param3, mf param4) {
        int var5_int = 0;
        ...
        try {
          L0: {
            var5_int = param3.a(param1, false);
            var6 = param3.a(var5_int, -40, param2);
            if (param0 < -5) {
              stackOut_3_0 = tb.a(117, var5_int, param3, param4, var6);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("si.B(").append(param0).append(44);
    ...
    final nm a(int param0, long param1) {
        nm var4 = null;
        nm var5 = null;
        int var6 = 0;
        var6 = BrickABrac.field_J ? 1 : 0;
        var4 = ((si) this).field_j[(int)(param1 & (long)(((si) this).field_g - 1))];
        ((si) this).field_h = var4.field_e;
        if (param0 >= -23) {
          ((si) this).a(60, (nm) null, -45L);
          L0: while (true) {
            if (((si) this).field_h == var4) {
              ((si) this).field_h = null;
              return null;
            } else {
              if (~param1 == ~((si) this).field_h.field_g) {
                var5 = ((si) this).field_h;
                ((si) this).field_h = ((si) this).field_h.field_e;
                return var5;
              } else {
                ((si) this).field_h = ((si) this).field_h.field_e;
                continue L0;
    ...
    final nm a(boolean param0) {
        ...
        if (param0) {
          if (((si) this).field_f > 0) {
            if (((si) this).field_e != ((si) this).field_j[((si) this).field_f + -1]) {
              var12 = ((si) this).field_e;
              ((si) this).field_e = var12.field_e;
              return var12;
            } else {
              L0: while (true) {
                if (((si) this).field_g > ((si) this).field_f) {
                  int fieldTemp$2 = ((si) this).field_f;
                  ((si) this).field_f = ((si) this).field_f + 1;
                  var4 = ((si) this).field_j[fieldTemp$2].field_e;
                  var9 = var4;
                  if (var4 != ((si) this).field_j[((si) this).field_f - 1]) {
                    ((si) this).field_e = var9.field_e;
                    return var9;
                  } else {
                    continue L0;
                  }
            ...
            L1: while (true) {
              if (((si) this).field_g > ((si) this).field_f) {
                int fieldTemp$3 = ((si) this).field_f;
                ((si) this).field_f = ((si) this).field_f + 1;
                var4 = ((si) this).field_j[fieldTemp$3].field_e;
                var5 = var4;
                if (var4 != ((si) this).field_j[((si) this).field_f - 1]) {
                  ((si) this).field_e = var5.field_e;
                  return var5;
                } else {
                  continue L1;
                }
    ...
    final static void a(int param0, boolean param1) {
        ...
        var2.a(gp.field_d.field_Eb, gp.field_d.field_db, 0);
    }
    ...
    final static void a(int param0, byte param1, int param2, int param3) {
        ...
        L0: {
          ...
          var4 = -5 + (640 + -um.field_p.field_x);
          var5 = -20 + (480 + -um.field_p.field_z - -15);
          um.field_p.c(var4, var5);
          if (param1 < -115) {
            break L0;
          } else {
            si.a(75, (byte) 65, 92, -101);
            break L0;
          }
        }
        var6 = var4 + (um.field_p.field_x - pa.field_j.field_x) / 2;
        var7 = 64 + var5;
        if ((param2 | param0) > 0) {
          L1: {
            var8 = -param2 + pa.field_j.field_z / 2 + var7;
            if (var8 <= 0) {
              if (0 <= var8) {
                break L1;
              } else {
                var7 = var7 - 12 * var8 / (param2 + var8);
                break L1;
              }
            } else {
              var7 = var7 - 6 * var8 / (var8 - -param2);
              break L1;
            }
          }
          L2: {
            var9 = -param0 + pa.field_j.field_x / 2 + var6;
            if (0 < var9) {
              var6 = var6 - 6 * var9 / (var9 + param0);
              break L2;
            } else {
              if (var9 < 0) {
                var6 = var6 - var9 * 36 / (var9 + param0);
                break L2;
              } else {
                pa.field_j.c(var6, var7);
                var8 = -20 + ((-gr.field_d[param3].field_x + um.field_p.field_x) / 2 + var4);
                var9 = 480 + -gr.field_d[param3].field_z + 60;
                gr.field_d[param3].c(var8, var9);
                return;
              }
            }
          }
    ...
    final void a(int param0, nm param1, long param2) {
        nm var5 = null;
        try {
            ...
            if (param0 != 34) {
                Object var6 = null;
                mb discarded$0 = si.a((byte) -123, (String) null, (String) null, (mf) null, (mf) null);
            }
            var5 = ((si) this).field_j[(int)((long)(((si) this).field_g - 1) & param2)];
            param1.field_e = var5;
            param1.field_b = var5.field_b;
            param1.field_b.field_e = param1;
            param1.field_e.field_b = param1;
            param1.field_g = param2;
        } catch (RuntimeException runtimeException) {
            throw qb.a((Throwable) (Object) runtimeException, "si.H(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 41);
        }
    }
    ...
    si(int param0) {
        ...
        ((si) this).field_j = new nm[param0];
        var2 = 0;
        L0: while (true) {
          if (var2 < param0) {
            nm dupTemp$2 = new nm();
            var3 = dupTemp$2;
            ((si) this).field_j[var2] = dupTemp$2;
            var3.field_b = var3;
            var3.field_e = var3;
            var2++;
            continue L0;
