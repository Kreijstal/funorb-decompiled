...
final class fg {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_f[var16];
                  var10 = field_c[var16] * this.field_k;
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_a[var7]) {
                              ...
                              var5++;
                              this.field_e[incrementValue$2] = bk.c(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_a[this.field_i[var6]];
                      var6++;
                      continue L2;
                    }
                  }
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_e, 0, field_f, 0, var2);
        int var3 = field_l[this.field_k - 1];
        ...
        for (var6 = 0; var6 < this.field_i.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = bk.field_M[this.field_d[var7]].a();
            }
