...
final class fg {
    ...
    final void a(float[] param0, int param1) {
        ...
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_c[0] * ((fg) this).field_k;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_g[var16]) {
                  var9 = field_f[var16];
                  var10 = field_c[var16] * ((fg) this).field_k;
            ...
            L3: {
              var7 = fg.b(field_f, var6);
              var8_int = fg.a(field_f, var6);
              var9 = this.a(field_f[var7], field_c[var7], field_f[var8_int], field_c[var8_int], field_f[var6]);
              var10 = field_c[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    fg() {
        ...
        if (var1 == 1) {
          var2 = bk.c(5);
          var3 = 0;
          ((fg) this).field_i = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((fg) this).field_a = new int[var3];
              ((fg) this).field_h = new int[var3];
              ((fg) this).field_d = new int[var3];
              ((fg) this).field_b = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((fg) this).field_k = bk.c(2) + 1;
                  var4 = bk.c(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((fg) this).field_e = new int[var5];
                      ((fg) this).field_e[0] = 0;
                      ((fg) this).field_e[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((fg) this).field_a[((fg) this).field_i[var6]];
                      var6++;
                      continue L2;
                    }
                  }
    ...
    final boolean b() {
        ...
        int var2 = ((fg) this).field_e.length;
        System.arraycopy((Object) (Object) ((fg) this).field_e, 0, (Object) (Object) field_f, 0, var2);
        int var3 = field_l[((fg) this).field_k - 1];
        int var4 = ed.b(9, var3 - 1);
        field_c[0] = bk.c(var4);
        field_c[1] = bk.c(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((fg) this).field_i.length; var6++) {
            var7 = ((fg) this).field_i[var6];
            var8 = ((fg) this).field_a[var7];
            var9 = ((fg) this).field_h[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = bk.field_M[((fg) this).field_d[var7]].a();
            }
