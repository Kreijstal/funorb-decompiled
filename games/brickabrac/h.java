...
abstract class h extends oc implements sd {
    ...
    public static void f(byte param0) {
        ...
        if (param0 > -82) {
            ...
            discarded$0 = h.a((String) null, false);
        }
        field_D = null;
    }
    ...
    private final boolean b(boolean param0, oc param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("h.KB(").append(param0).append(',');
    ...
    final static void a(int param0, int param1, byte param2, byte[] param3, int[] param4) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("h.FB(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
            stackIn_10_0 = stackOut_9_0;
            stackIn_10_1 = stackOut_9_1;
            ...
            L1: while (true) {
              if (param3 < var5_int) {
                if (param1) {
                  L2: {
                    if (this.field_E == null) {
                      discarded$10 = param0.append("null");
                      break L2;
                    } else {
                      discarded$11 = this.field_E.a(1 + param3, param2, 24, param0);
                      break L2;
                    }
                  }
                  decompiledRegionSelector0 = 1;
    ...
    private final boolean a(oc param0, byte param1) {
        ...
        try {
          ...
          L4: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) (var3);
            stackOut_8_1 = new StringBuilder().append("h.GB(");
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
