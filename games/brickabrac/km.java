...
abstract class km extends gf {
    ...
    final void a(int[] param0, int param1) {
        ...
        for (var3 = param1; param0.length > var3; var3++) {
            ((km) this).field_m[var3] = new q(param0[var3], (km) this);
            ((km) this).field_m[var3].a(-97);
        }
        ((km) this).b(true);
    }
    ...
    final void e(int param0) {
        ...
        L0: while (true) {
          if (((km) this).field_m.length <= var3) {
            ...
            var7 = (String) (Object) stackIn_5_0;
            var5 = var7;
            var4_ref_q.field_j = nn.field_g.c(var7) + 30;
            var2 = var2 + (nn.field_g.c(var7) + 30);
            if (-1 > (var3 ^ -1)) {
              var2 += 10;
              var3++;
              continue L0;
    ...
    void a(boolean param0, boolean param1, int param2) {
        ...
        int var4 = ((km) this).field_h.field_j;
        ...
        if (param4) {
          ...
          L0: while (true) {
            if (var11 <= -30) {
              ...
              if (-1 != (1 << var11 & param1.field_S)) {
                oc.a(var8, var11, var7, param1, param0, (byte) 115);
                var7 += 25;
                var9++;
                if (var9 == param5) {
                  var10++;
