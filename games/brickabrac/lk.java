...
final class lk extends qd {
                  ...
                  if (!((lk) this).field_r.a(var6, -128)) {
                    ...
                    L3: while (true) {
                      if (var6.field_z >= var5) {
                        ...
                        if (!((lk) this).field_r.a(23300, param0, var5, var6, var4_int)) {
                          continue L3;
                        } else {
                          break L2;
                        }
    ...
    private final void a(int param0, int param1, int[] param2, int param3, int param4, ka param5) {
        ...
        try {
          L0: {
            L1: {
              if ((4 & ((lk) this).field_r.field_n[param5.field_u]) == 0) {
                ...
                if (0 > param5.field_x) {
                  var7_int = ((lk) this).field_r.field_U[param5.field_u] / tj.field_q;
                  L2: while (true) {
          ...
          L7: {
            ...
            stackOut_26_1 = new StringBuilder().append("lk.G(").append(param0).append(44).append(param1).append(44);
          ...
          L8: {
            ...
            stackOut_29_1 = ((StringBuilder) (Object) stackIn_29_1).append(stackIn_29_2).append(44).append(param3).append(44).append(-1048576).append(44);
    ...
    private final void a(byte param0, int param1, ka param2) {
        ...
        try {
            ...
            L2: {
              if ((((lk) this).field_r.field_n[param2.field_u] & 4) == -1) {
                ...
                if (-1 <= param2.field_x) {
                  ...
                  var4_int = ((lk) this).field_r.field_U[param2.field_u] / tj.field_q;
          ...
          L6: {
            ...
            stackOut_17_1 = new StringBuilder().append("lk.C(").append(param0).append(44).append(param1).append(44);
    ...
    final static int[] a(int param0, int param1, int param2) {
        ...
        int[] var3 = var14;
        int var4 = (16745759 & param1) >> 16;
        int var5 = (param1 & 65300) >> 8;
        int var6 = 255 & param1;
        int var7 = (param2 & 16728276) >> 16;
        int var8 = (65533 & param2) >> 8;
        int var9 = 255 & param2;
        int var11 = 60 / ((param0 - -44) / 54);
        for (var10 = 0; 256 > var10; var10++) {
            var12 = 256 + -var10;
            var14[var10] = (var6 * var10 >> 8) + (var9 * var12 >> 8) + (((var5 * var10 >> 8) - -(var8 * var12 >> 8) << 8) + ((var7 * var12 >> 8) + (var10 * var4 >> 8) << 16));
        }
        return var3;
    }
    ...
    lk(ie param0) {
        ...
        try {
            ...
            throw qb.a((Throwable) (Object) runtimeException, "lk.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
