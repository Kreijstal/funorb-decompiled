...
abstract class dh extends tk {
          ...
          if (param0.length != 257) {
            ...
            L1: while (true) {
              if (var3_int >= 256) {
                ...
                var2++;
                ((dh) this).field_T[var3_int] = param0[var2] & 255;
                var3_int++;
                continue L1;
              }
            }
    ...
    private final void a(String param0, int param1, int param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 29: {
                    try {
                        param1 = param1 + var11_ref_fc.field_f;
                        var5 = 0;
                        statePc = 30;
                        continue stateLoop;
    ...
    final int a(String param0, int[] param1, String[] param2) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 2: {
                    StringBuilder discarded$10 = uk.a(' ', field_y, 0, false);
                    var4 = 0;
                    var5 = 0;
                    var6 = -1;
                    var7 = 0;
    ...
    final void a(fc[] param0, int[] param1) {
        if (param1 != null) {
    ...
    dh(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4) {
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        ((dh) this).field_N = 0;
