    ...
    fj(long param0, mh param1, mh param2, mh param3, mh param4) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_3_1 = new StringBuilder().append("fj.<init>(").append(param0).append(',');
        ...
        if (-1 > (param1 ^ -1)) {
          ...
          if (param0 > -75) {
            ...
            L4: {
              ...
              stackOut_22_0 = this.field_Yb;
              stackOut_22_1 = this.field_Wb;
              stackOut_22_2 = this.field_Xb;
          ...
          if (param0 > -75) {
            ...
            L6: {
              ...
              var19 = this.field_Vb;
              var19.field_zb = var11;
              stackOut_8_0 = this.field_Yb;
              stackOut_8_1 = this.field_Wb;
              stackOut_8_2 = this.field_Xb;
