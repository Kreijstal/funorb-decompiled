...
final class kb extends mh {
    ...
    final static boolean a(long param0, int param1, String param2, int[] param3, int param4) {
        ...
        try {
          L0: {
            L1: {
              if (param1 == -3) {
                ...
                var7 = (j) null;
                discarded$2 = kb.a((ak) null, 109, -70, (j) null);
                break L1;
              }
            }
            L2: {
          ...
          L5: {
            ...
            stackOut_9_1 = new StringBuilder().append("kb.F(").append(param0).append(',').append(param1).append(',');
          ...
          throw qb.a((Throwable) ((Object) stackIn_15_0), stackIn_15_2 + ',' + param4 + ')');
        }
    ...
    final static lo a(int param0, String param1) {
        ...
        RuntimeException decompiledCaughtException = null;
        lo stackOut_19_0 = null;
        lo stackOut_16_0 = null;
        lo stackOut_7_0 = null;
        ...
        try {
          ...
          L5: {
            ...
            stackOut_23_1 = new StringBuilder().append("kb.B(").append(param0).append(',');
    ...
    kb(mh param0, mh param1, mh param2, mh param3, mh param4, mh param5) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("kb.<init>(");
            stackIn_10_0 = stackOut_8_0;
    ...
    final static int a(ak param0, int param1, int param2, j param3) {
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              if (param2 > 63) {
                ...
                var5 = (int[]) null;
                discarded$2 = kb.a(-35L, 83, (String) null, (int[]) null, -41);
                break L2;
              }
            }
            L3: {
          ...
          L6: {
            ...
            stackOut_21_1 = new StringBuilder().append("kb.H(");
            stackIn_23_0 = stackOut_21_0;
            stackIn_23_1 = stackOut_21_1;
