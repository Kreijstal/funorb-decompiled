...
final class mb extends dh {
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  mb.a(lb.field_l, ((mb) this).field_M[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  hl.a(lb.field_l, ((mb) this).field_M[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  mb.a(lb.field_l, ((mb) this).field_M[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  hl.a(lb.field_l, ((mb) this).field_M[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
    ...
    mb(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((mb) this).field_M = new byte[256][];
        ((mb) this).field_M = mb.a(param5, param6);
    }
