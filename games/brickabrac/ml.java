    ...
    final static jp a(mf param0, int param1, int param2, int param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackIn_10_1 = new StringBuilder().append("ml.C(");
            ...
            if (-1 == (this.field_g.length ^ -1)) {
              ...
              L2: while (true) {
                if (this.field_g.length <= var3) {
                  return this.field_g.length - 1;
                } else {
                  if ((this.field_g[-1 + var3] + this.field_g[var3] >> 821112545 ^ -1) >= (param1 ^ -1)) {
                    var3++;
                    continue L2;
                  } else {
                    return -1 + var3;
    ...
    final static void a(int param0, tp param1, byte param2, int param3, int param4, int param5) {
        ...
        try {
                          ...
                          L9: {
                            ...
                            if (var15 >= 0) {
                              L10: {
                                ...
                                var9++;
                                var17 = param1.field_j[255 & param1.field_i[incrementValue$0]];
                                if (-1 != (var17 ^ -1)) {
                                  if ((var15 ^ -1) < -256) {
          ...
          L11: {
            ...
            stackIn_35_1 = new StringBuilder().append("ml.F(").append(param0).append(',');
