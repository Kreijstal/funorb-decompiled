    ...
    final static void a(String[] args, jp[][] param1, int param2, String[][] param3, byte[] param4, mf param5, jp[][] param6, mf param7, boolean param8, int param9, int[] param10, String[][] param11, mf param12, byte[] param13, int param14) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("oa.C(");
          ...
          L9: {
            ...
            stackOut_25_1 = ((StringBuilder) (Object) stackIn_25_1).append(stackIn_25_2).append(',').append(param8).append(',').append(param9).append(',');
          ...
          throw qb.a((Throwable) ((Object) stackIn_37_0), stackIn_37_2 + ',' + param14 + ')');
        }
    }
            ...
            L1: while (true) {
              if (this.field_Qb.length <= var8) {
                ...
                if (this.field_Vb != var8) {
                  this.field_Qb[var8].field_P = this.field_Qb[var8].field_P + 10000;
                  var8++;
                  continue L1;
                } else {
                  var8++;
          ...
          if (var2 >= this.field_Rb.length) {
            ...
            if (var2 != this.field_Vb) {
              if (this.field_Rb[var2].field_L != 0) {
                ...
                this.field_Qb[this.field_Vb].field_P = this.field_Qb[this.field_Vb].field_P + 10000;
                this.field_Vb = var2;
                this.field_Rb[var2].field_Nb = true;
                this.field_Qb[var2].field_P = this.field_Qb[var2].field_P - 10000;
                var2++;
                continue L0;
              } else {
                var2++;
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, jp[] param9, dh param10, jp[] param11, int param12, int param13, int param14, boolean param15, int param16, jp[] param17, dh param18, int param19) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("oa.D(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',').append(param8).append(',');
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
          ...
          L5: {
            stackOut_13_0 = (RuntimeException) ((Object) stackIn_13_0);
            stackOut_13_1 = ((StringBuilder) (Object) stackIn_13_1).append(stackIn_13_2).append(',').append(param12).append(',').append(param13).append(',').append(param14).append(',').append(param15).append(',').append(param16).append(',');
            stackIn_15_0 = stackOut_13_0;
            stackIn_15_1 = stackOut_13_1;
            stackIn_14_0 = stackOut_13_0;
            stackIn_14_1 = stackOut_13_1;
          ...
          throw qb.a((Throwable) ((Object) stackIn_19_0), stackIn_19_2 + ',' + param19 + ')');
        }
    }
