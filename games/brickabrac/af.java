...
abstract class af extends km {
    ...
    final void a(boolean param0, boolean param1, int param2) {
        ...
        nf.field_Y = -1;
        i var4 = (i) ((Object) this.field_C.d(-117));
        if (param2 > -52) {
            field_u = 41;
        }
        while (var4 != null) {
            var4.a(-127);
            var4 = (i) ((Object) this.field_C.a((byte) 116));
        }
        var4 = (i) ((Object) this.field_v.d(-113));
        while (var4 != null) {
            var4.a(-128);
            if (var4.field_p == 0) {
                var4.c(1);
            }
            var4 = (i) ((Object) this.field_v.a((byte) 116));
        }
    }
    ...
    final void b(byte param0) {
        ...
        var17 = (i) ((Object) this.field_C.d(-94));
        L0: while (true) {
          if (var17 == null) {
            var15 = (i) ((Object) this.field_v.d(-43));
            L1: while (true) {
              if (var15 == null) {
                L2: {
                  sc.b(-81);
                ...
                if (param0 < -14) {
                  L3: {
                    ...
                    if (-1 != var3) {
                      ...
                      L6: {
                        ((bi) (Object) stackIn_20_0).c(stackIn_20_1, 209, 2 * var5 + 246 - -2, 2, -1);
                        if (var6 != 0) {
                      ...
                      var10 = ob.field_D.a(rd.a(mp.field_bc[var3], new String[]{nl.a(true, true, 0, (long)dp.field_r[var3], cd.field_e)}, (byte) 103), this.field_y, this.field_E);
                      var11 = 0;
                      L7: while (true) {
                        if (var11 >= var10) {
                          ...
                          ob.field_D.c(this.field_E[var11], 209, var8, 2, -1);
                          var8 = var8 + var4;
                          var11++;
                          continue L7;
                        }
                ...
                var15.a((byte) 107);
                var15 = (i) ((Object) this.field_v.a((byte) 116));
                continue L1;
              }
            }
          } else {
            var17.a((byte) 103);
            var17 = (i) ((Object) this.field_C.a((byte) 116));
            continue L0;
          }
        }
    }
    ...
    af(int param0, int[] param1) {
        ...
        int var3_int = 0;
        this.field_E = new String[24];
        this.field_C = new vl();
        this.field_v = new vl();
        try {
            this.field_z = new vl[1 - -(field_s.length / 16)];
            for (var3_int = 0; this.field_z.length > var3_int; var3_int++) {
                this.field_z[var3_int] = new vl();
            }
            this.field_y = new int[]{373};
    ...
    private final void g(byte param0) {
        ...
        this.a(32367, this.field_C);
        this.a(32367, this.field_v);
    }
    ...
    final void a(boolean param0, int param1, int param2) {
        ...
        nf.field_Y = -1;
        nf.field_P = -1;
        this.field_z[this.field_x].c((byte) -114);
        if (param2 > 96) {
          var4 = 0;
          var5 = 0;
          L0: while (true) {
            if (var5 >= field_s.length) {
              L1: {
                if (!this.field_z[this.field_x].a(false)) {
              ...
              this.a(2, 0, this.field_z[this.field_w]);
              return;
            } else {
              if (!this.a(var5, (byte) 38)) {
                this.field_z[this.field_x].a(new kq(var5), (byte) 3);
                var4++;
                if ((var4 ^ -1) == -17) {
                  var4 = 0;
    ...
    private final void a(int param0, int param1, vl param2) {
        ...
        try {
          L0: {
            ...
            var4_int = 640 * param1;
            this.a(32367, this.field_v);
            var5 = (i) ((Object) this.field_C.c(3));
            L1: while (true) {
              if (var5 == null) {
                var6 = 82;
                ...
                L2: while (true) {
                  if (var9 == null) {
                    ...
                    this.field_C.a(cn.a(-var4_int, var8, 32, (af) (this), 32, var10, var4_int + var7, var9.field_p, param0 + -1), (byte) 3);
          ...
          L0: {
            L1: {
              if (param0 == 32367) {
                ...
                this.field_C = (vl) null;
                break L1;
              }
            }
            var5 = (i) ((Object) param1.c(param0 + -32364));
            L2: while (true) {
              if (var5 == null) {
                break L0;
              } else {
                ...
                if (!this.field_h.a((byte) 113)) {
                  ...
                  if (!this.a((byte) 90, param0)) {
                    ...
                    if (rk.field_Qb != 0) {
                      ...
                      L2: {
                        this.a(2, 1, this.field_z[this.field_w]);
                        if (this.a((byte) 86, 1)) {
                          break L2;
                        } else {
                          this.field_h.a(false, 0);
          ...
          if (this.field_m.length <= var5) {
            ...
            L2: while (true) {
              if (var6 >= this.field_m.length) {
                ...
                var11 = this.field_m[var6];
                var11.field_c = var5;
                var11.field_a = this.b(var6, 1);
                var11.field_d = this.b((byte) -7, var6);
