...
final class fk {
    ...
    final static boolean a(mf param0, mf param1, mf param2, int param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_20_1 = new StringBuilder().append("fk.E(");
          ...
          throw qb.a((Throwable) (Object) stackIn_29_0, stackIn_29_2 + 44 + param3 + 41);
        }
    ...
    final static void a(int param0, og param1) {
        ...
        try {
            ...
            throw qb.a((Throwable) (Object) runtimeException, "fk.C(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final int a(byte param0, int param1, int param2, byte[] param3, int param4, byte[] param5) {
        ...
        try {
              ...
              if (param2 >= param1) {
                ...
                if (var11 == 0) {
                  ...
                  L3: {
                    ...
                    var8 = var8 + var11;
                    var13 += 24;
                    int dupTemp$1 = ud.d(var7_int, var10 >>> var13);
                    var7_int = dupTemp$1;
          ...
          L4: {
            ...
            stackOut_26_1 = new StringBuilder().append("fk.F(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_28_0 = stackOut_26_0;
            stackIn_28_1 = stackOut_26_1;
            stackIn_27_0 = stackOut_26_0;
            stackIn_27_1 = stackOut_26_1;
    ...
    final static void a(int param0) {
        ...
        try {
          ...
          throw qb.a((Throwable) (Object) var1_ref, "fk.H(" + 14114 + 41);
        }
    }
    ...
    final int a(int param0, int param1, int param2, boolean param3, byte[] param4, byte[] param5) {
        ...
        try {
              ...
              L2: while (true) {
                L3: {
                  ...
                  if (var9 >= 0) {
                    ...
                    var7_int = ((fk) this).field_j[var7_int];
                    break L3;
                  }
                }
                L4: {
                  L5: {
                    var10 = ((fk) this).field_j[var7_int];
                    if (0 <= ((fk) this).field_j[var7_int]) {
                      break L5;
                    } else {
                      int incrementValue$7 = param1;
                      param1++;
                      param4[incrementValue$7] = (byte)(~var10);
                      if (param1 < param0) {
                        var7_int = 0;
                        break L5;
                      } else {
          ...
          L20: {
            ...
            stackOut_71_1 = new StringBuilder().append("fk.A(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
          ...
          throw qb.a((Throwable) (Object) stackIn_77_0, stackIn_77_2 + 41);
        }
        return stackIn_70_0;
    }
        ...
        try {
            ...
            try {
              ...
              L4: {
                ...
                stackOut_8_1 = new StringBuilder().append("fk.D(").append(param0).append(44);
    ...
    fk(byte[] param0) {
        ...
        try {
          L0: {
            ...
            ((fk) this).field_a = new int[var2_int];
            var19 = new int[33];
            var18 = var19;
            var17 = var18;
            var16 = var17;
          ...
          L12: {
            ...
            stackOut_35_1 = new StringBuilder().append("fk.<init>(");
