    ...
    final static pb a(int param0, int param1, int param2, vl param3) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_12_0 = var4;
            stackOut_12_1 = new StringBuilder().append("so.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
    ...
    final static void a(mf param0, mf param1, mf param2, int param3, mf param4) {
        ...
        L0: while (true) {
          if (gj.field_c.length <= var7_int) {
            ...
            var7 = cd.field_h;
            var7[4] = null;
            jp discarded$4 = pl.a("basic", "frame_bracket", (byte) 106, param0);
            ...
            jp discarded$5 = pl.a("basic", "locked", (byte) -45, param1);
                                              ...
                                              if (hp.field_l.length <= var10_int) {
                                                ...
                                                L11: while (true) {
                                                  if (mp.field_Vb.length <= var10_int) {
                                                    ...
                                                    jp dupTemp$7 = mp.field_Vb[var10_int].e();
    ...
    so(int param0, mf param1, mf param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("so.<init>(").append(param0).append(44);
