                ...
                L2: while (true) {
                  ...
                  if (var8 == 0) {
                    ...
                    try {
                      ...
                      throw qb.a((Throwable) ((Object) stackIn_35_0), (stackIn_35_2 != 0) + " " + param2 + " " + var9.length + " " + cg.a(var9.length, var9, (byte) -86) + " " + cg.a(var9.length - 2, var9, (byte) -86) + " " + this.field_k.field_p[param2] + " " + this.field_k.field_b);
                    }
                    L10: {
                      if (this.field_b) {
