...
final class bk extends nm {
    ...
    final static bk a(mf param0, int param1, int param2) {
        try {
            bk var4_ref = null;
            if (!bk.a(param0)) {
                param0.a(param2, param1, (byte) 102);
                return null;
            }
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        this.field_j = var2.e(255);
        this.field_o = var2.e(255);
        this.field_G = var2.e(255);
        this.field_J = var2.e(255);
        if (this.field_J < 0) {
    ...
    final oe c() {
        ...
        int var7;
        this.field_s = 0;
        this.field_y = new float[field_H];
        ...
        L0: while (true) {
          if (var3 >= this.field_l.length) {
            this.field_y = null;
            return new oe(this.field_j, var1, this.field_G, this.field_J, this.field_q);
          } else {
            var4 = this.a(var3);
            if (var4 != null) {
              L1: {
    ...
    final oe a(int[] param0) {
        ...
        L2: while (true) {
          if (this.field_Q >= this.field_l.length) {
            this.field_y = null;
            var12 = this.field_m;
            this.field_m = null;
            return new oe(this.field_j, var12, this.field_G, this.field_J, this.field_q);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
                    ...
                    L13: while (true) {
                      if (var41 >= var4) {
                        ...
                        L17: {
                          var23 = stackIn_46_0;
                          if (var3 == 0) {
                            stackIn_49_0 = (int[]) (field_r);
                            break L17;
                          } else {
                            stackIn_49_0 = (int[]) (field_x);
                            break L17;
                          }
                        }
                        var48 = stackIn_49_0;
                  ...
                  if (this.field_N) {
                    ...
                    L37: while (true) {
                      if (var19 >= this.field_C) {
                        ...
                        var40[var19] = var40[var19] + this.field_y[var20];
                        var19++;
                        continue L37;
                      }
                    }
