...
final class gb {
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        int var8 = field_d - param2;
        int var9 = param0 + param1 * field_d;
        for (var10 = -param3; var10 < 0; var10++) {
            ...
            for (var14 = -param2; var14 < 0; var14++) {
                ...
                var9++;
                field_a[incrementValue$0] = var16 - var15 | var15 - (var15 >>> 8);
            }
            var9 = var9 + var8;
            var6 = var6 + var7;
        }
    ...
    final static void f(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
            ...
            if (param2 <= param3) {
              L1: {
                ...
                if (param1 >= field_b) {
                  ...
                  param0 = param0 + var10 * (field_b - param1);
                  param1 = field_b;
                  break L1;
                }
              }
              ...
              L5: {
                ...
                if (param0 >= field_l) {
                  ...
                  param1 = param1 + var10 * (field_l - param0);
                  param0 = field_l;
                  break L5;
                }
              }
            ...
            L9: {
              if (param3 < 0) {
                gb.c(param0, param1 + param3, -param3 + 1, param4, param5);
                break L9;
              } else {
                gb.c(param0, param1, param3 + 1, param4, param5);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              gb.g(param0 + param2, param1, -param2 + 1, param4, param5);
              break L10;
            } else {
              gb.g(param0, param1, param2 + 1, param4, param5);
              break L10;
            }
          }
          return;
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param3 != 0) {
          if (param2 != 0) {
                  ...
                  L4: {
                    ...
                    if (var6 < field_l) {
                      ...
                      if (var6 >= field_h) {
                        ...
                        field_a[var6 + param1 * field_d] = param4;
                        break L4;
                      }
                    }
                  }
                  ...
                  L8: {
                    ...
                    if (var6 < field_b) {
                      ...
                      if (var6 >= field_i) {
                        ...
                        field_a[param0 + var6 * field_d] = param4;
                        break L8;
                      }
                    }
                  }
            ...
            L9: {
              if (param3 < 0) {
                gb.c(param0, param1 + param3, -param3 + 1, param4);
                break L9;
              } else {
                gb.c(param0, param1, param3 + 1, param4);
                break L9;
              }
            }
            return;
          ...
          L10: {
            if (param2 < 0) {
              gb.b(param0 + param2, param1, -param2 + 1, param4);
              break L10;
            } else {
              gb.b(param0, param1, param2 + 1, param4);
              break L10;
            }
          }
          return;
    ...
    final static void a(int param0, int param1, int param2, int param3, int param4) {
        ...
        if (param4 != 0) {
          if (param4 != 256) {
                    ...
                    L6: while (true) {
                      ...
                      L10: while (true) {
                        if (var23 > var21) {
                          ...
                          var25++;
                          field_a[incrementValue$2] = var24;
                          var23++;
                          continue L10;
                        }
                      }
                      ...
                      if (var18 > var15) {
                        ...
                        L15: while (true) {
                          if (var23 >= var21) {
                            ...
                            var22++;
                            field_a[incrementValue$4] = var24;
                            var23++;
                            continue L15;
                          }
                        }
            ...
            gb.f(param0, param1, param2, param3);
            return;
          }
        } else {
          return;
    ...
    final static void b(int param0, int param1, int param2, int param3, int param4) {
        gb.b(param0, param1, param2, param4);
        gb.b(param0, param1 + param3 - 1, param2, param4);
        gb.c(param0, param1, param3, param4);
        gb.c(param0 + param2 - 1, param1, param3, param4);
    }
    ...
    final static void d(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        if (param4 != 0) {
                    ...
                    if (param0 >= field_h) {
                      ...
                      if (param1 + param3 < field_b) {
                        ...
                        if (param1 < field_i) {
                          L3: {
                            L4: {
                              var10 = var6 + (var7 - param4) * field_d;
                              var11 = var8 + (var7 - param4) * field_d;
                              var12 = var6 + var7 * field_d;
                              var13 = var8 + var7 * field_d;
                              var14 = var6 + var9 * field_d;
                              var15 = var8 + var9 * field_d;
                              var16 = var6 + (var9 + param4) * field_d;
                              var17 = var8 + (var9 + param4) * field_d;
                              var18 = param4;
                              var19 = 0;
                              var20 = param4 * param4;
                              var21 = var20 - var18;
                            ...
                            gb.c(param0, param1 + var18, param3 - var18 - var18, param5);
                            gb.c(param0 + param2 - 1, param1 + var18, param3 - var18 - var18, param5);
                            gb.b(param0 + var18, param1, param2 - var18 - var18, param5);
                            gb.b(param0 + var18, param1 + param3 - 1, param2 - var18 - var18, param5);
                            L11: while (true) {
                              L12: {
          ...
          gb.b(param0, param1, param2, param3, param5);
          return;
        }
    }
    ...
    final static void d(int param0, int param1, int param2, int param3) {
        ...
        int var4 = field_d - param2;
        int var5 = param0 + param1 * field_d;
        gb.a(var5, field_a, 0, param2, -param3, var4);
    }
        ...
        if (param4 != 0) {
          ...
          L4: while (true) {
            if (var11 >= var7) {
              ...
              L7: {
                var19 = var17 + var11 * field_d;
                var20 = field_d + var17 - var18;
                ...
                if (var11 >= var21) {
                      ...
                      L10: while (true) {
                        ...
                        L14: while (true) {
                          if (var20 > var18) {
                            ...
                            var19++;
                            field_a[incrementValue$2] = param5;
                            var20++;
                            continue L14;
                          }
                        }
                  ...
                  L15: while (true) {
                    if (var22 >= var18) {
                      ...
                      var19++;
                      field_a[incrementValue$3] = param5;
                      var22++;
                      continue L15;
                    }
                  }
                    ...
                    if (var15 > var12) {
                      ...
                      L20: while (true) {
                        if (var20 >= var18) {
                          ...
                          var19++;
                          field_a[incrementValue$5] = param5;
                          var20++;
                          continue L20;
                        }
                      }
          ...
          gb.e(param0, param1, param2, param3, param5);
          return;
        }
    }
          ...
          if (param4 != 0) {
            ...
            L4: while (true) {
              if (var13 >= var9) {
                ...
                L7: {
                  var21 = var19 + var13 * field_d;
                  var22 = field_d + var19 - var20;
                  ...
                  if (var13 >= var23) {
                        ...
                        L10: while (true) {
                          ...
                          L14: while (true) {
                            if (var22 > var20) {
                              ...
                              var21++;
                              field_a[incrementValue$2] = param5 + var23;
                              var22++;
                              continue L14;
                            }
                          }
                    ...
                    L15: while (true) {
                      if (var24 >= var20) {
                        ...
                        var21++;
                        field_a[incrementValue$3] = param5 + var25;
                        var24++;
                        continue L15;
                      }
                    }
                      ...
                      if (var17 > var14) {
                        ...
                        L20: while (true) {
                          if (var22 >= var20) {
                            ...
                            var21++;
                            field_a[incrementValue$5] = param5 + var23;
                            var22++;
                            continue L20;
                          }
                        }
            ...
            gb.g(param0, param1, param2, param3, param5, param6);
            return;
          }
        } else {
          gb.c(param0, param1, param2, param3, param4, param5);
          return;
        }
    }
    ...
    private final static void a(int[] param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7) {
        ...
        L1: {
          var10 = field_d - param4 - param5 - param3;
          if (0 >= var10) {
            break L1;
          } else {
            var10 = 0;
                        ...
                        if (param1 - param2 < field_i) {
                          L3: {
                            L4: {
                              var4 = param0 + param1 * field_d;
                              var5 = var4;
                              var6 = var4 - param2 * field_d;
                              var7 = var4 + param2 * field_d;
                              var8 = param2;
                              var9 = 0;
    ...
    final static void a(int param0, int param1, int param2) {
        if (param0 >= field_l) {
            if (param1 < field_b || param0 >= field_h || param1 >= field_i) {
                return;
            }
            field_a[param0 + param1 * field_d] = param2;
            return;
        }
    }
    ...
    final static void g(int param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        int var6 = 256 - param5;
        int var7 = field_d - param2;
        int var8 = param0 + param1 * field_d;
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4, int param5) {
        gb.g(param0, param1, param2, param4, param5);
        gb.g(param0, param1 + param3 - 1, param2, param4, param5);
        if (param3 >= 3) {
            gb.c(param0, param1 + 1, param3 - 2, param4, param5);
            gb.c(param0 + param2 - 1, param1 + 1, param3 - 2, param4, param5);
            return;
        }
    }
          ...
          if (var13 > var15) {
            ...
            L5: while (true) {
              if (var18 >= param8) {
                ...
                L7: {
                  var19 = param7 + (param4 - param3) * field_d;
                  if (var13 >= var18) {
                    break L7;
                  } else {
                    var19 = var19 + (var18 - var13) * field_d;
                    break L7;
                  }
                }
                L8: while (true) {
                  ...
                  L6: while (true) {
                    ...
                    L10: while (true) {
                      if (var15 > var13) {
                        ...
                        var14++;
                        field_a[incrementValue$2] = param3;
                        var15++;
                        continue L10;
                      }
                    }
                    ...
                    if (var10 > var7) {
                      ...
                      L15: while (true) {
                        if (var15 >= var13) {
                          ...
                          incrementValue$4 = var14;
                          var14++;
                          field_a[incrementValue$4] = param3;
                          var15++;
                          continue L15;
                        }
                      }
    ...
    final static void e(int param0, int param1, int param2, int param3, int param4) {
        ...
        int var5 = field_d - param2;
        int var6 = param0 + param1 * field_d;
    ...
    final static void a(int param0, int param1, int param2, int param3, int[] param4) {
        ...
        int var22 = var6 + var8 * field_d;
        int var23 = field_d + var6 - var7;
        gb.a(0, 0, 0, 0, 0, var15, var5, var22, field_a, param3, param4, var23, var13, var6 - var7, var16 + var10, var19, var21, var8 - var9);
    }
    ...
    final static void h(int param0, int param1, int param2, int param3, int param4, int param5) {
        gb.a(field_a, 0, param2 + param3 * field_d, param0, param2, param4, field_d - param4, param5);
        gb.a(field_a, 0, param2 + param3 * field_d, param1, param3, param5, field_d - param4, param2, param4);
    }
    ...
    final static void e(int param0, int param1, int param2, int param3) {
        ...
        int var4 = param0 + param1 * field_d;
        if (param2 > 0) {
            if (param3 <= 0) {
                return;
            }
