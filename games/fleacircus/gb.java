...
final class gb {
          ...
          if (var10 >= 0) {
            ...
            L5: while (true) {
              if (var14 >= 0) {
                ...
                var9++;
                field_a[var9] = var16 - var15 | var15 - (var15 >>> 8);
                var14++;
                continue L5;
              }
            }
    ...
    final static void a(int param0, int param1, int param2, int param3, int[] param4) {
        ...
        var20 = var18 - var17;
        var21 = var20 - var19;
        var22 = var6 + var8 * field_d;
        var23 = field_d + var6 - var7;
        ...
        if (param2 > 0) {
            ...
            for (var5 = 0; var5 < param3; var5++) {
                for (var6 = 0; var6 < param2; var6++) {
                    ...
                    var4++;
                    field_a[var4] = (var11 << 16) + (var11 << 8) + var11;
                }
