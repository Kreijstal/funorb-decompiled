...
final class dj extends fa {
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, boolean param6) {
        ...
        L0: {
          ...
          if (param2 >= gb.field_b) {
            ...
            var12 = gb.field_b - param2;
            param4 = param4 - var12;
            param2 = gb.field_b;
            var11 = var11 + var12 * param3;
            var8 = var8 + var12 * gb.field_d;
            break L0;
          }
        }
        L1: {
          if (param2 + param4 <= gb.field_i) {
            break L1;
          } else {
            param4 = param4 - (param2 + param4 - gb.field_i);
            break L1;
          }
        }
        L2: {
          if (param1 >= gb.field_l) {
            break L2;
          } else {
            var12 = gb.field_l - param1;
            param3 = param3 - var12;
            param1 = gb.field_l;
            var11 = var11 + var12;
            var8 = var8 + var12;
        ...
        L3: {
          if (param1 + param3 <= gb.field_h) {
            break L3;
          } else {
            var12 = param1 + param3 - gb.field_h;
            param3 = param3 - var12;
            var10 = var10 + var12;
            var9 = var9 + var12;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param6) {
                  dj.a(0, gb.field_a, ((dj) this).field_O[param0], ((dj) this).field_P[param5], var11, var8, param3, param4, var9, var10);
                  break L5;
                } else {
                  jh.a(gb.field_a, ((dj) this).field_O[param0], param5, var11, var8, param3, param4, var9, var10);
                  break L5;
                }
              }
              return;
    ...
    dj(byte[] param0, int[] param1, int[] param2, int[] param3, int[] param4, int[] param5, byte[][] param6) {
        super(param0, param1, param2, param3, param4);
        ((dj) this).field_O = new byte[256][];
        ((dj) this).field_O = param6;
        ((dj) this).field_P = new int[4][];
        ((dj) this).field_P[0] = param5;
    }
    ...
    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, boolean param7) {
        ...
        L0: {
          ...
          if (param2 >= gb.field_b) {
            ...
            var13 = gb.field_b - param2;
            param4 = param4 - var13;
            param2 = gb.field_b;
            var12 = var12 + var13 * param3;
            var9 = var9 + var13 * gb.field_d;
            break L0;
          }
        }
        L1: {
        ...
        L3: {
          if (param1 + param3 <= gb.field_h) {
            ...
            var13 = param1 + param3 - gb.field_h;
            param3 = param3 - var13;
            var11 = var11 + var13;
            var10 = var10 + var13;
            break L3;
        ...
        L4: {
          if (param3 <= 0) {
            ...
            if (param4 > 0) {
              L5: {
                if (!param7) {
                  dj.a(0, gb.field_a, ((dj) this).field_O[param0], ((dj) this).field_P[param5], var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                } else {
                  jh.a(gb.field_a, ((dj) this).field_O[param0], param5, var12, var9, param3, param4, var10, var11, param6);
                  break L5;
                }
              }
              return;
