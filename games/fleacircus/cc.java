        ...
        if (param1 >= 10) {
          L0: {
            ...
            if (this.field_d == null) {
              ...
              this.field_d.a();
              this.field_j.a();
              var5 = (int)((double)(this.field_d.field_b - this.field_d.field_i) * 32.768 / var3);
              var6 = (int)((double)this.field_d.field_i * 32.768 / var3);
              break L0;
            }
          }
          L1: {
            ...
            if (this.field_m == null) {
              ...
              this.field_m.a();
              this.field_v.a();
              var8 = (int)((double)(this.field_m.field_b - this.field_m.field_i) * 32.768 / var3);
              var9 = (int)((double)this.field_m.field_i * 32.768 / var3);
              break L1;
            }
          }
          var11 = 0;
            ...
            if (var11 >= 5) {
              ...
              L3: while (true) {
                if (var11 >= param0) {
                      ...
                      L5: while (true) {
                        if (var14 >= param0) {
                          ...
                          L6: {
                            ...
                            var16 = this.field_p.a(param0);
                            if (var13 == 0) {
                              var12 = this.field_o.field_i + ((this.field_o.field_b - this.field_o.field_i) * var16 >> 8);
                              break L6;
                            } else {
                              var12 = this.field_o.field_i + ((this.field_o.field_b - this.field_o.field_i) * var15 >> 8);
                              break L6;
                            }
                          }
                          L7: {
                      ...
                      if (this.field_t <= 0) {
                        ...
                        L10: while (true) {
                          if (var12 >= param0) {
                            ...
                            field_q[var12] = field_q[var12] + field_q[var12 - var11] * this.field_t / 100;
                            var12++;
                            continue L10;
                          }
                        }
                  ...
                  L11: {
                    L12: {
                      if (this.field_n.field_h[0] > 0) {
                        break L12;
                      } else {
                        if (this.field_n.field_h[1] <= 0) {
                          break L11;
                        } else {
                          break L12;
                        }
                  ...
                  L27: {
                    ...
                    if (this.field_d == null) {
                      ...
                      var12 = var12 + (this.a(var7, var15, this.field_d.field_d) >> 1);
                  ...
                  L28: {
                    if (this.field_m == null) {
                      ...
                      var13 = var13 * ((this.a(var10, var15, this.field_m.field_d) >> 1) + 32768) >> 15;
                  ...
                  L29: while (true) {
                    if (var14 < 5) {
                      if (this.field_y[var14] != 0) {
                        ...
                        if (var15 < param0) {
                          field_q[var15] = field_q[var15] + this.a(field_u[var14], var13 * field_b[var14] >> 15, this.field_a.field_d);
              ...
              if (this.field_y[var11] != 0) {
                field_u[var11] = 0;
                field_x[var11] = (int)((double)this.field_l[var11] * var3);
                field_b[var11] = (this.field_y[var11] << 14) / 100;
                field_k[var11] = (int)((double)(this.field_a.field_b - this.field_a.field_i) * 32.768 * Math.pow(1.0057929410678534, (double)this.field_c[var11]) / var3);
                field_f[var11] = (int)((double)this.field_a.field_i * 32.768 / var3);
                var11++;
                continue L2;
              } else {
                var11++;
