...
final class pk extends dk {
    ...
    final StringBuilder a(StringBuilder param0, Hashtable param1, int param2, int param3) {
        ...
        try {
              ...
              if (((pk) this).a(param1, -103, param0, param2)) {
                ...
                if (((pk) this).field_I == 2147483647) {
                  ...
                  if (((pk) this).field_H == 2147483647) {
                    ...
                    StringBuilder discarded$27 = param0.append(" to ").append(((pk) this).field_I).append(44).append(((pk) this).field_H);
                    break L2;
                  }
                }
              } else {
          ...
          throw pf.a((Throwable) (Object) stackIn_15_0, stackIn_15_2 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_8_0;
    }
    ...
    final void a(byte param0, qa param1, int param2, int param3, int param4, int param5) {
        try {
            ...
            throw pf.a((Throwable) (Object) runtimeException, "pk.R(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
    }
    ...
    private pk(int param0, int param1, int param2, int param3, ch param4, kd param5, qa param6, boolean param7, boolean param8) {
        ...
        try {
            ...
            throw pf.a((Throwable) (Object) runtimeException, "pk.<init>(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + (param6 != null ? "{...}" : "null") + 44 + param7 + 44 + param8 + 41);
        }
    }
    ...
    final void a(int param0, int param1, qa param2, byte param3) {
        ...
        try {
          ...
          L9: {
            ...
            stackOut_32_1 = new StringBuilder().append("pk.I(").append(param0).append(44).append(param1).append(44);
          ...
          throw pf.a((Throwable) (Object) stackIn_35_0, stackIn_35_2 + 44 + param3 + 41);
        }
    }
    ...
    final static ve a(byte param0, String param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("pk.FA(").append(param0).append(44);
    ...
    final boolean a(int param0, boolean param1, int param2, qa param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_12_1 = new StringBuilder().append("pk.K(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_14_0 = stackOut_12_0;
            stackIn_14_1 = stackOut_12_1;
            stackIn_13_0 = stackOut_12_0;
            stackIn_13_1 = stackOut_12_1;
