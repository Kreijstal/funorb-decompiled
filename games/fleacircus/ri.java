        ...
        try {
          L0: {
            if (param0 < -36) {
              ...
              var8 = stackIn_19_0;
              discarded$1 = this.field_j.a(param3.field_i, param3.field_y + param1, -2 + (param4 - -param3.field_z), param3.field_u, param3.field_j, var8, -1, 1, 1, this.field_j.field_H);
    ...
    final static void a(dd[] param0, int param1, fa param2, int param3, int param4, boolean param5, int param6, int param7, fa param8, int param9, int param10, int param11, int param12, int param13, int param14, int param15, dd[] param16, dd[] param17, int param18, int param19, int param20) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_10_1 = ((StringBuilder) (Object) stackIn_10_1).append(stackIn_10_2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',').append(param6).append(',').append(param7).append(',');
          ...
          L5: {
            ...
            stackOut_13_1 = ((StringBuilder) (Object) stackIn_13_1).append(stackIn_13_2).append(',').append(param9).append(',').append(param10).append(',').append(param11).append(',').append(param12).append(',').append(param13).append(',').append(param14).append(',').append(param15).append(',');
          ...
          throw pf.a((Throwable) ((Object) stackIn_19_0), stackIn_19_2 + ',' + param18 + ',' + param19 + ',' + param20 + ')');
        }
    }
