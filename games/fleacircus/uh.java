...
final class uh extends lh {
    ...
    final static rh a(int param0, int param1, boolean param2, boolean param3, int param4) {
        ...
        try {
          L0: {
            if (param1 == 26) {
              stackIn_4_0 = ag.a(param2, param4, false, param0, param3, 1);
    ...
    final static void a(byte param0, rh param1) {
        ...
        try {
          ...
          L219: {
            ...
            stackIn_777_0 = (RuntimeException) (var2_ref);

            stackIn_777_1 = new StringBuilder().append("uh.A(").append(param0).append(',');

            if (param1 == null) {
              stackIn_778_0 = (RuntimeException) ((Object) stackIn_777_0);
              stackIn_778_1 = (StringBuilder) ((Object) stackIn_777_1);
              stackIn_778_2 = "null";
              break L219;
            } else {
              stackIn_778_0 = (RuntimeException) ((Object) stackIn_777_0);
