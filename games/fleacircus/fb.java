...
final class fb {
    ...
    final static int b(int param0) {
        ...
        try {
          L0: {
            discarded$12 = nb.field_a.a(gh.field_p, 91, true, mk.field_h);
            nb.field_a.d(true);
            L1: while (true) {
              L2: {
                L3: {
                  if (!wf.b(-111)) {
                    ...
                    discarded$13 = nb.field_a.a(id.field_b, (byte) -37, ji.field_a);
                    if (var2 != 0) {
                      break L2;
                    } else {
                      if (var2 == 0) {
    ...
    final static boolean a(byte param0, ih param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("fb.B(").append(param0).append(',');
