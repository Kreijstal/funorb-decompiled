...
final class fb {
    ...
    final static int b(int param0) {
        ...
        try {
          L0: {
            boolean discarded$12 = nb.field_a.a(gh.field_p, 91, true, mk.field_h);
            nb.field_a.d(true);
            L1: while (true) {
              if (!wf.b(-111)) {
                if (-1 != cl.field_b) {
                ...
                boolean discarded$13 = nb.field_a.a(id.field_b, (byte) -37, ji.field_a);
                continue L1;
              }
            }
          }
          ...
          throw pf.a((Throwable) (Object) var1, "fb.D(" + param0 + 41);
        }
        return stackIn_22_0;
    }
    ...
    final static boolean a(byte param0, ih param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("fb.B(").append(98).append(44);
    ...
    final static bi[] a(rh param0, byte param1, String param2, String param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = be.a(var5, var4_int, -1, param0);
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("fb.C(");
