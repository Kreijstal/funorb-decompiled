...
final class hk extends lh {
    ...
    final static hk a(rh param0, String param1, String param2) {
        try {
            ...
            hk var4_ref = null;
            if (!hk.a(param0)) {
                discarded$0 = param0.a(param2, param1, -60);
                return null;
            }
    ...
    final static hk a(rh param0, int param1, int param2) {
        try {
            ...
            hk var4_ref = null;
            if (!hk.a(param0)) {
                discarded$0 = param0.a((byte) -29, param1, param2);
                return null;
            }
    ...
    final sf a(int[] param0) {
        ...
        L1: {
          if (this.field_s != null) {
            ...
            this.field_x = 0;
            this.field_r = new float[field_j];
            this.field_s = new byte[this.field_m];
            this.field_J = 0;
            this.field_Q = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (this.field_Q >= this.field_z.length) {
            this.field_r = null;
            var12 = this.field_s;
            this.field_s = null;
            return new sf(this.field_D, var12, this.field_i, this.field_K, this.field_k);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        this.field_D = var2.c((byte) 124);
        this.field_m = var2.c((byte) -59);
        this.field_i = var2.c((byte) -90);
        this.field_K = var2.c((byte) -82);
        if (this.field_K < 0) {
    ...
    final sf b() {
        ...
        L0: while (true) {
          if (var3 >= this.field_z.length) {
            this.field_r = null;
            return new sf(this.field_D, var1, this.field_i, this.field_K, this.field_k);
          } else {
            var4 = this.a(var3);
            if (var4 != null) {
              L1: {
                  ...
                  if (this.field_E) {
                    ...
                    L37: while (true) {
                      if (var19 >= this.field_I) {
                        ...
                        var40[var19] = var40[var19] + this.field_r[var20];
                        var19++;
                        continue L37;
                      }
                    }
