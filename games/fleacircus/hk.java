...
final class hk extends lh {
    static sl[] field_G;
    private static ba[] field_v;
    private int field_J;
                              ...
                              if (var5 >= var4) {
                                ...
                                L6: while (true) {
                                  if (var6 >= var5) {
                                    ...
                                    int discarded$3 = hk.e(16);
                                    int discarded$4 = hk.e(16);
                                    field_B[var6] = hk.e(8);
                                    var6++;
                                    continue L6;
                                  }
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = si.a(var10, (byte) -56, var11);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    final static hk a(rh param0, int param1, int param2) {
        try {
            ...
            byte[] var3 = param0.a(param1, (byte) 120, param2);
            if (var3 == null) {
                return null;
            }
            hk var4 = null;
    ...
    final static int c() {
        int var0 = field_n[field_l] >> field_O & 1;
        field_O = field_O + 1;
    ...
    final sf a(int[] param0) {
        ...
        L1: {
          if (((hk) this).field_s != null) {
            break L1;
          } else {
            ((hk) this).field_x = 0;
            ((hk) this).field_r = new float[field_j];
            ((hk) this).field_s = new byte[((hk) this).field_m];
            ((hk) this).field_J = 0;
            ((hk) this).field_Q = 0;
            break L1;
          }
        ...
        L2: while (true) {
          if (((hk) this).field_Q >= ((hk) this).field_z.length) {
            ((hk) this).field_r = null;
            var14 = ((hk) this).field_s;
            ((hk) this).field_s = null;
            return new sf(((hk) this).field_D, var14, ((hk) this).field_i, ((hk) this).field_K, ((hk) this).field_k);
          } else {
            L3: {
              if (param0 == null) {
                break L3;
            ...
            L4: {
              ...
              if (var7 == null) {
                ...
                L5: {
                  var3 = ((hk) this).field_J;
                  var4 = var13.length;
                  if (var4 <= ((hk) this).field_m - var3) {
                    break L5;
                  } else {
                    var4 = ((hk) this).field_m - var3;
                    break L5;
                  }
                }
                var5 = 0;
                  ...
                  if (var5 >= var4) {
                    L7: {
                      if (param0 == null) {
                        ...
                        param0[0] = param0[0] - (var3 - ((hk) this).field_J);
                        break L7;
                      }
                    }
            ...
            ((hk) this).field_Q = ((hk) this).field_Q + 1;
            continue L2;
          }
        }
    }
    ...
    private final void a(byte[] param0) throws IOException {
        ...
        int var6_int = 0;
        byte[] var6 = null;
        ni var2 = new ni(param0);
        ((hk) this).field_D = var2.c((byte) 124);
        ((hk) this).field_m = var2.c((byte) -59);
        ...
        ((hk) this).field_z = new byte[var3][];
        for (var4 = 0; var4 < var3; var4++) {
            var5 = 0;
            do {
                var6_int = var2.e(false);
                var5 = var5 + var6_int;
            } while (var6_int >= 255);
            var6 = new byte[var5];
            var2.b(var6, 0, -103, var5);
            ((hk) this).field_z[var4] = var6;
        }
    }
    ...
    final sf b() {
        ...
        ((hk) this).field_x = 0;
        ((hk) this).field_r = new float[field_j];
        var1 = new byte[((hk) this).field_m];
        var2 = 0;
        var3 = 0;
        L0: while (true) {
          if (var3 >= ((hk) this).field_z.length) {
            ((hk) this).field_r = null;
            return new sf(((hk) this).field_D, var1, ((hk) this).field_i, ((hk) this).field_K, ((hk) this).field_k);
          } else {
            var4 = this.a(var3);
            if (var4 != null) {
              L1: {
                var5 = var4.length;
                if (var5 <= ((hk) this).field_m - var2) {
                  break L1;
                } else {
                  var5 = ((hk) this).field_m - var2;
                  break L1;
                }
              }
              var6 = 0;
    ...
    final static int e(int param0) {
        ...
        while (param0 >= 8 - field_O) {
            var3 = 8 - field_O;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_n[field_l] >> field_O & var4) << var2);
            field_O = 0;
            field_l = field_l + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_n[field_l] >> field_O & var3) << var2);
    ...
    private final float[] a(int param0) {
        ...
        L0: {
          hk.a(((hk) this).field_z[param0], 0);
          int discarded$1 = hk.c();
          var2 = hk.e(dk.a(field_B.length - 1, (byte) -57));
          var3 = field_F[var2] ? 1 : 0;
          if (var3 == 0) {
            stackOut_2_0 = field_N;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          } else {
            stackOut_1_0 = field_j;
        ...
        L8: {
          var14 = field_u[field_B[var2]];
          var16 = var14.field_a;
          var17_int = var14.field_d[var16];
          if (field_t[var17_int].b()) {
            stackOut_21_0 = 0;
          ...
          if (var17_int >= var14.field_b) {
            L10: {
              if (var15 != 0) {
                ...
                field_t[var18_int].a(field_P, var4 >> 1);
                break L10;
              }
            }
            L11: {
            ...
            L35: {
              var17 = null;
              if (((hk) this).field_x <= 0) {
                break L35;
              } else {
                L36: {
                  var18_int = ((hk) this).field_x + var4 >> 2;
                  ...
                  if (((hk) this).field_E) {
                    ...
                    var19 = 0;
                    L37: while (true) {
                      if (var19 >= ((hk) this).field_I) {
                        break L36;
                      } else {
                        var20 = (((hk) this).field_x >> 1) + var19;
                        var40[var19] = var40[var19] + ((hk) this).field_r[var20];
                        var19++;
                        continue L37;
                      }
                    }
            ...
            L39: {
              var18 = ((hk) this).field_r;
              ((hk) this).field_r = field_P;
              field_P = var18;
              ((hk) this).field_x = var4;
              ((hk) this).field_I = var12 - (var4 >> 1);
              stackOut_108_0 = this;
    ...
    private hk(byte[] param0) throws IOException {
        this.a(param0);
    }
