    ...
    final static dd[] a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        L0: while (true) {
          ...
          L6: while (true) {
            ...
            L11: while (true) {
              stackOut_61_0 = param3;
              stackOut_61_1 = var11;
              stackIn_59_0 = stackOut_61_0;
              stackIn_59_1 = stackOut_61_1;
              L12: while (true) {
                L13: {
                  if (stackIn_59_0 <= stackIn_59_1) {
                    ...
                    stackOut_57_0 = 0;
                    stackIn_32_0 = stackOut_57_0;
                    stackIn_58_0 = stackOut_57_0;
                    if (var15 != 0) {
                      break L13;
                    } else {
                      stackOut_58_0 = stackIn_58_0;
                      stackIn_55_0 = stackOut_58_0;
                      var12 = stackIn_55_0;
                      if (var12 >= var9) {
                        var11++;
                        continue L11;
                        ...
                        var10[0].field_B[var12 * var9 + var11] = param8;
                        stackOut_53_0 = var12 ^ -1;
                        stackOut_53_1 = -var11 + var9 ^ -1;
