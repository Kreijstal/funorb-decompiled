    ...
    final static void a(int param0, String param1, String param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ij.DA(").append(-1).append(',');
    ...
    public final void a(int param0, int param1, int param2, int param3, bb param4) {
        ...
        try {
          ...
          L5: {
            ...
            stackOut_12_1 = new StringBuilder().append("ij.JA(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
