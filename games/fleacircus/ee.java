...
final class ee implements ch {
    ...
    public final void a(int param0, int param1, boolean param2, qa param3, int param4) {
        ...
        try {
          L0: {
            if (param0 <= -36) {
              ...
              L2: {
                ...
                gb.e(param1 + param3.field_y, param3.field_z + param4, param3.field_u, param3.field_j, this.field_j);
                if (var14 != null) {
                  break L2;
                } else {
                  break L2;
              ...
              L3: {
                ...
                gb.f(var7, var8, var14.field_O, this.field_c);
                if (-1 != var14.field_K) {
                  ...
                  gb.f(var7 + var11, var12 + var8, 1, this.field_g);
                  break L3;
                } else {
                  break L3;
                }
              ...
              if (null != this.field_d) {
                var13 = this.field_a + var14.field_U - -var14.field_O;
                discarded$1 = this.field_d.a(param3.field_i, var13 + param3.field_y + param1, this.field_f + param4 - -param3.field_z, param3.field_u + -var13 + -this.field_a, param3.field_j - (this.field_a << -497739519), this.field_b, this.field_e, 1, 1, 0);
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("ee.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    ee(fa param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7) {
        try {
            ...
            throw pf.a((Throwable) ((Object) runtimeException), "ee.<init>(" + (param0 != null ? "{...}" : "null") + ',' + param1 + ',' + param2 + ',' + param3 + ',' + param4 + ',' + param5 + ',' + param6 + ',' + param7 + ')');
        }
    }
