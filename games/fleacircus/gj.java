    ...
    final static String a(int param0, CharSequence[] param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("gj.SA(").append(param0).append(44);
    ...
    private final void b(StringBuilder param0, Hashtable param1, int param2, int param3) {
        ...
        try {
          L0: {
            ...
            L2: while (true) {
              if (var6 == null) {
                ...
                L3: while (true) {
                  if (var7 > param3) {
                    StringBuilder discarded$13 = var6.a(param0, param1, param3 - -1, param2 ^ -82);
                    var6 = (qa) (Object) var5.c(-6144);
                    continue L2;
                  } else {
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("gj.AB(");
