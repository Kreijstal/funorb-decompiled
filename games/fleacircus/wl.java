...
final class wl {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_c[var16]) {
                  var9 = field_j[var16];
                  var10 = field_k[var16] * this.field_a;
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_e[var7]) {
                              ...
                              var5++;
                              this.field_g[incrementValue$2] = hk.e(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_e[this.field_l[var6]];
                      var6++;
                      continue L2;
                    }
                  }
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_g, 0, field_j, 0, var2);
        int var3 = field_i[this.field_a - 1];
        ...
        for (var6 = 0; var6 < this.field_l.length; var6++) {
            ...
            var11 = 0;
            if (var9 > 0) {
                var11 = hk.field_G[this.field_b[var7]].a();
            }
