...
final class wl {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((wl) this).field_g.length;
        var4 = field_i[((wl) this).field_a - 1];
        var5 = field_c;
        field_c[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_k[0] * ((wl) this).field_a;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_c[var16]) {
                  var9 = field_j[var16];
                  var10 = field_k[var16] * ((wl) this).field_a;
            ...
            L3: {
              var7 = wl.a(field_j, var6);
              var8_int = wl.b(field_j, var6);
              var9 = this.a(field_j[var7], field_k[var7], field_j[var8_int], field_k[var8_int], field_j[var6]);
              var10 = field_k[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    wl() {
        ...
        if (var1 == 1) {
          var2 = hk.e(5);
          var3 = 0;
          ((wl) this).field_l = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((wl) this).field_e = new int[var3];
              ((wl) this).field_h = new int[var3];
              ((wl) this).field_b = new int[var3];
              ((wl) this).field_d = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((wl) this).field_a = hk.e(2) + 1;
                  var4 = hk.e(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((wl) this).field_g = new int[var5];
                      ((wl) this).field_g[0] = 0;
                      ((wl) this).field_g[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((wl) this).field_e[((wl) this).field_l[var6]];
                      var6++;
                      continue L2;
                    }
                  }
    ...
    final boolean b() {
        ...
        int var2 = ((wl) this).field_g.length;
        System.arraycopy((Object) (Object) ((wl) this).field_g, 0, (Object) (Object) field_j, 0, var2);
        int var3 = field_i[((wl) this).field_a - 1];
        int var4 = dk.a(var3 - 1, (byte) -57);
        field_k[0] = hk.e(var4);
        field_k[1] = hk.e(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((wl) this).field_l.length; var6++) {
            var7 = ((wl) this).field_l[var6];
            var8 = ((wl) this).field_e[var7];
            var9 = ((wl) this).field_h[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = hk.field_G[((wl) this).field_b[var7]].a();
            }
