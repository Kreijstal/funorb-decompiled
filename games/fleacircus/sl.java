...
final class sl {
    ...
    private final static int a(int param0, int param1) {
        int var2 = 0;
        for (var2 = (int)Math.pow((double)param0, 1.0 / (double)param1) + 1; tf.b(var2, param1, -2) > param0; var2--) {
        }
        return var2;
    }
    ...
    final int a() {
        ...
        while (this.field_d[var1] >= 0) {
            var1 = hk.c() != 0 ? this.field_d[var1] : var1 + 1;
        }
          ...
          if (var1 == 0) {
            ...
            L5: while (true) {
              if (var2 >= this.field_a) {
                ...
                var4_int = hk.e(dk.a(this.field_a - var2, (byte) -57));
                var5 = 0;
                L6: while (true) {
                  if (var5 >= var4_int) {
                    var3_int++;
        ...
        L7: {
          ...
          if (var2 <= 0) {
            ...
            L9: {
              var6 = stackIn_23_0;
              if (var2 != 1) {
                var7 = this.field_a * this.field_e;
                break L9;
              } else {
                var7 = sl.a(this.field_a, this.field_e);
                break L9;
              }
            }
            ...
            L10: while (true) {
              if (var8 >= var7) {
                this.field_f = new float[this.field_a][this.field_e];
                if (var2 != 1) {
                  var8 = 0;
                  L11: while (true) {
