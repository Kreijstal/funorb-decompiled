        ...
        try {
          L0: {
            ...
            if (ha.a(param4, -32180, param2, param0)) {
              stackOut_5_0 = pd.a(param3.a(param2, (byte) 122, param0), true);
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("dl.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
