...
final class gk {
    ...
    gk() {
        ((gk) this).field_s = new byte[256];
        ((gk) this).field_p = 0;
        ((gk) this).field_d = new int[257];
        ((gk) this).field_B = new byte[18002];
        ((gk) this).field_a = new boolean[16];
        ((gk) this).field_w = new int[6][258];
        ((gk) this).field_F = new boolean[256];
        ((gk) this).field_g = new byte[18002];
        ((gk) this).field_x = new int[6];
        ((gk) this).field_b = new int[16];
        ((gk) this).field_m = new int[6][258];
        ((gk) this).field_h = new int[6][258];
        ((gk) this).field_f = new byte[4096];
        ((gk) this).field_v = new byte[6][258];
        ((gk) this).field_i = new int[256];
        ((gk) this).field_u = 0;
    }
