    ...
    final static StringBuilder a(int param0, StringBuilder param1, char param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_9_1 = new StringBuilder().append("uf.C(").append(param0).append(44);
    ...
    final cg a(int param0, boolean param1, ah param2, ah param3, int param4) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_15_1 = new StringBuilder().append("uf.B(").append(param0).append(44).append(param1).append(44);
          ...
          throw pf.a((Throwable) (Object) stackIn_21_0, stackIn_21_2 + 44 + param4 + 41);
        }
        return stackIn_14_0;
    }
