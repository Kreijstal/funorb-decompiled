...
final class jk extends hm {
    ...
    private final java.net.Socket a(String param0, int param1, String param2, byte param3) throws IOException {
        ...
        try {
          ...
          L9: {
            ...
            stackOut_27_1 = new StringBuilder().append("jk.I(");
          ...
          throw pf.a((Throwable) ((Object) stackIn_33_0), stackIn_33_2 + ',' + param3 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return stackIn_11_0;
        } else {
    ...
    private final java.net.Socket a(java.net.Proxy param0, byte param1) throws IOException {
        ...
        try {
            ...
            if (param0.type() != java.net.Proxy.Type.DIRECT) {
              ...
              if ((Object) var3_ref instanceof java.net.InetSocketAddress) {
                ...
                if (param0.type() == java.net.Proxy.Type.HTTP) {
                  ...
                  stackOut_19_0 = this.a((String) (var5), var4_ref.getPort(), var4_ref.getHostName(), (byte) 101);
              ...
              stackOut_1_0 = this.a(param1 + 238);
          ...
          L5: {
            ...
            stackOut_22_1 = new StringBuilder().append("jk.H(");
    ...
    final static ob a(String param0, byte param1) {
        ...
        ob stackOut_41_0 = null;
        ob stackOut_46_0 = null;
        ...
        try {
          ...
          L11: {
            ...
            stackOut_52_1 = new StringBuilder().append("jk.G(");
