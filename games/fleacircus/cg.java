...
final class cg extends gi {
              ...
              if (((cg) this).field_t) {
                ...
                L2: while (true) {
                  if (var3 == null) {
                    L3: while (true) {
                      L4: {
                        if (((cg) this).field_l >= ((cg) this).field_j.field_f.length) {
                          break L4;
                        } else {
                          L5: {
                            if (((cg) this).field_j.field_f[((cg) this).field_l] == 0) {
                              break L5;
                            } else {
                              if (((cg) this).field_o.field_d >= 250) {
                                ...
                                L6: {
                                  if (((cg) this).field_i[((cg) this).field_l] == 0) {
                                    dl discarded$4 = this.a(2, 1, ((cg) this).field_l);
                                    break L6;
                                  } else {
                                    break L6;
                                  }
                    ...
                    L7: {
                      ...
                      if (0 == ((cg) this).field_i[var4]) {
                        dl discarded$5 = this.a(2, 1, var4);
                        break L7;
                      } else {
                        break L7;
                      }
                ...
                if (!((cg) this).field_q) {
                  ...
                  L9: while (true) {
                    if (var3 == null) {
                      L10: while (true) {
                        L11: {
                          if (((cg) this).field_j.field_f.length <= ((cg) this).field_l) {
                            break L11;
                          } else {
                            if (((cg) this).field_j.field_f[((cg) this).field_l] != 0) {
    ...
    final static void a(java.math.BigInteger param0, int param1, ni param2, ni param3, java.math.BigInteger param4) {
        try {
            ...
            int discarded$0 = -60;
            qi.a(param4, param2.field_i, 0, param2.field_k, param3, param0);
                  ...
                  if (var5 == null) {
                    ...
                    if (2 < var5.length) {
                      ...
                      if (var6_int == ((cg) this).field_j.field_u[param2]) {
                        ...
                        var7_int = ((var5[-2 + var5.length] & 255) << 8) + (var5[var5.length + -1] & 255);
                        if ((65535 & ((cg) this).field_j.field_n[param2]) != var7_int) {
                          throw new RuntimeException();
                        } else {
                          L16: {
                            if (((cg) this).field_i[param2] != -2) {
                              L17: {
                                if (-1 != ((cg) this).field_i[param2]) {
                                  break L17;
                                } else {
                                  break L17;
                                }
    ...
    final void a(boolean param0) {
        ...
        lh var2 = ((cg) this).field_s.c((byte) 47);
        while (var2 != null) {
                ...
                if (((cg) this).field_j.field_i <= var3) {
                    ...
                    if (((cg) this).field_j.field_f[var3] == 0) {
                        ...
                        if (!(((cg) this).field_i[var3] != 0)) {
                            dl discarded$0 = this.a(2, 1, var3);
                        }
                        if (!(((cg) this).field_i[var3] != -1)) {
                            dl discarded$1 = this.a(2, 2, var3);
                        }
                        if (((cg) this).field_i[var3] == 1) {
                            var2.c(-1);
                        }
