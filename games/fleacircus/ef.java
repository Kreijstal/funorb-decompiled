    ...
    final static void a(sg param0, byte param1) {
        ...
        try {
              ...
              L4: while (true) {
                L5: {
                  L6: {
                    L7: {
                      if (var2_int >= qb.field_a) {
                        ...
                        if (var5 != 0) {
                          ...
                          L8: {
                            if (var6 == var7) {
                              dupTemp$4 = vg.field_H[var2_int].b(0);
                    ...
                    dupTemp$5 = param0.b(0);
                    bd.field_ob[dupTemp$5] = bd.field_ob[dupTemp$5] + 1;
                    if (param1 < -27) {
                      break L5;
                    } else {
                      break L6;
                ...
                L9: while (true) {
                  ...
                  fieldTemp$7 = qb.field_a;
                  qb.field_a = qb.field_a + 1;
                  vg.field_H[fieldTemp$7] = param0;
                  break L0;
                }
              }
            }
          ...
          L14: {
            ...
            stackOut_30_1 = new StringBuilder().append("ef.I(");
    ...
    final static boolean a(byte param0, String param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("ef.H(").append(param0).append(',');
