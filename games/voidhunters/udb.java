...
final class udb extends rqa {
    final static tv a(Class[] param0, dja[] param1, Class param2, int param3) {
        ...
        try {
              ...
              L1: while (true) {
                if (var4_int < param0.length) {
                  if (param0[var4_int] != param2) {
                    ...
                    stackOut_7_0 = param1[var4_int].a((byte) 39);
          ...
          L2: {
            ...
            stackOut_11_1 = new StringBuilder().append("udb.B(");
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 <= -119) {
              stackOut_3_0 = new nc(frb.a(174, 108));
