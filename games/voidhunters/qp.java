...
final class qp {
    ...
    private final void a(byte param0, byte[] param1) {
        ...
        try {
                    ...
                    if (var4 < 7) {
                      ...
                      L7: while (true) {
                        if (~var10 <= ~((qp) this).field_f) {
                          ...
                          L8: {
                            int dupTemp$4 = var8 + var3_ref.e(1869);
                            var8 = dupTemp$4;
                            ((qp) this).field_i[var10] = dupTemp$4;
                      ...
                      L9: while (true) {
                        if (((qp) this).field_f <= var10) {
                          ...
                          L10: {
                            int dupTemp$5 = var8 + var3_ref.n(-24099);
                            var8 = dupTemp$5;
                                    ...
                                    if (~((qp) this).field_f >= ~var10) {
                                      ...
                                      L22: while (true) {
                                        if (~var14 <= ~var12) {
                                          ...
                                          L24: {
                                            int dupTemp$6 = var8 + var3_ref.e(1869);
                                            var8 = dupTemp$6;
                                            ((qp) this).field_g[var11][var14] = dupTemp$6;
                                            var15 = dupTemp$6;
                                            if (~var13 > ~var15) {
                                              var13 = var15;
                                              break L24;
                                    ...
                                    if (var10 >= ((qp) this).field_f) {
                                      ...
                                      L27: while (true) {
                                        if (var14 >= var12) {
                                          ...
                                          L29: {
                                            int dupTemp$7 = var8 + var3_ref.n(-24099);
                                            var8 = dupTemp$7;
                                            ((qp) this).field_g[var11][var14] = dupTemp$7;
                                            var15 = dupTemp$7;
                                            if (~var15 >= ~var13) {
                                              break L29;
                                            } else {
          ...
          L35: {
            ...
            stackOut_144_1 = new StringBuilder().append("qp.A(").append(27).append(',');
    ...
    final static vu a(boolean param0, int param1, int param2) {
        ...
        try {
          L0: {
            ...
            L2: {
              ...
              if (iwa.field_b != 2) {
                ...
                rtb.field_h.field_R = isa.a(qna.field_o, new String[1], 91);
                ...
                L4: while (true) {
                  if (null == var7) {
                    ...
                    L12: {
                      ...
                      var7.field_wb.a(var13, 123, var14, var9, nna.field_w);
                            ...
                            if (qs.a(0, cka.field_o.field_a)) {
                              ...
                              if (erb.field_p) {
                                ...
                                L19: {
                                  if (!hb.field_c) {
                                    var17 = cka.field_o;
                                    var18 = isa.a(qia.field_o, new String[1], 124);
          ...
          decompiledCaughtException = decompiledCaughtParameter0;
          var3 = decompiledCaughtException;
          throw rta.a((Throwable) (Object) var3, "qp.C(" + param0 + ',' + 2 + ',' + param2 + ')');
        }
        ...
        try {
            ...
            try {
              ...
              L3: {
                ...
                stackOut_12_1 = new StringBuilder().append("qp.B(").append(param0).append(',').append(0).append(',');
    ...
    qp(byte[] param0, int param1, byte[] param2) {
        ...
        try {
          L0: {
            int discarded$3 = 0;
            ((qp) this).field_k = psb.a(param0, param0.length);
