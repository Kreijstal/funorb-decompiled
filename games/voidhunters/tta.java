...
final class tta extends rqa {
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("tta.A(");
        ...
        try {
          L0: {
            if (param1.b((byte) 100)) {
              ...
              stackIn_4_0 = param3 + " - " + param1.b(-124) + "%";
          ...
          L1: {
            ...
            stackIn_7_1 = new StringBuilder().append("tta.B(").append(param0).append(',');
    ...
    public static void a(int param0) {
        ...
        if (param0 <= 71) {
            ...
            tta.a(-36, (asb) null, (String) null, (String) null);
        }
    }
