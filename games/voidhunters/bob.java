...
class bob implements wwa, at {
    ...
    private final void c(shb param0, byte param1) {
        ...
        try {
          L0: {
            ...
            L2: {
              var3_int = ((bob) this).b(param0, (byte) 110);
              ...
              if (var6 != 0) {
                if (var6 != 2) {
                  ...
                  var5 = ((bob) this).field_d.field_k + (-((bob) this).field_d.field_A + (-((bob) this).field_d.field_k + var4) >> 1);
                  break L2;
                } else {
                  ...
                  L5: {
                    if (var6 == 1) {
                      if (!(param0.field_d instanceof re)) {
                        ...
                        ((re) (Object) param0.field_d).a(-2661, var3_int >> 1, ((bob) this).b((byte) -97, param0), var5, ((bob) this).field_d);
                        return;
                      }
                    } else {
                      if (var6 == 2) {
                        if (!(param0.field_d instanceof re)) {
                          ...
                          ((re) (Object) param0.field_d).a(var5, ((bob) this).field_d, 49, var3_int, ((bob) this).b((byte) -56, param0));
                          return;
                        }
                      } else {
                        return;
          ...
          L6: {
            ...
            stackOut_29_1 = new StringBuilder().append("bob.CA(");
          ...
          throw rta.a((Throwable) (Object) stackIn_32_0, stackIn_32_2 + 44 + 87 + 41);
        }
    }
        ...
        try {
          L0: {
            L1: {
              ...
              var9_int = ((bob) this).b(param5, (byte) 81);
            ...
            L2: {
              if (!((bob) this).field_g) {
                L3: {
                  ...
                  if (var12 != 0) {
                    if (var12 == 2) {
                      ...
                      var11 = ((bob) this).field_d.field_k + (-((bob) this).field_d.field_A + var10 - ((bob) this).field_d.field_k >> 1);
                      break L3;
                    }
                  } else {
                ...
                L5: {
                  ...
                  if (0 != var12) {
                    if (var12 == 3) {
                      ...
                      if (var12 != 1) {
                        if (var12 == 2) {
                          ((bob) this).field_d.b(((bob) this).b((byte) -72, param5), var9_int + this.a(param6, param5, param0, (byte) -13), var11 + this.a(param7, -124, param5, param2), param4, param1);
                          break L2;
                        } else {
                          break L2;
                        }
                      } else {
                        ((bob) this).field_d.a(((bob) this).b((byte) -109, param5), (var9_int >> 1) + this.a(param6, param5, param0, (byte) -13), this.a(param7, -117, param5, param2) + var11, param4, param1);
                        break L2;
                      }
                    }
                  } else {
                ...
                int discarded$1 = ((bob) this).field_d.a(((bob) this).b((byte) -112, param5), this.a(param6, param5, param0, (byte) -13), this.a(param7, -117, param5, param2), var9_int, var10, param4, param1, ((bob) this).field_c, ((bob) this).field_n, ((bob) this).field_h);
                break L2;
              }
            }
            bia.a((byte) 124);
          ...
          L6: {
            ...
            stackOut_26_1 = new StringBuilder().append("bob.AA(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44).append(param4).append(44);
          ...
          throw rta.a((Throwable) (Object) stackIn_29_0, stackIn_29_2 + 44 + param6 + 44 + param7 + 41);
        }
    }
    ...
    private final int a(int param0, int param1, shb param2, int param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = param3 + (((bob) this).field_k + param0) - (-param2.field_r + -param2.field_i);
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("bob.FA(").append(param0).append(44).append(param1).append(44);
    ...
    private final int a(int param0, shb param1, int param2, byte param3) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = param2 + (((bob) this).field_f + param1.field_g + param0) + param1.field_s;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            var5 = decompiledCaughtException;
            stackOut_4_0 = (RuntimeException) var5;
            stackOut_4_1 = new StringBuilder().append("bob.BA(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
          ...
          throw rta.a((Throwable) (Object) stackIn_7_0, stackIn_7_2 + 44 + param2 + 44 + param3 + 41);
        }
        return stackIn_3_0;
    }
    ...
    public final int a(shb param0, byte param1) {
        ...
        try {
          L0: {
            ar discarded$2 = ((bob) this).a(param0, 3);
            var3_int = -15 % ((param1 - -1) / 59);
            stackOut_0_0 = param0.field_d.a(29565) - (-((bob) this).field_k + -((bob) this).field_m);
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("bob.I(");
    ...
    public final int b(shb param0, byte param1) {
        ...
        try {
          L0: {
            if (param1 >= 66) {
              stackOut_3_0 = param0.field_h + (-((bob) this).field_f - ((bob) this).field_o);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("bob.M(");
            stackIn_7_0 = stackOut_5_0;
            stackIn_7_1 = stackOut_5_1;
    ...
    public final int a(int param0, int param1, int param2, int param3, shb param4, int param5) {
        ...
        try {
          L0: {
            L1: {
              ar discarded$8 = ((bob) this).a(param4, 3);
              if (param5 == -1) {
                break L1;
              } else {
                bob.b(38);
            ...
            stackOut_2_0 = param4.field_d.a(param1 + -((bob) this).b(-3, param2, param4), -23381, param0 - ((bob) this).a(0, param3, param4));
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("bob.F(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
          ...
          throw rta.a((Throwable) (Object) stackIn_7_0, stackIn_7_2 + 44 + param5 + 41);
        }
        return stackIn_3_0;
    }
    ...
    public final ar a(shb param0, int param1) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_9_1 = new StringBuilder().append("bob.D(");
    ...
    private final void a(int param0, shb param1, int param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param0 == 340287457) {
                ...
                var6 = null;
                int discarded$2 = this.a(-125, (shb) null, -85, (byte) -70);
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("bob.W(").append(param0).append(44);
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
            stackIn_4_0 = stackOut_3_0;
    ...
    final void a(int param0, bob param1) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "bob.EA(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    public final void b(int param0, int param1, int param2, int param3, shb param4, int param5) {
        ...
        try {
                ...
                L3: while (true) {
                  if (var11 < var12) {
                    ...
                    L4: {
                      ...
                      if (var10 == var12) {
                        stackOut_14_0 = var19.a(var8, -112);
                    ...
                    L5: {
                      var14 = stackIn_15_0;
                      if (var12 == var11) {
                        stackOut_19_0 = var19.a(var9, -124);
                        stackIn_20_0 = stackOut_19_0;
                        break L5;
                      } else {
                        if (var13 != null) {
                          stackOut_18_0 = var13.field_c[-1 + var13.field_c.length];
          ...
          L6: {
            ...
            stackOut_23_1 = new StringBuilder().append("bob.G(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
          ...
          throw rta.a((Throwable) (Object) stackIn_26_0, stackIn_26_2 + 44 + param5 + 41);
        }
    }
    ...
    public final int a(int param0, int param1, shb param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("bob.H(").append(param0).append(44).append(param1).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    public final int a(int param0, shb param1) {
        ...
        try {
          L0: {
            ...
            ar discarded$2 = ((bob) this).a(param1, 3);
            stackOut_2_0 = param1.field_d.c(-18877) + ((bob) this).field_f - -((bob) this).field_o;
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("bob.J(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    private final int a(byte param0, shb param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = param1.field_f - (((bob) this).field_k + ((bob) this).field_m);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            var3 = decompiledCaughtException;
            stackOut_4_0 = (RuntimeException) var3;
            stackOut_4_1 = new StringBuilder().append("bob.DA(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    public void a(int param0, shb param1, int param2, int param3, boolean param4) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "bob.A(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    public final int b(int param0, int param1, shb param2) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = this.a(param1, param0 + -114, param2, 0);
            stackIn_3_0 = stackOut_2_0;
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          ...
          L2: {
            var4 = decompiledCaughtException;
            stackOut_4_0 = (RuntimeException) var4;
            stackOut_4_1 = new StringBuilder().append("bob.L(").append(param0).append(44).append(param1).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    String b(byte param0, shb param1) {
        ...
        try {
          ...
          L2: {
            var3 = decompiledCaughtException;
            stackOut_4_0 = (RuntimeException) var3;
            stackOut_4_1 = new StringBuilder().append("bob.C(").append(param0).append(44);
            stackIn_6_0 = stackOut_4_0;
            stackIn_6_1 = stackOut_4_1;
            stackIn_5_0 = stackOut_4_0;
            stackIn_5_1 = stackOut_4_1;
    ...
    public final void a(shb param0, int param1, byte param2, int param3, int param4) {
        ...
        try {
              ...
              if (param0.e((byte) -120)) {
                L2: {
                  ...
                  if (1 + var7 < var14.field_c.length) {
                    ...
                    stackOut_4_3 = var13.field_c[var7 - -1].field_b;
                    stackIn_5_0 = stackOut_4_0;
                    stackIn_5_1 = stackOut_4_1;
                    stackIn_5_2 = stackOut_4_2;
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("bob.E(");
          ...
          throw rta.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 41);
        }
    }
    ...
    bob(no param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int param9, int param10, int param11, boolean param12) {
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "bob.<init>(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 44 + param6 + 44 + param7 + 44 + param8 + 44 + param9 + 44 + param10 + 44 + param11 + 44 + param12 + 41);
        }
    }
