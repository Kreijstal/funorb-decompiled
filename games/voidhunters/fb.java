...
final class fb extends rqa {
              ...
              if (var2 != 0) {
                if (var2 != 1) {
                  if (var2 != 2) {
                    ...
                    var13 = (iea) (Object) klb.field_q.d(0);
                    if (var13 == null) {
                      ifb.l(-119);
                      return;
                    } else {
                      int[] discarded$2 = oea.f((byte) -80);
                      var13.b(-3846);
                      break L1;
                    }
                  }
    ...
    final static String a(byte[] param0) {
        ...
        try {
          L0: {
            stackOut_2_0 = ac.a(1, param0.length, 0, param0);
          ...
          L1: {
            ...
            stackOut_4_1 = new StringBuilder().append("fb.D(");
