...
final class wf {
    ...
    private final void b(int param0, byte param1) {
        ...
        if (0 == this.field_c) {
            ...
            if (this.field_c == 1 || 2 == this.field_c || this.field_c == 3 || this.field_c == 4 || (this.field_c ^ -1) == -10) {
                var3 = 200;
            }
        }
        int var4 = 36;
        int var5 = (-dma.field_g + ip.field_p.width) / 2;
        var3 = var3 + var5;
        int var6 = (ip.field_p.height + -dma.field_j) / 2;
        var4 = var4 + var6;
        int var7 = pob.field_b;
        if (param1 != -61) {
            this.field_b = (ae) null;
        }
        int var8 = 0;
        if (-17 >= (var7 ^ -1)) {
    ...
    private final String a(String param0, byte param1, String param2, int param3) {
        ...
        try {
          L0: {
            ...
            stackIn_3_0 = jd.a(param2, param0, 0, "<col=ffaa00>" + bpb.field_q[param3] + "</col>");
            break L0;
          }
          ...
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("wf.M(");
          ...
          throw rta.a((Throwable) ((Object) stackIn_7_0), stackIn_10_2 + ',' + param3 + ')');
        }
        return stackIn_3_0;
    }
          ...
          if (!this.field_b.b((byte) 123)) {
            L4: {
              if (pma.field_o != 96) {
                ...
                if (this.field_b.field_j > var2) {
                  this.field_b.a((byte) -17, -1 + this.field_b.field_j);
                  break L4;
                } else {
                  this.field_b.a((byte) -17, var3);
                  break L4;
                }
              }
            }
            if ((pma.field_o ^ -1) == -98) {
              L5: {
                if (this.field_b.field_j < 0) {
                  break L5;
                } else {
                  if (var3 <= this.field_b.field_j) {
                    break L5;
                  } else {
                    this.field_b.a((byte) -17, 1 + this.field_b.field_j);
                    this.field_b.c(-19255);
                    break L3;
                  }
                }
              }
              this.field_b.a((byte) -17, var2);
              this.field_b.c(-19255);
              break L3;
            } else {
              this.field_b.c(-19255);
    ...
    private final int c(int param0, int param1) {
        ...
        if (0 != this.field_c) {
            ...
            if (param0 >= 2) {
                ...
                return var3 + vba.field_s[this.field_c] + (5 + var4) * param0;
            }
        }
        if (5 == this.field_c) {
            return vba.field_s[this.field_c] + var3;
        }
        return vba.field_s[this.field_c] + var3 - -(param0 * vba.field_o[this.field_c]);
    }
    ...
    private final void a(int param0, boolean param1, int param2) {
        ...
        L0: {
          ...
          var4 = pob.field_b;
          var5 = 2;
          var6 = vba.field_p[this.field_c][param0];
          var7 = vba.field_p[this.field_c].length;
        ...
        L16: {
          var17 = -var10 + var12 + var13 >> 678852897;
        ...
        L21: {
          ...
          if (var16 != 0) {
            L22: {
              ...
              if (-14 != (var6 ^ -1)) {
                stackIn_91_0 = var10 * hlb.field_p / 256;
                break L22;
              } else {
                stackIn_91_0 = var10 * kt.field_l / 256;
                break L22;
              }
            }
            L23: {
            ...
            L24: {
              ...
              if (param1) {
                stackIn_85_0 = 15658751;
                break L24;
              } else {
                stackIn_85_0 = 13421772;
                break L24;
              }
            }
            L25: {
    ...
    final void a(boolean param0, int param1, int param2) {
        ...
        if (0 != (this.field_b.field_j ^ -1)) {
            if (this.a(this.field_b.field_j, 117)) {
                param2 = this.field_b.field_j;
            }
        }
        this.field_b.a(param0, -1, param2, this.a(uia.field_b, kc.field_b, param1 ^ 7060));
    ...
    final int a(int param0, int param1, int param2) {
        ...
        L1: while (true) {
          if (vba.field_p[this.field_c].length <= var4) {
            return -1;
          } else {
    ...
    private final void b(int param0, boolean param1, int param2) {
        ...
        int var12_int;
        String var13;
        java.awt.datatransfer.StringSelection var13_ref;
        String var14;
        int var15;
        int[] var16;
        String var18;
        ...
        L0: {
          ...
          var4 = 1;
          var5 = vba.field_p[this.field_c][param2];
          var10_int = var5;
          if (var10_int != 0) {
            if (var10_int == 1) {
              if (this.field_b.e((byte) -126)) {
                if (fda.e((byte) 85)) {
                  iba.a(dsb.field_p, 2, (byte) -115, 320, ck.field_o, param1, wc.field_d, 0, 8, true, dsb.field_p.field_o, dra.field_v, 240, 8, dsb.field_p.field_A + dsb.field_p.field_o);
                  break L0;
                } else {
                          ...
                          if (var10_int != 21) {
                            if (-14 != (var10_int ^ -1)) {
                              if (var10_int != 14) {
                                  ...
                                  if (19 == var10_int) {
                                    ...
                                    if (var8 != 0) {
                                      ...
                                      if (!ef.field_E) {
                                        ...
                                        bea.a((byte) 114, "graphics_quality", jha.field_p);
                                        qra.a(-96);
                                        break L0;
                                      }
                                    } else {
                                                ...
                                                if ((var10_int ^ -1) != -18) {
                                                  if ((var10_int ^ -1) == -19) {
                                                    ...
                                                    if (this.a(param2, 125)) {
                                                      ...
                                                      if (!param1) {
                                                        this.field_b.field_j = this.field_b.field_j - 1;
                                                        break L0;
                                                      } else {
                                                        break L0;
                                                      }
                                                                      ...
                                                                      if (var18.length() == 0) {
                                                                        ...
                                                                        L12: {
                                                                          ...
                                                                          if (var19 == null) {
                                                                            ...
                                                                            var13 = var14;
                                                                            var13 = var14;
                                                                            if (var14.equals("wtwip")) {
                                                                              var13 = "games-wtwip.jagex.com";
                                                                              break L12;
                                                                            } else {
                                                                              if (!var14.equals("wtqa")) {
                                                                                if (var14.equals("wtrc")) {
                                                                        ...
                                                                        bm.field_o.a((byte) -45, (java.awt.datatransfer.Transferable) ((Object) var13_ref));
                                                                        wh.field_n = 100;
                                                                        var4 = 1;
                                ...
                                L19: {
                                  if (this.field_b.d(param0 + 12441)) {
                                    re.a(256, (byte) -104);
                                    break L19;
                                  } else {
                                    break L19;
                                ...
                                L20: {
                                  if (this.field_b.b((byte) 111)) {
                                    var10_int = this.b(31488, param2) + (this.a((byte) -76, param2) + -wrb.a(100, 131)) >> 1867720897;
                                ...
                                if (hlb.field_p == var7) {
                                  ...
                                  if (ef.field_E) {
                                    bea.a((byte) -22, "music_volume", hlb.field_p);
                                    qra.a(-122);
                                    break L0;
                                  } else {
                                    break L0;
                              ...
                              L25: {
                                if (this.field_b.b((byte) 126)) {
                                  var10_int = this.b(31488, param2) - (-this.a((byte) -79, param2) + wrb.a(100, 131)) >> -294120575;
                                  var11 = kc.field_b - var10_int;
                              ...
                              if (var6 == 0) {
                                ...
                                if (!ef.field_E) {
                                  ...
                                  bea.a((byte) 3, "fx_volume", kt.field_l);
                                  qra.a(-108);
                                  break L0;
                                }
                              }
        ...
        L33: {
          if (var4 == 0) {
            ...
            if (this.field_b.e((byte) -102)) {
              lha.a(param0 ^ -106, fa.field_d[7]);
              break L33;
            } else {
              break L33;
            }
        ...
        if ((this.field_c ^ -1) != -8) {
          ...
          L1: {
            if (param0 == 65) {
              ...
              var8 = (String) null;
              discarded$0 = this.a((String) null, (byte) -83, (String) null, -38);
              break L1;
            }
          }
          var2 = 0;
              ...
              L3: {
                if (5 == this.field_c) {
                  ...
                  if (-7 == (this.field_c ^ -1)) {
                    ...
                    nua.a(-1, 1000, 80 + var5_int, pqa.a(false, var2), 0, iia.field_c, 8555923, 480, -32, 160 + var6, 0, var2);
                    break L3;
                  } else {
                    break L3;
                  }
    ...
    private final int b(int param0, int param1) {
        ...
        int var4 = 0;
        if (param0 != 31488) {
            discarded$0 = this.a((byte) -10, -10);
        }
        int var3 = (ip.field_p.width - dma.field_g) / 2;
        if (this.field_c == 5) {
            return 190 * param1 + var3 + vba.field_r[this.field_c];
        }
        if (!(0 != this.field_c)) {
            if (-3 < (param1 ^ -1)) {
            ...
            return 25 + var3 + vba.field_r[this.field_c];
        }
        return vba.field_r[this.field_c] - -var3;
    }
    ...
    private final boolean a(int param0, int param1) {
        ...
        if (param0 == 2 && op.field_o == mb.field_k.length - 1) {
            return false;
        }
        return true;
    }
    ...
    private final void a(byte param0) {
        ...
        L0: {
          var6 = VoidHunters.field_G;
          if (si.field_o[13]) {
            var2 = vba.field_p[this.field_c].length;
            var3 = 0;
            L1: while (true) {
              if (var2 <= var3) {
                break L0;
              } else {
                var4 = vba.field_p[this.field_c][var3];
                if ((var4 ^ -1) == -7) {
                  var5 = he.field_o;
    ...
    private final int a(byte param0, int param1) {
        ...
        if (this.field_c == 0 && param1 < 2) {
            return ip.field_p.width / 2;
        }
        return vba.field_q[this.field_c] + var3;
    }
              ...
              if (lu.field_d) {
                ...
                if (!dua.field_o) {
                  L3: while (true) {
                    if (!ata.e(127)) {
                      L4: {
                        var2 = this.field_b.field_j;
                        this.field_b.a(this.a(qs.field_a, oq.field_H, 6868), 5620, this.a(uia.field_b, kc.field_b, param0 ^ 6868));
                        if (this.field_b.field_j < 0) {
                          break L4;
                        } else {
                          if (var2 == this.field_b.field_j) {
                            break L4;
                          } else {
                            lha.a(-124, fa.field_d[0]);
                            break L4;
                          }
                        }
                      }
                      if (0 == (this.field_b.field_j ^ -1)) {
                        ...
                        this.b(24, true, this.field_b.field_j);
                        break L2;
                      }
                    } else {
                      if (!qmb.a(-22029)) {
                        if (pma.field_o == 13) {
                          ...
                          L7: {
                            var2 = this.field_b.field_j;
                            this.a((byte) -51);
                            if (0 > this.field_b.field_j) {
                              break L7;
                            } else {
                              if (var2 == this.field_b.field_j) {
                                break L7;
                              } else {
                                lha.a(-110, fa.field_d[0]);
                                break L7;
                              }
                            }
                          }
                          if ((this.field_b.field_j ^ -1) == 0) {
                            continue L3;
                          } else {
                            this.b(24, false, this.field_b.field_j);
                            continue L3;
                          }
                        }
                      } else {
    ...
    private final int a(int param0, byte param1) {
        int discarded$0 = 0;
        if (this.field_c == 0 && -3 < (param0 ^ -1)) {
            return vba.field_o[this.field_c] + 30;
        }
        if (param1 != 70) {
            discarded$0 = this.c(-81, -122);
        }
        return 30;
    }
    ...
    wf(int param0) {
        this.field_c = param0;
        this.field_b = new ae(vba.field_p[this.field_c].length);
    }
