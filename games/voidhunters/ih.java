...
final class ih extends wm implements ntb, hd {
    ...
    final int a(byte param0, int param1) {
        ...
        if (param1 != 0) {
            return ((ih) this).field_d;
        }
        return ((ih) this).field_c;
    }
        ...
        try {
          L0: {
            if (param0 == ~((ih) this).field_c) {
                ...
                if (var6 >= var5.length) {
                  ...
                  L2: {
                    ...
                    if (var7 == null) {
                      ...
                      if (var7.q((byte) 120) != ((ih) this).field_d) {
                        break L2;
                      } else {
                        if (var7.l((byte) -10)) {
                          break L2;
              ...
              L3: {
                var10 = param2.d(param0 ^ 1000)[((ih) this).field_c];
                var4 = var10;
                if (var4 == null) {
                  break L3;
                } else {
                  if (var10.q((byte) 86) != ((ih) this).field_d) {
                    break L3;
                  } else {
                    if (var10.l((byte) -10)) {
                      break L3;
                    } else {
                      if (-1 == var10.o((byte) -117)) {
                        break L3;
                      } else {
                        return true;
                      }
          ...
          L4: {
            ...
            stackOut_21_1 = new StringBuilder().append("ih.G(").append(param0).append(44);
          ...
          L0: {
            L1: {
              if (((ih) this).field_c == -1) {
                ...
                var4 = param0.d(1000)[((ih) this).field_c];
                var3 = var4;
                if (var3 != null) {
    ...
    public final void a(faa param0, boolean param1) {
        try {
            ...
            ((ih) this).field_c = param0.i(0, 32);
            ((ih) this).field_d = param0.i(0, 32);
        } catch (RuntimeException runtimeException) {
            throw rta.a((Throwable) (Object) runtimeException, "ih.H(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final void a(pe param0, int param1, int param2, int param3) {
        ...
        try {
          L0: {
            L1: {
              if (param1 == -2) {
                ...
                var11 = null;
                int[] discarded$2 = ((ih) this).a(57, (int[]) null);
                break L1;
              }
            }
            L2: {
              if (param2 == 0) {
                ...
                L4: while (true) {
                  if (var7 == var8) {
                    ...
                    ((ih) this).field_c = var8;
                    break L2;
                  }
                }
              } else {
                ((ih) this).field_d = (so.field_b + param3) % so.field_b;
                break L2;
              }
            }
            break L0;
          ...
          throw rta.a((Throwable) (Object) stackIn_21_0, stackIn_21_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
    }
    ...
    public final boolean a(byte param0, tv param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("ih.C(").append(param0).append(44);
    ...
    public final void b(faa param0, int param1) {
        ...
        try {
            super.b(param0, -122);
            param0.a(-632, ((ih) this).field_c, 32);
            param0.a(-632, ((ih) this).field_d, 32);
        } catch (RuntimeException runtimeException) {
            throw rta.a((Throwable) (Object) runtimeException, "ih.B(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final int[] a(pe param0, int param1, int[] param2) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_13_1 = new StringBuilder().append("ih.J(");
    ...
    public final void a(tv param0, int param1) {
        ...
        try {
          L0: {
            L1: {
              super.a(param0, -86);
              var6 = (ih) (Object) param0;
              if (param1 < -19) {
                break L1;
              } else {
                var5 = null;
                ((ih) this).b((faa) null, -126);
                break L1;
              }
            }
            L2: {
              var4 = 0;
              if (((ih) this).field_c == var6.field_c) {
                break L2;
              } else {
                System.out.println("int ship_id has changed. before=" + var6.field_c + ", now=" + ((ih) this).field_c);
                var4 = 1;
                break L2;
              }
            }
            L3: {
              if (((ih) this).field_d != var6.field_d) {
                var4 = 1;
                System.out.println("int team_id has changed. before=" + var6.field_d + ", now=" + ((ih) this).field_d);
                break L3;
              } else {
                break L3;
              }
    ...
    public final int[] a(int param0, int[] param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("ih.N(").append(param0).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
    ...
    final String a(int param0) {
        String var2 = "Ship " + ((ih) this).field_c;
        if (((ih) this).field_c == param0) {
            var2 = "Any ship";
        }
        return var2 + " in team " + ((ih) this).field_d;
    }

    ih(int param0, int param1) {
        ((ih) this).field_d = param1;
        ((ih) this).field_c = param0;
    }
    ...
    public final void b(byte param0, tv param1) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "ih.D(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
