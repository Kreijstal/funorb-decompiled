...
final class sl implements dja {
    ...
    final static ha a(d param0, byte param1, int param2, java.awt.Canvas param3) {
        ...
        try {
          L0: {
            if (param1 == 16) {
              stackOut_3_0 = new qfa(param3, param0, param2);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("sl.E(");
    ...
    final static void a(byte param0, tjb param1) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "sl.C(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
