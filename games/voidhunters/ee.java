...
final class ee extends rqa {
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 <= -119) {
              stackOut_3_0 = new nc(frb.a(75, 94));
    ...
    static {
        ...
        field_q = new String[][]{new String[]{"War - Build and destroy", "Blueprints - Use your blueprint ship (6 players max)", "Sandbox - Freeform building with your friends (4 players max)"}};
        field_p = 0;
        field_r = "Kick";
    }
}
