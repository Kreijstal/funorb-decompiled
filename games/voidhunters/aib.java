...
final class aib implements ntb, ofa, utb {
    ...
    public final void b(byte param0, tv param1) {
        ...
        try {
          L0: {
            ...
            if ((this.field_d ^ -1) == (var3.field_d ^ -1)) {
              ...
              var3.field_a = (crb[]) ((Object) sqb.a(var3.field_a, this.field_a, 1, tob.field_o, false));
    ...
    final void a(int param0) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              L2: {
                if (var2_int >= this.field_a.length) {
                  break L2;
                } else {
                  this.field_a[var2_int] = null;
                  var2_int++;
                  if (var4 == 0) {
                    continue L1;
                  } else {
    ...
    final static void a(byte param0, asb param1) {
        ...
        StringBuilder stackIn_1174_1 = null;
        String stackIn_1174_2 = null;
        int decompiledRegionSelector0 = 0;
        ...
        try {
          ...
          throw rta.a((Throwable) ((Object) stackIn_1174_0), stackIn_1174_2 + ')');
        }
        if (decompiledRegionSelector0 == 0) {
          return;
        } else {
    ...
    public final void a(faa param0, boolean param1) {
        ...
        try {
          L0: {
            ...
            this.a(stackIn_7_1 != 0);
            this.field_a = (crb[]) ((Object) kcb.a(10, tob.field_o, param0, 1, -70, this.field_a));
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          ...
          L0: {
            L1: {
              if (param1 == 16520) {
                ...
                this.b((byte) -73, (tv) null);
                break L1;
              }
            }
            L2: {
              var4_int = param0.a(param1 + 13131, param2, this.field_a, 2) ? 1 : 0;
              if (var4_int == 0) {
                break L2;
              } else {
                this.b(param1 ^ -16566);
    ...
    public final void a(faa param0, int param1) {
        ...
        try {
          L0: {
            ...
            this.field_a = (crb[]) ((Object) pt.a(param1 ^ 35, 1, this.field_a, tob.field_o, 10, param0));
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
