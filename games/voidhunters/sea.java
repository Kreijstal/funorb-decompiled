...
final class sea extends rqa {
    ...
    final static void a(int param0, int param1, int param2, int param3, String param4, int param5, int param6) {
        ...
        try {
          L0: {
            L1: {
              hs.a(param2, param5, param1, false, param0, -1, param4, nua.field_p);
              if (param3 == 180) {
                break L1;
              } else {
                field_o = 96;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("sea.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
          ...
          throw rta.a((Throwable) (Object) stackIn_6_0, stackIn_6_2 + 44 + param5 + 44 + -1 + 41);
        }
    }
