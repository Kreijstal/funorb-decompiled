          ...
          L0: {
            L1: {
              if (param1 <= -119) {
                ...
                var4 = (nc[]) null;
                discarded$2 = this.a((nc[]) null, -101);
                break L1;
              }
            }
            stackOut_2_0 = new nc(frb.a(193, 108));
    ...
    final static void a(String[] args, byte[] param1, asb param2, asb param3, asb param4, phb[][] param5, String[] param6, int param7, String[][] param8, byte[] param9, int param10, int param11, boolean param12, int[] param13, int param14, int[] param15, String[][] param16, phb[][] param17, caa[] param18) {
        ...
        try {
          ...
          L10: {
            ...
            stackOut_29_1 = ((StringBuilder) (Object) stackIn_29_1).append(stackIn_29_2).append(',').append(param10).append(',').append(param11).append(',').append(param12).append(',');
          ...
          L11: {
            ...
            stackOut_32_1 = ((StringBuilder) (Object) stackIn_32_1).append(stackIn_32_2).append(',').append(param14).append(',');
