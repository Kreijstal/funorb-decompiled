...
final class db extends rqa {
    ...
    final static void a(java.awt.Frame param0, eab param1, byte param2) {
        ...
        try {
          L0: {
            L1: while (true) {
              var3 = param1.a(param0, (byte) 102);
              L2: while (true) {
                if (0 != var3.field_f) {
                  if (var3.field_f == 1) {
                    param0.setVisible(false);
                    param0.dispose();
                    var3_int = -124 % ((param2 - 76) / 32);
                    break L0;
                  } else {
                    gdb.b(-58, 100L);
                    continue L1;
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("db.E(");
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = new nc((Object) (Object) frb.a(193, 108));
    ...
    final static void a(String[] args, byte[] param1, asb param2, asb param3, asb param4, phb[][] param5, String[] param6, int param7, String[][] param8, byte[] param9, int param10, int param11, boolean param12, int[] param13, int param14, int[] param15, String[][] param16, phb[][] param17, caa[] param18) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("db.C(");
          ...
          L10: {
            ...
            stackOut_29_1 = ((StringBuilder) (Object) stackIn_29_1).append(stackIn_29_2).append(',').append(8).append(',').append(1).append(',').append(true).append(',');
          ...
          L11: {
            ...
            stackOut_32_1 = ((StringBuilder) (Object) stackIn_32_1).append(stackIn_32_2).append(',').append(1).append(',');
