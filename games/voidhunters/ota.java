...
final class ota {
    ...
    final void a(float[] param0, int param1) {
        ...
        int stackOut_8_1 = 0;
        int stackOut_8_2 = 0;
        var3 = ((ota) this).field_e.length;
        var4 = field_g[((ota) this).field_d - 1];
        var5 = field_j;
        field_j[1] = true;
        var5[0] = true;
        var6 = 2;
        L0: while (true) {
          if (var6 >= var3) {
            this.a(0, var3 - 1);
            var6 = 0;
            var7 = field_h[0] * ((ota) this).field_d;
            var16 = 1;
            var8_int = var16;
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_j[var16]) {
                  var9 = field_i[var16];
                  var10 = field_h[var16] * ((ota) this).field_d;
            ...
            L3: {
              var7 = ota.b(field_i, var6);
              var8_int = ota.a(field_i, var6);
              var9 = this.a(field_i[var7], field_h[var7], field_i[var8_int], field_h[var8_int], field_i[var6]);
              var10 = field_h[var6];
              var11 = var4 - var9;
              var12 = var9;
              if (var11 >= var12) {
    ...
    final boolean b() {
        ...
        int var12 = 0;
        int var13 = 0;
        int var1 = fca.c() != 0 ? 1 : 0;
        if (var1 == 0) {
            return false;
        }
        int var2 = ((ota) this).field_e.length;
        System.arraycopy((Object) (Object) ((ota) this).field_e, 0, (Object) (Object) field_i, 0, var2);
        int var3 = field_g[((ota) this).field_d - 1];
        int var4 = ieb.a(var3 - 1, 103);
        field_h[0] = fca.c(var4);
        field_h[1] = fca.c(var4);
        int var5 = 2;
        for (var6 = 0; var6 < ((ota) this).field_b.length; var6++) {
            var7 = ((ota) this).field_b[var6];
            var8 = ((ota) this).field_c[var7];
            var9 = ((ota) this).field_l[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = fca.field_s[((ota) this).field_f[var7]].b();
            }
    ...
    ota() {
        ...
        if (var1 == 1) {
          var2 = fca.c(5);
          var3 = 0;
          ((ota) this).field_b = new int[var2];
          var4 = 0;
          L0: while (true) {
            if (var4 >= var2) {
              ((ota) this).field_c = new int[var3];
              ((ota) this).field_l = new int[var3];
              ((ota) this).field_f = new int[var3];
              ((ota) this).field_k = new int[var3][];
              var4 = 0;
              L1: while (true) {
                if (var4 >= var3) {
                  ((ota) this).field_d = fca.c(2) + 1;
                  var4 = fca.c(4);
                  var5 = 2;
                  var6 = 0;
                  L2: while (true) {
                    if (var6 >= var2) {
                      ((ota) this).field_e = new int[var5];
                      ((ota) this).field_e[0] = 0;
                      ((ota) this).field_e[1] = 1 << var4;
                      var5 = 2;
                      var6 = 0;
                      L3: while (true) {
                        if (var6 >= var2) {
                      ...
                      var5 = var5 + ((ota) this).field_c[((ota) this).field_b[var6]];
                      var6++;
                      continue L2;
                    }
                  }
