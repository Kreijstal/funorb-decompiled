...
final class ota {
          ...
          if (var6 >= var3) {
            ...
            L1: while (true) {
              if (var16 >= var3) {
                ...
                if (field_j[var16]) {
                  var9 = field_i[var16];
                  var10 = field_h[var16] * this.field_d;
    ...
    final boolean b() {
        ...
        System.arraycopy(this.field_e, 0, field_i, 0, var2);
        int var3 = field_g[this.field_d - 1];
        ...
        for (var6 = 0; var6 < this.field_b.length; var6++) {
            ...
            var9 = this.field_l[var7];
            var10 = (1 << var9) - 1;
            var11 = 0;
            if (var9 > 0) {
                var11 = fca.field_s[this.field_f[var7]].b();
            }
                ...
                if (var4 >= var3) {
                  ...
                  L2: while (true) {
                    if (var6 >= var2) {
                        ...
                        if (var6 >= var2) {
                          ...
                          L6: while (true) {
                            if (var8 >= this.field_c[var7]) {
                              ...
                              var5++;
                              this.field_e[incrementValue$2] = fca.c(var4);
                              var8++;
                              continue L6;
                            }
                          }
                      ...
                      var5 = var5 + this.field_c[this.field_b[var6]];
                      var6++;
                      continue L2;
                    }
                  }
                  ...
                  L7: {
                    this.field_c[var4] = fca.c(3) + 1;
                    dupTemp$3 = fca.c(2);
                    this.field_l[var4] = dupTemp$3;
                    var5 = dupTemp$3;
                    if (var5 == 0) {
                      break L7;
                    } else {
                      this.field_f[var4] = fca.c(8);
                      break L7;
                    }
                  }
                  var5 = 1 << var5;
