...
final class vga {
    ...
    final int c(int param0) {
        ...
        int var2 = param0;
        fh var3 = ((vga) this).field_c.field_e;
        while (var3 != ((vga) this).field_c) {
            var2++;
            var3 = var3.field_e;
        }
        return var2;
    ...
    final fh a(byte param0) {
        fh var2 = null;
        var2 = ((vga) this).field_c.field_e;
        if (((vga) this).field_c != var2) {
          ((vga) this).field_a = var2.field_e;
          if (param0 != -54) {
            fh discarded$2 = ((vga) this).a(77);
            return var2;
          } else {
            return var2;
          }
        } else {
          ((vga) this).field_a = null;
          return null;
        }
    }
    ...
    final fh b(int param0) {
        fh var2 = null;
        var2 = ((vga) this).field_c.field_d;
        if (var2 != ((vga) this).field_c) {
          if (param0 != 1) {
            fh discarded$2 = ((vga) this).a((byte) 3);
            var2.d((byte) -35);
            return var2;
          } else {
            var2.d((byte) -35);
    ...
    final fh a(int param0) {
        fh var2 = null;
        if (param0 != 1900) {
            String discarded$0 = vga.a(-33L, 30);
            var2 = ((vga) this).field_a;
            if (!(((vga) this).field_c != var2)) {
                ((vga) this).field_a = null;
                return null;
            }
    ...
    public vga() {
        ((vga) this).field_c = new fh();
        ((vga) this).field_c.field_d = ((vga) this).field_c;
        ((vga) this).field_c.field_e = ((vga) this).field_c;
    }
