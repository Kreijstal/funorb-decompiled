...
final class ft extends kt {
    ...
    final void a(int param0, byte param1, int param2) {
        ...
        if (param0 != 0) {
          ...
          var5 = 255 & param1;
          this.field_u[var4] = (byte)(3 * var5 >> 696092293);
          return;
        } else {
          var4 = param2 * 2;
          incrementValue$3 = var4;
          var4++;
          this.field_u[incrementValue$3] = (byte)-1;
          var5 = 255 & param1;
          this.field_u[var4] = (byte)(3 * var5 >> 696092293);
          return;
        }
    ...
    final byte[] a(int param0, int param1, boolean param2, int param3) {
        this.field_u = new byte[2 * param1 * (param3 * param0)];
        if (param2) {
          return (byte[]) null;
        } else {
          this.a(param0, (byte) -10, param3, param1);
          return this.field_u;
        }
    }
