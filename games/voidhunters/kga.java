...
final class kga extends rqa {
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 < -119) {
              stackIn_4_0 = new nc(frb.a(84, 116));
          ...
          L1: {
            ...
            stackIn_7_1 = new StringBuilder().append("kga.A(");
    ...
    final static int a(int param0, String param1) {
        ...
        try {
          L0: {
            ...
            stackIn_1_0 = tea.a(nua.field_p, param1, 13879);
            break L0;
          }
        } catch (java.lang.RuntimeException decompiledCaughtParameter0) {
          decompiledCaughtException = decompiledCaughtParameter0;
          L1: {
            ...
            stackIn_4_1 = new StringBuilder().append("kga.D(").append(param0).append(',');
    ...
    final static void a(int param0, int[] param1) {
        try {
            ...
            throw rta.a((Throwable) ((Object) runtimeException), "kga.E(" + param0 + ',' + (param1 != null ? "{...}" : "null") + ')');
        }
    }
