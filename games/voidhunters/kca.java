    ...
    final static int a(int param0, int param1, int param2, int param3, int param4, int param5, String param6, int param7, int param8, int param9, int param10, byte param11, int param12) {
        ...
        try {
          L0: {
            if (param11 <= -61) {
              if (!li.field_i) {
                ...
                stackOut_4_0 = nma.field_b[param7].a(param1, param3, param10, 0, param0, param2, (int[]) null, false, 0, param9, param6, param5, param12, (aja[]) null, param8 | param4 << 1341547544, (aa) null);
          ...
          L1: {
            ...
            stackOut_8_1 = new StringBuilder().append("kca.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
    ...
    final int a(int param0, int param1) {
        ...
        L0: {
          ...
          if (param0 == -123454015) {
            ...
            var7 = (String) null;
            discarded$2 = kca.a(114, -24, -99, -33, 59, -105, (String) null, 97, -95, -68, -115, (byte) 21, -117);
            break L0;
          }
        }
