...
final class cka extends rqa {
    ...
    final static void a(int param0, String param1, int param2, int param3, int param4, int param5) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "cka.B(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
    }
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 <= -119) {
              stackOut_3_0 = new nc(oaa.b((byte) -51));
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("cka.A(");
