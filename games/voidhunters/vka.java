...
class vka {
                    ...
                    try {
                      L2: {
                        L3: {
                          var5 = new cob();
                          var4 = var5;
                          stackIn_10_0 = (cob) (var4);

                          stackIn_10_1 = 256;

                          if (!field_r) {
                            stackIn_11_0 = (cob) ((Object) stackIn_10_0);
                        ...
                        L5: {
                          ...
                          if (field_u <= 0) {
                            ...
                            if (field_e != null) {
                              ...
                              param0.a(0, field_u, (Runnable) ((Object) field_e));
                              break L5;
                            }
                          }
                        }
                ...
                L0: {
                  ...
                  L2: while (true) {
                    if (var1 <= this.field_k + 5000L) {
                      ...
                      this.b(256);
                      this.field_k = this.field_k + (long)(256000 / field_s);
                      var1 = wt.a(false);
                      continue L2;
                    }
                  }
              ...
              if (this.field_b != null) {
                try {
                  L4: {
                    ...
                    L6: {
                      var3_int = this.g();
                      if (this.field_d - var3_int <= this.field_h) {
                        break L6;
                      } else {
                        this.field_h = this.field_d - var3_int;
                        break L6;
                      }
                    }
                    L7: {
                      var4 = this.field_p + this.field_c;
                      if (var4 + 256 <= 16384) {
                        break L7;
                      } else {
                        var4 = 16128;
                    ...
                    L8: {
                      if (var4 + 256 <= this.field_o) {
                        ...
                        if (var4 + 256 <= this.field_o) {
                          ...
                          this.field_c = var4 - this.field_p;
                          break L8;
                        }
                      }
                    }
                          ...
                          if (var1 <= this.field_t) {
                            ...
                            L12: {
                              if (this.field_q) {
                                ...
                                this.field_c = Math.min(this.field_n, this.field_h);
    ...
    private final void a(int[] param0, int param1) {
        ...
        L1: {
          ...
          if (this.field_m == null) {
            ...
            if (this.field_l > 0) {
              ...
              this.field_l = this.field_l + (field_s >> 4);
              vka.b(this.field_m);
              this.a(this.field_m, this.field_m.b());
              var4 = 0;
              var5 = 255;
              var6 = 7;
              L2: while (true) {
        ...
        L17: {
          if (this.field_m == null) {
            ...
            this.field_m.a(param0, 0, param1);
            break L17;
          }
        }
        this.field_k = wt.a(false);
    }
    ...
    vka() {
        ...
        this.field_f = 0L;
        this.field_h = 0;
        this.field_i = new f[8];
        this.field_n = 0;
        this.field_t = 0L;
        this.field_d = 0;
        this.field_q = true;
        this.field_j = new f[8];
    }
}
