...
final class pm extends rqa {
    final static void e(byte param0) {
        ...
        try {
            ...
            if (param0 <= -17) {
              ...
              L1: while (true) {
                if (var1_int >= 256) {
                  ...
                  var2 = 15.0;
                  ap.field_p[var1_int] = (int)(255.0 * Math.pow((double)((float)var1_int / 256.0f), var2));
                  var1_int++;
                  continue L1;
                }
              }
          ...
          throw rta.a((Throwable) (Object) var1, "pm.C(" + param0 + 41);
        }
    }
    ...
    final static void a(int param0, int param1, int param2, String param3, int param4, int param5, byte param6) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("pm.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
          ...
          throw rta.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + param4 + 44 + param5 + 44 + param6 + 41);
        }
    }
