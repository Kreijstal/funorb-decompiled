    ...
    final static int a(int param0, String param1, int param2) {
        ...
        try {
          L0: {
            ...
            if (li.field_i) {
              stackOut_5_0 = de.a(param0, param2 ^ 14107).a(param1, param2 + -13878);
              stackIn_6_0 = stackOut_5_0;
              decompiledRegionSelector0 = 1;
              break L0;
            } else {
              stackOut_3_0 = ita.a(param0, param2 + -5891).b(param1);
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("tea.A(").append(param0).append(',');
