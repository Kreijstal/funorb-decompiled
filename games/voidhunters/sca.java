...
final class sca extends mc {
    ...
    sca(int param0, int param1, int param2, int param3, shb param4, boolean param5, int param6, int param7, no param8, int param9, String param10) {
        ...
        try {
          L0: {
            ...
            L3: {
              if (!this.field_y) {
                stackOut_9_0 = this.field_w + this.field_x * 2;
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("sca.<init>(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',');
    ...
    final void b(int param0, int param1, int param2, int param3) {
        ...
        int discarded$0 = this.field_v.a(this.field_A, this.field_x + (var7 + var5), var6 + this.field_x, this.field_w - this.field_x, -(this.field_x * 2) + this.field_f, this.field_z, -1, this.field_y ? 0 : 2, 1, this.field_v.field_k);
    }
