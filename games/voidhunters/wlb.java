...
final class wlb extends rqa {
    ...
    final static void f() {
        ...
        hab.field_g[26].field_w = new int[][]{new int[22]};
        hab.field_g[26].field_a = 4;
        hab.field_g[28] = new wfb(new int[8], 0, 0);
        hab.field_g[28].field_w = new int[][]{new int[12], new int[12], new int[8]};
        hab.field_g[42] = new wfb(new int[8], -5, 0);
        hab.field_g[42].field_g = new mua();
        hab.field_g[42].a((byte) -126, 3);
        hab.field_g[42].field_w = new int[][]{new int[24]};
        hab.field_g[42].field_a = 1;
        hab.field_g[43] = new wfb(new int[8], -3, 0);
        hab.field_g[43].field_c = new qjb(9);
        hab.field_g[43].field_w = new int[][]{new int[18]};
        hab.field_g[43].field_a = 1;
        hab.field_g[44] = new wfb(new int[8], -3, 0);
        hab.field_g[44].field_c = new qjb(10);
        hab.field_g[44].a((byte) -105, 7);
        hab.field_g[44].field_a = 1;
        hab.field_g[44].field_w = new int[][]{new int[12]};
        hab.field_g[47] = new wfb(new int[16], -20, 0);
        hab.field_g[47].field_B = 0;
        hab.field_g[47].field_A = new int[][]{new int[4], new int[4]};
        ...
        L0: while (true) {
          if (hab.field_g.length <= var1_int) {
            ...
            var29_ref.field_A = new int[][]{new int[6], new int[4]};
            var4 = -fnb.field_b / 2;
            var5 = -fnb.field_b / 2;
            var6 = uca.a(var5, (byte) 9, new int[9], var4);
            var30_ref = new wfb(var6, -fnb.field_b / 2, 0);
            var30_ref.a(111, 15);
            var30_ref.field_A = new int[][]{new int[4], new int[6], new int[4]};
            var30_ref.field_a = 3;
            ...
            var4 = -fnb.field_b / 2;
            var5 = 0;
            var6 = uca.a(var5, (byte) 9, new int[5], var4);
            var31_ref = new wfb(var6, -fnb.field_b / 2, -fnb.field_b / 2);
            var31_ref.a(113, 15);
            var31_ref.field_A = new int[][]{new int[5], new int[3]};
            var31_ref.field_a = 3;
            var31_ref.field_B = 0;
            ...
            var32_ref.a(101, 15);
            var32_ref.field_B = 0;
            var32_ref.field_A = new int[][]{new int[5], new int[3]};
            var32_ref.field_q = 0;
            hab.field_g[51] = var32_ref;
            var32_ref.field_a = 3;
            var4 = -fnb.field_b / 2;
            var5 = 0;
            var97 = uca.a(var5, (byte) 9, new int[6], var4);
            var81 = var97;
            var65 = var81;
            var33 = var65;
            var6 = var33;
            ...
            var4 = -fnb.field_b / 2;
            var5 = -fnb.field_b;
            var98 = uca.a(var5, (byte) 9, new int[6], var4);
            var82 = var98;
            var66 = var82;
            var35 = var66;
            var6 = var35;
            ...
            var4 = -fnb.field_a;
            var5 = -fnb.field_b / 2;
            var99 = uca.a(var5, (byte) 9, new int[5], var4);
            var83 = var99;
            var67 = var83;
            var37 = var67;
            var6 = var37;
            var38_ref = new wfb(var6, -fnb.field_a, 0);
            ta.a(var99, 118, var38_ref);
            var38_ref.a(114, 15);
            ...
            var39_ref.field_w = new int[][]{new int[18]};
            var39_ref.field_A = new int[][]{new int[4], new int[4]};
            ...
            var40_ref.field_w = new int[][]{new int[28]};
            var40_ref.field_a = 6;
            var40_ref.field_d = 1;
            ...
            var46_ref = new wfb(var102, 0, 0);
            ta.a(var102, 127, var46_ref);
            ...
            var56_ref = new wfb(var107, 0, 0);
            ta.a(var107, 121, var56_ref);
            var56_ref.a(107, 15);
            ...
            var5 = fnb.field_b / 2;
            var109 = uca.a(var5, (byte) 9, new int[25], var4);
            var60_ref = new wfb(var109, 0, 0);
            ...
            L1: while (true) {
              if (var8 >= var110.length) {
                ...
                var62.field_w = new int[][]{new int[14], new int[26]};
                var62.field_a = 0;
