...
abstract class aja implements ekb {
    ...
    final void a(float param0, float param1, float param2, float param3, int param4, int param5, int param6, int param7, int param8) {
        ...
        if (param4 == 0) {
          ...
          var16 = (((float)((aja) this).c() - param2) * var13 + -param3 * var12) / 4096.0f + param0;
          var17 = (-((float)((aja) this).c() - param2) * var12 + -param3 * var13) / 4096.0f + param1;
          var18 = (-param2 * var13 + ((float)((aja) this).b() - param3) * var12) / 4096.0f + param0;
          var19 = (--param2 * var12 + ((float)((aja) this).b() - param3) * var13) / 4096.0f + param1;
    ...
    final void b(int param0, int param1, int param2, int param3) {
        ((aja) this).a(param0, param1, param2, param3, 1, 0, 1, 1);
    }
    ...
    private final void a(float param0, float param1, float param2, float param3, float param4, float param5, int param6, int param7, int param8) {
        ((aja) this).a(param0, param1, param2, param3, param4, param5, param6, param7, param8, 1);
    }

    abstract void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6, int param7);

    final void a(int param0, int param1, int param2, int param3, int param4, int param5, int param6) {
        ((aja) this).a(param0, param1, param2, param3, param4, param5, param6, 1);
    }

    final void a(int param0, int param1) {
        ((aja) this).a(param0, param1, 1, 0, 1);
    }
