    ...
    final static int a(int param0, int param1) {
        ...
        if (param1 > 36) {
          ...
          if (param0 < 4096) {
            L0: {
              if (2048 <= param0) {
                stackIn_10_0 = kra.field_a[-param0 + 4096];
                break L0;
              } else {
                stackIn_10_0 = kra.field_a[param0];
                break L0;
              }
            }
            return stackIn_10_0;
            ...
            L1: {
              if (6144 > param0) {
                stackIn_6_0 = -kra.field_a[param0 + -4096];
                break L1;
              } else {
                stackIn_6_0 = -kra.field_a[8192 + -param0];
                break L1;
              }
            }
            return stackIn_6_0;
    ...
    final static void a(eab param0, byte param1, asb param2) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_25_1 = new StringBuilder().append("eu.E(");
