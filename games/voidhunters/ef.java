...
final class ef extends mc {
    ...
    final StringBuilder a(boolean param0, Hashtable param1, int param2, StringBuilder param3) {
        ...
        try {
              ...
              if (!((ef) this).a(param1, param2, (byte) 115, param3)) {
                ...
                if (((ef) this).field_w == 2147483647) {
                  ...
                  if (2147483647 == ((ef) this).field_C) {
                    ...
                    StringBuilder discarded$27 = param3.append(" to ").append(((ef) this).field_w).append(44).append(((ef) this).field_C);
                    break L1;
                  }
                }
              }
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("ef.JA(").append(param0).append(44);
    ...
    final void a(byte param0, int param1, int param2, int param3, shb param4, int param5) {
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "ef.G(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + param5 + 41);
        }
    }
    ...
    ef(int param0, int param1, int param2, int param3, wwa param4, sba param5, shb param6, boolean param7, boolean param8) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "ef.<init>(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + (param6 != null ? "{...}" : "null") + 44 + param7 + 44 + param8 + 41);
        }
    }
    ...
    final boolean a(int param0, int param1, int param2, int param3, shb param4, int param5, byte param6) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_13_1 = new StringBuilder().append("ef.S(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
    ...
    final void a(int param0, int param1, int param2, shb param3) {
        ...
        try {
          ...
          L8: {
            ...
            stackOut_29_1 = new StringBuilder().append("ef.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
