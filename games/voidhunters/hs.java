...
final class hs extends rqa {
    final static void a(int param0, int param1, int param2, boolean param3, int param4, int param5, String param6, int param7) {
        ...
        try {
              ...
              L1: {
                if (li.field_i) {
                  L2: {
                    ...
                    stackOut_6_1 = param5;
                    stackOut_6_2 = param1;
                    stackOut_6_3 = param2 << 703025464 | param4;
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("hs.B(").append(param0).append(',').append(param1).append(',').append(param2).append(',').append(param3).append(',').append(param4).append(',').append(param5).append(',');
    ...
    final static void a(ea param0, int param1, int param2) {
        ...
        try {
            ...
            discarded$0 = var5.g(param1 ^ 1594, var4);
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = new nc(frb.a(129, 85));
