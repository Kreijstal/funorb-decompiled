...
final class fca extends ksa {
    ...
    final static fca a(asb param0, int param1, int param2) {
        try {
            fca var4_ref = null;
            if (!fca.a(param0)) {
                param0.a((byte) 87, param2, param1);
                return null;
            }
            ...
            L1: while (true) {
              if (var2 >= var1) {
                ...
                L2: while (true) {
                  if (var3 >= var2) {
                    var2 = fca.c(6) + 1;
                    field_z = new ota[var2];
                    var3 = 0;
                    L3: while (true) {
                      if (var3 >= var2) {
                        var3 = fca.c(6) + 1;
                        field_d = new wsa[var3];
                        var4 = 0;
                        L4: while (true) {
                          if (var4 >= var3) {
                            var4 = fca.c(6) + 1;
                            field_i = new uha[var4];
                            var5 = 0;
                            L5: while (true) {
                              if (var5 >= var4) {
                                var5 = fca.c(6) + 1;
                                field_p = new boolean[var5];
                                ...
                                field_i[var5] = new uha();
                                var5++;
                                continue L5;
                              }
                            }
                          } else {
                            field_d[var4] = new wsa();
                            var4++;
                            continue L4;
                          }
                        }
                      } else {
                        field_z[var3] = new ota();
                        var3++;
                        continue L3;
                      }
                    }
                      ...
                      if (var9_int >= var5) {
                        ...
                        L12: while (true) {
                          if (var11 >= var5) {
                            ...
                            var9[var11] = obb.a(var10, -18644, var11);
                            var11++;
                            continue L12;
                          }
                        }
    ...
    private final static boolean a(asb param0) {
        byte[] var1 = null;
        if (!field_e) {
            var1 = param0.a(0, 0, (byte) 13);
            if (var1 == null) {
                return false;
            }
            fca.b(var1);
    ...
    final static int c() {
        int var0 = field_y[field_m] >> field_u & 1;
        field_u = field_u + 1;
        field_m = field_m + (field_u >> 3);
        field_u = field_u & 7;
        return var0;
    }
    ...
    final static int c(int param0) {
        ...
        while (param0 >= 8 - field_u) {
            var3 = 8 - field_u;
            var4 = (1 << var3) - 1;
            var1 = var1 + ((field_y[field_m] >> field_u & var4) << var2);
            field_u = 0;
            field_m = field_m + 1;
            var2 = var2 + var3;
            param0 = param0 - var3;
        ...
        if (param0 > 0) {
            var3 = (1 << param0) - 1;
            var1 = var1 + ((field_y[field_m] >> field_u & var3) << var2);
          ...
          if (var17_int >= var14.field_a) {
            L10: {
              if (var15 != 0) {
                ...
                field_z[var18_int].a(field_r, var4 >> 1);
                break L10;
              }
            }
            L11: {
    ...
    private fca(byte[] param0) throws IOException {
        this.a(param0);
    }
