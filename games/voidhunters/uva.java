...
final class uva extends ksa {
    ...
    final void a(int param0, int param1) {
        ...
        L1: {
          L2: {
            if (field_f == null) {
              ...
              if (field_f.length == ((uva) this).field_i.length) {
                break L1;
              } else {
                break L2;
              }
        ...
        var3 = ((uva) this).field_i.length;
        var4 = param0;
        var5 = ((uva) this).field_e - 1;
        var6 = ((uva) this).field_e * param1;
        var7 = var3 - 1;
        var8_int = 0;
        L3: while (true) {
          if (var8_int >= var3) {
            var8 = ((uva) this).field_i;
