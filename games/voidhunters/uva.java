...
final class uva extends ksa {
    ...
    final void a(int param0, int param1) {
        ...
        if (field_f == null || field_f.length != this.field_i.length) {
            field_f = new int[this.field_i.length];
        }
        int var3 = this.field_i.length;
        int var4 = param0;
        int var5 = this.field_e - 1;
        int var6 = this.field_e * param1;
        int var7 = var3 - 1;
        for (var8_int = 0; var8_int < var3; var8_int = var8_int + this.field_e) {
            var9 = var8_int + var6 & var7;
            for (var10 = 0; var10 < this.field_e; var10++) {
                var11 = var8_int + var10;
                var12 = var9 + (var10 + var4 & var5);
                field_f[var11] = this.field_i[var12];
            }
        }
        int[] var8 = this.field_i;
