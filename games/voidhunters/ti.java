...
final class ti extends qg {
    ...
    final void a(int param0, byte param1, pib param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_6_1 = new StringBuilder().append("ti.A(").append(param0).append(44).append(param1).append(44);
    ...
    final void a(int param0, int param1, int param2) {
        ...
        L0: {
          if (((ti) this).field_j) {
            var4 = 1 << (param0 & 3);
            var5 = (float)(1 << ((param0 & 60) >> 3)) / 32.0f;
            var6 = param2 & 65535;
