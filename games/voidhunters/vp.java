...
final class vp extends wm implements ntb {
        ...
        try {
          L0: {
            if (param1 == -2) {
              L1: {
                if (0 == param2) {
                  ((vp) this).field_d = (param3 + so.field_b) % so.field_b;
                  break L1;
                } else {
                  ((vp) this).field_c = (56 + param3) % 56;
                  break L1;
                }
              }
              break L0;
          ...
          throw rta.a((Throwable) (Object) stackIn_9_0, stackIn_9_2 + 44 + param1 + 44 + param2 + 44 + param3 + 41);
        }
    }
    ...
    final int a(byte param0, int param1) {
        ...
        if (0 == param1) {
            return ((vp) this).field_d;
        }
        return ((vp) this).field_c;
    }
    ...
    public final void b(byte param0, tv param1) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "vp.D(" + param0 + 44 + (param1 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final boolean a(int param0, lbb param1, pe param2) {
        ...
        try {
              ...
              if (var6 >= var5.length) {
                ...
                L2: {
                  ...
                  if (var7 == null) {
                    ...
                    if (var7.q((byte) 105) != ((vp) this).field_d) {
                      break L2;
                    } else {
                      if (0 < var7.field_k.a(((vp) this).field_c, 0)) {
                        stackOut_7_0 = 1;
          ...
          L3: {
            ...
            stackOut_12_1 = new StringBuilder().append("vp.G(").append(param0).append(44);
    ...
    public final void b(faa param0, int param1) {
        try {
            ...
            param0.a(-632, ((vp) this).field_d, 8);
            param0.a(-632, ((vp) this).field_c, 8);
        } catch (RuntimeException runtimeException) {
            throw rta.a((Throwable) (Object) runtimeException, "vp.B(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    public final void a(faa param0, boolean param1) {
        try {
            ...
            ((vp) this).field_d = param0.i(0, 8);
            ((vp) this).field_c = param0.i(0, 8);
        } catch (RuntimeException runtimeException) {
            throw rta.a((Throwable) (Object) runtimeException, "vp.H(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    final ucb[] a(pe param0, int param1) {
        ...
        try {
          L0: {
            if (param1 != -20605) {
              int discarded$2 = ((vp) this).a((byte) -105, 11);
              stackOut_2_0 = null;
    ...
    final int[] a(pe param0, int param1, int[] param2) {
        ...
        try {
          L0: {
            L1: {
              ...
              if (param1 >= 16) {
                ...
                var9 = null;
                ucb[] discarded$1 = ((vp) this).a((pe) null, -9);
                break L1;
              }
            }
            var6 = 0;
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("vp.J(");
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
    ...
    final String a(int param0) {
        if (param0 != -1) {
            Object var3 = null;
            boolean discarded$0 = ((vp) this).a(-64, (lbb) null, (pe) null);
        }
        String var2 = "Any ship ";
        return var2 + "on team " + ((vp) this).field_d + " holds component " + obb.field_o[((vp) this).field_c];
    }
    ...
    public final boolean a(byte param0, tv param1) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_7_1 = new StringBuilder().append("vp.C(").append(param0).append(44);
            stackIn_9_0 = stackOut_7_0;
            stackIn_9_1 = stackOut_7_1;
            stackIn_8_0 = stackOut_7_0;
