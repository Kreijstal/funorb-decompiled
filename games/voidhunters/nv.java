        ...
        try {
          L0: {
            L1: {
              ...
              param2++;
              ww.a(param0, param5, rba.field_b[incrementValue$2], (byte) 75, param4);
              if (param1 >= 57) {
                break L1;
              } else {
                field_o = 108;
            ...
            param3--;
            ww.a(param0, param5, rba.field_b[incrementValue$3], (byte) 75, param4);
            var6_int = param2;
            L2: while (true) {
              if (var6_int > param3) {
                break L0;
          ...
          if (param1 >= 0) {
            if (param1 < unb.field_p) {
              ...
              if (-1 == (var3 ^ -1)) {
                L0: {
                  if (-1 != (param1 ^ -1)) {
                    stackIn_22_0 = fcb.field_g;
                    break L0;
                  } else {
                    stackIn_22_0 = cta.field_r;
                    break L0;
                  }
                }
                return stackIn_22_0;
                ...
                if (-2 == (var3 ^ -1)) {
                  L1: {
                    if (param1 != 0) {
                      stackIn_26_0 = csa.field_a;
                      break L1;
                    } else {
                      stackIn_26_0 = fdb.field_T;
                      break L1;
                    }
                  }
                  return stackIn_26_0;
                  ...
                  if (2 == var3) {
                    L2: {
                      if (param1 != 0) {
                        stackIn_30_0 = pbb.field_a;
                        break L2;
                      } else {
                        stackIn_30_0 = jlb.field_t;
                        break L2;
                      }
                    }
                    return stackIn_30_0;
                    ...
                    if (var3 == 3) {
                      L3: {
                        if (0 == param1) {
                          stackIn_34_0 = ipa.field_q;
                          break L3;
                        } else {
                          stackIn_34_0 = vm.field_q;
                          break L3;
                        }
                      }
                      return stackIn_34_0;
