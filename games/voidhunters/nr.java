...
final class nr extends rqa {
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            ...
            stackOut_2_0 = new nc((Object) (Object) frb.a(57, 92));
    ...
    final static void a(kla param0, int param1, int param2, int param3, int param4, int param5) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "nr.B(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + param2 + 44 + param3 + 44 + param4 + 44 + param5 + 41);
        }
    }
