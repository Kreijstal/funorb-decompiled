...
final class pmb extends rqa {
    ...
    final static cp a(int param0, ds param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("pmb.D(").append(param0).append(',');
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 < -119) {
              stackOut_3_0 = new nc(frb.a(126, 108));
