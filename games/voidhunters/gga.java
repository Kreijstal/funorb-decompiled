...
final class gga extends mc {
    private gga(int param0, int param1, int param2, int param3, wwa param4, sba param5, shb param6) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "gga.<init>(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + (param5 != null ? "{...}" : "null") + 44 + (param6 != null ? "{...}" : "null") + 41);
        }
    }
    ...
    final void a(byte param0, int param1, int param2, int param3, shb param4, int param5) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_8_1 = new StringBuilder().append("gga.G(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
          ...
          throw rta.a((Throwable) (Object) stackIn_11_0, stackIn_11_2 + 44 + param5 + 41);
        }
    }
