...
final class nna extends dqa implements oo {
    ...
    public final void a(int param0, int param1, int param2, htb param3, int param4) {
        ...
        try {
          ...
          L3: {
            ...
            stackIn_13_1 = new StringBuilder().append("nna.Q(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
    ...
    final htb a(byte param0, String param1, sba param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackIn_6_1 = new StringBuilder().append("nna.H(").append(param0).append(',');
    ...
    final void b(int param0, int param1, int param2, int param3) {
        if (param2 < 47) {
            sba var6 = (sba) null;
            this.a((byte) -58, (String) null, (sba) null);
        }
        super.b(param0, param1, 61, param3);
        this.field_H.a(this.field_x, param0 - -this.field_g - -14, 10 + (param3 + this.field_r), this.field_h + -28, this.field_f, 16777215, -1, 0, 0, this.field_H.field_k);
    }
