    ...
    final static caa[] a(int param0, byte param1, int param2, asb param3) {
        ...
        try {
          ...
          L1: {
            ...
            stackIn_7_1 = new StringBuilder().append("ng.C(").append(param0).append(',').append(param1).append(',').append(param2).append(',');
