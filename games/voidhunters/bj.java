...
final class bj extends rqa {
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 <= -119) {
              stackOut_3_0 = new nc(frb.a(105, 97));
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("bj.A(");
    ...
    final static void a(byte param0, asb param1, no param2) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_14_1 = new StringBuilder().append("bj.C(").append(param0).append(',');
