...
final class lwa extends llb {
    ...
    final static int a(int param0, int param1) {
        ...
        try {
          ...
          throw rta.a((Throwable) (Object) var2, "lwa.D(" + param0 + 44 + -1 + 41);
        }
        return stackIn_9_0;
    }
    ...
    lwa(llb param0, llb param1, llb param2, llb param3, llb param4, llb param5) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var12 >= skb.field_q.length) {
                ...
                ((lwa) this).b(-561, var8);
                var10 = -(((lwa) this).field_G >> 1) + 240;
                ((lwa) this).field_L = 320 + -(((lwa) this).field_hb >> 1);
                break L0;
              } else {
                L2: {
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("lwa.<init>(");
