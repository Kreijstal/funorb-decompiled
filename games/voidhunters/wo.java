...
final class wo extends rqa {
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 <= -119) {
              stackOut_3_0 = new nc(frb.a(144, 88));
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("wo.A(");
    ...
    final static void a(int param0, boolean param1, int param2, boolean param3, kka param4) {
        ...
        try {
            ...
            throw rta.a((Throwable) ((Object) runtimeException), "wo.C(" + param0 + ',' + param1 + ',' + param2 + ',' + param3 + ',' + (param4 != null ? "{...}" : "null") + ')');
        }
    }
