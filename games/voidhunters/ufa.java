...
final class ufa extends rqa {
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 <= -119) {
              stackOut_3_0 = new nc(sva.field_m);
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("ufa.A(");
    ...
    final static void a(ds param0, byte param1, java.math.BigInteger param2, java.math.BigInteger param3, ds param4) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "ufa.C(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 44 + (param2 != null ? "{...}" : "null") + 44 + (param3 != null ? "{...}" : "null") + 44 + (param4 != null ? "{...}" : "null") + 41);
        }
    }
