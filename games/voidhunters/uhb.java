...
final class uhb extends rqa {
            ...
            switch (statePc) {
                ...
                case 10: {
                    try {
                        ...
                        stackOut_10_1 = new StringBuilder().append("uhb.B(");
            ...
            switch (statePc) {
                ...
                case 6: {
                    try {
                        ...
                        stackOut_6_1 = new StringBuilder().append("uhb.A(");
    ...
    final static asb a(int param0, int param1, int param2, boolean param3, boolean param4) {
        ...
        try {
          ...
          decompiledCaughtException = decompiledCaughtParameter;
          stackOut_4_0 = mla.a(param3, param4, -120, false, param1, param0);
    ...
    final static void a(boolean param0, int param1, byte param2, wma param3, int param4) {
        ...
        stateLoop: while (true) {
            switch (statePc) {
                ...
                case 27: {
                    try {
                        stackOut_27_0 = -1 + bs.field_b.length;
                ...
                case 31: {
                    try {
                        var17 = stackIn_31_0 - stackIn_31_1;
                ...
                case 42: {
                    try {
                        var19 = stackIn_42_0 + stackIn_42_1;
                        statePc = 43;
                        continue stateLoop;
                ...
                case 67: {
                    try {
                        ...
                        stackOut_67_1 = new StringBuilder().append("uhb.C(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
                ...
                case 71: {
                    throw rta.a((Throwable) (Object) stackIn_71_0, stackIn_71_2 + 44 + param4 + 41);
                }
                case 72: {
                    return;
                }
