...
final class mca extends rqa {
    final static byte[] a(boolean param0, int param1, faa param2, byte[] param3) {
        ...
        try {
          ...
          L6: {
            ...
            stackOut_18_1 = new StringBuilder().append("mca.B(").append(false).append(',').append(16).append(',');
    ...
    final nc a(nc[] param0, int param1) {
        ...
        try {
          L0: {
            if (param1 < -119) {
              stackOut_3_0 = new nc((Object) (Object) frb.a(37, 89));
          ...
          L1: {
            ...
            stackOut_5_1 = new StringBuilder().append("mca.A(");
