...
final class bba implements ntb {
        ...
        try {
          L0: {
            L1: {
              ...
              discarded$4 = tja.a(var3.field_b, 1, this.field_b, true, 5547);
              discarded$5 = tja.a(var3.field_c, 1, this.field_c, true, 5547);
              var4 = 0;
          ...
          if (0 > param0) {
            ...
            L2: {
              if (this.field_b == null) {
                ...
                stackOut_4_0 = this.field_b.length;
                stackIn_6_0 = stackOut_4_0;
                break L2;
              }
            }
                    ...
                    L2: while (true) {
                      L3: {
                        if (param3.length <= param2) {
                          ...
                          if (0 == (param3[incrementValue$4] ^ -1)) {
                            break L3;
                          } else {
    ...
    final void a(int param0, int param1) {
        rna[] discarded$0 = null;
        if (param1 != -1) {
            discarded$0 = this.c((byte) 14);
        }
        if (param0 >= 0) {
            if (this.field_b != null) {
    ...
    final int a(byte param0, int param1, int param2) {
        ...
        if (null != this.field_c) {
            if (param1 - var5 < this.field_c.length) {
