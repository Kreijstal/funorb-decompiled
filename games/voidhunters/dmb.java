    ...
    public void b(byte param0, tv param1) {
        ...
        try {
          L0: {
            L1: {
              if (param0 > 54) {
                ...
                var4 = null;
                boolean discarded$2 = ((dmb) this).a((byte) -58, (tv) null);
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("dmb.D(").append(param0).append(44);
    ...
    public boolean a(byte param0, tv param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("dmb.C(").append(param0).append(44);
    ...
    public void a(faa param0, boolean param1) {
        ...
        try {
          L0: {
            L1: {
              if (!param1) {
                ...
                var4 = null;
                phb[] discarded$2 = dmb.a(-64, (byte) 110, (asb) null, -56);
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            runtimeException = decompiledCaughtException;
            stackOut_3_0 = (RuntimeException) runtimeException;
            stackOut_3_1 = new StringBuilder().append("dmb.H(");
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
            stackIn_4_0 = stackOut_3_0;
            stackIn_4_1 = stackOut_3_1;
    ...
    public void a(tv param0, int param1) {
        ...
        try {
          ...
          L2: {
            runtimeException = decompiledCaughtException;
            stackOut_3_0 = (RuntimeException) runtimeException;
            stackOut_3_1 = new StringBuilder().append("dmb.F(");
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
            stackIn_4_0 = stackOut_3_0;
            stackIn_4_1 = stackOut_3_1;
    ...
    public void b(faa param0, int param1) {
        ...
        try {
          L0: {
            L1: {
              if (param1 <= -109) {
                ...
                var4 = null;
                phb[] discarded$2 = dmb.a(34, (byte) -8, (asb) null, 110);
                break L1;
              }
            }
            break L0;
          ...
          L2: {
            runtimeException = decompiledCaughtException;
            stackOut_3_0 = (RuntimeException) runtimeException;
            stackOut_3_1 = new StringBuilder().append("dmb.B(");
            stackIn_5_0 = stackOut_3_0;
            stackIn_5_1 = stackOut_3_1;
            stackIn_4_0 = stackOut_3_0;
            stackIn_4_1 = stackOut_3_1;
    ...
    final static phb[] a(int param0, byte param1, asb param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("dmb.G(").append(param0).append(44).append(param1).append(44);
