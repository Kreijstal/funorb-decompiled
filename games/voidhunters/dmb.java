    ...
    public void b(byte param0, tv param1) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_3_1 = new StringBuilder().append("dmb.D(").append(param0).append(',');
    ...
    public boolean a(byte param0, tv param1) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("dmb.C(").append(param0).append(',');
    ...
    final static phb[] a(int param0, byte param1, asb param2, int param3) {
        ...
        try {
          ...
          L2: {
            ...
            stackOut_7_1 = new StringBuilder().append("dmb.G(").append(param0).append(',').append(param1).append(',');
