    ...
    private final boolean b(int param0, shb param1) {
        ...
        try {
          ...
          L4: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) (var3);
            stackOut_8_1 = new StringBuilder().append("mc.SA(").append(param0).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
          ...
          L0: {
            ...
            L1: while (true) {
              if (var5_int > param0) {
                L2: {
                  if (null != this.field_t) {
                    discarded$10 = this.field_t.a(false, param3, param0 - -1, param2);
                    break L2;
                  } else {
    ...
    private final boolean a(byte param0, shb param1) {
        ...
        try {
          ...
          L4: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) (var3);
            stackOut_8_1 = new StringBuilder().append("mc.VA(").append(param0).append(',');
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
          ...
          L0: {
            L1: {
              if (param0 == -15834) {
                ...
                var6 = (shb) null;
                discarded$2 = this.a(-72, 29, -110, -50, (shb) null, 73, (byte) 9);
                break L1;
              }
            }
            L2: {
