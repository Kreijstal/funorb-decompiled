...
abstract class mc extends shb implements nea {
    ...
    boolean a(int param0, int param1, int param2, int param3, shb param4, int param5, byte param6) {
        ...
        try {
          ...
          L4: {
            ...
            stackOut_7_1 = new StringBuilder().append("mc.S(").append(param0).append(44).append(param1).append(44).append(param2).append(44).append(param3).append(44);
    ...
    final boolean a(int param0, shb param1) {
        ...
        try {
              ...
              L1: {
                L2: {
                  if (((mc) this).field_t == null) {
                    ...
                    if (!((mc) this).field_t.a(param0, param1)) {
                      break L2;
                    } else {
                      stackOut_5_0 = 1;
          ...
          L3: {
            ...
            stackOut_8_1 = new StringBuilder().append("mc.A(").append(param0).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
        ...
        try {
          L0: {
            L1: {
              ...
              if (null != ((mc) this).field_t) {
                ((mc) this).field_t.a(((mc) this).field_r + param0, ((mc) this).field_g + param1, param2, param3);
                break L1;
              } else {
                break L1;
              }
          ...
          L2: {
            ...
            stackOut_4_1 = new StringBuilder().append("mc.B(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_6_0 = stackOut_4_0;
    ...
    final static void a(ml param0, int param1) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "mc.TA(" + (param0 != null ? "{...}" : "null") + 44 + param1 + 41);
        }
    }
    ...
    StringBuilder a(boolean param0, Hashtable param1, int param2, StringBuilder param3) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_6_1 = new StringBuilder().append("mc.JA(").append(param0).append(44);
    ...
    void a(byte param0, int param1, int param2, int param3, shb param4, int param5) {
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "mc.G(" + param0 + 44 + param1 + 44 + param2 + 44 + param3 + 44 + (param4 != null ? "{...}" : "null") + 44 + param5 + 41);
        }
    }
    ...
    private final boolean b(int param0, shb param1) {
        ...
        try {
          ...
          L4: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) var3;
            stackOut_8_1 = new StringBuilder().append("mc.SA(").append(param0).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    final void a(int param0, int param1, StringBuilder param2, Hashtable param3) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var5_int > param0) {
                L2: {
                  if (null != ((mc) this).field_t) {
                    StringBuilder discarded$10 = ((mc) this).field_t.a(false, param3, param0 - -1, param2);
                    break L2;
                  } else {
                    StringBuilder discarded$11 = param2.append("null");
                    break L2;
                  }
                }
                L3: {
                ...
                StringBuilder discarded$12 = param2.append(32);
                var5_int++;
                continue L1;
              }
            }
          ...
          L4: {
            ...
            stackOut_10_1 = new StringBuilder().append("mc.UA(").append(param0).append(44).append(param1).append(44);
            stackIn_12_0 = stackOut_10_0;
            stackIn_12_1 = stackOut_10_1;
            stackIn_11_0 = stackOut_10_0;
            stackIn_11_1 = stackOut_10_1;
    ...
    private final boolean a(byte param0, shb param1) {
        ...
        try {
          ...
          L4: {
            var3 = decompiledCaughtException;
            stackOut_8_0 = (RuntimeException) var3;
            stackOut_8_1 = new StringBuilder().append("mc.VA(").append(param0).append(44);
            stackIn_10_0 = stackOut_8_0;
            stackIn_10_1 = stackOut_8_1;
            stackIn_9_0 = stackOut_8_0;
            stackIn_9_1 = stackOut_8_1;
    ...
    final boolean a(int param0, int param1, shb param2, char param3) {
        ...
        try {
          L0: {
            L1: {
              if (param0 == -15834) {
                ...
                var6 = null;
                boolean discarded$2 = ((mc) this).a(-72, 29, -110, -50, (shb) null, 73, (byte) 9);
                break L1;
              }
            }
            L2: {
            ...
            if (var5_int != 80) {
              ...
              L3: {
                if (!si.field_o[81]) {
                  stackOut_11_0 = this.a((byte) -47, param2);
                  stackIn_12_0 = stackOut_11_0;
                  break L3;
                } else {
                  stackOut_10_0 = this.b(-125, param2);
                  stackIn_12_0 = stackOut_10_0;
                  break L3;
                }
              }
          ...
          L4: {
            ...
            stackOut_15_1 = new StringBuilder().append("mc.N(").append(param0).append(44).append(param1).append(44);
    ...
    final boolean a(int param0, int param1, int param2, shb param3, int param4, int param5, int param6) {
        ...
        try {
          ...
          L3: {
            ...
            stackOut_9_1 = new StringBuilder().append("mc.WA(").append(param0).append(44).append(param1).append(44).append(param2).append(44);
            stackIn_11_0 = stackOut_9_0;
            stackIn_11_1 = stackOut_9_1;
            stackIn_10_0 = stackOut_9_0;
            stackIn_10_1 = stackOut_9_1;
