                ...
                L2: while (true) {
                  ...
                  if (var8 == 0) {
                    ...
                    try {
                      ...
                      throw rta.a((Throwable) ((Object) stackIn_37_0), (stackIn_37_2 != 0) + " " + param2 + " " + var9.length + " " + psb.a(var9, var9.length, 0) + " " + psb.a(var9, -2 + var9.length, 0) + " " + this.field_g.field_d[param2] + " " + this.field_g.field_k);
                    }
                    L10: {
                      if (!this.field_e) {
                        break L10;
