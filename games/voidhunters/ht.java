...
final class ht extends f {
    ...
    final static float[] a(int param0, int param1, float[] param2) {
        ...
        try {
          ...
          L1: {
            ...
            stackOut_2_1 = new StringBuilder().append("ht.A(").append(param0).append(44).append(0).append(44);
        ...
        try {
          if ((4 & ((ht) this).field_i.field_v[param0.field_o]) == 0) {
            ...
            if (param0.field_v >= 0) {
              ...
              var4_int = ((ht) this).field_i.field_l[param0.field_o] / vka.field_s;
                ...
                L0: {
                  if (((ht) this).field_i.field_j[param0.field_o] == 0) {
                    ...
                    L1: {
                      ...
                      stackOut_5_0 = ((ht) this).field_i;
                      stackOut_5_1 = (fkb) param0;
                      stackIn_7_0 = stackOut_5_0;
                      stackIn_7_1 = stackOut_5_1;
                      stackIn_6_0 = stackOut_5_0;
                      stackIn_6_1 = stackOut_5_1;
                      if (param0.field_n.field_e[param0.field_x] >= 0) {
          ...
          L3: {
            ...
            stackOut_19_1 = new StringBuilder().append("ht.D(");
          ...
          throw rta.a((Throwable) (Object) stackIn_22_0, stackIn_22_2 + 44 + -1 + 44 + param2 + 41);
        }
    }
                  ...
                  if (!((ht) this).field_i.a(var6, 0)) {
                    ...
                    L3: while (true) {
                      if (var5 <= var6.field_k) {
                        ...
                        if (((ht) this).field_i.a(var4_int, param0, var5, var6, (byte) -12)) {
                          break L2;
                        } else {
                          continue L3;
                        }
    ...
    private final void a(int param0, int param1, fkb param2, int[] param3, int param4, byte param5) {
        ...
        try {
            ...
            L1: {
              if (0 == (((ht) this).field_i.field_v[param2.field_o] & 4)) {
                ...
                if (param2.field_v >= 0) {
                  ...
                  var7_int = ((ht) this).field_i.field_l[param2.field_o] / vka.field_s;
                  L2: while (true) {
                    ...
                    if (param4 < var8) {
                      ...
                      L6: {
                        if (param2.field_n.field_e[param2.field_x] < 0) {
                          param2.field_j.d(-1);
                          break L6;
                        } else {
                          break L6;
          ...
          L7: {
            ...
            stackOut_24_1 = new StringBuilder().append("ht.C(").append(param0).append(44).append(param1).append(44);
          ...
          throw rta.a((Throwable) (Object) stackIn_30_0, stackIn_30_2 + 44 + param4 + 44 + param5 + 41);
        }
    }
    ...
    ht(hbb param0) {
        ...
        try {
            ...
            throw rta.a((Throwable) (Object) runtimeException, "ht.<init>(" + (param0 != null ? "{...}" : "null") + 41);
        }
    }
