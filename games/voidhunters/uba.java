        ...
        if (0 > nd.field_r) {
          ...
          L0: {
            ...
            if (nd.field_r >= 75) {
              ...
              var5 = (nd.field_r << 8) / 75;
              break L0;
            }
          }
          L1: {
            if (nd.field_r > 200) {
              var5 = (250 + -nd.field_r << 8) / 50;
              break L1;
            } else {
              break L1;
            }
          ...
          L6: {
            ...
            if (0 < var6) {
              ...
              reb.field_a.d(15 + var3, var4 + 10, var5 * var7 >> 8);
              break L6;
            } else {
              break L6;
            }
          ...
          L0: {
            L1: {
              ...
              if (param1 < -119) {
                ...
                var4 = null;
                nc discarded$2 = ((uba) this).a((nc[]) null, -7);
                break L1;
              }
            }
    ...
    final static void a(byte param0, int param1, Object param2) {
        ...
        try {
          L0: {
            ...
            L1: while (true) {
              if (var3_int >= hcb.field_p) {
                L2: {
                  var3_ref = lua.a((byte) -86);
                  if (var3_ref == null) {
                    break L2;
                  } else {
                    var3_ref.field_c = param2;
                    var3_ref.field_a = param1;
                    break L2;
                  }
                }
                break L0;
          ...
          L4: {
            ...
            stackOut_12_1 = new StringBuilder().append("uba.C(").append(-100).append(44).append(param1).append(44);
